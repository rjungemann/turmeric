...
`--allow-experimental`) done; UC-5 (docs) done. **Area:**
...
| UC-5 | **done** | Docs: `docs/guides/experimental-flags-guide.md` grows a "user-level default" section; CLAUDE.md's experiments rule notes the third source. Trowel's plan can drop its "interim" path. | `docs/guides/experimental-flags-guide.md`, CLAUDE.md |
