...
**Syntax highlighter** colors -- keywords (amber), types (teal), builtins (violet), strings (coral), comments (dark italic), numbers (sage green) -- all inspired by the language's Haskell/Clojure DNA
