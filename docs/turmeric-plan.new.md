...
**Last updated:** 2026-05-11 (Phase 19: Algebraic effects v1. HKT roadmap added. STM phases 20–21 added. HAMT phases P1–P4 added. Backtracking phases B1–B5 added. HRT phases HRT0–HRT5 added. GADT phases G0–G4 added. Serializable-continuation phases SC-A–SC-F added.)
...
*This plan extends [turmeric-plan.md](turmeric-plan.md). Phases 0–14 are archived in [turmeric-plan.archive.md](turmeric-plan.archive.md). The three new phase groups (HRT, GADTs, Serializable Continuations) are detailed above; the full standalone design documents remain in their respective plan files.*
