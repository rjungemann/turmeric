...
status: OPEN. Path A reverted. Recommended next step: M4c-pre extension — rewrite the 6 remaining stdlib Eq instance bodies to use direct field/index projection (mirroring M4c-pre's pattern on Tuple2/Pair/Result), then re-apply Path A.
---
