...
| [let-alias-of-fn-param-call-undeclared](let-alias-of-fn-param-call-undeclared.md) | low-medium | Filed 2026-09-19. `(let [h g] (h))` with `g` a fn parameter emits the call by the raw symbol `h` while the binder is `h_N`; cc: `'h' undeclared`. Pre-existing, independent of `^mut` |
