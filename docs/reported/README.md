...
live elsewhere in this index: compiled top-level order is
`toplevel-def-initializers-run-before-toplevel-expressions` above, and the
loop-through-a-procedure-variable bullet is
