...
**Status 2026-09-14.** Three resolved -- the two effect ones in a single change,
the dispatch one after; two open. The guide routes around each open one and says so where a reader
