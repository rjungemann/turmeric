...
status: OPEN. Execution paused at step 2 of the plan. M4b backlinks and M4c-pre stdlib rewrites remain in tree (suite 170 FAIL vs 172 prior baseline; only `hamt-delete` flap is the diff).
---
