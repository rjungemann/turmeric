...
status: OPEN. M4c implementation deferred. M4b backlinks shipped (inert). Recommended next step: M4c-pre — rewrite the small set of stdlib instance bodies that use carrier-helper inline-C, see "Stdlib bodies to rewrite" below.
---
