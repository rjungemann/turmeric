---
description: Cut a new minor release. Bump VERSION, update CHANGELOG + README, deploy web, push tag.
...
Run a full minor-version release of Turmeric. Order matters: the commit
...
..." note are deleted; the section never survives a release. If the note asks for a MAJOR bump, stop and use `/cut-major-release`.
