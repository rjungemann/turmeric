...
static int64_t __bench_vec_build(int64_t);
static int64_t __bench_vec_fmap_impl(int64_t, int64_t);
static int64_t inc1(int64_t);

static int64_t __inst_Functor_fmap_vec(int64_t container, int64_t fn) {
        return __bench_vec_fmap_impl(container, fn);
}
...
static int64_t __bench_vec_build(int64_t n) {
...
static int64_t __bench_vec_fmap_impl(int64_t container, int64_t fn) {
...
int main() {
        int64_t __t0;
        {
            int64_t v_31 = __bench_vec_build(INT64_C(1000000));
            (void)v_31;
            (void)(((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_vec_singleton.fmap))(v_31, (int64_t)(intptr_t)(inc1)));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
