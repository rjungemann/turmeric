...
static int64_t __bench_opt_some(int64_t);
static int64_t __bench_opt_none();
static int64_t __bench_opt_bind(int64_t, int64_t);
static int64_t __bench_opt_pure(int64_t);
static int64_t __bench_opt_val(int64_t);
static int64_t add1(int64_t);

static int64_t __inst_Applicative_pure_option(int64_t a) {
        return __bench_opt_pure(a);
}
...
static int64_t __inst_Monad_bind_option(int64_t m, int64_t f) {
        return __bench_opt_bind(m, f);
}
...
static int64_t __bench_opt_some(int64_t v) {
...
static int64_t __bench_opt_bind(int64_t m, int64_t f) {
...
static int64_t __bench_opt_pure(int64_t a) {
        return __bench_opt_some(a);
}

static int64_t __bench_opt_val(int64_t m) {
        int64_t *p = (int64_t *)(intptr_t)m; return p[1];
  
}

static int64_t add1(int64_t x) {
        return __bench_opt_some(((x) + (INT64_C(1))));
}

int main() {
        {
            int64_t acc_38 = __bench_opt_some(INT64_C(0));
            (void)acc_38;
            {
                int64_t i_39 = INT64_C(0);
                (void)i_39;
                while (1) {
                    if (!(((i_39) < (INT64_C(100000))))) break;
                    acc_38 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(acc_38, (int64_t)(intptr_t)(add1));
                    i_39 = ((i_39) + (INT64_C(1)));
                }
            }
            printf("%lld\n", (long long)(__bench_opt_val(acc_38)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
