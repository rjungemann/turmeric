...
static double __fn_893(double);
static tur_fnptr_double_double_t __inst_HasArr_arr_hyof_ArrW(int64_t);
...
static double call_hythin(int64_t, double);
...
static double __fn_893(double x) {
        return (x) * (2.0);
}

static tur_fnptr_double_double_t __inst_HasArr_arr_hyof_ArrW(int64_t self) {
        return __fn_893;
}

typedef struct dict_HasArr_ArrW {
    tur_fnptr_double_double_t (*arr_hyof)(int64_t);
} dict_HasArr_ArrW;
...
static double call_hythin(int64_t f, double x) {
...
int main(int argc, char **argv) {
        ...
        printf("%g\n", (double)(call_hythin((int64_t)(intptr_t)(__inst_HasArr_arr_hyof_ArrW((int64_t)(INT64_C(0)))), 1.5)));
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
}
