...
static int64_t pair_hyfn_hyarg(int64_t, int64_t);
...
static int64_t pair_hyfn_hyarg(int64_t f, int64_t arg) {
...
int main(int argc, char **argv) {
        ...
        {
            int64_t (*ap)(int64_t) = __inst_ArrowApply_app_arrow();
            (void)ap;
            int64_t *__t74 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t74[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t74[1] = (int64_t)(intptr_t)add1;
            void *__t75 = __t74;
            printf("%lld\n", (long long)(((int64_t (*)(int64_t))(intptr_t)ap)(pair_hyfn_hyarg((int64_t)(intptr_t)(__t75), INT64_C(41)))));
            int64_t *__t76 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t76[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t76[1] = (int64_t)(intptr_t)mul2;
            void *__t77 = __t76;
            printf("%lld\n", (long long)(((int64_t (*)(int64_t))(intptr_t)ap)(pair_hyfn_hyarg((int64_t)(intptr_t)(__t77), INT64_C(21)))));
        }
        {
            int64_t k_1137 = INT64_C(1000);
            (void)k_1137;
            int64_t (*ap)(int64_t) = __inst_ArrowApply_app_arrow();
            (void)ap;
            struct __env_1148 *__t78 = (struct __env_1148 *)malloc(sizeof(struct __env_1148));
            __t78->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1146;
            __t78->k = k_1137;
            void *__t79 = __t78;
            printf("%lld\n", (long long)(((int64_t (*)(int64_t))(intptr_t)ap)(pair_hyfn_hyarg((int64_t)(intptr_t)(__t79), INT64_C(7)))));
        }
        int64_t __t80;
        __t80 = INT64_C(0);
        return (int)__t80;
