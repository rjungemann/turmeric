...
static int64_t __fn_199(int64_t);
static int64_t __fn_203(int64_t);
...
static int64_t __fn_199(int64_t exit) {
        return INT64_C(42);
}

static int64_t __fn_203(int64_t exit) {
        return INT64_C(7);
}
...
static int64_t test_escape_no_exit() {
        int64_t __t0;
        {
            int64_t (*__esc_f)(int64_t) = __fn_199;
            (void)__esc_f;
            __t0 = __esc_f(INT64_C(0));
        }
        return __t0;
}
...
static int64_t test_escape_value() {
        int64_t __t1;
        {
            int64_t (*__esc_f)(int64_t) = __fn_203;
            (void)__esc_f;
            __t1 = __esc_f(INT64_C(0));
        }
