...
static int64_t __fn_264(int64_t);
static int64_t __fn_268(int64_t);
...
static int64_t __fn_264(int64_t exit) {
        return INT64_C(42);
}

static int64_t __fn_268(int64_t exit) {
        return INT64_C(7);
}
...
static int64_t test_escape_no_exit() {
        int64_t __t0;
        {
            int64_t (*__esc_f)(int64_t) = __fn_264;
            (void)__esc_f;
...
static int64_t test_escape_value() {
        int64_t __t1;
        {
            int64_t (*__esc_f)(int64_t) = __fn_268;
            (void)__esc_f;
