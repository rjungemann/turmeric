...
static int64_t __fn_619(int64_t);
...
static int64_t test_escape_no_exit();
static int64_t test_escape_value();
...
static int64_t __fn_619(int64_t exit) {
        return INT64_C(42);
}

static int64_t __fn_623(int64_t exit) {
        return INT64_C(7);
}
...
static int64_t test_escape_no_exit() {
        int64_t __t0;
        {
            int64_t (*__esc_f)(int64_t) = __fn_619;
            (void)__esc_f;
...
static int64_t test_escape_value() {
        int64_t __t1;
        {
            int64_t (*__esc_f)(int64_t) = __fn_623;
            (void)__esc_f;
            __t1 = ((int64_t (*)(int64_t))(intptr_t)__esc_f)(INT64_C(0));
        }
        return ((INT64_C(3)) + (__t1));
}

int main() {
        printf("%lld\n", (long long)(test_escape_no_exit()));
        printf("%lld\n", (long long)(test_escape_value()));
        int64_t __t2;
        __t2 = INT64_C(0);
        return (int)__t2;
}
