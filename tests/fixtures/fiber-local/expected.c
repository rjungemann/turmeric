...
int main() {
        int64_t __t0;
        {
            void * fa_209 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
            (void)fa_209;
            int64_t __t1;
            {
                void * fb_210 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                (void)fb_210;
                (void)(fiber_resume_fn((void *)(intptr_t)(fa_209), INT64_C(0)));
                (void)(fiber_resume_fn((void *)(intptr_t)(fb_210), INT64_C(0)));
                int64_t __t2;
                int64_t __t3;
                {
                    int64_t va_211 = fiber_local_get_fn((void *)(intptr_t)(fa_209), INT64_C(42));
                    (void)va_211;
                    int64_t __t4;
                    {
                        int64_t vb_212 = fiber_local_get_fn((void *)(intptr_t)(fb_210), INT64_C(42));
                        (void)vb_212;
                        printf("%lld\n", (long long)(((va_211) + (vb_212))));
                        fiber_free_fn((void *)(intptr_t)(fa_209));
                        fiber_free_fn((void *)(intptr_t)(fb_210));
                        int64_t __t5;
                        __t5 = INT64_C(0);
                        __t4 = __t5;
                    }
