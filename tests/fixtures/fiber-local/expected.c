...
int main() {
        int64_t __t0;
        {
            void * fa_274 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
            (void)fa_274;
            int64_t __t1;
            {
                void * fb_275 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                (void)fb_275;
                (void)(fiber_resume_fn((void *)(intptr_t)(fa_274), INT64_C(0)));
                (void)(fiber_resume_fn((void *)(intptr_t)(fb_275), INT64_C(0)));
                int64_t __t2;
                int64_t __t3;
                {
                    int64_t va_276 = fiber_local_get_fn((void *)(intptr_t)(fa_274), INT64_C(42));
                    (void)va_276;
                    int64_t __t4;
                    {
                        int64_t vb_277 = fiber_local_get_fn((void *)(intptr_t)(fb_275), INT64_C(42));
                        (void)vb_277;
                        printf("%lld\n", (long long)(((va_276) + (vb_277))));
                        fiber_free_fn((void *)(intptr_t)(fa_274));
                        fiber_free_fn((void *)(intptr_t)(fb_275));
                        int64_t __t5;
                        __t5 = INT64_C(0);
                        __t4 = __t5;
                    }
