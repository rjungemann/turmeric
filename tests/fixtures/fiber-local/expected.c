...
int main() {
        int64_t __t0;
        {
            void * fa_34 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
            (void)fa_34;
            int64_t __t1;
            {
                void * fb_35 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                (void)fb_35;
                (void)(fiber_resume_fn((void *)(intptr_t)(fa_34), INT64_C(0)));
                (void)(fiber_resume_fn((void *)(intptr_t)(fb_35), INT64_C(0)));
                int64_t __t2;
                int64_t __t3;
                {
                    int64_t va_36 = fiber_local_get_fn((void *)(intptr_t)(fa_34), INT64_C(42));
                    (void)va_36;
                    int64_t __t4;
                    {
                        int64_t vb_37 = fiber_local_get_fn((void *)(intptr_t)(fb_35), INT64_C(42));
                        (void)vb_37;
                        printf("%lld\n", (long long)(((va_36) + (vb_37))));
                        fiber_free_fn((void *)(intptr_t)(fa_34));
                        fiber_free_fn((void *)(intptr_t)(fb_35));
                        int64_t __t5;
                        __t5 = INT64_C(0);
                        __t4 = __t5;
                    }
