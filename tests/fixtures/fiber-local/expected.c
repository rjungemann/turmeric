...
int main() {
        int64_t __t0;
        {
            void * fa_14 = fiber_new_fn(fiber_a, INT64_C(0));
            (void)fa_14;
            int64_t __t1;
            {
                void * fb_15 = fiber_new_fn(fiber_b, INT64_C(0));
                (void)fb_15;
                (void)(fiber_resume_fn(fa_14, INT64_C(0)));
                (void)(fiber_resume_fn(fb_15, INT64_C(0)));
                int64_t __t2;
                int64_t __t3;
                {
                    int64_t va_16 = fiber_local_get_fn(fa_14, INT64_C(42));
                    (void)va_16;
                    int64_t __t4;
                    {
                        int64_t vb_17 = fiber_local_get_fn(fb_15, INT64_C(42));
                        (void)vb_17;
                        printf("%lld\n", (long long)(((va_16) + (vb_17))));
                        fiber_free_fn(fa_14);
                        fiber_free_fn(fb_15);
                        int64_t __t5;
                        __t5 = INT64_C(0);
