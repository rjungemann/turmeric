...
int main() {
        int64_t __t0;
        {
            void * fa_221 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
            (void)fa_221;
            int64_t __t1;
            {
                void * fb_222 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                (void)fb_222;
                (void)(fiber_resume_fn((void *)(intptr_t)(fa_221), INT64_C(0)));
                (void)(fiber_resume_fn((void *)(intptr_t)(fb_222), INT64_C(0)));
                int64_t __t2;
                int64_t __t3;
                {
                    int64_t va_223 = fiber_local_get_fn((void *)(intptr_t)(fa_221), INT64_C(42));
                    (void)va_223;
                    int64_t __t4;
                    {
                        int64_t vb_224 = fiber_local_get_fn((void *)(intptr_t)(fb_222), INT64_C(42));
                        (void)vb_224;
                        printf("%lld\n", (long long)(((va_223) + (vb_224))));
                        fiber_free_fn((void *)(intptr_t)(fa_221));
                        fiber_free_fn((void *)(intptr_t)(fb_222));
                        int64_t __t5;
                        __t5 = INT64_C(0);
                        __t4 = __t5;
                    }
