...
static void fiber_a();
static void fiber_b();
static int64_t fiber_local_get_fn(void *, int64_t);
...
static int64_t fiber_local_get_fn(void * f, int64_t key) {
...
int main() {
        int64_t __t0;
        {
            void * fa_629 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
            (void)fa_629;
            int64_t __t1;
            {
                void * fb_630 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                (void)fb_630;
                (void)(fiber_resume_fn((void *)(intptr_t)(fa_629), INT64_C(0)));
                (void)(fiber_resume_fn((void *)(intptr_t)(fb_630), INT64_C(0)));
                int64_t __t2;
                int64_t __t3;
                {
                    int64_t va_631 = fiber_local_get_fn((void *)(intptr_t)(fa_629), INT64_C(42));
                    (void)va_631;
                    int64_t __t4;
                    {
                        int64_t vb_632 = fiber_local_get_fn((void *)(intptr_t)(fb_630), INT64_C(42));
                        (void)vb_632;
                        printf("%lld\n", (long long)(((va_631) + (vb_632))));
                        fiber_free_fn((void *)(intptr_t)(fa_629));
                        fiber_free_fn((void *)(intptr_t)(fb_630));
                        int64_t __t5;
                        __t5 = INT64_C(0);
                        __t4 = __t5;
                    }
