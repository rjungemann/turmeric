...
int main() {
        int64_t __t0;
        {
            void * fa_34 = fiber_new_fn(fiber_a, INT64_C(0));
            (void)fa_34;
            int64_t __t1;
            {
                void * fb_35 = fiber_new_fn(fiber_b, INT64_C(0));
                (void)fb_35;
                (void)(fiber_resume_fn(fa_34, INT64_C(0)));
                (void)(fiber_resume_fn(fb_35, INT64_C(0)));
                int64_t __t2;
                int64_t __t3;
                {
                    int64_t va_36 = fiber_local_get_fn(fa_34, INT64_C(42));
                    (void)va_36;
                    int64_t __t4;
                    {
                        int64_t vb_37 = fiber_local_get_fn(fb_35, INT64_C(42));
                        (void)vb_37;
