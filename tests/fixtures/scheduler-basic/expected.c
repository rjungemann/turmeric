...
int main() {
        int64_t __t0;
        {
            void * sched_209 = scheduler_new_fn();
            (void)sched_209;
            int64_t __t1;
            {
                void * fa_210 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_210;
                int64_t __t2;
                {
                    void * fb_211 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_211;
                    scheduler_spawn_fn((void *)(intptr_t)(sched_209), (void *)(intptr_t)(fa_210));
                    scheduler_spawn_fn((void *)(intptr_t)(sched_209), (void *)(intptr_t)(fb_211));
                    scheduler_run_to_completion_fn((void *)(intptr_t)(sched_209));
                    fiber_free_fn((void *)(intptr_t)(fa_210));
                    fiber_free_fn((void *)(intptr_t)(fb_211));
