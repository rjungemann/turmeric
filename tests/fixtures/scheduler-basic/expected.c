...
int main() {
        int64_t __t0;
        {
            void * sched_629 = scheduler_new_fn();
            (void)sched_629;
            int64_t __t1;
            {
                void * fa_630 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_630;
                int64_t __t2;
                {
                    void * fb_631 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_631;
                    scheduler_spawn_fn((void *)(intptr_t)(sched_629), (void *)(intptr_t)(fa_630));
                    scheduler_spawn_fn((void *)(intptr_t)(sched_629), (void *)(intptr_t)(fb_631));
                    scheduler_run_to_completion_fn((void *)(intptr_t)(sched_629));
                    fiber_free_fn((void *)(intptr_t)(fa_630));
                    fiber_free_fn((void *)(intptr_t)(fb_631));
