...
int main() {
        int64_t __t0;
        {
            void * sched_274 = scheduler_new_fn();
            (void)sched_274;
            int64_t __t1;
            {
                void * fa_275 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_275;
                int64_t __t2;
                {
                    void * fb_276 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_276;
                    scheduler_spawn_fn((void *)(intptr_t)(sched_274), (void *)(intptr_t)(fa_275));
                    scheduler_spawn_fn((void *)(intptr_t)(sched_274), (void *)(intptr_t)(fb_276));
                    scheduler_run_to_completion_fn((void *)(intptr_t)(sched_274));
                    fiber_free_fn((void *)(intptr_t)(fa_275));
                    fiber_free_fn((void *)(intptr_t)(fb_276));
