...
static void scheduler_spawn_fn(void *, void *);
...
static void scheduler_spawn_fn(void * sched, void * f) {
        tur_scheduler_spawn((TurScheduler *)sched, (FiberBlock *)f);
  
}

static void scheduler_run_to_completion_fn(void * sched) {
...
int main() {
        int64_t __t0;
        {
            void * sched_221 = scheduler_new_fn();
            (void)sched_221;
            int64_t __t1;
            {
                void * fa_222 = fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_222;
                int64_t __t2;
                {
                    void * fb_223 = fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_223;
                    scheduler_spawn_fn((void *)(intptr_t)(sched_221), (void *)(intptr_t)(fa_222));
                    scheduler_spawn_fn((void *)(intptr_t)(sched_221), (void *)(intptr_t)(fb_223));
                    scheduler_run_to_completion_fn((void *)(intptr_t)(sched_221));
                    fiber_free_fn((void *)(intptr_t)(fa_222));
                    fiber_free_fn((void *)(intptr_t)(fb_223));
