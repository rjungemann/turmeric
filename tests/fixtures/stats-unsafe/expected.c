...
static void __handle_body_0(void) {
    tur_current_fiber->result = (int64_t)malloc(INT64_C(8));
}
...
int main() {
        ...
        void * __t2 = (void *)__dispatch_0(&__cap_0, (int64_t)(intptr_t)__fiber_0, 0);
        ...
        void * __t5 = (void *)__dispatch_3(&__cap_3, (int64_t)(intptr_t)__fiber_3, 0);
