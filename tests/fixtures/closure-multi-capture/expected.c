...
struct __env_201 { int64_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_199(void * __env_p_202) {
        struct __env_201 *__env___env_201 = (struct __env_201 *)__env_p_202;
        return ((__env___env_201->a) + (((__env___env_201->b) + (__env___env_201->c))));
}
...
int main() {
        int64_t __t0;
        {
            int64_t a_196 = INT64_C(10);
            (void)a_196;
            int64_t __t1;
            {
                int64_t b_197 = INT64_C(20);
                (void)b_197;
                int64_t __t2;
                {
                    int64_t c_198 = INT64_C(30);
                    (void)c_198;
                    int64_t __t3;
                    {
                        struct __env_201 *__t4 = (struct __env_201 *)malloc(sizeof(struct __env_201));
                        __t4->__fn = (int64_t)(intptr_t)__fn_199;
                        __t4->a = a_196;
                        __t4->b = b_197;
                        __t4->c = c_198;
                        void *__t5 = __t4;
