...
struct __env_266 { int64_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_264(void * __env_p_267) {
        struct __env_266 *__env___env_266 = (struct __env_266 *)__env_p_267;
        return ((__env___env_266->a) + (((__env___env_266->b) + (__env___env_266->c))));
}
...
int main() {
        int64_t __t0;
        {
            int64_t a_261 = INT64_C(10);
            (void)a_261;
            int64_t __t1;
            {
                int64_t b_262 = INT64_C(20);
                (void)b_262;
                int64_t __t2;
                {
                    int64_t c_263 = INT64_C(30);
                    (void)c_263;
                    int64_t __t3;
                    {
                        struct __env_266 *__t4 = (struct __env_266 *)malloc(sizeof(struct __env_266));
                        __t4->__fn = (int64_t)(intptr_t)__fn_264;
                        __t4->a = a_261;
                        __t4->b = b_262;
                        __t4->c = c_263;
                        void *__t5 = __t4;
