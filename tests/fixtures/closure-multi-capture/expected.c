...
struct __env_621 { int64_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_619(void * __env_p_622) {
        struct __env_621 *__env___env_621 = (struct __env_621 *)__env_p_622;
        return ((__env___env_621->a) + (((__env___env_621->b) + (__env___env_621->c))));
}
...
int main() {
        int64_t __t0;
        {
            int64_t a_616 = INT64_C(10);
            (void)a_616;
            int64_t __t1;
            {
                int64_t b_617 = INT64_C(20);
                (void)b_617;
                int64_t __t2;
                {
                    int64_t c_618 = INT64_C(30);
                    (void)c_618;
                    int64_t __t3;
                    {
                        struct __env_621 *__t4 = (struct __env_621 *)malloc(sizeof(struct __env_621));
                        __t4->__fn = (int64_t)(intptr_t)__fn_619;
                        __t4->a = a_616;
                        __t4->b = b_617;
                        __t4->c = c_618;
                        void *__t5 = __t4;
