...
struct __env_213 { int64_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_211(void * __env_p_214) {
        struct __env_213 *__env___env_213 = (struct __env_213 *)__env_p_214;
        return ((__env___env_213->a) + (((__env___env_213->b) + (__env___env_213->c))));
}
...
int main() {
        int64_t __t0;
        {
            int64_t a_208 = INT64_C(10);
            (void)a_208;
            int64_t __t1;
            {
                int64_t b_209 = INT64_C(20);
                (void)b_209;
                int64_t __t2;
                {
                    int64_t c_210 = INT64_C(30);
                    (void)c_210;
                    int64_t __t3;
                    {
                        struct __env_213 *__t4 = (struct __env_213 *)malloc(sizeof(struct __env_213));
                        __t4->__fn = (int64_t)(intptr_t)__fn_211;
                        __t4->a = a_208;
                        __t4->b = b_209;
                        __t4->c = c_210;
                        void *__t5 = __t4;
