...
int main() {
        {
            ...
            *__t0 = INT64_C(777);
            ...
            tur_frame_init(&__frame_2, NULL);
            {
                ...
                printf("%lld\n", (long long)(__t4));
                int64_t __t5 = rc_strong_count(cloned_617);
                printf("%lld\n", (long long)(__t5));
                struct __defer_env_6 __t8 = {.cloned = cloned_617};
                tur_frame_push_defer(&__frame_3, __defer_7, &__t8);
                tur_frame_fire_lifo(&__frame_3);
            }
            struct __defer_env_9 __t11 = {.orig = orig_616};
        ...
        }
        {
            ...
            *__t12 = INT64_C(888);
            ...
            __t13->value = __t12;
            RcControlBlock * orig_618 = __t13;
            (void)orig_618;
            tur_frame __frame_14;
            tur_frame_init(&__frame_14, NULL);
            {
                rc_strong_increment(orig_618);
                RcControlBlock * cloned_619 = orig_618;
                (void)cloned_619;
                tur_frame __frame_15;
                tur_frame_init(&__frame_15, &__frame_14);
                puts("before");
                int64_t __t16 = rc_strong_count(cloned_619);
                printf("%lld\n", (long long)(__t16));
                struct __defer_env_17 __t19 = {.cloned = cloned_619};
                tur_frame_push_defer(&__frame_15, __defer_18, &__t19);
                tur_frame_fire_lifo(&__frame_15);
            }
            struct __defer_env_20 __t22 = {.orig = orig_618};
