...
static int64_t __fn_1289(void * __env_p_1292) {
        ...
        tur_adt_Wide __t40 = __env___env_1291->w;
        __auto_type __ps_41 = (pong(&__t40, (__env___env_1291->n) - (INT64_C(1))));
...
static int64_t __fn_1304(void * __env_p_1307) {
        ...
        tur_adt_Wide __t42 = __env___env_1306->w;
        __auto_type __ps_43 = (ping(&__t42, (__env___env_1306->n) - (INT64_C(1))));
        if (tur_panicking) return (int64_t){0};
        return __ps_43;
}
...
static int64_t ping(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            struct __env_1291 *__t180 = (struct __env_1291 *)malloc(sizeof(struct __env_1291));
            __t180->__fn = (tur_thunk_int64_t_t)__fn_1289;
            __t180->w = *w;
            __t180->n = n;
            void *__t181 = __t180;
            int64_t __catch_result_182 = tur_catch_unwind_box((int64_t)(intptr_t)__t181);
            free((void *)(intptr_t)__t181);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_182);
            int64_t __t183;
            int64_t __t184 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
...
static int64_t pong(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            struct __env_1306 *__t189 = (struct __env_1306 *)malloc(sizeof(struct __env_1306));
            __t189->__fn = (tur_thunk_int64_t_t)__fn_1304;
            __t189->w = *w;
            __t189->n = n;
            void *__t190 = __t189;
            int64_t __catch_result_191 = tur_catch_unwind_box((int64_t)(intptr_t)__t190);
            free((void *)(intptr_t)__t190);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_195 = (ctor_MkWide(INT64_C(5), INT64_C(6), INT64_C(7), INT64_C(8)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Wide __t196 = __ps_195;
        __auto_type __ps_197 = (ping(&__t196, INT64_C(2000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_197));
        int64_t __t198;
        __t198 = INT64_C(0);
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_200 = (vec_new__spec__tur_adt_Vec__int__());
