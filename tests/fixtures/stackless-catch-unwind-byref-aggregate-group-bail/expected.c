...
static int64_t pong(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            void *__t197 = malloc(sizeof(void *) + sizeof(struct __env_1459));
            *(void (**)(void *))__t197 = drop_glue___env_1459;
            struct __env_1459 *__t196 = (struct __env_1459 *)((char *)__t197 + sizeof(void *));
            __t196->__fn = (tur_thunk_int64_t_t)__fn_1457;
            __t196->w = *w;
            __t196->n = n;
            void *__t198 = __t196;
