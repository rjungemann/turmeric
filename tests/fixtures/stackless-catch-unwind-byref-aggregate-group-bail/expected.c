...
#endif
#define TUR_TD_tur_adt_Wide
typedef struct tur_adt_Wide {
    union {
        struct { int64_t _0; int64_t _1; int64_t _2; int64_t _3; } MkWide;
    } as;
} tur_adt_Wide;

static tur_adt_Wide ctor_Wide_MkWide(int64_t _0, int64_t _1, int64_t _2, int64_t _3) {
    tur_adt_Wide __r;
    __r.as.MkWide._0 = _0;
    __r.as.MkWide._1 = _1;
    __r.as.MkWide._2 = _2;
...
#ifndef TUR_CTORALIAS_MkWide
#define TUR_CTORALIAS_MkWide
#define ctor_MkWide ctor_Wide_MkWide
#endif
...
static int64_t __fn_1631(void *);
static int64_t __fn_1646(void *);
...
static int64_t ping(const tur_adt_Wide *, int64_t);
static int64_t pong(const tur_adt_Wide *, int64_t);
...
struct __env_1633 { tur_thunk_int64_t_t __fn; tur_adt_Wide w; int64_t n; };
...
static int64_t __fn_1631(void * __env_p_1634) {
        struct __env_1633 *__env___env_1633 = (struct __env_1633 *)__env_p_1634;
        tur_adt_Wide __t62 = __env___env_1633->w;
        return pong(&__t62, (__env___env_1633->n) - (INT64_C(1)));
}

struct __env_1648 { tur_thunk_int64_t_t __fn; tur_adt_Wide w; int64_t n; };
static void drop_glue___env_1648(void *__p) {
    struct __env_1648 *__e = (struct __env_1648 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1646(void * __env_p_1649) {
        struct __env_1648 *__env___env_1648 = (struct __env_1648 *)__env_p_1649;
        tur_adt_Wide __t63 = __env___env_1648->w;
        return ping(&__t63, (__env___env_1648->n) - (INT64_C(1)));
}
...
static int64_t min(int64_t x, int64_t y) {
        int64_t __t66;
        bool __ps_67 = (__inst_Ord_gte_qu_int(x, y));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_67) {
            __t66 = y;
        } else {
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    bool __t2;
__tur_cps_self:;
    bool __ps_68 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
    if (tur_panicking) return ((int64_t)0);
    __t0 = __ps_68;
    if (__t0) {
        int64_t __ps_69 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((int64_t)0);
        h_999 = __ps_69;
        void * __ps_70 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((int64_t)0);
        k_1000 = __ps_70;
        bool __ps_71 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_999, (void *)(intptr_t)(k_1000), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_71;
        if (__t1) {
            int64_t __ps_72 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_999, (void *)(intptr_t)(k_1000), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
            bool __ps_74 = (((bool)((int64_t (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_72, __ps_73)));
            if (tur_panicking) return ((int64_t)0);
            __t2 = __ps_74;
            if (__t2) {
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1004 = __ps_77;
            (void)iter_1004;
            void * __ps_78 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_79 = (hamt_slkeyeq((void *)(intptr_t)(__ps_78)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1005 = __ps_79;
            (void)keyeq_1005;
            void * __ps_80 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1004), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_1005), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1006 = __ps_81;
            (void)result_1006;
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if (__ps_102) {
                    ...
                    bool __t104;
                    bool __ps_105 = (tnil_qu(t2_1297));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_105) {
                        __t104 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1296, t2_1297));
                        if (tur_panicking) return ((bool)0);
                        __t104 = __ps_106;
                    }
                    __t101 = __t104;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                int64_t out_1312 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1312;
                __t113 = out_1312;
            }
            __t111 = __t113;
        ...
        if (__ps_118) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1383 = __ps_119;
                (void)h_1383;
                void * __ps_120 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1384 = __ps_120;
                (void)k_1384;
                bool __ps_121 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1383, (void *)(intptr_t)(k_1384), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_121) {
                    void * __t122 = iter;
                    void * __t123 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1387 = __ps_127;
            (void)iter_1387;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1388 = __ps_129;
            (void)keyeq_1388;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1387), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1388)));
            if (tur_panicking) return ((bool)0);
            bool result_1389 = __ps_131;
            (void)result_1389;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1519));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1520 = __ps_154;
                (void)_un_unv_1520;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1570 = __ps_157;
            (void)r_1570;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1570));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                return schema_hydecode_hyvalue(r_1570);
            } else {
                int64_t __ps_159 = (schema_hydecode_hyerrors(r_1570));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t161;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1621 = __ps_162;
            (void)m_1621;
            tur_frame __frame_163;
            tur_frame_init(&__frame_163, NULL);
            struct __defer_env_164 __t166 = {.m = m_1621};
...
static int64_t ping(const tur_adt_Wide * w, int64_t n) {
        int64_t __t174;
        if ((n) == (INT64_C(0))) {
            int64_t __t175 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
                {
                    int64_t a_1627 = (int64_t)__scrut->as.MkWide._0;
                    int64_t b_1628 = (int64_t)__scrut->as.MkWide._1;
                    int64_t c_1629 = (int64_t)__scrut->as.MkWide._2;
                    int64_t d_1630 = (int64_t)__scrut->as.MkWide._3;
                    __t175 = a_1627;
                    goto ____t176;
                }
                ____t176:;
            ...
            void *__t178 = malloc(sizeof(void *) + sizeof(struct __env_1633));
            *(void (**)(void *))__t178 = drop_glue___env_1633;
            struct __env_1633 *__t177 = (struct __env_1633 *)((char *)__t178 + sizeof(void *));
            __t177->__fn = (tur_thunk_int64_t_t)__fn_1631;
            __t177->w = *w;
            TUR_REGION_NOTE_WORDS(&(__t177->w), sizeof(__t177->w));
            __t177->n = n;
            TUR_REGION_NOTE_WORDS(&(__t177->n), sizeof(__t177->n));
            void *__t179 = __t177;
            int64_t __catch_result_180 = tur_catch_unwind_box((int64_t)(intptr_t)__t179);
            TUR_CLOSURE_DROP(__t179);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_180);
            int64_t __t181;
            int64_t __t182 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
                {
                    int64_t a_1636 = (int64_t)__scrut->as.MkWide._0;
                    int64_t b_1637 = (int64_t)__scrut->as.MkWide._1;
                    int64_t c_1638 = (int64_t)__scrut->as.MkWide._2;
                    int64_t d_1639 = (int64_t)__scrut->as.MkWide._3;
                    __t182 = b_1637;
                    goto ____t183;
                }
                ____t183:;
...
static int64_t pong(const tur_adt_Wide * w, int64_t n) {
        int64_t __t184;
        if ((n) == (INT64_C(0))) {
            int64_t __t185 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
                {
                    int64_t a_1642 = (int64_t)__scrut->as.MkWide._0;
                    int64_t b_1643 = (int64_t)__scrut->as.MkWide._1;
                    int64_t c_1644 = (int64_t)__scrut->as.MkWide._2;
                    int64_t d_1645 = (int64_t)__scrut->as.MkWide._3;
                    __t185 = c_1644;
                    goto ____t186;
                }
                ____t186:;
            ...
            void *__t188 = malloc(sizeof(void *) + sizeof(struct __env_1648));
            *(void (**)(void *))__t188 = drop_glue___env_1648;
            struct __env_1648 *__t187 = (struct __env_1648 *)((char *)__t188 + sizeof(void *));
            __t187->__fn = (tur_thunk_int64_t_t)__fn_1646;
            __t187->w = *w;
            TUR_REGION_NOTE_WORDS(&(__t187->w), sizeof(__t187->w));
            __t187->n = n;
            TUR_REGION_NOTE_WORDS(&(__t187->n), sizeof(__t187->n));
            void *__t189 = __t187;
            int64_t __catch_result_190 = tur_catch_unwind_box((int64_t)(intptr_t)__t189);
            TUR_CLOSURE_DROP(__t189);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_190);
            int64_t __t191;
            int64_t __t192 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
                {
                    int64_t a_1651 = (int64_t)__scrut->as.MkWide._0;
                    int64_t b_1652 = (int64_t)__scrut->as.MkWide._1;
                    int64_t c_1653 = (int64_t)__scrut->as.MkWide._2;
                    int64_t d_1654 = (int64_t)__scrut->as.MkWide._3;
                    __t192 = d_1654;
                    goto ____t193;
                }
                ____t193:;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Wide __ps_194 = (ctor_Wide_MkWide(INT64_C(5), INT64_C(6), INT64_C(7), INT64_C(8)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Wide __t195 = __ps_194;
        int64_t __ps_196 = (ping(&__t195, INT64_C(2000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_196));
        int64_t __t197;
        __t197 = INT64_C(0);
