...
static int64_t __fn_1477(void * __env_p_1480) {
        ...
        tur_adt_Wide __t124 = __env___env_1479->w;
        int64_t __ps_125 = (pong(&__t124, (__env___env_1479->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_125;
}
...
static int64_t __fn_1492(void * __env_p_1495) {
        ...
        tur_adt_Wide __t126 = __env___env_1494->w;
        int64_t __ps_127 = (ping(&__t126, (__env___env_1494->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_127;
}
...
static int64_t ping(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            void *__t272 = malloc(sizeof(void *) + sizeof(struct __env_1479));
            *(void (**)(void *))__t272 = drop_glue___env_1479;
            struct __env_1479 *__t271 = (struct __env_1479 *)((char *)__t272 + sizeof(void *));
            __t271->__fn = (tur_thunk_int64_t_t)__fn_1477;
            __t271->w = *w;
            TUR_REGION_NOTE_WORDS(&(__t271->w), sizeof(__t271->w));
            __t271->n = n;
            TUR_REGION_NOTE_WORDS(&(__t271->n), sizeof(__t271->n));
            void *__t273 = __t271;
            int64_t __catch_result_274 = tur_catch_unwind_box((int64_t)(intptr_t)__t273);
            TUR_CLOSURE_DROP(__t273);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_274);
            int64_t __t275;
            int64_t __t276 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
...
static int64_t pong(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            void *__t282 = malloc(sizeof(void *) + sizeof(struct __env_1494));
            *(void (**)(void *))__t282 = drop_glue___env_1494;
            struct __env_1494 *__t281 = (struct __env_1494 *)((char *)__t282 + sizeof(void *));
            __t281->__fn = (tur_thunk_int64_t_t)__fn_1492;
            __t281->w = *w;
            TUR_REGION_NOTE_WORDS(&(__t281->w), sizeof(__t281->w));
            __t281->n = n;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Wide __ps_288 = (ctor_Wide_MkWide(INT64_C(5), INT64_C(6), INT64_C(7), INT64_C(8)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Wide __t289 = __ps_288;
        int64_t __ps_290 = (ping(&__t289, INT64_C(2000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_290));
        int64_t __t291;
        __t291 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_292 = (ctor_Cons_Cons__int(h, t));
