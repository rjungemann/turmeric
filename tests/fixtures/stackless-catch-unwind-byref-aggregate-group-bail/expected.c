...
struct __env_1628 { tur_thunk_int64_t_t __fn; tur_adt_Wide w; int64_t n; };
...
static int64_t __fn_1626(void * __env_p_1629) {
        ...
        tur_adt_Wide __t62 = __env___env_1628->w;
        return pong(&__t62, (__env___env_1628->n) - (INT64_C(1)));
}

struct __env_1643 { tur_thunk_int64_t_t __fn; tur_adt_Wide w; int64_t n; };
static void drop_glue___env_1643(void *__p) {
    struct __env_1643 *__e = (struct __env_1643 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1641(void * __env_p_1644) {
        struct __env_1643 *__env___env_1643 = (struct __env_1643 *)__env_p_1644;
        tur_adt_Wide __t63 = __env___env_1643->w;
        return ping(&__t63, (__env___env_1643->n) - (INT64_C(1)));
}
...
__tur_cps_self:;
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_998 = __ps_70;
        bool __ps_71 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_997, (void *)(intptr_t)(k_998), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_71;
        if (__t1) {
            int64_t __ps_72 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_997, (void *)(intptr_t)(k_998), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1002 = __ps_77;
            (void)iter_1002;
            void * __ps_78 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_79 = (hamt_slkeyeq((void *)(intptr_t)(__ps_78)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1003 = __ps_79;
            (void)keyeq_1003;
            void * __ps_80 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1002), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_1003), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1004 = __ps_81;
            (void)result_1004;
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if (__ps_102) {
                    ...
                    bool __t104;
                    bool __ps_105 = (tnil_qu(t2_1292));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_105) {
                        __t104 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1291, t2_1292));
                        if (tur_panicking) return ((bool)0);
                        __t104 = __ps_106;
                    }
                    __t101 = __t104;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                int64_t out_1307 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1307;
                __t113 = out_1307;
            }
            __t111 = __t113;
        ...
        if (__ps_118) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1378 = __ps_119;
                (void)h_1378;
                void * __ps_120 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1379 = __ps_120;
                (void)k_1379;
                bool __ps_121 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1378, (void *)(intptr_t)(k_1379), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_121) {
                    void * __t122 = iter;
                    void * __t123 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1382 = __ps_127;
            (void)iter_1382;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1383 = __ps_129;
            (void)keyeq_1383;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1382), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1383)));
            if (tur_panicking) return ((bool)0);
            bool result_1384 = __ps_131;
            (void)result_1384;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1514));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1515 = __ps_154;
                (void)_un_unv_1515;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1565 = __ps_157;
            (void)r_1565;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1565));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                return schema_hydecode_hyvalue(r_1565);
            } else {
                int64_t __ps_159 = (schema_hydecode_hyerrors(r_1565));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t161;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1616 = __ps_162;
            (void)m_1616;
            tur_frame __frame_163;
            tur_frame_init(&__frame_163, NULL);
            struct __defer_env_164 __t166 = {.m = m_1616};
...
static int64_t ping(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            int64_t __t175 = 0;
            {
                ...
                {
                    int64_t a_1622 = (int64_t)__scrut->as.MkWide._0;
                    int64_t b_1623 = (int64_t)__scrut->as.MkWide._1;
                    int64_t c_1624 = (int64_t)__scrut->as.MkWide._2;
                    int64_t d_1625 = (int64_t)__scrut->as.MkWide._3;
                    __t175 = a_1622;
                    goto ____t176;
                }
                ____t176:;
            ...
            void *__t178 = malloc(sizeof(void *) + sizeof(struct __env_1628));
            *(void (**)(void *))__t178 = drop_glue___env_1628;
            struct __env_1628 *__t177 = (struct __env_1628 *)((char *)__t178 + sizeof(void *));
            __t177->__fn = (tur_thunk_int64_t_t)__fn_1626;
            __t177->w = *w;
            ...
            int64_t __t182 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
                {
                    int64_t a_1631 = (int64_t)__scrut->as.MkWide._0;
                    int64_t b_1632 = (int64_t)__scrut->as.MkWide._1;
                    int64_t c_1633 = (int64_t)__scrut->as.MkWide._2;
                    int64_t d_1634 = (int64_t)__scrut->as.MkWide._3;
                    __t182 = b_1632;
                    goto ____t183;
                }
                ____t183:;
...
static int64_t pong(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            int64_t __t185 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
                {
                    int64_t a_1637 = (int64_t)__scrut->as.MkWide._0;
                    int64_t b_1638 = (int64_t)__scrut->as.MkWide._1;
                    int64_t c_1639 = (int64_t)__scrut->as.MkWide._2;
                    int64_t d_1640 = (int64_t)__scrut->as.MkWide._3;
                    __t185 = c_1639;
                    goto ____t186;
                }
                ____t186:;
            ...
            void *__t188 = malloc(sizeof(void *) + sizeof(struct __env_1643));
            *(void (**)(void *))__t188 = drop_glue___env_1643;
            struct __env_1643 *__t187 = (struct __env_1643 *)((char *)__t188 + sizeof(void *));
            __t187->__fn = (tur_thunk_int64_t_t)__fn_1641;
            __t187->w = *w;
            ...
            int64_t __t192 = 0;
            {
                const tur_adt_Wide *__scrut = (w);
                {
                    int64_t a_1646 = (int64_t)__scrut->as.MkWide._0;
                    int64_t b_1647 = (int64_t)__scrut->as.MkWide._1;
                    int64_t c_1648 = (int64_t)__scrut->as.MkWide._2;
                    int64_t d_1649 = (int64_t)__scrut->as.MkWide._3;
                    __t192 = d_1649;
                    goto ____t193;
                }
                ____t193:;
