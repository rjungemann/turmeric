...
static int64_t __fn_1442(void * __env_p_1445) {
        ...
        tur_adt_Wide __t44 = __env___env_1444->w;
        int64_t __ps_45 = (pong(&__t44, (__env___env_1444->n) - (INT64_C(1))));
...
static int64_t __fn_1457(void * __env_p_1460) {
        ...
        tur_adt_Wide __t46 = __env___env_1459->w;
        int64_t __ps_47 = (ping(&__t46, (__env___env_1459->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_47;
}
...
static int64_t ping(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            void *__t180 = malloc(sizeof(void *) + sizeof(struct __env_1444));
            *(void (**)(void *))__t180 = drop_glue___env_1444;
            struct __env_1444 *__t179 = (struct __env_1444 *)((char *)__t180 + sizeof(void *));
            __t179->__fn = (tur_thunk_int64_t_t)__fn_1442;
            __t179->w = *w;
            __t179->n = n;
            void *__t181 = __t179;
            int64_t __catch_result_182 = tur_catch_unwind_box((int64_t)(intptr_t)__t181);
            TUR_CLOSURE_DROP(__t181);
...
static int64_t pong(const tur_adt_Wide * w, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            *(void (**)(void *))__t190 = drop_glue___env_1459;
            ...
            __t189->__fn = (tur_thunk_int64_t_t)__fn_1457;
            __t189->w = *w;
            __t189->n = n;
            void *__t191 = __t189;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Wide __ps_196 = (ctor_Wide_MkWide(INT64_C(5), INT64_C(6), INT64_C(7), INT64_C(8)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Wide __t197 = __ps_196;
        int64_t __ps_198 = (ping(&__t197, INT64_C(2000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_198));
        int64_t __t199;
        __t199 = INT64_C(0);
