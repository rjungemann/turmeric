...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_20 = (const char *)__effect_args[0];
    int64_t k_21 = __k;
    tur_throw(13, (void*)msg_20, 6, "<unknown>");
    return 0;
}
...
static void __handle_body_1(void) {
    puts("before fail");
    int64_t __t3[1];
    __t3[0] = (int64_t)"something went wrong";
    tur_effect_perform("Fail", __t3, 1);
    puts("after fail");
...
static int64_t __dispatch_1(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Fail") == 0) {
...
int main(void) {
    ...
    if (setjmp(__t0.jmp_buf) == 0) {
        ...
        __eff_frame_1.cases[0].effect_name = "Fail";
        ...
        if (tur_exception_matches(__t0.caught, 13)) {
            const char * err_22 = (const char *)__t0.caught->payload;
            puts(err_22);
