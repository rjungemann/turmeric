...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(42);
            ...
            (void)r_261;
            int64_t __t3 = rc_strong_count(r_261);
            printf("%lld\n", (long long)(__t3));
            {
                rc_strong_increment(r_261);
                RcControlBlock * r2_262 = r_261;
                (void)r2_262;
                tur_frame __frame_4;
                tur_frame_init(&__frame_4, NULL);
                int64_t __t5 = rc_strong_count(r_261);
                printf("%lld\n", (long long)(__t5));
                int64_t __t6 = rc_strong_count(r2_262);
                printf("%lld\n", (long long)(__t6));
                struct __defer_env_7 __t9 = {.r2 = r2_262};
