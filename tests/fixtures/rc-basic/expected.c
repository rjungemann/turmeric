...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(42);
            ...
            (void)r_21;
            int64_t __t3 = rc_strong_count(r_21);
            printf("%lld\n", (long long)(__t3));
            {
                rc_strong_increment(r_21);
                RcControlBlock * r2_22 = r_21;
                (void)r2_22;
                tur_frame __frame_4;
                tur_frame_init(&__frame_4, NULL);
                int64_t __t5 = rc_strong_count(r_21);
                printf("%lld\n", (long long)(__t5));
                int64_t __t6 = rc_strong_count(r2_22);
                printf("%lld\n", (long long)(__t6));
                struct __defer_env_7 __t9 = {.r2 = r2_22};
