...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(42);
            ...
            (void)r_616;
            int64_t __t3 = rc_strong_count(r_616);
            printf("%lld\n", (long long)(__t3));
            {
                rc_strong_increment(r_616);
                RcControlBlock * r2_617 = r_616;
                (void)r2_617;
                tur_frame __frame_4;
                tur_frame_init(&__frame_4, NULL);
                int64_t __t5 = rc_strong_count(r_616);
                printf("%lld\n", (long long)(__t5));
                int64_t __t6 = rc_strong_count(r2_617);
                printf("%lld\n", (long long)(__t6));
                struct __defer_env_7 __t9 = {.r2 = r2_617};
                tur_frame_push_defer(&__frame_4, __defer_8, &__t9);
                tur_frame_fire_lifo(&__frame_4);
            }
            rc_strong_decrement(r_616);
            rc_free_queue_drain();
            int64_t __t10;
            __t10 = INT64_C(0);
            __t0 = __t10;
