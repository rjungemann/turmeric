...
static bool call_hypred(void *, int64_t);
static void * make_hygt(int64_t);
...
static bool call_hypred(void * f, int64_t x) {
        return TUR_APPLY1_T(bool, int64_t, f, x);
  
}

static void * make_hygt(int64_t n) {
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            void * gt5_899 = make_hygt(INT64_C(5));
            (void)gt5_899;
            puts((call_hypred((void *)(intptr_t)(gt5_899), INT64_C(8))) ? "true" : "false");
            puts((call_hypred((void *)(intptr_t)(gt5_899), INT64_C(2))) ? "true" : "false");
            int64_t __t28;
            __t28 = INT64_C(0);
            __t27 = __t28;
        }
