...
static bool __fn_859(void *, int64_t);
...
struct __env_861 { tur_thunk_bool_int64_t_t __fn; int64_t n; };
static bool __fn_859(void * __env_p_862, int64_t x) {
        struct __env_861 *__env___env_861 = (struct __env_861 *)__env_p_862;
        return (x) > (__env___env_861->n);
}
...
static void * make_gt(int64_t n) {
        struct __env_861 *__t25 = (struct __env_861 *)malloc(sizeof(struct __env_861));
        __t25->__fn = (tur_thunk_bool_int64_t_t)__fn_859;
        __t25->n = n;
        void *__t26 = __t25;
        return __t26;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            void * gt5_864 = make_gt(INT64_C(5));
            (void)gt5_864;
            puts((call_pred((void *)(intptr_t)(gt5_864), INT64_C(8))) ? "true" : "false");
            puts((call_pred((void *)(intptr_t)(gt5_864), INT64_C(2))) ? "true" : "false");
            int64_t __t28;
            __t28 = INT64_C(0);
            __t27 = __t28;
        }
