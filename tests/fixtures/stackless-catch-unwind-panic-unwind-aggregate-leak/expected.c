...
struct __env_1626 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
...
static int64_t __fn_1624(void * __env_p_1627) {
        ...
        return f(__env___env_1626->acc, INT64_C(4));
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n180->saved[2] = (int64_t)(intptr_t)(r_1629);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n186->saved[2] = (int64_t)(intptr_t)(r_1629);
          ...
          case 3: {
           ...
           r_1629 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           tur_result_box_free((int64_t)(intptr_t)r_1629);
