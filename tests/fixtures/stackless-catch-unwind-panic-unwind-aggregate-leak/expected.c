...
struct __env_1367 { tur_thunk_int64_t_t __fn; int64_t acc; };
...
static int64_t __fn_1365(void * __env_p_1368) {
        ...
        int64_t __ps_44 = (f(__env___env_1367->acc, INT64_C(4)));
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1080 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1080;
                __t112 = out_1080;
            }
            __t110 = __t112;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_119) {
            ...
            int64_t __t120;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1087 = (int64_t)(intptr_t)(__ps_124);
                (void)out_1087;
                __t120 = out_1087;
            }
            __t118 = __t120;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t129;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1162 = __ps_131;
            (void)iter_1162;
            void * __ps_132 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_133 = (hamt_slkeyeq((void *)(intptr_t)(__ps_132)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1163 = __ps_133;
            (void)keyeq_1163;
            void * __ps_134 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_135 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1162), (void *)(intptr_t)(__ps_134), (void *)(intptr_t)(keyeq_1163)));
            if (tur_panicking) return ((bool)0);
            bool result_1164 = __ps_135;
            (void)result_1164;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t156;
        {
            ...
            {
                tur_adt_Vec__int * __ps_158 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1291));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1292 = __ps_158;
                (void)_un_unv_1292;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t162;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1342 = __ps_163;
            (void)r_1342;
            int64_t __t164;
            bool __ps_165 = (schema_hydecode_hyok_qu(r_1342));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_165) {
                int64_t __ps_166 = (schema_hydecode_hyvalue(r_1342));
                if (tur_panicking) return ((int64_t)0);
                __t164 = __ps_166;
            } else {
                int64_t __ps_167 = (schema_hydecode_hyerrors(r_1342));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t f(int64_t acc, int64_t n) {
        int64_t r_1370 = 0;
        int64_t __t170 = 0;
        int64_t __t171 = 0;
        int64_t __t172 = 0;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n173->saved[0] = (int64_t)(intptr_t)(acc);
            __n173->saved[1] = (int64_t)(intptr_t)(n);
            __n173->saved[2] = (int64_t)(intptr_t)(r_1370);
          ...
          case 3: {
           ...
           r_1370 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           r_1370 = __box173;
           int64_t __t175;
           bool __ps_176 = (err_qu(r_1370));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_176) {
               int64_t __t177;
               bool __ps_178 = (some_qu(acc));
               if (tur_panicking) return ((int64_t)0);
               if (__ps_178) {
                   __t177 = INT64_C(111);
               } else {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_180 = (some__spec__int64_t_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_181 = (f(__ps_180, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        int64_t __ps_182 = (none__spec__int64_t());
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static int64_t some__spec__int64_t_int64_t(int64_t x) {
        int64_t __ps_187 = (ctor_Some__int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_187;
}

static int64_t none__spec__int64_t() {
        int64_t __ps_188 = (ctor_None__int());
        if (tur_panicking) return ((int64_t)0);
        return __ps_188;
}
