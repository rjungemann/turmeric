...
struct __env_1333 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
...
static int64_t __fn_1331(void * __env_p_1334) {
        ...
        int64_t __ps_42 = (f(__env___env_1333->acc, INT64_C(4)));
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_107) {
            ...
            int64_t __t108;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1047 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1047;
                __t108 = out_1047;
            }
            __t106 = __t108;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1054 = (int64_t)(intptr_t)(__ps_120);
                (void)out_1054;
                __t116 = out_1054;
            }
            __t114 = __t116;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1129 = __ps_127;
            (void)iter_1129;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1130 = __ps_129;
            (void)keyeq_1130;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1129), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1130)));
            if (tur_panicking) return ((bool)0);
            bool result_1131 = __ps_131;
            (void)result_1131;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1258));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1259 = __ps_154;
                (void)_un_unv_1259;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t157;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1308 = __ps_158;
            (void)r_1308;
            int64_t __t159;
            bool __ps_160 = (schema_hydecode_hyok_qu(r_1308));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_160) {
                int64_t __ps_161 = (schema_hydecode_hyvalue(r_1308));
                if (tur_panicking) return ((int64_t)0);
                __t159 = __ps_161;
            } else {
                int64_t __ps_162 = (schema_hydecode_hyerrors(r_1308));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n168->saved[2] = (int64_t)(intptr_t)(r_1336);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n174->saved[2] = (int64_t)(intptr_t)(r_1336);
          ...
          case 3: {
           ...
           r_1336 = (int64_t)(intptr_t)(__k->saved[2]);
