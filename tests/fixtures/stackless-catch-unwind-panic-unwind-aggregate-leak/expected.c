...
struct __env_1621 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
...
static int64_t __fn_1619(void * __env_p_1622) {
        ...
        return f(__env___env_1621->acc, INT64_C(4));
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n180->saved[2] = (int64_t)(intptr_t)(r_1624);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n186->saved[2] = (int64_t)(intptr_t)(r_1624);
          ...
          case 3: {
           ...
           r_1624 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           tur_result_box_free((int64_t)(intptr_t)r_1624);
