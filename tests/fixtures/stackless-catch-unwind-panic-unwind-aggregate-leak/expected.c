...
struct __env_1335 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
...
static int64_t __fn_1333(void * __env_p_1336) {
        ...
        int64_t __ps_42 = (f(__env___env_1335->acc, INT64_C(4)));
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_107) {
            ...
            int64_t __t108;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1048 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1048;
                __t108 = out_1048;
            }
            __t106 = __t108;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1055 = (int64_t)(intptr_t)(__ps_120);
                (void)out_1055;
                __t116 = out_1055;
            }
            __t114 = __t116;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1130 = __ps_127;
            (void)iter_1130;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1131 = __ps_129;
            (void)keyeq_1131;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1130), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1131)));
            if (tur_panicking) return ((bool)0);
            bool result_1132 = __ps_131;
            (void)result_1132;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1259));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1260 = __ps_154;
                (void)_un_unv_1260;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t158;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1310 = __ps_159;
            (void)r_1310;
            int64_t __t160;
            bool __ps_161 = (schema_hydecode_hyok_qu(r_1310));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_161) {
                int64_t __ps_162 = (schema_hydecode_hyvalue(r_1310));
                if (tur_panicking) return ((int64_t)0);
                __t160 = __ps_162;
            } else {
                int64_t __ps_163 = (schema_hydecode_hyerrors(r_1310));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n169->saved[2] = (int64_t)(intptr_t)(r_1338);
            __n169->saved[3] = (int64_t)(intptr_t)(__t166);
            __n169->saved[4] = (int64_t)(intptr_t)(__t167);
            __n169->saved[5] = (int64_t)(intptr_t)(__t168);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n175->saved[2] = (int64_t)(intptr_t)(r_1338);
             __n175->saved[3] = (int64_t)(intptr_t)(__t166);
          ...
          case 3: {
           ...
           r_1338 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           r_1338 = __box169;
           int64_t __t171;
           bool __ps_172 = (err_qu(r_1338));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_172) {
               int64_t __t173;
               bool __ps_174 = (some___spec__bool_tur_adt_Option__int(acc));
               if (tur_panicking) return ((int64_t)0);
               if (__ps_174) {
                   __t173 = INT64_C(111);
               } else {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_177 = (f(__ps_176, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        tur_adt_Option__int __ps_178 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_179 = (f(__ps_178, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        int64_t __t180;
        __t180 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_183 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_183;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_184 = (ctor_Option__int(false, ((int64_t)0)));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_184;
}
