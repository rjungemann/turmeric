...
struct __env_1277 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
static int64_t __fn_1275(void * __env_p_1278) {
        struct __env_1277 *__env___env_1277 = (struct __env_1277 *)__env_p_1278;
        __auto_type __ps_40 = (f(__env___env_1277->acc, INT64_C(4)));
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n178->saved[2] = (int64_t)(intptr_t)(r_1280);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n184->saved[2] = (int64_t)(intptr_t)(r_1280);
          ...
          case 3: {
           ...
           r_1280 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           r_1280 = __box178;
           int64_t __t180;
           __auto_type __ps_181 = (err_qu(r_1280));
           if (tur_panicking) return (int64_t){0};
           if (__ps_181) {
               int64_t __t182;
