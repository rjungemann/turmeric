...
static int64_t f(tur_adt_Option__int, int64_t);
...
struct __env_1472 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
...
static int64_t __fn_1470(void * __env_p_1473) {
        ...
        int64_t __ps_104 = (f(__env___env_1472->acc, INT64_C(4)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_104;
}
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_175) {
            ...
            int64_t __t176;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_180 = (_un_uncons_hyfmap(__ps_179, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                ...
                int64_t out_1147 = (int64_t)(intptr_t)(__ps_181);
                (void)out_1147;
                __t176 = out_1147;
            }
            __t174 = __t176;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_183) {
            ...
            int64_t __t184;
            {
                ...
                int64_t out_1154 = (int64_t)(intptr_t)(__ps_188);
                (void)out_1154;
                __t184 = out_1154;
            }
            __t182 = __t184;
...
static int64_t car(int64_t l) {
        int64_t __ps_189 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_189;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_190 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_190;
}

static bool null_qu(int64_t l) {
        bool __ps_191 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_191;
}

static int64_t length(int64_t l) {
        int64_t __ps_192 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_192;
}
        ...
        if (__ps_193) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1225 = __ps_194;
                (void)h_1225;
                void * __ps_195 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1226 = __ps_195;
                (void)k_1226;
                bool __ps_196 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1225, (void *)(intptr_t)(k_1226), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_196) {
                    void * __t197 = iter;
                    void * __t198 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t200;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1229 = __ps_202;
            (void)iter_1229;
            void * __ps_203 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_204 = (hamt_slkeyeq((void *)(intptr_t)(__ps_203)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1230 = __ps_204;
            (void)keyeq_1230;
            void * __ps_205 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_206 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1229), (void *)(intptr_t)(__ps_205), (void *)(intptr_t)(keyeq_1230)));
            if (tur_panicking) return ((bool)0);
            bool result_1231 = __ps_206;
            (void)result_1231;
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        int64_t __ps_209 = (set_hycount(s1));
        if (tur_panicking) return ((bool)0);
        int64_t __ps_210 = (set_hycount(s2));
        if (tur_panicking) return ((bool)0);
        bool __t208 = (__ps_209) == (__ps_210);
        if (__t208) {
            bool __ps_211 = (set_hyeq_hydriver(s1, s2));
            if (tur_panicking) return ((bool)0);
            __t208 = __ps_211;
        }
        return __t208;
...
static bool mutmap_hyeq_hyloop(int64_t m1, int64_t m2, int64_t i, int64_t cap, int64_t val_cmp) {
        ...
        if ((i) == (cap)) {
            ...
            bool __t213;
            bool __ps_214 = (mutmap_hyslot_hyoccupied_qu(m1, i));
            if (tur_panicking) return ((bool)0);
            if (__ps_214) {
                bool __t215;
                ...
                if (tur_panicking) return ((bool)0);
                bool __ps_218 = (mutmap_hyhas_qu(m2, __ps_216, __ps_217));
                if (tur_panicking) return ((bool)0);
                if (__ps_218) {
                    bool __t219;
                    int64_t __ps_220 = (mutmap_hyslot_hyvalue(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_221 = (mutmap_hyslot_hyhash(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_222 = (mutmap_hyslot_hykey(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_223 = (mutmap_hyget(m2, __ps_221, __ps_222));
                    if (tur_panicking) return ((bool)0);
                    bool __ps_224 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_220, __ps_223));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_224) {
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t227;
        {
            ...
            {
                tur_adt_Vec__int * __ps_229 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1361));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1362 = __ps_229;
                (void)_un_unv_1362;
                ...
                tur_adt_Vec__int * __t230;
                __t230 = _un_unv_1362;
                __t228 = __t230;
            }
            __t227 = __t228;
        }
        int64_t __ps_231 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t227))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_231;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_232 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_232);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t233;
        {
            int64_t __ps_234 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1412 = __ps_234;
            (void)r_1412;
            int64_t __t235;
            bool __ps_236 = (schema_hydecode_hyok_qu(r_1412));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_236) {
                int64_t __ps_237 = (schema_hydecode_hyvalue(r_1412));
                if (tur_panicking) return ((int64_t)0);
                __t235 = __ps_237;
            } else {
                int64_t __ps_238 = (schema_hydecode_hyerrors(r_1412));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_239 = (schema_hydecode_hyabort(__ps_238));
                if (tur_panicking) return ((int64_t)0);
                __t235 = __ps_239;
            }
            __t233 = __t235;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_240 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_240;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t241;
        {
            int64_t __ps_242 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1463 = __ps_242;
            (void)m_1463;
            int64_t __ps_243 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1464 = __ps_243;
            (void)r_1464;
            bool __ps_244 = (bt_hyundo_hyto_ex(m_1463));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_244);
            int64_t __t245;
            __t245 = r_1464;
...
static int64_t with_hyregion(int64_t body) {
        int64_t __ps_250 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_250;
}
...
static int64_t f(tur_adt_Option__int acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            tur_handler_node *__b254 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b254->parent = tur_handler_chain; tur_handler_chain = __b254;
            tur_cont *__n254 = (tur_cont*)malloc(sizeof(tur_cont));
            __n254->tag = 3; __n254->boundary = __b254; __n254->next = __k;
            __n254->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n254->saved[0] = (int64_t)(intptr_t)__ab; }
            __n254->saved[1] = (int64_t)(intptr_t)(n);
            __n254->saved[2] = (int64_t)(intptr_t)(r_1475);
            __n254->saved[3] = (int64_t)(intptr_t)(__t251);
            __n254->saved[4] = (int64_t)(intptr_t)(__t252);
            __n254->saved[5] = (int64_t)(intptr_t)(__t253);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             tur_cont *__n260 = (tur_cont*)malloc(sizeof(tur_cont));
             __n260->tag = 4; __n260->boundary = 0; __n260->next = __k;
             __n260->aggr_mask = 0x1u;
             { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n260->saved[0] = (int64_t)(intptr_t)__ab; }
             __n260->saved[1] = (int64_t)(intptr_t)(n);
             __n260->saved[2] = (int64_t)(intptr_t)(r_1475);
             __n260->saved[3] = (int64_t)(intptr_t)(__t251);
             __n260->saved[4] = (int64_t)(intptr_t)(__t252);
             __n260->saved[5] = (int64_t)(intptr_t)(__t253);
             tur_adt_Option__int __ra260_0 = (acc);
             int64_t __ra260_1 = ((n) - (INT64_C(1)));
             acc = __ra260_0;
             n = __ra260_1;
             __k = __n260; __pc = 1; break;
            }
           }
          }
          case 2: {
           tur_adt_Option__int __ra255_0 = (acc);
           int64_t __ra255_1 = (INT64_C(4));
           acc = __ra255_0;
           n = __ra255_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           r_1475 = (int64_t)(intptr_t)(__k->saved[2]);
           __t251 = (int64_t)(intptr_t)(__k->saved[3]);
           __t252 = (int64_t)(intptr_t)(__k->saved[4]);
           __t253 = (int64_t)(intptr_t)(__k->saved[5]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box254;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp254 = global_panic_payload; global_panic_payload = 0; __box254 = tur_box_err((int64_t)(intptr_t)__pp254); }
           else { __box254 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           r_1475 = __box254;
           int64_t __t256;
           bool __ps_257 = (err_qu(r_1475));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_257) {
               int64_t __t258;
               bool __ps_259 = (some___spec__bool_tur_adt_Option__int(acc));
               if (tur_panicking) return ((int64_t)0);
               if (__ps_259) {
                   __t258 = INT64_C(111);
               } else {
           ...
           tur_result_box_free((int64_t)(intptr_t)r_1475);
          ...
          case 4: {
           ...
           __t252 = (int64_t)(intptr_t)(__k->saved[4]);
           __t253 = (int64_t)(intptr_t)(__k->saved[5]);
           __t253 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t253)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_261 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_262 = (f(__ps_261, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_262));
        tur_adt_Option__int __ps_263 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_264 = (f(__ps_263, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_264));
        int64_t __t265;
        __t265 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_269 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_269;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_270 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_270;
}
