...
struct __env_1286 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
...
static int64_t __fn_1284(void * __env_p_1287) {
        ...
        __auto_type __ps_42 = (f(__env___env_1286->acc, INT64_C(4)));
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n160->saved[2] = (int64_t)(intptr_t)(r_1289);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n166->saved[2] = (int64_t)(intptr_t)(r_1289);
          ...
          case 3: {
           ...
           r_1289 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           r_1289 = __box160;
           int64_t __t162;
           __auto_type __ps_163 = (err_qu(r_1289));
           if (tur_panicking) return (int64_t){0};
           if (__ps_163) {
               int64_t __t164;
