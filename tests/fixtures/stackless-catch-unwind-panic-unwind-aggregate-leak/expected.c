...
static int64_t __fn_1282(void * __env_p_1285) {
        ...
        __auto_type __ps_42 = (f(__env___env_1284->acc, INT64_C(4)));
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n160->saved[2] = (int64_t)(intptr_t)(r_1287);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n166->saved[2] = (int64_t)(intptr_t)(r_1287);
          ...
          case 3: {
           ...
           r_1287 = __box160;
           int64_t __t162;
           __auto_type __ps_163 = (err_qu(r_1287));
           if (tur_panicking) return (int64_t){0};
           if (__ps_163) {
               int64_t __t164;
