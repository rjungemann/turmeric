...
struct __env_1274 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
static int64_t __fn_1272(void * __env_p_1275) {
        struct __env_1274 *__env___env_1274 = (struct __env_1274 *)__env_p_1275;
        __auto_type __ps_43 = (f(__env___env_1274->acc, INT64_C(4)));
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n186->saved[2] = (int64_t)(intptr_t)(r_1277);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n192->saved[2] = (int64_t)(intptr_t)(r_1277);
          ...
          case 3: {
           ...
           r_1277 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           r_1277 = __box186;
           int64_t __t188;
           __auto_type __ps_189 = (err_qu(r_1277));
           if (tur_panicking) return (int64_t){0};
           if (__ps_189) {
               int64_t __t190;
