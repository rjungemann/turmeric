...
struct __env_1468 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
...
static int64_t __fn_1466(void * __env_p_1469) {
        ...
        int64_t __ps_92 = (f(__env___env_1468->acc, INT64_C(4)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_92;
}
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_163) {
            ...
            int64_t __t164;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_168 = (_un_uncons_hyfmap(__ps_167, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                ...
                int64_t out_1135 = (int64_t)(intptr_t)(__ps_169);
                (void)out_1135;
                __t164 = out_1135;
            }
            __t162 = __t164;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_171) {
            ...
            int64_t __t172;
            {
                ...
                int64_t out_1142 = (int64_t)(intptr_t)(__ps_176);
                (void)out_1142;
                __t172 = out_1142;
            }
            __t170 = __t172;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        __tur_tailcall:;
        bool __ps_181 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((bool)0);
        if (__ps_181) {
            {
                int64_t __ps_182 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                int64_t h_1213 = __ps_182;
                (void)h_1213;
                void * __ps_183 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1214 = __ps_183;
                (void)k_1214;
                bool __ps_184 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1213, (void *)(intptr_t)(k_1214), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_184) {
                    void * __t185 = iter;
                    void * __t186 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t188;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1217 = __ps_190;
            (void)iter_1217;
            void * __ps_191 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_192 = (hamt_slkeyeq((void *)(intptr_t)(__ps_191)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1218 = __ps_192;
            (void)keyeq_1218;
            void * __ps_193 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_194 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1217), (void *)(intptr_t)(__ps_193), (void *)(intptr_t)(keyeq_1218)));
            if (tur_panicking) return ((bool)0);
            bool result_1219 = __ps_194;
            (void)result_1219;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t215;
        {
            ...
            {
                tur_adt_Vec__int * __ps_217 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1349));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1350 = __ps_217;
                (void)_un_unv_1350;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t221;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1400 = __ps_222;
            (void)r_1400;
            int64_t __t223;
            bool __ps_224 = (schema_hydecode_hyok_qu(r_1400));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_224) {
                int64_t __ps_225 = (schema_hydecode_hyvalue(r_1400));
                if (tur_panicking) return ((int64_t)0);
                __t223 = __ps_225;
            } else {
                int64_t __ps_226 = (schema_hydecode_hyerrors(r_1400));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n242->tag = 3; __n242->boundary = __b242; __n242->next = __k;
            __n242->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n242->saved[0] = (int64_t)(intptr_t)__ab; }
            __n242->saved[1] = (int64_t)(intptr_t)(n);
            __n242->saved[2] = (int64_t)(intptr_t)(r_1471);
            __n242->saved[3] = (int64_t)(intptr_t)(__t239);
            __n242->saved[4] = (int64_t)(intptr_t)(__t240);
            __n242->saved[5] = (int64_t)(intptr_t)(__t241);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             tur_cont *__n248 = (tur_cont*)malloc(sizeof(tur_cont));
             __n248->tag = 4; __n248->boundary = 0; __n248->next = __k;
             __n248->aggr_mask = 0x1u;
             { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n248->saved[0] = (int64_t)(intptr_t)__ab; }
             __n248->saved[1] = (int64_t)(intptr_t)(n);
             __n248->saved[2] = (int64_t)(intptr_t)(r_1471);
             __n248->saved[3] = (int64_t)(intptr_t)(__t239);
             __n248->saved[4] = (int64_t)(intptr_t)(__t240);
             __n248->saved[5] = (int64_t)(intptr_t)(__t241);
             tur_adt_Option__int __ra248_0 = (acc);
             int64_t __ra248_1 = ((n) - (INT64_C(1)));
             acc = __ra248_0;
             n = __ra248_1;
             __k = __n248; __pc = 1; break;
            }
           }
          }
          case 2: {
           tur_adt_Option__int __ra243_0 = (acc);
           int64_t __ra243_1 = (INT64_C(4));
           acc = __ra243_0;
           n = __ra243_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           r_1471 = (int64_t)(intptr_t)(__k->saved[2]);
           __t239 = (int64_t)(intptr_t)(__k->saved[3]);
           __t240 = (int64_t)(intptr_t)(__k->saved[4]);
           __t241 = (int64_t)(intptr_t)(__k->saved[5]);
           ...
           r_1471 = __box242;
           int64_t __t244;
           bool __ps_245 = (err_qu(r_1471));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_245) {
               int64_t __t246;
               bool __ps_247 = (some___spec__bool_tur_adt_Option__int(acc));
               if (tur_panicking) return ((int64_t)0);
               if (__ps_247) {
                   __t246 = INT64_C(111);
               } else {
          ...
          case 4: {
           ...
           __t240 = (int64_t)(intptr_t)(__k->saved[4]);
           __t241 = (int64_t)(intptr_t)(__k->saved[5]);
           __t241 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t241)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_249 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_250 = (f(__ps_249, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_250));
        tur_adt_Option__int __ps_251 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_252 = (f(__ps_251, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_252));
        int64_t __t253;
        __t253 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_257 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_257;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_258 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_258;
}
