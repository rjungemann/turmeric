...
struct __env_1269 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
static int64_t __fn_1267(void * __env_p_1270) {
        struct __env_1269 *__env___env_1269 = (struct __env_1269 *)__env_p_1270;
        __auto_type __ps_43 = (f(__env___env_1269->acc, INT64_C(4)));
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n186->saved[2] = (int64_t)(intptr_t)(r_1272);
            __n186->saved[3] = (int64_t)(intptr_t)(__t183);
            __n186->saved[4] = (int64_t)(intptr_t)(__t184);
            __n186->saved[5] = (int64_t)(intptr_t)(__t185);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n192->tag = 4; __n192->boundary = 0; __n192->next = __k;
             __n192->aggr_mask = 0x1u;
             { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n192->saved[0] = (int64_t)(intptr_t)__ab; }
             __n192->saved[1] = (int64_t)(intptr_t)(n);
             __n192->saved[2] = (int64_t)(intptr_t)(r_1272);
             __n192->saved[3] = (int64_t)(intptr_t)(__t183);
             __n192->saved[4] = (int64_t)(intptr_t)(__t184);
             __n192->saved[5] = (int64_t)(intptr_t)(__t185);
             __auto_type __ra192_0 = (acc);
             __auto_type __ra192_1 = ((n) - (INT64_C(1)));
             acc = __ra192_0;
             n = __ra192_1;
             __k = __n192; __pc = 1; break;
            }
           }
          }
          case 2: {
           __auto_type __ra187_0 = (acc);
           __auto_type __ra187_1 = (INT64_C(4));
           acc = __ra187_0;
           n = __ra187_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           r_1272 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           r_1272 = __box186;
           int64_t __t188;
           __auto_type __ps_189 = (err_qu(r_1272));
           if (tur_panicking) return (int64_t){0};
           if (__ps_189) {
               int64_t __t190;
               __auto_type __ps_191 = (some___spec__bool_tur_adt_Option__int(acc));
               if (tur_panicking) return (int64_t){0};
               if (__ps_191) {
                   __t190 = INT64_C(111);
               } else {
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_193 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_194 = (f(__ps_193, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_194));
        __auto_type __ps_195 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_196 = (f(__ps_195, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_196));
        int64_t __t197;
        __t197 = INT64_C(0);
