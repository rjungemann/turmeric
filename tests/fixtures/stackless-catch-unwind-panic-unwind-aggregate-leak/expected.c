...
static int64_t __fn_1439(void * __env_p_1442) {
        ...
        int64_t __ps_40 = (f(__env___env_1441->acc, INT64_C(4)));
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                int64_t out_1110 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1110;
                __t112 = out_1110;
            }
            __t110 = __t112;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_119) {
            ...
            int64_t __t120;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_123 = (list_hyconcat(__ps_122, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_124 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_121, __ps_123));
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_124), sizeof(__ps_124));
                int64_t out_1117 = (int64_t)(intptr_t)(__ps_124);
                (void)out_1117;
                __t120 = out_1117;
            }
            __t118 = __t120;
        ...
        if (__ps_129) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1188 = __ps_130;
                (void)h_1188;
                void * __ps_131 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1189 = __ps_131;
                (void)k_1189;
                bool __ps_132 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1188, (void *)(intptr_t)(k_1189), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_132) {
                    void * __t133 = iter;
                    void * __t134 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t136;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_138;
            (void)iter_1192;
            void * __ps_139 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_140 = (hamt_slkeyeq((void *)(intptr_t)(__ps_139)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_140;
            (void)keyeq_1193;
            void * __ps_141 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_142 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_141), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_142;
            (void)result_1194;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t163;
        {
            ...
            {
                tur_adt_Vec__int * __ps_165 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1322));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1323 = __ps_165;
                (void)_un_unv_1323;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t169;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1373 = __ps_170;
            (void)r_1373;
            int64_t __t171;
            bool __ps_172 = (schema_hydecode_hyok_qu(r_1373));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_172) {
                int64_t __ps_173 = (schema_hydecode_hyvalue(r_1373));
                if (tur_panicking) return ((int64_t)0);
                __t171 = __ps_173;
            } else {
                int64_t __ps_174 = (schema_hydecode_hyerrors(r_1373));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n190->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n190->saved[0] = (int64_t)(intptr_t)__ab; }
            __n190->saved[1] = (int64_t)(intptr_t)(n);
            __n190->saved[2] = (int64_t)(intptr_t)(r_1444);
            __n190->saved[3] = (int64_t)(intptr_t)(__t187);
            __n190->saved[4] = (int64_t)(intptr_t)(__t188);
            __n190->saved[5] = (int64_t)(intptr_t)(__t189);
            ...
            if ((n) == (INT64_C(0))) {
             ...
             __n196->tag = 4; __n196->boundary = 0; __n196->next = __k;
             __n196->aggr_mask = 0x1u;
             { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n196->saved[0] = (int64_t)(intptr_t)__ab; }
             __n196->saved[1] = (int64_t)(intptr_t)(n);
             __n196->saved[2] = (int64_t)(intptr_t)(r_1444);
             __n196->saved[3] = (int64_t)(intptr_t)(__t187);
             __n196->saved[4] = (int64_t)(intptr_t)(__t188);
             __n196->saved[5] = (int64_t)(intptr_t)(__t189);
             tur_adt_Option__int __ra196_0 = (acc);
             int64_t __ra196_1 = ((n) - (INT64_C(1)));
             acc = __ra196_0;
             n = __ra196_1;
             __k = __n196; __pc = 1; break;
            }
           }
          }
          case 2: {
           tur_adt_Option__int __ra191_0 = (acc);
           int64_t __ra191_1 = (INT64_C(4));
           acc = __ra191_0;
           n = __ra191_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           __t188 = (int64_t)(intptr_t)(__k->saved[4]);
           __t189 = (int64_t)(intptr_t)(__k->saved[5]);
           ...
           r_1444 = __box190;
           int64_t __t192;
           bool __ps_193 = (err_qu(r_1444));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_193) {
               int64_t __t194;
               bool __ps_195 = (some___spec__bool_tur_adt_Option__int(acc));
               if (tur_panicking) return ((int64_t)0);
               if (__ps_195) {
                   __t194 = INT64_C(111);
               } else {
          ...
          case 4: {
           ...
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t189)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_197 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_198 = (f(__ps_197, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_198));
        tur_adt_Option__int __ps_199 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_200 = (f(__ps_199, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_200));
        int64_t __t201;
        __t201 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_205 = (ctor_Option_Some__int(x));
