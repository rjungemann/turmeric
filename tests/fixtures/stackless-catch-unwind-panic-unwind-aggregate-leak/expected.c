...
struct __env_1441 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; };
...
static int64_t __fn_1439(void * __env_p_1442) {
        ...
        int64_t __ps_42 = (f(__env___env_1441->acc, INT64_C(4)));
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                int64_t __ps_115 = (list_hyhead(cell));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_116 = ((*( tur_thunk_int64_t_int64_t_t *)(f))(f, __ps_115));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_117 = (list_hytail(cell));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_118 = (_un_uncons_hyfmap(__ps_117, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                ...
                int64_t out_1110 = (int64_t)(intptr_t)(__t120);
                (void)out_1110;
                __t114 = out_1110;
            }
            __t112 = __t114;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_122) {
            ...
            int64_t __t123;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_126 = (list_hyconcat(__ps_125, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_127 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_124, __ps_126));
                if (tur_panicking) return ((int64_t)0);
                __auto_type __t128 = (__ps_127);
                TUR_REGION_NOTE_WORDS(&(__t128), sizeof(__t128));
                int64_t out_1117 = (int64_t)(intptr_t)(__t128);
                (void)out_1117;
                __t123 = out_1117;
            }
            __t121 = __t123;
        ...
        if (__ps_133) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1188 = __ps_134;
                (void)h_1188;
                void * __ps_135 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1189 = __ps_135;
                (void)k_1189;
                bool __ps_136 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1188, (void *)(intptr_t)(k_1189), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_136) {
                    void * __t137 = iter;
                    void * __t138 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t140;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_142;
            (void)iter_1192;
            void * __ps_143 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_144 = (hamt_slkeyeq((void *)(intptr_t)(__ps_143)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_144;
            (void)keyeq_1193;
            void * __ps_145 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_146 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_145), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_146;
            (void)result_1194;
        ...
        if ((i) == (cap)) {
            ...
            if (__ps_154) {
                ...
                if (__ps_158) {
                    ...
                    if (tur_panicking) return ((bool)0);
                    bool __ps_164 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_160, __ps_163));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_164) {
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t167;
        {
            ...
            {
                tur_adt_Vec__int * __ps_169 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1322));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1323 = __ps_169;
                (void)_un_unv_1323;
        ...
        int64_t __ps_171 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t167))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_171;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_172 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_172);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t173;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1373 = __ps_174;
            (void)r_1373;
            int64_t __t175;
            bool __ps_176 = (schema_hydecode_hyok_qu(r_1373));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_176) {
                int64_t __ps_177 = (schema_hydecode_hyvalue(r_1373));
                if (tur_panicking) return ((int64_t)0);
                __t175 = __ps_177;
            } else {
                int64_t __ps_178 = (schema_hydecode_hyerrors(r_1373));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_179 = (schema_hydecode_hyabort(__ps_178));
                if (tur_panicking) return ((int64_t)0);
                __t175 = __ps_179;
            }
            __t173 = __t175;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(5))) {
            ...
            __n194->tag = 3; __n194->boundary = __b194; __n194->next = __k;
            __n194->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n194->saved[0] = (int64_t)(intptr_t)__ab; }
            __n194->saved[1] = (int64_t)(intptr_t)(n);
            __n194->saved[2] = (int64_t)(intptr_t)(r_1444);
            __n194->saved[3] = (int64_t)(intptr_t)(__t191);
            __n194->saved[4] = (int64_t)(intptr_t)(__t192);
            __n194->saved[5] = (int64_t)(intptr_t)(__t193);
            __k = __n194; __pc = 2; break;
           } else {
            if ((n) == (INT64_C(0))) {
             ...
             __n200->tag = 4; __n200->boundary = 0; __n200->next = __k;
             __n200->aggr_mask = 0x1u;
             { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n200->saved[0] = (int64_t)(intptr_t)__ab; }
             __n200->saved[1] = (int64_t)(intptr_t)(n);
             __n200->saved[2] = (int64_t)(intptr_t)(r_1444);
             __n200->saved[3] = (int64_t)(intptr_t)(__t191);
             __n200->saved[4] = (int64_t)(intptr_t)(__t192);
             __n200->saved[5] = (int64_t)(intptr_t)(__t193);
             tur_adt_Option__int __ra200_0 = (acc);
             int64_t __ra200_1 = ((n) - (INT64_C(1)));
             acc = __ra200_0;
             n = __ra200_1;
             __k = __n200; __pc = 1; break;
            }
           }
          }
          case 2: {
           tur_adt_Option__int __ra195_0 = (acc);
           int64_t __ra195_1 = (INT64_C(4));
           acc = __ra195_0;
           n = __ra195_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           r_1444 = (int64_t)(intptr_t)(__k->saved[2]);
           __t191 = (int64_t)(intptr_t)(__k->saved[3]);
           __t192 = (int64_t)(intptr_t)(__k->saved[4]);
           __t193 = (int64_t)(intptr_t)(__k->saved[5]);
           ...
           r_1444 = __box194;
           int64_t __t196;
           bool __ps_197 = (err_qu(r_1444));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_197) {
               int64_t __t198;
               bool __ps_199 = (some___spec__bool_tur_adt_Option__int(acc));
               if (tur_panicking) return ((int64_t)0);
               if (__ps_199) {
                   __t198 = INT64_C(111);
               } else {
           ...
           tur_result_box_free((int64_t)(intptr_t)r_1444);
           __v = (int64_t)(intptr_t)(__t196); __pc = __k->tag; break;
          }
          case 4: {
           { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           n = (int64_t)(intptr_t)(__k->saved[1]);
           ...
           __t192 = (int64_t)(intptr_t)(__k->saved[4]);
           __t193 = (int64_t)(intptr_t)(__k->saved[5]);
           __t193 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t193)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_201 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_202 = (f(__ps_201, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_202));
        tur_adt_Option__int __ps_203 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_204 = (f(__ps_203, INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_204));
        int64_t __t205;
        __t205 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_209 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_209;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_210 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_210;
}
