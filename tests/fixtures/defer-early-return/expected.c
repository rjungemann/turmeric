...
int main() {
        ...
        {
            int64_t r1_622 = test_return_no_defer();
            (void)r1_622;
            printf("%lld\n", (long long)(r1_622));
        }
        puts("test-return-with-defer:");
        {
            int64_t r2_623 = test_return_with_defer();
            (void)r2_623;
            printf("%lld\n", (long long)(r2_623));
        }
        puts("test-return-in-nested-scope:");
        {
            int64_t r3_624 = test_return_in_nested_scope();
            (void)r3_624;
            printf("%lld\n", (long long)(r3_624));
        }
        puts("test-return-in-if:");
        {
            int64_t r4_625 = test_return_in_if();
            (void)r4_625;
            printf("%lld\n", (long long)(r4_625));
        }
        int64_t __t14;
