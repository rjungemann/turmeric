...
int main() {
        ...
        {
            int64_t r1_11 = test_return_no_defer();
            (void)r1_11;
            printf("%lld\n", (long long)(r1_11));
        }
        puts("test-return-with-defer:");
        {
            int64_t r2_12 = test_return_with_defer();
            (void)r2_12;
            printf("%lld\n", (long long)(r2_12));
        }
        puts("test-return-in-nested-scope:");
        {
            int64_t r3_13 = test_return_in_nested_scope();
            (void)r3_13;
            printf("%lld\n", (long long)(r3_13));
        }
        puts("test-return-in-if:");
        {
            int64_t r4_14 = test_return_in_if();
            (void)r4_14;
            printf("%lld\n", (long long)(r4_14));
        }
        int64_t __t10;
