...
static int64_t test_return_with_defer() {
        ...
        tur_frame_fire_chain(&__frame_0);
        return INT64_C(42);
...
int main() {
        ...
        {
            int64_t r1_202 = test_return_no_defer();
            (void)r1_202;
            printf("%lld\n", (long long)(r1_202));
        }
        puts("test-return-with-defer:");
        {
            int64_t r2_203 = test_return_with_defer();
            (void)r2_203;
            printf("%lld\n", (long long)(r2_203));
        }
        puts("test-return-in-nested-scope:");
        {
            int64_t r3_204 = test_return_in_nested_scope();
            (void)r3_204;
            printf("%lld\n", (long long)(r3_204));
        }
        puts("test-return-in-if:");
        {
            int64_t r4_205 = test_return_in_if();
            (void)r4_205;
            printf("%lld\n", (long long)(r4_205));
        }
        int64_t __t13;
