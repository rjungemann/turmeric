...
int main() {
        ...
        {
            int64_t r1_214 = test_return_no_defer();
            (void)r1_214;
            printf("%lld\n", (long long)(r1_214));
        }
        puts("test-return-with-defer:");
        {
            int64_t r2_215 = test_return_with_defer();
            (void)r2_215;
            printf("%lld\n", (long long)(r2_215));
        }
        puts("test-return-in-nested-scope:");
        {
            int64_t r3_216 = test_return_in_nested_scope();
            (void)r3_216;
            printf("%lld\n", (long long)(r3_216));
        }
        puts("test-return-in-if:");
        {
            int64_t r4_217 = test_return_in_if();
            (void)r4_217;
            printf("%lld\n", (long long)(r4_217));
        }
        int64_t __t13;
