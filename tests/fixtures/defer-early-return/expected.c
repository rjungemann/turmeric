...
int main() {
        ...
        {
            int64_t r1_267 = test_return_no_defer();
            (void)r1_267;
            printf("%lld\n", (long long)(r1_267));
        }
        puts("test-return-with-defer:");
        {
            int64_t r2_268 = test_return_with_defer();
            (void)r2_268;
            printf("%lld\n", (long long)(r2_268));
        }
        puts("test-return-in-nested-scope:");
        {
            int64_t r3_269 = test_return_in_nested_scope();
            (void)r3_269;
            printf("%lld\n", (long long)(r3_269));
        }
        puts("test-return-in-if:");
        {
            int64_t r4_270 = test_return_in_if();
            (void)r4_270;
            printf("%lld\n", (long long)(r4_270));
        }
        int64_t __t14;
