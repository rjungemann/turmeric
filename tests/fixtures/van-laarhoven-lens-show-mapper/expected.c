...
static int64_t show_hylens_un_undict_un1320(int64_t, int64_t, int64_t, int64_t);
static int64_t __poly_1329(void *, int64_t, int64_t, int64_t, int64_t);
static int64_t show_hylens_un_undict_un1341(int64_t, int64_t, int64_t, int64_t);
static int64_t __poly_1343(void *, int64_t, int64_t, int64_t, int64_t);
static int64_t show_hylens_un_undict_un1355(int64_t, int64_t, int64_t, int64_t);
...
static const char * __fn_1297(void * __env_p_1326, int64_t x) {
        struct __env_1328 *__env___env_1328 = (struct __env_1328 *)__env_p_1326;
        __auto_type __ps_45 = (((const char * (*)(int64_t))((void **)(intptr_t)__env___env_1328->__dict_1323)[0])(x));
...
static int64_t show_hylens_un_undict_un1320(int64_t __dict_1321, int64_t __dict_1323, int64_t g, int64_t s) {
...
static int64_t __poly_1329(void * __poly_env_1330, int64_t __poly_x0_1332, int64_t __poly_x1_1334, int64_t __poly_x2_1336, int64_t __poly_x3_1338) {
        __auto_type __ps_54 = (show_hylens_un_undict_un1320(__poly_x0_1332, __poly_x1_1334, __poly_x2_1336, __poly_x3_1338));
        if (tur_panicking) return (int64_t){0};
        return __ps_54;
}

static int64_t show_hylens_un_undict_un1341(int64_t __dict_1321, int64_t __dict_1323, int64_t g, int64_t s) {
        ...
        __t56->__fn = (int64_t)(intptr_t)__fn_1297;
...
static int64_t __poly_1343(void * __poly_env_1344, int64_t __poly_x0_1346, int64_t __poly_x1_1348, int64_t __poly_x2_1350, int64_t __poly_x3_1352) {
        __auto_type __ps_60 = (show_hylens_un_undict_un1341(__poly_x0_1346, __poly_x1_1348, __poly_x2_1350, __poly_x3_1352));
        if (tur_panicking) return (int64_t){0};
        return __ps_60;
}

static int64_t show_hylens_un_undict_un1355(int64_t __dict_1321, int64_t __dict_1323, int64_t g, int64_t s) {
        ...
        __t62->__fn = (int64_t)(intptr_t)__fn_1297;
...
static int64_t __poly_1357(void * __poly_env_1358, int64_t __poly_x0_1360, int64_t __poly_x1_1362, int64_t __poly_x2_1364, int64_t __poly_x3_1366) {
        __auto_type __ps_66 = (show_hylens_un_undict_un1355(__poly_x0_1360, __poly_x1_1362, __poly_x2_1364, __poly_x3_1366));
        if (tur_panicking) return (int64_t){0};
        return __ps_66;
}
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_129) {
            bool __t130;
            {
                ...
                bool __t131;
                if ((t1_989) == (INT64_C(0))) {
                    __t131 = (t2_990) == (INT64_C(0));
                } else {
                    bool __t132;
                    if ((t2_990) == (INT64_C(0))) {
                        __t132 = false;
                    } else {
                        __auto_type __ps_133 = (cons_hyeq_hygo(t1_989, t2_990));
                        if (tur_panicking) return (bool){0};
                        __t132 = __ps_133;
                    }
                    __t131 = __t132;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_135) {
            ...
            int64_t __t136;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_998 = (int64_t)(intptr_t)(__ps_141);
                (void)out_998;
                __t136 = out_998;
            }
            __t134 = __t136;
        ...
        if (__ps_153) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1076 = __ps_154;
                (void)h_1076;
                __auto_type __ps_155 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1077 = __ps_155;
                (void)k_1077;
                __auto_type __ps_156 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1076, (void *)(intptr_t)(k_1077), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_156) {
                    void * __t157 = iter;
                    void * __t158 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t160;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1080 = __ps_162;
            (void)iter_1080;
            __auto_type __ps_163 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_164 = (hamt_slkeyeq((void *)(intptr_t)(__ps_163)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1081 = __ps_164;
            (void)keyeq_1081;
            __auto_type __ps_165 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_166 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1080), (void *)(intptr_t)(__ps_165), (void *)(intptr_t)(keyeq_1081)));
            if (tur_panicking) return (bool){0};
            bool result_1082 = __ps_166;
            (void)result_1082;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t187;
        {
            ...
            {
                __auto_type __ps_189 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1209));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1210 = __ps_189;
                (void)_un_unv_1210;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t192;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1259 = __ps_193;
            (void)r_1259;
            int64_t __t194;
            __auto_type __ps_195 = (schema_hydecode_hyok_qu(r_1259));
            if (tur_panicking) return (int64_t){0};
            if (__ps_195) {
                __auto_type __ps_196 = (schema_hydecode_hyvalue(r_1259));
                if (tur_panicking) return (int64_t){0};
                __t194 = __ps_196;
            } else {
                __auto_type __ps_197 = (schema_hydecode_hyerrors(r_1259));
                if (tur_panicking) return (int64_t){0};
...
static const char * shown_hyint(tur_poly_fn_t l, int64_t s) {
        ...
        __t200[1] = (int64_t)(intptr_t)__fn_1308;
        void *__t201 = __t200;
...
static const char * shown_hybool(tur_poly_fn_t l, bool s) {
        ...
        __t204[1] = (int64_t)(intptr_t)__fn_1313;
        void *__t205 = __t204;
...
static int64_t peek_hyint(tur_poly_fn_t l, int64_t s) {
        ...
        __t208[1] = (int64_t)(intptr_t)__fn_1318;
        void *__t209 = __t208;
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_212 = (shown_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1329 }, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_212);
        __auto_type __ps_213 = (shown_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1343 }, true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_213);
        __auto_type __ps_214 = (peek_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1357 }, INT64_C(42)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_214));
        int64_t __t215;
        __t215 = INT64_C(0);
