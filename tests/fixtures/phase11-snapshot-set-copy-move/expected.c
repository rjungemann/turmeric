...
int main() {
        {
            int64_t x_616 = INT64_C(10);
            (void)x_616;
            {
                int64_t y_617 = INT64_C(0);
                (void)y_617;
                y_617 = x_616;
                printf("%lld\n", (long long)(y_617));
            }
        }
        {
            ...
            *((int64_t *)__t0) = INT64_C(1);
            void * a_618 = __t0;
            (void)a_618;
            void * __t1 = malloc(sizeof(int64_t));
            *((int64_t *)__t1) = INT64_C(2);
            void * b_619 = __t1;
            (void)b_619;
            tur_frame __frame_2;
            tur_frame_init(&__frame_2, NULL);
            a_618 = b_619;
            int64_t __t3 = *((int64_t *)a_618);
            printf("%lld\n", (long long)(__t3));
            struct __defer_env_4 __t6 = {.a = a_618};
