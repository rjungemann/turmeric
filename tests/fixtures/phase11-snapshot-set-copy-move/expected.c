...
int main() {
        ...
        }
        {
            ...
            *((int64_t *)__t1) = INT64_C(2);
            ...
            a_3 = b_4;
            int64_t __t3 = *((int64_t *)a_3);
            printf("%lld\n", (long long)(__t3));
            struct __defer_env_4 __t6 = {.a = a_3};
            tur_frame_push_defer(&__frame_2, __defer_5, &__t6);
            struct __defer_env_7 __t9 = {.b = b_4};
            tur_frame_push_defer(&__frame_2, __defer_8, &__t9);
