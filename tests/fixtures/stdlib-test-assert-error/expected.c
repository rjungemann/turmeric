...
static bool assert_error(void *);
static int64_t throws();
static int64_t ok();
...
static bool assert_error(void * thunk) {
        bool __t0;
        ...
        if (setjmp(__t1.jmp_buf) == 0) {
            ...
            if (tur_exception_matches(__t1.caught, 1)) {
                void * e_200 = (void *)__t1.caught->payload;
                __t2 = INT64_C(1);
    ...
    if (((__t2) == (INT64_C(1)))) {
        ...
        puts("Assertion failed: expected error");
        bool __t4;
        __t4 = false;
        __t0 = __t4;
    }
...
static int64_t throws() {
    int64_t *__t5 = (int64_t *)malloc(sizeof(int64_t));
    *__t5 = INT64_C(7);
    tur_throw(3, (void*)__t5, 15, "<unknown>");
}
...
int main() {
    puts((assert_error((void *)(intptr_t)(throws))) ? "true" : "false");
    puts((assert_error((void *)(intptr_t)(ok))) ? "true" : "false");
    int64_t __t6;
    __t6 = INT64_C(0);
    return (int)__t6;
}
