...
static int64_t __fn_283(int64_t x) {
        return times2(inc(x));
}
...
int main() {
        {
            int64_t opt_279 = __opt_some(INT64_C(42));
            (void)opt_279;
            {
                int64_t result_280 = __fmap_option(opt_279, (int64_t)(intptr_t)(id));
                (void)result_280;
                puts((__opt_some_(result_280)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_280)));
            }
        }
        {
            int64_t opt_281 = __opt_some(INT64_C(5));
            (void)opt_281;
            {
                int64_t lhs_285 = __fmap_option(opt_281, (int64_t)(intptr_t)(__fn_283));
                (void)lhs_285;
                {
                    int64_t rhs_286 = __fmap_option(__fmap_option(opt_281, (int64_t)(intptr_t)(inc)), (int64_t)(intptr_t)(times2));
                    (void)rhs_286;
                    printf("%lld\n", (long long)(__opt_unwrap(lhs_285)));
                    printf("%lld\n", (long long)(__opt_unwrap(rhs_286)));
                    puts((((__opt_unwrap(lhs_285)) == (__opt_unwrap(rhs_286)))) ? "true" : "false");
                }
            }
        }
        int64_t __t0;
