...
static int64_t id(int64_t);
static int64_t times2(int64_t);
...
static int64_t __fn_230(int64_t x) {
        return times2(inc(x));
}
...
int main() {
        {
            int64_t opt_226 = __opt_some(INT64_C(42));
            (void)opt_226;
            {
                int64_t result_227 = __fmap_option(opt_226, (int64_t)(intptr_t)(id));
                (void)result_227;
                puts((__opt_some_(result_227)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_227)));
            }
        }
        {
            int64_t opt_228 = __opt_some(INT64_C(5));
            (void)opt_228;
            {
                int64_t lhs_232 = __fmap_option(opt_228, (int64_t)(intptr_t)(__fn_230));
                (void)lhs_232;
                {
                    int64_t rhs_233 = __fmap_option(__fmap_option(opt_228, (int64_t)(intptr_t)(inc)), (int64_t)(intptr_t)(times2));
                    (void)rhs_233;
                    printf("%lld\n", (long long)(__opt_unwrap(lhs_232)));
                    printf("%lld\n", (long long)(__opt_unwrap(rhs_233)));
                    puts((((__opt_unwrap(lhs_232)) == (__opt_unwrap(rhs_233)))) ? "true" : "false");
                }
            }
        }
        int64_t __t0;
