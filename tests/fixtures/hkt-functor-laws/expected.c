...
static int64_t __fn_218(int64_t x) {
        return times2(inc(x));
}
...
int main() {
        {
            int64_t opt_214 = __opt_some(INT64_C(42));
            (void)opt_214;
            {
                int64_t result_215 = __fmap_option(opt_214, (int64_t)(intptr_t)(id));
                (void)result_215;
                puts((__opt_some_(result_215)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_215)));
            }
        }
        {
            int64_t opt_216 = __opt_some(INT64_C(5));
            (void)opt_216;
            {
                int64_t lhs_220 = __fmap_option(opt_216, (int64_t)(intptr_t)(__fn_218));
                (void)lhs_220;
                {
                    int64_t rhs_221 = __fmap_option(__fmap_option(opt_216, (int64_t)(intptr_t)(inc)), (int64_t)(intptr_t)(times2));
                    (void)rhs_221;
                    printf("%lld\n", (long long)(__opt_unwrap(lhs_220)));
                    printf("%lld\n", (long long)(__opt_unwrap(rhs_221)));
                    puts((((__opt_unwrap(lhs_220)) == (__opt_unwrap(rhs_221)))) ? "true" : "false");
                }
            }
        }
        int64_t __t0;
