...
static int64_t __fn_638(int64_t x) {
        return times2(inc(x));
}
...
int main() {
        {
            int64_t opt_634 = __opt_some(INT64_C(42));
            (void)opt_634;
            {
                int64_t result_635 = __fmap_option(opt_634, (int64_t)(intptr_t)(id));
                (void)result_635;
                puts((__opt_some_(result_635)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_635)));
            }
        }
        {
            int64_t opt_636 = __opt_some(INT64_C(5));
            (void)opt_636;
            {
                int64_t lhs_640 = __fmap_option(opt_636, (int64_t)(intptr_t)(__fn_638));
                (void)lhs_640;
                {
                    int64_t rhs_641 = __fmap_option(__fmap_option(opt_636, (int64_t)(intptr_t)(inc)), (int64_t)(intptr_t)(times2));
                    (void)rhs_641;
                    printf("%lld\n", (long long)(__opt_unwrap(lhs_640)));
                    printf("%lld\n", (long long)(__opt_unwrap(rhs_641)));
                    puts((((__opt_unwrap(lhs_640)) == (__opt_unwrap(rhs_641)))) ? "true" : "false");
                }
            }
        }
        int64_t __t0;
