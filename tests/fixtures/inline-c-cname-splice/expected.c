...
static int64_t carrier_hyeq_qu(int64_t, int64_t);
static int64_t bump_ex(int64_t);
...
static int64_t carrier_hyeq_qu(int64_t a, int64_t b) {
        int64_t __t172;
        if ((a) == (b)) {
            __t172 = INT64_C(1);
        } else {
...
static int64_t bump_ex(int64_t x) {
        return (x) + (INT64_C(1));
}
...
int main(int argc, char **argv) {
  ...
  int eq = (int)carrier_hyeq_qu(41, 41);
  int hi = (int)bump_ex(41);
  printf("%d\n", eq);
  printf("%d\n", hi);
  return 0;
