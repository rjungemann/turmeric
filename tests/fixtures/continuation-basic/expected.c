...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t156;
        {
            ...
            {
                tur_adt_Vec__int * __ps_158 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1320));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1321 = __ps_158;
                (void)_un_unv_1321;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t162;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1371 = __ps_163;
            (void)r_1371;
            int64_t __t164;
            bool __ps_165 = (schema_hydecode_hyok_qu(r_1371));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_165) {
                int64_t __ps_166 = (schema_hydecode_hyvalue(r_1371));
                if (tur_panicking) return ((int64_t)0);
                __t164 = __ps_166;
            } else {
                int64_t __ps_167 = (schema_hydecode_hyerrors(r_1371));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_179 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1435))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_179;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_180 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1438))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_180;
    return (intptr_t)(__t2);
}
