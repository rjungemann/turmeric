...
static int64_t __fn_861(int64_t);
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                ...
                (void)t2_780;
                if ((t1_779) == (INT64_C(0))) {
                    return (t2_780) == (INT64_C(0));
                } else {
                    if ((t2_780) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t12 = (*(int64_t *)(intptr_t)(t1_779));
                        int64_t __t13 = (*(int64_t *)(intptr_t)(t2_780));
                        x = __t12;
                        y = __t13;
                        goto __tur_tailcall;
                    }
...
static int64_t __fn_861(int64_t v) {
        return (v) + (INT64_C(1));
}
