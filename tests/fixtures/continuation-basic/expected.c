...
static int64_t __fn_812(int64_t);
static int64_t __fn_815(int64_t);
...
static int64_t __fn_812(int64_t v) {
        return (v) + (INT64_C(1));
}

static int64_t __fn_815(int64_t v) {
        return (v) + (INT64_C(10));
}
...
static int64_t test_shift() {
        int64_t __t3 = __fn_812(INT64_C(42));
        return __t3;
}

static int64_t test_shift_nested() {
        int64_t __t4 = __fn_815(INT64_C(5));
        return __t4;
}
