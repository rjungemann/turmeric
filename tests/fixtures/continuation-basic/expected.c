...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_67 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_743, (void *)(intptr_t)(k_744), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t69;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_748 = __ps_71;
            (void)iter_748;
            __auto_type __ps_72 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_73 = (hamt_slkeyeq((void *)(intptr_t)(__ps_72)));
            if (tur_panicking) return (bool){0};
            void * keyeq_749 = __ps_73;
            (void)keyeq_749;
            __auto_type __ps_74 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_75 = (map_hyeq_hyloop((void *)(intptr_t)(iter_748), (void *)(intptr_t)(__ps_74), (void *)(intptr_t)(keyeq_749), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_750 = __ps_75;
            (void)result_750;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_93) {
            bool __t94;
            {
                ...
                bool __t95;
                if ((t1_990) == (INT64_C(0))) {
                    __t95 = (t2_991) == (INT64_C(0));
                } else {
                    bool __t96;
                    if ((t2_991) == (INT64_C(0))) {
                        __t96 = false;
                    } else {
                        __auto_type __ps_97 = (cons_hyeq_hygo(t1_990, t2_991));
                        if (tur_panicking) return (bool){0};
                        __t96 = __ps_97;
                    }
                    __t95 = __t96;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_103) {
            ...
            int64_t __t104;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1006 = (int64_t)(intptr_t)(__ps_108);
                (void)out_1006;
                __t104 = out_1006;
            }
            __t102 = __t104;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t113;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1081 = __ps_115;
            (void)iter_1081;
            __auto_type __ps_116 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_117 = (hamt_slkeyeq((void *)(intptr_t)(__ps_116)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1082 = __ps_117;
            (void)keyeq_1082;
            __auto_type __ps_118 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_119 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1081), (void *)(intptr_t)(__ps_118), (void *)(intptr_t)(keyeq_1082)));
            if (tur_panicking) return (bool){0};
            bool result_1083 = __ps_119;
            (void)result_1083;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t140;
        {
            ...
            {
                __auto_type __ps_142 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1210));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1211 = __ps_142;
                (void)_un_unv_1211;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t145;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1260 = __ps_146;
            (void)r_1260;
            int64_t __t147;
            __auto_type __ps_148 = (schema_hydecode_hyok_qu(r_1260));
            if (tur_panicking) return (int64_t){0};
            if (__ps_148) {
                __auto_type __ps_149 = (schema_hydecode_hyvalue(r_1260));
                if (tur_panicking) return (int64_t){0};
                __t147 = __ps_149;
            } else {
                __auto_type __ps_150 = (schema_hydecode_hyerrors(r_1260));
                if (tur_panicking) return (int64_t){0};
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    __auto_type __ps_153 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1282))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_153;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    __auto_type __ps_154 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1285))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_154;
    return (intptr_t)(__t2);
}
