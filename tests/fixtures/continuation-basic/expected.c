...
static int64_t test_hyreset__cps(DK *k);
static int64_t test_hyshift__cps(DK *k);
static int64_t test_hyshift_hynested__cps(DK *k);
static int64_t hamt_slnew__cps(DK *k) {
    void * t0;
...
static int64_t test_hyreset__cps(DK *k) {
    DK *__p0 = dk_prompt(1, dk_frame(test_hyreset_k0, (intptr_t)k, dk_done()));
...
static int64_t test_hyshift__cps(DK *k) {
    DK *__p0 = dk_prompt(1, dk_frame(test_hyshift_k0, (intptr_t)k, dk_done()));
...
static int64_t test_hyshift_hynested__cps(DK *k) {
    DK *__p0 = dk_prompt(1, dk_frame(test_hyshift_hynested_k0, (intptr_t)k, dk_done()));
