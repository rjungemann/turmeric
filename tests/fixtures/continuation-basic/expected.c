...
static int64_t __fn_1468(int64_t);
...
static void __defer_258(void *__env) {
    ...
    bool __ps_271 = (bt_hyundo_hyto_ex(__e->m));
...
static int64_t __fn_1468(int64_t v) {
        return (v) + (INT64_C(1));
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_855 = __ps_156;
        bool __ps_157 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_854, (void *)(intptr_t)(k_855), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_157;
        if (__t1) {
            int64_t __ps_158 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_159 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_854, (void *)(intptr_t)(k_855), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t161;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_859 = __ps_163;
            (void)iter_859;
            void * __ps_164 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_165 = (hamt_slkeyeq((void *)(intptr_t)(__ps_164)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_860 = __ps_165;
            (void)keyeq_860;
            void * __ps_166 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_167 = (map_hyeq_hyloop((void *)(intptr_t)(iter_859), (void *)(intptr_t)(__ps_166), (void *)(intptr_t)(keyeq_860), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_861 = __ps_167;
            (void)result_861;
        ...
        if (__ps_186) {
            bool __t187;
            {
                ...
                if ((t1_1139) == (INT64_C(0))) {
                    __t188 = (t2_1140) == (INT64_C(0));
                } else {
                    bool __t189;
                    if ((t2_1140) == (INT64_C(0))) {
                        __t189 = false;
                    } else {
                        bool __ps_190 = (cons_hyeq_hygo(t1_1139, t2_1140));
                        if (tur_panicking) return ((bool)0);
                        __t189 = __ps_190;
                    }
                    __t188 = __t189;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_196) {
            ...
            int64_t __t197;
            {
                ...
                int64_t out_1155 = (int64_t)(intptr_t)(__ps_201);
                (void)out_1155;
                __t197 = out_1155;
            }
            __t195 = __t197;
        ...
        if (__ps_206) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1226 = __ps_207;
                (void)h_1226;
                void * __ps_208 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1227 = __ps_208;
                (void)k_1227;
                bool __ps_209 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1226, (void *)(intptr_t)(k_1227), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_209) {
                    void * __t210 = iter;
                    void * __t211 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t213;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1230 = __ps_215;
            (void)iter_1230;
            void * __ps_216 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_217 = (hamt_slkeyeq((void *)(intptr_t)(__ps_216)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1231 = __ps_217;
            (void)keyeq_1231;
            void * __ps_218 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_219 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1230), (void *)(intptr_t)(__ps_218), (void *)(intptr_t)(keyeq_1231)));
            if (tur_panicking) return ((bool)0);
            bool result_1232 = __ps_219;
            (void)result_1232;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t240;
        {
            ...
            {
                tur_adt_Vec__int * __ps_242 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1362));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1363 = __ps_242;
                (void)_un_unv_1363;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t246;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1413 = __ps_247;
            (void)r_1413;
            int64_t __t248;
            bool __ps_249 = (schema_hydecode_hyok_qu(r_1413));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_249) {
                int64_t __ps_250 = (schema_hydecode_hyvalue(r_1413));
                if (tur_panicking) return ((int64_t)0);
                __t248 = __ps_250;
            } else {
                int64_t __ps_251 = (schema_hydecode_hyerrors(r_1413));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t254;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1464 = __ps_255;
            (void)m_1464;
            tur_frame __frame_256;
            tur_frame_init(&__frame_256, NULL);
            struct __defer_env_257 __t259 = {.m = m_1464};
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_267 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1468))(INT64_C(42)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_267;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_268 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1471))(INT64_C(5)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_268;
    return (intptr_t)(__t2);
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_269 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_270 = (vec_new__spec__tur_adt_Vec__int__());
