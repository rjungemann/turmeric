...
static int64_t __fn_1303(int64_t);
...
static int64_t __fn_1303(int64_t v) {
        return (v) + (INT64_C(1));
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_763, (void *)(intptr_t)(k_764), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_768 = __ps_73;
            (void)iter_768;
            void * __ps_74 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_75 = (hamt_slkeyeq((void *)(intptr_t)(__ps_74)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_769 = __ps_75;
            (void)keyeq_769;
            void * __ps_76 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_768), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_769), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_770 = __ps_77;
            (void)result_770;
        ...
        if (__ps_95) {
            bool __t96;
            {
                ...
                if ((t1_1011) == (INT64_C(0))) {
                    __t97 = (t2_1012) == (INT64_C(0));
                } else {
                    bool __t98;
                    if ((t2_1012) == (INT64_C(0))) {
                        __t98 = false;
                    } else {
                        bool __ps_99 = (cons_hyeq_hygo(t1_1011, t2_1012));
                        if (tur_panicking) return ((bool)0);
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_105) {
            ...
            int64_t __t106;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1027 = (int64_t)(intptr_t)(__ps_110);
                (void)out_1027;
                __t106 = out_1027;
            }
            __t104 = __t106;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1102 = __ps_117;
            (void)iter_1102;
            void * __ps_118 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_119 = (hamt_slkeyeq((void *)(intptr_t)(__ps_118)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1103 = __ps_119;
            (void)keyeq_1103;
            void * __ps_120 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1102), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1103)));
            if (tur_panicking) return ((bool)0);
            bool result_1104 = __ps_121;
            (void)result_1104;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                tur_adt_Vec__int * __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1231));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1232 = __ps_144;
                (void)_un_unv_1232;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1281 = __ps_148;
            (void)r_1281;
            int64_t __t149;
            bool __ps_150 = (schema_hydecode_hyok_qu(r_1281));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_150) {
                int64_t __ps_151 = (schema_hydecode_hyvalue(r_1281));
                if (tur_panicking) return ((int64_t)0);
                __t149 = __ps_151;
            } else {
                int64_t __ps_152 = (schema_hydecode_hyerrors(r_1281));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_155 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1303))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_155;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_156 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1306))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_156;
    return (intptr_t)(__t2);
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_157 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_158 = (vec_new__spec__tur_adt_Vec__int__());
