...
static int64_t __fn_1466(int64_t);
...
static int64_t __fn_1466(int64_t v) {
        return (v) + (INT64_C(1));
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_843 = __ps_124;
        bool __ps_125 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_842, (void *)(intptr_t)(k_843), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_125;
        if (__t1) {
            int64_t __ps_126 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_127 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_842, (void *)(intptr_t)(k_843), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t129;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_847 = __ps_131;
            (void)iter_847;
            void * __ps_132 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_133 = (hamt_slkeyeq((void *)(intptr_t)(__ps_132)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_848 = __ps_133;
            (void)keyeq_848;
            void * __ps_134 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_135 = (map_hyeq_hyloop((void *)(intptr_t)(iter_847), (void *)(intptr_t)(__ps_134), (void *)(intptr_t)(keyeq_848), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_849 = __ps_135;
            (void)result_849;
        ...
        if (__ps_154) {
            bool __t155;
            {
                ...
                if ((t1_1127) == (INT64_C(0))) {
                    __t156 = (t2_1128) == (INT64_C(0));
                } else {
                    bool __t157;
                    if ((t2_1128) == (INT64_C(0))) {
                        __t157 = false;
                    } else {
                        bool __ps_158 = (cons_hyeq_hygo(t1_1127, t2_1128));
                        if (tur_panicking) return ((bool)0);
                        __t157 = __ps_158;
                    }
                    __t156 = __t157;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_164) {
            ...
            int64_t __t165;
            {
                ...
                int64_t out_1143 = (int64_t)(intptr_t)(__ps_169);
                (void)out_1143;
                __t165 = out_1143;
            }
            __t163 = __t165;
        ...
        if (__ps_174) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1214 = __ps_175;
                (void)h_1214;
                void * __ps_176 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1215 = __ps_176;
                (void)k_1215;
                bool __ps_177 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1214, (void *)(intptr_t)(k_1215), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_177) {
                    void * __t178 = iter;
                    void * __t179 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t181;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1218 = __ps_183;
            (void)iter_1218;
            void * __ps_184 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_185 = (hamt_slkeyeq((void *)(intptr_t)(__ps_184)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1219 = __ps_185;
            (void)keyeq_1219;
            void * __ps_186 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_187 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1218), (void *)(intptr_t)(__ps_186), (void *)(intptr_t)(keyeq_1219)));
            if (tur_panicking) return ((bool)0);
            bool result_1220 = __ps_187;
            (void)result_1220;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t208;
        {
            ...
            {
                tur_adt_Vec__int * __ps_210 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1350));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1351 = __ps_210;
                (void)_un_unv_1351;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t214;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1401 = __ps_215;
            (void)r_1401;
            int64_t __t216;
            bool __ps_217 = (schema_hydecode_hyok_qu(r_1401));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_217) {
                int64_t __ps_218 = (schema_hydecode_hyvalue(r_1401));
                if (tur_panicking) return ((int64_t)0);
                __t216 = __ps_218;
            } else {
                int64_t __ps_219 = (schema_hydecode_hyerrors(r_1401));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_232 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1466))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_232;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_233 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1469))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_233;
    return (intptr_t)(__t2);
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_234 = (ctor_Cons_Cons__int(h, t));
