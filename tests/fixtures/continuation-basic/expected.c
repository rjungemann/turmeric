...
static int64_t __fn_1609(int64_t);
...
static int64_t __fn_1609(int64_t v) {
        return (v) + (INT64_C(1));
}
...
static int64_t test_hyreset__cps(DK *__kont);
static int64_t test_hyshift__cps(DK *__kont);
static int64_t test_hyshift_hynested__cps(DK *__kont);
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_996 = __ps_164;
        bool __ps_165 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_995, (void *)(intptr_t)(k_996), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_165;
        if (__t1) {
            int64_t __ps_166 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_167 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_995, (void *)(intptr_t)(k_996), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t169;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1000 = __ps_171;
            (void)iter_1000;
            void * __ps_172 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_173 = (hamt_slkeyeq((void *)(intptr_t)(__ps_172)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1001 = __ps_173;
            (void)keyeq_1001;
            void * __ps_174 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_175 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1000), (void *)(intptr_t)(__ps_174), (void *)(intptr_t)(keyeq_1001), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1002 = __ps_175;
            (void)result_1002;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_194) {
            bool __t195;
            {
                ...
                (void)t2_1281;
                bool __t196;
                bool __ps_197 = (tnil_qu(t1_1280));
                if (tur_panicking) return ((bool)0);
                if (__ps_197) {
                    bool __ps_198 = (tnil_qu(t2_1281));
                    if (tur_panicking) return ((bool)0);
                    __t196 = __ps_198;
                } else {
                    bool __t199;
                    bool __ps_200 = (tnil_qu(t2_1281));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_200) {
                        __t199 = false;
                    } else {
                        bool __ps_201 = (cons_hyeq_hygo(t1_1280, t2_1281));
                        if (tur_panicking) return ((bool)0);
                        __t199 = __ps_201;
                    }
                    __t196 = __t199;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_207) {
            ...
            int64_t __t208;
            {
                ...
                int64_t out_1296 = (int64_t)(intptr_t)(__ps_212);
                (void)out_1296;
                __t208 = out_1296;
            }
            __t206 = __t208;
        ...
        if (__ps_216) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1367 = __ps_217;
                (void)h_1367;
                void * __ps_218 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1368 = __ps_218;
                (void)k_1368;
                bool __ps_219 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1367, (void *)(intptr_t)(k_1368), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_219) {
                    void * __t220 = iter;
                    void * __t221 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t223;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1371 = __ps_225;
            (void)iter_1371;
            void * __ps_226 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_227 = (hamt_slkeyeq((void *)(intptr_t)(__ps_226)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1372 = __ps_227;
            (void)keyeq_1372;
            void * __ps_228 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_229 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1371), (void *)(intptr_t)(__ps_228), (void *)(intptr_t)(keyeq_1372)));
            if (tur_panicking) return ((bool)0);
            bool result_1373 = __ps_229;
            (void)result_1373;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t250;
        {
            ...
            {
                tur_adt_Vec__int * __ps_252 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1503));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1504 = __ps_252;
                (void)_un_unv_1504;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t256;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1554 = __ps_257;
            (void)r_1554;
            int64_t __t258;
            bool __ps_259 = (schema_hydecode_hyok_qu(r_1554));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_259) {
                int64_t __ps_260 = (schema_hydecode_hyvalue(r_1554));
                if (tur_panicking) return ((int64_t)0);
                __t258 = __ps_260;
            } else {
                int64_t __ps_261 = (schema_hydecode_hyerrors(r_1554));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t264;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1605 = __ps_265;
            (void)m_1605;
            tur_frame __frame_266;
            tur_frame_init(&__frame_266, NULL);
            struct __defer_env_267 __t269 = {.m = m_1605};
...
static intptr_t test_hyreset_k0(intptr_t env, intptr_t __t0__slot, DK *__kont) {
    (void)env;
    int64_t __t0 = (int64_t)(__t0__slot);
    return dk_run(__kont, (intptr_t)(__t0));
}
static int64_t test_hyreset__cps(DK *__kont) {
    DK *__p0 = __dk_reap_keep(dk_prompt(1, dk_frame_resume_borrow(test_hyreset_k0, 0, __kont)));
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_277 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1609))(INT64_C(42)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_277;
    return (intptr_t)(__t2);
}
static int64_t test_hyshift__cps(DK *__kont) {
    DK *__p0 = __dk_reap_keep(dk_prompt(1, dk_frame_resume_borrow(test_hyshift_k0, 0, __kont)));
    DK *__sd1 = dk_shift(1, test_hyshift_s1, 0, __p0);
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_278 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1612))(INT64_C(5)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_278;
    return (intptr_t)(__t2);
}
static int64_t test_hyshift_hynested__cps(DK *__kont) {
    DK *__p0 = __dk_reap_keep(dk_prompt(1, dk_frame_resume_borrow(test_hyshift_hynested_k0, 0, __kont)));
    DK *__sd1 = dk_shift(1, test_hyshift_hynested_s1, 0, __p0);
    int64_t __sd1_r = dk_run(__sd1, 0);
    dk_free_node(__sd1);
    return __sd1_r;
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_279 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
