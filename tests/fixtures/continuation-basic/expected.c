...
static int64_t __fn_1619(int64_t);
static int64_t __fn_1622(int64_t);
...
static void __defer_163(void *__env) {
    ...
    bool __ps_175 = (bt_hyundo_hyto_ex(__e->m));
...
static int64_t __fn_1619(int64_t v) {
        return (v) + (INT64_C(1));
}

static int64_t __fn_1622(int64_t v) {
        return (v) + (INT64_C(10));
}
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_172 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1619))(INT64_C(42)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_172;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_173 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1622))(INT64_C(5)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_173;
    return (intptr_t)(__t2);
}
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_174 = (vec_new__spec__tur_adt_Vec__int__());
