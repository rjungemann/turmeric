...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            int64_t lx_617 = vec_hylen_hybyval(x);
            (void)lx_617;
            int64_t ly_618 = vec_hylen_hybyval(y);
            (void)ly_618;
            bool __t5;
            if ((lx_617) == (ly_618)) {
                __t5 = vec_hyeq_hyloop_hybyval(x, y, INT64_C(0), lx_617);
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_797 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_797;
                int64_t t2_798 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_798;
                if ((t1_797) == (INT64_C(0))) {
                    return (t2_798) == (INT64_C(0));
                } else {
                    if ((t2_798) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t12 = (*(int64_t *)(intptr_t)(t1_797));
                        int64_t __t13 = (*(int64_t *)(intptr_t)(t2_798));
                        x = __t12;
                        y = __t13;
                        goto __tur_tailcall;
                    }
