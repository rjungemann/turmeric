...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t254;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1465 = __ps_256;
            (void)r_1465;
            bool __ps_257 = (bt_hyundo_hyto_ex(m_1464));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_257);
            int64_t __t258;
            __t258 = r_1465;
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_264 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1470))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_264;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_265 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1473))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_265;
    return (intptr_t)(__t2);
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_266 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_267 = (vec_new__spec__tur_adt_Vec__int__());
