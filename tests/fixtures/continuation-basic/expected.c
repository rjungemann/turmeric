...
static intptr_t test_hyreset_k0(intptr_t env, intptr_t t0__slot) {
    DK *__kont = (DK *)env;
...
static intptr_t test_hyshift_k0(intptr_t env, intptr_t t0__slot) {
    DK *__kont = (DK *)env;
    int64_t t0 = (int64_t)(t0__slot);
    return dk_run(__kont, (intptr_t)(t0));
}
...
static intptr_t test_hyshift_hynested_k0(intptr_t env, intptr_t t0__slot) {
    DK *__kont = (DK *)env;
    int64_t t0 = (int64_t)(t0__slot);
    return dk_run(__kont, (intptr_t)(t0));
}
