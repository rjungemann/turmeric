...
static int64_t __fn_871(int64_t);
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            ...
            int64_t yi_604 = y;
            (void)yi_604;
            int64_t lx_605 = vec_hylen(xi_603);
            (void)lx_605;
            int64_t ly_606 = vec_hylen(yi_604);
            (void)ly_606;
            bool __t5;
            if ((lx_605) == (ly_606)) {
                int64_t *__t6 = (int64_t *)malloc(2 * sizeof(int64_t));
                __t6[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
                __t6[1] = (int64_t)(intptr_t)__fn_609;
                void *__t7 = __t6;
                __t5 = vec_hyeq_hyloop(xi_603, yi_604, INT64_C(0), lx_605, (int64_t)(intptr_t)(__t7));
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_789 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_789;
                int64_t t2_790 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_790;
                if ((t1_789) == (INT64_C(0))) {
                    return (t2_790) == (INT64_C(0));
                } else {
                    if ((t2_790) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t14 = (*(int64_t *)(intptr_t)(t1_789));
                        int64_t __t15 = (*(int64_t *)(intptr_t)(t2_790));
                        x = __t14;
                        y = __t15;
                        goto __tur_tailcall;
                    }
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t16[1] = (int64_t)(intptr_t)__fn_868;
        void *__t17 = __t16;
...
static int64_t __fn_871(int64_t v) {
        return (v) + (INT64_C(1));
}
