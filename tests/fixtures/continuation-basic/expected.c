...
static int64_t __fn_1437(int64_t);
...
static int64_t __fn_1437(int64_t v) {
        return (v) + (INT64_C(1));
}
...
__attribute__((unused)) static int64_t test_hyreset() {
    ...
    int64_t __r;
    tur_dk_jmp_buf __dkjb; tur_dk_jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (TUR_DK_SETJMP(__dkjb) == 0) { __r = test_hyreset__cps(__root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_179 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1437))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_179;
...
__attribute__((unused)) static int64_t test_hyshift() {
    ...
    int64_t __r;
    tur_dk_jmp_buf __dkjb; tur_dk_jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (TUR_DK_SETJMP(__dkjb) == 0) { __r = test_hyshift__cps(__root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_180 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1440))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_180;
    return (intptr_t)(__t2);
}
...
__attribute__((unused)) static int64_t test_hyshift_hynested() {
    ...
    int64_t __r;
    tur_dk_jmp_buf __dkjb; tur_dk_jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (TUR_DK_SETJMP(__dkjb) == 0) { __r = test_hyshift_hynested__cps(__root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
