...
static int64_t __fn_1625(int64_t);
...
static int64_t __fn_1625(int64_t v) {
        return (v) + (INT64_C(10));
}
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_172 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1622))(INT64_C(42)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_172;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_173 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1625))(INT64_C(5)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_173;
    return (intptr_t)(__t2);
}
