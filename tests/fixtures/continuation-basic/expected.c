...
static int64_t __fn_9(int64_t);
static int64_t test_reset();
static int64_t test_shift();
static int64_t test_shift_nested();
static int64_t __fn_5(int64_t v) {
        return ((v) + (INT64_C(1)));
}

static int64_t __fn_9(int64_t v) {
        return ((v) + (INT64_C(10)));
}
...
static int64_t test_shift() {
        int64_t __t0 = __fn_5(INT64_C(42));
        return __t0;
}

static int64_t test_shift_nested() {
        int64_t __t1 = __fn_9(INT64_C(5));
        return __t1;
}
