...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            int64_t lx_613 = vec_hylen_hybyval(x);
            (void)lx_613;
            int64_t ly_614 = vec_hylen_hybyval(y);
            (void)ly_614;
            bool __t5;
            if ((lx_613) == (ly_614)) {
                __t5 = vec_hyeq_hyloop_hybyval(x, y, INT64_C(0), lx_613);
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_793 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_793;
                int64_t t2_794 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_794;
                if ((t1_793) == (INT64_C(0))) {
                    return (t2_794) == (INT64_C(0));
                } else {
                    if ((t2_794) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t12 = (*(int64_t *)(intptr_t)(t1_793));
                        int64_t __t13 = (*(int64_t *)(intptr_t)(t2_794));
                        x = __t12;
                        y = __t13;
                        goto __tur_tailcall;
                    }
