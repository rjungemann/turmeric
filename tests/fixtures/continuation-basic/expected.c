...
static int64_t __fn_1470(int64_t);
...
static int64_t __fn_1470(int64_t v) {
        return (v) + (INT64_C(1));
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_855 = __ps_136;
        bool __ps_137 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_854, (void *)(intptr_t)(k_855), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_137;
        if (__t1) {
            int64_t __ps_138 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_139 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_854, (void *)(intptr_t)(k_855), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t141;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_859 = __ps_143;
            (void)iter_859;
            void * __ps_144 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_145 = (hamt_slkeyeq((void *)(intptr_t)(__ps_144)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_860 = __ps_145;
            (void)keyeq_860;
            void * __ps_146 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_147 = (map_hyeq_hyloop((void *)(intptr_t)(iter_859), (void *)(intptr_t)(__ps_146), (void *)(intptr_t)(keyeq_860), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_861 = __ps_147;
            (void)result_861;
        ...
        if (__ps_166) {
            bool __t167;
            {
                ...
                if ((t1_1139) == (INT64_C(0))) {
                    __t168 = (t2_1140) == (INT64_C(0));
                } else {
                    bool __t169;
                    if ((t2_1140) == (INT64_C(0))) {
                        __t169 = false;
                    } else {
                        bool __ps_170 = (cons_hyeq_hygo(t1_1139, t2_1140));
                        if (tur_panicking) return ((bool)0);
                        __t169 = __ps_170;
                    }
                    __t168 = __t169;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_176) {
            ...
            int64_t __t177;
            {
                ...
                int64_t out_1155 = (int64_t)(intptr_t)(__ps_181);
                (void)out_1155;
                __t177 = out_1155;
            }
            __t175 = __t177;
        ...
        if (__ps_186) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1226 = __ps_187;
                (void)h_1226;
                void * __ps_188 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1227 = __ps_188;
                (void)k_1227;
                bool __ps_189 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1226, (void *)(intptr_t)(k_1227), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_189) {
                    void * __t190 = iter;
                    void * __t191 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t193;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1230 = __ps_195;
            (void)iter_1230;
            void * __ps_196 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_197 = (hamt_slkeyeq((void *)(intptr_t)(__ps_196)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1231 = __ps_197;
            (void)keyeq_1231;
            void * __ps_198 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_199 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1230), (void *)(intptr_t)(__ps_198), (void *)(intptr_t)(keyeq_1231)));
            if (tur_panicking) return ((bool)0);
            bool result_1232 = __ps_199;
            (void)result_1232;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t220;
        {
            ...
            {
                tur_adt_Vec__int * __ps_222 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1362));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1363 = __ps_222;
                (void)_un_unv_1363;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t226;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1413 = __ps_227;
            (void)r_1413;
            int64_t __t228;
            bool __ps_229 = (schema_hydecode_hyok_qu(r_1413));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_229) {
                int64_t __ps_230 = (schema_hydecode_hyvalue(r_1413));
                if (tur_panicking) return ((int64_t)0);
                __t228 = __ps_230;
            } else {
                int64_t __ps_231 = (schema_hydecode_hyerrors(r_1413));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_244 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1470))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_244;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_245 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1473))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_245;
    return (intptr_t)(__t2);
}
