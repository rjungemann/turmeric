...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            int64_t lx_623 = vec_hylen_hybyval(x);
            (void)lx_623;
            int64_t ly_624 = vec_hylen_hybyval(y);
            (void)ly_624;
            bool __t5;
            if ((lx_623) == (ly_624)) {
                __t5 = vec_hyeq_hyloop_hybyval(x, y, INT64_C(0), lx_623);
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_803 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_803;
                int64_t t2_804 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_804;
                if ((t1_803) == (INT64_C(0))) {
                    return (t2_804) == (INT64_C(0));
                } else {
                    if ((t2_804) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t12 = (*(int64_t *)(intptr_t)(t1_803));
                        int64_t __t13 = (*(int64_t *)(intptr_t)(t2_804));
                        x = __t12;
                        y = __t13;
                        goto __tur_tailcall;
                    }
