...
static int64_t __fn_1435(int64_t);
...
static int64_t __fn_1435(int64_t v) {
        return (v) + (INT64_C(1));
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_815, (void *)(intptr_t)(k_816), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_820 = __ps_75;
            (void)iter_820;
            void * __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_821 = __ps_77;
            (void)keyeq_821;
            void * __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_820), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_821), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_822 = __ps_79;
            (void)result_822;
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                if ((t1_1100) == (INT64_C(0))) {
                    __t100 = (t2_1101) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_1101) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        bool __ps_102 = (cons_hyeq_hygo(t1_1100, t2_1101));
                        if (tur_panicking) return ((bool)0);
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1116 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1116;
                __t109 = out_1116;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1191 = __ps_120;
            (void)iter_1191;
            void * __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1192 = __ps_122;
            (void)keyeq_1192;
            void * __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1191), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1192)));
            if (tur_panicking) return ((bool)0);
            bool result_1193 = __ps_124;
            (void)result_1193;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                tur_adt_Vec__int * __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1320));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1321 = __ps_147;
                (void)_un_unv_1321;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1371 = __ps_152;
            (void)r_1371;
            int64_t __t153;
            bool __ps_154 = (schema_hydecode_hyok_qu(r_1371));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_154) {
                int64_t __ps_155 = (schema_hydecode_hyvalue(r_1371));
                if (tur_panicking) return ((int64_t)0);
                __t153 = __ps_155;
            } else {
                int64_t __ps_156 = (schema_hydecode_hyerrors(r_1371));
                if (tur_panicking) return ((int64_t)0);
...
__attribute__((unused)) static int64_t test_hyreset() {
    ...
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = test_hyreset__cps(__root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_168 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1435))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_168;
...
__attribute__((unused)) static int64_t test_hyshift() {
    ...
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = test_hyshift__cps(__root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_169 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1438))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_169;
    return (intptr_t)(__t2);
}
...
__attribute__((unused)) static int64_t test_hyshift_hynested() {
    ...
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = test_hyshift_hynested__cps(__root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_170 = (ctor_Cons_Cons__int(h, t));
