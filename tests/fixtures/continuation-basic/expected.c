...
static int64_t __fn_1284(int64_t);
...
static int64_t __fn_1284(int64_t v) {
        return (v) + (INT64_C(1));
}
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_95) {
            bool __t96;
            {
                ...
                bool __t97;
                if ((t1_992) == (INT64_C(0))) {
                    __t97 = (t2_993) == (INT64_C(0));
                } else {
                    bool __t98;
                    if ((t2_993) == (INT64_C(0))) {
                        __t98 = false;
                    } else {
                        __auto_type __ps_99 = (cons_hyeq_hygo(t1_992, t2_993));
                        if (tur_panicking) return (bool){0};
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_105) {
            ...
            int64_t __t106;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1008 = (int64_t)(intptr_t)(__ps_110);
                (void)out_1008;
                __t106 = out_1008;
            }
            __t104 = __t106;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1083 = __ps_117;
            (void)iter_1083;
            __auto_type __ps_118 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_119 = (hamt_slkeyeq((void *)(intptr_t)(__ps_118)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1084 = __ps_119;
            (void)keyeq_1084;
            __auto_type __ps_120 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1083), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1084)));
            if (tur_panicking) return (bool){0};
            bool result_1085 = __ps_121;
            (void)result_1085;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                __auto_type __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1212));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1213 = __ps_144;
                (void)_un_unv_1213;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1262 = __ps_148;
            (void)r_1262;
            int64_t __t149;
            __auto_type __ps_150 = (schema_hydecode_hyok_qu(r_1262));
            if (tur_panicking) return (int64_t){0};
            if (__ps_150) {
                __auto_type __ps_151 = (schema_hydecode_hyvalue(r_1262));
                if (tur_panicking) return (int64_t){0};
                __t149 = __ps_151;
            } else {
                __auto_type __ps_152 = (schema_hydecode_hyerrors(r_1262));
                if (tur_panicking) return (int64_t){0};
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    __auto_type __ps_155 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1284))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_155;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    __auto_type __ps_156 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1287))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_156;
    return (intptr_t)(__t2);
}
