...
static int64_t __fn_1365(int64_t v) {
        return (v) + (INT64_C(1));
}
        ...
        if (__ps_102) {
            bool __t103;
            {
                ...
                if ((t1_1072) == (INT64_C(0))) {
                    __t104 = (t2_1073) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_1073) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1072, t2_1073));
                        if (tur_panicking) return ((bool)0);
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1088 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1088;
                __t113 = out_1088;
            }
            __t111 = __t113;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t122;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1163 = __ps_124;
            (void)iter_1163;
            void * __ps_125 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_126 = (hamt_slkeyeq((void *)(intptr_t)(__ps_125)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1164 = __ps_126;
            (void)keyeq_1164;
            void * __ps_127 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_128 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1163), (void *)(intptr_t)(__ps_127), (void *)(intptr_t)(keyeq_1164)));
            if (tur_panicking) return ((bool)0);
            bool result_1165 = __ps_128;
            (void)result_1165;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t149;
        {
            ...
            {
                tur_adt_Vec__int * __ps_151 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1292));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1293 = __ps_151;
                (void)_un_unv_1293;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t155;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1343 = __ps_156;
            (void)r_1343;
            int64_t __t157;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1343));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                int64_t __ps_159 = (schema_hydecode_hyvalue(r_1343));
                if (tur_panicking) return ((int64_t)0);
                __t157 = __ps_159;
            } else {
                int64_t __ps_160 = (schema_hydecode_hyerrors(r_1343));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_163 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1365))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_163;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_164 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1368))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_164;
    return (intptr_t)(__t2);
}
