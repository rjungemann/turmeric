...
static int64_t __fn_1331(int64_t);
...
static int64_t __fn_1331(int64_t v) {
        return (v) + (INT64_C(1));
}
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1309 = __ps_152;
            (void)r_1309;
            int64_t __t153;
            bool __ps_154 = (schema_hydecode_hyok_qu(r_1309));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_154) {
                int64_t __ps_155 = (schema_hydecode_hyvalue(r_1309));
                if (tur_panicking) return ((int64_t)0);
                __t153 = __ps_155;
            } else {
                int64_t __ps_156 = (schema_hydecode_hyerrors(r_1309));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t test_hyshift_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_159 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1331))(INT64_C(42)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_159;
...
static intptr_t test_hyshift_hynested_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_160 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1334))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_160;
    return (intptr_t)(__t2);
}
