...
static tur_adt_Result__int__int make_hydirect() {
        ...
        *(void (**)(void *))__t180 = 0;
        ...
        __t179[1] = (int64_t)(intptr_t)__fn_1622;
        void *__t181 = __t179;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int c_1629 = __ps_196;
            (void)c_1629;
            bool __ps_197 = (err___spec__bool_tur_adt_Result__int__int(c_1629));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_197) {
                puts("caught-err");
            } else {
