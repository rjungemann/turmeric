...
static int64_t make_hylet();
static int64_t make_hydirect();
static int64_t make_hycaught();
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_177 = (make_hylet());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t a_1373 = __ps_177;
            (void)a_1373;
            bool __ps_178 = (ok_qu(a_1373));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_178) {
                puts("let-ok");
            } else {
        ...
        {
            int64_t __ps_179 = (make_hydirect());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t b_1374 = __ps_179;
            (void)b_1374;
            bool __ps_180 = (ok_qu(b_1374));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_180) {
                puts("direct-ok");
            } else {
        ...
        {
            int64_t __ps_181 = (make_hycaught());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t c_1375 = __ps_181;
            (void)c_1375;
            bool __ps_182 = (err_qu(c_1375));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_182) {
                puts("caught-err");
            } else {
