...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_160 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_160));
        double __ps_161 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_161));
        double __ps_162 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_163 = (nan_qu(__ps_162));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_163) ? "true" : "false");
        double __ps_164 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_165 = (nan_qu(__ps_164));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_165) ? "true" : "false");
        double __ps_166 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_167 = (nan_qu(__ps_166));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_167) ? "true" : "false");
        double __ps_168 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_168));
        double __ps_169 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_169));
        float __ps_170 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_170));
        double __ps_171 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_172 = (fdiv(1.0, __ps_171));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_172));
        int64_t __t173;
        __t173 = INT64_C(0);
