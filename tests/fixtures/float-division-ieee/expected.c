...
static float f32div(float a, float b) {
        return (a) / (b);
}

static double fconst(double a) {
        return (a) / (8.0);
}

static bool nan_qu(double x) {
        return (x) != (x);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_277 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_277));
        double __ps_278 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_278));
        double __ps_279 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_280 = (nan_qu(__ps_279));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_280) ? "true" : "false");
        double __ps_281 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_282 = (nan_qu(__ps_281));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_282) ? "true" : "false");
        double __ps_283 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_284 = (nan_qu(__ps_283));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_284) ? "true" : "false");
        double __ps_285 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_285));
        double __ps_286 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_286));
        float __ps_287 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_287));
        double __ps_288 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_289 = (fdiv(1.0, __ps_288));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_289));
        int64_t __t290;
        __t290 = INT64_C(0);
