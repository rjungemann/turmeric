...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_244 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_244));
        double __ps_245 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_245));
        double __ps_246 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_247 = (nan_qu(__ps_246));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_247) ? "true" : "false");
        double __ps_248 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_249 = (nan_qu(__ps_248));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_249) ? "true" : "false");
        double __ps_250 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_251 = (nan_qu(__ps_250));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_251) ? "true" : "false");
        double __ps_252 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_252));
        double __ps_253 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_253));
        float __ps_254 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_254));
        double __ps_255 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_256 = (fdiv(1.0, __ps_255));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_256));
        int64_t __t257;
        __t257 = INT64_C(0);
