...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_275 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_275));
        double __ps_276 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_276));
        double __ps_277 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_278 = (nan_qu(__ps_277));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_278) ? "true" : "false");
        double __ps_279 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_280 = (nan_qu(__ps_279));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_280) ? "true" : "false");
        double __ps_281 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_282 = (nan_qu(__ps_281));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_282) ? "true" : "false");
        double __ps_283 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_283));
        double __ps_284 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_284));
        float __ps_285 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_285));
        double __ps_286 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_287 = (fdiv(1.0, __ps_286));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_287));
        int64_t __t288;
        __t288 = INT64_C(0);
