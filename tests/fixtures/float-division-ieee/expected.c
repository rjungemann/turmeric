...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_232 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_232));
        double __ps_233 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_233));
        double __ps_234 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_235 = (nan_qu(__ps_234));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_235) ? "true" : "false");
        double __ps_236 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_237 = (nan_qu(__ps_236));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_237) ? "true" : "false");
        double __ps_238 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_239 = (nan_qu(__ps_238));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_239) ? "true" : "false");
        double __ps_240 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_240));
        double __ps_241 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_241));
        float __ps_242 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_242));
        double __ps_243 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_244 = (fdiv(1.0, __ps_243));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_244));
        int64_t __t245;
        __t245 = INT64_C(0);
