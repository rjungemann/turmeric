...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_267 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_267));
        double __ps_268 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_268));
        double __ps_269 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_270 = (nan_qu(__ps_269));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_270) ? "true" : "false");
        double __ps_271 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_272 = (nan_qu(__ps_271));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_272) ? "true" : "false");
        double __ps_273 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_274 = (nan_qu(__ps_273));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_274) ? "true" : "false");
        double __ps_275 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_275));
        double __ps_276 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_276));
        float __ps_277 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_277));
        double __ps_278 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_279 = (fdiv(1.0, __ps_278));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_279));
        int64_t __t280;
        __t280 = INT64_C(0);
