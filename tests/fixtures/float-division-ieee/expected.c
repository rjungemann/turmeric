...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_163 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_163));
        double __ps_164 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_164));
        double __ps_165 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_166 = (nan_qu(__ps_165));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_166) ? "true" : "false");
        double __ps_167 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_168 = (nan_qu(__ps_167));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_168) ? "true" : "false");
        double __ps_169 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_170 = (nan_qu(__ps_169));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_170) ? "true" : "false");
        double __ps_171 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_171));
        double __ps_172 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_172));
        float __ps_173 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_173));
        double __ps_174 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_175 = (fdiv(1.0, __ps_174));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_175));
        int64_t __t176;
        __t176 = INT64_C(0);
