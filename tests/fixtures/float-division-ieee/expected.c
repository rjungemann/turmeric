...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_168 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_168));
        double __ps_169 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_169));
        double __ps_170 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_171 = (nan_qu(__ps_170));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_171) ? "true" : "false");
        double __ps_172 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_173 = (nan_qu(__ps_172));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_176));
        double __ps_177 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_177));
        float __ps_178 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_178));
        double __ps_179 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_180 = (fdiv(1.0, __ps_179));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
