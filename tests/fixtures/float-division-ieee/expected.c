...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_264 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_264));
        double __ps_265 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_265));
        double __ps_266 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_267 = (nan_qu(__ps_266));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_267) ? "true" : "false");
        double __ps_268 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_269 = (nan_qu(__ps_268));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_269) ? "true" : "false");
        double __ps_270 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_271 = (nan_qu(__ps_270));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_271) ? "true" : "false");
        double __ps_272 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_272));
        double __ps_273 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_273));
        float __ps_274 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_274));
        double __ps_275 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_276 = (fdiv(1.0, __ps_275));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_276));
        int64_t __t277;
        __t277 = INT64_C(0);
