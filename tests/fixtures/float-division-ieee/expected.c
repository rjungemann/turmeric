...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_173));
        double __ps_174 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_174));
        double __ps_175 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_176 = (nan_qu(__ps_175));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_176) ? "true" : "false");
        double __ps_177 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_178 = (nan_qu(__ps_177));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_178) ? "true" : "false");
        double __ps_179 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_180 = (nan_qu(__ps_179));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_180) ? "true" : "false");
        double __ps_181 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_181));
        double __ps_182 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_182));
        float __ps_183 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_183));
        double __ps_184 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_185 = (fdiv(1.0, __ps_184));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_185));
        int64_t __t186;
        __t186 = INT64_C(0);
