...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_183 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_183));
        double __ps_184 = (fdiv(-7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_184));
        double __ps_185 = (fdiv(0.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_188 = (nan_qu(__ps_187));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_188) ? "true" : "false");
        double __ps_189 = (fdiv(7.1, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_190 = (nan_qu(__ps_189));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_190) ? "true" : "false");
        double __ps_191 = (fdiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_191));
        double __ps_192 = (fconst(16.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_192));
        float __ps_193 = (f32div(((float)7.5), ((float)2.5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%.7g\n", (double)(__ps_193));
        double __ps_194 = (fdiv(1.0, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_195 = (fdiv(1.0, __ps_194));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_195));
        int64_t __t196;
        __t196 = INT64_C(0);
