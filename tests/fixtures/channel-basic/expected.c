...
int main() {
        {
            ...
            (void)ch_220;
            {
                ...
                (void)prod_arg_221;
                {
                    ...
                    (void)cons_arg_222;
                    {
                        void * tp_223 = thread_spawn_fn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_221));
                        (void)tp_223;
                        {
                            void * tc_224 = thread_spawn_fn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_222));
                            (void)tc_224;
                            thread_join((void *)(intptr_t)(tp_223));
                            thread_join((void *)(intptr_t)(tc_224));
                        }
                    }
