...
int main() {
        {
            ...
            (void)ch_232;
            {
                ...
                (void)prod_arg_233;
                {
                    ...
                    (void)cons_arg_234;
                    {
                        void * tp_235 = thread_spawn_fn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_233));
                        (void)tp_235;
                        {
                            void * tc_236 = thread_spawn_fn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_234));
                            (void)tc_236;
                            thread_join((void *)(intptr_t)(tp_235));
                            thread_join((void *)(intptr_t)(tc_236));
                        }
                    }
