...
int main() {
        {
            ...
            (void)ch_238;
            {
                ...
                (void)prod_arg_239;
                {
                    ...
                    (void)cons_arg_240;
                    {
                        void * tp_241 = thread_spawn_fn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_239));
                        (void)tp_241;
                        {
                            void * tc_242 = thread_spawn_fn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_240));
                            (void)tc_242;
                            thread_join((void *)(intptr_t)(tp_241));
                            thread_join((void *)(intptr_t)(tc_242));
                        }
                    }
