...
int main() {
        {
            ...
            (void)ch_237;
            {
                ...
                (void)prod_arg_238;
                {
                    ...
                    (void)cons_arg_239;
                    {
                        void * tp_240 = thread_spawn_fn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_238));
                        (void)tp_240;
                        {
                            void * tc_241 = thread_spawn_fn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_239));
                            (void)tc_241;
                            thread_join((void *)(intptr_t)(tp_240));
                            thread_join((void *)(intptr_t)(tc_241));
                        }
                    }
