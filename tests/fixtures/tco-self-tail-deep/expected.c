...
static int64_t count_hydown(int64_t, int64_t);
...
static int64_t count_hydown(int64_t n, int64_t acc) {
        __tur_tailcall:;
        if ((n) == (INT64_C(0))) {
            return acc;
        } else {
            int64_t __t155 = (n) - (INT64_C(1));
            int64_t __t156 = (acc) + (INT64_C(1));
            n = __t155;
            acc = __t156;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_157 = (count_hydown(INT64_C(10000000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_157));
        int64_t __t158;
        __t158 = INT64_C(0);
