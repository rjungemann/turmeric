...
static const char * poly(int64_t x) {
        __auto_type __ps_157 = (__inst_Show_show_int(x));
        if (tur_panicking) return (const char *){0};
        __auto_type __ps_158 = (__inst_Ord_rank_int(x));
        if (tur_panicking) return (const char *){0};
        __auto_type __ps_159 = (combine(__ps_157, __ps_158));
        if (tur_panicking) return (const char *){0};
        return __ps_159;
}

static const char * use_hyboth(tur_poly_fn_t f) {
        __auto_type __ps_160 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return (const char *){0};
        puts(__ps_160);
        __auto_type __ps_161 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return (const char *){0};
        puts(__ps_161);
        const char * __t162;
        __t162 = "done";
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_163 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1300 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_163);
        int64_t __t164;
        __t164 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_165 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_166 = (vec_new__spec__tur_adt_Vec__int__());
