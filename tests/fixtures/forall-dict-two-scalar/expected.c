...
static int64_t poly_un_undict_un1451(int64_t __dict_1452, int64_t __dict_1454, int64_t x) {
        const char * __ps_40 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1452)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_41 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1454)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1457(void * __poly_env_1458, int64_t __poly_x0_1460, int64_t __poly_x1_1462, int64_t __poly_x2_1464) {
        int64_t __ps_43 = (poly_un_undict_un1451(__poly_x0_1460, __poly_x1_1462, __poly_x2_1464));
        if (tur_panicking) return ((int64_t)0);
        return __ps_43;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_819 = __ps_76;
        bool __ps_77 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_77;
        if (__t1) {
            int64_t __ps_78 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_79 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t81;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_823 = __ps_83;
            (void)iter_823;
            void * __ps_84 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_85 = (hamt_slkeyeq((void *)(intptr_t)(__ps_84)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_824 = __ps_85;
            (void)keyeq_824;
            void * __ps_86 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_87 = (map_hyeq_hyloop((void *)(intptr_t)(iter_823), (void *)(intptr_t)(__ps_86), (void *)(intptr_t)(keyeq_824), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_825 = __ps_87;
            (void)result_825;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1119 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1119;
                __t117 = out_1119;
            }
            __t115 = __t117;
...
static const char * poly(int64_t x) {
        const char * __ps_184 = (__inst_Show_show_int(x));
        if (tur_panicking) return ((const char *)0);
        int64_t __ps_185 = (__inst_Ord_rank_int(x));
        if (tur_panicking) return ((const char *)0);
        const char * __ps_186 = (combine(__ps_184, __ps_185));
        if (tur_panicking) return ((const char *)0);
        return __ps_186;
}

static const char * use_hyboth(tur_poly_fn_t f) {
        const char * __ps_187 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_187);
        const char * __ps_188 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_188);
        const char * __t189;
        __t189 = "done";
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_190 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1457 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_190);
        int64_t __t191;
        __t191 = INT64_C(0);
