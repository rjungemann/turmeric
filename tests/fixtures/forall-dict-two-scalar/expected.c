...
struct __defer_env_166 {int64_t m; };

static void __defer_172(void *__env) {
    untrailed_hyend();
}
...
static int64_t poly_un_undict_un1621(int64_t __dict_1622, int64_t __dict_1624, int64_t x) {
        const char * __ps_62 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1622)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_63 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1624)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        const char * __ps_64 = (combine(__ps_62, __ps_63));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1627(void * __poly_env_1628, int64_t __poly_x0_1630, int64_t __poly_x1_1632, int64_t __poly_x2_1634) {
        return poly_un_undict_un1621(__poly_x0_1630, __poly_x1_1632, __poly_x2_1634);
}
...
static int64_t min(int64_t x, int64_t y) {
        int64_t __t67;
        bool __ps_68 = (__inst_Ord_gte_qu_int(x, y));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_68) {
            __t67 = y;
        } else {
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    __t0 = __ps_69;
    if (__t0) {
        int64_t __ps_70 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((int64_t)0);
        h_996 = __ps_70;
        void * __ps_71 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((int64_t)0);
        k_997 = __ps_71;
        bool __ps_72 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_996, (void *)(intptr_t)(k_997), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_72;
        if (__t1) {
            int64_t __ps_73 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_74 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_996, (void *)(intptr_t)(k_997), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t76;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1001 = __ps_78;
            (void)iter_1001;
            void * __ps_79 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_80 = (hamt_slkeyeq((void *)(intptr_t)(__ps_79)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1002 = __ps_80;
            (void)keyeq_1002;
            void * __ps_81 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_82 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1001), (void *)(intptr_t)(__ps_81), (void *)(intptr_t)(keyeq_1002), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1003 = __ps_82;
            (void)result_1003;
...
static int64_t none() {
        int64_t __ps_90 = (ctor_Option_None());
        if (tur_panicking) return ((int64_t)0);
        return __ps_90;
}
        ...
        if (__ps_101) {
            bool __t102;
            {
                ...
                if (__ps_104) {
                    ...
                    bool __t106;
                    bool __ps_107 = (tnil_qu(t2_1282));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_107) {
                        __t106 = false;
                    } else {
                        bool __ps_108 = (cons_hyeq_hygo(t1_1281, t2_1282));
                        if (tur_panicking) return ((bool)0);
                        __t106 = __ps_108;
                    }
                    __t103 = __t106;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                int64_t out_1297 = (int64_t)(intptr_t)(__ps_119);
                (void)out_1297;
                __t115 = out_1297;
            }
            __t113 = __t115;
        ...
        if (__ps_120) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1368 = __ps_121;
                (void)h_1368;
                void * __ps_122 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1369 = __ps_122;
                (void)k_1369;
                bool __ps_123 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1368, (void *)(intptr_t)(k_1369), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_123) {
                    void * __t124 = iter;
                    void * __t125 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t127;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1372 = __ps_129;
            (void)iter_1372;
            void * __ps_130 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_131 = (hamt_slkeyeq((void *)(intptr_t)(__ps_130)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1373 = __ps_131;
            (void)keyeq_1373;
            void * __ps_132 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_133 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1372), (void *)(intptr_t)(__ps_132), (void *)(intptr_t)(keyeq_1373)));
            if (tur_panicking) return ((bool)0);
            bool result_1374 = __ps_133;
            (void)result_1374;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t154;
        {
            ...
            {
                tur_adt_Vec__int * __ps_156 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1504));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1505 = __ps_156;
                (void)_un_unv_1505;
        ...
        return schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t154)));
}
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1555 = __ps_159;
            (void)r_1555;
            bool __ps_160 = (schema_hydecode_hyok_qu(r_1555));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_160) {
                return schema_hydecode_hyvalue(r_1555);
            } else {
                int64_t __ps_161 = (schema_hydecode_hyerrors(r_1555));
                if (tur_panicking) return ((int64_t)0);
                return schema_hydecode_hyabort(__ps_161);
            }
        }
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t163;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1606 = __ps_164;
            (void)m_1606;
            tur_frame __frame_165;
            tur_frame_init(&__frame_165, NULL);
            struct __defer_env_166 __t168 = {.m = m_1606};
            tur_frame_push_defer(&__frame_165, __defer_167, &__t168);
            int64_t __t169;
            int64_t __ps_170 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) { tur_frame_fire_lifo(&__frame_165); return ((int64_t)0); }
            __t169 = __ps_170;
...
static int64_t with_hyuntrailed(int64_t body) {
        tur_frame __frame_171;
        tur_frame_init(&__frame_171, NULL);
        untrailed_hybegin();
        tur_frame_push_defer(&__frame_171, __defer_172, NULL);
        int64_t __t173;
        int64_t __ps_174 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
        if (tur_panicking) { tur_frame_fire_lifo(&__frame_171); return ((int64_t)0); }
        __t173 = __ps_174;
        tur_frame_fire_lifo(&__frame_171);
        return __t173;
}
...
static const char * poly(int64_t x) {
        ...
        int64_t __ps_177 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((const char *)0);
        return combine(__ps_176, __ps_177);
}

static const char * use_hyboth(tur_poly_fn_t f) {
        const char * __ps_178 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_178);
        const char * __ps_179 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_179);
        const char * __t180;
        __t180 = "done";
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_181 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1627 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_181);
        int64_t __t182;
        __t182 = INT64_C(0);
