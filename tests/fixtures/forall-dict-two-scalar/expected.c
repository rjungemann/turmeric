...
static int64_t list_hyeq_qu__cps(int64_t l1, int64_t l2, int64_t cmp_fn, DK *__kont) {
    ...
    int64_t __t4;
    int64_t __t5;
    bool __ps_189 = (null_qu(l1));
    if (tur_panicking) return ((int64_t)0);
    __t0 = __ps_189;
    if (__t0) {
        bool __ps_190 = (null_qu(l2));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_190;
        return dk_run(__kont, (intptr_t)(__t1));
    } else {
        bool __ps_191 = (null_qu(l2));
        if (tur_panicking) return ((int64_t)0);
        __t2 = __ps_191;
        if (__t2) {
            return dk_run(__kont, (intptr_t)(false));
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_198) {
            bool __t199;
            {
                ...
                (void)t2_1282;
                bool __t200;
                bool __ps_201 = (tnil_qu(t1_1281));
                if (tur_panicking) return ((bool)0);
                if (__ps_201) {
                    bool __ps_202 = (tnil_qu(t2_1282));
                    if (tur_panicking) return ((bool)0);
                    __t200 = __ps_202;
                } else {
                    bool __t203;
                    bool __ps_204 = (tnil_qu(t2_1282));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_204) {
                        __t203 = false;
                    } else {
                        bool __ps_205 = (cons_hyeq_hygo(t1_1281, t2_1282));
                        if (tur_panicking) return ((bool)0);
                        __t203 = __ps_205;
                    }
                    __t200 = __t203;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_211) {
            ...
            int64_t __t212;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_215 = (list_hyconcat(__ps_214, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_216 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_213, __ps_215));
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_216), sizeof(__ps_216));
                int64_t out_1297 = (int64_t)(intptr_t)(__ps_216);
                (void)out_1297;
                __t212 = out_1297;
            }
            __t210 = __t212;
...
static int64_t car(int64_t l) {
        int64_t __ps_217 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_217;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_218 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_218;
}
        ...
        if (__ps_220) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1368 = __ps_221;
                (void)h_1368;
                void * __ps_222 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1369 = __ps_222;
                (void)k_1369;
                bool __ps_223 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1368, (void *)(intptr_t)(k_1369), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_223) {
                    void * __t224 = iter;
                    void * __t225 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t227;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1372 = __ps_229;
            (void)iter_1372;
            void * __ps_230 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_231 = (hamt_slkeyeq((void *)(intptr_t)(__ps_230)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1373 = __ps_231;
            (void)keyeq_1373;
            void * __ps_232 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_233 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1372), (void *)(intptr_t)(__ps_232), (void *)(intptr_t)(keyeq_1373)));
            if (tur_panicking) return ((bool)0);
            bool result_1374 = __ps_233;
            (void)result_1374;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t254;
        {
            ...
            {
                tur_adt_Vec__int * __ps_256 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1504));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1505 = __ps_256;
                (void)_un_unv_1505;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t260;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1555 = __ps_261;
            (void)r_1555;
            int64_t __t262;
            bool __ps_263 = (schema_hydecode_hyok_qu(r_1555));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_263) {
                int64_t __ps_264 = (schema_hydecode_hyvalue(r_1555));
                if (tur_panicking) return ((int64_t)0);
                __t262 = __ps_264;
            } else {
                int64_t __ps_265 = (schema_hydecode_hyerrors(r_1555));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t268;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1606 = __ps_269;
            (void)m_1606;
            tur_frame __frame_270;
            tur_frame_init(&__frame_270, NULL);
            struct __defer_env_271 __t273 = {.m = m_1606};
...
static const char * poly(int64_t x) {
        const char * __ps_281 = (__inst_Show_show_int(x));
        if (tur_panicking) return ((const char *)0);
        int64_t __ps_282 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((const char *)0);
        const char * __ps_283 = (combine(__ps_281, __ps_282));
        if (tur_panicking) return ((const char *)0);
        return __ps_283;
}

static const char * use_hyboth(tur_poly_fn_t f) {
        const char * __ps_284 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_284);
        const char * __ps_285 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_285);
        const char * __t286;
        __t286 = "done";
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_287 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1627 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_287);
        int64_t __t288;
        __t288 = INT64_C(0);
