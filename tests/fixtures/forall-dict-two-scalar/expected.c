...
static int64_t poly_un_undict_un1447(int64_t __dict_1448, int64_t __dict_1450, int64_t x) {
        const char * __ps_40 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1448)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_41 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1450)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1453(void * __poly_env_1454, int64_t __poly_x0_1456, int64_t __poly_x1_1458, int64_t __poly_x2_1460) {
        int64_t __ps_43 = (poly_un_undict_un1447(__poly_x0_1456, __poly_x1_1458, __poly_x2_1460));
        if (tur_panicking) return ((int64_t)0);
        return __ps_43;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_189 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1453 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_189);
        int64_t __t190;
        __t190 = INT64_C(0);
