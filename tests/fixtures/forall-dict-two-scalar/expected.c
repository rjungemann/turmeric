...
static int64_t poly_un_undict_un1482(int64_t, int64_t, int64_t);
static int64_t __poly_1488(void *, int64_t, int64_t, int64_t);
...
static int64_t poly_un_undict_un1482(int64_t __dict_1483, int64_t __dict_1485, int64_t x) {
        const char * __ps_124 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1483)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_125 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1485)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1488(void * __poly_env_1489, int64_t __poly_x0_1491, int64_t __poly_x1_1493, int64_t __poly_x2_1495) {
        int64_t __ps_127 = (poly_un_undict_un1482(__poly_x0_1491, __poly_x1_1493, __poly_x2_1495));
        if (tur_panicking) return ((int64_t)0);
        return __ps_127;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t258;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1466 = __ps_260;
            (void)r_1466;
            bool __ps_261 = (bt_hyundo_hyto_ex(m_1465));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_261);
            int64_t __t262;
            __t262 = r_1466;
...
static const char * poly(int64_t x) {
        const char * __ps_268 = (__inst_Show_show_int(x));
        if (tur_panicking) return ((const char *)0);
        int64_t __ps_269 = (__inst_Ord_rank_int(x));
        if (tur_panicking) return ((const char *)0);
        const char * __ps_270 = (combine(__ps_268, __ps_269));
        if (tur_panicking) return ((const char *)0);
        return __ps_270;
}

static const char * use_hyboth(tur_poly_fn_t f) {
        const char * __ps_271 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_271);
        const char * __ps_272 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_272);
        const char * __t273;
        __t273 = "done";
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_274 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1488 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_274);
        int64_t __t275;
        __t275 = INT64_C(0);
