...
static int64_t poly_un_undict_un1279(int64_t __dict_1280, int64_t __dict_1282, int64_t x) {
        return (int64_t)(intptr_t)combine(((const char * (*)(int64_t))((void **)(intptr_t)__dict_1280)[0])(x), ((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1282)[0])(x));
}

static int64_t __poly_1285(void * __poly_env_1286, int64_t __poly_x0_1288, int64_t __poly_x1_1290, int64_t __poly_x2_1292) {
        return poly_un_undict_un1279(__poly_x0_1288, __poly_x1_1290, __poly_x2_1292);
}
...
static const char * poly(int64_t x) {
        return combine(__inst_Show_show_int(x), __inst_Ord_rank_int(x));
}

static const char * use_hyboth(tur_poly_fn_t f) {
        puts(((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_int_singleton))), (int64_t)(INT64_C(7))))));
        puts(((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_bool_singleton))), (int64_t)(true)))));
        const char * __t55;
        __t55 = "done";
        return __t55;
}
...
int main(int argc, char **argv) {
        ...
        puts(use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1285 }));
        int64_t __t56;
        __t56 = INT64_C(0);
        return (int)__t56;
}
