...
static int64_t __inst_Ord_rank_int(int64_t);
static int64_t __inst_Ord_rank_bool(bool);
static int64_t poly_un_undict_un1451(int64_t, int64_t, int64_t);
static int64_t __poly_1457(void *, int64_t, int64_t, int64_t);
...
static int64_t __inst_Ord_rank_int(int64_t x) {
        return (int)x;
...
static dict_Ord_int dict_Ord_int_singleton = {
    .rank = __inst_Ord_rank_int,
};

static int64_t __inst_Ord_rank_bool(bool x) {
        return x ? 1 : 0;
    
}

typedef struct dict_Ord_bool {
    int64_t (*rank)(bool);
} dict_Ord_bool;

static dict_Ord_bool dict_Ord_bool_singleton = {
    .rank = __inst_Ord_rank_bool,
};

static int64_t poly_un_undict_un1451(int64_t __dict_1452, int64_t __dict_1454, int64_t x) {
        const char * __ps_42 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1452)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_43 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1454)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        const char * __ps_44 = (combine(__ps_42, __ps_43));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_44;
}

static int64_t __poly_1457(void * __poly_env_1458, int64_t __poly_x0_1460, int64_t __poly_x1_1462, int64_t __poly_x2_1464) {
        int64_t __ps_45 = (poly_un_undict_un1451(__poly_x0_1460, __poly_x1_1462, __poly_x2_1464));
        if (tur_panicking) return ((int64_t)0);
        return __ps_45;
}
...
static void * hamt_slretain(void * m) {
        void * __ps_47 = (tur_hamt_retain((void *)(intptr_t)(m)));
        if (tur_panicking) return ((void *)0);
        return __ps_47;
}

static void * hamt_slset(void * m, int64_t hash, void * key, void * val) {
        void * __ps_48 = (tur_hamt_set((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key), (void *)(intptr_t)(val)));
        if (tur_panicking) return ((void *)0);
        return __ps_48;
}

static void * hamt_sldel(void * m, int64_t hash, void * key) {
        void * __ps_49 = (tur_hamt_del((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key)));
        if (tur_panicking) return ((void *)0);
        return __ps_49;
}

static void * hamt_slget(void * m, int64_t hash, void * key) {
        void * __ps_50 = (tur_hamt_get((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key)));
        if (tur_panicking) return ((void *)0);
        return __ps_50;
}

static bool hamt_slhas_qu(void * m, int64_t hash, void * key) {
        bool __ps_51 = (tur_hamt_has((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key)));
        if (tur_panicking) return ((bool)0);
        return __ps_51;
}

static void * hamt_slset_hycstr(void * m, const char * key, void * val) {
        void * __ps_52 = (tur_hamt_set_cstr((void *)(intptr_t)(m), key, (void *)(intptr_t)(val)));
        if (tur_panicking) return ((void *)0);
        return __ps_52;
}

static void * hamt_sldel_hycstr(void * m, const char * key) {
        void * __ps_53 = (tur_hamt_del_cstr((void *)(intptr_t)(m), key));
        if (tur_panicking) return ((void *)0);
        return __ps_53;
}

static void * hamt_slget_hycstr(void * m, const char * key) {
        void * __ps_54 = (tur_hamt_get_cstr((void *)(intptr_t)(m), key));
        if (tur_panicking) return ((void *)0);
        return __ps_54;
}

static bool hamt_slhas_hycstr_qu(void * m, const char * key) {
        bool __ps_55 = (tur_hamt_has_cstr((void *)(intptr_t)(m), key));
        if (tur_panicking) return ((bool)0);
        return __ps_55;
}

static int64_t hamt_slcount(void * m) {
        int64_t __ps_56 = (tur_hamt_count((void *)(intptr_t)(m)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_56;
}

static void * hamt_slmerge(void * a, void * b) {
        void * __ps_57 = (tur_hamt_merge((void *)(intptr_t)(a), (void *)(intptr_t)(b)));
        if (tur_panicking) return ((void *)0);
        return __ps_57;
}

static int64_t hamt_slhash_hystr(const char * str) {
        int64_t __ps_58 = (tur_hamt_hash_str(str));
        if (tur_panicking) return ((int64_t)0);
        return __ps_58;
}

static int64_t hamt_slhash_hyptr(void * ptr) {
        int64_t __ps_59 = (tur_hamt_hash_ptr((void *)(intptr_t)(ptr)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_59;
}
...
static bool hamt_sliter_hynext(void * iter, void * hash_out, void * key_out, void * val_out) {
        bool __ps_60 = (tur_hamt_iter_next((void *)(intptr_t)(iter), (void *)(intptr_t)(hash_out), (void *)(intptr_t)(key_out), (void *)(intptr_t)(val_out)));
        if (tur_panicking) return ((bool)0);
        return __ps_60;
}

static void * hamt_sliter_hyalloc(void * m) {
        void * __ps_61 = (tur_hamt_iter_alloc((void *)(intptr_t)(m)));
        if (tur_panicking) return ((void *)0);
        return __ps_61;
}
...
static bool hamt_sliter_hyadvance_ex(void * box) {
        bool __ps_62 = (tur_hamt_iter_advance((void *)(intptr_t)(box)));
        if (tur_panicking) return ((bool)0);
        return __ps_62;
}

static int64_t hamt_sliter_hycur_hyhash(void * box) {
        int64_t __ps_63 = (tur_hamt_iter_cur_hash((void *)(intptr_t)(box)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_63;
}

static void * hamt_sliter_hycur_hykey(void * box) {
        void * __ps_64 = (tur_hamt_iter_cur_key((void *)(intptr_t)(box)));
        if (tur_panicking) return ((void *)0);
        return __ps_64;
}

static void * hamt_sliter_hycur_hyval(void * box) {
        void * __ps_65 = (tur_hamt_iter_cur_val((void *)(intptr_t)(box)));
        if (tur_panicking) return ((void *)0);
        return __ps_65;
}

static void * hamt_slkeyeq(void * m) {
        void * __ps_66 = (tur_hamt_keyeq((void *)(intptr_t)(m)));
        if (tur_panicking) return ((void *)0);
        return __ps_66;
}

static void * hamt_slget_hydynamic(void * m, int64_t hash, void * key, void * keyeq) {
        void * __ps_67 = (tur_hamt_get_dynamic((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((void *)0);
        return __ps_67;
}

static bool hamt_slhas_hydynamic_qu(void * m, int64_t hash, void * key, void * keyeq) {
        bool __ps_68 = (tur_hamt_has_dynamic((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((bool)0);
        return __ps_68;
}

static void * hamt_slmap(void * m, void * fn, void * ctx) {
        void * __ps_69 = (tur_hamt_map((void *)(intptr_t)(m), (void *)(intptr_t)(fn), (void *)(intptr_t)(ctx)));
        if (tur_panicking) return ((void *)0);
        return __ps_69;
}

static void * hamt_slfilter(void * m, void * fn, void * ctx) {
        void * __ps_70 = (tur_hamt_filter((void *)(intptr_t)(m), (void *)(intptr_t)(fn), (void *)(intptr_t)(ctx)));
        if (tur_panicking) return ((void *)0);
        return __ps_70;
}

static void * hamt_slreduce(void * m, void * fn, void * init, void * ctx) {
        void * __ps_71 = (tur_hamt_reduce((void *)(intptr_t)(m), (void *)(intptr_t)(fn), (void *)(intptr_t)(init), (void *)(intptr_t)(ctx)));
        if (tur_panicking) return ((void *)0);
        return __ps_71;
}

static void * hamt_slmerge_hywith(void * a, void * b, void * fn, void * ctx) {
        void * __ps_72 = (tur_hamt_merge_with((void *)(intptr_t)(a), (void *)(intptr_t)(b), (void *)(intptr_t)(fn), (void *)(intptr_t)(ctx)));
        if (tur_panicking) return ((void *)0);
        return __ps_72;
}

static const char * hamt_slshow(void * m) {
        const char * __ps_73 = (tur_hamt_show((void *)(intptr_t)(m)));
...
static void * hamt_sltransient(void * m) {
        void * __ps_74 = (tur_hamt_transient((void *)(intptr_t)(m)));
        if (tur_panicking) return ((void *)0);
        return __ps_74;
}
...
static void * hamt_slpersistent_ex(void * t) {
        void * __ps_75 = (tur_hamt_persistent((void *)(intptr_t)(t)));
        if (tur_panicking) return ((void *)0);
        return __ps_75;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    bool __t1;
    bool __t2;
    bool __ps_76 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t0 = __ps_76;
    if (__t0) {
        int64_t __ps_77 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        h_818 = __ps_77;
        void * __ps_78 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_819 = __ps_78;
        bool __ps_79 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_79;
        if (__t1) {
            int64_t __ps_80 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_81 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_82 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_80, __ps_81));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t2 = __ps_82;
            if (__t2) {
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t83;
        {
            void * __ps_84 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_85 = (hamt_sliter_hyalloc((void *)(intptr_t)(__ps_84)));
            if (tur_panicking) return ((bool)0);
            void * iter_823 = __ps_85;
            (void)iter_823;
            void * __ps_86 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_87 = (hamt_slkeyeq((void *)(intptr_t)(__ps_86)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_824 = __ps_87;
            (void)keyeq_824;
            void * __ps_88 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_89 = (map_hyeq_hyloop((void *)(intptr_t)(iter_823), (void *)(intptr_t)(__ps_88), (void *)(intptr_t)(keyeq_824), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_825 = __ps_89;
            (void)result_825;
...
static bool vec_hyeq_hyloop(int64_t x, int64_t y, int64_t i, int64_t len) {
        ...
        if ((i) == (len)) {
            ...
            bool __t92;
            int64_t __ps_93 = (vec_hyget(x, i));
            if (tur_panicking) return ((bool)0);
            int64_t __ps_94 = (vec_hyget(y, i));
            if (tur_panicking) return ((bool)0);
            bool __ps_95 = (__inst_Eq_eq_qu_int(__ps_93, __ps_94));
            if (tur_panicking) return ((bool)0);
            if (__ps_95) {
                bool __ps_96 = (vec_hyeq_hyloop(x, y, (i) + (INT64_C(1)), len));
                if (tur_panicking) return ((bool)0);
                __t92 = __ps_96;
            } else {
                __t92 = false;
...
static int64_t none() {
        int64_t __ps_97 = (ctor_Option_None());
        if (tur_panicking) return ((int64_t)0);
        return __ps_97;
}
...
static int64_t list_hyeq_qu__cps(int64_t l1, int64_t l2, int64_t cmp_fn, DK *__kont) {
    ...
    int64_t __t4;
    int64_t __t5;
    bool __ps_99 = (tnil_qu(l1));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t0 = __ps_99;
    if (__t0) {
        bool __ps_100 = (tnil_qu(l2));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_100;
        return dk_run(__kont, (intptr_t)(__t1));
    } else {
        bool __ps_101 = (tnil_qu(l2));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t2 = __ps_101;
        if (__t2) {
            return dk_run(__kont, (intptr_t)(false));
        } else {
            int64_t __ps_102 = (list_hyhead(l1));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_103 = (list_hyhead(l2));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_104 = ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), __ps_102, __ps_103));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t3 = __ps_104;
            if (__t3) {
                int64_t __ps_105 = (list_hytail(l1));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t4 = __ps_105;
                int64_t __ps_106 = (list_hytail(l2));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t5 = __ps_106;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        bool __t107;
        bool __ps_108 = (__inst_Eq_eq_qu_int((int64_t)((tur_adt_Cons *)(intptr_t)(c1))->head, (int64_t)((tur_adt_Cons *)(intptr_t)(c2))->head));
        if (tur_panicking) return ((bool)0);
        if (__ps_108) {
            bool __t109;
            {
                ...
                if ((t1_1103) == (INT64_C(0))) {
                    __t110 = (t2_1104) == (INT64_C(0));
                } else {
                    bool __t111;
                    if ((t2_1104) == (INT64_C(0))) {
                        __t111 = false;
                    } else {
                        bool __ps_112 = (cons_hyeq_hygo(t1_1103, t2_1104));
                        if (tur_panicking) return ((bool)0);
                        __t111 = __ps_112;
                    }
                    __t110 = __t111;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_118) {
            ...
            int64_t __t119;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                __auto_type __t124 = (__ps_123);
                TUR_REGION_NOTE_WORDS(&(__t124), sizeof(__t124));
                int64_t out_1119 = (int64_t)(intptr_t)(__t124);
                (void)out_1119;
                __t119 = out_1119;
            }
            __t117 = __t119;
...
static int64_t car(int64_t l) {
        int64_t __ps_125 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_125;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_126 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_126;
}

static bool null_qu(int64_t l) {
        bool __ps_127 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_127;
}

static int64_t length(int64_t l) {
        int64_t __ps_128 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_128;
}
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        __tur_tailcall:;
        bool __ps_129 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((bool)0);
        if (__ps_129) {
            {
                int64_t __ps_130 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                int64_t h_1190 = __ps_130;
                (void)h_1190;
                void * __ps_131 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1191 = __ps_131;
                (void)k_1191;
                bool __ps_132 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1190, (void *)(intptr_t)(k_1191), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_132) {
                    void * __t133 = iter;
                    void * __t134 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t136;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * __ps_138 = (hamt_sliter_hyalloc((void *)(intptr_t)(__ps_137)));
            if (tur_panicking) return ((bool)0);
            void * iter_1194 = __ps_138;
            (void)iter_1194;
            void * __ps_139 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_140 = (hamt_slkeyeq((void *)(intptr_t)(__ps_139)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1195 = __ps_140;
            (void)keyeq_1195;
            void * __ps_141 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_142 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1194), (void *)(intptr_t)(__ps_141), (void *)(intptr_t)(keyeq_1195)));
            if (tur_panicking) return ((bool)0);
            bool result_1196 = __ps_142;
            (void)result_1196;
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        int64_t __ps_145 = (set_hycount(s1));
        if (tur_panicking) return ((bool)0);
        int64_t __ps_146 = (set_hycount(s2));
        if (tur_panicking) return ((bool)0);
        bool __t144 = (__ps_145) == (__ps_146);
        if (__t144) {
            bool __ps_147 = (set_hyeq_hydriver(s1, s2));
            if (tur_panicking) return ((bool)0);
            __t144 = __ps_147;
        }
        return __t144;
...
static bool mutmap_hyeq_hyloop(int64_t m1, int64_t m2, int64_t i, int64_t cap, int64_t val_cmp) {
        ...
        if ((i) == (cap)) {
            ...
            bool __t149;
            bool __ps_150 = (mutmap_hyslot_hyoccupied_qu(m1, i));
            if (tur_panicking) return ((bool)0);
            if (__ps_150) {
                bool __t151;
                ...
                if (tur_panicking) return ((bool)0);
                bool __ps_154 = (mutmap_hyhas_qu(m2, __ps_152, __ps_153));
                if (tur_panicking) return ((bool)0);
                if (__ps_154) {
                    bool __t155;
                    int64_t __ps_156 = (mutmap_hyslot_hyvalue(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_157 = (mutmap_hyslot_hyhash(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_158 = (mutmap_hyslot_hykey(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_159 = (mutmap_hyget(m2, __ps_157, __ps_158));
                    if (tur_panicking) return ((bool)0);
                    bool __ps_160 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_156, __ps_159));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_160) {
                ...
                bool __ps_162 = (mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp)));
                if (tur_panicking) return ((bool)0);
                __t149 = __ps_162;
            }
            __t148 = __t149;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t163;
        {
            ...
            {
                tur_adt_Vec__int * __ps_165 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1324));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1325 = __ps_165;
                (void)_un_unv_1325;
        ...
        int64_t __ps_167 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t163))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_167;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_168 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_168);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t169;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1375 = __ps_170;
            (void)r_1375;
            int64_t __t171;
            bool __ps_172 = (schema_hydecode_hyok_qu(r_1375));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_172) {
                int64_t __ps_173 = (schema_hydecode_hyvalue(r_1375));
                if (tur_panicking) return ((int64_t)0);
                __t171 = __ps_173;
            } else {
                int64_t __ps_174 = (schema_hydecode_hyerrors(r_1375));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_175 = (schema_hydecode_hyabort(__ps_174));
                if (tur_panicking) return ((int64_t)0);
                __t171 = __ps_175;
            }
            __t169 = __t171;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_176 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_176;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t177;
        {
            int64_t __ps_178 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1434 = __ps_178;
            (void)m_1434;
            int64_t __ps_179 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1435 = __ps_179;
            (void)r_1435;
            bool __ps_180 = (bt_hyundo_hyto_ex(m_1434));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_180);
            int64_t __t181;
            __t181 = r_1435;
...
static const char * poly(int64_t x) {
        const char * __ps_187 = (__inst_Show_show_int(x));
        if (tur_panicking) return ((const char *)0);
        int64_t __ps_188 = (__inst_Ord_rank_int(x));
        if (tur_panicking) return ((const char *)0);
        const char * __ps_189 = (combine(__ps_187, __ps_188));
        if (tur_panicking) return ((const char *)0);
        return __ps_189;
}

static const char * use_hyboth(tur_poly_fn_t f) {
        const char * __ps_190 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_190);
        const char * __ps_191 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_191);
        const char * __t192;
        __t192 = "done";
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_193 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1457 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_193);
        int64_t __t194;
        __t194 = INT64_C(0);
