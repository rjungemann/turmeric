...
static int64_t poly_un_undict_un1381(int64_t, int64_t, int64_t);
...
static int64_t poly_un_undict_un1381(int64_t __dict_1382, int64_t __dict_1384, int64_t x) {
        const char * __ps_44 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1382)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_45 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1384)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1387(void * __poly_env_1388, int64_t __poly_x0_1390, int64_t __poly_x1_1392, int64_t __poly_x2_1394) {
        int64_t __ps_47 = (poly_un_undict_un1381(__poly_x0_1390, __poly_x1_1392, __poly_x2_1394));
        if (tur_panicking) return ((int64_t)0);
        return __ps_47;
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_79 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_792, (void *)(intptr_t)(k_793), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t81;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_797 = __ps_83;
            (void)iter_797;
            void * __ps_84 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_85 = (hamt_slkeyeq((void *)(intptr_t)(__ps_84)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_798 = __ps_85;
            (void)keyeq_798;
            void * __ps_86 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_87 = (map_hyeq_hyloop((void *)(intptr_t)(iter_797), (void *)(intptr_t)(__ps_86), (void *)(intptr_t)(keyeq_798), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_799 = __ps_87;
            (void)result_799;
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                if ((t1_1077) == (INT64_C(0))) {
                    __t108 = (t2_1078) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_1078) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        bool __ps_110 = (cons_hyeq_hygo(t1_1077, t2_1078));
                        if (tur_panicking) return ((bool)0);
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1093 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1093;
                __t117 = out_1093;
            }
            __t115 = __t117;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t126;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1168 = __ps_128;
            (void)iter_1168;
            void * __ps_129 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_130 = (hamt_slkeyeq((void *)(intptr_t)(__ps_129)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1169 = __ps_130;
            (void)keyeq_1169;
            void * __ps_131 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_132 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1168), (void *)(intptr_t)(__ps_131), (void *)(intptr_t)(keyeq_1169)));
            if (tur_panicking) return ((bool)0);
            bool result_1170 = __ps_132;
            (void)result_1170;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t153;
        {
            ...
            {
                tur_adt_Vec__int * __ps_155 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1297));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1298 = __ps_155;
                (void)_un_unv_1298;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1348 = __ps_160;
            (void)r_1348;
            int64_t __t161;
            bool __ps_162 = (schema_hydecode_hyok_qu(r_1348));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_162) {
                int64_t __ps_163 = (schema_hydecode_hyvalue(r_1348));
                if (tur_panicking) return ((int64_t)0);
                __t161 = __ps_163;
            } else {
                int64_t __ps_164 = (schema_hydecode_hyerrors(r_1348));
                if (tur_panicking) return ((int64_t)0);
...
static const char * poly(int64_t x) {
        const char * __ps_167 = (__inst_Show_show_int(x));
        if (tur_panicking) return ((const char *)0);
        int64_t __ps_168 = (__inst_Ord_rank_int(x));
        if (tur_panicking) return ((const char *)0);
        const char * __ps_169 = (combine(__ps_167, __ps_168));
        if (tur_panicking) return ((const char *)0);
        return __ps_169;
}

static const char * use_hyboth(tur_poly_fn_t f) {
        const char * __ps_170 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_170);
        const char * __ps_171 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_171);
        const char * __t172;
        __t172 = "done";
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_173 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1387 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_173);
        int64_t __t174;
        __t174 = INT64_C(0);
