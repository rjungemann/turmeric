...
static int64_t __poly_1321(void * __poly_env_1322, int64_t __poly_x0_1324, int64_t __poly_x1_1326, int64_t __poly_x2_1328) {
        int64_t __ps_45 = (poly_un_undict_un1315(__poly_x0_1324, __poly_x1_1326, __poly_x2_1328));
        if (tur_panicking) return ((int64_t)0);
        return __ps_45;
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_764, (void *)(intptr_t)(k_765), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_769), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_770), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            ...
            bool __t100;
            {
                ...
                if ((t1_1012) == (INT64_C(0))) {
                    ...
                    if ((t2_1013) == (INT64_C(0))) {
                        ...
                        bool __ps_103 = (cons_hyeq_hygo(t1_1012, t2_1013));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_103;
                    }
                    __t101 = __t102;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t119;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_125 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1103), (void *)(intptr_t)(__ps_124), (void *)(intptr_t)(keyeq_1104)));
            if (tur_panicking) return ((bool)0);
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t146;
        {
            ...
            {
                tur_adt_Vec__int * __ps_148 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1232));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            (void)r_1282;
            int64_t __t153;
            bool __ps_154 = (schema_hydecode_hyok_qu(r_1282));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_154) {
                int64_t __ps_155 = (schema_hydecode_hyvalue(r_1282));
                if (tur_panicking) return ((int64_t)0);
                __t153 = __ps_155;
            } else {
                int64_t __ps_156 = (schema_hydecode_hyerrors(r_1282));
                if (tur_panicking) return ((int64_t)0);
...
static const char * poly(int64_t x) {
        const char * __ps_159 = (__inst_Show_show_int(x));
        if (tur_panicking) return ((const char *)0);
        int64_t __ps_160 = (__inst_Ord_rank_int(x));
        if (tur_panicking) return ((const char *)0);
        const char * __ps_161 = (combine(__ps_159, __ps_160));
        if (tur_panicking) return ((const char *)0);
        return __ps_161;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_165 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1321 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_165);
        int64_t __t166;
        __t166 = INT64_C(0);
