...
static int64_t poly_un_undict_un1290(int64_t, int64_t, int64_t);
static int64_t __poly_1296(void *, int64_t, int64_t, int64_t);
...
static int64_t poly_un_undict_un1290(int64_t __dict_1291, int64_t __dict_1293, int64_t x) {
        __auto_type __ps_40 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1291)[0])(x));
        if (tur_panicking) return (int64_t){0};
        __auto_type __ps_41 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1293)[0])(x));
        if (tur_panicking) return (int64_t){0};
...
static int64_t __poly_1296(void * __poly_env_1297, int64_t __poly_x0_1299, int64_t __poly_x1_1301, int64_t __poly_x2_1303) {
        __auto_type __ps_43 = (poly_un_undict_un1290(__poly_x0_1299, __poly_x1_1301, __poly_x2_1303));
        if (tur_panicking) return (int64_t){0};
        return __ps_43;
}
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_71) {
            bool __t72;
            {
                ...
                (void)k_744;
                bool __t75;
                __auto_type __ps_76 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_743, (void *)(intptr_t)(k_744), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_76) {
                    bool __t77;
                    __auto_type __ps_78 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_79 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_743, (void *)(intptr_t)(k_744), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t82;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_748 = __ps_84;
            (void)iter_748;
            __auto_type __ps_85 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_86 = (hamt_slkeyeq((void *)(intptr_t)(__ps_85)));
            if (tur_panicking) return (bool){0};
            void * keyeq_749 = __ps_86;
            (void)keyeq_749;
            __auto_type __ps_87 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_88 = (map_hyeq_hyloop((void *)(intptr_t)(iter_748), (void *)(intptr_t)(__ps_87), (void *)(intptr_t)(keyeq_749), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_750 = __ps_88;
            (void)result_750;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                bool __t108;
                if ((t1_987) == (INT64_C(0))) {
                    __t108 = (t2_988) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_988) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        __auto_type __ps_110 = (cons_hyeq_hygo(t1_987, t2_988));
                        if (tur_panicking) return (bool){0};
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_996 = (int64_t)(intptr_t)(__ps_118);
                (void)out_996;
                __t113 = out_996;
            }
            __t111 = __t113;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_120) {
            ...
            int64_t __t121;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1003 = (int64_t)(intptr_t)(__ps_125);
                (void)out_1003;
                __t121 = out_1003;
            }
            __t119 = __t121;
        ...
        if (__ps_130) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1074 = __ps_131;
                (void)h_1074;
                __auto_type __ps_132 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1075 = __ps_132;
                (void)k_1075;
                __auto_type __ps_133 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1074, (void *)(intptr_t)(k_1075), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_133) {
                    void * __t134 = iter;
                    void * __t135 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t137;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1078 = __ps_139;
            (void)iter_1078;
            __auto_type __ps_140 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_141 = (hamt_slkeyeq((void *)(intptr_t)(__ps_140)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1079 = __ps_141;
            (void)keyeq_1079;
            __auto_type __ps_142 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_143 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1078), (void *)(intptr_t)(__ps_142), (void *)(intptr_t)(keyeq_1079)));
            if (tur_panicking) return (bool){0};
            bool result_1080 = __ps_143;
            (void)result_1080;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t164;
        {
            ...
            {
                __auto_type __ps_166 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1207));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1208 = __ps_166;
                (void)_un_unv_1208;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t169;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1257 = __ps_170;
            (void)r_1257;
            int64_t __t171;
            __auto_type __ps_172 = (schema_hydecode_hyok_qu(r_1257));
            if (tur_panicking) return (int64_t){0};
            if (__ps_172) {
                __auto_type __ps_173 = (schema_hydecode_hyvalue(r_1257));
                if (tur_panicking) return (int64_t){0};
                __t171 = __ps_173;
            } else {
                __auto_type __ps_174 = (schema_hydecode_hyerrors(r_1257));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_183 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1296 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_183);
        int64_t __t184;
        __t184 = INT64_C(0);
