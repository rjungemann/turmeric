...
static int64_t poly_un_undict_un1636(int64_t, int64_t, int64_t);
static int64_t __poly_1642(void *, int64_t, int64_t, int64_t);
...
static int64_t poly_un_undict_un1636(int64_t __dict_1637, int64_t __dict_1639, int64_t x) {
        const char * __ps_62 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1637)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_63 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1639)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1642(void * __poly_env_1643, int64_t __poly_x0_1645, int64_t __poly_x1_1647, int64_t __poly_x2_1649) {
        return poly_un_undict_un1636(__poly_x0_1645, __poly_x1_1647, __poly_x2_1649);
}
...
__tur_cps_self:;
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_1000 = __ps_71;
        bool __ps_72 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_999, (void *)(intptr_t)(k_1000), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_72;
        if (__t1) {
            int64_t __ps_73 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_74 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_999, (void *)(intptr_t)(k_1000), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
            bool __ps_75 = (((bool)((int64_t (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_73, __ps_74)));
            if (tur_panicking) return ((int64_t)0);
            __t2 = __ps_75;
            if (__t2) {
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t76;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1004 = __ps_78;
            (void)iter_1004;
            void * __ps_79 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_80 = (hamt_slkeyeq((void *)(intptr_t)(__ps_79)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1005 = __ps_80;
            (void)keyeq_1005;
            void * __ps_81 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_82 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1004), (void *)(intptr_t)(__ps_81), (void *)(intptr_t)(keyeq_1005), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1006 = __ps_82;
            (void)result_1006;
...
__tur_cps_self:;
    ...
    if (__t0) {
        ...
        if (__t2) {
            ...
            if (tur_panicking) return ((int64_t)0);
            bool __ps_96 = (((bool)(*( tur_thunk_int64_t_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), __ps_94, __ps_95)));
            if (tur_panicking) return ((int64_t)0);
            __t3 = __ps_96;
            if (__t3) {
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_100) {
            bool __t101;
            {
                ...
                (void)t2_1297;
                bool __t102;
                bool __ps_103 = (tnil_qu(t1_1296));
                if (tur_panicking) return ((bool)0);
                if (__ps_103) {
                    bool __ps_104 = (tnil_qu(t2_1297));
                    if (tur_panicking) return ((bool)0);
                    __t102 = __ps_104;
                } else {
                    bool __t105;
                    bool __ps_106 = (tnil_qu(t2_1297));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_106) {
                        __t105 = false;
                    } else {
                        bool __ps_107 = (cons_hyeq_hygo(t1_1296, t2_1297));
                        if (tur_panicking) return ((bool)0);
                        __t105 = __ps_107;
                    }
                    __t102 = __t105;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                int64_t out_1312 = (int64_t)(intptr_t)(__ps_118);
                (void)out_1312;
                __t114 = out_1312;
            }
            __t112 = __t114;
        ...
        if (__ps_119) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1383 = __ps_120;
                (void)h_1383;
                void * __ps_121 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1384 = __ps_121;
                (void)k_1384;
                bool __ps_122 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1383, (void *)(intptr_t)(k_1384), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_122) {
                    void * __t123 = iter;
                    void * __t124 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t126;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1387 = __ps_128;
            (void)iter_1387;
            void * __ps_129 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_130 = (hamt_slkeyeq((void *)(intptr_t)(__ps_129)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1388 = __ps_130;
            (void)keyeq_1388;
            void * __ps_131 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_132 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1387), (void *)(intptr_t)(__ps_131), (void *)(intptr_t)(keyeq_1388)));
            if (tur_panicking) return ((bool)0);
            bool result_1389 = __ps_132;
            (void)result_1389;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t153;
        {
            ...
            {
                tur_adt_Vec__int * __ps_155 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1519));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1520 = __ps_155;
                (void)_un_unv_1520;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1570 = __ps_158;
            (void)r_1570;
            bool __ps_159 = (schema_hydecode_hyok_qu(r_1570));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_159) {
                return schema_hydecode_hyvalue(r_1570);
            } else {
                int64_t __ps_160 = (schema_hydecode_hyerrors(r_1570));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t162;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1621 = __ps_163;
            (void)m_1621;
            tur_frame __frame_164;
            tur_frame_init(&__frame_164, NULL);
            struct __defer_env_165 __t167 = {.m = m_1621};
...
static const char * poly(int64_t x) {
        const char * __ps_175 = (__inst_Show_show_int(x));
        if (tur_panicking) return ((const char *)0);
        int64_t __ps_176 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((const char *)0);
        return combine(__ps_175, __ps_176);
}

static const char * use_hyboth(tur_poly_fn_t f) {
        const char * __ps_177 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_177);
        const char * __ps_178 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_178);
        const char * __t179;
        __t179 = "done";
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_180 = (use_hyboth((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1642 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_180);
        int64_t __t181;
        __t181 = INT64_C(0);
