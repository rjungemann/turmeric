...
static int64_t poly_un_undict_un1315(int64_t __dict_1316, int64_t __dict_1318, int64_t x) {
        const char * __ps_42 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1316)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_43 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1318)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static const char * use_hyboth(tur_poly_fn_t f) {
        const char * __ps_162 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_162);
        const char * __ps_163 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Ord_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_163);
        const char * __t164;
        __t164 = "done";
