...
int main() {
        {
            int64_t x_214 = INT64_C(21);
            (void)x_214;
            {
                const void * r_215 = &x_214;
                (void)r_215;
                {
                    struct __env_218 *__t1 = (struct __env_218 *)malloc(sizeof(struct __env_218));
                    __t1->__fn = (int64_t)(intptr_t)__fn_216;
                    __t1->r = r_215;
                    void *__t2 = __t1;
                    void * f_221 = __t2;
                    (void)f_221;
