...
struct __env_212 { int64_t __fn; const void * r; };
static int64_t __fn_210(void * __env_p_213) {
        struct __env_212 *__env___env_212 = (struct __env_212 *)__env_p_213;
        int64_t __t0 = *((int64_t *)__env___env_212->r);
        return __t0;
}
...
int main() {
        {
            int64_t x_208 = INT64_C(21);
            (void)x_208;
            {
                const void * r_209 = &x_208;
                (void)r_209;
                {
                    struct __env_212 *__t1 = (struct __env_212 *)malloc(sizeof(struct __env_212));
                    __t1->__fn = (int64_t)(intptr_t)__fn_210;
                    __t1->r = r_209;
                    void *__t2 = __t1;
                    void * f_215 = __t2;
                    (void)f_215;
                    printf("%lld\n", (long long)(__fn_210(f_215)));
                }
            }
        }
        int64_t __t3;
