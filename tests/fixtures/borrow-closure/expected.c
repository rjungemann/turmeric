...
struct __env_200 { int64_t __fn; const void * r; };
static int64_t __fn_198(void * __env_p_201) {
        struct __env_200 *__env___env_200 = (struct __env_200 *)__env_p_201;
        int64_t __t0 = *((int64_t *)__env___env_200->r);
        return __t0;
}
...
int main() {
        {
            int64_t x_196 = INT64_C(21);
            (void)x_196;
            {
                const void * r_197 = &x_196;
                (void)r_197;
                {
                    struct __env_200 *__t1 = (struct __env_200 *)malloc(sizeof(struct __env_200));
                    __t1->__fn = (int64_t)(intptr_t)__fn_198;
                    __t1->r = r_197;
                    void *__t2 = __t1;
                    void * f_203 = __t2;
                    (void)f_203;
                    printf("%lld\n", (long long)(__fn_198(f_203)));
                }
            }
        }
        int64_t __t3;
