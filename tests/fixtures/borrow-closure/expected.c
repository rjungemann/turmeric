...
struct __env_265 { int64_t __fn; const void * r; };
static int64_t __fn_263(void * __env_p_266) {
        struct __env_265 *__env___env_265 = (struct __env_265 *)__env_p_266;
        int64_t __t0 = *((int64_t *)__env___env_265->r);
        return __t0;
}
...
int main() {
        {
            int64_t x_261 = INT64_C(21);
            (void)x_261;
            {
                const void * r_262 = &x_261;
                (void)r_262;
                {
                    struct __env_265 *__t1 = (struct __env_265 *)malloc(sizeof(struct __env_265));
                    __t1->__fn = (int64_t)(intptr_t)__fn_263;
                    __t1->r = r_262;
                    void *__t2 = __t1;
                    void * f_268 = __t2;
                    (void)f_268;
                    printf("%lld\n", (long long)(__fn_263(f_268)));
                }
            }
        }
        int64_t __t3;
