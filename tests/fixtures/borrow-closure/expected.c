...
int main() {
        {
            int64_t x_213 = INT64_C(21);
            (void)x_213;
            {
                const void * r_214 = &x_213;
                (void)r_214;
                {
                    struct __env_217 *__t1 = (struct __env_217 *)malloc(sizeof(struct __env_217));
                    __t1->__fn = (int64_t)(intptr_t)__fn_215;
                    __t1->r = r_214;
                    void *__t2 = __t1;
                    void * f_220 = __t2;
                    (void)f_220;
