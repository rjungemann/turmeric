...
struct __env_620 { int64_t __fn; const void * r; };
static int64_t __fn_618(void * __env_p_621) {
        struct __env_620 *__env___env_620 = (struct __env_620 *)__env_p_621;
        int64_t __t0 = *((int64_t *)__env___env_620->r);
        return __t0;
}
...
int main() {
        {
            int64_t x_616 = INT64_C(21);
            (void)x_616;
            {
                const void * r_617 = &x_616;
                (void)r_617;
                {
                    struct __env_620 *__t1 = (struct __env_620 *)malloc(sizeof(struct __env_620));
                    __t1->__fn = (int64_t)(intptr_t)__fn_618;
                    __t1->r = r_617;
                    void *__t2 = __t1;
                    void * f_623 = __t2;
                    (void)f_623;
                    printf("%lld\n", (long long)(__fn_618(f_623)));
                }
            }
        }
        int64_t __t3;
