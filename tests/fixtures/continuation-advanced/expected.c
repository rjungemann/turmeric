...
static bool __fn_986(int64_t, int64_t);
...
static int64_t __fn_1289(void *, int64_t);
...
static bool __fn_986(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_986;
        void *__t15 = __t14;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_1117;
            void *__t18 = __t17;
...
struct __env_1279 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_1277(void * __env_p_1280, int64_t v) {
        struct __env_1279 *__env___env_1279 = (struct __env_1279 *)__env_p_1280;
        return (__env___env_1279->x) + (v);
}

static int64_t __fn_1283(int64_t v) {
        return INT64_C(42);
}

struct __env_1291 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_1289(void * __env_p_1292, int64_t v) {
        struct __env_1291 *__env___env_1291 = (struct __env_1291 *)__env_p_1292;
        return (__env___env_1291->a) + ((__env___env_1291->b) + ((__env___env_1291->c) + (v)));
}
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            int64_t __t31;
            {
                int64_t out_990 = (int64_t)(intptr_t)(tcons__spec__tur_adt_Cons__int___int64_t_int64_t((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f))));
                (void)out_990;
                __t31 = out_990;
            }
            __t30 = __t31;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            int64_t __t33;
            {
                int64_t out_997 = (int64_t)(intptr_t)(tcons__spec__tur_adt_Cons__int___int64_t_int64_t(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2)));
                (void)out_997;
                __t33 = out_997;
            }
            __t32 = __t33;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_1062 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_1062;
                void * k_1063 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_1063;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1062, (void *)(intptr_t)(k_1063), (void *)(intptr_t)(keyeq))) {
                    void * __t34 = iter;
                    void * __t35 = s2_hamt;
                    void * __t36 = keyeq;
                    iter = __t34;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t37;
        {
            void * iter_1066 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_1066;
            void * keyeq_1067 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_1067;
            bool result_1068 = set_hyeq_hyloop((void *)(intptr_t)(iter_1066), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_1067));
            (void)result_1068;
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        bool __t39 = (set_hycount(s1)) == (set_hycount(s2));
        if (__t39) {
            __t39 = set_hyeq_hydriver(s1, s2);
        }
        return __t39;
}
            ...
            if (mutmap_hyslot_hyoccupied_qu(m1, i)) {
                ...
                if (mutmap_hyhas_qu(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i))) {
                    ...
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), mutmap_hyslot_hyvalue(m1, i), mutmap_hyget(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i)))) {
                        __t43 = mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp));
                    } else {
                        __t43 = false;
                    }
                    __t42 = __t43;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        int64_t __t44;
        {
            int64_t _un_unv_1196 = vec_hynew();
            (void)_un_unv_1196;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t48;
        {
            int64_t r_1245 = schema_hydecode(schema, node);
            (void)r_1245;
            int64_t __t49;
            if (schema_hydecode_hyok_qu(r_1245)) {
                __t49 = schema_hydecode_hyvalue(r_1245);
            } else {
                __t49 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1245));
            }
            __t48 = __t49;
        }
        return __t48;
...
static int64_t test_hynested_hyreset() {
        int64_t __t50 = __fn_1267(INT64_C(5));
        int64_t __t51 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t50), dk_prompt(1, dk_done())), 0);
        return (INT64_C(1)) + (__t51);
}

static int64_t test_hyshift_hyreturn_hydifferent() {
        int64_t __t52 = __fn_1270(INT64_C(7));
        int64_t __t53 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t52), dk_prompt(1, dk_done())), 0);
        return __t53;
}

static int64_t test_hymultiple_hyshifts() {
        int64_t __t54 = __fn_1273(INT64_C(3));
        int64_t __t55 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t54), dk_prompt(1, dk_done())), 0);
        return __t55;
}

static int64_t test_hyshift_hyignores_hyk() {
        int64_t __t56 = __fn_1283(INT64_C(10));
        int64_t __t57 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t56), dk_prompt(1, dk_done())), 0);
        return __t57;
}
...
static int64_t test_hydeeply_hynested_hyshift() {
        int64_t a_1285 = INT64_C(1);
        (void)a_1285;
        int64_t b_1286 = INT64_C(2);
        (void)b_1286;
        int64_t c_1287 = INT64_C(3);
        (void)c_1287;
        struct __env_1291 *__t59 = (struct __env_1291 *)malloc(sizeof(struct __env_1291));
        __t59->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1289;
        __t59->a = a_1285;
        __t59->b = b_1286;
        __t59->c = c_1287;
        void *__t60 = __t59;
        int64_t __t58 = __fn_1289(__t60, INT64_C(10));
        int64_t __t61 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t58), dk_prompt(1, dk_done())), 0);
        return __t61;
}
