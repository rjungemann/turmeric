...
static int64_t __fn_859(int64_t);
static int64_t __fn_862(int64_t);
static int64_t __fn_865(int64_t);
static int64_t __fn_869(void *, int64_t);
...
static int64_t __fn_859(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_862(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_865(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_871 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_869(void * __env_p_872, int64_t v) {
        struct __env_871 *__env___env_871 = (struct __env_871 *)__env_p_872;
        return (__env___env_871->x) + (v);
}
...
struct __env_883 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_881(void * __env_p_884, int64_t v) {
        struct __env_883 *__env___env_883 = (struct __env_883 *)__env_p_884;
        return (__env___env_883->a) + ((__env___env_883->b) + ((__env___env_883->c) + (v)));
}
...
static int64_t test_deeply_nested_shift() {
        int64_t a_877 = INT64_C(1);
        (void)a_877;
        int64_t b_878 = INT64_C(2);
        (void)b_878;
        int64_t c_879 = INT64_C(3);
        (void)c_879;
        struct __env_883 *__t34 = (struct __env_883 *)malloc(sizeof(struct __env_883));
        __t34->__fn = (tur_thunk_int64_t_int64_t_t)__fn_881;
        __t34->a = a_877;
        __t34->b = b_878;
        __t34->c = c_879;
        void *__t35 = __t34;
        int64_t __t33 = __fn_881(__t35, INT64_C(10));
