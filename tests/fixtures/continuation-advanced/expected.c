...
static int64_t __fn_1285(int64_t);
static int64_t __fn_1288(int64_t);
static int64_t __fn_1291(int64_t);
static int64_t __fn_1295(void *, int64_t);
static int64_t __fn_1301(int64_t);
...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t3) {
            ...
            *(void (**)(void *))__t7 = 0;
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_759;
            void *__t8 = __t6;
...
static int64_t __fn_1285(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_1288(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_1291(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_1297 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static void drop_glue___env_1297(void *__p) {
    struct __env_1297 *__e = (struct __env_1297 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1295(void * __env_p_1298, int64_t v) {
        struct __env_1297 *__env___env_1297 = (struct __env_1297 *)__env_p_1298;
        return (__env___env_1297->x) + (v);
}

static int64_t __fn_1301(int64_t v) {
        return INT64_C(42);
}

struct __env_1309 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static void drop_glue___env_1309(void *__p) {
    struct __env_1309 *__e = (struct __env_1309 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1307(void * __env_p_1310, int64_t v) {
        struct __env_1309 *__env___env_1309 = (struct __env_1309 *)__env_p_1310;
        return (__env___env_1309->a) + ((__env___env_1309->b) + ((__env___env_1309->c) + (v)));
}
...
static int64_t map_hyeq_hyloop__cps(void * iter_742, void * m2_hyhamt_743, void * keyeq_744, int64_t val_cmp, DK *__kont);
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_746, (void *)(intptr_t)(k_747), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static intptr_t map_hyeq_hyloop_j2(intptr_t env, intptr_t k_747__slot, DK *__kont) {
    ...
    __ce_map_hyeq_hyloop_j3->f3 = h_746;
    __ce_map_hyeq_hyloop_j3->f4 = k_747;
    __ce_map_hyeq_hyloop_j3->f5 = keyeq;
    __dk_reap_ptr((intptr_t)__ce_map_hyeq_hyloop_j3);
    return hamt_slhas_hydynamic_qu__cps(m2_hamt, h_746, k_747, keyeq, __dk_reap_node(dk_frame_resume(map_hyeq_hyloop_j3, (intptr_t)__ce_map_hyeq_hyloop_j3, __kont))); /* cps->cps heap join */
}
typedef struct { int64_t f0; void * f1; void * f2; void * f3; } map_hyeq_hyloop_j1_env;
static intptr_t map_hyeq_hyloop_j1(intptr_t env, intptr_t h_746__slot, DK *__kont) {
    map_hyeq_hyloop_j1_env *__cap = (map_hyeq_hyloop_j1_env *)(intptr_t)env;
    int64_t val_cmp = __cap->f0;
    void * iter = __cap->f1;
    void * m2_hamt = __cap->f2;
    void * keyeq = __cap->f3;
    int64_t h_746 = (int64_t)(h_746__slot);
    ...
    __ce_map_hyeq_hyloop_j2->f3 = h_746;
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_751 = __ps_73;
            (void)iter_751;
            __auto_type __ps_74 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_75 = (hamt_slkeyeq((void *)(intptr_t)(__ps_74)));
            if (tur_panicking) return (bool){0};
            void * keyeq_752 = __ps_75;
            (void)keyeq_752;
            __auto_type __ps_76 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_751), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_752), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_753 = __ps_77;
            (void)result_753;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_751));
            bool __t78;
            __t78 = result_753;
            __t71 = __t78;
        }
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_95) {
            bool __t96;
            {
                ...
                bool __t97;
                if ((t1_993) == (INT64_C(0))) {
                    __t97 = (t2_994) == (INT64_C(0));
                } else {
                    bool __t98;
                    if ((t2_994) == (INT64_C(0))) {
                        __t98 = false;
                    } else {
                        __auto_type __ps_99 = (cons_hyeq_hygo(t1_993, t2_994));
                        if (tur_panicking) return (bool){0};
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_105) {
            ...
            int64_t __t106;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1009 = (int64_t)(intptr_t)(__ps_110);
                (void)out_1009;
                __t106 = out_1009;
            }
            __t104 = __t106;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1084 = __ps_117;
            (void)iter_1084;
            __auto_type __ps_118 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_119 = (hamt_slkeyeq((void *)(intptr_t)(__ps_118)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1085 = __ps_119;
            (void)keyeq_1085;
            __auto_type __ps_120 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1084), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1085)));
            if (tur_panicking) return (bool){0};
            bool result_1086 = __ps_121;
            (void)result_1086;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                __auto_type __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1213));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1214 = __ps_144;
                (void)_un_unv_1214;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1263 = __ps_148;
            (void)r_1263;
            int64_t __t149;
            __auto_type __ps_150 = (schema_hydecode_hyok_qu(r_1263));
            if (tur_panicking) return (int64_t){0};
            if (__ps_150) {
                __auto_type __ps_151 = (schema_hydecode_hyvalue(r_1263));
                if (tur_panicking) return (int64_t){0};
                __t149 = __ps_151;
            } else {
                __auto_type __ps_152 = (schema_hydecode_hyerrors(r_1263));
                if (tur_panicking) return (int64_t){0};
...
static intptr_t test_hynested_hyreset_s2(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t6;
    __auto_type __ps_155 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1285))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t6 = __ps_155;
...
static intptr_t test_hyshift_hyreturn_hydifferent_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    __auto_type __ps_156 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1288))(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_156;
...
static intptr_t test_hymultiple_hyshifts_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t4;
    __auto_type __ps_157 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1291))(INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t4 = __ps_157;
...
static intptr_t test_hyshift_hyignores_hyk_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    __auto_type __ps_158 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1301))(INT64_C(10)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_158;
    return (intptr_t)(__t2);
}
...
static intptr_t test_hydeeply_hynested_hyshift_s1(intptr_t env, DK *subk) {
    ...
    int64_t c_1305 = __cap->f0;
    int64_t b_1304 = __cap->f1;
    int64_t a_1303 = __cap->f2;
    int64_t v_1306;
    int64_t __t4;
    int64_t __t2;
    int64_t __t3;
...
static int64_t test_hydeeply_hynested_hyshift__cps(DK *__kont) {
    ...
    __ce_test_hydeeply_hynested_hyshift_s1->f0 = c_1305;
    __ce_test_hydeeply_hynested_hyshift_s1->f1 = b_1304;
    __ce_test_hydeeply_hynested_hyshift_s1->f2 = a_1303;
