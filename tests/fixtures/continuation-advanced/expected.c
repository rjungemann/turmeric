...
static int64_t __fn_895(int64_t);
static int64_t __fn_898(int64_t);
static int64_t __fn_901(int64_t);
static int64_t __fn_905(void *, int64_t);
static int64_t __fn_911(int64_t);
...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        __t2[1] = (int64_t)(intptr_t)__fn_587;
        void *__t3 = __t2;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            int64_t lx_626 = vec_hylen_hybyval(x);
            (void)lx_626;
            int64_t ly_627 = vec_hylen_hybyval(y);
            (void)ly_627;
            bool __t5;
            if ((lx_626) == (ly_627)) {
                __t5 = vec_hyeq_hyloop_hybyval(x, y, INT64_C(0), lx_626);
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_806 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_806;
                int64_t t2_807 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_807;
                if ((t1_806) == (INT64_C(0))) {
                    return (t2_807) == (INT64_C(0));
                } else {
                    if ((t2_807) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t12 = (*(int64_t *)(intptr_t)(t1_806));
                        int64_t __t13 = (*(int64_t *)(intptr_t)(t2_807));
                        x = __t12;
                        y = __t13;
                        goto __tur_tailcall;
                    }
...
static int64_t __fn_895(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_898(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_901(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_907 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_905(void * __env_p_908, int64_t v) {
        struct __env_907 *__env___env_907 = (struct __env_907 *)__env_p_908;
        return (__env___env_907->x) + (v);
}

static int64_t __fn_911(int64_t v) {
        return INT64_C(42);
}

struct __env_919 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_917(void * __env_p_920, int64_t v) {
        struct __env_919 *__env___env_919 = (struct __env_919 *)__env_p_920;
        return (__env___env_919->a) + ((__env___env_919->b) + ((__env___env_919->c) + (v)));
}
...
static bool vec_hyeq_hyloop(int64_t xi, int64_t yi, int64_t i, int64_t len, int64_t cmp) {
        ...
        if ((i) == (len)) {
            ...
            if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(cmp)))[0])((void *)(intptr_t)(cmp), vec_hyget(xi, i), vec_hyget(yi, i))) {
                __t17 = vec_hyeq_hyloop(xi, yi, (i) + (INT64_C(1)), len, (int64_t)(intptr_t)(cmp));
            } else {
                __t17 = false;
            }
            __t16 = __t17;
...
static bool vec_hyeq_hyloop_hybyval(int64_t x, int64_t y, int64_t i, int64_t len) {
        ...
        if ((i) == (len)) {
            ...
            if (__inst_Eq_eq_qu_int(vec_hydata_hyget_un_un((void *)(intptr_t)(((Vec *)(intptr_t)(x))->data), i), vec_hydata_hyget_un_un((void *)(intptr_t)(((Vec *)(intptr_t)(y))->data), i))) {
                __t19 = vec_hyeq_hyloop_hybyval(x, y, (i) + (INT64_C(1)), len);
            } else {
                __t19 = false;
            }
            __t18 = __t19;
...
static int64_t test_hydeeply_hynested_hyshift() {
        int64_t a_913 = INT64_C(1);
        (void)a_913;
        int64_t b_914 = INT64_C(2);
        (void)b_914;
        int64_t c_915 = INT64_C(3);
        (void)c_915;
        struct __env_919 *__t34 = (struct __env_919 *)malloc(sizeof(struct __env_919));
        __t34->__fn = (tur_thunk_int64_t_int64_t_t)__fn_917;
        __t34->a = a_913;
        __t34->b = b_914;
        __t34->c = c_915;
        void *__t35 = __t34;
        int64_t __t33 = __fn_917(__t35, INT64_C(10));
