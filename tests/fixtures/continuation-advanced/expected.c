...
static int64_t __fn_851(int64_t);
static int64_t __fn_854(int64_t);
static int64_t __fn_857(int64_t);
static int64_t __fn_861(void *, int64_t);
static int64_t __fn_867(int64_t);
static int64_t __fn_873(void *, int64_t);
...
static int64_t __fn_851(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_854(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_857(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_863 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_861(void * __env_p_864, int64_t v) {
        struct __env_863 *__env___env_863 = (struct __env_863 *)__env_p_864;
        return (__env___env_863->x) + (v);
}

static int64_t __fn_867(int64_t v) {
        return INT64_C(42);
}

struct __env_875 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_873(void * __env_p_876, int64_t v) {
        struct __env_875 *__env___env_875 = (struct __env_875 *)__env_p_876;
        return (__env___env_875->a) + ((__env___env_875->b) + ((__env___env_875->c) + (v)));
}
...
static int64_t test_nested_reset() {
        int64_t __t3 = __fn_851(INT64_C(5));
        return (INT64_C(1)) + ((INT64_C(10)) + (__t3));
}

static int64_t test_shift_return_different() {
        int64_t __t4 = __fn_854(INT64_C(7));
        return __t4;
}
...
static int64_t test_multiple_shifts() {
        int64_t __t5;
        {
            int64_t __t6 = __fn_857(INT64_C(3));
            int64_t x_859 = __t6;
            (void)x_859;
            struct __env_863 *__t8 = (struct __env_863 *)malloc(sizeof(struct __env_863));
            __t8->__fn = (tur_thunk_int64_t_int64_t_t)__fn_861;
            __t8->x = x_859;
            void *__t9 = __t8;
            int64_t __t7 = __fn_861(__t9, INT64_C(4));
            __t5 = __t7;
        }
        return __t5;
}
...
static int64_t test_shift_ignores_k() {
        int64_t __t10 = __fn_867(INT64_C(10));
        return __t10;
}
...
static int64_t test_deeply_nested_shift() {
        int64_t __t11;
        {
            int64_t a_869 = INT64_C(1);
            (void)a_869;
            int64_t b_870 = INT64_C(2);
            (void)b_870;
            int64_t c_871 = INT64_C(3);
            (void)c_871;
            struct __env_875 *__t13 = (struct __env_875 *)malloc(sizeof(struct __env_875));
            __t13->__fn = (tur_thunk_int64_t_int64_t_t)__fn_873;
            __t13->a = a_869;
            __t13->b = b_870;
            __t13->c = c_871;
            void *__t14 = __t13;
            int64_t __t12 = __fn_873(__t14, INT64_C(10));
            __t11 = __t12;
        }
        return __t11;
}
