...
static int64_t __fn_841(int64_t);
static int64_t __fn_844(int64_t);
static int64_t __fn_847(int64_t);
...
static int64_t __fn_841(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_844(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_847(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_853 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_851(void * __env_p_854, int64_t v) {
        struct __env_853 *__env___env_853 = (struct __env_853 *)__env_p_854;
        return (__env___env_853->x) + (v);
}
...
struct __env_865 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_863(void * __env_p_866, int64_t v) {
        struct __env_865 *__env___env_865 = (struct __env_865 *)__env_p_866;
        return (__env___env_865->a) + ((__env___env_865->b) + ((__env___env_865->c) + (v)));
}
...
static int64_t test_nested_reset() {
        int64_t __t3 = __fn_841(INT64_C(5));
        return (INT64_C(1)) + ((INT64_C(10)) + (__t3));
}

static int64_t test_shift_return_different() {
        int64_t __t4 = __fn_844(INT64_C(7));
        return __t4;
}
...
static int64_t test_multiple_shifts() {
        int64_t __t5;
        {
            int64_t __t6 = __fn_847(INT64_C(3));
            int64_t x_849 = __t6;
            (void)x_849;
            struct __env_853 *__t8 = (struct __env_853 *)malloc(sizeof(struct __env_853));
            __t8->__fn = (tur_thunk_int64_t_int64_t_t)__fn_851;
            __t8->x = x_849;
            void *__t9 = __t8;
            int64_t __t7 = __fn_851(__t9, INT64_C(4));
            __t5 = __t7;
        }
        return __t5;
}
...
static int64_t test_shift_ignores_k() {
        int64_t __t10 = __fn_857(INT64_C(10));
        return __t10;
}
...
static int64_t test_deeply_nested_shift() {
        int64_t __t11;
        {
            int64_t a_859 = INT64_C(1);
            (void)a_859;
            int64_t b_860 = INT64_C(2);
            (void)b_860;
            int64_t c_861 = INT64_C(3);
            (void)c_861;
            struct __env_865 *__t13 = (struct __env_865 *)malloc(sizeof(struct __env_865));
            __t13->__fn = (tur_thunk_int64_t_int64_t_t)__fn_863;
            __t13->a = a_859;
            __t13->b = b_860;
            __t13->c = c_861;
            void *__t14 = __t13;
            int64_t __t12 = __fn_863(__t14, INT64_C(10));
            __t11 = __t12;
        }
        return __t11;
}
