...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t3) {
            ...
            *(void (**)(void *))__t7 = 0;
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_831;
            void *__t8 = __t6;
            ...
            case 1: {
                ...
                bool __t16 = 0;
                {
                    ...
                    case 1: {
                        ...
                        bool __ps_17 = (__inst_Eq_eq_qu_int(vx_908, vy_909));
                        if (tur_panicking) return ((bool)0);
                        __t16 = __ps_17;
                        break;
                    }
            ...
            case 0: {
                ...
                bool __t20 = 0;
                {
                    ...
                    case 0: {
                        ...
                        bool __ps_21 = (__inst_Eq_eq_qu_int(vx_961, vy_962));
                        if (tur_panicking) return ((bool)0);
                        __t20 = __ps_21;
                        break;
                    }
            ...
            case 1: {
                ...
                bool __t22 = 0;
                {
                    ...
                    case 1: {
                        ...
                        bool __ps_23 = (__inst_Eq_eq_qu_int(ex_964, ey_966));
                        if (tur_panicking) return ((bool)0);
                        __t22 = __ps_23;
                        break;
                    }
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t30;
        {
            ...
            if ((t1_1108) == (INT64_C(0))) {
                __t31 = (t2_1109) == (INT64_C(0));
            } else {
                bool __t32;
                if ((t2_1109) == (INT64_C(0))) {
                    __t32 = false;
                } else {
                    bool __ps_33 = (cons_hyeq_hygo(t1_1108, t2_1109));
                    if (tur_panicking) return ((bool)0);
                    __t32 = __ps_33;
                }
                __t31 = __t32;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t36) {
            ...
            *(void (**)(void *))__t41 = 0;
            ...
            __t40[1] = (int64_t)(intptr_t)__fn_1244;
            void *__t42 = __t40;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_75 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t77;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_823 = __ps_79;
            (void)iter_823;
            void * __ps_80 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_81 = (hamt_slkeyeq((void *)(intptr_t)(__ps_80)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_824 = __ps_81;
            (void)keyeq_824;
            void * __ps_82 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_83 = (map_hyeq_hyloop((void *)(intptr_t)(iter_823), (void *)(intptr_t)(__ps_82), (void *)(intptr_t)(keyeq_824), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_825 = __ps_83;
            (void)result_825;
...
static int64_t none() {
        int64_t __ps_91 = (ctor_Option_None());
...
static int64_t list_hyeq_qu__cps(int64_t l1, int64_t l2, int64_t cmp_fn, DK *__kont) {
    ...
    int64_t __t4;
    int64_t __t5;
    bool __ps_93 = (tnil_qu(l1));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t0 = __ps_93;
    if (__t0) {
        bool __ps_94 = (tnil_qu(l2));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_94;
        ...
        if (__t2) {
            ...
            int64_t __ps_96 = (list_hyhead(l1));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_97 = (list_hyhead(l2));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_98 = ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), __ps_96, __ps_97));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t3 = __ps_98;
            if (__t3) {
                int64_t __ps_99 = (list_hytail(l1));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t4 = __ps_99;
                int64_t __ps_100 = (list_hytail(l2));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t5 = __ps_100;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        bool __t101;
        bool __ps_102 = (__inst_Eq_eq_qu_int((int64_t)((tur_adt_Cons *)(intptr_t)(c1))->head, (int64_t)((tur_adt_Cons *)(intptr_t)(c2))->head));
        if (tur_panicking) return ((bool)0);
        if (__ps_102) {
            bool __t103;
            {
                ...
                if ((t1_1103) == (INT64_C(0))) {
                    __t104 = (t2_1104) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_1104) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1103, t2_1104));
                        if (tur_panicking) return ((bool)0);
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1119 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1119;
                __t113 = out_1119;
            }
            __t111 = __t113;
...
static int64_t car(int64_t l) {
        int64_t __ps_118 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_118;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_119 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_119;
}

static bool null_qu(int64_t l) {
        bool __ps_120 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_120;
}

static int64_t length(int64_t l) {
        int64_t __ps_121 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_121;
}
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t122;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1194 = __ps_124;
            (void)iter_1194;
            void * __ps_125 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_126 = (hamt_slkeyeq((void *)(intptr_t)(__ps_125)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1195 = __ps_126;
            (void)keyeq_1195;
            void * __ps_127 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_128 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1194), (void *)(intptr_t)(__ps_127), (void *)(intptr_t)(keyeq_1195)));
            if (tur_panicking) return ((bool)0);
            bool result_1196 = __ps_128;
            (void)result_1196;
        ...
        if ((i) == (cap)) {
            ...
            if (__ps_136) {
                ...
                if (__ps_140) {
                    ...
                    if (tur_panicking) return ((bool)0);
                    bool __ps_146 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_142, __ps_145));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_146) {
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t149;
        {
            ...
            {
                tur_adt_Vec__int * __ps_151 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1323));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1324 = __ps_151;
                (void)_un_unv_1324;
        ...
        int64_t __ps_153 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t149))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_153;
}
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t155;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1374 = __ps_156;
            (void)r_1374;
            int64_t __t157;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1374));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                int64_t __ps_159 = (schema_hydecode_hyvalue(r_1374));
                if (tur_panicking) return ((int64_t)0);
                __t157 = __ps_159;
            } else {
                int64_t __ps_160 = (schema_hydecode_hyerrors(r_1374));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_161 = (schema_hydecode_hyabort(__ps_160));
                if (tur_panicking) return ((int64_t)0);
                __t157 = __ps_161;
            }
            __t155 = __t157;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_162 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_162;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t163;
        {
            int64_t __ps_164 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1433 = __ps_164;
            (void)m_1433;
            int64_t __ps_165 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1434 = __ps_165;
            (void)r_1434;
            bool __ps_166 = (bt_hyundo_hyto_ex(m_1433));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_166);
            int64_t __t167;
            __t167 = r_1434;
...
static intptr_t test_hynested_hyreset_s2(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t6;
    int64_t __ps_172 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1438))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t6 = __ps_172;
...
static intptr_t test_hyshift_hyreturn_hydifferent_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_173 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1441))(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_173;
...
static intptr_t test_hymultiple_hyshifts_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t4;
    int64_t __ps_174 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1444))(INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t4 = __ps_174;
...
static intptr_t test_hyshift_hyignores_hyk_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_175 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1454))(INT64_C(10)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_175;
    return (intptr_t)(__t2);
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_176 = (ctor_Cons_Cons__int(h, t));
