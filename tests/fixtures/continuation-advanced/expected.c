...
static int64_t __fn_888(int64_t);
static int64_t __fn_891(int64_t);
static int64_t __fn_894(int64_t);
static int64_t __fn_898(void *, int64_t);
static int64_t __fn_904(int64_t);
static int64_t __fn_910(void *, int64_t);
...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        __t2[1] = (int64_t)(intptr_t)__fn_585;
        void *__t3 = __t2;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            int64_t lx_619 = vec_hylen_hybyval(x);
            (void)lx_619;
            int64_t ly_620 = vec_hylen_hybyval(y);
            (void)ly_620;
            bool __t5;
            if ((lx_619) == (ly_620)) {
                __t5 = vec_hyeq_hyloop_hybyval(x, y, INT64_C(0), lx_619);
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static int64_t __fn_888(int64_t v) {
        return (v) * (INT64_C(2));
}
...
struct __env_900 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_898(void * __env_p_901, int64_t v) {
        struct __env_900 *__env___env_900 = (struct __env_900 *)__env_p_901;
        return (__env___env_900->x) + (v);
}

static int64_t __fn_904(int64_t v) {
        return INT64_C(42);
}

struct __env_912 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_910(void * __env_p_913, int64_t v) {
        struct __env_912 *__env___env_912 = (struct __env_912 *)__env_p_913;
        return (__env___env_912->a) + ((__env___env_912->b) + ((__env___env_912->c) + (v)));
}
...
static int64_t test_hydeeply_hynested_hyshift() {
        int64_t a_906 = INT64_C(1);
        (void)a_906;
        int64_t b_907 = INT64_C(2);
        (void)b_907;
        int64_t c_908 = INT64_C(3);
        (void)c_908;
        struct __env_912 *__t34 = (struct __env_912 *)malloc(sizeof(struct __env_912));
        __t34->__fn = (tur_thunk_int64_t_int64_t_t)__fn_910;
        __t34->a = a_906;
        __t34->b = b_907;
        __t34->c = c_908;
        void *__t35 = __t34;
        int64_t __t33 = __fn_910(__t35, INT64_C(10));
