...
static int64_t __fn_866(int64_t);
static int64_t __fn_869(int64_t);
static int64_t __fn_872(int64_t);
static int64_t __fn_876(void *, int64_t);
static int64_t __fn_882(int64_t);
...
static int64_t __fn_866(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_869(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_872(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_878 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_876(void * __env_p_879, int64_t v) {
        struct __env_878 *__env___env_878 = (struct __env_878 *)__env_p_879;
        return (__env___env_878->x) + (v);
}

static int64_t __fn_882(int64_t v) {
        return INT64_C(42);
}

struct __env_890 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_888(void * __env_p_891, int64_t v) {
        struct __env_890 *__env___env_890 = (struct __env_890 *)__env_p_891;
        return (__env___env_890->a) + ((__env___env_890->b) + ((__env___env_890->c) + (v)));
}
...
static int64_t test_hydeeply_hynested_hyshift() {
        int64_t a_884 = INT64_C(1);
        (void)a_884;
        int64_t b_885 = INT64_C(2);
        (void)b_885;
        int64_t c_886 = INT64_C(3);
        (void)c_886;
        struct __env_890 *__t30 = (struct __env_890 *)malloc(sizeof(struct __env_890));
        __t30->__fn = (tur_thunk_int64_t_int64_t_t)__fn_888;
        __t30->a = a_884;
        __t30->b = b_885;
        __t30->c = c_886;
        void *__t31 = __t30;
        int64_t __t29 = __fn_888(__t31, INT64_C(10));
