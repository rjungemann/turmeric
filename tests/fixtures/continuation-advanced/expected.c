        ...
        if (__ps_122) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1190 = __ps_123;
                (void)h_1190;
                void * __ps_124 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1191 = __ps_124;
                (void)k_1191;
                bool __ps_125 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1190, (void *)(intptr_t)(k_1191), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_125) {
                    void * __t126 = iter;
                    void * __t127 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t129;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1194 = __ps_131;
            (void)iter_1194;
            void * __ps_132 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_133 = (hamt_slkeyeq((void *)(intptr_t)(__ps_132)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1195 = __ps_133;
            (void)keyeq_1195;
            void * __ps_134 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_135 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1194), (void *)(intptr_t)(__ps_134), (void *)(intptr_t)(keyeq_1195)));
            if (tur_panicking) return ((bool)0);
            bool result_1196 = __ps_135;
            (void)result_1196;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t156;
        {
            ...
            {
                tur_adt_Vec__int * __ps_158 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1323));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1324 = __ps_158;
                (void)_un_unv_1324;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t162;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1374 = __ps_163;
            (void)r_1374;
            int64_t __t164;
            bool __ps_165 = (schema_hydecode_hyok_qu(r_1374));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_165) {
                int64_t __ps_166 = (schema_hydecode_hyvalue(r_1374));
                if (tur_panicking) return ((int64_t)0);
                __t164 = __ps_166;
            } else {
                int64_t __ps_167 = (schema_hydecode_hyerrors(r_1374));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t test_hynested_hyreset_s2(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t6;
    int64_t __ps_179 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1438))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t6 = __ps_179;
...
static intptr_t test_hyshift_hyreturn_hydifferent_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_180 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1441))(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_180;
...
static intptr_t test_hymultiple_hyshifts_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t4;
    int64_t __ps_181 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1444))(INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t4 = __ps_181;
...
static intptr_t test_hyshift_hyignores_hyk_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_182 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1454))(INT64_C(10)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_182;
    return (intptr_t)(__t2);
}
