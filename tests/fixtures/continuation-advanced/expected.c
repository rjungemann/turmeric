...
static int64_t __fn_1336(int64_t);
static int64_t __fn_1339(int64_t);
static int64_t __fn_1342(int64_t);
static int64_t __fn_1346(void *, int64_t);
static int64_t __fn_1352(int64_t);
...
static int64_t __fn_1336(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_1339(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_1342(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_1348 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static void drop_glue___env_1348(void *__p) {
    struct __env_1348 *__e = (struct __env_1348 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1346(void * __env_p_1349, int64_t v) {
        struct __env_1348 *__env___env_1348 = (struct __env_1348 *)__env_p_1349;
        return (__env___env_1348->x) + (v);
}

static int64_t __fn_1352(int64_t v) {
        return INT64_C(42);
}

struct __env_1360 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static void drop_glue___env_1360(void *__p) {
    struct __env_1360 *__e = (struct __env_1360 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1358(void * __env_p_1361, int64_t v) {
        struct __env_1360 *__env___env_1360 = (struct __env_1360 *)__env_p_1361;
        return (__env___env_1360->a) + ((__env___env_1360->b) + ((__env___env_1360->c) + (v)));
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_794, (void *)(intptr_t)(k_795), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_799 = __ps_77;
            (void)iter_799;
            void * __ps_78 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_79 = (hamt_slkeyeq((void *)(intptr_t)(__ps_78)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_800 = __ps_79;
            (void)keyeq_800;
            void * __ps_80 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_799), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_800), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_801 = __ps_81;
            (void)result_801;
...
static int64_t none() {
        int64_t __ps_89 = (ctor_Option(false, ((int64_t)0)));
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if ((t1_1043) == (INT64_C(0))) {
                    __t101 = (t2_1044) == (INT64_C(0));
                } else {
                    bool __t102;
                    if ((t2_1044) == (INT64_C(0))) {
                        __t102 = false;
                    } else {
                        bool __ps_103 = (cons_hyeq_hygo(t1_1043, t2_1044));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_103;
                    }
                    __t101 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_109) {
            ...
            int64_t __t110;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1059 = (int64_t)(intptr_t)(__ps_114);
                (void)out_1059;
                __t110 = out_1059;
            }
            __t108 = __t110;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t119;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1134 = __ps_121;
            (void)iter_1134;
            void * __ps_122 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_123 = (hamt_slkeyeq((void *)(intptr_t)(__ps_122)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1135 = __ps_123;
            (void)keyeq_1135;
            void * __ps_124 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_125 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1134), (void *)(intptr_t)(__ps_124), (void *)(intptr_t)(keyeq_1135)));
            if (tur_panicking) return ((bool)0);
            bool result_1136 = __ps_125;
            (void)result_1136;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t146;
        {
            ...
            {
                tur_adt_Vec__int * __ps_148 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1263));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1264 = __ps_148;
                (void)_un_unv_1264;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t152;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1314 = __ps_153;
            (void)r_1314;
            int64_t __t154;
            bool __ps_155 = (schema_hydecode_hyok_qu(r_1314));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_155) {
                int64_t __ps_156 = (schema_hydecode_hyvalue(r_1314));
                if (tur_panicking) return ((int64_t)0);
                __t154 = __ps_156;
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1314));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t test_hynested_hyreset_s2(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t6;
    int64_t __ps_160 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1336))(INT64_C(5)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t6 = __ps_160;
...
static intptr_t test_hyshift_hyreturn_hydifferent_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_161 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1339))(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_161;
...
static intptr_t test_hymultiple_hyshifts_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t4;
    int64_t __ps_162 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1342))(INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t4 = __ps_162;
...
static intptr_t test_hyshift_hyignores_hyk_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_163 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1352))(INT64_C(10)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t2 = __ps_163;
    return (intptr_t)(__t2);
}
...
static intptr_t test_hydeeply_hynested_hyshift_s1(intptr_t env, DK *subk) {
    ...
    int64_t c_1356 = __cap->f0;
    int64_t b_1355 = __cap->f1;
    int64_t a_1354 = __cap->f2;
    int64_t v_1357;
    int64_t __t4;
    int64_t __t2;
    int64_t __t3;
...
static int64_t test_hydeeply_hynested_hyshift__cps(DK *__kont) {
    ...
    __ce_test_hydeeply_hynested_hyshift_s1->f0 = c_1356;
    __ce_test_hydeeply_hynested_hyshift_s1->f1 = b_1355;
    __ce_test_hydeeply_hynested_hyshift_s1->f2 = a_1354;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_164 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_165 = (vec_new__spec__tur_adt_Vec__int__());
