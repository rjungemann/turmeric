...
static bool __fn_629(int64_t, int64_t);
...
static int64_t __fn_883(int64_t);
static int64_t __fn_886(int64_t);
static int64_t __fn_889(int64_t);
static int64_t __fn_893(void *, int64_t);
static int64_t __fn_899(int64_t);
static int64_t __fn_905(void *, int64_t);
...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        __t2[1] = (int64_t)(intptr_t)__fn_578;
        void *__t3 = __t2;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        __t4[1] = (int64_t)(intptr_t)__fn_602;
        void *__t5 = __t4;
...
static bool __fn_629(int64_t a, int64_t b) {
        return (a) == (b);
}
...
static bool __inst_Eq_eq_qu_Option(int64_t x, int64_t y) {
        ...
        __t6[1] = (int64_t)(intptr_t)__fn_629;
        void *__t7 = __t6;
...
static int64_t __fn_883(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_886(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_889(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_895 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_893(void * __env_p_896, int64_t v) {
        struct __env_895 *__env___env_895 = (struct __env_895 *)__env_p_896;
        return (__env___env_895->x) + (v);
}

static int64_t __fn_899(int64_t v) {
        return INT64_C(42);
}

struct __env_907 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_905(void * __env_p_908, int64_t v) {
        struct __env_907 *__env___env_907 = (struct __env_907 *)__env_p_908;
        return (__env___env_907->a) + ((__env___env_907->b) + ((__env___env_907->c) + (v)));
}
...
static int64_t test_nested_reset() {
        int64_t __t25 = __fn_883(INT64_C(5));
        int64_t __t26 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t25), dk_prompt(1, dk_done())), 0);
        return (INT64_C(1)) + (__t26);
}

static int64_t test_shift_return_different() {
        int64_t __t27 = __fn_886(INT64_C(7));
        int64_t __t28 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t27), dk_prompt(1, dk_done())), 0);
        return __t28;
}

static int64_t test_multiple_shifts() {
        int64_t __t29 = __fn_889(INT64_C(3));
        int64_t __t30 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t29), dk_prompt(1, dk_done())), 0);
        return __t30;
}

static int64_t test_shift_ignores_k() {
        int64_t __t31 = __fn_899(INT64_C(10));
        int64_t __t32 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t31), dk_prompt(1, dk_done())), 0);
        return __t32;
}
...
static int64_t test_deeply_nested_shift() {
        int64_t a_901 = INT64_C(1);
        (void)a_901;
        int64_t b_902 = INT64_C(2);
        (void)b_902;
        int64_t c_903 = INT64_C(3);
        (void)c_903;
        struct __env_907 *__t34 = (struct __env_907 *)malloc(sizeof(struct __env_907));
        __t34->__fn = (tur_thunk_int64_t_int64_t_t)__fn_905;
        __t34->a = a_901;
        __t34->b = b_902;
        __t34->c = c_903;
        void *__t35 = __t34;
        int64_t __t33 = __fn_905(__t35, INT64_C(10));
        int64_t __t36 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t33), dk_prompt(1, dk_done())), 0);
        return __t36;
}
