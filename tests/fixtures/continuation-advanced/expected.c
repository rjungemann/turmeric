...
static int64_t __fn_874(void *, int64_t);
static int64_t __fn_880(int64_t);
static int64_t __fn_886(void *, int64_t);
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_782 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_782;
                int64_t t2_783 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_783;
                if ((t1_782) == (INT64_C(0))) {
                    return (t2_783) == (INT64_C(0));
                } else {
                    if ((t2_783) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t12 = (*(int64_t *)(intptr_t)(t1_782));
                        int64_t __t13 = (*(int64_t *)(intptr_t)(t2_783));
                        x = __t12;
                        y = __t13;
                        goto __tur_tailcall;
                    }
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_861;
        void *__t15 = __t14;
...
static int64_t __fn_864(int64_t v) {
        return (v) * (INT64_C(2));
}
...
struct __env_876 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_874(void * __env_p_877, int64_t v) {
        struct __env_876 *__env___env_876 = (struct __env_876 *)__env_p_877;
        return (__env___env_876->x) + (v);
}
...
struct __env_888 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_886(void * __env_p_889, int64_t v) {
        struct __env_888 *__env___env_888 = (struct __env_888 *)__env_p_889;
        return (__env___env_888->a) + ((__env___env_888->b) + ((__env___env_888->c) + (v)));
}
...
static int64_t test_hydeeply_hynested_hyshift() {
        int64_t a_882 = INT64_C(1);
        (void)a_882;
        int64_t b_883 = INT64_C(2);
        (void)b_883;
        int64_t c_884 = INT64_C(3);
        (void)c_884;
        struct __env_888 *__t30 = (struct __env_888 *)malloc(sizeof(struct __env_888));
        __t30->__fn = (tur_thunk_int64_t_int64_t_t)__fn_886;
        __t30->a = a_882;
        __t30->b = b_883;
        __t30->c = c_884;
        void *__t31 = __t30;
        int64_t __t29 = __fn_886(__t31, INT64_C(10));
