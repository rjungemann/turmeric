...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                bool __t108;
                if ((t1_981) == (INT64_C(0))) {
                    __t108 = (t2_982) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_982) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        __auto_type __ps_110 = (cons_hyeq_hygo(t1_981, t2_982));
                        if (tur_panicking) return (bool){0};
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_990 = (int64_t)(intptr_t)(__ps_118);
                (void)out_990;
                __t113 = out_990;
            }
            __t111 = __t113;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_120) {
            ...
            int64_t __t121;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_997 = (int64_t)(intptr_t)(__ps_125);
                (void)out_997;
                __t121 = out_997;
            }
            __t119 = __t121;
        ...
        if (__ps_130) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1068 = __ps_131;
                (void)h_1068;
                __auto_type __ps_132 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1069 = __ps_132;
                (void)k_1069;
                __auto_type __ps_133 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1068, (void *)(intptr_t)(k_1069), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_133) {
                    void * __t134 = iter;
                    void * __t135 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t137;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1072 = __ps_139;
            (void)iter_1072;
            __auto_type __ps_140 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_141 = (hamt_slkeyeq((void *)(intptr_t)(__ps_140)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1073 = __ps_141;
            (void)keyeq_1073;
            __auto_type __ps_142 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_143 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1072), (void *)(intptr_t)(__ps_142), (void *)(intptr_t)(keyeq_1073)));
            if (tur_panicking) return (bool){0};
            bool result_1074 = __ps_143;
            (void)result_1074;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t164;
        {
            ...
            {
                __auto_type __ps_166 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1201));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1202 = __ps_166;
                (void)_un_unv_1202;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t169;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1251 = __ps_170;
            (void)r_1251;
            int64_t __t171;
            __auto_type __ps_172 = (schema_hydecode_hyok_qu(r_1251));
            if (tur_panicking) return (int64_t){0};
            if (__ps_172) {
                __auto_type __ps_173 = (schema_hydecode_hyvalue(r_1251));
                if (tur_panicking) return (int64_t){0};
                __t171 = __ps_173;
            } else {
                __auto_type __ps_174 = (schema_hydecode_hyerrors(r_1251));
                if (tur_panicking) return (int64_t){0};
...
static int64_t test_hynested_hyreset() {
        int64_t __t177 = __fn_1273(INT64_C(5));
        int64_t __t178 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t177), dk_prompt(1, dk_done())), 0);
        return (INT64_C(1)) + (__t178);
}

static int64_t test_hyshift_hyreturn_hydifferent() {
        int64_t __t179 = __fn_1276(INT64_C(7));
        int64_t __t180 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t179), dk_prompt(1, dk_done())), 0);
        return __t180;
}

static int64_t test_hymultiple_hyshifts() {
        int64_t __t181 = __fn_1279(INT64_C(3));
        int64_t __t182 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t181), dk_prompt(1, dk_done())), 0);
        return __t182;
}

static int64_t test_hyshift_hyignores_hyk() {
        int64_t __t183 = __fn_1289(INT64_C(10));
...
static int64_t test_hydeeply_hynested_hyshift() {
        ...
        (void)c_1293;
        struct __env_1297 *__t186 = (struct __env_1297 *)malloc(sizeof(struct __env_1297));
        __t186->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1295;
        __t186->a = a_1291;
        __t186->b = b_1292;
        __t186->c = c_1293;
        void *__t187 = __t186;
        int64_t __t185 = __fn_1295(__t187, INT64_C(10));
        int64_t __t188 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t185), dk_prompt(1, dk_done())), 0);
        return __t188;
}
