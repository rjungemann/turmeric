...
static int64_t __fn_1631(int64_t);
static int64_t __fn_1635(void *, int64_t);
static int64_t __fn_1641(int64_t);
...
static int64_t __fn_1631(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_1637 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
...
static int64_t __fn_1635(void * __env_p_1638, int64_t v) {
        ...
        return (__env___env_1637->x) + (v);
}

static int64_t __fn_1641(int64_t v) {
        return INT64_C(42);
}

struct __env_1649 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static void drop_glue___env_1649(void *__p) {
    struct __env_1649 *__e = (struct __env_1649 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1647(void * __env_p_1650, int64_t v) {
        struct __env_1649 *__env___env_1649 = (struct __env_1649 *)__env_p_1650;
        return (__env___env_1649->a) + ((__env___env_1649->b) + ((__env___env_1649->c) + (v)));
}
...
static intptr_t test_hynested_hyreset_s2(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t6;
    int64_t __ps_172 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1625))(INT64_C(5)));
    if (tur_panicking) return ((int64_t)0);
    __t6 = __ps_172;
...
static intptr_t test_hyshift_hyreturn_hydifferent_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_173 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1628))(INT64_C(7)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_173;
...
static intptr_t test_hymultiple_hyshifts_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t4;
    int64_t __ps_174 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1631))(INT64_C(3)));
    if (tur_panicking) return ((int64_t)0);
    __t4 = __ps_174;
...
static intptr_t test_hyshift_hyignores_hyk_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_175 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1641))(INT64_C(10)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_175;
    return (intptr_t)(__t2);
}
...
static intptr_t test_hydeeply_hynested_hyshift_s1(intptr_t env, DK *subk) {
    ...
    int64_t c_1645 = __cap->f0;
    int64_t b_1644 = __cap->f1;
    int64_t a_1643 = __cap->f2;
    int64_t v_1646;
    int64_t __t4;
    int64_t __t2;
    int64_t __t3;
...
static int64_t test_hydeeply_hynested_hyshift__cps(DK *__kont) {
    ...
    __ce_test_hydeeply_hynested_hyshift_s1->f0 = c_1645;
    __ce_test_hydeeply_hynested_hyshift_s1->f1 = b_1644;
    __ce_test_hydeeply_hynested_hyshift_s1->f2 = a_1643;
