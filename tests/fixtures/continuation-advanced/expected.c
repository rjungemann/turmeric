...
static int64_t __fn_906(int64_t);
static int64_t __fn_909(int64_t);
static int64_t __fn_912(int64_t);
static int64_t __fn_916(void *, int64_t);
static int64_t __fn_922(int64_t);
static int64_t __fn_928(void *, int64_t);
...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        __t2[1] = (int64_t)(intptr_t)__fn_589;
        void *__t3 = __t2;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t4) {
            ...
            __t5[1] = (int64_t)(intptr_t)__fn_625;
            void *__t6 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t13[1] = (int64_t)(intptr_t)__fn_807;
        void *__t14 = __t13;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t15) {
            ...
            __t16[1] = (int64_t)(intptr_t)__fn_903;
            void *__t17 = __t16;
...
static int64_t __fn_906(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_909(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_912(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_918 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_916(void * __env_p_919, int64_t v) {
        struct __env_918 *__env___env_918 = (struct __env_918 *)__env_p_919;
        return (__env___env_918->x) + (v);
}

static int64_t __fn_922(int64_t v) {
        return INT64_C(42);
}

struct __env_930 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_928(void * __env_p_931, int64_t v) {
        struct __env_930 *__env___env_930 = (struct __env_930 *)__env_p_931;
        return (__env___env_930->a) + ((__env___env_930->b) + ((__env___env_930->c) + (v)));
}
...
static bool vec_hyeq_hyloop(int64_t x, int64_t y, int64_t i, int64_t len, int64_t cmp) {
        ...
        if ((i) == (len)) {
            ...
            if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(cmp)))[0])((void *)(intptr_t)(cmp), vec_hyget(x, i), vec_hyget(y, i))) {
                __t19 = vec_hyeq_hyloop(x, y, (i) + (INT64_C(1)), len, (int64_t)(intptr_t)(cmp));
            } else {
                __t19 = false;
            }
            __t18 = __t19;
            ...
            if (mutmap_hyslot_hyoccupied_qu(m1, i)) {
                ...
                if (mutmap_hyhas_qu(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i))) {
                    ...
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), mutmap_hyslot_hyvalue(m1, i), mutmap_hyget(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i)))) {
                        __t28 = mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp));
                    } else {
                        __t28 = false;
                    }
                    __t27 = __t28;
                ...
                __t26 = mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp));
            }
            __t25 = __t26;
        }
        return __t25;
...
static int64_t test_hynested_hyreset() {
        int64_t __t29 = __fn_906(INT64_C(5));
        int64_t __t30 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t29), dk_prompt(1, dk_done())), 0);
        return (INT64_C(1)) + (__t30);
}

static int64_t test_hyshift_hyreturn_hydifferent() {
        int64_t __t31 = __fn_909(INT64_C(7));
        int64_t __t32 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t31), dk_prompt(1, dk_done())), 0);
        return __t32;
}

static int64_t test_hymultiple_hyshifts() {
        int64_t __t33 = __fn_912(INT64_C(3));
        int64_t __t34 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t33), dk_prompt(1, dk_done())), 0);
        return __t34;
}

static int64_t test_hyshift_hyignores_hyk() {
        int64_t __t35 = __fn_922(INT64_C(10));
        int64_t __t36 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t35), dk_prompt(1, dk_done())), 0);
        return __t36;
}
...
static int64_t test_hydeeply_hynested_hyshift() {
        int64_t a_924 = INT64_C(1);
        (void)a_924;
        int64_t b_925 = INT64_C(2);
        (void)b_925;
        int64_t c_926 = INT64_C(3);
        (void)c_926;
        struct __env_930 *__t38 = (struct __env_930 *)malloc(sizeof(struct __env_930));
        __t38->__fn = (tur_thunk_int64_t_int64_t_t)__fn_928;
        __t38->a = a_924;
        __t38->b = b_925;
        __t38->c = c_926;
        void *__t39 = __t38;
        int64_t __t37 = __fn_928(__t39, INT64_C(10));
        int64_t __t40 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t37), dk_prompt(1, dk_done())), 0);
        return __t40;
}
