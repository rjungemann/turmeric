...
static int64_t __fn_694(int64_t);
static int64_t __fn_697(int64_t);
static int64_t __fn_700(int64_t);
static int64_t __fn_704(void *, int64_t);
static int64_t __fn_710(int64_t);
static int64_t __fn_716(void *, int64_t);
...
static int64_t __fn_694(int64_t v) {
        return ((v) * (INT64_C(2)));
}
...
struct __env_706 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_704(void * __env_p_707, int64_t v) {
        struct __env_706 *__env___env_706 = (struct __env_706 *)__env_p_707;
        return ((__env___env_706->x) + (v));
}

static int64_t __fn_710(int64_t v) {
        return INT64_C(42);
}

struct __env_718 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_716(void * __env_p_719, int64_t v) {
        struct __env_718 *__env___env_718 = (struct __env_718 *)__env_p_719;
        return ((__env___env_718->a) + (((__env___env_718->b) + (((__env___env_718->c) + (v))))));
}
...
static int64_t test_nested_reset() {
        int64_t __t1 = __fn_694(INT64_C(5));
        return ((INT64_C(1)) + (((INT64_C(10)) + (__t1))));
}

static int64_t test_shift_return_different() {
        int64_t __t2 = __fn_697(INT64_C(7));
        return __t2;
}
...
static int64_t test_multiple_shifts() {
        int64_t __t3;
        {
            int64_t __t4 = __fn_700(INT64_C(3));
            int64_t x_702 = __t4;
            (void)x_702;
            struct __env_706 *__t6 = (struct __env_706 *)malloc(sizeof(struct __env_706));
            __t6->__fn = (tur_thunk_int64_t_int64_t_t)__fn_704;
            __t6->x = x_702;
            void *__t7 = __t6;
            int64_t __t5 = __fn_704(__t7, INT64_C(4));
            __t3 = __t5;
        }
        return __t3;
}
...
static int64_t test_shift_ignores_k() {
        int64_t __t8 = __fn_710(INT64_C(10));
        return __t8;
}
...
static int64_t test_deeply_nested_shift() {
        int64_t __t9;
        {
            int64_t a_712 = INT64_C(1);
            (void)a_712;
            int64_t b_713 = INT64_C(2);
            (void)b_713;
            int64_t c_714 = INT64_C(3);
            (void)c_714;
            struct __env_718 *__t11 = (struct __env_718 *)malloc(sizeof(struct __env_718));
            __t11->__fn = (tur_thunk_int64_t_int64_t_t)__fn_716;
            __t11->a = a_712;
            __t11->b = b_713;
            __t11->c = c_714;
            void *__t12 = __t11;
            int64_t __t10 = __fn_716(__t12, INT64_C(10));
            __t9 = __t10;
        }
        return __t9;
}
