...
static int64_t __fn_878(int64_t);
static int64_t __fn_881(int64_t);
static int64_t __fn_884(int64_t);
static int64_t __fn_888(void *, int64_t);
static int64_t __fn_894(int64_t);
static int64_t __fn_900(void *, int64_t);
...
static int64_t __fn_878(int64_t v) {
        return (v) * (INT64_C(2));
}

static int64_t __fn_881(int64_t v) {
        return (v) + (INT64_C(100));
}

static int64_t __fn_884(int64_t v) {
        return (v) * (INT64_C(2));
}

struct __env_890 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_888(void * __env_p_891, int64_t v) {
        struct __env_890 *__env___env_890 = (struct __env_890 *)__env_p_891;
        return (__env___env_890->x) + (v);
}

static int64_t __fn_894(int64_t v) {
        return INT64_C(42);
}

struct __env_902 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_900(void * __env_p_903, int64_t v) {
        struct __env_902 *__env___env_902 = (struct __env_902 *)__env_p_903;
        return (__env___env_902->a) + ((__env___env_902->b) + ((__env___env_902->c) + (v)));
}
...
static int64_t test_nested_reset() {
        int64_t __t3 = __fn_878(INT64_C(5));
        return (INT64_C(1)) + ((INT64_C(10)) + (__t3));
}

static int64_t test_shift_return_different() {
        int64_t __t4 = __fn_881(INT64_C(7));
        return __t4;
}
...
static int64_t test_multiple_shifts() {
        int64_t __t5;
        {
            int64_t __t6 = __fn_884(INT64_C(3));
            int64_t x_886 = __t6;
            (void)x_886;
            struct __env_890 *__t8 = (struct __env_890 *)malloc(sizeof(struct __env_890));
            __t8->__fn = (tur_thunk_int64_t_int64_t_t)__fn_888;
            __t8->x = x_886;
            void *__t9 = __t8;
            int64_t __t7 = __fn_888(__t9, INT64_C(4));
            __t5 = __t7;
        }
        return __t5;
}
...
static int64_t test_shift_ignores_k() {
        int64_t __t10 = __fn_894(INT64_C(10));
        return __t10;
}
...
static int64_t test_deeply_nested_shift() {
        int64_t __t11;
        {
            int64_t a_896 = INT64_C(1);
            (void)a_896;
            int64_t b_897 = INT64_C(2);
            (void)b_897;
            int64_t c_898 = INT64_C(3);
            (void)c_898;
            struct __env_902 *__t13 = (struct __env_902 *)malloc(sizeof(struct __env_902));
            __t13->__fn = (tur_thunk_int64_t_int64_t_t)__fn_900;
            __t13->a = a_896;
            __t13->b = b_897;
            __t13->c = c_898;
            void *__t14 = __t13;
            int64_t __t12 = __fn_900(__t14, INT64_C(10));
            __t11 = __t12;
        }
        return __t11;
}
