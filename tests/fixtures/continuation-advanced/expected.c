...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return map_eq_dynamic(x, y, (int64_t)(intptr_t)(__fn_576));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return vec_eq_(x, y, (int64_t)(intptr_t)(__fn_600));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return option_eq_(x, y, (int64_t)(intptr_t)(__fn_627));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return result_eq_(x, y, (int64_t)(intptr_t)(__fn_649), (int64_t)(intptr_t)(__fn_653));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return pair_eq_carrier_(x, y, (int64_t)(intptr_t)(__fn_669), (int64_t)(intptr_t)(__fn_673));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return list_eq_(x, y, (int64_t)(intptr_t)(__fn_776));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return mutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_855));
}
...
static int64_t test_nested_reset() {
        int64_t __t7 = __fn_859(INT64_C(5));
        int64_t __t8 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t7), dk_prompt(1, dk_done())), 0);
        return (INT64_C(1)) + (__t8);
}

static int64_t test_shift_return_different() {
        int64_t __t9 = __fn_862(INT64_C(7));
        int64_t __t10 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t9), dk_prompt(1, dk_done())), 0);
        return __t10;
}

static int64_t test_multiple_shifts() {
        int64_t __t11 = __fn_865(INT64_C(3));
        int64_t __t12 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t11), dk_prompt(1, dk_done())), 0);
        return __t12;
}

static int64_t test_shift_ignores_k() {
        int64_t __t13 = __fn_875(INT64_C(10));
        int64_t __t14 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t13), dk_prompt(1, dk_done())), 0);
        return __t14;
}
...
static int64_t test_deeply_nested_shift() {
        ...
        (void)c_879;
        struct __env_883 *__t16 = (struct __env_883 *)malloc(sizeof(struct __env_883));
        __t16->__fn = (tur_thunk_int64_t_int64_t_t)__fn_881;
        __t16->a = a_877;
        __t16->b = b_878;
        __t16->c = c_879;
        void *__t17 = __t16;
        int64_t __t15 = __fn_881(__t17, INT64_C(10));
        int64_t __t18 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t15), dk_prompt(1, dk_done())), 0);
        return __t18;
}
