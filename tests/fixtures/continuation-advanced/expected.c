...
__attribute__((unused)) static int64_t test_hynested_hyreset() {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = test_hynested_hyreset__cps(__root);
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
    if (!tur_async_suspended && --__dk_entry_depth == 0) __dk_reap_run();
    return __ret;
...
__attribute__((unused)) static int64_t test_hyshift_hyreturn_hydifferent() {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = test_hyshift_hyreturn_hydifferent__cps(__root);
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
    if (!tur_async_suspended && --__dk_entry_depth == 0) __dk_reap_run();
    return __ret;
...
__attribute__((unused)) static int64_t test_hymultiple_hyshifts() {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = test_hymultiple_hyshifts__cps(__root);
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
    if (!tur_async_suspended && --__dk_entry_depth == 0) __dk_reap_run();
    return __ret;
...
__attribute__((unused)) static int64_t test_hyshift_hyignores_hyk() {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = test_hyshift_hyignores_hyk__cps(__root);
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
    if (!tur_async_suspended && --__dk_entry_depth == 0) __dk_reap_run();
    return __ret;
...
__attribute__((unused)) static int64_t test_hyreset_hyno_hyshift() {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = test_hyreset_hyno_hyshift__cps(__root);
    int64_t __ret = (int64_t)(__r);
    if (!tur_async_suspended) dk_free(__root);
    if (!tur_async_suspended && --__dk_entry_depth == 0) __dk_reap_run();
    return __ret;
