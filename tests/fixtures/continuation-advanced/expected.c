...
static int64_t __fn_899(void *, int64_t);
static int64_t __fn_905(int64_t);
...
struct __env_901 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_899(void * __env_p_902, int64_t v) {
        struct __env_901 *__env___env_901 = (struct __env_901 *)__env_p_902;
        return (__env___env_901->x) + (v);
}

static int64_t __fn_905(int64_t v) {
        return INT64_C(42);
}

struct __env_913 { tur_thunk_int64_t_int64_t_t __fn; int64_t a; int64_t b; int64_t c; };
static int64_t __fn_911(void * __env_p_914, int64_t v) {
        struct __env_913 *__env___env_913 = (struct __env_913 *)__env_p_914;
        return (__env___env_913->a) + ((__env___env_913->b) + ((__env___env_913->c) + (v)));
}
...
static int64_t test_hynested_hyreset() {
        int64_t __t23 = __fn_889(INT64_C(5));
        int64_t __t24 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t23), dk_prompt(1, dk_done())), 0);
        return (INT64_C(1)) + (__t24);
}

static int64_t test_hyshift_hyreturn_hydifferent() {
        int64_t __t25 = __fn_892(INT64_C(7));
        int64_t __t26 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t25), dk_prompt(1, dk_done())), 0);
        return __t26;
}

static int64_t test_hymultiple_hyshifts() {
        int64_t __t27 = __fn_895(INT64_C(3));
        int64_t __t28 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t27), dk_prompt(1, dk_done())), 0);
        return __t28;
}

static int64_t test_hyshift_hyignores_hyk() {
        int64_t __t29 = __fn_905(INT64_C(10));
...
static int64_t test_hydeeply_hynested_hyshift() {
        int64_t a_907 = INT64_C(1);
        (void)a_907;
        int64_t b_908 = INT64_C(2);
        (void)b_908;
        int64_t c_909 = INT64_C(3);
        (void)c_909;
        struct __env_913 *__t32 = (struct __env_913 *)malloc(sizeof(struct __env_913));
        __t32->__fn = (tur_thunk_int64_t_int64_t_t)__fn_911;
        __t32->a = a_907;
        __t32->b = b_908;
        __t32->c = c_909;
        void *__t33 = __t32;
        int64_t __t31 = __fn_911(__t33, INT64_C(10));
        int64_t __t34 = (int64_t)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t31), dk_prompt(1, dk_done())), 0);
        return __t34;
}
