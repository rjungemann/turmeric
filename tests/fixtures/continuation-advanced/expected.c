...
struct __defer_env_265 {int64_t m; };

static void __defer_271(void *__env) {
    untrailed_hyend();
}

static void __defer_266(void *__env) {
    struct __defer_env_265 *__e = (struct __defer_env_265 *)__env;
    bool __ps_281 = (bt_hyundo_hyto_ex(__e->m));
...
static int64_t list_hyeq_qu__cps(int64_t l1, int64_t l2, int64_t cmp_fn, DK *__kont) {
    ...
    int64_t __t4;
    int64_t __t5;
    bool __ps_185 = (tnil_qu(l1));
    if (tur_panicking) return ((int64_t)0);
    __t0 = __ps_185;
    if (__t0) {
        bool __ps_186 = (tnil_qu(l2));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_186;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_194) {
            bool __t195;
            {
                ...
                (void)t2_1284;
                bool __t196;
                if ((t1_1283) == (INT64_C(0))) {
                    __t196 = (t2_1284) == (INT64_C(0));
                } else {
                    bool __t197;
                    if ((t2_1284) == (INT64_C(0))) {
                        __t197 = false;
                    } else {
                        bool __ps_198 = (cons_hyeq_hygo(t1_1283, t2_1284));
                        if (tur_panicking) return ((bool)0);
                        __t197 = __ps_198;
                    }
                    __t196 = __t197;
...
static int64_t _un_uncons_hyfmap__cps(int64_t cell, void * f, DK *__kont) {
    ...
    int64_t __t1;
    int64_t __t3;
    bool __ps_199 = (tnil_qu(cell));
    if (tur_panicking) return ((int64_t)0);
    __t0 = __ps_199;
    if (__t0) {
        return dk_run(__kont, (intptr_t)(INT64_C(0)));
    } else {
        int64_t __ps_200 = (list_hyhead(cell));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_201 = ((*( tur_thunk_int64_t_int64_t_t *)(f))(f, __ps_200));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_201;
        int64_t __ps_202 = (list_hytail(cell));
        if (tur_panicking) return ((int64_t)0);
        __t3 = __ps_202;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_204) {
            ...
            int64_t __t205;
            {
                int64_t __ps_206 = (list_hyhead(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_207 = (list_hytail(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_208 = (list_hyconcat(__ps_207, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_209 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_206, __ps_208));
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_209), sizeof(__ps_209));
                int64_t out_1299 = (int64_t)(intptr_t)(__ps_209);
                (void)out_1299;
                __t205 = out_1299;
            }
            __t203 = __t205;
...
static int64_t car(int64_t l) {
        int64_t __ps_210 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_210;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_211 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_211;
}

static bool null_qu(int64_t l) {
        bool __ps_212 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_212;
}

static int64_t length(int64_t l) {
        int64_t __ps_213 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_213;
}
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        __tur_tailcall:;
        bool __ps_214 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((bool)0);
        if (__ps_214) {
            {
                int64_t __ps_215 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                int64_t h_1370 = __ps_215;
                (void)h_1370;
                void * __ps_216 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1371 = __ps_216;
                (void)k_1371;
                bool __ps_217 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1370, (void *)(intptr_t)(k_1371), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_217) {
                    void * __t218 = iter;
                    void * __t219 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t221;
        {
            void * __ps_222 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_223 = (hamt_sliter_hyalloc((void *)(intptr_t)(__ps_222)));
            if (tur_panicking) return ((bool)0);
            void * iter_1374 = __ps_223;
            (void)iter_1374;
            void * __ps_224 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_225 = (hamt_slkeyeq((void *)(intptr_t)(__ps_224)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1375 = __ps_225;
            (void)keyeq_1375;
            void * __ps_226 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_227 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1374), (void *)(intptr_t)(__ps_226), (void *)(intptr_t)(keyeq_1375)));
            if (tur_panicking) return ((bool)0);
            bool result_1376 = __ps_227;
            (void)result_1376;
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        int64_t __ps_230 = (set_hycount(s1));
        if (tur_panicking) return ((bool)0);
        int64_t __ps_231 = (set_hycount(s2));
        if (tur_panicking) return ((bool)0);
        bool __t229 = (__ps_230) == (__ps_231);
        if (__t229) {
            bool __ps_232 = (set_hyeq_hydriver(s1, s2));
            if (tur_panicking) return ((bool)0);
            __t229 = __ps_232;
        }
        return __t229;
...
static bool mutmap_hyeq_hyloop(int64_t m1, int64_t m2, int64_t i, int64_t cap, int64_t val_cmp) {
        ...
        if ((i) == (cap)) {
            ...
            bool __t234;
            bool __ps_235 = (mutmap_hyslot_hyoccupied_qu(m1, i));
            if (tur_panicking) return ((bool)0);
            if (__ps_235) {
                bool __t236;
                int64_t __ps_237 = (mutmap_hyslot_hyhash(m1, i));
                if (tur_panicking) return ((bool)0);
                int64_t __ps_238 = (mutmap_hyslot_hykey(m1, i));
                if (tur_panicking) return ((bool)0);
                bool __ps_239 = (mutmap_hyhas_qu(m2, __ps_237, __ps_238));
                if (tur_panicking) return ((bool)0);
                if (__ps_239) {
                    bool __t240;
                    int64_t __ps_241 = (mutmap_hyslot_hyvalue(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_242 = (mutmap_hyslot_hyhash(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_243 = (mutmap_hyslot_hykey(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_244 = (mutmap_hyget(m2, __ps_242, __ps_243));
                    if (tur_panicking) return ((bool)0);
                    bool __ps_245 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_241, __ps_244));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_245) {
                        bool __ps_246 = (mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp)));
                        if (tur_panicking) return ((bool)0);
                        __t240 = __ps_246;
                    } else {
                        __t240 = false;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t248;
        {
            int64_t _un_unvw_1506 = a;
            (void)_un_unvw_1506;
            tur_adt_Vec__int * __t249;
            {
                tur_adt_Vec__int * __ps_250 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1506));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1507 = __ps_250;
                (void)_un_unv_1507;
        ...
        int64_t __ps_252 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t248))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_252;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_253 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_253);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t254;
        {
            int64_t __ps_255 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1557 = __ps_255;
            (void)r_1557;
            int64_t __t256;
            bool __ps_257 = (schema_hydecode_hyok_qu(r_1557));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_257) {
                int64_t __ps_258 = (schema_hydecode_hyvalue(r_1557));
                if (tur_panicking) return ((int64_t)0);
                __t256 = __ps_258;
            } else {
                int64_t __ps_259 = (schema_hydecode_hyerrors(r_1557));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_260 = (schema_hydecode_hyabort(__ps_259));
                if (tur_panicking) return ((int64_t)0);
                __t256 = __ps_260;
            }
            __t254 = __t256;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_261 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_261;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t262;
        {
            int64_t __ps_263 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1608 = __ps_263;
            (void)m_1608;
            tur_frame __frame_264;
            tur_frame_init(&__frame_264, NULL);
            struct __defer_env_265 __t267 = {.m = m_1608};
            tur_frame_push_defer(&__frame_264, __defer_266, &__t267);
            int64_t __t268;
            int64_t __ps_269 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) { tur_frame_fire_lifo(&__frame_264); return ((int64_t)0); }
            __t268 = __ps_269;
            tur_frame_fire_lifo(&__frame_264);
            __t262 = __t268;
        }
        return __t262;
}
...
static int64_t with_hyuntrailed(int64_t body) {
        tur_frame __frame_270;
        tur_frame_init(&__frame_270, NULL);
        untrailed_hybegin();
        tur_frame_push_defer(&__frame_270, __defer_271, NULL);
        int64_t __t272;
        int64_t __ps_273 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
        if (tur_panicking) { tur_frame_fire_lifo(&__frame_270); return ((int64_t)0); }
        __t272 = __ps_273;
        tur_frame_fire_lifo(&__frame_270);
        return __t272;
}
...
static intptr_t test_hynested_hyreset_s2(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t6;
    int64_t __ps_275 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1612))(INT64_C(5)));
    if (tur_panicking) return ((int64_t)0);
    __t6 = __ps_275;
...
static intptr_t test_hyshift_hyreturn_hydifferent_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_276 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1615))(INT64_C(7)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_276;
...
static intptr_t test_hymultiple_hyshifts_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t4;
    int64_t __ps_277 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1618))(INT64_C(3)));
    if (tur_panicking) return ((int64_t)0);
    __t4 = __ps_277;
...
static intptr_t test_hyshift_hyignores_hyk_s1(intptr_t env, DK *subk) {
    (void)env; (void)subk;
    int64_t __t2;
    int64_t __ps_278 = (((int64_t (*)(int64_t))(intptr_t)(__fn_1628))(INT64_C(10)));
    if (tur_panicking) return ((int64_t)0);
    __t2 = __ps_278;
    return (intptr_t)(__t2);
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_279 = (ctor_Cons_Cons__int(h, t));
