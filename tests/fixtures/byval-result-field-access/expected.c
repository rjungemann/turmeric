...
static int64_t parse(int64_t b) {
        int64_t __t280;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_281 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t280 = __ps_281;
        } else {
            int64_t __ps_282 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t280 = __ps_282;
        }
        return __t280;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t283;
        {
            int64_t __ps_284 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1608 = __ps_284;
            (void)r_1608;
            tur_adt_Option__int __ps_285 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1609 = __ps_285;
            (void)o_1609;
            int64_t __ps_286 = (ok_hyval(r_1608));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_286));
            int64_t __ps_287 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1609));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_287));
            int64_t __t288;
            __t288 = INT64_C(0);
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_291 = (ctor_Result_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_291;
}
