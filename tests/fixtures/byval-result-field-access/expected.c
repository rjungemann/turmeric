...
static int64_t parse(int64_t b) {
        int64_t __t235;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_236 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t235 = __ps_236;
        } else {
            int64_t __ps_237 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t235 = __ps_237;
        }
        return __t235;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t238;
        {
            int64_t __ps_239 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1465 = __ps_239;
            (void)r_1465;
            tur_adt_Option__int __ps_240 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1466 = __ps_240;
            (void)o_1466;
            int64_t __ps_241 = (ok_hyval(r_1465));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_241));
            int64_t __ps_242 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1466));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_242));
            int64_t __t243;
            __t243 = INT64_C(0);
            __t238 = __t243;
            if (r_1465) tur_region_free((void *)(intptr_t)r_1465);
        }
        return (int)__t238;
}
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_246 = (ctor_Result_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_246;
}

static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_247 = (ctor_Option_Some__int(x));
