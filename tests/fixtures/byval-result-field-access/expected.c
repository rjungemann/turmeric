...
static int64_t parse(int64_t b) {
        int64_t __t157;
        if ((b) == (INT64_C(0))) {
            __auto_type __ps_158 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return (int64_t){0};
            __t157 = __ps_158;
        } else {
            __auto_type __ps_159 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return (int64_t){0};
            __t157 = __ps_159;
        }
        return __t157;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t160;
        {
            __auto_type __ps_161 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1302 = __ps_161;
            (void)r_1302;
            __auto_type __ps_162 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1303 = __ps_162;
            (void)o_1303;
            printf("%lld\n", (long long)((int64_t)((tur_adt_Result *)(intptr_t)(r_1302))->ok_val));
            printf("%lld\n", (long long)((int64_t)(o_1303).value));
            int64_t __t163;
            __t163 = INT64_C(0);
            __t160 = __t163;
        }
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_167 = (ctor_Option__int(true, x));
