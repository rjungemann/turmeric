...
static int64_t parse(int64_t b) {
        int64_t __t183;
        if ((b) == (INT64_C(0))) {
            __auto_type __ps_184 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return (int64_t){0};
            __t183 = __ps_184;
        } else {
            __auto_type __ps_185 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return (int64_t){0};
            __t183 = __ps_185;
        }
        return __t183;
...
int main(int argc, char **argv) {
        ...
        int64_t __t186;
        {
            __auto_type __ps_187 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1266 = __ps_187;
            (void)r_1266;
            __auto_type __ps_188 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1267 = __ps_188;
            (void)o_1267;
            printf("%lld\n", (long long)((int64_t)((tur_adt_Result *)(intptr_t)(r_1266))->ok_val));
            printf("%lld\n", (long long)((int64_t)(o_1267).value));
            int64_t __t189;
            __t189 = INT64_C(0);
            __t186 = __t189;
        }
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        __auto_type __ps_191 = (ctor_Result(false, (int64_t){0}, (int64_t)(intptr_t)(e)));
        if (tur_panicking) return (int64_t){0};
        return __ps_191;
}
