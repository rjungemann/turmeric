...
static int64_t parse(int64_t b) {
        int64_t __t270;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_271 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t270 = __ps_271;
        } else {
            int64_t __ps_272 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t270 = __ps_272;
        }
        return __t270;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t273;
        {
            int64_t __ps_274 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1467 = __ps_274;
            (void)r_1467;
            tur_adt_Option__int __ps_275 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1468 = __ps_275;
            (void)o_1468;
            int64_t __ps_276 = (ok_hyval(r_1467));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_276));
            int64_t __ps_277 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1468));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_277));
            int64_t __t278;
            __t278 = INT64_C(0);
            __t273 = __t278;
            if (r_1467) tur_region_free((void *)(intptr_t)r_1467);
        }
        return (int)__t273;
}
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_281 = (ctor_Result_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_281;
}
