...
static int64_t parse(int64_t b) {
        int64_t __t247;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_248 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t247 = __ps_248;
        } else {
            int64_t __ps_249 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t247 = __ps_249;
        }
        return __t247;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t250;
        {
            int64_t __ps_251 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1469 = __ps_251;
            (void)r_1469;
            tur_adt_Option__int __ps_252 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1470 = __ps_252;
            (void)o_1470;
            int64_t __ps_253 = (ok_hyval(r_1469));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_253));
            int64_t __ps_254 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1470));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_254));
            int64_t __t255;
            __t255 = INT64_C(0);
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_258 = (ctor_Result_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_258;
}
