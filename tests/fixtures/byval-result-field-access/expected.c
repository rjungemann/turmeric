...
static int64_t parse(int64_t b) {
        int64_t __t267;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_268 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t267 = __ps_268;
        } else {
            int64_t __ps_269 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t267 = __ps_269;
        }
        return __t267;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t270;
        {
            int64_t __ps_271 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1469 = __ps_271;
            (void)r_1469;
            tur_adt_Option__int __ps_272 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1470 = __ps_272;
            (void)o_1470;
            int64_t __ps_273 = (ok_hyval(r_1469));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_273));
            int64_t __ps_274 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1470));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_274));
            int64_t __t275;
            __t275 = INT64_C(0);
            __t270 = __t275;
            if (r_1469) tur_region_free((void *)(intptr_t)r_1469);
        }
        return (int)__t270;
}
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_278 = (ctor_Result_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_278;
}
