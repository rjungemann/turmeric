...
static int64_t parse(int64_t b) {
        int64_t __t182;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_183 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t182 = __ps_183;
        } else {
            int64_t __ps_184 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t182 = __ps_184;
        }
        return __t182;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t185;
        {
            int64_t __ps_186 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1436 = __ps_186;
            (void)r_1436;
            tur_adt_Option__int __ps_187 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1437 = __ps_187;
            (void)o_1437;
            int64_t __ps_188 = (ok_hyval(r_1436));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_188));
            int64_t __ps_189 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1437));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_189));
            int64_t __t190;
            __t190 = INT64_C(0);
            __t185 = __t190;
            if (r_1436) free((void *)(intptr_t)r_1436);
        }
        return (int)__t185;
}
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_193 = (ctor_Result_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_193;
}
