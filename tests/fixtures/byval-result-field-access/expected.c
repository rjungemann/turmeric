...
static int64_t parse(int64_t b) {
        if ((b) == (INT64_C(0))) {
            ...
            TUR_MUSTTAIL return ok((b) * (INT64_C(2)));
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            int64_t __ps_174 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1623 = __ps_174;
            (void)r_1623;
            tur_adt_Option__int __ps_175 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1624 = __ps_175;
            (void)o_1624;
            int64_t __ps_176 = (ok_hyval(r_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_176));
            int64_t __ps_177 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            int64_t __t178;
            __t178 = INT64_C(0);
            __t173 = __t178;
            if (r_1623) tur_region_free((void *)(intptr_t)r_1623);
        }
        return (int)__t173;
}
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        return ctor_Result_Err((int64_t)(intptr_t)(e));
}
