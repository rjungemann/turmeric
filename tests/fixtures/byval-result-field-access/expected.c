...
static int64_t parse(int64_t b) {
        int64_t __t55;
        if ((b) == (INT64_C(0))) {
            __t55 = err__spec__int64_t_const_char__("zero");
        } else {
            __t55 = ok((b) * (INT64_C(2)));
        }
        return __t55;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t56;
        {
            int64_t r_1266 = parse(INT64_C(7));
            (void)r_1266;
            tur_adt_Option__int o_1267 = some__spec__tur_adt_Option__int_int64_t(INT64_C(9));
            (void)o_1267;
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        return ctor_Result(false, (int64_t){0}, (int64_t)(intptr_t)(e));
}
