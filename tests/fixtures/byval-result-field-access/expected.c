...
static int64_t parse(int64_t b) {
        int64_t __t162;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_163 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t162 = __ps_163;
        } else {
            int64_t __ps_164 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t162 = __ps_164;
        }
        return __t162;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t165;
        {
            int64_t __ps_166 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1332 = __ps_166;
            (void)r_1332;
            tur_adt_Option__int __ps_167 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1333 = __ps_167;
            (void)o_1333;
            printf("%lld\n", (long long)((int64_t)((tur_adt_Result *)(intptr_t)(r_1332))->ok_val));
            printf("%lld\n", (long long)((int64_t)(o_1333).value));
            int64_t __t168;
            __t168 = INT64_C(0);
            __t165 = __t168;
        }
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_171 = (ctor_Result(false, ((int64_t)0), (int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_171;
}
