...
static int64_t parse(int64_t b) {
        int64_t __t278;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_279 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t278 = __ps_279;
        } else {
            int64_t __ps_280 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t278 = __ps_280;
        }
        return __t278;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t281;
        {
            int64_t __ps_282 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1608 = __ps_282;
            (void)r_1608;
            tur_adt_Option__int __ps_283 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1609 = __ps_283;
            (void)o_1609;
            int64_t __ps_284 = (ok_hyval(r_1608));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_284));
            int64_t __ps_285 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1609));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_285));
            int64_t __t286;
            __t286 = INT64_C(0);
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_289 = (ctor_Result_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_289;
}

static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_290 = (ctor_Option_Some__int(x));
