...
static int64_t parse(int64_t b) {
        int64_t __t175;
        if ((b) == (INT64_C(0))) {
            __auto_type __ps_176 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return (int64_t){0};
            __t175 = __ps_176;
        } else {
            __auto_type __ps_177 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return (int64_t){0};
            __t175 = __ps_177;
        }
        return __t175;
...
int main(int argc, char **argv) {
        ...
        int64_t __t178;
        {
            __auto_type __ps_179 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1277 = __ps_179;
            (void)r_1277;
            __auto_type __ps_180 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1278 = __ps_180;
            (void)o_1278;
            printf("%lld\n", (long long)((int64_t)((tur_adt_Result *)(intptr_t)(r_1277))->ok_val));
            printf("%lld\n", (long long)((int64_t)(o_1278).value));
            int64_t __t181;
            __t181 = INT64_C(0);
            __t178 = __t181;
        }
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        __auto_type __ps_184 = (ctor_Result(false, (int64_t){0}, (int64_t)(intptr_t)(e)));
        if (tur_panicking) return (int64_t){0};
        return __ps_184;
}

static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_185 = (ctor_Option__int(true, x));
