...
static int64_t parse(int64_t b) {
        int64_t __t50;
        if ((b) == (INT64_C(0))) {
            __t50 = err__spec__int64_t_const_char__("zero");
        } else {
            __t50 = ok((b) * (INT64_C(2)));
        }
        return __t50;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t51;
        {
            int64_t r_1263 = parse(INT64_C(7));
            (void)r_1263;
            tur_adt_Option__int o_1264 = some__spec__tur_adt_Option__int_int64_t(INT64_C(9));
            (void)o_1264;
            printf("%lld\n", (long long)((int64_t)((tur_adt_Result *)(intptr_t)(r_1263))->ok_val));
            printf("%lld\n", (long long)((int64_t)(o_1264).value));
            int64_t __t52;
            __t52 = INT64_C(0);
            __t51 = __t52;
        }
