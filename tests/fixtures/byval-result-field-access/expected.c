        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                if ((t1_1071) == (INT64_C(0))) {
                    __t108 = (t2_1072) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_1072) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        bool __ps_110 = (cons_hyeq_hygo(t1_1071, t2_1072));
                        if (tur_panicking) return ((bool)0);
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t parse(int64_t b) {
        int64_t __t167;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_168 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t167 = __ps_168;
        } else {
            int64_t __ps_169 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t167 = __ps_169;
        }
        return __t167;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t170;
        {
            int64_t __ps_171 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1364 = __ps_171;
            (void)r_1364;
            int64_t __ps_172 = (some__spec__int64_t_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t o_1365 = __ps_172;
            (void)o_1365;
            int64_t __ps_173 = (ok_hyval(r_1364));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_173));
            int64_t __ps_174 = (unwrap(o_1365));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_174));
            int64_t __t175;
            __t175 = INT64_C(0);
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_178 = (ctor_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_178;
}

static int64_t some__spec__int64_t_int64_t(int64_t x) {
        int64_t __ps_179 = (ctor_Some__int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_179;
}
