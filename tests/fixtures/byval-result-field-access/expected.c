...
static int64_t parse(int64_t b) {
        int64_t __t166;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_167 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t166 = __ps_167;
        } else {
            int64_t __ps_168 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t166 = __ps_168;
        }
        return __t166;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t169;
        {
            int64_t __ps_170 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1368 = __ps_170;
            (void)r_1368;
            tur_adt_Option__int __ps_171 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1369 = __ps_171;
            (void)o_1369;
            int64_t __ps_172 = (ok_hyval(r_1368));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_172));
            int64_t __ps_173 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1369));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_173));
            int64_t __t174;
            __t174 = INT64_C(0);
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_177 = (ctor_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_177;
}

static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_178 = (ctor_Some__int(x));
