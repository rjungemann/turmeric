...
static int64_t parse(int64_t b) {
        int64_t __t179;
        if ((b) == (INT64_C(0))) {
            __auto_type __ps_180 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return (int64_t){0};
            __t179 = __ps_180;
        } else {
            __auto_type __ps_181 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return (int64_t){0};
            __t179 = __ps_181;
        }
        return __t179;
...
int main(int argc, char **argv) {
        ...
        int64_t __t182;
        {
            __auto_type __ps_183 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1269 = __ps_183;
            (void)r_1269;
            __auto_type __ps_184 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1270 = __ps_184;
            (void)o_1270;
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        __auto_type __ps_188 = (ctor_Result(false, (int64_t){0}, (int64_t)(intptr_t)(e)));
        if (tur_panicking) return (int64_t){0};
        return __ps_188;
}
