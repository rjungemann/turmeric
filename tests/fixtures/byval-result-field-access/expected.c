...
static int64_t parse(int64_t b) {
        int64_t __t183;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_184 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t183 = __ps_184;
        } else {
            int64_t __ps_185 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t183 = __ps_185;
        }
        return __t183;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t186;
        {
            int64_t __ps_187 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1438 = __ps_187;
            (void)r_1438;
            tur_adt_Option__int __ps_188 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1439 = __ps_188;
            (void)o_1439;
            int64_t __ps_189 = (ok_hyval(r_1438));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_189));
            int64_t __ps_190 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1439));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_190));
            int64_t __t191;
            __t191 = INT64_C(0);
            __t186 = __t191;
            if (r_1438) tur_region_free((void *)(intptr_t)r_1438);
        }
        return (int)__t186;
}
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_194 = (ctor_Result_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_194;
}
