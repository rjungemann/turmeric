...
static int64_t parse(int64_t b) {
        int64_t __t171;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_172 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t171 = __ps_172;
        } else {
            int64_t __ps_173 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t171 = __ps_173;
        }
        return __t171;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t174;
        {
            int64_t __ps_175 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1434 = __ps_175;
            (void)r_1434;
            tur_adt_Option__int __ps_176 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1435 = __ps_176;
            (void)o_1435;
            int64_t __ps_177 = (ok_hyval(r_1434));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            int64_t __ps_178 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1435));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_178));
            int64_t __t179;
            __t179 = INT64_C(0);
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_182 = (ctor_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_182;
}
