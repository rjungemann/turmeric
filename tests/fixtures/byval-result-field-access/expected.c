...
static int64_t parse(int64_t b) {
        int64_t __t175;
        if ((b) == (INT64_C(0))) {
            int64_t __ps_176 = (err__spec__int64_t_const_char__("zero"));
            if (tur_panicking) return ((int64_t)0);
            __t175 = __ps_176;
        } else {
            int64_t __ps_177 = (ok((b) * (INT64_C(2))));
            if (tur_panicking) return ((int64_t)0);
            __t175 = __ps_177;
        }
        return __t175;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t178;
        {
            int64_t __ps_179 = (parse(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1434 = __ps_179;
            (void)r_1434;
            tur_adt_Option__int __ps_180 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1435 = __ps_180;
            (void)o_1435;
            int64_t __ps_181 = (ok_hyval(r_1434));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_181));
            int64_t __ps_182 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1435));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_182));
            int64_t __t183;
            __t183 = INT64_C(0);
...
static int64_t err__spec__int64_t_const_char__(const char * e) {
        int64_t __ps_186 = (ctor_Err((int64_t)(intptr_t)(e)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_186;
}
