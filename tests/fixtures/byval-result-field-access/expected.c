...
static Result parse(int64_t b) {
        int64_t __t55;
        if ((b) == (INT64_C(0))) {
            __t55 = err(((union { const char * s; int64_t d; }){.s = "zero"}).d);
        } else {
            __t55 = ok((b) * (INT64_C(2)));
        }
                return (*(Result *)(intptr_t)(__t55));
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t56;
        {
            Result r_1248 = parse(INT64_C(7));
            (void)r_1248;
            Option__int o_1249 = some__spec__Option__int_int64_t(INT64_C(9));
            (void)o_1249;
            printf("%lld\n", (long long)((r_1248).ok_val));
            printf("%lld\n", (long long)((o_1249).value));
            int64_t __t57;
            __t57 = INT64_C(0);
            __t56 = __t57;
        }
