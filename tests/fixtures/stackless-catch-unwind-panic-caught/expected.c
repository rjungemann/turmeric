         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n235->tag = 3; __n235->boundary = __b235; __n235->next = __k;
            __n235->aggr_mask = 0x0u;
            __n235->saved[0] = (int64_t)(intptr_t)(n);
            __n235->saved[1] = (int64_t)(intptr_t)(r_1467);
            __n235->saved[2] = (int64_t)(intptr_t)(__t233);
            __n235->saved[3] = (int64_t)(intptr_t)(__t234);
            __k = __n235; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic("boom");
          ...
          case 3: {
           ...
           r_1467 = __box235;
           bool __ps_236 = (err_qu(r_1467));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_236) {
            tur_cont *__n237 = (tur_cont*)malloc(sizeof(tur_cont));
            __n237->tag = 4; __n237->boundary = 0; __n237->next = __k;
            __n237->aggr_mask = 0x0u;
            __n237->saved[0] = (int64_t)(intptr_t)(n);
            __n237->saved[1] = (int64_t)(intptr_t)(r_1467);
            __n237->saved[2] = (int64_t)(intptr_t)(__t233);
            __n237->saved[3] = (int64_t)(intptr_t)(__t234);
            int64_t __ra237_0 = ((n) - (INT64_C(1)));
            n = __ra237_0;
            __k = __n237; __pc = 1; break;
           } else {
          ...
          case 4: {
           ...
           __t233 = (int64_t)(intptr_t)(__k->saved[2]);
           __t234 = (int64_t)(intptr_t)(__k->saved[3]);
           __t234 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)r_1467);
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t234)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_238 = (h(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_238));
        int64_t __t239;
        __t239 = INT64_C(0);
