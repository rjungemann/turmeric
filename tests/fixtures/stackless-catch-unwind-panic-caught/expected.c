         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n247->tag = 3; __n247->boundary = __b247; __n247->next = __k;
            __n247->aggr_mask = 0x0u;
            __n247->saved[0] = (int64_t)(intptr_t)(n);
            __n247->saved[1] = (int64_t)(intptr_t)(r_1471);
            __n247->saved[2] = (int64_t)(intptr_t)(__t245);
            __n247->saved[3] = (int64_t)(intptr_t)(__t246);
            __k = __n247; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic("boom");
          ...
          case 3: {
           ...
           r_1471 = __box247;
           bool __ps_248 = (err_qu(r_1471));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_248) {
            tur_cont *__n249 = (tur_cont*)malloc(sizeof(tur_cont));
            __n249->tag = 4; __n249->boundary = 0; __n249->next = __k;
            __n249->aggr_mask = 0x0u;
            __n249->saved[0] = (int64_t)(intptr_t)(n);
            __n249->saved[1] = (int64_t)(intptr_t)(r_1471);
            __n249->saved[2] = (int64_t)(intptr_t)(__t245);
            __n249->saved[3] = (int64_t)(intptr_t)(__t246);
            int64_t __ra249_0 = ((n) - (INT64_C(1)));
            n = __ra249_0;
            __k = __n249; __pc = 1; break;
           } else {
          ...
          case 4: {
           ...
           __t245 = (int64_t)(intptr_t)(__k->saved[2]);
           __t246 = (int64_t)(intptr_t)(__k->saved[3]);
           __t246 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)r_1471);
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t246)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_250 = (h(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_250));
        int64_t __t251;
        __t251 = INT64_C(0);
