         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n278->tag = 3; __n278->boundary = __b278; __n278->next = __k;
            __n278->aggr_mask = 0x0u;
            __n278->saved[0] = (int64_t)(intptr_t)(n);
            __n278->saved[1] = (int64_t)(intptr_t)(r_1610);
            __n278->saved[2] = (int64_t)(intptr_t)(__t276);
            __n278->saved[3] = (int64_t)(intptr_t)(__t277);
            __k = __n278; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic("boom");
          ...
          case 3: {
           ...
           r_1610 = __box278;
           bool __ps_279 = (err_qu(r_1610));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_279) {
            tur_cont *__n280 = (tur_cont*)malloc(sizeof(tur_cont));
            __n280->tag = 4; __n280->boundary = 0; __n280->next = __k;
            __n280->aggr_mask = 0x0u;
            __n280->saved[0] = (int64_t)(intptr_t)(n);
            __n280->saved[1] = (int64_t)(intptr_t)(r_1610);
            __n280->saved[2] = (int64_t)(intptr_t)(__t276);
            __n280->saved[3] = (int64_t)(intptr_t)(__t277);
            int64_t __ra280_0 = ((n) - (INT64_C(1)));
            n = __ra280_0;
            __k = __n280; __pc = 1; break;
           } else {
          ...
          case 4: {
           ...
           __t276 = (int64_t)(intptr_t)(__k->saved[2]);
           __t277 = (int64_t)(intptr_t)(__k->saved[3]);
           __t277 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)r_1610);
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t277)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_281 = (h(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_281));
        int64_t __t282;
        __t282 = INT64_C(0);
