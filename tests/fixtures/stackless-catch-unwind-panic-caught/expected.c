         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n162->saved[1] = (int64_t)(intptr_t)(r_1334);
          ...
          case 3: {
           ...
           r_1334 = __box162;
           bool __ps_163 = (err_qu(r_1334));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_163) {
            tur_cont *__n164 = (tur_cont*)malloc(sizeof(tur_cont));
            __n164->tag = 4; __n164->boundary = 0; __n164->next = __k;
            __n164->aggr_mask = 0x0u;
            __n164->saved[0] = (int64_t)(intptr_t)(n);
            __n164->saved[1] = (int64_t)(intptr_t)(r_1334);
            __n164->saved[2] = (int64_t)(intptr_t)(__t160);
            __n164->saved[3] = (int64_t)(intptr_t)(__t161);
            int64_t __ra164_0 = ((n) - (INT64_C(1)));
            n = __ra164_0;
            __k = __n164; __pc = 1; break;
           } else {
          ...
          case 4: {
           ...
           __t160 = (int64_t)(intptr_t)(__k->saved[2]);
           __t161 = (int64_t)(intptr_t)(__k->saved[3]);
           __t161 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t161)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_165 = (h(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_165));
        int64_t __t166;
        __t166 = INT64_C(0);
