...
static int64_t uid__gtint(int64_t);
...
static int64_t uid__gtint(int64_t u) {
        return (int64_t)u; 
}
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(uid__gtint(INT64_C(7))));
        printf("%lld\n", (long long)(uid__gtint(INT64_C(42))));
        printf("%lld\n", (long long)(INT64_C(100)));
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
}
