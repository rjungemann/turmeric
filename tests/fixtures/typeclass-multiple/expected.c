...
typedef struct dict_MyShow_int {
    ...
    const char * (*show_hylist)(int64_t, int64_t);
} dict_MyShow_int;

static dict_MyShow_int dict_MyShow_int_singleton = {
    .show = __inst_MyShow_show_int,
    .show_hylist = __inst_MyShow_show_hylist_int,
};
