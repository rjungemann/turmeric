...
static const char * __inst_MyShow_show_hylist_int(int64_t, int64_t);
static const char * __inst_MyShow_show_bool(bool);
static const char * __inst_MyShow_show_hylist_bool(bool, bool);
...
static const char * __inst_MyShow_show_hylist_int(int64_t x, int64_t y) {
        return "int list";
}
...
static const char * __inst_MyShow_show_hylist_bool(bool x, bool y) {
        return "bool list";
}
