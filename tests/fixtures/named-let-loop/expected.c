...
static int64_t __fn_1624(int64_t, int64_t);
...
static int64_t __fn_1624(int64_t n, int64_t acc) {
        __tur_tailcall:;
        if ((n) == (INT64_C(0))) {
            printf("%lld\n", (long long)(acc));
            return INT64_C(0);
        } else {
            int64_t __t62 = (n) - (INT64_C(1));
            int64_t __t63 = (acc) + (n);
            n = __t62;
            acc = __t63;
            goto __tur_tailcall;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t174;
        {
            int64_t __ps_175 = (__fn_1624(INT64_C(10), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t174 = __ps_175;
        }
        return (int)__t174;
