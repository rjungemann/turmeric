...
static int64_t __fn_1278(int64_t, int64_t);
...
static int64_t __fn_1278__cps(int64_t n_1276, int64_t acc_1277, DK *__kont);
...
static int64_t __fn_1278__cps(int64_t n, int64_t acc, DK *__kont) {
    bool __t0;
    int64_t __t1;
    int64_t __t2;
    __t0 = (n) == (INT64_C(0));
    if (__t0) {
        ...
        __auto_type __ps_40 = (__fn_1278((n) - (INT64_C(1)), (acc) + (n)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t2 = __ps_40;
        return dk_run(__kont, (intptr_t)(__t2));
    }
}
__attribute__((unused)) static int64_t __fn_1278(int64_t n, int64_t acc) {
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = __fn_1278__cps(n, acc, __root);
    dk_free(__root);
    return (int64_t)(__r);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t174;
        {
            __auto_type __ps_175 = (__fn_1278(INT64_C(10), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t174 = __ps_175;
        }
        return (int)__t174;
