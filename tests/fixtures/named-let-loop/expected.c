...
static int64_t __fn_1609(int64_t, int64_t);
...
static int64_t __fn_1609(int64_t n, int64_t acc) {
        __tur_tailcall:;
        if ((n) == (INT64_C(0))) {
            printf("%lld\n", (long long)(acc));
            return INT64_C(0);
        } else {
            int64_t __t128 = (n) - (INT64_C(1));
            int64_t __t129 = (acc) + (n);
            n = __t128;
            acc = __t129;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t277;
        {
            int64_t __ps_278 = (__fn_1609(INT64_C(10), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t277 = __ps_278;
        }
        return (int)__t277;
