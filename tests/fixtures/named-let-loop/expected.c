...
static int64_t __fn_1466(int64_t, int64_t);
...
static int64_t __fn_1466(int64_t n, int64_t acc) {
        __tur_tailcall:;
        if ((n) == (INT64_C(0))) {
            printf("%lld\n", (long long)(acc));
            return INT64_C(0);
        } else {
            int64_t __t92 = (n) - (INT64_C(1));
            int64_t __t93 = (acc) + (n);
            n = __t92;
            acc = __t93;
            goto __tur_tailcall;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t234;
        {
            int64_t __ps_235 = (__fn_1466(INT64_C(10), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t234 = __ps_235;
        }
        return (int)__t234;
