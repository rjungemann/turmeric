...
static int64_t __fn_1329(int64_t, int64_t);
...
static int64_t __fn_1329__cps(int64_t n_1327, int64_t acc_1328, DK *__kont);
...
static int64_t __fn_1329__cps(int64_t n, int64_t acc, DK *__kont) {
    int64_t __t0;
    int64_t __t42;
    if ((n) == (INT64_C(0))) {
        printf("%lld\n", (long long)(acc));
        ...
        int64_t __ps_44 = (__fn_1329((n) - (INT64_C(1)), (acc) + (n)));
...
__attribute__((unused)) static int64_t __fn_1329(int64_t n, int64_t acc) {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = __fn_1329__cps(n, acc, __root); }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t162;
        {
            int64_t __ps_163 = (__fn_1329(INT64_C(10), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t162 = __ps_163;
        }
        return (int)__t162;
