...
static int64_t __fn_1267(int64_t, int64_t);
...
static int64_t __fn_1267(int64_t n, int64_t acc) {
        __tur_tailcall:;
        if ((n) == (INT64_C(0))) {
            printf("%lld\n", (long long)(acc));
            return INT64_C(0);
        } else {
            int64_t __t43 = (n) - (INT64_C(1));
            int64_t __t44 = (acc) + (n);
            n = __t43;
            acc = __t44;
            goto __tur_tailcall;
...
int main(int argc, char **argv) {
        ...
        int64_t __t183;
        {
            __auto_type __ps_184 = (__fn_1267(INT64_C(10), INT64_C(0)));
