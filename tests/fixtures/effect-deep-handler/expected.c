...
static int64_t three_steps();

static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_619 = __k;
    int64_t __t6;
    bool __t7 = tur_effect_cont_valid(k_619);
    if (__t7) {
        int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_619, (int64_t)INT64_C(1));
        __t6 = __t8;
    } else {
        int64_t __t9 = tur_effect_cont_resume((int64_t)(intptr_t)k_619, (int64_t)INT64_C(0));
        __t6 = __t9;
    }
    return (int64_t)__t6;
}
...
static void __handle_body_4(void) {
    tur_current_fiber->result = (int64_t)three_steps();
}
...
static int64_t __dispatch_4(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Step") == 0) {
...
static int64_t three_steps() {
        int64_t __t0;
        {
            int64_t __t1 = tur_effect_perform("Step", NULL, 0);
            int64_t a_616 = __t1;
            (void)a_616;
            int64_t __t2 = tur_effect_perform("Step", NULL, 0);
            int64_t b_617 = __t2;
            (void)b_617;
            int64_t __t3 = tur_effect_perform("Step", NULL, 0);
            int64_t c_618 = __t3;
            (void)c_618;
            __t0 = ((a_616) + (((b_617) + (c_618))));
        }
        return __t0;
}
...
int main(int argc, char **argv) {
    ...
    __eff_frame_4.cases[0].effect_name = "Step";
