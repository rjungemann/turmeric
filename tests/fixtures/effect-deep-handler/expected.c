...
static int64_t __effect_handler_4(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_4 = __k;
    int64_t __t5;
    bool __t6 = !((TurContK *)(intptr_t)k_4)->consumed;
    if (__t6) {
        if (((TurContK *)(intptr_t)k_4)->origin_fiber != (void *)tur_current_fiber) { fprintf(stderr, "continuation error: resume on wrong fiber\n"); abort(); }
...
int main(void) {
    ...
    EffectHandlerFrame **__eff_chain_7 = (tur_current_fiber ? (EffectHandlerFrame **)&tur_current_fiber->effect_handler_chain : &global_effect_handler_chain);
    __eff_frame_7.parent = *__eff_chain_7;
    __eff_frame_7.n_cases = 1;
    __eff_frame_7.cases[0].effect_name = "Step";
    __eff_frame_7.cases[0].handler_fn = __effect_handler_4;
    __eff_frame_7.cases[0].env = NULL;
    *__eff_chain_7 = &__eff_frame_7;
    int64_t __t8 = three_steps();
