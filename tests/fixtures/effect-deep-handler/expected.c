...
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_24 = __k;
    int64_t __t6;
    bool __t7 = tur_effect_cont_valid(k_24);
    if (__t7) {
        int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_24, (int64_t)INT64_C(1));
        __t6 = __t8;
    } else {
        int64_t __t9 = tur_effect_cont_resume((int64_t)(intptr_t)k_24, (int64_t)INT64_C(0));
        __t6 = __t9;
    }
    return (int64_t)__t6;
}
