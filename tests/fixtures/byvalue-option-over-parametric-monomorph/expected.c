...
static tur_adt_Result__Vec__int__cstr mk_hyv(int64_t n) {
        tur_adt_Result__Vec__int__cstr __t176;
        {
            ...
            tur_adt_Vec__int * v_1630 = __ps_177;
            (void)v_1630;
            vec_hypush_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(v_1630))), n);
            tur_adt_Result__Vec__int__cstr __t178;
            tur_adt_Result__Vec__int__cstr __ps_179 = (ok__spec__tur_adt_Result__Vec__int__cstr_tur_adt_Vec__int__(v_1630));
            if (tur_panicking) return (tur_adt_Result__Vec__int__cstr){0};
            __t178 = __ps_179;
            __t176 = __t178;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t182;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__P p_1632 = __ps_183;
            (void)p_1632;
            tur_adt_Option__Q__int __ps_184 = (mk_hyq(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__Q__int q_1633 = __ps_184;
            (void)q_1633;
            tur_adt_Result__Vec__int__cstr __ps_185 = (mk_hyv(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__Vec__int__cstr v_1634 = __ps_185;
            (void)v_1634;
            tur_adt_Option__Option__int __ps_186 = (mk_hyoo(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__Option__int oo_1635 = __ps_186;
            (void)oo_1635;
            int64_t __t187;
            bool __ps_188 = (some___spec__bool_tur_adt_Option__P(p_1632));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_188) {
                tur_adt_P __ps_189 = (unwrap__spec__tur_adt_P_tur_adt_Option__P(p_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t187));
            int64_t __t190;
            bool __ps_191 = (some___spec__bool_tur_adt_Option__P(p_1632));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_191) {
                tur_adt_P __ps_192 = (unwrap__spec__tur_adt_P_tur_adt_Option__P(p_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t190));
            int64_t __t193;
            bool __ps_194 = (some___spec__bool_tur_adt_Option__Q__int(q_1633));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_194) {
                tur_adt_Q__int __ps_195 = (unwrap__spec__tur_adt_Q__int_tur_adt_Option__Q__int(q_1633));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t193));
            int64_t __t196;
            bool __ps_197 = (ok___spec__bool_tur_adt_Result__Vec__int__cstr(v_1634));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_197) {
                tur_adt_Vec__int * __ps_198 = (ok_val__spec__tur_adt_Vec__int___tur_adt_Result__Vec__int__cstr(v_1634));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t196));
            int64_t __t200;
            bool __ps_201 = (some___spec__bool_tur_adt_Option__Option__int(oo_1635));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_201) {
                int64_t __t202;
                {
                    tur_adt_Option__int __ps_203 = (unwrap__spec__tur_adt_Option__int_tur_adt_Option__Option__int(oo_1635));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    tur_adt_Option__int inner_1636 = __ps_203;
                    (void)inner_1636;
                    int64_t __t204;
                    bool __ps_205 = (some___spec__bool_tur_adt_Option__int(inner_1636));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    if (__ps_205) {
                        int64_t __ps_206 = (unwrap__spec__int64_t_tur_adt_Option__int(inner_1636));
                        /* panic-return-signal: ret ctype unknown; no propagation here */
                        __t204 = __ps_206;
                    } else {
            ...
            case 0:
                break;
            case 1:
                if (p_1632.as.Some._0) free((void *)(intptr_t)p_1632.as.Some._0);
                break;
            }
        }
        return (int)__t182;
...
static bool some___spec__bool_tur_adt_Option__P(tur_adt_Option__P o) {
        bool __t210 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                tur_adt_P _un_1069 = *(tur_adt_P *)(intptr_t)(__scrut->as.Some._0);
                __t210 = true;
                break;
            }
            case 0: {
...
static tur_adt_P unwrap__spec__tur_adt_P_tur_adt_Option__P(tur_adt_Option__P o) {
        tur_adt_P __t211 = {0};
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                tur_adt_P v_1073 = *(tur_adt_P *)(intptr_t)(__scrut->as.Some._0);
                __t211 = v_1073;
                break;
            }
            case 0: {
...
static bool some___spec__bool_tur_adt_Option__Q__int(tur_adt_Option__Q__int o) {
        bool __t212 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                tur_adt_Q__int _un_1069 = __scrut->as.Some._0;
                __t212 = true;
                break;
            }
            case 0: {
...
static tur_adt_Q__int unwrap__spec__tur_adt_Q__int_tur_adt_Option__Q__int(tur_adt_Option__Q__int o) {
        tur_adt_Q__int __t213 = {0};
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                tur_adt_Q__int v_1073 = __scrut->as.Some._0;
                __t213 = v_1073;
                break;
            }
            case 0: {
...
static bool ok___spec__bool_tur_adt_Result__Vec__int__cstr(tur_adt_Result__Vec__int__cstr r) {
        bool __t214 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                tur_adt_Vec__int * _un_1119 = (tur_adt_Vec__int *)__scrut->as.Ok._0;
                __t214 = true;
                break;
            }
            case 1: {
                const char * _un_1120 = (const char *)__scrut->as.Err._0;
                __t214 = false;
                break;
            }
            default: break;
...
static tur_adt_Vec__int * ok_val__spec__tur_adt_Vec__int___tur_adt_Result__Vec__int__cstr(tur_adt_Result__Vec__int__cstr r) {
        tur_adt_Vec__int * __t215 = {0};
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                tur_adt_Vec__int * v_1125 = (tur_adt_Vec__int *)__scrut->as.Ok._0;
                __t215 = v_1125;
                break;
            }
            case 1: {
                const char * _un_1126 = (const char *)__scrut->as.Err._0;
...
static bool some___spec__bool_tur_adt_Option__Option__int(tur_adt_Option__Option__int o) {
        bool __t216 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                tur_adt_Option__int _un_1069 = __scrut->as.Some._0;
                __t216 = true;
                break;
            }
            case 0: {
...
static tur_adt_Option__int unwrap__spec__tur_adt_Option__int_tur_adt_Option__Option__int(tur_adt_Option__Option__int o) {
        tur_adt_Option__int __t217 = {0};
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                tur_adt_Option__int v_1073 = __scrut->as.Some._0;
                __t217 = v_1073;
                break;
            }
            case 0: {
