...
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * s_262 = (const char *)__effect_args[0];
    int64_t k_263 = __k;
    puts(s_262);
    int64_t __t7;
    int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_263, (int64_t)0);
    __t7 = __t8;
    return (int64_t)__t7;
}
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_264 = __k;
    int64_t __t9 = tur_effect_cont_resume((int64_t)(intptr_t)k_264, (int64_t)INT64_C(42));
    return (int64_t)__t9;
}
...
int main() {
        int64_t __t3;
        {
            ...
            int64_t result_265 = __t10;
            (void)result_265;
            printf("%lld\n", (long long)(result_265));
            int64_t __t11;
            __t11 = INT64_C(0);
            __t3 = __t11;
        }
