...
static int64_t fmap_twice(int64_t, int64_t);
...
static int64_t fmap_twice(int64_t container, int64_t fn) {
        return ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_option_singleton.fmap))(((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_option_singleton.fmap))(container, fn), fn);
}
...
int main() {
        {
            int64_t opt_225 = __opt_some(INT64_C(10));
            (void)opt_225;
            {
                int64_t result_226 = fmap_twice(opt_225, (int64_t)(intptr_t)(inc));
                (void)result_226;
                printf("%lld\n", (long long)(__opt_unwrap(result_226)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
