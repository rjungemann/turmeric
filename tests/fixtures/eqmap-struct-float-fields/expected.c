        ...
        }
        {
            int64_t __t4;
            {
                ...
                int64_t __t5;
                {
                    ...
                    (void)__tur_mk___869;
                    __t5 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___869), __inst_Hash_hash_FPoint(__tur_mk___869), __inst_MapKey_mk_box_FPoint(__tur_mk___869), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___869), __inst_MapKey_mk_owned__FPoint(__tur_mk___869));
                }
                __t4 = map_assoc_eq_o(tur_map_kcheck(__t5, &__tur_mk___868), __inst_Hash_hash_FPoint(__tur_mk___868), __inst_MapKey_mk_box_FPoint(__tur_mk___868), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___868), __inst_MapKey_mk_owned__FPoint(__tur_mk___868));
            }
            int64_t a_870 = __t4;
            (void)a_870;
            int64_t __t6;
            {
                ...
                int64_t __t7;
                {
                    ...
                    (void)__tur_mk___872;
                    __t7 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___872), __inst_Hash_hash_FPoint(__tur_mk___872), __inst_MapKey_mk_box_FPoint(__tur_mk___872), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___872), __inst_MapKey_mk_owned__FPoint(__tur_mk___872));
                }
                __t6 = map_assoc_eq_o(tur_map_kcheck(__t7, &__tur_mk___871), __inst_Hash_hash_FPoint(__tur_mk___871), __inst_MapKey_mk_box_FPoint(__tur_mk___871), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___871), __inst_MapKey_mk_owned__FPoint(__tur_mk___871));
            }
            int64_t b_873 = __t6;
            (void)b_873;
            int64_t __t8;
            {
                ...
                int64_t __t9;
                {
                    ...
                    (void)__tur_mk___875;
                    __t9 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___875), __inst_Hash_hash_FPoint(__tur_mk___875), __inst_MapKey_mk_box_FPoint(__tur_mk___875), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___875), __inst_MapKey_mk_owned__FPoint(__tur_mk___875));
                }
                __t8 = map_assoc_eq_o(tur_map_kcheck(__t9, &__tur_mk___874), __inst_Hash_hash_FPoint(__tur_mk___874), __inst_MapKey_mk_box_FPoint(__tur_mk___874), INT64_C(999), __inst_MapKey_mk_cmp_FPoint(__tur_mk___874), __inst_MapKey_mk_owned__FPoint(__tur_mk___874));
            }
            int64_t c_876 = __t8;
            (void)c_876;
            int64_t __t10;
            {
                ...
                int64_t __t11;
                {
                    ...
                    (void)__tur_mk___878;
                    __t11 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___878), __inst_Hash_hash_FPoint(__tur_mk___878), __inst_MapKey_mk_box_FPoint(__tur_mk___878), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___878), __inst_MapKey_mk_owned__FPoint(__tur_mk___878));
                }
                __t10 = map_assoc_eq_o(tur_map_kcheck(__t11, &__tur_mk___877), __inst_Hash_hash_FPoint(__tur_mk___877), __inst_MapKey_mk_box_FPoint(__tur_mk___877), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___877), __inst_MapKey_mk_owned__FPoint(__tur_mk___877));
            }
            int64_t d_879 = __t10;
            (void)d_879;
            int64_t __t12;
