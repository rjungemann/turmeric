        ...
        }
        {
            int64_t __t8;
            {
                ...
                int64_t __t9;
                {
                    ...
                    (void)__tur_mk___869;
                    __t9 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___869), __inst_Hash_hash_FPoint(__tur_mk___869), __inst_MapKey_mk_box_FPoint(__tur_mk___869), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___869), __inst_MapKey_mk_owned__FPoint(__tur_mk___869));
                }
                __t8 = map_assoc_eq_o(tur_map_kcheck(__t9, &__tur_mk___868), __inst_Hash_hash_FPoint(__tur_mk___868), __inst_MapKey_mk_box_FPoint(__tur_mk___868), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___868), __inst_MapKey_mk_owned__FPoint(__tur_mk___868));
            }
            int64_t a_870 = __t8;
            (void)a_870;
            int64_t __t10;
            {
                ...
                int64_t __t11;
                {
                    ...
                    (void)__tur_mk___872;
                    __t11 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___872), __inst_Hash_hash_FPoint(__tur_mk___872), __inst_MapKey_mk_box_FPoint(__tur_mk___872), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___872), __inst_MapKey_mk_owned__FPoint(__tur_mk___872));
                }
                __t10 = map_assoc_eq_o(tur_map_kcheck(__t11, &__tur_mk___871), __inst_Hash_hash_FPoint(__tur_mk___871), __inst_MapKey_mk_box_FPoint(__tur_mk___871), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___871), __inst_MapKey_mk_owned__FPoint(__tur_mk___871));
            }
            int64_t b_873 = __t10;
            (void)b_873;
            int64_t __t12;
            {
                ...
                int64_t __t13;
                {
                    ...
                    (void)__tur_mk___875;
                    __t13 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___875), __inst_Hash_hash_FPoint(__tur_mk___875), __inst_MapKey_mk_box_FPoint(__tur_mk___875), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___875), __inst_MapKey_mk_owned__FPoint(__tur_mk___875));
                }
                __t12 = map_assoc_eq_o(tur_map_kcheck(__t13, &__tur_mk___874), __inst_Hash_hash_FPoint(__tur_mk___874), __inst_MapKey_mk_box_FPoint(__tur_mk___874), INT64_C(999), __inst_MapKey_mk_cmp_FPoint(__tur_mk___874), __inst_MapKey_mk_owned__FPoint(__tur_mk___874));
            }
            int64_t c_876 = __t12;
            (void)c_876;
            int64_t __t14;
            {
                ...
                int64_t __t15;
                {
                    ...
                    (void)__tur_mk___878;
                    __t15 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___878), __inst_Hash_hash_FPoint(__tur_mk___878), __inst_MapKey_mk_box_FPoint(__tur_mk___878), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___878), __inst_MapKey_mk_owned__FPoint(__tur_mk___878));
                }
                __t14 = map_assoc_eq_o(tur_map_kcheck(__t15, &__tur_mk___877), __inst_Hash_hash_FPoint(__tur_mk___877), __inst_MapKey_mk_box_FPoint(__tur_mk___877), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___877), __inst_MapKey_mk_owned__FPoint(__tur_mk___877));
            }
            int64_t d_879 = __t14;
            (void)d_879;
            int64_t __t16;
            if (map_eq_k_(a_870, b_873, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (int64_t)(intptr_t)(__fn_882))) {
                __t16 = INT64_C(1);
            } else {
                __t16 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t16));
            int64_t __t17;
            if (map_eq_k_(a_870, c_876, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (int64_t)(intptr_t)(__fn_886))) {
                __t17 = INT64_C(1);
            } else {
                __t17 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t17));
            int64_t __t18;
            if (map_eq_k_(a_870, d_879, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (int64_t)(intptr_t)(__fn_890))) {
                __t18 = INT64_C(1);
            } else {
                __t18 = INT64_C(0);
            }
