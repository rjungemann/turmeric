...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t26;
            {
                FPoint __tur_mk___868 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)__tur_mk___868;
                int64_t __t27;
                {
                    FPoint __tur_mk___869 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)__tur_mk___869;
                    __t27 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___869), __inst_Hash_hash_FPoint(__tur_mk___869), __inst_MapKey_mk_box_FPoint(__tur_mk___869), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___869), __inst_MapKey_mk_owned__FPoint(__tur_mk___869));
                }
                __t26 = map_assoc_eq_o(tur_map_kcheck(__t27, &__tur_mk___868), __inst_Hash_hash_FPoint(__tur_mk___868), __inst_MapKey_mk_box_FPoint(__tur_mk___868), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___868), __inst_MapKey_mk_owned__FPoint(__tur_mk___868));
            }
            int64_t a_870 = __t26;
            (void)a_870;
            int64_t __t28;
            {
                FPoint __tur_mk___871 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)__tur_mk___871;
                int64_t __t29;
                {
                    FPoint __tur_mk___872 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)__tur_mk___872;
                    __t29 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___872), __inst_Hash_hash_FPoint(__tur_mk___872), __inst_MapKey_mk_box_FPoint(__tur_mk___872), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___872), __inst_MapKey_mk_owned__FPoint(__tur_mk___872));
                }
                __t28 = map_assoc_eq_o(tur_map_kcheck(__t29, &__tur_mk___871), __inst_Hash_hash_FPoint(__tur_mk___871), __inst_MapKey_mk_box_FPoint(__tur_mk___871), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___871), __inst_MapKey_mk_owned__FPoint(__tur_mk___871));
            }
            int64_t b_873 = __t28;
            (void)b_873;
            int64_t __t30;
            {
                FPoint __tur_mk___874 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)__tur_mk___874;
                int64_t __t31;
                {
                    FPoint __tur_mk___875 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)__tur_mk___875;
                    __t31 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___875), __inst_Hash_hash_FPoint(__tur_mk___875), __inst_MapKey_mk_box_FPoint(__tur_mk___875), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___875), __inst_MapKey_mk_owned__FPoint(__tur_mk___875));
                }
                __t30 = map_assoc_eq_o(tur_map_kcheck(__t31, &__tur_mk___874), __inst_Hash_hash_FPoint(__tur_mk___874), __inst_MapKey_mk_box_FPoint(__tur_mk___874), INT64_C(999), __inst_MapKey_mk_cmp_FPoint(__tur_mk___874), __inst_MapKey_mk_owned__FPoint(__tur_mk___874));
            }
            int64_t c_876 = __t30;
            (void)c_876;
            int64_t __t32;
            {
                FPoint __tur_mk___877 = (FPoint){.x = ((float)9.9), .y = ((float)9.9)};
                (void)__tur_mk___877;
                int64_t __t33;
                {
                    FPoint __tur_mk___878 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)__tur_mk___878;
                    __t33 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___878), __inst_Hash_hash_FPoint(__tur_mk___878), __inst_MapKey_mk_box_FPoint(__tur_mk___878), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___878), __inst_MapKey_mk_owned__FPoint(__tur_mk___878));
                }
                __t32 = map_assoc_eq_o(tur_map_kcheck(__t33, &__tur_mk___877), __inst_Hash_hash_FPoint(__tur_mk___877), __inst_MapKey_mk_box_FPoint(__tur_mk___877), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___877), __inst_MapKey_mk_owned__FPoint(__tur_mk___877));
            }
            int64_t d_879 = __t32;
            (void)d_879;
            int64_t __t34;
            ...
            void *__t36 = __t35;
            if (map_eq_k_qu(a_870, b_873, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (void *)(intptr_t)(__t36))) {
                __t34 = INT64_C(1);
            } else {
                __t34 = INT64_C(0);
            }
            ...
            void *__t39 = __t38;
            if (map_eq_k_qu(a_870, c_876, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (void *)(intptr_t)(__t39))) {
                __t37 = INT64_C(1);
            } else {
                __t37 = INT64_C(0);
            }
            ...
            void *__t42 = __t41;
            if (map_eq_k_qu(a_870, d_879, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (void *)(intptr_t)(__t42))) {
                __t40 = INT64_C(1);
            } else {
                __t40 = INT64_C(0);
            }
