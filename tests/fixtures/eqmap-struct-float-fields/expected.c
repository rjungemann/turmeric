...
static int64_t __inst_Hash_hash_FPoint(FPoint);
static bool __inst_Eq_eq_qu_FPoint(FPoint, FPoint);
static int64_t __inst_MapKey_mk_hybox_FPoint(FPoint);
static int64_t __inst_MapKey_mk_hycmp_FPoint(FPoint);
static int64_t __inst_MapKey_mk_hyowned_qu_FPoint(FPoint);
...
static bool fpoint_hycarrier_hyeq_qu(int64_t, int64_t);
...
static int64_t __inst_Hash_hash_FPoint(FPoint p) {
        uint32_t ix, iy;
...
typedef struct dict_Hash_FPoint {
    int64_t (*hash)(FPoint);
} dict_Hash_FPoint;

static dict_Hash_FPoint dict_Hash_FPoint_singleton = {
    .hash = __inst_Hash_hash_FPoint,
};

static bool __inst_Eq_eq_qu_FPoint(FPoint a, FPoint b) {
        bool __t20 = ((a).x) == ((b).x);
        if (__t20) {
            __t20 = ((a).y) == ((b).y);
        }
...
typedef struct dict_Eq_FPoint {
    bool (*eq_qu)(FPoint, FPoint);
} dict_Eq_FPoint;

static dict_Eq_FPoint dict_Eq_FPoint_singleton = {
    .eq_qu = __inst_Eq_eq_qu_FPoint,
};

static int64_t __inst_MapKey_mk_hybox_FPoint(FPoint p) {
        return (int64_t)(intptr_t)tur_hamt_box_key(&p, sizeof(p)); 
}

static int64_t __inst_MapKey_mk_hycmp_FPoint(FPoint p) {
        return (int64_t)(intptr_t)fpoint_hycarrier_hyeq_qu;
}

static int64_t __inst_MapKey_mk_hyowned_qu_FPoint(FPoint p) {
        return INT64_C(1);
}

typedef struct dict_MapKey_FPoint {
    int64_t (*mk_hybox)(FPoint);
    int64_t (*mk_hycmp)(FPoint);
    int64_t (*mk_hyowned_qu)(FPoint);
} dict_MapKey_FPoint;

static dict_MapKey_FPoint dict_MapKey_FPoint_singleton = {
    .mk_hybox = __inst_MapKey_mk_hybox_FPoint,
    .mk_hycmp = __inst_MapKey_mk_hycmp_FPoint,
    .mk_hyowned_qu = __inst_MapKey_mk_hyowned_qu_FPoint,
};
...
static bool fpoint_hycarrier_hyeq_qu(int64_t a, int64_t b) {
        FPoint *pa = (FPoint *)(intptr_t)a; FPoint *pb = (FPoint *)(intptr_t)b;
...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t26;
            {
                FPoint _un_untur_unmk_un_un_903 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)_un_untur_unmk_un_un_903;
                int64_t __t27;
                {
                    FPoint _un_untur_unmk_un_un_904 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)_un_untur_unmk_un_un_904;
                    __t27 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_904), __inst_Hash_hash_FPoint(_un_untur_unmk_un_un_904), __inst_MapKey_mk_hybox_FPoint(_un_untur_unmk_un_un_904), INT64_C(100), __inst_MapKey_mk_hycmp_FPoint(_un_untur_unmk_un_un_904), __inst_MapKey_mk_hyowned_qu_FPoint(_un_untur_unmk_un_un_904));
                }
                __t26 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t27, &_un_untur_unmk_un_un_903), __inst_Hash_hash_FPoint(_un_untur_unmk_un_un_903), __inst_MapKey_mk_hybox_FPoint(_un_untur_unmk_un_un_903), INT64_C(200), __inst_MapKey_mk_hycmp_FPoint(_un_untur_unmk_un_un_903), __inst_MapKey_mk_hyowned_qu_FPoint(_un_untur_unmk_un_un_903));
            }
            int64_t a_905 = __t26;
            (void)a_905;
            int64_t __t28;
            {
                FPoint _un_untur_unmk_un_un_906 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)_un_untur_unmk_un_un_906;
                int64_t __t29;
                {
                    FPoint _un_untur_unmk_un_un_907 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)_un_untur_unmk_un_un_907;
                    __t29 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_907), __inst_Hash_hash_FPoint(_un_untur_unmk_un_un_907), __inst_MapKey_mk_hybox_FPoint(_un_untur_unmk_un_un_907), INT64_C(100), __inst_MapKey_mk_hycmp_FPoint(_un_untur_unmk_un_un_907), __inst_MapKey_mk_hyowned_qu_FPoint(_un_untur_unmk_un_un_907));
                }
                __t28 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t29, &_un_untur_unmk_un_un_906), __inst_Hash_hash_FPoint(_un_untur_unmk_un_un_906), __inst_MapKey_mk_hybox_FPoint(_un_untur_unmk_un_un_906), INT64_C(200), __inst_MapKey_mk_hycmp_FPoint(_un_untur_unmk_un_un_906), __inst_MapKey_mk_hyowned_qu_FPoint(_un_untur_unmk_un_un_906));
            }
            int64_t b_908 = __t28;
            (void)b_908;
            int64_t __t30;
            {
                FPoint _un_untur_unmk_un_un_909 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)_un_untur_unmk_un_un_909;
                int64_t __t31;
                {
                    FPoint _un_untur_unmk_un_un_910 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)_un_untur_unmk_un_un_910;
                    __t31 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_910), __inst_Hash_hash_FPoint(_un_untur_unmk_un_un_910), __inst_MapKey_mk_hybox_FPoint(_un_untur_unmk_un_un_910), INT64_C(100), __inst_MapKey_mk_hycmp_FPoint(_un_untur_unmk_un_un_910), __inst_MapKey_mk_hyowned_qu_FPoint(_un_untur_unmk_un_un_910));
                }
                __t30 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t31, &_un_untur_unmk_un_un_909), __inst_Hash_hash_FPoint(_un_untur_unmk_un_un_909), __inst_MapKey_mk_hybox_FPoint(_un_untur_unmk_un_un_909), INT64_C(999), __inst_MapKey_mk_hycmp_FPoint(_un_untur_unmk_un_un_909), __inst_MapKey_mk_hyowned_qu_FPoint(_un_untur_unmk_un_un_909));
            }
            int64_t c_911 = __t30;
            (void)c_911;
            int64_t __t32;
            {
                FPoint _un_untur_unmk_un_un_912 = (FPoint){.x = ((float)9.9), .y = ((float)9.9)};
                (void)_un_untur_unmk_un_un_912;
                int64_t __t33;
                {
                    FPoint _un_untur_unmk_un_un_913 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)_un_untur_unmk_un_un_913;
                    __t33 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_913), __inst_Hash_hash_FPoint(_un_untur_unmk_un_un_913), __inst_MapKey_mk_hybox_FPoint(_un_untur_unmk_un_un_913), INT64_C(100), __inst_MapKey_mk_hycmp_FPoint(_un_untur_unmk_un_un_913), __inst_MapKey_mk_hyowned_qu_FPoint(_un_untur_unmk_un_un_913));
                }
                __t32 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t33, &_un_untur_unmk_un_un_912), __inst_Hash_hash_FPoint(_un_untur_unmk_un_un_912), __inst_MapKey_mk_hybox_FPoint(_un_untur_unmk_un_un_912), INT64_C(200), __inst_MapKey_mk_hycmp_FPoint(_un_untur_unmk_un_un_912), __inst_MapKey_mk_hyowned_qu_FPoint(_un_untur_unmk_un_un_912));
            }
            int64_t d_914 = __t32;
            (void)d_914;
            int64_t __t34;
            ...
            void *__t36 = __t35;
            if (map_hyeq_hyk_qu(a_905, b_908, __inst_MapKey_mk_hycmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (void *)(intptr_t)(__t36))) {
                __t34 = INT64_C(1);
            } else {
                __t34 = INT64_C(0);
            }
            ...
            void *__t39 = __t38;
            if (map_hyeq_hyk_qu(a_905, c_911, __inst_MapKey_mk_hycmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (void *)(intptr_t)(__t39))) {
                __t37 = INT64_C(1);
            } else {
                __t37 = INT64_C(0);
            }
            ...
            void *__t42 = __t41;
            if (map_hyeq_hyk_qu(a_905, d_914, __inst_MapKey_mk_hycmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (void *)(intptr_t)(__t42))) {
                __t40 = INT64_C(1);
            } else {
                __t40 = INT64_C(0);
            }
