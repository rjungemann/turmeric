...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t4;
            {
                FPoint __tur_mk___860 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)__tur_mk___860;
                int64_t __t5;
                {
                    FPoint __tur_mk___861 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)__tur_mk___861;
                    __t5 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___861), __inst_Hash_hash_FPoint(__tur_mk___861), __inst_MapKey_mk_box_FPoint(__tur_mk___861), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___861), __inst_MapKey_mk_owned__FPoint(__tur_mk___861));
                }
                __t4 = map_assoc_eq_o(tur_map_kcheck(__t5, &__tur_mk___860), __inst_Hash_hash_FPoint(__tur_mk___860), __inst_MapKey_mk_box_FPoint(__tur_mk___860), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___860), __inst_MapKey_mk_owned__FPoint(__tur_mk___860));
            }
            int64_t a_862 = __t4;
            (void)a_862;
            int64_t __t6;
            {
                FPoint __tur_mk___863 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)__tur_mk___863;
                int64_t __t7;
                {
                    FPoint __tur_mk___864 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)__tur_mk___864;
                    __t7 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___864), __inst_Hash_hash_FPoint(__tur_mk___864), __inst_MapKey_mk_box_FPoint(__tur_mk___864), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___864), __inst_MapKey_mk_owned__FPoint(__tur_mk___864));
                }
                __t6 = map_assoc_eq_o(tur_map_kcheck(__t7, &__tur_mk___863), __inst_Hash_hash_FPoint(__tur_mk___863), __inst_MapKey_mk_box_FPoint(__tur_mk___863), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___863), __inst_MapKey_mk_owned__FPoint(__tur_mk___863));
            }
            int64_t b_865 = __t6;
            (void)b_865;
            int64_t __t8;
            {
                FPoint __tur_mk___866 = (FPoint){.x = ((float)3.5), .y = ((float)4.5)};
                (void)__tur_mk___866;
                int64_t __t9;
                {
                    FPoint __tur_mk___867 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)__tur_mk___867;
                    __t9 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___867), __inst_Hash_hash_FPoint(__tur_mk___867), __inst_MapKey_mk_box_FPoint(__tur_mk___867), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___867), __inst_MapKey_mk_owned__FPoint(__tur_mk___867));
                }
                __t8 = map_assoc_eq_o(tur_map_kcheck(__t9, &__tur_mk___866), __inst_Hash_hash_FPoint(__tur_mk___866), __inst_MapKey_mk_box_FPoint(__tur_mk___866), INT64_C(999), __inst_MapKey_mk_cmp_FPoint(__tur_mk___866), __inst_MapKey_mk_owned__FPoint(__tur_mk___866));
            }
            int64_t c_868 = __t8;
            (void)c_868;
            int64_t __t10;
            {
                FPoint __tur_mk___869 = (FPoint){.x = ((float)9.9), .y = ((float)9.9)};
                (void)__tur_mk___869;
                int64_t __t11;
                {
                    FPoint __tur_mk___870 = (FPoint){.x = ((float)1.5), .y = ((float)2.5)};
                    (void)__tur_mk___870;
                    __t11 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___870), __inst_Hash_hash_FPoint(__tur_mk___870), __inst_MapKey_mk_box_FPoint(__tur_mk___870), INT64_C(100), __inst_MapKey_mk_cmp_FPoint(__tur_mk___870), __inst_MapKey_mk_owned__FPoint(__tur_mk___870));
                }
                __t10 = map_assoc_eq_o(tur_map_kcheck(__t11, &__tur_mk___869), __inst_Hash_hash_FPoint(__tur_mk___869), __inst_MapKey_mk_box_FPoint(__tur_mk___869), INT64_C(200), __inst_MapKey_mk_cmp_FPoint(__tur_mk___869), __inst_MapKey_mk_owned__FPoint(__tur_mk___869));
            }
            int64_t d_871 = __t10;
            (void)d_871;
            int64_t __t12;
            if (map_eq_k_(a_862, b_865, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (int64_t)(intptr_t)(__fn_874))) {
                __t12 = INT64_C(1);
            } else {
                __t12 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t12));
            int64_t __t13;
            if (map_eq_k_(a_862, c_868, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (int64_t)(intptr_t)(__fn_878))) {
                __t13 = INT64_C(1);
            } else {
                __t13 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t13));
            int64_t __t14;
            if (map_eq_k_(a_862, d_871, __inst_MapKey_mk_cmp_FPoint((FPoint){.x = 0.0, .y = 0.0}), (int64_t)(intptr_t)(__fn_882))) {
                __t14 = INT64_C(1);
            } else {
                __t14 = INT64_C(0);
            }
