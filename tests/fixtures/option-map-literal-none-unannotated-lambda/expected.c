...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_265 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t266 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
        tur_adt_Option__int __ps_267 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_265, (int64_t)(intptr_t)(__t266)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_265) tur_region_free((void *)(intptr_t)__ps_265);
        int64_t __ps_268 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_267, INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_268));
        int64_t __ps_269 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t270 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_271 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_269, (int64_t)(intptr_t)(__t270)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_269) tur_region_free((void *)(intptr_t)__ps_269);
        int64_t __ps_272 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_271, INT64_C(88)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_272));
        tur_adt_Option__int __ps_273 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t274 = (void *)((char *)&__tur_fatbox_4 + sizeof(void *));
        tur_adt_Option__int __ps_275 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_273, (int64_t)(intptr_t)(__t274)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_276 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_275, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_276));
        int64_t __t277;
        __t277 = INT64_C(0);
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_int64_t_int64_t(int64_t o, int64_t f) {
        tur_adt_Option__int __t281 = {0};
        {
            tur_adt_Option *__scrut = (tur_adt_Option *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_933 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_282 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_933));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_283 = (some__spec__tur_adt_Option__int_int64_t(__ps_282));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t281 = __ps_283;
                break;
            }
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t287 = {0};
        {
            ...
            case 1: {
                int64_t v_933 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_288 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_933));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_289 = (some__spec__tur_adt_Option__int_int64_t(__ps_288));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t287 = __ps_289;
                break;
            }
            case 0: {
                tur_adt_Option__int __ps_290 = (none__spec__tur_adt_Option__int());
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t287 = __ps_290;
                break;
            }
