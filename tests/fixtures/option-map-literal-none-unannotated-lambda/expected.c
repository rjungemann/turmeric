...
static int64_t unwrap_hyor(int64_t o, int64_t dflt) {
        int64_t __t94 = 0;
        {
            ...
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_864 = (int64_t)__scrut->as.Some._0;
                __t94 = v_864;
                break;
            }
            case 0: {
...
static int64_t option_hymap(int64_t o, int64_t f) {
        int64_t __t95 = 0;
        {
            ...
            case 1: {
                ...
                int64_t __ps_96 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_870));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_97 = (some(__ps_96));
                if (tur_panicking) return ((int64_t)0);
                __t95 = __ps_97;
                break;
            }
            case 0: {
                int64_t __ps_98 = (none());
                if (tur_panicking) return ((int64_t)0);
                __t95 = __ps_98;
                break;
            }
        ...
        if (__ps_108) {
            bool __t109;
            {
                ...
                if ((t1_1070) == (INT64_C(0))) {
                    __t110 = (t2_1071) == (INT64_C(0));
                } else {
                    bool __t111;
                    if ((t2_1071) == (INT64_C(0))) {
                        __t111 = false;
                    } else {
                        bool __ps_112 = (cons_hyeq_hygo(t1_1070, t2_1071));
                        if (tur_panicking) return ((bool)0);
                        __t111 = __ps_112;
                    }
                    __t110 = __t111;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_118) {
            ...
            int64_t __t119;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1086 = (int64_t)(intptr_t)(__ps_123);
                (void)out_1086;
                __t119 = out_1086;
            }
            __t117 = __t119;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t128;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1161 = __ps_130;
            (void)iter_1161;
            void * __ps_131 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_132 = (hamt_slkeyeq((void *)(intptr_t)(__ps_131)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1162 = __ps_132;
            (void)keyeq_1162;
            void * __ps_133 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_134 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1161), (void *)(intptr_t)(__ps_133), (void *)(intptr_t)(keyeq_1162)));
            if (tur_panicking) return ((bool)0);
            bool result_1163 = __ps_134;
            (void)result_1163;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t155;
        {
            ...
            {
                tur_adt_Vec__int * __ps_157 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1290));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1291 = __ps_157;
                (void)_un_unv_1291;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t161;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1341 = __ps_162;
            (void)r_1341;
            int64_t __t163;
            bool __ps_164 = (schema_hydecode_hyok_qu(r_1341));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_164) {
                int64_t __ps_165 = (schema_hydecode_hyvalue(r_1341));
                if (tur_panicking) return ((int64_t)0);
                __t163 = __ps_165;
            } else {
                int64_t __ps_166 = (schema_hydecode_hyerrors(r_1341));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_169 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t170 = (void *)((char *)&__tur_fatbox_0 + sizeof(void *));
        int64_t __ps_171 = (option_hymap(__ps_169, (int64_t)(intptr_t)(__t170)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_172 = (unwrap_hyor(__ps_171, INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_172));
        int64_t __ps_173 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t174 = (void *)((char *)&__tur_fatbox_1 + sizeof(void *));
        int64_t __ps_175 = (option_hymap(__ps_173, (int64_t)(intptr_t)(__t174)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_176 = (unwrap_hyor(__ps_175, INT64_C(88)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        int64_t __ps_177 = (some__spec__int64_t_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t178 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
        int64_t __ps_179 = (option_hymap(__ps_177, (int64_t)(intptr_t)(__t178)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_180 = (unwrap_hyor(__ps_179, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
...
static int64_t some__spec__int64_t_int64_t(int64_t x) {
        int64_t __ps_184 = (ctor_Some__int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_184;
}
...
static void __tur_fatbox_init(void) {
    { char *__b = (char *)&__tur_fatbox_0;
      ...
      __s[1] = (int64_t)(intptr_t)__fn_1363; }
    { char *__b = (char *)&__tur_fatbox_1;
      int64_t *__s = (int64_t *)(__b + sizeof(void *));
      __s[0] = (int64_t)(intptr_t)__tur_fatshim1;
      __s[1] = (int64_t)(intptr_t)__fn_1366; }
    { char *__b = (char *)&__tur_fatbox_2;
      int64_t *__s = (int64_t *)(__b + sizeof(void *));
      __s[0] = (int64_t)(intptr_t)__tur_fatshim1;
      __s[1] = (int64_t)(intptr_t)__fn_1369; }
}
