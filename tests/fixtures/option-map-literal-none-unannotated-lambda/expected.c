...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_268 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t269 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
        tur_adt_Option__int __ps_270 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_268, (int64_t)(intptr_t)(__t269)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_268) tur_region_free((void *)(intptr_t)__ps_268);
        int64_t __ps_271 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_270, INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_271));
        int64_t __ps_272 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t273 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_274 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_272, (int64_t)(intptr_t)(__t273)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_272) tur_region_free((void *)(intptr_t)__ps_272);
        int64_t __ps_275 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_274, INT64_C(88)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_275));
        tur_adt_Option__int __ps_276 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t277 = (void *)((char *)&__tur_fatbox_4 + sizeof(void *));
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_279 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_278, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_279));
        int64_t __t280;
        __t280 = INT64_C(0);
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_int64_t_int64_t(int64_t o, int64_t f) {
        tur_adt_Option__int __t284 = {0};
        {
            tur_adt_Option *__scrut = (tur_adt_Option *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_933 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_285 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_933));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_286 = (some__spec__tur_adt_Option__int_int64_t(__ps_285));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t284 = __ps_286;
                break;
            }
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t290 = {0};
        {
            ...
            case 1: {
                int64_t v_933 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_291 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_933));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_292 = (some__spec__tur_adt_Option__int_int64_t(__ps_291));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t290 = __ps_292;
                break;
            }
            case 0: {
                tur_adt_Option__int __ps_293 = (none__spec__tur_adt_Option__int());
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t290 = __ps_293;
                break;
            }
...
static void __tur_fatbox_init(void) {
    ...
    { char *__b = (char *)&__tur_fatbox_2;
      ...
      __s[1] = (int64_t)(intptr_t)__fn_1466; }
