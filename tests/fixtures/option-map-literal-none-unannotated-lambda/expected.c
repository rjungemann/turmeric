...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_174 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t175 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
        tur_adt_Option__int __ps_176 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_174, (int64_t)(intptr_t)(__t175)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        int64_t __ps_178 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t179 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_180 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_178, (int64_t)(intptr_t)(__t179)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_178) tur_region_free((void *)(intptr_t)__ps_178);
        int64_t __ps_181 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_180, INT64_C(88)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_185 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_184, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        int64_t __t186;
        __t186 = INT64_C(0);
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_int64_t_int64_t(int64_t o, int64_t f) {
        tur_adt_Option__int __t190 = {0};
        {
            tur_adt_Option *__scrut = (tur_adt_Option *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_1074 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_191 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_1074));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_192 = (some__spec__tur_adt_Option__int_int64_t(__ps_191));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t190 = __ps_192;
                break;
            }
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_194 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_194;
}
...
static int64_t option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t__cps(tur_adt_Option__int o, int64_t f, DK *__kont) {
    ...
    tur_adt_Option__int __t196 = {0};
    {
        ...
        case 1: {
            int64_t v_1074 = (int64_t)__scrut->as.Some._0;
            int64_t __ps_197 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_1074));
            if (tur_panicking) return ((int64_t)0);
