...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_164 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t165 = (void *)((char *)&__tur_fatbox_0 + sizeof(void *));
        tur_adt_Option__int __ps_166 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_164, (int64_t)(intptr_t)(__t165)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_167 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_166, INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_167));
        int64_t __ps_168 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t169 = (void *)((char *)&__tur_fatbox_1 + sizeof(void *));
        tur_adt_Option__int __ps_170 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_168, (int64_t)(intptr_t)(__t169)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_175 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_174, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_175));
        int64_t __t176;
        __t176 = INT64_C(0);
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_int64_t_int64_t(int64_t o, int64_t f) {
        tur_adt_Option__int __t180 = {0};
        {
            tur_adt_Option *__scrut = (tur_adt_Option *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_870 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_181 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_870));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_182 = (some__spec__tur_adt_Option__int_int64_t(__ps_181));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t180 = __ps_182;
                break;
            }
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_184 = (ctor_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_184;
}
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t186 = {0};
        {
            ...
            case 1: {
                int64_t v_870 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_187 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_870));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_188 = (some__spec__tur_adt_Option__int_int64_t(__ps_187));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t186 = __ps_188;
                break;
            }
