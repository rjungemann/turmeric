...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_276 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t277 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
        tur_adt_Option__int __ps_278 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_276, (int64_t)(intptr_t)(__t277)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_276) tur_region_free((void *)(intptr_t)__ps_276);
        int64_t __ps_279 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_278, INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_279));
        int64_t __ps_280 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t281 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_282 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_280, (int64_t)(intptr_t)(__t281)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_280) tur_region_free((void *)(intptr_t)__ps_280);
        int64_t __ps_283 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_282, INT64_C(88)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_283));
        tur_adt_Option__int __ps_284 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t285 = (void *)((char *)&__tur_fatbox_4 + sizeof(void *));
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_287 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_286, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_287));
        int64_t __t288;
        __t288 = INT64_C(0);
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_int64_t_int64_t(int64_t o, int64_t f) {
        tur_adt_Option__int __t292 = {0};
        {
            tur_adt_Option *__scrut = (tur_adt_Option *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_1074 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_293 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_1074));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_294 = (some__spec__tur_adt_Option__int_int64_t(__ps_293));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t292 = __ps_294;
                break;
            }
            case 0: {
                tur_adt_Option__int __ps_295 = (none__spec__tur_adt_Option__int());
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t292 = __ps_295;
                break;
            }
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_296 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_296;
}
