...
static int64_t __fn_1613(int64_t x) {
        return (x) * (INT64_C(2));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_278 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t279 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
        tur_adt_Option__int __ps_280 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_278, (int64_t)(intptr_t)(__t279)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_278) tur_region_free((void *)(intptr_t)__ps_278);
        int64_t __ps_281 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_280, INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_281));
        int64_t __ps_282 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t283 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_284 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_282, (int64_t)(intptr_t)(__t283)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_282) tur_region_free((void *)(intptr_t)__ps_282);
        int64_t __ps_285 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_284, INT64_C(88)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_285));
        tur_adt_Option__int __ps_286 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t287 = (void *)((char *)&__tur_fatbox_4 + sizeof(void *));
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_289 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_288, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_289));
        int64_t __t290;
        __t290 = INT64_C(0);
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_int64_t_int64_t(int64_t o, int64_t f) {
        tur_adt_Option__int __t294 = {0};
        {
            tur_adt_Option *__scrut = (tur_adt_Option *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_1074 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_295 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_1074));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_296 = (some__spec__tur_adt_Option__int_int64_t(__ps_295));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t294 = __ps_296;
                break;
            }
            case 0: {
                tur_adt_Option__int __ps_297 = (none__spec__tur_adt_Option__int());
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t294 = __ps_297;
                break;
            }
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_298 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_298;
}
...
static int64_t option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t__cps(tur_adt_Option__int o, int64_t f, DK *__kont) {
    ...
    tur_adt_Option__int __t300 = {0};
    {
        ...
        case 1: {
            int64_t v_1074 = (int64_t)__scrut->as.Some._0;
            int64_t __ps_301 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_1074));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Option__int __ps_302 = (some__spec__tur_adt_Option__int_int64_t(__ps_301));
            if (tur_panicking) return ((int64_t)0);
            __t300 = __ps_302;
            break;
        }
        case 0: {
            tur_adt_Option__int __ps_303 = (none__spec__tur_adt_Option__int());
            if (tur_panicking) return ((int64_t)0);
            __t300 = __ps_303;
            break;
        }
...
static void __tur_fatbox_init(void) {
    ...
    { char *__b = (char *)&__tur_fatbox_2;
      ...
      __s[1] = (int64_t)(intptr_t)__fn_1607; }
    { char *__b = (char *)&__tur_fatbox_3;
      int64_t *__s = (int64_t *)(__b + sizeof(void *));
      __s[0] = (int64_t)(intptr_t)__tur_fatshim1;
      __s[1] = (int64_t)(intptr_t)__fn_1610; }
