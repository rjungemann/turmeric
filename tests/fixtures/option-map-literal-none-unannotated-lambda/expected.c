...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_184 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_183, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_184));
        int64_t __t185;
        __t185 = INT64_C(0);
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_int64_t_int64_t(int64_t o, int64_t f) {
        tur_adt_Option__int __t189 = {0};
        {
            tur_adt_Option *__scrut = (tur_adt_Option *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_894 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_190 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_894));
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t195 = {0};
        {
            ...
            case 1: {
                int64_t v_894 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_196 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_894));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_197 = (some__spec__tur_adt_Option__int_int64_t(__ps_196));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t195 = __ps_197;
                break;
            }
