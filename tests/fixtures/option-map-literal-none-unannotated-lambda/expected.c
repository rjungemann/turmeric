...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_233 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t234 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
        tur_adt_Option__int __ps_235 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_233, (int64_t)(intptr_t)(__t234)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_233) tur_region_free((void *)(intptr_t)__ps_233);
        int64_t __ps_236 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_235, INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_236));
        int64_t __ps_237 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t238 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_239 = (option_map__spec__tur_adt_Option__int_int64_t_int64_t(__ps_237, (int64_t)(intptr_t)(__t238)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_237) tur_region_free((void *)(intptr_t)__ps_237);
        int64_t __ps_240 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_239, INT64_C(88)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_240));
        tur_adt_Option__int __ps_241 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t242 = (void *)((char *)&__tur_fatbox_4 + sizeof(void *));
        tur_adt_Option__int __ps_243 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_241, (int64_t)(intptr_t)(__t242)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_244 = (unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(__ps_243, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_244));
        int64_t __t245;
        __t245 = INT64_C(0);
...
static int64_t unwrap_or__spec__int64_t_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t dflt) {
        int64_t __t248 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_915 = (int64_t)__scrut->as.Some._0;
                __t248 = v_915;
                break;
            }
            case 0: {
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_int64_t_int64_t(int64_t o, int64_t f) {
        tur_adt_Option__int __t249 = {0};
        {
            tur_adt_Option *__scrut = (tur_adt_Option *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_921 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_250 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), v_921));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_251 = (some__spec__tur_adt_Option__int_int64_t(__ps_250));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t249 = __ps_251;
                break;
            }
            case 0: {
                tur_adt_Option__int __ps_252 = (none__spec__tur_adt_Option__int());
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t249 = __ps_252;
                break;
            }
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_253 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_253;
}
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t255 = {0};
        {
            ...
            case 1: {
                int64_t v_921 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_256 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_921));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_257 = (some__spec__tur_adt_Option__int_int64_t(__ps_256));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t255 = __ps_257;
                break;
            }
...
static void __tur_fatbox_init(void) {
    ...
    { char *__b = (char *)&__tur_fatbox_2;
      ...
      __s[1] = (int64_t)(intptr_t)__fn_1464; }
