...
static bool assert(int64_t, int64_t);
static bool assert_true(int64_t);
static bool assert_false(int64_t);
static bool assert_nil(int64_t);
static int64_t run_test(const char *, void *);
...
static bool assert(int64_t expected, int64_t actual) {
        bool __t0;
        if (((expected) == (actual))) {
            __t0 = true;
        } else {
            puts("Assertion failed: expected");
            printf("%lld\n", (long long)(expected));
            puts("but got");
            printf("%lld\n", (long long)(actual));
            bool __t1;
...
static bool assert_true(int64_t x) {
        ...
        if (((x) == (INT64_C(1)))) {
            ...
            puts("Assertion failed: expected true");
            bool __t3;
            __t3 = false;
            __t2 = __t3;
        }
...
static bool assert_false(int64_t x) {
        bool __t4;
        if (((x) == (INT64_C(1)))) {
            puts("Assertion failed: expected false");
            bool __t5;
            __t5 = false;
            __t4 = __t5;
        } else {
...
static bool assert_nil(int64_t x) {
        bool __t6;
        if (((x) == (INT64_C(0)))) {
            __t6 = true;
        } else {
            puts("Assertion failed: expected nil");
            bool __t7;
            __t7 = false;
            __t6 = __t7;
        }
...
static int64_t run_test(const char * name, void * test_fn) {
        int64_t __t8;
        if (((((int64_t (*) (void))test_fn) ()) == (INT64_C(1)))) {
            puts(".");
            int64_t __t9;
            __t9 = INT64_C(1);
            __t8 = __t9;
...
int main() {
        printf("%lld\n", (long long)(run_test("pass", (void *)(intptr_t)(t_pass))));
        printf("%lld\n", (long long)(run_test("fail", (void *)(intptr_t)(t_fail))));
        int64_t __t11;
        __t11 = INT64_C(0);
        return (int)__t11;
}
