...
static int64_t describe(tur_tagged_t);
...
static int64_t describe(tur_tagged_t x) {
        const char * __t0 = 0;
        {
            tur_tagged_t __t1 = x;
            if (TUR_GETTAG(__t1) == 0) {
                int64_t __udisp_0_267 = (int64_t)(intptr_t)TUR_UNTAG(__t1);
                __t0 = __inst_Show_show_int(__udisp_0_267);
            }
            else if (TUR_GETTAG(__t1) == 1) {
                bool __udisp_0_268 = (bool)(intptr_t)TUR_UNTAG(__t1);
                __t0 = __inst_Show_show_bool(__udisp_0_268);
            }
        }
        puts(__t0);
        int64_t __t2;
...
int main() {
        (void)(describe(TUR_TAG(0, (int64_t)(intptr_t)(INT64_C(42)))));
        (void)(describe(TUR_TAG(1, (int64_t)(intptr_t)(true))));
        int64_t __t3;
        __t3 = INT64_C(0);
        return (int)__t3;
}
