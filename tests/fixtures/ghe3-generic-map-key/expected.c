...
int main(int argc, char **argv) {
        ...
        {
            int64_t m_811 = map_assoc_g__spec__int64_t_int64_t_const_char___int64_t(map_assoc_g__spec__int64_t_int64_t_const_char___int64_t(map_new(), "alpha", INT64_C(1)), "beta", INT64_C(2));
            (void)m_811;
            int64_t m2_812 = map_assoc_g__spec__int64_t_int64_t_const_char___int64_t(m_811, dup_str("beta"), INT64_C(99));
            (void)m2_812;
            printf("%lld\n", (long long)(map_get_g__spec__int64_t_int64_t_const_char__(m2_812, dup_str("alpha"))));
            printf("%lld\n", (long long)(map_get_g__spec__int64_t_int64_t_const_char__(m2_812, dup_str("beta"))));
            printf("%lld\n", (long long)(map_count(m2_812)));
            int64_t __t3;
            if (map_has_g___spec__bool_int64_t_const_char__(m2_812, "alpha")) {
                __t3 = INT64_C(1);
            } else {
                __t3 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t3));
            int64_t __t4;
            if (map_has_g___spec__bool_int64_t_const_char__(map_dissoc_g__spec__int64_t_int64_t_const_char__(m2_812, "alpha"), "alpha")) {
                __t4 = INT64_C(1);
            } else {
                __t4 = INT64_C(0);
            }
        ...
        {
            int64_t mi_813 = map_assoc_g(map_assoc_g(map_new(), INT64_C(5), INT64_C(100)), INT64_C(7), INT64_C(200));
            (void)mi_813;
            printf("%lld\n", (long long)(map_get_g(mi_813, INT64_C(5))));
            printf("%lld\n", (long long)(map_get_g(mi_813, INT64_C(7))));
            int64_t __t5;
            if (map_has_g_(mi_813, INT64_C(5))) {
                __t5 = INT64_C(1);
            } else {
                __t5 = INT64_C(0);
            }
        ...
        {
            int64_t mb_814 = map_assoc_g__spec__int64_t_int64_t_bool_int64_t(map_assoc_g__spec__int64_t_int64_t_bool_int64_t(map_new(), true, INT64_C(10)), false, INT64_C(20));
            (void)mb_814;
            printf("%lld\n", (long long)(map_get_g__spec__int64_t_int64_t_bool(mb_814, true)));
            printf("%lld\n", (long long)(map_get_g__spec__int64_t_int64_t_bool(mb_814, false)));
        }
        {
            int64_t mf_815 = map_assoc_g__spec__int64_t_int64_t_float_int64_t(map_assoc_g__spec__int64_t_int64_t_float_int64_t(map_new(), ((float)1.5), INT64_C(7)), ((float)2.5), INT64_C(8));
            (void)mf_815;
            printf("%lld\n", (long long)(map_get_g__spec__int64_t_int64_t_float(mf_815, ((float)1.5))));
            printf("%lld\n", (long long)(map_get_g__spec__int64_t_int64_t_float(mf_815, ((float)2.5))));
            printf("%lld\n", (long long)(map_count(mf_815)));
        }
        int64_t __t6;
        __t6 = INT64_C(0);
        return (int)__t6;
...
static int64_t map_assoc_g__spec__int64_t_int64_t_const_char___int64_t(int64_t m, const char * key, int64_t val) {
        return map_assoc_eq(m, __inst_Hash_hash_cstr(key), __inst_MapKey_mk_box_cstr(key), val, __inst_MapKey_mk_cmp_cstr(key));
}

static int64_t map_get_g__spec__int64_t_int64_t_const_char__(int64_t m, const char * key) {
        return map_get_eq(m, __inst_Hash_hash_cstr(key), __inst_MapKey_mk_box_cstr(key), __inst_MapKey_mk_cmp_cstr(key));
}

static bool map_has_g___spec__bool_int64_t_const_char__(int64_t m, const char * key) {
        return map_has_eq_(m, __inst_Hash_hash_cstr(key), __inst_MapKey_mk_box_cstr(key), __inst_MapKey_mk_cmp_cstr(key));
}

static int64_t map_dissoc_g__spec__int64_t_int64_t_const_char__(int64_t m, const char * key) {
        return map_dissoc_eq(m, __inst_Hash_hash_cstr(key), __inst_MapKey_mk_box_cstr(key), __inst_MapKey_mk_cmp_cstr(key));
}

static int64_t map_assoc_g__spec__int64_t_int64_t_bool_int64_t(int64_t m, bool key, int64_t val) {
        return map_assoc_eq(m, __inst_Hash_hash_bool(key), __inst_MapKey_mk_box_bool(key), val, __inst_MapKey_mk_cmp_bool(key));
}

static int64_t map_get_g__spec__int64_t_int64_t_bool(int64_t m, bool key) {
        return map_get_eq(m, __inst_Hash_hash_bool(key), __inst_MapKey_mk_box_bool(key), __inst_MapKey_mk_cmp_bool(key));
}

static int64_t map_assoc_g__spec__int64_t_int64_t_float_int64_t(int64_t m, float key, int64_t val) {
        return map_assoc_eq(m, __inst_Hash_hash_float32(key), __inst_MapKey_mk_box_float32(key), val, __inst_MapKey_mk_cmp_float32(key));
}

static int64_t map_get_g__spec__int64_t_int64_t_float(int64_t m, float key) {
        return map_get_eq(m, __inst_Hash_hash_float32(key), __inst_MapKey_mk_box_float32(key), __inst_MapKey_mk_cmp_float32(key));
}
