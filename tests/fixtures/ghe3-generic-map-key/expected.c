...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            bool __t31;
            {
                ...
                (void)__tur_mk___862;
                __t31 = map_has_eq_o_(tur_map_kcheck(m2_859, &__tur_mk___862), __inst_Hash_hash_cstr(__tur_mk___862), __inst_MapKey_mk_box_cstr(__tur_mk___862), __inst_MapKey_mk_cmp_cstr(__tur_mk___862), __inst_MapKey_mk_owned__cstr(__tur_mk___862));
            }
            if (__t31) {
                __t30 = INT64_C(1);
            } else {
            ...
            bool __t33;
            {
                ...
                __t33 = map_has_eq_o_(tur_map_kcheck(__t34, &__tur_mk___863), __inst_Hash_hash_cstr(__tur_mk___863), __inst_MapKey_mk_box_cstr(__tur_mk___863), __inst_MapKey_mk_cmp_cstr(__tur_mk___863), __inst_MapKey_mk_owned__cstr(__tur_mk___863));
            }
            if (__t33) {
                __t32 = INT64_C(1);
            } else {
        ...
        }
        {
            ...
            bool __t40;
            {
                ...
                (void)__tur_mk___870;
                __t40 = map_has_eq_o_(tur_map_kcheck(mi_867, &__tur_mk___870), __inst_Hash_hash_int(__tur_mk___870), __inst_MapKey_mk_box_int(__tur_mk___870), __inst_MapKey_mk_cmp_int(__tur_mk___870), __inst_MapKey_mk_owned__int(__tur_mk___870));
            }
            if (__t40) {
                __t39 = INT64_C(1);
            } else {
