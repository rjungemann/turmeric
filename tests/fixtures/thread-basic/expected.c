...
int main() {
        {
            void * arg1_206 = thread_arg_new(INT64_C(10));
            (void)arg1_206;
            {
                void * t1_207 = thread_spawn((void *)(intptr_t)(arg1_206));
                (void)t1_207;
                thread_join((void *)(intptr_t)(t1_207));
                thread_arg_free((void *)(intptr_t)(arg1_206));
            }
        }
        {
            void * arg2_208 = thread_arg_new(INT64_C(20));
            (void)arg2_208;
            {
                void * t2_209 = thread_spawn((void *)(intptr_t)(arg2_208));
                (void)t2_209;
                thread_join((void *)(intptr_t)(t2_209));
                thread_arg_free((void *)(intptr_t)(arg2_208));
            }
        }
        printf("%lld\n", (long long)(INT64_C(0)));
        int64_t __t0;
