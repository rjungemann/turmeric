...
int main() {
        {
            void * arg1_223 = thread_arg_new(INT64_C(10));
            (void)arg1_223;
            {
                void * t1_224 = thread_spawn((void *)(intptr_t)(arg1_223));
                (void)t1_224;
                thread_join((void *)(intptr_t)(t1_224));
                thread_arg_free((void *)(intptr_t)(arg1_223));
            }
        }
        {
            void * arg2_225 = thread_arg_new(INT64_C(20));
            (void)arg2_225;
            {
                void * t2_226 = thread_spawn((void *)(intptr_t)(arg2_225));
                (void)t2_226;
                thread_join((void *)(intptr_t)(t2_226));
                thread_arg_free((void *)(intptr_t)(arg2_225));
            }
        }
        printf("%lld\n", (long long)(INT64_C(0)));
        int64_t __t0;
