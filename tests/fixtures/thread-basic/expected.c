...
int main() {
        {
            void * arg1_218 = thread_arg_new(INT64_C(10));
            (void)arg1_218;
            {
                void * t1_219 = thread_spawn((void *)(intptr_t)(arg1_218));
                (void)t1_219;
                thread_join((void *)(intptr_t)(t1_219));
                thread_arg_free((void *)(intptr_t)(arg1_218));
            }
        }
        {
            void * arg2_220 = thread_arg_new(INT64_C(20));
            (void)arg2_220;
            {
                void * t2_221 = thread_spawn((void *)(intptr_t)(arg2_220));
                (void)t2_221;
                thread_join((void *)(intptr_t)(t2_221));
                thread_arg_free((void *)(intptr_t)(arg2_220));
            }
        }
        printf("%lld\n", (long long)(INT64_C(0)));
        int64_t __t0;
