...
int main() {
        {
            void * arg1_224 = thread_arg_new(INT64_C(10));
            (void)arg1_224;
            {
                void * t1_225 = thread_spawn((void *)(intptr_t)(arg1_224));
                (void)t1_225;
                thread_join((void *)(intptr_t)(t1_225));
                thread_arg_free((void *)(intptr_t)(arg1_224));
            }
        }
        {
            void * arg2_226 = thread_arg_new(INT64_C(20));
            (void)arg2_226;
            {
                void * t2_227 = thread_spawn((void *)(intptr_t)(arg2_226));
                (void)t2_227;
                thread_join((void *)(intptr_t)(t2_227));
                thread_arg_free((void *)(intptr_t)(arg2_226));
            }
        }
        printf("%lld\n", (long long)(INT64_C(0)));
        int64_t __t0;
