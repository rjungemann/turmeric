...
int main() {
        {
            void * arg1_31 = thread_arg_new(INT64_C(10));
            (void)arg1_31;
            {
                void * t1_32 = thread_spawn((void *)(intptr_t)(arg1_31));
                (void)t1_32;
                thread_join((void *)(intptr_t)(t1_32));
                thread_arg_free((void *)(intptr_t)(arg1_31));
            }
        }
        {
            void * arg2_33 = thread_arg_new(INT64_C(20));
            (void)arg2_33;
            {
                void * t2_34 = thread_spawn((void *)(intptr_t)(arg2_33));
                (void)t2_34;
                thread_join((void *)(intptr_t)(t2_34));
                thread_arg_free((void *)(intptr_t)(arg2_33));
            }
        }
        printf("%lld\n", (long long)(INT64_C(0)));
        int64_t __t0;
