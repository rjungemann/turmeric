...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = (Point){.x = INT64_C(42), .y = INT64_C(99)};
            RcControlBlock *__t2 = rc_cb_alloc(0, 26, NULL);
            __t2->value = __t1;
            RcControlBlock * p_22 = __t2;
            (void)p_22;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            int64_t __t4 = rc_strong_count(p_22);
            printf("%lld\n", (long long)(__t4));
            struct __defer_env_5 __t7 = {.p = p_22};
