...
int main() {
        int64_t __t0;
        {
            void * tg_217 = tg_new();
            (void)tg_217;
            tg_spawn((void *)(intptr_t)(tg_217));
            tg_spawn((void *)(intptr_t)(tg_217));
            tg_spawn((void *)(intptr_t)(tg_217));
            tg_task_done((void *)(intptr_t)(tg_217));
            tg_task_done((void *)(intptr_t)(tg_217));
            tg_task_done((void *)(intptr_t)(tg_217));
            tg_wait((void *)(intptr_t)(tg_217));
            printf("%lld\n", (long long)(INT64_C(42)));
            tg_free((void *)(intptr_t)(tg_217));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
