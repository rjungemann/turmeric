...
int main() {
        {
            void * arg_629 = make_arg();
            (void)arg_629;
            {
                void * t_630 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_629));
                (void)t_630;
                thread_join((void *)(intptr_t)(t_630));
            }
            free_arg((void *)(intptr_t)(arg_629));
        }
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
