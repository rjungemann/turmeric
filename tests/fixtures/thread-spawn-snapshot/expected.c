...
int main(int argc, char **argv) {
        ...
        {
            void * arg_910 = make_hyarg();
            (void)arg_910;
            {
                void * t_911 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_910));
                (void)t_911;
                thread_hyjoin((void *)(intptr_t)(t_911));
            }
            free_hyarg((void *)(intptr_t)(arg_910));
        }
        int64_t __t29;
        __t29 = INT64_C(0);
        return (int)__t29;
