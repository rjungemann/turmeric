...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * arg_1629 = __ps_172;
            (void)arg_1629;
            {
                void * __ps_173 = (thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_1629)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * t_1630 = __ps_173;
                (void)t_1630;
                thread_hyjoin((void *)(intptr_t)(t_1630));
            }
            free_hyarg((void *)(intptr_t)(arg_1629));
        }
        int64_t __t174;
        __t174 = INT64_C(0);
        return (int)__t174;
