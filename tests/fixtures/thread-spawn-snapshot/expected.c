...
int main(int argc, char **argv) {
        ...
        {
            void * arg_863 = make_arg();
            (void)arg_863;
            {
                void * t_864 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_863));
                (void)t_864;
                thread_join((void *)(intptr_t)(t_864));
            }
            free_arg((void *)(intptr_t)(arg_863));
        }
        int64_t __t7;
        __t7 = INT64_C(0);
        return (int)__t7;
