...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            void * arg_1279 = __ps_181;
            (void)arg_1279;
            {
                __auto_type __ps_182 = (thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_1279)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * t_1280 = __ps_182;
                (void)t_1280;
                thread_hyjoin((void *)(intptr_t)(t_1280));
            }
            free_hyarg((void *)(intptr_t)(arg_1279));
        }
        int64_t __t183;
        __t183 = INT64_C(0);
        return (int)__t183;
