...
int main(int argc, char **argv) {
        ...
        {
            void * arg_870 = make_hyarg();
            (void)arg_870;
            {
                void * t_871 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_870));
                (void)t_871;
                thread_hyjoin((void *)(intptr_t)(t_871));
            }
            free_hyarg((void *)(intptr_t)(arg_870));
        }
        int64_t __t21;
        __t21 = INT64_C(0);
        return (int)__t21;
