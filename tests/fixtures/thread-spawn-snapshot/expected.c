...
int main() {
        {
            void * arg_626 = make_arg();
            (void)arg_626;
            {
                void * t_627 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_626));
                (void)t_627;
                thread_join((void *)(intptr_t)(t_627));
            }
            free_arg((void *)(intptr_t)(arg_626));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
