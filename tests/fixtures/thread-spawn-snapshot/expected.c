...
int main(int argc, char **argv) {
        ...
        {
            void * arg_707 = make_arg();
            (void)arg_707;
            {
                void * t_708 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_707));
                (void)t_708;
                thread_join((void *)(intptr_t)(t_708));
            }
            free_arg((void *)(intptr_t)(arg_707));
        }
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
