...
int main(int argc, char **argv) {
        ...
        {
            void * arg_882 = make_hyarg();
            (void)arg_882;
            {
                void * t_883 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_882));
                (void)t_883;
                thread_hyjoin((void *)(intptr_t)(t_883));
            }
            free_hyarg((void *)(intptr_t)(arg_882));
        }
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
