...
int main(int argc, char **argv) {
        ...
        {
            void * arg_882 = make_arg();
            (void)arg_882;
            {
                void * t_883 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_882));
                (void)t_883;
                thread_join((void *)(intptr_t)(t_883));
            }
            free_arg((void *)(intptr_t)(arg_882));
        }
        int64_t __t3;
        __t3 = INT64_C(0);
        return (int)__t3;
