...
int main(int argc, char **argv) {
        ...
        {
            void * arg_893 = make_hyarg();
            (void)arg_893;
            {
                void * t_894 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_893));
                (void)t_894;
                thread_hyjoin((void *)(intptr_t)(t_894));
            }
            free_hyarg((void *)(intptr_t)(arg_893));
        }
        int64_t __t23;
        __t23 = INT64_C(0);
        return (int)__t23;
