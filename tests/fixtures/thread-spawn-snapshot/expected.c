...
int main(int argc, char **argv) {
        ...
        {
            void * arg_999 = make_hyarg();
            (void)arg_999;
            {
                void * t_1000 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_999));
                (void)t_1000;
                thread_hyjoin((void *)(intptr_t)(t_1000));
            }
            free_hyarg((void *)(intptr_t)(arg_999));
        }
        int64_t __t42;
        __t42 = INT64_C(0);
        return (int)__t42;
