...
int main(int argc, char **argv) {
        ...
        {
            void * arg_898 = make_hyarg();
            (void)arg_898;
            {
                void * t_899 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_898));
                (void)t_899;
                thread_hyjoin((void *)(intptr_t)(t_899));
            }
            free_hyarg((void *)(intptr_t)(arg_898));
        }
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
