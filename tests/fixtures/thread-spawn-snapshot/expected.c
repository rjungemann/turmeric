...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            void * __ps_180 = (make_hyarg());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * arg_1446 = __ps_180;
            (void)arg_1446;
            {
                void * __ps_181 = (thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_1446)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * t_1447 = __ps_181;
                (void)t_1447;
                thread_hyjoin((void *)(intptr_t)(t_1447));
            }
            free_hyarg((void *)(intptr_t)(arg_1446));
        }
        int64_t __t182;
        __t182 = INT64_C(0);
        return (int)__t182;
