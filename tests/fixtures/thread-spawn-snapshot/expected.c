...
int main() {
        {
            void * arg_206 = make_arg();
            (void)arg_206;
            {
                void * t_207 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_206));
                (void)t_207;
                thread_join((void *)(intptr_t)(t_207));
            }
            free_arg((void *)(intptr_t)(arg_206));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
