...
int main() {
        {
            void * arg_542 = make_arg();
            (void)arg_542;
            {
                void * t_543 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_542));
                (void)t_543;
                thread_join((void *)(intptr_t)(t_543));
            }
            free_arg((void *)(intptr_t)(arg_542));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
