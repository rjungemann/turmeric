...
int main(int argc, char **argv) {
        ...
        {
            void * arg_767 = make_arg();
            (void)arg_767;
            {
                void * t_768 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_767));
                (void)t_768;
                thread_join((void *)(intptr_t)(t_768));
            }
            free_arg((void *)(intptr_t)(arg_767));
        }
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
