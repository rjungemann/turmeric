...
int main(int argc, char **argv) {
        ...
        {
            void * arg_878 = make_hyarg();
            (void)arg_878;
            {
                void * t_879 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_878));
                (void)t_879;
                thread_hyjoin((void *)(intptr_t)(t_879));
            }
            free_hyarg((void *)(intptr_t)(arg_878));
        }
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
