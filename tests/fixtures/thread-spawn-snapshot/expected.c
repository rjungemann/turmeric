...
int main(int argc, char **argv) {
        ...
        {
            void * arg_868 = make_hyarg();
            (void)arg_868;
            {
                void * t_869 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_868));
                (void)t_869;
                thread_hyjoin((void *)(intptr_t)(t_869));
            }
            free_hyarg((void *)(intptr_t)(arg_868));
        }
        int64_t __t23;
        __t23 = INT64_C(0);
        return (int)__t23;
