...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            void * __ps_232 = (make_hyarg());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * arg_1473 = __ps_232;
            (void)arg_1473;
            {
                void * __ps_233 = (thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_1473)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * t_1474 = __ps_233;
                (void)t_1474;
                thread_hyjoin((void *)(intptr_t)(t_1474));
            }
            free_hyarg((void *)(intptr_t)(arg_1473));
        }
        int64_t __t234;
        __t234 = INT64_C(0);
        return (int)__t234;
