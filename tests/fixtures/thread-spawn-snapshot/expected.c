...
int main() {
        {
            void * arg_271 = make_arg();
            (void)arg_271;
            {
                void * t_272 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_271));
                (void)t_272;
                thread_join((void *)(intptr_t)(t_272));
            }
            free_arg((void *)(intptr_t)(arg_271));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
