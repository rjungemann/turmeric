...
int main() {
        {
            void * arg_625 = make_arg();
            (void)arg_625;
            {
                void * t_626 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_625));
                (void)t_626;
                thread_join((void *)(intptr_t)(t_626));
            }
            free_arg((void *)(intptr_t)(arg_625));
        }
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
