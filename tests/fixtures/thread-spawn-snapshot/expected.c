...
int main(int argc, char **argv) {
        ...
        {
            void * arg_855 = make_arg();
            (void)arg_855;
            {
                void * t_856 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_855));
                (void)t_856;
                thread_join((void *)(intptr_t)(t_856));
            }
            free_arg((void *)(intptr_t)(arg_855));
        }
        int64_t __t3;
        __t3 = INT64_C(0);
        return (int)__t3;
