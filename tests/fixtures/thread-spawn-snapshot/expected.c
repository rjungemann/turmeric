...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            void * __ps_179 = (make_hyarg());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * arg_1444 = __ps_179;
            (void)arg_1444;
            {
                void * __ps_180 = (thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_1444)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * t_1445 = __ps_180;
                (void)t_1445;
                thread_hyjoin((void *)(intptr_t)(t_1445));
            }
            free_hyarg((void *)(intptr_t)(arg_1444));
        }
        int64_t __t181;
        __t181 = INT64_C(0);
        return (int)__t181;
