...
int main(int argc, char **argv) {
        ...
        {
            void * arg_887 = make_arg();
            (void)arg_887;
            {
                void * t_888 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_887));
                (void)t_888;
                thread_join((void *)(intptr_t)(t_888));
            }
            free_arg((void *)(intptr_t)(arg_887));
        }
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
