...
int main(int argc, char **argv) {
        ...
        {
            void * arg_775 = make_arg();
            (void)arg_775;
            {
                void * t_776 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_775));
                (void)t_776;
                thread_join((void *)(intptr_t)(t_776));
            }
            free_arg((void *)(intptr_t)(arg_775));
        }
        int64_t __t2;
        __t2 = INT64_C(0);
        return (int)__t2;
