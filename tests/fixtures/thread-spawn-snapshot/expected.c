...
int main(int argc, char **argv) {
        ...
        {
            void * arg_845 = make_arg();
            (void)arg_845;
            {
                void * t_846 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_845));
                (void)t_846;
                thread_join((void *)(intptr_t)(t_846));
            }
            free_arg((void *)(intptr_t)(arg_845));
        }
        int64_t __t3;
        __t3 = INT64_C(0);
        return (int)__t3;
