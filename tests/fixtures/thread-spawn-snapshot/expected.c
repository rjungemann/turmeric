...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * arg_1626 = __ps_172;
            (void)arg_1626;
            {
                void * __ps_173 = (thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_1626)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * t_1627 = __ps_173;
                (void)t_1627;
                thread_hyjoin((void *)(intptr_t)(t_1627));
            }
            free_hyarg((void *)(intptr_t)(arg_1626));
        }
        int64_t __t174;
        __t174 = INT64_C(0);
        return (int)__t174;
