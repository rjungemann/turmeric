...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            void * __ps_159 = (make_hyarg());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * arg_1336 = __ps_159;
            (void)arg_1336;
            {
                void * __ps_160 = (thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_1336)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * t_1337 = __ps_160;
                (void)t_1337;
                thread_hyjoin((void *)(intptr_t)(t_1337));
            }
            free_hyarg((void *)(intptr_t)(arg_1336));
        }
        int64_t __t161;
        __t161 = INT64_C(0);
        return (int)__t161;
