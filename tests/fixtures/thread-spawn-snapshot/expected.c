...
int main(int argc, char **argv) {
        ...
        {
            void * arg_804 = make_arg();
            (void)arg_804;
            {
                void * t_805 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_804));
                (void)t_805;
                thread_join((void *)(intptr_t)(t_805));
            }
            free_arg((void *)(intptr_t)(arg_804));
        }
        int64_t __t2;
        __t2 = INT64_C(0);
        return (int)__t2;
