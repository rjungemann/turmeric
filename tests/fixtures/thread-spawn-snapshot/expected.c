...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            __auto_type __ps_173 = (make_hyarg());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * arg_1289 = __ps_173;
            (void)arg_1289;
            {
                __auto_type __ps_174 = (thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_1289)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * t_1290 = __ps_174;
                (void)t_1290;
