...
int main(int argc, char **argv) {
        ...
        {
            void * arg_698 = make_arg();
            (void)arg_698;
            {
                void * t_699 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_698));
                (void)t_699;
                thread_join((void *)(intptr_t)(t_699));
            }
            free_arg((void *)(intptr_t)(arg_698));
        }
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
