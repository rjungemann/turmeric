...
int main(int argc, char **argv) {
        ...
        {
            void * arg_874 = make_hyarg();
            (void)arg_874;
            {
                void * t_875 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_874));
                (void)t_875;
                thread_hyjoin((void *)(intptr_t)(t_875));
            }
            free_hyarg((void *)(intptr_t)(arg_874));
        }
        int64_t __t21;
        __t21 = INT64_C(0);
        return (int)__t21;
