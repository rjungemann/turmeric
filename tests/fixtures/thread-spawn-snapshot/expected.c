...
int main() {
        {
            void * arg_627 = make_arg();
            (void)arg_627;
            {
                void * t_628 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_627));
                (void)t_628;
                thread_join((void *)(intptr_t)(t_628));
            }
            free_arg((void *)(intptr_t)(arg_627));
        }
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
