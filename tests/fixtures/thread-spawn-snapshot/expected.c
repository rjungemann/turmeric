...
int main(int argc, char **argv) {
        ...
        {
            void * arg_819 = make_arg();
            (void)arg_819;
            {
                void * t_820 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_819));
                (void)t_820;
                thread_join((void *)(intptr_t)(t_820));
            }
            free_arg((void *)(intptr_t)(arg_819));
        }
        int64_t __t3;
        __t3 = INT64_C(0);
        return (int)__t3;
