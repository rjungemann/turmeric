...
int main(int argc, char **argv) {
        ...
        {
            void * arg_996 = make_hyarg();
            (void)arg_996;
            {
                void * t_997 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_996));
                (void)t_997;
                thread_hyjoin((void *)(intptr_t)(t_997));
            }
            free_hyarg((void *)(intptr_t)(arg_996));
        }
        int64_t __t42;
        __t42 = INT64_C(0);
        return (int)__t42;
