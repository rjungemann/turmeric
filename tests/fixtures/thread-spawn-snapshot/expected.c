...
int main() {
        {
            void * arg_218 = make_arg();
            (void)arg_218;
            {
                void * t_219 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_218));
                (void)t_219;
                thread_join((void *)(intptr_t)(t_219));
            }
            free_arg((void *)(intptr_t)(arg_218));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
