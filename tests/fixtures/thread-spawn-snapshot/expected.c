...
int main(int argc, char **argv) {
        ...
        {
            void * arg_890 = make_hyarg();
            (void)arg_890;
            {
                void * t_891 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_890));
                (void)t_891;
                thread_hyjoin((void *)(intptr_t)(t_891));
            }
            free_hyarg((void *)(intptr_t)(arg_890));
        }
        int64_t __t21;
        __t21 = INT64_C(0);
        return (int)__t21;
