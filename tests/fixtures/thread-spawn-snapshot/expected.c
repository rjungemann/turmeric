...
int main(int argc, char **argv) {
        ...
        {
            void * arg_884 = make_hyarg();
            (void)arg_884;
            {
                void * t_885 = thread_hyspawn_hyfn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_884));
                (void)t_885;
                thread_hyjoin((void *)(intptr_t)(t_885));
            }
            free_hyarg((void *)(intptr_t)(arg_884));
        }
        int64_t __t21;
        __t21 = INT64_C(0);
        return (int)__t21;
