...
int main() {
        {
            void * arg_630 = make_arg();
            (void)arg_630;
            {
                void * t_631 = thread_spawn_fn((void *)(intptr_t)(worker), (void *)(intptr_t)(arg_630));
                (void)t_631;
                thread_join((void *)(intptr_t)(t_631));
            }
            free_arg((void *)(intptr_t)(arg_630));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
