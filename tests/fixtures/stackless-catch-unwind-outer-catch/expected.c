...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t158;
        {
            int64_t *__t159 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t159[0] = (int64_t)(intptr_t)__tur_fatshim0;
            __t159[1] = (int64_t)(intptr_t)__fn_1283;
            void *__t160 = __t159;
            int64_t __catch_result_161 = tur_catch_unwind_box((int64_t)(intptr_t)__t160);
            free((void *)(intptr_t)__t160);
            int64_t r_1285 = __catch_result_161;
            (void)r_1285;
            __auto_type __ps_162 = (err_qu(r_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_162) {
                puts("caught-outer");
            } else {
