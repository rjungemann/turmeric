...
static int64_t __fn_1304() {
        __auto_type __ps_42 = (f(INT64_C(3)));
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t160;
        {
            ...
            *(void (**)(void *))__t162 = 0;
            ...
            __t161[1] = (int64_t)(intptr_t)__fn_1304;
            void *__t163 = __t161;
            int64_t __catch_result_164 = tur_catch_unwind_box((int64_t)(intptr_t)__t163);
            TUR_CLOSURE_DROP(__t163);
            int64_t r_1306 = __catch_result_164;
            (void)r_1306;
            __auto_type __ps_165 = (err_qu(r_1306));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_165) {
                puts("caught-outer");
            } else {
            ...
            __t166 = INT64_C(0);
            __t160 = __t166;
            tur_result_box_free((int64_t)(intptr_t)r_1306);
        }
        return (int)__t160;
}
