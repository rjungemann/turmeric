    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t164;
        {
            ...
            *(void (**)(void *))__t166 = 0;
            ...
            __t165[0] = (int64_t)(intptr_t)__tur_fatshim0;
            __t165[1] = (int64_t)(intptr_t)__fn_1330;
            void *__t167 = __t165;
            int64_t __catch_result_168 = tur_catch_unwind_box((int64_t)(intptr_t)__t167);
            TUR_CLOSURE_DROP(__t167);
            int64_t r_1332 = __catch_result_168;
            (void)r_1332;
            bool __ps_169 = (err_qu(r_1332));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_169) {
                puts("caught-outer");
            } else {
            ...
            __t170 = INT64_C(0);
            __t164 = __t170;
            tur_result_box_free((int64_t)(intptr_t)r_1332);
        }
        return (int)__t164;
}
