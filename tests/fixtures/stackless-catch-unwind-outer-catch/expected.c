...
static int64_t __fn_1283() {
        __auto_type __ps_40 = (f(INT64_C(3)));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t178;
        {
            int64_t *__t179 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t179[0] = (int64_t)(intptr_t)__tur_fatshim0;
            __t179[1] = (int64_t)(intptr_t)__fn_1283;
            void *__t180 = __t179;
            int64_t __catch_result_181 = tur_catch_unwind_box((int64_t)(intptr_t)__t180);
            free((void *)(intptr_t)__t180);
            int64_t r_1285 = __catch_result_181;
            (void)r_1285;
            __auto_type __ps_182 = (err_qu(r_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_182) {
                puts("caught-outer");
            } else {
