...
static int64_t poly_hyshow_un_undict_un1450(int64_t, int64_t);
static int64_t __poly_1454(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1462(int64_t, int64_t);
static int64_t __poly_1466(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1450(int64_t __dict_1451, int64_t x) {
        const char * __ps_40 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1451)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_40;
}

static int64_t __poly_1454(void * __poly_env_1455, int64_t __poly_x0_1457, int64_t __poly_x1_1459) {
        int64_t __ps_41 = (poly_hyshow_un_undict_un1450(__poly_x0_1457, __poly_x1_1459));
        if (tur_panicking) return ((int64_t)0);
        return __ps_41;
}

static int64_t poly_hyrank_un_undict_un1462(int64_t __dict_1463, int64_t x) {
        int64_t __ps_42 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1463)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_42;
}

static int64_t __poly_1466(void * __poly_env_1467, int64_t __poly_x0_1469, int64_t __poly_x1_1471) {
        int64_t __ps_43 = (poly_hyrank_un_undict_un1462(__poly_x0_1469, __poly_x1_1471));
        if (tur_panicking) return ((int64_t)0);
        return __ps_43;
}
...
static int64_t poly_hyrank(int64_t x) {
        int64_t __ps_184 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_184;
}

static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_185 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_185);
        const char * __ps_186 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_186);
        const char * __t187;
        __t187 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_188 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_189 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_188) + (__ps_189);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_190 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1454 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_190);
        int64_t __ps_191 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1466 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_191));
        int64_t __t192;
        __t192 = INT64_C(0);
