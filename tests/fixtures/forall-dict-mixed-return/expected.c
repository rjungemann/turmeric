...
static int64_t poly_hyshow_un_undict_un1452(int64_t __dict_1453, int64_t x) {
        const char * __ps_40 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1453)[0])(x));
...
static int64_t __poly_1456(void * __poly_env_1457, int64_t __poly_x0_1459, int64_t __poly_x1_1461) {
        int64_t __ps_41 = (poly_hyshow_un_undict_un1452(__poly_x0_1459, __poly_x1_1461));
        if (tur_panicking) return ((int64_t)0);
        return __ps_41;
}

static int64_t poly_hyrank_un_undict_un1464(int64_t __dict_1465, int64_t x) {
        int64_t __ps_42 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1465)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1468(void * __poly_env_1469, int64_t __poly_x0_1471, int64_t __poly_x1_1473) {
        int64_t __ps_43 = (poly_hyrank_un_undict_un1464(__poly_x0_1471, __poly_x1_1473));
        if (tur_panicking) return ((int64_t)0);
        return __ps_43;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_820 = __ps_76;
        bool __ps_77 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_819, (void *)(intptr_t)(k_820), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_77;
        if (__t1) {
            int64_t __ps_78 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_79 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_819, (void *)(intptr_t)(k_820), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t81;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_824 = __ps_83;
            (void)iter_824;
            void * __ps_84 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_85 = (hamt_slkeyeq((void *)(intptr_t)(__ps_84)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_825 = __ps_85;
            (void)keyeq_825;
            void * __ps_86 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_87 = (map_hyeq_hyloop((void *)(intptr_t)(iter_824), (void *)(intptr_t)(__ps_86), (void *)(intptr_t)(keyeq_825), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_826 = __ps_87;
            (void)result_826;
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                if ((t1_1104) == (INT64_C(0))) {
                    __t108 = (t2_1105) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_1105) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        bool __ps_110 = (cons_hyeq_hygo(t1_1104, t2_1105));
                        if (tur_panicking) return ((bool)0);
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1120 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1120;
                __t117 = out_1120;
            }
            __t115 = __t117;
...
static int64_t poly_hyrank(int64_t x) {
        int64_t __ps_185 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_185;
}

static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_186 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_186);
        const char * __ps_187 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_187);
        const char * __t188;
        __t188 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_189 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_190 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_189) + (__ps_190);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_191 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1456 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_191);
        int64_t __ps_192 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1468 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_192));
        int64_t __t193;
        __t193 = INT64_C(0);
