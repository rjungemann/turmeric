...
static int64_t poly_hyshow_un_undict_un1346(int64_t, int64_t);
static int64_t __poly_1350(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1358(int64_t, int64_t);
static int64_t __poly_1362(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1346(int64_t __dict_1347, int64_t x) {
        const char * __ps_42 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1347)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_42;
}

static int64_t __poly_1350(void * __poly_env_1351, int64_t __poly_x0_1353, int64_t __poly_x1_1355) {
        int64_t __ps_43 = (poly_hyshow_un_undict_un1346(__poly_x0_1353, __poly_x1_1355));
        if (tur_panicking) return ((int64_t)0);
        return __ps_43;
}

static int64_t poly_hyrank_un_undict_un1358(int64_t __dict_1359, int64_t x) {
        int64_t __ps_44 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1359)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_44;
}

static int64_t __poly_1362(void * __poly_env_1363, int64_t __poly_x0_1365, int64_t __poly_x1_1367) {
        int64_t __ps_45 = (poly_hyrank_un_undict_un1358(__poly_x0_1365, __poly_x1_1367));
        if (tur_panicking) return ((int64_t)0);
        return __ps_45;
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_77 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_793, (void *)(intptr_t)(k_794), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_798 = __ps_81;
            (void)iter_798;
            void * __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_799 = __ps_83;
            (void)keyeq_799;
            void * __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_798), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_799), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_800 = __ps_85;
            (void)result_800;
        ...
        if (__ps_103) {
            bool __t104;
            {
                ...
                if ((t1_1042) == (INT64_C(0))) {
                    __t105 = (t2_1043) == (INT64_C(0));
                } else {
                    bool __t106;
                    if ((t2_1043) == (INT64_C(0))) {
                        __t106 = false;
                    } else {
                        bool __ps_107 = (cons_hyeq_hygo(t1_1042, t2_1043));
                        if (tur_panicking) return ((bool)0);
                        __t106 = __ps_107;
                    }
                    __t105 = __t106;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1058 = (int64_t)(intptr_t)(__ps_118);
                (void)out_1058;
                __t114 = out_1058;
            }
            __t112 = __t114;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1133 = __ps_125;
            (void)iter_1133;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1134 = __ps_127;
            (void)keyeq_1134;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1133), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1134)));
            if (tur_panicking) return ((bool)0);
            bool result_1135 = __ps_129;
            (void)result_1135;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1262));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1263 = __ps_152;
                (void)_un_unv_1263;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t156;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1313 = __ps_157;
            (void)r_1313;
            int64_t __t158;
            bool __ps_159 = (schema_hydecode_hyok_qu(r_1313));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_159) {
                int64_t __ps_160 = (schema_hydecode_hyvalue(r_1313));
                if (tur_panicking) return ((int64_t)0);
                __t158 = __ps_160;
            } else {
                int64_t __ps_161 = (schema_hydecode_hyerrors(r_1313));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t poly_hyrank(int64_t x) {
        int64_t __ps_165 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_165;
}

static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_166 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_166);
        const char * __ps_167 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_167);
        const char * __t168;
        __t168 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_169 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_170 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_169) + (__ps_170);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_171 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1350 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_171);
        int64_t __ps_172 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1362 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_172));
        int64_t __t173;
        __t173 = INT64_C(0);
