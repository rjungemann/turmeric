...
static int64_t poly_hyshow_un_undict_un1448(int64_t, int64_t);
static int64_t __poly_1452(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1460(int64_t, int64_t);
static int64_t __poly_1464(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1448(int64_t __dict_1449, int64_t x) {
        const char * __ps_44 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1449)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_44;
}

static int64_t __poly_1452(void * __poly_env_1453, int64_t __poly_x0_1455, int64_t __poly_x1_1457) {
        int64_t __ps_45 = (poly_hyshow_un_undict_un1448(__poly_x0_1455, __poly_x1_1457));
        if (tur_panicking) return ((int64_t)0);
        return __ps_45;
}

static int64_t poly_hyrank_un_undict_un1460(int64_t __dict_1461, int64_t x) {
        int64_t __ps_46 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1461)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_46;
}

static int64_t __poly_1464(void * __poly_env_1465, int64_t __poly_x0_1467, int64_t __poly_x1_1469) {
        int64_t __ps_47 = (poly_hyrank_un_undict_un1460(__poly_x0_1467, __poly_x1_1469));
        if (tur_panicking) return ((int64_t)0);
        return __ps_47;
}
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t126;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1193 = __ps_128;
            (void)iter_1193;
            void * __ps_129 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_130 = (hamt_slkeyeq((void *)(intptr_t)(__ps_129)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1194 = __ps_130;
            (void)keyeq_1194;
            void * __ps_131 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_132 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1193), (void *)(intptr_t)(__ps_131), (void *)(intptr_t)(keyeq_1194)));
            if (tur_panicking) return ((bool)0);
            bool result_1195 = __ps_132;
            (void)result_1195;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t153;
        {
            ...
            {
                tur_adt_Vec__int * __ps_155 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1322));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1323 = __ps_155;
                (void)_un_unv_1323;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1373 = __ps_160;
            (void)r_1373;
            int64_t __t161;
            bool __ps_162 = (schema_hydecode_hyok_qu(r_1373));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_162) {
                int64_t __ps_163 = (schema_hydecode_hyvalue(r_1373));
                if (tur_panicking) return ((int64_t)0);
                __t161 = __ps_163;
            } else {
                int64_t __ps_164 = (schema_hydecode_hyerrors(r_1373));
                if (tur_panicking) return ((int64_t)0);
...
static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_178 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_178);
        const char * __ps_179 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_179);
        const char * __t180;
        __t180 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_181 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_182 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_181) + (__ps_182);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_183 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1452 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_183);
        int64_t __ps_184 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1464 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_184));
        int64_t __t185;
        __t185 = INT64_C(0);
