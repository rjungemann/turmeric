...
static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_175 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_175);
        const char * __ps_176 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_176);
        const char * __t177;
        __t177 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_178 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_179 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_178) + (__ps_179);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_180 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1626 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_180);
        int64_t __ps_181 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1638 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        int64_t __t182;
        __t182 = INT64_C(0);
