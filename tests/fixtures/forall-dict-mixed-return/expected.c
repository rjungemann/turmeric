...
static int64_t poly_hyshow_un_undict_un1286(int64_t, int64_t);
static int64_t __poly_1290(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1298(int64_t, int64_t);
static int64_t __poly_1302(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1286(int64_t __dict_1287, int64_t x) {
        __auto_type __ps_40 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1287)[0])(x));
        if (tur_panicking) return (int64_t){0};
        return (int64_t)(intptr_t)__ps_40;
}

static int64_t __poly_1290(void * __poly_env_1291, int64_t __poly_x0_1293, int64_t __poly_x1_1295) {
        __auto_type __ps_41 = (poly_hyshow_un_undict_un1286(__poly_x0_1293, __poly_x1_1295));
        if (tur_panicking) return (int64_t){0};
        return __ps_41;
}

static int64_t poly_hyrank_un_undict_un1298(int64_t __dict_1299, int64_t x) {
        __auto_type __ps_42 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1299)[0])(x));
        if (tur_panicking) return (int64_t){0};
        return (int64_t)(intptr_t)__ps_42;
}

static int64_t __poly_1302(void * __poly_env_1303, int64_t __poly_x0_1305, int64_t __poly_x1_1307) {
        __auto_type __ps_43 = (poly_hyrank_un_undict_un1298(__poly_x0_1305, __poly_x1_1307));
        if (tur_panicking) return (int64_t){0};
        return __ps_43;
}
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_184 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1290 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_184);
        __auto_type __ps_185 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1302 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        int64_t __t186;
        __t186 = INT64_C(0);
