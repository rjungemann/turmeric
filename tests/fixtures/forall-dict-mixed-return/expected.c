...
static int64_t poly_hyshow_un_undict_un1637(int64_t, int64_t);
static int64_t __poly_1641(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1649(int64_t, int64_t);
static int64_t __poly_1653(void *, int64_t, int64_t);
...
static const char * poly_hyshow(int64_t);
static int64_t poly_hyrank(int64_t);
static const char * use_hyshow(tur_poly_fn_t);
static int64_t use_hyrank(tur_poly_fn_t);
...
static int64_t poly_hyshow_un_undict_un1637(int64_t __dict_1638, int64_t x) {
        const char * __ps_62 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1638)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_62;
}

static int64_t __poly_1641(void * __poly_env_1642, int64_t __poly_x0_1644, int64_t __poly_x1_1646) {
        return poly_hyshow_un_undict_un1637(__poly_x0_1644, __poly_x1_1646);
}

static int64_t poly_hyrank_un_undict_un1649(int64_t __dict_1650, int64_t x) {
        int64_t __ps_63 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1650)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_63;
}

static int64_t __poly_1653(void * __poly_env_1654, int64_t __poly_x0_1656, int64_t __poly_x1_1658) {
        return poly_hyrank_un_undict_un1649(__poly_x0_1656, __poly_x1_1658);
}
...
__tur_cps_self:;
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_1001 = __ps_70;
        bool __ps_71 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_1000, (void *)(intptr_t)(k_1001), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_71;
        if (__t1) {
            int64_t __ps_72 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_1000, (void *)(intptr_t)(k_1001), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1005 = __ps_77;
            (void)iter_1005;
            void * __ps_78 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_79 = (hamt_slkeyeq((void *)(intptr_t)(__ps_78)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1006 = __ps_79;
            (void)keyeq_1006;
            void * __ps_80 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1005), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_1006), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1007 = __ps_81;
            (void)result_1007;
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if (__ps_102) {
                    ...
                    bool __t104;
                    bool __ps_105 = (tnil_qu(t2_1298));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_105) {
                        __t104 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1297, t2_1298));
                        if (tur_panicking) return ((bool)0);
                        __t104 = __ps_106;
                    }
                    __t101 = __t104;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                int64_t out_1313 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1313;
                __t113 = out_1313;
            }
            __t111 = __t113;
        ...
        if (__ps_118) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1384 = __ps_119;
                (void)h_1384;
                void * __ps_120 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1385 = __ps_120;
                (void)k_1385;
                bool __ps_121 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1384, (void *)(intptr_t)(k_1385), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_121) {
                    void * __t122 = iter;
                    void * __t123 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1388 = __ps_127;
            (void)iter_1388;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1389 = __ps_129;
            (void)keyeq_1389;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1388), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1389)));
            if (tur_panicking) return ((bool)0);
            bool result_1390 = __ps_131;
            (void)result_1390;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1520));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1521 = __ps_154;
                (void)_un_unv_1521;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1571 = __ps_157;
            (void)r_1571;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1571));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                return schema_hydecode_hyvalue(r_1571);
            } else {
                int64_t __ps_159 = (schema_hydecode_hyerrors(r_1571));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t161;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1622 = __ps_162;
            (void)m_1622;
            tur_frame __frame_163;
            tur_frame_init(&__frame_163, NULL);
            struct __defer_env_164 __t166 = {.m = m_1622};
...
static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_174 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_174);
        const char * __ps_175 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_175);
        const char * __t176;
        __t176 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_177 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_178 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_177) + (__ps_178);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_179 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1641 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_179);
        int64_t __ps_180 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1653 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
