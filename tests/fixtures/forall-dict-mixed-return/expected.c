...
static int64_t poly_hyshow_un_undict_un1378(int64_t, int64_t);
static int64_t __poly_1382(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1390(int64_t, int64_t);
static int64_t __poly_1394(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1378(int64_t __dict_1379, int64_t x) {
        const char * __ps_44 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1379)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_44;
}

static int64_t __poly_1382(void * __poly_env_1383, int64_t __poly_x0_1385, int64_t __poly_x1_1387) {
        int64_t __ps_45 = (poly_hyshow_un_undict_un1378(__poly_x0_1385, __poly_x1_1387));
        if (tur_panicking) return ((int64_t)0);
        return __ps_45;
}

static int64_t poly_hyrank_un_undict_un1390(int64_t __dict_1391, int64_t x) {
        int64_t __ps_46 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1391)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_46;
}

static int64_t __poly_1394(void * __poly_env_1395, int64_t __poly_x0_1397, int64_t __poly_x1_1399) {
        int64_t __ps_47 = (poly_hyrank_un_undict_un1390(__poly_x0_1397, __poly_x1_1399));
        if (tur_panicking) return ((int64_t)0);
        return __ps_47;
}
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                if ((t1_1074) == (INT64_C(0))) {
                    __t108 = (t2_1075) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_1075) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        bool __ps_110 = (cons_hyeq_hygo(t1_1074, t2_1075));
                        if (tur_panicking) return ((bool)0);
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1090 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1090;
                __t117 = out_1090;
            }
            __t115 = __t117;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t126;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1165 = __ps_128;
            (void)iter_1165;
            void * __ps_129 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_130 = (hamt_slkeyeq((void *)(intptr_t)(__ps_129)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1166 = __ps_130;
            (void)keyeq_1166;
            void * __ps_131 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_132 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1165), (void *)(intptr_t)(__ps_131), (void *)(intptr_t)(keyeq_1166)));
            if (tur_panicking) return ((bool)0);
            bool result_1167 = __ps_132;
            (void)result_1167;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t153;
        {
            ...
            {
                tur_adt_Vec__int * __ps_155 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1294));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1295 = __ps_155;
                (void)_un_unv_1295;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1345 = __ps_160;
            (void)r_1345;
            int64_t __t161;
            bool __ps_162 = (schema_hydecode_hyok_qu(r_1345));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_162) {
                int64_t __ps_163 = (schema_hydecode_hyvalue(r_1345));
                if (tur_panicking) return ((int64_t)0);
                __t161 = __ps_163;
            } else {
                int64_t __ps_164 = (schema_hydecode_hyerrors(r_1345));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_174 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1382 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_174);
        int64_t __ps_175 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1394 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_175));
        int64_t __t176;
        __t176 = INT64_C(0);
