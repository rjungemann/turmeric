...
static int64_t poly_hyshow_un_undict_un1452(int64_t, int64_t);
static int64_t __poly_1456(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1464(int64_t, int64_t);
static int64_t __poly_1468(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1452(int64_t __dict_1453, int64_t x) {
        const char * __ps_42 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1453)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_42;
}

static int64_t __poly_1456(void * __poly_env_1457, int64_t __poly_x0_1459, int64_t __poly_x1_1461) {
        int64_t __ps_43 = (poly_hyshow_un_undict_un1452(__poly_x0_1459, __poly_x1_1461));
        if (tur_panicking) return ((int64_t)0);
        return __ps_43;
}

static int64_t poly_hyrank_un_undict_un1464(int64_t __dict_1465, int64_t x) {
        int64_t __ps_44 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1465)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_44;
}

static int64_t __poly_1468(void * __poly_env_1469, int64_t __poly_x0_1471, int64_t __poly_x1_1473) {
        int64_t __ps_45 = (poly_hyrank_un_undict_un1464(__poly_x0_1471, __poly_x1_1473));
        if (tur_panicking) return ((int64_t)0);
        return __ps_45;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_820 = __ps_78;
        bool __ps_79 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_819, (void *)(intptr_t)(k_820), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_79;
        if (__t1) {
            int64_t __ps_80 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_81 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_819, (void *)(intptr_t)(k_820), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t83;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_824 = __ps_85;
            (void)iter_824;
            void * __ps_86 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_87 = (hamt_slkeyeq((void *)(intptr_t)(__ps_86)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_825 = __ps_87;
            (void)keyeq_825;
            void * __ps_88 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_89 = (map_hyeq_hyloop((void *)(intptr_t)(iter_824), (void *)(intptr_t)(__ps_88), (void *)(intptr_t)(keyeq_825), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_826 = __ps_89;
            (void)result_826;
        ...
        if (__ps_108) {
            bool __t109;
            {
                ...
                if ((t1_1104) == (INT64_C(0))) {
                    __t110 = (t2_1105) == (INT64_C(0));
                } else {
                    bool __t111;
                    if ((t2_1105) == (INT64_C(0))) {
                        __t111 = false;
                    } else {
                        bool __ps_112 = (cons_hyeq_hygo(t1_1104, t2_1105));
                        if (tur_panicking) return ((bool)0);
                        __t111 = __ps_112;
                    }
                    __t110 = __t111;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_118) {
            ...
            int64_t __t119;
            {
                ...
                int64_t out_1120 = (int64_t)(intptr_t)(__t124);
                (void)out_1120;
                __t119 = out_1120;
            }
            __t117 = __t119;
        ...
        if (__ps_129) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1191 = __ps_130;
                (void)h_1191;
                void * __ps_131 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1192 = __ps_131;
                (void)k_1192;
                bool __ps_132 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1191, (void *)(intptr_t)(k_1192), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_132) {
                    void * __t133 = iter;
                    void * __t134 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t136;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1195 = __ps_138;
            (void)iter_1195;
            void * __ps_139 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_140 = (hamt_slkeyeq((void *)(intptr_t)(__ps_139)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1196 = __ps_140;
            (void)keyeq_1196;
            void * __ps_141 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_142 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1195), (void *)(intptr_t)(__ps_141), (void *)(intptr_t)(keyeq_1196)));
            if (tur_panicking) return ((bool)0);
            bool result_1197 = __ps_142;
            (void)result_1197;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t163;
        {
            ...
            {
                tur_adt_Vec__int * __ps_165 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1325));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1326 = __ps_165;
                (void)_un_unv_1326;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t169;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1376 = __ps_170;
            (void)r_1376;
            int64_t __t171;
            bool __ps_172 = (schema_hydecode_hyok_qu(r_1376));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_172) {
                int64_t __ps_173 = (schema_hydecode_hyvalue(r_1376));
                if (tur_panicking) return ((int64_t)0);
                __t171 = __ps_173;
            } else {
                int64_t __ps_174 = (schema_hydecode_hyerrors(r_1376));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t poly_hyrank(int64_t x) {
        int64_t __ps_188 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_188;
}

static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_189 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_189);
        const char * __ps_190 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_190);
        const char * __t191;
        __t191 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_192 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_193 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_192) + (__ps_193);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_194 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1456 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_194);
        int64_t __ps_195 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1468 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_195));
        int64_t __t196;
        __t196 = INT64_C(0);
