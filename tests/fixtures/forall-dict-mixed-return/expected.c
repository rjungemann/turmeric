...
static int64_t __poly_1626(void * __poly_env_1627, int64_t __poly_x0_1629, int64_t __poly_x1_1631) {
        return poly_hyshow_un_undict_un1622(__poly_x0_1629, __poly_x1_1631);
}

static int64_t poly_hyrank_un_undict_un1634(int64_t __dict_1635, int64_t x) {
        int64_t __ps_63 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1635)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1638(void * __poly_env_1639, int64_t __poly_x0_1641, int64_t __poly_x1_1643) {
        return poly_hyrank_un_undict_un1634(__poly_x0_1641, __poly_x1_1643);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_179 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1626 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_179);
        int64_t __ps_180 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1638 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
