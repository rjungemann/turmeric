...
static int64_t poly_hyshow_un_undict_un1622(int64_t, int64_t);
static int64_t __poly_1626(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1634(int64_t, int64_t);
static int64_t __poly_1638(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1622(int64_t __dict_1623, int64_t x) {
        const char * __ps_128 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1623)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_128;
}

static int64_t __poly_1626(void * __poly_env_1627, int64_t __poly_x0_1629, int64_t __poly_x1_1631) {
        int64_t __ps_129 = (poly_hyshow_un_undict_un1622(__poly_x0_1629, __poly_x1_1631));
        if (tur_panicking) return ((int64_t)0);
        return __ps_129;
}

static int64_t poly_hyrank_un_undict_un1634(int64_t __dict_1635, int64_t x) {
        int64_t __ps_130 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1635)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_130;
}

static int64_t __poly_1638(void * __poly_env_1639, int64_t __poly_x0_1641, int64_t __poly_x1_1643) {
        int64_t __ps_131 = (poly_hyrank_un_undict_un1634(__poly_x0_1641, __poly_x1_1643));
        if (tur_panicking) return ((int64_t)0);
        return __ps_131;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_998 = __ps_168;
        bool __ps_169 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_997, (void *)(intptr_t)(k_998), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_169;
        if (__t1) {
            int64_t __ps_170 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_171 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_997, (void *)(intptr_t)(k_998), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t173;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1002 = __ps_175;
            (void)iter_1002;
            void * __ps_176 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_177 = (hamt_slkeyeq((void *)(intptr_t)(__ps_176)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1003 = __ps_177;
            (void)keyeq_1003;
            void * __ps_178 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_179 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1002), (void *)(intptr_t)(__ps_178), (void *)(intptr_t)(keyeq_1003), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1004 = __ps_179;
            (void)result_1004;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_198) {
            bool __t199;
            {
                ...
                (void)t2_1283;
                bool __t200;
                bool __ps_201 = (tnil_qu(t1_1282));
                if (tur_panicking) return ((bool)0);
                if (__ps_201) {
                    bool __ps_202 = (tnil_qu(t2_1283));
                    if (tur_panicking) return ((bool)0);
                    __t200 = __ps_202;
                } else {
                    bool __t203;
                    bool __ps_204 = (tnil_qu(t2_1283));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_204) {
                        __t203 = false;
                    } else {
                        bool __ps_205 = (cons_hyeq_hygo(t1_1282, t2_1283));
                        if (tur_panicking) return ((bool)0);
                        __t203 = __ps_205;
                    }
                    __t200 = __t203;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_211) {
            ...
            int64_t __t212;
            {
                ...
                int64_t out_1298 = (int64_t)(intptr_t)(__ps_216);
                (void)out_1298;
                __t212 = out_1298;
            }
            __t210 = __t212;
        ...
        if (__ps_220) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1369 = __ps_221;
                (void)h_1369;
                void * __ps_222 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1370 = __ps_222;
                (void)k_1370;
                bool __ps_223 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1369, (void *)(intptr_t)(k_1370), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_223) {
                    void * __t224 = iter;
                    void * __t225 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t227;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1373 = __ps_229;
            (void)iter_1373;
            void * __ps_230 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_231 = (hamt_slkeyeq((void *)(intptr_t)(__ps_230)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1374 = __ps_231;
            (void)keyeq_1374;
            void * __ps_232 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_233 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1373), (void *)(intptr_t)(__ps_232), (void *)(intptr_t)(keyeq_1374)));
            if (tur_panicking) return ((bool)0);
            bool result_1375 = __ps_233;
            (void)result_1375;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t254;
        {
            ...
            {
                tur_adt_Vec__int * __ps_256 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1505));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1506 = __ps_256;
                (void)_un_unv_1506;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t260;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1556 = __ps_261;
            (void)r_1556;
            int64_t __t262;
            bool __ps_263 = (schema_hydecode_hyok_qu(r_1556));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_263) {
                int64_t __ps_264 = (schema_hydecode_hyvalue(r_1556));
                if (tur_panicking) return ((int64_t)0);
                __t262 = __ps_264;
            } else {
                int64_t __ps_265 = (schema_hydecode_hyerrors(r_1556));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t268;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1607 = __ps_269;
            (void)m_1607;
            tur_frame __frame_270;
            tur_frame_init(&__frame_270, NULL);
            struct __defer_env_271 __t273 = {.m = m_1607};
...
static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_283 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_283);
        const char * __ps_284 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_284);
        const char * __t285;
        __t285 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_286 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_287 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_286) + (__ps_287);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_288 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1626 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_288);
        int64_t __ps_289 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1638 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_289));
        int64_t __t290;
        __t290 = INT64_C(0);
