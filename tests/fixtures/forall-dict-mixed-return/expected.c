...
static int64_t poly_hyshow_un_undict_un1344(int64_t, int64_t);
static int64_t __poly_1348(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1356(int64_t, int64_t);
static int64_t __poly_1360(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1344(int64_t __dict_1345, int64_t x) {
        const char * __ps_42 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1345)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_42;
}

static int64_t __poly_1348(void * __poly_env_1349, int64_t __poly_x0_1351, int64_t __poly_x1_1353) {
        int64_t __ps_43 = (poly_hyshow_un_undict_un1344(__poly_x0_1351, __poly_x1_1353));
        if (tur_panicking) return ((int64_t)0);
        return __ps_43;
}

static int64_t poly_hyrank_un_undict_un1356(int64_t __dict_1357, int64_t x) {
        int64_t __ps_44 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1357)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_44;
}

static int64_t __poly_1360(void * __poly_env_1361, int64_t __poly_x0_1363, int64_t __poly_x1_1365) {
        int64_t __ps_45 = (poly_hyrank_un_undict_un1356(__poly_x0_1363, __poly_x1_1365));
        if (tur_panicking) return ((int64_t)0);
        return __ps_45;
}
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t155;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1311 = __ps_156;
            (void)r_1311;
            int64_t __t157;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1311));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                int64_t __ps_159 = (schema_hydecode_hyvalue(r_1311));
                if (tur_panicking) return ((int64_t)0);
                __t157 = __ps_159;
            } else {
                int64_t __ps_160 = (schema_hydecode_hyerrors(r_1311));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_170 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1348 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_170);
        int64_t __ps_171 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1360 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_171));
        int64_t __t172;
        __t172 = INT64_C(0);
