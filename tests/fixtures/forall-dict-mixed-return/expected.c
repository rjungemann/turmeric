...
static int64_t poly_hyshow_un_undict_un1448(int64_t __dict_1449, int64_t x) {
        const char * __ps_40 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1449)[0])(x));
...
static int64_t __poly_1452(void * __poly_env_1453, int64_t __poly_x0_1455, int64_t __poly_x1_1457) {
        int64_t __ps_41 = (poly_hyshow_un_undict_un1448(__poly_x0_1455, __poly_x1_1457));
        if (tur_panicking) return ((int64_t)0);
        return __ps_41;
}

static int64_t poly_hyrank_un_undict_un1460(int64_t __dict_1461, int64_t x) {
        int64_t __ps_42 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1461)[0])(x));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t __poly_1464(void * __poly_env_1465, int64_t __poly_x0_1467, int64_t __poly_x1_1469) {
        int64_t __ps_43 = (poly_hyrank_un_undict_un1460(__poly_x0_1467, __poly_x1_1469));
        if (tur_panicking) return ((int64_t)0);
        return __ps_43;
}
...
static int64_t poly_hyrank(int64_t x) {
        int64_t __ps_173 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_173;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_179 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1452 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_179);
        int64_t __ps_180 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1464 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
