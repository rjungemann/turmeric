...
static int64_t poly_hyshow_un_undict_un1382(int64_t, int64_t);
static int64_t __poly_1386(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1394(int64_t, int64_t);
static int64_t __poly_1398(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1382(int64_t __dict_1383, int64_t x) {
        const char * __ps_44 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1383)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_44;
}

static int64_t __poly_1386(void * __poly_env_1387, int64_t __poly_x0_1389, int64_t __poly_x1_1391) {
        int64_t __ps_45 = (poly_hyshow_un_undict_un1382(__poly_x0_1389, __poly_x1_1391));
        if (tur_panicking) return ((int64_t)0);
        return __ps_45;
}

static int64_t poly_hyrank_un_undict_un1394(int64_t __dict_1395, int64_t x) {
        int64_t __ps_46 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1395)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_46;
}

static int64_t __poly_1398(void * __poly_env_1399, int64_t __poly_x0_1401, int64_t __poly_x1_1403) {
        int64_t __ps_47 = (poly_hyrank_un_undict_un1394(__poly_x0_1401, __poly_x1_1403));
        if (tur_panicking) return ((int64_t)0);
        return __ps_47;
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_79 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_793, (void *)(intptr_t)(k_794), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t81;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_798 = __ps_83;
            (void)iter_798;
            void * __ps_84 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_85 = (hamt_slkeyeq((void *)(intptr_t)(__ps_84)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_799 = __ps_85;
            (void)keyeq_799;
            void * __ps_86 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_87 = (map_hyeq_hyloop((void *)(intptr_t)(iter_798), (void *)(intptr_t)(__ps_86), (void *)(intptr_t)(keyeq_799), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_800 = __ps_87;
            (void)result_800;
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                if ((t1_1078) == (INT64_C(0))) {
                    __t108 = (t2_1079) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_1079) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        bool __ps_110 = (cons_hyeq_hygo(t1_1078, t2_1079));
                        if (tur_panicking) return ((bool)0);
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1094 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1094;
                __t117 = out_1094;
            }
            __t115 = __t117;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t126;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1169 = __ps_128;
            (void)iter_1169;
            void * __ps_129 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_130 = (hamt_slkeyeq((void *)(intptr_t)(__ps_129)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1170 = __ps_130;
            (void)keyeq_1170;
            void * __ps_131 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_132 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1169), (void *)(intptr_t)(__ps_131), (void *)(intptr_t)(keyeq_1170)));
            if (tur_panicking) return ((bool)0);
            bool result_1171 = __ps_132;
            (void)result_1171;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t153;
        {
            ...
            {
                tur_adt_Vec__int * __ps_155 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1298));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1299 = __ps_155;
                (void)_un_unv_1299;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1349 = __ps_160;
            (void)r_1349;
            int64_t __t161;
            bool __ps_162 = (schema_hydecode_hyok_qu(r_1349));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_162) {
                int64_t __ps_163 = (schema_hydecode_hyvalue(r_1349));
                if (tur_panicking) return ((int64_t)0);
                __t161 = __ps_163;
            } else {
                int64_t __ps_164 = (schema_hydecode_hyerrors(r_1349));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t poly_hyrank(int64_t x) {
        int64_t __ps_168 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_168;
}

static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_169 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_169);
        const char * __ps_170 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_170);
        const char * __t171;
        __t171 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_172 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_173 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_172) + (__ps_173);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_174 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1386 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_174);
        int64_t __ps_175 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1398 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_175));
        int64_t __t176;
        __t176 = INT64_C(0);
