...
static int64_t poly_hyshow_un_undict_un1635(int64_t, int64_t);
static int64_t __poly_1639(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1647(int64_t, int64_t);
static int64_t __poly_1651(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1635(int64_t __dict_1636, int64_t x) {
        const char * __ps_62 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1636)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_62;
}

static int64_t __poly_1639(void * __poly_env_1640, int64_t __poly_x0_1642, int64_t __poly_x1_1644) {
        return poly_hyshow_un_undict_un1635(__poly_x0_1642, __poly_x1_1644);
}

static int64_t poly_hyrank_un_undict_un1647(int64_t __dict_1648, int64_t x) {
        int64_t __ps_63 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1648)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_63;
}

static int64_t __poly_1651(void * __poly_env_1652, int64_t __poly_x0_1654, int64_t __poly_x1_1656) {
        return poly_hyrank_un_undict_un1647(__poly_x0_1654, __poly_x1_1656);
}
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if (__ps_102) {
                    ...
                    bool __t104;
                    bool __ps_105 = (tnil_qu(t2_1296));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_105) {
                        __t104 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1295, t2_1296));
                        if (tur_panicking) return ((bool)0);
                        __t104 = __ps_106;
                    }
                    __t101 = __t104;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                int64_t out_1311 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1311;
                __t113 = out_1311;
            }
            __t111 = __t113;
        ...
        if (__ps_118) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1382 = __ps_119;
                (void)h_1382;
                void * __ps_120 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1383 = __ps_120;
                (void)k_1383;
                bool __ps_121 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1382, (void *)(intptr_t)(k_1383), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_121) {
                    void * __t122 = iter;
                    void * __t123 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1386 = __ps_127;
            (void)iter_1386;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1387 = __ps_129;
            (void)keyeq_1387;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1386), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1387)));
            if (tur_panicking) return ((bool)0);
            bool result_1388 = __ps_131;
            (void)result_1388;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1518));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1519 = __ps_154;
                (void)_un_unv_1519;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1569 = __ps_157;
            (void)r_1569;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1569));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                return schema_hydecode_hyvalue(r_1569);
            } else {
                int64_t __ps_159 = (schema_hydecode_hyerrors(r_1569));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t161;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1620 = __ps_162;
            (void)m_1620;
            tur_frame __frame_163;
            tur_frame_init(&__frame_163, NULL);
            struct __defer_env_164 __t166 = {.m = m_1620};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_179 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1639 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_179);
        int64_t __ps_180 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1651 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
