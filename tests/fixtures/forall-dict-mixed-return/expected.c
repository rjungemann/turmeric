...
static int64_t poly_hyshow_un_undict_un1483(int64_t, int64_t);
static int64_t __poly_1487(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1495(int64_t, int64_t);
static int64_t __poly_1499(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1483(int64_t __dict_1484, int64_t x) {
        const char * __ps_104 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1484)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_104;
}

static int64_t __poly_1487(void * __poly_env_1488, int64_t __poly_x0_1490, int64_t __poly_x1_1492) {
        int64_t __ps_105 = (poly_hyshow_un_undict_un1483(__poly_x0_1490, __poly_x1_1492));
        if (tur_panicking) return ((int64_t)0);
        return __ps_105;
}

static int64_t poly_hyrank_un_undict_un1495(int64_t __dict_1496, int64_t x) {
        int64_t __ps_106 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1496)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_106;
}

static int64_t __poly_1499(void * __poly_env_1500, int64_t __poly_x0_1502, int64_t __poly_x1_1504) {
        int64_t __ps_107 = (poly_hyrank_un_undict_un1495(__poly_x0_1502, __poly_x1_1504));
        if (tur_panicking) return ((int64_t)0);
        return __ps_107;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_857 = __ps_140;
        bool __ps_141 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_856, (void *)(intptr_t)(k_857), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_141;
        if (__t1) {
            int64_t __ps_142 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_143 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_856, (void *)(intptr_t)(k_857), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t145;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_861 = __ps_147;
            (void)iter_861;
            void * __ps_148 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_149 = (hamt_slkeyeq((void *)(intptr_t)(__ps_148)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_862 = __ps_149;
            (void)keyeq_862;
            void * __ps_150 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_151 = (map_hyeq_hyloop((void *)(intptr_t)(iter_861), (void *)(intptr_t)(__ps_150), (void *)(intptr_t)(keyeq_862), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_863 = __ps_151;
            (void)result_863;
        ...
        if (__ps_170) {
            bool __t171;
            {
                ...
                if ((t1_1141) == (INT64_C(0))) {
                    __t172 = (t2_1142) == (INT64_C(0));
                } else {
                    bool __t173;
                    if ((t2_1142) == (INT64_C(0))) {
                        __t173 = false;
                    } else {
                        bool __ps_174 = (cons_hyeq_hygo(t1_1141, t2_1142));
                        if (tur_panicking) return ((bool)0);
                        __t173 = __ps_174;
                    }
                    __t172 = __t173;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_180) {
            ...
            int64_t __t181;
            {
                ...
                int64_t out_1157 = (int64_t)(intptr_t)(__ps_185);
                (void)out_1157;
                __t181 = out_1157;
            }
            __t179 = __t181;
        ...
        if (__ps_190) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1228 = __ps_191;
                (void)h_1228;
                void * __ps_192 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1229 = __ps_192;
                (void)k_1229;
                bool __ps_193 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1228, (void *)(intptr_t)(k_1229), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_193) {
                    void * __t194 = iter;
                    void * __t195 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t197;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1232 = __ps_199;
            (void)iter_1232;
            void * __ps_200 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_201 = (hamt_slkeyeq((void *)(intptr_t)(__ps_200)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1233 = __ps_201;
            (void)keyeq_1233;
            void * __ps_202 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_203 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1232), (void *)(intptr_t)(__ps_202), (void *)(intptr_t)(keyeq_1233)));
            if (tur_panicking) return ((bool)0);
            bool result_1234 = __ps_203;
            (void)result_1234;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t224;
        {
            ...
            {
                tur_adt_Vec__int * __ps_226 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1364));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1365 = __ps_226;
                (void)_un_unv_1365;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t230;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1415 = __ps_231;
            (void)r_1415;
            int64_t __t232;
            bool __ps_233 = (schema_hydecode_hyok_qu(r_1415));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_233) {
                int64_t __ps_234 = (schema_hydecode_hyvalue(r_1415));
                if (tur_panicking) return ((int64_t)0);
                __t232 = __ps_234;
            } else {
                int64_t __ps_235 = (schema_hydecode_hyerrors(r_1415));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t poly_hyrank(int64_t x) {
        int64_t __ps_249 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_249;
}

static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_250 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_250);
        const char * __ps_251 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_251);
        const char * __t252;
        __t252 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_253 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_254 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_253) + (__ps_254);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_255 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1487 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_255);
        int64_t __ps_256 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1499 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_256));
        int64_t __t257;
        __t257 = INT64_C(0);
