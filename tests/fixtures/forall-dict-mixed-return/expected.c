...
static int64_t poly_hyshow_un_undict_un1479(int64_t, int64_t);
static int64_t __poly_1483(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1491(int64_t, int64_t);
static int64_t __poly_1495(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1479(int64_t __dict_1480, int64_t x) {
        const char * __ps_92 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1480)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_92;
}

static int64_t __poly_1483(void * __poly_env_1484, int64_t __poly_x0_1486, int64_t __poly_x1_1488) {
        int64_t __ps_93 = (poly_hyshow_un_undict_un1479(__poly_x0_1486, __poly_x1_1488));
        if (tur_panicking) return ((int64_t)0);
        return __ps_93;
}

static int64_t poly_hyrank_un_undict_un1491(int64_t __dict_1492, int64_t x) {
        int64_t __ps_94 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1492)[0])(x));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_94;
}

static int64_t __poly_1495(void * __poly_env_1496, int64_t __poly_x0_1498, int64_t __poly_x1_1500) {
        int64_t __ps_95 = (poly_hyrank_un_undict_un1491(__poly_x0_1498, __poly_x1_1500));
        if (tur_panicking) return ((int64_t)0);
        return __ps_95;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_845 = __ps_128;
        bool __ps_129 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_844, (void *)(intptr_t)(k_845), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_129;
        if (__t1) {
            int64_t __ps_130 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_131 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_844, (void *)(intptr_t)(k_845), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t133;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_849 = __ps_135;
            (void)iter_849;
            void * __ps_136 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_137 = (hamt_slkeyeq((void *)(intptr_t)(__ps_136)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_850 = __ps_137;
            (void)keyeq_850;
            void * __ps_138 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_139 = (map_hyeq_hyloop((void *)(intptr_t)(iter_849), (void *)(intptr_t)(__ps_138), (void *)(intptr_t)(keyeq_850), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_851 = __ps_139;
            (void)result_851;
        ...
        if (__ps_158) {
            bool __t159;
            {
                ...
                if ((t1_1129) == (INT64_C(0))) {
                    __t160 = (t2_1130) == (INT64_C(0));
                } else {
                    bool __t161;
                    if ((t2_1130) == (INT64_C(0))) {
                        __t161 = false;
                    } else {
                        bool __ps_162 = (cons_hyeq_hygo(t1_1129, t2_1130));
                        if (tur_panicking) return ((bool)0);
                        __t161 = __ps_162;
                    }
                    __t160 = __t161;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_168) {
            ...
            int64_t __t169;
            {
                ...
                int64_t out_1145 = (int64_t)(intptr_t)(__ps_173);
                (void)out_1145;
                __t169 = out_1145;
            }
            __t167 = __t169;
        ...
        if (__ps_178) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1216 = __ps_179;
                (void)h_1216;
                void * __ps_180 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1217 = __ps_180;
                (void)k_1217;
                bool __ps_181 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1216, (void *)(intptr_t)(k_1217), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_181) {
                    void * __t182 = iter;
                    void * __t183 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t185;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1220 = __ps_187;
            (void)iter_1220;
            void * __ps_188 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_189 = (hamt_slkeyeq((void *)(intptr_t)(__ps_188)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1221 = __ps_189;
            (void)keyeq_1221;
            void * __ps_190 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_191 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1220), (void *)(intptr_t)(__ps_190), (void *)(intptr_t)(keyeq_1221)));
            if (tur_panicking) return ((bool)0);
            bool result_1222 = __ps_191;
            (void)result_1222;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t212;
        {
            ...
            {
                tur_adt_Vec__int * __ps_214 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1352));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1353 = __ps_214;
                (void)_un_unv_1353;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t218;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1403 = __ps_219;
            (void)r_1403;
            int64_t __t220;
            bool __ps_221 = (schema_hydecode_hyok_qu(r_1403));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_221) {
                int64_t __ps_222 = (schema_hydecode_hyvalue(r_1403));
                if (tur_panicking) return ((int64_t)0);
                __t220 = __ps_222;
            } else {
                int64_t __ps_223 = (schema_hydecode_hyerrors(r_1403));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t poly_hyrank(int64_t x) {
        int64_t __ps_237 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_237;
}

static const char * use_hyshow(tur_poly_fn_t f) {
        const char * __ps_238 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_238);
        const char * __ps_239 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return ((const char *)0);
        puts(__ps_239);
        const char * __t240;
        __t240 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        int64_t __ps_241 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_242 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return ((int64_t)0);
        return (__ps_241) + (__ps_242);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_243 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1483 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_243);
        int64_t __ps_244 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1495 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_244));
        int64_t __t245;
        __t245 = INT64_C(0);
