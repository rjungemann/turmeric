...
static int64_t poly_hyshow_un_undict_un1283(int64_t, int64_t);
static int64_t __poly_1287(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1295(int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1283(int64_t __dict_1284, int64_t x) {
        __auto_type __ps_40 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1284)[0])(x));
        if (tur_panicking) return (int64_t){0};
        return (int64_t)(intptr_t)__ps_40;
}

static int64_t __poly_1287(void * __poly_env_1288, int64_t __poly_x0_1290, int64_t __poly_x1_1292) {
        __auto_type __ps_41 = (poly_hyshow_un_undict_un1283(__poly_x0_1290, __poly_x1_1292));
        if (tur_panicking) return (int64_t){0};
        return __ps_41;
}

static int64_t poly_hyrank_un_undict_un1295(int64_t __dict_1296, int64_t x) {
        __auto_type __ps_42 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1296)[0])(x));
        if (tur_panicking) return (int64_t){0};
...
static int64_t __poly_1299(void * __poly_env_1300, int64_t __poly_x0_1302, int64_t __poly_x1_1304) {
        __auto_type __ps_43 = (poly_hyrank_un_undict_un1295(__poly_x0_1302, __poly_x1_1304));
        if (tur_panicking) return (int64_t){0};
        return __ps_43;
}
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t168;
        {
            ...
            {
                __auto_type __ps_170 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1200));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1201 = __ps_170;
                (void)_un_unv_1201;
...
static int64_t poly_hyrank(int64_t x) {
        __auto_type __ps_182 = (__inst_Rank_rank_int(x));
        if (tur_panicking) return (int64_t){0};
        return __ps_182;
}

static const char * use_hyshow(tur_poly_fn_t f) {
        __auto_type __ps_183 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)(INT64_C(7))))));
        if (tur_panicking) return (const char *){0};
        puts(__ps_183);
        __auto_type __ps_184 = (((const char *)(intptr_t)(((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)(true)))));
        if (tur_panicking) return (const char *){0};
        puts(__ps_184);
        const char * __t185;
        __t185 = "shown";
...
static int64_t use_hyrank(tur_poly_fn_t f) {
        __auto_type __ps_186 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_int_singleton))), (int64_t)(INT64_C(7))));
        if (tur_panicking) return (int64_t){0};
        __auto_type __ps_187 = (((int64_t(*)(void*, int64_t, int64_t))f.fn)(f.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Rank_bool_singleton))), (int64_t)(true)));
        if (tur_panicking) return (int64_t){0};
        return (__ps_186) + (__ps_187);
}
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_188 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1287 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_188);
        __auto_type __ps_189 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1299 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        int64_t __t190;
        __t190 = INT64_C(0);
