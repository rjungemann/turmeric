...
static int64_t poly_hyshow_un_undict_un1295(int64_t __dict_1296, int64_t x) {
        __auto_type __ps_42 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1296)[0])(x));
...
static int64_t __poly_1299(void * __poly_env_1300, int64_t __poly_x0_1302, int64_t __poly_x1_1304) {
        __auto_type __ps_43 = (poly_hyshow_un_undict_un1295(__poly_x0_1302, __poly_x1_1304));
        if (tur_panicking) return (int64_t){0};
        return __ps_43;
}

static int64_t poly_hyrank_un_undict_un1307(int64_t __dict_1308, int64_t x) {
        __auto_type __ps_44 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1308)[0])(x));
        if (tur_panicking) return (int64_t){0};
...
static int64_t __poly_1311(void * __poly_env_1312, int64_t __poly_x0_1314, int64_t __poly_x1_1316) {
        __auto_type __ps_45 = (poly_hyrank_un_undict_un1307(__poly_x0_1314, __poly_x1_1316));
        if (tur_panicking) return (int64_t){0};
        return __ps_45;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_166 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1299 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_166);
        __auto_type __ps_167 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1311 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_167));
        int64_t __t168;
        __t168 = INT64_C(0);
