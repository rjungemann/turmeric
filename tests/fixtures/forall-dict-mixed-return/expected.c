...
static int64_t poly_hyshow_un_undict_un1280(int64_t, int64_t);
static int64_t __poly_1284(void *, int64_t, int64_t);
static int64_t poly_hyrank_un_undict_un1292(int64_t, int64_t);
static int64_t __poly_1296(void *, int64_t, int64_t);
...
static int64_t poly_hyshow_un_undict_un1280(int64_t __dict_1281, int64_t x) {
        __auto_type __ps_43 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1281)[0])(x));
        if (tur_panicking) return (int64_t){0};
        return (int64_t)(intptr_t)__ps_43;
}

static int64_t __poly_1284(void * __poly_env_1285, int64_t __poly_x0_1287, int64_t __poly_x1_1289) {
        __auto_type __ps_44 = (poly_hyshow_un_undict_un1280(__poly_x0_1287, __poly_x1_1289));
        if (tur_panicking) return (int64_t){0};
        return __ps_44;
}

static int64_t poly_hyrank_un_undict_un1292(int64_t __dict_1293, int64_t x) {
        __auto_type __ps_45 = (((int64_t (*)(int64_t))((void **)(intptr_t)__dict_1293)[0])(x));
        if (tur_panicking) return (int64_t){0};
        return (int64_t)(intptr_t)__ps_45;
}

static int64_t __poly_1296(void * __poly_env_1297, int64_t __poly_x0_1299, int64_t __poly_x1_1301) {
        __auto_type __ps_46 = (poly_hyrank_un_undict_un1292(__poly_x0_1299, __poly_x1_1301));
        if (tur_panicking) return (int64_t){0};
        return __ps_46;
}
        ...
        if (__ps_137) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1064 = __ps_138;
                (void)h_1064;
                __auto_type __ps_139 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1065 = __ps_139;
                (void)k_1065;
                __auto_type __ps_140 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1064, (void *)(intptr_t)(k_1065), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_140) {
                    void * __t141 = iter;
                    void * __t142 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t144;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1068 = __ps_146;
            (void)iter_1068;
            __auto_type __ps_147 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_148 = (hamt_slkeyeq((void *)(intptr_t)(__ps_147)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1069 = __ps_148;
            (void)keyeq_1069;
            __auto_type __ps_149 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_150 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1068), (void *)(intptr_t)(__ps_149), (void *)(intptr_t)(keyeq_1069)));
            if (tur_panicking) return (bool){0};
            bool result_1070 = __ps_150;
            (void)result_1070;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t177;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1247 = __ps_178;
            (void)r_1247;
            int64_t __t179;
            __auto_type __ps_180 = (schema_hydecode_hyok_qu(r_1247));
            if (tur_panicking) return (int64_t){0};
            if (__ps_180) {
                __auto_type __ps_181 = (schema_hydecode_hyvalue(r_1247));
                if (tur_panicking) return (int64_t){0};
                __t179 = __ps_181;
            } else {
                __auto_type __ps_182 = (schema_hydecode_hyerrors(r_1247));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_192 = (use_hyshow((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1284 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_192);
        __auto_type __ps_193 = (use_hyrank((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1296 }));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_193));
        int64_t __t194;
        __t194 = INT64_C(0);
