...
static void * ValidationError_(const char *, const char *);
static const char * ValidationError_message(void *);
static const char * ValidationError_field(void *);
static void ValidationError_free(void *);
static void * NotFoundError_(const char *);
static const char * NotFoundError_what(void *);
static void NotFoundError_free(void *);
static void * PermissionError_(const char *, const char *);
static const char * PermissionError_message(void *);
static const char * PermissionError_path(void *);
static void PermissionError_free(void *);
...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_446));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_466));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_493));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_513), (int64_t)(intptr_t)(__fn_517));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_533), (int64_t)(intptr_t)(__fn_537));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_553));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_624));
}
...
static void * ValidationError_(const char * message, const char * field) {
...
static const char * ValidationError_message(void * err) {
        typedef struct { const char *message; const char *field; } ValidationError;
...
static const char * ValidationError_field(void * err) {
        typedef struct { const char *message; const char *field; } ValidationError;
  ValidationError *e = (ValidationError*)err;
...
static void ValidationError_free(void * err) {
        free(err);
  
}

static void * NotFoundError_(const char * what) {
...
static const char * NotFoundError_what(void * err) {
        typedef struct { const char *what; } NotFoundError;
...
static void NotFoundError_free(void * err) {
        free(err);
  
}

static void * PermissionError_(const char * message, const char * path) {
...
static const char * PermissionError_message(void * err) {
        typedef struct { const char *message; const char *path; } PermissionError;
...
static const char * PermissionError_path(void * err) {
        typedef struct { const char *message; const char *path; } PermissionError;
  PermissionError *e = (PermissionError*)err;
...
static void PermissionError_free(void * err) {
        free(err);
...
int main() {
        {
            void * ve_640 = ValidationError_("must be positive", "age");
            (void)ve_640;
            puts(ValidationError_message((void *)(intptr_t)(ve_640)));
            puts(ValidationError_field((void *)(intptr_t)(ve_640)));
            ValidationError_free((void *)(intptr_t)(ve_640));
        }
        {
            void * ne_641 = NotFoundError_("config.toml");
            (void)ne_641;
            puts(NotFoundError_what((void *)(intptr_t)(ne_641)));
            NotFoundError_free((void *)(intptr_t)(ne_641));
        }
        {
            void * pe_642 = PermissionError_("read denied", "/etc/shadow");
            (void)pe_642;
            puts(PermissionError_message((void *)(intptr_t)(pe_642)));
            puts(PermissionError_path((void *)(intptr_t)(pe_642)));
            PermissionError_free((void *)(intptr_t)(pe_642));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
