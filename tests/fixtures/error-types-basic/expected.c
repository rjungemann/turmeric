...
int main() {
        {
            ...
            (void)ve_45;
            puts(ValidationError_message(ve_45));
            puts(ValidationError_field(ve_45));
            ValidationError_free(ve_45);
        }
        {
            void * ne_46 = NotFoundError_("config.toml");
            (void)ne_46;
            puts(NotFoundError_what(ne_46));
            NotFoundError_free(ne_46);
        }
        {
            void * pe_47 = PermissionError_("read denied", "/etc/shadow");
            (void)pe_47;
            puts(PermissionError_message(pe_47));
            puts(PermissionError_path(pe_47));
            PermissionError_free(pe_47);
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
