...
int main() {
        {
            void * ve_220 = ValidationError_("must be positive", "age");
            (void)ve_220;
            puts(ValidationError_message((void *)(intptr_t)(ve_220)));
            puts(ValidationError_field((void *)(intptr_t)(ve_220)));
            ValidationError_free((void *)(intptr_t)(ve_220));
        }
        {
            void * ne_221 = NotFoundError_("config.toml");
            (void)ne_221;
            puts(NotFoundError_what((void *)(intptr_t)(ne_221)));
            NotFoundError_free((void *)(intptr_t)(ne_221));
        }
        {
            void * pe_222 = PermissionError_("read denied", "/etc/shadow");
            (void)pe_222;
            puts(PermissionError_message((void *)(intptr_t)(pe_222)));
            puts(PermissionError_path((void *)(intptr_t)(pe_222)));
            PermissionError_free((void *)(intptr_t)(pe_222));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
