...
int main() {
        {
            void * ve_45 = ValidationError_("must be positive", "age");
            (void)ve_45;
            puts(ValidationError_message((void *)(intptr_t)(ve_45)));
            puts(ValidationError_field((void *)(intptr_t)(ve_45)));
            ValidationError_free((void *)(intptr_t)(ve_45));
        }
        {
            void * ne_46 = NotFoundError_("config.toml");
            (void)ne_46;
            puts(NotFoundError_what((void *)(intptr_t)(ne_46)));
            NotFoundError_free((void *)(intptr_t)(ne_46));
        }
        {
            void * pe_47 = PermissionError_("read denied", "/etc/shadow");
            (void)pe_47;
            puts(PermissionError_message((void *)(intptr_t)(pe_47)));
            puts(PermissionError_path((void *)(intptr_t)(pe_47)));
            PermissionError_free((void *)(intptr_t)(pe_47));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
