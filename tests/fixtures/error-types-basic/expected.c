...
int main() {
        {
            void * ve_285 = ValidationError_("must be positive", "age");
            (void)ve_285;
            puts(ValidationError_message((void *)(intptr_t)(ve_285)));
            puts(ValidationError_field((void *)(intptr_t)(ve_285)));
            ValidationError_free((void *)(intptr_t)(ve_285));
        }
        {
            void * ne_286 = NotFoundError_("config.toml");
            (void)ne_286;
            puts(NotFoundError_what((void *)(intptr_t)(ne_286)));
            NotFoundError_free((void *)(intptr_t)(ne_286));
        }
        {
            void * pe_287 = PermissionError_("read denied", "/etc/shadow");
            (void)pe_287;
            puts(PermissionError_message((void *)(intptr_t)(pe_287)));
            puts(PermissionError_path((void *)(intptr_t)(pe_287)));
            PermissionError_free((void *)(intptr_t)(pe_287));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
