...
int main() {
        {
            void * ve_232 = ValidationError_("must be positive", "age");
            (void)ve_232;
            puts(ValidationError_message((void *)(intptr_t)(ve_232)));
            puts(ValidationError_field((void *)(intptr_t)(ve_232)));
            ValidationError_free((void *)(intptr_t)(ve_232));
        }
        {
            void * ne_233 = NotFoundError_("config.toml");
            (void)ne_233;
            puts(NotFoundError_what((void *)(intptr_t)(ne_233)));
            NotFoundError_free((void *)(intptr_t)(ne_233));
        }
        {
            void * pe_234 = PermissionError_("read denied", "/etc/shadow");
            (void)pe_234;
            puts(PermissionError_message((void *)(intptr_t)(pe_234)));
            puts(PermissionError_path((void *)(intptr_t)(pe_234)));
            PermissionError_free((void *)(intptr_t)(pe_234));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
