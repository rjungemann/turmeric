...
int main() {
        int64_t __t0;
        {
            ...
            *__t3 = INT64_C(2);
            ...
            __t4->value = __t3;
            RcControlBlock * y_262 = __t4;
            (void)y_262;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            {
                /* rc-elision: skipped rc_strong_increment(x_261) — last-use clone */
                RcControlBlock * z_263 = x_261;
                (void)z_263;
                /* rc-elision: skipped rc_strong_decrement(z_263) — matched elided clone */
            }
            struct __defer_env_6 __t8 = {.x = x_261};
            tur_frame_push_defer(&__frame_5, __defer_7, &__t8);
            struct __defer_env_9 __t11 = {.y = y_262};
