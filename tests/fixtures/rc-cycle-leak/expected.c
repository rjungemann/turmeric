...
int main() {
        int64_t __t0;
        {
            ...
            *__t3 = INT64_C(2);
            ...
            __t4->value = __t3;
            RcControlBlock * y_617 = __t4;
            (void)y_617;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            {
                /* rc-elision: skipped rc_strong_increment(x_616) — last-use clone */
                RcControlBlock * z_618 = x_616;
                (void)z_618;
                /* rc-elision: skipped rc_strong_decrement(z_618) — matched elided clone */
            }
            struct __defer_env_6 __t8 = {.x = x_616};
            tur_frame_push_defer(&__frame_5, __defer_7, &__t8);
            struct __defer_env_9 __t11 = {.y = y_617};
