...
int main() {
        int64_t __t0;
        {
            ...
            *__t3 = INT64_C(2);
            ...
            __t4->value = __t3;
            RcControlBlock * y_197 = __t4;
            (void)y_197;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            {
                /* rc-elision: skipped rc_strong_increment(x_196) — last-use clone */
                RcControlBlock * z_198 = x_196;
                (void)z_198;
                /* rc-elision: skipped rc_strong_decrement(z_198) — matched elided clone */
            }
            struct __defer_env_6 __t8 = {.x = x_196};
            tur_frame_push_defer(&__frame_5, __defer_7, &__t8);
            struct __defer_env_9 __t11 = {.y = y_197};
