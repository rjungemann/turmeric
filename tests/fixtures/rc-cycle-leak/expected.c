...
int main() {
        int64_t __t0;
        {
            ...
            *__t3 = INT64_C(2);
            ...
            __t4->value = __t3;
            RcControlBlock * y_2 = __t4;
            (void)y_2;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            {
                /* rc-elision: skipped rc_strong_increment(x_1) — last-use clone */
                RcControlBlock * z_3 = x_1;
                (void)z_3;
                /* rc-elision: skipped rc_strong_decrement(z_3) — matched elided clone */
            }
            struct __defer_env_6 __t8 = {.x = x_1};
            tur_frame_push_defer(&__frame_5, __defer_7, &__t8);
            struct __defer_env_9 __t11 = {.y = y_2};
