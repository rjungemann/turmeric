...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_70 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_741, (void *)(intptr_t)(k_742), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t72;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_746 = __ps_74;
            (void)iter_746;
            __auto_type __ps_75 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_76 = (hamt_slkeyeq((void *)(intptr_t)(__ps_75)));
            if (tur_panicking) return (bool){0};
            void * keyeq_747 = __ps_76;
            (void)keyeq_747;
            __auto_type __ps_77 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_78 = (map_hyeq_hyloop((void *)(intptr_t)(iter_746), (void *)(intptr_t)(__ps_77), (void *)(intptr_t)(keyeq_747), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_748 = __ps_78;
            (void)result_748;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_96) {
            bool __t97;
            {
                ...
                bool __t98;
                if ((t1_988) == (INT64_C(0))) {
                    __t98 = (t2_989) == (INT64_C(0));
                } else {
                    bool __t99;
                    if ((t2_989) == (INT64_C(0))) {
                        __t99 = false;
                    } else {
                        __auto_type __ps_100 = (cons_hyeq_hygo(t1_988, t2_989));
                        if (tur_panicking) return (bool){0};
                        __t99 = __ps_100;
                    }
                    __t98 = __t99;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_106) {
            ...
            int64_t __t107;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1004 = (int64_t)(intptr_t)(__ps_111);
                (void)out_1004;
                __t107 = out_1004;
            }
            __t105 = __t107;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t116;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1079 = __ps_118;
            (void)iter_1079;
            __auto_type __ps_119 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_120 = (hamt_slkeyeq((void *)(intptr_t)(__ps_119)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1080 = __ps_120;
            (void)keyeq_1080;
            __auto_type __ps_121 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_122 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1079), (void *)(intptr_t)(__ps_121), (void *)(intptr_t)(keyeq_1080)));
            if (tur_panicking) return (bool){0};
            bool result_1081 = __ps_122;
            (void)result_1081;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t143;
        {
            ...
            {
                __auto_type __ps_145 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1208));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1209 = __ps_145;
                (void)_un_unv_1209;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t148;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1258 = __ps_149;
            (void)r_1258;
            int64_t __t150;
            __auto_type __ps_151 = (schema_hydecode_hyok_qu(r_1258));
            if (tur_panicking) return (int64_t){0};
            if (__ps_151) {
                __auto_type __ps_152 = (schema_hydecode_hyvalue(r_1258));
                if (tur_panicking) return (int64_t){0};
                __t150 = __ps_152;
            } else {
                __auto_type __ps_153 = (schema_hydecode_hyerrors(r_1258));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t156;
        {
            __auto_type __ps_157 = (__fn_1281(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t156 = __ps_157;
        }
        return (int)__t156;
