...
static int64_t __fn_1608(int64_t);
...
static int64_t __fn_1608(int64_t x) {
        __tur_tailcall:;
        if ((x) == (INT64_C(0))) {
            return INT64_C(0);
        } else {
            printf("%lld\n", (long long)(x));
            int64_t __t128 = (x) - (INT64_C(1));
            x = __t128;
            goto __tur_tailcall;
        }
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_994 = __ps_165;
        bool __ps_166 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_993, (void *)(intptr_t)(k_994), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_166;
        if (__t1) {
            int64_t __ps_167 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_168 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_993, (void *)(intptr_t)(k_994), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t170;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_998 = __ps_172;
            (void)iter_998;
            void * __ps_173 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_174 = (hamt_slkeyeq((void *)(intptr_t)(__ps_173)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_999 = __ps_174;
            (void)keyeq_999;
            void * __ps_175 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_176 = (map_hyeq_hyloop((void *)(intptr_t)(iter_998), (void *)(intptr_t)(__ps_175), (void *)(intptr_t)(keyeq_999), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1000 = __ps_176;
            (void)result_1000;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_195) {
            bool __t196;
            {
                ...
                (void)t2_1279;
                bool __t197;
                bool __ps_198 = (tnil_qu(t1_1278));
                if (tur_panicking) return ((bool)0);
                if (__ps_198) {
                    bool __ps_199 = (tnil_qu(t2_1279));
                    if (tur_panicking) return ((bool)0);
                    __t197 = __ps_199;
                } else {
                    bool __t200;
                    bool __ps_201 = (tnil_qu(t2_1279));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_201) {
                        __t200 = false;
                    } else {
                        bool __ps_202 = (cons_hyeq_hygo(t1_1278, t2_1279));
                        if (tur_panicking) return ((bool)0);
                        __t200 = __ps_202;
                    }
                    __t197 = __t200;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_208) {
            ...
            int64_t __t209;
            {
                ...
                int64_t out_1294 = (int64_t)(intptr_t)(__ps_213);
                (void)out_1294;
                __t209 = out_1294;
            }
            __t207 = __t209;
        ...
        if (__ps_217) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1365 = __ps_218;
                (void)h_1365;
                void * __ps_219 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1366 = __ps_219;
                (void)k_1366;
                bool __ps_220 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1365, (void *)(intptr_t)(k_1366), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_220) {
                    void * __t221 = iter;
                    void * __t222 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t224;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1369 = __ps_226;
            (void)iter_1369;
            void * __ps_227 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_228 = (hamt_slkeyeq((void *)(intptr_t)(__ps_227)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1370 = __ps_228;
            (void)keyeq_1370;
            void * __ps_229 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_230 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1369), (void *)(intptr_t)(__ps_229), (void *)(intptr_t)(keyeq_1370)));
            if (tur_panicking) return ((bool)0);
            bool result_1371 = __ps_230;
            (void)result_1371;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t251;
        {
            ...
            {
                tur_adt_Vec__int * __ps_253 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1501));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1502 = __ps_253;
                (void)_un_unv_1502;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t257;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1552 = __ps_258;
            (void)r_1552;
            int64_t __t259;
            bool __ps_260 = (schema_hydecode_hyok_qu(r_1552));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_260) {
                int64_t __ps_261 = (schema_hydecode_hyvalue(r_1552));
                if (tur_panicking) return ((int64_t)0);
                __t259 = __ps_261;
            } else {
                int64_t __ps_262 = (schema_hydecode_hyerrors(r_1552));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t265;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1603 = __ps_266;
            (void)m_1603;
            tur_frame __frame_267;
            tur_frame_init(&__frame_267, NULL);
            struct __defer_env_268 __t270 = {.m = m_1603};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t278;
        {
            int64_t __ps_279 = (__fn_1608(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t278 = __ps_279;
        }
        return (int)__t278;
