...
static int64_t __fn_1609(int64_t x) {
        __tur_tailcall:;
        if ((x) == (INT64_C(0))) {
            return INT64_C(0);
        } else {
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_995 = __ps_69;
        bool __ps_70 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_994, (void *)(intptr_t)(k_995), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_70;
        if (__t1) {
            int64_t __ps_71 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_72 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_994, (void *)(intptr_t)(k_995), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t74;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_999 = __ps_76;
            (void)iter_999;
            void * __ps_77 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_78 = (hamt_slkeyeq((void *)(intptr_t)(__ps_77)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1000 = __ps_78;
            (void)keyeq_1000;
            void * __ps_79 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_80 = (map_hyeq_hyloop((void *)(intptr_t)(iter_999), (void *)(intptr_t)(__ps_79), (void *)(intptr_t)(keyeq_1000), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1001 = __ps_80;
            (void)result_1001;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            int64_t __ps_174 = (__fn_1609(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t173 = __ps_174;
        }
        return (int)__t173;
