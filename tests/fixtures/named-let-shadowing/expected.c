...
static int64_t __fn_1263(int64_t);
...
static int64_t __fn_1263(int64_t x) {
        __tur_tailcall:;
        if ((x) == (INT64_C(0))) {
            return INT64_C(0);
        } else {
            printf("%lld\n", (long long)(x));
            int64_t __t19 = (x) - (INT64_C(1));
            x = __t19;
            goto __tur_tailcall;
        }
}
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t49;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1240)) {
                __t50 = schema_hydecode_hyvalue(r_1240);
            } else {
                __t50 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1240));
            }
            __t49 = __t50;
        }
        return __t49;
