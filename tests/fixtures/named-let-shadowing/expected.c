...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_814 = __ps_73;
        bool __ps_74 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_813, (void *)(intptr_t)(k_814), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_74;
        if (__t1) {
        ...
        if (__ps_123) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1185 = __ps_124;
                (void)h_1185;
                void * __ps_125 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1186 = __ps_125;
                (void)k_1186;
                bool __ps_126 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1185, (void *)(intptr_t)(k_1186), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_126) {
                    void * __t127 = iter;
                    void * __t128 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t130;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1189 = __ps_132;
            (void)iter_1189;
            void * __ps_133 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_134 = (hamt_slkeyeq((void *)(intptr_t)(__ps_133)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1190 = __ps_134;
            (void)keyeq_1190;
            void * __ps_135 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_136 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1189), (void *)(intptr_t)(__ps_135), (void *)(intptr_t)(keyeq_1190)));
            if (tur_panicking) return ((bool)0);
            bool result_1191 = __ps_136;
            (void)result_1191;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t157;
        {
            ...
            {
                tur_adt_Vec__int * __ps_159 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1318));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1319 = __ps_159;
                (void)_un_unv_1319;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t163;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1369 = __ps_164;
            (void)r_1369;
            int64_t __t165;
            bool __ps_166 = (schema_hydecode_hyok_qu(r_1369));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_166) {
                int64_t __ps_167 = (schema_hydecode_hyvalue(r_1369));
                if (tur_panicking) return ((int64_t)0);
                __t165 = __ps_167;
            } else {
                int64_t __ps_168 = (schema_hydecode_hyerrors(r_1369));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t180;
        {
            int64_t __ps_181 = (__fn_1434(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t180 = __ps_181;
        }
        return (int)__t180;
