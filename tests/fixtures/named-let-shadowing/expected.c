...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_816 = __ps_75;
        bool __ps_76 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_815, (void *)(intptr_t)(k_816), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_76;
        if (__t1) {
            int64_t __ps_77 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_78 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_815, (void *)(intptr_t)(k_816), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t80;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_820 = __ps_82;
            (void)iter_820;
            void * __ps_83 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_84 = (hamt_slkeyeq((void *)(intptr_t)(__ps_83)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_821 = __ps_84;
            (void)keyeq_821;
            void * __ps_85 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_86 = (map_hyeq_hyloop((void *)(intptr_t)(iter_820), (void *)(intptr_t)(__ps_85), (void *)(intptr_t)(keyeq_821), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_822 = __ps_86;
            (void)result_822;
        ...
        if (__ps_105) {
            bool __t106;
            {
                ...
                if ((t1_1100) == (INT64_C(0))) {
                    __t107 = (t2_1101) == (INT64_C(0));
                } else {
                    bool __t108;
                    if ((t2_1101) == (INT64_C(0))) {
                        __t108 = false;
                    } else {
                        bool __ps_109 = (cons_hyeq_hygo(t1_1100, t2_1101));
                        if (tur_panicking) return ((bool)0);
                        __t108 = __ps_109;
                    }
                    __t107 = __t108;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                int64_t out_1116 = (int64_t)(intptr_t)(__t121);
                (void)out_1116;
                __t116 = out_1116;
            }
            __t114 = __t116;
        ...
        if (__ps_126) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1187 = __ps_127;
                (void)h_1187;
                void * __ps_128 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1188 = __ps_128;
                (void)k_1188;
                bool __ps_129 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1187, (void *)(intptr_t)(k_1188), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_129) {
                    void * __t130 = iter;
                    void * __t131 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t133;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1191 = __ps_135;
            (void)iter_1191;
            void * __ps_136 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_137 = (hamt_slkeyeq((void *)(intptr_t)(__ps_136)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1192 = __ps_137;
            (void)keyeq_1192;
            void * __ps_138 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_139 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1191), (void *)(intptr_t)(__ps_138), (void *)(intptr_t)(keyeq_1192)));
            if (tur_panicking) return ((bool)0);
            bool result_1193 = __ps_139;
            (void)result_1193;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t160;
        {
            ...
            {
                tur_adt_Vec__int * __ps_162 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1321));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1322 = __ps_162;
                (void)_un_unv_1322;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t166;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1372 = __ps_167;
            (void)r_1372;
            int64_t __t168;
            bool __ps_169 = (schema_hydecode_hyok_qu(r_1372));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_169) {
                int64_t __ps_170 = (schema_hydecode_hyvalue(r_1372));
                if (tur_panicking) return ((int64_t)0);
                __t168 = __ps_170;
            } else {
                int64_t __ps_171 = (schema_hydecode_hyerrors(r_1372));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t184;
        {
            int64_t __ps_185 = (__fn_1438(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t184 = __ps_185;
        }
        return (int)__t184;
