...
static int64_t __fn_1272(int64_t);
...
static int64_t __fn_1272__cps(int64_t x_1271, DK *__kont);
...
static int64_t __fn_1272__cps(int64_t x, DK *__kont) {
    bool __t0;
    int64_t __t2;
    int64_t __t1;
    __t0 = (x) == (INT64_C(0));
    if (__t0) {
        ...
        printf("%lld\n", (long long)(x));
        __t2 = 0;
        __auto_type __ps_40 = (__fn_1272((x) - (INT64_C(1))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_40;
        return dk_run(__kont, (intptr_t)(__t1));
    }
}
__attribute__((unused)) static int64_t __fn_1272(int64_t x) {
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = __fn_1272__cps(x, __root);
    dk_free(__root);
    return (int64_t)(__r);
}
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_68) {
            bool __t69;
            {
                ...
                (void)k_738;
                bool __t72;
                __auto_type __ps_73 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_737, (void *)(intptr_t)(k_738), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_73) {
                    bool __t74;
                    __auto_type __ps_75 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_76 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_737, (void *)(intptr_t)(k_738), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_742 = __ps_81;
            (void)iter_742;
            __auto_type __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return (bool){0};
            void * keyeq_743 = __ps_83;
            (void)keyeq_743;
            __auto_type __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_742), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_743), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_744 = __ps_85;
            (void)result_744;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_103) {
            bool __t104;
            {
                ...
                bool __t105;
                if ((t1_979) == (INT64_C(0))) {
                    __t105 = (t2_980) == (INT64_C(0));
                } else {
                    bool __t106;
                    if ((t2_980) == (INT64_C(0))) {
                        __t106 = false;
                    } else {
                        __auto_type __ps_107 = (cons_hyeq_hygo(t1_979, t2_980));
                        if (tur_panicking) return (bool){0};
                        __t106 = __ps_107;
                    }
                    __t105 = __t106;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_109) {
            ...
            int64_t __t110;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_988 = (int64_t)(intptr_t)(__ps_115);
                (void)out_988;
                __t110 = out_988;
            }
            __t108 = __t110;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_117) {
            ...
            int64_t __t118;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_995 = (int64_t)(intptr_t)(__ps_122);
                (void)out_995;
                __t118 = out_995;
            }
            __t116 = __t118;
        ...
        if (__ps_127) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1066 = __ps_128;
                (void)h_1066;
                __auto_type __ps_129 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1067 = __ps_129;
                (void)k_1067;
                __auto_type __ps_130 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1066, (void *)(intptr_t)(k_1067), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_130) {
                    void * __t131 = iter;
                    void * __t132 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t134;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1070 = __ps_136;
            (void)iter_1070;
            __auto_type __ps_137 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_138 = (hamt_slkeyeq((void *)(intptr_t)(__ps_137)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1071 = __ps_138;
            (void)keyeq_1071;
            __auto_type __ps_139 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_140 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1070), (void *)(intptr_t)(__ps_139), (void *)(intptr_t)(keyeq_1071)));
            if (tur_panicking) return (bool){0};
            bool result_1072 = __ps_140;
            (void)result_1072;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t161;
        {
            ...
            {
                __auto_type __ps_163 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1199));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1200 = __ps_163;
                (void)_un_unv_1200;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t166;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1249 = __ps_167;
            (void)r_1249;
            int64_t __t168;
            __auto_type __ps_169 = (schema_hydecode_hyok_qu(r_1249));
            if (tur_panicking) return (int64_t){0};
            if (__ps_169) {
                __auto_type __ps_170 = (schema_hydecode_hyvalue(r_1249));
                if (tur_panicking) return (int64_t){0};
                __t168 = __ps_170;
            } else {
                __auto_type __ps_171 = (schema_hydecode_hyerrors(r_1249));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        int64_t __t174;
        {
            __auto_type __ps_175 = (__fn_1272(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t174 = __ps_175;
        }
        return (int)__t174;
