...
static int64_t __fn_1271(int64_t);
...
static int64_t __fn_1271(int64_t x) {
        __tur_tailcall:;
        if ((x) == (INT64_C(0))) {
            return INT64_C(0);
        } else {
        ...
        if (__ps_134) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1066 = __ps_135;
                (void)h_1066;
                __auto_type __ps_136 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1067 = __ps_136;
                (void)k_1067;
                __auto_type __ps_137 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1066, (void *)(intptr_t)(k_1067), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_137) {
                    void * __t138 = iter;
                    void * __t139 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t141;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1070 = __ps_143;
            (void)iter_1070;
            __auto_type __ps_144 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_145 = (hamt_slkeyeq((void *)(intptr_t)(__ps_144)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1071 = __ps_145;
            (void)keyeq_1071;
            __auto_type __ps_146 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_147 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1070), (void *)(intptr_t)(__ps_146), (void *)(intptr_t)(keyeq_1071)));
            if (tur_panicking) return (bool){0};
            bool result_1072 = __ps_147;
            (void)result_1072;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t174;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1248 = __ps_175;
            (void)r_1248;
            int64_t __t176;
            __auto_type __ps_177 = (schema_hydecode_hyok_qu(r_1248));
            if (tur_panicking) return (int64_t){0};
            if (__ps_177) {
                __auto_type __ps_178 = (schema_hydecode_hyvalue(r_1248));
                if (tur_panicking) return (int64_t){0};
                __t176 = __ps_178;
            } else {
                __auto_type __ps_179 = (schema_hydecode_hyerrors(r_1248));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        int64_t __t182;
        {
            __auto_type __ps_183 = (__fn_1271(INT64_C(3)));
