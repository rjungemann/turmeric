...
static int64_t __fn_1245(int64_t);
...
static int64_t __fn_1245(int64_t x) {
        __tur_tailcall:;
        if ((x) == (INT64_C(0))) {
            return INT64_C(0);
        } else {
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t49;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1222)) {
                __t50 = schema_hydecode_hyvalue(r_1222);
            } else {
                __t50 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1222));
            }
            __t49 = __t50;
        }
        return __t49;
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t52 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t52 = (Cons__int){.head = h, .tail = t};
        return __t52;
}
