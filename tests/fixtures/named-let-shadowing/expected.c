...
static int64_t __fn_1302(int64_t);
...
static int64_t __fn_1302__cps(int64_t x_1301, DK *__kont);
...
static int64_t __fn_1302__cps(int64_t x, DK *__kont) {
    int64_t __t0;
    int64_t __t42;
    if ((x) == (INT64_C(0))) {
        __t42 = INT64_C(0);
        ...
        printf("%lld\n", (long long)(x));
        int64_t __t43;
        int64_t __ps_44 = (__fn_1302((x) - (INT64_C(1))));
...
__attribute__((unused)) static int64_t __fn_1302(int64_t x) {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = __fn_1302__cps(x, __root); }
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_72 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_761, (void *)(intptr_t)(k_762), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t74;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_766 = __ps_76;
            (void)iter_766;
            void * __ps_77 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_78 = (hamt_slkeyeq((void *)(intptr_t)(__ps_77)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_767 = __ps_78;
            (void)keyeq_767;
            void * __ps_79 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_80 = (map_hyeq_hyloop((void *)(intptr_t)(iter_766), (void *)(intptr_t)(__ps_79), (void *)(intptr_t)(keyeq_767), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_768 = __ps_80;
            (void)result_768;
...
static int64_t none() {
        int64_t __ps_88 = (ctor_Option(false, ((int64_t)0)));
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                if ((t1_1009) == (INT64_C(0))) {
                    __t100 = (t2_1010) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_1010) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        bool __ps_102 = (cons_hyeq_hygo(t1_1009, t2_1010));
                        if (tur_panicking) return ((bool)0);
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1025 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1025;
                __t109 = out_1025;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1100 = __ps_120;
            (void)iter_1100;
            void * __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1101 = __ps_122;
            (void)keyeq_1101;
            void * __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1100), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1101)));
            if (tur_panicking) return ((bool)0);
            bool result_1102 = __ps_124;
            (void)result_1102;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                tur_adt_Vec__int * __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1229));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1230 = __ps_147;
                (void)_un_unv_1230;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t150;
        {
            int64_t __ps_151 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1279 = __ps_151;
            (void)r_1279;
            int64_t __t152;
            bool __ps_153 = (schema_hydecode_hyok_qu(r_1279));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_153) {
                int64_t __ps_154 = (schema_hydecode_hyvalue(r_1279));
                if (tur_panicking) return ((int64_t)0);
                __t152 = __ps_154;
            } else {
                int64_t __ps_155 = (schema_hydecode_hyerrors(r_1279));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_156 = (schema_hydecode_hyabort(__ps_155));
                if (tur_panicking) return ((int64_t)0);
                __t152 = __ps_156;
            }
            __t150 = __t152;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_157 = (((int64_t (*)(int64_t))(intptr_t)f)(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_157;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t158;
        {
            int64_t __ps_159 = (__fn_1302(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t158 = __ps_159;
        }
        return (int)__t158;
