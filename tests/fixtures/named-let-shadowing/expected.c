...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_76 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_813, (void *)(intptr_t)(k_814), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t78;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_818 = __ps_80;
            (void)iter_818;
            void * __ps_81 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_82 = (hamt_slkeyeq((void *)(intptr_t)(__ps_81)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_819 = __ps_82;
            (void)keyeq_819;
            void * __ps_83 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_84 = (map_hyeq_hyloop((void *)(intptr_t)(iter_818), (void *)(intptr_t)(__ps_83), (void *)(intptr_t)(keyeq_819), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_820 = __ps_84;
            (void)result_820;
        ...
        if (__ps_103) {
            bool __t104;
            {
                ...
                if ((t1_1098) == (INT64_C(0))) {
                    __t105 = (t2_1099) == (INT64_C(0));
                } else {
                    bool __t106;
                    if ((t2_1099) == (INT64_C(0))) {
                        __t106 = false;
                    } else {
                        bool __ps_107 = (cons_hyeq_hygo(t1_1098, t2_1099));
                        if (tur_panicking) return ((bool)0);
                        __t106 = __ps_107;
                    }
                    __t105 = __t106;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1114 = (int64_t)(intptr_t)(__ps_118);
                (void)out_1114;
                __t114 = out_1114;
            }
            __t112 = __t114;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1189 = __ps_125;
            (void)iter_1189;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1190 = __ps_127;
            (void)keyeq_1190;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1189), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1190)));
            if (tur_panicking) return ((bool)0);
            bool result_1191 = __ps_129;
            (void)result_1191;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1318));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1319 = __ps_152;
                (void)_un_unv_1319;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t156;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1369 = __ps_157;
            (void)r_1369;
            int64_t __t158;
            bool __ps_159 = (schema_hydecode_hyok_qu(r_1369));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_159) {
                int64_t __ps_160 = (schema_hydecode_hyvalue(r_1369));
                if (tur_panicking) return ((int64_t)0);
                __t158 = __ps_160;
            } else {
                int64_t __ps_161 = (schema_hydecode_hyerrors(r_1369));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            int64_t __ps_174 = (__fn_1434(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t173 = __ps_174;
        }
        return (int)__t173;
