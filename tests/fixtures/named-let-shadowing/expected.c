        ...
        if (__ps_195) {
            bool __t196;
            {
                ...
                if ((t1_1278) == (INT64_C(0))) {
                    __t197 = (t2_1279) == (INT64_C(0));
                } else {
                    bool __t198;
                    if ((t2_1279) == (INT64_C(0))) {
                        __t198 = false;
                    } else {
                        bool __ps_199 = (cons_hyeq_hygo(t1_1278, t2_1279));
                        if (tur_panicking) return ((bool)0);
                        __t198 = __ps_199;
                    }
                    __t197 = __t198;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_205) {
            ...
            int64_t __t206;
            {
                ...
                int64_t out_1294 = (int64_t)(intptr_t)(__ps_210);
                (void)out_1294;
                __t206 = out_1294;
            }
            __t204 = __t206;
        ...
        if (__ps_215) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1365 = __ps_216;
                (void)h_1365;
                void * __ps_217 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1366 = __ps_217;
                (void)k_1366;
                bool __ps_218 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1365, (void *)(intptr_t)(k_1366), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_218) {
                    void * __t219 = iter;
                    void * __t220 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t222;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1369 = __ps_224;
            (void)iter_1369;
            void * __ps_225 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_226 = (hamt_slkeyeq((void *)(intptr_t)(__ps_225)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1370 = __ps_226;
            (void)keyeq_1370;
            void * __ps_227 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_228 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1369), (void *)(intptr_t)(__ps_227), (void *)(intptr_t)(keyeq_1370)));
            if (tur_panicking) return ((bool)0);
            bool result_1371 = __ps_228;
            (void)result_1371;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t249;
        {
            ...
            {
                tur_adt_Vec__int * __ps_251 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1501));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1502 = __ps_251;
                (void)_un_unv_1502;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t255;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1552 = __ps_256;
            (void)r_1552;
            int64_t __t257;
            bool __ps_258 = (schema_hydecode_hyok_qu(r_1552));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_258) {
                int64_t __ps_259 = (schema_hydecode_hyvalue(r_1552));
                if (tur_panicking) return ((int64_t)0);
                __t257 = __ps_259;
            } else {
                int64_t __ps_260 = (schema_hydecode_hyerrors(r_1552));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t263;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1603 = __ps_264;
            (void)m_1603;
            tur_frame __frame_265;
            tur_frame_init(&__frame_265, NULL);
            struct __defer_env_266 __t268 = {.m = m_1603};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t276;
        {
            int64_t __ps_277 = (__fn_1608(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t276 = __ps_277;
        }
        return (int)__t276;
