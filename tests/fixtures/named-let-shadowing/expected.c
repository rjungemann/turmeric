...
static int64_t __fn_1248(int64_t);
...
static int64_t __fn_1248(int64_t x) {
        __tur_tailcall:;
        if ((x) == (INT64_C(0))) {
            return INT64_C(0);
        } else {
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(c1))->head, ((Cons *)(intptr_t)(c2))->head)) {
            bool __t33;
            {
                ...
                bool __t34;
                if ((t1_965) == (INT64_C(0))) {
                    __t34 = (t2_966) == (INT64_C(0));
                } else {
                    bool __t35;
                    if ((t2_966) == (INT64_C(0))) {
                        __t35 = false;
                    } else {
                        __t35 = cons_hyeq_hygo(t1_965, t2_966);
                    }
                    __t34 = __t35;
                }
                __t33 = __t34;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t54;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1225)) {
                __t55 = schema_hydecode_hyvalue(r_1225);
            } else {
                __t55 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1225));
            }
            __t54 = __t55;
        }
        return __t54;
