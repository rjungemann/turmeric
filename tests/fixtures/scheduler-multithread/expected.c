...
int main() {
        int64_t __t0;
        {
            void * sched_249 = scheduler_mt_new(INT64_C(2));
            (void)sched_249;
            {
                void * fa_250 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_250;
                {
                    void * fb_251 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_251;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_249), (void *)(intptr_t)(fa_250));
                    scheduler_mt_spawn((void *)(intptr_t)(sched_249), (void *)(intptr_t)(fb_251));
                    (void)(thread_sleep(INT64_C(100)));
                    scheduler_mt_free((void *)(intptr_t)(sched_249));
                    fiber_free((void *)(intptr_t)(fa_250));
                    fiber_free((void *)(intptr_t)(fb_251));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
