...
static bool __inst_Eq_eq_qu_Tuple2(int64_t x, int64_t y) {
        return tuple2_hyeq_hycarrier_qu(x, y, (int64_t)(intptr_t)(__fn_814), (int64_t)(intptr_t)(__fn_818));
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            void * sched_942 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_942;
            {
                int64_t fa_943 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_943;
                {
                    int64_t fb_944 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_944;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_942), fa_943);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_942), fb_944);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_942));
                    fiber_hyfree(fa_943);
                    fiber_hyfree(fb_944);
                }
            }
