...
static void scheduler_unpark_(int64_t);
...
static int64_t fiber_done_(int64_t f) {
...
static void fiber_local_set_(int64_t f, int64_t key, int64_t value) {
...
static void scheduler_unpark_(int64_t f) {
