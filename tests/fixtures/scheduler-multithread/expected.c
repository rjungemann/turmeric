...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_996;
        void *__t15 = __t14;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_1124;
            void *__t18 = __t17;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            int64_t __t31;
            {
                int64_t out_1000 = (int64_t)(intptr_t)(tcons__spec__Cons__int___int64_t_int64_t((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f))));
                (void)out_1000;
                __t31 = out_1000;
            }
            __t30 = __t31;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            int64_t __t33;
            {
                int64_t out_1007 = (int64_t)(intptr_t)(tcons__spec__Cons__int___int64_t_int64_t(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2)));
                (void)out_1007;
                __t33 = out_1007;
            }
            __t32 = __t33;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        int64_t __t44;
        {
            int64_t _un_unv_1203 = vec_hynew();
            (void)_un_unv_1203;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t48;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1251)) {
                __t49 = schema_hydecode_hyvalue(r_1251);
            } else {
                __t49 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1251));
            }
            __t48 = __t49;
        }
        return __t48;
...
int main(int argc, char **argv) {
        ...
        int64_t __t50;
        {
            void * sched_1297 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_1297;
            {
                int64_t fa_1298 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_1298;
                {
                    int64_t fb_1299 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_1299;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_1297), fa_1298);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_1297), fb_1299);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_1297));
                    fiber_hyfree(fa_1298);
                    fiber_hyfree(fb_1299);
                }
            }
            int64_t __t51;
            __t51 = INT64_C(0);
