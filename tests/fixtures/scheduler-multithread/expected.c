...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t254;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1492 = __ps_256;
            (void)r_1492;
            bool __ps_257 = (bt_hyundo_hyto_ex(m_1491));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_257);
            int64_t __t258;
            __t258 = r_1492;
...
static void fiber_hya() {
        int64_t __ps_264 = (fiber_hythread_hyid());
        if (tur_panicking) return;
        printf("%lld\n", (long long)(__ps_264));
}

static void fiber_hyb() {
        int64_t __ps_265 = (fiber_hythread_hyid());
        if (tur_panicking) return;
        printf("%lld\n", (long long)(__ps_265));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t266;
        {
            void * __ps_267 = (scheduler_hymt_hynew(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * sched_1521 = __ps_267;
            (void)sched_1521;
            {
                void * __ps_268 = (fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * fa_1522 = __ps_268;
                (void)fa_1522;
                {
                    void * __ps_269 = (fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0)));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    void * fb_1523 = __ps_269;
                    (void)fb_1523;
