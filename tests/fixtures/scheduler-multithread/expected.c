...
static bool __fn_904(int64_t, int64_t);
...
static int64_t fiber_new(void *, int64_t);
static int64_t fiber_resume(int64_t, int64_t);
static void fiber_yield(int64_t);
static int64_t fiber_done_qu(int64_t);
static int64_t fiber_arg(int64_t);
static void fiber_free(int64_t);
static int64_t fiber_local_get(int64_t, int64_t);
static void fiber_local_set_ex(int64_t, int64_t, int64_t);
static int64_t fiber_local_current_get(int64_t);
static void fiber_local_current_set_ex(int64_t, int64_t);
static void scheduler_yield_ex();
static void scheduler_park_ex();
static void scheduler_unpark_ex(int64_t);
...
static void scheduler_mt_spawn(void *, int64_t);
...
static void scheduler_mt_unpark(int64_t);
static void fiber_a();
static void fiber_b();
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        __t4[1] = (int64_t)(intptr_t)__fn_626;
        void *__t5 = __t4;
...
static bool __inst_Eq_eq_qu_Tuple2(int64_t x, int64_t y) {
        return tuple2_eq_carrier_qu(x, y, (int64_t)(intptr_t)(__fn_803), (int64_t)(intptr_t)(__fn_807));
}
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t16[1] = (int64_t)(intptr_t)__fn_825;
        void *__t17 = __t16;
...
static bool __fn_904(int64_t a, int64_t b) {
        return (a) == (b);
}
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t18[1] = (int64_t)(intptr_t)__fn_904;
        void *__t19 = __t18;
...
static int64_t fiber_new(void * fn, int64_t stack_size) {
        return (void *)tur_fiber_block_new((void(*)(void))fn, (size_t)stack_size);
  
}

static int64_t fiber_resume(int64_t f, int64_t arg) {
...
static int64_t fiber_done_qu(int64_t f) {
        FiberBlock *fb = (FiberBlock *)f;
  return fb ? (int64_t)fb->done : 1;
  
}

static int64_t fiber_arg(int64_t f) {
        FiberBlock *fb = (FiberBlock *)f;
  return fb ? fb->arg : 0;
  
}

static void fiber_free(int64_t f) {
        tur_fiber_block_free((FiberBlock *)f);
  
}

static int64_t fiber_local_get(int64_t f, int64_t key) {
        return tur_fiber_local_get((FiberBlock *)f, (int64_t)key);
  
}

static void fiber_local_set_ex(int64_t f, int64_t key, int64_t value) {
...
static void fiber_local_current_set_ex(int64_t key, int64_t value) {
...
static void scheduler_unpark_ex(int64_t f) {
...
static void scheduler_mt_spawn(void * sched, int64_t fiber) {
...
static void scheduler_mt_unpark(int64_t fiber) {
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            void * sched_931 = scheduler_mt_new(INT64_C(2));
            (void)sched_931;
            {
                int64_t fa_932 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_932;
                {
                    int64_t fb_933 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_933;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_931), fa_932);
                    scheduler_mt_spawn((void *)(intptr_t)(sched_931), fb_933);
                    thread_sleep(INT64_C(100));
                    scheduler_mt_free((void *)(intptr_t)(sched_931));
                    fiber_free(fa_932);
                    fiber_free(fb_933);
                }
            }
