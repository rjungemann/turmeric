...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            bool __t13;
            {
                ...
                bool __t14;
                if ((t1_806) == (INT64_C(0))) {
                    __t14 = (t2_807) == (INT64_C(0));
                } else {
                    bool __t15;
                    if ((t2_807) == (INT64_C(0))) {
                        __t15 = false;
                    } else {
                        __t15 = __inst_Eq_eq_qu_Cons(t1_806, t2_807);
                    }
                    __t14 = __t15;
                }
                __t13 = __t14;
...
int main(int argc, char **argv) {
        ...
        int64_t __t23;
        {
            void * sched_912 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_912;
            {
                int64_t fa_913 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_913;
                {
                    int64_t fb_914 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_914;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_912), fa_913);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_912), fb_914);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_912));
                    fiber_hyfree(fa_913);
                    fiber_hyfree(fb_914);
                }
            }
