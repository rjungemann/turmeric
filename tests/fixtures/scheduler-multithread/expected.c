        ...
        bool __t28;
        {
            ...
            if ((t1_1043) == (INT64_C(0))) {
                ...
                if ((t2_1044) == (INT64_C(0))) {
                    ...
                    __auto_type __ps_31 = (cons_hyeq_hygo(t1_1043, t2_1044));
                    if (tur_panicking) return (bool){0};
                    __t30 = __ps_31;
                }
                __t29 = __t30;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_790, (void *)(intptr_t)(k_791), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_795), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_796), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            ...
            bool __t96;
            {
                ...
                if ((t1_1038) == (INT64_C(0))) {
                    ...
                    if ((t2_1039) == (INT64_C(0))) {
                        ...
                        __auto_type __ps_99 = (cons_hyeq_hygo(t1_1038, t2_1039));
                        if (tur_panicking) return (bool){0};
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1129), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1130)));
            if (tur_panicking) return (bool){0};
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                __auto_type __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1258));
                if (tur_panicking) return (int64_t){0};
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            (void)r_1308;
            int64_t __t149;
            __auto_type __ps_150 = (schema_hydecode_hyok_qu(r_1308));
            if (tur_panicking) return (int64_t){0};
            if (__ps_150) {
                __auto_type __ps_151 = (schema_hydecode_hyvalue(r_1308));
                if (tur_panicking) return (int64_t){0};
                __t149 = __ps_151;
            } else {
                __auto_type __ps_152 = (schema_hydecode_hyerrors(r_1308));
                if (tur_panicking) return (int64_t){0};
