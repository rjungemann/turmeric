...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return map_eq_(x, y, (int64_t)(intptr_t)(__fn_618));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return vec_eq_(x, y, (int64_t)(intptr_t)(__fn_642));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return option_eq_(x, y, (int64_t)(intptr_t)(__fn_669));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return result_eq_(x, y, (int64_t)(intptr_t)(__fn_691), (int64_t)(intptr_t)(__fn_695));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return pair_eq_carrier_(x, y, (int64_t)(intptr_t)(__fn_711), (int64_t)(intptr_t)(__fn_715));
}
...
static bool __inst_Eq_eq__Tuple2(int64_t x, int64_t y) {
        return tuple2_eq_carrier_(x, y, (int64_t)(intptr_t)(__fn_796), (int64_t)(intptr_t)(__fn_800));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return list_eq_(x, y, (int64_t)(intptr_t)(__fn_818));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return mutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_897));
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t3;
        {
            void * sched_925 = scheduler_mt_new(INT64_C(2));
            (void)sched_925;
            {
                void * fa_926 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_926;
                {
                    void * fb_927 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_927;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_925), (void *)(intptr_t)(fa_926));
                    scheduler_mt_spawn((void *)(intptr_t)(sched_925), (void *)(intptr_t)(fb_927));
                    thread_sleep(INT64_C(100));
                    scheduler_mt_free((void *)(intptr_t)(sched_925));
                    fiber_free((void *)(intptr_t)(fa_926));
                    fiber_free((void *)(intptr_t)(fb_927));
                }
            }
            int64_t __t4;
            __t4 = INT64_C(0);
