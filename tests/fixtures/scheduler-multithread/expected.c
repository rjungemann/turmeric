...
static bool __fn_821(int64_t, int64_t);
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        __t4[1] = (int64_t)(intptr_t)__fn_639;
        void *__t5 = __t4;
...
static bool __fn_821(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t12[1] = (int64_t)(intptr_t)__fn_821;
        void *__t13 = __t12;
...
int main(int argc, char **argv) {
        ...
        int64_t __t21;
        {
            void * sched_934 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_934;
            {
                int64_t fa_935 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_935;
                {
                    int64_t fb_936 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_936;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_934), fa_935);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_934), fb_936);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_934));
                    fiber_hyfree(fa_935);
                    fiber_hyfree(fb_936);
                }
            }
