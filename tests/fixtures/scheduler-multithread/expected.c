...
static void fiber_hya() {
        int64_t __ps_163 = (fiber_hythread_hyid());
        if (tur_panicking) return;
        printf("%lld\n", (long long)(__ps_163));
}

static void fiber_hyb() {
        int64_t __ps_164 = (fiber_hythread_hyid());
        if (tur_panicking) return;
        printf("%lld\n", (long long)(__ps_164));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t165;
        {
            void * __ps_166 = (scheduler_hymt_hynew(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * sched_1416 = __ps_166;
            (void)sched_1416;
            {
                int64_t __ps_167 = (fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t fa_1417 = __ps_167;
                (void)fa_1417;
                {
                    int64_t __ps_168 = (fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0)));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    int64_t fb_1418 = __ps_168;
                    (void)fb_1418;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_1416), fa_1417);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_1416), fb_1418);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_1416));
                    fiber_hyfree(fa_1417);
                    fiber_hyfree(fb_1418);
                }
            }
            int64_t __t169;
            __t169 = INT64_C(0);
