...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_771, (void *)(intptr_t)(k_772), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_776 = __ps_73;
            (void)iter_776;
            __auto_type __ps_74 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_75 = (hamt_slkeyeq((void *)(intptr_t)(__ps_74)));
            if (tur_panicking) return (bool){0};
            void * keyeq_777 = __ps_75;
            (void)keyeq_777;
            __auto_type __ps_76 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_776), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_777), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_778 = __ps_77;
            (void)result_778;
        ...
        if (__ps_95) {
            bool __t96;
            {
                ...
                if ((t1_1019) == (INT64_C(0))) {
                    __t97 = (t2_1020) == (INT64_C(0));
                } else {
                    bool __t98;
                    if ((t2_1020) == (INT64_C(0))) {
                        __t98 = false;
                    } else {
                        __auto_type __ps_99 = (cons_hyeq_hygo(t1_1019, t2_1020));
                        if (tur_panicking) return (bool){0};
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_105) {
            ...
            int64_t __t106;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1035 = (int64_t)(intptr_t)(__ps_110);
                (void)out_1035;
                __t106 = out_1035;
            }
            __t104 = __t106;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1110 = __ps_117;
            (void)iter_1110;
            __auto_type __ps_118 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_119 = (hamt_slkeyeq((void *)(intptr_t)(__ps_118)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1111 = __ps_119;
            (void)keyeq_1111;
            __auto_type __ps_120 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1110), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1111)));
            if (tur_panicking) return (bool){0};
            bool result_1112 = __ps_121;
            (void)result_1112;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                __auto_type __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1239));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1240 = __ps_144;
                (void)_un_unv_1240;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1289 = __ps_148;
            (void)r_1289;
            int64_t __t149;
            __auto_type __ps_150 = (schema_hydecode_hyok_qu(r_1289));
            if (tur_panicking) return (int64_t){0};
            if (__ps_150) {
                __auto_type __ps_151 = (schema_hydecode_hyvalue(r_1289));
                if (tur_panicking) return (int64_t){0};
                __t149 = __ps_151;
            } else {
                __auto_type __ps_152 = (schema_hydecode_hyerrors(r_1289));
                if (tur_panicking) return (int64_t){0};
...
static void fiber_hya() {
        __auto_type __ps_155 = (fiber_hythread_hyid());
        if (tur_panicking) return;
        printf("%lld\n", (long long)(__ps_155));
}

static void fiber_hyb() {
        __auto_type __ps_156 = (fiber_hythread_hyid());
        if (tur_panicking) return;
        printf("%lld\n", (long long)(__ps_156));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t157;
        {
            __auto_type __ps_158 = (scheduler_hymt_hynew(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * sched_1335 = __ps_158;
            (void)sched_1335;
            {
                __auto_type __ps_159 = (fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t fa_1336 = __ps_159;
                (void)fa_1336;
                {
                    __auto_type __ps_160 = (fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0)));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    int64_t fb_1337 = __ps_160;
                    (void)fb_1337;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_1335), fa_1336);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_1335), fb_1337);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_1335));
                    fiber_hyfree(fa_1336);
                    fiber_hyfree(fb_1337);
                }
            }
            int64_t __t161;
            __t161 = INT64_C(0);
