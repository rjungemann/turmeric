...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return map_eq_(x, y, (int64_t)(intptr_t)(__fn_555));
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t3;
        {
            void * sched_862 = scheduler_mt_new(INT64_C(2));
            (void)sched_862;
            {
                void * fa_863 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_863;
                {
                    void * fb_864 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_864;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_862), (void *)(intptr_t)(fa_863));
                    scheduler_mt_spawn((void *)(intptr_t)(sched_862), (void *)(intptr_t)(fb_864));
                    thread_sleep(INT64_C(100));
                    scheduler_mt_free((void *)(intptr_t)(sched_862));
                    fiber_free((void *)(intptr_t)(fa_863));
                    fiber_free((void *)(intptr_t)(fb_864));
                }
            }
            int64_t __t4;
            __t4 = INT64_C(0);
