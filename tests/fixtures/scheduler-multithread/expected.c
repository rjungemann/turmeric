...
int main() {
        int64_t __t0;
        {
            void * sched_314 = scheduler_mt_new(INT64_C(2));
            (void)sched_314;
            {
                void * fa_315 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_315;
                {
                    void * fb_316 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_316;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_314), (void *)(intptr_t)(fa_315));
                    scheduler_mt_spawn((void *)(intptr_t)(sched_314), (void *)(intptr_t)(fb_316));
                    thread_sleep(INT64_C(100));
                    scheduler_mt_free((void *)(intptr_t)(sched_314));
                    fiber_free((void *)(intptr_t)(fa_315));
                    fiber_free((void *)(intptr_t)(fb_316));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
