...
static void scheduler_unpark_ex(void *);
...
static int64_t fiber_done_qu(void * f) {
...
static void fiber_local_set_ex(void * f, int64_t key, int64_t value) {
...
static void scheduler_unpark_ex(void * f) {
