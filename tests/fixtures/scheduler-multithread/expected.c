...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t12[1] = (int64_t)(intptr_t)__fn_832;
        void *__t13 = __t12;
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            void * sched_945 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_945;
            {
                int64_t fa_946 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_946;
                {
                    int64_t fb_947 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_947;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_945), fa_946);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_945), fb_947);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_945));
                    fiber_hyfree(fa_946);
                    fiber_hyfree(fb_947);
                }
            }
