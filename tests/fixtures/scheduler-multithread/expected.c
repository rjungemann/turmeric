...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_901;
        void *__t15 = __t14;
...
int main(int argc, char **argv) {
        ...
        int64_t __t21;
        {
            void * sched_928 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_928;
            {
                int64_t fa_929 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_929;
                {
                    int64_t fb_930 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_930;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_928), fa_929);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_928), fb_930);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_928));
                    fiber_hyfree(fa_929);
                    fiber_hyfree(fb_930);
                }
            }
