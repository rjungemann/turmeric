            ...
            case 1: {
                ...
                bool __t14 = 0;
                {
                    ...
                    case 1: {
                        ...
                        bool __ps_15 = (__inst_Eq_eq_qu_int(vx_932, vy_933));
                        if (tur_panicking) return ((bool)0);
                        __t14 = __ps_15;
                        break;
                    }
            ...
            case 0: {
                ...
                bool __t18 = 0;
                {
                    ...
                    case 0: {
                        ...
                        bool __ps_19 = (__inst_Eq_eq_qu_int(vx_985, vy_986));
                        if (tur_panicking) return ((bool)0);
                        __t18 = __ps_19;
                        break;
                    }
            ...
            case 1: {
                ...
                bool __t20 = 0;
                {
                    ...
                    case 1: {
                        ...
                        bool __ps_21 = (__inst_Eq_eq_qu_int(ex_988, ey_990));
                        if (tur_panicking) return ((bool)0);
                        __t20 = __ps_21;
                        break;
                    }
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t28;
        {
            ...
            if ((t1_1132) == (INT64_C(0))) {
                __t29 = (t2_1133) == (INT64_C(0));
            } else {
                bool __t30;
                if ((t2_1133) == (INT64_C(0))) {
                    __t30 = false;
                } else {
                    bool __ps_31 = (cons_hyeq_hygo(t1_1132, t2_1133));
                    if (tur_panicking) return ((bool)0);
                    __t30 = __ps_31;
                }
                __t29 = __t30;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_842, (void *)(intptr_t)(k_843), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_847 = __ps_75;
            (void)iter_847;
            void * __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_848 = __ps_77;
            (void)keyeq_848;
            void * __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_847), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_848), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_849 = __ps_79;
            (void)result_849;
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                if ((t1_1127) == (INT64_C(0))) {
                    __t100 = (t2_1128) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_1128) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        bool __ps_102 = (cons_hyeq_hygo(t1_1127, t2_1128));
                        if (tur_panicking) return ((bool)0);
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1143 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1143;
                __t109 = out_1143;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1218 = __ps_120;
            (void)iter_1218;
            void * __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1219 = __ps_122;
            (void)keyeq_1219;
            void * __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1218), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1219)));
            if (tur_panicking) return ((bool)0);
            bool result_1220 = __ps_124;
            (void)result_1220;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                tur_adt_Vec__int * __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1347));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1348 = __ps_147;
                (void)_un_unv_1348;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1398 = __ps_152;
            (void)r_1398;
            int64_t __t153;
            bool __ps_154 = (schema_hydecode_hyok_qu(r_1398));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_154) {
                int64_t __ps_155 = (schema_hydecode_hyvalue(r_1398));
                if (tur_panicking) return ((int64_t)0);
                __t153 = __ps_155;
            } else {
                int64_t __ps_156 = (schema_hydecode_hyerrors(r_1398));
                if (tur_panicking) return ((int64_t)0);
...
static void fiber_hya() {
        int64_t __ps_168 = (fiber_hythread_hyid());
        if (tur_panicking) return;
        printf("%lld\n", (long long)(__ps_168));
}

static void fiber_hyb() {
        int64_t __ps_169 = (fiber_hythread_hyid());
        if (tur_panicking) return;
        printf("%lld\n", (long long)(__ps_169));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t170;
        {
            void * __ps_171 = (scheduler_hymt_hynew(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * sched_1486 = __ps_171;
            (void)sched_1486;
            {
                void * __ps_172 = (fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * fa_1487 = __ps_172;
                (void)fa_1487;
                {
                    void * __ps_173 = (fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0)));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    void * fb_1488 = __ps_173;
                    (void)fb_1488;
