...
static bool __inst_Eq_eq_qu_Tuple2(int64_t x, int64_t y) {
        return tuple2_eq_carrier_qu(x, y, (int64_t)(intptr_t)(__fn_814), (int64_t)(intptr_t)(__fn_818));
}
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t16[1] = (int64_t)(intptr_t)__fn_836;
        void *__t17 = __t16;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t18[1] = (int64_t)(intptr_t)__fn_915;
        void *__t19 = __t18;
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            void * sched_942 = scheduler_mt_new(INT64_C(2));
            (void)sched_942;
            {
                int64_t fa_943 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_943;
                {
                    int64_t fb_944 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_944;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_942), fa_943);
                    scheduler_mt_spawn((void *)(intptr_t)(sched_942), fb_944);
                    thread_sleep(INT64_C(100));
                    scheduler_mt_free((void *)(intptr_t)(sched_942));
                    fiber_free(fa_943);
                    fiber_free(fb_944);
                }
            }
