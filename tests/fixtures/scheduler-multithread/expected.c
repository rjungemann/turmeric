...
int main() {
        int64_t __t0;
        {
            void * sched_261 = scheduler_mt_new(INT64_C(2));
            (void)sched_261;
            {
                void * fa_262 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_262;
                {
                    void * fb_263 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_263;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_261), (void *)(intptr_t)(fa_262));
                    scheduler_mt_spawn((void *)(intptr_t)(sched_261), (void *)(intptr_t)(fb_263));
                    (void)(thread_sleep(INT64_C(100)));
                    scheduler_mt_free((void *)(intptr_t)(sched_261));
                    fiber_free((void *)(intptr_t)(fa_262));
                    fiber_free((void *)(intptr_t)(fb_263));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
