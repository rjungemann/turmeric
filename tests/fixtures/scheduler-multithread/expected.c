...
int main() {
        int64_t __t0;
        {
            void * sched_74 = scheduler_mt_new(INT64_C(2));
            (void)sched_74;
            {
                void * fa_75 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_75;
                {
                    void * fb_76 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_76;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_74), (void *)(intptr_t)(fa_75));
                    scheduler_mt_spawn((void *)(intptr_t)(sched_74), (void *)(intptr_t)(fb_76));
                    (void)(thread_sleep(INT64_C(100)));
                    scheduler_mt_free((void *)(intptr_t)(sched_74));
                    fiber_free((void *)(intptr_t)(fa_75));
                    fiber_free((void *)(intptr_t)(fb_76));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
