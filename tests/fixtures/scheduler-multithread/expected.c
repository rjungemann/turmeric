...
static bool __fn_379(int64_t, int64_t);
static bool __inst_Eq_eq__Map(int64_t, int64_t);
static bool __fn_399(int64_t, int64_t);
static bool __inst_Eq_eq__Vec(int64_t, int64_t);
static bool __fn_426(int64_t, int64_t);
static bool __inst_Eq_eq__Option(int64_t, int64_t);
static bool __fn_446(int64_t, int64_t);
...
static bool __fn_379(int64_t a, int64_t b) {
        return ((a) == (b));
}

static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return map_eq_(x, y, (int64_t)(intptr_t)(__fn_379));
}
...
static bool __fn_399(int64_t a, int64_t b) {
        return ((a) == (b));
}

static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return vec_eq_(x, y, (int64_t)(intptr_t)(__fn_399));
}
...
static bool __fn_426(int64_t a, int64_t b) {
        return ((a) == (b));
}

static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return option_eq_(x, y, (int64_t)(intptr_t)(__fn_426));
}
...
static bool __fn_446(int64_t a, int64_t b) {
        return ((a) == (b));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return result_eq_(x, y, (int64_t)(intptr_t)(__fn_446), (int64_t)(intptr_t)(__fn_450));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return pair_eq_carrier_(x, y, (int64_t)(intptr_t)(__fn_466), (int64_t)(intptr_t)(__fn_470));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return list_eq_(x, y, (int64_t)(intptr_t)(__fn_486));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return mutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_557));
}
...
int main() {
        int64_t __t0;
        {
            void * sched_585 = scheduler_mt_new(INT64_C(2));
            (void)sched_585;
            {
                void * fa_586 = fiber_new((void *)(intptr_t)(fiber_a), INT64_C(0));
                (void)fa_586;
                {
                    void * fb_587 = fiber_new((void *)(intptr_t)(fiber_b), INT64_C(0));
                    (void)fb_587;
                    scheduler_mt_spawn((void *)(intptr_t)(sched_585), (void *)(intptr_t)(fa_586));
                    scheduler_mt_spawn((void *)(intptr_t)(sched_585), (void *)(intptr_t)(fb_587));
                    thread_sleep(INT64_C(100));
                    scheduler_mt_free((void *)(intptr_t)(sched_585));
                    fiber_free((void *)(intptr_t)(fa_586));
                    fiber_free((void *)(intptr_t)(fb_587));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
