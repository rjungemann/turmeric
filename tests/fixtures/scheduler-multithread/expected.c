...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t14;
        {
            ...
            bool __t15;
            if ((t1_999) == (INT64_C(0))) {
                __t15 = (t2_1000) == (INT64_C(0));
            } else {
                bool __t16;
                if ((t2_1000) == (INT64_C(0))) {
                    __t16 = false;
                } else {
                    __t16 = cons_hyeq_hygo(t1_999, t2_1000);
                }
                __t15 = __t16;
            }
            __t14 = __t15;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t17) {
            ...
            __t18[1] = (int64_t)(intptr_t)__fn_1127;
            void *__t19 = __t18;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(c1))->head, ((Cons *)(intptr_t)(c2))->head)) {
            bool __t32;
            {
                int64_t t1_994 = ((Cons *)(intptr_t)(c1))->tail;
                (void)t1_994;
                int64_t t2_995 = ((Cons *)(intptr_t)(c2))->tail;
                (void)t2_995;
                bool __t33;
                if ((t1_994) == (INT64_C(0))) {
                    __t33 = (t2_995) == (INT64_C(0));
                } else {
                    bool __t34;
                    if ((t2_995) == (INT64_C(0))) {
                        __t34 = false;
                    } else {
                        __t34 = cons_hyeq_hygo(t1_994, t2_995);
                    }
                    __t33 = __t34;
                }
                __t32 = __t33;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            int64_t __t36;
            {
                int64_t out_1003 = (int64_t)(intptr_t)(tcons__spec__Cons__int___int64_t_int64_t((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f))));
                (void)out_1003;
                __t36 = out_1003;
            }
            __t35 = __t36;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            int64_t __t38;
            {
                int64_t out_1010 = (int64_t)(intptr_t)(tcons__spec__Cons__int___int64_t_int64_t(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2)));
                (void)out_1010;
                __t38 = out_1010;
            }
            __t37 = __t38;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_1073 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_1073;
                void * k_1074 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_1074;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1073, (void *)(intptr_t)(k_1074), (void *)(intptr_t)(keyeq))) {
                    void * __t39 = iter;
                    void * __t40 = s2_hamt;
                    void * __t41 = keyeq;
                    iter = __t39;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t42;
        {
            void * iter_1077 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_1077;
            void * keyeq_1078 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_1078;
            bool result_1079 = set_hyeq_hyloop((void *)(intptr_t)(iter_1077), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_1078));
            (void)result_1079;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        int64_t __t49;
        {
            int64_t _un_unv_1206 = vec_hynew();
            (void)_un_unv_1206;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t53;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1254)) {
                __t54 = schema_hydecode_hyvalue(r_1254);
            } else {
                __t54 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1254));
            }
            __t53 = __t54;
        }
        return __t53;
...
int main(int argc, char **argv) {
        ...
        int64_t __t55;
        {
            void * sched_1300 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_1300;
            {
                int64_t fa_1301 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_1301;
                {
                    int64_t fb_1302 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_1302;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_1300), fa_1301);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_1300), fb_1302);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_1300));
                    fiber_hyfree(fa_1301);
                    fiber_hyfree(fb_1302);
                }
            }
            int64_t __t56;
            __t56 = INT64_C(0);
