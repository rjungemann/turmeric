...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            int64_t lx_640 = vec_hylen_hybyval(x);
            (void)lx_640;
            int64_t ly_641 = vec_hylen_hybyval(y);
            (void)ly_641;
            bool __t5;
            if ((lx_640) == (ly_641)) {
                __t5 = vec_hyeq_hyloop_hybyval(x, y, INT64_C(0), lx_640);
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_820 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_820;
                int64_t t2_821 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_821;
                if ((t1_820) == (INT64_C(0))) {
                    return (t2_821) == (INT64_C(0));
                } else {
                    if ((t2_821) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t12 = (*(int64_t *)(intptr_t)(t1_820));
                        int64_t __t13 = (*(int64_t *)(intptr_t)(t2_821));
                        x = __t12;
                        y = __t13;
                        goto __tur_tailcall;
                    }
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            void * sched_926 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_926;
            {
                int64_t fa_927 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_927;
                {
                    int64_t fb_928 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_928;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_926), fa_927);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_926), fb_928);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_926));
                    fiber_hyfree(fa_927);
                    fiber_hyfree(fb_928);
                }
            }
