...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        __t2[1] = (int64_t)(intptr_t)__fn_603;
        void *__t3 = __t2;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            ...
            int64_t yi_631 = y;
            (void)yi_631;
            int64_t lx_632 = vec_hylen(xi_630);
            (void)lx_632;
            int64_t ly_633 = vec_hylen(yi_631);
            (void)ly_633;
            bool __t5;
            if ((lx_632) == (ly_633)) {
                int64_t *__t6 = (int64_t *)malloc(2 * sizeof(int64_t));
                __t6[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
                __t6[1] = (int64_t)(intptr_t)__fn_636;
                void *__t7 = __t6;
                __t5 = vec_hyeq_hyloop(xi_630, yi_631, INT64_C(0), lx_632, (int64_t)(intptr_t)(__t7));
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_816 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_816;
                int64_t t2_817 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_817;
                if ((t1_816) == (INT64_C(0))) {
                    return (t2_817) == (INT64_C(0));
                } else {
                    if ((t2_817) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t14 = (*(int64_t *)(intptr_t)(t1_816));
                        int64_t __t15 = (*(int64_t *)(intptr_t)(t2_817));
                        x = __t14;
                        y = __t15;
                        goto __tur_tailcall;
                    }
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t16[1] = (int64_t)(intptr_t)__fn_895;
        void *__t17 = __t16;
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            void * sched_922 = scheduler_hymt_hynew(INT64_C(2));
            (void)sched_922;
            {
                int64_t fa_923 = fiber_hynew((void *)(intptr_t)(fiber_hya), INT64_C(0));
                (void)fa_923;
                {
                    int64_t fb_924 = fiber_hynew((void *)(intptr_t)(fiber_hyb), INT64_C(0));
                    (void)fb_924;
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_922), fa_923);
                    scheduler_hymt_hyspawn((void *)(intptr_t)(sched_922), fb_924);
                    thread_hysleep(INT64_C(100));
                    scheduler_hymt_hyfree((void *)(intptr_t)(sched_922));
                    fiber_hyfree(fa_923);
                    fiber_hyfree(fb_924);
                }
            }
