...
static bool map_hyeq_hyk_qu(int64_t, int64_t, int64_t, void *);
...
static const char * dupe(const char *);
...
static bool __fn_903(int64_t __cmp_a, int64_t __cmp_b) {
        return __inst_Eq_eq_qu_int(__cmp_a, __cmp_b);
}

static bool __fn_907(int64_t __cmp_a, int64_t __cmp_b) {
        return __inst_Eq_eq_qu_int(__cmp_a, __cmp_b);
}

static bool __fn_911(int64_t __cmp_a, int64_t __cmp_b) {
        return __inst_Eq_eq_qu_int(__cmp_a, __cmp_b);
}

static bool __fn_915(int64_t __cmp_a, int64_t __cmp_b) {
        return __inst_Eq_eq_qu_int(__cmp_a, __cmp_b);
}
...
static bool map_hyeq_hyk_qu(int64_t m1, int64_t m2, int64_t keyeq, void * val_cmp) {
        return map_hyeq_hyraw_hyk_qu(m1, m2, keyeq, (int64_t)(intptr_t)(val_cmp));
}
...
static const char * dupe(const char * s) {
        const char* p=(const char*)(intptr_t)s; size_t n=0; while(p[n])n++;
...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t25;
            {
                const char * _un_untur_unmk_un_un_890 = "age";
                (void)_un_untur_unmk_un_un_890;
                int64_t __t26;
                {
                    const char * _un_untur_unmk_un_un_891 = "name";
            ...
            int64_t __t27;
            {
                const char * _un_untur_unmk_un_un_893 = dupe("age");
                (void)_un_untur_unmk_un_un_893;
                int64_t __t28;
                {
                    const char * _un_untur_unmk_un_un_894 = dupe("name");
                    (void)_un_untur_unmk_un_un_894;
                    __t28 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_894), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_894), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_894), INT64_C(1), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_894), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_894));
                }
                __t27 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t28, &_un_untur_unmk_un_un_893), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_893), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_893), INT64_C(2), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_893), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_893));
            }
            int64_t b_895 = __t27;
            (void)b_895;
            int64_t __t29;
            {
                const char * _un_untur_unmk_un_un_896 = "age";
                (void)_un_untur_unmk_un_un_896;
                int64_t __t30;
                {
                    const char * _un_untur_unmk_un_un_897 = "name";
                    (void)_un_untur_unmk_un_un_897;
                    __t30 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_897), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_897), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_897), INT64_C(1), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_897), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_897));
                }
                __t29 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t30, &_un_untur_unmk_un_un_896), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_896), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_896), INT64_C(99), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_896), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_896));
            }
            int64_t c_898 = __t29;
            (void)c_898;
            int64_t __t31;
            {
                const char * _un_untur_unmk_un_un_899 = "name";
                (void)_un_untur_unmk_un_un_899;
                __t31 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_899), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_899), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_899), INT64_C(1), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_899), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_899));
            }
            int64_t d_900 = __t31;
            (void)d_900;
            int64_t __t32;
            int64_t *__t33 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t33[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
            __t33[1] = (int64_t)(intptr_t)__fn_903;
            void *__t34 = __t33;
            if (map_hyeq_hyk_qu(a_892, b_895, __inst_MapKey_mk_hycmp_cstr(((union { int64_t s; const char * d; }){.s = INT64_C(0)}).d), (void *)(intptr_t)(__t34))) {
                __t32 = INT64_C(1);
            } else {
                __t32 = INT64_C(0);
            }
            ...
            __t36[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
            __t36[1] = (int64_t)(intptr_t)__fn_907;
            void *__t37 = __t36;
            if (map_hyeq_hyk_qu(a_892, c_898, __inst_MapKey_mk_hycmp_cstr(((union { int64_t s; const char * d; }){.s = INT64_C(0)}).d), (void *)(intptr_t)(__t37))) {
                __t35 = INT64_C(1);
            } else {
                __t35 = INT64_C(0);
            }
            ...
            __t39[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
            __t39[1] = (int64_t)(intptr_t)__fn_911;
            void *__t40 = __t39;
            if (map_hyeq_hyk_qu(a_892, d_900, __inst_MapKey_mk_hycmp_cstr(((union { int64_t s; const char * d; }){.s = INT64_C(0)}).d), (void *)(intptr_t)(__t40))) {
                __t38 = INT64_C(1);
            } else {
                __t38 = INT64_C(0);
            }
            ...
            __t42[1] = (int64_t)(intptr_t)__fn_915;
            void *__t43 = __t42;
            if (map_hyeq_hyk_qu(a_892, a_892, __inst_MapKey_mk_hycmp_cstr(((union { int64_t s; const char * d; }){.s = INT64_C(0)}).d), (void *)(intptr_t)(__t43))) {
                __t41 = INT64_C(1);
            } else {
                __t41 = INT64_C(0);
            }
