...
static void __handle_body_0(void) {
    int64_t __t2;
    {
        ...
        (void)arr_616;
        (*((int64_t *)arr_616 + INT64_C(0)) = INT64_C(42));
        int64_t __t3;
        int64_t __t4;
        {
            int64_t v_617 = (*((int64_t *)arr_616 + INT64_C(0)));
            (void)v_617;
            printf("%lld\n", (long long)(v_617));
            (*((int64_t *)arr_616 + INT64_C(1)) = INT64_C(99));
            int64_t __t5;
            int64_t __t6;
            {
                int64_t v2_618 = (*((int64_t *)arr_616 + INT64_C(1)));
                (void)v2_618;
                printf("%lld\n", (long long)(v2_618));
                free(arr_616);
                int64_t __t7;
