...
static void __handle_body_0(void) {
    int64_t __t2;
    {
        ...
        (void)arr_196;
        (*((int64_t *)arr_196 + INT64_C(0)) = INT64_C(42));
        int64_t __t3;
        int64_t __t4;
        {
            int64_t v_197 = (*((int64_t *)arr_196 + INT64_C(0)));
            (void)v_197;
            printf("%lld\n", (long long)(v_197));
            (*((int64_t *)arr_196 + INT64_C(1)) = INT64_C(99));
            int64_t __t5;
            int64_t __t6;
            {
                int64_t v2_198 = (*((int64_t *)arr_196 + INT64_C(1)));
                (void)v2_198;
                printf("%lld\n", (long long)(v2_198));
                free(arr_196);
                int64_t __t7;
