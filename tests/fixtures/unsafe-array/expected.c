...
static void __handle_body_0(void) {
    int64_t __t2;
    {
        ...
        (void)arr_213;
        (*((int64_t *)arr_213 + INT64_C(0)) = INT64_C(42));
        int64_t __t3;
        int64_t __t4;
        {
            int64_t v_214 = (*((int64_t *)arr_213 + INT64_C(0)));
            (void)v_214;
            printf("%lld\n", (long long)(v_214));
            (*((int64_t *)arr_213 + INT64_C(1)) = INT64_C(99));
            int64_t __t5;
            int64_t __t6;
            {
                int64_t v2_215 = (*((int64_t *)arr_213 + INT64_C(1)));
                (void)v2_215;
                printf("%lld\n", (long long)(v2_215));
                free(arr_213);
                int64_t __t7;
