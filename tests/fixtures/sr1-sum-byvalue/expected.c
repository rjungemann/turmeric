...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t172 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1630 = (int64_t)__scrut->as.Circle._0;
                __t172 = (INT64_C(3)) * ((r_1630) * (r_1630));
                break;
            }
            case 1: {
                int64_t w_1631 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1632 = (int64_t)__scrut->as.Rect._1;
                __t172 = (w_1631) * (h_1632);
                break;
            }
            case 2: {
                tur_adt_Pt p_1633 = __scrut->as.Dot._0;
                __t172 = INT64_C(0);
                break;
            }
            case 3: {
...
static double dot_hyx(const tur_adt_Shape * s) {
        double __t173 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 2: {
                tur_adt_Pt p_1635 = __scrut->as.Dot._0;
                double __t174 = 0;
                {
                    tur_adt_Pt __scrut = (p_1635);
                    {
                        double x_1636 = (double)__scrut.x;
                        double y_1637 = (double)__scrut.y;
                        __t174 = x_1636;
                        goto ____t175;
                    }
                    ____t175:;
            ...
            case 0: {
                int64_t r_1638 = (int64_t)__scrut->as.Circle._0;
                __t173 = 0.0;
                break;
            }
            case 1: {
                int64_t w_1639 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1640 = (int64_t)__scrut->as.Rect._1;
                __t173 = 0.0;
                break;
            }
            case 3: {
