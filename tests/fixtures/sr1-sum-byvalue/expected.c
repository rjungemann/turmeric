...
static void __defer_164(void *__env) {
    ...
    bool __ps_199 = (bt_hyundo_hyto_ex(__e->m));
...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        ...
        if ((i) == (INT64_C(0))) {
            ...
            int64_t __t177 = (i) - (INT64_C(1));
            tur_adt_Shape __ps_178 = (ctor_Shape_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Shape __t179 = __ps_178;
            int64_t __ps_180 = (area(&__t179));
            if (tur_panicking) return ((int64_t)0);
            int64_t __t181 = (acc) + (__ps_180);
            i = __t177;
            acc = __t181;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_182 = (ctor_Shape_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t183 = __ps_182;
        int64_t __ps_184 = (area(&__t183));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_184));
        tur_adt_Shape __ps_185 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t186 = __ps_185;
        int64_t __ps_187 = (area(&__t186));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_187));
        tur_adt_Shape __ps_188 = (ctor_Shape_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t189 = __ps_188;
        int64_t __ps_190 = (area(&__t189));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_190));
        tur_adt_Pt __ps_191 = (ctor_Pt_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_192 = (ctor_Shape_Dot(__ps_191));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t193 = __ps_192;
        double __ps_194 = (dot_hyx(&__t193));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_194));
        int64_t __ps_195 = (sum_hyareas(INT64_C(1000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_195));
        int64_t __t196;
        __t196 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_197 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
