...
static void __defer_163(void *__env) {
    ...
    bool __ps_197 = (bt_hyundo_hyto_ex(__e->m));
...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t172 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1618 = (int64_t)__scrut->as.Circle._0;
                __t172 = (INT64_C(3)) * ((r_1618) * (r_1618));
                break;
            }
            case 1: {
                int64_t w_1619 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1620 = (int64_t)__scrut->as.Rect._1;
                __t172 = (w_1619) * (h_1620);
                break;
            }
            case 2: {
                tur_adt_Pt p_1621 = __scrut->as.Dot._0;
                __t172 = INT64_C(0);
                break;
            }
            case 3: {
...
static double dot_hyx(const tur_adt_Shape * s) {
        double __t173 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 2: {
                tur_adt_Pt p_1623 = __scrut->as.Dot._0;
                double __t174 = 0;
                {
                    tur_adt_Pt __scrut = (p_1623);
                    {
                        double x_1624 = (double)__scrut.x;
                        double y_1625 = (double)__scrut.y;
                        __t174 = x_1624;
                        goto ____t175;
                    }
                    ____t175:;
            ...
            case 0: {
                int64_t r_1626 = (int64_t)__scrut->as.Circle._0;
                __t173 = 0.0;
                break;
            }
            case 1: {
                int64_t w_1627 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1628 = (int64_t)__scrut->as.Rect._1;
                __t173 = 0.0;
                break;
            }
            case 3: {
...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        ...
        if ((i) == (INT64_C(0))) {
            ...
            int64_t __t176 = (i) - (INT64_C(1));
            tur_adt_Shape __ps_177 = (ctor_Shape_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Shape __t178 = __ps_177;
            int64_t __ps_179 = (area(&__t178));
            if (tur_panicking) return ((int64_t)0);
            int64_t __t180 = (acc) + (__ps_179);
            i = __t176;
            acc = __t180;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_181 = (ctor_Shape_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t182 = __ps_181;
        int64_t __ps_183 = (area(&__t182));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_183));
        tur_adt_Shape __ps_184 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t185 = __ps_184;
        int64_t __ps_186 = (area(&__t185));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_186));
        tur_adt_Shape __ps_187 = (ctor_Shape_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t188 = __ps_187;
        int64_t __ps_189 = (area(&__t188));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        tur_adt_Pt __ps_190 = (ctor_Pt_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_191 = (ctor_Shape_Dot(__ps_190));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t192 = __ps_191;
        double __ps_193 = (dot_hyx(&__t192));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_193));
        int64_t __ps_194 = (sum_hyareas(INT64_C(1000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_194));
        int64_t __t195;
        __t195 = INT64_C(0);
