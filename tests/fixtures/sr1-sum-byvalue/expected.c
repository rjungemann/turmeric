...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t163 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1373 = (int64_t)__scrut->as.Circle._0;
                __t163 = (INT64_C(3)) * ((r_1373) * (r_1373));
                break;
            }
            case 1: {
                int64_t w_1374 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1375 = (int64_t)__scrut->as.Rect._1;
                __t163 = (w_1374) * (h_1375);
                break;
            }
            case 2: {
                tur_adt_Pt p_1376 = __scrut->as.Dot._0;
                __t163 = INT64_C(0);
                break;
            }
            case 3: {
...
static double dot_hyx(const tur_adt_Shape * s) {
        double __t164 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 2: {
                tur_adt_Pt p_1378 = __scrut->as.Dot._0;
                double __t165 = 0;
                {
                    tur_adt_Pt __scrut = (p_1378);
                    {
                        double x_1379 = (double)__scrut.x;
                        double y_1380 = (double)__scrut.y;
                        __t165 = x_1379;
                        goto ____t166;
                    }
                    ____t166:;
            ...
            case 0: {
                int64_t r_1381 = (int64_t)__scrut->as.Circle._0;
                __t164 = 0.0;
                break;
            }
            case 1: {
                int64_t w_1382 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1383 = (int64_t)__scrut->as.Rect._1;
                __t164 = 0.0;
                break;
            }
            case 3: {
...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        ...
        if ((i) == (INT64_C(0))) {
            ...
            int64_t __t167 = (i) - (INT64_C(1));
            tur_adt_Shape __ps_168 = (ctor_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Shape __t169 = __ps_168;
            int64_t __ps_170 = (area(&__t169));
            if (tur_panicking) return ((int64_t)0);
            int64_t __t171 = (acc) + (__ps_170);
            i = __t167;
            acc = __t171;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_172 = (ctor_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t173 = __ps_172;
        int64_t __ps_174 = (area(&__t173));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_174));
        tur_adt_Shape __ps_175 = (ctor_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t176 = __ps_175;
        int64_t __ps_177 = (area(&__t176));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        tur_adt_Shape __ps_178 = (ctor_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t179 = __ps_178;
        int64_t __ps_180 = (area(&__t179));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        tur_adt_Pt __ps_181 = (ctor_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_182 = (ctor_Dot(__ps_181));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t183 = __ps_182;
        double __ps_184 = (dot_hyx(&__t183));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_184));
        int64_t __ps_185 = (sum_hyareas(INT64_C(1000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        int64_t __t186;
        __t186 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_187 = (ctor_Cons__int(h, t));
