...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_181 = (ctor_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t182 = __ps_181;
        int64_t __ps_183 = (area(&__t182));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_183));
        tur_adt_Shape __ps_184 = (ctor_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t185 = __ps_184;
        int64_t __ps_186 = (area(&__t185));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_186));
        tur_adt_Shape __ps_187 = (ctor_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t188 = __ps_187;
        int64_t __ps_189 = (area(&__t188));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        tur_adt_Pt __ps_190 = (ctor_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_191 = (ctor_Dot(__ps_190));
        /* panic-return-signal: ret ctype unknown; no propagation here */
