...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        ...
        if ((i) == (INT64_C(0))) {
            ...
            int64_t __t172 = (i) - (INT64_C(1));
            tur_adt_Shape __ps_173 = (ctor_Shape_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Shape __t174 = __ps_173;
            int64_t __ps_175 = (area(&__t174));
            if (tur_panicking) return ((int64_t)0);
            int64_t __t176 = (acc) + (__ps_175);
            i = __t172;
            acc = __t176;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        tur_adt_Shape __ps_180 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t181 = __ps_180;
        int64_t __ps_182 = (area(&__t181));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_182));
        tur_adt_Shape __ps_183 = (ctor_Shape_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t184 = __ps_183;
        int64_t __ps_185 = (area(&__t184));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        tur_adt_Pt __ps_186 = (ctor_Pt_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_187 = (ctor_Shape_Dot(__ps_186));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t188 = __ps_187;
        double __ps_189 = (dot_hyx(&__t188));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_189));
        int64_t __ps_190 = (sum_hyareas(INT64_C(1000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_190));
        int64_t __t191;
        __t191 = INT64_C(0);
