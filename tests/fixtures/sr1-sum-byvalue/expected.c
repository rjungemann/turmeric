...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        ...
        if ((i) == (INT64_C(0))) {
            ...
            int64_t __t279 = (i) - (INT64_C(1));
            tur_adt_Shape __ps_280 = (ctor_Shape_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Shape __t281 = __ps_280;
            int64_t __ps_282 = (area(&__t281));
            if (tur_panicking) return ((int64_t)0);
            int64_t __t283 = (acc) + (__ps_282);
            i = __t279;
            acc = __t283;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_284 = (ctor_Shape_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t285 = __ps_284;
        int64_t __ps_286 = (area(&__t285));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_286));
        tur_adt_Shape __ps_287 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t288 = __ps_287;
        int64_t __ps_289 = (area(&__t288));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_289));
        tur_adt_Shape __ps_290 = (ctor_Shape_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t291 = __ps_290;
        int64_t __ps_292 = (area(&__t291));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_292));
        tur_adt_Pt __ps_293 = (ctor_Pt_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_294 = (ctor_Shape_Dot(__ps_293));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t295 = __ps_294;
        double __ps_296 = (dot_hyx(&__t295));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_296));
        int64_t __ps_297 = (sum_hyareas(INT64_C(1000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_297));
        int64_t __t298;
        __t298 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_299 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_300 = (vec_new__spec__tur_adt_Vec__int__());
