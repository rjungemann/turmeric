...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t172 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1632 = (int64_t)__scrut->as.Circle._0;
                __t172 = (INT64_C(3)) * ((r_1632) * (r_1632));
                break;
            }
            case 1: {
                int64_t w_1633 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1634 = (int64_t)__scrut->as.Rect._1;
                __t172 = (w_1633) * (h_1634);
                break;
            }
            case 2: {
...
static double dot_hyx(const tur_adt_Shape * s) {
        double __t173 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 2: {
                tur_adt_Pt p_1637 = __scrut->as.Dot._0;
                double __t174 = 0;
                {
                    tur_adt_Pt __scrut = (p_1637);
                    {
                        double x_1638 = (double)__scrut.x;
                        double y_1639 = (double)__scrut.y;
                        __t174 = x_1638;
                        goto ____t175;
                    }
                    ____t175:;
            ...
            case 0: {
                int64_t r_1640 = (int64_t)__scrut->as.Circle._0;
                __t173 = 0.0;
                break;
            }
            case 1: {
                int64_t w_1641 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1642 = (int64_t)__scrut->as.Rect._1;
                __t173 = 0.0;
                break;
            }
            case 3: {
