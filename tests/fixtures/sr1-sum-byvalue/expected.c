...
static tur_adt_Shape ctor_Dot(tur_adt_Pt _0) {
    tur_adt_Shape __r;
    __r.tag = 2;
    memset((char *)&__r + sizeof(__r.tag), 0, offsetof(tur_adt_Shape, as) - sizeof(__r.tag));
...
static tur_adt_Shape ctor_Nowhere() {
    tur_adt_Shape __r;
    __r.tag = 3;
    memset((char *)&__r + sizeof(__r.tag), 0, offsetof(tur_adt_Shape, as) - sizeof(__r.tag));
...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        ...
        if ((i) == (INT64_C(0))) {
            ...
            tur_adt_Shape __ps_173 = (ctor_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_177 = (ctor_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t178 = __ps_177;
        int64_t __ps_179 = (area(&__t178));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        tur_adt_Shape __ps_180 = (ctor_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t181 = __ps_180;
        int64_t __ps_182 = (area(&__t181));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_182));
        tur_adt_Shape __ps_183 = (ctor_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t184 = __ps_183;
        int64_t __ps_185 = (area(&__t184));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        tur_adt_Pt __ps_186 = (ctor_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_187 = (ctor_Dot(__ps_186));
        /* panic-return-signal: ret ctype unknown; no propagation here */
