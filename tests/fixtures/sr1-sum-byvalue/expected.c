...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t172 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1627 = (int64_t)__scrut->as.Circle._0;
                __t172 = (INT64_C(3)) * ((r_1627) * (r_1627));
                break;
            }
            case 1: {
                int64_t w_1628 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1629 = (int64_t)__scrut->as.Rect._1;
                __t172 = (w_1628) * (h_1629);
                break;
            }
            case 2: {
                tur_adt_Pt p_1630 = __scrut->as.Dot._0;
                __t172 = INT64_C(0);
                break;
            }
            case 3: {
...
static double dot_hyx(const tur_adt_Shape * s) {
        double __t173 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 2: {
                tur_adt_Pt p_1632 = __scrut->as.Dot._0;
                double __t174 = 0;
                {
                    tur_adt_Pt __scrut = (p_1632);
                    {
                        double x_1633 = (double)__scrut.x;
                        double y_1634 = (double)__scrut.y;
                        __t174 = x_1633;
                        goto ____t175;
                    }
                    ____t175:;
            ...
            case 0: {
                int64_t r_1635 = (int64_t)__scrut->as.Circle._0;
                __t173 = 0.0;
                break;
            }
            case 1: {
                int64_t w_1636 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1637 = (int64_t)__scrut->as.Rect._1;
                __t173 = 0.0;
                break;
            }
            case 3: {
