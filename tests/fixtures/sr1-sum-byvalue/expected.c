...
#endif
static tur_adt_Pt ctor_Pt_Pt(double _0, double _1) {
    tur_adt_Pt __r;
    __r.x = _0;
    __r.y = _1;
    return __r;
...
#ifndef TUR_CTORALIAS_Pt
#define TUR_CTORALIAS_Pt
#define ctor_Pt ctor_Pt_Pt
#endif
#ifndef TUR_TD_tur_adt_Pt
#define TUR_TD_tur_adt_Pt
typedef struct tur_adt_Pt {
...
#endif
#ifndef TUR_TD_tur_adt_Shape
#define TUR_TD_tur_adt_Shape
typedef struct tur_adt_Shape {
    int tag;
    union {
        struct { int64_t _0; } Circle;
        struct { int64_t _0; int64_t _1; } Rect;
        struct { tur_adt_Pt _0; } Dot;
        struct { } Nowhere;
    } as;
} tur_adt_Shape;

#endif
static tur_adt_Shape ctor_Shape_Circle(int64_t _0) {
    tur_adt_Shape __r;
    __r.tag = 0;
...
#ifndef TUR_CTORALIAS_Circle
#define TUR_CTORALIAS_Circle
#define ctor_Circle ctor_Shape_Circle
#endif
static tur_adt_Shape ctor_Shape_Rect(int64_t _0, int64_t _1) {
    tur_adt_Shape __r;
    __r.tag = 1;
    memset((char *)&__r + sizeof(__r.tag), 0, offsetof(tur_adt_Shape, as) - sizeof(__r.tag));
...
#ifndef TUR_CTORALIAS_Rect
#define TUR_CTORALIAS_Rect
#define ctor_Rect ctor_Shape_Rect
#endif
static tur_adt_Shape ctor_Shape_Dot(tur_adt_Pt _0) {
    tur_adt_Shape __r;
    __r.tag = 2;
    memset((char *)&__r + sizeof(__r.tag), 0, offsetof(tur_adt_Shape, as) - sizeof(__r.tag));
    memset((char *)&__r.as + sizeof(__r.as.Dot), 0, sizeof(__r.as) - sizeof(__r.as.Dot));
    __r.as.Dot._0 = _0;
    return __r;
}

#ifndef TUR_CTORALIAS_Dot
#define TUR_CTORALIAS_Dot
#define ctor_Dot ctor_Shape_Dot
#endif
static tur_adt_Shape ctor_Shape_Nowhere() {
    tur_adt_Shape __r;
    __r.tag = 3;
    memset((char *)&__r + sizeof(__r.tag), 0, offsetof(tur_adt_Shape, as) - sizeof(__r.tag));
    memset((char *)&__r.as + sizeof(__r.as.Nowhere), 0, sizeof(__r.as) - sizeof(__r.as.Nowhere));
    return __r;
}

#ifndef TUR_CTORALIAS_Nowhere
#define TUR_CTORALIAS_Nowhere
#define ctor_Nowhere ctor_Shape_Nowhere
#endif
...
static void __defer_268(void *__env) {
    ...
    bool __ps_303 = (bt_hyundo_hyto_ex(__e->m));
...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t277 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1617 = (int64_t)__scrut->as.Circle._0;
                __t277 = (INT64_C(3)) * ((r_1617) * (r_1617));
                break;
            }
            case 1: {
                int64_t w_1618 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1619 = (int64_t)__scrut->as.Rect._1;
                __t277 = (w_1618) * (h_1619);
                break;
            }
            case 2: {
                tur_adt_Pt p_1620 = __scrut->as.Dot._0;
                __t277 = INT64_C(0);
                break;
            }
            case 3: {
...
static double dot_hyx(const tur_adt_Shape * s) {
        double __t278 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 2: {
                tur_adt_Pt p_1622 = __scrut->as.Dot._0;
                double __t279 = 0;
                {
                    tur_adt_Pt __scrut = (p_1622);
                    {
                        double x_1623 = (double)__scrut.x;
                        double y_1624 = (double)__scrut.y;
                        __t279 = x_1623;
                        goto ____t280;
                    }
                    ____t280:;
            ...
            case 0: {
                int64_t r_1625 = (int64_t)__scrut->as.Circle._0;
                __t278 = 0.0;
                break;
            }
            case 1: {
                int64_t w_1626 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1627 = (int64_t)__scrut->as.Rect._1;
                __t278 = 0.0;
                break;
            }
            case 3: {
...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        __tur_tailcall:;
        if ((i) == (INT64_C(0))) {
            return acc;
        } else {
            int64_t __t281 = (i) - (INT64_C(1));
            tur_adt_Shape __ps_282 = (ctor_Shape_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Shape __t283 = __ps_282;
            int64_t __ps_284 = (area(&__t283));
            if (tur_panicking) return ((int64_t)0);
            int64_t __t285 = (acc) + (__ps_284);
            i = __t281;
            acc = __t285;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_286 = (ctor_Shape_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t287 = __ps_286;
        int64_t __ps_288 = (area(&__t287));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_288));
        tur_adt_Shape __ps_289 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t290 = __ps_289;
        int64_t __ps_291 = (area(&__t290));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_291));
        tur_adt_Shape __ps_292 = (ctor_Shape_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t293 = __ps_292;
        int64_t __ps_294 = (area(&__t293));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_294));
        tur_adt_Pt __ps_295 = (ctor_Pt_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_296 = (ctor_Shape_Dot(__ps_295));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t297 = __ps_296;
        double __ps_298 = (dot_hyx(&__t297));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_298));
        int64_t __ps_299 = (sum_hyareas(INT64_C(1000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_299));
        int64_t __t300;
        __t300 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_301 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
