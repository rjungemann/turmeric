...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t232 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1474 = (int64_t)__scrut->as.Circle._0;
                __t232 = (INT64_C(3)) * ((r_1474) * (r_1474));
                break;
            }
            case 1: {
                int64_t w_1475 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1476 = (int64_t)__scrut->as.Rect._1;
                __t232 = (w_1475) * (h_1476);
                break;
            }
            case 2: {
                tur_adt_Pt p_1477 = __scrut->as.Dot._0;
                __t232 = INT64_C(0);
                break;
            }
            case 3: {
...
static double dot_hyx(const tur_adt_Shape * s) {
        double __t233 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 2: {
                tur_adt_Pt p_1479 = __scrut->as.Dot._0;
                double __t234 = 0;
                {
                    tur_adt_Pt __scrut = (p_1479);
                    {
                        double x_1480 = (double)__scrut.x;
                        double y_1481 = (double)__scrut.y;
                        __t234 = x_1480;
                        goto ____t235;
                    }
                    ____t235:;
            ...
            case 0: {
                int64_t r_1482 = (int64_t)__scrut->as.Circle._0;
                __t233 = 0.0;
                break;
            }
            case 1: {
                int64_t w_1483 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1484 = (int64_t)__scrut->as.Rect._1;
                __t233 = 0.0;
                break;
            }
            case 3: {
...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        ...
        if ((i) == (INT64_C(0))) {
            ...
            int64_t __t236 = (i) - (INT64_C(1));
            tur_adt_Shape __ps_237 = (ctor_Shape_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Shape __t238 = __ps_237;
            int64_t __ps_239 = (area(&__t238));
            if (tur_panicking) return ((int64_t)0);
            int64_t __t240 = (acc) + (__ps_239);
            i = __t236;
            acc = __t240;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_241 = (ctor_Shape_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t242 = __ps_241;
        int64_t __ps_243 = (area(&__t242));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_243));
        tur_adt_Shape __ps_244 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t245 = __ps_244;
        int64_t __ps_246 = (area(&__t245));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_246));
        tur_adt_Shape __ps_247 = (ctor_Shape_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t248 = __ps_247;
        int64_t __ps_249 = (area(&__t248));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_249));
        tur_adt_Pt __ps_250 = (ctor_Pt_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_251 = (ctor_Shape_Dot(__ps_250));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t252 = __ps_251;
        double __ps_253 = (dot_hyx(&__t252));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_253));
        int64_t __ps_254 = (sum_hyareas(INT64_C(1000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_254));
        int64_t __t255;
        __t255 = INT64_C(0);
