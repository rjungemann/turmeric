...
static int64_t sum_hyareas(int64_t i, int64_t acc) {
        ...
        if ((i) == (INT64_C(0))) {
            ...
            int64_t __t248 = (i) - (INT64_C(1));
            tur_adt_Shape __ps_249 = (ctor_Shape_Circle(INT64_C(2)));
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Shape __t250 = __ps_249;
            int64_t __ps_251 = (area(&__t250));
            if (tur_panicking) return ((int64_t)0);
            int64_t __t252 = (acc) + (__ps_251);
            i = __t248;
            acc = __t252;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Shape __ps_253 = (ctor_Shape_Circle(INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t254 = __ps_253;
        int64_t __ps_255 = (area(&__t254));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_255));
        tur_adt_Shape __ps_256 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t257 = __ps_256;
        int64_t __ps_258 = (area(&__t257));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_258));
        tur_adt_Shape __ps_259 = (ctor_Shape_Nowhere());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t260 = __ps_259;
        int64_t __ps_261 = (area(&__t260));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_261));
        tur_adt_Pt __ps_262 = (ctor_Pt_Pt(7.1, 2.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __ps_263 = (ctor_Shape_Dot(__ps_262));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Shape __t264 = __ps_263;
        double __ps_265 = (dot_hyx(&__t264));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_265));
        int64_t __ps_266 = (sum_hyareas(INT64_C(1000), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_266));
        int64_t __t267;
        __t267 = INT64_C(0);
