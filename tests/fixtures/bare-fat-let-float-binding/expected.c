...
static double __fn_895(void *, double);
...
struct __env_897 { tur_thunk_double_double_t __fn; double k; };
static double __fn_895(void * __env_p_898, double x) {
        struct __env_897 *__env___env_897 = (struct __env_897 *)__env_p_898;
        return (x) * (__env___env_897->k);
}
...
static double run_hywith(void * g, double x) {
        double __t25;
        {
            double y_892 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_892;
            __t25 = y_892;
        }
        return __t25;
...
static void * make_hyscale(double k) {
        struct __env_897 *__t26 = (struct __env_897 *)malloc(sizeof(struct __env_897));
        __t26->__fn = (tur_thunk_double_double_t)__fn_895;
        __t26->k = k;
        void *__t27 = __t26;
        return __t27;
}
