...
static double __fn_884(void *, double);
...
struct __env_886 { tur_thunk_double_double_t __fn; double k; };
static double __fn_884(void * __env_p_887, double x) {
        struct __env_886 *__env___env_886 = (struct __env_886 *)__env_p_887;
        return (x) * (__env___env_886->k);
}
...
static double run_with(void * g, double x) {
        double __t25;
        {
            double y_881 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_881;
            __t25 = y_881;
        }
        return __t25;
...
static void * make_scale(double k) {
        struct __env_886 *__t26 = (struct __env_886 *)malloc(sizeof(struct __env_886));
        __t26->__fn = (tur_thunk_double_double_t)__fn_884;
        __t26->k = k;
        void *__t27 = __t26;
        return __t27;
}
