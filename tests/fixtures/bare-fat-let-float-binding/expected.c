...
static double __fn_860(void *, double);
...
struct __env_862 { tur_thunk_double_double_t __fn; double k; };
static double __fn_860(void * __env_p_863, double x) {
        struct __env_862 *__env___env_862 = (struct __env_862 *)__env_p_863;
        return (x) * (__env___env_862->k);
}
...
static double run_with(void * g, double x) {
        double __t25;
        {
            double y_857 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_857;
            __t25 = y_857;
        }
        return __t25;
...
static void * make_scale(double k) {
        struct __env_862 *__t26 = (struct __env_862 *)malloc(sizeof(struct __env_862));
        __t26->__fn = (tur_thunk_double_double_t)__fn_860;
        __t26->k = k;
        void *__t27 = __t26;
        return __t27;
}
