...
int main() {
        {
            void * a_283 = atomic_new(INT64_C(10));
            (void)a_283;
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_283))));
            {
                int64_t prev_add_284 = atomic_add_((void *)(intptr_t)(a_283), INT64_C(5));
                (void)prev_add_284;
                printf("%lld\n", (long long)(prev_add_284));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_283))));
            }
            {
                int64_t prev_sub_285 = atomic_sub_((void *)(intptr_t)(a_283), INT64_C(3));
                (void)prev_sub_285;
                printf("%lld\n", (long long)(prev_sub_285));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_283))));
            }
            atomic_store_((void *)(intptr_t)(a_283), INT64_C(100));
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_283))));
            {
                int64_t prev_swap_286 = atomic_swap_((void *)(intptr_t)(a_283), INT64_C(42));
                (void)prev_swap_286;
                printf("%lld\n", (long long)(prev_swap_286));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_283))));
            }
            {
                bool ok_287 = atomic_cas_((void *)(intptr_t)(a_283), INT64_C(42), INT64_C(99));
                (void)ok_287;
                puts((ok_287) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_283))));
            }
            {
                bool fail_288 = atomic_cas_((void *)(intptr_t)(a_283), INT64_C(0), INT64_C(1));
                (void)fail_288;
                puts((fail_288) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_283))));
            }
            atomic_free((void *)(intptr_t)(a_283));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
