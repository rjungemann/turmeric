...
int main() {
        {
            void * a_638 = atomic_new(INT64_C(10));
            (void)a_638;
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_638))));
            {
                int64_t prev_add_639 = atomic_add_((void *)(intptr_t)(a_638), INT64_C(5));
                (void)prev_add_639;
                printf("%lld\n", (long long)(prev_add_639));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_638))));
            }
            {
                int64_t prev_sub_640 = atomic_sub_((void *)(intptr_t)(a_638), INT64_C(3));
                (void)prev_sub_640;
                printf("%lld\n", (long long)(prev_sub_640));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_638))));
            }
            atomic_store_((void *)(intptr_t)(a_638), INT64_C(100));
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_638))));
            {
                int64_t prev_swap_641 = atomic_swap_((void *)(intptr_t)(a_638), INT64_C(42));
                (void)prev_swap_641;
                printf("%lld\n", (long long)(prev_swap_641));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_638))));
            }
            {
                bool ok_642 = atomic_cas_((void *)(intptr_t)(a_638), INT64_C(42), INT64_C(99));
                (void)ok_642;
                puts((ok_642) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_638))));
            }
            {
                bool fail_643 = atomic_cas_((void *)(intptr_t)(a_638), INT64_C(0), INT64_C(1));
                (void)fail_643;
                puts((fail_643) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_638))));
            }
            atomic_free((void *)(intptr_t)(a_638));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
