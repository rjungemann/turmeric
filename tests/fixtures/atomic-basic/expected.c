...
int main() {
        {
            ...
            (void)a_43;
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_43))));
            {
                int64_t prev_add_44 = atomic_add_((void *)(intptr_t)(a_43), INT64_C(5));
                (void)prev_add_44;
                printf("%lld\n", (long long)(prev_add_44));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_43))));
            }
            {
                int64_t prev_sub_45 = atomic_sub_((void *)(intptr_t)(a_43), INT64_C(3));
                (void)prev_sub_45;
                printf("%lld\n", (long long)(prev_sub_45));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_43))));
            }
            atomic_store_((void *)(intptr_t)(a_43), INT64_C(100));
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_43))));
            {
                int64_t prev_swap_46 = atomic_swap_((void *)(intptr_t)(a_43), INT64_C(42));
                (void)prev_swap_46;
                printf("%lld\n", (long long)(prev_swap_46));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_43))));
            }
            {
                bool ok_47 = atomic_cas_((void *)(intptr_t)(a_43), INT64_C(42), INT64_C(99));
                (void)ok_47;
                puts((ok_47) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_43))));
            }
            {
                bool fail_48 = atomic_cas_((void *)(intptr_t)(a_43), INT64_C(0), INT64_C(1));
                (void)fail_48;
                puts((fail_48) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_43))));
            }
            atomic_free((void *)(intptr_t)(a_43));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
