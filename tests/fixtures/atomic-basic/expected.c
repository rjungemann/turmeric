...
int main() {
        {
            void * a_218 = atomic_new(INT64_C(10));
            (void)a_218;
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_218))));
            {
                int64_t prev_add_219 = atomic_add_((void *)(intptr_t)(a_218), INT64_C(5));
                (void)prev_add_219;
                printf("%lld\n", (long long)(prev_add_219));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_218))));
            }
            {
                int64_t prev_sub_220 = atomic_sub_((void *)(intptr_t)(a_218), INT64_C(3));
                (void)prev_sub_220;
                printf("%lld\n", (long long)(prev_sub_220));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_218))));
            }
            atomic_store_((void *)(intptr_t)(a_218), INT64_C(100));
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_218))));
            {
                int64_t prev_swap_221 = atomic_swap_((void *)(intptr_t)(a_218), INT64_C(42));
                (void)prev_swap_221;
                printf("%lld\n", (long long)(prev_swap_221));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_218))));
            }
            {
                bool ok_222 = atomic_cas_((void *)(intptr_t)(a_218), INT64_C(42), INT64_C(99));
                (void)ok_222;
                puts((ok_222) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_218))));
            }
            {
                bool fail_223 = atomic_cas_((void *)(intptr_t)(a_218), INT64_C(0), INT64_C(1));
                (void)fail_223;
                puts((fail_223) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_218))));
            }
            atomic_free((void *)(intptr_t)(a_218));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
