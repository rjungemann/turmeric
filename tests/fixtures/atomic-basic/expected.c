...
static int64_t atomic_sub_(void *, int64_t);
...
static void atomic_store_(void * p, int64_t v) {
        int64_t *cell = (int64_t *)p;
...
static int64_t atomic_sub_(void * p, int64_t delta) {
        int64_t *cell = (int64_t *)p;
  return (int64_t)__atomic_fetch_sub(cell, (int64_t)delta, __ATOMIC_SEQ_CST);
  
}

static int64_t atomic_swap_(void * p, int64_t new_val) {
        int64_t *cell = (int64_t *)p;
...
static bool atomic_cas_(void * p, int64_t expected, int64_t desired) {
        int64_t *cell = (int64_t *)p;
...
int main() {
        {
            void * a_230 = atomic_new(INT64_C(10));
            (void)a_230;
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_230))));
            {
                int64_t prev_add_231 = atomic_add_((void *)(intptr_t)(a_230), INT64_C(5));
                (void)prev_add_231;
                printf("%lld\n", (long long)(prev_add_231));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_230))));
            }
            {
                int64_t prev_sub_232 = atomic_sub_((void *)(intptr_t)(a_230), INT64_C(3));
                (void)prev_sub_232;
                printf("%lld\n", (long long)(prev_sub_232));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_230))));
            }
            atomic_store_((void *)(intptr_t)(a_230), INT64_C(100));
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_230))));
            {
                int64_t prev_swap_233 = atomic_swap_((void *)(intptr_t)(a_230), INT64_C(42));
                (void)prev_swap_233;
                printf("%lld\n", (long long)(prev_swap_233));
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_230))));
            }
            {
                bool ok_234 = atomic_cas_((void *)(intptr_t)(a_230), INT64_C(42), INT64_C(99));
                (void)ok_234;
                puts((ok_234) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_230))));
            }
            {
                bool fail_235 = atomic_cas_((void *)(intptr_t)(a_230), INT64_C(0), INT64_C(1));
                (void)fail_235;
                puts((fail_235) ? "true" : "false");
                printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(a_230))));
            }
            atomic_free((void *)(intptr_t)(a_230));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
