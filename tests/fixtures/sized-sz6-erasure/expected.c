...
static int64_t ctor_SVNil() {
    tur_adt_SizedVec *__r = (tur_adt_SizedVec *)malloc(sizeof(tur_adt_SizedVec));
    __r->tag = 0;
    return (int64_t)(intptr_t)__r;
}

static int64_t ctor_SVCons(int64_t _0, int64_t _1) {
    tur_adt_SizedVec *__r = (tur_adt_SizedVec *)malloc(sizeof(tur_adt_SizedVec));
    __r->tag = 1;
    __r->as.SVCons._0 = _0;
    __r->as.SVCons._1 = _1;
...
static int64_t svlen(int64_t v) {
        int64_t __t25 = 0;
        {
            tur_adt_SizedVec *__scrut = (tur_adt_SizedVec *)(intptr_t)(v);
            switch (__scrut->tag) {
            case 0: {
                __t25 = INT64_C(0);
                break;
            ...
            case 1: {
                int64_t _un_893 = (int64_t)__scrut->as.SVCons._0;
                int64_t xs_894 = (int64_t)__scrut->as.SVCons._1;
                __t25 = (INT64_C(1)) + (svlen(xs_894));
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(svlen(ctor_SVCons(INT64_C(7), ctor_SVNil()))));
        int64_t __t26;
        __t26 = INT64_C(0);
        return (int)__t26;
}
