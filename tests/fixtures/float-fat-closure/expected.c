...
static void * make_hyscaler(double);
static void * compose(int64_t, int64_t);
static double run_hywith(int64_t, double);
...
static bool __inst_Eq_eq_qu_Tuple2(int64_t x, int64_t y) {
        return tuple2_hyeq_hycarrier_qu(x, y, (int64_t)(intptr_t)(__fn_788), (int64_t)(intptr_t)(__fn_792));
}
...
static void * make_hyscaler(double k) {
...
static double run_hywith(int64_t h, double x) {
...
int main(int argc, char **argv) {
        ...
        {
            void * f2_910 = make_hyscaler(2.0);
            (void)f2_910;
            void * f3_911 = make_hyscaler(3.0);
            (void)f3_911;
            void * f6_912 = compose((int64_t)(intptr_t)(f2_910), (int64_t)(intptr_t)(f3_911));
            (void)f6_912;
            printf("%g\n", (double)(run_hywith((int64_t)(intptr_t)(f2_910), 1.5)));
            printf("%g\n", (double)(run_hywith((int64_t)(intptr_t)(f3_911), 1.5)));
            printf("%g\n", (double)(run_hywith((int64_t)(intptr_t)(f6_912), 1.0)));
        }
        int64_t __t30;
        __t30 = INT64_C(0);
        return (int)__t30;
