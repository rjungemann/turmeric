...
int main() {
        int64_t __t1;
        {
            void * a_221 = ok(INT64_C(7));
            (void)a_221;
            int64_t __t2;
            {
                void * b_222 = err(INT64_C(99));
                (void)b_222;
                puts((ok_((void *)(intptr_t)(a_221))) ? "true" : "false");
                puts((ok_((void *)(intptr_t)(b_222))) ? "true" : "false");
                printf("%lld\n", (long long)(result_unwrap((void *)(intptr_t)(a_221))));
                printf("%lld\n", (long long)(result_unwrap_or((void *)(intptr_t)(b_222), INT64_C(123))));
                result_free((void *)(intptr_t)(a_221));
                result_free((void *)(intptr_t)(b_222));
                int64_t __t3;
                __t3 = INT64_C(0);
                __t2 = __t3;
            }
