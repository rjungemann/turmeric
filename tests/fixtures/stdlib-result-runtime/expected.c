...
static int64_t result_unwrap_or(void * r, int64_t default_val) {
        int64_t __t0;
        if (ok_((void *)(intptr_t)(r))) {
            __t0 = result_unwrap((void *)(intptr_t)(r));
        } else {
            __t0 = default_val;
        }
        return __t0;
...
int main() {
        int64_t __t1;
        {
            void * a_274 = ok(INT64_C(7));
            (void)a_274;
            int64_t __t2;
            {
                void * b_275 = err(INT64_C(99));
                (void)b_275;
                puts((ok_((void *)(intptr_t)(a_274))) ? "true" : "false");
                puts((ok_((void *)(intptr_t)(b_275))) ? "true" : "false");
                printf("%lld\n", (long long)(result_unwrap((void *)(intptr_t)(a_274))));
                printf("%lld\n", (long long)(result_unwrap_or((void *)(intptr_t)(b_275), INT64_C(123))));
                result_free((void *)(intptr_t)(a_274));
                result_free((void *)(intptr_t)(b_275));
                int64_t __t3;
                __t3 = INT64_C(0);
                __t2 = __t3;
            }
