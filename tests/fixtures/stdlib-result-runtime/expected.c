...
int main() {
        int64_t __t1;
        {
            void * a_209 = ok(INT64_C(7));
            (void)a_209;
            int64_t __t2;
            {
                void * b_210 = err(INT64_C(99));
                (void)b_210;
                puts((ok_((void *)(intptr_t)(a_209))) ? "true" : "false");
                puts((ok_((void *)(intptr_t)(b_210))) ? "true" : "false");
                printf("%lld\n", (long long)(result_unwrap((void *)(intptr_t)(a_209))));
                printf("%lld\n", (long long)(result_unwrap_or((void *)(intptr_t)(b_210), INT64_C(123))));
                result_free((void *)(intptr_t)(a_209));
                result_free((void *)(intptr_t)(b_210));
                int64_t __t3;
                __t3 = INT64_C(0);
                __t2 = __t3;
            }
