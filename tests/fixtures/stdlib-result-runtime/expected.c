...
static void u_result_free(void *);
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_488));
}
...
static int64_t u_result_unwrap(void * r) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *result = (void*)r;
  if (result == NULL || !result->is_ok) {
    fprintf(stderr, "unwrap called on u-err\n");
    return 0;
  }
  return (int)result->ok_val;
...
static int64_t u_result_unwrap_or(void * r, int64_t default_val) {
        int64_t __t0;
        if (u_ok_((void *)(intptr_t)(r))) {
            __t0 = u_result_unwrap((void *)(intptr_t)(r));
        } else {
            __t0 = default_val;
        }
        return __t0;
...
static void u_result_free(void * r) {
        free(r);
...
int main() {
        int64_t __t1;
        {
            void * a_629 = u_ok(INT64_C(7));
            (void)a_629;
            int64_t __t2;
            {
                void * b_630 = u_err(INT64_C(99));
                (void)b_630;
                puts((u_ok_((void *)(intptr_t)(a_629))) ? "true" : "false");
                puts((u_ok_((void *)(intptr_t)(b_630))) ? "true" : "false");
                printf("%lld\n", (long long)(u_result_unwrap((void *)(intptr_t)(a_629))));
                printf("%lld\n", (long long)(u_result_unwrap_or((void *)(intptr_t)(b_630), INT64_C(123))));
                u_result_free((void *)(intptr_t)(a_629));
                u_result_free((void *)(intptr_t)(b_630));
                int64_t __t3;
                __t3 = INT64_C(0);
                __t2 = __t3;
            }
