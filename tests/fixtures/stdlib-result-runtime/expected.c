...
int main() {
        int64_t __t1;
        {
            ...
            int64_t __t2;
            {
                ...
                (void)b_35;
                puts((ok_((void *)(intptr_t)(a_34))) ? "true" : "false");
                puts((ok_((void *)(intptr_t)(b_35))) ? "true" : "false");
                printf("%lld\n", (long long)(result_unwrap((void *)(intptr_t)(a_34))));
                printf("%lld\n", (long long)(result_unwrap_or((void *)(intptr_t)(b_35), INT64_C(123))));
                result_free((void *)(intptr_t)(a_34));
                result_free((void *)(intptr_t)(b_35));
                int64_t __t3;
                __t3 = INT64_C(0);
                __t2 = __t3;
            }
