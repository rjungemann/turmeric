...
static tur_adt_Cons__int * __fn_1623__spec__tur_adt_Cons__int___void__(void *);
...
struct __env_1625 { int64_t __fn; int64_t x; };
...
static int64_t __fn_1623(void * __env_p_1626) {
        ...
        return tcons(__env___env_1625->x, __ps_62);
}
...
__tur_cps_self:;
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_998 = __ps_69;
        bool __ps_70 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_997, (void *)(intptr_t)(k_998), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_70;
        if (__t1) {
            int64_t __ps_71 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_72 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_997, (void *)(intptr_t)(k_998), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t74;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1002 = __ps_76;
            (void)iter_1002;
            void * __ps_77 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_78 = (hamt_slkeyeq((void *)(intptr_t)(__ps_77)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1003 = __ps_78;
            (void)keyeq_1003;
            void * __ps_79 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_80 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1002), (void *)(intptr_t)(__ps_79), (void *)(intptr_t)(keyeq_1003), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1004 = __ps_80;
            (void)result_1004;
...
static int64_t tcons(int64_t h, int64_t t) {
        __auto_type __ps_89 = (ctor_Cons_Cons(h, (int64_t)(intptr_t)(t)));
        if (tur_panicking) return ((int64_t)0);
...
__tur_cps_self:;
    ...
    if (__t0) {
        ...
        if (__t2) {
            ...
            if (tur_panicking) return ((int64_t)0);
            bool __ps_95 = (((bool)(*( tur_thunk_int64_t_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), __ps_93, __ps_94)));
            if (tur_panicking) return ((int64_t)0);
            __t3 = __ps_95;
            if (__t3) {
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if (__ps_102) {
                    ...
                    bool __t104;
                    bool __ps_105 = (tnil_qu(t2_1295));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_105) {
                        __t104 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1294, t2_1295));
                        if (tur_panicking) return ((bool)0);
                        __t104 = __ps_106;
                    }
                    __t101 = __t104;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                int64_t out_1310 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1310;
                __t113 = out_1310;
            }
            __t111 = __t113;
        ...
        if (__ps_118) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1381 = __ps_119;
                (void)h_1381;
                void * __ps_120 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1382 = __ps_120;
                (void)k_1382;
                bool __ps_121 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1381, (void *)(intptr_t)(k_1382), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_121) {
                    void * __t122 = iter;
                    void * __t123 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1385 = __ps_127;
            (void)iter_1385;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1386 = __ps_129;
            (void)keyeq_1386;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1385), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1386)));
            if (tur_panicking) return ((bool)0);
            bool result_1387 = __ps_131;
            (void)result_1387;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1517));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1518 = __ps_154;
                (void)_un_unv_1518;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1568 = __ps_157;
            (void)r_1568;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1568));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                return schema_hydecode_hyvalue(r_1568);
            } else {
                int64_t __ps_159 = (schema_hydecode_hyerrors(r_1568));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t161;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1619 = __ps_162;
            (void)m_1619;
            tur_frame __frame_163;
            tur_frame_init(&__frame_163, NULL);
            struct __defer_env_164 __t166 = {.m = m_1619};
...
static void * pure(int64_t x) {
        void *__t175 = malloc(sizeof(void *) + sizeof(struct __env_1625));
        *(void (**)(void *))__t175 = drop_glue___env_1625;
        struct __env_1625 *__t174 = (struct __env_1625 *)((char *)__t175 + sizeof(void *));
        __t174->__fn = (int64_t)(intptr_t)__fn_1623;
        __t174->x = x;
        TUR_REGION_NOTE_WORDS(&(__t174->x), sizeof(__t174->x));
        void *__t176 = __t174;
        return __t176;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Cons__int * __t177;
        {
            void * __ps_178 = (pure__spec__void___int64_t(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t _un_uncall_unhead_un1628_1629 = (int64_t)(intptr_t)(__ps_178);
            (void)_un_uncall_unhead_un1628_1629;
            tur_adt_Cons__int * __ps_179 = (__fn_1623__spec__tur_adt_Cons__int___void__((void *)(intptr_t)(_un_uncall_unhead_un1628_1629)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t177 = __ps_179;
        }
        int64_t __ps_180 = (thead__spec__int64_t_tur_adt_Cons__int__(__t177));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
...
struct __env_1625__spec__tur_adt_Cons__int__ { int64_t __fn; int64_t x; };
static void drop_glue___env_1625__spec__tur_adt_Cons__int__(void *__p) {
    struct __env_1625__spec__tur_adt_Cons__int__ *__e = (struct __env_1625__spec__tur_adt_Cons__int__ *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static tur_adt_Cons__int * __fn_1623__spec__tur_adt_Cons__int___void__(void * __env_p_1626) {
        struct __env_1625__spec__tur_adt_Cons__int__ *__env___env_1625__spec__tur_adt_Cons__int__ = (struct __env_1625__spec__tur_adt_Cons__int__ *)__env_p_1626;
        tur_adt_Cons__int * __ps_183 = (tnil__spec__tur_adt_Cons__int__());
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        tur_adt_Cons__int * __ps_184 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__env___env_1625__spec__tur_adt_Cons__int__->x, (int64_t)(intptr_t)(__ps_183)));
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        return __ps_184;
}

static void * pure__spec__void___int64_t(int64_t x) {
        void *__t186 = malloc(sizeof(void *) + sizeof(struct __env_1625__spec__tur_adt_Cons__int__));
        *(void (**)(void *))__t186 = drop_glue___env_1625__spec__tur_adt_Cons__int__;
        struct __env_1625__spec__tur_adt_Cons__int__ *__t185 = (struct __env_1625__spec__tur_adt_Cons__int__ *)((char *)__t186 + sizeof(void *));
        __t185->__fn = (int64_t)(intptr_t)__fn_1623__spec__tur_adt_Cons__int___void__;
        __t185->x = x;
        TUR_REGION_NOTE_WORDS(&(__t185->x), sizeof(__t185->x));
        void *__t187 = __t185;
        return __t187;
}
