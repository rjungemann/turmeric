...
static int64_t __fn_1434(void * __env_p_1437) {
        ...
        int64_t __ps_40 = (tnil());
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_41 = (tcons(__env___env_1436->x, __ps_40));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_815 = __ps_74;
        bool __ps_75 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_814, (void *)(intptr_t)(k_815), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_75;
        if (__t1) {
        ...
        if (__ps_125) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1186 = __ps_126;
                (void)h_1186;
                void * __ps_127 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1187 = __ps_127;
                (void)k_1187;
                bool __ps_128 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1186, (void *)(intptr_t)(k_1187), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_128) {
                    void * __t129 = iter;
                    void * __t130 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t132;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_134;
            (void)iter_1190;
            void * __ps_135 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_136 = (hamt_slkeyeq((void *)(intptr_t)(__ps_135)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_136;
            (void)keyeq_1191;
            void * __ps_137 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_138 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_137), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_138;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t159;
        {
            ...
            {
                tur_adt_Vec__int * __ps_161 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_161;
                (void)_un_unv_1320;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t165;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_166;
            (void)r_1370;
            int64_t __t167;
            bool __ps_168 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_168) {
                int64_t __ps_169 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t167 = __ps_169;
            } else {
                int64_t __ps_170 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
...
static void * pure(int64_t x) {
        void *__t183 = malloc(sizeof(void *) + sizeof(struct __env_1436));
        *(void (**)(void *))__t183 = drop_glue___env_1436;
        struct __env_1436 *__t182 = (struct __env_1436 *)((char *)__t183 + sizeof(void *));
        __t182->__fn = (int64_t)(intptr_t)__fn_1434;
        __t182->x = x;
        void *__t184 = __t182;
        return __t184;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Cons__int * __t185;
        {
            void * __ps_186 = (pure__spec__void___int64_t(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t _un_uncall_unhead_un1439_1440 = (int64_t)(intptr_t)(__ps_186);
            (void)_un_uncall_unhead_un1439_1440;
            tur_adt_Cons__int * __ps_187 = (__fn_1434__spec__tur_adt_Cons__int___void__((void *)(intptr_t)(_un_uncall_unhead_un1439_1440)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t185 = __ps_187;
        }
        int64_t __ps_188 = (thead__spec__int64_t_tur_adt_Cons__int__(__t185));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_188));
        int64_t __t189;
        __t189 = INT64_C(0);
...
static tur_adt_Cons__int * __fn_1434__spec__tur_adt_Cons__int___void__(void * __env_p_1437) {
        ...
        int64_t __ps_192 = (tnil());
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        tur_adt_Cons__int * __ps_193 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__env___env_1436__spec__tur_adt_Cons__int__->x, __ps_192));
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        return __ps_193;
}

static void * pure__spec__void___int64_t(int64_t x) {
        void *__t195 = malloc(sizeof(void *) + sizeof(struct __env_1436__spec__tur_adt_Cons__int__));
        *(void (**)(void *))__t195 = drop_glue___env_1436__spec__tur_adt_Cons__int__;
        struct __env_1436__spec__tur_adt_Cons__int__ *__t194 = (struct __env_1436__spec__tur_adt_Cons__int__ *)((char *)__t195 + sizeof(void *));
        __t194->__fn = (int64_t)(intptr_t)__fn_1434__spec__tur_adt_Cons__int___void__;
        __t194->x = x;
        void *__t196 = __t194;
        return __t196;
}
