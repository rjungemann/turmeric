...
static tur_adt_Cons__int * __fn_1434__spec__tur_adt_Cons__int___void__(void *);
...
static int64_t ctor_Cons(int64_t _0, int64_t _1) {
    fprintf(stderr, "tur: internal error: base constructor 'ctor_Cons' of a parametric type has no definition; a call reached the dead base generic path instead of a per-spec clone\n");
    abort();
}
...
struct __env_1436 { int64_t __fn; int64_t x; };
...
static int64_t __fn_1434(void * __env_p_1437) {
        ...
        int64_t __ps_44 = (tnil());
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_45 = (tcons(__env___env_1436->x, __ps_44));
        if (tur_panicking) return ((int64_t)0);
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_77 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_814, (void *)(intptr_t)(k_815), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_819 = __ps_81;
            (void)iter_819;
            void * __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_820 = __ps_83;
            (void)keyeq_820;
            void * __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_819), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_820), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_821 = __ps_85;
            (void)result_821;
...
static int64_t tcons(int64_t h, int64_t t) {
        __auto_type __ps_95 = (ctor_Cons(h, t));
        if (tur_panicking) return ((int64_t)0);
        return (int64_t)(intptr_t)__ps_95;
}
        ...
        if (__ps_105) {
            bool __t106;
            {
                ...
                if ((t1_1099) == (INT64_C(0))) {
                    __t107 = (t2_1100) == (INT64_C(0));
                } else {
                    bool __t108;
                    if ((t2_1100) == (INT64_C(0))) {
                        __t108 = false;
                    } else {
                        bool __ps_109 = (cons_hyeq_hygo(t1_1099, t2_1100));
                        if (tur_panicking) return ((bool)0);
                        __t108 = __ps_109;
                    }
                    __t107 = __t108;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1115 = (int64_t)(intptr_t)(__ps_120);
                (void)out_1115;
                __t116 = out_1115;
            }
            __t114 = __t116;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_127;
            (void)iter_1190;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_129;
            (void)keyeq_1191;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_131;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_154;
                (void)_un_unv_1320;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t158;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_159;
            (void)r_1370;
            int64_t __t160;
            bool __ps_161 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_161) {
                int64_t __ps_162 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t160 = __ps_162;
            } else {
                int64_t __ps_163 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t166;
        {
            int64_t __ps_167 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1429 = __ps_167;
            (void)m_1429;
            int64_t __ps_168 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1430 = __ps_168;
            (void)r_1430;
            bool __ps_169 = (bt_hyundo_hyto_ex(m_1429));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_169);
            int64_t __t170;
            __t170 = r_1430;
...
static void * pure(int64_t x) {
        void *__t176 = malloc(sizeof(void *) + sizeof(struct __env_1436));
        *(void (**)(void *))__t176 = drop_glue___env_1436;
        struct __env_1436 *__t175 = (struct __env_1436 *)((char *)__t176 + sizeof(void *));
        __t175->__fn = (int64_t)(intptr_t)__fn_1434;
        __t175->x = x;
        void *__t177 = __t175;
        return __t177;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Cons__int * __t178;
        {
            void * __ps_179 = (pure__spec__void___int64_t(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t _un_uncall_unhead_un1439_1440 = (int64_t)(intptr_t)(__ps_179);
            (void)_un_uncall_unhead_un1439_1440;
            tur_adt_Cons__int * __ps_180 = (__fn_1434__spec__tur_adt_Cons__int___void__((void *)(intptr_t)(_un_uncall_unhead_un1439_1440)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t178 = __ps_180;
        }
        int64_t __ps_181 = (thead__spec__int64_t_tur_adt_Cons__int__(__t178));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        int64_t __t182;
        __t182 = INT64_C(0);
...
struct __env_1436__spec__tur_adt_Cons__int__ { int64_t __fn; int64_t x; };
static void drop_glue___env_1436__spec__tur_adt_Cons__int__(void *__p) {
    struct __env_1436__spec__tur_adt_Cons__int__ *__e = (struct __env_1436__spec__tur_adt_Cons__int__ *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static tur_adt_Cons__int * __fn_1434__spec__tur_adt_Cons__int___void__(void * __env_p_1437) {
        struct __env_1436__spec__tur_adt_Cons__int__ *__env___env_1436__spec__tur_adt_Cons__int__ = (struct __env_1436__spec__tur_adt_Cons__int__ *)__env_p_1437;
        int64_t __ps_185 = (tnil());
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        tur_adt_Cons__int * __ps_186 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__env___env_1436__spec__tur_adt_Cons__int__->x, __ps_185));
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        return __ps_186;
}

static void * pure__spec__void___int64_t(int64_t x) {
        void *__t188 = malloc(sizeof(void *) + sizeof(struct __env_1436__spec__tur_adt_Cons__int__));
        *(void (**)(void *))__t188 = drop_glue___env_1436__spec__tur_adt_Cons__int__;
        struct __env_1436__spec__tur_adt_Cons__int__ *__t187 = (struct __env_1436__spec__tur_adt_Cons__int__ *)((char *)__t188 + sizeof(void *));
        __t187->__fn = (int64_t)(intptr_t)__fn_1434__spec__tur_adt_Cons__int___void__;
        __t187->x = x;
        void *__t189 = __t187;
        return __t189;
}
