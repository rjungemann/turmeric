...
static int64_t __fn_1469(void * __env_p_1472) {
        ...
        int64_t __ps_104 = (tnil());
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_105 = (tcons(__env___env_1471->x, __ps_104));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_854 = __ps_138;
        bool __ps_139 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_853, (void *)(intptr_t)(k_854), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_139;
        if (__t1) {
            int64_t __ps_140 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_141 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_853, (void *)(intptr_t)(k_854), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t143;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_858 = __ps_145;
            (void)iter_858;
            void * __ps_146 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_147 = (hamt_slkeyeq((void *)(intptr_t)(__ps_146)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_859 = __ps_147;
            (void)keyeq_859;
            void * __ps_148 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_149 = (map_hyeq_hyloop((void *)(intptr_t)(iter_858), (void *)(intptr_t)(__ps_148), (void *)(intptr_t)(keyeq_859), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_860 = __ps_149;
            (void)result_860;
...
static int64_t none() {
        int64_t __ps_157 = (ctor_Option_None());
        if (tur_panicking) return ((int64_t)0);
        return __ps_157;
}
...
static int64_t tcons(int64_t h, int64_t t) {
        __auto_type __ps_159 = (ctor_Cons_Cons(h, t));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_179) {
            ...
            int64_t __t180;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_184), sizeof(__ps_184));
                int64_t out_1154 = (int64_t)(intptr_t)(__ps_184);
                (void)out_1154;
                __t180 = out_1154;
            }
            __t178 = __t180;
...
static int64_t car(int64_t l) {
        int64_t __ps_185 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_185;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_186 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_186;
}

static bool null_qu(int64_t l) {
        bool __ps_187 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_187;
}

static int64_t length(int64_t l) {
        int64_t __ps_188 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_188;
}
        ...
        if (__ps_189) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1225 = __ps_190;
                (void)h_1225;
                void * __ps_191 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1226 = __ps_191;
                (void)k_1226;
                bool __ps_192 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1225, (void *)(intptr_t)(k_1226), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_192) {
                    void * __t193 = iter;
                    void * __t194 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t196;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1229 = __ps_198;
            (void)iter_1229;
            void * __ps_199 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_200 = (hamt_slkeyeq((void *)(intptr_t)(__ps_199)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1230 = __ps_200;
            (void)keyeq_1230;
            void * __ps_201 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_202 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1229), (void *)(intptr_t)(__ps_201), (void *)(intptr_t)(keyeq_1230)));
            if (tur_panicking) return ((bool)0);
            bool result_1231 = __ps_202;
            (void)result_1231;
        ...
        if ((i) == (cap)) {
            ...
            if (__ps_210) {
                ...
                if (__ps_214) {
                    ...
                    if (tur_panicking) return ((bool)0);
                    bool __ps_220 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_216, __ps_219));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_220) {
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t223;
        {
            ...
            {
                tur_adt_Vec__int * __ps_225 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1361));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1362 = __ps_225;
                (void)_un_unv_1362;
        ...
        int64_t __ps_227 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t223))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_227;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_228 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_228);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t229;
        {
            int64_t __ps_230 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1412 = __ps_230;
            (void)r_1412;
            int64_t __t231;
            bool __ps_232 = (schema_hydecode_hyok_qu(r_1412));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_232) {
                int64_t __ps_233 = (schema_hydecode_hyvalue(r_1412));
                if (tur_panicking) return ((int64_t)0);
                __t231 = __ps_233;
            } else {
                int64_t __ps_234 = (schema_hydecode_hyerrors(r_1412));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_235 = (schema_hydecode_hyabort(__ps_234));
                if (tur_panicking) return ((int64_t)0);
                __t231 = __ps_235;
            }
            __t229 = __t231;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_236 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_236;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t237;
        {
            int64_t __ps_238 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1463 = __ps_238;
            (void)m_1463;
            int64_t __ps_239 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1464 = __ps_239;
            (void)r_1464;
            bool __ps_240 = (bt_hyundo_hyto_ex(m_1463));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_240);
            int64_t __t241;
            __t241 = r_1464;
...
static void * pure(int64_t x) {
        void *__t248 = malloc(sizeof(void *) + sizeof(struct __env_1471));
        *(void (**)(void *))__t248 = drop_glue___env_1471;
        struct __env_1471 *__t247 = (struct __env_1471 *)((char *)__t248 + sizeof(void *));
        __t247->__fn = (int64_t)(intptr_t)__fn_1469;
        __t247->x = x;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Cons__int * __t250;
        {
            void * __ps_251 = (pure__spec__void___int64_t(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t _un_uncall_unhead_un1474_1475 = (int64_t)(intptr_t)(__ps_251);
            (void)_un_uncall_unhead_un1474_1475;
            tur_adt_Cons__int * __ps_252 = (__fn_1469__spec__tur_adt_Cons__int___void__((void *)(intptr_t)(_un_uncall_unhead_un1474_1475)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t250 = __ps_252;
        }
        int64_t __ps_253 = (thead__spec__int64_t_tur_adt_Cons__int__(__t250));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_253));
        int64_t __t254;
        __t254 = INT64_C(0);
...
static tur_adt_Cons__int * __fn_1469__spec__tur_adt_Cons__int___void__(void * __env_p_1472) {
        ...
        int64_t __ps_257 = (tnil());
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        tur_adt_Cons__int * __ps_258 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__env___env_1471__spec__tur_adt_Cons__int__->x, __ps_257));
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        return __ps_258;
}

static void * pure__spec__void___int64_t(int64_t x) {
        void *__t260 = malloc(sizeof(void *) + sizeof(struct __env_1471__spec__tur_adt_Cons__int__));
        *(void (**)(void *))__t260 = drop_glue___env_1471__spec__tur_adt_Cons__int__;
        struct __env_1471__spec__tur_adt_Cons__int__ *__t259 = (struct __env_1471__spec__tur_adt_Cons__int__ *)((char *)__t260 + sizeof(void *));
        __t259->__fn = (int64_t)(intptr_t)__fn_1469__spec__tur_adt_Cons__int___void__;
        __t259->x = x;
        TUR_REGION_NOTE_WORDS(&(__t259->x), sizeof(__t259->x));
        void *__t261 = __t259;
        return __t261;
}
