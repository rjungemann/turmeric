...
static tur_adt_Cons__int * __fn_1368__spec__tur_adt_Cons__int___void__(void *);
...
struct __env_1370 { int64_t __fn; int64_t x; };
...
static int64_t __fn_1368(void * __env_p_1371) {
        ...
        int64_t __ps_45 = (tcons(__env___env_1370->x, __ps_44));
        if (tur_panicking) return ((int64_t)0);
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_77 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_790, (void *)(intptr_t)(k_791), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_795 = __ps_81;
            (void)iter_795;
            void * __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_796 = __ps_83;
            (void)keyeq_796;
            void * __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_795), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_796), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_797 = __ps_85;
            (void)result_797;
        ...
        if (__ps_105) {
            bool __t106;
            {
                ...
                if ((t1_1075) == (INT64_C(0))) {
                    __t107 = (t2_1076) == (INT64_C(0));
                } else {
                    bool __t108;
                    if ((t2_1076) == (INT64_C(0))) {
                        __t108 = false;
                    } else {
                        bool __ps_109 = (cons_hyeq_hygo(t1_1075, t2_1076));
                        if (tur_panicking) return ((bool)0);
                        __t108 = __ps_109;
                    }
                    __t107 = __t108;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1091 = (int64_t)(intptr_t)(__ps_120);
                (void)out_1091;
                __t116 = out_1091;
            }
            __t114 = __t116;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1166 = __ps_127;
            (void)iter_1166;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1167 = __ps_129;
            (void)keyeq_1167;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1166), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1167)));
            if (tur_panicking) return ((bool)0);
            bool result_1168 = __ps_131;
            (void)result_1168;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1295));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1296 = __ps_154;
                (void)_un_unv_1296;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t158;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1346 = __ps_159;
            (void)r_1346;
            int64_t __t160;
            bool __ps_161 = (schema_hydecode_hyok_qu(r_1346));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_161) {
                int64_t __ps_162 = (schema_hydecode_hyvalue(r_1346));
                if (tur_panicking) return ((int64_t)0);
                __t160 = __ps_162;
            } else {
                int64_t __ps_163 = (schema_hydecode_hyerrors(r_1346));
                if (tur_panicking) return ((int64_t)0);
...
static void * pure(int64_t x) {
        void *__t167 = malloc(sizeof(void *) + sizeof(struct __env_1370));
        *(void (**)(void *))__t167 = drop_glue___env_1370;
        struct __env_1370 *__t166 = (struct __env_1370 *)((char *)__t167 + sizeof(void *));
        __t166->__fn = (int64_t)(intptr_t)__fn_1368;
        __t166->x = x;
        void *__t168 = __t166;
        return __t168;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Cons__int * __t169;
        {
            void * __ps_170 = (pure__spec__void___int64_t(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t _un_uncall_unhead_un1373_1374 = (int64_t)(intptr_t)(__ps_170);
            (void)_un_uncall_unhead_un1373_1374;
            tur_adt_Cons__int * __ps_171 = (__fn_1368__spec__tur_adt_Cons__int___void__((void *)(intptr_t)(_un_uncall_unhead_un1373_1374)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t169 = __ps_171;
        }
        int64_t __ps_172 = (thead__spec__int64_t_tur_adt_Cons__int__(__t169));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_172));
        int64_t __t173;
        __t173 = INT64_C(0);
...
struct __env_1370__spec__tur_adt_Cons__int__ { int64_t __fn; int64_t x; };
static void drop_glue___env_1370__spec__tur_adt_Cons__int__(void *__p) {
    struct __env_1370__spec__tur_adt_Cons__int__ *__e = (struct __env_1370__spec__tur_adt_Cons__int__ *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static tur_adt_Cons__int * __fn_1368__spec__tur_adt_Cons__int___void__(void * __env_p_1371) {
        struct __env_1370__spec__tur_adt_Cons__int__ *__env___env_1370__spec__tur_adt_Cons__int__ = (struct __env_1370__spec__tur_adt_Cons__int__ *)__env_p_1371;
        int64_t __ps_176 = (tnil());
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        tur_adt_Cons__int * __ps_177 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__env___env_1370__spec__tur_adt_Cons__int__->x, __ps_176));
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        return __ps_177;
}

static void * pure__spec__void___int64_t(int64_t x) {
        void *__t179 = malloc(sizeof(void *) + sizeof(struct __env_1370__spec__tur_adt_Cons__int__));
        *(void (**)(void *))__t179 = drop_glue___env_1370__spec__tur_adt_Cons__int__;
        struct __env_1370__spec__tur_adt_Cons__int__ *__t178 = (struct __env_1370__spec__tur_adt_Cons__int__ *)((char *)__t179 + sizeof(void *));
        __t178->__fn = (int64_t)(intptr_t)__fn_1368__spec__tur_adt_Cons__int___void__;
        __t178->x = x;
        void *__t180 = __t178;
        return __t180;
}
