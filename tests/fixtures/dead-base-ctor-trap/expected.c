...
static tur_adt_Cons__int * __fn_1328__spec__tur_adt_Cons__int___void__(void *);
...
struct __env_1330 { int64_t __fn; int64_t x; };
...
static int64_t __fn_1328(void * __env_p_1331) {
        ...
        int64_t __ps_43 = (tcons(__env___env_1330->x, __ps_42));
        if (tur_panicking) return ((int64_t)0);
        ...
        if (__ps_102) {
            bool __t103;
            {
                ...
                if ((t1_1036) == (INT64_C(0))) {
                    __t104 = (t2_1037) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_1037) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1036, t2_1037));
                        if (tur_panicking) return ((bool)0);
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1052 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1052;
                __t113 = out_1052;
            }
            __t111 = __t113;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t122;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1127 = __ps_124;
            (void)iter_1127;
            void * __ps_125 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_126 = (hamt_slkeyeq((void *)(intptr_t)(__ps_125)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1128 = __ps_126;
            (void)keyeq_1128;
            void * __ps_127 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_128 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1127), (void *)(intptr_t)(__ps_127), (void *)(intptr_t)(keyeq_1128)));
            if (tur_panicking) return ((bool)0);
            bool result_1129 = __ps_128;
            (void)result_1129;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t149;
        {
            ...
            {
                tur_adt_Vec__int * __ps_151 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1256));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1257 = __ps_151;
                (void)_un_unv_1257;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t154;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1306 = __ps_155;
            (void)r_1306;
            int64_t __t156;
            bool __ps_157 = (schema_hydecode_hyok_qu(r_1306));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_157) {
                int64_t __ps_158 = (schema_hydecode_hyvalue(r_1306));
                if (tur_panicking) return ((int64_t)0);
                __t156 = __ps_158;
            } else {
                int64_t __ps_159 = (schema_hydecode_hyerrors(r_1306));
                if (tur_panicking) return ((int64_t)0);
...
static void * pure(int64_t x) {
        void *__t163 = malloc(sizeof(void *) + sizeof(struct __env_1330));
        *(void (**)(void *))__t163 = drop_glue___env_1330;
        struct __env_1330 *__t162 = (struct __env_1330 *)((char *)__t163 + sizeof(void *));
        __t162->__fn = (int64_t)(intptr_t)__fn_1328;
        __t162->x = x;
        void *__t164 = __t162;
        return __t164;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Cons__int * __t165;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t _un_uncall_unhead_un1333_1334 = (int64_t)(intptr_t)(__ps_166);
            (void)_un_uncall_unhead_un1333_1334;
            tur_adt_Cons__int * __ps_167 = (__fn_1328__spec__tur_adt_Cons__int___void__((void *)(intptr_t)(_un_uncall_unhead_un1333_1334)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t165 = __ps_167;
        }
...
struct __env_1330__spec__tur_adt_Cons__int__ { int64_t __fn; int64_t x; };
static void drop_glue___env_1330__spec__tur_adt_Cons__int__(void *__p) {
    struct __env_1330__spec__tur_adt_Cons__int__ *__e = (struct __env_1330__spec__tur_adt_Cons__int__ *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static tur_adt_Cons__int * __fn_1328__spec__tur_adt_Cons__int___void__(void * __env_p_1331) {
        struct __env_1330__spec__tur_adt_Cons__int__ *__env___env_1330__spec__tur_adt_Cons__int__ = (struct __env_1330__spec__tur_adt_Cons__int__ *)__env_p_1331;
        int64_t __ps_172 = (tnil());
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        tur_adt_Cons__int * __ps_173 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__env___env_1330__spec__tur_adt_Cons__int__->x, __ps_172));
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        return __ps_173;
}

static void * pure__spec__void___int64_t(int64_t x) {
        void *__t175 = malloc(sizeof(void *) + sizeof(struct __env_1330__spec__tur_adt_Cons__int__));
        *(void (**)(void *))__t175 = drop_glue___env_1330__spec__tur_adt_Cons__int__;
        struct __env_1330__spec__tur_adt_Cons__int__ *__t174 = (struct __env_1330__spec__tur_adt_Cons__int__ *)((char *)__t175 + sizeof(void *));
        __t174->__fn = (int64_t)(intptr_t)__fn_1328__spec__tur_adt_Cons__int___void__;
        __t174->x = x;
        void *__t176 = __t174;
        return __t176;
}
