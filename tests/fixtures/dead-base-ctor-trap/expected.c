...
static tur_adt_Cons__int * __fn_1438__spec__tur_adt_Cons__int___void__(void *);
...
struct __env_1440 { int64_t __fn; int64_t x; };
...
static int64_t __fn_1438(void * __env_p_1441) {
        ...
        int64_t __ps_42 = (tnil());
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_43 = (tcons(__env___env_1440->x, __ps_42));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    bool __t1;
    bool __t2;
    bool __ps_74 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t0 = __ps_74;
    if (__t0) {
        int64_t __ps_75 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        h_816 = __ps_75;
        void * __ps_76 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_817 = __ps_76;
        bool __ps_77 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_816, (void *)(intptr_t)(k_817), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_77;
        if (__t1) {
...
static int64_t tcons(int64_t h, int64_t t) {
        __auto_type __ps_97 = (ctor_Cons_Cons(h, t));
        if (tur_panicking) return ((int64_t)0);
...
static int64_t list_hyeq_qu__cps(int64_t l1, int64_t l2, int64_t cmp_fn, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (__t2) {
            ...
            int64_t __ps_101 = (list_hyhead(l1));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_102 = (list_hyhead(l2));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_103 = ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), __ps_101, __ps_102));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t3 = __ps_103;
            if (__t3) {
                int64_t __ps_104 = (list_hytail(l1));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t4 = __ps_104;
                int64_t __ps_105 = (list_hytail(l2));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t5 = __ps_105;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        bool __t106;
        bool __ps_107 = (__inst_Eq_eq_qu_int((int64_t)((tur_adt_Cons *)(intptr_t)(c1))->head, (int64_t)((tur_adt_Cons *)(intptr_t)(c2))->head));
        if (tur_panicking) return ((bool)0);
        if (__ps_107) {
            bool __t108;
            {
                ...
                if ((t1_1101) == (INT64_C(0))) {
                    __t109 = (t2_1102) == (INT64_C(0));
                } else {
                    bool __t110;
                    if ((t2_1102) == (INT64_C(0))) {
                        __t110 = false;
                    } else {
                        bool __ps_111 = (cons_hyeq_hygo(t1_1101, t2_1102));
                        if (tur_panicking) return ((bool)0);
                        __t110 = __ps_111;
                    }
                    __t109 = __t110;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_117) {
            ...
            int64_t __t118;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                __auto_type __t123 = (__ps_122);
                TUR_REGION_NOTE_WORDS(&(__t123), sizeof(__t123));
                int64_t out_1117 = (int64_t)(intptr_t)(__t123);
                (void)out_1117;
                __t118 = out_1117;
            }
            __t116 = __t118;
...
static void * pure(int64_t x) {
        void *__t187 = malloc(sizeof(void *) + sizeof(struct __env_1440));
        *(void (**)(void *))__t187 = drop_glue___env_1440;
        struct __env_1440 *__t186 = (struct __env_1440 *)((char *)__t187 + sizeof(void *));
        __t186->__fn = (int64_t)(intptr_t)__fn_1438;
        __t186->x = x;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Cons__int * __t189;
        {
            void * __ps_190 = (pure__spec__void___int64_t(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t _un_uncall_unhead_un1443_1444 = (int64_t)(intptr_t)(__ps_190);
            (void)_un_uncall_unhead_un1443_1444;
            tur_adt_Cons__int * __ps_191 = (__fn_1438__spec__tur_adt_Cons__int___void__((void *)(intptr_t)(_un_uncall_unhead_un1443_1444)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t189 = __ps_191;
        }
        int64_t __ps_192 = (thead__spec__int64_t_tur_adt_Cons__int__(__t189));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_192));
        int64_t __t193;
        __t193 = INT64_C(0);
...
struct __env_1440__spec__tur_adt_Cons__int__ { int64_t __fn; int64_t x; };
static void drop_glue___env_1440__spec__tur_adt_Cons__int__(void *__p) {
    struct __env_1440__spec__tur_adt_Cons__int__ *__e = (struct __env_1440__spec__tur_adt_Cons__int__ *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static tur_adt_Cons__int * __fn_1438__spec__tur_adt_Cons__int___void__(void * __env_p_1441) {
        struct __env_1440__spec__tur_adt_Cons__int__ *__env___env_1440__spec__tur_adt_Cons__int__ = (struct __env_1440__spec__tur_adt_Cons__int__ *)__env_p_1441;
        int64_t __ps_196 = (tnil());
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        tur_adt_Cons__int * __ps_197 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__env___env_1440__spec__tur_adt_Cons__int__->x, __ps_196));
        if (tur_panicking) return ((tur_adt_Cons__int *)0);
        return __ps_197;
}

static void * pure__spec__void___int64_t(int64_t x) {
        void *__t199 = malloc(sizeof(void *) + sizeof(struct __env_1440__spec__tur_adt_Cons__int__));
        *(void (**)(void *))__t199 = drop_glue___env_1440__spec__tur_adt_Cons__int__;
        struct __env_1440__spec__tur_adt_Cons__int__ *__t198 = (struct __env_1440__spec__tur_adt_Cons__int__ *)((char *)__t199 + sizeof(void *));
        __t198->__fn = (int64_t)(intptr_t)__fn_1438__spec__tur_adt_Cons__int___void__;
        __t198->x = x;
        TUR_REGION_NOTE_WORDS(&(__t198->x), sizeof(__t198->x));
        void *__t200 = __t198;
        return __t200;
}
