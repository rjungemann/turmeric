...
typedef int64_t (*tur_thunk_int64_t_const_char___t)(void *, const char *);
...
static int64_t __fn_861(void *, const char *);
...
static int64_t first_byte(const char *);
static int64_t call_s(void *, const char *);
static void * make_scorer(int64_t);
...
struct __env_863 { tur_thunk_int64_t_const_char___t __fn; int64_t n; };
static int64_t __fn_861(void * __env_p_864, const char * s) {
        struct __env_863 *__env___env_863 = (struct __env_863 *)__env_p_864;
        return (__env___env_863->n) + (first_byte(s));
}
...
static int64_t first_byte(const char * s) {
        return (int64_t)(unsigned char)((const char *)(intptr_t)s)[0];
  
}

static int64_t call_s(void * f, const char * s) {
        return TUR_APPLY1_T(int64_t, char *, f, s);
  
}

static void * make_scorer(int64_t n) {
        struct __env_863 *__t7 = (struct __env_863 *)malloc(sizeof(struct __env_863));
        __t7->__fn = (tur_thunk_int64_t_const_char___t)__fn_861;
        __t7->n = n;
        void *__t8 = __t7;
        return __t8;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t9;
        {
            void * f_866 = make_scorer(INT64_C(1));
            (void)f_866;
            int64_t r_867 = call_s((void *)(intptr_t)(f_866), "hello");
            (void)r_867;
            printf("%lld\n", (long long)(r_867));
            int64_t __t10;
            __t10 = INT64_C(0);
