...
static int64_t __fn_896(void *, const char *);
...
static int64_t first_hybyte(const char *);
static int64_t call_hys(void *, const char *);
static void * make_hyscorer(int64_t);
...
struct __env_898 { tur_thunk_int64_t_const_char___t __fn; int64_t n; };
static int64_t __fn_896(void * __env_p_899, const char * s) {
        struct __env_898 *__env___env_898 = (struct __env_898 *)__env_p_899;
        return (__env___env_898->n) + (first_hybyte(s));
}
...
static int64_t first_hybyte(const char * s) {
        return (int64_t)(unsigned char)((const char *)(intptr_t)s)[0];
  
}

static int64_t call_hys(void * f, const char * s) {
        return TUR_APPLY1_T(int64_t, char *, f, s);
  
}

static void * make_hyscorer(int64_t n) {
        struct __env_898 *__t25 = (struct __env_898 *)malloc(sizeof(struct __env_898));
        __t25->__fn = (tur_thunk_int64_t_const_char___t)__fn_896;
        __t25->n = n;
        void *__t26 = __t25;
        return __t26;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            void * f_901 = make_hyscorer(INT64_C(1));
            (void)f_901;
            int64_t r_902 = call_hys((void *)(intptr_t)(f_901), "hello");
            (void)r_902;
            printf("%lld\n", (long long)(r_902));
            int64_t __t28;
            __t28 = INT64_C(0);
