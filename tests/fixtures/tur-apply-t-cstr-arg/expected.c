...
static int64_t __fn_885(void *, const char *);
...
struct __env_887 { tur_thunk_int64_t_const_char___t __fn; int64_t n; };
static int64_t __fn_885(void * __env_p_888, const char * s) {
        struct __env_887 *__env___env_887 = (struct __env_887 *)__env_p_888;
        return (__env___env_887->n) + (first_byte(s));
}
...
static void * make_scorer(int64_t n) {
        ...
        __t25->__fn = (tur_thunk_int64_t_const_char___t)__fn_885;
        __t25->n = n;
        void *__t26 = __t25;
        return __t26;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            void * f_890 = make_scorer(INT64_C(1));
            (void)f_890;
            int64_t r_891 = call_s((void *)(intptr_t)(f_890), "hello");
            (void)r_891;
            printf("%lld\n", (long long)(r_891));
            int64_t __t28;
            __t28 = INT64_C(0);
