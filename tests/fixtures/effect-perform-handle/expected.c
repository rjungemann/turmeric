...
static int64_t use_ask();

static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_208 = __k;
    int64_t __t3 = tur_effect_cont_resume((int64_t)(intptr_t)k_208, (int64_t)INT64_C(41));
    return (int64_t)__t3;
}

static void __handle_body_1(void);
static void __handle_body_1(void) {
    tur_current_fiber->result = (int64_t)use_ask();
}
...
static int64_t use_ask() {
        int64_t __t0 = tur_effect_perform("Ask", NULL, 0);
        return ((INT64_C(1)) + (__t0));
}
...
int main(void) {
    ...
    int64_t __t4 = (int64_t)__dispatch_1(&__cap_1, (int64_t)(intptr_t)__fiber_1, 0);
