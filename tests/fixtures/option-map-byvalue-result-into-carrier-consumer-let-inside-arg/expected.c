...
static int64_t option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t__cps(tur_adt_Option__int o_813, int64_t f, DK *__kont);
static int64_t hamt_slnew__cps(DK *__kont) {
    void * __t0;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_94) {
            bool __t95;
            {
                ...
                bool __t96;
                if ((t1_988) == (INT64_C(0))) {
                    __t96 = (t2_989) == (INT64_C(0));
                } else {
                    bool __t97;
                    if ((t2_989) == (INT64_C(0))) {
                        __t97 = false;
                    } else {
                        __auto_type __ps_98 = (cons_hyeq_hygo(t1_988, t2_989));
                        if (tur_panicking) return (bool){0};
                        __t97 = __ps_98;
                    }
                    __t96 = __t97;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_104) {
            ...
            int64_t __t105;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1004 = (int64_t)(intptr_t)(__ps_109);
                (void)out_1004;
                __t105 = out_1004;
            }
            __t103 = __t105;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t114;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1079 = __ps_116;
            (void)iter_1079;
            __auto_type __ps_117 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_118 = (hamt_slkeyeq((void *)(intptr_t)(__ps_117)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1080 = __ps_118;
            (void)keyeq_1080;
            __auto_type __ps_119 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_120 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1079), (void *)(intptr_t)(__ps_119), (void *)(intptr_t)(keyeq_1080)));
            if (tur_panicking) return (bool){0};
            bool result_1081 = __ps_120;
            (void)result_1081;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t141;
        {
            ...
            {
                __auto_type __ps_143 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1208));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1209 = __ps_143;
                (void)_un_unv_1209;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t146;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1258 = __ps_147;
            (void)r_1258;
            int64_t __t148;
            __auto_type __ps_149 = (schema_hydecode_hyok_qu(r_1258));
            if (tur_panicking) return (int64_t){0};
            if (__ps_149) {
                __auto_type __ps_150 = (schema_hydecode_hyvalue(r_1258));
                if (tur_panicking) return (int64_t){0};
                __t148 = __ps_150;
            } else {
                __auto_type __ps_151 = (schema_hydecode_hyerrors(r_1258));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __t154;
        {
            ...
            void *__t157 = __t156;
            __auto_type __ps_158 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1279, (int64_t)(intptr_t)(__t157)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t154 = __ps_158;
        }
        tur_adt_Option__int __t159 = __t154;
        __auto_type __ps_160 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t159), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_160));
        tur_adt_Option__int __t161;
        __auto_type __ps_162 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t *__t163 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t163[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t163[1] = (int64_t)(intptr_t)__fn_1284;
        void *__t164 = __t163;
        __auto_type __ps_165 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_162, (int64_t)(intptr_t)(__t164)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t161 = __ps_165;
        tur_adt_Option__int __t166 = __t161;
        __auto_type __ps_167 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t166), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_167));
        tur_adt_Option__int __t168;
        if (true) {
            __auto_type __ps_169 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t *__t170 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t170[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t170[1] = (int64_t)(intptr_t)__fn_1287;
            void *__t171 = __t170;
            __auto_type __ps_172 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_169, (int64_t)(intptr_t)(__t171)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t168 = __ps_172;
        } else {
            __auto_type __ps_173 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t *__t174 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t174[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t174[1] = (int64_t)(intptr_t)__fn_1290;
            void *__t175 = __t174;
            __auto_type __ps_176 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_173, (int64_t)(intptr_t)(__t175)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t168 = __ps_176;
        }
        tur_adt_Option__int __t177 = __t168;
        __auto_type __ps_178 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t177), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_178));
        {
            __auto_type __ps_179 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1292 = __ps_179;
            (void)o_1292;
            int64_t *__t180 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t180[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t180[1] = (int64_t)(intptr_t)__fn_1294;
            void *__t181 = __t180;
            __auto_type __ps_182 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1292, (int64_t)(intptr_t)(__t181)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t183 = __ps_182;
            __auto_type __ps_184 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t183), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_184));
        }
        int64_t __t185;
...
static int64_t option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t__cps(tur_adt_Option__int o, int64_t f, DK *__kont) {
    ...
    if ((bool)(o).is_some) {
        __auto_type __ps_190 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), (int64_t)(o).value));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_191 = (some__spec__tur_adt_Option__int_int64_t(__ps_190));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t189 = __ps_191;
    } else {
        __auto_type __ps_192 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t189 = __ps_192;
    }
    __t0 = __t189;
