            ...
            bool __t97;
            {
                ...
                if ((t1_1009) == (INT64_C(0))) {
                    ...
                    if ((t2_1010) == (INT64_C(0))) {
                        ...
                        bool __ps_100 = (cons_hyeq_hygo(t1_1009, t2_1010));
                        if (tur_panicking) return ((bool)0);
                        __t99 = __ps_100;
                    }
                    __t98 = __t99;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t116;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_122 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1100), (void *)(intptr_t)(__ps_121), (void *)(intptr_t)(keyeq_1101)));
            if (tur_panicking) return ((bool)0);
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t143;
        {
            ...
            {
                tur_adt_Vec__int * __ps_145 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1229));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t148;
        {
            ...
            (void)r_1279;
            int64_t __t150;
            bool __ps_151 = (schema_hydecode_hyok_qu(r_1279));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_151) {
                int64_t __ps_152 = (schema_hydecode_hyvalue(r_1279));
                if (tur_panicking) return ((int64_t)0);
                __t150 = __ps_152;
            } else {
                int64_t __ps_153 = (schema_hydecode_hyerrors(r_1279));
                if (tur_panicking) return ((int64_t)0);
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __t156;
        {
            ...
            *(void (**)(void *))__t159 = 0;
            ...
            void *__t160 = __t158;
            tur_adt_Option__int __ps_161 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1300, (int64_t)(intptr_t)(__t160)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t156 = __ps_161;
        }
        tur_adt_Option__int __t162 = __t156;
        int64_t __ps_163 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t162), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_163));
        tur_adt_Option__int __t164;
        tur_adt_Option__int __ps_165 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        *(void (**)(void *))__t167 = 0;
        ...
        void *__t168 = __t166;
        tur_adt_Option__int __ps_169 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_165, (int64_t)(intptr_t)(__t168)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t164 = __ps_169;
        tur_adt_Option__int __t170 = __t164;
        int64_t __ps_171 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t170), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_171));
        ...
        if (true) {
            ...
            *(void (**)(void *))__t175 = 0;
            ...
            tur_adt_Option__int __ps_178 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        int64_t __ps_184 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t183), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_184));
        {
            tur_adt_Option__int __ps_185 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            *(void (**)(void *))__t187 = 0;
            ...
            void *__t188 = __t186;
            tur_adt_Option__int __ps_189 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1313, (int64_t)(intptr_t)(__t188)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t190 = __ps_189;
            int64_t __ps_191 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t190), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_191));
        }
        int64_t __t192;
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_195 = (ctor_Option__int(true, x));
...
static int64_t option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t__cps(tur_adt_Option__int o, int64_t f, DK *__kont) {
    ...
    if ((bool)(o).is_some) {
        int64_t __ps_197 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), (int64_t)(o).value));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Option__int __ps_198 = (some__spec__tur_adt_Option__int_int64_t(__ps_197));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t196 = __ps_198;
    } else {
