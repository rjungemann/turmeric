...
int main(int argc, char **argv) {
        ...
        tur_adt_Option__int __t182;
        {
            ...
            tur_adt_Option__int o_1264 = __ps_183;
            (void)o_1264;
            ...
            void *__t185 = __t184;
            __auto_type __ps_186 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1264, (int64_t)(intptr_t)(__t185)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t182 = __ps_186;
        }
        tur_adt_Option__int __t187 = __t182;
        __auto_type __ps_188 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t187), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_188));
        tur_adt_Option__int __t189;
        __auto_type __ps_190 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t *__t191 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t191[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t191[1] = (int64_t)(intptr_t)__fn_1269;
        void *__t192 = __t191;
        __auto_type __ps_193 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_190, (int64_t)(intptr_t)(__t192)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t189 = __ps_193;
        tur_adt_Option__int __t194 = __t189;
        __auto_type __ps_195 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t194), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_195));
        tur_adt_Option__int __t196;
        if (true) {
            __auto_type __ps_197 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t *__t198 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t198[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t198[1] = (int64_t)(intptr_t)__fn_1272;
            void *__t199 = __t198;
            __auto_type __ps_200 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_197, (int64_t)(intptr_t)(__t199)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t196 = __ps_200;
        } else {
            __auto_type __ps_201 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t *__t202 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t202[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t202[1] = (int64_t)(intptr_t)__fn_1275;
            void *__t203 = __t202;
            __auto_type __ps_204 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_201, (int64_t)(intptr_t)(__t203)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t196 = __ps_204;
        }
        tur_adt_Option__int __t205 = __t196;
        __auto_type __ps_206 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t205), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_206));
        {
            __auto_type __ps_207 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1277 = __ps_207;
            (void)o_1277;
            int64_t *__t208 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t208[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t208[1] = (int64_t)(intptr_t)__fn_1279;
            void *__t209 = __t208;
            __auto_type __ps_210 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1277, (int64_t)(intptr_t)(__t209)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t211 = __ps_210;
            __auto_type __ps_212 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t211), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_212));
        }
        int64_t __t213;
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_215 = (ctor_Option__int(true, x));
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t216;
        if ((bool)(o).is_some) {
            __auto_type __ps_217 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), (int64_t)(o).value));
            if (tur_panicking) return (tur_adt_Option__int){0};
            __auto_type __ps_218 = (some__spec__tur_adt_Option__int_int64_t(__ps_217));
            if (tur_panicking) return (tur_adt_Option__int){0};
            __t216 = __ps_218;
        } else {
            __auto_type __ps_219 = (none__spec__tur_adt_Option__int());
            if (tur_panicking) return (tur_adt_Option__int){0};
            __t216 = __ps_219;
        }
        return __t216;
