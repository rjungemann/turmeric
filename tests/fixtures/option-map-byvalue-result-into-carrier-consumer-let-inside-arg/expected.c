...
int main(int argc, char **argv) {
        ...
        Option__int __t44;
        {
            ...
            (void)o_1005;
            tur_option_t *__t45 = (tur_option_t *)(intptr_t)(o_1005);
            int64_t *__t46 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t46[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t46[1] = (int64_t)(intptr_t)__fn_1007;
            void *__t47 = __t46;
            __t44 = option_map__spec__Option__int_Option__int_int64_t((__t45 ? (Option__int){.is_some = __t45->is_some, .value = __t45->value} : (Option__int){0}), (int64_t)(intptr_t)(__t47));
        }
        Option__int __t48 = __t44;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t48), INT64_C(99))));
        Option__int __t49;
        tur_option_t *__t50 = (tur_option_t *)(intptr_t)(some(INT64_C(4)));
        int64_t *__t51 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t51[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t51[1] = (int64_t)(intptr_t)__fn_1010;
        void *__t52 = __t51;
        __t49 = option_map__spec__Option__int_Option__int_int64_t((__t50 ? (Option__int){.is_some = __t50->is_some, .value = __t50->value} : (Option__int){0}), (int64_t)(intptr_t)(__t52));
        Option__int __t53 = __t49;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t53), INT64_C(99))));
        Option__int __t54;
        if (true) {
            tur_option_t *__t55 = (tur_option_t *)(intptr_t)(some(INT64_C(7)));
            int64_t *__t56 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t56[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t56[1] = (int64_t)(intptr_t)__fn_1013;
            void *__t57 = __t56;
            __t54 = option_map__spec__Option__int_Option__int_int64_t((__t55 ? (Option__int){.is_some = __t55->is_some, .value = __t55->value} : (Option__int){0}), (int64_t)(intptr_t)(__t57));
        } else {
            tur_option_t *__t58 = (tur_option_t *)(intptr_t)(some(INT64_C(0)));
            int64_t *__t59 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t59[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t59[1] = (int64_t)(intptr_t)__fn_1016;
            void *__t60 = __t59;
            __t54 = option_map__spec__Option__int_Option__int_int64_t((__t58 ? (Option__int){.is_some = __t58->is_some, .value = __t58->value} : (Option__int){0}), (int64_t)(intptr_t)(__t60));
        }
        Option__int __t61 = __t54;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t61), INT64_C(99))));
        {
            int64_t o_1018 = some(INT64_C(6));
            (void)o_1018;
            tur_option_t *__t62 = (tur_option_t *)(intptr_t)(o_1018);
            int64_t *__t63 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t63[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t63[1] = (int64_t)(intptr_t)__fn_1020;
            void *__t64 = __t63;
            Option__int __t65 = option_map__spec__Option__int_Option__int_int64_t((__t62 ? (Option__int){.is_some = __t62->is_some, .value = __t62->value} : (Option__int){0}), (int64_t)(intptr_t)(__t64));
            printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t65), INT64_C(0))));
        }
        int64_t __t66;
        __t66 = INT64_C(0);
        return (int)__t66;
