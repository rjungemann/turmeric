...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __t245;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1467 = __ps_246;
            (void)o_1467;
            void *__t247 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
            tur_adt_Option__int __ps_248 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1467, (int64_t)(intptr_t)(__t247)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t245 = __ps_248;
        }
        tur_adt_Option__int __t249 = __t245;
        int64_t __ps_250 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t249), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_250));
        tur_adt_Option__int __t251;
        tur_adt_Option__int __ps_252 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t253 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_254 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_252, (int64_t)(intptr_t)(__t253)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t251 = __ps_254;
        tur_adt_Option__int __t255 = __t251;
        int64_t __ps_256 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t255), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_256));
        tur_adt_Option__int __t257;
        if (true) {
            tur_adt_Option__int __ps_258 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t259 = (void *)((char *)&__tur_fatbox_4 + sizeof(void *));
            tur_adt_Option__int __ps_260 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_258, (int64_t)(intptr_t)(__t259)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t257 = __ps_260;
        } else {
            tur_adt_Option__int __ps_261 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t262 = (void *)((char *)&__tur_fatbox_5 + sizeof(void *));
            tur_adt_Option__int __ps_263 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_261, (int64_t)(intptr_t)(__t262)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t257 = __ps_263;
        }
        tur_adt_Option__int __t264 = __t257;
        int64_t __ps_265 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t264), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_265));
        {
            tur_adt_Option__int __ps_266 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1480 = __ps_266;
            (void)o_1480;
            void *__t267 = (void *)((char *)&__tur_fatbox_6 + sizeof(void *));
            tur_adt_Option__int __ps_268 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1480, (int64_t)(intptr_t)(__t267)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t269 = __ps_268;
            int64_t __ps_270 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t269), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_270));
        }
        int64_t __t271;
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_274 = (ctor_Option_Some__int(x));
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t275 = {0};
        {
            tur_adt_Option__int __scrut_v = (o);
            tur_adt_Option__int *__scrut = &__scrut_v;
            switch (__scrut->tag) {
            case 1: {
                int64_t v_933 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_276 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_933));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_277 = (some__spec__tur_adt_Option__int_int64_t(__ps_276));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t275 = __ps_277;
                break;
            }
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_279 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_279;
}
...
static void __tur_fatbox_init(void) {
    ...
    { char *__b = (char *)&__tur_fatbox_6;
      int64_t *__s = (int64_t *)(__b + sizeof(void *));
      __s[0] = (int64_t)(intptr_t)__tur_fatshim1;
      __s[1] = (int64_t)(intptr_t)__fn_1482; }
}
