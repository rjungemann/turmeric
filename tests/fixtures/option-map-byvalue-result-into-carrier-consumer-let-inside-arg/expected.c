...
static int64_t __fn_1261(int64_t);
...
static int64_t __fn_1261(int64_t x) {
        return (x) * (INT64_C(5));
}
...
int main(int argc, char **argv) {
        ...
        Option__int __t55;
        {
            Option__int o_1246 = some__spec__Option__int_int64_t(INT64_C(5));
            (void)o_1246;
            int64_t *__t56 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t56[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t56[1] = (int64_t)(intptr_t)__fn_1248;
            void *__t57 = __t56;
            __t55 = option_map__spec__Option__int_Option__int_int64_t(o_1246, (int64_t)(intptr_t)(__t57));
        }
        Option__int __t58 = __t55;
        ...
        __t60[1] = (int64_t)(intptr_t)__fn_1251;
        void *__t61 = __t60;
        __t59 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(4)), (int64_t)(intptr_t)(__t61));
        Option__int __t62 = __t59;
        ...
        if (true) {
            ...
            __t64[1] = (int64_t)(intptr_t)__fn_1254;
            void *__t65 = __t64;
            __t63 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(7)), (int64_t)(intptr_t)(__t65));
        } else {
            int64_t *__t66 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t66[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t66[1] = (int64_t)(intptr_t)__fn_1257;
            void *__t67 = __t66;
            __t63 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(0)), (int64_t)(intptr_t)(__t67));
        }
        Option__int __t68 = __t63;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t68), INT64_C(99))));
        {
            Option__int o_1259 = some__spec__Option__int_int64_t(INT64_C(6));
            (void)o_1259;
            int64_t *__t69 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t69[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t69[1] = (int64_t)(intptr_t)__fn_1261;
            void *__t70 = __t69;
            Option__int __t71 = option_map__spec__Option__int_Option__int_int64_t(o_1259, (int64_t)(intptr_t)(__t70));
...
static Option__int option_map__spec__Option__int_Option__int_int64_t(Option__int o, int64_t f) {
        Option__int __t74;
        if ((o).is_some) {
            __t74 = some__spec__Option__int_int64_t((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), (o).value));
        } else {
            __t74 = none__spec__Option__int();
        }
        return __t74;
}
