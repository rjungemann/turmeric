...
static int64_t __fn_1451(int64_t);
...
static int64_t __fn_1441(int64_t x) {
        return (x) * (INT64_C(2));
}

static int64_t __fn_1444(int64_t x) {
        return (x) * (INT64_C(3));
}
...
static int64_t __fn_1451(int64_t x) {
        return (x) * (INT64_C(5));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __t184;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1436 = __ps_185;
            (void)o_1436;
            void *__t186 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
            tur_adt_Option__int __ps_187 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1436, (int64_t)(intptr_t)(__t186)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t184 = __ps_187;
        }
        tur_adt_Option__int __t188 = __t184;
        int64_t __ps_189 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t188), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        tur_adt_Option__int __t190;
        tur_adt_Option__int __ps_191 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t190 = __ps_193;
        tur_adt_Option__int __t194 = __t190;
        int64_t __ps_195 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t194), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_195));
        ...
        if (true) {
            ...
            tur_adt_Option__int __ps_199 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_197, (int64_t)(intptr_t)(__t198)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t196 = __ps_199;
        } else {
            tur_adt_Option__int __ps_200 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t201 = (void *)((char *)&__tur_fatbox_5 + sizeof(void *));
            tur_adt_Option__int __ps_202 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_200, (int64_t)(intptr_t)(__t201)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t196 = __ps_202;
        }
        tur_adt_Option__int __t203 = __t196;
        int64_t __ps_204 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t203), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_204));
        {
            tur_adt_Option__int __ps_205 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1449 = __ps_205;
            (void)o_1449;
            void *__t206 = (void *)((char *)&__tur_fatbox_6 + sizeof(void *));
            tur_adt_Option__int __ps_207 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1449, (int64_t)(intptr_t)(__t206)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t208 = __ps_207;
            int64_t __ps_209 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t208), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_209));
        }
        int64_t __t210;
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t214 = {0};
        {
            tur_adt_Option__int __scrut_v = (o);
            tur_adt_Option__int *__scrut = &__scrut_v;
            switch (__scrut->tag) {
            case 1: {
                int64_t v_896 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_215 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_896));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_216 = (some__spec__tur_adt_Option__int_int64_t(__ps_215));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t214 = __ps_216;
                break;
            }
