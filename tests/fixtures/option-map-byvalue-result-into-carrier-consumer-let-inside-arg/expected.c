...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __t265;
        {
            tur_adt_Option__int __ps_266 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1467 = __ps_266;
            (void)o_1467;
            void *__t267 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
            tur_adt_Option__int __ps_268 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1467, (int64_t)(intptr_t)(__t267)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t265 = __ps_268;
        }
        tur_adt_Option__int __t269 = __t265;
        int64_t __ps_270 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t269), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_270));
        tur_adt_Option__int __t271;
        tur_adt_Option__int __ps_272 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t273 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_274 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_272, (int64_t)(intptr_t)(__t273)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t271 = __ps_274;
        tur_adt_Option__int __t275 = __t271;
        int64_t __ps_276 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t275), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_276));
        tur_adt_Option__int __t277;
        if (true) {
            tur_adt_Option__int __ps_278 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t279 = (void *)((char *)&__tur_fatbox_4 + sizeof(void *));
            tur_adt_Option__int __ps_280 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_278, (int64_t)(intptr_t)(__t279)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t277 = __ps_280;
        } else {
            tur_adt_Option__int __ps_281 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t282 = (void *)((char *)&__tur_fatbox_5 + sizeof(void *));
            tur_adt_Option__int __ps_283 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_281, (int64_t)(intptr_t)(__t282)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t277 = __ps_283;
        }
        tur_adt_Option__int __t284 = __t277;
        int64_t __ps_285 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t284), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_285));
        {
            tur_adt_Option__int __ps_286 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1480 = __ps_286;
            (void)o_1480;
            void *__t287 = (void *)((char *)&__tur_fatbox_6 + sizeof(void *));
            tur_adt_Option__int __ps_288 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1480, (int64_t)(intptr_t)(__t287)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t289 = __ps_288;
            int64_t __ps_290 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t289), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_290));
        }
        int64_t __t291;
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t295 = {0};
        {
            ...
            case 1: {
                ...
                int64_t __ps_296 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_933));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_297 = (some__spec__tur_adt_Option__int_int64_t(__ps_296));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t295 = __ps_297;
                break;
            }
