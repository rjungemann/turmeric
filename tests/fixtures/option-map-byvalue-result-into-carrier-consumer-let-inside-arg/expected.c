...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __t233;
        {
            tur_adt_Option__int __ps_234 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1463 = __ps_234;
            (void)o_1463;
            void *__t235 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
            tur_adt_Option__int __ps_236 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1463, (int64_t)(intptr_t)(__t235)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t233 = __ps_236;
        }
        tur_adt_Option__int __t237 = __t233;
        int64_t __ps_238 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t237), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_238));
        tur_adt_Option__int __t239;
        tur_adt_Option__int __ps_240 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t241 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        tur_adt_Option__int __ps_242 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_240, (int64_t)(intptr_t)(__t241)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t239 = __ps_242;
        tur_adt_Option__int __t243 = __t239;
        int64_t __ps_244 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t243), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_244));
        tur_adt_Option__int __t245;
        if (true) {
            tur_adt_Option__int __ps_246 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t247 = (void *)((char *)&__tur_fatbox_4 + sizeof(void *));
            tur_adt_Option__int __ps_248 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_246, (int64_t)(intptr_t)(__t247)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t245 = __ps_248;
        } else {
            tur_adt_Option__int __ps_249 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t250 = (void *)((char *)&__tur_fatbox_5 + sizeof(void *));
            tur_adt_Option__int __ps_251 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_249, (int64_t)(intptr_t)(__t250)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t245 = __ps_251;
        }
        tur_adt_Option__int __t252 = __t245;
        int64_t __ps_253 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t252), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_253));
        {
            tur_adt_Option__int __ps_254 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1476 = __ps_254;
            (void)o_1476;
            void *__t255 = (void *)((char *)&__tur_fatbox_6 + sizeof(void *));
            tur_adt_Option__int __ps_256 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1476, (int64_t)(intptr_t)(__t255)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t257 = __ps_256;
            int64_t __ps_258 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t257), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_258));
        }
        int64_t __t259;
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t263 = {0};
        {
            tur_adt_Option__int __scrut_v = (o);
            tur_adt_Option__int *__scrut = &__scrut_v;
            switch (__scrut->tag) {
            case 1: {
                int64_t v_921 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_264 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_921));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_265 = (some__spec__tur_adt_Option__int_int64_t(__ps_264));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t263 = __ps_265;
                break;
            }
            case 0: {
                tur_adt_Option__int __ps_266 = (none__spec__tur_adt_Option__int());
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t263 = __ps_266;
                break;
            }
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_267 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_267;
}
...
static void __tur_fatbox_init(void) {
    ...
    { char *__b = (char *)&__tur_fatbox_6;
      int64_t *__s = (int64_t *)(__b + sizeof(void *));
      __s[0] = (int64_t)(intptr_t)__tur_fatshim1;
      __s[1] = (int64_t)(intptr_t)__fn_1478; }
}
