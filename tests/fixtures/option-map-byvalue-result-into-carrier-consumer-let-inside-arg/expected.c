...
static int64_t __fn_1033(int64_t);
...
static int64_t __fn_1027(int64_t x) {
        return (x) * (INT64_C(2));
}

static int64_t __fn_1030(int64_t x) {
        return (x) * (INT64_C(3));
}

static int64_t __fn_1033(int64_t x) {
        return x;
}

static int64_t __fn_1037(int64_t x) {
        return (x) * (INT64_C(5));
}
...
int main(int argc, char **argv) {
        ...
        Option__int __t44;
        {
            Option__int o_1022 = some__spec__Option__int_int64_t(INT64_C(5));
            (void)o_1022;
            int64_t *__t45 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t45[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t45[1] = (int64_t)(intptr_t)__fn_1024;
            void *__t46 = __t45;
            __t44 = option_map__spec__Option__int_Option__int_int64_t(o_1022, (int64_t)(intptr_t)(__t46));
        }
        Option__int __t47 = __t44;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t47), INT64_C(99))));
        Option__int __t48;
        int64_t *__t49 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t49[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t49[1] = (int64_t)(intptr_t)__fn_1027;
        void *__t50 = __t49;
        __t48 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(4)), (int64_t)(intptr_t)(__t50));
        Option__int __t51 = __t48;
        ...
        if (true) {
            ...
            __t53[1] = (int64_t)(intptr_t)__fn_1030;
            void *__t54 = __t53;
            __t52 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(7)), (int64_t)(intptr_t)(__t54));
        } else {
            int64_t *__t55 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t55[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t55[1] = (int64_t)(intptr_t)__fn_1033;
            void *__t56 = __t55;
            __t52 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(0)), (int64_t)(intptr_t)(__t56));
        }
        Option__int __t57 = __t52;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t57), INT64_C(99))));
        {
            Option__int o_1035 = some__spec__Option__int_int64_t(INT64_C(6));
            (void)o_1035;
            int64_t *__t58 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t58[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t58[1] = (int64_t)(intptr_t)__fn_1037;
            void *__t59 = __t58;
            Option__int __t60 = option_map__spec__Option__int_Option__int_int64_t(o_1035, (int64_t)(intptr_t)(__t59));
            printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t60), INT64_C(0))));
        }
        int64_t __t61;
        __t61 = INT64_C(0);
        return (int)__t61;
