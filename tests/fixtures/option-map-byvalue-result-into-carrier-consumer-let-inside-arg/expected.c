...
static int64_t __fn_1012(int64_t);
static int64_t __fn_1015(int64_t);
...
static int64_t __fn_1012(int64_t x) {
        return (x) * (INT64_C(2));
}

static int64_t __fn_1015(int64_t x) {
        return (x) * (INT64_C(3));
}

static int64_t __fn_1018(int64_t x) {
        return x;
}
...
int main(int argc, char **argv) {
        ...
        Option__int __t51;
        {
            int64_t o_1007 = some(INT64_C(5));
            (void)o_1007;
            tur_option_t *__t52 = (tur_option_t *)(intptr_t)(o_1007);
            int64_t *__t53 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t53[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t53[1] = (int64_t)(intptr_t)__fn_1009;
            void *__t54 = __t53;
            __t51 = option_map__spec__Option__int_Option__int_int64_t((__t52 ? (Option__int){.is_some = __t52->is_some, .value = __t52->value} : (Option__int){0}), (int64_t)(intptr_t)(__t54));
        }
        Option__int __t55 = __t51;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t55), INT64_C(99))));
        Option__int __t56;
        tur_option_t *__t57 = (tur_option_t *)(intptr_t)(some(INT64_C(4)));
        int64_t *__t58 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t58[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t58[1] = (int64_t)(intptr_t)__fn_1012;
        void *__t59 = __t58;
        __t56 = option_map__spec__Option__int_Option__int_int64_t((__t57 ? (Option__int){.is_some = __t57->is_some, .value = __t57->value} : (Option__int){0}), (int64_t)(intptr_t)(__t59));
        Option__int __t60 = __t56;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t60), INT64_C(99))));
        Option__int __t61;
        if (true) {
            tur_option_t *__t62 = (tur_option_t *)(intptr_t)(some(INT64_C(7)));
            int64_t *__t63 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t63[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t63[1] = (int64_t)(intptr_t)__fn_1015;
            void *__t64 = __t63;
            __t61 = option_map__spec__Option__int_Option__int_int64_t((__t62 ? (Option__int){.is_some = __t62->is_some, .value = __t62->value} : (Option__int){0}), (int64_t)(intptr_t)(__t64));
        } else {
            tur_option_t *__t65 = (tur_option_t *)(intptr_t)(some(INT64_C(0)));
            int64_t *__t66 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t66[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t66[1] = (int64_t)(intptr_t)__fn_1018;
            void *__t67 = __t66;
            __t61 = option_map__spec__Option__int_Option__int_int64_t((__t65 ? (Option__int){.is_some = __t65->is_some, .value = __t65->value} : (Option__int){0}), (int64_t)(intptr_t)(__t67));
        }
        Option__int __t68 = __t61;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t68), INT64_C(99))));
        {
            int64_t o_1020 = some(INT64_C(6));
            (void)o_1020;
            tur_option_t *__t69 = (tur_option_t *)(intptr_t)(o_1020);
            int64_t *__t70 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t70[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t70[1] = (int64_t)(intptr_t)__fn_1022;
            void *__t71 = __t70;
            Option__int __t72 = option_map__spec__Option__int_Option__int_int64_t((__t69 ? (Option__int){.is_some = __t69->is_some, .value = __t69->value} : (Option__int){0}), (int64_t)(intptr_t)(__t71));
            printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t72), INT64_C(0))));
        }
        int64_t __t73;
        __t73 = INT64_C(0);
        return (int)__t73;
