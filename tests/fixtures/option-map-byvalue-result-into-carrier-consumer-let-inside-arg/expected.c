...
int main(int argc, char **argv) {
        ...
        tur_adt_Option__int __t178;
        {
            ...
            tur_adt_Option__int o_1267 = __ps_179;
            (void)o_1267;
            ...
            void *__t181 = __t180;
            __auto_type __ps_182 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1267, (int64_t)(intptr_t)(__t181)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t178 = __ps_182;
        }
        tur_adt_Option__int __t183 = __t178;
        __auto_type __ps_184 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t183), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_184));
        tur_adt_Option__int __t185;
        __auto_type __ps_186 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t *__t187 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t187[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t187[1] = (int64_t)(intptr_t)__fn_1272;
        void *__t188 = __t187;
        __auto_type __ps_189 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_186, (int64_t)(intptr_t)(__t188)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t185 = __ps_189;
        tur_adt_Option__int __t190 = __t185;
        __auto_type __ps_191 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t190), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_191));
        ...
        if (true) {
            ...
            __t194[1] = (int64_t)(intptr_t)__fn_1275;
            void *__t195 = __t194;
            __auto_type __ps_196 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_193, (int64_t)(intptr_t)(__t195)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t192 = __ps_196;
        } else {
            __auto_type __ps_197 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t *__t198 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t198[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t198[1] = (int64_t)(intptr_t)__fn_1278;
            void *__t199 = __t198;
            __auto_type __ps_200 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_197, (int64_t)(intptr_t)(__t199)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t192 = __ps_200;
        }
        tur_adt_Option__int __t201 = __t192;
        __auto_type __ps_202 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t201), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_202));
        {
            __auto_type __ps_203 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1280 = __ps_203;
            (void)o_1280;
            int64_t *__t204 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t204[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t204[1] = (int64_t)(intptr_t)__fn_1282;
            void *__t205 = __t204;
            __auto_type __ps_206 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1280, (int64_t)(intptr_t)(__t205)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t207 = __ps_206;
            __auto_type __ps_208 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t207), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_208));
        }
        int64_t __t209;
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        ...
        if ((bool)(o).is_some) {
            __auto_type __ps_214 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), (int64_t)(o).value));
            if (tur_panicking) return (tur_adt_Option__int){0};
            __auto_type __ps_215 = (some__spec__tur_adt_Option__int_int64_t(__ps_214));
            if (tur_panicking) return (tur_adt_Option__int){0};
            __t213 = __ps_215;
        } else {
