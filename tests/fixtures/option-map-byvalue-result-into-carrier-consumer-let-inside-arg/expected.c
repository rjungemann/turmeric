...
static int64_t __fn_1449(int64_t);
...
static int64_t __fn_1442(int64_t x) {
        return (x) * (INT64_C(3));
}

static int64_t __fn_1445(int64_t x) {
        return x;
}

static int64_t __fn_1449(int64_t x) {
        return (x) * (INT64_C(5));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __t180;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1434 = __ps_181;
            (void)o_1434;
            void *__t182 = (void *)((char *)&__tur_fatbox_2 + sizeof(void *));
            tur_adt_Option__int __ps_183 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1434, (int64_t)(intptr_t)(__t182)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t180 = __ps_183;
        }
        ...
        tur_adt_Option__int __ps_187 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        void *__t188 = (void *)((char *)&__tur_fatbox_3 + sizeof(void *));
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t186 = __ps_189;
        tur_adt_Option__int __t190 = __t186;
        int64_t __ps_191 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t190), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_191));
        ...
        if (true) {
            ...
            tur_adt_Option__int __ps_195 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(__ps_193, (int64_t)(intptr_t)(__t194)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t192 = __ps_195;
        } else {
            tur_adt_Option__int __ps_196 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t197 = (void *)((char *)&__tur_fatbox_5 + sizeof(void *));
        ...
        tur_adt_Option__int __t199 = __t192;
        int64_t __ps_200 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t199), INT64_C(99)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_200));
        {
            tur_adt_Option__int __ps_201 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(6)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int o_1447 = __ps_201;
            (void)o_1447;
            void *__t202 = (void *)((char *)&__tur_fatbox_6 + sizeof(void *));
            tur_adt_Option__int __ps_203 = (option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(o_1447, (int64_t)(intptr_t)(__t202)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __t204 = __ps_203;
            int64_t __ps_205 = (unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t204), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_205));
        }
        int64_t __t206;
...
static tur_adt_Option__int option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t(tur_adt_Option__int o, int64_t f) {
        tur_adt_Option__int __t210 = {0};
        {
            tur_adt_Option__int __scrut_v = (o);
            tur_adt_Option__int *__scrut = &__scrut_v;
            switch (__scrut->tag) {
            case 1: {
                int64_t v_895 = (int64_t)__scrut->as.Some._0;
                int64_t __ps_211 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), v_895));
                if (tur_panicking) return (tur_adt_Option__int){0};
                tur_adt_Option__int __ps_212 = (some__spec__tur_adt_Option__int_int64_t(__ps_211));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t210 = __ps_212;
                break;
            }
...
static void __tur_fatbox_init(void) {
    ...
    { char *__b = (char *)&__tur_fatbox_6;
      int64_t *__s = (int64_t *)(__b + sizeof(void *));
      __s[0] = (int64_t)(intptr_t)__tur_fatshim1;
      __s[1] = (int64_t)(intptr_t)__fn_1449; }
}
