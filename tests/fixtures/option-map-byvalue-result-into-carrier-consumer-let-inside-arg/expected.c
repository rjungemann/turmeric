...
static int64_t __fn_1035(int64_t);
...
static int64_t __fn_1025(int64_t x) {
        return (x) * (INT64_C(2));
}

static int64_t __fn_1028(int64_t x) {
        return (x) * (INT64_C(3));
}

static int64_t __fn_1031(int64_t x) {
        return x;
}

static int64_t __fn_1035(int64_t x) {
        return (x) * (INT64_C(5));
}
...
int main(int argc, char **argv) {
        ...
        Option__int __t42;
        {
            Option__int o_1020 = some__spec__Option__int_int64_t(INT64_C(5));
            (void)o_1020;
            int64_t *__t43 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t43[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t43[1] = (int64_t)(intptr_t)__fn_1022;
            void *__t44 = __t43;
            __t42 = option_map__spec__Option__int_Option__int_int64_t(o_1020, (int64_t)(intptr_t)(__t44));
        }
        Option__int __t45 = __t42;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t45), INT64_C(99))));
        Option__int __t46;
        int64_t *__t47 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t47[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t47[1] = (int64_t)(intptr_t)__fn_1025;
        void *__t48 = __t47;
        __t46 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(4)), (int64_t)(intptr_t)(__t48));
        Option__int __t49 = __t46;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t49), INT64_C(99))));
        Option__int __t50;
        if (true) {
            int64_t *__t51 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t51[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t51[1] = (int64_t)(intptr_t)__fn_1028;
            void *__t52 = __t51;
            __t50 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(7)), (int64_t)(intptr_t)(__t52));
        } else {
            int64_t *__t53 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t53[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t53[1] = (int64_t)(intptr_t)__fn_1031;
            void *__t54 = __t53;
            __t50 = option_map__spec__Option__int_Option__int_int64_t(some__spec__Option__int_int64_t(INT64_C(0)), (int64_t)(intptr_t)(__t54));
        }
        Option__int __t55 = __t50;
        printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t55), INT64_C(99))));
        {
            Option__int o_1033 = some__spec__Option__int_int64_t(INT64_C(6));
            (void)o_1033;
            int64_t *__t56 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t56[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t56[1] = (int64_t)(intptr_t)__fn_1035;
            void *__t57 = __t56;
            Option__int __t58 = option_map__spec__Option__int_Option__int_int64_t(o_1033, (int64_t)(intptr_t)(__t57));
            printf("%lld\n", (long long)(unwrap_hyor_hycarrier((int64_t)(intptr_t)(&__t58), INT64_C(0))));
        }
        int64_t __t59;
        __t59 = INT64_C(0);
        return (int)__t59;
