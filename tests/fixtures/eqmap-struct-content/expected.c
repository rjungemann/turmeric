...
static int64_t __inst_Hash_hash_Point(Point);
static bool __inst_Eq_eq_qu_Point(Point, Point);
static int64_t __inst_MapKey_mk_hybox_Point(Point);
static int64_t __inst_MapKey_mk_hycmp_Point(Point);
static int64_t __inst_MapKey_mk_hyowned_qu_Point(Point);
...
static bool point_hycarrier_hyeq_qu(int64_t, int64_t);
...
static int64_t __inst_Hash_hash_Point(Point p) {
        return (int64_t)(p.x * 1000003 + p.y); 
}

typedef struct dict_Hash_Point {
    int64_t (*hash)(Point);
} dict_Hash_Point;

static dict_Hash_Point dict_Hash_Point_singleton = {
    .hash = __inst_Hash_hash_Point,
};

static bool __inst_Eq_eq_qu_Point(Point a, Point b) {
        bool __t20 = ((a).x) == ((b).x);
        if (__t20) {
            __t20 = ((a).y) == ((b).y);
        }
...
typedef struct dict_Eq_Point {
    bool (*eq_qu)(Point, Point);
} dict_Eq_Point;

static dict_Eq_Point dict_Eq_Point_singleton = {
    .eq_qu = __inst_Eq_eq_qu_Point,
};

static int64_t __inst_MapKey_mk_hybox_Point(Point p) {
        return (int64_t)(intptr_t)tur_hamt_box_key(&p, sizeof(p)); 
}

static int64_t __inst_MapKey_mk_hycmp_Point(Point p) {
        return (int64_t)(intptr_t)point_hycarrier_hyeq_qu;
}

static int64_t __inst_MapKey_mk_hyowned_qu_Point(Point p) {
        return INT64_C(1);
}

typedef struct dict_MapKey_Point {
    int64_t (*mk_hybox)(Point);
    int64_t (*mk_hycmp)(Point);
    int64_t (*mk_hyowned_qu)(Point);
} dict_MapKey_Point;

static dict_MapKey_Point dict_MapKey_Point_singleton = {
    .mk_hybox = __inst_MapKey_mk_hybox_Point,
    .mk_hycmp = __inst_MapKey_mk_hycmp_Point,
    .mk_hyowned_qu = __inst_MapKey_mk_hyowned_qu_Point,
};

static bool __fn_917(int64_t __cmp_a, int64_t __cmp_b) {
        return __inst_Eq_eq_qu_int(__cmp_a, __cmp_b);
}

static bool __fn_921(int64_t __cmp_a, int64_t __cmp_b) {
        return __inst_Eq_eq_qu_int(__cmp_a, __cmp_b);
}

static bool __fn_925(int64_t __cmp_a, int64_t __cmp_b) {
        return __inst_Eq_eq_qu_int(__cmp_a, __cmp_b);
}
...
static bool point_hycarrier_hyeq_qu(int64_t a, int64_t b) {
        Point *pa = (Point *)(intptr_t)a; Point *pb = (Point *)(intptr_t)b;
...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t26;
            {
                Point _un_untur_unmk_un_un_903 = (Point){.x = INT64_C(5), .y = INT64_C(6)};
                (void)_un_untur_unmk_un_un_903;
                int64_t __t27;
                {
                    Point _un_untur_unmk_un_un_904 = (Point){.x = INT64_C(3), .y = INT64_C(4)};
                    (void)_un_untur_unmk_un_un_904;
                    __t27 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_904), __inst_Hash_hash_Point(_un_untur_unmk_un_un_904), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_904), INT64_C(100), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_904), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_904));
                }
                __t26 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t27, &_un_untur_unmk_un_un_903), __inst_Hash_hash_Point(_un_untur_unmk_un_un_903), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_903), INT64_C(200), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_903), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_903));
            }
            int64_t a_905 = __t26;
            (void)a_905;
            int64_t __t28;
            {
                Point _un_untur_unmk_un_un_906 = (Point){.x = INT64_C(5), .y = INT64_C(6)};
                (void)_un_untur_unmk_un_un_906;
                int64_t __t29;
                {
                    Point _un_untur_unmk_un_un_907 = (Point){.x = INT64_C(3), .y = INT64_C(4)};
                    (void)_un_untur_unmk_un_un_907;
                    __t29 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_907), __inst_Hash_hash_Point(_un_untur_unmk_un_un_907), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_907), INT64_C(100), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_907), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_907));
                }
                __t28 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t29, &_un_untur_unmk_un_un_906), __inst_Hash_hash_Point(_un_untur_unmk_un_un_906), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_906), INT64_C(200), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_906), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_906));
            }
            int64_t b_908 = __t28;
            (void)b_908;
            int64_t __t30;
            {
                Point _un_untur_unmk_un_un_909 = (Point){.x = INT64_C(5), .y = INT64_C(6)};
                (void)_un_untur_unmk_un_un_909;
                int64_t __t31;
                {
                    Point _un_untur_unmk_un_un_910 = (Point){.x = INT64_C(3), .y = INT64_C(4)};
                    (void)_un_untur_unmk_un_un_910;
                    __t31 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_910), __inst_Hash_hash_Point(_un_untur_unmk_un_un_910), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_910), INT64_C(100), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_910), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_910));
                }
                __t30 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t31, &_un_untur_unmk_un_un_909), __inst_Hash_hash_Point(_un_untur_unmk_un_un_909), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_909), INT64_C(999), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_909), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_909));
            }
            int64_t c_911 = __t30;
            (void)c_911;
            int64_t __t32;
            {
                Point _un_untur_unmk_un_un_912 = (Point){.x = INT64_C(7), .y = INT64_C(7)};
                (void)_un_untur_unmk_un_un_912;
                int64_t __t33;
                {
                    Point _un_untur_unmk_un_un_913 = (Point){.x = INT64_C(3), .y = INT64_C(4)};
                    (void)_un_untur_unmk_un_un_913;
                    __t33 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_913), __inst_Hash_hash_Point(_un_untur_unmk_un_un_913), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_913), INT64_C(100), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_913), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_913));
                }
                __t32 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t33, &_un_untur_unmk_un_un_912), __inst_Hash_hash_Point(_un_untur_unmk_un_un_912), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_912), INT64_C(200), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_912), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_912));
            }
            int64_t d_914 = __t32;
            (void)d_914;
            int64_t __t34;
            int64_t *__t35 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t35[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
            __t35[1] = (int64_t)(intptr_t)__fn_917;
            void *__t36 = __t35;
            if (map_hyeq_hyk_qu(a_905, b_908, __inst_MapKey_mk_hycmp_Point((Point){.x = INT64_C(0), .y = INT64_C(0)}), (void *)(intptr_t)(__t36))) {
                __t34 = INT64_C(1);
            } else {
                __t34 = INT64_C(0);
            }
            ...
            __t38[1] = (int64_t)(intptr_t)__fn_921;
            void *__t39 = __t38;
            if (map_hyeq_hyk_qu(a_905, c_911, __inst_MapKey_mk_hycmp_Point((Point){.x = INT64_C(0), .y = INT64_C(0)}), (void *)(intptr_t)(__t39))) {
                __t37 = INT64_C(1);
            } else {
                __t37 = INT64_C(0);
            }
            ...
            __t41[1] = (int64_t)(intptr_t)__fn_925;
            void *__t42 = __t41;
            if (map_hyeq_hyk_qu(a_905, d_914, __inst_MapKey_mk_hycmp_Point((Point){.x = INT64_C(0), .y = INT64_C(0)}), (void *)(intptr_t)(__t42))) {
                __t40 = INT64_C(1);
            } else {
                __t40 = INT64_C(0);
            }
