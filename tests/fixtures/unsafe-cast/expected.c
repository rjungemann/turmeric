...
static void __handle_body_0(void) {
    int64_t __t2;
    {
        ...
        int64_t __t3;
        {
            int64_t y_209 = ((int64_t)x_208);
            (void)y_209;
            printf("%lld\n", (long long)(y_209));
            int64_t __t4;
            int64_t __t5;
            {
                int64_t z_210 = ((int64_t)x_208);
                (void)z_210;
                printf("%lld\n", (long long)(z_210));
                int64_t __t6;
                int64_t __t7;
                {
                    int64_t w_211 = ((int64_t)x_208);
                    (void)w_211;
                    printf("%lld\n", (long long)(w_211));
                    int64_t __t8;
                    __t8 = INT64_C(0);
...
int main() {
        ...
        int64_t __t9 = (int64_t)__dispatch_0(&__cap_0, (int64_t)(intptr_t)__fiber_0, 0);
