...
static void * tg_new();
static void tg_spawn(void *);
static void tg_task_done(void *);
...
static void tg_spawn(void * group) {
        typedef struct {
      pthread_mutex_t lock;
      pthread_cond_t done_cond;
      int64_t task_count;
...
static void tg_task_done(void * group) {
        typedef struct {
      pthread_mutex_t lock;
      pthread_cond_t done_cond;
      int64_t task_count;
...
static void tg_wait(void * group) {
        typedef struct {
      pthread_mutex_t lock;
      pthread_cond_t done_cond;
      int64_t task_count;
...
static void tg_cancel(void * group) {
        typedef struct {
      pthread_mutex_t lock;
      pthread_cond_t done_cond;
      int64_t task_count;
...
static void tg_free(void * group) {
        typedef struct {
      pthread_mutex_t lock;
      pthread_cond_t done_cond;
      int64_t task_count;
...
int main() {
        int64_t __t0;
        {
            void * tg_32 = tg_new();
            (void)tg_32;
            tg_spawn((int64_t)(intptr_t)(tg_32));
            tg_spawn((int64_t)(intptr_t)(tg_32));
            tg_spawn((int64_t)(intptr_t)(tg_32));
            tg_cancel((int64_t)(intptr_t)(tg_32));
            tg_task_done((int64_t)(intptr_t)(tg_32));
            tg_task_done((int64_t)(intptr_t)(tg_32));
            tg_task_done((int64_t)(intptr_t)(tg_32));
            tg_wait((int64_t)(intptr_t)(tg_32));
            puts("error-propagated");
            tg_free((int64_t)(intptr_t)(tg_32));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
