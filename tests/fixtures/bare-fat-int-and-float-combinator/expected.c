...
static int64_t apply_int(void *, int64_t);
static double apply_float(void *, double);
...
static int64_t apply_int(void * g, int64_t x) {
        return (*( tur_thunk_int64_t_int64_t_t *)(g))(g, x);
}

static double apply_float(void * g, double x) {
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(apply_int((void *)(intptr_t)(make_inc(INT64_C(1))), INT64_C(4))));
        printf("%g\n", (double)(apply_float((void *)(intptr_t)(make_scale(2.0)), 3.5)));
        int64_t __t29;
        __t29 = INT64_C(0);
        return (int)__t29;
}
