...
static int64_t apply_hyint(void *, int64_t);
static double apply_hyfloat(void *, double);
...
static int64_t apply_hyint(void * g, int64_t x) {
        return (*( tur_thunk_int64_t_int64_t_t *)(g))(g, x);
}

static double apply_hyfloat(void * g, double x) {
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(apply_hyint((void *)(intptr_t)(make_hyinc(INT64_C(1))), INT64_C(4))));
        printf("%g\n", (double)(apply_hyfloat((void *)(intptr_t)(make_hyscale(2.0)), 3.5)));
        int64_t __t29;
        __t29 = INT64_C(0);
        return (int)__t29;
}
