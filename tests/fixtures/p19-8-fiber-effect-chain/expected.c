...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_220 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_220, (int64_t)INT64_C(20));
    return (int64_t)__t2;
}
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_222 = __k;
    int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_222, (int64_t)INT64_C(30));
    return (int64_t)__t7;
}
...
static int64_t __effect_handler_18(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_228 = __k;
    int64_t __t19 = tur_effect_cont_resume((int64_t)(intptr_t)k_228, (int64_t)INT64_C(99));
...
int main() {
        int64_t __t10;
        {
            void * f1_224 = fiber_new_fn((void *)(intptr_t)(fiber1_body), INT64_C(0));
            (void)f1_224;
            int64_t __t11;
            {
                int64_t v1_225 = fiber_resume_fn((void *)(intptr_t)(f1_224), INT64_C(0));
                (void)v1_225;
                fiber_free_fn((void *)(intptr_t)(f1_224));
                int64_t __t12;
                int64_t __t13;
                {
                    void * f2_226 = fiber_new_fn((void *)(intptr_t)(fiber2_body), INT64_C(0));
                    (void)f2_226;
                    int64_t __t14;
                    {
                        int64_t v2_227 = fiber_resume_fn((void *)(intptr_t)(f2_226), INT64_C(0));
                        (void)v2_227;
                        fiber_free_fn((void *)(intptr_t)(f2_226));
                        int64_t __t15;
                        int64_t __t16;
                        {
