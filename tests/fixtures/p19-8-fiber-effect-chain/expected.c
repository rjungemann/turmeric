...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_273 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_273, (int64_t)INT64_C(20));
    return (int64_t)__t2;
}
...
static void __handle_body_0(void) {
    ...
    tur_current_fiber->result = (int64_t)__t3;
}
...
static void fiber1_body() {
        {
            ...
            __eff_frame_0.cases[0].effect_name = "Ask";
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_275 = __k;
    int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_275, (int64_t)INT64_C(30));
    return (int64_t)__t7;
}

static void __handle_body_5(void);
static void __handle_body_5(void) {
    int64_t __t8 = tur_effect_perform("Ask", NULL, 0);
    tur_current_fiber->result = (int64_t)__t8;
}
...
static int64_t __effect_handler_18(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_281 = __k;
    int64_t __t19 = tur_effect_cont_resume((int64_t)(intptr_t)k_281, (int64_t)INT64_C(99));
    return (int64_t)__t19;
}

static void __handle_body_17(void);
static void __handle_body_17(void) {
    int64_t __t20 = tur_effect_perform("Ask", NULL, 0);
    tur_current_fiber->result = (int64_t)__t20;
}

static int64_t __dispatch_17(void *__ctx_void, int64_t __k_int, int64_t __resume_val);
static int64_t __dispatch_17(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    TurEffectCaptureCtx *__dcap = (TurEffectCaptureCtx *)__ctx_void;
    FiberBlock *__fiber = (FiberBlock *)(intptr_t)__k_int;
    int64_t __r = tur_fiber_block_resume(__fiber, __resume_val);
    ...
    if (!__dcap->has_pending_effect) return __r;
    if (strcmp(__dcap->eff_name, "Ask") == 0) {
        return __effect_handler_18(__dcap->eff_args, __dcap->eff_n_args, __k_int, NULL);
    } else {
        /* Phase 19D: bubble up unhandled effect to outer fiber */
        FiberBlock *__outer_f = tur_current_fiber;
        if (__outer_f && __outer_f->eff_ctx) {
            ...
            tur_fiber_block_yield(0);
            __outer_cap->has_pending_effect = false;
            return __dispatch_17(__ctx_void, __k_int, __outer_f->arg);
        }
        fprintf(stderr, "dispatch: unhandled effect: %s\n", __dcap->eff_name);
        abort();
    }
...
int main() {
        int64_t __t10;
        {
            void * f1_277 = fiber_new_fn((void *)(intptr_t)(fiber1_body), INT64_C(0));
            (void)f1_277;
            int64_t __t11;
            {
                int64_t v1_278 = fiber_resume_fn((void *)(intptr_t)(f1_277), INT64_C(0));
                (void)v1_278;
                fiber_free_fn((void *)(intptr_t)(f1_277));
                int64_t __t12;
                int64_t __t13;
                {
                    void * f2_279 = fiber_new_fn((void *)(intptr_t)(fiber2_body), INT64_C(0));
                    (void)f2_279;
                    int64_t __t14;
                    {
                        int64_t v2_280 = fiber_resume_fn((void *)(intptr_t)(f2_279), INT64_C(0));
                        (void)v2_280;
                        fiber_free_fn((void *)(intptr_t)(f2_279));
                        int64_t __t15;
                        int64_t __t16;
                        {
                            TurEffectCaptureCtx __cap_17;
                            __cap_17.has_pending_effect = false;
                            __cap_17.eff_name = NULL;
                            __cap_17.eff_n_args = 0;
                            __cap_17.dispatch = __dispatch_17;
                            __cap_17.body_env = NULL;
                            FiberBlock *__fiber_17 = tur_fiber_block_new(__handle_body_17, 0);
                            __fiber_17->eff_ctx = &__cap_17;
                            EffectHandlerFrame *__parent_chain_17 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
                            EffectHandlerFrame __eff_frame_17;
                            __eff_frame_17.parent = __parent_chain_17;
                            __eff_frame_17.n_cases = 1;
                            __eff_frame_17.cases[0].effect_name = "Ask";
                            __eff_frame_17.cases[0].handler_fn = NULL;
                            __eff_frame_17.cases[0].env = NULL;
