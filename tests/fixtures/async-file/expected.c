...
static void fiber_writer();
static void fiber_reader();
...
static void fiber_writer() {
        int fd = open("/tmp/tur-async-file-test.txt", O_WRONLY | O_CREAT | O_TRUNC, 0644);
...
static void fiber_reader() {
  ...
  int fd = open("/tmp/tur-async-file-test.txt", O_RDONLY, 0);
...
int main() {
        ...
        int64_t __t1;
        {
            ...
            (void)s_220;
            sched_spawn((void *)(intptr_t)(s_220), (void *)(intptr_t)(mk_fiber((void *)(intptr_t)(fiber_writer))));
            sched_spawn((void *)(intptr_t)(s_220), (void *)(intptr_t)(mk_fiber((void *)(intptr_t)(fiber_reader))));
