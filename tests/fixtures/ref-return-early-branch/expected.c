...
static int64_t keep_or_return(bool);
...
static int64_t keep_or_return(bool flag) {
        int64_t __t0;
        {
            ...
            *((int64_t *)__t1) = INT64_C(7);
            ...
            if (flag) {
                tur_frame_fire_chain(&__frame_2);
                                int64_t __t4 = *((int64_t *)r_618);
return __t4;
            } else {
            }
            int64_t __t5 = *((int64_t *)r_618);
            __t3 = __t5;
            struct __defer_env_6 __t8 = {.r = r_618};
            tur_frame_push_defer(&__frame_2, __defer_7, &__t8);
...
int main() {
        printf("%lld\n", (long long)(keep_or_return(false)));
        printf("%lld\n", (long long)(keep_or_return(true)));
        int64_t __t9;
        __t9 = INT64_C(0);
        return (int)__t9;
}
