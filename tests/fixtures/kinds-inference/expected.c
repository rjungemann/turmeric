...
static int64_t double_it(int64_t);
...
static int64_t double_it(int64_t x) {
        return ((x) * (INT64_C(2)));
}

int main() {
        {
            int64_t o_628 = __opt_some(INT64_C(7));
            (void)o_628;
            {
                int64_t o2_629 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_option_singleton.fmap))(o_628, (int64_t)(intptr_t)(double_it));
                (void)o2_629;
                printf("%lld\n", (long long)(__opt_unwrap(o2_629)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
