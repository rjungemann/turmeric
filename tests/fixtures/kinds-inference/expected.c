...
int main() {
        {
            int64_t o_225 = __opt_some(INT64_C(7));
            (void)o_225;
            {
                int64_t o2_226 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_option_singleton.fmap))(o_225, (int64_t)(intptr_t)(double_it));
                (void)o2_226;
                printf("%lld\n", (long long)(__opt_unwrap(o2_226)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
