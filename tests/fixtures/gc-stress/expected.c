...
int main() {
        gc_enable();
        {
            int64_t i_21 = INT64_C(0);
            (void)i_21;
            while (1) {
                if (!(((i_21) < (INT64_C(20))))) break;
                {
                    int64_t *__t0 = (int64_t *)malloc(sizeof(int64_t));
                    *__t0 = i_21;
                    RcControlBlock *__t1 = rc_cb_alloc(0, 3, NULL);
                    __t1->value = __t0;
                    RcControlBlock * r_22 = __t1;
                    (void)r_22;
                    {
                        RcControlBlock *__t2 = r_22; rc_weak_increment(r_22);
                        RcControlBlock * w_23 = __t2;
                        (void)w_23;
                        rc_strong_decrement(r_22);
                        rc_free_queue_drain();
                        gc_force();
                    }
                }
