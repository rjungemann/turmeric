...
int main() {
        int64_t __t0;
        {
            void * ch_217 = achan_new(INT64_C(2));
            (void)ch_217;
            (void)(chan_slot((void *)(intptr_t)(ch_217), INT64_C(1)));
            {
                void * q_218 = sched_new();
                (void)q_218;
                sched_push((void *)(intptr_t)(q_218), (void *)(intptr_t)(fiber_new_fn((void *)(intptr_t)(producer))));
                sched_push((void *)(intptr_t)(q_218), (void *)(intptr_t)(fiber_new_fn((void *)(intptr_t)(consumer))));
                sched_run((void *)(intptr_t)(q_218));
                sched_free((void *)(intptr_t)(q_218));
            }
            achan_free((void *)(intptr_t)(ch_217));
            puts("done");
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
