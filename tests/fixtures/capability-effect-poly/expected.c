...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_437));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_457));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_484));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_504), (int64_t)(intptr_t)(__fn_508));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_524), (int64_t)(intptr_t)(__fn_528));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_544));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_615));
}
...
static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    const char * s_620 = (const char *)__effect_args[0];
    int64_t k_621 = __k;
    puts(s_620);
    int64_t __t4;
    int64_t __t5 = tur_effect_cont_resume((int64_t)(intptr_t)k_621, (int64_t)0);
    __t4 = __t5;
    return (int64_t)__t4;
}
...
static void __handle_body_2(void) {
    ...
    (void)(((int64_t (*)(const char *))(intptr_t)((__henv_2->cap).print_line))("hello"));
    int64_t __t6;
    __t6 = ((int64_t (*)(const char *))(intptr_t)((__henv_2->cap).print_line))("world");
    tur_current_fiber->result = (int64_t)__t6;
}
...
int main() {
        int64_t __t1;
        {
            Printer cap_619 = (Printer){.print_line = (int64_t)(intptr_t)do_write_line};
            (void)cap_619;
            __HEnv_2 *__henv_2 = (__HEnv_2 *)malloc(sizeof(__HEnv_2));
            __henv_2->cap = cap_619;
            ...
            __eff_frame_2.cases[0].effect_name = "Write";
