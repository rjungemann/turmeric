...
static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    const char * s_212 = (const char *)__effect_args[0];
    int64_t k_213 = __k;
    puts(s_212);
    int64_t __t4;
    int64_t __t5 = tur_effect_cont_resume((int64_t)(intptr_t)k_213, (int64_t)0);
    __t4 = __t5;
    return (int64_t)__t4;
}
...
int main() {
        int64_t __t1;
        {
            Printer cap_211 = (Printer){.print_line = (int64_t)(intptr_t)do_write_line};
            (void)cap_211;
            __HEnv_2 *__henv_2 = (__HEnv_2 *)malloc(sizeof(__HEnv_2));
            __henv_2->cap = cap_211;
