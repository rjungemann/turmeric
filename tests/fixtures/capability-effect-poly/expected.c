...
static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * s_200 = (const char *)__effect_args[0];
    int64_t k_201 = __k;
    puts(s_200);
    int64_t __t4;
    int64_t __t5 = tur_effect_cont_resume((int64_t)(intptr_t)k_201, (int64_t)0);
    __t4 = __t5;
    return (int64_t)__t4;
}
...
static void __handle_body_2(void) {
    (void)(((int64_t (*)(const char *))(intptr_t)((cap_199).print_line))("hello"));
    int64_t __t6;
    __t6 = ((int64_t (*)(const char *))(intptr_t)((cap_199).print_line))("world");
...
int main() {
        int64_t __t1;
        {
            Printer cap_199 = (Printer){.print_line = (int64_t)(intptr_t)do_write_line};
            (void)cap_199;
