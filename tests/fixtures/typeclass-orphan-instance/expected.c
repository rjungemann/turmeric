...
static int64_t __inst_Show_show_it_int(int64_t);
...
static int64_t __inst_Show_show_it_int(int64_t x) {
        printf("%lld\n", (long long)(x));
        int64_t __t0;
        __t0 = x;
        return __t0;
...
typedef struct dict_Show_int {
    int64_t (*show_it)(int64_t);
} dict_Show_int;

static dict_Show_int dict_Show_int_singleton = {
    .show_it = __inst_Show_show_it_int,
};
...
int main() {
        (void)(((int64_t (*)(int64_t))(intptr_t)(dict_Show_int_singleton.show_it))(INT64_C(42)));
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
}
