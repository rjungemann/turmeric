...
static int64_t chan_new(int64_t);
static int64_t use_raw(void *);
...
static int64_t __fn_897(void * __env_p_900, int64_t user) {
        ...
        printf("%lld\n", (long long)(use_raw((void *)(intptr_t)(__env___env_899->ch))));
        int64_t __t20;
        __t20 = INT64_C(0);
        return __t20;
}
...
static int64_t chan_new(int64_t marker) {
...
int main(int argc, char **argv) {
        ...
        int64_t __t26;
        {
            int64_t ch_895 = chan_new(INT64_C(99));
            (void)ch_895;
