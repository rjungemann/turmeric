...
static int64_t chan_hynew(int64_t);
static int64_t use_hyraw(void *);
...
struct __env_899 { tur_thunk_int64_t_int64_t_t __fn; int64_t ch; };
static int64_t __fn_897(void * __env_p_900, int64_t user) {
        struct __env_899 *__env___env_899 = (struct __env_899 *)__env_p_900;
        printf("%lld\n", (long long)(use_hyraw((void *)(intptr_t)(__env___env_899->ch))));
        int64_t __t20;
        __t20 = INT64_C(0);
        return __t20;
}
...
static int64_t chan_hynew(int64_t marker) {
...
static int64_t use_hyraw(void * p) {
        return ((int64_t *)(intptr_t)p)[1]; 
}

static void spawn(void * f) {
        ((void(*)(void*,int64_t))((int64_t*)f)[0])((void*)f, 0); 
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t26;
        {
            int64_t ch_895 = chan_hynew(INT64_C(99));
            (void)ch_895;
            struct __env_899 *__t27 = (struct __env_899 *)malloc(sizeof(struct __env_899));
            __t27->__fn = (tur_thunk_int64_t_int64_t_t)__fn_897;
            __t27->ch = ch_895;
            void *__t28 = __t27;
