...
static int64_t __inst_HasArr_arr_of_ArrW(int64_t);
...
static int64_t __fn_857(int64_t x) {
        return (x) + (INT64_C(1));
}

static int64_t __inst_HasArr_arr_of_ArrW(int64_t self) {
        return __fn_857;
}

typedef struct dict_HasArr_ArrW {
    int64_t (*arr_of)(int64_t);
} dict_HasArr_ArrW;
