...
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t x_196 = (int64_t)__effect_args[0];
    int64_t k_197 = __k;
    int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_197, (int64_t)((x_196) + (INT64_C(10))));
    return (int64_t)__t7;
}

static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t x_198 = (int64_t)__effect_args[0];
    int64_t k_199 = __k;
    int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_199, (int64_t)((x_198) * (INT64_C(2))));
    return (int64_t)__t8;
}

static void __handle_body_4(void);
static void __handle_body_4(void) {
    tur_current_fiber->result = (int64_t)compute();
}
