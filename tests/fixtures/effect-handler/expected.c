...
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t k_262 = __k;
    int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_262, (int64_t)((x_261) + (INT64_C(10))));
    return (int64_t)__t7;
}

static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t x_263 = (int64_t)__effect_args[0];
    int64_t k_264 = __k;
    int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_264, (int64_t)((x_263) * (INT64_C(2))));
    return (int64_t)__t8;
}
