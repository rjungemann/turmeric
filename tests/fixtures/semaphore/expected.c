...
int main() {
        {
            void * s1_42 = sem_new(INT64_C(1));
            (void)s1_42;
            sem_acquire((void *)(intptr_t)(s1_42));
            sem_release((void *)(intptr_t)(s1_42));
            printf("%lld\n", (long long)(INT64_C(1)));
            sem_free((void *)(intptr_t)(s1_42));
        }
        {
            void * s2_43 = sem_new(INT64_C(0));
            (void)s2_43;
            {
                void * arg_44 = sem_arg_new((void *)(intptr_t)(s2_43));
                (void)arg_44;
                {
                    void * t_45 = sem_thread_spawn((void *)(intptr_t)(sem_worker), (void *)(intptr_t)(arg_44));
                    (void)t_45;
                    sem_release((void *)(intptr_t)(s2_43));
                    sem_thread_join((void *)(intptr_t)(t_45));
                }
                printf("%lld\n", (long long)(sem_arg_result((void *)(intptr_t)(arg_44))));
                sem_arg_free((void *)(intptr_t)(arg_44));
            }
            sem_free((void *)(intptr_t)(s2_43));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
