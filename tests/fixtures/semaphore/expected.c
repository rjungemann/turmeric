...
int main() {
        {
            void * s1_229 = sem_new(INT64_C(1));
            (void)s1_229;
            sem_acquire((void *)(intptr_t)(s1_229));
            sem_release((void *)(intptr_t)(s1_229));
            printf("%lld\n", (long long)(INT64_C(1)));
            sem_free((void *)(intptr_t)(s1_229));
        }
        {
            void * s2_230 = sem_new(INT64_C(0));
            (void)s2_230;
            {
                void * arg_231 = sem_arg_new((void *)(intptr_t)(s2_230));
                (void)arg_231;
                {
                    void * t_232 = sem_thread_spawn((void *)(intptr_t)(sem_worker), (void *)(intptr_t)(arg_231));
                    (void)t_232;
                    sem_release((void *)(intptr_t)(s2_230));
                    sem_thread_join((void *)(intptr_t)(t_232));
                }
                printf("%lld\n", (long long)(sem_arg_result((void *)(intptr_t)(arg_231))));
                sem_arg_free((void *)(intptr_t)(arg_231));
            }
            sem_free((void *)(intptr_t)(s2_230));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
