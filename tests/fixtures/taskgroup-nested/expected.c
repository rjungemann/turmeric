...
int main() {
        int64_t __t0;
        {
            void * outer_205 = tg_new();
            (void)outer_205;
            void * inner_206 = tg_new();
            (void)inner_206;
            tg_spawn((void *)(intptr_t)(outer_205));
            tg_spawn((void *)(intptr_t)(outer_205));
            tg_spawn((void *)(intptr_t)(inner_206));
            tg_task_done((void *)(intptr_t)(outer_205));
            tg_task_done((void *)(intptr_t)(outer_205));
            tg_task_done((void *)(intptr_t)(inner_206));
            tg_wait((void *)(intptr_t)(inner_206));
            tg_wait((void *)(intptr_t)(outer_205));
            puts("nested-complete");
            tg_free((void *)(intptr_t)(inner_206));
            tg_free((void *)(intptr_t)(outer_205));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
