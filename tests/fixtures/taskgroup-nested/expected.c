...
int main() {
        int64_t __t0;
        {
            void * outer_625 = tg_new();
            (void)outer_625;
            void * inner_626 = tg_new();
            (void)inner_626;
            tg_spawn((void *)(intptr_t)(outer_625));
            tg_spawn((void *)(intptr_t)(outer_625));
            tg_spawn((void *)(intptr_t)(inner_626));
            tg_task_done((void *)(intptr_t)(outer_625));
            tg_task_done((void *)(intptr_t)(outer_625));
            tg_task_done((void *)(intptr_t)(inner_626));
            tg_wait((void *)(intptr_t)(inner_626));
            tg_wait((void *)(intptr_t)(outer_625));
            puts("nested-complete");
            tg_free((void *)(intptr_t)(inner_626));
            tg_free((void *)(intptr_t)(outer_625));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
