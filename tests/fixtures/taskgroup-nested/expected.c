...
int main() {
        int64_t __t0;
        {
            void * outer_217 = tg_new();
            (void)outer_217;
            void * inner_218 = tg_new();
            (void)inner_218;
            tg_spawn((void *)(intptr_t)(outer_217));
            tg_spawn((void *)(intptr_t)(outer_217));
            tg_spawn((void *)(intptr_t)(inner_218));
            tg_task_done((void *)(intptr_t)(outer_217));
            tg_task_done((void *)(intptr_t)(outer_217));
            tg_task_done((void *)(intptr_t)(inner_218));
            tg_wait((void *)(intptr_t)(inner_218));
            tg_wait((void *)(intptr_t)(outer_217));
            puts("nested-complete");
            tg_free((void *)(intptr_t)(inner_218));
            tg_free((void *)(intptr_t)(outer_217));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
