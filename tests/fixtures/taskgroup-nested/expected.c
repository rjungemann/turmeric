...
int main() {
        int64_t __t0;
        {
            void * outer_30 = tg_new();
            (void)outer_30;
            void * inner_31 = tg_new();
            (void)inner_31;
            tg_spawn((int64_t)(intptr_t)(outer_30));
            tg_spawn((int64_t)(intptr_t)(outer_30));
            tg_spawn((int64_t)(intptr_t)(inner_31));
            tg_task_done((int64_t)(intptr_t)(outer_30));
            tg_task_done((int64_t)(intptr_t)(outer_30));
            tg_task_done((int64_t)(intptr_t)(inner_31));
            tg_wait((int64_t)(intptr_t)(inner_31));
            tg_wait((int64_t)(intptr_t)(outer_30));
            puts("nested-complete");
            tg_free((int64_t)(intptr_t)(inner_31));
            tg_free((int64_t)(intptr_t)(outer_30));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
