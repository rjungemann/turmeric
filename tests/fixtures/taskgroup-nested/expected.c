...
int main() {
        int64_t __t0;
        {
            void * outer_270 = tg_new();
            (void)outer_270;
            void * inner_271 = tg_new();
            (void)inner_271;
            tg_spawn((void *)(intptr_t)(outer_270));
            tg_spawn((void *)(intptr_t)(outer_270));
            tg_spawn((void *)(intptr_t)(inner_271));
            tg_task_done((void *)(intptr_t)(outer_270));
            tg_task_done((void *)(intptr_t)(outer_270));
            tg_task_done((void *)(intptr_t)(inner_271));
            tg_wait((void *)(intptr_t)(inner_271));
            tg_wait((void *)(intptr_t)(outer_270));
            puts("nested-complete");
            tg_free((void *)(intptr_t)(inner_271));
            tg_free((void *)(intptr_t)(outer_270));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
