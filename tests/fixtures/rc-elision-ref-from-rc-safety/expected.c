...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(7);
            ...
            __t2->value = __t1;
            RcControlBlock * orig_208 = __t2;
            (void)orig_208;
            {
                /* rc-elision: skipped rc_strong_increment(orig_208) — last-use clone */
                RcControlBlock * tmp_209 = orig_208;
                (void)tmp_209;
                /* rc-elision: skipped rc_strong_decrement(tmp_209) — matched elided clone */
            }
            {
                void *__t3 = tur_ref_from_rc(orig_208);
                void * owned_210 = __t3;
                (void)owned_210;
                int64_t __t4 = *((int64_t *)owned_210);
                printf("%lld\n", (long long)(__t4));
            }
            int64_t __t5;
            __t5 = INT64_C(0);
