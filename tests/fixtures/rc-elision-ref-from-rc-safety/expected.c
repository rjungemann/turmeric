...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(7);
            ...
            __t2->value = __t1;
            RcControlBlock * orig_616 = __t2;
            (void)orig_616;
            {
                /* rc-elision: skipped rc_strong_increment(orig_616) — last-use clone */
                RcControlBlock * tmp_617 = orig_616;
                (void)tmp_617;
                /* rc-elision: skipped rc_strong_decrement(tmp_617) — matched elided clone */
            }
            {
                void *__t3 = tur_ref_from_rc(orig_616);
                void * owned_618 = __t3;
                (void)owned_618;
                int64_t __t4 = *((int64_t *)owned_618);
                printf("%lld\n", (long long)(__t4));
            }
            int64_t __t5;
            __t5 = INT64_C(0);
