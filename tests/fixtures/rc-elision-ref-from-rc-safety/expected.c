...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(7);
            ...
            __t2->value = __t1;
            RcControlBlock * orig_196 = __t2;
            (void)orig_196;
            {
                /* rc-elision: skipped rc_strong_increment(orig_196) — last-use clone */
                RcControlBlock * tmp_197 = orig_196;
                (void)tmp_197;
                /* rc-elision: skipped rc_strong_decrement(tmp_197) — matched elided clone */
            }
            {
                void *__t3 = tur_ref_from_rc(orig_196);
                void * owned_198 = __t3;
                (void)owned_198;
                int64_t __t4 = *((int64_t *)owned_198);
                printf("%lld\n", (long long)(__t4));
            }
            int64_t __t5;
            __t5 = INT64_C(0);
