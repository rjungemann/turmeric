...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(7);
            ...
            __t2->value = __t1;
            RcControlBlock * orig_261 = __t2;
            (void)orig_261;
            {
                /* rc-elision: skipped rc_strong_increment(orig_261) — last-use clone */
                RcControlBlock * tmp_262 = orig_261;
                (void)tmp_262;
                /* rc-elision: skipped rc_strong_decrement(tmp_262) — matched elided clone */
            }
            {
                void *__t3 = tur_ref_from_rc(orig_261);
                void * owned_263 = __t3;
                (void)owned_263;
                int64_t __t4 = *((int64_t *)owned_263);
                printf("%lld\n", (long long)(__t4));
            }
            int64_t __t5;
            __t5 = INT64_C(0);
