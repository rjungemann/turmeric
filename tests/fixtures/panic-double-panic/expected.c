...
static void __defer_156(void *__env) {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_frame __frame_155;
        tur_frame_init(&__frame_155, NULL);
        tur_frame_push_defer(&__frame_155, __defer_156, NULL);
        tur_panic_set_frame(&__frame_155);
