...
static void __defer_43(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_42;
        tur_frame_init(&__frame_42, NULL);
        tur_frame_push_defer(&__frame_42, __defer_43, NULL);
        tur_panic_set_frame(&__frame_42);
