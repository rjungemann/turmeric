...
static void __defer_26(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_25;
        tur_frame_init(&__frame_25, NULL);
        tur_frame_push_defer(&__frame_25, __defer_26, NULL);
        tur_panic_set_frame(&__frame_25);
