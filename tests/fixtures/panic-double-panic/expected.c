...
static void __defer_24(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_23;
        tur_frame_init(&__frame_23, NULL);
        tur_frame_push_defer(&__frame_23, __defer_24, NULL);
        tur_panic_set_frame(&__frame_23);
