...
static void __defer_160(void *__env) {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_frame __frame_159;
        tur_frame_init(&__frame_159, NULL);
        tur_frame_push_defer(&__frame_159, __defer_160, NULL);
        tur_panic_set_frame(&__frame_159);
