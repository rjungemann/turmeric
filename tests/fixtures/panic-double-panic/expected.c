...
static void __defer_51(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_50;
        tur_frame_init(&__frame_50, NULL);
        tur_frame_push_defer(&__frame_50, __defer_51, NULL);
        tur_panic_set_frame(&__frame_50);
