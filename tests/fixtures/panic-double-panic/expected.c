...
static void __defer_56(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_55;
        tur_frame_init(&__frame_55, NULL);
        tur_frame_push_defer(&__frame_55, __defer_56, NULL);
        tur_panic_set_frame(&__frame_55);
