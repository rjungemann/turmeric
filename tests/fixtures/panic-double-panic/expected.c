...
static void __defer_45(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_44;
        tur_frame_init(&__frame_44, NULL);
        tur_frame_push_defer(&__frame_44, __defer_45, NULL);
        tur_panic_set_frame(&__frame_44);
