...
static void __defer_52(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_51;
        tur_frame_init(&__frame_51, NULL);
        tur_frame_push_defer(&__frame_51, __defer_52, NULL);
        tur_panic_set_frame(&__frame_51);
