...
static void __defer_25(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_24;
        tur_frame_init(&__frame_24, NULL);
        tur_frame_push_defer(&__frame_24, __defer_25, NULL);
        tur_panic_set_frame(&__frame_24);
