...
static void __defer_245(void *__env) {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_frame __frame_244;
        tur_frame_init(&__frame_244, NULL);
        tur_frame_push_defer(&__frame_244, __defer_245, NULL);
        tur_panic_set_frame(&__frame_244);
