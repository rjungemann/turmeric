...
static void __defer_154(void *__env) {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_frame __frame_153;
        tur_frame_init(&__frame_153, NULL);
        tur_frame_push_defer(&__frame_153, __defer_154, NULL);
        tur_panic_set_frame(&__frame_153);
