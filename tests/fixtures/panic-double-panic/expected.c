...
static void __defer_22(void *__env) {
...
int main(int argc, char **argv) {
        ...
        tur_frame __frame_21;
        tur_frame_init(&__frame_21, NULL);
        tur_frame_push_defer(&__frame_21, __defer_22, NULL);
        tur_panic_set_frame(&__frame_21);
