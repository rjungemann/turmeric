...
static int64_t __fn_861(void *, int64_t);
...
struct __env_863 { tur_thunk_int64_t_int64_t_t __fn; int64_t n; };
static int64_t __fn_861(void * __env_p_864, int64_t x) {
        struct __env_863 *__env___env_863 = (struct __env_863 *)__env_p_864;
        return (x) + (__env___env_863->n);
}
...
static void * make_inc(int64_t n) {
        struct __env_863 *__t25 = (struct __env_863 *)malloc(sizeof(struct __env_863));
        __t25->__fn = (tur_thunk_int64_t_int64_t_t)__fn_861;
        __t25->n = n;
        void *__t26 = __t25;
        return __t26;
}
