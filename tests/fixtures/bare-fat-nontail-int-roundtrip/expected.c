...
static int64_t __fn_896(void *, int64_t);
...
static double int__gtfloat(int64_t);
static double use_int_cb(void *, int64_t);
static void * make_inc(int64_t);
...
struct __env_898 { tur_thunk_int64_t_int64_t_t __fn; int64_t n; };
static int64_t __fn_896(void * __env_p_899, int64_t x) {
        struct __env_898 *__env___env_898 = (struct __env_898 *)__env_p_899;
        return (x) + (__env___env_898->n);
}
...
static double int__gtfloat(int64_t n) {
        return (double)n; 
}

static double use_int_cb(void * g, int64_t x) {
        return int__gtfloat((*( tur_thunk_int64_t_int64_t_t *)(g))(g, x));
}

static void * make_inc(int64_t n) {
        struct __env_898 *__t25 = (struct __env_898 *)malloc(sizeof(struct __env_898));
        __t25->__fn = (tur_thunk_int64_t_int64_t_t)__fn_896;
        __t25->n = n;
        void *__t26 = __t25;
        return __t26;
}
...
int main(int argc, char **argv) {
        ...
        printf("%g\n", (double)(use_int_cb((void *)(intptr_t)(make_inc(INT64_C(1))), INT64_C(4))));
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
}
