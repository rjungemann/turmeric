...
static double use_hyint_hycb(void *, int64_t);
static void * make_hyinc(int64_t);
...
static double int_hy_gtfloat(int64_t n) {
        return (double)n; 
}

static double use_hyint_hycb(void * g, int64_t x) {
        return int_hy_gtfloat((*( tur_thunk_int64_t_int64_t_t *)(g))(g, x));
}

static void * make_hyinc(int64_t n) {
...
int main(int argc, char **argv) {
        ...
        printf("%g\n", (double)(use_hyint_hycb((void *)(intptr_t)(make_hyinc(INT64_C(1))), INT64_C(4))));
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
}
