...
int main() {
        {
            ...
            (void)m_35;
            {
                void * c_36 = condvar_new();
                (void)c_36;
                mutex_lock((void *)(intptr_t)(m_35));
                condvar_signal((void *)(intptr_t)(c_36));
                printf("%lld\n", (long long)(INT64_C(1)));
                mutex_unlock((void *)(intptr_t)(m_35));
                mutex_lock((void *)(intptr_t)(m_35));
                condvar_broadcast((void *)(intptr_t)(c_36));
                printf("%lld\n", (long long)(INT64_C(2)));
                mutex_unlock((void *)(intptr_t)(m_35));
                condvar_free((void *)(intptr_t)(c_36));
            }
            mutex_free((void *)(intptr_t)(m_35));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
