...
int main() {
        {
            void * m_210 = mutex_new();
            (void)m_210;
            {
                void * c_211 = condvar_new();
                (void)c_211;
                mutex_lock((void *)(intptr_t)(m_210));
                condvar_signal((void *)(intptr_t)(c_211));
                printf("%lld\n", (long long)(INT64_C(1)));
                mutex_unlock((void *)(intptr_t)(m_210));
                mutex_lock((void *)(intptr_t)(m_210));
                condvar_broadcast((void *)(intptr_t)(c_211));
                printf("%lld\n", (long long)(INT64_C(2)));
                mutex_unlock((void *)(intptr_t)(m_210));
                condvar_free((void *)(intptr_t)(c_211));
            }
            mutex_free((void *)(intptr_t)(m_210));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
