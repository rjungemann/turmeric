...
static void * condvar_new();
static void condvar_signal(void *);
static void condvar_broadcast(void *);
static void condvar_free(void *);
...
static void condvar_signal(void * c) {
        pthread_cond_signal((pthread_cond_t *)c);
  
}

static void condvar_broadcast(void * c) {
        pthread_cond_broadcast((pthread_cond_t *)c);
  
}

static void condvar_free(void * c) {
...
int main() {
        {
            void * m_630 = mutex_new();
            (void)m_630;
            {
                void * c_631 = condvar_new();
                (void)c_631;
                mutex_lock((void *)(intptr_t)(m_630));
                condvar_signal((void *)(intptr_t)(c_631));
                printf("%lld\n", (long long)(INT64_C(1)));
                mutex_unlock((void *)(intptr_t)(m_630));
                mutex_lock((void *)(intptr_t)(m_630));
                condvar_broadcast((void *)(intptr_t)(c_631));
                printf("%lld\n", (long long)(INT64_C(2)));
                mutex_unlock((void *)(intptr_t)(m_630));
                condvar_free((void *)(intptr_t)(c_631));
            }
            mutex_free((void *)(intptr_t)(m_630));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
