...
int main() {
        {
            void * m_275 = mutex_new();
            (void)m_275;
            {
                void * c_276 = condvar_new();
                (void)c_276;
                mutex_lock((void *)(intptr_t)(m_275));
                condvar_signal((void *)(intptr_t)(c_276));
                printf("%lld\n", (long long)(INT64_C(1)));
                mutex_unlock((void *)(intptr_t)(m_275));
                mutex_lock((void *)(intptr_t)(m_275));
                condvar_broadcast((void *)(intptr_t)(c_276));
                printf("%lld\n", (long long)(INT64_C(2)));
                mutex_unlock((void *)(intptr_t)(m_275));
                condvar_free((void *)(intptr_t)(c_276));
            }
            mutex_free((void *)(intptr_t)(m_275));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
