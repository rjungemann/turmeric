...
static int64_t __poly_1346(void * __poly_env_1347, int64_t __poly_x0_1349, int64_t __poly_x1_1351, int64_t __poly_x2_1353, int64_t __poly_x3_1355) {
        __auto_type __ps_56 = (deep_hylens_un_undict_un1337(__poly_x0_1349, __poly_x1_1351, __poly_x2_1353, __poly_x3_1355));
        if (tur_panicking) return (int64_t){0};
        return __ps_56;
}
...
static int64_t __poly_1360(void * __poly_env_1361, int64_t __poly_x0_1363, int64_t __poly_x1_1365, int64_t __poly_x2_1367, int64_t __poly_x3_1369) {
        __auto_type __ps_63 = (deep_hylens_un_undict_un1358(__poly_x0_1363, __poly_x1_1365, __poly_x2_1367, __poly_x3_1369));
        if (tur_panicking) return (int64_t){0};
        return __ps_63;
}
...
static int64_t __poly_1374(void * __poly_env_1375, int64_t __poly_x0_1377, int64_t __poly_x1_1379, int64_t __poly_x2_1381, int64_t __poly_x3_1383) {
        __auto_type __ps_70 = (deep_hylens_un_undict_un1372(__poly_x0_1377, __poly_x1_1379, __poly_x2_1381, __poly_x3_1383));
        if (tur_panicking) return (int64_t){0};
        return __ps_70;
}
...
static int64_t __poly_1388(void * __poly_env_1389, int64_t __poly_x0_1391, int64_t __poly_x1_1393, int64_t __poly_x2_1395, int64_t __poly_x3_1397) {
        __auto_type __ps_77 = (deep_hylens_un_undict_un1386(__poly_x0_1391, __poly_x1_1393, __poly_x2_1395, __poly_x3_1397));
        if (tur_panicking) return (int64_t){0};
        return __ps_77;
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_105 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_767, (void *)(intptr_t)(k_768), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t107;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_113 = (map_hyeq_hyloop((void *)(intptr_t)(iter_772), (void *)(intptr_t)(__ps_112), (void *)(intptr_t)(keyeq_773), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            ...
            bool __t132;
            {
                ...
                if ((t1_1015) == (INT64_C(0))) {
                    ...
                    if ((t2_1016) == (INT64_C(0))) {
                        ...
                        __auto_type __ps_135 = (cons_hyeq_hygo(t1_1015, t2_1016));
                        if (tur_panicking) return (bool){0};
                        __t134 = __ps_135;
                    }
                    __t133 = __t134;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t151;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_157 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1106), (void *)(intptr_t)(__ps_156), (void *)(intptr_t)(keyeq_1107)));
            if (tur_panicking) return (bool){0};
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t178;
        {
            ...
            {
                __auto_type __ps_180 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1235));
                if (tur_panicking) return (int64_t){0};
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t183;
        {
            ...
            (void)r_1285;
            int64_t __t185;
            __auto_type __ps_186 = (schema_hydecode_hyok_qu(r_1285));
            if (tur_panicking) return (int64_t){0};
            if (__ps_186) {
                __auto_type __ps_187 = (schema_hydecode_hyvalue(r_1285));
                if (tur_panicking) return (int64_t){0};
                __t185 = __ps_187;
            } else {
                __auto_type __ps_188 = (schema_hydecode_hyerrors(r_1285));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_202 = (use_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1346 }, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_202);
        __auto_type __ps_203 = (use_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1360 }, INT64_C(-5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_203);
        __auto_type __ps_204 = (use_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1374 }, true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_204);
        __auto_type __ps_205 = (use_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1388 }, false));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_205);
        int64_t __t206;
        __t206 = INT64_C(0);
