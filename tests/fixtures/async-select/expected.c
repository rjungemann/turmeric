...
int main() {
        int64_t __t0;
        {
            ...
            (void)fut2_621;
            {
                int64_t __t3 = tur_await_future((TurFuture*)(intptr_t)fut1_620);
                int64_t x_622 = __t3;
                (void)x_622;
                puts("Got:42");
                if (async_done_((void *)(intptr_t)(fut2_621))) {
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut2_621);
                        int64_t y_623 = __t4;
                        (void)y_623;
                        puts("Got:99");
                    }
