/Users/rjungemann/Projects/turmeric4/src/emit.c:3445:22: runtime error: load of value 86, which is not a valid value for type 'bool'
SUMMARY: UndefinedBehaviorSanitizer: undefined-behavior /Users/rjungemann/Projects/turmeric4/src/emit.c:3445:22 
/Users/rjungemann/Projects/turmeric4/src/emit.c:3161:16: runtime error: load of value 86, which is not a valid value for type 'bool'
SUMMARY: UndefinedBehaviorSanitizer: undefined-behavior /Users/rjungemann/Projects/turmeric4/src/emit.c:3161:16 
...
static bool async_done_(void *);
static int64_t compute_42();
static int64_t compute_99();
...
static bool async_done_(void * fut) {
        typedef enum { FUTURE_PENDING, FUTURE_FULFILLED, FUTURE_REJECTED } TurFutureStatus;
...
int main() {
        int64_t __t0;
        {
            ...
            (void)fut2_26;
            {
                int64_t __t3 = tur_await_future((TurFuture*)(intptr_t)fut1_25);
                int64_t x_27 = __t3;
                (void)x_27;
                puts("Got:42");
                if (async_done_((void *)(intptr_t)(fut2_26))) {
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut2_26);
                        int64_t y_28 = __t4;
                        (void)y_28;
                        puts("Got:99");
                    }
