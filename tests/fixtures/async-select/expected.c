...
int main() {
        int64_t __t0;
        {
            ...
            (void)fut2_266;
            {
                int64_t __t3 = tur_await_future((TurFuture*)(intptr_t)fut1_265);
                int64_t x_267 = __t3;
                (void)x_267;
                puts("Got:42");
                if (async_done_((void *)(intptr_t)(fut2_266))) {
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut2_266);
                        int64_t y_268 = __t4;
                        (void)y_268;
                        puts("Got:99");
                    }
