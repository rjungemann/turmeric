...
int main() {
        int64_t __t0;
        {
            ...
            (void)fut2_213;
            {
                int64_t __t3 = tur_await_future((TurFuture*)(intptr_t)fut1_212);
                int64_t x_214 = __t3;
                (void)x_214;
                puts("Got:42");
                if (async_done_((void *)(intptr_t)(fut2_213))) {
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut2_213);
                        int64_t y_215 = __t4;
                        (void)y_215;
                        puts("Got:99");
                    }
