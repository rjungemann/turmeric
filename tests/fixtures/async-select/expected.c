...
int main() {
        int64_t __t0;
        {
            ...
            (void)fut2_201;
            {
                int64_t __t3 = tur_await_future((TurFuture*)(intptr_t)fut1_200);
                int64_t x_202 = __t3;
                (void)x_202;
                puts("Got:42");
                if (async_done_((void *)(intptr_t)(fut2_201))) {
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut2_201);
                        int64_t y_203 = __t4;
                        (void)y_203;
                        puts("Got:99");
                    }
