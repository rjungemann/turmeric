...
int main() {
        {
            void * mtx_225 = mutex_new();
            (void)mtx_225;
            {
                void * counter_226 = ms_counter_new();
                (void)counter_226;
                {
                    void * handles_227 = ms_spawn_all((void *)(intptr_t)(ms_worker), (void *)(intptr_t)(mtx_225), (void *)(intptr_t)(counter_226), INT64_C(10), INT64_C(100));
                    (void)handles_227;
                    ms_join_all((void *)(intptr_t)(handles_227), INT64_C(10));
                }
                printf("%lld\n", (long long)(ms_counter_load((void *)(intptr_t)(counter_226))));
                ms_counter_free((void *)(intptr_t)(counter_226));
            }
            mutex_free((void *)(intptr_t)(mtx_225));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
