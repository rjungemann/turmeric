...
int main() {
        {
            void * mtx_50 = mutex_new();
            (void)mtx_50;
            {
                void * counter_51 = ms_counter_new();
                (void)counter_51;
                {
                    void * handles_52 = ms_spawn_all((void *)(intptr_t)(ms_worker), (void *)(intptr_t)(mtx_50), (void *)(intptr_t)(counter_51), INT64_C(10), INT64_C(100));
                    (void)handles_52;
                    ms_join_all((void *)(intptr_t)(handles_52), INT64_C(10));
                }
                printf("%lld\n", (long long)(ms_counter_load((void *)(intptr_t)(counter_51))));
                ms_counter_free((void *)(intptr_t)(counter_51));
            }
            mutex_free((void *)(intptr_t)(mtx_50));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
