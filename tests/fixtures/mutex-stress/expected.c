...
int main() {
        {
            void * mtx_237 = mutex_new();
            (void)mtx_237;
            {
                void * counter_238 = ms_counter_new();
                (void)counter_238;
                {
                    void * handles_239 = ms_spawn_all((void *)(intptr_t)(ms_worker), (void *)(intptr_t)(mtx_237), (void *)(intptr_t)(counter_238), INT64_C(10), INT64_C(100));
                    (void)handles_239;
                    ms_join_all((void *)(intptr_t)(handles_239), INT64_C(10));
                }
                printf("%lld\n", (long long)(ms_counter_load((void *)(intptr_t)(counter_238))));
                ms_counter_free((void *)(intptr_t)(counter_238));
            }
            mutex_free((void *)(intptr_t)(mtx_237));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
