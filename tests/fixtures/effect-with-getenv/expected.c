...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * key_215 = (const char *)__effect_args[0];
    int64_t k_216 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_216, (int64_t)getenv(key_215));
    return (int64_t)__t2;
}
...
static void __handle_body_0(void) {
    {
        int64_t __t3[1];
        __t3[0] = (int64_t)"PATH";
        const char * __t4 = (const char *)tur_effect_perform("GetEnv", __t3, 1);
        const char * __214 = __t4;
        (void)__214;
        puts("getenv ok");
    }
...
static int64_t __dispatch_0(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "GetEnv") == 0) {
...
int main(void) {
    ...
    __eff_frame_0.cases[0].effect_name = "GetEnv";
