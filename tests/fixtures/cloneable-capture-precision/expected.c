...
static int64_t __cont_fn_1(void *__env, int64_t __value) { (void)__env; return __value; }

static int64_t __fn_774() {
        tur_cloneable_cont *__t2 = tur_cloneable_cont_alloc(__cont_fn_1, NULL, NULL, NULL);
...
static int64_t make_resumable(NoToken nc, int64_t result) {
        int64_t __t5;
        {
            int64_t (*f)() = __fn_774;
            (void)f;
            __t5 = tur_cloneable_cont_resume(((int64_t (*)(void))(intptr_t)f)(), result);
        }
        return __t5;
}
