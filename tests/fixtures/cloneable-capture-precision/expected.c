...
static int64_t tur_handler_dispatch(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    for (int __i = 0; __tbl && __i < __tbl->n_entries; __i++) {
        if (strcmp(__dcap->eff_name, __tbl->entries[__i].eff_name) == 0) {
            ...
            if (__en->cont_kind == 4) { /* CK_MULTISHOT */
                struct __tur_msdyn_env *__ms = (struct __tur_msdyn_env *)malloc(sizeof(struct __tur_msdyn_env));
                if (!__ms) abort();
                __ms->ctx = __ctx_void; __ms->k_int = __k_int;
                int64_t __k_ms = (int64_t)(intptr_t)tur_cloneable_cont_alloc(__tur_msdyn_cont, __ms, __tur_msdyn_clone, free);
                return __en->fn(__dcap->eff_args, __dcap->eff_n_args, __k_ms, __en->env);
            }
...
static int64_t __inst_Clone_clone_CloneToken(CloneToken);
static int64_t __fn_897();
...
static int64_t k_hyidentity(int64_t);
static int64_t make_hyresumable(NoToken, int64_t);
...
static int64_t __inst_Clone_clone_CloneToken(CloneToken t) {
        return INT64_C(0);
}

typedef struct dict_Clone_CloneToken {
    int64_t (*clone)(CloneToken);
} dict_Clone_CloneToken;

static dict_Clone_CloneToken dict_Clone_CloneToken_singleton = {
    .clone = __inst_Clone_clone_CloneToken,
};

static int64_t __cont_fn_20(void *__env, int64_t __value) { (void)__env; return __value; }

static int64_t __fn_897() {
        tur_cloneable_cont *__t21 = tur_cloneable_cont_alloc(__cont_fn_20, NULL, NULL, NULL);
        int64_t __t22 = k_hyidentity((int64_t)(intptr_t)__t21);
        return __t22;
}
        ...
        if (tnil_qu(l1)) {
            ...
            if (tnil_qu(l2)) {
                ...
                if ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), list_hyhead(l1), list_hyhead(l2))) {
                    __t25 = list_hyeq_qu(list_hytail(l1), list_hytail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t25 = false;
                }
                __t24 = __t25;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            __t26 = tcons((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f)));
        }
        return __t26;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            __t27 = tcons(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2));
        }
        return __t27;
}
...
static int64_t k_hyidentity(int64_t k) {
        return k;
}

static int64_t make_hyresumable(NoToken nc, int64_t result) {
        int64_t __t28;
        {
            int64_t (*f)() = __fn_897;
            (void)f;
            __t28 = tur_cloneable_cont_resume(((int64_t (*)(void))(intptr_t)f)(), result);
        }
        return __t28;
}
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(make_hyresumable((NoToken){.tag = INT64_C(0)}, INT64_C(42))));
        return 0;
}
