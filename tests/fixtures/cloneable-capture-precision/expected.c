...
static int64_t make_resumable(NoToken, int64_t);
...
static int64_t __cont_fn_2(void *__env, int64_t __value) { (void)__env; return __value; }

static int64_t __fn_862() {
        tur_cloneable_cont *__t3 = tur_cloneable_cont_alloc(__cont_fn_2, NULL, NULL, NULL);
        int64_t __t4 = k_identity((int64_t)(intptr_t)__t3);
        return __t4;
}
        ...
        if (tnil_(l1)) {
            ...
            if (tnil_(l2)) {
                ...
                if (((bool (*)(int64_t, int64_t))(intptr_t)cmp_fn)(list_head(l1), list_head(l2))) {
                    __t7 = list_eq_(list_tail(l1), list_tail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t7 = false;
                }
                __t6 = __t7;
...
static int64_t __cons_fmap(int64_t cell, void * f) {
        ...
        if (tnil_(cell)) {
            ...
            __t8 = tcons((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_head(cell)), __cons_fmap(list_tail(cell), (void *)(intptr_t)(f)));
        }
        return __t8;
}
...
static int64_t list_concat(int64_t l1, int64_t l2) {
        ...
        if (tnil_(l1)) {
            ...
            __t9 = tcons(list_head(l1), list_concat(list_tail(l1), l2));
        }
        return __t9;
}
...
static int64_t make_resumable(NoToken nc, int64_t result) {
        int64_t __t10;
        {
            int64_t (*f)() = __fn_862;
            (void)f;
            __t10 = tur_cloneable_cont_resume(((int64_t (*)(void))(intptr_t)f)(), result);
        }
        return __t10;
}
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(make_resumable((NoToken){.tag = INT64_C(0)}, INT64_C(42))));
        return 0;
}
