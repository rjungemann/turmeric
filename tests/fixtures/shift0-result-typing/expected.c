...
static bool __inst_Eq_eq_qu_Tuple2(int64_t x, int64_t y) {
        return tuple2_eq_carrier_qu(x, y, (int64_t)(intptr_t)(__fn_786), (int64_t)(intptr_t)(__fn_790));
}
...
static bool __fn_891(int64_t v) {
        return (v) == (INT64_C(0));
}
