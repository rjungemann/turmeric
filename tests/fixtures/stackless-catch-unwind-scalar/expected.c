...
struct __env_1305 { tur_thunk_int64_t_t __fn; int64_t n; bool flag; };
...
static int64_t __fn_1303(void * __env_p_1306) {
        ...
        __auto_type __ps_42 = (f((__env___env_1305->n) - (INT64_C(1)), !(__env___env_1305->flag)));
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n159->saved[1] = (int64_t)(intptr_t)(flag);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_162 = (f(INT64_C(500000), true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_162));
        int64_t __t163;
        __t163 = INT64_C(0);
