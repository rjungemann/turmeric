         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n285->saved[1] = (int64_t)(intptr_t)(flag);
            __n285->saved[2] = (int64_t)(intptr_t)(__t282);
            __n285->saved[3] = (int64_t)(intptr_t)(__t283);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_288 = (f(INT64_C(500000), true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_288));
        int64_t __t289;
        __t289 = INT64_C(0);
