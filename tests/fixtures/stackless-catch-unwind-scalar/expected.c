...
struct __env_1626 { tur_thunk_int64_t_t __fn; int64_t n; bool flag; };
...
static int64_t __fn_1624(void * __env_p_1627) {
        ...
        return f((__env___env_1626->n) - (INT64_C(1)), !(__env___env_1626->flag));
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n179->saved[1] = (int64_t)(intptr_t)(flag);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_182 = (f(INT64_C(500000), true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_182));
        int64_t __t183;
        __t183 = INT64_C(0);
