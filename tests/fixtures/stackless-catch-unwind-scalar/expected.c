...
struct __env_1439 { tur_thunk_int64_t_t __fn; int64_t n; bool flag; };
...
static int64_t __fn_1437(void * __env_p_1440) {
        ...
        int64_t __ps_40 = (f((__env___env_1439->n) - (INT64_C(1)), !(__env___env_1439->flag)));
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n187->saved[1] = (int64_t)(intptr_t)(flag);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_190 = (f(INT64_C(500000), true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_190));
        int64_t __t191;
        __t191 = INT64_C(0);
