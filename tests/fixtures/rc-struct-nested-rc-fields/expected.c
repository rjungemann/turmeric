...
static void drop_glue_Node(void *ptr) {
    if (!ptr) return;
    Node *s = (Node *)ptr;
...
static void walk_glue_Node(void *ptr, RcWalkChildFn cb, void *ctx) {
    if (!ptr || !cb) return;
    Node *s = (Node *)ptr;
...
int main() {
        int64_t __t0;
        {
            ...
            *__t3 = (Node){.val = inner_617};
            RcControlBlock *__t4 = rc_cb_alloc_struct(0, 18, drop_glue_Node, walk_glue_Node);
            __t4->value = __t3;
            RcControlBlock * outer_618 = __t4;
            (void)outer_618;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            int64_t __t6 = rc_strong_count(outer_618);
            printf("%lld\n", (long long)(__t6));
            struct __defer_env_7 __t9 = {.outer = outer_618};
