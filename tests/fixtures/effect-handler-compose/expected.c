...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_209 = (const char *)__effect_args[0];
    int64_t k_210 = __k;
    puts(msg_209);
    int64_t __t3;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_210, (int64_t)0);
    __t3 = __t4;
    return (int64_t)__t3;
}
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_208 = __k;
    int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_208, (int64_t)INT64_C(41));
    return (int64_t)__t7;
}
...
static void __handle_body_5(void) {
    int64_t __t8[1];
    __t8[0] = (int64_t)"tick";
    tur_effect_perform("Log", __t8, 1);
    int64_t __t9;
    int64_t __t10 = tur_effect_perform("Counter", NULL, 0);
    __t9 = ((__t10) + (INT64_C(1)));
    tur_current_fiber->result = (int64_t)__t9;
}
...
static int64_t __dispatch_5(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Counter") == 0) {
...
int main() {
        int64_t __t0;
        {
            ...
            __eff_frame_1.cases[0].effect_name = "Log";
