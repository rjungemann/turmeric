...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_262 = (const char *)__effect_args[0];
    int64_t k_263 = __k;
    puts(msg_262);
    int64_t __t3;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_263, (int64_t)0);
    __t3 = __t4;
    return (int64_t)__t3;
}
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_261 = __k;
    int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_261, (int64_t)INT64_C(41));
    return (int64_t)__t7;
}
