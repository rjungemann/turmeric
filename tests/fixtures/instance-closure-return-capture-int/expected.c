...
static int64_t __inst_HasArr_arr_hyof_ArrW(int64_t, int64_t);
...
struct __env_896 { tur_thunk_int64_t_int64_t_t __fn; int64_t n; };
...
static int64_t __inst_HasArr_arr_hyof_ArrW(int64_t self, int64_t n) {
        struct __env_896 *__t20 = (struct __env_896 *)malloc(sizeof(struct __env_896));
        __t20->__fn = (tur_thunk_int64_t_int64_t_t)__fn_894;
        __t20->n = n;
        void *__t21 = __t20;
        return __t21;
}
...
typedef struct dict_HasArr_ArrW {
    int64_t (*arr_hyof)(int64_t, int64_t);
} dict_HasArr_ArrW;

static dict_HasArr_ArrW dict_HasArr_ArrW_singleton = {
    .arr_hyof = __inst_HasArr_arr_hyof_ArrW,
};
...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_901 = (int64_t)(INT64_C(0));
            (void)w_901;
            int64_t g = (int64_t)(intptr_t)(__inst_HasArr_arr_hyof_ArrW(w_901, INT64_C(100)));
            (void)g;
