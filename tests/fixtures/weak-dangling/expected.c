...
int main() {
        {
            ...
            *__t0 = INT64_C(99);
            ...
            __t1->value = __t0;
            RcControlBlock * r_618 = __t1;
            (void)r_618;
            {
                RcControlBlock *__t2 = r_618; rc_weak_increment(r_618);
                RcControlBlock * w_619 = __t2;
                (void)w_619;
                rc_strong_decrement(r_618);
                rc_free_queue_drain();
                {
                    RcControlBlock *__t3 = rc_upgrade(w_619);
                    ...
                    void * u_620 = __t4;
                    (void)u_620;
                    puts((some_((void *)(intptr_t)(u_620))) ? "true" : "false");
                }
            }
        }
        int64_t __t5;
