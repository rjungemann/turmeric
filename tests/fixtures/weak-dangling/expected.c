...
int main() {
        {
            ...
            *__t0 = INT64_C(99);
            ...
            __t1->value = __t0;
            RcControlBlock * r_196 = __t1;
            (void)r_196;
            {
                RcControlBlock *__t2 = r_196; rc_weak_increment(r_196);
                RcControlBlock * w_197 = __t2;
                (void)w_197;
                rc_strong_decrement(r_196);
                rc_free_queue_drain();
                {
                    RcControlBlock *__t3 = rc_upgrade(w_197);
                    RcControlBlock * u_198 = __t3;
                    (void)u_198;
                    tur_frame __frame_4;
                    tur_frame_init(&__frame_4, NULL);
                    int64_t __t5 = rc_strong_count(u_198);
                    printf("%lld\n", (long long)(__t5));
                    struct __defer_env_6 __t8 = {.u = u_198};
