...
int main() {
        {
            ...
            *__t0 = INT64_C(99);
            ...
            (void)r_1;
            {
                RcControlBlock *__t2 = r_1; rc_weak_increment(r_1);
                RcControlBlock * w_2 = __t2;
                (void)w_2;
                rc_strong_decrement(r_1);
                rc_free_queue_drain();
                {
                    RcControlBlock *__t3 = rc_upgrade(w_2);
                    RcControlBlock * u_3 = __t3;
                    (void)u_3;
                    tur_frame __frame_4;
                    tur_frame_init(&__frame_4, NULL);
                    int64_t __t5 = rc_strong_count(u_3);
                    printf("%lld\n", (long long)(__t5));
                    struct __defer_env_6 __t8 = {.u = u_3};
