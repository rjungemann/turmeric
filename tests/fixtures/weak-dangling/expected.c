...
int main() {
        {
            ...
            *__t0 = INT64_C(99);
            ...
            __t1->value = __t0;
            RcControlBlock * r_208 = __t1;
            (void)r_208;
            {
                RcControlBlock *__t2 = r_208; rc_weak_increment(r_208);
                RcControlBlock * w_209 = __t2;
                (void)w_209;
                rc_strong_decrement(r_208);
                rc_free_queue_drain();
                {
                    RcControlBlock *__t3 = rc_upgrade(w_209);
                    RcControlBlock * u_210 = __t3;
                    (void)u_210;
                    tur_frame __frame_4;
                    tur_frame_init(&__frame_4, NULL);
                    int64_t __t5 = rc_strong_count(u_210);
                    printf("%lld\n", (long long)(__t5));
                    struct __defer_env_6 __t8 = {.u = u_210};
