...
int main() {
        {
            ...
            *__t0 = INT64_C(99);
            ...
            __t1->value = __t0;
            RcControlBlock * r_261 = __t1;
            (void)r_261;
            {
                RcControlBlock *__t2 = r_261; rc_weak_increment(r_261);
                RcControlBlock * w_262 = __t2;
                (void)w_262;
                rc_strong_decrement(r_261);
                rc_free_queue_drain();
                {
                    RcControlBlock *__t3 = rc_upgrade(w_262);
                    RcControlBlock * u_263 = __t3;
                    (void)u_263;
                    tur_frame __frame_4;
                    tur_frame_init(&__frame_4, NULL);
                    int64_t __t5 = rc_strong_count(u_263);
                    printf("%lld\n", (long long)(__t5));
                    struct __defer_env_6 __t8 = {.u = u_263};
