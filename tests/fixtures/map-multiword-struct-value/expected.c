...
static int64_t none() {
        int64_t __ps_138 = (ctor_Option_None());
        if (tur_panicking) return ((int64_t)0);
        return __ps_138;
}
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t264;
        {
            tur_adt_Map__int__Point * __t265;
            {
                ...
                tur_adt_Point __ps_266 = (ctor_Point_Point(INT64_C(30), INT64_C(40)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                ...
                tur_adt_Map__int__Point * __t269;
                {
                    ...
                    tur_adt_Point __ps_270 = (ctor_Point_Point(INT64_C(7), INT64_C(8)));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_310 = (ctor_Cons_Cons__int(h, t));
