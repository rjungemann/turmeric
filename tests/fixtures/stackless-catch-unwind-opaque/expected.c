...
struct __env_1275 { tur_thunk_int64_t_t __fn; int64_t c; int64_t n; };
static int64_t __fn_1273(void * __env_p_1276) {
        struct __env_1275 *__env___env_1275 = (struct __env_1275 *)__env_p_1276;
        __auto_type __ps_43 = (step((__env___env_1275->c) + (INT64_C(1)), (__env___env_1275->n) - (INT64_C(1))));
        ...
        if (__ps_134) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1068 = __ps_135;
                (void)h_1068;
                __auto_type __ps_136 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1069 = __ps_136;
                (void)k_1069;
                __auto_type __ps_137 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1068, (void *)(intptr_t)(k_1069), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_137) {
                    void * __t138 = iter;
                    void * __t139 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t141;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1072 = __ps_143;
            (void)iter_1072;
            __auto_type __ps_144 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_145 = (hamt_slkeyeq((void *)(intptr_t)(__ps_144)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1073 = __ps_145;
            (void)keyeq_1073;
            __auto_type __ps_146 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_147 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1072), (void *)(intptr_t)(__ps_146), (void *)(intptr_t)(keyeq_1073)));
            if (tur_panicking) return (bool){0};
            bool result_1074 = __ps_147;
            (void)result_1074;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t174;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1250 = __ps_175;
            (void)r_1250;
            int64_t __t176;
            __auto_type __ps_177 = (schema_hydecode_hyok_qu(r_1250));
            if (tur_panicking) return (int64_t){0};
            if (__ps_177) {
                __auto_type __ps_178 = (schema_hydecode_hyvalue(r_1250));
                if (tur_panicking) return (int64_t){0};
                __t176 = __ps_178;
            } else {
                __auto_type __ps_179 = (schema_hydecode_hyerrors(r_1250));
                if (tur_panicking) return (int64_t){0};
