...
static int64_t __fn_1610(void * __env_p_1613) {
        ...
        int64_t __ps_128 = (step((__env___env_1612->c) + (INT64_C(1)), (__env___env_1612->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_128;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_280 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_280));
        int64_t __t281;
        __t281 = INT64_C(0);
