...
static int64_t __fn_1436(void * __env_p_1439) {
        ...
        int64_t __ps_40 = (step((__env___env_1438->c) + (INT64_C(1)), (__env___env_1438->n) - (INT64_C(1))));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_173 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_173));
        int64_t __t174;
        __t174 = INT64_C(0);
