...
static int64_t __fn_1471(void * __env_p_1474) {
        ...
        int64_t __ps_124 = (step((__env___env_1473->c) + (INT64_C(1)), (__env___env_1473->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_269 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_269));
        int64_t __t270;
        __t270 = INT64_C(0);
