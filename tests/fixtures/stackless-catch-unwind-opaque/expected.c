...
static int64_t __fn_1304(void * __env_p_1307) {
        ...
        int64_t __ps_42 = (step((__env___env_1306->c) + (INT64_C(1)), (__env___env_1306->n) - (INT64_C(1))));
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_70 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_763, (void *)(intptr_t)(k_764), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t72;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_78 = (map_hyeq_hyloop((void *)(intptr_t)(iter_768), (void *)(intptr_t)(__ps_77), (void *)(intptr_t)(keyeq_769), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            ...
            bool __t97;
            {
                ...
                if ((t1_1011) == (INT64_C(0))) {
                    ...
                    if ((t2_1012) == (INT64_C(0))) {
                        ...
                        bool __ps_100 = (cons_hyeq_hygo(t1_1011, t2_1012));
                        if (tur_panicking) return ((bool)0);
                        __t99 = __ps_100;
                    }
                    __t98 = __t99;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t116;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_122 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1102), (void *)(intptr_t)(__ps_121), (void *)(intptr_t)(keyeq_1103)));
            if (tur_panicking) return ((bool)0);
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t143;
        {
            ...
            {
                tur_adt_Vec__int * __ps_145 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1231));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t148;
        {
            ...
            (void)r_1281;
            int64_t __t150;
            bool __ps_151 = (schema_hydecode_hyok_qu(r_1281));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_151) {
                int64_t __ps_152 = (schema_hydecode_hyvalue(r_1281));
                if (tur_panicking) return ((int64_t)0);
                __t150 = __ps_152;
            } else {
                int64_t __ps_153 = (schema_hydecode_hyerrors(r_1281));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_160 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_160));
        int64_t __t161;
        __t161 = INT64_C(0);
