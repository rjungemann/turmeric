...
static int64_t __fn_1440(void * __env_p_1443) {
        ...
        int64_t __ps_40 = (step((__env___env_1442->c) + (INT64_C(1)), (__env___env_1442->n) - (INT64_C(1))));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_185 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        int64_t __t186;
        __t186 = INT64_C(0);
