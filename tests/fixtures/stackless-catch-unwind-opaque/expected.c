...
struct __env_1334 { tur_thunk_int64_t_t __fn; int64_t c; int64_t n; };
...
static int64_t __fn_1332(void * __env_p_1335) {
        ...
        int64_t __ps_42 = (step((__env___env_1334->c) + (INT64_C(1)), (__env___env_1334->n) - (INT64_C(1))));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_164 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_164));
        int64_t __t165;
        __t165 = INT64_C(0);
