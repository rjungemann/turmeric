...
struct __env_1471 { tur_thunk_int64_t_t __fn; int64_t c; int64_t n; };
...
static int64_t __fn_1469(void * __env_p_1472) {
        ...
        int64_t __ps_124 = (step((__env___env_1471->c) + (INT64_C(1)), (__env___env_1471->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_272 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_272));
        int64_t __t273;
        __t273 = INT64_C(0);
