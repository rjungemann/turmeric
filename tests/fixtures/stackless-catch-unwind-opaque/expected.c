...
struct __env_1469 { tur_thunk_int64_t_t __fn; int64_t c; int64_t n; };
...
static int64_t __fn_1467(void * __env_p_1470) {
        ...
        int64_t __ps_92 = (step((__env___env_1469->c) + (INT64_C(1)), (__env___env_1469->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_92;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_237 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_237));
        int64_t __t238;
        __t238 = INT64_C(0);
