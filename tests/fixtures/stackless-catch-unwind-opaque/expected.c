...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_107) {
            bool __t108;
            {
                ...
                bool __t109;
                if ((t1_978) == (INT64_C(0))) {
                    __t109 = (t2_979) == (INT64_C(0));
                } else {
                    bool __t110;
                    if ((t2_979) == (INT64_C(0))) {
                        __t110 = false;
                    } else {
                        __auto_type __ps_111 = (cons_hyeq_hygo(t1_978, t2_979));
                        if (tur_panicking) return (bool){0};
                        __t110 = __ps_111;
                    }
                    __t109 = __t110;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_987 = (int64_t)(intptr_t)(__ps_119);
                (void)out_987;
                __t114 = out_987;
            }
            __t112 = __t114;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_121) {
            ...
            int64_t __t122;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_994 = (int64_t)(intptr_t)(__ps_126);
                (void)out_994;
                __t122 = out_994;
            }
            __t120 = __t122;
        ...
        if (__ps_131) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1065 = __ps_132;
                (void)h_1065;
                __auto_type __ps_133 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1066 = __ps_133;
                (void)k_1066;
                __auto_type __ps_134 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1065, (void *)(intptr_t)(k_1066), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_134) {
                    void * __t135 = iter;
                    void * __t136 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t138;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1069 = __ps_140;
            (void)iter_1069;
            __auto_type __ps_141 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_142 = (hamt_slkeyeq((void *)(intptr_t)(__ps_141)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1070 = __ps_142;
            (void)keyeq_1070;
            __auto_type __ps_143 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_144 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1069), (void *)(intptr_t)(__ps_143), (void *)(intptr_t)(keyeq_1070)));
            if (tur_panicking) return (bool){0};
            bool result_1071 = __ps_144;
            (void)result_1071;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t165;
        {
            ...
            {
                __auto_type __ps_167 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1198));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1199 = __ps_167;
                (void)_un_unv_1199;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t170;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1248 = __ps_171;
            (void)r_1248;
            int64_t __t172;
            __auto_type __ps_173 = (schema_hydecode_hyok_qu(r_1248));
            if (tur_panicking) return (int64_t){0};
            if (__ps_173) {
                __auto_type __ps_174 = (schema_hydecode_hyvalue(r_1248));
                if (tur_panicking) return (int64_t){0};
                __t172 = __ps_174;
            } else {
                __auto_type __ps_175 = (schema_hydecode_hyerrors(r_1248));
                if (tur_panicking) return (int64_t){0};
...
static int64_t step(int64_t c, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 2: {
           __auto_type __ra181_0 = ((c) + (INT64_C(1)));
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_182 = (step(INT64_C(0), INT64_C(200000)));
