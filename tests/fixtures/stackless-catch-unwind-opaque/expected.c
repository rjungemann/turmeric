...
struct __env_1336 { tur_thunk_int64_t_t __fn; int64_t c; int64_t n; };
...
static int64_t __fn_1334(void * __env_p_1337) {
        ...
        int64_t __ps_42 = (step((__env___env_1336->c) + (INT64_C(1)), (__env___env_1336->n) - (INT64_C(1))));
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t153;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1311 = __ps_154;
            (void)r_1311;
            int64_t __t155;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1311));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                int64_t __ps_157 = (schema_hydecode_hyvalue(r_1311));
                if (tur_panicking) return ((int64_t)0);
                __t155 = __ps_157;
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1311));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n163->saved[3] = (int64_t)(intptr_t)(__t162);
            __k = __n163; __pc = 2; break;
           }
          }
          case 2: {
           int64_t __ra164_0 = ((c) + (INT64_C(1)));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_165 = (step(INT64_C(0), INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_165));
        int64_t __t166;
        __t166 = INT64_C(0);
