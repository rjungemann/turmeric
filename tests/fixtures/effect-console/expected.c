...
static void echo_doubled();

static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_264 = __k;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_264, (int64_t)INT64_C(21));
    return (int64_t)__t4;
}
...
static void __handle_body_2(void) {
    ...
    __eff_frame_5.cases[0].effect_name = "Write";
...
static void echo_doubled() {
        {
            int64_t __t0 = tur_effect_perform("Read", NULL, 0);
            int64_t x_261 = __t0;
            (void)x_261;
            int64_t __t1[1];
            __t1[0] = (int64_t)"result:";
            tur_effect_perform("Write", __t1, 1);
            printf("%lld\n", (long long)(((x_261) * (INT64_C(2)))));
        }
}
...
int main(int argc, char **argv) {
    ...
    __eff_frame_2.cases[0].effect_name = "Read";
