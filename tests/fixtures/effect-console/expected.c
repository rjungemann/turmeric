...
static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_199 = __k;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_199, (int64_t)INT64_C(21));
    return (int64_t)__t4;
}

static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * s_197 = (const char *)__effect_args[0];
    int64_t k_198 = __k;
    puts(s_197);
    int64_t __t7;
    int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_198, (int64_t)0);
    __t7 = __t8;
    return (int64_t)__t7;
}
