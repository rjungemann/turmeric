...
static int64_t __fn_1467(void * __env_p_1470) {
        ...
        int64_t __ps_92 = (g((__env___env_1469->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_92;
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            tur_handler_node *__b236 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b236->parent = tur_handler_chain; tur_handler_chain = __b236;
            tur_cont *__n236 = (tur_cont*)malloc(sizeof(tur_cont));
            __n236->tag = 3; __n236->boundary = __b236; __n236->next = __k;
            __n236->aggr_mask = 0x0u;
            __n236->saved[0] = (int64_t)(intptr_t)(n);
            __n236->saved[1] = (int64_t)(intptr_t)(__t233);
            __n236->saved[2] = (int64_t)(intptr_t)(__t234);
            __n236->saved[3] = (int64_t)(intptr_t)(__t235);
            __k = __n236; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic("x");
          ...
          case 3: {
           ...
           int64_t __box236;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp236 = global_panic_payload; global_panic_payload = 0; __box236 = tur_box_err((int64_t)(intptr_t)__pp236); }
           else { __box236 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box236);
           (void)(__box236);
           ...
           __n237->saved[1] = (int64_t)(intptr_t)(__t233);
           __n237->saved[2] = (int64_t)(intptr_t)(__t234);
           __n237->saved[3] = (int64_t)(intptr_t)(__t235);
           __k = __n237; __pc = 4; break;
          }
          case 4: {
           int64_t __ra238_0 = ((n) - (INT64_C(1)));
           n = __ra238_0;
           __pc = 1; break;
          }
          case 5: {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_239 = (g(INT64_C(500000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_239));
        int64_t __t240;
        __t240 = INT64_C(0);
