...
static int64_t __fn_1471(void * __env_p_1474) {
        ...
        int64_t __ps_124 = (g((__env___env_1473->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            tur_handler_node *__b268 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b268->parent = tur_handler_chain; tur_handler_chain = __b268;
            tur_cont *__n268 = (tur_cont*)malloc(sizeof(tur_cont));
            __n268->tag = 3; __n268->boundary = __b268; __n268->next = __k;
            __n268->aggr_mask = 0x0u;
            __n268->saved[0] = (int64_t)(intptr_t)(n);
            __n268->saved[1] = (int64_t)(intptr_t)(__t265);
            __n268->saved[2] = (int64_t)(intptr_t)(__t266);
            __n268->saved[3] = (int64_t)(intptr_t)(__t267);
            __k = __n268; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic("x");
          ...
          case 3: {
           ...
           int64_t __box268;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp268 = global_panic_payload; global_panic_payload = 0; __box268 = tur_box_err((int64_t)(intptr_t)__pp268); }
           else { __box268 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box268);
           (void)(__box268);
           ...
           __n269->saved[1] = (int64_t)(intptr_t)(__t265);
           __n269->saved[2] = (int64_t)(intptr_t)(__t266);
           __n269->saved[3] = (int64_t)(intptr_t)(__t267);
           __k = __n269; __pc = 4; break;
          }
          case 4: {
           int64_t __ra270_0 = ((n) - (INT64_C(1)));
           n = __ra270_0;
           __pc = 1; break;
          }
          case 5: {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_271 = (g(INT64_C(500000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_271));
        int64_t __t272;
        __t272 = INT64_C(0);
