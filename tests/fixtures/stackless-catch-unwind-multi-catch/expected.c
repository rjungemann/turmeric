...
static int64_t __fn_1279(void * __env_p_1282) {
        ...
        __auto_type __ps_40 = (g((__env___env_1281->n) - (INT64_C(1))));
        if (tur_panicking) return (int64_t){0};
        return __ps_40;
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n177->saved[1] = (int64_t)(intptr_t)(__t174);
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_180 = (g(INT64_C(500000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
