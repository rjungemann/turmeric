...
static int64_t __fn_1471(void * __env_p_1474) {
        ...
        int64_t __ps_104 = (g((__env___env_1473->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_104;
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            tur_handler_node *__b248 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b248->parent = tur_handler_chain; tur_handler_chain = __b248;
            tur_cont *__n248 = (tur_cont*)malloc(sizeof(tur_cont));
            __n248->tag = 3; __n248->boundary = __b248; __n248->next = __k;
            __n248->aggr_mask = 0x0u;
            __n248->saved[0] = (int64_t)(intptr_t)(n);
            __n248->saved[1] = (int64_t)(intptr_t)(__t245);
            __n248->saved[2] = (int64_t)(intptr_t)(__t246);
            __n248->saved[3] = (int64_t)(intptr_t)(__t247);
            __k = __n248; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic("x");
          ...
          case 3: {
           ...
           int64_t __box248;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp248 = global_panic_payload; global_panic_payload = 0; __box248 = tur_box_err((int64_t)(intptr_t)__pp248); }
           else { __box248 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box248);
           (void)(__box248);
           ...
           __n249->saved[1] = (int64_t)(intptr_t)(__t245);
           __n249->saved[2] = (int64_t)(intptr_t)(__t246);
           __n249->saved[3] = (int64_t)(intptr_t)(__t247);
           __k = __n249; __pc = 4; break;
          }
          case 4: {
           int64_t __ra250_0 = ((n) - (INT64_C(1)));
           n = __ra250_0;
           __pc = 1; break;
          }
          case 5: {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_251 = (g(INT64_C(500000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_251));
        int64_t __t252;
        __t252 = INT64_C(0);
