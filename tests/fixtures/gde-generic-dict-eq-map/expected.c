...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t25;
            {
                const char * __tur_mk___893 = "age";
                (void)__tur_mk___893;
                int64_t __t26;
                {
                    const char * __tur_mk___894 = "name";
                    (void)__tur_mk___894;
                    __t26 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___894), __inst_Hash_hash_cstr(__tur_mk___894), __inst_MapKey_mk_box_cstr(__tur_mk___894), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___894), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___894));
                }
                __t25 = map_assoc_eq_o(tur_map_kcheck(__t26, &__tur_mk___893), __inst_Hash_hash_cstr(__tur_mk___893), __inst_MapKey_mk_box_cstr(__tur_mk___893), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___893), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___893));
            }
            int64_t mapX_895 = __t25;
            (void)mapX_895;
            int64_t __t27;
            {
                const char * __tur_mk___896 = dupe("age");
                (void)__tur_mk___896;
                int64_t __t28;
                {
                    const char * __tur_mk___897 = dupe("name");
                    (void)__tur_mk___897;
                    __t28 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___897), __inst_Hash_hash_cstr(__tur_mk___897), __inst_MapKey_mk_box_cstr(__tur_mk___897), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___897), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___897));
                }
                __t27 = map_assoc_eq_o(tur_map_kcheck(__t28, &__tur_mk___896), __inst_Hash_hash_cstr(__tur_mk___896), __inst_MapKey_mk_box_cstr(__tur_mk___896), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___896), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___896));
            }
            int64_t mapY_898 = __t27;
            (void)mapY_898;
            int64_t __t29;
            {
                const char * __tur_mk___899 = "age";
                (void)__tur_mk___899;
                int64_t __t30;
                {
                    const char * __tur_mk___900 = "name";
                    (void)__tur_mk___900;
                    __t30 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___900), __inst_Hash_hash_cstr(__tur_mk___900), __inst_MapKey_mk_box_cstr(__tur_mk___900), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___900), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___900));
                }
                __t29 = map_assoc_eq_o(tur_map_kcheck(__t30, &__tur_mk___899), __inst_Hash_hash_cstr(__tur_mk___899), __inst_MapKey_mk_box_cstr(__tur_mk___899), INT64_C(99), __inst_MapKey_mk_cmp_cstr(__tur_mk___899), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___899));
            }
            int64_t mapZ_901 = __t29;
            (void)mapZ_901;
            int64_t __t31;
            {
                const char * __tur_mk___902 = "name";
                (void)__tur_mk___902;
                __t31 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___902), __inst_Hash_hash_cstr(__tur_mk___902), __inst_MapKey_mk_box_cstr(__tur_mk___902), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___902), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___902));
            }
