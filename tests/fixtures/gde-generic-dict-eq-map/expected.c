/Users/rjungemann/Projects/turmeric/src/compiler/emit_fns.c:156:62: runtime error: load of value 194, which is not a valid value for type 'bool'
SUMMARY: UndefinedBehaviorSanitizer: undefined-behavior /Users/rjungemann/Projects/turmeric/src/compiler/emit_fns.c:156:62 
...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t3;
            {
                const char * __tur_mk___850 = "age";
                (void)__tur_mk___850;
                int64_t __t4;
                {
                    const char * __tur_mk___851 = "name";
                    (void)__tur_mk___851;
                    __t4 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___851), __inst_Hash_hash_cstr(__tur_mk___851), __inst_MapKey_mk_box_cstr(__tur_mk___851), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___851), __inst_MapKey_mk_owned__cstr(__tur_mk___851));
                }
                __t3 = map_assoc_eq_o(tur_map_kcheck(__t4, &__tur_mk___850), __inst_Hash_hash_cstr(__tur_mk___850), __inst_MapKey_mk_box_cstr(__tur_mk___850), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___850), __inst_MapKey_mk_owned__cstr(__tur_mk___850));
            }
            int64_t mapX_852 = __t3;
            (void)mapX_852;
            int64_t __t5;
            {
                const char * __tur_mk___853 = dupe("age");
                (void)__tur_mk___853;
                int64_t __t6;
                {
                    const char * __tur_mk___854 = dupe("name");
                    (void)__tur_mk___854;
                    __t6 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___854), __inst_Hash_hash_cstr(__tur_mk___854), __inst_MapKey_mk_box_cstr(__tur_mk___854), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___854), __inst_MapKey_mk_owned__cstr(__tur_mk___854));
                }
                __t5 = map_assoc_eq_o(tur_map_kcheck(__t6, &__tur_mk___853), __inst_Hash_hash_cstr(__tur_mk___853), __inst_MapKey_mk_box_cstr(__tur_mk___853), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___853), __inst_MapKey_mk_owned__cstr(__tur_mk___853));
            }
            int64_t mapY_855 = __t5;
            (void)mapY_855;
            int64_t __t7;
            {
                const char * __tur_mk___856 = "age";
                (void)__tur_mk___856;
                int64_t __t8;
                {
                    const char * __tur_mk___857 = "name";
                    (void)__tur_mk___857;
                    __t8 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___857), __inst_Hash_hash_cstr(__tur_mk___857), __inst_MapKey_mk_box_cstr(__tur_mk___857), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___857), __inst_MapKey_mk_owned__cstr(__tur_mk___857));
                }
                __t7 = map_assoc_eq_o(tur_map_kcheck(__t8, &__tur_mk___856), __inst_Hash_hash_cstr(__tur_mk___856), __inst_MapKey_mk_box_cstr(__tur_mk___856), INT64_C(99), __inst_MapKey_mk_cmp_cstr(__tur_mk___856), __inst_MapKey_mk_owned__cstr(__tur_mk___856));
            }
            int64_t mapZ_858 = __t7;
            (void)mapZ_858;
            int64_t __t9;
            {
                const char * __tur_mk___859 = "name";
                (void)__tur_mk___859;
                __t9 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___859), __inst_Hash_hash_cstr(__tur_mk___859), __inst_MapKey_mk_box_cstr(__tur_mk___859), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___859), __inst_MapKey_mk_owned__cstr(__tur_mk___859));
            }
            int64_t mapW_860 = __t9;
            (void)mapW_860;
            int64_t __t10;
            if (eq2(mapX_852, mapY_855)) {
                __t10 = INT64_C(1);
            } else {
                __t10 = INT64_C(0);
            }
