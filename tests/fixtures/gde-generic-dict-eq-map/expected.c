...
static bool eq2(int64_t, int64_t);
static bool eq2__spec__bool_int64_t_int64_t(int64_t, int64_t);
...
static bool eq2(int64_t a, int64_t b) {
...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t25;
            {
                const char * _un_untur_unmk_un_un_893 = "age";
                (void)_un_untur_unmk_un_un_893;
                int64_t __t26;
                {
                    const char * _un_untur_unmk_un_un_894 = "name";
                    (void)_un_untur_unmk_un_un_894;
                    __t26 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_894), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_894), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_894), INT64_C(1), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_894), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_894));
                }
                __t25 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t26, &_un_untur_unmk_un_un_893), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_893), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_893), INT64_C(2), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_893), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_893));
            }
            int64_t mapX_895 = __t25;
            (void)mapX_895;
            int64_t __t27;
            {
                const char * _un_untur_unmk_un_un_896 = dupe("age");
                (void)_un_untur_unmk_un_un_896;
                int64_t __t28;
                {
                    const char * _un_untur_unmk_un_un_897 = dupe("name");
                    (void)_un_untur_unmk_un_un_897;
                    __t28 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_897), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_897), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_897), INT64_C(1), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_897), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_897));
                }
                __t27 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t28, &_un_untur_unmk_un_un_896), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_896), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_896), INT64_C(2), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_896), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_896));
            }
            int64_t mapY_898 = __t27;
            (void)mapY_898;
            int64_t __t29;
            {
                const char * _un_untur_unmk_un_un_899 = "age";
                (void)_un_untur_unmk_un_un_899;
                int64_t __t30;
                {
                    const char * _un_untur_unmk_un_un_900 = "name";
                    (void)_un_untur_unmk_un_un_900;
                    __t30 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_900), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_900), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_900), INT64_C(1), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_900), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_900));
                }
                __t29 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(__t30, &_un_untur_unmk_un_un_899), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_899), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_899), INT64_C(99), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_899), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_899));
            }
            int64_t mapZ_901 = __t29;
            (void)mapZ_901;
            int64_t __t31;
            {
                const char * _un_untur_unmk_un_un_902 = "name";
                (void)_un_untur_unmk_un_un_902;
                __t31 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(map_hynew(), &_un_untur_unmk_un_un_902), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_902), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_902), INT64_C(1), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_902), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_902));
            }
            int64_t mapW_903 = __t31;
            (void)mapW_903;
            int64_t __t32;
            if (eq2__spec__bool_int64_t_int64_t(mapX_895, mapY_898)) {
                __t32 = INT64_C(1);
            } else {
                __t32 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t32));
            int64_t __t33;
            if (eq2__spec__bool_int64_t_int64_t(mapX_895, mapZ_901)) {
                __t33 = INT64_C(1);
            } else {
                __t33 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t33));
            int64_t __t34;
            if (eq2__spec__bool_int64_t_int64_t(mapX_895, mapW_903)) {
                __t34 = INT64_C(1);
            } else {
                __t34 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t34));
            int64_t __t35;
            if (eq2__spec__bool_int64_t_int64_t(mapX_895, mapX_895)) {
                __t35 = INT64_C(1);
            } else {
                __t35 = INT64_C(0);
            }
...
static bool eq2__spec__bool_int64_t_int64_t(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_Map(a, b);
}
