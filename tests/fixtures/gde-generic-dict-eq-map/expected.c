        ...
        }
        {
            int64_t __t3;
            {
                ...
                int64_t __t4;
                {
                    ...
                    (void)__tur_mk___859;
                    __t4 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___859), __inst_Hash_hash_cstr(__tur_mk___859), __inst_MapKey_mk_box_cstr(__tur_mk___859), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___859), __inst_MapKey_mk_owned__cstr(__tur_mk___859));
                }
                __t3 = map_assoc_eq_o(tur_map_kcheck(__t4, &__tur_mk___858), __inst_Hash_hash_cstr(__tur_mk___858), __inst_MapKey_mk_box_cstr(__tur_mk___858), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___858), __inst_MapKey_mk_owned__cstr(__tur_mk___858));
            }
            int64_t mapX_860 = __t3;
            (void)mapX_860;
            int64_t __t5;
            {
                ...
                int64_t __t6;
                {
                    ...
                    (void)__tur_mk___862;
                    __t6 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___862), __inst_Hash_hash_cstr(__tur_mk___862), __inst_MapKey_mk_box_cstr(__tur_mk___862), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___862), __inst_MapKey_mk_owned__cstr(__tur_mk___862));
                }
                __t5 = map_assoc_eq_o(tur_map_kcheck(__t6, &__tur_mk___861), __inst_Hash_hash_cstr(__tur_mk___861), __inst_MapKey_mk_box_cstr(__tur_mk___861), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___861), __inst_MapKey_mk_owned__cstr(__tur_mk___861));
            }
            int64_t mapY_863 = __t5;
            (void)mapY_863;
            int64_t __t7;
            {
                ...
                int64_t __t8;
                {
                    ...
                    (void)__tur_mk___865;
                    __t8 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___865), __inst_Hash_hash_cstr(__tur_mk___865), __inst_MapKey_mk_box_cstr(__tur_mk___865), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___865), __inst_MapKey_mk_owned__cstr(__tur_mk___865));
                }
                __t7 = map_assoc_eq_o(tur_map_kcheck(__t8, &__tur_mk___864), __inst_Hash_hash_cstr(__tur_mk___864), __inst_MapKey_mk_box_cstr(__tur_mk___864), INT64_C(99), __inst_MapKey_mk_cmp_cstr(__tur_mk___864), __inst_MapKey_mk_owned__cstr(__tur_mk___864));
            }
            int64_t mapZ_866 = __t7;
            (void)mapZ_866;
            int64_t __t9;
            {
                const char * __tur_mk___867 = "name";
                (void)__tur_mk___867;
                __t9 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___867), __inst_Hash_hash_cstr(__tur_mk___867), __inst_MapKey_mk_box_cstr(__tur_mk___867), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___867), __inst_MapKey_mk_owned__cstr(__tur_mk___867));
            }
            int64_t mapW_868 = __t9;
            (void)mapW_868;
            int64_t __t10;
