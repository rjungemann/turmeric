...
int main(int argc, char **argv) {
        ...
        }
        {
            int64_t __t25;
            {
                const char * __tur_mk___882 = "age";
                (void)__tur_mk___882;
                int64_t __t26;
                {
                    const char * __tur_mk___883 = "name";
                    (void)__tur_mk___883;
                    __t26 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___883), __inst_Hash_hash_cstr(__tur_mk___883), __inst_MapKey_mk_box_cstr(__tur_mk___883), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___883), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___883));
                }
                __t25 = map_assoc_eq_o(tur_map_kcheck(__t26, &__tur_mk___882), __inst_Hash_hash_cstr(__tur_mk___882), __inst_MapKey_mk_box_cstr(__tur_mk___882), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___882), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___882));
            }
            int64_t mapX_884 = __t25;
            (void)mapX_884;
            int64_t __t27;
            {
                const char * __tur_mk___885 = dupe("age");
                (void)__tur_mk___885;
                int64_t __t28;
                {
                    const char * __tur_mk___886 = dupe("name");
                    (void)__tur_mk___886;
                    __t28 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___886), __inst_Hash_hash_cstr(__tur_mk___886), __inst_MapKey_mk_box_cstr(__tur_mk___886), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___886), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___886));
                }
                __t27 = map_assoc_eq_o(tur_map_kcheck(__t28, &__tur_mk___885), __inst_Hash_hash_cstr(__tur_mk___885), __inst_MapKey_mk_box_cstr(__tur_mk___885), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___885), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___885));
            }
            int64_t mapY_887 = __t27;
            (void)mapY_887;
            int64_t __t29;
            {
                const char * __tur_mk___888 = "age";
                (void)__tur_mk___888;
                int64_t __t30;
                {
                    const char * __tur_mk___889 = "name";
                    (void)__tur_mk___889;
                    __t30 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___889), __inst_Hash_hash_cstr(__tur_mk___889), __inst_MapKey_mk_box_cstr(__tur_mk___889), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___889), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___889));
                }
                __t29 = map_assoc_eq_o(tur_map_kcheck(__t30, &__tur_mk___888), __inst_Hash_hash_cstr(__tur_mk___888), __inst_MapKey_mk_box_cstr(__tur_mk___888), INT64_C(99), __inst_MapKey_mk_cmp_cstr(__tur_mk___888), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___888));
            }
            int64_t mapZ_890 = __t29;
            (void)mapZ_890;
            int64_t __t31;
            {
                const char * __tur_mk___891 = "name";
                (void)__tur_mk___891;
                __t31 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___891), __inst_Hash_hash_cstr(__tur_mk___891), __inst_MapKey_mk_box_cstr(__tur_mk___891), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___891), __inst_MapKey_mk_owned_qu_cstr(__tur_mk___891));
            }
            int64_t mapW_892 = __t31;
            (void)mapW_892;
            int64_t __t32;
            if (eq2__spec__bool_int64_t_int64_t(mapX_884, mapY_887)) {
                __t32 = INT64_C(1);
            } else {
                __t32 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t32));
            int64_t __t33;
            if (eq2__spec__bool_int64_t_int64_t(mapX_884, mapZ_890)) {
                __t33 = INT64_C(1);
            } else {
                __t33 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t33));
            int64_t __t34;
            if (eq2__spec__bool_int64_t_int64_t(mapX_884, mapW_892)) {
                __t34 = INT64_C(1);
            } else {
                __t34 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t34));
            int64_t __t35;
            if (eq2__spec__bool_int64_t_int64_t(mapX_884, mapX_884)) {
                __t35 = INT64_C(1);
            } else {
                __t35 = INT64_C(0);
            }
