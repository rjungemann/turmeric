        ...
        }
        {
            int64_t __t7;
            {
                ...
                int64_t __t8;
                {
                    ...
                    (void)__tur_mk___859;
                    __t8 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___859), __inst_Hash_hash_cstr(__tur_mk___859), __inst_MapKey_mk_box_cstr(__tur_mk___859), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___859), __inst_MapKey_mk_owned__cstr(__tur_mk___859));
                }
                __t7 = map_assoc_eq_o(tur_map_kcheck(__t8, &__tur_mk___858), __inst_Hash_hash_cstr(__tur_mk___858), __inst_MapKey_mk_box_cstr(__tur_mk___858), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___858), __inst_MapKey_mk_owned__cstr(__tur_mk___858));
            }
            int64_t mapX_860 = __t7;
            (void)mapX_860;
            int64_t __t9;
            {
                ...
                int64_t __t10;
                {
                    ...
                    (void)__tur_mk___862;
                    __t10 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___862), __inst_Hash_hash_cstr(__tur_mk___862), __inst_MapKey_mk_box_cstr(__tur_mk___862), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___862), __inst_MapKey_mk_owned__cstr(__tur_mk___862));
                }
                __t9 = map_assoc_eq_o(tur_map_kcheck(__t10, &__tur_mk___861), __inst_Hash_hash_cstr(__tur_mk___861), __inst_MapKey_mk_box_cstr(__tur_mk___861), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___861), __inst_MapKey_mk_owned__cstr(__tur_mk___861));
            }
            int64_t mapY_863 = __t9;
            (void)mapY_863;
            int64_t __t11;
            {
                ...
                int64_t __t12;
                {
                    ...
                    (void)__tur_mk___865;
                    __t12 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___865), __inst_Hash_hash_cstr(__tur_mk___865), __inst_MapKey_mk_box_cstr(__tur_mk___865), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___865), __inst_MapKey_mk_owned__cstr(__tur_mk___865));
                }
                __t11 = map_assoc_eq_o(tur_map_kcheck(__t12, &__tur_mk___864), __inst_Hash_hash_cstr(__tur_mk___864), __inst_MapKey_mk_box_cstr(__tur_mk___864), INT64_C(99), __inst_MapKey_mk_cmp_cstr(__tur_mk___864), __inst_MapKey_mk_owned__cstr(__tur_mk___864));
            }
            int64_t mapZ_866 = __t11;
            (void)mapZ_866;
            int64_t __t13;
            {
                const char * __tur_mk___867 = "name";
                (void)__tur_mk___867;
                __t13 = map_assoc_eq_o(tur_map_kcheck(map_new(), &__tur_mk___867), __inst_Hash_hash_cstr(__tur_mk___867), __inst_MapKey_mk_box_cstr(__tur_mk___867), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___867), __inst_MapKey_mk_owned__cstr(__tur_mk___867));
            }
            int64_t mapW_868 = __t13;
            (void)mapW_868;
            int64_t __t14;
