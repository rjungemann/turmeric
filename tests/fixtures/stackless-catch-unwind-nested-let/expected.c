...
struct __env_1626 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
...
static int64_t __fn_1624(void * __env_p_1627) {
        ...
        return f((__env___env_1626->n) - (INT64_C(1)), (__env___env_1626->acc) + (INT64_C(1)));
}
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_106) {
            ...
            int64_t __t107;
            {
                ...
                int64_t out_1303 = (int64_t)(intptr_t)(__ps_112);
                (void)out_1303;
                __t107 = out_1303;
            }
            __t105 = __t107;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                int64_t out_1310 = (int64_t)(intptr_t)(__ps_119);
                (void)out_1310;
                __t115 = out_1310;
            }
            __t113 = __t115;
        ...
        if (__ps_120) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1381 = __ps_121;
                (void)h_1381;
                void * __ps_122 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1382 = __ps_122;
                (void)k_1382;
                bool __ps_123 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1381, (void *)(intptr_t)(k_1382), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_123) {
                    void * __t124 = iter;
                    void * __t125 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t127;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1385 = __ps_129;
            (void)iter_1385;
            void * __ps_130 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_131 = (hamt_slkeyeq((void *)(intptr_t)(__ps_130)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1386 = __ps_131;
            (void)keyeq_1386;
            void * __ps_132 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_133 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1385), (void *)(intptr_t)(__ps_132), (void *)(intptr_t)(keyeq_1386)));
            if (tur_panicking) return ((bool)0);
            bool result_1387 = __ps_133;
            (void)result_1387;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t154;
        {
            ...
            {
                tur_adt_Vec__int * __ps_156 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1517));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1518 = __ps_156;
                (void)_un_unv_1518;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1568 = __ps_159;
            (void)r_1568;
            bool __ps_160 = (schema_hydecode_hyok_qu(r_1568));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_160) {
                return schema_hydecode_hyvalue(r_1568);
            } else {
                int64_t __ps_161 = (schema_hydecode_hyerrors(r_1568));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t163;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1619 = __ps_164;
            (void)m_1619;
            tur_frame __frame_165;
            tur_frame_init(&__frame_165, NULL);
            struct __defer_env_166 __t168 = {.m = m_1619};
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t180;
           {
               int64_t d_1629 = (n) - (INT64_C(1));
               (void)d_1629;
               int64_t s_1630 = (acc) + (n);
               (void)s_1630;
               int64_t __t181;
               if ((d_1629) == (INT64_C(0))) {
                   __t181 = s_1630;
               } else {
                   __t181 = (s_1630) + (d_1629);
               }
               __t180 = __t181;
           }
