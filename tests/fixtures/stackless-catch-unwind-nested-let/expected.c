...
struct __env_1437 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
...
static int64_t __fn_1435(void * __env_p_1438) {
        ...
        int64_t __ps_40 = (f((__env___env_1437->n) - (INT64_C(1)), (__env___env_1437->acc) + (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t188;
           {
               int64_t d_1440 = (n) - (INT64_C(1));
               (void)d_1440;
               int64_t s_1441 = (acc) + (n);
               (void)s_1441;
               int64_t __t189;
               if ((d_1440) == (INT64_C(0))) {
                   __t189 = s_1441;
               } else {
                   __t189 = (s_1441) + (d_1440);
               }
               __t188 = __t189;
           }
