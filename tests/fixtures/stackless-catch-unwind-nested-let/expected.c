...
struct __env_1371 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
...
static int64_t __fn_1369(void * __env_p_1372) {
        ...
        int64_t __ps_44 = (f((__env___env_1371->n) - (INT64_C(1)), (__env___env_1371->acc) + (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t172;
           {
               int64_t d_1374 = (n) - (INT64_C(1));
               (void)d_1374;
               int64_t s_1375 = (acc) + (n);
               (void)s_1375;
               int64_t __t173;
               if ((d_1374) == (INT64_C(0))) {
                   __t173 = s_1375;
               } else {
                   __t173 = (s_1375) + (d_1374);
               }
               __t172 = __t173;
           }
