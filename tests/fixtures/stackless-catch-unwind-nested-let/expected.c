...
struct __env_1275 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
static int64_t __fn_1273(void * __env_p_1276) {
        struct __env_1275 *__env___env_1275 = (struct __env_1275 *)__env_p_1276;
        __auto_type __ps_40 = (f((__env___env_1275->n) - (INT64_C(1)), (__env___env_1275->acc) + (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t178;
           {
               int64_t d_1278 = (n) - (INT64_C(1));
               (void)d_1278;
               int64_t s_1279 = (acc) + (n);
               (void)s_1279;
               int64_t __t179;
               if ((d_1278) == (INT64_C(0))) {
                   __t179 = s_1279;
               } else {
                   __t179 = (s_1279) + (d_1278);
               }
               __t178 = __t179;
           }
