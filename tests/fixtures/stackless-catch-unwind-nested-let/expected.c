...
struct __env_1272 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
static int64_t __fn_1270(void * __env_p_1273) {
        struct __env_1272 *__env___env_1272 = (struct __env_1272 *)__env_p_1273;
        __auto_type __ps_40 = (f((__env___env_1272->n) - (INT64_C(1)), (__env___env_1272->acc) + (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t178;
           {
               int64_t d_1275 = (n) - (INT64_C(1));
               (void)d_1275;
               int64_t s_1276 = (acc) + (n);
               (void)s_1276;
               int64_t __t179;
               if ((d_1275) == (INT64_C(0))) {
                   __t179 = s_1276;
               } else {
                   __t179 = (s_1276) + (d_1275);
               }
               __t178 = __t179;
           }
