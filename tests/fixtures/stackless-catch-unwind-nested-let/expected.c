...
struct __env_1280 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
static int64_t __fn_1278(void * __env_p_1281) {
        struct __env_1280 *__env___env_1280 = (struct __env_1280 *)__env_p_1281;
        __auto_type __ps_40 = (f((__env___env_1280->n) - (INT64_C(1)), (__env___env_1280->acc) + (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t178;
           {
               int64_t d_1283 = (n) - (INT64_C(1));
               (void)d_1283;
               int64_t s_1284 = (acc) + (n);
               (void)s_1284;
               int64_t __t179;
               if ((d_1283) == (INT64_C(0))) {
                   __t179 = s_1284;
               } else {
                   __t179 = (s_1284) + (d_1283);
               }
               __t178 = __t179;
           }
