...
struct __env_1274 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
static int64_t __fn_1272(void * __env_p_1275) {
        struct __env_1274 *__env___env_1274 = (struct __env_1274 *)__env_p_1275;
        __auto_type __ps_43 = (f((__env___env_1274->n) - (INT64_C(1)), (__env___env_1274->acc) + (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t186;
           {
               int64_t d_1277 = (n) - (INT64_C(1));
               (void)d_1277;
               int64_t s_1278 = (acc) + (n);
               (void)s_1278;
               int64_t __t187;
               if ((d_1277) == (INT64_C(0))) {
                   __t187 = s_1278;
               } else {
                   __t187 = (s_1278) + (d_1277);
               }
               __t186 = __t187;
           }
