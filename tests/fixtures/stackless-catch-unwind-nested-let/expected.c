...
struct __env_1277 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
static int64_t __fn_1275(void * __env_p_1278) {
        struct __env_1277 *__env___env_1277 = (struct __env_1277 *)__env_p_1278;
        __auto_type __ps_40 = (f((__env___env_1277->n) - (INT64_C(1)), (__env___env_1277->acc) + (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t178;
           {
               int64_t d_1280 = (n) - (INT64_C(1));
               (void)d_1280;
               int64_t s_1281 = (acc) + (n);
               (void)s_1281;
               int64_t __t179;
               if ((d_1280) == (INT64_C(0))) {
                   __t179 = s_1281;
               } else {
                   __t179 = (s_1281) + (d_1280);
               }
               __t178 = __t179;
           }
