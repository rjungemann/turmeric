...
struct __env_1333 { tur_thunk_int64_t_t __fn; int64_t n; int64_t acc; };
...
static int64_t __fn_1331(void * __env_p_1334) {
        ...
        int64_t __ps_42 = (f((__env___env_1333->n) - (INT64_C(1)), (__env___env_1333->acc) + (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t168;
           {
               int64_t d_1336 = (n) - (INT64_C(1));
               (void)d_1336;
               int64_t s_1337 = (acc) + (n);
               (void)s_1337;
               int64_t __t169;
               if ((d_1336) == (INT64_C(0))) {
                   __t169 = s_1337;
               } else {
                   __t169 = (s_1337) + (d_1336);
               }
               __t168 = __t169;
           }
