...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t18[1] = (int64_t)(intptr_t)__fn_897;
        void *__t19 = __t18;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t20) {
            ...
            __t21[1] = (int64_t)(intptr_t)__fn_1017;
            void *__t22 = __t21;
...
int main(int argc, char **argv) {
        ...
        tur_option_t *__t48 = (tur_option_t *)(intptr_t)(some(INT64_C(7)));
        int64_t *__t49 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t49[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t;
        __t49[1] = (int64_t)(intptr_t)pos_hyi_qu;
        void *__t50 = __t49;
        printf("%lld\n", (long long)(unwrap_hyor_hydefault(keep_if__spec__Option__int_Option__int_bool((__t48 ? (Option__int){.is_some = __t48->is_some, .value = __t48->value} : (Option__int){0}), (int64_t)(intptr_t)(__t50)), INT64_C(11))));
        tur_option_t *__t51 = (tur_option_t *)(intptr_t)(some(INT64_C(-3)));
        ...
        void *__t53 = __t52;
        printf("%lld\n", (long long)(unwrap_hyor_hydefault(keep_if__spec__Option__int_Option__int_bool((__t51 ? (Option__int){.is_some = __t51->is_some, .value = __t51->value} : (Option__int){0}), (int64_t)(intptr_t)(__t53)), INT64_C(11))));
        tur_option_t *__t54 = (tur_option_t *)(intptr_t)(some(((union { double s; int64_t d; }){.s = -2.5}).d));
        int64_t *__t55 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t55[0] = (int64_t)(intptr_t)__tur_fatshim_bool_double;
        __t55[1] = (int64_t)(intptr_t)pos_hyf_qu;
        void *__t56 = __t55;
        printf("%lld\n", (long long)(float_hy_gtint((unwrap_hyor_hydefault_hyf(keep_if__spec__Option__float_Option__float_bool((__t54 ? (Option__float){.is_some = __t54->is_some, .value = ((union { int64_t s; double d; }){.s = __t54->value}).d} : (Option__float){0}), (int64_t)(intptr_t)(__t56)), 4.5)) * (100.0))));
...
static Option__float keep_if__spec__Option__float_Option__float_bool(Option__float o, int64_t pred) {
        ...
        if ((o).is_some) {
            ...
            if ((*( tur_thunk_bool_double_t *)((void *)(intptr_t)(pred)))((void *)(intptr_t)(pred), (o).value)) {
                ...
                __t61 = none__spec__Option__float();
            }
            __t60 = __t61;
        } else {
            __t60 = none__spec__Option__float();
        }
        return __t60;
}
