...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_67 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_755, (void *)(intptr_t)(k_756), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t69;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_760 = __ps_71;
            (void)iter_760;
            __auto_type __ps_72 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_73 = (hamt_slkeyeq((void *)(intptr_t)(__ps_72)));
            if (tur_panicking) return (bool){0};
            void * keyeq_761 = __ps_73;
            (void)keyeq_761;
            __auto_type __ps_74 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_75 = (map_hyeq_hyloop((void *)(intptr_t)(iter_760), (void *)(intptr_t)(__ps_74), (void *)(intptr_t)(keyeq_761), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_762 = __ps_75;
            (void)result_762;
        ...
        if (__ps_94) {
            bool __t95;
            {
                ...
                if ((t1_1002) == (INT64_C(0))) {
                    __t96 = (t2_1003) == (INT64_C(0));
                } else {
                    bool __t97;
                    if ((t2_1003) == (INT64_C(0))) {
                        __t97 = false;
                    } else {
                        __auto_type __ps_98 = (cons_hyeq_hygo(t1_1002, t2_1003));
                        if (tur_panicking) return (bool){0};
                        __t97 = __ps_98;
                    }
                    __t96 = __t97;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_104) {
            ...
            int64_t __t105;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1018 = (int64_t)(intptr_t)(__ps_109);
                (void)out_1018;
                __t105 = out_1018;
            }
            __t103 = __t105;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t114;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1093 = __ps_116;
            (void)iter_1093;
            __auto_type __ps_117 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_118 = (hamt_slkeyeq((void *)(intptr_t)(__ps_117)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1094 = __ps_118;
            (void)keyeq_1094;
            __auto_type __ps_119 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_120 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1093), (void *)(intptr_t)(__ps_119), (void *)(intptr_t)(keyeq_1094)));
            if (tur_panicking) return (bool){0};
            bool result_1095 = __ps_120;
            (void)result_1095;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t141;
        {
            ...
            {
                __auto_type __ps_143 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1222));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1223 = __ps_143;
                (void)_un_unv_1223;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t146;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1272 = __ps_147;
            (void)r_1272;
            int64_t __t148;
            __auto_type __ps_149 = (schema_hydecode_hyok_qu(r_1272));
            if (tur_panicking) return (int64_t){0};
            if (__ps_149) {
                __auto_type __ps_150 = (schema_hydecode_hyvalue(r_1272));
                if (tur_panicking) return (int64_t){0};
                __t148 = __ps_150;
            } else {
                __auto_type __ps_151 = (schema_hydecode_hyerrors(r_1272));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_156 = (wrap_some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_157 = (unwrap_hyor_hydefault(__ps_156, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_157));
        __auto_type __ps_158 = (wrap_some__spec__tur_adt_Option__float_double(3.25));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_159 = (unwrap_hyor_hydefault_hyf(__ps_158, 0.0));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_160 = (float_hy_gtint((__ps_159) * (100.0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_160));
        __auto_type __ps_161 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t *__t162 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t162[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t;
        __t162[1] = (int64_t)(intptr_t)pos_hyi_qu;
        void *__t163 = __t162;
        __auto_type __ps_164 = (keep_if__spec__tur_adt_Option__int_tur_adt_Option__int_bool(__ps_161, (int64_t)(intptr_t)(__t163)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_165 = (unwrap_hyor_hydefault(__ps_164, INT64_C(11)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_165));
        __auto_type __ps_166 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(-3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t *__t167 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t167[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t;
        __t167[1] = (int64_t)(intptr_t)pos_hyi_qu;
        void *__t168 = __t167;
        __auto_type __ps_169 = (keep_if__spec__tur_adt_Option__int_tur_adt_Option__int_bool(__ps_166, (int64_t)(intptr_t)(__t168)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_170 = (unwrap_hyor_hydefault(__ps_169, INT64_C(11)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_170));
        __auto_type __ps_171 = (some__spec__tur_adt_Option__float_double(-2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t *__t172 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t172[0] = (int64_t)(intptr_t)__tur_fatshim_bool_double;
        __t172[1] = (int64_t)(intptr_t)pos_hyf_qu;
        void *__t173 = __t172;
        __auto_type __ps_174 = (keep_if__spec__tur_adt_Option__float_tur_adt_Option__float_bool(__ps_171, (int64_t)(intptr_t)(__t173)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_175 = (unwrap_hyor_hydefault_hyf(__ps_174, 4.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_176 = (float_hy_gtint((__ps_175) * (100.0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        __auto_type __ps_177 = (none());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_178 = (some_qu(__ps_177));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Option__int wrap_some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_182 = (some__spec__tur_adt_Option__int_int64_t(x));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_183 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_183;
}

static tur_adt_Option__float wrap_some__spec__tur_adt_Option__float_double(double x) {
        __auto_type __ps_184 = (some__spec__tur_adt_Option__float_double(x));
...
static tur_adt_Option__float some__spec__tur_adt_Option__float_double(double x) {
        __auto_type __ps_185 = (ctor_Option__float(true, x));
        if (tur_panicking) return (tur_adt_Option__float){0};
        return __ps_185;
}
