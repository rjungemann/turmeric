...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t2) {
            ...
            __t3[1] = (int64_t)(intptr_t)__fn_677;
            void *__t4 = __t3;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t5) {
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_713;
            void *__t7 = __t6;
...
static int64_t __inst_Applicative_ap_Option(int64_t ff, int64_t fa) {
        ...
        if (some___spec__bool_Option__opaque((__t12 ? (Option__opaque){.is_some = __t12->is_some, .value = (void *)(__t12->value)} : (Option__opaque){0}))) {
            ...
            if (some_qu(fa)) {
                int64_t __t14;
                {
                    int64_t _un_uncall_unhead_un748_749 = (int64_t)(intptr_t)(((ff) ? ((Option *)(intptr_t)(ff))->value : 0));
                    (void)_un_uncall_unhead_un748_749;
                    __t14 = ((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(_un_uncall_unhead_un748_749)))[0])((void *)(intptr_t)(_un_uncall_unhead_un748_749), ((fa) ? ((Option *)(intptr_t)(fa))->value : 0));
                }
                __t13 = some(__t14);
            } else {
                __t13 = none();
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t23[1] = (int64_t)(intptr_t)__fn_899;
        void *__t24 = __t23;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t25) {
            ...
            __t26[1] = (int64_t)(intptr_t)__fn_1019;
            void *__t27 = __t26;
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            bool __t29;
            {
                int64_t h_664 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_664;
                void * k_665 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_665;
                bool __t30;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_664, (void *)(intptr_t)(k_665), (void *)(intptr_t)(keyeq))) {
                    bool __t31;
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)), map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_664, (void *)(intptr_t)(k_665), (void *)(intptr_t)(keyeq)))) {
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t32;
        {
            void * iter_669 = hamt_sliter_hyalloc((void *)(intptr_t)(map_hyhamt(m1)));
            (void)iter_669;
            void * keyeq_670 = hamt_slkeyeq((void *)(intptr_t)(map_hyhamt(m1)));
            (void)keyeq_670;
            bool result_671 = map_hyeq_hyloop((void *)(intptr_t)(iter_669), (void *)(intptr_t)(map_hyhamt(m2)), (void *)(intptr_t)(keyeq_670), (int64_t)(intptr_t)(val_cmp));
            (void)result_671;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_669));
            bool __t33;
            __t33 = result_671;
            __t32 = __t33;
        }
...
int main(int argc, char **argv) {
        ...
        tur_option_t *__t53 = (tur_option_t *)(intptr_t)(some(INT64_C(7)));
        ...
        void *__t55 = __t54;
        printf("%lld\n", (long long)(unwrap_hyor_hydefault(keep_if__spec__Option__int_Option__int_bool((__t53 ? (Option__int){.is_some = __t53->is_some, .value = __t53->value} : (Option__int){0}), (int64_t)(intptr_t)(__t55)), INT64_C(11))));
        tur_option_t *__t56 = (tur_option_t *)(intptr_t)(some(INT64_C(-3)));
        ...
        void *__t58 = __t57;
        printf("%lld\n", (long long)(unwrap_hyor_hydefault(keep_if__spec__Option__int_Option__int_bool((__t56 ? (Option__int){.is_some = __t56->is_some, .value = __t56->value} : (Option__int){0}), (int64_t)(intptr_t)(__t58)), INT64_C(11))));
        tur_option_t *__t59 = (tur_option_t *)(intptr_t)(some(((union { double s; int64_t d; }){.s = -2.5}).d));
        int64_t *__t60 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t60[0] = (int64_t)(intptr_t)__tur_fatshim_bool_double;
        __t60[1] = (int64_t)(intptr_t)pos_hyf_qu;
        void *__t61 = __t60;
        printf("%lld\n", (long long)(float_hy_gtint((unwrap_hyor_hydefault_hyf(keep_if__spec__Option__float_Option__float_bool((__t59 ? (Option__float){.is_some = __t59->is_some, .value = ((union { int64_t s; double d; }){.s = __t59->value}).d} : (Option__float){0}), (int64_t)(intptr_t)(__t61)), 4.5)) * (100.0))));
...
static Option__float keep_if__spec__Option__float_Option__float_bool(Option__float o, int64_t pred) {
        ...
        if ((o).is_some) {
            ...
            __t65 = none__spec__Option__float();
        }
        return __t65;
}
