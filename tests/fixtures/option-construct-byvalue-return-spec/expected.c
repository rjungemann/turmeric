        ...
        if (__ps_134) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1074 = __ps_135;
                (void)h_1074;
                __auto_type __ps_136 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1075 = __ps_136;
                (void)k_1075;
                __auto_type __ps_137 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1074, (void *)(intptr_t)(k_1075), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_137) {
                    void * __t138 = iter;
                    void * __t139 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t141;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1078 = __ps_143;
            (void)iter_1078;
            __auto_type __ps_144 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_145 = (hamt_slkeyeq((void *)(intptr_t)(__ps_144)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1079 = __ps_145;
            (void)keyeq_1079;
            __auto_type __ps_146 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_147 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1078), (void *)(intptr_t)(__ps_146), (void *)(intptr_t)(keyeq_1079)));
            if (tur_panicking) return (bool){0};
            bool result_1080 = __ps_147;
            (void)result_1080;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t174;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1257 = __ps_175;
            (void)r_1257;
            int64_t __t176;
            __auto_type __ps_177 = (schema_hydecode_hyok_qu(r_1257));
            if (tur_panicking) return (int64_t){0};
            if (__ps_177) {
                __auto_type __ps_178 = (schema_hydecode_hyvalue(r_1257));
                if (tur_panicking) return (int64_t){0};
                __t176 = __ps_178;
            } else {
                __auto_type __ps_179 = (schema_hydecode_hyerrors(r_1257));
                if (tur_panicking) return (int64_t){0};
