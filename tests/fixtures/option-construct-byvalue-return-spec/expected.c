...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t2) {
            ...
            __t3[1] = (int64_t)(intptr_t)__fn_683;
            void *__t4 = __t3;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t5) {
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_719;
            void *__t7 = __t6;
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            bool __t20;
            {
                int64_t h_670 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_670;
                void * k_671 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_671;
                bool __t21;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_670, (void *)(intptr_t)(k_671), (void *)(intptr_t)(keyeq))) {
                    bool __t22;
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)), map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_670, (void *)(intptr_t)(k_671), (void *)(intptr_t)(keyeq)))) {
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t23;
        {
            void * iter_675 = hamt_sliter_hyalloc((void *)(intptr_t)(map_hyhamt(m1)));
            (void)iter_675;
            void * keyeq_676 = hamt_slkeyeq((void *)(intptr_t)(map_hyhamt(m1)));
            (void)keyeq_676;
            bool result_677 = map_hyeq_hyloop((void *)(intptr_t)(iter_675), (void *)(intptr_t)(map_hyhamt(m2)), (void *)(intptr_t)(keyeq_676), (int64_t)(intptr_t)(val_cmp));
            (void)result_677;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_675));
            bool __t24;
            __t24 = result_677;
            __t23 = __t24;
        }
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            int64_t __t31;
            {
                int64_t out_910 = (int64_t)(intptr_t)(tcons__spec__Cons__int___int64_t_int64_t((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f))));
                (void)out_910;
                __t31 = out_910;
            }
            __t30 = __t31;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            int64_t __t33;
            {
                int64_t out_917 = (int64_t)(intptr_t)(tcons__spec__Cons__int___int64_t_int64_t(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2)));
                (void)out_917;
                __t33 = out_917;
            }
            __t32 = __t33;
...
int main(int argc, char **argv) {
        ...
        void *__t47 = __t46;
        printf("%lld\n", (long long)(unwrap_hyor_hydefault(keep_if__spec__Option__int_Option__int_bool(some__spec__Option__int_int64_t(INT64_C(7)), (int64_t)(intptr_t)(__t47)), INT64_C(11))));
        ...
        void *__t49 = __t48;
        printf("%lld\n", (long long)(unwrap_hyor_hydefault(keep_if__spec__Option__int_Option__int_bool(some__spec__Option__int_int64_t(INT64_C(-3)), (int64_t)(intptr_t)(__t49)), INT64_C(11))));
        int64_t *__t50 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t50[0] = (int64_t)(intptr_t)__tur_fatshim_bool_double;
        __t50[1] = (int64_t)(intptr_t)pos_hyf_qu;
        void *__t51 = __t50;
        printf("%lld\n", (long long)(float_hy_gtint((unwrap_hyor_hydefault_hyf(keep_if__spec__Option__float_Option__float_bool(some__spec__Option__float_double(-2.5), (int64_t)(intptr_t)(__t51)), 4.5)) * (100.0))));
