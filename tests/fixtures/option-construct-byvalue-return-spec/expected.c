...
static int64_t __tur_fatshim_bool_double(void *__e, double a0) {
    return (int64_t)(((bool (*)(double))(intptr_t)((int64_t *)__e)[1])(a0));
}
static union { void *__a; int64_t __b;
               char __c[sizeof(void *) + 2 * sizeof(int64_t)]; }
    __tur_fatbox_3 = { .__a = (void *)__tur_fatbox_keep };
typedef int64_t (*tur_thunk_int64_t_double_t)(void *, double);
#if defined(__GNUC__) && !defined(__clang__)
...
static int64_t keep_if__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t__cps(tur_adt_Option__int o, int64_t pred, DK *__kont) {
    ...
    if (__ps_206) {
        ...
        if (tur_panicking) return ((int64_t)0);
        bool __ps_209 = (((bool)(*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(pred)))((void *)(intptr_t)(pred), __ps_208)));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_209) {
            __t207 = o;
        } else {
...
static int64_t keep_if__spec__tur_adt_Option__float_tur_adt_Option__float_int64_t__cps(tur_adt_Option__float o, int64_t pred, DK *__kont) {
    ...
    if (__ps_214) {
        ...
        if (tur_panicking) return ((int64_t)0);
        bool __ps_217 = (((bool)(*( tur_thunk_int64_t_double_t *)((void *)(intptr_t)(pred)))((void *)(intptr_t)(pred), __ps_216)));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_217) {
            __t215 = o;
        } else {
