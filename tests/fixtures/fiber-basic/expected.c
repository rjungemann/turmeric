...
int main() {
        int64_t __t0;
        {
            void * f_270 = fiber_new_fn((void *)(intptr_t)(fiber_body), INT64_C(0));
            (void)f_270;
            int64_t __t1;
            {
                int64_t result_271 = fiber_resume_fn((void *)(intptr_t)(f_270), INT64_C(0));
                (void)result_271;
                printf("%lld\n", (long long)(result_271));
                fiber_free_fn((void *)(intptr_t)(f_270));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
