...
struct __defer_env_8 {RcControlBlock * orig; };

struct __defer_env_5 {RcControlBlock * cloned; };
...
static void __defer_6(void *__env) {
    ...
    rc_strong_decrement(__e->cloned);
    rc_free_queue_drain();
}
...
int main() {
        {
            ...
            *__t0 = INT64_C(42);
            ...
            __t1->value = __t0;
            RcControlBlock * orig_616 = __t1;
            (void)orig_616;
            tur_frame __frame_2;
            tur_frame_init(&__frame_2, NULL);
            {
                rc_strong_increment(orig_616);
                RcControlBlock * cloned_617 = orig_616;
                (void)cloned_617;
                tur_frame __frame_3;
                tur_frame_init(&__frame_3, &__frame_2);
                int64_t __t4 = rc_strong_count(cloned_617);
                printf("%lld\n", (long long)(__t4));
                struct __defer_env_5 __t7 = {.cloned = cloned_617};
                tur_frame_push_defer(&__frame_3, __defer_6, &__t7);
                tur_frame_fire_lifo(&__frame_3);
            }
            struct __defer_env_8 __t10 = {.orig = orig_616};
        ...
        *__t11 = INT64_C(99);
        ...
        __t12->value = __t11;
        rc_strong_increment(__t12);
        int64_t __t13 = rc_strong_count(__t12);
        printf("%lld\n", (long long)(__t13));
        int64_t __t14;
        __t14 = INT64_C(0);
        return (int)__t14;
