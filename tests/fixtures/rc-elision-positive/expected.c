...
int main() {
        {
            ...
            *__t0 = INT64_C(42);
            ...
            __t1->value = __t0;
            RcControlBlock * orig_208 = __t1;
            (void)orig_208;
            tur_frame __frame_2;
            tur_frame_init(&__frame_2, NULL);
            {
                rc_strong_increment(orig_208);
                RcControlBlock * cloned_209 = orig_208;
                (void)cloned_209;
                tur_frame __frame_3;
                tur_frame_init(&__frame_3, &__frame_2);
                int64_t __t4 = rc_strong_count(cloned_209);
                printf("%lld\n", (long long)(__t4));
                struct __defer_env_5 __t7 = {.cloned = cloned_209};
                tur_frame_push_defer(&__frame_3, __defer_6, &__t7);
                tur_frame_fire_lifo(&__frame_3);
            }
            struct __defer_env_8 __t10 = {.orig = orig_208};
