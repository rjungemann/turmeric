...
static int64_t classify(tur_tagged_t);
...
static int64_t classify(tur_tagged_t x) {
        int64_t __t0 = 0;
        {
            tur_tagged_t __t1 = x;
            if (TUR_GETTAG(__t1) == 0) {
                ...
                const char * s_212 = (const char *)(intptr_t)TUR_UNTAG(__t1);
                __t0 = INT64_C(3);
            }
        }
        return __t0;
...
int main() {
        printf("%lld\n", (long long)(classify(TUR_TAG(0, (int64_t)(intptr_t)(INT64_C(99))))));
        printf("%lld\n", (long long)(classify(TUR_TAG(1, (int64_t)(intptr_t)(false)))));
        printf("%lld\n", (long long)(classify(TUR_TAG(2, (int64_t)(intptr_t)("hi")))));
        int64_t __t2;
        __t2 = INT64_C(0);
        return (int)__t2;
}
