...
struct __defer_env_43 {int64_t i; };

static void __defer_44(void *__env) {
    struct __defer_env_43 *__e = (struct __defer_env_43 *)__env;
    printf("%lld\n", (long long)(__e->i));
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t i_1007 = INT64_C(0);
            (void)i_1007;
            while (1) {
                if (!((i_1007) < (INT64_C(3)))) break;
                tur_frame __frame_42;
                tur_frame_init(&__frame_42, NULL);
                struct __defer_env_43 __t45 = {.i = i_1007};
                tur_frame_push_defer(&__frame_42, __defer_44, &__t45);
                i_1007 = (i_1007) + (INT64_C(1));
                tur_frame_fire_lifo(&__frame_42);
            }
            puts("loop done");
        }
        int64_t __t46;
