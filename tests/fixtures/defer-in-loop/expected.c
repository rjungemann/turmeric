...
struct __defer_env_156 {int64_t i; };

static void __defer_157(void *__env) {
    struct __defer_env_156 *__e = (struct __defer_env_156 *)__env;
    printf("%lld\n", (long long)(__e->i));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t i_1300 = INT64_C(0);
            (void)i_1300;
            while (1) {
                if (!((i_1300) < (INT64_C(3)))) break;
                tur_frame __frame_155;
                tur_frame_init(&__frame_155, NULL);
                struct __defer_env_156 __t158 = {.i = i_1300};
                tur_frame_push_defer(&__frame_155, __defer_157, &__t158);
                i_1300 = (i_1300) + (INT64_C(1));
