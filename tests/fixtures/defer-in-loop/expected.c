...
struct __defer_env_24 {int64_t i; };

static void __defer_25(void *__env) {
    struct __defer_env_24 *__e = (struct __defer_env_24 *)__env;
    printf("%lld\n", (long long)(__e->i));
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t i_885 = INT64_C(0);
            (void)i_885;
            while (1) {
                if (!((i_885) < (INT64_C(3)))) break;
                tur_frame __frame_23;
                tur_frame_init(&__frame_23, NULL);
                struct __defer_env_24 __t26 = {.i = i_885};
                tur_frame_push_defer(&__frame_23, __defer_25, &__t26);
                i_885 = (i_885) + (INT64_C(1));
