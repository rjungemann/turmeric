...
struct __defer_env_182 {int64_t i; };
...
int main(int argc, char **argv) {
        ...
        {
            int64_t i_1264 = INT64_C(0);
            (void)i_1264;
            while (1) {
                if (!((i_1264) < (INT64_C(3)))) break;
                tur_frame __frame_181;
                tur_frame_init(&__frame_181, NULL);
                struct __defer_env_182 __t184 = {.i = i_1264};
                tur_frame_push_defer(&__frame_181, __defer_183, &__t184);
                i_1264 = (i_1264) + (INT64_C(1));
