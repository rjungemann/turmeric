...
struct __defer_env_169 {int64_t i; };
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t i_1432 = INT64_C(0);
            (void)i_1432;
            while (1) {
                if (!((i_1432) < (INT64_C(3)))) break;
                tur_frame __frame_168;
                tur_frame_init(&__frame_168, NULL);
                struct __defer_env_169 __t171 = {.i = i_1432};
                tur_frame_push_defer(&__frame_168, __defer_170, &__t171);
                i_1432 = (i_1432) + (INT64_C(1));
