...
struct __defer_env_160 {int64_t i; };
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t i_1326 = INT64_C(0);
            (void)i_1326;
            while (1) {
                if (!((i_1326) < (INT64_C(3)))) break;
                tur_frame __frame_159;
                tur_frame_init(&__frame_159, NULL);
                struct __defer_env_160 __t162 = {.i = i_1326};
                tur_frame_push_defer(&__frame_159, __defer_161, &__t162);
                i_1326 = (i_1326) + (INT64_C(1));
