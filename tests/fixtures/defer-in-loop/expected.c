...
struct __defer_env_47 {int64_t i; };

static void __defer_48(void *__env) {
    struct __defer_env_47 *__e = (struct __defer_env_47 *)__env;
    printf("%lld\n", (long long)(__e->i));
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            while (1) {
                ...
                struct __defer_env_47 __t49 = {.i = i_1005};
                tur_frame_push_defer(&__frame_46, __defer_48, &__t49);
