...
struct __defer_env_278 {int64_t i; };

struct __defer_env_267 {int64_t m; };

static void __defer_279(void *__env) {
    struct __defer_env_278 *__e = (struct __defer_env_278 *)__env;
    printf("%lld\n", (long long)(__e->i));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t i_1606 = INT64_C(0);
            (void)i_1606;
            while (1) {
                if (!((i_1606) < (INT64_C(3)))) break;
                tur_frame __frame_277;
                tur_frame_init(&__frame_277, NULL);
                struct __defer_env_278 __t280 = {.i = i_1606};
                tur_frame_push_defer(&__frame_277, __defer_279, &__t280);
                i_1606 = (i_1606) + (INT64_C(1));
