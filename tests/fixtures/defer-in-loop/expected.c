...
struct __defer_env_45 {int64_t i; };

static void __defer_46(void *__env) {
    struct __defer_env_45 *__e = (struct __defer_env_45 *)__env;
    printf("%lld\n", (long long)(__e->i));
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t i_1022 = INT64_C(0);
            (void)i_1022;
            while (1) {
                if (!((i_1022) < (INT64_C(3)))) break;
                tur_frame __frame_44;
                tur_frame_init(&__frame_44, NULL);
                struct __defer_env_45 __t47 = {.i = i_1022};
                tur_frame_push_defer(&__frame_44, __defer_46, &__t47);
                i_1022 = (i_1022) + (INT64_C(1));
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t49 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t49 = (Cons__int){.head = h, .tail = t};
        return __t49;
}
