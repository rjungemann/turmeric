...
struct __defer_env_154 {int64_t i; };

static void __defer_155(void *__env) {
    struct __defer_env_154 *__e = (struct __defer_env_154 *)__env;
    printf("%lld\n", (long long)(__e->i));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t i_1279 = INT64_C(0);
            (void)i_1279;
            while (1) {
                if (!((i_1279) < (INT64_C(3)))) break;
                tur_frame __frame_153;
                tur_frame_init(&__frame_153, NULL);
                struct __defer_env_154 __t156 = {.i = i_1279};
                tur_frame_push_defer(&__frame_153, __defer_155, &__t156);
                i_1279 = (i_1279) + (INT64_C(1));
                tur_frame_fire_lifo(&__frame_153);
            }
            puts("loop done");
        }
        int64_t __t157;
