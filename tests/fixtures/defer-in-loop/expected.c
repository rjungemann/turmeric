...
struct __defer_env_30 {int64_t i; };
...
int main(int argc, char **argv) {
        ...
        {
            int64_t i_900 = INT64_C(0);
            (void)i_900;
            while (1) {
                if (!((i_900) < (INT64_C(3)))) break;
                tur_frame __frame_29;
                tur_frame_init(&__frame_29, NULL);
                struct __defer_env_30 __t32 = {.i = i_900};
                tur_frame_push_defer(&__frame_29, __defer_31, &__t32);
                i_900 = (i_900) + (INT64_C(1));
