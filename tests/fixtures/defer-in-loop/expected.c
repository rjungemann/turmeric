...
struct __defer_env_51 {int64_t i; };
...
int main(int argc, char **argv) {
        ...
        {
            int64_t i_1261 = INT64_C(0);
            (void)i_1261;
            while (1) {
                if (!((i_1261) < (INT64_C(3)))) break;
                tur_frame __frame_50;
                tur_frame_init(&__frame_50, NULL);
                struct __defer_env_51 __t53 = {.i = i_1261};
                tur_frame_push_defer(&__frame_50, __defer_52, &__t53);
                i_1261 = (i_1261) + (INT64_C(1));
