...
struct __defer_env_22 {int64_t i; };

static void __defer_23(void *__env) {
    struct __defer_env_22 *__e = (struct __defer_env_22 *)__env;
    printf("%lld\n", (long long)(__e->i));
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t i_880 = INT64_C(0);
            (void)i_880;
            while (1) {
                if (!((i_880) < (INT64_C(3)))) break;
                tur_frame __frame_21;
                tur_frame_init(&__frame_21, NULL);
                struct __defer_env_22 __t24 = {.i = i_880};
                tur_frame_push_defer(&__frame_21, __defer_23, &__t24);
                i_880 = (i_880) + (INT64_C(1));
                tur_frame_fire_lifo(&__frame_21);
            }
            puts("loop done");
        }
        int64_t __t25;
