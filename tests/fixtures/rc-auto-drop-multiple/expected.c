...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t155;
        {
            ...
            *__t158 = INT64_C(20);
            ...
            __t159->value = __t158;
            RcControlBlock * y_1282 = __t159;
            (void)y_1282;
            tur_frame __frame_160;
            tur_frame_init(&__frame_160, NULL);
            struct __defer_env_161 __t163 = {.x = x_1281};
            tur_frame_push_defer(&__frame_160, __defer_162, &__t163);
            struct __defer_env_164 __t166 = {.y = y_1282};
            tur_frame_push_defer(&__frame_160, __defer_165, &__t166);
            int64_t __t167;
            int64_t __t168 = rc_strong_count(x_1281);
            int64_t __t169 = rc_strong_count(y_1282);
