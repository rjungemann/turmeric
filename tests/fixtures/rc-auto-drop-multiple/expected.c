...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t25;
        {
            ...
            *__t28 = INT64_C(20);
            ...
            __t29->value = __t28;
            RcControlBlock * y_869 = __t29;
            (void)y_869;
            tur_frame __frame_30;
            tur_frame_init(&__frame_30, NULL);
            struct __defer_env_31 __t33 = {.x = x_868};
            tur_frame_push_defer(&__frame_30, __defer_32, &__t33);
            struct __defer_env_34 __t36 = {.y = y_869};
            tur_frame_push_defer(&__frame_30, __defer_35, &__t36);
            int64_t __t37;
            int64_t __t38 = rc_strong_count(x_868);
            int64_t __t39 = rc_strong_count(y_869);
            __t37 = (__t38) + (__t39);
