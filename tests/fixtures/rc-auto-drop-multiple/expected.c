...
struct __defer_env_164 {RcControlBlock * y; };

struct __defer_env_161 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t155;
        {
            ...
            *__t156 = INT64_C(10);
            ...
            (void)x_1300;
            int64_t *__t158 = (int64_t *)malloc(sizeof(int64_t));
            *__t158 = INT64_C(20);
            RcControlBlock *__t159 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t159, __t158, NULL);
            RcControlBlock * y_1301 = __t159;
            (void)y_1301;
            tur_frame __frame_160;
            tur_frame_init(&__frame_160, NULL);
            struct __defer_env_161 __t163 = {.x = x_1300};
            tur_frame_push_defer(&__frame_160, __defer_162, &__t163);
            struct __defer_env_164 __t166 = {.y = y_1301};
            tur_frame_push_defer(&__frame_160, __defer_165, &__t166);
            int64_t __t167;
            int64_t __t168 = rc_strong_count(x_1300);
            int64_t __t169 = rc_strong_count(y_1301);
            __t167 = (__t168) + (__t169);
