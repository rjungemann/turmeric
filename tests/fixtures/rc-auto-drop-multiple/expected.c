...
struct __defer_env_284 {RcControlBlock * y; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t275;
        {
            ...
            *__t278 = INT64_C(20);
            ...
            struct __defer_env_284 __t286 = {.y = y_1607};
            tur_frame_push_defer(&__frame_280, __defer_285, &__t286);
            int64_t __t287;
            int64_t __t288 = rc_strong_count(x_1606);
            int64_t __t289 = rc_strong_count(y_1607);
            __t287 = (__t288) + (__t289);
