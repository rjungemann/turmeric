...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t44;
        {
            ...
            *__t47 = INT64_C(20);
            ...
            __t48->value = __t47;
            RcControlBlock * y_1023 = __t48;
            (void)y_1023;
            tur_frame __frame_49;
            tur_frame_init(&__frame_49, NULL);
            struct __defer_env_50 __t52 = {.x = x_1022};
            tur_frame_push_defer(&__frame_49, __defer_51, &__t52);
            struct __defer_env_53 __t55 = {.y = y_1023};
            tur_frame_push_defer(&__frame_49, __defer_54, &__t55);
            int64_t __t56;
            int64_t __t57 = rc_strong_count(x_1022);
            int64_t __t58 = rc_strong_count(y_1023);
            __t56 = (__t57) + (__t58);
