...
struct __defer_env_53 {RcControlBlock * y; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t44;
        {
            ...
            *__t47 = INT64_C(20);
            ...
            struct __defer_env_53 __t55 = {.y = y_1006};
            tur_frame_push_defer(&__frame_49, __defer_54, &__t55);
            int64_t __t56;
            int64_t __t57 = rc_strong_count(x_1005);
            int64_t __t58 = rc_strong_count(y_1006);
            __t56 = (__t57) + (__t58);
