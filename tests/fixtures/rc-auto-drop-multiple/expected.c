...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t42;
        {
            ...
            *__t45 = INT64_C(20);
            ...
            __t46->value = __t45;
            RcControlBlock * y_987 = __t46;
            (void)y_987;
            tur_frame __frame_47;
            tur_frame_init(&__frame_47, NULL);
            struct __defer_env_48 __t50 = {.x = x_986};
            tur_frame_push_defer(&__frame_47, __defer_49, &__t50);
            struct __defer_env_51 __t53 = {.y = y_987};
            tur_frame_push_defer(&__frame_47, __defer_52, &__t53);
            int64_t __t54;
            int64_t __t55 = rc_strong_count(x_986);
            int64_t __t56 = rc_strong_count(y_987);
            __t54 = (__t55) + (__t56);
