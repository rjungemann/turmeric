...
struct __defer_env_186 {RcControlBlock * y; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t177;
        {
            ...
            *__t180 = INT64_C(20);
            ...
            __t181->value = __t180;
            RcControlBlock * y_1268 = __t181;
            (void)y_1268;
            tur_frame __frame_182;
            tur_frame_init(&__frame_182, NULL);
            struct __defer_env_183 __t185 = {.x = x_1267};
            tur_frame_push_defer(&__frame_182, __defer_184, &__t185);
            struct __defer_env_186 __t188 = {.y = y_1268};
            tur_frame_push_defer(&__frame_182, __defer_187, &__t188);
            int64_t __t189;
            int64_t __t190 = rc_strong_count(x_1267);
            int64_t __t191 = rc_strong_count(y_1268);
