...
struct __defer_env_169 {RcControlBlock * y; };

struct __defer_env_166 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t160;
        {
            ...
            *__t163 = INT64_C(20);
            ...
            RcControlBlock * y_1331 = __t164;
            (void)y_1331;
            tur_frame __frame_165;
            tur_frame_init(&__frame_165, NULL);
            struct __defer_env_166 __t168 = {.x = x_1330};
            tur_frame_push_defer(&__frame_165, __defer_167, &__t168);
            struct __defer_env_169 __t171 = {.y = y_1331};
            tur_frame_push_defer(&__frame_165, __defer_170, &__t171);
            int64_t __t172;
            int64_t __t173 = rc_strong_count(x_1330);
            int64_t __t174 = rc_strong_count(y_1331);
