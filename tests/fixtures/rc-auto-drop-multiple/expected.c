...
static int64_t test_rc_auto_drop_multiple() {
        int64_t __t1;
        {
            ...
            *__t4 = INT64_C(20);
            ...
            __t5->value = __t4;
            RcControlBlock * y_692 = __t5;
            (void)y_692;
            tur_frame __frame_6;
            tur_frame_init(&__frame_6, NULL);
            struct __defer_env_7 __t9 = {.x = x_691};
            tur_frame_push_defer(&__frame_6, __defer_8, &__t9);
            struct __defer_env_10 __t12 = {.y = y_692};
            tur_frame_push_defer(&__frame_6, __defer_11, &__t12);
            int64_t __t13;
            int64_t __t14 = rc_strong_count(x_691);
            int64_t __t15 = rc_strong_count(y_692);
            __t13 = ((__t14) + (__t15));
