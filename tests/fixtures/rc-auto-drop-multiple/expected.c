...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t55;
        {
            ...
            *__t58 = INT64_C(20);
            ...
            __t59->value = __t58;
            RcControlBlock * y_1265 = __t59;
            (void)y_1265;
            tur_frame __frame_60;
            tur_frame_init(&__frame_60, NULL);
            struct __defer_env_61 __t63 = {.x = x_1264};
            tur_frame_push_defer(&__frame_60, __defer_62, &__t63);
            struct __defer_env_64 __t66 = {.y = y_1265};
            tur_frame_push_defer(&__frame_60, __defer_65, &__t66);
            int64_t __t67;
            int64_t __t68 = rc_strong_count(x_1264);
            int64_t __t69 = rc_strong_count(y_1265);
            __t67 = (__t68) + (__t69);
