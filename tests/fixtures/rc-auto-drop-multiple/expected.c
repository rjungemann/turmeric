...
struct __defer_env_30 {RcControlBlock * y; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t21;
        {
            ...
            *__t24 = INT64_C(20);
            ...
            __t25->value = __t24;
            RcControlBlock * y_881 = __t25;
            (void)y_881;
            tur_frame __frame_26;
            tur_frame_init(&__frame_26, NULL);
            struct __defer_env_27 __t29 = {.x = x_880};
            tur_frame_push_defer(&__frame_26, __defer_28, &__t29);
            struct __defer_env_30 __t32 = {.y = y_881};
            tur_frame_push_defer(&__frame_26, __defer_31, &__t32);
            int64_t __t33;
            int64_t __t34 = rc_strong_count(x_880);
            int64_t __t35 = rc_strong_count(y_881);
            __t33 = (__t34) + (__t35);
