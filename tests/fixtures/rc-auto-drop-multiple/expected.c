...
struct __defer_env_276 {RcControlBlock * y; };

struct __defer_env_273 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t267;
        {
            ...
            *__t268 = INT64_C(10);
            ...
            (void)x_1465;
            int64_t *__t270 = (int64_t *)malloc(sizeof(int64_t));
            *__t270 = INT64_C(20);
            TUR_REGION_NOTE_WORDS(&((*__t270)), sizeof((*__t270)));
            RcControlBlock *__t271 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t271, __t270, NULL);
            RcControlBlock * y_1466 = __t271;
            (void)y_1466;
            tur_frame __frame_272;
            tur_frame_init(&__frame_272, NULL);
            struct __defer_env_273 __t275 = {.x = x_1465};
            tur_frame_push_defer(&__frame_272, __defer_274, &__t275);
            struct __defer_env_276 __t278 = {.y = y_1466};
            tur_frame_push_defer(&__frame_272, __defer_277, &__t278);
            int64_t __t279;
            int64_t __t280 = rc_strong_count(x_1465);
            int64_t __t281 = rc_strong_count(y_1466);
