...
struct __defer_env_172 {RcControlBlock * y; };

struct __defer_env_169 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t163;
        {
            ...
            *__t166 = INT64_C(20);
            ...
            RcControlBlock * y_1363 = __t167;
            (void)y_1363;
            tur_frame __frame_168;
            tur_frame_init(&__frame_168, NULL);
            struct __defer_env_169 __t171 = {.x = x_1362};
            tur_frame_push_defer(&__frame_168, __defer_170, &__t171);
            struct __defer_env_172 __t174 = {.y = y_1363};
            tur_frame_push_defer(&__frame_168, __defer_173, &__t174);
            int64_t __t175;
            int64_t __t176 = rc_strong_count(x_1362);
            int64_t __t177 = rc_strong_count(y_1363);
