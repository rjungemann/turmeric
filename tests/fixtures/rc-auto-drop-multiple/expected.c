...
struct __defer_env_273 {RcControlBlock * y; };

struct __defer_env_270 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t264;
        {
            ...
            *__t267 = INT64_C(20);
            ...
            RcControlBlock * y_1468 = __t268;
            (void)y_1468;
            tur_frame __frame_269;
            tur_frame_init(&__frame_269, NULL);
            struct __defer_env_270 __t272 = {.x = x_1467};
            tur_frame_push_defer(&__frame_269, __defer_271, &__t272);
            struct __defer_env_273 __t275 = {.y = y_1468};
            tur_frame_push_defer(&__frame_269, __defer_274, &__t275);
            int64_t __t276;
            int64_t __t277 = rc_strong_count(x_1467);
            int64_t __t278 = rc_strong_count(y_1468);
            __t276 = (__t277) + (__t278);
