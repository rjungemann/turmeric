...
struct __defer_env_189 {RcControlBlock * y; };

struct __defer_env_186 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t180;
        {
            ...
            *__t183 = INT64_C(20);
            ...
            RcControlBlock * y_1437 = __t184;
            (void)y_1437;
            tur_frame __frame_185;
            tur_frame_init(&__frame_185, NULL);
            struct __defer_env_186 __t188 = {.x = x_1436};
            tur_frame_push_defer(&__frame_185, __defer_187, &__t188);
            struct __defer_env_189 __t191 = {.y = y_1437};
            tur_frame_push_defer(&__frame_185, __defer_190, &__t191);
            int64_t __t192;
            int64_t __t193 = rc_strong_count(x_1436);
            int64_t __t194 = rc_strong_count(y_1437);
