...
struct __defer_env_168 {RcControlBlock * y; };

struct __defer_env_165 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t159;
        {
            ...
            *__t162 = INT64_C(20);
            ...
            RcControlBlock * y_1327 = __t163;
            (void)y_1327;
            tur_frame __frame_164;
            tur_frame_init(&__frame_164, NULL);
            struct __defer_env_165 __t167 = {.x = x_1326};
            tur_frame_push_defer(&__frame_164, __defer_166, &__t167);
            struct __defer_env_168 __t170 = {.y = y_1327};
            tur_frame_push_defer(&__frame_164, __defer_169, &__t170);
            int64_t __t171;
            int64_t __t172 = rc_strong_count(x_1326);
            int64_t __t173 = rc_strong_count(y_1327);
            __t171 = (__t172) + (__t173);
