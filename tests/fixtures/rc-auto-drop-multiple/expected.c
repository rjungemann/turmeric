...
struct __defer_env_11 {RcControlBlock * y; };

struct __defer_env_8 {RcControlBlock * x; };
...
static int64_t test_rc_auto_drop_multiple() {
        int64_t __t2;
        {
            ...
            *__t5 = INT64_C(20);
            RcControlBlock *__t6 = rc_cb_alloc(0, 3, NULL);
            __t6->value = __t5;
            RcControlBlock * y_795 = __t6;
            (void)y_795;
            tur_frame __frame_7;
            tur_frame_init(&__frame_7, NULL);
            struct __defer_env_8 __t10 = {.x = x_794};
            tur_frame_push_defer(&__frame_7, __defer_9, &__t10);
            struct __defer_env_11 __t13 = {.y = y_795};
            tur_frame_push_defer(&__frame_7, __defer_12, &__t13);
            int64_t __t14;
            int64_t __t15 = rc_strong_count(x_794);
            int64_t __t16 = rc_strong_count(y_795);
            __t14 = (__t15) + (__t16);
