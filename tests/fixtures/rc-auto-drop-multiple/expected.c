...
static int64_t test_rc_auto_drop_multiple() {
        int64_t __t3;
        {
            ...
            *__t6 = INT64_C(20);
            ...
            __t7->value = __t6;
            RcControlBlock * y_846 = __t7;
            (void)y_846;
            tur_frame __frame_8;
            tur_frame_init(&__frame_8, NULL);
            struct __defer_env_9 __t11 = {.x = x_845};
            tur_frame_push_defer(&__frame_8, __defer_10, &__t11);
            struct __defer_env_12 __t14 = {.y = y_846};
            tur_frame_push_defer(&__frame_8, __defer_13, &__t14);
            int64_t __t15;
            int64_t __t16 = rc_strong_count(x_845);
            int64_t __t17 = rc_strong_count(y_846);
            __t15 = (__t16) + (__t17);
