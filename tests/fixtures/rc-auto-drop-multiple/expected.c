...
struct __defer_env_33 {RcControlBlock * y; };

struct __defer_env_30 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t24;
        {
            ...
            *__t25 = INT64_C(10);
            ...
            (void)x_880;
            int64_t *__t27 = (int64_t *)malloc(sizeof(int64_t));
            *__t27 = INT64_C(20);
            RcControlBlock *__t28 = rc_cb_alloc(0, 3, NULL);
            __t28->value = __t27;
            RcControlBlock * y_881 = __t28;
            (void)y_881;
            tur_frame __frame_29;
            tur_frame_init(&__frame_29, NULL);
            struct __defer_env_30 __t32 = {.x = x_880};
            tur_frame_push_defer(&__frame_29, __defer_31, &__t32);
            struct __defer_env_33 __t35 = {.y = y_881};
            tur_frame_push_defer(&__frame_29, __defer_34, &__t35);
            int64_t __t36;
            int64_t __t37 = rc_strong_count(x_880);
            int64_t __t38 = rc_strong_count(y_881);
            __t36 = (__t37) + (__t38);
