...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t181;
        {
            ...
            *__t184 = INT64_C(20);
            ...
            __t185->value = __t184;
            RcControlBlock * y_1270 = __t185;
            (void)y_1270;
            tur_frame __frame_186;
            tur_frame_init(&__frame_186, NULL);
            struct __defer_env_187 __t189 = {.x = x_1269};
            tur_frame_push_defer(&__frame_186, __defer_188, &__t189);
            struct __defer_env_190 __t192 = {.y = y_1270};
            tur_frame_push_defer(&__frame_186, __defer_191, &__t192);
            int64_t __t193;
            int64_t __t194 = rc_strong_count(x_1269);
            int64_t __t195 = rc_strong_count(y_1270);
