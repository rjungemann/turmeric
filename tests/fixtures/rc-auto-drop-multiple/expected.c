...
struct __defer_env_59 {RcControlBlock * y; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t50;
        {
            ...
            *__t53 = INT64_C(20);
            ...
            __t54->value = __t53;
            RcControlBlock * y_1244 = __t54;
            (void)y_1244;
            tur_frame __frame_55;
            tur_frame_init(&__frame_55, NULL);
            struct __defer_env_56 __t58 = {.x = x_1243};
            tur_frame_push_defer(&__frame_55, __defer_57, &__t58);
            struct __defer_env_59 __t61 = {.y = y_1244};
            tur_frame_push_defer(&__frame_55, __defer_60, &__t61);
            int64_t __t62;
            int64_t __t63 = rc_strong_count(x_1243);
            int64_t __t64 = rc_strong_count(y_1244);
            __t62 = (__t63) + (__t64);
