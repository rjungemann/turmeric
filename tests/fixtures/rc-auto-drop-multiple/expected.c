...
static int64_t test_rc_auto_drop_multiple() {
        int64_t __t0;
        {
            ...
            *__t3 = INT64_C(20);
            ...
            __t4->value = __t3;
            RcControlBlock * y_621 = __t4;
            (void)y_621;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            struct __defer_env_6 __t8 = {.x = x_620};
            tur_frame_push_defer(&__frame_5, __defer_7, &__t8);
            struct __defer_env_9 __t11 = {.y = y_621};
            tur_frame_push_defer(&__frame_5, __defer_10, &__t11);
            int64_t __t12;
            int64_t __t13 = rc_strong_count(x_620);
            int64_t __t14 = rc_strong_count(y_621);
            __t12 = ((__t13) + (__t14));
