...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t23;
        {
            ...
            *__t26 = INT64_C(20);
            ...
            __t27->value = __t26;
            RcControlBlock * y_884 = __t27;
            (void)y_884;
            tur_frame __frame_28;
            tur_frame_init(&__frame_28, NULL);
            struct __defer_env_29 __t31 = {.x = x_883};
            tur_frame_push_defer(&__frame_28, __defer_30, &__t31);
            struct __defer_env_32 __t34 = {.y = y_884};
            tur_frame_push_defer(&__frame_28, __defer_33, &__t34);
            int64_t __t35;
            int64_t __t36 = rc_strong_count(x_883);
            int64_t __t37 = rc_strong_count(y_884);
            __t35 = (__t36) + (__t37);
