...
struct __defer_env_286 {RcControlBlock * y; };

struct __defer_env_283 {RcControlBlock * x; };

struct __defer_env_267 {int64_t m; };

static void __defer_287(void *__env) {
    struct __defer_env_286 *__e = (struct __defer_env_286 *)__env;
    rc_strong_decrement(__e->y);
    rc_free_queue_drain();
}

static void __defer_284(void *__env) {
    struct __defer_env_283 *__e = (struct __defer_env_283 *)__env;
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t277;
        {
            ...
            *__t278 = INT64_C(10);
            ...
            (void)x_1606;
            int64_t *__t280 = (int64_t *)malloc(sizeof(int64_t));
            *__t280 = INT64_C(20);
            TUR_REGION_NOTE_WORDS(&((*__t280)), sizeof((*__t280)));
            RcControlBlock *__t281 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t281, __t280, NULL);
            RcControlBlock * y_1607 = __t281;
            (void)y_1607;
            tur_frame __frame_282;
            tur_frame_init(&__frame_282, NULL);
            struct __defer_env_283 __t285 = {.x = x_1606};
            tur_frame_push_defer(&__frame_282, __defer_284, &__t285);
            struct __defer_env_286 __t288 = {.y = y_1607};
            tur_frame_push_defer(&__frame_282, __defer_287, &__t288);
            int64_t __t289;
            int64_t __t290 = rc_strong_count(x_1606);
            int64_t __t291 = rc_strong_count(y_1607);
            __t289 = (__t290) + (__t291);
