...
struct __defer_env_241 {RcControlBlock * y; };

struct __defer_env_238 {RcControlBlock * x; };

static void __defer_242(void *__env) {
    struct __defer_env_241 *__e = (struct __defer_env_241 *)__env;
    rc_strong_decrement(__e->y);
    rc_free_queue_drain();
}

static void __defer_239(void *__env) {
    struct __defer_env_238 *__e = (struct __defer_env_238 *)__env;
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t232;
        {
            ...
            *__t233 = INT64_C(10);
            ...
            (void)x_1463;
            int64_t *__t235 = (int64_t *)malloc(sizeof(int64_t));
            *__t235 = INT64_C(20);
            TUR_REGION_NOTE_WORDS(&((*__t235)), sizeof((*__t235)));
            RcControlBlock *__t236 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t236, __t235, NULL);
            RcControlBlock * y_1464 = __t236;
            (void)y_1464;
            tur_frame __frame_237;
            tur_frame_init(&__frame_237, NULL);
            struct __defer_env_238 __t240 = {.x = x_1463};
            tur_frame_push_defer(&__frame_237, __defer_239, &__t240);
            struct __defer_env_241 __t243 = {.y = y_1464};
            tur_frame_push_defer(&__frame_237, __defer_242, &__t243);
            int64_t __t244;
            int64_t __t245 = rc_strong_count(x_1463);
            int64_t __t246 = rc_strong_count(y_1464);
            __t244 = (__t245) + (__t246);
            tur_frame_fire_lifo(&__frame_237);
            __t232 = __t244;
        }
        return __t232;
}
