...
struct __defer_env_61 {RcControlBlock * y; };

struct __defer_env_58 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t52;
        {
            ...
            *__t55 = INT64_C(20);
            ...
            __t56->value = __t55;
            RcControlBlock * y_1008 = __t56;
            (void)y_1008;
            tur_frame __frame_57;
            tur_frame_init(&__frame_57, NULL);
            struct __defer_env_58 __t60 = {.x = x_1007};
            tur_frame_push_defer(&__frame_57, __defer_59, &__t60);
            struct __defer_env_61 __t63 = {.y = y_1008};
            tur_frame_push_defer(&__frame_57, __defer_62, &__t63);
            int64_t __t64;
            int64_t __t65 = rc_strong_count(x_1007);
            int64_t __t66 = rc_strong_count(y_1008);
            __t64 = (__t65) + (__t66);
