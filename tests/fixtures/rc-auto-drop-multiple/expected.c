...
struct __defer_env_55 {RcControlBlock * y; };

struct __defer_env_52 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t46;
        {
            ...
            *__t49 = INT64_C(20);
            ...
            __t50->value = __t49;
            RcControlBlock * y_1006 = __t50;
            (void)y_1006;
            tur_frame __frame_51;
            tur_frame_init(&__frame_51, NULL);
            struct __defer_env_52 __t54 = {.x = x_1005};
            tur_frame_push_defer(&__frame_51, __defer_53, &__t54);
            struct __defer_env_55 __t57 = {.y = y_1006};
            tur_frame_push_defer(&__frame_51, __defer_56, &__t57);
            int64_t __t58;
            int64_t __t59 = rc_strong_count(x_1005);
            int64_t __t60 = rc_strong_count(y_1006);
            __t58 = (__t59) + (__t60);
