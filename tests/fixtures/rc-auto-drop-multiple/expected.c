...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t172;
        {
            ...
            *__t175 = INT64_C(20);
            ...
            RcControlBlock * y_1617 = __t176;
            (void)y_1617;
            tur_frame __frame_177;
            tur_frame_init(&__frame_177, NULL);
            struct __defer_env_178 __t180 = {.x = x_1616};
            tur_frame_push_defer(&__frame_177, __defer_179, &__t180);
            struct __defer_env_181 __t183 = {.y = y_1617};
            tur_frame_push_defer(&__frame_177, __defer_182, &__t183);
            int64_t __t184;
            int64_t __t185 = rc_strong_count(x_1616);
            int64_t __t186 = rc_strong_count(y_1617);
