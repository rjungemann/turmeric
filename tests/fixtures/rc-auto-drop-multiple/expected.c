...
struct __defer_env_162 {RcControlBlock * y; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t153;
        {
            ...
            *__t156 = INT64_C(20);
            ...
            struct __defer_env_162 __t164 = {.y = y_1280};
            tur_frame_push_defer(&__frame_158, __defer_163, &__t164);
            int64_t __t165;
            int64_t __t166 = rc_strong_count(x_1279);
            int64_t __t167 = rc_strong_count(y_1280);
            __t165 = (__t166) + (__t167);
