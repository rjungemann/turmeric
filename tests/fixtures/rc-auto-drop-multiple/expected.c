...
struct __defer_env_51 {RcControlBlock * y; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t42;
        {
            ...
            *__t45 = INT64_C(20);
            ...
            struct __defer_env_51 __t53 = {.y = y_1006};
            tur_frame_push_defer(&__frame_47, __defer_52, &__t53);
            int64_t __t54;
            int64_t __t55 = rc_strong_count(x_1005);
            int64_t __t56 = rc_strong_count(y_1006);
            __t54 = (__t55) + (__t56);
