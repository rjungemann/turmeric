...
struct __defer_env_60 {RcControlBlock * y; };

struct __defer_env_57 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t51;
        {
            ...
            *__t52 = INT64_C(10);
            ...
            (void)x_1007;
            int64_t *__t54 = (int64_t *)malloc(sizeof(int64_t));
            *__t54 = INT64_C(20);
            RcControlBlock *__t55 = rc_cb_alloc(0, 3, NULL);
            __t55->value = __t54;
            RcControlBlock * y_1008 = __t55;
            (void)y_1008;
            tur_frame __frame_56;
            tur_frame_init(&__frame_56, NULL);
            struct __defer_env_57 __t59 = {.x = x_1007};
            tur_frame_push_defer(&__frame_56, __defer_58, &__t59);
            struct __defer_env_60 __t62 = {.y = y_1008};
            tur_frame_push_defer(&__frame_56, __defer_61, &__t62);
            int64_t __t63;
            int64_t __t64 = rc_strong_count(x_1007);
            int64_t __t65 = rc_strong_count(y_1008);
            __t63 = (__t64) + (__t65);
