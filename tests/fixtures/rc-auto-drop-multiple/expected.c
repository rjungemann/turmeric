...
static int64_t test_hyrc_hyauto_hydrop_hymultiple();
...
struct __defer_env_182 {RcControlBlock * y; };

struct __defer_env_179 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t173;
        {
            ...
            *__t174 = INT64_C(10);
            ...
            (void)x_1606;
            int64_t *__t176 = (int64_t *)malloc(sizeof(int64_t));
            *__t176 = INT64_C(20);
            TUR_REGION_NOTE_WORDS(&((*__t176)), sizeof((*__t176)));
            RcControlBlock *__t177 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t177, __t176, NULL);
            RcControlBlock * y_1607 = __t177;
            (void)y_1607;
            tur_frame __frame_178;
            tur_frame_init(&__frame_178, NULL);
            struct __defer_env_179 __t181 = {.x = x_1606};
            tur_frame_push_defer(&__frame_178, __defer_180, &__t181);
            struct __defer_env_182 __t184 = {.y = y_1607};
            tur_frame_push_defer(&__frame_178, __defer_183, &__t184);
            int64_t __t185;
            int64_t __t186 = rc_strong_count(x_1606);
            int64_t __t187 = rc_strong_count(y_1607);
