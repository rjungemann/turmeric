...
struct __defer_env_253 {RcControlBlock * y; };

struct __defer_env_250 {RcControlBlock * x; };

static void __defer_254(void *__env) {
    struct __defer_env_253 *__e = (struct __defer_env_253 *)__env;
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t244;
        {
            ...
            *__t245 = INT64_C(10);
            ...
            (void)x_1467;
            int64_t *__t247 = (int64_t *)malloc(sizeof(int64_t));
            *__t247 = INT64_C(20);
            TUR_REGION_NOTE_WORDS(&((*__t247)), sizeof((*__t247)));
            RcControlBlock *__t248 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t248, __t247, NULL);
            RcControlBlock * y_1468 = __t248;
            (void)y_1468;
            tur_frame __frame_249;
            tur_frame_init(&__frame_249, NULL);
            struct __defer_env_250 __t252 = {.x = x_1467};
            tur_frame_push_defer(&__frame_249, __defer_251, &__t252);
            struct __defer_env_253 __t255 = {.y = y_1468};
            tur_frame_push_defer(&__frame_249, __defer_254, &__t255);
            int64_t __t256;
            int64_t __t257 = rc_strong_count(x_1467);
            int64_t __t258 = rc_strong_count(y_1468);
            __t256 = (__t257) + (__t258);
