...
struct __defer_env_192 {RcControlBlock * y; };

struct __defer_env_189 {RcControlBlock * x; };
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t183;
        {
            ...
            *__t186 = INT64_C(20);
            TUR_REGION_NOTE_WORDS(&((*__t186)), sizeof((*__t186)));
            RcControlBlock *__t187 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t187, __t186, NULL);
            RcControlBlock * y_1437 = __t187;
            (void)y_1437;
            tur_frame __frame_188;
            tur_frame_init(&__frame_188, NULL);
            struct __defer_env_189 __t191 = {.x = x_1436};
            tur_frame_push_defer(&__frame_188, __defer_190, &__t191);
            struct __defer_env_192 __t194 = {.y = y_1437};
            tur_frame_push_defer(&__frame_188, __defer_193, &__t194);
            int64_t __t195;
            int64_t __t196 = rc_strong_count(x_1436);
            int64_t __t197 = rc_strong_count(y_1437);
