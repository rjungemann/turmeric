...
struct __defer_env_38 {RcControlBlock * y; };

struct __defer_env_35 {RcControlBlock * x; };

static void __defer_39(void *__env) {
    struct __defer_env_38 *__e = (struct __defer_env_38 *)__env;
...
static int64_t test_hyrc_hyauto_hydrop_hymultiple() {
        int64_t __t29;
        {
            ...
            *__t32 = INT64_C(20);
            ...
            __t33->value = __t32;
            RcControlBlock * y_901 = __t33;
            (void)y_901;
            tur_frame __frame_34;
            tur_frame_init(&__frame_34, NULL);
            struct __defer_env_35 __t37 = {.x = x_900};
            tur_frame_push_defer(&__frame_34, __defer_36, &__t37);
            struct __defer_env_38 __t40 = {.y = y_901};
            tur_frame_push_defer(&__frame_34, __defer_39, &__t40);
            int64_t __t41;
            int64_t __t42 = rc_strong_count(x_900);
            int64_t __t43 = rc_strong_count(y_901);
            __t41 = (__t42) + (__t43);
