...
static int64_t test_rc_auto_drop_multiple() {
        int64_t __t2;
        {
            ...
            *__t5 = INT64_C(20);
            ...
            __t6->value = __t5;
            RcControlBlock * y_766 = __t6;
            (void)y_766;
            tur_frame __frame_7;
            tur_frame_init(&__frame_7, NULL);
            struct __defer_env_8 __t10 = {.x = x_765};
            tur_frame_push_defer(&__frame_7, __defer_9, &__t10);
            struct __defer_env_11 __t13 = {.y = y_766};
            tur_frame_push_defer(&__frame_7, __defer_12, &__t13);
            int64_t __t14;
            int64_t __t15 = rc_strong_count(x_765);
            int64_t __t16 = rc_strong_count(y_766);
            __t14 = (__t15) + (__t16);
