...
static void * use_question(bool b) {
        void * __t1;
        {
            int64_t __t2;
            {
                void * __q_0_277 = get_value(b);
                (void)__q_0_277;
                int64_t __t3;
                if (err_((void *)(intptr_t)(__q_0_277))) {
                    return err(err_val((void *)(intptr_t)(__q_0_277)));
                } else {
                    __t3 = ok_val((void *)(intptr_t)(__q_0_277));
                }
                __t2 = __t3;
            }
            int64_t x_278 = __t2;
            (void)x_278;
            __t1 = ok(((x_278) * (INT64_C(2))));
        }
        return __t1;
}
...
int main() {
        int64_t __t4;
        {
            void * r1_279 = use_question(true);
            (void)r1_279;
            int64_t __t5;
            {
                int64_t v1_280 = ok_val((void *)(intptr_t)(r1_279));
                (void)v1_280;
                printf("%lld\n", (long long)(v1_280));
                int64_t __t6;
                __t6 = INT64_C(0);
