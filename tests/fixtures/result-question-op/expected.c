...
static void * use_question(bool b) {
        void * __t1;
        {
            int64_t __t2;
            {
                void * __q_0_212 = get_value(b);
                (void)__q_0_212;
                int64_t __t3;
                if (err_((void *)(intptr_t)(__q_0_212))) {
                    return err(err_val((void *)(intptr_t)(__q_0_212)));
                } else {
                    __t3 = ok_val((void *)(intptr_t)(__q_0_212));
                }
                __t2 = __t3;
            }
            int64_t x_213 = __t2;
            (void)x_213;
            __t1 = ok(((x_213) * (INT64_C(2))));
        }
        return __t1;
}
...
int main() {
        int64_t __t4;
        {
            void * r1_214 = use_question(true);
            (void)r1_214;
            int64_t __t5;
            {
                int64_t v1_215 = ok_val((void *)(intptr_t)(r1_214));
                (void)v1_215;
                printf("%lld\n", (long long)(v1_215));
                int64_t __t6;
                __t6 = INT64_C(0);
