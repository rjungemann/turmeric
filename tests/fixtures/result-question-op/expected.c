...
static void * use_question(bool b) {
        void * __t1;
        {
            int64_t __t2;
            {
                void * __q_val_17 = get_value(b);
                (void)__q_val_17;
                int64_t __t3;
                if (err_(__q_val_17)) {
                    return err(err_val(__q_val_17));
                } else {
                    __t3 = ok_val(__q_val_17);
                }
                __t2 = __t3;
            }
            int64_t x_18 = __t2;
            (void)x_18;
            __t1 = ok(((x_18) * (INT64_C(2))));
        }
        return __t1;
}
...
int main() {
        int64_t __t4;
        {
            void * r1_19 = use_question(true);
            (void)r1_19;
            int64_t __t5;
            {
                int64_t v1_20 = ok_val(r1_19);
                (void)v1_20;
                printf("%lld\n", (long long)(v1_20));
                int64_t __t6;
                __t6 = INT64_C(0);
