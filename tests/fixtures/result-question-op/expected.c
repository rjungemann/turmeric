...
static void * use_question(bool b) {
        void * __t1;
        {
            int64_t __t2;
            {
                void * __q_0_224 = get_value(b);
                (void)__q_0_224;
                int64_t __t3;
                if (err_((void *)(intptr_t)(__q_0_224))) {
                    return err(err_val((void *)(intptr_t)(__q_0_224)));
                } else {
                    __t3 = ok_val((void *)(intptr_t)(__q_0_224));
                }
                __t2 = __t3;
            }
            int64_t x_225 = __t2;
            (void)x_225;
            __t1 = ok(((x_225) * (INT64_C(2))));
        }
        return __t1;
}
...
int main() {
        int64_t __t4;
        {
            void * r1_226 = use_question(true);
            (void)r1_226;
            int64_t __t5;
            {
                int64_t v1_227 = ok_val((void *)(intptr_t)(r1_226));
                (void)v1_227;
                printf("%lld\n", (long long)(v1_227));
                int64_t __t6;
                __t6 = INT64_C(0);
