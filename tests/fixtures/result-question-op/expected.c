...
static void * use_question(bool b) {
        void * __t1;
        {
            int64_t __t2;
            {
                void * __q_0_37 = get_value(b);
                (void)__q_0_37;
                int64_t __t3;
                if (err_((void *)(intptr_t)(__q_0_37))) {
                    return err(err_val((void *)(intptr_t)(__q_0_37)));
                } else {
                    __t3 = ok_val((void *)(intptr_t)(__q_0_37));
                }
                __t2 = __t3;
            }
            int64_t x_38 = __t2;
            (void)x_38;
            __t1 = ok(((x_38) * (INT64_C(2))));
        }
        return __t1;
}
...
int main() {
        int64_t __t4;
        {
            void * r1_39 = use_question(true);
            (void)r1_39;
            int64_t __t5;
            {
                int64_t v1_40 = ok_val((void *)(intptr_t)(r1_39));
                (void)v1_40;
                printf("%lld\n", (long long)(v1_40));
                int64_t __t6;
                __t6 = INT64_C(0);
