...
static void * get_value(bool);
static void * use_question(bool);
...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_443));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_463));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_490));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_510), (int64_t)(intptr_t)(__fn_514));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_530), (int64_t)(intptr_t)(__fn_534));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_550));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_621));
}
...
static void * get_value(bool b) {
        void * __t0;
        if (b) {
            __t0 = u_ok(INT64_C(42));
        } else {
            __t0 = u_err(INT64_C(1));
        }
        return __t0;
}

typedef struct __HEnv_2 __HEnv_2;
struct __HEnv_2 {
    bool b;
};
...
static void __handle_body_2(void) {
    ...
    __HEnv_2 *__henv_2 = (__HEnv_2 *)__cap->body_env;
    int64_t __t4;
    {
        void * __q_0_632 = get_value(__henv_2->b);
        (void)__q_0_632;
        int64_t __t5;
        if (err_((void *)(intptr_t)(__q_0_632))) {
            return err(err_val((void *)(intptr_t)(__q_0_632)));
        } else {
            __t5 = ok_val((void *)(intptr_t)(__q_0_632));
        }
        __t4 = __t5;
    }
...
static int64_t __dispatch_2(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Unsafe") == 0) {
        return __effect_handler_3(__dcap->eff_args, __dcap->eff_n_args, __k_int, __dcap->body_env);
    } else {
...
static void * use_question(bool b) {
        void * __t1;
        {
            ...
            int64_t __t6 = (int64_t)__dispatch_2(&__cap_2, (int64_t)(intptr_t)__fiber_2, 0);
...
int main() {
        int64_t __t7;
        {
            void * r1_635 = use_question(true);
            (void)r1_635;
            int64_t __t8;
            {
                int64_t v1_636 = u_ok_val((void *)(intptr_t)(r1_635));
                (void)v1_636;
                printf("%lld\n", (long long)(v1_636));
                int64_t __t9;
                __t9 = INT64_C(0);
