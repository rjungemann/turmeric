...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            {
                int64_t _un_untur_unse_un_un_1364 = INT64_C(2);
                (void)_un_untur_unse_un_un_1364;
                tur_adt_Set__int * __t165;
                {
                    int64_t _un_untur_unse_un_un_1365 = INT64_C(1);
                    (void)_un_untur_unse_un_un_1365;
                    tur_adt_Set__int * __ps_166 = (set_new__spec__tur_adt_Set__int__());
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    int64_t __ps_167 = (__inst_MapKey_mk_hybox_int(_un_untur_unse_un_un_1365));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    int64_t __ps_168 = (__inst_MapKey_mk_hycmp_int(_un_untur_unse_un_un_1365));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    int64_t __ps_169 = (__inst_MapKey_mk_hyowned_qu_int(_un_untur_unse_un_un_1365));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                ...
                int64_t __ps_171 = (__inst_MapKey_mk_hybox_int(_un_untur_unse_un_un_1364));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_172 = (__inst_MapKey_mk_hycmp_int(_un_untur_unse_un_un_1364));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_173 = (__inst_MapKey_mk_hyowned_qu_int(_un_untur_unse_un_un_1364));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            tur_adt_Set__int * a_1366 = __t164;
            (void)a_1366;
            tur_adt_Set__int * __t175;
            {
                int64_t _un_untur_unse_un_un_1367 = INT64_C(1);
                (void)_un_untur_unse_un_un_1367;
                tur_adt_Set__int * __t176;
                {
                    ...
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    int64_t __ps_178 = (__inst_MapKey_mk_hybox_int(_un_untur_unse_un_un_1368));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    int64_t __ps_179 = (__inst_MapKey_mk_hycmp_int(_un_untur_unse_un_un_1368));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    int64_t __ps_180 = (__inst_MapKey_mk_hyowned_qu_int(_un_untur_unse_un_un_1368));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                ...
                int64_t __ps_182 = (__inst_MapKey_mk_hybox_int(_un_untur_unse_un_un_1367));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_183 = (__inst_MapKey_mk_hycmp_int(_un_untur_unse_un_un_1367));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_184 = (__inst_MapKey_mk_hyowned_qu_int(_un_untur_unse_un_un_1367));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            tur_adt_Set__int * b_1369 = __t175;
            (void)b_1369;
            tur_adt_Set__int * __t186;
            {
                int64_t _un_untur_unse_un_un_1370 = INT64_C(1);
                (void)_un_untur_unse_un_un_1370;
                tur_adt_Set__int * __ps_187 = (set_new__spec__tur_adt_Set__int__());
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_188 = (__inst_MapKey_mk_hybox_int(_un_untur_unse_un_un_1370));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_189 = (__inst_MapKey_mk_hycmp_int(_un_untur_unse_un_un_1370));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_190 = (__inst_MapKey_mk_hyowned_qu_int(_un_untur_unse_un_un_1370));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            tur_adt_Set__int * c_1371 = __t186;
            (void)c_1371;
            int64_t __ps_192 = (size_hyof((tur_adt_Set__int *)(intptr_t)((int64_t)(intptr_t)(a_1366))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_192));
            bool __ps_193 = (__inst_Eq_eq_qu_Set__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(a_1366, b_1369));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_193) ? "true" : "false");
            bool __ps_194 = (__inst_Eq_eq_qu_Set__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(a_1366, c_1371));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool set_eq_full__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(tur_adt_Set__int * s1, tur_adt_Set__int * s2) {
        int64_t __ps_200 = (set_hycount((int64_t)(intptr_t)(s1)));
        if (tur_panicking) return ((bool)0);
        int64_t __ps_201 = (set_hycount((int64_t)(intptr_t)(s2)));
        if (tur_panicking) return ((bool)0);
...
static bool set_eq_driver__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(tur_adt_Set__int * s1, tur_adt_Set__int * s2) {
        bool __t203;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * keyeq_1163 = __ps_207;
            (void)keyeq_1163;
            int64_t __ps_208 = (set_hamt__spec__int64_t_tur_adt_Set__int__((tur_adt_Set__int *)(intptr_t)(s2)));
            if (tur_panicking) return ((bool)0);
            bool __ps_209 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1162), (void *)(intptr_t)(__ps_208), (void *)(intptr_t)(keyeq_1163)));
            if (tur_panicking) return ((bool)0);
            bool result_1164 = __ps_209;
            (void)result_1164;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_1162));
            bool __t210;
            __t210 = result_1164;
