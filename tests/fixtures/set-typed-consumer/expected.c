...
static tur_adt_Set__int * set_add__spec__tur_adt_Set__int___tur_adt_Set__int___int64_t_int64_t(tur_adt_Set__int *, int64_t, int64_t);
...
int main(int argc, char **argv) {
        ...
        {
            tur_adt_Set__int * a_1266 = set_add__spec__tur_adt_Set__int___tur_adt_Set__int___int64_t_int64_t(set_add__spec__tur_adt_Set__int___tur_adt_Set__int___int64_t_int64_t(set_new__spec__tur_adt_Set__int__(), INT64_C(1), INT64_C(1)), INT64_C(2), INT64_C(2));
            (void)a_1266;
            tur_adt_Set__int * b_1267 = set_add__spec__tur_adt_Set__int___tur_adt_Set__int___int64_t_int64_t(set_add__spec__tur_adt_Set__int___tur_adt_Set__int___int64_t_int64_t(set_new__spec__tur_adt_Set__int__(), INT64_C(2), INT64_C(2)), INT64_C(1), INT64_C(1));
            (void)b_1267;
            tur_adt_Set__int * c_1268 = set_add__spec__tur_adt_Set__int___tur_adt_Set__int___int64_t_int64_t(set_new__spec__tur_adt_Set__int__(), INT64_C(1), INT64_C(1));
            (void)c_1268;
            printf("%lld\n", (long long)(size_hyof((int64_t)(intptr_t)(a_1266))));
            puts((__inst_Eq_eq_qu_Set__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(a_1266, b_1267)) ? "true" : "false");
            puts((__inst_Eq_eq_qu_Set__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(a_1266, c_1268)) ? "true" : "false");
        }
        int64_t __t55;
        __t55 = INT64_C(0);
        return (int)__t55;
...
static tur_adt_Set__int * set_add__spec__tur_adt_Set__int___tur_adt_Set__int___int64_t_int64_t(tur_adt_Set__int * s, int64_t h, int64_t x) {
        struct { void *hamt; } *set = (void*)(intptr_t)s;
...
static bool __inst_Eq_eq_qu_Set__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(tur_adt_Set__int * x, tur_adt_Set__int * y) {
        return set_eq_full__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(x, y);
}

static bool set_eq_full__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(tur_adt_Set__int * s1, tur_adt_Set__int * s2) {
        bool __t56 = (set_hycount((int64_t)(intptr_t)(s1))) == (set_hycount((int64_t)(intptr_t)(s2)));
        if (__t56) {
            __t56 = set_eq_driver__spec__bool_tur_adt_Set__int___tur_adt_Set__int__(s1, s2);
        }
        return __t56;
}
