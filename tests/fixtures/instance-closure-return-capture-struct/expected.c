...
static int64_t __inst_HasArr_arr_hyof_ArrW(int64_t self, int64_t n) {
        void * __t20;
        {
            Box b_894 = (Box){.n = n};
            (void)b_894;
            struct __env_898 *__t21 = (struct __env_898 *)malloc(sizeof(struct __env_898));
            __t21->__fn = (tur_thunk_int64_t_int64_t_t)__fn_896;
            __t21->b = b_894;
            void *__t22 = __t21;
            __t20 = __t22;
        }
...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_903 = (int64_t)(INT64_C(0));
            (void)w_903;
            int64_t g = (int64_t)(intptr_t)(__inst_HasArr_arr_hyof_ArrW(w_903, INT64_C(100)));
            (void)g;
