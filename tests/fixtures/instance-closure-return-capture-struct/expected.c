...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_892 = (int64_t)(INT64_C(0));
            (void)w_892;
            int64_t g = (int64_t)(intptr_t)(__inst_HasArr_arr_of_ArrW(w_892, INT64_C(100)));
            (void)g;
