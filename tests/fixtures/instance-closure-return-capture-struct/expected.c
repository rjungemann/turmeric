...
static int64_t __inst_HasArr_arr_of_ArrW(int64_t self, int64_t n) {
        void * __t20;
        {
            Box b_859 = (Box){.n = n};
            (void)b_859;
            struct __env_863 *__t21 = (struct __env_863 *)malloc(sizeof(struct __env_863));
            __t21->__fn = (tur_thunk_int64_t_int64_t_t)__fn_861;
            __t21->b = b_859;
            void *__t22 = __t21;
            __t20 = __t22;
        }
