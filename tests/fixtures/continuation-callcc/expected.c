...
static int64_t test_callcc_no_resume();
static int64_t test_callcc_value();

static int64_t __fn_216(int64_t k) {
        return INT64_C(99);
}

static int64_t __fn_220(int64_t k) {
        return INT64_C(10);
}
...
static int64_t test_callcc_no_resume() {
        int64_t __t0;
        {
            int64_t (*__cc_f)(int64_t) = __fn_216;
            (void)__cc_f;
            __t0 = ((int64_t (*)(int64_t))(intptr_t)__cc_f)(INT64_C(0));
        }
        return __t0;
}
...
static int64_t test_callcc_value() {
        int64_t __t1;
        {
            int64_t (*__cc_f)(int64_t) = __fn_220;
            (void)__cc_f;
            __t1 = ((int64_t (*)(int64_t))(intptr_t)__cc_f)(INT64_C(0));
        }
        return ((INT64_C(1)) + (__t1));
}

int main() {
        printf("%lld\n", (long long)(test_callcc_no_resume()));
        printf("%lld\n", (long long)(test_callcc_value()));
        int64_t __t2;
        __t2 = INT64_C(0);
        return (int)__t2;
}
