...
static int64_t __fn_199(int64_t k) {
        return INT64_C(99);
}

static int64_t __fn_203(int64_t k) {
        return INT64_C(10);
}
...
static int64_t test_callcc_no_resume() {
        int64_t __t0;
        {
            int64_t (*__cc_f)(int64_t) = __fn_199;
            (void)__cc_f;
            __t0 = __cc_f(INT64_C(0));
        }
        return __t0;
}
...
static int64_t test_callcc_value() {
        int64_t __t1;
        {
            int64_t (*__cc_f)(int64_t) = __fn_203;
            (void)__cc_f;
            __t1 = __cc_f(INT64_C(0));
        }
