...
struct __env_1475 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1473(void * __env_p_1476) {
        struct __env_1475 *__env___env_1475 = (struct __env_1475 *)__env_p_1476;
        int64_t __ps_124 = (step(__env___env_1475->acc, (__env___env_1475->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t255;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1466 = __ps_257;
            (void)r_1466;
            bool __ps_258 = (bt_hyundo_hyto_ex(m_1465));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_258);
            int64_t __t259;
            __t259 = r_1466;
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t268;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_269 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t268 = __ps_269;
        } else {
            void *__t271 = malloc(sizeof(void *) + sizeof(struct __env_1475));
            *(void (**)(void *))__t271 = drop_glue___env_1475;
            struct __env_1475 *__t270 = (struct __env_1475 *)((char *)__t271 + sizeof(void *));
            __t270->__fn = (tur_thunk_int64_t_t)__fn_1473;
            __t270->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t270->acc), sizeof(__t270->acc));
            __t270->n = n;
            TUR_REGION_NOTE_WORDS(&(__t270->n), sizeof(__t270->n));
            void *__t272 = __t270;
            int64_t __catch_result_273 = tur_catch_unwind_box((int64_t)(intptr_t)__t272);
            TUR_CLOSURE_DROP(__t272);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_273);
            int64_t __t274;
            __t274 = (n) + (INT64_C(100));
            __t268 = __t274;
        }
        return __t268;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_275 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_276 = (step(__ps_275, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_276));
        tur_adt_Result__int__int __ps_277 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_278 = (step(__ps_277, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_278));
        int64_t __t279;
        __t279 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_283 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_284 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_284;
}
