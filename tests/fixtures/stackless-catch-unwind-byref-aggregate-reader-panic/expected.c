...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        if ((n) == (INT64_C(0))) {
            ...
            void *__t174 = malloc(sizeof(void *) + sizeof(struct __env_1614));
            *(void (**)(void *))__t174 = drop_glue___env_1614;
            struct __env_1614 *__t173 = (struct __env_1614 *)((char *)__t174 + sizeof(void *));
            __t173->__fn = (tur_thunk_int64_t_t)__fn_1612;
            __t173->acc = acc;
