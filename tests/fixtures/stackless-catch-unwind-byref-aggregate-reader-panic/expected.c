...
struct __env_1614 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1612(void * __env_p_1615) {
        struct __env_1614 *__env___env_1614 = (struct __env_1614 *)__env_p_1615;
        int64_t __ps_128 = (step(__env___env_1614->acc, (__env___env_1614->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_128;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_997 = __ps_165;
        bool __ps_166 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_996, (void *)(intptr_t)(k_997), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_166;
        if (__t1) {
            int64_t __ps_167 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_168 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_996, (void *)(intptr_t)(k_997), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t170;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1001 = __ps_172;
            (void)iter_1001;
            void * __ps_173 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_174 = (hamt_slkeyeq((void *)(intptr_t)(__ps_173)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1002 = __ps_174;
            (void)keyeq_1002;
            void * __ps_175 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_176 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1001), (void *)(intptr_t)(__ps_175), (void *)(intptr_t)(keyeq_1002), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1003 = __ps_176;
            (void)result_1003;
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t281;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_282 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t281 = __ps_282;
        } else {
            void *__t284 = malloc(sizeof(void *) + sizeof(struct __env_1614));
            *(void (**)(void *))__t284 = drop_glue___env_1614;
            struct __env_1614 *__t283 = (struct __env_1614 *)((char *)__t284 + sizeof(void *));
            __t283->__fn = (tur_thunk_int64_t_t)__fn_1612;
            __t283->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t283->acc), sizeof(__t283->acc));
            __t283->n = n;
            TUR_REGION_NOTE_WORDS(&(__t283->n), sizeof(__t283->n));
            void *__t285 = __t283;
            int64_t __catch_result_286 = tur_catch_unwind_box((int64_t)(intptr_t)__t285);
            TUR_CLOSURE_DROP(__t285);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_286);
            int64_t __t287;
            __t287 = (n) + (INT64_C(100));
            __t281 = __t287;
        }
        return __t281;
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_293 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
...
static bool ok___spec__bool_tur_adt_Result__int__int(tur_adt_Result__int__int r) {
        bool __t295 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t _un_1114 = (int64_t)__scrut->as.Ok._0;
                __t295 = true;
                break;
            }
            case 1: {
                int64_t _un_1115 = (int64_t)__scrut->as.Err._0;
                __t295 = false;
                break;
            }
            default: break;
