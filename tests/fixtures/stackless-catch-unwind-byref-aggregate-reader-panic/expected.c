...
struct __env_1338 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
static void drop_glue___env_1338(void *__p) {
    struct __env_1338 *__e = (struct __env_1338 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1336(void * __env_p_1339) {
        struct __env_1338 *__env___env_1338 = (struct __env_1338 *)__env_p_1339;
        tur_adt_Result__int__int __t42 = __env___env_1338->acc;
        int64_t __ps_43 = (step(&__t42, (__env___env_1338->n) - (INT64_C(1))));
...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __ps_166 = (describe(acc));
            if (tur_panicking) break;
            __v = (int64_t)(intptr_t)(__ps_166); __pc = __k->tag; break;
           } else {
            tur_handler_node *__b167 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b167->parent = tur_handler_chain; tur_handler_chain = __b167;
            tur_cont *__n167 = (tur_cont*)malloc(sizeof(tur_cont));
            __n167->tag = 3; __n167->boundary = __b167; __n167->next = __k;
            __n167->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, acc, sizeof(tur_adt_Result__int__int)); __n167->saved[0] = (int64_t)(intptr_t)__ab; }
            __n167->saved[1] = (int64_t)(intptr_t)(n);
            __n167->saved[2] = (int64_t)(intptr_t)(__t164);
            __n167->saved[3] = (int64_t)(intptr_t)(__t165);
            __k = __n167; __pc = 2; break;
           }
          }
          case 2: {
           const tur_adt_Result__int__int *__ra168_0 = (acc);
           int64_t __ra168_1 = ((n) - (INT64_C(1)));
           memmove(&acc__agg, __ra168_0, sizeof(tur_adt_Result__int__int)); acc = &acc__agg;
           n = __ra168_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           int64_t __box167;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp167 = global_panic_payload; global_panic_payload = 0; __box167 = tur_box_err((int64_t)(intptr_t)__pp167); }
           else { __box167 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box167);
           (void)(__box167);
           __v = (int64_t)(intptr_t)((n) + (INT64_C(100))); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_171 = (step(&__t170, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_171));
        ...
        int64_t __ps_174 = (step(&__t173, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_174));
        int64_t __t175;
        __t175 = INT64_C(0);
