...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t279;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_280 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t279 = __ps_280;
        } else {
            void *__t282 = malloc(sizeof(void *) + sizeof(struct __env_1614));
            *(void (**)(void *))__t282 = drop_glue___env_1614;
            struct __env_1614 *__t281 = (struct __env_1614 *)((char *)__t282 + sizeof(void *));
            __t281->__fn = (tur_thunk_int64_t_t)__fn_1612;
            __t281->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t281->acc), sizeof(__t281->acc));
            __t281->n = n;
            TUR_REGION_NOTE_WORDS(&(__t281->n), sizeof(__t281->n));
            void *__t283 = __t281;
            int64_t __catch_result_284 = tur_catch_unwind_box((int64_t)(intptr_t)__t283);
            TUR_CLOSURE_DROP(__t283);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_284);
            int64_t __t285;
            __t285 = (n) + (INT64_C(100));
            __t279 = __t285;
        }
        return __t279;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_287 = (step(__ps_286, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_287));
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_291 = (ctor_Cons_Cons__int(h, t));
