...
struct __env_1471 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1469(void * __env_p_1472) {
        ...
        int64_t __ps_92 = (step(__env___env_1471->acc, (__env___env_1471->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_92;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_844 = __ps_125;
        bool __ps_126 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_843, (void *)(intptr_t)(k_844), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_126;
        if (__t1) {
            int64_t __ps_127 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_128 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_843, (void *)(intptr_t)(k_844), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t130;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_848 = __ps_132;
            (void)iter_848;
            void * __ps_133 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_134 = (hamt_slkeyeq((void *)(intptr_t)(__ps_133)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_849 = __ps_134;
            (void)keyeq_849;
            void * __ps_135 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_136 = (map_hyeq_hyloop((void *)(intptr_t)(iter_848), (void *)(intptr_t)(__ps_135), (void *)(intptr_t)(keyeq_849), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_850 = __ps_136;
            (void)result_850;
        ...
        if (__ps_155) {
            bool __t156;
            {
                ...
                if ((t1_1128) == (INT64_C(0))) {
                    __t157 = (t2_1129) == (INT64_C(0));
                } else {
                    bool __t158;
                    if ((t2_1129) == (INT64_C(0))) {
                        __t158 = false;
                    } else {
                        bool __ps_159 = (cons_hyeq_hygo(t1_1128, t2_1129));
                        if (tur_panicking) return ((bool)0);
                        __t158 = __ps_159;
                    }
                    __t157 = __t158;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_165) {
            ...
            int64_t __t166;
            {
                ...
                int64_t out_1144 = (int64_t)(intptr_t)(__ps_170);
                (void)out_1144;
                __t166 = out_1144;
            }
            __t164 = __t166;
        ...
        if (__ps_175) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1215 = __ps_176;
                (void)h_1215;
                void * __ps_177 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1216 = __ps_177;
                (void)k_1216;
                bool __ps_178 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1215, (void *)(intptr_t)(k_1216), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_178) {
                    void * __t179 = iter;
                    void * __t180 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t182;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1219 = __ps_184;
            (void)iter_1219;
            void * __ps_185 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_186 = (hamt_slkeyeq((void *)(intptr_t)(__ps_185)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1220 = __ps_186;
            (void)keyeq_1220;
            void * __ps_187 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_188 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1219), (void *)(intptr_t)(__ps_187), (void *)(intptr_t)(keyeq_1220)));
            if (tur_panicking) return ((bool)0);
            bool result_1221 = __ps_188;
            (void)result_1221;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t209;
        {
            ...
            {
                tur_adt_Vec__int * __ps_211 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1351));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1352 = __ps_211;
                (void)_un_unv_1352;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t215;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1402 = __ps_216;
            (void)r_1402;
            int64_t __t217;
            bool __ps_218 = (schema_hydecode_hyok_qu(r_1402));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_218) {
                int64_t __ps_219 = (schema_hydecode_hyvalue(r_1402));
                if (tur_panicking) return ((int64_t)0);
                __t217 = __ps_219;
            } else {
                int64_t __ps_220 = (schema_hydecode_hyerrors(r_1402));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t236;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_237 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t236 = __ps_237;
        } else {
            void *__t239 = malloc(sizeof(void *) + sizeof(struct __env_1471));
            *(void (**)(void *))__t239 = drop_glue___env_1471;
            struct __env_1471 *__t238 = (struct __env_1471 *)((char *)__t239 + sizeof(void *));
            __t238->__fn = (tur_thunk_int64_t_t)__fn_1469;
            __t238->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t238->acc), sizeof(__t238->acc));
            __t238->n = n;
            TUR_REGION_NOTE_WORDS(&(__t238->n), sizeof(__t238->n));
            void *__t240 = __t238;
            int64_t __catch_result_241 = tur_catch_unwind_box((int64_t)(intptr_t)__t240);
            TUR_CLOSURE_DROP(__t240);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_241);
            int64_t __t242;
            __t242 = (n) + (INT64_C(100));
            __t236 = __t242;
        }
        return __t236;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_243 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_244 = (step(__ps_243, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_244));
        tur_adt_Result__int__int __ps_245 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_246 = (step(__ps_245, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_246));
        int64_t __t247;
        __t247 = INT64_C(0);
...
static bool ok___spec__bool_tur_adt_Result__int__int(tur_adt_Result__int__int r) {
        bool __t250 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t _un_961 = (int64_t)__scrut->as.Ok._0;
                __t250 = true;
                break;
            }
            case 1: {
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_251 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_252 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_252;
}
