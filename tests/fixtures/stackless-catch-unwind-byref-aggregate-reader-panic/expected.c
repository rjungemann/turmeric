...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                (void)t2_1282;
                bool __t100;
                bool __ps_101 = (tnil_qu(t1_1281));
                if (tur_panicking) return ((bool)0);
                if (__ps_101) {
                    bool __ps_102 = (tnil_qu(t2_1282));
                    if (tur_panicking) return ((bool)0);
                    __t100 = __ps_102;
                } else {
                    bool __t103;
                    bool __ps_104 = (tnil_qu(t2_1282));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_104) {
                        __t103 = false;
                    } else {
                        bool __ps_105 = (cons_hyeq_hygo(t1_1281, t2_1282));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_105;
                    }
                    __t100 = __t103;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                int64_t out_1297 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1297;
                __t112 = out_1297;
            }
            __t110 = __t112;
        ...
        if (__ps_117) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1368 = __ps_118;
                (void)h_1368;
                void * __ps_119 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1369 = __ps_119;
                (void)k_1369;
                bool __ps_120 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1368, (void *)(intptr_t)(k_1369), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_120) {
                    void * __t121 = iter;
                    void * __t122 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t124;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1372 = __ps_126;
            (void)iter_1372;
            void * __ps_127 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_128 = (hamt_slkeyeq((void *)(intptr_t)(__ps_127)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1373 = __ps_128;
            (void)keyeq_1373;
            void * __ps_129 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_130 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1372), (void *)(intptr_t)(__ps_129), (void *)(intptr_t)(keyeq_1373)));
            if (tur_panicking) return ((bool)0);
            bool result_1374 = __ps_130;
            (void)result_1374;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t151;
        {
            ...
            {
                tur_adt_Vec__int * __ps_153 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1504));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1505 = __ps_153;
                (void)_un_unv_1505;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1555 = __ps_156;
            (void)r_1555;
            bool __ps_157 = (schema_hydecode_hyok_qu(r_1555));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_157) {
                return schema_hydecode_hyvalue(r_1555);
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1555));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t160;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1606 = __ps_161;
            (void)m_1606;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            struct __defer_env_163 __t165 = {.m = m_1606};
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        if ((n) == (INT64_C(0))) {
            ...
            void *__t175 = malloc(sizeof(void *) + sizeof(struct __env_1614));
            *(void (**)(void *))__t175 = drop_glue___env_1614;
            struct __env_1614 *__t174 = (struct __env_1614 *)((char *)__t175 + sizeof(void *));
            __t174->__fn = (tur_thunk_int64_t_t)__fn_1612;
            __t174->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t174->acc), sizeof(__t174->acc));
            __t174->n = n;
            TUR_REGION_NOTE_WORDS(&(__t174->n), sizeof(__t174->n));
            void *__t176 = __t174;
            int64_t __catch_result_177 = tur_catch_unwind_box((int64_t)(intptr_t)__t176);
            TUR_CLOSURE_DROP(__t176);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_177);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_178 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_179 = (step(__ps_178, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        tur_adt_Result__int__int __ps_180 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_181 = (step(__ps_180, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        int64_t __t182;
        __t182 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_183 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_186 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_187 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_187;
}
