...
struct __env_1308 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
static void drop_glue___env_1308(void *__p) {
    struct __env_1308 *__e = (struct __env_1308 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1306(void * __env_p_1309) {
        struct __env_1308 *__env___env_1308 = (struct __env_1308 *)__env_p_1309;
        tur_adt_Result__int__int __t42 = __env___env_1308->acc;
        int64_t __ps_43 = (step(&__t42, (__env___env_1308->n) - (INT64_C(1))));
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_764, (void *)(intptr_t)(k_765), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_769 = __ps_75;
            (void)iter_769;
            void * __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_770 = __ps_77;
            (void)keyeq_770;
            void * __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_769), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_770), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_771 = __ps_79;
            (void)result_771;
...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __ps_161 = (describe(acc));
            if (tur_panicking) break;
            __v = (int64_t)(intptr_t)(__ps_161); __pc = __k->tag; break;
           } else {
            ...
            __n162->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, acc, sizeof(tur_adt_Result__int__int)); __n162->saved[0] = (int64_t)(intptr_t)__ab; }
            __n162->saved[1] = (int64_t)(intptr_t)(n);
            __n162->saved[2] = (int64_t)(intptr_t)(__t159);
            __n162->saved[3] = (int64_t)(intptr_t)(__t160);
          ...
          case 3: {
           ...
           __t159 = (int64_t)(intptr_t)(__k->saved[2]);
           __t160 = (int64_t)(intptr_t)(__k->saved[3]);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_166 = (step(&__t165, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_166));
        ...
        int64_t __ps_169 = (step(&__t168, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_169));
        int64_t __t170;
        __t170 = INT64_C(0);
