...
struct __env_1440 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
static void drop_glue___env_1440(void *__p) {
    struct __env_1440 *__e = (struct __env_1440 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1438(void * __env_p_1441) {
        struct __env_1440 *__env___env_1440 = (struct __env_1440 *)__env_p_1441;
        int64_t __ps_40 = (step(__env___env_1440->acc, (__env___env_1440->n) - (INT64_C(1))));
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_72 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_816, (void *)(intptr_t)(k_817), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t74;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_821 = __ps_76;
            (void)iter_821;
            void * __ps_77 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_78 = (hamt_slkeyeq((void *)(intptr_t)(__ps_77)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_822 = __ps_78;
            (void)keyeq_822;
            void * __ps_79 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_80 = (map_hyeq_hyloop((void *)(intptr_t)(iter_821), (void *)(intptr_t)(__ps_79), (void *)(intptr_t)(keyeq_822), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_823 = __ps_80;
            (void)result_823;
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if ((t1_1101) == (INT64_C(0))) {
                    __t101 = (t2_1102) == (INT64_C(0));
                } else {
                    bool __t102;
                    if ((t2_1102) == (INT64_C(0))) {
                        __t102 = false;
                    } else {
                        bool __ps_103 = (cons_hyeq_hygo(t1_1101, t2_1102));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_103;
                    }
                    __t101 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_109) {
            ...
            int64_t __t110;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1117 = (int64_t)(intptr_t)(__ps_114);
                (void)out_1117;
                __t110 = out_1117;
            }
            __t108 = __t110;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t119;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_121;
            (void)iter_1192;
            void * __ps_122 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_123 = (hamt_slkeyeq((void *)(intptr_t)(__ps_122)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_123;
            (void)keyeq_1193;
            void * __ps_124 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_125 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_124), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_125;
            (void)result_1194;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t146;
        {
            ...
            {
                tur_adt_Vec__int * __ps_148 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1321));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1322 = __ps_148;
                (void)_un_unv_1322;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t152;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1372 = __ps_153;
            (void)r_1372;
            int64_t __t154;
            bool __ps_155 = (schema_hydecode_hyok_qu(r_1372));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_155) {
                int64_t __ps_156 = (schema_hydecode_hyvalue(r_1372));
                if (tur_panicking) return ((int64_t)0);
                __t154 = __ps_156;
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1372));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t172;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_173 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t172 = __ps_173;
        } else {
            void *__t175 = malloc(sizeof(void *) + sizeof(struct __env_1440));
            *(void (**)(void *))__t175 = drop_glue___env_1440;
            struct __env_1440 *__t174 = (struct __env_1440 *)((char *)__t175 + sizeof(void *));
            __t174->__fn = (tur_thunk_int64_t_t)__fn_1438;
            __t174->acc = acc;
            __t174->n = n;
            void *__t176 = __t174;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_179 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_180 = (step(__ps_179, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        tur_adt_Result__int__int __ps_181 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_182 = (step(__ps_181, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_182));
        int64_t __t183;
        __t183 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_184 = (ctor_Cons_Cons__int(h, t));
...
static bool ok___spec__bool_tur_adt_Result__int__int(tur_adt_Result__int__int r) {
        bool __t186 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t _un_934 = (int64_t)__scrut->as.Ok._0;
                __t186 = true;
                break;
            }
            case 1: {
                int64_t _un_935 = (int64_t)__scrut->as.Err._0;
                __t186 = false;
                break;
            }
            default: break;
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_187 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_188 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_188;
}
