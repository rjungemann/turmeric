...
struct __env_1627 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1625(void * __env_p_1628) {
        ...
        return step(__env___env_1627->acc, (__env___env_1627->n) - (INT64_C(1)));
}
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        if ((n) == (INT64_C(0))) {
            ...
            void *__t174 = malloc(sizeof(void *) + sizeof(struct __env_1627));
            *(void (**)(void *))__t174 = drop_glue___env_1627;
            struct __env_1627 *__t173 = (struct __env_1627 *)((char *)__t174 + sizeof(void *));
            __t173->__fn = (tur_thunk_int64_t_t)__fn_1625;
            __t173->acc = acc;
