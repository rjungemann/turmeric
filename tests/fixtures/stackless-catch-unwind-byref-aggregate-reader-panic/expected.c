...
struct __env_1624 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1622(void * __env_p_1625) {
        struct __env_1624 *__env___env_1624 = (struct __env_1624 *)__env_p_1625;
        return step(__env___env_1624->acc, (__env___env_1624->n) - (INT64_C(1)));
}
...
static int64_t describe(tur_adt_Result__int__int r) {
        bool __ps_172 = (ok___spec__bool_tur_adt_Result__int__int(r));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_172) {
            return INT64_C(10);
        } else {
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        if ((n) == (INT64_C(0))) {
            ...
            void *__t174 = malloc(sizeof(void *) + sizeof(struct __env_1624));
            *(void (**)(void *))__t174 = drop_glue___env_1624;
            struct __env_1624 *__t173 = (struct __env_1624 *)((char *)__t174 + sizeof(void *));
            __t173->__fn = (tur_thunk_int64_t_t)__fn_1622;
            __t173->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t173->acc), sizeof(__t173->acc));
            __t173->n = n;
            TUR_REGION_NOTE_WORDS(&(__t173->n), sizeof(__t173->n));
            void *__t175 = __t173;
            int64_t __catch_result_176 = tur_catch_unwind_box((int64_t)(intptr_t)__t175);
            TUR_CLOSURE_DROP(__t175);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_176);
            return (n) + (INT64_C(100));
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_177 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_178 = (step(__ps_177, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_178));
        tur_adt_Result__int__int __ps_179 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_180 = (step(__ps_179, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
