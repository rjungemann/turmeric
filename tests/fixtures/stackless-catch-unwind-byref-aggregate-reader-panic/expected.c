...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t27;
        {
            ...
            bool __t28;
            if ((t1_996) == (INT64_C(0))) {
                __t28 = (t2_997) == (INT64_C(0));
            } else {
                bool __t29;
                if ((t2_997) == (INT64_C(0))) {
                    __t29 = false;
                } else {
                    __auto_type __ps_30 = (cons_hyeq_hygo(t1_996, t2_997));
                    if (tur_panicking) return (bool){0};
                    __t29 = __ps_30;
                }
                __t28 = __t29;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t33) {
            ...
            __t37[1] = (int64_t)(intptr_t)__fn_1132;
            void *__t38 = __t37;
...
static int64_t __fn_1285(void * __env_p_1288) {
        ...
        tur_adt_Result__int__int __t40 = __env___env_1287->acc;
        __auto_type __ps_41 = (step(&__t40, (__env___env_1287->n) - (INT64_C(1))));
...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            __auto_type __ps_159 = (describe(acc));
            if (tur_panicking) break;
            __v = (int64_t)(intptr_t)(__ps_159); __pc = __k->tag; break;
           } else {
            tur_handler_node *__b160 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b160->parent = tur_handler_chain; tur_handler_chain = __b160;
            tur_cont *__n160 = (tur_cont*)malloc(sizeof(tur_cont));
            __n160->tag = 3; __n160->boundary = __b160; __n160->next = __k;
            __n160->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, acc, sizeof(tur_adt_Result__int__int)); __n160->saved[0] = (int64_t)(intptr_t)__ab; }
            __n160->saved[1] = (int64_t)(intptr_t)(n);
            __n160->saved[2] = (int64_t)(intptr_t)(__t157);
            __n160->saved[3] = (int64_t)(intptr_t)(__t158);
            __k = __n160; __pc = 2; break;
           }
          }
          case 2: {
           __auto_type __ra161_0 = (acc);
           __auto_type __ra161_1 = ((n) - (INT64_C(1)));
           memmove(&acc__agg, __ra161_0, sizeof(tur_adt_Result__int__int)); acc = &acc__agg;
           n = __ra161_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           int64_t __box160;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp160 = global_panic_payload; global_panic_payload = 0; __box160 = tur_box_err((int64_t)(intptr_t)__pp160); }
           else { __box160 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box160);
           (void)(__box160);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_162 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t163 = __ps_162;
        __auto_type __ps_164 = (step(&__t163, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_164));
        __auto_type __ps_165 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t166 = __ps_165;
        __auto_type __ps_167 = (step(&__t166, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_167));
        int64_t __t168;
        __t168 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        __auto_type __ps_171 = (ctor_Result__int__int(true, x, (int64_t){0}));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        __auto_type __ps_172 = (ctor_Result__int__int(false, (int64_t){0}, e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_172;
}
