...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            void *__t186 = malloc(sizeof(void *) + sizeof(struct __env_1440));
            *(void (**)(void *))__t186 = drop_glue___env_1440;
            struct __env_1440 *__t185 = (struct __env_1440 *)((char *)__t186 + sizeof(void *));
            __t185->__fn = (tur_thunk_int64_t_t)__fn_1438;
            __t185->acc = acc;
            __t185->n = n;
            void *__t187 = __t185;
