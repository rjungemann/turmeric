...
struct __env_1444 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1442(void * __env_p_1445) {
        struct __env_1444 *__env___env_1444 = (struct __env_1444 *)__env_p_1445;
        int64_t __ps_40 = (step(__env___env_1444->acc, (__env___env_1444->n) - (INT64_C(1))));
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_819 = __ps_73;
        bool __ps_74 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_74;
        if (__t1) {
            int64_t __ps_75 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_76 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t78;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_823 = __ps_80;
            (void)iter_823;
            void * __ps_81 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_82 = (hamt_slkeyeq((void *)(intptr_t)(__ps_81)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_824 = __ps_82;
            (void)keyeq_824;
            void * __ps_83 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_84 = (map_hyeq_hyloop((void *)(intptr_t)(iter_823), (void *)(intptr_t)(__ps_83), (void *)(intptr_t)(keyeq_824), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_825 = __ps_84;
            (void)result_825;
        ...
        if (__ps_103) {
            bool __t104;
            {
                ...
                if ((t1_1103) == (INT64_C(0))) {
                    __t105 = (t2_1104) == (INT64_C(0));
                } else {
                    bool __t106;
                    if ((t2_1104) == (INT64_C(0))) {
                        __t106 = false;
                    } else {
                        bool __ps_107 = (cons_hyeq_hygo(t1_1103, t2_1104));
                        if (tur_panicking) return ((bool)0);
                        __t106 = __ps_107;
                    }
                    __t105 = __t106;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                int64_t out_1119 = (int64_t)(intptr_t)(__ps_118);
                (void)out_1119;
                __t114 = out_1119;
            }
            __t112 = __t114;
        ...
        if (__ps_123) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1190 = __ps_124;
                (void)h_1190;
                void * __ps_125 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1191 = __ps_125;
                (void)k_1191;
                bool __ps_126 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1190, (void *)(intptr_t)(k_1191), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_126) {
                    void * __t127 = iter;
                    void * __t128 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t130;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1194 = __ps_132;
            (void)iter_1194;
            void * __ps_133 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_134 = (hamt_slkeyeq((void *)(intptr_t)(__ps_133)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1195 = __ps_134;
            (void)keyeq_1195;
            void * __ps_135 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_136 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1194), (void *)(intptr_t)(__ps_135), (void *)(intptr_t)(keyeq_1195)));
            if (tur_panicking) return ((bool)0);
            bool result_1196 = __ps_136;
            (void)result_1196;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t157;
        {
            ...
            {
                tur_adt_Vec__int * __ps_159 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1324));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1325 = __ps_159;
                (void)_un_unv_1325;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t163;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1375 = __ps_164;
            (void)r_1375;
            int64_t __t165;
            bool __ps_166 = (schema_hydecode_hyok_qu(r_1375));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_166) {
                int64_t __ps_167 = (schema_hydecode_hyvalue(r_1375));
                if (tur_panicking) return ((int64_t)0);
                __t165 = __ps_167;
            } else {
                int64_t __ps_168 = (schema_hydecode_hyerrors(r_1375));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t184;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_185 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t184 = __ps_185;
        } else {
            void *__t187 = malloc(sizeof(void *) + sizeof(struct __env_1444));
            *(void (**)(void *))__t187 = drop_glue___env_1444;
            struct __env_1444 *__t186 = (struct __env_1444 *)((char *)__t187 + sizeof(void *));
            __t186->__fn = (tur_thunk_int64_t_t)__fn_1442;
            __t186->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t186->acc), sizeof(__t186->acc));
            __t186->n = n;
            TUR_REGION_NOTE_WORDS(&(__t186->n), sizeof(__t186->n));
            void *__t188 = __t186;
            int64_t __catch_result_189 = tur_catch_unwind_box((int64_t)(intptr_t)__t188);
            TUR_CLOSURE_DROP(__t188);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_189);
            int64_t __t190;
            __t190 = (n) + (INT64_C(100));
            __t184 = __t190;
        }
        return __t184;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_191 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_192 = (step(__ps_191, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_192));
        tur_adt_Result__int__int __ps_193 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_194 = (step(__ps_193, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_194));
        int64_t __t195;
        __t195 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_196 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_199 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_200 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_200;
}
