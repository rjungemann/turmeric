...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_108) {
            bool __t109;
            {
                ...
                bool __t110;
                if ((t1_979) == (INT64_C(0))) {
                    __t110 = (t2_980) == (INT64_C(0));
                } else {
                    bool __t111;
                    if ((t2_980) == (INT64_C(0))) {
                        __t111 = false;
                    } else {
                        __auto_type __ps_112 = (cons_hyeq_hygo(t1_979, t2_980));
                        if (tur_panicking) return (bool){0};
                        __t111 = __ps_112;
                    }
                    __t110 = __t111;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_988 = (int64_t)(intptr_t)(__ps_120);
                (void)out_988;
                __t115 = out_988;
            }
            __t113 = __t115;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_122) {
            ...
            int64_t __t123;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_995 = (int64_t)(intptr_t)(__ps_127);
                (void)out_995;
                __t123 = out_995;
            }
            __t121 = __t123;
        ...
        if (__ps_132) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1066 = __ps_133;
                (void)h_1066;
                __auto_type __ps_134 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1067 = __ps_134;
                (void)k_1067;
                __auto_type __ps_135 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1066, (void *)(intptr_t)(k_1067), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_135) {
                    void * __t136 = iter;
                    void * __t137 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t139;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1070 = __ps_141;
            (void)iter_1070;
            __auto_type __ps_142 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_143 = (hamt_slkeyeq((void *)(intptr_t)(__ps_142)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1071 = __ps_143;
            (void)keyeq_1071;
            __auto_type __ps_144 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_145 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1070), (void *)(intptr_t)(__ps_144), (void *)(intptr_t)(keyeq_1071)));
            if (tur_panicking) return (bool){0};
            bool result_1072 = __ps_145;
            (void)result_1072;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t166;
        {
            ...
            {
                __auto_type __ps_168 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1199));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1200 = __ps_168;
                (void)_un_unv_1200;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t171;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1249 = __ps_172;
            (void)r_1249;
            int64_t __t173;
            __auto_type __ps_174 = (schema_hydecode_hyok_qu(r_1249));
            if (tur_panicking) return (int64_t){0};
            if (__ps_174) {
                __auto_type __ps_175 = (schema_hydecode_hyvalue(r_1249));
                if (tur_panicking) return (int64_t){0};
                __t173 = __ps_175;
            } else {
                __auto_type __ps_176 = (schema_hydecode_hyerrors(r_1249));
                if (tur_panicking) return (int64_t){0};
...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            __auto_type __ps_183 = (describe(acc));
            if (tur_panicking) break;
            __v = (int64_t)(intptr_t)(__ps_183); __pc = __k->tag; break;
           } else {
            ...
            __n184->saved[2] = (int64_t)(intptr_t)(__t181);
            __n184->saved[3] = (int64_t)(intptr_t)(__t182);
            __k = __n184; __pc = 2; break;
           }
          }
          case 2: {
           __auto_type __ra185_0 = (acc);
           __auto_type __ra185_1 = ((n) - (INT64_C(1)));
           memmove(&acc__agg, __ra185_0, sizeof(tur_adt_Result__int__int)); acc = &acc__agg;
           n = __ra185_1;
           __pc = 1; break;
          }
          case 3: {
