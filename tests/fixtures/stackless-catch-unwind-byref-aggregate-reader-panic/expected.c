...
static int64_t __fn_1442(void * __env_p_1445) {
        ...
        int64_t __ps_42 = (step(__env___env_1444->acc, (__env___env_1444->n) - (INT64_C(1))));
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_819 = __ps_75;
        bool __ps_76 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_76;
        if (__t1) {
            int64_t __ps_77 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_78 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t80;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_823 = __ps_82;
            (void)iter_823;
            void * __ps_83 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_84 = (hamt_slkeyeq((void *)(intptr_t)(__ps_83)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_824 = __ps_84;
            (void)keyeq_824;
            void * __ps_85 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_86 = (map_hyeq_hyloop((void *)(intptr_t)(iter_823), (void *)(intptr_t)(__ps_85), (void *)(intptr_t)(keyeq_824), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_825 = __ps_86;
            (void)result_825;
        ...
        if (__ps_105) {
            bool __t106;
            {
                ...
                if ((t1_1103) == (INT64_C(0))) {
                    __t107 = (t2_1104) == (INT64_C(0));
                } else {
                    bool __t108;
                    if ((t2_1104) == (INT64_C(0))) {
                        __t108 = false;
                    } else {
                        bool __ps_109 = (cons_hyeq_hygo(t1_1103, t2_1104));
                        if (tur_panicking) return ((bool)0);
                        __t108 = __ps_109;
                    }
                    __t107 = __t108;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                int64_t out_1119 = (int64_t)(intptr_t)(__t121);
                (void)out_1119;
                __t116 = out_1119;
            }
            __t114 = __t116;
        ...
        if (__ps_126) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1190 = __ps_127;
                (void)h_1190;
                void * __ps_128 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1191 = __ps_128;
                (void)k_1191;
                bool __ps_129 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1190, (void *)(intptr_t)(k_1191), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_129) {
                    void * __t130 = iter;
                    void * __t131 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t133;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1194 = __ps_135;
            (void)iter_1194;
            void * __ps_136 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_137 = (hamt_slkeyeq((void *)(intptr_t)(__ps_136)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1195 = __ps_137;
            (void)keyeq_1195;
            void * __ps_138 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_139 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1194), (void *)(intptr_t)(__ps_138), (void *)(intptr_t)(keyeq_1195)));
            if (tur_panicking) return ((bool)0);
            bool result_1196 = __ps_139;
            (void)result_1196;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t160;
        {
            ...
            {
                tur_adt_Vec__int * __ps_162 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1324));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1325 = __ps_162;
                (void)_un_unv_1325;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t166;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1375 = __ps_167;
            (void)r_1375;
            int64_t __t168;
            bool __ps_169 = (schema_hydecode_hyok_qu(r_1375));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_169) {
                int64_t __ps_170 = (schema_hydecode_hyvalue(r_1375));
                if (tur_panicking) return ((int64_t)0);
                __t168 = __ps_170;
            } else {
                int64_t __ps_171 = (schema_hydecode_hyerrors(r_1375));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t187;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_188 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t187 = __ps_188;
        } else {
            void *__t190 = malloc(sizeof(void *) + sizeof(struct __env_1444));
            *(void (**)(void *))__t190 = drop_glue___env_1444;
            struct __env_1444 *__t189 = (struct __env_1444 *)((char *)__t190 + sizeof(void *));
            __t189->__fn = (tur_thunk_int64_t_t)__fn_1442;
            __t189->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t189->acc), sizeof(__t189->acc));
            __t189->n = n;
            TUR_REGION_NOTE_WORDS(&(__t189->n), sizeof(__t189->n));
            void *__t191 = __t189;
            int64_t __catch_result_192 = tur_catch_unwind_box((int64_t)(intptr_t)__t191);
            TUR_CLOSURE_DROP(__t191);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_192);
            int64_t __t193;
            __t193 = (n) + (INT64_C(100));
            __t187 = __t193;
        }
        return __t187;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_194 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_195 = (step(__ps_194, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_195));
        tur_adt_Result__int__int __ps_196 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_197 = (step(__ps_196, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_197));
        int64_t __t198;
        __t198 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_199 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_202 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_203 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_203;
}
