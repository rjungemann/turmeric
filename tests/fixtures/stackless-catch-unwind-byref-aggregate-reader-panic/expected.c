...
static int64_t __fn_1270(void * __env_p_1273) {
        ...
        tur_adt_Result__int__int __t43 = __env___env_1272->acc;
        __auto_type __ps_44 = (step(&__t43, (__env___env_1272->n) - (INT64_C(1))));
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        bool __t71;
        __auto_type __ps_72 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
        if (tur_panicking) return (bool){0};
        if (__ps_72) {
            bool __t73;
            {
                __auto_type __ps_74 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                int64_t h_736 = __ps_74;
                (void)h_736;
                __auto_type __ps_75 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_737 = __ps_75;
                (void)k_737;
                bool __t76;
                __auto_type __ps_77 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_736, (void *)(intptr_t)(k_737), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_77) {
                    bool __t78;
                    __auto_type __ps_79 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_80 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_736, (void *)(intptr_t)(k_737), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_81 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_79, __ps_80));
                    if (tur_panicking) return (bool){0};
                    if (__ps_81) {
                        __auto_type __ps_82 = (map_hyeq_hyloop((void *)(intptr_t)(iter), (void *)(intptr_t)(m2_hamt), (void *)(intptr_t)(keyeq), (int64_t)(intptr_t)(val_cmp)));
                        if (tur_panicking) return (bool){0};
                        __t78 = __ps_82;
                    } else {
                        __t78 = false;
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t83;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_85 = (hamt_sliter_hyalloc((void *)(intptr_t)(__ps_84)));
            if (tur_panicking) return (bool){0};
            void * iter_741 = __ps_85;
            (void)iter_741;
            __auto_type __ps_86 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_87 = (hamt_slkeyeq((void *)(intptr_t)(__ps_86)));
            if (tur_panicking) return (bool){0};
            void * keyeq_742 = __ps_87;
            (void)keyeq_742;
            __auto_type __ps_88 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_89 = (map_hyeq_hyloop((void *)(intptr_t)(iter_741), (void *)(intptr_t)(__ps_88), (void *)(intptr_t)(keyeq_742), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_743 = __ps_89;
            (void)result_743;
...
static bool vec_hyeq_hyloop(int64_t x, int64_t y, int64_t i, int64_t len, int64_t cmp) {
        ...
        if ((i) == (len)) {
            ...
            bool __t92;
            __auto_type __ps_93 = (vec_hyget(x, i));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_94 = (vec_hyget(y, i));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_95 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(cmp)))[0])((void *)(intptr_t)(cmp), __ps_93, __ps_94));
            if (tur_panicking) return (bool){0};
            if (__ps_95) {
                __auto_type __ps_96 = (vec_hyeq_hyloop(x, y, (i) + (INT64_C(1)), len, (int64_t)(intptr_t)(cmp)));
                if (tur_panicking) return (bool){0};
                __t92 = __ps_96;
            } else {
                __t92 = false;
...
static int64_t none() {
        __auto_type __ps_97 = (ctor_Option(false, (int64_t){0}));
        if (tur_panicking) return (int64_t){0};
        return __ps_97;
}
...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            __auto_type __ps_187 = (describe(acc));
            if (tur_panicking) break;
            __v = (int64_t)(intptr_t)(__ps_187); __pc = __k->tag; break;
           } else {
            ...
            __n188->saved[2] = (int64_t)(intptr_t)(__t185);
            __n188->saved[3] = (int64_t)(intptr_t)(__t186);
            __k = __n188; __pc = 2; break;
           }
          }
          case 2: {
           __auto_type __ra189_0 = (acc);
           __auto_type __ra189_1 = ((n) - (INT64_C(1)));
           memmove(&acc__agg, __ra189_0, sizeof(tur_adt_Result__int__int)); acc = &acc__agg;
           n = __ra189_1;
           __pc = 1; break;
          }
          case 3: {
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_190 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t191 = __ps_190;
        __auto_type __ps_192 = (step(&__t191, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_192));
        __auto_type __ps_193 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t194 = __ps_193;
        __auto_type __ps_195 = (step(&__t194, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_195));
        int64_t __t196;
        __t196 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_197 = (ctor_Cons__int(h, t));
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        __auto_type __ps_198 = (ctor_Result__int__int(true, x, (int64_t){0}));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        __auto_type __ps_199 = (ctor_Result__int__int(false, (int64_t){0}, e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_199;
}
