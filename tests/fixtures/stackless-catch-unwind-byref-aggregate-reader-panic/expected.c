...
struct __env_1442 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
static void drop_glue___env_1442(void *__p) {
    struct __env_1442 *__e = (struct __env_1442 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1440(void * __env_p_1443) {
        struct __env_1442 *__env___env_1442 = (struct __env_1442 *)__env_p_1443;
        int64_t __ps_40 = (step(__env___env_1442->acc, (__env___env_1442->n) - (INT64_C(1))));
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t183;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_184 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t183 = __ps_184;
        } else {
            void *__t186 = malloc(sizeof(void *) + sizeof(struct __env_1442));
            *(void (**)(void *))__t186 = drop_glue___env_1442;
            struct __env_1442 *__t185 = (struct __env_1442 *)((char *)__t186 + sizeof(void *));
            __t185->__fn = (tur_thunk_int64_t_t)__fn_1440;
            __t185->acc = acc;
            __t185->n = n;
            void *__t187 = __t185;
            int64_t __catch_result_188 = tur_catch_unwind_box((int64_t)(intptr_t)__t187);
            TUR_CLOSURE_DROP(__t187);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_188);
            int64_t __t189;
            __t189 = (n) + (INT64_C(100));
            __t183 = __t189;
        }
        return __t183;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_190 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_191 = (step(__ps_190, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_191));
        tur_adt_Result__int__int __ps_192 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_193 = (step(__ps_192, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_193));
        int64_t __t194;
        __t194 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_195 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_196 = (vec_new__spec__tur_adt_Vec__int__());
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_198 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_199 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_199;
}
