...
struct __env_1473 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1471(void * __env_p_1474) {
        struct __env_1473 *__env___env_1473 = (struct __env_1473 *)__env_p_1474;
        int64_t __ps_124 = (step(__env___env_1473->acc, (__env___env_1473->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_856 = __ps_157;
        bool __ps_158 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_855, (void *)(intptr_t)(k_856), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_158;
        if (__t1) {
            int64_t __ps_159 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_160 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_855, (void *)(intptr_t)(k_856), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t162;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_860 = __ps_164;
            (void)iter_860;
            void * __ps_165 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_166 = (hamt_slkeyeq((void *)(intptr_t)(__ps_165)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_861 = __ps_166;
            (void)keyeq_861;
            void * __ps_167 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_168 = (map_hyeq_hyloop((void *)(intptr_t)(iter_860), (void *)(intptr_t)(__ps_167), (void *)(intptr_t)(keyeq_861), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_862 = __ps_168;
            (void)result_862;
        ...
        if (__ps_187) {
            bool __t188;
            {
                ...
                if ((t1_1140) == (INT64_C(0))) {
                    __t189 = (t2_1141) == (INT64_C(0));
                } else {
                    bool __t190;
                    if ((t2_1141) == (INT64_C(0))) {
                        __t190 = false;
                    } else {
                        bool __ps_191 = (cons_hyeq_hygo(t1_1140, t2_1141));
                        if (tur_panicking) return ((bool)0);
                        __t190 = __ps_191;
                    }
                    __t189 = __t190;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_197) {
            ...
            int64_t __t198;
            {
                ...
                int64_t out_1156 = (int64_t)(intptr_t)(__ps_202);
                (void)out_1156;
                __t198 = out_1156;
            }
            __t196 = __t198;
        ...
        if (__ps_207) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1227 = __ps_208;
                (void)h_1227;
                void * __ps_209 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1228 = __ps_209;
                (void)k_1228;
                bool __ps_210 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1227, (void *)(intptr_t)(k_1228), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_210) {
                    void * __t211 = iter;
                    void * __t212 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t214;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1231 = __ps_216;
            (void)iter_1231;
            void * __ps_217 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_218 = (hamt_slkeyeq((void *)(intptr_t)(__ps_217)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1232 = __ps_218;
            (void)keyeq_1232;
            void * __ps_219 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_220 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1231), (void *)(intptr_t)(__ps_219), (void *)(intptr_t)(keyeq_1232)));
            if (tur_panicking) return ((bool)0);
            bool result_1233 = __ps_220;
            (void)result_1233;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t241;
        {
            ...
            {
                tur_adt_Vec__int * __ps_243 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1363));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1364 = __ps_243;
                (void)_un_unv_1364;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t247;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1414 = __ps_248;
            (void)r_1414;
            int64_t __t249;
            bool __ps_250 = (schema_hydecode_hyok_qu(r_1414));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_250) {
                int64_t __ps_251 = (schema_hydecode_hyvalue(r_1414));
                if (tur_panicking) return ((int64_t)0);
                __t249 = __ps_251;
            } else {
                int64_t __ps_252 = (schema_hydecode_hyerrors(r_1414));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t255;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1465 = __ps_256;
            (void)m_1465;
            tur_frame __frame_257;
            tur_frame_init(&__frame_257, NULL);
            struct __defer_env_258 __t260 = {.m = m_1465};
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t271;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_272 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t271 = __ps_272;
        } else {
            void *__t274 = malloc(sizeof(void *) + sizeof(struct __env_1473));
            *(void (**)(void *))__t274 = drop_glue___env_1473;
            struct __env_1473 *__t273 = (struct __env_1473 *)((char *)__t274 + sizeof(void *));
            __t273->__fn = (tur_thunk_int64_t_t)__fn_1471;
            __t273->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t273->acc), sizeof(__t273->acc));
            __t273->n = n;
            TUR_REGION_NOTE_WORDS(&(__t273->n), sizeof(__t273->n));
            void *__t275 = __t273;
            int64_t __catch_result_276 = tur_catch_unwind_box((int64_t)(intptr_t)__t275);
            TUR_CLOSURE_DROP(__t275);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_276);
            int64_t __t277;
            __t277 = (n) + (INT64_C(100));
            __t271 = __t277;
        }
        return __t271;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_278 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_279 = (step(__ps_278, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_279));
        tur_adt_Result__int__int __ps_280 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_281 = (step(__ps_280, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_281));
        int64_t __t282;
        __t282 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_283 = (ctor_Cons_Cons__int(h, t));
...
static bool ok___spec__bool_tur_adt_Result__int__int(tur_adt_Result__int__int r) {
        bool __t285 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t _un_973 = (int64_t)__scrut->as.Ok._0;
                __t285 = true;
                break;
            }
            case 1: {
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_286 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_287 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_287;
}
