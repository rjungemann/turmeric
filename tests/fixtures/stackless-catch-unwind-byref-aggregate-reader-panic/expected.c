...
static int64_t __fn_1473(void * __env_p_1476) {
        ...
        int64_t __ps_104 = (step(__env___env_1475->acc, (__env___env_1475->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_104;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_856 = __ps_137;
        bool __ps_138 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_855, (void *)(intptr_t)(k_856), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_138;
        if (__t1) {
            int64_t __ps_139 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_140 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_855, (void *)(intptr_t)(k_856), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t142;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_860 = __ps_144;
            (void)iter_860;
            void * __ps_145 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_146 = (hamt_slkeyeq((void *)(intptr_t)(__ps_145)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_861 = __ps_146;
            (void)keyeq_861;
            void * __ps_147 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_148 = (map_hyeq_hyloop((void *)(intptr_t)(iter_860), (void *)(intptr_t)(__ps_147), (void *)(intptr_t)(keyeq_861), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_862 = __ps_148;
            (void)result_862;
        ...
        if (__ps_167) {
            bool __t168;
            {
                ...
                if ((t1_1140) == (INT64_C(0))) {
                    __t169 = (t2_1141) == (INT64_C(0));
                } else {
                    bool __t170;
                    if ((t2_1141) == (INT64_C(0))) {
                        __t170 = false;
                    } else {
                        bool __ps_171 = (cons_hyeq_hygo(t1_1140, t2_1141));
                        if (tur_panicking) return ((bool)0);
                        __t170 = __ps_171;
                    }
                    __t169 = __t170;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_177) {
            ...
            int64_t __t178;
            {
                ...
                int64_t out_1156 = (int64_t)(intptr_t)(__ps_182);
                (void)out_1156;
                __t178 = out_1156;
            }
            __t176 = __t178;
        ...
        if (__ps_187) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1227 = __ps_188;
                (void)h_1227;
                void * __ps_189 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1228 = __ps_189;
                (void)k_1228;
                bool __ps_190 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1227, (void *)(intptr_t)(k_1228), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_190) {
                    void * __t191 = iter;
                    void * __t192 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t194;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1231 = __ps_196;
            (void)iter_1231;
            void * __ps_197 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_198 = (hamt_slkeyeq((void *)(intptr_t)(__ps_197)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1232 = __ps_198;
            (void)keyeq_1232;
            void * __ps_199 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_200 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1231), (void *)(intptr_t)(__ps_199), (void *)(intptr_t)(keyeq_1232)));
            if (tur_panicking) return ((bool)0);
            bool result_1233 = __ps_200;
            (void)result_1233;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t221;
        {
            ...
            {
                tur_adt_Vec__int * __ps_223 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1363));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1364 = __ps_223;
                (void)_un_unv_1364;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t227;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1414 = __ps_228;
            (void)r_1414;
            int64_t __t229;
            bool __ps_230 = (schema_hydecode_hyok_qu(r_1414));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_230) {
                int64_t __ps_231 = (schema_hydecode_hyvalue(r_1414));
                if (tur_panicking) return ((int64_t)0);
                __t229 = __ps_231;
            } else {
                int64_t __ps_232 = (schema_hydecode_hyerrors(r_1414));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        int64_t __t248;
        if ((n) == (INT64_C(0))) {
            int64_t __ps_249 = (describe(acc));
            if (tur_panicking) return ((int64_t)0);
            __t248 = __ps_249;
        } else {
            void *__t251 = malloc(sizeof(void *) + sizeof(struct __env_1475));
            *(void (**)(void *))__t251 = drop_glue___env_1475;
            struct __env_1475 *__t250 = (struct __env_1475 *)((char *)__t251 + sizeof(void *));
            __t250->__fn = (tur_thunk_int64_t_t)__fn_1473;
            __t250->acc = acc;
            TUR_REGION_NOTE_WORDS(&(__t250->acc), sizeof(__t250->acc));
            __t250->n = n;
            TUR_REGION_NOTE_WORDS(&(__t250->n), sizeof(__t250->n));
            void *__t252 = __t250;
            int64_t __catch_result_253 = tur_catch_unwind_box((int64_t)(intptr_t)__t252);
            TUR_CLOSURE_DROP(__t252);
            tur_result_box_free((int64_t)(intptr_t)__catch_result_253);
            int64_t __t254;
            __t254 = (n) + (INT64_C(100));
            __t248 = __t254;
        }
        return __t248;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_255 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_256 = (step(__ps_255, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_256));
        tur_adt_Result__int__int __ps_257 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_258 = (step(__ps_257, INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_258));
        int64_t __t259;
        __t259 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_260 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_261 = (vec_new__spec__tur_adt_Vec__int__());
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_263 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_264 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_264;
}
