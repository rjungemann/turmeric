...
struct __env_1615 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
static void drop_glue___env_1615(void *__p) {
    struct __env_1615 *__e = (struct __env_1615 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1613(void * __env_p_1616) {
        struct __env_1615 *__env___env_1615 = (struct __env_1615 *)__env_p_1616;
        return step(__env___env_1615->acc, (__env___env_1615->n) - (INT64_C(1)));
}
...
static int64_t step(tur_adt_Result__int__int acc, int64_t n) {
        if ((n) == (INT64_C(0))) {
            ...
            void *__t174 = malloc(sizeof(void *) + sizeof(struct __env_1615));
            *(void (**)(void *))__t174 = drop_glue___env_1615;
            struct __env_1615 *__t173 = (struct __env_1615 *)((char *)__t174 + sizeof(void *));
            __t173->__fn = (tur_thunk_int64_t_t)__fn_1613;
            __t173->acc = acc;
