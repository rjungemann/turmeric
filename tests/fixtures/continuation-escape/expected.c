...
static int64_t __fn_620(int64_t exit2) {
        return INT64_C(100);
}

static int64_t __fn_623(int64_t exit1) {
        int64_t __t0;
        {
            int64_t (*__esc_f)(int64_t) = __fn_620;
            (void)__esc_f;
...
static int64_t __fn_627(int64_t exit) {
        return INT64_C(5);
}
...
static int64_t test_escape_let() {
        int64_t __t2;
        {
            int64_t __t3;
            {
                int64_t (*__esc_f)(int64_t) = __fn_627;
                (void)__esc_f;
                __t3 = ((int64_t (*)(int64_t))(intptr_t)__esc_f)(INT64_C(0));
            }
            int64_t v_630 = __t3;
            (void)v_630;
            __t2 = ((v_630) + (INT64_C(10)));
        }
        return __t2;
}
