...
static int64_t __fn_200(int64_t);
static int64_t __fn_203(int64_t);
static int64_t __fn_207(int64_t);
...
static int64_t __fn_200(int64_t exit2) {
        return INT64_C(100);
}

static int64_t __fn_203(int64_t exit1) {
        int64_t __t0;
        {
            int64_t (*__esc_f)(int64_t) = __fn_200;
            (void)__esc_f;
...
static int64_t __fn_207(int64_t exit) {
        return INT64_C(5);
}
...
static int64_t test_escape_let() {
        int64_t __t2;
        {
            int64_t __t3;
            {
                int64_t (*__esc_f)(int64_t) = __fn_207;
                (void)__esc_f;
                __t3 = __esc_f(INT64_C(0));
            }
            int64_t v_210 = __t3;
            (void)v_210;
            __t2 = ((v_210) + (INT64_C(10)));
        }
        return __t2;
}

int main() {
        printf("%lld\n", (long long)(test_escape_nested()));
        printf("%lld\n", (long long)(test_escape_let()));
        int64_t __t4;
        __t4 = INT64_C(0);
        return (int)__t4;
}
