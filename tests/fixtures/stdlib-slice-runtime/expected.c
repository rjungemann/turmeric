...
int main() {
        int64_t __t0;
        {
            ...
            int64_t __t1;
            {
                void * s_35 = slice_new((void *)(intptr_t)(p_34), INT64_C(3));
                (void)s_35;
                printf("%lld\n", (long long)(slice_len((void *)(intptr_t)(s_35))));
                printf("%lld\n", (long long)(slice_get((void *)(intptr_t)(s_35), INT64_C(0))));
                printf("%lld\n", (long long)(slice_get((void *)(intptr_t)(s_35), INT64_C(2))));
                slice_free((void *)(intptr_t)(s_35));
                free_buf((void *)(intptr_t)(p_34));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
