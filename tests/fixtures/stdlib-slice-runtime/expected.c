...
int main() {
        int64_t __t0;
        {
            ...
            int64_t __t1;
            {
                void * s_630 = slice_new((void *)(intptr_t)(p_629), INT64_C(3));
                (void)s_630;
                printf("%lld\n", (long long)(slice_len((void *)(intptr_t)(s_630))));
                printf("%lld\n", (long long)(slice_get((void *)(intptr_t)(s_630), INT64_C(0))));
                printf("%lld\n", (long long)(slice_get((void *)(intptr_t)(s_630), INT64_C(2))));
                slice_free((void *)(intptr_t)(s_630));
                free_buf((void *)(intptr_t)(p_629));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
