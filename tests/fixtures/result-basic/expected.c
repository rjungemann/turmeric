...
int main() {
        int64_t __t0;
        {
            void * r1_228 = ok(INT64_C(42));
            (void)r1_228;
            int64_t __t1;
            {
                void * r2_229 = err(INT64_C(7));
                (void)r2_229;
                puts((ok_((void *)(intptr_t)(r1_228))) ? "true" : "false");
                puts((ok_((void *)(intptr_t)(r2_229))) ? "true" : "false");
                puts((err_((void *)(intptr_t)(r1_228))) ? "true" : "false");
                puts((err_((void *)(intptr_t)(r2_229))) ? "true" : "false");
                printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(r1_228))));
                printf("%lld\n", (long long)(err_val((void *)(intptr_t)(r2_229))));
                printf("%lld\n", (long long)(result_unwrap((void *)(intptr_t)(r1_228))));
                printf("%lld\n", (long long)(result_unwrap_or((void *)(intptr_t)(r2_229), INT64_C(99))));
                printf("%lld\n", (long long)(result_expect((void *)(intptr_t)(r1_228), "should not abort")));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
