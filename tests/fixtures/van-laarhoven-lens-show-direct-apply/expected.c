...
static int64_t __poly_1350(void * __poly_env_1351, int64_t __poly_x0_1353, int64_t __poly_x1_1355, int64_t __poly_x2_1357, int64_t __poly_x3_1359) {
        int64_t __ps_57 = (deep_hylens_un_undict_un1341(__poly_x0_1353, __poly_x1_1355, __poly_x2_1357, __poly_x3_1359));
        if (tur_panicking) return ((int64_t)0);
        return __ps_57;
}
...
static int64_t __poly_1364(void * __poly_env_1365, int64_t __poly_x0_1367, int64_t __poly_x1_1369, int64_t __poly_x2_1371, int64_t __poly_x3_1373) {
        int64_t __ps_64 = (deep_hylens_un_undict_un1362(__poly_x0_1367, __poly_x1_1369, __poly_x2_1371, __poly_x3_1373));
        if (tur_panicking) return ((int64_t)0);
        return __ps_64;
}
...
static int64_t __poly_1378(void * __poly_env_1379, int64_t __poly_x0_1381, int64_t __poly_x1_1383, int64_t __poly_x2_1385, int64_t __poly_x3_1387) {
        int64_t __ps_71 = (deep_hylens_un_undict_un1376(__poly_x0_1381, __poly_x1_1383, __poly_x2_1385, __poly_x3_1387));
        if (tur_panicking) return ((int64_t)0);
        return __ps_71;
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_99 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_767, (void *)(intptr_t)(k_768), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t101;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_107 = (map_hyeq_hyloop((void *)(intptr_t)(iter_772), (void *)(intptr_t)(__ps_106), (void *)(intptr_t)(keyeq_773), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            ...
            bool __t126;
            {
                ...
                if ((t1_1015) == (INT64_C(0))) {
                    ...
                    if ((t2_1016) == (INT64_C(0))) {
                        ...
                        bool __ps_129 = (cons_hyeq_hygo(t1_1015, t2_1016));
                        if (tur_panicking) return ((bool)0);
                        __t128 = __ps_129;
                    }
                    __t127 = __t128;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t145;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_151 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1106), (void *)(intptr_t)(__ps_150), (void *)(intptr_t)(keyeq_1107)));
            if (tur_panicking) return ((bool)0);
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t172;
        {
            ...
            {
                tur_adt_Vec__int * __ps_174 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1235));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t177;
        {
            ...
            (void)r_1285;
            int64_t __t179;
            bool __ps_180 = (schema_hydecode_hyok_qu(r_1285));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_180) {
                int64_t __ps_181 = (schema_hydecode_hyvalue(r_1285));
                if (tur_panicking) return ((int64_t)0);
                __t179 = __ps_181;
            } else {
                int64_t __ps_182 = (schema_hydecode_hyerrors(r_1285));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_195 = (use_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1350 }, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_195);
        const char * __ps_196 = (use_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1364 }, true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_196);
        const char * __ps_197 = (use_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1378 }, false));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_197);
        int64_t __t198;
        __t198 = INT64_C(0);
