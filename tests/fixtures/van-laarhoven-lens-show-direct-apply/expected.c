...
static const char * __fn_1287(void * __env_p_1311, int64_t x) {
        ...
        const char * __t20;
        {
            ...
            const char * __t21;
            {
                int64_t y_1282 = x;
                (void)y_1282;
                __t21 = ((const char * (*)(int64_t))((void **)(intptr_t)__env___env_1313->__dict_1308)[0])(y_1282);
            }
            __t20 = __t21;
        }
        return __t20;
...
static int64_t deep_hylens_un_undict_un1305(int64_t __dict_1306, int64_t __dict_1308, int64_t g, int64_t s) {
        struct __env_1313 *__t22 = (struct __env_1313 *)malloc(sizeof(struct __env_1313));
        __t22->__fn = (int64_t)(intptr_t)__fn_1287;
        __t22->__dict_1308 = __dict_1308;
        void *__t23 = __t22;
        void *__t24 = (void *)(intptr_t)(__t23);
        return (int64_t)(intptr_t)((int64_t (*)(int64_t, tur_poly_fn_t))((void **)(intptr_t)__dict_1306)[0])(((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(g)))[0])((void *)(intptr_t)(g), s), (tur_poly_fn_t){ __t24, (int64_t(*)(void*,int64_t))(intptr_t)((int64_t*)__t24)[0] });
}
...
static int64_t __poly_1314(void * __poly_env_1315, int64_t __poly_x0_1317, int64_t __poly_x1_1319, int64_t __poly_x2_1321, int64_t __poly_x3_1323) {
        return deep_hylens_un_undict_un1305(__poly_x0_1317, __poly_x1_1319, __poly_x2_1321, __poly_x3_1323);
}

static int64_t deep_hylens_un_undict_un1326(int64_t __dict_1306, int64_t __dict_1308, int64_t g, int64_t s) {
        struct __env_1313 *__t25 = (struct __env_1313 *)malloc(sizeof(struct __env_1313));
        __t25->__fn = (int64_t)(intptr_t)__fn_1287;
        __t25->__dict_1308 = __dict_1308;
        void *__t26 = __t25;
        void *__t27 = (void *)(intptr_t)(__t26);
        return (int64_t)(intptr_t)((int64_t (*)(int64_t, tur_poly_fn_t))((void **)(intptr_t)__dict_1306)[0])(((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(g)))[0])((void *)(intptr_t)(g), s), (tur_poly_fn_t){ __t27, (int64_t(*)(void*,int64_t))(intptr_t)((int64_t*)__t27)[0] });
}
...
static int64_t __poly_1328(void * __poly_env_1329, int64_t __poly_x0_1331, int64_t __poly_x1_1333, int64_t __poly_x2_1335, int64_t __poly_x3_1337) {
        return deep_hylens_un_undict_un1326(__poly_x0_1331, __poly_x1_1333, __poly_x2_1335, __poly_x3_1337);
}

static int64_t deep_hylens_un_undict_un1340(int64_t __dict_1306, int64_t __dict_1308, int64_t g, int64_t s) {
        struct __env_1313 *__t28 = (struct __env_1313 *)malloc(sizeof(struct __env_1313));
        __t28->__fn = (int64_t)(intptr_t)__fn_1287;
        __t28->__dict_1308 = __dict_1308;
        void *__t29 = __t28;
        void *__t30 = (void *)(intptr_t)(__t29);
        return (int64_t)(intptr_t)((int64_t (*)(int64_t, tur_poly_fn_t))((void **)(intptr_t)__dict_1306)[0])(((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(g)))[0])((void *)(intptr_t)(g), s), (tur_poly_fn_t){ __t30, (int64_t(*)(void*,int64_t))(intptr_t)((int64_t*)__t30)[0] });
}
...
static int64_t __poly_1342(void * __poly_env_1343, int64_t __poly_x0_1345, int64_t __poly_x1_1347, int64_t __poly_x2_1349, int64_t __poly_x3_1351) {
        return deep_hylens_un_undict_un1340(__poly_x0_1345, __poly_x1_1347, __poly_x2_1349, __poly_x3_1351);
}
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__inst_Eq_eq_qu_int((int64_t)((tur_adt_Cons *)(intptr_t)(c1))->head, (int64_t)((tur_adt_Cons *)(intptr_t)(c2))->head)) {
            bool __t43;
            {
                ...
                bool __t44;
                if ((t1_985) == (INT64_C(0))) {
                    __t44 = (t2_986) == (INT64_C(0));
                } else {
                    bool __t45;
                    if ((t2_986) == (INT64_C(0))) {
                        __t45 = false;
                    } else {
                        __t45 = cons_hyeq_hygo(t1_985, t2_986);
                    }
                    __t44 = __t45;
                }
                __t43 = __t44;
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        bool __t55 = (set_hycount(s1)) == (set_hycount(s2));
        if (__t55) {
            __t55 = set_hyeq_hydriver(s1, s2);
        }
        return __t55;
}
            ...
            if (mutmap_hyslot_hyoccupied_qu(m1, i)) {
                ...
                if (mutmap_hyhas_qu(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i))) {
                    ...
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), mutmap_hyslot_hyvalue(m1, i), mutmap_hyget(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i)))) {
                        __t59 = mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp));
                    } else {
                        __t59 = false;
                    }
                    __t58 = __t59;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t64;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1249)) {
                __t65 = schema_hydecode_hyvalue(r_1249);
            } else {
                __t65 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1249));
            }
            __t64 = __t65;
        }
        return __t64;
...
static const char * use_hyint(tur_poly_fn_t l, int64_t s) {
        ...
        __t66[1] = (int64_t)(intptr_t)__fn_1298;
        void *__t67 = __t66;
        return ((union { int64_t s; const char * d; }){.s = run_hyid(((int64_t(*)(void*, int64_t, int64_t, int64_t, int64_t))l.fn)(l.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Functor_Identity_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)(__t67)), (int64_t)(s)))}).d;
}
...
static const char * use_hybool(tur_poly_fn_t l, bool s) {
        ...
        __t68[1] = (int64_t)(intptr_t)__fn_1303;
        void *__t69 = __t68;
        return ((union { int64_t s; const char * d; }){.s = run_hyid(((int64_t(*)(void*, int64_t, int64_t, int64_t, int64_t))l.fn)(l.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Functor_Identity_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)(__t69)), (int64_t)(s)))}).d;
}
...
int main(int argc, char **argv) {
        ...
        puts(use_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1314 }, INT64_C(7)));
        puts(use_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1328 }, true));
        puts(use_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1342 }, false));
        int64_t __t70;
        __t70 = INT64_C(0);
        return (int)__t70;
}
