...
static void __defer_296(void *__env) {
    ...
    bool __ps_321 = (bt_hyundo_hyto_ex(__e->m));
        ...
        if (__ps_224) {
            bool __t225;
            {
                ...
                if ((t1_1284) == (INT64_C(0))) {
                    __t226 = (t2_1285) == (INT64_C(0));
                } else {
                    bool __t227;
                    if ((t2_1285) == (INT64_C(0))) {
                        __t227 = false;
                    } else {
                        bool __ps_228 = (cons_hyeq_hygo(t1_1284, t2_1285));
                        if (tur_panicking) return ((bool)0);
                        __t227 = __ps_228;
                    }
                    __t226 = __t227;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_234) {
            ...
            int64_t __t235;
            {
                ...
                int64_t out_1300 = (int64_t)(intptr_t)(__ps_239);
                (void)out_1300;
                __t235 = out_1300;
            }
            __t233 = __t235;
        ...
        if (__ps_244) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1371 = __ps_245;
                (void)h_1371;
                void * __ps_246 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1372 = __ps_246;
                (void)k_1372;
                bool __ps_247 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1371, (void *)(intptr_t)(k_1372), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_247) {
                    void * __t248 = iter;
                    void * __t249 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t251;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1375 = __ps_253;
            (void)iter_1375;
            void * __ps_254 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_255 = (hamt_slkeyeq((void *)(intptr_t)(__ps_254)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1376 = __ps_255;
            (void)keyeq_1376;
            void * __ps_256 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_257 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1375), (void *)(intptr_t)(__ps_256), (void *)(intptr_t)(keyeq_1376)));
            if (tur_panicking) return ((bool)0);
            bool result_1377 = __ps_257;
            (void)result_1377;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t278;
        {
            ...
            {
                tur_adt_Vec__int * __ps_280 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1507));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1508 = __ps_280;
                (void)_un_unv_1508;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t284;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1558 = __ps_285;
            (void)r_1558;
            int64_t __t286;
            bool __ps_287 = (schema_hydecode_hyok_qu(r_1558));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_287) {
                int64_t __ps_288 = (schema_hydecode_hyvalue(r_1558));
                if (tur_panicking) return ((int64_t)0);
                __t286 = __ps_288;
            } else {
                int64_t __ps_289 = (schema_hydecode_hyerrors(r_1558));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t292;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1609 = __ps_293;
            (void)m_1609;
            tur_frame __frame_294;
            tur_frame_init(&__frame_294, NULL);
            struct __defer_env_295 __t297 = {.m = m_1609};
...
static const char * use_hyint(tur_poly_fn_t l, int64_t s) {
        ...
        *(void (**)(void *))__t306 = 0;
        ...
        __t305[1] = (int64_t)(intptr_t)__fn_1640;
        void *__t307 = __t305;
...
static const char * use_hybool(tur_poly_fn_t l, bool s) {
        ...
        *(void (**)(void *))__t311 = 0;
        ...
        __t310[1] = (int64_t)(intptr_t)__fn_1645;
        void *__t312 = __t310;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        const char * __ps_315 = (use_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1656 }, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_315);
        const char * __ps_316 = (use_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1670 }, true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_316);
        const char * __ps_317 = (use_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1684 }, false));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_317);
        int64_t __t318;
        __t318 = INT64_C(0);
