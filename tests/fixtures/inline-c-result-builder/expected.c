...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_768, (void *)(intptr_t)(k_769), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_773), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_774), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            ...
            bool __t96;
            {
                ...
                if ((t1_1016) == (INT64_C(0))) {
                    ...
                    if ((t2_1017) == (INT64_C(0))) {
                        ...
                        __auto_type __ps_99 = (cons_hyeq_hygo(t1_1016, t2_1017));
                        if (tur_panicking) return (bool){0};
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1107), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1108)));
            if (tur_panicking) return (bool){0};
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                __auto_type __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1236));
                if (tur_panicking) return (int64_t){0};
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            (void)r_1286;
            int64_t __t149;
            __auto_type __ps_150 = (schema_hydecode_hyok_qu(r_1286));
            if (tur_panicking) return (int64_t){0};
            if (__ps_150) {
                __auto_type __ps_151 = (schema_hydecode_hyvalue(r_1286));
                if (tur_panicking) return (int64_t){0};
                __t149 = __ps_151;
            } else {
                __auto_type __ps_152 = (schema_hydecode_hyerrors(r_1286));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            __auto_type __ps_159 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1313));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_160 = (device_hytag(__ps_159));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_160));
            __auto_type __ps_161 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1313));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            __auto_type __ps_166 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1314));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_166));
        }
        {
            ...
            (void)c_1315;
            __auto_type __ps_169 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1315));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_169));
        }
        {
            ...
            (void)c_1316;
            __auto_type __ps_172 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1316));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_172));
        }
        {
            ...
            (void)o_1317;
            __auto_type __ps_175 = (some___spec__bool_tur_adt_Option__Device(o_1317));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_175) ? "true" : "false");
            __auto_type __ps_176 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1317));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_177 = (device_hytag(__ps_176));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            __auto_type __ps_178 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1317));
            /* panic-return-signal: ret ctype unknown; no propagation here */
