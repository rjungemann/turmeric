...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t5) {
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_789;
            void *__t7 = __t6;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_988;
        void *__t15 = __t14;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_1119;
            void *__t18 = __t17;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t48;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1247)) {
                __t49 = schema_hydecode_hyvalue(r_1247);
            } else {
                __t49 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1247));
            }
            __t48 = __t49;
        }
        return __t48;
...
int main(int argc, char **argv) {
        ...
        {
                        tur_result_box_t *__t50 = (tur_result_box_t *)(intptr_t)(open_hydevice(INT64_C(7)));
            tur_adt_Result__Device__int r_1274 = (tur_adt_Result__Device__int){.is_ok = __t50->is_ok, .ok_val = (int64_t)(__t50->ok_val), .err_val = __t50->err_val};
            (void)r_1274;
            tur_adt_Result__Device__int __t51 = r_1274;
            puts((ok_qu((int64_t)(intptr_t)(&__t51))) ? "true" : "false");
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1274))));
            device_hyfree(ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1274));
        }
        {
                        tur_result_box_t *__t52 = (tur_result_box_t *)(intptr_t)(open_hydevice(INT64_C(-1)));
            tur_adt_Result__Device__int e_1275 = (tur_adt_Result__Device__int){.is_ok = __t52->is_ok, .ok_val = (int64_t)(__t52->ok_val), .err_val = __t52->err_val};
            (void)e_1275;
            tur_adt_Result__Device__int __t53 = e_1275;
            puts((err_qu((int64_t)(intptr_t)(&__t53))) ? "true" : "false");
            printf("%lld\n", (long long)(err_val__spec__int64_t_tur_adt_Result__Device__int(e_1275)));
        }
        {
                        tur_result_box_t *__t54 = (tur_result_box_t *)(intptr_t)(classify(INT64_C(21)));
            tur_adt_Result__int__int c_1276 = (tur_adt_Result__int__int){.is_ok = __t54->is_ok, .ok_val = __t54->ok_val, .err_val = __t54->err_val};
            (void)c_1276;
            printf("%lld\n", (long long)(ok_val__spec__int64_t_tur_adt_Result__int__int(c_1276)));
        }
        {
                        tur_result_box_t *__t55 = (tur_result_box_t *)(intptr_t)(classify(INT64_C(-5)));
            tur_adt_Result__int__int c_1277 = (tur_adt_Result__int__int){.is_ok = __t55->is_ok, .ok_val = __t55->ok_val, .err_val = __t55->err_val};
            (void)c_1277;
            printf("%lld\n", (long long)(err_val__spec__int64_t_tur_adt_Result__int__int(c_1277)));
        }
        {
                        tur_option_t *__t56 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(5)));
            tur_adt_Option__Device o_1278 = (__t56 ? (tur_adt_Option__Device){.is_some = __t56->is_some, .value = (int64_t)(__t56->value)} : (tur_adt_Option__Device){0});
            (void)o_1278;
            puts((some___spec__bool_tur_adt_Option__Device(o_1278)) ? "true" : "false");
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_tur_adt_Option__Device(o_1278))));
            device_hyfree(unwrap__spec__int64_t_tur_adt_Option__Device(o_1278));
        }
        tur_option_t *__t57 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(-1)));
        puts((some___spec__bool_tur_adt_Option__Device((__t57 ? (tur_adt_Option__Device){.is_some = __t57->is_some, .value = (int64_t)(__t57->value)} : (tur_adt_Option__Device){0}))) ? "true" : "false");
        tur_option_t *__t58 = (tur_option_t *)(intptr_t)(maybe_hyint(INT64_C(9)));
        printf("%lld\n", (long long)(unwrap__spec__int64_t_tur_adt_Option__int((__t58 ? (tur_adt_Option__int){.is_some = __t58->is_some, .value = __t58->value} : (tur_adt_Option__int){0}))));
        tur_option_t *__t59 = (tur_option_t *)(intptr_t)(maybe_hyint(INT64_C(0)));
        puts((some___spec__bool_tur_adt_Option__int((__t59 ? (tur_adt_Option__int){.is_some = __t59->is_some, .value = __t59->value} : (tur_adt_Option__int){0}))) ? "true" : "false");
        int64_t __t60;
        __t60 = INT64_C(0);
        return (int)__t60;
}
