...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                (void)t2_1286;
                bool __t100;
                bool __ps_101 = (tnil_qu(t1_1285));
                if (tur_panicking) return ((bool)0);
                if (__ps_101) {
                    bool __ps_102 = (tnil_qu(t2_1286));
                    if (tur_panicking) return ((bool)0);
                    __t100 = __ps_102;
                } else {
                    bool __t103;
                    bool __ps_104 = (tnil_qu(t2_1286));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_104) {
                        __t103 = false;
                    } else {
                        bool __ps_105 = (cons_hyeq_hygo(t1_1285, t2_1286));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_105;
                    }
                    __t100 = __t103;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                int64_t out_1301 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1301;
                __t112 = out_1301;
            }
            __t110 = __t112;
        ...
        if (__ps_117) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1372 = __ps_118;
                (void)h_1372;
                void * __ps_119 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1373 = __ps_119;
                (void)k_1373;
                bool __ps_120 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1372, (void *)(intptr_t)(k_1373), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_120) {
                    void * __t121 = iter;
                    void * __t122 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t124;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1376 = __ps_126;
            (void)iter_1376;
            void * __ps_127 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_128 = (hamt_slkeyeq((void *)(intptr_t)(__ps_127)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1377 = __ps_128;
            (void)keyeq_1377;
            void * __ps_129 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_130 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1376), (void *)(intptr_t)(__ps_129), (void *)(intptr_t)(keyeq_1377)));
            if (tur_panicking) return ((bool)0);
            bool result_1378 = __ps_130;
            (void)result_1378;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t151;
        {
            ...
            {
                tur_adt_Vec__int * __ps_153 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1508));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1509 = __ps_153;
                (void)_un_unv_1509;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1559 = __ps_156;
            (void)r_1559;
            bool __ps_157 = (schema_hydecode_hyok_qu(r_1559));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_157) {
                return schema_hydecode_hyvalue(r_1559);
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1559));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t160;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1610 = __ps_161;
            (void)m_1610;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            struct __defer_env_163 __t165 = {.m = m_1610};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1619 = __t175;
            (void)r_1619;
            bool __ps_176 = (ok___spec__bool_tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            void * __ps_177 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_178 = (device_hytag((void *)(intptr_t)(__ps_177)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_178));
            void * __ps_179 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1620 = __t182;
            (void)e_1620;
            bool __ps_183 = (err___spec__bool_tur_adt_Result__Device__int(e_1620));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_183) ? "true" : "false");
            int64_t __ps_184 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1620));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_184));
        }
        {
            ...
            tur_adt_Result__int__int c_1621 = __t187;
            (void)c_1621;
            int64_t __ps_188 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1621));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_188));
        }
        {
            ...
            tur_adt_Result__int__int c_1622 = __t191;
            (void)c_1622;
            int64_t __ps_192 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1622));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_192));
        }
        {
            ...
            tur_adt_Option__Device o_1623 = __t195;
            (void)o_1623;
            bool __ps_196 = (some___spec__bool_tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_196) ? "true" : "false");
            void * __ps_197 = (unwrap__spec__void___tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_198 = (device_hytag((void *)(intptr_t)(__ps_197)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_198));
            void * __ps_199 = (unwrap__spec__void___tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_210 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
