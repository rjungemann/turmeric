...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1339 = (tur_adt_Result__Device__int){.is_ok = __t160->is_ok, .ok_val = (int64_t)(__t160->ok_val), .err_val = __t160->err_val};
            (void)r_1339;
            tur_adt_Result__Device__int __t161 = r_1339;
            bool __ps_162 = (ok_qu((int64_t)(intptr_t)(&__t161)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_162) ? "true" : "false");
            int64_t __ps_163 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1339));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_164 = (device_hytag(__ps_163));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_164));
            int64_t __ps_165 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1339));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1340 = (tur_adt_Result__Device__int){.is_ok = __t167->is_ok, .ok_val = (int64_t)(__t167->ok_val), .err_val = __t167->err_val};
            (void)e_1340;
            tur_adt_Result__Device__int __t168 = e_1340;
            bool __ps_169 = (err_qu((int64_t)(intptr_t)(&__t168)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_169) ? "true" : "false");
            int64_t __ps_170 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1340));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_170));
        }
        {
            ...
            tur_adt_Result__int__int c_1341 = (tur_adt_Result__int__int){.is_ok = __t172->is_ok, .ok_val = __t172->ok_val, .err_val = __t172->err_val};
            (void)c_1341;
            int64_t __ps_173 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1341));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_173));
        }
        {
            ...
            tur_adt_Result__int__int c_1342 = (tur_adt_Result__int__int){.is_ok = __t175->is_ok, .ok_val = __t175->ok_val, .err_val = __t175->err_val};
            (void)c_1342;
            int64_t __ps_176 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1342));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_176));
        }
        {
            ...
            tur_adt_Option__Device o_1343 = (__t178 ? (tur_adt_Option__Device){.is_some = __t178->is_some, .value = (int64_t)(__t178->value)} : (tur_adt_Option__Device){0});
            (void)o_1343;
            bool __ps_179 = (some___spec__bool_tur_adt_Option__Device(o_1343));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_179) ? "true" : "false");
            int64_t __ps_180 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1343));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_181 = (device_hytag(__ps_180));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_181));
            int64_t __ps_182 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1343));
            /* panic-return-signal: ret ctype unknown; no propagation here */
