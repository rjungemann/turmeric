...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1277 = (tur_adt_Result__Device__int){.is_ok = __t182->is_ok, .ok_val = (int64_t)(__t182->ok_val), .err_val = __t182->err_val};
            (void)r_1277;
            tur_adt_Result__Device__int __t183 = r_1277;
            __auto_type __ps_184 = (ok_qu((int64_t)(intptr_t)(&__t183)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_184) ? "true" : "false");
            __auto_type __ps_185 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1277));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_186 = (device_hytag(__ps_185));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_186));
            __auto_type __ps_187 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1277));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1278 = (tur_adt_Result__Device__int){.is_ok = __t189->is_ok, .ok_val = (int64_t)(__t189->ok_val), .err_val = __t189->err_val};
            (void)e_1278;
            tur_adt_Result__Device__int __t190 = e_1278;
            __auto_type __ps_191 = (err_qu((int64_t)(intptr_t)(&__t190)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_191) ? "true" : "false");
            __auto_type __ps_192 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1278));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_192));
        }
        {
            ...
            tur_adt_Result__int__int c_1279 = (tur_adt_Result__int__int){.is_ok = __t194->is_ok, .ok_val = __t194->ok_val, .err_val = __t194->err_val};
            (void)c_1279;
            __auto_type __ps_195 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1279));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_195));
        }
        {
            ...
            tur_adt_Result__int__int c_1280 = (tur_adt_Result__int__int){.is_ok = __t197->is_ok, .ok_val = __t197->ok_val, .err_val = __t197->err_val};
            (void)c_1280;
            __auto_type __ps_198 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1280));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_198));
        }
        {
            ...
            tur_adt_Option__Device o_1281 = (__t200 ? (tur_adt_Option__Device){.is_some = __t200->is_some, .value = (int64_t)(__t200->value)} : (tur_adt_Option__Device){0});
            (void)o_1281;
            __auto_type __ps_201 = (some___spec__bool_tur_adt_Option__Device(o_1281));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_201) ? "true" : "false");
            __auto_type __ps_202 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1281));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_203 = (device_hytag(__ps_202));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_203));
            __auto_type __ps_204 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1281));
            /* panic-return-signal: ret ctype unknown; no propagation here */
