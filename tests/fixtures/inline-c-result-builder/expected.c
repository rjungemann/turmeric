        ...
        bool __t28;
        {
            ...
            if ((t1_1021) == (INT64_C(0))) {
                ...
                if ((t2_1022) == (INT64_C(0))) {
                    ...
                    bool __ps_31 = (cons_hyeq_hygo(t1_1021, t2_1022));
                    if (tur_panicking) return ((bool)0);
                    __t30 = __ps_31;
                }
                __t29 = __t30;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_768, (void *)(intptr_t)(k_769), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_773 = __ps_73;
            (void)iter_773;
            void * __ps_74 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_75 = (hamt_slkeyeq((void *)(intptr_t)(__ps_74)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_774 = __ps_75;
            (void)keyeq_774;
            void * __ps_76 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_773), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_774), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_775 = __ps_77;
            (void)result_775;
        ...
        if (__ps_95) {
            bool __t96;
            {
                ...
                if ((t1_1016) == (INT64_C(0))) {
                    __t97 = (t2_1017) == (INT64_C(0));
                } else {
                    bool __t98;
                    if ((t2_1017) == (INT64_C(0))) {
                        __t98 = false;
                    } else {
                        bool __ps_99 = (cons_hyeq_hygo(t1_1016, t2_1017));
                        if (tur_panicking) return ((bool)0);
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_105) {
            ...
            int64_t __t106;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1032 = (int64_t)(intptr_t)(__ps_110);
                (void)out_1032;
                __t106 = out_1032;
            }
            __t104 = __t106;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1107 = __ps_117;
            (void)iter_1107;
            void * __ps_118 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_119 = (hamt_slkeyeq((void *)(intptr_t)(__ps_118)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1108 = __ps_119;
            (void)keyeq_1108;
            void * __ps_120 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1107), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1108)));
            if (tur_panicking) return ((bool)0);
            bool result_1109 = __ps_121;
            (void)result_1109;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                tur_adt_Vec__int * __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1236));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1237 = __ps_144;
                (void)_un_unv_1237;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1286 = __ps_148;
            (void)r_1286;
            int64_t __t149;
            bool __ps_150 = (schema_hydecode_hyok_qu(r_1286));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_150) {
                int64_t __ps_151 = (schema_hydecode_hyvalue(r_1286));
                if (tur_panicking) return ((int64_t)0);
                __t149 = __ps_151;
            } else {
                int64_t __ps_152 = (schema_hydecode_hyerrors(r_1286));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_155 = (open_hydevice(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        tur_result_box_t *__t156 = (tur_result_box_t *)(intptr_t)(__ps_155);
            tur_adt_Result__Device__int r_1313 = (tur_adt_Result__Device__int){.is_ok = __t156->is_ok, .ok_val = (int64_t)(__t156->ok_val), .err_val = __t156->err_val};
            (void)r_1313;
            tur_adt_Result__Device__int __t157 = r_1313;
            bool __ps_158 = (ok_qu((int64_t)(intptr_t)(&__t157)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_158) ? "true" : "false");
            int64_t __ps_159 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1313));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_160 = (device_hytag(__ps_159));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_160));
            int64_t __ps_161 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1313));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree(__ps_161);
        }
        {
            int64_t __ps_162 = (open_hydevice(INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        tur_result_box_t *__t163 = (tur_result_box_t *)(intptr_t)(__ps_162);
            tur_adt_Result__Device__int e_1314 = (tur_adt_Result__Device__int){.is_ok = __t163->is_ok, .ok_val = (int64_t)(__t163->ok_val), .err_val = __t163->err_val};
            (void)e_1314;
            tur_adt_Result__Device__int __t164 = e_1314;
            bool __ps_165 = (err_qu((int64_t)(intptr_t)(&__t164)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_165) ? "true" : "false");
            int64_t __ps_166 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1314));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_166));
        }
        {
            int64_t __ps_167 = (classify(INT64_C(21)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        tur_result_box_t *__t168 = (tur_result_box_t *)(intptr_t)(__ps_167);
            tur_adt_Result__int__int c_1315 = (tur_adt_Result__int__int){.is_ok = __t168->is_ok, .ok_val = __t168->ok_val, .err_val = __t168->err_val};
            (void)c_1315;
            int64_t __ps_169 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1315));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_169));
        }
        {
            int64_t __ps_170 = (classify(INT64_C(-5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        tur_result_box_t *__t171 = (tur_result_box_t *)(intptr_t)(__ps_170);
            tur_adt_Result__int__int c_1316 = (tur_adt_Result__int__int){.is_ok = __t171->is_ok, .ok_val = __t171->ok_val, .err_val = __t171->err_val};
            (void)c_1316;
            int64_t __ps_172 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1316));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_172));
        }
        {
            int64_t __ps_173 = (maybe_hyopen(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        tur_option_t *__t174 = (tur_option_t *)(intptr_t)(__ps_173);
            tur_adt_Option__Device o_1317 = (__t174 ? (tur_adt_Option__Device){.is_some = __t174->is_some, .value = (int64_t)(__t174->value)} : (tur_adt_Option__Device){0});
            (void)o_1317;
            bool __ps_175 = (some___spec__bool_tur_adt_Option__Device(o_1317));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_175) ? "true" : "false");
            int64_t __ps_176 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1317));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_177 = (device_hytag(__ps_176));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            int64_t __ps_178 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1317));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree(__ps_178);
        }
        int64_t __ps_179 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t180 = (tur_option_t *)(intptr_t)(__ps_179);
        bool __ps_181 = (some___spec__bool_tur_adt_Option__Device((__t180 ? (tur_adt_Option__Device){.is_some = __t180->is_some, .value = (int64_t)(__t180->value)} : (tur_adt_Option__Device){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_181) ? "true" : "false");
        int64_t __ps_182 = (maybe_hyint(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t183 = (tur_option_t *)(intptr_t)(__ps_182);
        int64_t __ps_184 = (unwrap__spec__int64_t_tur_adt_Option__int((__t183 ? (tur_adt_Option__int){.is_some = __t183->is_some, .value = __t183->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_184));
        int64_t __ps_185 = (maybe_hyint(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t186 = (tur_option_t *)(intptr_t)(__ps_185);
        bool __ps_187 = (some___spec__bool_tur_adt_Option__int((__t186 ? (tur_adt_Option__int){.is_some = __t186->is_some, .value = __t186->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
