...
static void __defer_266(void *__env) {
    ...
    bool __ps_324 = (bt_hyundo_hyto_ex(__e->m));
        ...
        if (__ps_194) {
            bool __t195;
            {
                ...
                if ((t1_1285) == (INT64_C(0))) {
                    __t196 = (t2_1286) == (INT64_C(0));
                } else {
                    bool __t197;
                    if ((t2_1286) == (INT64_C(0))) {
                        __t197 = false;
                    } else {
                        bool __ps_198 = (cons_hyeq_hygo(t1_1285, t2_1286));
                        if (tur_panicking) return ((bool)0);
                        __t197 = __ps_198;
                    }
                    __t196 = __t197;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_204) {
            ...
            int64_t __t205;
            {
                ...
                int64_t out_1301 = (int64_t)(intptr_t)(__ps_209);
                (void)out_1301;
                __t205 = out_1301;
            }
            __t203 = __t205;
        ...
        if (__ps_214) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1372 = __ps_215;
                (void)h_1372;
                void * __ps_216 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1373 = __ps_216;
                (void)k_1373;
                bool __ps_217 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1372, (void *)(intptr_t)(k_1373), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_217) {
                    void * __t218 = iter;
                    void * __t219 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t221;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1376 = __ps_223;
            (void)iter_1376;
            void * __ps_224 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_225 = (hamt_slkeyeq((void *)(intptr_t)(__ps_224)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1377 = __ps_225;
            (void)keyeq_1377;
            void * __ps_226 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_227 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1376), (void *)(intptr_t)(__ps_226), (void *)(intptr_t)(keyeq_1377)));
            if (tur_panicking) return ((bool)0);
            bool result_1378 = __ps_227;
            (void)result_1378;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t248;
        {
            ...
            {
                tur_adt_Vec__int * __ps_250 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1508));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1509 = __ps_250;
                (void)_un_unv_1509;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t254;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1559 = __ps_255;
            (void)r_1559;
            int64_t __t256;
            bool __ps_257 = (schema_hydecode_hyok_qu(r_1559));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_257) {
                int64_t __ps_258 = (schema_hydecode_hyvalue(r_1559));
                if (tur_panicking) return ((int64_t)0);
                __t256 = __ps_258;
            } else {
                int64_t __ps_259 = (schema_hydecode_hyerrors(r_1559));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t262;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1610 = __ps_263;
            (void)m_1610;
            tur_frame __frame_264;
            tur_frame_init(&__frame_264, NULL);
            struct __defer_env_265 __t267 = {.m = m_1610};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_275 = (open_hydevice(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        int64_t __t276 = (int64_t)(intptr_t)(__ps_275);
            tur_adt_Result__Device__int __t277 = (*(tur_adt_Result__Device__int *)(intptr_t)(__t276));
            if (__t276) free((void *)(intptr_t)(__t276));
            tur_adt_Result__Device__int r_1619 = __t277;
            (void)r_1619;
            bool __ps_278 = (ok___spec__bool_tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_278) ? "true" : "false");
            void * __ps_279 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_280 = (device_hytag((void *)(intptr_t)(__ps_279)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_280));
            void * __ps_281 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree((void *)(intptr_t)(__ps_281));
        }
        {
            int64_t __ps_282 = (open_hydevice(INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        int64_t __t283 = (int64_t)(intptr_t)(__ps_282);
            tur_adt_Result__Device__int __t284 = (*(tur_adt_Result__Device__int *)(intptr_t)(__t283));
            if (__t283) free((void *)(intptr_t)(__t283));
            tur_adt_Result__Device__int e_1620 = __t284;
            (void)e_1620;
            bool __ps_285 = (err___spec__bool_tur_adt_Result__Device__int(e_1620));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_285) ? "true" : "false");
            int64_t __ps_286 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1620));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_286));
        }
        {
            int64_t __ps_287 = (classify(INT64_C(21)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        int64_t __t288 = (int64_t)(intptr_t)(__ps_287);
            tur_adt_Result__int__int __t289 = (*(tur_adt_Result__int__int *)(intptr_t)(__t288));
            if (__t288) free((void *)(intptr_t)(__t288));
            tur_adt_Result__int__int c_1621 = __t289;
            (void)c_1621;
            int64_t __ps_290 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1621));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_290));
        }
        {
            int64_t __ps_291 = (classify(INT64_C(-5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        int64_t __t292 = (int64_t)(intptr_t)(__ps_291);
            tur_adt_Result__int__int __t293 = (*(tur_adt_Result__int__int *)(intptr_t)(__t292));
            if (__t292) free((void *)(intptr_t)(__t292));
            tur_adt_Result__int__int c_1622 = __t293;
            (void)c_1622;
            int64_t __ps_294 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1622));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_294));
        }
        {
            int64_t __ps_295 = (maybe_hyopen(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        int64_t __t296 = (int64_t)(intptr_t)(__ps_295);
            tur_adt_Option__Device __t297 = (__t296 ? (*(tur_adt_Option__Device *)(intptr_t)(__t296)) : (tur_adt_Option__Device){0});
            if (__t296) free((void *)(intptr_t)(__t296));
            tur_adt_Option__Device o_1623 = __t297;
            (void)o_1623;
            bool __ps_298 = (some___spec__bool_tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_298) ? "true" : "false");
            void * __ps_299 = (unwrap__spec__void___tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_300 = (device_hytag((void *)(intptr_t)(__ps_299)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_300));
            void * __ps_301 = (unwrap__spec__void___tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree((void *)(intptr_t)(__ps_301));
        }
        int64_t __ps_302 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t303 = (int64_t)(intptr_t)(__ps_302);
        bool __ps_304 = (some___spec__bool_tur_adt_Option__Device((__t303 ? (*(tur_adt_Option__Device *)(intptr_t)(__t303)) : (tur_adt_Option__Device){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_302) tur_region_free((void *)(intptr_t)__ps_302);
        puts((__ps_304) ? "true" : "false");
        int64_t __ps_305 = (maybe_hyint(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t306 = (int64_t)(intptr_t)(__ps_305);
        int64_t __ps_307 = (unwrap__spec__int64_t_tur_adt_Option__int((__t306 ? (*(tur_adt_Option__int *)(intptr_t)(__t306)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_305) tur_region_free((void *)(intptr_t)__ps_305);
        printf("%lld\n", (long long)(__ps_307));
        int64_t __ps_308 = (maybe_hyint(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t309 = (int64_t)(intptr_t)(__ps_308);
        bool __ps_310 = (some___spec__bool_tur_adt_Option__int((__t309 ? (*(tur_adt_Option__int *)(intptr_t)(__t309)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_308) tur_region_free((void *)(intptr_t)__ps_308);
        puts((__ps_310) ? "true" : "false");
        int64_t __t311;
        __t311 = INT64_C(0);
        return (int)__t311;
}
