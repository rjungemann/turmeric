...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t51;
        {
            ...
            if ((t1_1290) == (INT64_C(0))) {
                __t52 = (t2_1291) == (INT64_C(0));
            } else {
                bool __t53;
                if ((t2_1291) == (INT64_C(0))) {
                    __t53 = false;
                } else {
                    bool __ps_54 = (cons_hyeq_hygo(t1_1290, t2_1291));
                    if (tur_panicking) return ((bool)0);
                    __t53 = __ps_54;
                }
                __t52 = __t53;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_97) {
            bool __t98;
            {
                ...
                (void)t2_1286;
                bool __t99;
                bool __ps_100 = (tnil_qu(t1_1285));
                if (tur_panicking) return ((bool)0);
                if (__ps_100) {
                    bool __ps_101 = (tnil_qu(t2_1286));
                    if (tur_panicking) return ((bool)0);
                    __t99 = __ps_101;
                } else {
                    bool __t102;
                    bool __ps_103 = (tnil_qu(t2_1286));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_103) {
                        __t102 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1285, t2_1286));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_104;
                    }
                    __t99 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                int64_t out_1301 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1301;
                __t111 = out_1301;
            }
            __t109 = __t111;
        ...
        if (__ps_116) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1372 = __ps_117;
                (void)h_1372;
                void * __ps_118 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1373 = __ps_118;
                (void)k_1373;
                bool __ps_119 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1372, (void *)(intptr_t)(k_1373), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_119) {
                    void * __t120 = iter;
                    void * __t121 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1376 = __ps_125;
            (void)iter_1376;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1377 = __ps_127;
            (void)keyeq_1377;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1376), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1377)));
            if (tur_panicking) return ((bool)0);
            bool result_1378 = __ps_129;
            (void)result_1378;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1508));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1509 = __ps_152;
                (void)_un_unv_1509;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1559 = __ps_155;
            (void)r_1559;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1559));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                return schema_hydecode_hyvalue(r_1559);
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1559));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1610 = __ps_160;
            (void)m_1610;
            tur_frame __frame_161;
            tur_frame_init(&__frame_161, NULL);
            struct __defer_env_162 __t164 = {.m = m_1610};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1619 = __t174;
            (void)r_1619;
            bool __ps_175 = (ok___spec__bool_tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_175) ? "true" : "false");
            void * __ps_176 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_177 = (device_hytag((void *)(intptr_t)(__ps_176)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            void * __ps_178 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1619));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1620 = __t181;
            (void)e_1620;
            bool __ps_182 = (err___spec__bool_tur_adt_Result__Device__int(e_1620));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_182) ? "true" : "false");
            int64_t __ps_183 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1620));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_183));
        }
        {
            ...
            tur_adt_Result__int__int c_1621 = __t186;
            (void)c_1621;
            int64_t __ps_187 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1621));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_187));
        }
        {
            ...
            tur_adt_Result__int__int c_1622 = __t190;
            (void)c_1622;
            int64_t __ps_191 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1622));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_191));
        }
        {
            ...
            tur_adt_Option__Device o_1623 = __t194;
            (void)o_1623;
            bool __ps_195 = (some___spec__bool_tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_195) ? "true" : "false");
            void * __ps_196 = (unwrap__spec__void___tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_197 = (device_hytag((void *)(intptr_t)(__ps_196)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_197));
            void * __ps_198 = (unwrap__spec__void___tur_adt_Option__Device(o_1623));
            /* panic-return-signal: ret ctype unknown; no propagation here */
