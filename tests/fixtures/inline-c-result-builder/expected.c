...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1285 = (tur_adt_Result__Device__int){.is_ok = __t174->is_ok, .ok_val = (int64_t)(__t174->ok_val), .err_val = __t174->err_val};
            (void)r_1285;
            tur_adt_Result__Device__int __t175 = r_1285;
            __auto_type __ps_176 = (ok_qu((int64_t)(intptr_t)(&__t175)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            __auto_type __ps_177 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_178 = (device_hytag(__ps_177));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_178));
            __auto_type __ps_179 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1286 = (tur_adt_Result__Device__int){.is_ok = __t181->is_ok, .ok_val = (int64_t)(__t181->ok_val), .err_val = __t181->err_val};
            (void)e_1286;
            tur_adt_Result__Device__int __t182 = e_1286;
            __auto_type __ps_183 = (err_qu((int64_t)(intptr_t)(&__t182)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_183) ? "true" : "false");
            __auto_type __ps_184 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1286));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_184));
        }
        {
            ...
            tur_adt_Result__int__int c_1287 = (tur_adt_Result__int__int){.is_ok = __t186->is_ok, .ok_val = __t186->ok_val, .err_val = __t186->err_val};
            (void)c_1287;
            __auto_type __ps_187 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1287));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_187));
        }
        {
            ...
            tur_adt_Result__int__int c_1288 = (tur_adt_Result__int__int){.is_ok = __t189->is_ok, .ok_val = __t189->ok_val, .err_val = __t189->err_val};
            (void)c_1288;
            __auto_type __ps_190 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1288));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_190));
        }
        {
            ...
            tur_adt_Option__Device o_1289 = (__t192 ? (tur_adt_Option__Device){.is_some = __t192->is_some, .value = (int64_t)(__t192->value)} : (tur_adt_Option__Device){0});
            (void)o_1289;
            __auto_type __ps_193 = (some___spec__bool_tur_adt_Option__Device(o_1289));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_193) ? "true" : "false");
            __auto_type __ps_194 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1289));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_195 = (device_hytag(__ps_194));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_195));
            __auto_type __ps_196 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1289));
            /* panic-return-signal: ret ctype unknown; no propagation here */
