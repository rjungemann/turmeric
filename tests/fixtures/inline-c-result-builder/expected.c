...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_67) {
            bool __t68;
            {
                ...
                (void)k_748;
                bool __t71;
                __auto_type __ps_72 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_747, (void *)(intptr_t)(k_748), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_72) {
                    bool __t73;
                    __auto_type __ps_74 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_75 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_747, (void *)(intptr_t)(k_748), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t78;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_752 = __ps_80;
            (void)iter_752;
            __auto_type __ps_81 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_82 = (hamt_slkeyeq((void *)(intptr_t)(__ps_81)));
            if (tur_panicking) return (bool){0};
            void * keyeq_753 = __ps_82;
            (void)keyeq_753;
            __auto_type __ps_83 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_84 = (map_hyeq_hyloop((void *)(intptr_t)(iter_752), (void *)(intptr_t)(__ps_83), (void *)(intptr_t)(keyeq_753), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_754 = __ps_84;
            (void)result_754;
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1288 = (tur_adt_Result__Device__int){.is_ok = __t174->is_ok, .ok_val = (int64_t)(__t174->ok_val), .err_val = __t174->err_val};
            (void)r_1288;
            tur_adt_Result__Device__int __t175 = r_1288;
            __auto_type __ps_176 = (ok_qu((int64_t)(intptr_t)(&__t175)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            __auto_type __ps_177 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1288));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_178 = (device_hytag(__ps_177));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_178));
            __auto_type __ps_179 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1288));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1289 = (tur_adt_Result__Device__int){.is_ok = __t181->is_ok, .ok_val = (int64_t)(__t181->ok_val), .err_val = __t181->err_val};
            (void)e_1289;
            tur_adt_Result__Device__int __t182 = e_1289;
            __auto_type __ps_183 = (err_qu((int64_t)(intptr_t)(&__t182)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_183) ? "true" : "false");
            __auto_type __ps_184 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1289));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_184));
        }
        {
            ...
            tur_adt_Result__int__int c_1290 = (tur_adt_Result__int__int){.is_ok = __t186->is_ok, .ok_val = __t186->ok_val, .err_val = __t186->err_val};
            (void)c_1290;
            __auto_type __ps_187 = (ok_val__spec__int64_t_tur_adt_Result__int__int(c_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_187));
        }
        {
            ...
            tur_adt_Result__int__int c_1291 = (tur_adt_Result__int__int){.is_ok = __t189->is_ok, .ok_val = __t189->ok_val, .err_val = __t189->err_val};
            (void)c_1291;
            __auto_type __ps_190 = (err_val__spec__int64_t_tur_adt_Result__int__int(c_1291));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_190));
        }
        {
            ...
            tur_adt_Option__Device o_1292 = (__t192 ? (tur_adt_Option__Device){.is_some = __t192->is_some, .value = (int64_t)(__t192->value)} : (tur_adt_Option__Device){0});
            (void)o_1292;
            __auto_type __ps_193 = (some___spec__bool_tur_adt_Option__Device(o_1292));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_193) ? "true" : "false");
            __auto_type __ps_194 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1292));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_195 = (device_hytag(__ps_194));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_195));
            __auto_type __ps_196 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1292));
            /* panic-return-signal: ret ctype unknown; no propagation here */
