...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_206 = (const char *)__effect_args[0];
    int64_t k_207 = __k;
    puts(msg_206);
    int64_t __t3;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_207, (int64_t)INT64_C(0));
    __t3 = __t4;
    return (int64_t)__t3;
}
...
static void __handle_body_1(void) {
    greet("hello");
    {
        int64_t v_205 = run_twice(INT64_C(5));
        (void)v_205;
        printf("%lld\n", (long long)(v_205));
    }
