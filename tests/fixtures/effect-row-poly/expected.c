...
static void greet(const char *);
static int64_t run_twice(int64_t);
static int64_t scale(int64_t);
...
static int64_t run_twice(int64_t x) {
        return ((x) + (x));
}

static int64_t scale(int64_t n) {
        return ((n) * (INT64_C(2)));
}

static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_31 = (const char *)__effect_args[0];
    int64_t k_32 = __k;
    puts(msg_31);
    int64_t __t2;
...
int main() {
        ...
        __eff_frame_3.cases[0].handler_fn = __effect_handler_1;
        __eff_frame_3.cases[0].env = NULL;
        *__eff_chain_3 = &__eff_frame_3;
        greet("hello");
        {
            int64_t v_30 = run_twice(INT64_C(5));
            (void)v_30;
            printf("%lld\n", (long long)(v_30));
        }
