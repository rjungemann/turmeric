...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_626 = (const char *)__effect_args[0];
    int64_t k_627 = __k;
    puts(msg_626);
    int64_t __t3;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_627, (int64_t)INT64_C(0));
    __t3 = __t4;
    return (int64_t)__t3;
}
...
static void __handle_body_1(void) {
    greet("hello");
    {
        int64_t v_625 = run_twice(INT64_C(5));
        (void)v_625;
        printf("%lld\n", (long long)(v_625));
    }
...
int main() {
        ...
        int64_t __t6 = (int64_t)__dispatch_1(&__cap_1, (int64_t)(intptr_t)__fiber_1, 0);
