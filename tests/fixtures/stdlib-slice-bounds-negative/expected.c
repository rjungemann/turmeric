...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t48;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1225)) {
                __t49 = schema_hydecode_hyvalue(r_1225);
            } else {
                __t49 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1225));
            }
            __t48 = __t49;
        }
        return __t48;
...
int main(int argc, char **argv) {
        ...
        int64_t __t50;
        {
            void * p_1250 = make_hybuf();
            (void)p_1250;
            int64_t __t51;
            {
                void * s_1251 = ls_hynew((void *)(intptr_t)(p_1250), INT64_C(1));
                (void)s_1251;
                printf("%lld\n", (long long)(ls_hyget((void *)(intptr_t)(s_1251), INT64_C(2))));
                int64_t __t52;
                __t52 = INT64_C(0);
                __t51 = __t52;
            }
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t53 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t53 = (Cons__int){.head = h, .tail = t};
        return __t53;
}
