...
static void * ls_hynew(void *, int64_t);
static int64_t ls_hyget(void *, int64_t);
static void * make_hybuf();
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_194) {
            bool __t195;
            {
                ...
                (void)t2_1282;
                bool __t196;
                bool __ps_197 = (tnil_qu(t1_1281));
                if (tur_panicking) return ((bool)0);
                if (__ps_197) {
                    bool __ps_198 = (tnil_qu(t2_1282));
                    if (tur_panicking) return ((bool)0);
                    __t196 = __ps_198;
                } else {
                    bool __t199;
                    bool __ps_200 = (tnil_qu(t2_1282));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_200) {
                        __t199 = false;
                    } else {
                        bool __ps_201 = (cons_hyeq_hygo(t1_1281, t2_1282));
                        if (tur_panicking) return ((bool)0);
                        __t199 = __ps_201;
                    }
                    __t196 = __t199;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_207) {
            ...
            int64_t __t208;
            {
                ...
                int64_t out_1297 = (int64_t)(intptr_t)(__ps_212);
                (void)out_1297;
                __t208 = out_1297;
            }
            __t206 = __t208;
...
static void * ls_hynew(void * data, int64_t length) {
        struct { int64_t *p; size_t len; } *s = malloc(sizeof(*s));
  s->p = (int64_t*)data;
  s->len = (size_t)length;
  return s;
...
static int64_t ls_hyget(void * s, int64_t i) {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t277;
        {
            void * __ps_278 = (make_hybuf());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1613 = __ps_278;
            (void)p_1613;
            int64_t __t279;
            {
                void * __ps_280 = (ls_hynew((void *)(intptr_t)(p_1613), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1614 = __ps_280;
                (void)s_1614;
                int64_t __ps_281 = (ls_hyget((void *)(intptr_t)(s_1614), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_281));
                int64_t __t282;
                __t282 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_283 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_284 = (vec_new__spec__tur_adt_Vec__int__());
