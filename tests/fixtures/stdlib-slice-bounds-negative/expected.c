...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            ...
            int64_t yi_605 = y;
            (void)yi_605;
            int64_t lx_606 = vec_hylen(xi_604);
            (void)lx_606;
            int64_t ly_607 = vec_hylen(yi_605);
            (void)ly_607;
            bool __t5;
            if ((lx_606) == (ly_607)) {
                int64_t *__t6 = (int64_t *)malloc(2 * sizeof(int64_t));
                __t6[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
                __t6[1] = (int64_t)(intptr_t)__fn_610;
                void *__t7 = __t6;
                __t5 = vec_hyeq_hyloop(xi_604, yi_605, INT64_C(0), lx_606, (int64_t)(intptr_t)(__t7));
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_790 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_790;
                int64_t t2_791 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_791;
                if ((t1_790) == (INT64_C(0))) {
                    return (t2_791) == (INT64_C(0));
                } else {
                    if ((t2_791) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t14 = (*(int64_t *)(intptr_t)(t1_790));
                        int64_t __t15 = (*(int64_t *)(intptr_t)(t2_791));
                        x = __t14;
                        y = __t15;
                        goto __tur_tailcall;
                    }
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t16[1] = (int64_t)(intptr_t)__fn_869;
        void *__t17 = __t16;
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            void * p_875 = make_hybuf();
            (void)p_875;
            int64_t __t26;
            {
                void * s_876 = ls_hynew((void *)(intptr_t)(p_875), INT64_C(1));
                (void)s_876;
                printf("%lld\n", (long long)(ls_hyget((void *)(intptr_t)(s_876), INT64_C(2))));
                int64_t __t27;
                __t27 = INT64_C(0);
                __t26 = __t27;
            }
