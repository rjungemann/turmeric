...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_102) {
            bool __t103;
            {
                ...
                bool __t104;
                if ((t1_991) == (INT64_C(0))) {
                    __t104 = (t2_992) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_992) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        __auto_type __ps_106 = (cons_hyeq_hygo(t1_991, t2_992));
                        if (tur_panicking) return (bool){0};
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1000 = (int64_t)(intptr_t)(__ps_114);
                (void)out_1000;
                __t109 = out_1000;
            }
            __t107 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1007 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1007;
                __t117 = out_1007;
            }
            __t115 = __t117;
        ...
        if (__ps_126) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1078 = __ps_127;
                (void)h_1078;
                __auto_type __ps_128 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1079 = __ps_128;
                (void)k_1079;
                __auto_type __ps_129 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1078, (void *)(intptr_t)(k_1079), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_129) {
                    void * __t130 = iter;
                    void * __t131 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t133;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1082 = __ps_135;
            (void)iter_1082;
            __auto_type __ps_136 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_137 = (hamt_slkeyeq((void *)(intptr_t)(__ps_136)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1083 = __ps_137;
            (void)keyeq_1083;
            __auto_type __ps_138 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_139 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1082), (void *)(intptr_t)(__ps_138), (void *)(intptr_t)(keyeq_1083)));
            if (tur_panicking) return (bool){0};
            bool result_1084 = __ps_139;
            (void)result_1084;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t160;
        {
            ...
            {
                __auto_type __ps_162 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1211));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1212 = __ps_162;
                (void)_un_unv_1212;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t165;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1261 = __ps_166;
            (void)r_1261;
            int64_t __t167;
            __auto_type __ps_168 = (schema_hydecode_hyok_qu(r_1261));
            if (tur_panicking) return (int64_t){0};
            if (__ps_168) {
                __auto_type __ps_169 = (schema_hydecode_hyvalue(r_1261));
                if (tur_panicking) return (int64_t){0};
                __t167 = __ps_169;
            } else {
                __auto_type __ps_170 = (schema_hydecode_hyerrors(r_1261));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            __auto_type __ps_174 = (make_hybuf());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1286 = __ps_174;
            (void)p_1286;
            int64_t __t175;
            {
                __auto_type __ps_176 = (ls_hynew((void *)(intptr_t)(p_1286), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1287 = __ps_176;
                (void)s_1287;
                __auto_type __ps_177 = (ls_hyget((void *)(intptr_t)(s_1287), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_177));
                int64_t __t178;
                __t178 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_179 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_180 = (vec_new__spec__tur_adt_Vec__int__());
