...
static bool __fn_859(int64_t, int64_t);
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            bool __t13;
            {
                int64_t t1_780 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_780;
                int64_t t2_781 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_781;
                bool __t14;
                if ((t1_780) == (INT64_C(0))) {
                    __t14 = (t2_781) == (INT64_C(0));
                } else {
                    bool __t15;
                    if ((t2_781) == (INT64_C(0))) {
                        __t15 = false;
                    } else {
                        __t15 = __inst_Eq_eq_qu_Cons(t1_780, t2_781);
                    }
                    __t14 = __t15;
                }
                __t13 = __t14;
...
static bool __fn_859(int64_t a, int64_t b) {
        return (a) == (b);
}
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t16[1] = (int64_t)(intptr_t)__fn_859;
        void *__t17 = __t16;
...
int main(int argc, char **argv) {
        ...
        int64_t __t23;
        {
            void * p_865 = make_hybuf();
            (void)p_865;
            int64_t __t24;
            {
                void * s_866 = ls_hynew((void *)(intptr_t)(p_865), INT64_C(1));
                (void)s_866;
                printf("%lld\n", (long long)(ls_hyget((void *)(intptr_t)(s_866), INT64_C(2))));
                int64_t __t25;
                __t25 = INT64_C(0);
                __t24 = __t25;
            }
