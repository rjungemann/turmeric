        ...
        if (__ps_154) {
            bool __t155;
            {
                ...
                if ((t1_1128) == (INT64_C(0))) {
                    __t156 = (t2_1129) == (INT64_C(0));
                } else {
                    bool __t157;
                    if ((t2_1129) == (INT64_C(0))) {
                        __t157 = false;
                    } else {
                        bool __ps_158 = (cons_hyeq_hygo(t1_1128, t2_1129));
                        if (tur_panicking) return ((bool)0);
                        __t157 = __ps_158;
                    }
                    __t156 = __t157;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_164) {
            ...
            int64_t __t165;
            {
                ...
                int64_t out_1144 = (int64_t)(intptr_t)(__ps_169);
                (void)out_1144;
                __t165 = out_1144;
            }
            __t163 = __t165;
        ...
        if (__ps_174) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1215 = __ps_175;
                (void)h_1215;
                void * __ps_176 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1216 = __ps_176;
                (void)k_1216;
                bool __ps_177 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1215, (void *)(intptr_t)(k_1216), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_177) {
                    void * __t178 = iter;
                    void * __t179 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t181;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1219 = __ps_183;
            (void)iter_1219;
            void * __ps_184 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_185 = (hamt_slkeyeq((void *)(intptr_t)(__ps_184)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1220 = __ps_185;
            (void)keyeq_1220;
            void * __ps_186 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_187 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1219), (void *)(intptr_t)(__ps_186), (void *)(intptr_t)(keyeq_1220)));
            if (tur_panicking) return ((bool)0);
            bool result_1221 = __ps_187;
            (void)result_1221;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t208;
        {
            ...
            {
                tur_adt_Vec__int * __ps_210 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1351));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1352 = __ps_210;
                (void)_un_unv_1352;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t214;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1402 = __ps_215;
            (void)r_1402;
            int64_t __t216;
            bool __ps_217 = (schema_hydecode_hyok_qu(r_1402));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_217) {
                int64_t __ps_218 = (schema_hydecode_hyvalue(r_1402));
                if (tur_panicking) return ((int64_t)0);
                __t216 = __ps_218;
            } else {
                int64_t __ps_219 = (schema_hydecode_hyerrors(r_1402));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t232;
        {
            void * __ps_233 = (make_hybuf());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1470 = __ps_233;
            (void)p_1470;
            int64_t __t234;
            {
                void * __ps_235 = (ls_hynew((void *)(intptr_t)(p_1470), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1471 = __ps_235;
                (void)s_1471;
                int64_t __ps_236 = (ls_hyget((void *)(intptr_t)(s_1471), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_236));
                int64_t __t237;
                __t237 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_238 = (ctor_Cons_Cons__int(h, t));
