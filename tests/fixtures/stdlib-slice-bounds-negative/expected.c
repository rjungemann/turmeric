...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__inst_Eq_eq_qu_int((int64_t)((tur_adt_Cons *)(intptr_t)(c1))->head, (int64_t)((tur_adt_Cons *)(intptr_t)(c2))->head)) {
            bool __t32;
            {
                ...
                bool __t33;
                if ((t1_982) == (INT64_C(0))) {
                    __t33 = (t2_983) == (INT64_C(0));
                } else {
                    bool __t34;
                    if ((t2_983) == (INT64_C(0))) {
                        __t34 = false;
                    } else {
                        __t34 = cons_hyeq_hygo(t1_982, t2_983);
                    }
                    __t33 = __t34;
                }
                __t32 = __t33;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t53;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1246)) {
                __t54 = schema_hydecode_hyvalue(r_1246);
            } else {
                __t54 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1246));
            }
            __t53 = __t54;
        }
        return __t53;
...
int main(int argc, char **argv) {
        ...
        int64_t __t55;
        {
            void * p_1271 = make_hybuf();
            (void)p_1271;
            int64_t __t56;
            {
                void * s_1272 = ls_hynew((void *)(intptr_t)(p_1271), INT64_C(1));
                (void)s_1272;
                printf("%lld\n", (long long)(ls_hyget((void *)(intptr_t)(s_1272), INT64_C(2))));
                int64_t __t57;
                __t57 = INT64_C(0);
                __t56 = __t57;
            }
