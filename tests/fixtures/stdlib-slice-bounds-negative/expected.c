        ...
        if (__ps_133) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1063 = __ps_134;
                (void)h_1063;
                __auto_type __ps_135 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1064 = __ps_135;
                (void)k_1064;
                __auto_type __ps_136 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1063, (void *)(intptr_t)(k_1064), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_136) {
                    void * __t137 = iter;
                    void * __t138 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t140;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1067 = __ps_142;
            (void)iter_1067;
            __auto_type __ps_143 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_144 = (hamt_slkeyeq((void *)(intptr_t)(__ps_143)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1068 = __ps_144;
            (void)keyeq_1068;
            __auto_type __ps_145 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_146 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1067), (void *)(intptr_t)(__ps_145), (void *)(intptr_t)(keyeq_1068)));
            if (tur_panicking) return (bool){0};
            bool result_1069 = __ps_146;
            (void)result_1069;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t173;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1246 = __ps_174;
            (void)r_1246;
            int64_t __t175;
            __auto_type __ps_176 = (schema_hydecode_hyok_qu(r_1246));
            if (tur_panicking) return (int64_t){0};
            if (__ps_176) {
                __auto_type __ps_177 = (schema_hydecode_hyvalue(r_1246));
                if (tur_panicking) return (int64_t){0};
                __t175 = __ps_177;
            } else {
                __auto_type __ps_178 = (schema_hydecode_hyerrors(r_1246));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        int64_t __t181;
        {
            ...
            void * p_1271 = __ps_182;
            (void)p_1271;
            int64_t __t183;
            {
                __auto_type __ps_184 = (ls_hynew((void *)(intptr_t)(p_1271), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1272 = __ps_184;
                (void)s_1272;
                __auto_type __ps_185 = (ls_hyget((void *)(intptr_t)(s_1272), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_185));
                int64_t __t186;
                __t186 = INT64_C(0);
