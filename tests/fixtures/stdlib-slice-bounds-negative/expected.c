...
int main(int argc, char **argv) {
        ...
        int64_t __t173;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1279 = __ps_174;
            (void)p_1279;
            int64_t __t175;
            {
                __auto_type __ps_176 = (ls_hynew((void *)(intptr_t)(p_1279), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1280 = __ps_176;
                (void)s_1280;
                __auto_type __ps_177 = (ls_hyget((void *)(intptr_t)(s_1280), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_177));
                int64_t __t178;
                __t178 = INT64_C(0);
