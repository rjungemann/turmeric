...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            int64_t lx_618 = vec_hylen_hybyval(x);
            (void)lx_618;
            int64_t ly_619 = vec_hylen_hybyval(y);
            (void)ly_619;
            bool __t5;
            if ((lx_618) == (ly_619)) {
                __t5 = vec_hyeq_hyloop_hybyval(x, y, INT64_C(0), lx_618);
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(x))->head, ((Cons *)(intptr_t)(y))->head)) {
            {
                int64_t t1_798 = ((Cons *)(intptr_t)(x))->tail;
                (void)t1_798;
                int64_t t2_799 = ((Cons *)(intptr_t)(y))->tail;
                (void)t2_799;
                if ((t1_798) == (INT64_C(0))) {
                    return (t2_799) == (INT64_C(0));
                } else {
                    if ((t2_799) == (INT64_C(0))) {
                        return false;
                    } else {
                        int64_t __t12 = (*(int64_t *)(intptr_t)(t1_798));
                        int64_t __t13 = (*(int64_t *)(intptr_t)(t2_799));
                        x = __t12;
                        y = __t13;
                        goto __tur_tailcall;
                    }
...
int main(int argc, char **argv) {
        ...
        int64_t __t23;
        {
            void * p_890 = make_hybuf();
            (void)p_890;
            int64_t __t24;
            {
                void * s_891 = ls_hynew((void *)(intptr_t)(p_890), INT64_C(1));
                (void)s_891;
                printf("%lld\n", (long long)(ls_hyget((void *)(intptr_t)(s_891), INT64_C(2))));
                int64_t __t25;
                __t25 = INT64_C(0);
                __t24 = __t25;
            }
