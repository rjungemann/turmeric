...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t12[1] = (int64_t)(intptr_t)__fn_782;
        void *__t13 = __t12;
...
int main(int argc, char **argv) {
        ...
        int64_t __t21;
        {
            void * p_867 = make_hybuf();
            (void)p_867;
            int64_t __t22;
            {
                void * s_868 = ls_hynew((void *)(intptr_t)(p_867), INT64_C(1));
                (void)s_868;
                printf("%lld\n", (long long)(ls_hyget((void *)(intptr_t)(s_868), INT64_C(2))));
                int64_t __t23;
                __t23 = INT64_C(0);
                __t22 = __t23;
            }
