...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t12[1] = (int64_t)(intptr_t)__fn_806;
        void *__t13 = __t12;
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            void * p_898 = make_hybuf();
            (void)p_898;
            int64_t __t26;
            {
                void * s_899 = ls_hynew((void *)(intptr_t)(p_898), INT64_C(1));
                (void)s_899;
                printf("%lld\n", (long long)(ls_hyget((void *)(intptr_t)(s_899), INT64_C(2))));
                int64_t __t27;
                __t27 = INT64_C(0);
                __t26 = __t27;
            }
