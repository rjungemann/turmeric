...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_93) {
            bool __t94;
            {
                ...
                bool __t95;
                if ((t1_991) == (INT64_C(0))) {
                    __t95 = (t2_992) == (INT64_C(0));
                } else {
                    bool __t96;
                    if ((t2_992) == (INT64_C(0))) {
                        __t96 = false;
                    } else {
                        __auto_type __ps_97 = (cons_hyeq_hygo(t1_991, t2_992));
                        if (tur_panicking) return (bool){0};
                        __t96 = __ps_97;
                    }
                    __t95 = __t96;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_103) {
            ...
            int64_t __t104;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1007 = (int64_t)(intptr_t)(__ps_108);
                (void)out_1007;
                __t104 = out_1007;
            }
            __t102 = __t104;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t113;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1082 = __ps_115;
            (void)iter_1082;
            __auto_type __ps_116 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_117 = (hamt_slkeyeq((void *)(intptr_t)(__ps_116)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1083 = __ps_117;
            (void)keyeq_1083;
            __auto_type __ps_118 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_119 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1082), (void *)(intptr_t)(__ps_118), (void *)(intptr_t)(keyeq_1083)));
            if (tur_panicking) return (bool){0};
            bool result_1084 = __ps_119;
            (void)result_1084;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t140;
        {
            ...
            {
                __auto_type __ps_142 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1211));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1212 = __ps_142;
                (void)_un_unv_1212;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t145;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1261 = __ps_146;
            (void)r_1261;
            int64_t __t147;
            __auto_type __ps_148 = (schema_hydecode_hyok_qu(r_1261));
            if (tur_panicking) return (int64_t){0};
            if (__ps_148) {
                __auto_type __ps_149 = (schema_hydecode_hyvalue(r_1261));
                if (tur_panicking) return (int64_t){0};
                __t147 = __ps_149;
            } else {
                __auto_type __ps_150 = (schema_hydecode_hyerrors(r_1261));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t153;
        {
            __auto_type __ps_154 = (make_hybuf());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1286 = __ps_154;
            (void)p_1286;
            int64_t __t155;
            {
                __auto_type __ps_156 = (ls_hynew((void *)(intptr_t)(p_1286), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1287 = __ps_156;
                (void)s_1287;
                __auto_type __ps_157 = (ls_hyget((void *)(intptr_t)(s_1287), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_157));
                int64_t __t158;
                __t158 = INT64_C(0);
