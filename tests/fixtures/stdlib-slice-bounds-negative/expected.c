        ...
        if (__ps_186) {
            bool __t187;
            {
                ...
                if ((t1_1140) == (INT64_C(0))) {
                    __t188 = (t2_1141) == (INT64_C(0));
                } else {
                    bool __t189;
                    if ((t2_1141) == (INT64_C(0))) {
                        __t189 = false;
                    } else {
                        bool __ps_190 = (cons_hyeq_hygo(t1_1140, t2_1141));
                        if (tur_panicking) return ((bool)0);
                        __t189 = __ps_190;
                    }
                    __t188 = __t189;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_196) {
            ...
            int64_t __t197;
            {
                ...
                int64_t out_1156 = (int64_t)(intptr_t)(__ps_201);
                (void)out_1156;
                __t197 = out_1156;
            }
            __t195 = __t197;
        ...
        if (__ps_206) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1227 = __ps_207;
                (void)h_1227;
                void * __ps_208 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1228 = __ps_208;
                (void)k_1228;
                bool __ps_209 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1227, (void *)(intptr_t)(k_1228), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_209) {
                    void * __t210 = iter;
                    void * __t211 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t213;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1231 = __ps_215;
            (void)iter_1231;
            void * __ps_216 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_217 = (hamt_slkeyeq((void *)(intptr_t)(__ps_216)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1232 = __ps_217;
            (void)keyeq_1232;
            void * __ps_218 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_219 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1231), (void *)(intptr_t)(__ps_218), (void *)(intptr_t)(keyeq_1232)));
            if (tur_panicking) return ((bool)0);
            bool result_1233 = __ps_219;
            (void)result_1233;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t240;
        {
            ...
            {
                tur_adt_Vec__int * __ps_242 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1363));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1364 = __ps_242;
                (void)_un_unv_1364;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t246;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1414 = __ps_247;
            (void)r_1414;
            int64_t __t248;
            bool __ps_249 = (schema_hydecode_hyok_qu(r_1414));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_249) {
                int64_t __ps_250 = (schema_hydecode_hyvalue(r_1414));
                if (tur_panicking) return ((int64_t)0);
                __t248 = __ps_250;
            } else {
                int64_t __ps_251 = (schema_hydecode_hyerrors(r_1414));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t254;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1465 = __ps_255;
            (void)m_1465;
            tur_frame __frame_256;
            tur_frame_init(&__frame_256, NULL);
            struct __defer_env_257 __t259 = {.m = m_1465};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t267;
        {
            void * __ps_268 = (make_hybuf());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1472 = __ps_268;
            (void)p_1472;
            int64_t __t269;
            {
                void * __ps_270 = (ls_hynew((void *)(intptr_t)(p_1472), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1473 = __ps_270;
                (void)s_1473;
                int64_t __ps_271 = (ls_hyget((void *)(intptr_t)(s_1473), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_271));
                int64_t __t272;
                __t272 = INT64_C(0);
