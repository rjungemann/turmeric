...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t12[1] = (int64_t)(intptr_t)__fn_800;
        void *__t13 = __t12;
...
int main(int argc, char **argv) {
        ...
        int64_t __t23;
        {
            void * p_892 = make_hybuf();
            (void)p_892;
            int64_t __t24;
            {
                void * s_893 = ls_hynew((void *)(intptr_t)(p_892), INT64_C(1));
                (void)s_893;
                printf("%lld\n", (long long)(ls_hyget((void *)(intptr_t)(s_893), INT64_C(2))));
                int64_t __t25;
                __t25 = INT64_C(0);
                __t24 = __t25;
            }
