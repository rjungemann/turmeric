...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t156;
        {
            ...
            {
                tur_adt_Vec__int * __ps_158 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1324));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1325 = __ps_158;
                (void)_un_unv_1325;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t162;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1375 = __ps_163;
            (void)r_1375;
            int64_t __t164;
            bool __ps_165 = (schema_hydecode_hyok_qu(r_1375));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_165) {
                int64_t __ps_166 = (schema_hydecode_hyvalue(r_1375));
                if (tur_panicking) return ((int64_t)0);
                __t164 = __ps_166;
            } else {
                int64_t __ps_167 = (schema_hydecode_hyerrors(r_1375));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t180;
        {
            void * __ps_181 = (make_hybuf());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1443 = __ps_181;
            (void)p_1443;
            int64_t __t182;
            {
                void * __ps_183 = (ls_hynew((void *)(intptr_t)(p_1443), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1444 = __ps_183;
                (void)s_1444;
                int64_t __ps_184 = (ls_hyget((void *)(intptr_t)(s_1444), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_184));
                int64_t __t185;
                __t185 = INT64_C(0);
