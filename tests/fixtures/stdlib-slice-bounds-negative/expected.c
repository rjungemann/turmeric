...
static void * ls_new(void *, int64_t);
static int64_t ls_get(void *, int64_t);
...
static void * ls_new(void * data, int64_t length) {
        struct { int64_t *p; size_t len; } *s = malloc(sizeof(*s));
  s->p = (int64_t*)data;
  s->len = (size_t)length;
  return s;
...
static int64_t ls_get(void * s, int64_t i) {
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            ...
            int64_t __t26;
            {
                void * s_896 = ls_new((void *)(intptr_t)(p_895), INT64_C(1));
                (void)s_896;
                printf("%lld\n", (long long)(ls_get((void *)(intptr_t)(s_896), INT64_C(2))));
                int64_t __t27;
                __t27 = INT64_C(0);
                __t26 = __t27;
            }
