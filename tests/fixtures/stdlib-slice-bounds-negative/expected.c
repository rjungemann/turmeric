...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t155;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1286 = __ps_156;
            (void)p_1286;
            int64_t __t157;
            {
                __auto_type __ps_158 = (ls_hynew((void *)(intptr_t)(p_1286), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1287 = __ps_158;
                (void)s_1287;
                __auto_type __ps_159 = (ls_hyget((void *)(intptr_t)(s_1287), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_159));
                int64_t __t160;
                __t160 = INT64_C(0);
