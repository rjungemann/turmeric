        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                if ((t1_1101) == (INT64_C(0))) {
                    __t100 = (t2_1102) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_1102) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        bool __ps_102 = (cons_hyeq_hygo(t1_1101, t2_1102));
                        if (tur_panicking) return ((bool)0);
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1117 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1117;
                __t109 = out_1117;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_120;
            (void)iter_1192;
            void * __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_122;
            (void)keyeq_1193;
            void * __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_124;
            (void)result_1194;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                tur_adt_Vec__int * __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1321));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1322 = __ps_147;
                (void)_un_unv_1322;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1372 = __ps_152;
            (void)r_1372;
            int64_t __t153;
            bool __ps_154 = (schema_hydecode_hyok_qu(r_1372));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_154) {
                int64_t __ps_155 = (schema_hydecode_hyvalue(r_1372));
                if (tur_panicking) return ((int64_t)0);
                __t153 = __ps_155;
            } else {
                int64_t __ps_156 = (schema_hydecode_hyerrors(r_1372));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t168;
        {
            void * __ps_169 = (make_hybuf());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * p_1439 = __ps_169;
            (void)p_1439;
            int64_t __t170;
            {
                void * __ps_171 = (ls_hynew((void *)(intptr_t)(p_1439), INT64_C(1)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * s_1440 = __ps_171;
                (void)s_1440;
                int64_t __ps_172 = (ls_hyget((void *)(intptr_t)(s_1440), INT64_C(2)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_172));
                int64_t __t173;
                __t173 = INT64_C(0);
