...
int main() {
        puts((__inst_MyEq_eq__int(INT64_C(1), INT64_C(1))) ? "true" : "false");
        puts((__inst_MyEq_eq__int(INT64_C(1), INT64_C(2))) ? "true" : "false");
        puts((__inst_MyOrd_lt__int(INT64_C(3), INT64_C(5))) ? "true" : "false");
        puts((__inst_MyOrd_lt__int(INT64_C(7), INT64_C(2))) ? "true" : "false");
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
