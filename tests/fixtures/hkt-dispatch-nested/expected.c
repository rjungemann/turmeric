...
static bool __inst_MyOrd_lt__int(int64_t, int64_t);
...
static bool __inst_MyOrd_lt__int(int64_t x, int64_t y) {
        return ((x) < (y));
}

typedef struct dict_MyOrd_int {
    bool (*lt_)(int64_t, int64_t);
} dict_MyOrd_int;

static dict_MyOrd_int dict_MyOrd_int_singleton = {
    .lt_ = __inst_MyOrd_lt__int,
};
...
int main() {
        puts((((bool (*)(int64_t, int64_t))(intptr_t)(dict_MyEq_int_singleton.eq_))(INT64_C(1), INT64_C(1))) ? "true" : "false");
        puts((((bool (*)(int64_t, int64_t))(intptr_t)(dict_MyEq_int_singleton.eq_))(INT64_C(1), INT64_C(2))) ? "true" : "false");
        puts((((bool (*)(int64_t, int64_t))(intptr_t)(dict_MyOrd_int_singleton.lt_))(INT64_C(3), INT64_C(5))) ? "true" : "false");
        puts((((bool (*)(int64_t, int64_t))(intptr_t)(dict_MyOrd_int_singleton.lt_))(INT64_C(7), INT64_C(2))) ? "true" : "false");
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
