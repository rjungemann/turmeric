...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_1011 = __ps_68;
        bool __ps_69 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_1010, (void *)(intptr_t)(k_1011), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_69;
        if (__t1) {
            int64_t __ps_70 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_1010, (void *)(intptr_t)(k_1011), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1015 = __ps_75;
            (void)iter_1015;
            void * __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1016 = __ps_77;
            (void)keyeq_1016;
            void * __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1015), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_1016), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1017 = __ps_79;
            (void)result_1017;
...
static int64_t h1(int64_t n) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            tur_adt_Big s_1639 = __ps_172;
            (void)s_1639;
            int64_t __ps_173 = (sum5(&s_1639));
            if (tur_panicking) return ((int64_t)0);
            int64_t k_1640 = __ps_173;
            (void)k_1640;
            return h2(k_1640);
        }
}
