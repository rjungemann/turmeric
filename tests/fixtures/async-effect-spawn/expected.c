...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t __t2;
    {
        void *__t3 = (void *)tur_async_fiber((int64_t(*)(void))(intptr_t)__fn_2);
        void * fut_4 = __t3;
        (void)fut_4;
        int64_t __t4;
        {
            int64_t __t5 = tur_await_future((TurFuture*)(intptr_t)fut_4);
            int64_t val_5 = __t5;
            (void)val_5;
