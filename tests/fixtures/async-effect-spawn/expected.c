...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t __t2;
    {
        void *__t3 = (void *)tur_async_fiber((int64_t(*)(void))(intptr_t)__fn_22);
        void * fut_24 = __t3;
        (void)fut_24;
        int64_t __t4;
        {
            int64_t __t5 = tur_await_future((TurFuture*)(intptr_t)fut_24);
            int64_t val_25 = __t5;
            (void)val_25;
...
int main() {
        int64_t __t0;
        {
            ...
            __eff_frame_6.cases[0].effect_name = "GetValue";
            __eff_frame_6.cases[0].handler_fn = __effect_handler_1;
