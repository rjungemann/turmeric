...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t __t3;
    {
        void *__t4 = (void *)tur_async_fiber((int64_t(*)(void))(intptr_t)__fn_262);
        void * fut_264 = __t4;
        (void)fut_264;
        int64_t __t5;
        {
            int64_t __t6 = tur_await_future((TurFuture*)(intptr_t)fut_264);
            int64_t val_265 = __t6;
            (void)val_265;
            int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_261, (int64_t)val_265);
            __t5 = __t7;
        }
        __t3 = __t5;
    }
...
static void __handle_body_1(void) {
    int64_t __t8 = tur_effect_perform("GetValue", NULL, 0);
...
static int64_t __dispatch_1(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "GetValue") == 0) {
...
int main() {
        int64_t __t0;
        {
            ...
            __eff_frame_1.cases[0].effect_name = "GetValue";
            __eff_frame_1.cases[0].handler_fn = NULL;
            __eff_frame_1.cases[0].env = NULL;
            __fiber_1->effect_handler_chain = &__eff_frame_1;
            int64_t __t9 = (int64_t)__dispatch_1(&__cap_1, (int64_t)(intptr_t)__fiber_1, 0);
