...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t __t3;
    {
        void *__t4 = (void *)tur_async_fiber((int64_t(*)(void))(intptr_t)__fn_197);
        void * fut_199 = __t4;
        (void)fut_199;
        int64_t __t5;
        {
            int64_t __t6 = tur_await_future((TurFuture*)(intptr_t)fut_199);
            int64_t val_200 = __t6;
            (void)val_200;
            int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_196, (int64_t)val_200);
            __t5 = __t7;
        }
        __t3 = __t5;
    }
...
int main() {
        int64_t __t0;
        {
            ...
            int64_t result_201 = __t9;
            (void)result_201;
            printf("%lld\n", (long long)(result_201));
            int64_t __t10;
            __t10 = INT64_C(0);
            __t0 = __t10;
        }
