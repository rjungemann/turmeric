...
struct __env_858 { tur_thunk_int64_t_int64_t_t __fn; int64_t n; };
static int64_t __fn_856(void * __env_p_859, int64_t x) {
        struct __env_858 *__env___env_858 = (struct __env_858 *)__env_p_859;
        return (x) + (__env___env_858->n);
}

static int64_t __fn_863(int64_t g, int64_t x) {
...
static void * make_adder(int64_t n) {
        ...
        __t25->__fn = (tur_thunk_int64_t_int64_t_t)__fn_856;
        __t25->n = n;
        void *__t26 = __t25;
        return __t26;
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t (*run)(int64_t, int64_t) = __fn_863;
            (void)run;
