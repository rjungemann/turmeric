...
static int64_t __fn_887(int64_t, int64_t);
...
struct __env_882 { tur_thunk_int64_t_int64_t_t __fn; int64_t n; };
static int64_t __fn_880(void * __env_p_883, int64_t x) {
        struct __env_882 *__env___env_882 = (struct __env_882 *)__env_p_883;
        return (x) + (__env___env_882->n);
}

static int64_t __fn_887(int64_t g, int64_t x) {
...
int main(int argc, char **argv) {
        ...
        {
            int64_t (*run)(int64_t, int64_t) = __fn_887;
            (void)run;
            printf("%lld\n", (long long)(((int64_t (*)(void *, int64_t))(intptr_t)run)(make_adder(INT64_C(10)), INT64_C(5))));
        }
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
