...
int main() {
        gc_enable();
        {
            ...
            *__t0 = INT64_C(1);
            ...
            __t1->value = __t0;
            RcControlBlock * a_618 = __t1;
            (void)a_618;
            int64_t *__t2 = (int64_t *)malloc(sizeof(int64_t));
            *__t2 = INT64_C(2);
            RcControlBlock *__t3 = rc_cb_alloc(0, 3, NULL);
            __t3->value = __t2;
            RcControlBlock * b_619 = __t3;
            (void)b_619;
            {
                RcControlBlock *__t4 = a_618; rc_weak_increment(a_618);
                RcControlBlock * wa_620 = __t4;
                (void)wa_620;
                RcControlBlock *__t5 = b_619; rc_weak_increment(b_619);
                RcControlBlock * wb_621 = __t5;
                (void)wb_621;
                ...
                gc_force();
                {
                    RcControlBlock *__t6 = rc_upgrade(wa_620);
                    ...
                    void * ua_622 = __t7;
                    (void)ua_622;
                    RcControlBlock *__t8 = rc_upgrade(wb_621);
                    ...
                    (void)ub_623;
                    int64_t __t10;
                    if (some_((void *)(intptr_t)(ua_622))) {
                        __t10 = INT64_C(1);
                    } else {
                        __t10 = INT64_C(0);
                    }
                    int64_t __t11;
                    if (some_((void *)(intptr_t)(ub_623))) {
                        __t11 = INT64_C(1);
                    } else {
                        __t11 = INT64_C(0);
                    }
