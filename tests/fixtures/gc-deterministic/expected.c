...
int main() {
        gc_enable();
        {
            ...
            *__t0 = INT64_C(1);
            ...
            __t1->value = __t0;
            RcControlBlock * a_261 = __t1;
            (void)a_261;
            int64_t *__t2 = (int64_t *)malloc(sizeof(int64_t));
            *__t2 = INT64_C(2);
            RcControlBlock *__t3 = rc_cb_alloc(0, 3, NULL);
            __t3->value = __t2;
            RcControlBlock * b_262 = __t3;
            (void)b_262;
            {
                RcControlBlock *__t4 = a_261; rc_weak_increment(a_261);
                RcControlBlock * wa_263 = __t4;
                (void)wa_263;
                RcControlBlock *__t5 = b_262; rc_weak_increment(b_262);
                RcControlBlock * wb_264 = __t5;
                (void)wb_264;
                rc_strong_decrement(a_261);
                rc_free_queue_drain();
                rc_strong_decrement(b_262);
                rc_free_queue_drain();
                gc_force();
                {
                    RcControlBlock *__t6 = rc_upgrade(wa_263);
                    RcControlBlock * ua_265 = __t6;
                    (void)ua_265;
                    RcControlBlock *__t7 = rc_upgrade(wb_264);
                    RcControlBlock * ub_266 = __t7;
                    (void)ub_266;
                    tur_frame __frame_8;
                    tur_frame_init(&__frame_8, NULL);
                    int64_t __t9 = rc_strong_count(ua_265);
                    int64_t __t10 = rc_strong_count(ub_266);
                    printf("%lld\n", (long long)(((__t9) + (__t10))));
                    struct __defer_env_11 __t13 = {.ua = ua_265};
                    tur_frame_push_defer(&__frame_8, __defer_12, &__t13);
                    struct __defer_env_14 __t16 = {.ub = ub_266};
