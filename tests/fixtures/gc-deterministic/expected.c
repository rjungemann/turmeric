...
int main() {
        gc_enable();
        {
            ...
            *__t0 = INT64_C(1);
            ...
            __t1->value = __t0;
            RcControlBlock * a_196 = __t1;
            (void)a_196;
            int64_t *__t2 = (int64_t *)malloc(sizeof(int64_t));
            *__t2 = INT64_C(2);
            RcControlBlock *__t3 = rc_cb_alloc(0, 3, NULL);
            __t3->value = __t2;
            RcControlBlock * b_197 = __t3;
            (void)b_197;
            {
                RcControlBlock *__t4 = a_196; rc_weak_increment(a_196);
                RcControlBlock * wa_198 = __t4;
                (void)wa_198;
                RcControlBlock *__t5 = b_197; rc_weak_increment(b_197);
                RcControlBlock * wb_199 = __t5;
                (void)wb_199;
                rc_strong_decrement(a_196);
                rc_free_queue_drain();
                rc_strong_decrement(b_197);
                rc_free_queue_drain();
                gc_force();
                {
                    RcControlBlock *__t6 = rc_upgrade(wa_198);
                    RcControlBlock * ua_200 = __t6;
                    (void)ua_200;
                    RcControlBlock *__t7 = rc_upgrade(wb_199);
                    RcControlBlock * ub_201 = __t7;
                    (void)ub_201;
                    tur_frame __frame_8;
                    tur_frame_init(&__frame_8, NULL);
                    int64_t __t9 = rc_strong_count(ua_200);
                    int64_t __t10 = rc_strong_count(ub_201);
                    printf("%lld\n", (long long)(((__t9) + (__t10))));
                    struct __defer_env_11 __t13 = {.ua = ua_200};
                    tur_frame_push_defer(&__frame_8, __defer_12, &__t13);
                    struct __defer_env_14 __t16 = {.ub = ub_201};
