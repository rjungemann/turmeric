...
int main() {
        gc_enable();
        {
            ...
            *__t0 = INT64_C(1);
            ...
            __t1->value = __t0;
            RcControlBlock * a_208 = __t1;
            (void)a_208;
            int64_t *__t2 = (int64_t *)malloc(sizeof(int64_t));
            *__t2 = INT64_C(2);
            RcControlBlock *__t3 = rc_cb_alloc(0, 3, NULL);
            __t3->value = __t2;
            RcControlBlock * b_209 = __t3;
            (void)b_209;
            {
                RcControlBlock *__t4 = a_208; rc_weak_increment(a_208);
                RcControlBlock * wa_210 = __t4;
                (void)wa_210;
                RcControlBlock *__t5 = b_209; rc_weak_increment(b_209);
                RcControlBlock * wb_211 = __t5;
                (void)wb_211;
                rc_strong_decrement(a_208);
                rc_free_queue_drain();
                rc_strong_decrement(b_209);
                rc_free_queue_drain();
                gc_force();
                {
                    RcControlBlock *__t6 = rc_upgrade(wa_210);
                    RcControlBlock * ua_212 = __t6;
                    (void)ua_212;
                    RcControlBlock *__t7 = rc_upgrade(wb_211);
                    RcControlBlock * ub_213 = __t7;
                    (void)ub_213;
                    tur_frame __frame_8;
                    tur_frame_init(&__frame_8, NULL);
                    int64_t __t9 = rc_strong_count(ua_212);
                    int64_t __t10 = rc_strong_count(ub_213);
                    printf("%lld\n", (long long)(((__t9) + (__t10))));
                    struct __defer_env_11 __t13 = {.ua = ua_212};
                    tur_frame_push_defer(&__frame_8, __defer_12, &__t13);
                    struct __defer_env_14 __t16 = {.ub = ub_213};
