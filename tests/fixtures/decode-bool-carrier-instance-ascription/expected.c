...
static bool __fn_1004(int64_t, int64_t);
...
static int64_t __inst_Applicative_ap_Option(int64_t ff, int64_t fa) {
        ...
        if (some___spec__bool_Option__opaque((__t12 ? (Option__opaque){.is_some = __t12->is_some, .value = (void *)(__t12->value)} : (Option__opaque){0}))) {
            ...
            if (some_qu(fa)) {
                int64_t __t14;
                {
                    int64_t _un_uncall_unhead_un733_734 = (int64_t)(intptr_t)(((ff) ? ((Option *)(intptr_t)(ff))->value : 0));
                    (void)_un_uncall_unhead_un733_734;
                    __t14 = ((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(_un_uncall_unhead_un733_734)))[0])((void *)(intptr_t)(_un_uncall_unhead_un733_734), ((fa) ? ((Option *)(intptr_t)(fa))->value : 0));
                }
                __t13 = some(__t14);
            } else {
                __t13 = none();
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t24[1] = (int64_t)(intptr_t)__fn_884;
        void *__t25 = __t24;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t26) {
            ...
            __t27[1] = (int64_t)(intptr_t)__fn_1004;
            void *__t28 = __t27;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_950 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_950;
                void * k_951 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_951;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_950, (void *)(intptr_t)(k_951), (void *)(intptr_t)(keyeq))) {
                    void * __t42 = iter;
                    void * __t43 = s2_hamt;
                    void * __t44 = keyeq;
                    iter = __t42;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t45;
        {
            void * iter_954 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_954;
            void * keyeq_955 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_955;
            bool result_956 = set_hyeq_hyloop((void *)(intptr_t)(iter_954), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_955));
            (void)result_956;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_954));
            bool __t46;
            __t46 = result_956;
            __t45 = __t46;
        }
...
int main(int argc, char **argv) {
        ...
        tur_result_box_t *__t52 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(1)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t52->is_ok, .ok_val = (bool)(__t52->ok_val), .err_val = (const char *)(intptr_t)(__t52->err_val)}));
        tur_result_box_t *__t53 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(0)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t53->is_ok, .ok_val = (bool)(__t53->ok_val), .err_val = (const char *)(intptr_t)(__t53->err_val)}));
        tur_result_box_t *__t54 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_int(INT64_C(5)));
        decode_unbool_uncarrier_untest__show_hyint(ok_val__spec__int64_t_Result__int__cstr((Result__int__cstr){.is_ok = __t54->is_ok, .ok_val = __t54->ok_val, .err_val = (const char *)(intptr_t)(__t54->err_val)}));
        int64_t __t55;
        __t55 = INT64_C(0);
        return (int)__t55;
}
