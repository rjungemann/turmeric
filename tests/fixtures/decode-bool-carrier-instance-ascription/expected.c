...
int main(int argc, char **argv) {
        ...
        tur_result_box_t *__t29 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(1)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t29->is_ok, .ok_val = (bool)(__t29->ok_val), .err_val = (const char *)(intptr_t)(__t29->err_val)}));
        tur_result_box_t *__t30 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(0)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t30->is_ok, .ok_val = (bool)(__t30->ok_val), .err_val = (const char *)(intptr_t)(__t30->err_val)}));
        tur_result_box_t *__t31 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_int(INT64_C(5)));
        decode_unbool_uncarrier_untest__show_hyint(ok_val__spec__int64_t_Result__int__cstr((Result__int__cstr){.is_ok = __t31->is_ok, .ok_val = __t31->ok_val, .err_val = (const char *)(intptr_t)(__t31->err_val)}));
        int64_t __t32;
        __t32 = INT64_C(0);
        return (int)__t32;
}
