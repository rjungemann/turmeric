...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_194) {
            bool __t195;
            {
                ...
                (void)t2_1278;
                bool __t196;
                if ((t1_1277) == (INT64_C(0))) {
                    __t196 = (t2_1278) == (INT64_C(0));
                } else {
                    bool __t197;
                    if ((t2_1278) == (INT64_C(0))) {
                        __t197 = false;
                    } else {
                        bool __ps_198 = (cons_hyeq_hygo(t1_1277, t2_1278));
                        if (tur_panicking) return ((bool)0);
                        __t197 = __ps_198;
                    }
                    __t196 = __t197;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_204) {
            ...
            int64_t __t205;
            {
                ...
                int64_t out_1293 = (int64_t)(intptr_t)(__ps_209);
                (void)out_1293;
                __t205 = out_1293;
            }
            __t203 = __t205;
        ...
        if (__ps_214) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1364 = __ps_215;
                (void)h_1364;
                void * __ps_216 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1365 = __ps_216;
                (void)k_1365;
                bool __ps_217 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1364, (void *)(intptr_t)(k_1365), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_217) {
                    void * __t218 = iter;
                    void * __t219 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t221;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1368 = __ps_223;
            (void)iter_1368;
            void * __ps_224 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_225 = (hamt_slkeyeq((void *)(intptr_t)(__ps_224)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1369 = __ps_225;
            (void)keyeq_1369;
            void * __ps_226 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_227 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1368), (void *)(intptr_t)(__ps_226), (void *)(intptr_t)(keyeq_1369)));
            if (tur_panicking) return ((bool)0);
            bool result_1370 = __ps_227;
            (void)result_1370;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t248;
        {
            ...
            {
                tur_adt_Vec__int * __ps_250 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1500));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1501 = __ps_250;
                (void)_un_unv_1501;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t254;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1551 = __ps_255;
            (void)r_1551;
            int64_t __t256;
            bool __ps_257 = (schema_hydecode_hyok_qu(r_1551));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_257) {
                int64_t __ps_258 = (schema_hydecode_hyvalue(r_1551));
                if (tur_panicking) return ((int64_t)0);
                __t256 = __ps_258;
            } else {
                int64_t __ps_259 = (schema_hydecode_hyerrors(r_1551));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t262;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1602 = __ps_263;
            (void)m_1602;
            tur_frame __frame_264;
            tur_frame_init(&__frame_264, NULL);
            struct __defer_env_265 __t267 = {.m = m_1602};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_275 = (__inst_Decode_decode_bool(INT64_C(1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_276 = (ok_val__spec__bool_tur_adt_Result__bool__cstr((*(tur_adt_Result__bool__cstr *)(intptr_t)(__ps_275))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_275) tur_region_free((void *)(intptr_t)__ps_275);
        decode_unbool_uncarrier_untest__show_hybool(__ps_276);
        int64_t __ps_277 = (__inst_Decode_decode_bool(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        int64_t __ps_279 = (__inst_Decode_decode_int(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_280 = (ok_val__spec__int64_t_tur_adt_Result__int__cstr((*(tur_adt_Result__int__cstr *)(intptr_t)(__ps_279))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_279) tur_region_free((void *)(intptr_t)__ps_279);
        decode_unbool_uncarrier_untest__show_hyint(__ps_280);
        int64_t __t281;
        __t281 = INT64_C(0);
        return (int)__t281;
}
