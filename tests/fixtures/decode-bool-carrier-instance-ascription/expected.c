...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t23[1] = (int64_t)(intptr_t)__fn_884;
        void *__t24 = __t23;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t25) {
            ...
            __t26[1] = (int64_t)(intptr_t)__fn_1004;
            void *__t27 = __t26;
...
int main(int argc, char **argv) {
        ...
        tur_result_box_t *__t51 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(1)));
        ...
        tur_result_box_t *__t52 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(0)));
        ...
        tur_result_box_t *__t53 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_int(INT64_C(5)));
        decode_unbool_uncarrier_untest__show_hyint(ok_val__spec__int64_t_Result__int__cstr((Result__int__cstr){.is_ok = __t53->is_ok, .ok_val = __t53->ok_val, .err_val = (const char *)(intptr_t)(__t53->err_val)}));
        int64_t __t54;
        __t54 = INT64_C(0);
        return (int)__t54;
}
