        ...
        bool __t28;
        {
            ...
            if ((t1_1013) == (INT64_C(0))) {
                ...
                if ((t2_1014) == (INT64_C(0))) {
                    ...
                    bool __ps_31 = (cons_hyeq_hygo(t1_1013, t2_1014));
                    if (tur_panicking) return ((bool)0);
                    __t30 = __ps_31;
                }
                __t29 = __t30;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_760, (void *)(intptr_t)(k_761), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_765), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_766), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            ...
            bool __t96;
            {
                ...
                if ((t1_1008) == (INT64_C(0))) {
                    ...
                    if ((t2_1009) == (INT64_C(0))) {
                        ...
                        bool __ps_99 = (cons_hyeq_hygo(t1_1008, t2_1009));
                        if (tur_panicking) return ((bool)0);
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1099), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1100)));
            if (tur_panicking) return ((bool)0);
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                tur_adt_Vec__int * __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1228));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            (void)r_1278;
            int64_t __t149;
            bool __ps_150 = (schema_hydecode_hyok_qu(r_1278));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_150) {
                int64_t __ps_151 = (schema_hydecode_hyvalue(r_1278));
                if (tur_panicking) return ((int64_t)0);
                __t149 = __ps_151;
            } else {
                int64_t __ps_152 = (schema_hydecode_hyerrors(r_1278));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_155 = (__inst_Decode_decode_bool(INT64_C(1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_result_box_t *__t156 = (tur_result_box_t *)(intptr_t)(__ps_155);
        bool __ps_157 = (ok_val__spec__bool_tur_adt_Result__bool__cstr((tur_adt_Result__bool__cstr){.is_ok = __t156->is_ok, .ok_val = __t156->ok_val, .err_val = (const char *)(intptr_t)(__t156->err_val)}));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        decode_unbool_uncarrier_untest__show_hybool(__ps_157);
        int64_t __ps_158 = (__inst_Decode_decode_bool(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_result_box_t *__t159 = (tur_result_box_t *)(intptr_t)(__ps_158);
        bool __ps_160 = (ok_val__spec__bool_tur_adt_Result__bool__cstr((tur_adt_Result__bool__cstr){.is_ok = __t159->is_ok, .ok_val = __t159->ok_val, .err_val = (const char *)(intptr_t)(__t159->err_val)}));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        decode_unbool_uncarrier_untest__show_hybool(__ps_160);
        int64_t __ps_161 = (__inst_Decode_decode_int(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_result_box_t *__t162 = (tur_result_box_t *)(intptr_t)(__ps_161);
        int64_t __ps_163 = (ok_val__spec__int64_t_tur_adt_Result__int__cstr((tur_adt_Result__int__cstr){.is_ok = __t162->is_ok, .ok_val = __t162->ok_val, .err_val = (const char *)(intptr_t)(__t162->err_val)}));
        /* panic-return-signal: ret ctype unknown; no propagation here */
