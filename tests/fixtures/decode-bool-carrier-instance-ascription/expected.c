...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t28;
        {
            ...
            int64_t t1_1104 = __t29;
            (void)t1_1104;
            __auto_type __t30 = (y);
            TUR_REGION_NOTE_WORDS(&(__t30), sizeof(__t30));
            int64_t t2_1105 = __t30;
            (void)t2_1105;
            bool __t31;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                int64_t out_1115 = (int64_t)(intptr_t)(__t120);
                (void)out_1115;
                __t115 = out_1115;
            }
            __t113 = __t115;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t159;
        {
            ...
            {
                tur_adt_Vec__int * __ps_161 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1320));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1321 = __ps_161;
                (void)_un_unv_1321;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t165;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1371 = __ps_166;
            (void)r_1371;
            int64_t __t167;
            bool __ps_168 = (schema_hydecode_hyok_qu(r_1371));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_168) {
                int64_t __ps_169 = (schema_hydecode_hyvalue(r_1371));
                if (tur_panicking) return ((int64_t)0);
                __t167 = __ps_169;
            } else {
                int64_t __ps_170 = (schema_hydecode_hyerrors(r_1371));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_183 = (__inst_Decode_decode_bool(INT64_C(1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_184 = (ok_val__spec__bool_tur_adt_Result__bool__cstr((*(tur_adt_Result__bool__cstr *)(intptr_t)(__ps_183))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_183) tur_region_free((void *)(intptr_t)__ps_183);
        decode_unbool_uncarrier_untest__show_hybool(__ps_184);
        int64_t __ps_185 = (__inst_Decode_decode_bool(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_186 = (ok_val__spec__bool_tur_adt_Result__bool__cstr((*(tur_adt_Result__bool__cstr *)(intptr_t)(__ps_185))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_185) tur_region_free((void *)(intptr_t)__ps_185);
        decode_unbool_uncarrier_untest__show_hybool(__ps_186);
        int64_t __ps_187 = (__inst_Decode_decode_int(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_188 = (ok_val__spec__int64_t_tur_adt_Result__int__cstr((*(tur_adt_Result__int__cstr *)(intptr_t)(__ps_187))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_187) tur_region_free((void *)(intptr_t)__ps_187);
        decode_unbool_uncarrier_untest__show_hyint(__ps_188);
        int64_t __t189;
        __t189 = INT64_C(0);
        return (int)__t189;
}
...
static bool ok_val__spec__bool_tur_adt_Result__bool__cstr(tur_adt_Result__bool__cstr r) {
        bool __t192 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                bool v_938 = (bool)__scrut->as.Ok._0;
                __t192 = v_938;
                break;
            }
            case 1: {
...
static int64_t ok_val__spec__int64_t_tur_adt_Result__int__cstr(tur_adt_Result__int__cstr r) {
        int64_t __t193 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t v_938 = (int64_t)__scrut->as.Ok._0;
                __t193 = v_938;
                break;
            }
            case 1: {
