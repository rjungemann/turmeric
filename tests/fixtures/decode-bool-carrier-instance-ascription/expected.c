...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_813 = __ps_72;
        bool __ps_73 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_812, (void *)(intptr_t)(k_813), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_73;
        if (__t1) {
        ...
        if (__ps_122) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1184 = __ps_123;
                (void)h_1184;
                void * __ps_124 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1185 = __ps_124;
                (void)k_1185;
                bool __ps_125 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1184, (void *)(intptr_t)(k_1185), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_125) {
                    void * __t126 = iter;
                    void * __t127 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t129;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1188 = __ps_131;
            (void)iter_1188;
            void * __ps_132 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_133 = (hamt_slkeyeq((void *)(intptr_t)(__ps_132)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1189 = __ps_133;
            (void)keyeq_1189;
            void * __ps_134 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_135 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1188), (void *)(intptr_t)(__ps_134), (void *)(intptr_t)(keyeq_1189)));
            if (tur_panicking) return ((bool)0);
            bool result_1190 = __ps_135;
            (void)result_1190;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t156;
        {
            ...
            {
                tur_adt_Vec__int * __ps_158 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1317));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1318 = __ps_158;
                (void)_un_unv_1318;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t162;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1368 = __ps_163;
            (void)r_1368;
            int64_t __t164;
            bool __ps_165 = (schema_hydecode_hyok_qu(r_1368));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_165) {
                int64_t __ps_166 = (schema_hydecode_hyvalue(r_1368));
                if (tur_panicking) return ((int64_t)0);
                __t164 = __ps_166;
            } else {
                int64_t __ps_167 = (schema_hydecode_hyerrors(r_1368));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_179 = (__inst_Decode_decode_bool(INT64_C(1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t180 = (int64_t)(intptr_t)(__ps_179);
        tur_adt_Result__bool__cstr __t181 = (*(tur_adt_Result__bool__cstr *)(intptr_t)(__t180));
        if (__t180) free((void *)(intptr_t)(__t180));
        bool __ps_182 = (ok_val__spec__bool_tur_adt_Result__bool__cstr(__t181));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        decode_unbool_uncarrier_untest__show_hybool(__ps_182);
        int64_t __ps_183 = (__inst_Decode_decode_bool(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t184 = (int64_t)(intptr_t)(__ps_183);
        tur_adt_Result__bool__cstr __t185 = (*(tur_adt_Result__bool__cstr *)(intptr_t)(__t184));
        if (__t184) free((void *)(intptr_t)(__t184));
        bool __ps_186 = (ok_val__spec__bool_tur_adt_Result__bool__cstr(__t185));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        decode_unbool_uncarrier_untest__show_hybool(__ps_186);
        int64_t __ps_187 = (__inst_Decode_decode_int(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t188 = (int64_t)(intptr_t)(__ps_187);
        tur_adt_Result__int__cstr __t189 = (*(tur_adt_Result__int__cstr *)(intptr_t)(__t188));
        if (__t188) free((void *)(intptr_t)(__t188));
        int64_t __ps_190 = (ok_val__spec__int64_t_tur_adt_Result__int__cstr(__t189));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        decode_unbool_uncarrier_untest__show_hyint(__ps_190);
        int64_t __t191;
        __t191 = INT64_C(0);
        return (int)__t191;
}
