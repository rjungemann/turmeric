...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_97) {
            bool __t98;
            {
                ...
                (void)t2_1288;
                bool __t99;
                bool __ps_100 = (tnil_qu(t1_1287));
                if (tur_panicking) return ((bool)0);
                if (__ps_100) {
                    bool __ps_101 = (tnil_qu(t2_1288));
                    if (tur_panicking) return ((bool)0);
                    __t99 = __ps_101;
                } else {
                    bool __t102;
                    bool __ps_103 = (tnil_qu(t2_1288));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_103) {
                        __t102 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1287, t2_1288));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_104;
                    }
                    __t99 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                int64_t out_1303 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1303;
                __t111 = out_1303;
            }
            __t109 = __t111;
        ...
        if (__ps_116) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1374 = __ps_117;
                (void)h_1374;
                void * __ps_118 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1375 = __ps_118;
                (void)k_1375;
                bool __ps_119 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1374, (void *)(intptr_t)(k_1375), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_119) {
                    void * __t120 = iter;
                    void * __t121 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1378 = __ps_125;
            (void)iter_1378;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1379 = __ps_127;
            (void)keyeq_1379;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1378), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1379)));
            if (tur_panicking) return ((bool)0);
            bool result_1380 = __ps_129;
            (void)result_1380;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1510));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1511 = __ps_152;
                (void)_un_unv_1511;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1561 = __ps_155;
            (void)r_1561;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1561));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                return schema_hydecode_hyvalue(r_1561);
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1561));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1612 = __ps_160;
            (void)m_1612;
            tur_frame __frame_161;
            tur_frame_init(&__frame_161, NULL);
            struct __defer_env_162 __t164 = {.m = m_1612};
...
static bool ok_val__spec__bool_tur_adt_Result__bool__cstr(tur_adt_Result__bool__cstr r) {
        bool __t180 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                bool v_1117 = (bool)__scrut->as.Ok._0;
                __t180 = v_1117;
                break;
            }
            case 1: {
...
static int64_t ok_val__spec__int64_t_tur_adt_Result__int__cstr(tur_adt_Result__int__cstr r) {
        int64_t __t181 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t v_1117 = (int64_t)__scrut->as.Ok._0;
                __t181 = v_1117;
                break;
            }
            case 1: {
