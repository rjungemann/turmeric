...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_160 = (__inst_Decode_decode_bool(INT64_C(1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_result_box_t *__t161 = (tur_result_box_t *)(intptr_t)(__ps_160);
        bool __ps_162 = (ok_val__spec__bool_tur_adt_Result__bool__cstr((tur_adt_Result__bool__cstr){.is_ok = __t161->is_ok, .ok_val = __t161->ok_val, .err_val = (const char *)(intptr_t)(__t161->err_val)}));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        decode_unbool_uncarrier_untest__show_hybool(__ps_162);
        int64_t __ps_163 = (__inst_Decode_decode_bool(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_result_box_t *__t164 = (tur_result_box_t *)(intptr_t)(__ps_163);
        bool __ps_165 = (ok_val__spec__bool_tur_adt_Result__bool__cstr((tur_adt_Result__bool__cstr){.is_ok = __t164->is_ok, .ok_val = __t164->ok_val, .err_val = (const char *)(intptr_t)(__t164->err_val)}));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        decode_unbool_uncarrier_untest__show_hybool(__ps_165);
        int64_t __ps_166 = (__inst_Decode_decode_int(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_result_box_t *__t167 = (tur_result_box_t *)(intptr_t)(__ps_166);
        int64_t __ps_168 = (ok_val__spec__int64_t_tur_adt_Result__int__cstr((tur_adt_Result__int__cstr){.is_ok = __t167->is_ok, .ok_val = __t167->ok_val, .err_val = (const char *)(intptr_t)(__t167->err_val)}));
        /* panic-return-signal: ret ctype unknown; no propagation here */
