...
static bool __fn_1002(int64_t, int64_t);
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t16[1] = (int64_t)(intptr_t)__fn_882;
        void *__t17 = __t16;
...
static bool __fn_1002(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t18) {
            ...
            __t19[1] = (int64_t)(intptr_t)__fn_1002;
            void *__t20 = __t19;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_948 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_948;
                void * k_949 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_949;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_948, (void *)(intptr_t)(k_949), (void *)(intptr_t)(keyeq))) {
                    void * __t34 = iter;
                    void * __t35 = s2_hamt;
                    void * __t36 = keyeq;
                    iter = __t34;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t37;
        {
            void * iter_952 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_952;
            void * keyeq_953 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_953;
            bool result_954 = set_hyeq_hyloop((void *)(intptr_t)(iter_952), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_953));
            (void)result_954;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_952));
            bool __t38;
            __t38 = result_954;
            __t37 = __t38;
        }
...
int main(int argc, char **argv) {
        ...
        tur_result_box_t *__t44 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(1)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t44->is_ok, .ok_val = (bool)(__t44->ok_val), .err_val = (const char *)(intptr_t)(__t44->err_val)}));
        tur_result_box_t *__t45 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(0)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t45->is_ok, .ok_val = (bool)(__t45->ok_val), .err_val = (const char *)(intptr_t)(__t45->err_val)}));
        tur_result_box_t *__t46 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_int(INT64_C(5)));
        decode_unbool_uncarrier_untest__show_hyint(ok_val__spec__int64_t_Result__int__cstr((Result__int__cstr){.is_ok = __t46->is_ok, .ok_val = __t46->ok_val, .err_val = (const char *)(intptr_t)(__t46->err_val)}));
        int64_t __t47;
        __t47 = INT64_C(0);
        return (int)__t47;
}
