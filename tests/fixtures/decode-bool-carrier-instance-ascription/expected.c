...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        __t4[1] = (int64_t)(intptr_t)__fn_607;
        void *__t5 = __t4;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t12[1] = (int64_t)(intptr_t)__fn_789;
        void *__t13 = __t12;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_871;
        void *__t15 = __t14;
...
int main(int argc, char **argv) {
        ...
        tur_result_box_t *__t21 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(1)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t21->is_ok, .ok_val = (bool)(__t21->ok_val), .err_val = (const char *)(intptr_t)(__t21->err_val)}));
        tur_result_box_t *__t22 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(0)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t22->is_ok, .ok_val = (bool)(__t22->ok_val), .err_val = (const char *)(intptr_t)(__t22->err_val)}));
        tur_result_box_t *__t23 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_int(INT64_C(5)));
        decode_unbool_uncarrier_untest__show_hyint(ok_val__spec__int64_t_Result__int__cstr((Result__int__cstr){.is_ok = __t23->is_ok, .ok_val = __t23->ok_val, .err_val = (const char *)(intptr_t)(__t23->err_val)}));
        int64_t __t24;
        __t24 = INT64_C(0);
        return (int)__t24;
}
