...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t18[1] = (int64_t)(intptr_t)__fn_882;
        void *__t19 = __t18;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t20) {
            ...
            __t21[1] = (int64_t)(intptr_t)__fn_1002;
            void *__t22 = __t21;
...
int main(int argc, char **argv) {
        ...
        tur_result_box_t *__t46 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(1)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t46->is_ok, .ok_val = (bool)(__t46->ok_val), .err_val = (const char *)(intptr_t)(__t46->err_val)}));
        tur_result_box_t *__t47 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(0)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_Result__bool__cstr((Result__bool__cstr){.is_ok = __t47->is_ok, .ok_val = (bool)(__t47->ok_val), .err_val = (const char *)(intptr_t)(__t47->err_val)}));
        tur_result_box_t *__t48 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_int(INT64_C(5)));
        decode_unbool_uncarrier_untest__show_hyint(ok_val__spec__int64_t_Result__int__cstr((Result__int__cstr){.is_ok = __t48->is_ok, .ok_val = __t48->ok_val, .err_val = (const char *)(intptr_t)(__t48->err_val)}));
        int64_t __t49;
        __t49 = INT64_C(0);
        return (int)__t49;
}
