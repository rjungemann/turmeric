...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t14;
        {
            ...
            bool __t15;
            if ((t1_983) == (INT64_C(0))) {
                __t15 = (t2_984) == (INT64_C(0));
            } else {
                bool __t16;
                if ((t2_984) == (INT64_C(0))) {
                    __t16 = false;
                } else {
                    __t16 = cons_hyeq_hygo(t1_983, t2_984);
                }
                __t15 = __t16;
            }
            __t14 = __t15;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t17) {
            ...
            __t18[1] = (int64_t)(intptr_t)__fn_1114;
            void *__t19 = __t18;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__inst_Eq_eq_qu_int((int64_t)((tur_adt_Cons *)(intptr_t)(c1))->head, (int64_t)((tur_adt_Cons *)(intptr_t)(c2))->head)) {
            bool __t32;
            {
                ...
                bool __t33;
                if ((t1_978) == (INT64_C(0))) {
                    __t33 = (t2_979) == (INT64_C(0));
                } else {
                    bool __t34;
                    if ((t2_979) == (INT64_C(0))) {
                        __t34 = false;
                    } else {
                        __t34 = cons_hyeq_hygo(t1_978, t2_979);
                    }
                    __t33 = __t34;
                }
                __t32 = __t33;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t53;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1242)) {
                __t54 = schema_hydecode_hyvalue(r_1242);
            } else {
                __t54 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1242));
            }
            __t53 = __t54;
        }
        return __t53;
...
int main(int argc, char **argv) {
        ...
        tur_result_box_t *__t55 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(1)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_tur_adt_Result__bool__cstr((tur_adt_Result__bool__cstr){.is_ok = __t55->is_ok, .ok_val = __t55->ok_val, .err_val = (const char *)(intptr_t)(__t55->err_val)}));
        tur_result_box_t *__t56 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_bool(INT64_C(0)));
        decode_unbool_uncarrier_untest__show_hybool(ok_val__spec__bool_tur_adt_Result__bool__cstr((tur_adt_Result__bool__cstr){.is_ok = __t56->is_ok, .ok_val = __t56->ok_val, .err_val = (const char *)(intptr_t)(__t56->err_val)}));
        tur_result_box_t *__t57 = (tur_result_box_t *)(intptr_t)(__inst_Decode_decode_int(INT64_C(5)));
        decode_unbool_uncarrier_untest__show_hyint(ok_val__spec__int64_t_tur_adt_Result__int__cstr((tur_adt_Result__int__cstr){.is_ok = __t57->is_ok, .ok_val = __t57->ok_val, .err_val = (const char *)(intptr_t)(__t57->err_val)}));
        int64_t __t58;
        __t58 = INT64_C(0);
        return (int)__t58;
}
