...
int main() {
        int64_t __t0;
        {
            void * d0_290 = bwsd_new(INT64_C(16));
            (void)d0_290;
            int64_t __t1;
            {
                void * d1_291 = bwsd_new(INT64_C(16));
                (void)d1_291;
                bwsd_push((void *)(intptr_t)(d0_290), (void *)(intptr_t)(d0_290));
                bwsd_push((void *)(intptr_t)(d0_290), (void *)(intptr_t)(d0_290));
                bwsd_push((void *)(intptr_t)(d0_290), (void *)(intptr_t)(d0_290));
                bwsd_push((void *)(intptr_t)(d0_290), (void *)(intptr_t)(d0_290));
                bwsd_push((void *)(intptr_t)(d0_290), (void *)(intptr_t)(d0_290));
                ...
                int64_t __t3;
                {
                    void * state_292 = make_state((void *)(intptr_t)(d0_290), (void *)(intptr_t)(d1_291), INT64_C(8));
                    (void)state_292;
                    int64_t __t4;
                    {
                        void * handles_293 = launch_workers((void *)(intptr_t)(bal_worker));
                        (void)handles_293;
                        int64_t __t5;
                        {
                            int64_t count_294 = wait_done((void *)(intptr_t)(state_292));
                            (void)count_294;
                            join_workers((void *)(intptr_t)(handles_293));
                            print_count(count_294);
                            free_state((void *)(intptr_t)(state_292));
                            bwsd_free((void *)(intptr_t)(d0_290));
                            bwsd_free((void *)(intptr_t)(d1_291));
                            int64_t __t6;
                            __t6 = INT64_C(0);
                            __t5 = __t6;
                        }
