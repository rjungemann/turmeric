...
int main() {
        int64_t __t0;
        {
            void * d0_225 = bwsd_new(INT64_C(16));
            (void)d0_225;
            int64_t __t1;
            {
                void * d1_226 = bwsd_new(INT64_C(16));
                (void)d1_226;
                bwsd_push((void *)(intptr_t)(d0_225), (void *)(intptr_t)(d0_225));
                bwsd_push((void *)(intptr_t)(d0_225), (void *)(intptr_t)(d0_225));
                bwsd_push((void *)(intptr_t)(d0_225), (void *)(intptr_t)(d0_225));
                bwsd_push((void *)(intptr_t)(d0_225), (void *)(intptr_t)(d0_225));
                bwsd_push((void *)(intptr_t)(d0_225), (void *)(intptr_t)(d0_225));
                ...
                int64_t __t3;
                {
                    void * state_227 = make_state((void *)(intptr_t)(d0_225), (void *)(intptr_t)(d1_226), INT64_C(8));
                    (void)state_227;
                    int64_t __t4;
                    {
                        void * handles_228 = launch_workers((void *)(intptr_t)(bal_worker));
                        (void)handles_228;
                        int64_t __t5;
                        {
                            int64_t count_229 = wait_done((void *)(intptr_t)(state_227));
                            (void)count_229;
                            join_workers((void *)(intptr_t)(handles_228));
                            print_count(count_229);
                            free_state((void *)(intptr_t)(state_227));
                            bwsd_free((void *)(intptr_t)(d0_225));
                            bwsd_free((void *)(intptr_t)(d1_226));
                            int64_t __t6;
                            __t6 = INT64_C(0);
                            __t5 = __t6;
                        }
