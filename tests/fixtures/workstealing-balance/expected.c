...
int main() {
        int64_t __t0;
        {
            void * d0_645 = bwsd_new(INT64_C(16));
            (void)d0_645;
            int64_t __t1;
            {
                void * d1_646 = bwsd_new(INT64_C(16));
                (void)d1_646;
                bwsd_push((void *)(intptr_t)(d0_645), (void *)(intptr_t)(d0_645));
                bwsd_push((void *)(intptr_t)(d0_645), (void *)(intptr_t)(d0_645));
                bwsd_push((void *)(intptr_t)(d0_645), (void *)(intptr_t)(d0_645));
                bwsd_push((void *)(intptr_t)(d0_645), (void *)(intptr_t)(d0_645));
                bwsd_push((void *)(intptr_t)(d0_645), (void *)(intptr_t)(d0_645));
                ...
                int64_t __t3;
                {
                    void * state_647 = make_state((void *)(intptr_t)(d0_645), (void *)(intptr_t)(d1_646), INT64_C(8));
                    (void)state_647;
                    int64_t __t4;
                    {
                        void * handles_648 = launch_workers((void *)(intptr_t)(bal_worker));
                        (void)handles_648;
                        int64_t __t5;
                        {
                            int64_t count_649 = wait_done((void *)(intptr_t)(state_647));
                            (void)count_649;
                            join_workers((void *)(intptr_t)(handles_648));
                            print_count(count_649);
                            free_state((void *)(intptr_t)(state_647));
                            bwsd_free((void *)(intptr_t)(d0_645));
                            bwsd_free((void *)(intptr_t)(d1_646));
                            int64_t __t6;
                            __t6 = INT64_C(0);
                            __t5 = __t6;
                        }
