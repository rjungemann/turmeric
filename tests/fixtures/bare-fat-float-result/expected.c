...
static double run_with(void *, double);
...
static double run_with(void * g, double x) {
        return (*( tur_thunk_double_double_t *)(g))(g, x);
}
...
int main(int argc, char **argv) {
        ...
        printf("%g\n", (double)(run_with((void *)(intptr_t)(make_scale(2.0)), 3.5)));
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
}
