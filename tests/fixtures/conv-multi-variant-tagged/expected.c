...
static int64_t area(int64_t s) {
        int64_t __t50 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1248 = (int64_t)__scrut->as.Circle._0;
                __t50 = (INT64_C(3)) * ((r_1248) * (r_1248));
                break;
            }
            case 1: {
                int64_t w_1249 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1250 = (int64_t)__scrut->as.Rect._1;
                __t50 = (w_1249) * (h_1250);
                break;
            }
            default: break;
...
int main(int argc, char **argv) {
        ...
        int64_t __t51;
        {
            int64_t c_1251 = ctor_Circle(INT64_C(2));
            (void)c_1251;
            int64_t r_1252 = ctor_Rect(INT64_C(3), INT64_C(4));
            (void)r_1252;
            printf("%lld\n", (long long)(area(c_1251)));
            printf("%lld\n", (long long)(area(r_1252)));
            int64_t __t52;
            __t52 = INT64_C(0);
            __t51 = __t52;
        }
