...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t232 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1468 = (int64_t)__scrut->as.Circle._0;
                __t232 = (INT64_C(3)) * ((r_1468) * (r_1468));
                break;
            }
            case 1: {
                int64_t w_1469 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1470 = (int64_t)__scrut->as.Rect._1;
                __t232 = (w_1469) * (h_1470);
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t233;
        {
            tur_adt_Shape __ps_234 = (ctor_Shape_Circle(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape c_1471 = __ps_234;
            (void)c_1471;
            tur_adt_Shape __ps_235 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape r_1472 = __ps_235;
            (void)r_1472;
            int64_t __ps_236 = (area(&c_1471));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_236));
            int64_t __ps_237 = (area(&r_1472));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_237));
            int64_t __t238;
            __t238 = INT64_C(0);
