...
static int64_t ctor_Circle(int64_t _0) {
    tur_adt_Shape *__r = (tur_adt_Shape *)malloc(sizeof(tur_adt_Shape));
    __r->tag = 0;
    __r->as.Circle._0 = _0;
    return (int64_t)(intptr_t)__r;
}

static int64_t ctor_Rect(int64_t _0, int64_t _1) {
    tur_adt_Shape *__r = (tur_adt_Shape *)malloc(sizeof(tur_adt_Shape));
    __r->tag = 1;
    __r->as.Rect._0 = _0;
    __r->as.Rect._1 = _1;
...
static int64_t area(int64_t s) {
        int64_t __t173 = 0;
        {
            tur_adt_Shape *__scrut = (tur_adt_Shape *)(intptr_t)(s);
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1277 = (int64_t)__scrut->as.Circle._0;
                __t173 = (INT64_C(3)) * ((r_1277) * (r_1277));
                break;
            }
            case 1: {
                int64_t w_1278 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1279 = (int64_t)__scrut->as.Rect._1;
                __t173 = (w_1278) * (h_1279);
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
        ...
        int64_t __t174;
        {
            __auto_type __ps_175 = (ctor_Circle(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t c_1280 = __ps_175;
            (void)c_1280;
            __auto_type __ps_176 = (ctor_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1281 = __ps_176;
            (void)r_1281;
            __auto_type __ps_177 = (area(c_1280));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            __auto_type __ps_178 = (area(r_1281));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_178));
            int64_t __t179;
            __t179 = INT64_C(0);
