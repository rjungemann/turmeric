...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t168 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1437 = (int64_t)__scrut->as.Circle._0;
                __t168 = (INT64_C(3)) * ((r_1437) * (r_1437));
                break;
            }
            case 1: {
                int64_t w_1438 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1439 = (int64_t)__scrut->as.Rect._1;
                __t168 = (w_1438) * (h_1439);
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t169;
        {
            tur_adt_Shape __ps_170 = (ctor_Circle(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape c_1440 = __ps_170;
            (void)c_1440;
            tur_adt_Shape __ps_171 = (ctor_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape r_1441 = __ps_171;
            (void)r_1441;
            tur_adt_Shape __t172 = c_1440;
            int64_t __ps_173 = (area(&__t172));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_173));
            tur_adt_Shape __t174 = r_1441;
