...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t275 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1611 = (int64_t)__scrut->as.Circle._0;
                __t275 = (INT64_C(3)) * ((r_1611) * (r_1611));
                break;
            }
            case 1: {
                int64_t w_1612 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1613 = (int64_t)__scrut->as.Rect._1;
                __t275 = (w_1612) * (h_1613);
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t276;
        {
            tur_adt_Shape __ps_277 = (ctor_Shape_Circle(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape c_1614 = __ps_277;
            (void)c_1614;
            tur_adt_Shape __ps_278 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape r_1615 = __ps_278;
            (void)r_1615;
            int64_t __ps_279 = (area(&c_1614));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_279));
            int64_t __ps_280 = (area(&r_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_280));
            int64_t __t281;
            __t281 = INT64_C(0);
