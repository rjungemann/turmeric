...
static int64_t area(int64_t s) {
        int64_t __t55 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1251 = (int64_t)__scrut->as.Circle._0;
                __t55 = (INT64_C(3)) * ((r_1251) * (r_1251));
                break;
            }
            case 1: {
                int64_t w_1252 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1253 = (int64_t)__scrut->as.Rect._1;
                __t55 = (w_1252) * (h_1253);
                break;
            }
            default: break;
...
int main(int argc, char **argv) {
        ...
        int64_t __t56;
        {
            int64_t c_1254 = ctor_Circle(INT64_C(2));
            (void)c_1254;
            int64_t r_1255 = ctor_Rect(INT64_C(3), INT64_C(4));
            (void)r_1255;
            printf("%lld\n", (long long)(area(c_1254)));
            printf("%lld\n", (long long)(area(r_1255)));
            int64_t __t57;
            __t57 = INT64_C(0);
            __t56 = __t57;
        }
