...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t172 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1612 = (int64_t)__scrut->as.Circle._0;
                __t172 = (INT64_C(3)) * ((r_1612) * (r_1612));
                break;
            }
            case 1: {
                int64_t w_1613 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1614 = (int64_t)__scrut->as.Rect._1;
                __t172 = (w_1613) * (h_1614);
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape c_1615 = __ps_174;
            (void)c_1615;
            tur_adt_Shape __ps_175 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape r_1616 = __ps_175;
            (void)r_1616;
            int64_t __ps_176 = (area(&c_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_176));
            int64_t __ps_177 = (area(&r_1616));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            int64_t __t178;
            __t178 = INT64_C(0);
