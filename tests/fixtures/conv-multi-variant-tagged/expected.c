...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            tur_adt_Shape __ps_174 = (ctor_Circle(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape c_1440 = __ps_174;
            (void)c_1440;
            tur_adt_Shape __ps_175 = (ctor_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape r_1441 = __ps_175;
            (void)r_1441;
            tur_adt_Shape __t176 = c_1440;
            int64_t __ps_177 = (area(&__t176));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            tur_adt_Shape __t178 = r_1441;
