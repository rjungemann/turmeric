...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t244 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1472 = (int64_t)__scrut->as.Circle._0;
                __t244 = (INT64_C(3)) * ((r_1472) * (r_1472));
                break;
            }
            case 1: {
                int64_t w_1473 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1474 = (int64_t)__scrut->as.Rect._1;
                __t244 = (w_1473) * (h_1474);
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t245;
        {
            tur_adt_Shape __ps_246 = (ctor_Shape_Circle(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape c_1475 = __ps_246;
            (void)c_1475;
            tur_adt_Shape __ps_247 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape r_1476 = __ps_247;
            (void)r_1476;
            int64_t __ps_248 = (area(&c_1475));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_248));
            int64_t __ps_249 = (area(&r_1476));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_249));
            int64_t __t250;
            __t250 = INT64_C(0);
