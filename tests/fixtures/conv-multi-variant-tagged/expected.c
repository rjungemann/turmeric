...
static int64_t area(int64_t s) {
        int64_t __t160 = 0;
        {
            ...
            case 0: {
                ...
                __t160 = (INT64_C(3)) * ((r_1335) * (r_1335));
                break;
            }
            case 1: {
                int64_t w_1336 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1337 = (int64_t)__scrut->as.Rect._1;
                __t160 = (w_1336) * (h_1337);
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t161;
        {
            int64_t __ps_162 = (ctor_Circle(INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t c_1338 = __ps_162;
            (void)c_1338;
            int64_t __ps_163 = (ctor_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t r_1339 = __ps_163;
            (void)r_1339;
