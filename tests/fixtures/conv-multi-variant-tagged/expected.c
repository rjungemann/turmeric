...
int main(int argc, char **argv) {
        ...
        int64_t __t56;
        {
            int64_t c_1272 = ctor_Circle(INT64_C(2));
            (void)c_1272;
            int64_t r_1273 = ctor_Rect(INT64_C(3), INT64_C(4));
            (void)r_1273;
            printf("%lld\n", (long long)(area(c_1272)));
            printf("%lld\n", (long long)(area(r_1273)));
            int64_t __t57;
            __t57 = INT64_C(0);
            __t56 = __t57;
        }
