...
static int64_t area(int64_t s) {
        int64_t __t50 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1266 = (int64_t)__scrut->as.Circle._0;
                __t50 = (INT64_C(3)) * ((r_1266) * (r_1266));
                break;
            }
            case 1: {
                int64_t w_1267 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1268 = (int64_t)__scrut->as.Rect._1;
                __t50 = (w_1267) * (h_1268);
                break;
            }
            default: break;
...
int main(int argc, char **argv) {
        ...
        int64_t __t51;
        {
            int64_t c_1269 = ctor_Circle(INT64_C(2));
            (void)c_1269;
            int64_t r_1270 = ctor_Rect(INT64_C(3), INT64_C(4));
            (void)r_1270;
            printf("%lld\n", (long long)(area(c_1269)));
            printf("%lld\n", (long long)(area(r_1270)));
            int64_t __t52;
            __t52 = INT64_C(0);
            __t51 = __t52;
        }
