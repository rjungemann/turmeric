...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t172 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1624 = (int64_t)__scrut->as.Circle._0;
                __t172 = (INT64_C(3)) * ((r_1624) * (r_1624));
                break;
            }
            case 1: {
                int64_t w_1625 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1626 = (int64_t)__scrut->as.Rect._1;
                __t172 = (w_1625) * (h_1626);
                break;
            }
            default: break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape c_1627 = __ps_174;
            (void)c_1627;
            tur_adt_Shape __ps_175 = (ctor_Shape_Rect(INT64_C(3), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Shape r_1628 = __ps_175;
            (void)r_1628;
            int64_t __ps_176 = (area(&c_1627));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_176));
            int64_t __ps_177 = (area(&r_1628));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            int64_t __t178;
            __t178 = INT64_C(0);
