...
static int64_t area(const tur_adt_Shape * s) {
        int64_t __t179 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                int64_t r_1439 = (int64_t)__scrut->as.Circle._0;
                __t179 = (INT64_C(3)) * ((r_1439) * (r_1439));
                break;
            }
            case 1: {
                int64_t w_1440 = (int64_t)__scrut->as.Rect._0;
                int64_t h_1441 = (int64_t)__scrut->as.Rect._1;
                __t179 = (w_1440) * (h_1441);
                break;
            }
            default: break;
            }
