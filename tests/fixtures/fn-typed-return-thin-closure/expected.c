...
typedef int64_t (*tur_fnptr_int64_t_double_t)(double);
...
static int64_t __fn_894(double);
...
static int64_t __fn_894(double x) {
        return INT64_C(7);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t (*g)(int64_t) = make_hyadd1();
            (void)g;
            int64_t (*h)(double) = make_hytrunc();
            (void)h;
            printf("%lld\n", (long long)(((int64_t (*)(int64_t))(intptr_t)g)(INT64_C(41))));
            printf("%lld\n", (long long)(((int64_t (*)(double))(intptr_t)h)(3.5)));
        }
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
