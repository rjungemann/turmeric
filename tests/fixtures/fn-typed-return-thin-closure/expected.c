...
static int64_t __fn_883(double);
...
static tur_fnptr_int64_t_int64_t_t make_add1();
static tur_fnptr_int64_t_double_t make_trunc();
...
static int64_t __fn_880(int64_t x) {
        return (x) + (INT64_C(1));
}

static int64_t __fn_883(double x) {
        return INT64_C(7);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t (*g)(int64_t) = make_add1();
            (void)g;
            int64_t (*h)(double) = make_trunc();
            (void)h;
