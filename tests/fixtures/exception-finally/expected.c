...
static int64_t test_finally_runs();
static int64_t test_finally_with_exception();
...
static int64_t test_finally_with_exception() {
        ...
        if (setjmp(__t3.jmp_buf) == 0) {
            ...
            *__t6 = INT64_C(42);
            tur_throw(3, (void*)__t6, 11, "<unknown>");
            global_handler_chain = global_handler_chain->parent;
            goto __t5;
        } else {
            if (tur_exception_matches(__t3.caught, 1)) {
                void * e_198 = (void *)__t3.caught->payload;
                __t4 = INT64_C(0);
    ...
    __t5:
    puts("finally ran after catch");
    return __t4;
}

int main() {
    puts("exception-finally test");
    int64_t __t7;
    __t7 = INT64_C(0);
    return (int)__t7;
}
