...
int main(int argc, char **argv) {
        ...
        {
            void * h_916 = compose((int64_t)(intptr_t)(make_scale(2.0)), (int64_t)(intptr_t)(make_add(1.0)));
            (void)h_916;
            printf("%g\n", (double)(call_f((int64_t)(intptr_t)(h_916), 3.0)));
        }
        int64_t __t31;
        __t31 = INT64_C(0);
        return (int)__t31;
