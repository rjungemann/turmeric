...
static const char * __fn_1313(void *, int64_t);
static int64_t __fn_1324(int64_t);
static int64_t __fn_1329(bool);
static int64_t __fn_1334(int64_t);
static int64_t two_hylens_un_undict_un1336(int64_t, int64_t, int64_t, int64_t, int64_t);
static int64_t __poly_1347(void *, int64_t, int64_t, int64_t, int64_t, int64_t);
static int64_t two_hylens_un_undict_un1361(int64_t, int64_t, int64_t, int64_t, int64_t);
static int64_t __poly_1363(void *, int64_t, int64_t, int64_t, int64_t, int64_t);
static int64_t two_hylens_un_undict_un1377(int64_t, int64_t, int64_t, int64_t, int64_t);
static int64_t __poly_1379(void *, int64_t, int64_t, int64_t, int64_t, int64_t);
...
struct __env_1346 { int64_t __fn; int64_t __dict_1339; int64_t __dict_1341; };
static const char * __fn_1313(void * __env_p_1344, int64_t x) {
        struct __env_1346 *__env___env_1346 = (struct __env_1346 *)__env_p_1344;
        __auto_type __ps_45 = (((const char * (*)(int64_t))((void **)(intptr_t)__env___env_1346->__dict_1339)[0])(x));
        if (tur_panicking) return (const char *){0};
        __auto_type __ps_46 = (((int64_t (*)(int64_t))((void **)(intptr_t)__env___env_1346->__dict_1341)[0])(x));
        if (tur_panicking) return (const char *){0};
...
static int64_t __fn_1329(bool x) {
...
static int64_t two_hylens_un_undict_un1336(int64_t __dict_1337, int64_t __dict_1339, int64_t __dict_1341, int64_t g, int64_t s) {
        __auto_type __ps_51 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(g)))[0])((void *)(intptr_t)(g), s));
        if (tur_panicking) return (int64_t){0};
        struct __env_1346 *__t52 = (struct __env_1346 *)malloc(sizeof(struct __env_1346));
        __t52->__fn = (int64_t)(intptr_t)__fn_1313;
        __t52->__dict_1339 = __dict_1339;
        __t52->__dict_1341 = __dict_1341;
        void *__t53 = __t52;
        void *__t54 = (void *)(intptr_t)(__t53);
        __auto_type __ps_55 = (((int64_t (*)(int64_t, tur_poly_fn_t))((void **)(intptr_t)__dict_1337)[0])(__ps_51, (tur_poly_fn_t){ __t54, (int64_t(*)(void*,int64_t))(intptr_t)((int64_t*)__t54)[0] }));
        if (tur_panicking) return (int64_t){0};
        return (int64_t)(intptr_t)__ps_55;
}

static int64_t __poly_1347(void * __poly_env_1348, int64_t __poly_x0_1350, int64_t __poly_x1_1352, int64_t __poly_x2_1354, int64_t __poly_x3_1356, int64_t __poly_x4_1358) {
        __auto_type __ps_56 = (two_hylens_un_undict_un1336(__poly_x0_1350, __poly_x1_1352, __poly_x2_1354, __poly_x3_1356, __poly_x4_1358));
        if (tur_panicking) return (int64_t){0};
        return __ps_56;
}

static int64_t two_hylens_un_undict_un1361(int64_t __dict_1337, int64_t __dict_1339, int64_t __dict_1341, int64_t g, int64_t s) {
        __auto_type __ps_57 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(g)))[0])((void *)(intptr_t)(g), s));
        if (tur_panicking) return (int64_t){0};
        struct __env_1346 *__t58 = (struct __env_1346 *)malloc(sizeof(struct __env_1346));
        __t58->__fn = (int64_t)(intptr_t)__fn_1313;
        __t58->__dict_1339 = __dict_1339;
        __t58->__dict_1341 = __dict_1341;
        void *__t59 = __t58;
        void *__t60 = (void *)(intptr_t)(__t59);
        __auto_type __ps_61 = (((int64_t (*)(int64_t, tur_poly_fn_t))((void **)(intptr_t)__dict_1337)[0])(__ps_57, (tur_poly_fn_t){ __t60, (int64_t(*)(void*,int64_t))(intptr_t)((int64_t*)__t60)[0] }));
        if (tur_panicking) return (int64_t){0};
        return (int64_t)(intptr_t)__ps_61;
}

static int64_t __poly_1363(void * __poly_env_1364, int64_t __poly_x0_1366, int64_t __poly_x1_1368, int64_t __poly_x2_1370, int64_t __poly_x3_1372, int64_t __poly_x4_1374) {
        __auto_type __ps_62 = (two_hylens_un_undict_un1361(__poly_x0_1366, __poly_x1_1368, __poly_x2_1370, __poly_x3_1372, __poly_x4_1374));
        if (tur_panicking) return (int64_t){0};
        return __ps_62;
}

static int64_t two_hylens_un_undict_un1377(int64_t __dict_1337, int64_t __dict_1339, int64_t __dict_1341, int64_t g, int64_t s) {
        __auto_type __ps_63 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(g)))[0])((void *)(intptr_t)(g), s));
        if (tur_panicking) return (int64_t){0};
        struct __env_1346 *__t64 = (struct __env_1346 *)malloc(sizeof(struct __env_1346));
        __t64->__fn = (int64_t)(intptr_t)__fn_1313;
        __t64->__dict_1339 = __dict_1339;
        __t64->__dict_1341 = __dict_1341;
        void *__t65 = __t64;
        void *__t66 = (void *)(intptr_t)(__t65);
        __auto_type __ps_67 = (((int64_t (*)(int64_t, tur_poly_fn_t))((void **)(intptr_t)__dict_1337)[0])(__ps_63, (tur_poly_fn_t){ __t66, (int64_t(*)(void*,int64_t))(intptr_t)((int64_t*)__t66)[0] }));
        if (tur_panicking) return (int64_t){0};
        return (int64_t)(intptr_t)__ps_67;
}

static int64_t __poly_1379(void * __poly_env_1380, int64_t __poly_x0_1382, int64_t __poly_x1_1384, int64_t __poly_x2_1386, int64_t __poly_x3_1388, int64_t __poly_x4_1390) {
        __auto_type __ps_68 = (two_hylens_un_undict_un1377(__poly_x0_1382, __poly_x1_1384, __poly_x2_1386, __poly_x3_1388, __poly_x4_1390));
        if (tur_panicking) return (int64_t){0};
        return __ps_68;
}
