...
int main(void) {
    printf("%lld\n", (long long)(INT8_C(42)));
    printf("%lld\n", (long long)(INT16_C(1000)));
    printf("%lld\n", (long long)(INT32_C(100000)));
    printf("%lld\n", (long long)(INT64_C(9000000000)));
    printf("%llu\n", (unsigned long long)(UINT8_C(200)));
    printf("%llu\n", (unsigned long long)(UINT16_C(60000)));
    printf("%llu\n", (unsigned long long)(UINT32_C(3000000000)));
    printf("%llu\n", (unsigned long long)(UINT64_C(18000000000)));
    printf("%.7g\n", (double)(((float)2.5)));
    printf("%g\n", (double)(2.5));
    printf("%lld\n", (long long)(((int64_t)(INT8_C(42)))));
    printf("%lld\n", (long long)(((int64_t)(UINT8_C(200)))));
    printf("%lld\n", (long long)(((int32_t)(INT64_C(9000000000)))));
    printf("%.7g\n", (double)(((float)(INT64_C(100)))));
    printf("%g\n", (double)(((double)(((float)1.5)))));
    return 0;
}
