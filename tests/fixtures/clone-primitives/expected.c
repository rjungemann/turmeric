...
int main() {
        {
            int64_t a_198 = INT64_C(42);
            (void)a_198;
            {
                int64_t b_199 = ((int64_t (*)(int64_t))(intptr_t)(dict_Clone_int_singleton.clone))(a_198);
                (void)b_199;
                printf("%lld\n", (long long)(b_199));
            }
        }
        {
            int64_t c_200 = INT64_C(99);
            (void)c_200;
            {
                int64_t d_201 = ((int64_t (*)(int64_t))(intptr_t)(dict_Clone_int_singleton.clone))(c_200);
                (void)d_201;
                printf("%lld\n", (long long)(d_201));
            }
        }
