...
int main() {
        {
            int64_t a_618 = INT64_C(42);
            (void)a_618;
            {
                int64_t b_619 = ((int64_t (*)(int64_t))(intptr_t)(dict_Clone_int_singleton.clone))(a_618);
                (void)b_619;
                printf("%lld\n", (long long)(b_619));
            }
        }
        {
            int64_t c_620 = INT64_C(99);
            (void)c_620;
            {
                int64_t d_621 = ((int64_t (*)(int64_t))(intptr_t)(dict_Clone_int_singleton.clone))(c_620);
                (void)d_621;
                printf("%lld\n", (long long)(d_621));
            }
        }
