...
int main() {
        {
            int64_t a_263 = INT64_C(42);
            (void)a_263;
            {
                int64_t b_264 = ((int64_t (*)(int64_t))(intptr_t)(dict_Clone_int_singleton.clone))(a_263);
                (void)b_264;
                printf("%lld\n", (long long)(b_264));
            }
        }
        {
            int64_t c_265 = INT64_C(99);
            (void)c_265;
            {
                int64_t d_266 = ((int64_t (*)(int64_t))(intptr_t)(dict_Clone_int_singleton.clone))(c_265);
                (void)d_266;
                printf("%lld\n", (long long)(d_266));
            }
        }
