...
int main() {
        {
            int64_t a_210 = INT64_C(42);
            (void)a_210;
            {
                int64_t b_211 = ((int64_t (*)(int64_t))(intptr_t)(dict_Clone_int_singleton.clone))(a_210);
                (void)b_211;
                printf("%lld\n", (long long)(b_211));
            }
        }
        {
            int64_t c_212 = INT64_C(99);
            (void)c_212;
            {
                int64_t d_213 = ((int64_t (*)(int64_t))(intptr_t)(dict_Clone_int_singleton.clone))(c_212);
                (void)d_213;
                printf("%lld\n", (long long)(d_213));
            }
        }
