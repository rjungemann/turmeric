...
int main() {
        {
            ...
            EffectHandlerFrame **__eff_chain_4 = (tur_current_fiber ? (EffectHandlerFrame **)&tur_current_fiber->effect_handler_chain : &global_effect_handler_chain);
            __eff_frame_4.parent = *__eff_chain_4;
            __eff_frame_4.n_cases = 1;
            __eff_frame_4.cases[0].effect_name = "Abort";
            __eff_frame_4.cases[0].handler_fn = __effect_handler_3;
            __eff_frame_4.cases[0].env = NULL;
            *__eff_chain_4 = &__eff_frame_4;
            int64_t __t5 = safe_divide(INT64_C(10), INT64_C(0));
