...
static int64_t safe_divide(int64_t n, int64_t d) {
        ...
        if (((d) == (INT64_C(0)))) {
            int64_t __t1[1];
            __t1[0] = (int64_t)"division by zero";
            int64_t __t2 = tur_effect_perform("Abort", __t1, 1);
            __t0 = __t2;
        } else {
            __t0 = ((d) ? ((n) / (d)) : (fprintf(stderr, "division by zero\n"), abort(), 0));
        }
        return __t0;
}
...
static int64_t __effect_handler_4(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_619 = (const char *)__effect_args[0];
    int64_t k_620 = __k;
    tur_panic(msg_619);
...
static void __handle_body_3(void) {
    tur_current_fiber->result = (int64_t)safe_divide(INT64_C(10), INT64_C(0));
}
...
static int64_t __dispatch_3(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Abort") == 0) {
...
int main() {
        {
            ...
            __eff_frame_3.cases[0].effect_name = "Abort";
