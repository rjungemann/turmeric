...
#endif
#define TUR_TD_tur_adt_HRow
typedef struct tur_adt_HRow {
    int64_t h;
} tur_adt_HRow;
typedef tur_adt_HRow HRow;

static tur_adt_HRow ctor_HRow_HRow(int64_t _0) {
    tur_adt_HRow __r;
    __r.h = _0;
    return __r;
}

#ifndef TUR_CTORALIAS_HRow
#define TUR_CTORALIAS_HRow
#define ctor_HRow ctor_HRow_HRow
#endif
...
static int64_t main__cps(DK *__kont) {
    tur_handler_table_t * _un_unctlhoist_un1610_1611;
    tur_adt_HRow row_1612;
    ...
    _un_unctlhoist_un1610_1611 = __t174;
    tur_adt_HRow __ps_175 = (ctor_HRow_HRow((int64_t)(intptr_t)(_un_unctlhoist_un1610_1611)));
    if (tur_panicking) return ((int64_t)0);
    row_1612 = __ps_175;
    __t1 = (tur_handler_table_t *)(row_1612).h;
