...
static int64_t main__cps(DK *__kont) {
    tur_handler_table_t * _un_unctlhoist_un1619_1620;
    tur_adt_HRow row_1621;
    ...
    _un_unctlhoist_un1619_1620 = __t174;
    tur_adt_HRow __ps_175 = (ctor_HRow_HRow((int64_t)(intptr_t)(_un_unctlhoist_un1619_1620)));
    if (tur_panicking) return ((int64_t)0);
    row_1621 = __ps_175;
    __t1 = (tur_handler_table_t *)(row_1621).h;
