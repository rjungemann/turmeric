...
static void __wh_body_182(void);
static void __wh_body_182(void) {
    int64_t __t183 = tur_effect_perform("Ask", NULL, 0);
    printf("%lld\n", (long long)((__t183) + (INT64_C(1))));
    int64_t __t184;
    __t184 = INT64_C(0);
    tur_current_fiber->result = (int64_t)__t184;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t177;
        {
            ...
            __auto_type __ps_181 = (ctor_HRow((int64_t)(intptr_t)(__t180)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_HRow row_1270 = __ps_181;
            (void)row_1270;
            tur_handler_table_t *__wh_tbl_182 = (tur_handler_table_t *)(row_1270).h;
            TurEffectCaptureCtx __wh_cap_182;
            __wh_cap_182.has_pending_effect = false;
            __wh_cap_182.eff_name = NULL;
            __wh_cap_182.eff_n_args = 0;
            __wh_cap_182.dispatch = tur_handler_dispatch;
            __wh_cap_182.body_env = NULL;
            __wh_cap_182.table = __wh_tbl_182;
            FiberBlock *__wh_fiber_182 = tur_fiber_block_new(__wh_body_182, 0);
            __wh_fiber_182->eff_ctx = &__wh_cap_182;
            EffectHandlerFrame *__wh_parent_182 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
            EffectHandlerFrame __wh_frame_182;
            __wh_frame_182.parent = __wh_parent_182;
            int __wh_nf_182 = __wh_tbl_182->n_entries < 8 ? __wh_tbl_182->n_entries : 8;
            __wh_frame_182.n_cases = __wh_nf_182;
            for (int __wi = 0; __wi < __wh_nf_182; __wi++) {
                __wh_frame_182.cases[__wi].effect_name = __wh_tbl_182->entries[__wi].eff_name;
                __wh_frame_182.cases[__wi].handler_fn = NULL;
                __wh_frame_182.cases[__wi].env = NULL;
            }
            __wh_fiber_182->effect_handler_chain = &__wh_frame_182;
            int64_t __t185 = (int64_t)tur_handler_dispatch(&__wh_cap_182, (int64_t)(intptr_t)__wh_fiber_182, 0);
            if (__wh_fiber_182->done) { free(__wh_fiber_182->stack); free(__wh_fiber_182); }
            __t177 = __t185;
        }
        return (int)__t177;
}
