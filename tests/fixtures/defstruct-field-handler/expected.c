...
static void __wh_body_59(void);
static void __wh_body_59(void) {
    int64_t __t60 = tur_effect_perform("Ask", NULL, 0);
    printf("%lld\n", (long long)((__t60) + (INT64_C(1))));
    int64_t __t61;
    __t61 = INT64_C(0);
    tur_current_fiber->result = (int64_t)__t61;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t55;
        {
            ...
            tur_adt_HRow row_1267 = ctor_HRow((int64_t)(intptr_t)(__t58));
            (void)row_1267;
            tur_handler_table_t *__wh_tbl_59 = (tur_handler_table_t *)(row_1267).h;
            TurEffectCaptureCtx __wh_cap_59;
            __wh_cap_59.has_pending_effect = false;
            __wh_cap_59.eff_name = NULL;
            __wh_cap_59.eff_n_args = 0;
            __wh_cap_59.dispatch = tur_handler_dispatch;
            __wh_cap_59.body_env = NULL;
            __wh_cap_59.table = __wh_tbl_59;
            FiberBlock *__wh_fiber_59 = tur_fiber_block_new(__wh_body_59, 0);
            __wh_fiber_59->eff_ctx = &__wh_cap_59;
            EffectHandlerFrame *__wh_parent_59 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
            EffectHandlerFrame __wh_frame_59;
            __wh_frame_59.parent = __wh_parent_59;
            int __wh_nf_59 = __wh_tbl_59->n_entries < 8 ? __wh_tbl_59->n_entries : 8;
            __wh_frame_59.n_cases = __wh_nf_59;
            for (int __wi = 0; __wi < __wh_nf_59; __wi++) {
                __wh_frame_59.cases[__wi].effect_name = __wh_tbl_59->entries[__wi].eff_name;
                __wh_frame_59.cases[__wi].handler_fn = NULL;
                __wh_frame_59.cases[__wi].env = NULL;
            }
            __wh_fiber_59->effect_handler_chain = &__wh_frame_59;
            int64_t __t62 = (int64_t)tur_handler_dispatch(&__wh_cap_59, (int64_t)(intptr_t)__wh_fiber_59, 0);
            if (__wh_fiber_59->done) { free(__wh_fiber_59->stack); free(__wh_fiber_59); }
            __t55 = __t62;
        }
        return (int)__t55;
}
