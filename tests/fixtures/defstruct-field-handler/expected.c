...
static void __wh_body_158(void);
static void __wh_body_158(void) {
    int64_t __t159 = tur_effect_perform("Ask", NULL, 0);
    printf("%lld\n", (long long)((__t159) + (INT64_C(1))));
    int64_t __t160;
    __t160 = INT64_C(0);
    tur_current_fiber->result = (int64_t)__t160;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t153;
        {
            ...
            __auto_type __ps_157 = (ctor_HRow((int64_t)(intptr_t)(__t156)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_HRow row_1282 = __ps_157;
            (void)row_1282;
            tur_handler_table_t *__wh_tbl_158 = (tur_handler_table_t *)(row_1282).h;
            TurEffectCaptureCtx __wh_cap_158;
            __wh_cap_158.has_pending_effect = false;
            __wh_cap_158.eff_name = NULL;
            __wh_cap_158.eff_n_args = 0;
            __wh_cap_158.dispatch = tur_handler_dispatch;
            __wh_cap_158.body_env = NULL;
            __wh_cap_158.table = __wh_tbl_158;
            FiberBlock *__wh_fiber_158 = tur_fiber_block_new(__wh_body_158, 0);
            __wh_fiber_158->eff_ctx = &__wh_cap_158;
            EffectHandlerFrame *__wh_parent_158 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
            EffectHandlerFrame __wh_frame_158;
            __wh_frame_158.parent = __wh_parent_158;
            int __wh_nf_158 = __wh_tbl_158->n_entries < 8 ? __wh_tbl_158->n_entries : 8;
            __wh_frame_158.n_cases = __wh_nf_158;
            for (int __wi = 0; __wi < __wh_nf_158; __wi++) {
                __wh_frame_158.cases[__wi].effect_name = __wh_tbl_158->entries[__wi].eff_name;
                __wh_frame_158.cases[__wi].handler_fn = NULL;
                __wh_frame_158.cases[__wi].env = NULL;
            }
            __wh_fiber_158->effect_handler_chain = &__wh_frame_158;
            int64_t __t161 = (int64_t)tur_handler_dispatch(&__wh_cap_158, (int64_t)(intptr_t)__wh_fiber_158, 0);
            if (__wh_fiber_158->done) { free(__wh_fiber_158->stack); free(__wh_fiber_158); }
            __t153 = __t161;
        }
        return (int)__t153;
}
