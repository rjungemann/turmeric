...
static int64_t main__cps(DK *__kont) {
    tur_handler_table_t * _un_unctlhoist_un1609_1610;
    tur_adt_HRow row_1611;
    ...
    _un_unctlhoist_un1609_1610 = __t174;
    tur_adt_HRow __ps_175 = (ctor_HRow_HRow((int64_t)(intptr_t)(_un_unctlhoist_un1609_1610)));
    if (tur_panicking) return ((int64_t)0);
    row_1611 = __ps_175;
