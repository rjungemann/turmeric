...
static void __wh_body_186(void);
static void __wh_body_186(void) {
    int64_t __t187 = tur_effect_perform("Ask", NULL, 0);
    printf("%lld\n", (long long)((__t187) + (INT64_C(1))));
    int64_t __t188;
    __t188 = INT64_C(0);
    tur_current_fiber->result = (int64_t)__t188;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t181;
        {
            ...
            __auto_type __ps_185 = (ctor_HRow((int64_t)(intptr_t)(__t184)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_HRow row_1267 = __ps_185;
            (void)row_1267;
            tur_handler_table_t *__wh_tbl_186 = (tur_handler_table_t *)(row_1267).h;
            TurEffectCaptureCtx __wh_cap_186;
            __wh_cap_186.has_pending_effect = false;
            __wh_cap_186.eff_name = NULL;
            __wh_cap_186.eff_n_args = 0;
            __wh_cap_186.dispatch = tur_handler_dispatch;
            __wh_cap_186.body_env = NULL;
            __wh_cap_186.table = __wh_tbl_186;
            FiberBlock *__wh_fiber_186 = tur_fiber_block_new(__wh_body_186, 0);
            __wh_fiber_186->eff_ctx = &__wh_cap_186;
            EffectHandlerFrame *__wh_parent_186 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
            EffectHandlerFrame __wh_frame_186;
            __wh_frame_186.parent = __wh_parent_186;
            int __wh_nf_186 = __wh_tbl_186->n_entries < 8 ? __wh_tbl_186->n_entries : 8;
            __wh_frame_186.n_cases = __wh_nf_186;
            for (int __wi = 0; __wi < __wh_nf_186; __wi++) {
                __wh_frame_186.cases[__wi].effect_name = __wh_tbl_186->entries[__wi].eff_name;
                __wh_frame_186.cases[__wi].handler_fn = NULL;
                __wh_frame_186.cases[__wi].env = NULL;
            }
            __wh_fiber_186->effect_handler_chain = &__wh_frame_186;
            int64_t __t189 = (int64_t)tur_handler_dispatch(&__wh_cap_186, (int64_t)(intptr_t)__wh_fiber_186, 0);
            if (__wh_fiber_186->done) { free(__wh_fiber_186->stack); free(__wh_fiber_186); }
            __t181 = __t189;
        }
        return (int)__t181;
}
