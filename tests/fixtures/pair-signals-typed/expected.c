...
typedef struct Pair__float__float {
    double fst;
    double snd;
} Pair__float__float;
...
static Pair__float__float __fn_903(void *, double);
...
static void * pair_hysignals(int64_t, int64_t);
static Pair__float__float call_hypair(int64_t, double);
static double pair_fst__spec__double_Pair__float__float(Pair__float__float);
static double pair_snd__spec__double_Pair__float__float(Pair__float__float);
...
struct __env_905 { int64_t __fn; int64_t av; int64_t bv; };
static Pair__float__float __fn_903(void * __env_p_906, double t) {
        struct __env_905 *__env___env_905 = (struct __env_905 *)__env_p_906;
        return (Pair__float__float){.fst = (*( tur_thunk_double_double_t *)((void *)(intptr_t)(__env___env_905->av)))((void *)(intptr_t)(__env___env_905->av), t), .snd = (*( tur_thunk_double_double_t *)((void *)(intptr_t)(__env___env_905->bv)))((void *)(intptr_t)(__env___env_905->bv), t)};
}
...
static void * pair_hysignals(int64_t sa, int64_t sb) {
        void * __t27;
        {
            int64_t av = (int64_t)(intptr_t)(sa);
            (void)av;
            int64_t bv = (int64_t)(intptr_t)(sb);
            (void)bv;
            struct __env_905 *__t28 = (struct __env_905 *)malloc(sizeof(struct __env_905));
            __t28->__fn = (int64_t)(intptr_t)__fn_903;
            __t28->av = av;
            __t28->bv = bv;
            void *__t29 = __t28;
            __t27 = __t29;
...
static Pair__float__float call_hypair(int64_t f, double t) {
        return ((Pair__float__float (*)(void*, double))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), t);
}
...
int main(int argc, char **argv) {
        ...
        {
            void * s2_910 = make_hyscaler(2.0);
            (void)s2_910;
            void * s3_911 = make_hyscaler(3.0);
            (void)s3_911;
            Pair__float__float p_912 = call_hypair((int64_t)(intptr_t)(pair_hysignals((int64_t)(intptr_t)(s2_910), (int64_t)(intptr_t)(s3_911))), 1.0);
            (void)p_912;
            printf("%g\n", (double)(pair_fst__spec__double_Pair__float__float(p_912)));
            printf("%g\n", (double)(pair_snd__spec__double_Pair__float__float(p_912)));
        }
        int64_t __t30;
        __t30 = INT64_C(0);
        return (int)__t30;
...
static double pair_fst__spec__double_Pair__float__float(Pair__float__float p) {
        return (p).fst;
}

static double pair_snd__spec__double_Pair__float__float(Pair__float__float p) {
        return (p).snd;
}
