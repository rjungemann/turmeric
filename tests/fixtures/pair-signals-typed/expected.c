...
static void * pair_signals(int64_t, int64_t);
static Pair__float__float call_pair(int64_t, double);
...
static void * pair_signals(int64_t sa, int64_t sb) {
        void * __t27;
        {
...
int main(int argc, char **argv) {
        ...
        {
            void * s2_910 = make_scaler(2.0);
            (void)s2_910;
            void * s3_911 = make_scaler(3.0);
            (void)s3_911;
            Pair__float__float p_912 = call_pair((int64_t)(intptr_t)(pair_signals((int64_t)(intptr_t)(s2_910), (int64_t)(intptr_t)(s3_911))), 1.0);
            (void)p_912;
