...
static tur_adt_Option__int opt_hyif(bool b) {
        ...
        if (b) {
            __t55 = some__spec__tur_adt_Option__int_int64_t(INT64_C(1));
        } else {
...
static tur_adt_Option__int opt_hylet(bool b) {
        tur_adt_Option__int __t56;
        {
            int64_t x_1272 = INT64_C(5);
            (void)x_1272;
            tur_adt_Option__int __t57;
            if (b) {
                __t57 = some__spec__tur_adt_Option__int_int64_t(x_1272);
            } else {
                __t57 = none__spec__tur_adt_Option__int();
            }
            __t56 = __t57;
        }
        return __t56;
...
static tur_adt_Option__int opt_hydo(bool b) {
        ...
        tur_adt_Option__int __t59;
        {
            ...
            if (b) {
                __t60 = some__spec__tur_adt_Option__int_int64_t(y_1274);
            } else {
...
static tur_adt_Result__int__cstr res_hyif(bool b) {
        tur_adt_Result__int__cstr __t61;
        if (b) {
            __t61 = ok__spec__tur_adt_Result__int__cstr_int64_t(INT64_C(7));
        } else {
            __t61 = err__spec__tur_adt_Result__int__cstr_const_char__("bad");
        }
        return __t61;
}
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t62;
        {
            tur_adt_Option__int __t63;
            if (b) {
                __t63 = some__spec__tur_adt_Option__int_int64_t(INT64_C(11));
            } else {
                __t63 = none__spec__tur_adt_Option__int();
            }
            tur_adt_Option__int o_1277 = __t63;
            (void)o_1277;
            int64_t __t64;
            if ((bool)(o_1277).is_some) {
                __t64 = (int64_t)(o_1277).value;
            } else {
                __t64 = INT64_C(0);
            }
            __t62 = __t64;
...
static bool opt_hypred(bool b) {
        ...
        if (b) {
            __t65 = some__spec__tur_adt_Option__int_int64_t(INT64_C(1));
        } else {
            __t65 = none__spec__tur_adt_Option__int();
        }
        return some___spec__bool_tur_adt_Option__int(__t65);
}

static int64_t res_hyok(const tur_adt_Result__int__cstr * r) {
        int64_t __t66;
        if ((bool)(r)->is_ok) {
            __t66 = (int64_t)(r)->ok_val;
        } else {
            __t66 = (INT64_C(0)) - (INT64_C(1));
        }
        return __t66;
}
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__cstr __t67 = res_hyif(true);
    printf("%lld\n", (long long)(res_hyok(&__t67)));
    tur_adt_Result__int__cstr __t68 = res_hyif(false);
    printf("%lld\n", (long long)(res_hyok(&__t68)));
