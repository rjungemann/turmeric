...
static Option__int opt_hyif(bool);
static Option__int opt_hylet(bool);
static Option__int opt_hydo(bool);
static Result__int__cstr res_hyif(bool);
...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t2) {
            ...
            __t3[1] = (int64_t)(intptr_t)__fn_675;
            void *__t4 = __t3;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t5) {
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_711;
            void *__t7 = __t6;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_1026;
            void *__t18 = __t17;
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            bool __t20;
            {
                int64_t h_662 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_662;
                void * k_663 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_663;
                bool __t21;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_662, (void *)(intptr_t)(k_663), (void *)(intptr_t)(keyeq))) {
                    bool __t22;
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)), map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_662, (void *)(intptr_t)(k_663), (void *)(intptr_t)(keyeq)))) {
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t23;
        {
            void * iter_667 = hamt_sliter_hyalloc((void *)(intptr_t)(map_hyhamt(m1)));
            (void)iter_667;
            void * keyeq_668 = hamt_slkeyeq((void *)(intptr_t)(map_hyhamt(m1)));
            (void)keyeq_668;
            bool result_669 = map_hyeq_hyloop((void *)(intptr_t)(iter_667), (void *)(intptr_t)(map_hyhamt(m2)), (void *)(intptr_t)(keyeq_668), (int64_t)(intptr_t)(val_cmp));
            (void)result_669;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_667));
            bool __t24;
            __t24 = result_669;
            __t23 = __t24;
        }
...
static int64_t ok(int64_t x) {
        return tur_box_ok((int64_t)(intptr_t)x);
}

static int64_t err(int64_t e) {
        return tur_box_err((int64_t)(intptr_t)e);
}
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            int64_t __t31;
            {
                int64_t out_902 = (int64_t)(intptr_t)(tcons__spec__Cons__int___int64_t_int64_t((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f))));
                (void)out_902;
                __t31 = out_902;
            }
            __t30 = __t31;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            int64_t __t33;
            {
                int64_t out_909 = (int64_t)(intptr_t)(tcons__spec__Cons__int___int64_t_int64_t(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2)));
                (void)out_909;
                __t33 = out_909;
            }
            __t32 = __t33;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_972 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_972;
                void * k_973 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_973;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_972, (void *)(intptr_t)(k_973), (void *)(intptr_t)(keyeq))) {
                    void * __t34 = iter;
                    void * __t35 = s2_hamt;
                    void * __t36 = keyeq;
                    iter = __t34;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t37;
        {
            void * iter_976 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_976;
            void * keyeq_977 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_977;
            bool result_978 = set_hyeq_hyloop((void *)(intptr_t)(iter_976), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_977));
            (void)result_978;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_976));
            bool __t38;
            __t38 = result_978;
            __t37 = __t38;
        }
...
static Option__int opt_hyif(bool b) {
        Option__int __t44;
        if (b) {
            __t44 = some__spec__Option__int_int64_t(INT64_C(1));
        } else {
            __t44 = none__spec__Option__int();
        }
        return __t44;
}
...
static Option__int opt_hylet(bool b) {
        Option__int __t45;
        {
            int64_t x_1030 = INT64_C(5);
            (void)x_1030;
            Option__int __t46;
            if (b) {
                __t46 = some__spec__Option__int_int64_t(x_1030);
            } else {
...
static Option__int opt_hydo(bool b) {
        ...
        Option__int __t48;
        {
            int64_t y_1032 = INT64_C(9);
            (void)y_1032;
            Option__int __t49;
            if (b) {
                __t49 = some__spec__Option__int_int64_t(y_1032);
            } else {
                __t49 = none__spec__Option__int();
            }
            __t48 = __t49;
        }
        __t47 = __t48;
...
static Result__int__cstr res_hyif(bool b) {
        Result__int__cstr __t50;
        if (b) {
            __t50 = ok__spec__Result__int__cstr_int64_t(INT64_C(7));
        } else {
            __t50 = err__spec__Result__int__cstr_const_char__("bad");
        }
        return __t50;
}
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t51;
        {
            Option__int __t52;
            if (b) {
                __t52 = some__spec__Option__int_int64_t(INT64_C(11));
            } else {
                tur_option_t *__t53 = (tur_option_t *)(intptr_t)(none());
                __t52 = (__t53 ? (Option__int){.is_some = __t53->is_some, .value = __t53->value} : (Option__int){0});
            }
            Option__int o_1035 = __t52;
            (void)o_1035;
            int64_t __t54;
            if ((o_1035).is_some) {
                __t54 = (o_1035).value;
...
static bool opt_hypred(bool b) {
        Option__int __t55;
        if (b) {
            __t55 = some__spec__Option__int_int64_t(INT64_C(1));
        } else {
            tur_option_t *__t56 = (tur_option_t *)(intptr_t)(none());
            __t55 = (__t56 ? (Option__int){.is_some = __t56->is_some, .value = __t56->value} : (Option__int){0});
        }
        return some___spec__bool_Option__int(__t55);
}
...
int main(int argc, char **argv) {
    ...
    puts((opt_hypred(false)) ? "true" : "false");
    return 0;
}
