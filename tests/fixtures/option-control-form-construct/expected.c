...
static tur_adt_Option__int opt_hylet(bool b) {
        {
            int64_t x_1625 = INT64_C(5);
            (void)x_1625;
            if (b) {
                tur_adt_Option__int __ps_174 = (some__spec__tur_adt_Option__int_int64_t(x_1625));
                if (tur_panicking) return (tur_adt_Option__int){0};
                return __ps_174;
            } else {
...
static tur_adt_Option__int opt_hydo(bool b) {
        {
            int64_t y_1627 = INT64_C(9);
            (void)y_1627;
            if (b) {
                tur_adt_Option__int __ps_176 = (some__spec__tur_adt_Option__int_int64_t(y_1627));
                if (tur_panicking) return (tur_adt_Option__int){0};
                return __ps_176;
            } else {
...
static int64_t opt_hyconsume(bool b) {
        {
            ...
            tur_adt_Option__int o_1630 = __t180;
            (void)o_1630;
            bool __ps_183 = (some___spec__bool_tur_adt_Option__int(o_1630));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_183) {
                return unwrap__spec__int64_t_tur_adt_Option__int(o_1630);
            } else {
                return INT64_C(0);
            }
        }
