...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                bool __t100;
                if ((t1_997) == (INT64_C(0))) {
                    __t100 = (t2_998) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_998) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        __auto_type __ps_102 = (cons_hyeq_hygo(t1_997, t2_998));
                        if (tur_panicking) return (bool){0};
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1013 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1013;
                __t109 = out_1013;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1088 = __ps_120;
            (void)iter_1088;
            __auto_type __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1089 = __ps_122;
            (void)keyeq_1089;
            __auto_type __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1088), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1089)));
            if (tur_panicking) return (bool){0};
            bool result_1090 = __ps_124;
            (void)result_1090;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                __auto_type __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1217));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1218 = __ps_147;
                (void)_un_unv_1218;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t150;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1267 = __ps_151;
            (void)r_1267;
            int64_t __t152;
            __auto_type __ps_153 = (schema_hydecode_hyok_qu(r_1267));
            if (tur_panicking) return (int64_t){0};
            if (__ps_153) {
                __auto_type __ps_154 = (schema_hydecode_hyvalue(r_1267));
                if (tur_panicking) return (int64_t){0};
                __t152 = __ps_154;
            } else {
                __auto_type __ps_155 = (schema_hydecode_hyerrors(r_1267));
                if (tur_panicking) return (int64_t){0};
...
static tur_adt_Option__int opt_hylet(bool b) {
        ...
        {
            int64_t x_1290 = INT64_C(5);
            (void)x_1290;
            tur_adt_Option__int __t162;
            if (b) {
                __auto_type __ps_163 = (some__spec__tur_adt_Option__int_int64_t(x_1290));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t162 = __ps_163;
            } else {
...
static tur_adt_Option__int opt_hydo(bool b) {
        ...
        {
            int64_t y_1292 = INT64_C(9);
            (void)y_1292;
            tur_adt_Option__int __t167;
            if (b) {
                __auto_type __ps_168 = (some__spec__tur_adt_Option__int_int64_t(y_1292));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t167 = __ps_168;
            } else {
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t173;
        {
            ...
            tur_adt_Option__int o_1295 = __t174;
            (void)o_1295;
            int64_t __t177;
            if ((bool)(o_1295).is_some) {
                __t177 = (int64_t)(o_1295).value;
            } else {
                __t177 = INT64_C(0);
            }
            __t173 = __t177;
