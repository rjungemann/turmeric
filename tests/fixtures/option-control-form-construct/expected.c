...
static tur_adt_Option__int opt_hylet(bool b) {
        tur_adt_Option__int __t185;
        {
            ...
            if (b) {
                tur_adt_Option__int __ps_187 = (some__spec__tur_adt_Option__int_int64_t(x_1441));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t186 = __ps_187;
            } else {
...
static tur_adt_Option__int opt_hydo(bool b) {
        ...
        tur_adt_Option__int __t190;
        {
            ...
            if (b) {
                tur_adt_Option__int __ps_192 = (some__spec__tur_adt_Option__int_int64_t(y_1443));
                if (tur_panicking) return (tur_adt_Option__int){0};
                __t191 = __ps_192;
            } else {
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t197;
        {
            ...
            tur_adt_Option__int o_1446 = __t198;
            (void)o_1446;
            int64_t __t201;
            bool __ps_202 = (some___spec__bool_tur_adt_Option__int(o_1446));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_202) {
                int64_t __ps_203 = (unwrap__spec__int64_t_tur_adt_Option__int(o_1446));
                if (tur_panicking) return ((int64_t)0);
                __t201 = __ps_203;
            } else {
                __t201 = INT64_C(0);
