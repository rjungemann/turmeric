...
static bool __fn_993(int64_t, int64_t);
...
static bool __fn_993(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_993;
            void *__t18 = __t17;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_939 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_939;
                void * k_940 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_940;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_939, (void *)(intptr_t)(k_940), (void *)(intptr_t)(keyeq))) {
                    void * __t32 = iter;
                    void * __t33 = s2_hamt;
                    void * __t34 = keyeq;
                    iter = __t32;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t35;
        {
            void * iter_943 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_943;
            void * keyeq_944 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_944;
            bool result_945 = set_hyeq_hyloop((void *)(intptr_t)(iter_943), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_944));
            (void)result_945;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_943));
            bool __t36;
            __t36 = result_945;
            __t35 = __t36;
        }
...
static Option__int opt_hyif(bool b) {
        int64_t __t42;
        if (b) {
            __t42 = some(INT64_C(1));
        } else {
            __t42 = none();
        }
                tur_option_t *__t43 = (tur_option_t *)(intptr_t)(__t42);
...
static Option__int opt_hylet(bool b) {
        int64_t __t44;
        {
            ...
            __t44 = __t45;
                ...
                tur_option_t *__t46 = (tur_option_t *)(intptr_t)(__t44);
...
static Option__int opt_hydo(bool b) {
        ...
        __t47 = __t48;
                tur_option_t *__t50 = (tur_option_t *)(intptr_t)(__t47);
        return (__t50 ? (Option__int){.is_some = __t50->is_some, .value = __t50->value} : (Option__int){0});
}
...
static Result__int__cstr res_hyif(bool b) {
        ...
        if (b) {
            ...
            __t51 = err(((union { const char * s; int64_t d; }){.s = "bad"}).d);
        }
                tur_result_box_t *__t52 = (tur_result_box_t *)(intptr_t)(__t51);
        return (Result__int__cstr){.is_ok = __t52->is_ok, .ok_val = __t52->ok_val, .err_val = (const char *)(intptr_t)(__t52->err_val)};
}
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t53;
        {
            int64_t __t54;
            if (b) {
                __t54 = some(INT64_C(11));
            } else {
                __t54 = none();
            }
            int64_t o_1002 = __t54;
            (void)o_1002;
            int64_t __t55;
            if (((o_1002) ? ((Option *)(intptr_t)(o_1002))->is_some : 0)) {
                __t55 = ((o_1002) ? ((Option *)(intptr_t)(o_1002))->value : 0);
            } else {
                __t55 = INT64_C(0);
            }
            __t53 = __t55;
