...
static int64_t ok(int64_t x) {
        return ctor_Result(true, x, (int64_t){0});
}

static int64_t err(int64_t e) {
        return ctor_Result(false, (int64_t){0}, e);
}
...
static tur_adt_Option__int opt_hyif(bool b) {
        tur_adt_Option__int __t50;
        if (b) {
            __t50 = some__spec__tur_adt_Option__int_int64_t(INT64_C(1));
        } else {
            __t50 = none__spec__tur_adt_Option__int();
        }
        return __t50;
}

static tur_adt_Option__int opt_hylet(bool b) {
        tur_adt_Option__int __t51;
        {
            int64_t x_1269 = INT64_C(5);
            (void)x_1269;
            tur_adt_Option__int __t52;
            if (b) {
                __t52 = some__spec__tur_adt_Option__int_int64_t(x_1269);
            } else {
                __t52 = none__spec__tur_adt_Option__int();
            }
            __t51 = __t52;
        }
        return __t51;
...
static tur_adt_Option__int opt_hydo(bool b) {
        tur_adt_Option__int __t53;
        tur_adt_Option__int __t54;
        {
            int64_t y_1271 = INT64_C(9);
            (void)y_1271;
            tur_adt_Option__int __t55;
            if (b) {
                __t55 = some__spec__tur_adt_Option__int_int64_t(y_1271);
            } else {
                __t55 = none__spec__tur_adt_Option__int();
            }
            __t54 = __t55;
        }
        __t53 = __t54;
...
static tur_adt_Result__int__cstr res_hyif(bool b) {
        tur_adt_Result__int__cstr __t56;
        if (b) {
            __t56 = ok__spec__tur_adt_Result__int__cstr_int64_t(INT64_C(7));
        } else {
            __t56 = err__spec__tur_adt_Result__int__cstr_const_char__("bad");
        }
        return __t56;
}
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t57;
        {
            tur_adt_Option__int __t58;
            if (b) {
                __t58 = some__spec__tur_adt_Option__int_int64_t(INT64_C(11));
            } else {
                __t58 = none__spec__tur_adt_Option__int();
            }
            tur_adt_Option__int o_1274 = __t58;
            (void)o_1274;
            int64_t __t59;
            if ((bool)(o_1274).is_some) {
                __t59 = (int64_t)(o_1274).value;
            } else {
                __t59 = INT64_C(0);
            }
            __t57 = __t59;
...
static bool opt_hypred(bool b) {
        ...
        if (b) {
            __t60 = some__spec__tur_adt_Option__int_int64_t(INT64_C(1));
        } else {
            __t60 = none__spec__tur_adt_Option__int();
        }
        return some___spec__bool_tur_adt_Option__int(__t60);
}

static int64_t res_hyok(const tur_adt_Result__int__cstr * r) {
        int64_t __t61;
        if ((bool)(r)->is_ok) {
            __t61 = (int64_t)(r)->ok_val;
        } else {
            __t61 = (INT64_C(0)) - (INT64_C(1));
        }
        return __t61;
}
...
static tur_adt_Result__int__cstr ok__spec__tur_adt_Result__int__cstr_int64_t(int64_t x) {
        return ctor_Result__int__cstr(true, x, (const char *){0});
}

static tur_adt_Result__int__cstr err__spec__tur_adt_Result__int__cstr_const_char__(const char * e) {
        return ctor_Result__int__cstr(false, (int64_t){0}, e);
}
...
int main(int argc, char **argv) {
    ...
    printf("%lld\n", (long long)((int64_t)(opt_hyif(true)).value));
    puts(((bool)(opt_hyif(false)).is_some) ? "true" : "false");
    printf("%lld\n", (long long)((int64_t)(opt_hylet(true)).value));
    printf("%lld\n", (long long)((int64_t)(opt_hydo(true)).value));
    tur_adt_Result__int__cstr __t62 = res_hyif(true);
    printf("%lld\n", (long long)(res_hyok(&__t62)));
    tur_adt_Result__int__cstr __t63 = res_hyif(false);
    printf("%lld\n", (long long)(res_hyok(&__t63)));
