...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        __t2[1] = (int64_t)(intptr_t)__fn_590;
        void *__t3 = __t2;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t4) {
            ...
            __t5[1] = (int64_t)(intptr_t)__fn_626;
            void *__t6 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t13[1] = (int64_t)(intptr_t)__fn_808;
        void *__t14 = __t13;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t15) {
            ...
            __t16[1] = (int64_t)(intptr_t)__fn_904;
            void *__t17 = __t16;
...
static Option__int opt_hyif(bool b) {
        int64_t __t29;
        if (b) {
            __t29 = some(INT64_C(1));
        } else {
            __t29 = none();
        }
                tur_option_t *__t30 = (tur_option_t *)(intptr_t)(__t29);
...
static Option__int opt_hylet(bool b) {
        int64_t __t31;
        {
            ...
            __t31 = __t32;
                ...
                tur_option_t *__t33 = (tur_option_t *)(intptr_t)(__t31);
        return (__t33 ? (Option__int){.is_some = __t33->is_some, .value = __t33->value} : (Option__int){0});
}
...
static Option__int opt_hydo(bool b) {
        ...
        __t34 = __t35;
                tur_option_t *__t37 = (tur_option_t *)(intptr_t)(__t34);
        return (__t37 ? (Option__int){.is_some = __t37->is_some, .value = __t37->value} : (Option__int){0});
}
...
static Result__int__cstr res_hyif(bool b) {
        ...
        if (b) {
            ...
            __t38 = err(((union { const char * s; int64_t d; }){.s = "bad"}).d);
        }
                tur_result_box_t *__t39 = (tur_result_box_t *)(intptr_t)(__t38);
        return (Result__int__cstr){.is_ok = __t39->is_ok, .ok_val = __t39->ok_val, .err_val = (const char *)(intptr_t)(__t39->err_val)};
}
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t40;
        {
            ...
            (void)o_913;
            int64_t __t42;
            if (((o_913) ? ((Option *)(intptr_t)(o_913))->is_some : 0)) {
                __t42 = ((o_913) ? ((Option *)(intptr_t)(o_913))->value : 0);
            } else {
                __t42 = INT64_C(0);
            }
            __t40 = __t42;
...
static bool opt_hypred(bool b) {
        int64_t __t43;
        if (b) {
            __t43 = some(INT64_C(1));
        } else {
            __t43 = none();
        }
        return some_qu(__t43);
}

static int64_t res_hyok(const Result__int__cstr * r) {
        int64_t __t44;
        if (((Result *)(intptr_t)(r))->is_ok) {
            __t44 = ((Result *)(intptr_t)(r))->ok_val;
        } else {
            __t44 = (INT64_C(0)) - (INT64_C(1));
        }
        return __t44;
}
...
int main(int argc, char **argv) {
    ...
    Result__int__cstr __t45 = res_hyif(true);
    printf("%lld\n", (long long)(res_hyok(&__t45)));
    Result__int__cstr __t46 = res_hyif(false);
    printf("%lld\n", (long long)(res_hyok(&__t46)));
