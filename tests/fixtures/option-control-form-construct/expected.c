...
static Option__int opt_hyif(bool b) {
        Option__int __t50;
        if (b) {
            __t50 = some__spec__Option__int_int64_t(INT64_C(1));
        } else {
            __t50 = none__spec__Option__int();
        }
        return __t50;
}
...
static Option__int opt_hylet(bool b) {
        Option__int __t51;
        {
            int64_t x_1251 = INT64_C(5);
            (void)x_1251;
            Option__int __t52;
            if (b) {
                __t52 = some__spec__Option__int_int64_t(x_1251);
            } else {
...
static Option__int opt_hydo(bool b) {
        ...
        Option__int __t54;
        {
            int64_t y_1253 = INT64_C(9);
            (void)y_1253;
            Option__int __t55;
            if (b) {
                __t55 = some__spec__Option__int_int64_t(y_1253);
            } else {
...
static Result__int__cstr res_hyif(bool b) {
        Result__int__cstr __t56;
        if (b) {
            __t56 = ok__spec__Result__int__cstr_int64_t(INT64_C(7));
        } else {
            __t56 = err__spec__Result__int__cstr_const_char__("bad");
        }
        return __t56;
}
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t57;
        {
            Option__int __t58;
            if (b) {
                __t58 = some__spec__Option__int_int64_t(INT64_C(11));
            } else {
                tur_option_t *__t59 = (tur_option_t *)(intptr_t)(none());
                __t58 = (__t59 ? (Option__int){.is_some = __t59->is_some, .value = __t59->value} : (Option__int){0});
            }
            Option__int o_1256 = __t58;
            (void)o_1256;
            int64_t __t60;
            if ((o_1256).is_some) {
                __t60 = (o_1256).value;
...
static bool opt_hypred(bool b) {
        Option__int __t61;
        if (b) {
            __t61 = some__spec__Option__int_int64_t(INT64_C(1));
        } else {
            tur_option_t *__t62 = (tur_option_t *)(intptr_t)(none());
            __t61 = (__t62 ? (Option__int){.is_some = __t62->is_some, .value = __t62->value} : (Option__int){0});
        }
        return some___spec__bool_Option__int(__t61);
}

static int64_t res_hyok(const Result__int__cstr * r) {
        int64_t __t63;
        if (((Result *)(intptr_t)(r))->is_ok) {
            __t63 = ((Result *)(intptr_t)(r))->ok_val;
        } else {
            __t63 = (INT64_C(0)) - (INT64_C(1));
        }
        return __t63;
}
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t66 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t66 = (Cons__int){.head = h, .tail = t};
        return __t66;
}
...
int main(int argc, char **argv) {
    ...
    Result__int__cstr __t64 = res_hyif(true);
    printf("%lld\n", (long long)(res_hyok(&__t64)));
    Result__int__cstr __t65 = res_hyif(false);
    printf("%lld\n", (long long)(res_hyok(&__t65)));
