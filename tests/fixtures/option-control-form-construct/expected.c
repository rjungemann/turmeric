...
static int64_t __inst_Applicative_ap_Option(int64_t ff, int64_t fa) {
        ...
        if (some___spec__bool_Option__opaque((__t12 ? (Option__opaque){.is_some = __t12->is_some, .value = (void *)(__t12->value)} : (Option__opaque){0}))) {
            ...
            if (some_qu(fa)) {
                int64_t __t14;
                {
                    int64_t _un_uncall_unhead_un740_741 = (int64_t)(intptr_t)(((ff) ? ((Option *)(intptr_t)(ff))->value : 0));
                    (void)_un_uncall_unhead_un740_741;
                    __t14 = ((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(_un_uncall_unhead_un740_741)))[0])((void *)(intptr_t)(_un_uncall_unhead_un740_741), ((fa) ? ((Option *)(intptr_t)(fa))->value : 0));
                }
                __t13 = some(__t14);
            } else {
                __t13 = none();
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t23[1] = (int64_t)(intptr_t)__fn_891;
        void *__t24 = __t23;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t25) {
            ...
            __t26[1] = (int64_t)(intptr_t)__fn_1011;
            void *__t27 = __t26;
...
static int64_t err(int64_t e) {
        return tur_err((int64_t)(intptr_t)e);
}
...
static Option__int opt_hyif(bool b) {
        int64_t __t51;
        if (b) {
            __t51 = some(INT64_C(1));
        } else {
            __t51 = none();
        }
                tur_option_t *__t52 = (tur_option_t *)(intptr_t)(__t51);
...
static Option__int opt_hylet(bool b) {
        int64_t __t53;
        {
            ...
            __t53 = __t54;
                ...
                tur_option_t *__t55 = (tur_option_t *)(intptr_t)(__t53);
        return (__t55 ? (Option__int){.is_some = __t55->is_some, .value = __t55->value} : (Option__int){0});
}
...
static Option__int opt_hydo(bool b) {
        ...
        __t56 = __t57;
                tur_option_t *__t59 = (tur_option_t *)(intptr_t)(__t56);
        return (__t59 ? (Option__int){.is_some = __t59->is_some, .value = __t59->value} : (Option__int){0});
}
...
static Result__int__cstr res_hyif(bool b) {
        ...
        if (b) {
            ...
            __t60 = err(((union { const char * s; int64_t d; }){.s = "bad"}).d);
        }
                tur_result_box_t *__t61 = (tur_result_box_t *)(intptr_t)(__t60);
        return (Result__int__cstr){.is_ok = __t61->is_ok, .ok_val = __t61->ok_val, .err_val = (const char *)(intptr_t)(__t61->err_val)};
}
...
static int64_t opt_hyconsume(bool b) {
        int64_t __t62;
        {
            int64_t __t63;
            if (b) {
                __t63 = some(INT64_C(11));
            } else {
                __t63 = none();
            }
            int64_t o_1020 = __t63;
            (void)o_1020;
            int64_t __t64;
            if (((o_1020) ? ((Option *)(intptr_t)(o_1020))->is_some : 0)) {
                __t64 = ((o_1020) ? ((Option *)(intptr_t)(o_1020))->value : 0);
            } else {
                __t64 = INT64_C(0);
            }
            __t62 = __t64;
...
static bool opt_hypred(bool b) {
        int64_t __t65;
        if (b) {
            __t65 = some(INT64_C(1));
        } else {
            __t65 = none();
        }
        tur_option_t *__t66 = (tur_option_t *)(intptr_t)(__t65);
        return some___spec__bool_Option__int((__t66 ? (Option__int){.is_some = __t66->is_some, .value = __t66->value} : (Option__int){0}));
}

static int64_t res_hyok(const Result__int__cstr * r) {
        int64_t __t67;
        if (((Result *)(intptr_t)(r))->is_ok) {
            __t67 = ((Result *)(intptr_t)(r))->ok_val;
        } else {
            __t67 = (INT64_C(0)) - (INT64_C(1));
        }
        return __t67;
}
...
int main(int argc, char **argv) {
    ...
    Result__int__cstr __t68 = res_hyif(true);
    printf("%lld\n", (long long)(res_hyok(&__t68)));
    Result__int__cstr __t69 = res_hyif(false);
