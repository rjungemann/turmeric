...
static int64_t __fn_1471(void * __env_p_1474) {
        ...
        int64_t __ps_124 = (pong(__env___env_1473->acc, (__env___env_1473->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}
...
static int64_t __fn_1478(void * __env_p_1481) {
        ...
        int64_t __ps_125 = (ping(__env___env_1480->acc, (__env___env_1480->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_125;
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_855 = __ps_158;
        bool __ps_159 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_854, (void *)(intptr_t)(k_855), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_159;
        if (__t1) {
            int64_t __ps_160 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_161 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_854, (void *)(intptr_t)(k_855), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t163;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_859 = __ps_165;
            (void)iter_859;
            void * __ps_166 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_167 = (hamt_slkeyeq((void *)(intptr_t)(__ps_166)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_860 = __ps_167;
            (void)keyeq_860;
            void * __ps_168 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_169 = (map_hyeq_hyloop((void *)(intptr_t)(iter_859), (void *)(intptr_t)(__ps_168), (void *)(intptr_t)(keyeq_860), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_861 = __ps_169;
            (void)result_861;
        ...
        if (__ps_188) {
            bool __t189;
            {
                ...
                if ((t1_1139) == (INT64_C(0))) {
                    __t190 = (t2_1140) == (INT64_C(0));
                } else {
                    bool __t191;
                    if ((t2_1140) == (INT64_C(0))) {
                        __t191 = false;
                    } else {
                        bool __ps_192 = (cons_hyeq_hygo(t1_1139, t2_1140));
                        if (tur_panicking) return ((bool)0);
                        __t191 = __ps_192;
                    }
                    __t190 = __t191;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_198) {
            ...
            int64_t __t199;
            {
                ...
                int64_t out_1155 = (int64_t)(intptr_t)(__ps_203);
                (void)out_1155;
                __t199 = out_1155;
            }
            __t197 = __t199;
        ...
        if (__ps_208) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1226 = __ps_209;
                (void)h_1226;
                void * __ps_210 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1227 = __ps_210;
                (void)k_1227;
                bool __ps_211 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1226, (void *)(intptr_t)(k_1227), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_211) {
                    void * __t212 = iter;
                    void * __t213 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t215;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1230 = __ps_217;
            (void)iter_1230;
            void * __ps_218 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_219 = (hamt_slkeyeq((void *)(intptr_t)(__ps_218)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1231 = __ps_219;
            (void)keyeq_1231;
            void * __ps_220 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_221 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1230), (void *)(intptr_t)(__ps_220), (void *)(intptr_t)(keyeq_1231)));
            if (tur_panicking) return ((bool)0);
            bool result_1232 = __ps_221;
            (void)result_1232;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t242;
        {
            ...
            {
                tur_adt_Vec__int * __ps_244 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1362));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1363 = __ps_244;
                (void)_un_unv_1363;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t248;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1413 = __ps_249;
            (void)r_1413;
            int64_t __t250;
            bool __ps_251 = (schema_hydecode_hyok_qu(r_1413));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_251) {
                int64_t __ps_252 = (schema_hydecode_hyvalue(r_1413));
                if (tur_panicking) return ((int64_t)0);
                __t250 = __ps_252;
            } else {
                int64_t __ps_253 = (schema_hydecode_hyerrors(r_1413));
                if (tur_panicking) return ((int64_t)0);
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1470) == (INT64_C(0))) {
     int64_t __t270;
     bool __ps_271 = (ok___spec__bool_tur_adt_Result__int__int(acc_1469));
     if (tur_panicking) return ((int64_t)0);
     if (__ps_271) {
         __t270 = INT64_C(100);
     } else {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1469, sizeof(tur_adt_Result__int__int)); __n272->saved[0] = (int64_t)(intptr_t)__ab; }
     __n272->saved[1] = (int64_t)(intptr_t)(n_1470);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1476, sizeof(tur_adt_Result__int__int)); __n272->saved[2] = (int64_t)(intptr_t)__ab; }
     __n272->saved[3] = (int64_t)(intptr_t)(n_1477);
     __n272->saved[4] = (int64_t)(intptr_t)(__t266);
     __n272->saved[5] = (int64_t)(intptr_t)(__t267);
     __n272->saved[6] = (int64_t)(intptr_t)(__t268);
     __n272->saved[7] = (int64_t)(intptr_t)(__t269);
     __k = __n272; __pc = 3; break;
    }
   }
   case 3: {
    tur_adt_Result__int__int __ra273_0 = (acc_1469);
    int64_t __ra273_1 = ((n_1470) - (INT64_C(1)));
    acc_1476 = __ra273_0;
    n_1477 = __ra273_1;
    __pc = 2; break;
   }
   case 4: {
    ...
    __t266 = (int64_t)(intptr_t)(__k->saved[4]);
    __t267 = (int64_t)(intptr_t)(__k->saved[5]);
    __t268 = (int64_t)(intptr_t)(__k->saved[6]);
    __t269 = (int64_t)(intptr_t)(__k->saved[7]);
    ...
    (void)(__box272);
    int64_t __t274;
    bool __ps_275 = (ok___spec__bool_tur_adt_Result__int__int(acc_1469));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_275) {
        __t274 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1470) + (__t274)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1477) == (INT64_C(0))) {
     int64_t __t276;
     bool __ps_277 = (ok___spec__bool_tur_adt_Result__int__int(acc_1476));
     if (tur_panicking) return ((int64_t)0);
     if (__ps_277) {
         __t276 = INT64_C(300);
     } else {
     ...
     __n278->tag = 6; __n278->boundary = __b278; __n278->next = __k;
     __n278->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1469, sizeof(tur_adt_Result__int__int)); __n278->saved[0] = (int64_t)(intptr_t)__ab; }
     __n278->saved[1] = (int64_t)(intptr_t)(n_1470);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1476, sizeof(tur_adt_Result__int__int)); __n278->saved[2] = (int64_t)(intptr_t)__ab; }
     __n278->saved[3] = (int64_t)(intptr_t)(n_1477);
     __n278->saved[4] = (int64_t)(intptr_t)(__t266);
     __n278->saved[5] = (int64_t)(intptr_t)(__t267);
     __n278->saved[6] = (int64_t)(intptr_t)(__t268);
     __n278->saved[7] = (int64_t)(intptr_t)(__t269);
     __k = __n278; __pc = 5; break;
    }
   }
   case 5: {
    tur_adt_Result__int__int __ra279_0 = (acc_1476);
    int64_t __ra279_1 = ((n_1477) - (INT64_C(1)));
    acc_1469 = __ra279_0;
    n_1470 = __ra279_1;
    __pc = 1; break;
   }
   case 6: {
    ...
    (void)(__box278);
    int64_t __t280;
    bool __ps_281 = (ok___spec__bool_tur_adt_Result__int__int(acc_1476));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_281) {
        __t280 = INT64_C(2);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1477) + (__t280)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_282 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_283 = (ping(__ps_282, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_283));
    tur_adt_Result__int__int __ps_284 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_285 = (ping(__ps_284, INT64_C(6)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_285));
    int64_t __t286;
    __t286 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_290 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_291 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_291;
}
