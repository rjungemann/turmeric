...
struct __env_1438 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1436(void * __env_p_1439) {
        ...
        int64_t __ps_40 = (pong(__env___env_1438->acc, (__env___env_1438->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_40;
}

struct __env_1445 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
static void drop_glue___env_1445(void *__p) {
    struct __env_1445 *__e = (struct __env_1445 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1443(void * __env_p_1446) {
        struct __env_1445 *__env___env_1445 = (struct __env_1445 *)__env_p_1446;
        int64_t __ps_41 = (ping(__env___env_1445->acc, (__env___env_1445->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_41;
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_815, (void *)(intptr_t)(k_816), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_820 = __ps_77;
            (void)iter_820;
            void * __ps_78 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_79 = (hamt_slkeyeq((void *)(intptr_t)(__ps_78)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_821 = __ps_79;
            (void)keyeq_821;
            void * __ps_80 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_820), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_821), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_822 = __ps_81;
            (void)result_822;
        ...
        if (__ps_100) {
            bool __t101;
            {
                ...
                if ((t1_1100) == (INT64_C(0))) {
                    __t102 = (t2_1101) == (INT64_C(0));
                } else {
                    bool __t103;
                    if ((t2_1101) == (INT64_C(0))) {
                        __t103 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1100, t2_1101));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_104;
                    }
                    __t102 = __t103;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1116 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1116;
                __t111 = out_1116;
            }
            __t109 = __t111;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t120;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1191 = __ps_122;
            (void)iter_1191;
            void * __ps_123 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_124 = (hamt_slkeyeq((void *)(intptr_t)(__ps_123)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1192 = __ps_124;
            (void)keyeq_1192;
            void * __ps_125 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_126 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1191), (void *)(intptr_t)(__ps_125), (void *)(intptr_t)(keyeq_1192)));
            if (tur_panicking) return ((bool)0);
            bool result_1193 = __ps_126;
            (void)result_1193;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t147;
        {
            ...
            {
                tur_adt_Vec__int * __ps_149 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1320));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1321 = __ps_149;
                (void)_un_unv_1321;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t153;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1371 = __ps_154;
            (void)r_1371;
            int64_t __t155;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1371));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                int64_t __ps_157 = (schema_hydecode_hyvalue(r_1371));
                if (tur_panicking) return ((int64_t)0);
                __t155 = __ps_157;
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1371));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Result__int__int acc_1434; memset(&acc_1434, 0, sizeof(tur_adt_Result__int__int));
 int64_t n_1435 = 0;
 tur_adt_Result__int__int acc_1441; memset(&acc_1441, 0, sizeof(tur_adt_Result__int__int));
 int64_t n_1442 = 0;
 int64_t __t170 = 0;
 int64_t __t171 = 0;
 int64_t __t172 = 0;
 ...
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1434, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   n_1435 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1441, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   n_1442 = (int64_t)(intptr_t)(__a1);
   break; }
 }
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1435) == (INT64_C(0))) {
     int64_t __t174;
     bool __ps_175 = (ok___spec__bool_tur_adt_Result__int__int(acc_1434));
     if (tur_panicking) return ((int64_t)0);
     if (__ps_175) {
         __t174 = INT64_C(100);
     } else {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1434, sizeof(tur_adt_Result__int__int)); __n176->saved[0] = (int64_t)(intptr_t)__ab; }
     __n176->saved[1] = (int64_t)(intptr_t)(n_1435);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1441, sizeof(tur_adt_Result__int__int)); __n176->saved[2] = (int64_t)(intptr_t)__ab; }
     __n176->saved[3] = (int64_t)(intptr_t)(n_1442);
     __n176->saved[4] = (int64_t)(intptr_t)(__t170);
     __n176->saved[5] = (int64_t)(intptr_t)(__t171);
     __n176->saved[6] = (int64_t)(intptr_t)(__t172);
     __n176->saved[7] = (int64_t)(intptr_t)(__t173);
     __k = __n176; __pc = 3; break;
    }
   }
   case 3: {
    tur_adt_Result__int__int __ra177_0 = (acc_1434);
    int64_t __ra177_1 = ((n_1435) - (INT64_C(1)));
    acc_1441 = __ra177_0;
    n_1442 = __ra177_1;
    __pc = 2; break;
   }
   case 4: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1434, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1435 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&acc_1441, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1442 = (int64_t)(intptr_t)(__k->saved[3]);
    __t170 = (int64_t)(intptr_t)(__k->saved[4]);
    __t171 = (int64_t)(intptr_t)(__k->saved[5]);
    __t172 = (int64_t)(intptr_t)(__k->saved[6]);
    __t173 = (int64_t)(intptr_t)(__k->saved[7]);
    ...
    (void)(__box176);
    int64_t __t178;
    bool __ps_179 = (ok___spec__bool_tur_adt_Result__int__int(acc_1434));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_179) {
        __t178 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1435) + (__t178)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1442) == (INT64_C(0))) {
     int64_t __t180;
     bool __ps_181 = (ok___spec__bool_tur_adt_Result__int__int(acc_1441));
     if (tur_panicking) return ((int64_t)0);
     if (__ps_181) {
         __t180 = INT64_C(300);
     } else {
     ...
     __n182->tag = 6; __n182->boundary = __b182; __n182->next = __k;
     __n182->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1434, sizeof(tur_adt_Result__int__int)); __n182->saved[0] = (int64_t)(intptr_t)__ab; }
     __n182->saved[1] = (int64_t)(intptr_t)(n_1435);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1441, sizeof(tur_adt_Result__int__int)); __n182->saved[2] = (int64_t)(intptr_t)__ab; }
     __n182->saved[3] = (int64_t)(intptr_t)(n_1442);
     __n182->saved[4] = (int64_t)(intptr_t)(__t170);
     __n182->saved[5] = (int64_t)(intptr_t)(__t171);
     __n182->saved[6] = (int64_t)(intptr_t)(__t172);
     __n182->saved[7] = (int64_t)(intptr_t)(__t173);
     __k = __n182; __pc = 5; break;
    }
   }
   case 5: {
    tur_adt_Result__int__int __ra183_0 = (acc_1441);
    int64_t __ra183_1 = ((n_1442) - (INT64_C(1)));
    acc_1434 = __ra183_0;
    n_1435 = __ra183_1;
    __pc = 1; break;
   }
   case 6: {
    ...
    (void)(__box182);
    int64_t __t184;
    bool __ps_185 = (ok___spec__bool_tur_adt_Result__int__int(acc_1441));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_185) {
        __t184 = INT64_C(2);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1442) + (__t184)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_186 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_187 = (ping(__ps_186, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_187));
    tur_adt_Result__int__int __ps_188 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_189 = (ping(__ps_188, INT64_C(6)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_189));
    int64_t __t190;
    __t190 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_194 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_195 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_195;
}
