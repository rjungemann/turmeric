...
static int64_t use_double(int64_t);

static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t x_617 = (int64_t)__effect_args[0];
    int64_t k_618 = __k;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_618, (int64_t)((x_617) * (INT64_C(2))));
    return (int64_t)__t4;
}

static void __handle_body_2(void);
static void __handle_body_2(void) {
    tur_current_fiber->result = (int64_t)use_double(INT64_C(21));
}
...
static int64_t __dispatch_2(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Double") == 0) {
...
static int64_t use_double(int64_t n) {
        int64_t __t0[1];
        __t0[0] = (int64_t)n;
        int64_t __t1 = tur_effect_perform("Double", __t0, 1);
        return __t1;
}
