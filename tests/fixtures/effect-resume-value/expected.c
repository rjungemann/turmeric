...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t x_2 = (int64_t)__effect_args[0];
    int64_t k_3 = __k;
    if (((TurContK *)(intptr_t)k_3)->origin_fiber != (void *)tur_current_fiber) { fprintf(stderr, "continuation error: resume on wrong fiber\n"); abort(); }
    ((TurContK *)(intptr_t)k_3)->consumed = true;
    return (int64_t)((x_2) * (INT64_C(2)));
}
