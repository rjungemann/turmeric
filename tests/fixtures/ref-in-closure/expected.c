...
int main() {
        {
            ...
            *((int64_t *)__t0) = INT64_C(42);
            ...
            tur_frame_push_defer(&__frame_1, __defer_2, NULL);
            {
                ...
                (void)v_617;
                {
                    struct __env_620 *__t4 = (struct __env_620 *)malloc(sizeof(struct __env_620));
                    __t4->__fn = (int64_t)(intptr_t)__fn_618;
                    __t4->v = v_617;
                    void *__t5 = __t4;
                    void * f_623 = __t5;
                    (void)f_623;
            ...
            struct __defer_env_6 __t8 = {.r = r_616};
