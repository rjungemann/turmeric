...
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_617 = __k;
    int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_617, (int64_t)INT64_C(41));
    return (int64_t)__t7;
}
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    printf("%lld\n", (long long)(x_618));
    int64_t __t8;
    int64_t __t9 = tur_effect_cont_resume((int64_t)(intptr_t)k_619, (int64_t)0);
    __t8 = __t9;
    return (int64_t)__t8;
}
...
static int64_t use_both() {
        int64_t __t0;
        {
            ...
            int64_t result_616 = ((INT64_C(1)) + (__t1));
            (void)result_616;
            int64_t __t2[1];
            __t2[0] = (int64_t)result_616;
