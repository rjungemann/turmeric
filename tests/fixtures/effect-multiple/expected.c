...
static int64_t use_both();

static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_262 = __k;
    int64_t __t7 = tur_effect_cont_resume((int64_t)(intptr_t)k_262, (int64_t)INT64_C(41));
    return (int64_t)__t7;
}
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    printf("%lld\n", (long long)(x_263));
    int64_t __t8;
    int64_t __t9 = tur_effect_cont_resume((int64_t)(intptr_t)k_264, (int64_t)0);
    __t8 = __t9;
    return (int64_t)__t8;
}
...
static void __handle_body_4(void) {
    tur_current_fiber->result = (int64_t)use_both();
}
...
static int64_t __dispatch_4(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    } else if (strcmp(__dcap->eff_name, "Tell") == 0) {
...
static int64_t use_both() {
        int64_t __t0;
        {
            ...
            int64_t result_261 = ((INT64_C(1)) + (__t1));
            (void)result_261;
            int64_t __t2[1];
            __t2[0] = (int64_t)result_261;
...
int main(int argc, char **argv) {
    ...
    __eff_frame_4.cases[0].effect_name = "Ask";
    __eff_frame_4.cases[0].handler_fn = NULL;
    __eff_frame_4.cases[0].env = NULL;
    __eff_frame_4.cases[1].effect_name = "Tell";
