...
int main() {
        {
            void * results_227 = fb_results_new();
            (void)results_227;
            {
                void * rng_a_228 = fb_range_new((void *)(intptr_t)(results_227), INT64_C(0), INT64_C(5));
                (void)rng_a_228;
                {
                    void * rng_b_229 = fb_range_new((void *)(intptr_t)(results_227), INT64_C(5), INT64_C(5));
                    (void)rng_b_229;
                    {
                        void * rng_c_230 = fb_range_new((void *)(intptr_t)(results_227), INT64_C(10), INT64_C(5));
                        (void)rng_c_230;
                        {
                            void * ta_231 = fb_thread_spawn((void *)(intptr_t)(fb_worker), (void *)(intptr_t)(rng_a_228));
                            (void)ta_231;
                            {
                                void * tb_232 = fb_thread_spawn((void *)(intptr_t)(fb_worker), (void *)(intptr_t)(rng_b_229));
                                (void)tb_232;
                                {
                                    void * tc_233 = fb_thread_spawn((void *)(intptr_t)(fb_worker), (void *)(intptr_t)(rng_c_230));
                                    (void)tc_233;
                                    fb_thread_join((void *)(intptr_t)(ta_231));
                                    fb_thread_join((void *)(intptr_t)(tb_232));
                                    fb_thread_join((void *)(intptr_t)(tc_233));
                                }
                            }
                        }
                        fb_print((void *)(intptr_t)(results_227), INT64_C(0));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(1));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(2));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(3));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(4));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(5));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(6));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(7));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(8));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(9));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(10));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(11));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(12));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(13));
                        fb_print((void *)(intptr_t)(results_227), INT64_C(14));
                        fb_range_free((void *)(intptr_t)(rng_a_228));
                        fb_range_free((void *)(intptr_t)(rng_b_229));
                        fb_range_free((void *)(intptr_t)(rng_c_230));
                    }
                }
            }
            fb_results_free((void *)(intptr_t)(results_227));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
