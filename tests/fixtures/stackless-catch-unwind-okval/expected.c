...
static int64_t ok_hyval(int64_t r) {
        int64_t __t94 = 0;
        {
            ...
            switch (__scrut ? __scrut->tag : 0) {
            case 0: {
                int64_t v_910 = (int64_t)__scrut->as.Ok._0;
                __t94 = v_910;
                break;
            }
            case 1: {
        ...
        if (__ps_104) {
            bool __t105;
            {
                ...
                if ((t1_1071) == (INT64_C(0))) {
                    __t106 = (t2_1072) == (INT64_C(0));
                } else {
                    bool __t107;
                    if ((t2_1072) == (INT64_C(0))) {
                        __t107 = false;
                    } else {
                        bool __ps_108 = (cons_hyeq_hygo(t1_1071, t2_1072));
                        if (tur_panicking) return ((bool)0);
                        __t107 = __ps_108;
                    }
                    __t106 = __t107;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1080 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1080;
                __t111 = out_1080;
            }
            __t109 = __t111;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_118) {
            ...
            int64_t __t119;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1087 = (int64_t)(intptr_t)(__ps_123);
                (void)out_1087;
                __t119 = out_1087;
            }
            __t117 = __t119;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t128;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1162 = __ps_130;
            (void)iter_1162;
            void * __ps_131 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_132 = (hamt_slkeyeq((void *)(intptr_t)(__ps_131)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1163 = __ps_132;
            (void)keyeq_1163;
            void * __ps_133 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_134 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1162), (void *)(intptr_t)(__ps_133), (void *)(intptr_t)(keyeq_1163)));
            if (tur_panicking) return ((bool)0);
            bool result_1164 = __ps_134;
            (void)result_1164;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t155;
        {
            ...
            {
                tur_adt_Vec__int * __ps_157 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1291));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1292 = __ps_157;
                (void)_un_unv_1292;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t161;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1342 = __ps_162;
            (void)r_1342;
            int64_t __t163;
            bool __ps_164 = (schema_hydecode_hyok_qu(r_1342));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_164) {
                int64_t __ps_165 = (schema_hydecode_hyvalue(r_1342));
                if (tur_panicking) return ((int64_t)0);
                __t163 = __ps_165;
            } else {
                int64_t __ps_166 = (schema_hydecode_hyerrors(r_1342));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n171->saved[1] = (int64_t)(intptr_t)(r_1369);
          ...
          case 3: {
           ...
           r_1369 = __box171;
           int64_t __t173;
           bool __ps_174 = (ok_qu(r_1369));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_174) {
               int64_t __ps_175 = (ok_hyval(r_1369));
               if (tur_panicking) return ((int64_t)0);
               __t173 = (INT64_C(1)) + (__ps_175);
           } else {
               __t173 = INT64_C(0);
           }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_176 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        int64_t __t177;
        __t177 = INT64_C(0);
