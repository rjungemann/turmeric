...
static int64_t t_pass();
static int64_t t_fail();
...
static int64_t register_test(const char * name, void * test_fn) {
...
int main() {
        (void)(register_test("t-pass", (void *)(intptr_t)(t_pass)));
        (void)(register_test("t-fail", (void *)(intptr_t)(t_fail)));
        int64_t __t0;
        __t0 = run_tests_();
        return (int)__t0;
}
