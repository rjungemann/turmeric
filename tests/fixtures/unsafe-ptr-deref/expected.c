...
static void __handle_body_0(void) {
    int64_t __t2;
    {
        void * p_208 = malloc(INT64_C(16));
        (void)p_208;
        *((int64_t *)p_208) = INT64_C(99);
        int64_t __t3;
        int64_t __t4;
        {
            ...
            int64_t __t6;
            {
                void * p2_210 = ((char *)p_208 + INT64_C(8));
                (void)p2_210;
                *((int64_t *)p2_210) = INT64_C(200);
                int64_t __t7;
                int64_t __t8;
                {
                    int64_t v2_211 = *((int64_t *)p2_210);
                    (void)v2_211;
                    printf("%lld\n", (long long)(v2_211));
                    free(p_208);
                    int64_t __t9;
...
int main() {
        ...
        int64_t __t10 = (int64_t)__dispatch_0(&__cap_0, (int64_t)(intptr_t)__fiber_0, 0);
