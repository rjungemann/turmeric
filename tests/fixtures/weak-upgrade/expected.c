...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(99);
            ...
            __t2->value = __t1;
            RcControlBlock * rc_616 = __t2;
            (void)rc_616;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            {
                RcControlBlock *__t4 = rc_616; rc_weak_increment(rc_616);
                RcControlBlock * w_617 = __t4;
                (void)w_617;
                bool __t5 = true; // weak? not fully implemented in Phase 9
                puts((__t5) ? "true" : "false");
            }
            struct __defer_env_6 __t8 = {.rc = rc_616};
