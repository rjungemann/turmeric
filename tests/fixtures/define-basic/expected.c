...
static bool __fn_474(int64_t, int64_t);
...
static bool __fn_474(int64_t a, int64_t b) {
        return (a) == (b);
}

static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return map_eq_(x, y, (int64_t)(intptr_t)(__fn_474));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return vec_eq_(x, y, (int64_t)(intptr_t)(__fn_498));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return option_eq_(x, y, (int64_t)(intptr_t)(__fn_525));
}
...
static bool __fn_547(int64_t a, int64_t b) {
        return (a) == (b);
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return result_eq_(x, y, (int64_t)(intptr_t)(__fn_547), (int64_t)(intptr_t)(__fn_551));
}
...
static bool __fn_567(int64_t a, int64_t b) {
        return (a) == (b);
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return pair_eq_carrier_(x, y, (int64_t)(intptr_t)(__fn_567), (int64_t)(intptr_t)(__fn_571));
}
...
static bool __inst_Eq_eq__Tuple2(int64_t x, int64_t y) {
        return tuple2_eq_carrier_(x, y, (int64_t)(intptr_t)(__fn_652), (int64_t)(intptr_t)(__fn_656));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return list_eq_(x, y, (int64_t)(intptr_t)(__fn_674));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return mutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_753));
}
...
int main(int argc, char **argv) {
    ...
    {
        int64_t x_756 = INT64_C(1);
        (void)x_756;
        {
            int64_t y_757 = INT64_C(2);
            (void)y_757;
            printf("%lld\n", (long long)((x_756) + (y_757)));
        }
    }
    return 0;
}
