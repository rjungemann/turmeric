...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_174 = (some__spec__int64_t_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_175 = (step(__ps_174, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_175));
        int64_t __ps_176 = (none__spec__int64_t());
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static int64_t some__spec__int64_t_int64_t(int64_t x) {
        int64_t __ps_181 = (ctor_Some__int(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_181;
}

static int64_t none__spec__int64_t() {
        int64_t __ps_182 = (ctor_None__int());
        if (tur_panicking) return ((int64_t)0);
        return __ps_182;
}
