...
struct __env_1305 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
static int64_t __fn_1303(void * __env_p_1306) {
        ...
        int64_t __ps_42 = (step(__env___env_1305->acc, (__env___env_1305->n) - (INT64_C(1))));
...
static int64_t some(int64_t x) {
        int64_t __ps_86 = (ctor_Option(true, x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_86;
}
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t159;
            bool __ps_160 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_160) {
                __t159 = INT64_C(100);
            } else {
            ...
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n161->saved[0] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           (void)(__box161);
           int64_t __t163;
           bool __ps_164 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_164) {
               __t163 = INT64_C(1);
           } else {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_165 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_166 = (step(__ps_165, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_166));
        tur_adt_Option__int __ps_167 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_168 = (step(__ps_167, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_168));
        int64_t __t169;
        __t169 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_172 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_172;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_173 = (ctor_Option__int(false, ((int64_t)0)));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_173;
}
