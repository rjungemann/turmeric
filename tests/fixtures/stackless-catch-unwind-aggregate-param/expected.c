...
static int64_t __fn_1303(void * __env_p_1306) {
        ...
        __auto_type __ps_42 = (step(__env___env_1305->acc, (__env___env_1305->n) - (INT64_C(1))));
...
static int64_t some(int64_t x) {
        __auto_type __ps_86 = (ctor_Option(true, x));
        if (tur_panicking) return (int64_t){0};
        return __ps_86;
}
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t159;
            __auto_type __ps_160 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return (int64_t){0};
            if (__ps_160) {
                __t159 = INT64_C(100);
            } else {
          ...
          case 3: {
           ...
           (void)(__box161);
           int64_t __t163;
           __auto_type __ps_164 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return (int64_t){0};
           if (__ps_164) {
               __t163 = INT64_C(1);
           } else {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_165 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_166 = (step(__ps_165, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_166));
        __auto_type __ps_167 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_168 = (step(__ps_167, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_168));
        int64_t __t169;
        __t169 = INT64_C(0);
