...
struct __env_1286 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
static int64_t __fn_1284(void * __env_p_1287) {
        ...
        __auto_type __ps_42 = (step(__env___env_1286->acc, (__env___env_1286->n) - (INT64_C(1))));
