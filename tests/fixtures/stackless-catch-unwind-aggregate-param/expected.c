        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t177;
            __auto_type __ps_178 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return (int64_t){0};
            if (__ps_178) {
                __t177 = INT64_C(100);
            } else {
            ...
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n179->saved[0] = (int64_t)(intptr_t)__ab; }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_183 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_184 = (step(__ps_183, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_184));
        __auto_type __ps_185 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_186 = (step(__ps_185, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_186));
        int64_t __t187;
        __t187 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_190 = (ctor_Option__int(true, x));
