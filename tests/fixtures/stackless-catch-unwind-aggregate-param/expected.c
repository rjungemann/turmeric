...
static int64_t some(int64_t x) {
        int64_t __ps_176 = (ctor_Option_Some(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_176;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_198) {
            ...
            int64_t __t199;
            {
                ...
                int64_t out_1154 = (int64_t)(intptr_t)(__ps_203);
                (void)out_1154;
                __t199 = out_1154;
            }
            __t197 = __t199;
        ...
        if (__ps_208) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1225 = __ps_209;
                (void)h_1225;
                void * __ps_210 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1226 = __ps_210;
                (void)k_1226;
                bool __ps_211 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1225, (void *)(intptr_t)(k_1226), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_211) {
                    void * __t212 = iter;
                    void * __t213 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t215;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1229 = __ps_217;
            (void)iter_1229;
            void * __ps_218 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_219 = (hamt_slkeyeq((void *)(intptr_t)(__ps_218)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1230 = __ps_219;
            (void)keyeq_1230;
            void * __ps_220 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_221 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1229), (void *)(intptr_t)(__ps_220), (void *)(intptr_t)(keyeq_1230)));
            if (tur_panicking) return ((bool)0);
            bool result_1231 = __ps_221;
            (void)result_1231;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t242;
        {
            ...
            {
                tur_adt_Vec__int * __ps_244 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1361));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1362 = __ps_244;
                (void)_un_unv_1362;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t248;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1412 = __ps_249;
            (void)r_1412;
            int64_t __t250;
            bool __ps_251 = (schema_hydecode_hyok_qu(r_1412));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_251) {
                int64_t __ps_252 = (schema_hydecode_hyvalue(r_1412));
                if (tur_panicking) return ((int64_t)0);
                __t250 = __ps_252;
            } else {
                int64_t __ps_253 = (schema_hydecode_hyerrors(r_1412));
                if (tur_panicking) return ((int64_t)0);
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t268;
            bool __ps_269 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_269) {
                __t268 = INT64_C(100);
            } else {
            ...
            __v = (int64_t)(intptr_t)(__t268); __pc = __k->tag; break;
           } else {
            ...
            __n270->tag = 3; __n270->boundary = __b270; __n270->next = __k;
            __n270->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n270->saved[0] = (int64_t)(intptr_t)__ab; }
            __n270->saved[1] = (int64_t)(intptr_t)(n);
            __n270->saved[2] = (int64_t)(intptr_t)(__t266);
            __n270->saved[3] = (int64_t)(intptr_t)(__t267);
            __k = __n270; __pc = 2; break;
           }
          }
          case 2: {
           tur_adt_Option__int __ra271_0 = (acc);
           int64_t __ra271_1 = ((n) - (INT64_C(1)));
           acc = __ra271_0;
           n = __ra271_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           __t266 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           (void)(__box270);
           int64_t __t272;
           bool __ps_273 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_273) {
               __t272 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t272)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_274 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_275 = (step(__ps_274, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_275));
        tur_adt_Option__int __ps_276 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_277 = (step(__ps_276, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_277));
        int64_t __t278;
        __t278 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_282 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_282;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_283 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_283;
}
