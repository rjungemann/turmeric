...
struct __env_1274 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
static int64_t __fn_1272(void * __env_p_1275) {
        struct __env_1274 *__env___env_1274 = (struct __env_1274 *)__env_p_1275;
        __auto_type __ps_43 = (step(__env___env_1274->acc, (__env___env_1274->n) - (INT64_C(1))));
