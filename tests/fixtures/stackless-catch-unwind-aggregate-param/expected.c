...
struct __env_1472 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
static int64_t some(int64_t x) {
        int64_t __ps_156 = (ctor_Option_Some(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_156;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_178) {
            ...
            int64_t __t179;
            {
                ...
                int64_t out_1154 = (int64_t)(intptr_t)(__ps_183);
                (void)out_1154;
                __t179 = out_1154;
            }
            __t177 = __t179;
        ...
        if (__ps_188) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1225 = __ps_189;
                (void)h_1225;
                void * __ps_190 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1226 = __ps_190;
                (void)k_1226;
                bool __ps_191 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1225, (void *)(intptr_t)(k_1226), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_191) {
                    void * __t192 = iter;
                    void * __t193 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t195;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1229 = __ps_197;
            (void)iter_1229;
            void * __ps_198 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_199 = (hamt_slkeyeq((void *)(intptr_t)(__ps_198)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1230 = __ps_199;
            (void)keyeq_1230;
            void * __ps_200 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_201 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1229), (void *)(intptr_t)(__ps_200), (void *)(intptr_t)(keyeq_1230)));
            if (tur_panicking) return ((bool)0);
            bool result_1231 = __ps_201;
            (void)result_1231;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t222;
        {
            ...
            {
                tur_adt_Vec__int * __ps_224 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1361));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1362 = __ps_224;
                (void)_un_unv_1362;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t228;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1412 = __ps_229;
            (void)r_1412;
            int64_t __t230;
            bool __ps_231 = (schema_hydecode_hyok_qu(r_1412));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_231) {
                int64_t __ps_232 = (schema_hydecode_hyvalue(r_1412));
                if (tur_panicking) return ((int64_t)0);
                __t230 = __ps_232;
            } else {
                int64_t __ps_233 = (schema_hydecode_hyerrors(r_1412));
                if (tur_panicking) return ((int64_t)0);
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t248;
            bool __ps_249 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_249) {
                __t248 = INT64_C(100);
            } else {
            ...
            __v = (int64_t)(intptr_t)(__t248); __pc = __k->tag; break;
           } else {
            ...
            __n250->tag = 3; __n250->boundary = __b250; __n250->next = __k;
            __n250->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n250->saved[0] = (int64_t)(intptr_t)__ab; }
            __n250->saved[1] = (int64_t)(intptr_t)(n);
            __n250->saved[2] = (int64_t)(intptr_t)(__t246);
            __n250->saved[3] = (int64_t)(intptr_t)(__t247);
            __k = __n250; __pc = 2; break;
           }
          }
          case 2: {
           tur_adt_Option__int __ra251_0 = (acc);
           int64_t __ra251_1 = ((n) - (INT64_C(1)));
           acc = __ra251_0;
           n = __ra251_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           __t246 = (int64_t)(intptr_t)(__k->saved[2]);
           ...
           (void)(__box250);
           int64_t __t252;
           bool __ps_253 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_253) {
               __t252 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t252)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_254 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_255 = (step(__ps_254, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_255));
        tur_adt_Option__int __ps_256 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_257 = (step(__ps_256, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_257));
        int64_t __t258;
        __t258 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_259 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_260 = (vec_new__spec__tur_adt_Vec__int__());
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_262 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_262;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_263 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_263;
}
