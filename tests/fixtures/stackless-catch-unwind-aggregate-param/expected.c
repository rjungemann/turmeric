...
static int64_t some(int64_t x) {
        int64_t __ps_94 = (ctor_Option_Some(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_94;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                int64_t out_1117 = (int64_t)(intptr_t)(__t122);
                (void)out_1117;
                __t117 = out_1117;
            }
            __t115 = __t117;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n189->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n189->saved[0] = (int64_t)(intptr_t)__ab; }
            __n189->saved[1] = (int64_t)(intptr_t)(n);
          ...
          case 2: {
           tur_adt_Option__int __ra190_0 = (acc);
           int64_t __ra190_1 = ((n) - (INT64_C(1)));
           acc = __ra190_0;
           n = __ra190_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           (void)(__box189);
           int64_t __t191;
           bool __ps_192 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_192) {
               __t191 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t191)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_193 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_201 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_201;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_202 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_202;
}
