...
struct __env_1371 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1091 = (int64_t)(intptr_t)(__ps_119);
                (void)out_1091;
                __t115 = out_1091;
            }
            __t113 = __t115;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t124;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1166 = __ps_126;
            (void)iter_1166;
            void * __ps_127 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_128 = (hamt_slkeyeq((void *)(intptr_t)(__ps_127)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1167 = __ps_128;
            (void)keyeq_1167;
            void * __ps_129 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_130 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1166), (void *)(intptr_t)(__ps_129), (void *)(intptr_t)(keyeq_1167)));
            if (tur_panicking) return ((bool)0);
            bool result_1168 = __ps_130;
            (void)result_1168;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t151;
        {
            ...
            {
                tur_adt_Vec__int * __ps_153 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1295));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1296 = __ps_153;
                (void)_un_unv_1296;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t157;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1346 = __ps_158;
            (void)r_1346;
            int64_t __t159;
            bool __ps_160 = (schema_hydecode_hyok_qu(r_1346));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_160) {
                int64_t __ps_161 = (schema_hydecode_hyvalue(r_1346));
                if (tur_panicking) return ((int64_t)0);
                __t159 = __ps_161;
            } else {
                int64_t __ps_162 = (schema_hydecode_hyerrors(r_1346));
                if (tur_panicking) return ((int64_t)0);
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t167;
            bool __ps_168 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_168) {
                __t167 = INT64_C(100);
            } else {
            ...
            __v = (int64_t)(intptr_t)(__t167); __pc = __k->tag; break;
           } else {
            ...
            __n169->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n169->saved[0] = (int64_t)(intptr_t)__ab; }
            __n169->saved[1] = (int64_t)(intptr_t)(n);
            __n169->saved[2] = (int64_t)(intptr_t)(__t165);
            __n169->saved[3] = (int64_t)(intptr_t)(__t166);
            __k = __n169; __pc = 2; break;
           }
          }
          case 2: {
           tur_adt_Option__int __ra170_0 = (acc);
           int64_t __ra170_1 = ((n) - (INT64_C(1)));
           acc = __ra170_0;
           n = __ra170_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           tur_result_box_free((int64_t)(intptr_t)__box169);
           (void)(__box169);
           int64_t __t171;
           bool __ps_172 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_172) {
               __t171 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t171)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_173 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_174 = (step(__ps_173, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_174));
        tur_adt_Option__int __ps_175 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_176 = (step(__ps_175, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        int64_t __t177;
        __t177 = INT64_C(0);
...
static bool some___spec__bool_tur_adt_Option__int(tur_adt_Option__int o) {
        bool __t180 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t _un_858 = (int64_t)__scrut->as.Some._0;
                __t180 = true;
                break;
            }
            case 0: {
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_181 = (ctor_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_181;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_182 = (ctor_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_182;
}
