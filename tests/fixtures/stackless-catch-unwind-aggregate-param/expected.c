...
static int64_t __fn_1282(void * __env_p_1285) {
        ...
        __auto_type __ps_40 = (step(__env___env_1284->acc, (__env___env_1284->n) - (INT64_C(1))));
...
static int64_t some(int64_t x) {
        __auto_type __ps_84 = (ctor_Option(true, x));
        if (tur_panicking) return (int64_t){0};
        return __ps_84;
}
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t157;
            __auto_type __ps_158 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return (int64_t){0};
            if (__ps_158) {
                __t157 = INT64_C(100);
            } else {
            ...
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n159->saved[0] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           (void)(__box159);
           int64_t __t161;
           __auto_type __ps_162 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return (int64_t){0};
           if (__ps_162) {
               __t161 = INT64_C(1);
           } else {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_163 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_164 = (step(__ps_163, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_164));
        __auto_type __ps_165 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_166 = (step(__ps_165, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_166));
        int64_t __t167;
        __t167 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_170 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_170;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        __auto_type __ps_171 = (ctor_Option__int(false, (int64_t){0}));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_171;
}
