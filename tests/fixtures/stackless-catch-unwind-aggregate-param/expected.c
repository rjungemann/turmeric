...
struct __env_1437 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
static int64_t some(int64_t x) {
        int64_t __ps_88 = (ctor_Option_Some(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_88;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1115 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1115;
                __t111 = out_1115;
            }
            __t109 = __t111;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t120;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_122;
            (void)iter_1190;
            void * __ps_123 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_124 = (hamt_slkeyeq((void *)(intptr_t)(__ps_123)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_124;
            (void)keyeq_1191;
            void * __ps_125 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_126 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_125), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_126;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t147;
        {
            ...
            {
                tur_adt_Vec__int * __ps_149 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_149;
                (void)_un_unv_1320;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t153;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_154;
            (void)r_1370;
            int64_t __t155;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                int64_t __ps_157 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t155 = __ps_157;
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t172;
            bool __ps_173 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_173) {
                __t172 = INT64_C(100);
            } else {
            ...
            __n174->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n174->saved[0] = (int64_t)(intptr_t)__ab; }
            __n174->saved[1] = (int64_t)(intptr_t)(n);
            __n174->saved[2] = (int64_t)(intptr_t)(__t170);
            __n174->saved[3] = (int64_t)(intptr_t)(__t171);
            __k = __n174; __pc = 2; break;
           }
          }
          case 2: {
           tur_adt_Option__int __ra175_0 = (acc);
           int64_t __ra175_1 = ((n) - (INT64_C(1)));
           acc = __ra175_0;
           n = __ra175_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           (void)(__box174);
           int64_t __t176;
           bool __ps_177 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_177) {
               __t176 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t176)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_178 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_179 = (step(__ps_178, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        tur_adt_Option__int __ps_180 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool some___spec__bool_tur_adt_Option__int(tur_adt_Option__int o) {
        bool __t185 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t _un_882 = (int64_t)__scrut->as.Some._0;
                __t185 = true;
                break;
            }
            case 0: {
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_186 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_186;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_187 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_187;
}
