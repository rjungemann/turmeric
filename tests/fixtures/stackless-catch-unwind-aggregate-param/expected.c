...
static int64_t some(int64_t x) {
        int64_t __ps_92 = (ctor_Option_Some(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_92;
}
        ...
        if (__ps_124) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1186 = __ps_125;
                (void)h_1186;
                void * __ps_126 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1187 = __ps_126;
                (void)k_1187;
                bool __ps_127 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1186, (void *)(intptr_t)(k_1187), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_127) {
                    void * __t128 = iter;
                    void * __t129 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t131;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_133;
            (void)iter_1190;
            void * __ps_134 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_135 = (hamt_slkeyeq((void *)(intptr_t)(__ps_134)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_135;
            (void)keyeq_1191;
            void * __ps_136 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_137 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_136), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_137;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t158;
        {
            ...
            {
                tur_adt_Vec__int * __ps_160 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_160;
                (void)_un_unv_1320;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t164;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_165;
            (void)r_1370;
            int64_t __t166;
            bool __ps_167 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_167) {
                int64_t __ps_168 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t166 = __ps_168;
            } else {
                int64_t __ps_169 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t183;
            bool __ps_184 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_184) {
                __t183 = INT64_C(100);
            } else {
            ...
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n185->saved[0] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           (void)(__box185);
           int64_t __t187;
           bool __ps_188 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_188) {
               __t187 = INT64_C(1);
           } else {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_189 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_190 = (step(__ps_189, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_190));
        tur_adt_Option__int __ps_191 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_197 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_197;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_198 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_198;
}
