...
struct __env_1280 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
static int64_t __fn_1278(void * __env_p_1281) {
        struct __env_1280 *__env___env_1280 = (struct __env_1280 *)__env_p_1281;
        __auto_type __ps_40 = (step(__env___env_1280->acc, (__env___env_1280->n) - (INT64_C(1))));
