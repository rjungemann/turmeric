...
struct __env_1470 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t256;
        {
            ...
            struct __defer_env_259 __t261 = {.m = m_1463};
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t271;
            bool __ps_272 = (some___spec__bool_tur_adt_Option__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_272) {
                __t271 = INT64_C(100);
            } else {
            ...
            __v = (int64_t)(intptr_t)(__t271); __pc = __k->tag; break;
           } else {
            tur_handler_node *__b273 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b273->parent = tur_handler_chain; tur_handler_chain = __b273;
            tur_cont *__n273 = (tur_cont*)malloc(sizeof(tur_cont));
            __n273->tag = 3; __n273->boundary = __b273; __n273->next = __k;
            __n273->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n273->saved[0] = (int64_t)(intptr_t)__ab; }
            __n273->saved[1] = (int64_t)(intptr_t)(n);
            __n273->saved[2] = (int64_t)(intptr_t)(__t269);
            __n273->saved[3] = (int64_t)(intptr_t)(__t270);
            __k = __n273; __pc = 2; break;
           }
          }
          case 2: {
           tur_adt_Option__int __ra274_0 = (acc);
           int64_t __ra274_1 = ((n) - (INT64_C(1)));
           acc = __ra274_0;
           n = __ra274_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           int64_t __box273;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp273 = global_panic_payload; global_panic_payload = 0; __box273 = tur_box_err((int64_t)(intptr_t)__pp273); }
           else { __box273 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box273);
           (void)(__box273);
           int64_t __t275;
           bool __ps_276 = (some___spec__bool_tur_adt_Option__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_276) {
               __t275 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t275)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_277 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_285 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_285;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_286 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_286;
}
