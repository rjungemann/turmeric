tests/fixtures/unsafe-oversized/input.tur:2:3: warning: unsafe block has 22 expressions (threshold: 20); consider breaking into smaller blocks
1 | (defn main [] :int
2 |   (unsafe
  |   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
3 |     (println 1)
...
int main() {
        ...
        *__eff_chain_1 = &__eff_frame_1;
        ...
        printf("%lld\n", (long long)(INT64_C(8)));
        printf("%lld\n", (long long)(INT64_C(9)));
        printf("%lld\n", (long long)(INT64_C(10)));
        printf("%lld\n", (long long)(INT64_C(11)));
        printf("%lld\n", (long long)(INT64_C(12)));
        printf("%lld\n", (long long)(INT64_C(13)));
        printf("%lld\n", (long long)(INT64_C(14)));
        printf("%lld\n", (long long)(INT64_C(15)));
        printf("%lld\n", (long long)(INT64_C(16)));
        printf("%lld\n", (long long)(INT64_C(17)));
        printf("%lld\n", (long long)(INT64_C(18)));
        printf("%lld\n", (long long)(INT64_C(19)));
        printf("%lld\n", (long long)(INT64_C(20)));
        printf("%lld\n", (long long)(INT64_C(21)));
        printf("%lld\n", (long long)(INT64_C(22)));
