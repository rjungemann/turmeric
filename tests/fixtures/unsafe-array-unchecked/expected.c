...
static void __handle_body_0(void) {
    int64_t __t2;
    {
        void * arr_616 = malloc(INT64_C(16));
        (void)arr_616;
        memset(arr_616, INT64_C(0), INT64_C(16));
        int64_t __t3;
        int64_t __t4;
        {
            void * p_617 = (&(arr_616));
            (void)p_617;
            (*((int64_t *)p_617 + INT64_C(0)) = INT64_C(42));
            int64_t __t5;
            int64_t __t6;
            {
                int64_t v_618 = (*((int64_t *)p_617 + INT64_C(0)));
                (void)v_618;
                printf("%lld\n", (long long)(v_618));
                int64_t __t7;
                __t7 = INT64_C(0);
    ...
    tur_current_fiber->result = (int64_t)__t2;
}
