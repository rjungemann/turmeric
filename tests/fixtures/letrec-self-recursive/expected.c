...
static int64_t __fn_1272__cps(int64_t n_1271, DK *__kont);
...
static int64_t __fn_1272__cps(int64_t n, DK *__kont) {
    bool __t0;
    int64_t __t1;
    int64_t __t2;
    __t0 = (n) == (INT64_C(0));
    if (__t0) {
        ...
        __auto_type __ps_40 = (__fn_1272((n) - (INT64_C(1))));
...
__attribute__((unused)) static int64_t __fn_1272(int64_t n) {
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = __fn_1272__cps(n, __root);
    dk_free(__root);
    return (int64_t)(__r);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t174;
        {
            __auto_type __ps_175 = (__fn_1272(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_175));
            int64_t __t176;
            __t176 = INT64_C(0);
