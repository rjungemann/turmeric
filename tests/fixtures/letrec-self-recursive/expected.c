...
static int64_t __fn_1328__cps(int64_t n_1327, DK *__kont);
...
static int64_t __fn_1328__cps(int64_t n, DK *__kont) {
    int64_t __t0;
    int64_t __t42;
    if ((n) == (INT64_C(0))) {
        __t42 = INT64_C(1);
    } else {
        int64_t __ps_43 = (__fn_1328((n) - (INT64_C(1))));
...
__attribute__((unused)) static int64_t __fn_1328(int64_t n) {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = __fn_1328__cps(n, __root); }
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_75 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_787, (void *)(intptr_t)(k_788), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t77;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_792 = __ps_79;
            (void)iter_792;
            void * __ps_80 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_81 = (hamt_slkeyeq((void *)(intptr_t)(__ps_80)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_793 = __ps_81;
            (void)keyeq_793;
            void * __ps_82 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_83 = (map_hyeq_hyloop((void *)(intptr_t)(iter_792), (void *)(intptr_t)(__ps_82), (void *)(intptr_t)(keyeq_793), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_794 = __ps_83;
            (void)result_794;
        ...
        if (__ps_101) {
            bool __t102;
            {
                ...
                if ((t1_1035) == (INT64_C(0))) {
                    __t103 = (t2_1036) == (INT64_C(0));
                } else {
                    bool __t104;
                    if ((t2_1036) == (INT64_C(0))) {
                        __t104 = false;
                    } else {
                        bool __ps_105 = (cons_hyeq_hygo(t1_1035, t2_1036));
                        if (tur_panicking) return ((bool)0);
                        __t104 = __ps_105;
                    }
                    __t103 = __t104;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1051 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1051;
                __t112 = out_1051;
            }
            __t110 = __t112;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t121;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1126 = __ps_123;
            (void)iter_1126;
            void * __ps_124 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_125 = (hamt_slkeyeq((void *)(intptr_t)(__ps_124)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1127 = __ps_125;
            (void)keyeq_1127;
            void * __ps_126 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_127 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1126), (void *)(intptr_t)(__ps_126), (void *)(intptr_t)(keyeq_1127)));
            if (tur_panicking) return ((bool)0);
            bool result_1128 = __ps_127;
            (void)result_1128;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t148;
        {
            ...
            {
                tur_adt_Vec__int * __ps_150 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1255));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1256 = __ps_150;
                (void)_un_unv_1256;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t153;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1305 = __ps_154;
            (void)r_1305;
            int64_t __t155;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1305));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                int64_t __ps_157 = (schema_hydecode_hyvalue(r_1305));
                if (tur_panicking) return ((int64_t)0);
                __t155 = __ps_157;
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1305));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t161;
        {
            int64_t __ps_162 = (__fn_1328(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_162));
            int64_t __t163;
            __t163 = INT64_C(0);
