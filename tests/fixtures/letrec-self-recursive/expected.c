...
static int64_t __fn_1465(int64_t n) {
        int64_t __t92;
        if ((n) == (INT64_C(0))) {
            __t92 = INT64_C(1);
        } else {
            int64_t __ps_93 = (__fn_1465((n) - (INT64_C(1))));
            if (tur_panicking) return ((int64_t)0);
            __t92 = (n) * (__ps_93);
        }
        return __t92;
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_841 = __ps_126;
        bool __ps_127 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_840, (void *)(intptr_t)(k_841), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_127;
        if (__t1) {
            int64_t __ps_128 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_129 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_840, (void *)(intptr_t)(k_841), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t131;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_845 = __ps_133;
            (void)iter_845;
            void * __ps_134 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_135 = (hamt_slkeyeq((void *)(intptr_t)(__ps_134)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_846 = __ps_135;
            (void)keyeq_846;
            void * __ps_136 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_137 = (map_hyeq_hyloop((void *)(intptr_t)(iter_845), (void *)(intptr_t)(__ps_136), (void *)(intptr_t)(keyeq_846), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_847 = __ps_137;
            (void)result_847;
        ...
        if (__ps_156) {
            bool __t157;
            {
                ...
                if ((t1_1125) == (INT64_C(0))) {
                    __t158 = (t2_1126) == (INT64_C(0));
                } else {
                    bool __t159;
                    if ((t2_1126) == (INT64_C(0))) {
                        __t159 = false;
                    } else {
                        bool __ps_160 = (cons_hyeq_hygo(t1_1125, t2_1126));
                        if (tur_panicking) return ((bool)0);
                        __t159 = __ps_160;
                    }
                    __t158 = __t159;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_166) {
            ...
            int64_t __t167;
            {
                ...
                int64_t out_1141 = (int64_t)(intptr_t)(__ps_171);
                (void)out_1141;
                __t167 = out_1141;
            }
            __t165 = __t167;
        ...
        if (__ps_176) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1212 = __ps_177;
                (void)h_1212;
                void * __ps_178 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1213 = __ps_178;
                (void)k_1213;
                bool __ps_179 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1212, (void *)(intptr_t)(k_1213), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_179) {
                    void * __t180 = iter;
                    void * __t181 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t183;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1216 = __ps_185;
            (void)iter_1216;
            void * __ps_186 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_187 = (hamt_slkeyeq((void *)(intptr_t)(__ps_186)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1217 = __ps_187;
            (void)keyeq_1217;
            void * __ps_188 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_189 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1216), (void *)(intptr_t)(__ps_188), (void *)(intptr_t)(keyeq_1217)));
            if (tur_panicking) return ((bool)0);
            bool result_1218 = __ps_189;
            (void)result_1218;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t210;
        {
            ...
            {
                tur_adt_Vec__int * __ps_212 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1348));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1349 = __ps_212;
                (void)_un_unv_1349;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t216;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1399 = __ps_217;
            (void)r_1399;
            int64_t __t218;
            bool __ps_219 = (schema_hydecode_hyok_qu(r_1399));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_219) {
                int64_t __ps_220 = (schema_hydecode_hyvalue(r_1399));
                if (tur_panicking) return ((int64_t)0);
                __t218 = __ps_220;
            } else {
                int64_t __ps_221 = (schema_hydecode_hyerrors(r_1399));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t234;
        {
            int64_t __ps_235 = (__fn_1465(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_235));
            int64_t __t236;
            __t236 = INT64_C(0);
