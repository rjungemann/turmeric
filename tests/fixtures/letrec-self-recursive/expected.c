...
static int64_t __fn_1618(int64_t n) {
        int64_t __t62;
        if ((n) == (INT64_C(0))) {
            __t62 = INT64_C(1);
        } else {
            int64_t __ps_63 = (__fn_1618((n) - (INT64_C(1))));
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_995 = __ps_70;
        bool __ps_71 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_994, (void *)(intptr_t)(k_995), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_71;
        if (__t1) {
            int64_t __ps_72 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_994, (void *)(intptr_t)(k_995), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_999 = __ps_77;
            (void)iter_999;
            void * __ps_78 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_79 = (hamt_slkeyeq((void *)(intptr_t)(__ps_78)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1000 = __ps_79;
            (void)keyeq_1000;
            void * __ps_80 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_999), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_1000), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1001 = __ps_81;
            (void)result_1001;
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if (__ps_102) {
                    ...
                    bool __t104;
                    bool __ps_105 = (tnil_qu(t2_1289));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_105) {
                        __t104 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1288, t2_1289));
                        if (tur_panicking) return ((bool)0);
                        __t104 = __ps_106;
                    }
                    __t101 = __t104;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                int64_t out_1304 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1304;
                __t113 = out_1304;
            }
            __t111 = __t113;
        ...
        if (__ps_118) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1375 = __ps_119;
                (void)h_1375;
                void * __ps_120 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1376 = __ps_120;
                (void)k_1376;
                bool __ps_121 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1375, (void *)(intptr_t)(k_1376), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_121) {
                    void * __t122 = iter;
                    void * __t123 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1379 = __ps_127;
            (void)iter_1379;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1380 = __ps_129;
            (void)keyeq_1380;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1379), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1380)));
            if (tur_panicking) return ((bool)0);
            bool result_1381 = __ps_131;
            (void)result_1381;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1511));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1512 = __ps_154;
                (void)_un_unv_1512;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1562 = __ps_157;
            (void)r_1562;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1562));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                return schema_hydecode_hyvalue(r_1562);
            } else {
                int64_t __ps_159 = (schema_hydecode_hyerrors(r_1562));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t161;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1613 = __ps_162;
            (void)m_1613;
            tur_frame __frame_163;
            tur_frame_init(&__frame_163, NULL);
            struct __defer_env_164 __t166 = {.m = m_1613};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t174;
        {
            int64_t __ps_175 = (__fn_1618(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_175));
            int64_t __t176;
            __t176 = INT64_C(0);
