...
static int64_t __fn_1266(int64_t n) {
        int64_t __t43;
        if ((n) == (INT64_C(0))) {
            __t43 = INT64_C(1);
        } else {
            __auto_type __ps_44 = (__fn_1266((n) - (INT64_C(1))));
        ...
        if (__ps_135) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1060 = __ps_136;
                (void)h_1060;
                __auto_type __ps_137 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1061 = __ps_137;
                (void)k_1061;
                __auto_type __ps_138 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1060, (void *)(intptr_t)(k_1061), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_138) {
                    void * __t139 = iter;
                    void * __t140 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t142;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1064 = __ps_144;
            (void)iter_1064;
            __auto_type __ps_145 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_146 = (hamt_slkeyeq((void *)(intptr_t)(__ps_145)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1065 = __ps_146;
            (void)keyeq_1065;
            __auto_type __ps_147 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_148 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1064), (void *)(intptr_t)(__ps_147), (void *)(intptr_t)(keyeq_1065)));
            if (tur_panicking) return (bool){0};
            bool result_1066 = __ps_148;
            (void)result_1066;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t175;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1243 = __ps_176;
            (void)r_1243;
            int64_t __t177;
            __auto_type __ps_178 = (schema_hydecode_hyok_qu(r_1243));
            if (tur_panicking) return (int64_t){0};
            if (__ps_178) {
                __auto_type __ps_179 = (schema_hydecode_hyvalue(r_1243));
                if (tur_panicking) return (int64_t){0};
                __t177 = __ps_179;
            } else {
                __auto_type __ps_180 = (schema_hydecode_hyerrors(r_1243));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        int64_t __t183;
        {
            __auto_type __ps_184 = (__fn_1266(INT64_C(5)));
