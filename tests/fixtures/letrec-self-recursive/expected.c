...
static int64_t __fn_1302__cps(int64_t n_1301, DK *__kont);
...
static int64_t __fn_1302__cps(int64_t n, DK *__kont) {
    int64_t __t0;
    int64_t __t42;
    if ((n) == (INT64_C(0))) {
        __t42 = INT64_C(1);
    } else {
        int64_t __ps_43 = (__fn_1302((n) - (INT64_C(1))));
...
__attribute__((unused)) static int64_t __fn_1302(int64_t n) {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = __fn_1302__cps(n, __root); }
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_761, (void *)(intptr_t)(k_762), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_766 = __ps_75;
            (void)iter_766;
            void * __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_767 = __ps_77;
            (void)keyeq_767;
            void * __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_766), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_767), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_768 = __ps_79;
            (void)result_768;
        ...
        if (__ps_97) {
            bool __t98;
            {
                ...
                if ((t1_1009) == (INT64_C(0))) {
                    __t99 = (t2_1010) == (INT64_C(0));
                } else {
                    bool __t100;
                    if ((t2_1010) == (INT64_C(0))) {
                        __t100 = false;
                    } else {
                        bool __ps_101 = (cons_hyeq_hygo(t1_1009, t2_1010));
                        if (tur_panicking) return ((bool)0);
                        __t100 = __ps_101;
                    }
                    __t99 = __t100;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_107) {
            ...
            int64_t __t108;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1025 = (int64_t)(intptr_t)(__ps_112);
                (void)out_1025;
                __t108 = out_1025;
            }
            __t106 = __t108;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t117;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1100 = __ps_119;
            (void)iter_1100;
            void * __ps_120 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_121 = (hamt_slkeyeq((void *)(intptr_t)(__ps_120)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1101 = __ps_121;
            (void)keyeq_1101;
            void * __ps_122 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_123 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1100), (void *)(intptr_t)(__ps_122), (void *)(intptr_t)(keyeq_1101)));
            if (tur_panicking) return ((bool)0);
            bool result_1102 = __ps_123;
            (void)result_1102;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t144;
        {
            ...
            {
                tur_adt_Vec__int * __ps_146 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1229));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1230 = __ps_146;
                (void)_un_unv_1230;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t149;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1279 = __ps_150;
            (void)r_1279;
            int64_t __t151;
            bool __ps_152 = (schema_hydecode_hyok_qu(r_1279));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_152) {
                int64_t __ps_153 = (schema_hydecode_hyvalue(r_1279));
                if (tur_panicking) return ((int64_t)0);
                __t151 = __ps_153;
            } else {
                int64_t __ps_154 = (schema_hydecode_hyerrors(r_1279));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t157;
        {
            int64_t __ps_158 = (__fn_1302(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_158));
            int64_t __t159;
            __t159 = INT64_C(0);
