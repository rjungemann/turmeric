...
static int64_t __fn_1281__cps(int64_t n, DK *__kont) {
    ...
    if ((n) == (INT64_C(0))) {
        ...
        __auto_type __ps_43 = (__fn_1281((n) - (INT64_C(1))));
...
__attribute__((unused)) static int64_t __fn_1281(int64_t n) {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = __fn_1281__cps(n, __root); }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t157;
        {
            __auto_type __ps_158 = (__fn_1281(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_158));
            int64_t __t159;
            __t159 = INT64_C(0);
