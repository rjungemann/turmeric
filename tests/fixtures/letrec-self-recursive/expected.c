...
static int64_t __fn_1434(int64_t n) {
        int64_t __t40;
        if ((n) == (INT64_C(0))) {
            __t40 = INT64_C(1);
        } else {
            int64_t __ps_41 = (__fn_1434((n) - (INT64_C(1))));
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_814 = __ps_74;
        bool __ps_75 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_813, (void *)(intptr_t)(k_814), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_75;
        if (__t1) {
            int64_t __ps_76 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_77 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_813, (void *)(intptr_t)(k_814), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_818 = __ps_81;
            (void)iter_818;
            void * __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_819 = __ps_83;
            (void)keyeq_819;
            void * __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_818), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_819), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_820 = __ps_85;
            (void)result_820;
        ...
        if (__ps_104) {
            bool __t105;
            {
                ...
                if ((t1_1098) == (INT64_C(0))) {
                    __t106 = (t2_1099) == (INT64_C(0));
                } else {
                    bool __t107;
                    if ((t2_1099) == (INT64_C(0))) {
                        __t107 = false;
                    } else {
                        bool __ps_108 = (cons_hyeq_hygo(t1_1098, t2_1099));
                        if (tur_panicking) return ((bool)0);
                        __t107 = __ps_108;
                    }
                    __t106 = __t107;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1114 = (int64_t)(intptr_t)(__ps_119);
                (void)out_1114;
                __t115 = out_1114;
            }
            __t113 = __t115;
        ...
        if (__ps_124) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1185 = __ps_125;
                (void)h_1185;
                void * __ps_126 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1186 = __ps_126;
                (void)k_1186;
                bool __ps_127 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1185, (void *)(intptr_t)(k_1186), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_127) {
                    void * __t128 = iter;
                    void * __t129 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t131;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1189 = __ps_133;
            (void)iter_1189;
            void * __ps_134 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_135 = (hamt_slkeyeq((void *)(intptr_t)(__ps_134)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1190 = __ps_135;
            (void)keyeq_1190;
            void * __ps_136 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_137 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1189), (void *)(intptr_t)(__ps_136), (void *)(intptr_t)(keyeq_1190)));
            if (tur_panicking) return ((bool)0);
            bool result_1191 = __ps_137;
            (void)result_1191;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t158;
        {
            ...
            {
                tur_adt_Vec__int * __ps_160 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1318));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1319 = __ps_160;
                (void)_un_unv_1319;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t164;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1369 = __ps_165;
            (void)r_1369;
            int64_t __t166;
            bool __ps_167 = (schema_hydecode_hyok_qu(r_1369));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_167) {
                int64_t __ps_168 = (schema_hydecode_hyvalue(r_1369));
                if (tur_panicking) return ((int64_t)0);
                __t166 = __ps_168;
            } else {
                int64_t __ps_169 = (schema_hydecode_hyerrors(r_1369));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t181;
        {
            int64_t __ps_182 = (__fn_1434(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_182));
            int64_t __t183;
            __t183 = INT64_C(0);
