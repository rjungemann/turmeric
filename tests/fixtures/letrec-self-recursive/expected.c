...
static int64_t __fn_1469(int64_t n) {
        int64_t __t104;
        if ((n) == (INT64_C(0))) {
            __t104 = INT64_C(1);
        } else {
            int64_t __ps_105 = (__fn_1469((n) - (INT64_C(1))));
            if (tur_panicking) return ((int64_t)0);
            __t104 = (n) * (__ps_105);
        }
        return __t104;
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_853 = __ps_138;
        bool __ps_139 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_852, (void *)(intptr_t)(k_853), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_139;
        if (__t1) {
            int64_t __ps_140 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_141 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_852, (void *)(intptr_t)(k_853), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t143;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_857 = __ps_145;
            (void)iter_857;
            void * __ps_146 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_147 = (hamt_slkeyeq((void *)(intptr_t)(__ps_146)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_858 = __ps_147;
            (void)keyeq_858;
            void * __ps_148 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_149 = (map_hyeq_hyloop((void *)(intptr_t)(iter_857), (void *)(intptr_t)(__ps_148), (void *)(intptr_t)(keyeq_858), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_859 = __ps_149;
            (void)result_859;
        ...
        if (__ps_168) {
            bool __t169;
            {
                ...
                if ((t1_1137) == (INT64_C(0))) {
                    __t170 = (t2_1138) == (INT64_C(0));
                } else {
                    bool __t171;
                    if ((t2_1138) == (INT64_C(0))) {
                        __t171 = false;
                    } else {
                        bool __ps_172 = (cons_hyeq_hygo(t1_1137, t2_1138));
                        if (tur_panicking) return ((bool)0);
                        __t171 = __ps_172;
                    }
                    __t170 = __t171;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_178) {
            ...
            int64_t __t179;
            {
                ...
                int64_t out_1153 = (int64_t)(intptr_t)(__ps_183);
                (void)out_1153;
                __t179 = out_1153;
            }
            __t177 = __t179;
        ...
        if (__ps_188) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1224 = __ps_189;
                (void)h_1224;
                void * __ps_190 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1225 = __ps_190;
                (void)k_1225;
                bool __ps_191 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1224, (void *)(intptr_t)(k_1225), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_191) {
                    void * __t192 = iter;
                    void * __t193 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t195;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1228 = __ps_197;
            (void)iter_1228;
            void * __ps_198 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_199 = (hamt_slkeyeq((void *)(intptr_t)(__ps_198)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1229 = __ps_199;
            (void)keyeq_1229;
            void * __ps_200 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_201 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1228), (void *)(intptr_t)(__ps_200), (void *)(intptr_t)(keyeq_1229)));
            if (tur_panicking) return ((bool)0);
            bool result_1230 = __ps_201;
            (void)result_1230;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t222;
        {
            ...
            {
                tur_adt_Vec__int * __ps_224 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1360));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1361 = __ps_224;
                (void)_un_unv_1361;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t228;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1411 = __ps_229;
            (void)r_1411;
            int64_t __t230;
            bool __ps_231 = (schema_hydecode_hyok_qu(r_1411));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_231) {
                int64_t __ps_232 = (schema_hydecode_hyvalue(r_1411));
                if (tur_panicking) return ((int64_t)0);
                __t230 = __ps_232;
            } else {
                int64_t __ps_233 = (schema_hydecode_hyerrors(r_1411));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t246;
        {
            int64_t __ps_247 = (__fn_1469(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_247));
            int64_t __t248;
            __t248 = INT64_C(0);
