...
static void walk(int64_t i, int64_t n) {
        __tur_tailcall:;
        {
            int64_t j_1626 = (i) + (INT64_C(1));
            (void)j_1626;
            if ((j_1626) < (n)) {
                int64_t __t175 = j_1626;
                int64_t __t176 = n;
                i = __t175;
                n = __t176;
                goto __tur_tailcall;
...
static void with_hyref(int64_t n) {
        __tur_tailcall:;
        {
            ...
            *((int64_t *)__t177) = INT64_C(1);
            ...
            struct __defer_env_179 __t181 = {.b = b_1628};
...
static void with_hyany(int64_t n) {
        __tur_tailcall:;
        {
            tur_tagged_t a_1630 = TUR_TAG(3, (int64_t)(intptr_t)(n));
            (void)a_1630;
            if ((n) == (INT64_C(0))) {
                puts("any done");
                __tur_any_drop(a_1630);
                return;
            } else {
