...
struct __env_24 { int64_t __fn; int64_t x; };
static int64_t __fn_22(void * __env_p_25) {
        struct __env_24 *__env___env_24 = (struct __env_24 *)__env_p_25;
        return ((__env___env_24->x) + (INT64_C(1)));
}
...
int main() {
        {
            ...
            (void)x_21;
            {
                struct __env_24 *__t0 = (struct __env_24 *)malloc(sizeof(struct __env_24));
                __t0->__fn = (int64_t)(intptr_t)__fn_22;
                __t0->x = x_21;
                void *__t1 = __t0;
                void * f_27 = __t1;
                (void)f_27;
                printf("%lld\n", (long long)(__fn_22(f_27)));
            }
        }
        return (int)0;
}
