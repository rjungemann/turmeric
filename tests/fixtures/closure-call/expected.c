...
struct __env_619 { int64_t __fn; int64_t x; };
static int64_t __fn_617(void * __env_p_620) {
        struct __env_619 *__env___env_619 = (struct __env_619 *)__env_p_620;
        return ((__env___env_619->x) + (INT64_C(1)));
}
...
int main() {
        {
            ...
            (void)x_616;
            {
                struct __env_619 *__t0 = (struct __env_619 *)malloc(sizeof(struct __env_619));
                __t0->__fn = (int64_t)(intptr_t)__fn_617;
                __t0->x = x_616;
                void *__t1 = __t0;
                void * f_622 = __t1;
                (void)f_622;
                printf("%lld\n", (long long)(__fn_617(f_622)));
            }
        }
        return (int)0;
}
