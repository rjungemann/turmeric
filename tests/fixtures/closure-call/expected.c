...
struct __env_211 { int64_t __fn; int64_t x; };
static int64_t __fn_209(void * __env_p_212) {
        struct __env_211 *__env___env_211 = (struct __env_211 *)__env_p_212;
        return ((__env___env_211->x) + (INT64_C(1)));
}
...
int main() {
        {
            ...
            (void)x_208;
            {
                struct __env_211 *__t0 = (struct __env_211 *)malloc(sizeof(struct __env_211));
                __t0->__fn = (int64_t)(intptr_t)__fn_209;
                __t0->x = x_208;
                void *__t1 = __t0;
                void * f_214 = __t1;
                (void)f_214;
                printf("%lld\n", (long long)(__fn_209(f_214)));
            }
        }
        return (int)0;
}
