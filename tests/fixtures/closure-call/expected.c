...
struct __env_199 { int64_t __fn; int64_t x; };
static int64_t __fn_197(void * __env_p_200) {
        struct __env_199 *__env___env_199 = (struct __env_199 *)__env_p_200;
        return ((__env___env_199->x) + (INT64_C(1)));
}
...
int main() {
        {
            ...
            (void)x_196;
            {
                struct __env_199 *__t0 = (struct __env_199 *)malloc(sizeof(struct __env_199));
                __t0->__fn = (int64_t)(intptr_t)__fn_197;
                __t0->x = x_196;
                void *__t1 = __t0;
                void * f_202 = __t1;
                (void)f_202;
                printf("%lld\n", (long long)(__fn_197(f_202)));
            }
        }
        return (int)0;
}
