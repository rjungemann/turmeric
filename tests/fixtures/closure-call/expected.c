...
struct __env_264 { int64_t __fn; int64_t x; };
static int64_t __fn_262(void * __env_p_265) {
        struct __env_264 *__env___env_264 = (struct __env_264 *)__env_p_265;
        return ((__env___env_264->x) + (INT64_C(1)));
}
...
int main() {
        {
            ...
            (void)x_261;
            {
                struct __env_264 *__t0 = (struct __env_264 *)malloc(sizeof(struct __env_264));
                __t0->__fn = (int64_t)(intptr_t)__fn_262;
                __t0->x = x_261;
                void *__t1 = __t0;
                void * f_267 = __t1;
                (void)f_267;
                printf("%lld\n", (long long)(__fn_262(f_267)));
            }
        }
        return (int)0;
}
