...
static bool __fn_797(int64_t n) {
        bool __t1;
        if ((n) == (INT64_C(0))) {
            __t1 = true;
        } else {
            __t1 = __fn_800((n) - (INT64_C(1)));
        }
        return __t1;
}

static bool __fn_800(int64_t n) {
        bool __t2;
        if ((n) == (INT64_C(0))) {
            __t2 = false;
        } else {
            __t2 = __fn_797((n) - (INT64_C(1)));
        }
        return __t2;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t4;
        {
            puts((__fn_797(INT64_C(4))) ? "true" : "false");
            puts((__fn_800(INT64_C(3))) ? "true" : "false");
            int64_t __t5;
            __t5 = INT64_C(0);
            __t4 = __t5;
        }
