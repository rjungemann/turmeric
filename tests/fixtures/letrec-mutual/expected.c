...
__attribute__((unused)) static bool __fn_1282(int64_t n) {
    ...
    if (setjmp(__dkjb) == 0) { __r = __fn_1282__cps(n, __root); }
...
__attribute__((unused)) static bool __fn_1285(int64_t n) {
    ...
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = __fn_1285__cps(n, __root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    bool __ret = (bool)(__r);
    if (!tur_async_suspended) dk_free(__root);
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_741, (void *)(intptr_t)(k_742), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_746 = __ps_75;
            (void)iter_746;
            __auto_type __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return (bool){0};
            void * keyeq_747 = __ps_77;
            (void)keyeq_747;
            __auto_type __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_746), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_747), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_748 = __ps_79;
            (void)result_748;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_97) {
            bool __t98;
            {
                ...
                bool __t99;
                if ((t1_988) == (INT64_C(0))) {
                    __t99 = (t2_989) == (INT64_C(0));
                } else {
                    bool __t100;
                    if ((t2_989) == (INT64_C(0))) {
                        __t100 = false;
                    } else {
                        __auto_type __ps_101 = (cons_hyeq_hygo(t1_988, t2_989));
                        if (tur_panicking) return (bool){0};
                        __t100 = __ps_101;
                    }
                    __t99 = __t100;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_107) {
            ...
            int64_t __t108;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1004 = (int64_t)(intptr_t)(__ps_112);
                (void)out_1004;
                __t108 = out_1004;
            }
            __t106 = __t108;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t117;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1079 = __ps_119;
            (void)iter_1079;
            __auto_type __ps_120 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_121 = (hamt_slkeyeq((void *)(intptr_t)(__ps_120)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1080 = __ps_121;
            (void)keyeq_1080;
            __auto_type __ps_122 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_123 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1079), (void *)(intptr_t)(__ps_122), (void *)(intptr_t)(keyeq_1080)));
            if (tur_panicking) return (bool){0};
            bool result_1081 = __ps_123;
            (void)result_1081;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t144;
        {
            ...
            {
                __auto_type __ps_146 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1208));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1209 = __ps_146;
                (void)_un_unv_1209;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t149;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1258 = __ps_150;
            (void)r_1258;
            int64_t __t151;
            __auto_type __ps_152 = (schema_hydecode_hyok_qu(r_1258));
            if (tur_panicking) return (int64_t){0};
            if (__ps_152) {
                __auto_type __ps_153 = (schema_hydecode_hyvalue(r_1258));
                if (tur_panicking) return (int64_t){0};
                __t151 = __ps_153;
            } else {
                __auto_type __ps_154 = (schema_hydecode_hyerrors(r_1258));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t157;
        {
            __auto_type __ps_158 = (__fn_1282(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_158) ? "true" : "false");
            __auto_type __ps_159 = (__fn_1285(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
