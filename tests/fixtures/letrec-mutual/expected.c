...
static bool __fn_1470(int64_t);
static bool __fn_1473(int64_t);
...
static bool __fn_1470(int64_t n) {
        bool __t104;
        if ((n) == (INT64_C(0))) {
            __t104 = true;
        } else {
            bool __ps_105 = (__fn_1473((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t104 = __ps_105;
        }
        return __t104;
...
static bool __fn_1473(int64_t n) {
        bool __t106;
        if ((n) == (INT64_C(0))) {
            __t106 = false;
        } else {
            bool __ps_107 = (__fn_1470((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t106 = __ps_107;
        }
        return __t106;
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_853 = __ps_140;
        bool __ps_141 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_852, (void *)(intptr_t)(k_853), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_141;
        if (__t1) {
            int64_t __ps_142 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_143 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_852, (void *)(intptr_t)(k_853), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t145;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_857 = __ps_147;
            (void)iter_857;
            void * __ps_148 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_149 = (hamt_slkeyeq((void *)(intptr_t)(__ps_148)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_858 = __ps_149;
            (void)keyeq_858;
            void * __ps_150 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_151 = (map_hyeq_hyloop((void *)(intptr_t)(iter_857), (void *)(intptr_t)(__ps_150), (void *)(intptr_t)(keyeq_858), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_859 = __ps_151;
            (void)result_859;
        ...
        if (__ps_170) {
            bool __t171;
            {
                ...
                if ((t1_1137) == (INT64_C(0))) {
                    __t172 = (t2_1138) == (INT64_C(0));
                } else {
                    bool __t173;
                    if ((t2_1138) == (INT64_C(0))) {
                        __t173 = false;
                    } else {
                        bool __ps_174 = (cons_hyeq_hygo(t1_1137, t2_1138));
                        if (tur_panicking) return ((bool)0);
                        __t173 = __ps_174;
                    }
                    __t172 = __t173;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_180) {
            ...
            int64_t __t181;
            {
                ...
                int64_t out_1153 = (int64_t)(intptr_t)(__ps_185);
                (void)out_1153;
                __t181 = out_1153;
            }
            __t179 = __t181;
        ...
        if (__ps_190) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1224 = __ps_191;
                (void)h_1224;
                void * __ps_192 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1225 = __ps_192;
                (void)k_1225;
                bool __ps_193 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1224, (void *)(intptr_t)(k_1225), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_193) {
                    void * __t194 = iter;
                    void * __t195 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t197;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1228 = __ps_199;
            (void)iter_1228;
            void * __ps_200 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_201 = (hamt_slkeyeq((void *)(intptr_t)(__ps_200)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1229 = __ps_201;
            (void)keyeq_1229;
            void * __ps_202 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_203 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1228), (void *)(intptr_t)(__ps_202), (void *)(intptr_t)(keyeq_1229)));
            if (tur_panicking) return ((bool)0);
            bool result_1230 = __ps_203;
            (void)result_1230;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t248;
        {
            bool __ps_249 = (__fn_1470(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_249) ? "true" : "false");
            bool __ps_250 = (__fn_1473(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_250) ? "true" : "false");
            int64_t __t251;
            __t251 = INT64_C(0);
            __t248 = __t251;
        }
