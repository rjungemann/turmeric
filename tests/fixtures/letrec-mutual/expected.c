...
static bool __fn_1010(int64_t);
static bool __fn_1013(int64_t);
...
static bool __fn_1010(int64_t n) {
        bool __t29;
        if ((n) == (INT64_C(0))) {
            __t29 = true;
        } else {
            __t29 = __fn_1013((n) - (INT64_C(1)));
        }
        return __t29;
}

static bool __fn_1013(int64_t n) {
        bool __t30;
        if ((n) == (INT64_C(0))) {
            __t30 = false;
        } else {
            __t30 = __fn_1010((n) - (INT64_C(1)));
        }
        return __t30;
}
            ...
            bool __t32;
            {
                ...
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_650, (void *)(intptr_t)(k_651), (void *)(intptr_t)(keyeq))) {
                    ...
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)), map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_650, (void *)(intptr_t)(k_651), (void *)(intptr_t)(keyeq)))) {
                        __t34 = map_hyeq_hyloop((void *)(intptr_t)(iter), (void *)(intptr_t)(m2_hamt), (void *)(intptr_t)(keyeq), (int64_t)(intptr_t)(val_cmp));
                    } else {
                        __t34 = false;
                    }
                    __t33 = __t34;
...
static bool vec_hyeq_hyloop(int64_t x, int64_t y, int64_t i, int64_t len, int64_t cmp) {
        ...
        if ((i) == (len)) {
            ...
            if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(cmp)))[0])((void *)(intptr_t)(cmp), vec_hyget(x, i), vec_hyget(y, i))) {
                __t38 = vec_hyeq_hyloop(x, y, (i) + (INT64_C(1)), len, (int64_t)(intptr_t)(cmp));
            } else {
                __t38 = false;
            }
            __t37 = __t38;
        ...
        if (tnil_qu(l1)) {
            ...
            if (tnil_qu(l2)) {
                ...
                if ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), list_hyhead(l1), list_hyhead(l2))) {
                    __t41 = list_hyeq_qu(list_hytail(l1), list_hytail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t41 = false;
                }
                __t40 = __t41;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            __t42 = tcons((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f)));
        }
        return __t42;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            __t43 = tcons(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2));
        }
        return __t43;
}
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        bool __t49 = (set_hycount(s1)) == (set_hycount(s2));
        if (__t49) {
            __t49 = set_hyeq_hydriver(s1, s2);
        }
        return __t49;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t54;
        {
            puts((__fn_1010(INT64_C(4))) ? "true" : "false");
            puts((__fn_1013(INT64_C(3))) ? "true" : "false");
            int64_t __t55;
            __t55 = INT64_C(0);
            __t54 = __t55;
        }
