...
static bool __fn_1284(int64_t);
static bool __fn_1287(int64_t);
...
static int64_t __fn_1284__cps(int64_t n_1283, DK *__kont);
static int64_t __fn_1287__cps(int64_t n_1286, DK *__kont);
...
static int64_t __fn_1284__cps(int64_t n, DK *__kont) {
    bool __t0;
    bool __t42;
    if ((n) == (INT64_C(0))) {
        __t42 = true;
    } else {
        __auto_type __ps_43 = (__fn_1287((n) - (INT64_C(1))));
...
static int64_t __fn_1287__cps(int64_t n, DK *__kont) {
    bool __t0;
    bool __t44;
    if ((n) == (INT64_C(0))) {
        __t44 = false;
    } else {
        __auto_type __ps_45 = (__fn_1284((n) - (INT64_C(1))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t44 = __ps_45;
    }
    __t0 = __t44;
...
__attribute__((unused)) static bool __fn_1287(int64_t n) {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = __fn_1287__cps(n, __root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    bool __ret = (bool)(__r);
    if (!tur_async_suspended) dk_free(__root);
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_742, (void *)(intptr_t)(k_743), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_747 = __ps_77;
            (void)iter_747;
            __auto_type __ps_78 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_79 = (hamt_slkeyeq((void *)(intptr_t)(__ps_78)));
            if (tur_panicking) return (bool){0};
            void * keyeq_748 = __ps_79;
            (void)keyeq_748;
            __auto_type __ps_80 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_747), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_748), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_749 = __ps_81;
            (void)result_749;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t159;
        {
            __auto_type __ps_160 = (__fn_1284(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_160) ? "true" : "false");
            __auto_type __ps_161 = (__fn_1287(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
