...
static bool __fn_1331(int64_t);
static bool __fn_1334(int64_t);
...
static bool __fn_1331(int64_t n) {
        bool __t42;
        if ((n) == (INT64_C(0))) {
            __t42 = true;
        } else {
            bool __ps_43 = (__fn_1334((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t42 = __ps_43;
        }
        return __t42;
...
static bool __fn_1334(int64_t n) {
        bool __t44;
        if ((n) == (INT64_C(0))) {
            __t44 = false;
        } else {
            bool __ps_45 = (__fn_1331((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t44 = __ps_45;
        }
        return __t44;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_77 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_788, (void *)(intptr_t)(k_789), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_793 = __ps_81;
            (void)iter_793;
            void * __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_794 = __ps_83;
            (void)keyeq_794;
            void * __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_793), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_794), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_795 = __ps_85;
            (void)result_795;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t163;
        {
            bool __ps_164 = (__fn_1331(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_164) ? "true" : "false");
            bool __ps_165 = (__fn_1334(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
