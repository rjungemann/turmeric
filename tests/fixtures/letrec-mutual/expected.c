...
static bool __fn_871(int64_t);
static bool __fn_874(int64_t);
...
static bool __fn_871(int64_t n) {
        bool __t18;
        if ((n) == (INT64_C(0))) {
            __t18 = true;
        } else {
            __t18 = __fn_874((n) - (INT64_C(1)));
        }
        return __t18;
}

static bool __fn_874(int64_t n) {
        bool __t19;
        if ((n) == (INT64_C(0))) {
            __t19 = false;
        } else {
            __t19 = __fn_871((n) - (INT64_C(1)));
        }
        return __t19;
}
...
static bool vec_hyeq_hyloop(int64_t xi, int64_t yi, int64_t i, int64_t len, int64_t cmp) {
        ...
        if ((i) == (len)) {
            ...
            if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(cmp)))[0])((void *)(intptr_t)(cmp), vec_hyget(xi, i), vec_hyget(yi, i))) {
                __t21 = vec_hyeq_hyloop(xi, yi, (i) + (INT64_C(1)), len, (int64_t)(intptr_t)(cmp));
            } else {
                __t21 = false;
            }
            __t20 = __t21;
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            puts((__fn_871(INT64_C(4))) ? "true" : "false");
            puts((__fn_874(INT64_C(3))) ? "true" : "false");
            int64_t __t28;
            __t28 = INT64_C(0);
            __t27 = __t28;
        }
