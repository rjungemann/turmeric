...
static bool __fn_1622(int64_t);
static bool __fn_1625(int64_t);
...
static bool __fn_1622(int64_t n) {
        if ((n) == (INT64_C(0))) {
            return true;
        } else {
            TUR_MUSTTAIL return __fn_1625((n) - (INT64_C(1)));
        }
}

static bool __fn_1625(int64_t n) {
        if ((n) == (INT64_C(0))) {
            return false;
        } else {
            TUR_MUSTTAIL return __fn_1622((n) - (INT64_C(1)));
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t172;
        {
            bool __ps_173 = (__fn_1622(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_173) ? "true" : "false");
            bool __ps_174 = (__fn_1625(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
