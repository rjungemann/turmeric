...
static int64_t __fn_1270__cps(int64_t n_1269, DK *__kont);
static int64_t __fn_1273__cps(int64_t n_1272, DK *__kont);
...
static int64_t __fn_1270__cps(int64_t n, DK *__kont) {
    bool t0;
    bool t1;
    t0 = (n) == (INT64_C(0));
    if (t0) {
...
static int64_t __fn_1273__cps(int64_t n, DK *__kont) {
    bool t0;
    bool t1;
    t0 = (n) == (INT64_C(0));
    if (t0) {
