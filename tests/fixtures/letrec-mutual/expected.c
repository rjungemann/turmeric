...
static bool __fn_812(int64_t n) {
        bool __t2;
        if ((n) == (INT64_C(0))) {
            __t2 = true;
        } else {
            __t2 = __fn_815((n) - (INT64_C(1)));
        }
        return __t2;
}

static bool __fn_815(int64_t n) {
        bool __t3;
        if ((n) == (INT64_C(0))) {
            __t3 = false;
        } else {
            __t3 = __fn_812((n) - (INT64_C(1)));
        }
        return __t3;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t5;
        {
            puts((__fn_812(INT64_C(4))) ? "true" : "false");
            puts((__fn_815(INT64_C(3))) ? "true" : "false");
            int64_t __t6;
            __t6 = INT64_C(0);
            __t5 = __t6;
        }
