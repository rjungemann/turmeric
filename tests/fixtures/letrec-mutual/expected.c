...
static bool __fn_1435(int64_t);
static bool __fn_1438(int64_t);
...
static bool __fn_1435(int64_t n) {
        bool __t40;
        if ((n) == (INT64_C(0))) {
            __t40 = true;
        } else {
            bool __ps_41 = (__fn_1438((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t40 = __ps_41;
        }
        return __t40;
...
static bool __fn_1438(int64_t n) {
        bool __t42;
        if ((n) == (INT64_C(0))) {
            __t42 = false;
        } else {
            bool __ps_43 = (__fn_1435((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t42 = __ps_43;
        }
        return __t42;
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_814 = __ps_76;
        bool __ps_77 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_813, (void *)(intptr_t)(k_814), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_77;
        if (__t1) {
            int64_t __ps_78 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_79 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_813, (void *)(intptr_t)(k_814), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t81;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_818 = __ps_83;
            (void)iter_818;
            void * __ps_84 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_85 = (hamt_slkeyeq((void *)(intptr_t)(__ps_84)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_819 = __ps_85;
            (void)keyeq_819;
            void * __ps_86 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_87 = (map_hyeq_hyloop((void *)(intptr_t)(iter_818), (void *)(intptr_t)(__ps_86), (void *)(intptr_t)(keyeq_819), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_820 = __ps_87;
            (void)result_820;
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                if ((t1_1098) == (INT64_C(0))) {
                    __t108 = (t2_1099) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_1099) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        bool __ps_110 = (cons_hyeq_hygo(t1_1098, t2_1099));
                        if (tur_panicking) return ((bool)0);
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1114 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1114;
                __t117 = out_1114;
            }
            __t115 = __t117;
        ...
        if (__ps_126) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1185 = __ps_127;
                (void)h_1185;
                void * __ps_128 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1186 = __ps_128;
                (void)k_1186;
                bool __ps_129 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1185, (void *)(intptr_t)(k_1186), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_129) {
                    void * __t130 = iter;
                    void * __t131 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t133;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1189 = __ps_135;
            (void)iter_1189;
            void * __ps_136 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_137 = (hamt_slkeyeq((void *)(intptr_t)(__ps_136)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1190 = __ps_137;
            (void)keyeq_1190;
            void * __ps_138 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_139 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1189), (void *)(intptr_t)(__ps_138), (void *)(intptr_t)(keyeq_1190)));
            if (tur_panicking) return ((bool)0);
            bool result_1191 = __ps_139;
            (void)result_1191;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t160;
        {
            ...
            {
                tur_adt_Vec__int * __ps_162 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1318));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1319 = __ps_162;
                (void)_un_unv_1319;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t166;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1369 = __ps_167;
            (void)r_1369;
            int64_t __t168;
            bool __ps_169 = (schema_hydecode_hyok_qu(r_1369));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_169) {
                int64_t __ps_170 = (schema_hydecode_hyvalue(r_1369));
                if (tur_panicking) return ((int64_t)0);
                __t168 = __ps_170;
            } else {
                int64_t __ps_171 = (schema_hydecode_hyerrors(r_1369));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t183;
        {
            bool __ps_184 = (__fn_1435(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_184) ? "true" : "false");
            bool __ps_185 = (__fn_1438(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
