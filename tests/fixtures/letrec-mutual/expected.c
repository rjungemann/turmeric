...
static bool __fn_1264(int64_t n) {
        bool __t19;
        if ((n) == (INT64_C(0))) {
            __t19 = true;
        } else {
            __t19 = __fn_1267((n) - (INT64_C(1)));
        }
        return __t19;
}
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t50;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1240)) {
                __t51 = schema_hydecode_hyvalue(r_1240);
            } else {
                __t51 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1240));
            }
            __t50 = __t51;
        }
        return __t50;
...
int main(int argc, char **argv) {
        ...
        int64_t __t52;
        {
            puts((__fn_1264(INT64_C(4))) ? "true" : "false");
            puts((__fn_1267(INT64_C(3))) ? "true" : "false");
            int64_t __t53;
            __t53 = INT64_C(0);
            __t52 = __t53;
        }
