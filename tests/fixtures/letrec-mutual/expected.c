...
static bool __fn_1282(int64_t);
static bool __fn_1285(int64_t);
...
static int64_t __fn_1282__cps(int64_t n_1281, DK *__kont);
static int64_t __fn_1285__cps(int64_t n_1284, DK *__kont);
...
static int64_t __fn_1282__cps(int64_t n, DK *__kont) {
    bool __t0;
    bool __t40;
    if ((n) == (INT64_C(0))) {
        __t40 = true;
    } else {
        __auto_type __ps_41 = (__fn_1285((n) - (INT64_C(1))));
...
__attribute__((unused)) static bool __fn_1282(int64_t n) {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = __fn_1282__cps(n, __root);
    bool __ret = (bool)(__r);
    if (!tur_async_suspended) dk_free(__root);
    if (!tur_async_suspended && --__dk_entry_depth == 0) __dk_reap_run();
    return __ret;
}
static int64_t __fn_1285__cps(int64_t n, DK *__kont) {
    bool __t0;
    bool __t42;
    if ((n) == (INT64_C(0))) {
        __t42 = false;
    } else {
        __auto_type __ps_43 = (__fn_1282((n) - (INT64_C(1))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t42 = __ps_43;
    }
    __t0 = __t42;
...
__attribute__((unused)) static bool __fn_1285(int64_t n) {
    __dk_entry_depth++;
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = __fn_1285__cps(n, __root);
    bool __ret = (bool)(__r);
    if (!tur_async_suspended) dk_free(__root);
    if (!tur_async_suspended && --__dk_entry_depth == 0) __dk_reap_run();
    return __ret;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t177;
        {
            __auto_type __ps_178 = (__fn_1282(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_178) ? "true" : "false");
            __auto_type __ps_179 = (__fn_1285(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
