...
static bool __fn_1369(int64_t);
static bool __fn_1372(int64_t);
...
static bool __fn_1369(int64_t n) {
        bool __t44;
        if ((n) == (INT64_C(0))) {
            __t44 = true;
        } else {
            bool __ps_45 = (__fn_1372((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t44 = __ps_45;
        }
        return __t44;
...
static bool __fn_1372(int64_t n) {
        bool __t46;
        if ((n) == (INT64_C(0))) {
            __t46 = false;
        } else {
            bool __ps_47 = (__fn_1369((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t46 = __ps_47;
        }
        return __t46;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t167;
        {
            bool __ps_168 = (__fn_1369(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_168) ? "true" : "false");
            bool __ps_169 = (__fn_1372(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
