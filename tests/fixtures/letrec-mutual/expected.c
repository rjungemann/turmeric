...
static bool __fn_885(int64_t);
static bool __fn_888(int64_t);
...
static bool __fn_885(int64_t n) {
        bool __t16;
        if ((n) == (INT64_C(0))) {
            __t16 = true;
        } else {
            __t16 = __fn_888((n) - (INT64_C(1)));
        }
        return __t16;
}

static bool __fn_888(int64_t n) {
        bool __t17;
        if ((n) == (INT64_C(0))) {
            __t17 = false;
        } else {
            __t17 = __fn_885((n) - (INT64_C(1)));
        }
        return __t17;
}
...
static bool vec_hyeq_hyloop_hybyval(int64_t x, int64_t y, int64_t i, int64_t len) {
        ...
        if ((i) == (len)) {
            ...
            if (__inst_Eq_eq_qu_int(vec_hydata_hyget_un_un((void *)(intptr_t)(((Vec *)(intptr_t)(x))->data), i), vec_hydata_hyget_un_un((void *)(intptr_t)(((Vec *)(intptr_t)(y))->data), i))) {
                __t21 = vec_hyeq_hyloop_hybyval(x, y, (i) + (INT64_C(1)), len);
            } else {
                __t21 = false;
            }
            __t20 = __t21;
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            puts((__fn_885(INT64_C(4))) ? "true" : "false");
            puts((__fn_888(INT64_C(3))) ? "true" : "false");
            int64_t __t28;
            __t28 = INT64_C(0);
            __t27 = __t28;
        }
