...
static bool __fn_1333(int64_t);
static bool __fn_1336(int64_t);
...
static bool __fn_1333(int64_t n) {
        bool __t42;
        if ((n) == (INT64_C(0))) {
            __t42 = true;
        } else {
            bool __ps_43 = (__fn_1336((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t42 = __ps_43;
        }
        return __t42;
...
static bool __fn_1336(int64_t n) {
        bool __t44;
        if ((n) == (INT64_C(0))) {
            __t44 = false;
        } else {
            bool __ps_45 = (__fn_1333((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t44 = __ps_45;
        }
        return __t44;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t156;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1309 = __ps_157;
            (void)r_1309;
            int64_t __t158;
            bool __ps_159 = (schema_hydecode_hyok_qu(r_1309));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_159) {
                int64_t __ps_160 = (schema_hydecode_hyvalue(r_1309));
                if (tur_panicking) return ((int64_t)0);
                __t158 = __ps_160;
            } else {
                int64_t __ps_161 = (schema_hydecode_hyerrors(r_1309));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t164;
        {
            bool __ps_165 = (__fn_1333(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_165) ? "true" : "false");
            bool __ps_166 = (__fn_1336(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
