...
static bool __fn_903(int64_t);
static bool __fn_906(int64_t);
...
static bool __fn_903(int64_t n) {
        bool __t18;
        if ((n) == (INT64_C(0))) {
            __t18 = true;
        } else {
            __t18 = __fn_906((n) - (INT64_C(1)));
        }
        return __t18;
}

static bool __fn_906(int64_t n) {
        bool __t19;
        if ((n) == (INT64_C(0))) {
            __t19 = false;
        } else {
            __t19 = __fn_903((n) - (INT64_C(1)));
        }
        return __t19;
}
...
static bool vec_hyeq_hyloop(int64_t x, int64_t y, int64_t i, int64_t len, int64_t cmp) {
        ...
        if ((i) == (len)) {
            ...
            if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(cmp)))[0])((void *)(intptr_t)(cmp), vec_hyget(x, i), vec_hyget(y, i))) {
                __t21 = vec_hyeq_hyloop(x, y, (i) + (INT64_C(1)), len, (int64_t)(intptr_t)(cmp));
            } else {
                __t21 = false;
            }
            __t20 = __t21;
            ...
            if (mutmap_hyslot_hyoccupied_qu(m1, i)) {
                ...
                if (mutmap_hyhas_qu(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i))) {
                    ...
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), mutmap_hyslot_hyvalue(m1, i), mutmap_hyget(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i)))) {
                        __t30 = mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp));
                    } else {
                        __t30 = false;
                    }
                    __t29 = __t30;
...
int main(int argc, char **argv) {
        ...
        int64_t __t31;
        {
            puts((__fn_903(INT64_C(4))) ? "true" : "false");
            puts((__fn_906(INT64_C(3))) ? "true" : "false");
            int64_t __t32;
            __t32 = INT64_C(0);
            __t31 = __t32;
        }
