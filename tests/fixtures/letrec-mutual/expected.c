...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__inst_Eq_eq_qu_int((int64_t)((tur_adt_Cons *)(intptr_t)(c1))->head, (int64_t)((tur_adt_Cons *)(intptr_t)(c2))->head)) {
            bool __t34;
            {
                ...
                bool __t35;
                if ((t1_979) == (INT64_C(0))) {
                    __t35 = (t2_980) == (INT64_C(0));
                } else {
                    bool __t36;
                    if ((t2_980) == (INT64_C(0))) {
                        __t36 = false;
                    } else {
                        __t36 = cons_hyeq_hygo(t1_979, t2_980);
                    }
                    __t35 = __t36;
                }
                __t34 = __t35;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t55;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1243)) {
                __t56 = schema_hydecode_hyvalue(r_1243);
            } else {
                __t56 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1243));
            }
            __t55 = __t56;
        }
        return __t55;
...
int main(int argc, char **argv) {
        ...
        int64_t __t57;
        {
            puts((__fn_1267(INT64_C(4))) ? "true" : "false");
            puts((__fn_1270(INT64_C(3))) ? "true" : "false");
            int64_t __t58;
            __t58 = INT64_C(0);
            __t57 = __t58;
        }
