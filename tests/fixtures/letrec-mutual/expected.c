...
static bool __fn_1468(int64_t);
static bool __fn_1471(int64_t);
...
static bool __fn_1468(int64_t n) {
        bool __t124;
        if ((n) == (INT64_C(0))) {
            __t124 = true;
        } else {
            bool __ps_125 = (__fn_1471((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t124 = __ps_125;
        }
        return __t124;
...
static bool __fn_1471(int64_t n) {
        bool __t126;
        if ((n) == (INT64_C(0))) {
            __t126 = false;
        } else {
            bool __ps_127 = (__fn_1468((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t126 = __ps_127;
        }
        return __t126;
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t258;
        {
            ...
            struct __defer_env_261 __t263 = {.m = m_1462};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t271;
        {
            bool __ps_272 = (__fn_1468(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_272) ? "true" : "false");
            bool __ps_273 = (__fn_1471(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
