...
static bool __fn_848(int64_t n) {
        bool __t2;
        if ((n) == (INT64_C(0))) {
            __t2 = true;
        } else {
            __t2 = __fn_851((n) - (INT64_C(1)));
        }
        return __t2;
}

static bool __fn_851(int64_t n) {
        bool __t3;
        if ((n) == (INT64_C(0))) {
            __t3 = false;
        } else {
            __t3 = __fn_848((n) - (INT64_C(1)));
        }
        return __t3;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t5;
        {
            puts((__fn_848(INT64_C(4))) ? "true" : "false");
            puts((__fn_851(INT64_C(3))) ? "true" : "false");
            int64_t __t6;
            __t6 = INT64_C(0);
            __t5 = __t6;
        }
