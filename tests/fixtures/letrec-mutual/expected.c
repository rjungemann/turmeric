...
static int64_t __fn_1276__cps(int64_t n_1275, DK *__kont);
...
static int64_t __fn_1273__cps(int64_t n, DK *__kont) {
    ...
    if (__t0) {
        ...
        __auto_type __ps_40 = (__fn_1276((n) - (INT64_C(1))));
...
static int64_t __fn_1276__cps(int64_t n, DK *__kont) {
    bool __t0;
    bool __t1;
    __t0 = (n) == (INT64_C(0));
    if (__t0) {
...
__attribute__((unused)) static bool __fn_1276(int64_t n) {
    DK *__root = dk_prompt(DK_ROOT_TAG, dk_done());
    int64_t __r = __fn_1276__cps(n, __root);
    dk_free(__root);
    return (bool)(__r);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t175;
        {
            __auto_type __ps_176 = (__fn_1273(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            __auto_type __ps_177 = (__fn_1276(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
