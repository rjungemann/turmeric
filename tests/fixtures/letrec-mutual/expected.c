...
static bool __fn_1609(int64_t);
static bool __fn_1612(int64_t);
...
static bool __fn_1609(int64_t n) {
        bool __t128;
        if ((n) == (INT64_C(0))) {
            __t128 = true;
        } else {
            bool __ps_129 = (__fn_1612((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t128 = __ps_129;
        }
        return __t128;
...
static bool __fn_1612(int64_t n) {
        bool __t130;
        if ((n) == (INT64_C(0))) {
            __t130 = false;
        } else {
            bool __ps_131 = (__fn_1609((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t130 = __ps_131;
        }
        return __t130;
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_994 = __ps_168;
        bool __ps_169 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_993, (void *)(intptr_t)(k_994), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_169;
        if (__t1) {
            int64_t __ps_170 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_171 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_993, (void *)(intptr_t)(k_994), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t173;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_998 = __ps_175;
            (void)iter_998;
            void * __ps_176 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_177 = (hamt_slkeyeq((void *)(intptr_t)(__ps_176)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_999 = __ps_177;
            (void)keyeq_999;
            void * __ps_178 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_179 = (map_hyeq_hyloop((void *)(intptr_t)(iter_998), (void *)(intptr_t)(__ps_178), (void *)(intptr_t)(keyeq_999), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1000 = __ps_179;
            (void)result_1000;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_198) {
            bool __t199;
            {
                ...
                (void)t2_1279;
                bool __t200;
                bool __ps_201 = (tnil_qu(t1_1278));
                if (tur_panicking) return ((bool)0);
                if (__ps_201) {
                    bool __ps_202 = (tnil_qu(t2_1279));
                    if (tur_panicking) return ((bool)0);
                    __t200 = __ps_202;
                } else {
                    bool __t203;
                    bool __ps_204 = (tnil_qu(t2_1279));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_204) {
                        __t203 = false;
                    } else {
                        bool __ps_205 = (cons_hyeq_hygo(t1_1278, t2_1279));
                        if (tur_panicking) return ((bool)0);
                        __t203 = __ps_205;
                    }
                    __t200 = __t203;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_211) {
            ...
            int64_t __t212;
            {
                ...
                int64_t out_1294 = (int64_t)(intptr_t)(__ps_216);
                (void)out_1294;
                __t212 = out_1294;
            }
            __t210 = __t212;
        ...
        if (__ps_220) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1365 = __ps_221;
                (void)h_1365;
                void * __ps_222 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1366 = __ps_222;
                (void)k_1366;
                bool __ps_223 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1365, (void *)(intptr_t)(k_1366), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_223) {
                    void * __t224 = iter;
                    void * __t225 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t227;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1369 = __ps_229;
            (void)iter_1369;
            void * __ps_230 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_231 = (hamt_slkeyeq((void *)(intptr_t)(__ps_230)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1370 = __ps_231;
            (void)keyeq_1370;
            void * __ps_232 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_233 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1369), (void *)(intptr_t)(__ps_232), (void *)(intptr_t)(keyeq_1370)));
            if (tur_panicking) return ((bool)0);
            bool result_1371 = __ps_233;
            (void)result_1371;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t254;
        {
            ...
            {
                tur_adt_Vec__int * __ps_256 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1501));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1502 = __ps_256;
                (void)_un_unv_1502;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t260;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1552 = __ps_261;
            (void)r_1552;
            int64_t __t262;
            bool __ps_263 = (schema_hydecode_hyok_qu(r_1552));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_263) {
                int64_t __ps_264 = (schema_hydecode_hyvalue(r_1552));
                if (tur_panicking) return ((int64_t)0);
                __t262 = __ps_264;
            } else {
                int64_t __ps_265 = (schema_hydecode_hyerrors(r_1552));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t268;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1603 = __ps_269;
            (void)m_1603;
            tur_frame __frame_270;
            tur_frame_init(&__frame_270, NULL);
            struct __defer_env_271 __t273 = {.m = m_1603};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t281;
        {
            bool __ps_282 = (__fn_1609(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_282) ? "true" : "false");
            bool __ps_283 = (__fn_1612(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
