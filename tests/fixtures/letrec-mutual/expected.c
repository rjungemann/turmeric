...
static bool __fn_760(int64_t n) {
        bool __t0;
        if ((n) == (INT64_C(0))) {
            __t0 = true;
        } else {
            __t0 = __fn_763((n) - (INT64_C(1)));
        }
        return __t0;
}

static bool __fn_763(int64_t n) {
        bool __t1;
        if ((n) == (INT64_C(0))) {
            __t1 = false;
        } else {
            __t1 = __fn_760((n) - (INT64_C(1)));
        }
        return __t1;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t3;
        {
            puts((__fn_760(INT64_C(4))) ? "true" : "false");
            puts((__fn_763(INT64_C(3))) ? "true" : "false");
            int64_t __t4;
            __t4 = INT64_C(0);
            __t3 = __t4;
        }
