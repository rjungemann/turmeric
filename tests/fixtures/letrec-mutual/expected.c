...
static bool __fn_1470(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            bool __ps_125 = (__fn_1473((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t124 = __ps_125;
        }
        return __t124;
...
static bool __fn_1473(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            bool __ps_127 = (__fn_1470((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t126 = __ps_127;
        }
        return __t126;
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_853 = __ps_160;
        bool __ps_161 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_852, (void *)(intptr_t)(k_853), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_161;
        if (__t1) {
            int64_t __ps_162 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_163 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_852, (void *)(intptr_t)(k_853), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t165;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_857 = __ps_167;
            (void)iter_857;
            void * __ps_168 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_169 = (hamt_slkeyeq((void *)(intptr_t)(__ps_168)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_858 = __ps_169;
            (void)keyeq_858;
            void * __ps_170 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_171 = (map_hyeq_hyloop((void *)(intptr_t)(iter_857), (void *)(intptr_t)(__ps_170), (void *)(intptr_t)(keyeq_858), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_859 = __ps_171;
            (void)result_859;
        ...
        if (__ps_190) {
            bool __t191;
            {
                ...
                if ((t1_1137) == (INT64_C(0))) {
                    __t192 = (t2_1138) == (INT64_C(0));
                } else {
                    bool __t193;
                    if ((t2_1138) == (INT64_C(0))) {
                        __t193 = false;
                    } else {
                        bool __ps_194 = (cons_hyeq_hygo(t1_1137, t2_1138));
                        if (tur_panicking) return ((bool)0);
                        __t193 = __ps_194;
                    }
                    __t192 = __t193;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_200) {
            ...
            int64_t __t201;
            {
                ...
                int64_t out_1153 = (int64_t)(intptr_t)(__ps_205);
                (void)out_1153;
                __t201 = out_1153;
            }
            __t199 = __t201;
        ...
        if (__ps_210) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1224 = __ps_211;
                (void)h_1224;
                void * __ps_212 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1225 = __ps_212;
                (void)k_1225;
                bool __ps_213 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1224, (void *)(intptr_t)(k_1225), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_213) {
                    void * __t214 = iter;
                    void * __t215 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t217;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1228 = __ps_219;
            (void)iter_1228;
            void * __ps_220 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_221 = (hamt_slkeyeq((void *)(intptr_t)(__ps_220)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1229 = __ps_221;
            (void)keyeq_1229;
            void * __ps_222 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_223 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1228), (void *)(intptr_t)(__ps_222), (void *)(intptr_t)(keyeq_1229)));
            if (tur_panicking) return ((bool)0);
            bool result_1230 = __ps_223;
            (void)result_1230;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t244;
        {
            ...
            {
                tur_adt_Vec__int * __ps_246 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1360));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1361 = __ps_246;
                (void)_un_unv_1361;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t250;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1411 = __ps_251;
            (void)r_1411;
            int64_t __t252;
            bool __ps_253 = (schema_hydecode_hyok_qu(r_1411));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_253) {
                int64_t __ps_254 = (schema_hydecode_hyvalue(r_1411));
                if (tur_panicking) return ((int64_t)0);
                __t252 = __ps_254;
            } else {
                int64_t __ps_255 = (schema_hydecode_hyerrors(r_1411));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t268;
        {
            bool __ps_269 = (__fn_1470(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_269) ? "true" : "false");
            bool __ps_270 = (__fn_1473(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
