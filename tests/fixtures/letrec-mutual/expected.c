...
static int64_t __fn_1282__cps(int64_t n, DK *__kont) {
    ...
    if ((n) == (INT64_C(0))) {
        ...
        __auto_type __ps_43 = (__fn_1285((n) - (INT64_C(1))));
...
static int64_t __fn_1285__cps(int64_t n, DK *__kont) {
    ...
    if ((n) == (INT64_C(0))) {
        ...
        __auto_type __ps_45 = (__fn_1282((n) - (INT64_C(1))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t44 = __ps_45;
    }
    __t0 = __t44;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_73 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_741, (void *)(intptr_t)(k_742), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t75;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_746 = __ps_77;
            (void)iter_746;
            __auto_type __ps_78 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_79 = (hamt_slkeyeq((void *)(intptr_t)(__ps_78)));
            if (tur_panicking) return (bool){0};
            void * keyeq_747 = __ps_79;
            (void)keyeq_747;
            __auto_type __ps_80 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_81 = (map_hyeq_hyloop((void *)(intptr_t)(iter_746), (void *)(intptr_t)(__ps_80), (void *)(intptr_t)(keyeq_747), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_748 = __ps_81;
            (void)result_748;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                bool __t101;
                if ((t1_988) == (INT64_C(0))) {
                    __t101 = (t2_989) == (INT64_C(0));
                } else {
                    bool __t102;
                    if ((t2_989) == (INT64_C(0))) {
                        __t102 = false;
                    } else {
                        __auto_type __ps_103 = (cons_hyeq_hygo(t1_988, t2_989));
                        if (tur_panicking) return (bool){0};
                        __t102 = __ps_103;
                    }
                    __t101 = __t102;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t119;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1079 = __ps_121;
            (void)iter_1079;
            __auto_type __ps_122 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_123 = (hamt_slkeyeq((void *)(intptr_t)(__ps_122)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1080 = __ps_123;
            (void)keyeq_1080;
            __auto_type __ps_124 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_125 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1079), (void *)(intptr_t)(__ps_124), (void *)(intptr_t)(keyeq_1080)));
            if (tur_panicking) return (bool){0};
            bool result_1081 = __ps_125;
            (void)result_1081;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t146;
        {
            ...
            {
                __auto_type __ps_148 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1208));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1209 = __ps_148;
                (void)_un_unv_1209;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1258 = __ps_152;
            (void)r_1258;
            int64_t __t153;
            __auto_type __ps_154 = (schema_hydecode_hyok_qu(r_1258));
            if (tur_panicking) return (int64_t){0};
            if (__ps_154) {
                __auto_type __ps_155 = (schema_hydecode_hyvalue(r_1258));
                if (tur_panicking) return (int64_t){0};
                __t153 = __ps_155;
            } else {
                __auto_type __ps_156 = (schema_hydecode_hyerrors(r_1258));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t159;
        {
            __auto_type __ps_160 = (__fn_1282(INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_160) ? "true" : "false");
            __auto_type __ps_161 = (__fn_1285(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
