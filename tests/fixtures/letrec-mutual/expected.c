...
static bool __fn_880(int64_t n) {
        bool __t20;
        if ((n) == (INT64_C(0))) {
            __t20 = true;
        } else {
            __t20 = __fn_883((n) - (INT64_C(1)));
        }
        return __t20;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            puts((__fn_880(INT64_C(4))) ? "true" : "false");
            puts((__fn_883(INT64_C(3))) ? "true" : "false");
            int64_t __t28;
            __t28 = INT64_C(0);
            __t27 = __t28;
        }
