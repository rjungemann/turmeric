...
static int64_t show_hylens_un_undict_un1323(int64_t, int64_t, int64_t, int64_t);
...
static int64_t show_hylens_un_undict_un1323(int64_t __dict_1324, int64_t __dict_1326, int64_t g, int64_t s) {
        int64_t __t48;
        {
            __auto_type __ps_49 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1326)[0])(s));
            if (tur_panicking) return (int64_t){0};
            const char * tag_1301 = __ps_49;
            (void)tag_1301;
...
static int64_t __poly_1329(void * __poly_env_1330, int64_t __poly_x0_1332, int64_t __poly_x1_1334, int64_t __poly_x2_1336, int64_t __poly_x3_1338) {
        __auto_type __ps_55 = (show_hylens_un_undict_un1323(__poly_x0_1332, __poly_x1_1334, __poly_x2_1336, __poly_x3_1338));
        if (tur_panicking) return (int64_t){0};
        return __ps_55;
}

static int64_t show_hylens_un_undict_un1341(int64_t __dict_1324, int64_t __dict_1326, int64_t g, int64_t s) {
        int64_t __t56;
        {
            __auto_type __ps_57 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1326)[0])(s));
            if (tur_panicking) return (int64_t){0};
            const char * tag_1301 = __ps_57;
            (void)tag_1301;
            __auto_type __ps_58 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(g)))[0])((void *)(intptr_t)(g), s));
            if (tur_panicking) return (int64_t){0};
            struct __env_1305 *__t59 = (struct __env_1305 *)malloc(sizeof(struct __env_1305));
            __t59->__fn = (int64_t)(intptr_t)__fn_1303;
            __t59->tag = tag_1301;
            void *__t60 = __t59;
...
static int64_t __poly_1343(void * __poly_env_1344, int64_t __poly_x0_1346, int64_t __poly_x1_1348, int64_t __poly_x2_1350, int64_t __poly_x3_1352) {
        __auto_type __ps_63 = (show_hylens_un_undict_un1341(__poly_x0_1346, __poly_x1_1348, __poly_x2_1350, __poly_x3_1352));
        if (tur_panicking) return (int64_t){0};
        return __ps_63;
}

static int64_t show_hylens_un_undict_un1355(int64_t __dict_1324, int64_t __dict_1326, int64_t g, int64_t s) {
        int64_t __t64;
        {
            __auto_type __ps_65 = (((const char * (*)(int64_t))((void **)(intptr_t)__dict_1326)[0])(s));
            if (tur_panicking) return (int64_t){0};
            const char * tag_1301 = __ps_65;
            (void)tag_1301;
            __auto_type __ps_66 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(g)))[0])((void *)(intptr_t)(g), s));
            if (tur_panicking) return (int64_t){0};
            struct __env_1305 *__t67 = (struct __env_1305 *)malloc(sizeof(struct __env_1305));
            __t67->__fn = (int64_t)(intptr_t)__fn_1303;
            __t67->tag = tag_1301;
            void *__t68 = __t67;
            void *__t69 = (void *)(intptr_t)(__t68);
            __auto_type __ps_70 = (((int64_t (*)(int64_t, tur_poly_fn_t))((void **)(intptr_t)__dict_1324)[0])(__ps_66, (tur_poly_fn_t){ __t69, (int64_t(*)(void*,int64_t))(intptr_t)((int64_t*)__t69)[0] }));
            if (tur_panicking) return (int64_t){0};
            __t64 = __ps_70;
        }
...
static int64_t __poly_1357(void * __poly_env_1358, int64_t __poly_x0_1360, int64_t __poly_x1_1362, int64_t __poly_x2_1364, int64_t __poly_x3_1366) {
        __auto_type __ps_71 = (show_hylens_un_undict_un1355(__poly_x0_1360, __poly_x1_1362, __poly_x2_1364, __poly_x3_1366));
        if (tur_panicking) return (int64_t){0};
        return __ps_71;
}
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                (void)k_751;
                bool __t103;
                __auto_type __ps_104 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_750, (void *)(intptr_t)(k_751), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_104) {
                    bool __t105;
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t110;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_755 = __ps_112;
            (void)iter_755;
            __auto_type __ps_113 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_114 = (hamt_slkeyeq((void *)(intptr_t)(__ps_113)));
            if (tur_panicking) return (bool){0};
            void * keyeq_756 = __ps_114;
            (void)keyeq_756;
            __auto_type __ps_115 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_116 = (map_hyeq_hyloop((void *)(intptr_t)(iter_755), (void *)(intptr_t)(__ps_115), (void *)(intptr_t)(keyeq_756), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_757 = __ps_116;
            (void)result_757;
...
static int64_t peek_hyint(tur_poly_fn_t l, int64_t s) {
        ...
        __t213[1] = (int64_t)(intptr_t)__fn_1321;
        void *__t214 = __t213;
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_217 = (shown_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1329 }, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_217);
        __auto_type __ps_218 = (shown_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1343 }, true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_218);
        __auto_type __ps_219 = (peek_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1357 }, INT64_C(42)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_219));
        int64_t __t220;
        __t220 = INT64_C(0);
