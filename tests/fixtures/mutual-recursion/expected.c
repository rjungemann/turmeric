...
static bool is_hyeven(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            bool __ps_245 = (is_hyodd((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t244 = __ps_245;
        }
        return __t244;
...
static bool is_hyodd(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            bool __ps_247 = (is_hyeven((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t246 = __ps_247;
        }
        return __t246;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        bool __ps_248 = (is_hyeven(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_248) ? "true" : "false");
        return (int)0;
}

static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_249 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_250 = (vec_new__spec__tur_adt_Vec__int__());
