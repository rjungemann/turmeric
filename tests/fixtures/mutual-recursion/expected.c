...
static bool is_hyeven(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            bool __ps_276 = (is_hyodd((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t275 = __ps_276;
        }
        return __t275;
...
static bool is_hyodd(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            bool __ps_278 = (is_hyeven((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t277 = __ps_278;
        }
        return __t277;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        bool __ps_279 = (is_hyeven(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_280 = (ctor_Cons_Cons__int(h, t));
