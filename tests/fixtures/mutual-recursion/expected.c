...
static bool is_hyeven(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            bool __ps_268 = (is_hyodd((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t267 = __ps_268;
        }
        return __t267;
...
static bool is_hyodd(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            bool __ps_270 = (is_hyeven((n) - (INT64_C(1))));
            if (tur_panicking) return ((bool)0);
            __t269 = __ps_270;
        }
        return __t269;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        bool __ps_271 = (is_hyeven(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_272 = (ctor_Cons_Cons__int(h, t));
