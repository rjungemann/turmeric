...
static int64_t ne_hyof(int64_t, int64_t);
static int64_t ne_hyhead(int64_t);
static int64_t ne_hylen(int64_t);
static int64_t __nlen(int64_t, int64_t);
...
static int64_t ne_hyof(int64_t x, int64_t xs) {
        return tcons(x, xs);
}

static int64_t ne_hyhead(int64_t ne) {
        return list_hyhead(ne);
}

static int64_t ne_hylen(int64_t ne) {
        return __nlen(ne, INT64_C(0));
}

static int64_t __nlen(int64_t xs, int64_t acc) {
        __tur_tailcall:;
        if (tnil_qu(xs)) {
            return acc;
        } else {
            int64_t __t25 = list_hytail(xs);
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(ne_hyhead(ne_hyof(INT64_C(7), tnil()))));
        printf("%lld\n", (long long)(ne_hyhead(ne_hyof(INT64_C(42), tcons(INT64_C(9), tnil())))));
        printf("%lld\n", (long long)(ne_hylen(ne_hyof(INT64_C(1), tcons(INT64_C(2), tcons(INT64_C(3), tnil()))))));
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
}
