...
static int64_t ne_of(int64_t, int64_t);
static int64_t ne_head(int64_t);
static int64_t ne_len(int64_t);
...
static int64_t ne_of(int64_t x, int64_t xs) {
        return tcons(x, xs);
}

static int64_t ne_head(int64_t ne) {
        return list_head(ne);
}

static int64_t ne_len(int64_t ne) {
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(ne_head(ne_of(INT64_C(7), tnil()))));
        printf("%lld\n", (long long)(ne_head(ne_of(INT64_C(42), tcons(INT64_C(9), tnil())))));
        printf("%lld\n", (long long)(ne_len(ne_of(INT64_C(1), tcons(INT64_C(2), tcons(INT64_C(3), tnil()))))));
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
}
