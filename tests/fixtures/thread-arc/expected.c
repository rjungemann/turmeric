...
int main() {
        {
            void * shared_218 = arc_new(INT64_C(21));
            (void)shared_218;
            {
                void * c1_219 = arc_clone((void *)(intptr_t)(shared_218));
                (void)c1_219;
                {
                    void * c2_220 = arc_clone((void *)(intptr_t)(shared_218));
                    (void)c2_220;
                    printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(shared_218))));
                    {
                        void * a1_221 = thread_arg_new((void *)(intptr_t)(c1_219));
                        (void)a1_221;
                        {
                            void * a2_222 = thread_arg_new((void *)(intptr_t)(c2_220));
                            (void)a2_222;
                            {
                                void * t1_223 = thread_spawn((void *)(intptr_t)(a1_221));
                                (void)t1_223;
                                {
                                    void * t2_224 = thread_spawn((void *)(intptr_t)(a2_222));
                                    (void)t2_224;
                                    thread_join((void *)(intptr_t)(t1_223));
                                    thread_join((void *)(intptr_t)(t2_224));
                                }
                            }
                            printf("%lld\n", (long long)(thread_arg_result((void *)(intptr_t)(a1_221))));
                            printf("%lld\n", (long long)(thread_arg_result((void *)(intptr_t)(a2_222))));
                            arc_drop((void *)(intptr_t)(c1_219));
                            arc_drop((void *)(intptr_t)(c2_220));
                            printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(shared_218))));
                            thread_arg_free((void *)(intptr_t)(a1_221));
                            thread_arg_free((void *)(intptr_t)(a2_222));
                        }
                    }
                }
            }
            arc_drop((void *)(intptr_t)(shared_218));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
