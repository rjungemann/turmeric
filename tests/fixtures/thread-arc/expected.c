...
int main() {
        {
            void * shared_230 = arc_new(INT64_C(21));
            (void)shared_230;
            {
                void * c1_231 = arc_clone((void *)(intptr_t)(shared_230));
                (void)c1_231;
                {
                    void * c2_232 = arc_clone((void *)(intptr_t)(shared_230));
                    (void)c2_232;
                    printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(shared_230))));
                    {
                        void * a1_233 = thread_arg_new((void *)(intptr_t)(c1_231));
                        (void)a1_233;
                        {
                            void * a2_234 = thread_arg_new((void *)(intptr_t)(c2_232));
                            (void)a2_234;
                            {
                                void * t1_235 = thread_spawn((void *)(intptr_t)(a1_233));
                                (void)t1_235;
                                {
                                    void * t2_236 = thread_spawn((void *)(intptr_t)(a2_234));
                                    (void)t2_236;
                                    thread_join((void *)(intptr_t)(t1_235));
                                    thread_join((void *)(intptr_t)(t2_236));
                                }
                            }
                            printf("%lld\n", (long long)(thread_arg_result((void *)(intptr_t)(a1_233))));
                            printf("%lld\n", (long long)(thread_arg_result((void *)(intptr_t)(a2_234))));
                            arc_drop((void *)(intptr_t)(c1_231));
                            arc_drop((void *)(intptr_t)(c2_232));
                            printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(shared_230))));
                            thread_arg_free((void *)(intptr_t)(a1_233));
                            thread_arg_free((void *)(intptr_t)(a2_234));
                        }
                    }
                }
            }
            arc_drop((void *)(intptr_t)(shared_230));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
