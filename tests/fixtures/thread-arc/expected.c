...
int main() {
        {
            void * shared_43 = arc_new(INT64_C(21));
            (void)shared_43;
            {
                void * c1_44 = arc_clone((void *)(intptr_t)(shared_43));
                (void)c1_44;
                {
                    void * c2_45 = arc_clone((void *)(intptr_t)(shared_43));
                    (void)c2_45;
                    printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(shared_43))));
                    {
                        void * a1_46 = thread_arg_new((void *)(intptr_t)(c1_44));
                        (void)a1_46;
                        {
                            void * a2_47 = thread_arg_new((void *)(intptr_t)(c2_45));
                            (void)a2_47;
                            {
                                void * t1_48 = thread_spawn((void *)(intptr_t)(a1_46));
                                (void)t1_48;
                                {
                                    void * t2_49 = thread_spawn((void *)(intptr_t)(a2_47));
                                    (void)t2_49;
                                    thread_join((void *)(intptr_t)(t1_48));
                                    thread_join((void *)(intptr_t)(t2_49));
                                }
                            }
                            printf("%lld\n", (long long)(thread_arg_result((void *)(intptr_t)(a1_46))));
                            printf("%lld\n", (long long)(thread_arg_result((void *)(intptr_t)(a2_47))));
                            arc_drop((void *)(intptr_t)(c1_44));
                            arc_drop((void *)(intptr_t)(c2_45));
                            printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(shared_43))));
                            thread_arg_free((void *)(intptr_t)(a1_46));
                            thread_arg_free((void *)(intptr_t)(a2_47));
                        }
                    }
                }
            }
            arc_drop((void *)(intptr_t)(shared_43));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
