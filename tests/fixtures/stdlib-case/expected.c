...
int main() {
        {
            int64_t x_616 = INT64_C(2);
            (void)x_616;
            {
                int64_t case_disc_0_617 = x_616;
                (void)case_disc_0_617;
                if (((case_disc_0_617) == (INT64_C(1)))) {
                    puts("one");
                } else {
                    if (((case_disc_0_617) == (INT64_C(2)))) {
                        puts("two");
                    } else {
                        if (((case_disc_0_617) == (INT64_C(3)))) {
                            puts("three");
                        } else {
                            puts("other");
                        }
        ...
        {
            int64_t y_618 = INT64_C(99);
            (void)y_618;
            {
                int64_t case_disc_1_619 = y_618;
                (void)case_disc_1_619;
                if (((case_disc_1_619) == (INT64_C(0)))) {
                    puts("zero");
                } else {
                    puts("unknown");
                }
