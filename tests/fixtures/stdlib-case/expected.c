...
int main() {
        {
            int64_t x_196 = INT64_C(2);
            (void)x_196;
            {
                int64_t case_disc_0_197 = x_196;
                (void)case_disc_0_197;
                if (((case_disc_0_197) == (INT64_C(1)))) {
                    puts("one");
                } else {
                    if (((case_disc_0_197) == (INT64_C(2)))) {
                        puts("two");
                    } else {
                        if (((case_disc_0_197) == (INT64_C(3)))) {
                            puts("three");
                        } else {
                            puts("other");
                        }
        ...
        {
            int64_t y_198 = INT64_C(99);
            (void)y_198;
            {
                int64_t case_disc_1_199 = y_198;
                (void)case_disc_1_199;
                if (((case_disc_1_199) == (INT64_C(0)))) {
                    puts("zero");
                } else {
                    puts("unknown");
                }
