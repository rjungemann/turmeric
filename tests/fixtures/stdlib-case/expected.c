...
int main() {
        {
            int64_t x_208 = INT64_C(2);
            (void)x_208;
            {
                int64_t case_disc_0_209 = x_208;
                (void)case_disc_0_209;
                if (((case_disc_0_209) == (INT64_C(1)))) {
                    puts("one");
                } else {
                    if (((case_disc_0_209) == (INT64_C(2)))) {
                        puts("two");
                    } else {
                        if (((case_disc_0_209) == (INT64_C(3)))) {
                            puts("three");
                        } else {
                            puts("other");
                        }
        ...
        {
            int64_t y_210 = INT64_C(99);
            (void)y_210;
            {
                int64_t case_disc_1_211 = y_210;
                (void)case_disc_1_211;
                if (((case_disc_1_211) == (INT64_C(0)))) {
                    puts("zero");
                } else {
                    puts("unknown");
                }
