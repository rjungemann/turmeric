...
int main() {
        {
            int64_t x_214 = INT64_C(2);
            (void)x_214;
            {
                int64_t case_disc_0_215 = x_214;
                (void)case_disc_0_215;
                if (((case_disc_0_215) == (INT64_C(1)))) {
                    puts("one");
                } else {
                    if (((case_disc_0_215) == (INT64_C(2)))) {
                        puts("two");
                    } else {
                        if (((case_disc_0_215) == (INT64_C(3)))) {
                            puts("three");
                        } else {
                            puts("other");
                        }
        ...
        {
            int64_t y_216 = INT64_C(99);
            (void)y_216;
            {
                int64_t case_disc_1_217 = y_216;
                (void)case_disc_1_217;
                if (((case_disc_1_217) == (INT64_C(0)))) {
                    puts("zero");
                } else {
                    puts("unknown");
                }
