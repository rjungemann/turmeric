...
int main() {
        {
            int64_t x_261 = INT64_C(2);
            (void)x_261;
            {
                int64_t case_disc_0_262 = x_261;
                (void)case_disc_0_262;
                if (((case_disc_0_262) == (INT64_C(1)))) {
                    puts("one");
                } else {
                    if (((case_disc_0_262) == (INT64_C(2)))) {
                        puts("two");
                    } else {
                        if (((case_disc_0_262) == (INT64_C(3)))) {
                            puts("three");
                        } else {
                            puts("other");
                        }
        ...
        {
            int64_t y_263 = INT64_C(99);
            (void)y_263;
            {
                int64_t case_disc_1_264 = y_263;
                (void)case_disc_1_264;
                if (((case_disc_1_264) == (INT64_C(0)))) {
                    puts("zero");
                } else {
                    puts("unknown");
                }
