...
int main() {
        {
            int64_t x_213 = INT64_C(2);
            (void)x_213;
            {
                int64_t case_disc_0_214 = x_213;
                (void)case_disc_0_214;
                if (((case_disc_0_214) == (INT64_C(1)))) {
                    puts("one");
                } else {
                    if (((case_disc_0_214) == (INT64_C(2)))) {
                        puts("two");
                    } else {
                        if (((case_disc_0_214) == (INT64_C(3)))) {
                            puts("three");
                        } else {
                            puts("other");
                        }
        ...
        {
            int64_t y_215 = INT64_C(99);
            (void)y_215;
            {
                int64_t case_disc_1_216 = y_215;
                (void)case_disc_1_216;
                if (((case_disc_1_216) == (INT64_C(0)))) {
                    puts("zero");
                } else {
                    puts("unknown");
                }
