...
static int64_t __fn_645(int64_t);
static int64_t __fn_649(int64_t);
...
static int64_t __fn_637(int64_t x) {
        return __opt_some(((x) * (INT64_C(3))));
}

static int64_t __fn_641(int64_t x) {
        return __opt_some(((x) * (INT64_C(3))));
}

static int64_t __fn_645(int64_t x) {
        return __opt_some(((x) * (INT64_C(2))));
}

static int64_t __fn_649(int64_t y) {
...
int main() {
        {
            int64_t result3_635 = __opt_some(INT64_C(99));
            (void)result3_635;
            puts((__opt_some_(result3_635)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result3_635)));
        }
        {
            int64_t result_639 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_637));
            (void)result_639;
            puts((__opt_some_(result_639)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_639)));
        }
        {
            int64_t result2_643 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_none(), (int64_t)(intptr_t)(__fn_641));
            (void)result2_643;
            puts((__opt_some_(result2_643)) ? "true" : "false");
        }
        {
            int64_t step1_647 = __bind_option(__opt_some(INT64_C(3)), (int64_t)(intptr_t)(__fn_645));
            (void)step1_647;
            {
                int64_t result4_651 = __bind_option(step1_647, (int64_t)(intptr_t)(__fn_649));
                (void)result4_651;
                puts((__opt_some_(result4_651)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result4_651)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
