...
int main() {
        ...
        {
            int64_t result_44 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_42));
            (void)result_44;
            puts((__opt_some_(result_44)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_44)));
        }
        {
            int64_t result2_48 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_none(), (int64_t)(intptr_t)(__fn_46));
            (void)result2_48;
