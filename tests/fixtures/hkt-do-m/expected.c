...
static int64_t __fn_233(int64_t);
static int64_t __fn_237(int64_t);
static int64_t __fn_241(int64_t);
...
static int64_t __fn_229(int64_t x) {
        return __opt_some(((x) * (INT64_C(3))));
}

static int64_t __fn_233(int64_t x) {
        return __opt_some(((x) * (INT64_C(3))));
}

static int64_t __fn_237(int64_t x) {
        return __opt_some(((x) * (INT64_C(2))));
}

static int64_t __fn_241(int64_t y) {
...
int main() {
        {
            int64_t result3_227 = __opt_some(INT64_C(99));
            (void)result3_227;
            puts((__opt_some_(result3_227)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result3_227)));
        }
        {
            int64_t result_231 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_229));
            (void)result_231;
            puts((__opt_some_(result_231)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_231)));
        }
        {
            int64_t result2_235 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_none(), (int64_t)(intptr_t)(__fn_233));
            (void)result2_235;
            puts((__opt_some_(result2_235)) ? "true" : "false");
        }
        {
            int64_t step1_239 = __bind_option(__opt_some(INT64_C(3)), (int64_t)(intptr_t)(__fn_237));
            (void)step1_239;
            {
                int64_t result4_243 = __bind_option(step1_239, (int64_t)(intptr_t)(__fn_241));
                (void)result4_243;
                puts((__opt_some_(result4_243)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result4_243)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
