...
static int64_t __fn_282(int64_t);
static int64_t __fn_286(int64_t);
static int64_t __fn_290(int64_t);
static int64_t __fn_294(int64_t);
...
static int64_t __fn_282(int64_t x) {
        return __opt_some(((x) * (INT64_C(3))));
}

static int64_t __fn_286(int64_t x) {
        return __opt_some(((x) * (INT64_C(3))));
}
...
static int64_t __fn_294(int64_t y) {
...
int main() {
        {
            int64_t result3_280 = __opt_some(INT64_C(99));
            (void)result3_280;
            puts((__opt_some_(result3_280)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result3_280)));
        }
        {
            int64_t result_284 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_282));
            (void)result_284;
            puts((__opt_some_(result_284)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_284)));
        }
        {
            int64_t result2_288 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_none(), (int64_t)(intptr_t)(__fn_286));
            (void)result2_288;
            puts((__opt_some_(result2_288)) ? "true" : "false");
        }
        {
            int64_t step1_292 = __bind_option(__opt_some(INT64_C(3)), (int64_t)(intptr_t)(__fn_290));
            (void)step1_292;
            {
                int64_t result4_296 = __bind_option(step1_292, (int64_t)(intptr_t)(__fn_294));
                (void)result4_296;
                puts((__opt_some_(result4_296)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result4_296)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
