...
static int64_t __fn_229(int64_t);
...
static int64_t __fn_217(int64_t x) {
        return __opt_some(((x) * (INT64_C(3))));
}

static int64_t __fn_221(int64_t x) {
        return __opt_some(((x) * (INT64_C(3))));
}

static int64_t __fn_225(int64_t x) {
        return __opt_some(((x) * (INT64_C(2))));
}

static int64_t __fn_229(int64_t y) {
...
int main() {
        {
            int64_t result3_215 = __opt_some(INT64_C(99));
            (void)result3_215;
            puts((__opt_some_(result3_215)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result3_215)));
        }
        {
            int64_t result_219 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_217));
            (void)result_219;
            puts((__opt_some_(result_219)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_219)));
        }
        {
            int64_t result2_223 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Monad_option_singleton.bind))(__opt_none(), (int64_t)(intptr_t)(__fn_221));
            (void)result2_223;
            puts((__opt_some_(result2_223)) ? "true" : "false");
        }
        {
            int64_t step1_227 = __bind_option(__opt_some(INT64_C(3)), (int64_t)(intptr_t)(__fn_225));
            (void)step1_227;
            {
                int64_t result4_231 = __bind_option(step1_227, (int64_t)(intptr_t)(__fn_229));
                (void)result4_231;
                puts((__opt_some_(result4_231)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result4_231)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
