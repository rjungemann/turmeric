...
int main() {
        int64_t __t0;
        {
            ...
            (void)fc_248;
            {
                void * arg_249 = make_worker_arg((void *)(intptr_t)(fc_248), INT64_C(42));
                (void)arg_249;
                {
                    void * t_250 = thread_spawn_raw((void *)(intptr_t)(future_worker), (void *)(intptr_t)(arg_249));
                    (void)t_250;
                    {
                        void * result_251 = fc_get((void *)(intptr_t)(fc_248));
                        (void)result_251;
                        if (result_ok_((void *)(intptr_t)(result_251))) {
                            print_labelled("ok:", result_val((void *)(intptr_t)(result_251)));
                        } else {
                            print_labelled("err:", result_err((void *)(intptr_t)(result_251)));
                        }
                        result_free((void *)(intptr_t)(result_251));
                        thread_join_raw((void *)(intptr_t)(t_250));
                    }
                    fc_free((void *)(intptr_t)(fc_248));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
