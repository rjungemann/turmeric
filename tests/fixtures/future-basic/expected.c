...
int main() {
        int64_t __t0;
        {
            ...
            (void)fc_55;
            {
                void * arg_56 = make_worker_arg((void *)(intptr_t)(fc_55), INT64_C(42));
                (void)arg_56;
                {
                    void * t_57 = thread_spawn_raw((void *)(intptr_t)(future_worker), (void *)(intptr_t)(arg_56));
                    (void)t_57;
                    {
                        void * result_58 = fc_get((void *)(intptr_t)(fc_55));
                        (void)result_58;
                        if (result_ok_((void *)(intptr_t)(result_58))) {
                            print_labelled("ok:", result_val((void *)(intptr_t)(result_58)));
                        } else {
                            print_labelled("err:", result_err((void *)(intptr_t)(result_58)));
                        }
                        result_free((void *)(intptr_t)(result_58));
                        thread_join_raw((void *)(intptr_t)(t_57));
                    }
                    fc_free((void *)(intptr_t)(fc_55));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
