...
static int64_t inner(const tur_adt_Result__int__int *);
...
struct __env_1290 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1288(void * __env_p_1291) {
        ...
        tur_adt_Result__int__int __t42 = __env___env_1290->acc;
        __auto_type __ps_43 = (step(&__t42, (__env___env_1290->n) - (INT64_C(1))));
...
static int64_t inner(const tur_adt_Result__int__int * r) {
        int64_t __t157;
        if ((bool)(r)->is_ok) {
            __t157 = INT64_C(1);
        } else {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           (void)(__box162);
           __auto_type __ps_164 = (describe(acc));
           if (tur_panicking) break;
           __v = (int64_t)(intptr_t)((n) + (__ps_164)); __pc = __k->tag; break;
          }
         }
        }
}
