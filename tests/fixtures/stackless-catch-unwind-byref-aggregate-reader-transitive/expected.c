...
static int64_t __fn_1474(void * __env_p_1477) {
        ...
        int64_t __ps_124 = (step(__env___env_1476->acc, (__env___env_1476->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1473) == (INT64_C(0))) {
     tur_adt_Result__int__int __ra273_0 = (acc_1472);
     r_1471 = __ra273_0;
     __pc = 2; break;
    } else {
     ...
     __n274->tag = 5; __n274->boundary = __b274; __n274->next = __k;
     __n274->aggr_mask = 0xdu;
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1472, sizeof(tur_adt_Result__int__int)); __n274->saved[0] = (int64_t)(intptr_t)__ab; }
     __n274->saved[1] = (int64_t)(intptr_t)(n_1473);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1471, sizeof(tur_adt_Result__int__int)); __n274->saved[2] = (int64_t)(intptr_t)__ab; }
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1470, sizeof(tur_adt_Result__int__int)); __n274->saved[3] = (int64_t)(intptr_t)__ab; }
     __n274->saved[4] = (int64_t)(intptr_t)(__t268);
     __n274->saved[5] = (int64_t)(intptr_t)(__t269);
     __n274->saved[6] = (int64_t)(intptr_t)(__t270);
     __n274->saved[7] = (int64_t)(intptr_t)(__t271);
     __n274->saved[8] = (int64_t)(intptr_t)(__t272);
     __k = __n274; __pc = 4; break;
    }
   }
   case 4: {
    tur_adt_Result__int__int __ra275_0 = (acc_1472);
    int64_t __ra275_1 = ((n_1473) - (INT64_C(1)));
    acc_1472 = __ra275_0;
    n_1473 = __ra275_1;
    __pc = 1; break;
   }
   case 5: {
    ...
    __t271 = (int64_t)(intptr_t)(__k->saved[7]);
    __t272 = (int64_t)(intptr_t)(__k->saved[8]);
    ...
    __n276->tag = 6; __n276->boundary = 0; __n276->next = __k;
    __n276->aggr_mask = 0xdu;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1472, sizeof(tur_adt_Result__int__int)); __n276->saved[0] = (int64_t)(intptr_t)__ab; }
    __n276->saved[1] = (int64_t)(intptr_t)(n_1473);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1471, sizeof(tur_adt_Result__int__int)); __n276->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1470, sizeof(tur_adt_Result__int__int)); __n276->saved[3] = (int64_t)(intptr_t)__ab; }
    __n276->saved[4] = (int64_t)(intptr_t)(__t268);
    __n276->saved[5] = (int64_t)(intptr_t)(__t269);
    __n276->saved[6] = (int64_t)(intptr_t)(__t270);
    __n276->saved[7] = (int64_t)(intptr_t)(__t271);
    __n276->saved[8] = (int64_t)(intptr_t)(__t272);
    tur_adt_Result__int__int __ra276_0 = (acc_1472);
    r_1471 = __ra276_0;
    __k = __n276; __pc = 2; break;
   }
   case 6: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1472, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1473 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t271 = (int64_t)(intptr_t)(__k->saved[7]);
    __t272 = (int64_t)(intptr_t)(__k->saved[8]);
    __t271 = (int64_t)(intptr_t)(__v);
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((n_1473) + (__t271)); __pc = __k->tag; break;
   }
   case 2: {
    tur_adt_Result__int__int __ra277_0 = (r_1471);
    r_1470 = __ra277_0;
    __pc = 3; break;
   }
   case 3: {
    int64_t __t278;
    bool __ps_279 = (ok___spec__bool_tur_adt_Result__int__int(r_1470));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_279) {
        __t278 = INT64_C(1);
    } else {
