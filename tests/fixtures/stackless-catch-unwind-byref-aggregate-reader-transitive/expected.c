...
static int64_t __fn_1613(void * __env_p_1616) {
        ...
        int64_t __ps_128 = (step(__env___env_1615->acc, (__env___env_1615->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_128;
}
...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __ps_280 = (inner(r));
        if (tur_panicking) return ((int64_t)0);
        return __ps_280;
}

static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Result__int__int acc_1611; memset(&acc_1611, 0, sizeof(tur_adt_Result__int__int));
 int64_t n_1612 = 0;
 tur_adt_Result__int__int r_1610; memset(&r_1610, 0, sizeof(tur_adt_Result__int__int));
 ...
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1611, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   n_1612 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&r_1610, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   break; }
  case 3: {
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1612) == (INT64_C(0))) {
     tur_adt_Result__int__int __ra286_0 = (acc_1611);
     r_1610 = __ra286_0;
     __pc = 2; break;
    } else {
     tur_handler_node *__b287 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
     __b287->parent = tur_handler_chain; tur_handler_chain = __b287;
     tur_cont *__n287 = (tur_cont*)malloc(sizeof(tur_cont));
     __n287->tag = 5; __n287->boundary = __b287; __n287->next = __k;
     __n287->aggr_mask = 0xdu;
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1611, sizeof(tur_adt_Result__int__int)); __n287->saved[0] = (int64_t)(intptr_t)__ab; }
     __n287->saved[1] = (int64_t)(intptr_t)(n_1612);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1610, sizeof(tur_adt_Result__int__int)); __n287->saved[2] = (int64_t)(intptr_t)__ab; }
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1609, sizeof(tur_adt_Result__int__int)); __n287->saved[3] = (int64_t)(intptr_t)__ab; }
     __n287->saved[4] = (int64_t)(intptr_t)(__t281);
     __n287->saved[5] = (int64_t)(intptr_t)(__t282);
     __n287->saved[6] = (int64_t)(intptr_t)(__t283);
     __n287->saved[7] = (int64_t)(intptr_t)(__t284);
     __n287->saved[8] = (int64_t)(intptr_t)(__t285);
     __k = __n287; __pc = 4; break;
    }
   }
   case 4: {
    tur_adt_Result__int__int __ra288_0 = (acc_1611);
    int64_t __ra288_1 = ((n_1612) - (INT64_C(1)));
    acc_1611 = __ra288_0;
    n_1612 = __ra288_1;
    __pc = 1; break;
   }
   case 5: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1611, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1612 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&r_1610, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&r_1609, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    __t281 = (int64_t)(intptr_t)(__k->saved[4]);
    __t282 = (int64_t)(intptr_t)(__k->saved[5]);
    __t283 = (int64_t)(intptr_t)(__k->saved[6]);
    __t284 = (int64_t)(intptr_t)(__k->saved[7]);
    __t285 = (int64_t)(intptr_t)(__k->saved[8]);
    tur_handler_chain = __k->boundary->parent; free(__k->boundary);
    int64_t __box287;
    if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp287 = global_panic_payload; global_panic_payload = 0; __box287 = tur_box_err((int64_t)(intptr_t)__pp287); }
    else { __box287 = tur_box_ok(__v); }
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    tur_result_box_free((int64_t)(intptr_t)__box287);
    (void)(__box287);
    tur_cont *__n289 = (tur_cont*)malloc(sizeof(tur_cont));
    __n289->tag = 6; __n289->boundary = 0; __n289->next = __k;
    __n289->aggr_mask = 0xdu;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1611, sizeof(tur_adt_Result__int__int)); __n289->saved[0] = (int64_t)(intptr_t)__ab; }
    __n289->saved[1] = (int64_t)(intptr_t)(n_1612);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1610, sizeof(tur_adt_Result__int__int)); __n289->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1609, sizeof(tur_adt_Result__int__int)); __n289->saved[3] = (int64_t)(intptr_t)__ab; }
    __n289->saved[4] = (int64_t)(intptr_t)(__t281);
    __n289->saved[5] = (int64_t)(intptr_t)(__t282);
    __n289->saved[6] = (int64_t)(intptr_t)(__t283);
    __n289->saved[7] = (int64_t)(intptr_t)(__t284);
    __n289->saved[8] = (int64_t)(intptr_t)(__t285);
    tur_adt_Result__int__int __ra289_0 = (acc_1611);
    r_1610 = __ra289_0;
    __k = __n289; __pc = 2; break;
   }
   case 6: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1611, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1612 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t284 = (int64_t)(intptr_t)(__k->saved[7]);
    __t285 = (int64_t)(intptr_t)(__k->saved[8]);
    __t284 = (int64_t)(intptr_t)(__v);
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((n_1612) + (__t284)); __pc = __k->tag; break;
   }
   case 2: {
    tur_adt_Result__int__int __ra290_0 = (r_1610);
    r_1609 = __ra290_0;
    __pc = 3; break;
   }
   case 3: {
    int64_t __t291;
    bool __ps_292 = (ok___spec__bool_tur_adt_Result__int__int(r_1609));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_292) {
        __t291 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)(__t291); __pc = __k->tag; break;
   }
  }
 }
}
