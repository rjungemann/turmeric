...
static int64_t __fn_1276(void * __env_p_1279) {
        ...
        tur_adt_Result__int__int __t43 = __env___env_1278->acc;
        __auto_type __ps_44 = (step(&__t43, (__env___env_1278->n) - (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           (void)(__box188);
           __auto_type __ps_190 = (describe(acc));
           if (tur_panicking) break;
           __v = (int64_t)(intptr_t)((n) + (__ps_190)); __pc = __k->tag; break;
          }
         }
        }
}
