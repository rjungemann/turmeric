...
struct __env_1616 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1614(void * __env_p_1617) {
        struct __env_1616 *__env___env_1616 = (struct __env_1616 *)__env_p_1617;
        return step(__env___env_1616->acc, (__env___env_1616->n) - (INT64_C(1)));
}
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Result__int__int acc_1612; memset(&acc_1612, 0, sizeof(tur_adt_Result__int__int));
 int64_t n_1613 = 0;
 tur_adt_Result__int__int r_1611; memset(&r_1611, 0, sizeof(tur_adt_Result__int__int));
 ...
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1612, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   n_1613 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&r_1611, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   break; }
  case 3: {
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1613) == (INT64_C(0))) {
     tur_adt_Result__int__int __ra179_0 = (acc_1612);
     r_1611 = __ra179_0;
     __pc = 2; break;
    } else {
     ...
     __n180->tag = 5; __n180->boundary = __b180; __n180->next = __k;
     __n180->aggr_mask = 0xdu;
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1612, sizeof(tur_adt_Result__int__int)); __n180->saved[0] = (int64_t)(intptr_t)__ab; }
     __n180->saved[1] = (int64_t)(intptr_t)(n_1613);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1611, sizeof(tur_adt_Result__int__int)); __n180->saved[2] = (int64_t)(intptr_t)__ab; }
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1610, sizeof(tur_adt_Result__int__int)); __n180->saved[3] = (int64_t)(intptr_t)__ab; }
     ...
     __n180->saved[8] = (int64_t)(intptr_t)(__t178);
     __k = __n180; __pc = 4; break;
    }
   }
   case 4: {
    tur_adt_Result__int__int __ra181_0 = (acc_1612);
    int64_t __ra181_1 = ((n_1613) - (INT64_C(1)));
    acc_1612 = __ra181_0;
    n_1613 = __ra181_1;
    __pc = 1; break;
   }
   case 5: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1612, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1613 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&r_1611, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&r_1610, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    __t178 = (int64_t)(intptr_t)(__k->saved[8]);
    ...
    __n182->tag = 6; __n182->boundary = 0; __n182->next = __k;
    __n182->aggr_mask = 0xdu;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1612, sizeof(tur_adt_Result__int__int)); __n182->saved[0] = (int64_t)(intptr_t)__ab; }
    __n182->saved[1] = (int64_t)(intptr_t)(n_1613);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1611, sizeof(tur_adt_Result__int__int)); __n182->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1610, sizeof(tur_adt_Result__int__int)); __n182->saved[3] = (int64_t)(intptr_t)__ab; }
    __n182->saved[4] = (int64_t)(intptr_t)(__t174);
    __n182->saved[5] = (int64_t)(intptr_t)(__t175);
    __n182->saved[6] = (int64_t)(intptr_t)(__t176);
    __n182->saved[7] = (int64_t)(intptr_t)(__t177);
    __n182->saved[8] = (int64_t)(intptr_t)(__t178);
    tur_adt_Result__int__int __ra182_0 = (acc_1612);
    r_1611 = __ra182_0;
   ...
   case 6: {
    ...
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((n_1613) + (__t177)); __pc = __k->tag; break;
   }
   case 2: {
    tur_adt_Result__int__int __ra183_0 = (r_1611);
    r_1610 = __ra183_0;
    __pc = 3; break;
   }
   case 3: {
    int64_t __t184;
    bool __ps_185 = (ok___spec__bool_tur_adt_Result__int__int(r_1610));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_185) {
        __t184 = INT64_C(1);
    } else {
