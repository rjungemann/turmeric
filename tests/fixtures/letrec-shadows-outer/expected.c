...
struct __env_813 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_811(void * __env_p_814) {
        struct __env_813 *__env___env_813 = (struct __env_813 *)__env_p_814;
        return __env___env_813->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t3;
        {
            ...
            int64_t __t4;
            {
                struct __env_813 *__t5 = (struct __env_813 *)malloc(sizeof(struct __env_813));
                __t5->__fn = (tur_thunk_int64_t_t)__fn_811;
                __t5->x = x_809;
                void *__t6 = __t5;
                void * f_810 = __t6;
                (void)f_810;
                printf("%lld\n", (long long)(__fn_811(f_810)));
                {
                    int64_t x_816 = INT64_C(99);
                    (void)x_816;
                    printf("%lld\n", (long long)(__fn_811(f_810)));
                }
                int64_t __t7;
