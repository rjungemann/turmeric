...
struct __env_701 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_699(void * __env_p_702) {
        struct __env_701 *__env___env_701 = (struct __env_701 *)__env_p_702;
        return __env___env_701->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t1;
        {
            ...
            int64_t __t2;
            {
                struct __env_701 *__t3 = (struct __env_701 *)malloc(sizeof(struct __env_701));
                __t3->__fn = (tur_thunk_int64_t_t)__fn_699;
                __t3->x = x_697;
                void *__t4 = __t3;
                void * f_698 = __t4;
                (void)f_698;
                printf("%lld\n", (long long)(__fn_699(f_698)));
                {
                    int64_t x_704 = INT64_C(99);
                    (void)x_704;
                    printf("%lld\n", (long long)(__fn_699(f_698)));
                }
                int64_t __t5;
