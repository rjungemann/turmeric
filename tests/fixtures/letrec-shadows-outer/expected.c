...
struct __env_904 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_902(void * __env_p_905) {
        struct __env_904 *__env___env_904 = (struct __env_904 *)__env_p_905;
        return __env___env_904->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t29;
        {
            ...
            int64_t __t30;
            {
                struct __env_904 *__t31 = (struct __env_904 *)malloc(sizeof(struct __env_904));
                __t31->__fn = (tur_thunk_int64_t_t)__fn_902;
                __t31->x = x_900;
                void *__t32 = __t31;
                int64_t f_901 = (int64_t)(intptr_t)(__t32);
                (void)f_901;
                printf("%lld\n", (long long)(__fn_902((void *)(intptr_t)(f_901))));
                {
                    int64_t x_907 = INT64_C(99);
                    (void)x_907;
                    printf("%lld\n", (long long)(__fn_902((void *)(intptr_t)(f_901))));
                }
                int64_t __t33;
