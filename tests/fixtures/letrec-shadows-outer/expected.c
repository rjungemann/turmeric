...
struct __env_990 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_988(void * __env_p_991) {
        struct __env_990 *__env___env_990 = (struct __env_990 *)__env_p_991;
        return __env___env_990->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t42;
        {
            ...
            int64_t __t43;
            {
                struct __env_990 *__t44 = (struct __env_990 *)malloc(sizeof(struct __env_990));
                __t44->__fn = (tur_thunk_int64_t_t)__fn_988;
                __t44->x = x_986;
                void *__t45 = __t44;
                int64_t f_987 = (int64_t)(intptr_t)(__t45);
                (void)f_987;
                printf("%lld\n", (long long)(__fn_988((void *)(intptr_t)(f_987))));
                {
                    int64_t x_993 = INT64_C(99);
                    (void)x_993;
                    printf("%lld\n", (long long)(__fn_988((void *)(intptr_t)(f_987))));
                }
                int64_t __t46;
