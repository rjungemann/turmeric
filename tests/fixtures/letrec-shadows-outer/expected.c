...
struct __env_887 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_885(void * __env_p_888) {
        struct __env_887 *__env___env_887 = (struct __env_887 *)__env_p_888;
        return __env___env_887->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t23;
        {
            ...
            int64_t __t24;
            {
                ...
                __t25->__fn = (tur_thunk_int64_t_t)__fn_885;
                __t25->x = x_883;
                void *__t26 = __t25;
                int64_t f_884 = (int64_t)(intptr_t)(__t26);
                (void)f_884;
                printf("%lld\n", (long long)(__fn_885((void *)(intptr_t)(f_884))));
                {
                    int64_t x_890 = INT64_C(99);
                    (void)x_890;
                    printf("%lld\n", (long long)(__fn_885((void *)(intptr_t)(f_884))));
                }
                int64_t __t27;
