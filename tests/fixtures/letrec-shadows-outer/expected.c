...
struct __env_698 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_696(void * __env_p_699) {
        struct __env_698 *__env___env_698 = (struct __env_698 *)__env_p_699;
        return __env___env_698->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t1;
        {
            ...
            int64_t __t2;
            {
                struct __env_698 *__t3 = (struct __env_698 *)malloc(sizeof(struct __env_698));
                __t3->__fn = (tur_thunk_int64_t_t)__fn_696;
                __t3->x = x_694;
                void *__t4 = __t3;
                void * f_695 = __t4;
                (void)f_695;
                printf("%lld\n", (long long)(__fn_696(f_695)));
                {
                    int64_t x_701 = INT64_C(99);
                    (void)x_701;
                    printf("%lld\n", (long long)(__fn_696(f_695)));
                }
                int64_t __t5;
