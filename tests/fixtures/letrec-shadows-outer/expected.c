...
struct __env_1611 { tur_thunk_int64_t_t __fn; int64_t x; };
        ...
        int64_t __t172;
        {
            ...
            int64_t __t173;
            {
                ...
                *(void (**)(void *))__t175 = drop_glue___env_1611;
                ...
                __t174->__fn = (tur_thunk_int64_t_t)__fn_1609;
                __t174->x = x_1607;
                TUR_REGION_NOTE_WORDS(&(__t174->x), sizeof(__t174->x));
                void *__t176 = __t174;
                int64_t f_1608 = (int64_t)(intptr_t)(__t176);
                (void)f_1608;
                int64_t __ps_177 = (__fn_1609((void *)(intptr_t)(f_1608)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_177));
                {
                    int64_t x_1614 = INT64_C(99);
                    (void)x_1614;
                    int64_t __ps_178 = (__fn_1609((void *)(intptr_t)(f_1608)));
                    /* panic-return-signal: ret ctype unknown; no propagation here */
                    printf("%lld\n", (long long)(__ps_178));
                }
                int64_t __t179;
