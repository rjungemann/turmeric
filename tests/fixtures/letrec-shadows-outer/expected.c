...
struct __env_839 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_837(void * __env_p_840) {
        struct __env_839 *__env___env_839 = (struct __env_839 *)__env_p_840;
        return __env___env_839->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t3;
        {
            ...
            int64_t __t4;
            {
                struct __env_839 *__t5 = (struct __env_839 *)malloc(sizeof(struct __env_839));
                __t5->__fn = (tur_thunk_int64_t_t)__fn_837;
                __t5->x = x_835;
                void *__t6 = __t5;
                void * f_836 = __t6;
                (void)f_836;
                printf("%lld\n", (long long)(__fn_837(f_836)));
                {
                    int64_t x_842 = INT64_C(99);
                    (void)x_842;
                    printf("%lld\n", (long long)(__fn_837(f_836)));
                }
                int64_t __t7;
