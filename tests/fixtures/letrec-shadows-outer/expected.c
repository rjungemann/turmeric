...
struct __env_884 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_882(void * __env_p_885) {
        struct __env_884 *__env___env_884 = (struct __env_884 *)__env_p_885;
        return __env___env_884->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t21;
        {
            ...
            int64_t __t22;
            {
                struct __env_884 *__t23 = (struct __env_884 *)malloc(sizeof(struct __env_884));
                __t23->__fn = (tur_thunk_int64_t_t)__fn_882;
                __t23->x = x_880;
                void *__t24 = __t23;
                int64_t f_881 = (int64_t)(intptr_t)(__t24);
                (void)f_881;
                printf("%lld\n", (long long)(__fn_882((void *)(intptr_t)(f_881))));
                {
                    int64_t x_887 = INT64_C(99);
                    (void)x_887;
                    printf("%lld\n", (long long)(__fn_882((void *)(intptr_t)(f_881))));
                }
                int64_t __t25;
