...
struct __env_895 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_893(void * __env_p_896) {
        struct __env_895 *__env___env_895 = (struct __env_895 *)__env_p_896;
        return __env___env_895->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            ...
            int64_t __t26;
            {
                struct __env_895 *__t27 = (struct __env_895 *)malloc(sizeof(struct __env_895));
                __t27->__fn = (tur_thunk_int64_t_t)__fn_893;
                __t27->x = x_891;
                void *__t28 = __t27;
                int64_t f_892 = (int64_t)(intptr_t)(__t28);
                (void)f_892;
                printf("%lld\n", (long long)(__fn_893((void *)(intptr_t)(f_892))));
                {
                    int64_t x_898 = INT64_C(99);
                    (void)x_898;
                    printf("%lld\n", (long long)(__fn_893((void *)(intptr_t)(f_892))));
                }
                int64_t __t29;
