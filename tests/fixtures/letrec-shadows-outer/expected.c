...
struct __env_878 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_876(void * __env_p_879) {
        struct __env_878 *__env___env_878 = (struct __env_878 *)__env_p_879;
        return __env___env_878->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t21;
        {
            ...
            int64_t __t22;
            {
                struct __env_878 *__t23 = (struct __env_878 *)malloc(sizeof(struct __env_878));
                __t23->__fn = (tur_thunk_int64_t_t)__fn_876;
                __t23->x = x_874;
                void *__t24 = __t23;
                int64_t f_875 = (int64_t)(intptr_t)(__t24);
                (void)f_875;
                printf("%lld\n", (long long)(__fn_876((void *)(intptr_t)(f_875))));
                {
                    int64_t x_881 = INT64_C(99);
                    (void)x_881;
                    printf("%lld\n", (long long)(__fn_876((void *)(intptr_t)(f_875))));
                }
                int64_t __t25;
