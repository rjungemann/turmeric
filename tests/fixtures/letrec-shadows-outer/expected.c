...
struct __env_993 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_991(void * __env_p_994) {
        struct __env_993 *__env___env_993 = (struct __env_993 *)__env_p_994;
        return __env___env_993->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t42;
        {
            ...
            int64_t __t43;
            {
                struct __env_993 *__t44 = (struct __env_993 *)malloc(sizeof(struct __env_993));
                __t44->__fn = (tur_thunk_int64_t_t)__fn_991;
                __t44->x = x_989;
                void *__t45 = __t44;
                int64_t f_990 = (int64_t)(intptr_t)(__t45);
                (void)f_990;
                printf("%lld\n", (long long)(__fn_991((void *)(intptr_t)(f_990))));
                {
                    int64_t x_996 = INT64_C(99);
                    (void)x_996;
                    printf("%lld\n", (long long)(__fn_991((void *)(intptr_t)(f_990))));
                }
                int64_t __t46;
