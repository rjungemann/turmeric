...
struct __env_769 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_767(void * __env_p_770) {
        struct __env_769 *__env___env_769 = (struct __env_769 *)__env_p_770;
        return __env___env_769->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t2;
        {
            ...
            int64_t __t3;
            {
                struct __env_769 *__t4 = (struct __env_769 *)malloc(sizeof(struct __env_769));
                __t4->__fn = (tur_thunk_int64_t_t)__fn_767;
                __t4->x = x_765;
                void *__t5 = __t4;
                void * f_766 = __t5;
                (void)f_766;
                printf("%lld\n", (long long)(__fn_767(f_766)));
                {
                    int64_t x_772 = INT64_C(99);
                    (void)x_772;
                    printf("%lld\n", (long long)(__fn_767(f_766)));
                }
                int64_t __t6;
