...
struct __env_761 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_759(void * __env_p_762) {
        struct __env_761 *__env___env_761 = (struct __env_761 *)__env_p_762;
        return __env___env_761->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t1;
        {
            ...
            int64_t __t2;
            {
                struct __env_761 *__t3 = (struct __env_761 *)malloc(sizeof(struct __env_761));
                __t3->__fn = (tur_thunk_int64_t_t)__fn_759;
                __t3->x = x_757;
                void *__t4 = __t3;
                void * f_758 = __t4;
                (void)f_758;
                printf("%lld\n", (long long)(__fn_759(f_758)));
                {
                    int64_t x_764 = INT64_C(99);
                    (void)x_764;
                    printf("%lld\n", (long long)(__fn_759(f_758)));
                }
                int64_t __t5;
