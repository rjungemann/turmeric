...
struct __env_862 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_860(void * __env_p_863) {
        struct __env_862 *__env___env_862 = (struct __env_862 *)__env_p_863;
        return __env___env_862->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t23;
        {
            ...
            int64_t __t24;
            {
                struct __env_862 *__t25 = (struct __env_862 *)malloc(sizeof(struct __env_862));
                __t25->__fn = (tur_thunk_int64_t_t)__fn_860;
                __t25->x = x_858;
                void *__t26 = __t25;
                int64_t f_859 = (int64_t)(intptr_t)(__t26);
                (void)f_859;
                printf("%lld\n", (long long)(__fn_860((void *)(intptr_t)(f_859))));
                {
                    int64_t x_865 = INT64_C(99);
                    (void)x_865;
                    printf("%lld\n", (long long)(__fn_860((void *)(intptr_t)(f_859))));
                }
                int64_t __t27;
