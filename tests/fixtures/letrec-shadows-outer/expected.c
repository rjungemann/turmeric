...
struct __env_798 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_796(void * __env_p_799) {
        struct __env_798 *__env___env_798 = (struct __env_798 *)__env_p_799;
        return __env___env_798->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t2;
        {
            ...
            int64_t __t3;
            {
                struct __env_798 *__t4 = (struct __env_798 *)malloc(sizeof(struct __env_798));
                __t4->__fn = (tur_thunk_int64_t_t)__fn_796;
                __t4->x = x_794;
                void *__t5 = __t4;
                void * f_795 = __t5;
                (void)f_795;
                printf("%lld\n", (long long)(__fn_796(f_795)));
                {
                    int64_t x_801 = INT64_C(99);
                    (void)x_801;
                    printf("%lld\n", (long long)(__fn_796(f_795)));
                }
                int64_t __t6;
