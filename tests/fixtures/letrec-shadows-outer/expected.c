...
struct __env_892 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_890(void * __env_p_893) {
        struct __env_892 *__env___env_892 = (struct __env_892 *)__env_p_893;
        return __env___env_892->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            ...
            int64_t __t26;
            {
                struct __env_892 *__t27 = (struct __env_892 *)malloc(sizeof(struct __env_892));
                __t27->__fn = (tur_thunk_int64_t_t)__fn_890;
                __t27->x = x_888;
                void *__t28 = __t27;
                int64_t f_889 = (int64_t)(intptr_t)(__t28);
                (void)f_889;
                printf("%lld\n", (long long)(__fn_890((void *)(intptr_t)(f_889))));
                {
                    int64_t x_895 = INT64_C(99);
                    (void)x_895;
                    printf("%lld\n", (long long)(__fn_890((void *)(intptr_t)(f_889))));
                }
                int64_t __t29;
