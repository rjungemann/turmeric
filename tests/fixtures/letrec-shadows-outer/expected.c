...
struct __env_849 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_847(void * __env_p_850) {
        struct __env_849 *__env___env_849 = (struct __env_849 *)__env_p_850;
        return __env___env_849->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t3;
        {
            ...
            int64_t __t4;
            {
                struct __env_849 *__t5 = (struct __env_849 *)malloc(sizeof(struct __env_849));
                __t5->__fn = (tur_thunk_int64_t_t)__fn_847;
                __t5->x = x_845;
                void *__t6 = __t5;
                void * f_846 = __t6;
                (void)f_846;
                printf("%lld\n", (long long)(__fn_847(f_846)));
                {
                    int64_t x_852 = INT64_C(99);
                    (void)x_852;
                    printf("%lld\n", (long long)(__fn_847(f_846)));
                }
                int64_t __t7;
