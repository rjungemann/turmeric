...
struct __env_881 { tur_thunk_int64_t_t __fn; int64_t x; };
static int64_t __fn_879(void * __env_p_882) {
        struct __env_881 *__env___env_881 = (struct __env_881 *)__env_p_882;
        return __env___env_881->x;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            ...
            int64_t __t26;
            {
                struct __env_881 *__t27 = (struct __env_881 *)malloc(sizeof(struct __env_881));
                __t27->__fn = (tur_thunk_int64_t_t)__fn_879;
                __t27->x = x_877;
                void *__t28 = __t27;
                int64_t f_878 = (int64_t)(intptr_t)(__t28);
                (void)f_878;
                printf("%lld\n", (long long)(__fn_879((void *)(intptr_t)(f_878))));
                {
                    int64_t x_884 = INT64_C(99);
                    (void)x_884;
                    printf("%lld\n", (long long)(__fn_879((void *)(intptr_t)(f_878))));
                }
                int64_t __t29;
