...
int main() {
        {
            void * ch_220 = chan_new(INT64_C(4));
            (void)ch_220;
            {
                void * prod_arg_221 = targ_new((void *)(intptr_t)(ch_220));
                (void)prod_arg_221;
                {
                    void * cons_arg_222 = targ_new((void *)(intptr_t)(ch_220));
                    (void)cons_arg_222;
                    {
                        void * tp_223 = pc_thread_spawn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_221));
                        (void)tp_223;
                        {
                            void * tc_224 = pc_thread_spawn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_222));
                            (void)tc_224;
                            pc_thread_join((void *)(intptr_t)(tp_223));
                            pc_thread_join((void *)(intptr_t)(tc_224));
                        }
                    }
                    printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(cons_arg_222))));
                    targ_free((void *)(intptr_t)(prod_arg_221));
                    targ_free((void *)(intptr_t)(cons_arg_222));
                }
            }
            chan_free((void *)(intptr_t)(ch_220));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
