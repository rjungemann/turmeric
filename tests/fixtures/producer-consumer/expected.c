...
int main() {
        {
            void * ch_45 = chan_new(INT64_C(4));
            (void)ch_45;
            {
                void * prod_arg_46 = targ_new((void *)(intptr_t)(ch_45));
                (void)prod_arg_46;
                {
                    void * cons_arg_47 = targ_new((void *)(intptr_t)(ch_45));
                    (void)cons_arg_47;
                    {
                        void * tp_48 = pc_thread_spawn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_46));
                        (void)tp_48;
                        {
                            void * tc_49 = pc_thread_spawn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_47));
                            (void)tc_49;
                            pc_thread_join((void *)(intptr_t)(tp_48));
                            pc_thread_join((void *)(intptr_t)(tc_49));
                        }
                    }
                    printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(cons_arg_47))));
                    targ_free((void *)(intptr_t)(prod_arg_46));
                    targ_free((void *)(intptr_t)(cons_arg_47));
                }
            }
            chan_free((void *)(intptr_t)(ch_45));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
