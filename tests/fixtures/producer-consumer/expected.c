...
int main() {
        {
            void * ch_238 = chan_new(INT64_C(4));
            (void)ch_238;
            {
                void * prod_arg_239 = targ_new((void *)(intptr_t)(ch_238));
                (void)prod_arg_239;
                {
                    void * cons_arg_240 = targ_new((void *)(intptr_t)(ch_238));
                    (void)cons_arg_240;
                    {
                        void * tp_241 = pc_thread_spawn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_239));
                        (void)tp_241;
                        {
                            void * tc_242 = pc_thread_spawn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_240));
                            (void)tc_242;
                            pc_thread_join((void *)(intptr_t)(tp_241));
                            pc_thread_join((void *)(intptr_t)(tc_242));
                        }
                    }
                    printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(cons_arg_240))));
                    targ_free((void *)(intptr_t)(prod_arg_239));
                    targ_free((void *)(intptr_t)(cons_arg_240));
                }
            }
            chan_free((void *)(intptr_t)(ch_238));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
