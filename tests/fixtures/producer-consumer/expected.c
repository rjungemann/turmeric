...
static void * pc_thread_spawn(void *, void *);
static void pc_thread_join(void *);
...
static void * pc_thread_spawn(void * fn_ptr, void * arg) {
...
static void pc_thread_join(void * t) {
...
int main() {
        {
            void * ch_232 = chan_new(INT64_C(4));
            (void)ch_232;
            {
                void * prod_arg_233 = targ_new((void *)(intptr_t)(ch_232));
                (void)prod_arg_233;
                {
                    void * cons_arg_234 = targ_new((void *)(intptr_t)(ch_232));
                    (void)cons_arg_234;
                    {
                        void * tp_235 = pc_thread_spawn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_233));
                        (void)tp_235;
                        {
                            void * tc_236 = pc_thread_spawn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_234));
                            (void)tc_236;
                            pc_thread_join((void *)(intptr_t)(tp_235));
                            pc_thread_join((void *)(intptr_t)(tc_236));
                        }
                    }
                    printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(cons_arg_234))));
                    targ_free((void *)(intptr_t)(prod_arg_233));
                    targ_free((void *)(intptr_t)(cons_arg_234));
                }
            }
            chan_free((void *)(intptr_t)(ch_232));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
