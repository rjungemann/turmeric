...
int main() {
        {
            void * ch_237 = chan_new(INT64_C(4));
            (void)ch_237;
            {
                void * prod_arg_238 = targ_new((void *)(intptr_t)(ch_237));
                (void)prod_arg_238;
                {
                    void * cons_arg_239 = targ_new((void *)(intptr_t)(ch_237));
                    (void)cons_arg_239;
                    {
                        void * tp_240 = pc_thread_spawn((void *)(intptr_t)(producer), (void *)(intptr_t)(prod_arg_238));
                        (void)tp_240;
                        {
                            void * tc_241 = pc_thread_spawn((void *)(intptr_t)(consumer), (void *)(intptr_t)(cons_arg_239));
                            (void)tc_241;
                            pc_thread_join((void *)(intptr_t)(tp_240));
                            pc_thread_join((void *)(intptr_t)(tc_241));
                        }
                    }
                    printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(cons_arg_239))));
                    targ_free((void *)(intptr_t)(prod_arg_238));
                    targ_free((void *)(intptr_t)(cons_arg_239));
                }
            }
            chan_free((void *)(intptr_t)(ch_237));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
