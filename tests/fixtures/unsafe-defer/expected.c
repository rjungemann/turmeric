...
struct __defer_env_9 {RcControlBlock * r; };

struct __defer_env_6 {void * p; };
        ...
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(9);
            ...
            tur_frame_init(&__frame_3, NULL);
            {
                ...
                struct __defer_env_6 __t8 = {.p = p_2};
                tur_frame_push_defer(&__frame_5, __defer_7, &__t8);
                printf("%lld\n", (long long)(INT64_C(1)));
                tur_frame_fire_lifo(&__frame_5);
            }
            struct __defer_env_9 __t11 = {.r = r_1};
            tur_frame_push_defer(&__frame_3, __defer_10, &__t11);
            int64_t __t12;
            __t12 = INT64_C(0);
