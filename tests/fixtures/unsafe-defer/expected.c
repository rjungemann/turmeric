...
struct __defer_env_12 {RcControlBlock * r; };
...
static void __handle_body_5(void) {
    ...
    struct __defer_env_8 __t10 = {.p = __henv_5->p};
...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(9);
            ...
            struct __defer_env_12 __t14 = {.r = r_213};
            tur_frame_push_defer(&__frame_3, __defer_13, &__t14);
            int64_t __t15;
            __t15 = INT64_C(0);
