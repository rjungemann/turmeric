...
static double __fn_894(void *, double);
static void * __fn_899(int64_t);
static double __fn_904(void *, double);
static void * __fn_909(void *, int64_t);
static double __fn_917(void *, double);
...
static void * invert_hycap();
static void * konst(double);
static void * apply_hysf(int64_t, int64_t);
...
static bool __inst_Eq_eq_qu_Tuple2(int64_t x, int64_t y) {
        return tuple2_hyeq_hycarrier_qu(x, y, (int64_t)(intptr_t)(__fn_789), (int64_t)(intptr_t)(__fn_793));
}
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t16[1] = (int64_t)(intptr_t)__fn_811;
        void *__t17 = __t16;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t18[1] = (int64_t)(intptr_t)__fn_890;
        void *__t19 = __t18;
...
struct __env_896 { tur_thunk_double_double_t __fn; int64_t sig; };
static double __fn_894(void * __env_p_897, double t) {
        struct __env_896 *__env___env_896 = (struct __env_896 *)__env_p_897;
        return (0.0) - ((*( tur_thunk_double_double_t *)((void *)(intptr_t)(__env___env_896->sig)))((void *)(intptr_t)(__env___env_896->sig), t));
}

static void * __fn_899(int64_t sig) {
        struct __env_896 *__t20 = (struct __env_896 *)malloc(sizeof(struct __env_896));
        __t20->__fn = (tur_thunk_double_double_t)__fn_894;
        __t20->sig = sig;
        void *__t21 = __t20;
        return __t21;
}

struct __env_906 { tur_thunk_double_double_t __fn; double z; int64_t sig; };
static double __fn_904(void * __env_p_907, double t) {
        struct __env_906 *__env___env_906 = (struct __env_906 *)__env_p_907;
        return (__env___env_906->z) - ((*( tur_thunk_double_double_t *)((void *)(intptr_t)(__env___env_906->sig)))((void *)(intptr_t)(__env___env_906->sig), t));
}

struct __env_911 { int64_t __fn; double z; };
static void * __fn_909(void * __env_p_912, int64_t sig) {
        struct __env_911 *__env___env_911 = (struct __env_911 *)__env_p_912;
        struct __env_906 *__t22 = (struct __env_906 *)malloc(sizeof(struct __env_906));
        __t22->__fn = (tur_thunk_double_double_t)__fn_904;
        __t22->z = __env___env_911->z;
        __t22->sig = sig;
        void *__t23 = __t22;
        return __t23;
}

struct __env_919 { tur_thunk_double_double_t __fn; double kv; };
static double __fn_917(void * __env_p_920, double t) {
        struct __env_919 *__env___env_919 = (struct __env_919 *)__env_p_920;
        return __env___env_919->kv;
}
        ...
        if (tnil_qu(l1)) {
            ...
            if (tnil_qu(l2)) {
                ...
                if ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), list_hyhead(l1), list_hyhead(l2))) {
                    __t26 = list_hyeq_qu(list_hytail(l1), list_hytail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t26 = false;
                }
                __t25 = __t26;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            __t27 = tcons((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f)));
        }
        return __t27;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            __t28 = tcons(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2));
        }
        return __t28;
}
...
static int64_t invert() {
        return (int64_t)(intptr_t)__fn_899;
}
...
static void * invert_hycap() {
        void * __t29;
        {
            double z_901 = 0.0;
            (void)z_901;
            struct __env_911 *__t30 = (struct __env_911 *)malloc(sizeof(struct __env_911));
            __t30->__fn = (int64_t)(intptr_t)__fn_909;
            __t30->z = z_901;
            void *__t31 = __t30;
            __t29 = __t31;
        }
...
static void * konst(double k) {
        void * __t32;
        {
            double kv_915 = k;
            (void)kv_915;
            struct __env_919 *__t33 = (struct __env_919 *)malloc(sizeof(struct __env_919));
            __t33->__fn = (tur_thunk_double_double_t)__fn_917;
            __t33->kv = kv_915;
            void *__t34 = __t33;
            __t32 = __t34;
        }
...
int main(int argc, char **argv) {
        ...
        {
            int64_t *__t35 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t35[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t35[1] = (int64_t)(intptr_t)invert();
            void *__t36 = __t35;
            int64_t out = (int64_t)(intptr_t)(apply_hysf((int64_t)(intptr_t)(__t36), (int64_t)(intptr_t)(konst(0.5))));
            (void)out;
            printf("%g\n", (double)((*( tur_thunk_double_double_t *)((void *)(intptr_t)(out)))((void *)(intptr_t)(out), 0.0)));
        }
        {
            int64_t out = (int64_t)(intptr_t)(apply_hysf((int64_t)(intptr_t)(invert_hycap()), (int64_t)(intptr_t)(konst(0.5))));
            (void)out;
            printf("%g\n", (double)((*( tur_thunk_double_double_t *)((void *)(intptr_t)(out)))((void *)(intptr_t)(out), 0.0)));
        }
        int64_t __t37;
