...
static void * future_error_worker(void *);
...
static void * future_error_worker(void * arg) {
        void **args = (void **)arg;
...
int main() {
        int64_t __t0;
        {
            ...
            (void)fc_235;
            {
                void * arg_236 = make_worker_arg((void *)(intptr_t)(fc_235), INT64_C(-1));
                (void)arg_236;
                {
                    void * t_237 = thread_spawn_raw((void *)(intptr_t)(future_error_worker), (void *)(intptr_t)(arg_236));
                    (void)t_237;
                    {
                        void * result_238 = fc_get((void *)(intptr_t)(fc_235));
                        (void)result_238;
                        if (result_ok_((void *)(intptr_t)(result_238))) {
                            print_labelled("ok:", INT64_C(0));
                        } else {
                            print_labelled("err:", result_err((void *)(intptr_t)(result_238)));
                        }
                        result_free((void *)(intptr_t)(result_238));
                        thread_join_raw((void *)(intptr_t)(t_237));
                    }
                    fc_free((void *)(intptr_t)(fc_235));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
