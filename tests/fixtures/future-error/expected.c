...
int main() {
        int64_t __t0;
        {
            ...
            (void)fc_223;
            {
                void * arg_224 = make_worker_arg((void *)(intptr_t)(fc_223), INT64_C(-1));
                (void)arg_224;
                {
                    void * t_225 = thread_spawn_raw((void *)(intptr_t)(future_error_worker), (void *)(intptr_t)(arg_224));
                    (void)t_225;
                    {
                        void * result_226 = fc_get((void *)(intptr_t)(fc_223));
                        (void)result_226;
                        if (result_ok_((void *)(intptr_t)(result_226))) {
                            print_labelled("ok:", INT64_C(0));
                        } else {
                            print_labelled("err:", result_err((void *)(intptr_t)(result_226)));
                        }
                        result_free((void *)(intptr_t)(result_226));
                        thread_join_raw((void *)(intptr_t)(t_225));
                    }
