...
int main() {
        int64_t __t0;
        {
            ...
            (void)fc_48;
            {
                void * arg_49 = make_worker_arg((void *)(intptr_t)(fc_48), INT64_C(-1));
                (void)arg_49;
                {
                    void * t_50 = thread_spawn_raw((void *)(intptr_t)(future_error_worker), (void *)(intptr_t)(arg_49));
                    (void)t_50;
                    {
                        void * result_51 = fc_get((void *)(intptr_t)(fc_48));
                        (void)result_51;
                        if (result_ok_((void *)(intptr_t)(result_51))) {
                            print_labelled("ok:", INT64_C(0));
                        } else {
                            print_labelled("err:", result_err((void *)(intptr_t)(result_51)));
                        }
                        result_free((void *)(intptr_t)(result_51));
                        thread_join_raw((void *)(intptr_t)(t_50));
                    }
                    fc_free((void *)(intptr_t)(fc_48));
                }
            }
            int64_t __t1;
            __t1 = INT64_C(0);
