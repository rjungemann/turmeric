...
int main() {
        {
            void * m_205 = mutex_new();
            (void)m_205;
            mutex_lock((void *)(intptr_t)(m_205));
            printf("%lld\n", (long long)(INT64_C(1)));
            mutex_unlock((void *)(intptr_t)(m_205));
            printf("%lld\n", (long long)(INT64_C(2)));
            {
                bool got_206 = mutex_try_lock((void *)(intptr_t)(m_205));
                (void)got_206;
                puts((got_206) ? "true" : "false");
                {
                    bool got2_207 = mutex_try_lock((void *)(intptr_t)(m_205));
                    (void)got2_207;
                    puts((got2_207) ? "true" : "false");
                }
                mutex_unlock((void *)(intptr_t)(m_205));
            }
            mutex_free((void *)(intptr_t)(m_205));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
