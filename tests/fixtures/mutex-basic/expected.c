...
static bool mutex_try_lock(void * m) {
...
int main() {
        {
            void * m_270 = mutex_new();
            (void)m_270;
            mutex_lock((void *)(intptr_t)(m_270));
            printf("%lld\n", (long long)(INT64_C(1)));
            mutex_unlock((void *)(intptr_t)(m_270));
            printf("%lld\n", (long long)(INT64_C(2)));
            {
                bool got_271 = mutex_try_lock((void *)(intptr_t)(m_270));
                (void)got_271;
                puts((got_271) ? "true" : "false");
                {
                    bool got2_272 = mutex_try_lock((void *)(intptr_t)(m_270));
                    (void)got2_272;
                    puts((got2_272) ? "true" : "false");
                }
                mutex_unlock((void *)(intptr_t)(m_270));
            }
            mutex_free((void *)(intptr_t)(m_270));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
