...
int main() {
        {
            void * m_30 = mutex_new();
            (void)m_30;
            mutex_lock((void *)(intptr_t)(m_30));
            printf("%lld\n", (long long)(INT64_C(1)));
            mutex_unlock((void *)(intptr_t)(m_30));
            printf("%lld\n", (long long)(INT64_C(2)));
            {
                bool got_31 = mutex_try_lock((void *)(intptr_t)(m_30));
                (void)got_31;
                puts((got_31) ? "true" : "false");
                {
                    bool got2_32 = mutex_try_lock((void *)(intptr_t)(m_30));
                    (void)got2_32;
                    puts((got2_32) ? "true" : "false");
                }
                mutex_unlock((void *)(intptr_t)(m_30));
            }
            mutex_free((void *)(intptr_t)(m_30));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
