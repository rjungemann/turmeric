...
int main() {
        {
            void * m_217 = mutex_new();
            (void)m_217;
            mutex_lock((void *)(intptr_t)(m_217));
            printf("%lld\n", (long long)(INT64_C(1)));
            mutex_unlock((void *)(intptr_t)(m_217));
            printf("%lld\n", (long long)(INT64_C(2)));
            {
                bool got_218 = mutex_try_lock((void *)(intptr_t)(m_217));
                (void)got_218;
                puts((got_218) ? "true" : "false");
                {
                    bool got2_219 = mutex_try_lock((void *)(intptr_t)(m_217));
                    (void)got2_219;
                    puts((got2_219) ? "true" : "false");
                }
                mutex_unlock((void *)(intptr_t)(m_217));
            }
            mutex_free((void *)(intptr_t)(m_217));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
