...
int main() {
        {
            void * m_625 = mutex_new();
            (void)m_625;
            mutex_lock((void *)(intptr_t)(m_625));
            printf("%lld\n", (long long)(INT64_C(1)));
            mutex_unlock((void *)(intptr_t)(m_625));
            printf("%lld\n", (long long)(INT64_C(2)));
            {
                bool got_626 = mutex_try_lock((void *)(intptr_t)(m_625));
                (void)got_626;
                puts((got_626) ? "true" : "false");
                {
                    bool got2_627 = mutex_try_lock((void *)(intptr_t)(m_625));
                    (void)got2_627;
                    puts((got2_627) ? "true" : "false");
                }
                mutex_unlock((void *)(intptr_t)(m_625));
            }
            mutex_free((void *)(intptr_t)(m_625));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
