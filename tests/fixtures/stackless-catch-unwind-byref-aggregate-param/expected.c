...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t255;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1464 = __ps_257;
            (void)r_1464;
            bool __ps_258 = (bt_hyundo_hyto_ex(m_1463));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_258);
            int64_t __t259;
            __t259 = r_1464;
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t267;
            bool __ps_268 = (ok___spec__bool_tur_adt_Result__int__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_268) {
                __t267 = INT64_C(100);
            } else {
            ...
            __v = (int64_t)(intptr_t)(__t267); __pc = __k->tag; break;
           } else {
            tur_handler_node *__b269 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b269->parent = tur_handler_chain; tur_handler_chain = __b269;
            tur_cont *__n269 = (tur_cont*)malloc(sizeof(tur_cont));
            __n269->tag = 3; __n269->boundary = __b269; __n269->next = __k;
            __n269->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc, sizeof(tur_adt_Result__int__int)); __n269->saved[0] = (int64_t)(intptr_t)__ab; }
            __n269->saved[1] = (int64_t)(intptr_t)(n);
            __n269->saved[2] = (int64_t)(intptr_t)(__t265);
            __n269->saved[3] = (int64_t)(intptr_t)(__t266);
            __k = __n269; __pc = 2; break;
           }
          }
          case 2: {
           tur_adt_Result__int__int __ra270_0 = (acc);
           int64_t __ra270_1 = ((n) - (INT64_C(1)));
           acc = __ra270_0;
           n = __ra270_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           __t265 = (int64_t)(intptr_t)(__k->saved[2]);
           __t266 = (int64_t)(intptr_t)(__k->saved[3]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box269;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp269 = global_panic_payload; global_panic_payload = 0; __box269 = tur_box_err((int64_t)(intptr_t)__pp269); }
           else { __box269 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box269);
           (void)(__box269);
           int64_t __t271;
           bool __ps_272 = (ok___spec__bool_tur_adt_Result__int__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_272) {
               __t271 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t271)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_273 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_274 = (step(__ps_273, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_274));
        tur_adt_Result__int__int __ps_275 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_276 = (step(__ps_275, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_276));
        int64_t __t277;
        __t277 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_281 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_282 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_282;
}
