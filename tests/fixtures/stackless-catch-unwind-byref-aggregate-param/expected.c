...
struct __env_1612 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1610(void * __env_p_1613) {
        struct __env_1612 *__env___env_1612 = (struct __env_1612 *)__env_p_1613;
        return step(__env___env_1612->acc, (__env___env_1612->n) - (INT64_C(1)));
}
