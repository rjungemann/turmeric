        ...
        bool __t28;
        {
            ...
            if ((t1_1015) == (INT64_C(0))) {
                ...
                if ((t2_1016) == (INT64_C(0))) {
                    ...
                    __auto_type __ps_31 = (cons_hyeq_hygo(t1_1015, t2_1016));
                    if (tur_panicking) return (bool){0};
                    __t30 = __ps_31;
                }
                __t29 = __t30;
...
static int64_t __fn_1303(void * __env_p_1306) {
        ...
        __auto_type __ps_43 = (step(&__t42, (__env___env_1305->n) - (INT64_C(1))));
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_762, (void *)(intptr_t)(k_763), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_767), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_768), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            ...
            bool __t98;
            {
                ...
                if ((t1_1010) == (INT64_C(0))) {
                    ...
                    if ((t2_1011) == (INT64_C(0))) {
                        ...
                        __auto_type __ps_101 = (cons_hyeq_hygo(t1_1010, t2_1011));
                        if (tur_panicking) return (bool){0};
                        __t100 = __ps_101;
                    }
                    __t99 = __t100;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t117;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_123 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1101), (void *)(intptr_t)(__ps_122), (void *)(intptr_t)(keyeq_1102)));
            if (tur_panicking) return (bool){0};
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t144;
        {
            ...
            {
                __auto_type __ps_146 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1230));
                if (tur_panicking) return (int64_t){0};
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t149;
        {
            ...
            (void)r_1280;
            int64_t __t151;
            __auto_type __ps_152 = (schema_hydecode_hyok_qu(r_1280));
            if (tur_panicking) return (int64_t){0};
            if (__ps_152) {
                __auto_type __ps_153 = (schema_hydecode_hyvalue(r_1280));
                if (tur_panicking) return (int64_t){0};
                __t151 = __ps_153;
            } else {
                __auto_type __ps_154 = (schema_hydecode_hyerrors(r_1280));
                if (tur_panicking) return (int64_t){0};
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t159;
            __auto_type __ps_160 = (ok_qu((int64_t)(intptr_t)(acc)));
            if (tur_panicking) return (int64_t){0};
            if (__ps_160) {
                __t159 = INT64_C(100);
            } else {
          ...
          case 3: {
           ...
           (void)(__box161);
           int64_t __t163;
           __auto_type __ps_164 = (ok_qu((int64_t)(intptr_t)(acc)));
           if (tur_panicking) return (int64_t){0};
           if (__ps_164) {
               __t163 = INT64_C(1);
           } else {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_165 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t166 = __ps_165;
        __auto_type __ps_167 = (step(&__t166, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_167));
        __auto_type __ps_168 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t169 = __ps_168;
        __auto_type __ps_170 = (step(&__t169, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_170));
        int64_t __t171;
        __t171 = INT64_C(0);
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_173 = (vec_new__spec__tur_adt_Vec__int__());
