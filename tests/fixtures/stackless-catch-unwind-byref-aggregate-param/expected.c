...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_108) {
            bool __t109;
            {
                ...
                bool __t110;
                if ((t1_977) == (INT64_C(0))) {
                    __t110 = (t2_978) == (INT64_C(0));
                } else {
                    bool __t111;
                    if ((t2_978) == (INT64_C(0))) {
                        __t111 = false;
                    } else {
                        __auto_type __ps_112 = (cons_hyeq_hygo(t1_977, t2_978));
                        if (tur_panicking) return (bool){0};
                        __t111 = __ps_112;
                    }
                    __t110 = __t111;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_986 = (int64_t)(intptr_t)(__ps_120);
                (void)out_986;
                __t115 = out_986;
            }
            __t113 = __t115;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_122) {
            ...
            int64_t __t123;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_993 = (int64_t)(intptr_t)(__ps_127);
                (void)out_993;
                __t123 = out_993;
            }
            __t121 = __t123;
        ...
        if (__ps_132) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1064 = __ps_133;
                (void)h_1064;
                __auto_type __ps_134 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1065 = __ps_134;
                (void)k_1065;
                __auto_type __ps_135 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1064, (void *)(intptr_t)(k_1065), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_135) {
                    void * __t136 = iter;
                    void * __t137 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t139;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1068 = __ps_141;
            (void)iter_1068;
            __auto_type __ps_142 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_143 = (hamt_slkeyeq((void *)(intptr_t)(__ps_142)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1069 = __ps_143;
            (void)keyeq_1069;
            __auto_type __ps_144 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_145 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1068), (void *)(intptr_t)(__ps_144), (void *)(intptr_t)(keyeq_1069)));
            if (tur_panicking) return (bool){0};
            bool result_1070 = __ps_145;
            (void)result_1070;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t166;
        {
            ...
            {
                __auto_type __ps_168 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1197));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1198 = __ps_168;
                (void)_un_unv_1198;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t171;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1247 = __ps_172;
            (void)r_1247;
            int64_t __t173;
            __auto_type __ps_174 = (schema_hydecode_hyok_qu(r_1247));
            if (tur_panicking) return (int64_t){0};
            if (__ps_174) {
                __auto_type __ps_175 = (schema_hydecode_hyvalue(r_1247));
                if (tur_panicking) return (int64_t){0};
                __t173 = __ps_175;
            } else {
                __auto_type __ps_176 = (schema_hydecode_hyerrors(r_1247));
                if (tur_panicking) return (int64_t){0};
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n183->saved[2] = (int64_t)(intptr_t)(__t179);
            __n183->saved[3] = (int64_t)(intptr_t)(__t180);
          ...
          case 3: {
           ...
           __t179 = (int64_t)(intptr_t)(__k->saved[2]);
           __t180 = (int64_t)(intptr_t)(__k->saved[3]);
           ...
           (void)(__box183);
           int64_t __t185;
           __auto_type __ps_186 = (ok_qu((int64_t)(intptr_t)(acc)));
           if (tur_panicking) return (int64_t){0};
           if (__ps_186) {
               __t185 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t185)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_187 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t188 = __ps_187;
        __auto_type __ps_189 = (step(&__t188, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        __auto_type __ps_190 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t191 = __ps_190;
        __auto_type __ps_192 = (step(&__t191, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_192));
        int64_t __t193;
        __t193 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_194 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_195 = (vec_new__spec__tur_adt_Vec__int__());
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        __auto_type __ps_196 = (ctor_Result__int__int(true, x, (int64_t){0}));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        __auto_type __ps_197 = (ctor_Result__int__int(false, (int64_t){0}, e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_197;
}
