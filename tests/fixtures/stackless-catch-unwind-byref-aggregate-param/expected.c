...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t3) {
            ...
            *(void (**)(void *))__t7 = 0;
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_756;
            void *__t8 = __t6;
...
struct __env_1286 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
static void drop_glue___env_1286(void *__p) {
    struct __env_1286 *__e = (struct __env_1286 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1284(void * __env_p_1287) {
        struct __env_1286 *__env___env_1286 = (struct __env_1286 *)__env_p_1287;
        tur_adt_Result__int__int __t42 = __env___env_1286->acc;
        __auto_type __ps_43 = (step(&__t42, (__env___env_1286->n) - (INT64_C(1))));
...
static int64_t map_hyeq_hyloop__cps(void * iter_739, void * m2_hyhamt_740, void * keyeq_741, int64_t val_cmp, DK *__kont);
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_743, (void *)(intptr_t)(k_744), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static intptr_t map_hyeq_hyloop_j2(intptr_t env, intptr_t k_744__slot, DK *__kont) {
    ...
    __ce_map_hyeq_hyloop_j3->f3 = h_743;
    __ce_map_hyeq_hyloop_j3->f4 = k_744;
    __ce_map_hyeq_hyloop_j3->f5 = keyeq;
    __dk_reap_ptr((intptr_t)__ce_map_hyeq_hyloop_j3);
    return hamt_slhas_hydynamic_qu__cps(m2_hamt, h_743, k_744, keyeq, __dk_reap_node(dk_frame_resume(map_hyeq_hyloop_j3, (intptr_t)__ce_map_hyeq_hyloop_j3, __kont))); /* cps->cps heap join */
}
typedef struct { int64_t f0; void * f1; void * f2; void * f3; } map_hyeq_hyloop_j1_env;
static intptr_t map_hyeq_hyloop_j1(intptr_t env, intptr_t h_743__slot, DK *__kont) {
    map_hyeq_hyloop_j1_env *__cap = (map_hyeq_hyloop_j1_env *)(intptr_t)env;
    int64_t val_cmp = __cap->f0;
    void * iter = __cap->f1;
    void * m2_hamt = __cap->f2;
    void * keyeq = __cap->f3;
    int64_t h_743 = (int64_t)(h_743__slot);
    ...
    __ce_map_hyeq_hyloop_j2->f3 = h_743;
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_748 = __ps_75;
            (void)iter_748;
            __auto_type __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return (bool){0};
            void * keyeq_749 = __ps_77;
            (void)keyeq_749;
            __auto_type __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_748), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_749), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_750 = __ps_79;
            (void)result_750;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_748));
            bool __t80;
            __t80 = result_750;
            __t73 = __t80;
        }
