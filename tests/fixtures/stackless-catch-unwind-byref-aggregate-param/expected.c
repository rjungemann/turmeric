...
static void __defer_267(void *__env) {
    ...
    bool __ps_294 = (bt_hyundo_hyto_ex(__e->m));
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_195) {
            bool __t196;
            {
                ...
                (void)t2_1280;
                bool __t197;
                if ((t1_1279) == (INT64_C(0))) {
                    __t197 = (t2_1280) == (INT64_C(0));
                } else {
                    bool __t198;
                    if ((t2_1280) == (INT64_C(0))) {
                        __t198 = false;
                    } else {
                        bool __ps_199 = (cons_hyeq_hygo(t1_1279, t2_1280));
                        if (tur_panicking) return ((bool)0);
                        __t198 = __ps_199;
                    }
                    __t197 = __t198;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_205) {
            ...
            int64_t __t206;
            {
                ...
                int64_t out_1295 = (int64_t)(intptr_t)(__ps_210);
                (void)out_1295;
                __t206 = out_1295;
            }
            __t204 = __t206;
        ...
        if (__ps_215) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1366 = __ps_216;
                (void)h_1366;
                void * __ps_217 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1367 = __ps_217;
                (void)k_1367;
                bool __ps_218 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1366, (void *)(intptr_t)(k_1367), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_218) {
                    void * __t219 = iter;
                    void * __t220 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t222;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1370 = __ps_224;
            (void)iter_1370;
            void * __ps_225 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_226 = (hamt_slkeyeq((void *)(intptr_t)(__ps_225)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1371 = __ps_226;
            (void)keyeq_1371;
            void * __ps_227 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_228 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1370), (void *)(intptr_t)(__ps_227), (void *)(intptr_t)(keyeq_1371)));
            if (tur_panicking) return ((bool)0);
            bool result_1372 = __ps_228;
            (void)result_1372;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t249;
        {
            ...
            {
                tur_adt_Vec__int * __ps_251 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1502));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1503 = __ps_251;
                (void)_un_unv_1503;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t255;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1553 = __ps_256;
            (void)r_1553;
            int64_t __t257;
            bool __ps_258 = (schema_hydecode_hyok_qu(r_1553));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_258) {
                int64_t __ps_259 = (schema_hydecode_hyvalue(r_1553));
                if (tur_panicking) return ((int64_t)0);
                __t257 = __ps_259;
            } else {
                int64_t __ps_260 = (schema_hydecode_hyerrors(r_1553));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t263;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1604 = __ps_264;
            (void)m_1604;
            tur_frame __frame_265;
            tur_frame_init(&__frame_265, NULL);
            struct __defer_env_266 __t268 = {.m = m_1604};
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t278;
            bool __ps_279 = (ok___spec__bool_tur_adt_Result__int__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_279) {
                __t278 = INT64_C(100);
            } else {
            ...
            __v = (int64_t)(intptr_t)(__t278); __pc = __k->tag; break;
           } else {
            tur_handler_node *__b280 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b280->parent = tur_handler_chain; tur_handler_chain = __b280;
            tur_cont *__n280 = (tur_cont*)malloc(sizeof(tur_cont));
            __n280->tag = 3; __n280->boundary = __b280; __n280->next = __k;
            __n280->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc, sizeof(tur_adt_Result__int__int)); __n280->saved[0] = (int64_t)(intptr_t)__ab; }
            __n280->saved[1] = (int64_t)(intptr_t)(n);
            __n280->saved[2] = (int64_t)(intptr_t)(__t276);
            __n280->saved[3] = (int64_t)(intptr_t)(__t277);
            __k = __n280; __pc = 2; break;
           }
          }
          case 2: {
           tur_adt_Result__int__int __ra281_0 = (acc);
           int64_t __ra281_1 = ((n) - (INT64_C(1)));
           acc = __ra281_0;
           n = __ra281_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           __t276 = (int64_t)(intptr_t)(__k->saved[2]);
           __t277 = (int64_t)(intptr_t)(__k->saved[3]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box280;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp280 = global_panic_payload; global_panic_payload = 0; __box280 = tur_box_err((int64_t)(intptr_t)__pp280); }
           else { __box280 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box280);
           (void)(__box280);
           int64_t __t282;
           bool __ps_283 = (ok___spec__bool_tur_adt_Result__int__int(acc));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_283) {
               __t282 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t282)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_284 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_285 = (step(__ps_284, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_285));
        tur_adt_Result__int__int __ps_286 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_287 = (step(__ps_286, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_287));
        int64_t __t288;
        __t288 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_289 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_290 = (vec_new__spec__tur_adt_Vec__int__());
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_292 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_293 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_293;
}
