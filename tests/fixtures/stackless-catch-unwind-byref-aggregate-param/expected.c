...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t3) {
            ...
            *(void (**)(void *))__t7 = 0;
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_827;
            void *__t8 = __t6;
            ...
            case 1: {
                ...
                bool __t16 = 0;
                {
                    ...
                    case 1: {
                        ...
                        bool __ps_17 = (__inst_Eq_eq_qu_int(vx_904, vy_905));
                        if (tur_panicking) return ((bool)0);
                        __t16 = __ps_17;
                        break;
                    }
            ...
            case 0: {
                ...
                bool __t20 = 0;
                {
                    ...
                    case 0: {
                        ...
                        bool __ps_21 = (__inst_Eq_eq_qu_int(vx_957, vy_958));
                        if (tur_panicking) return ((bool)0);
                        __t20 = __ps_21;
                        break;
                    }
            ...
            case 1: {
                ...
                bool __t22 = 0;
                {
                    ...
                    case 1: {
                        ...
                        bool __ps_23 = (__inst_Eq_eq_qu_int(ex_960, ey_962));
                        if (tur_panicking) return ((bool)0);
                        __t22 = __ps_23;
                        break;
                    }
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t30;
        {
            ...
            if ((t1_1104) == (INT64_C(0))) {
                __t31 = (t2_1105) == (INT64_C(0));
            } else {
                bool __t32;
                if ((t2_1105) == (INT64_C(0))) {
                    __t32 = false;
                } else {
                    bool __ps_33 = (cons_hyeq_hygo(t1_1104, t2_1105));
                    if (tur_panicking) return ((bool)0);
                    __t32 = __ps_33;
                }
                __t31 = __t32;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t36) {
            ...
            *(void (**)(void *))__t41 = 0;
            ...
            __t40[1] = (int64_t)(intptr_t)__fn_1240;
            void *__t42 = __t40;
...
static int64_t __fn_1435(void * __env_p_1438) {
        ...
        int64_t __ps_44 = (step(__env___env_1437->acc, (__env___env_1437->n) - (INT64_C(1))));
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_76 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_814, (void *)(intptr_t)(k_815), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t78;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_819 = __ps_80;
            (void)iter_819;
            void * __ps_81 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_82 = (hamt_slkeyeq((void *)(intptr_t)(__ps_81)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_820 = __ps_82;
            (void)keyeq_820;
            void * __ps_83 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_84 = (map_hyeq_hyloop((void *)(intptr_t)(iter_819), (void *)(intptr_t)(__ps_83), (void *)(intptr_t)(keyeq_820), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_821 = __ps_84;
            (void)result_821;
        ...
        if (__ps_103) {
            bool __t104;
            {
                ...
                if ((t1_1099) == (INT64_C(0))) {
                    __t105 = (t2_1100) == (INT64_C(0));
                } else {
                    bool __t106;
                    if ((t2_1100) == (INT64_C(0))) {
                        __t106 = false;
                    } else {
                        bool __ps_107 = (cons_hyeq_hygo(t1_1099, t2_1100));
                        if (tur_panicking) return ((bool)0);
                        __t106 = __ps_107;
                    }
                    __t105 = __t106;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1115 = (int64_t)(intptr_t)(__ps_118);
                (void)out_1115;
                __t114 = out_1115;
            }
            __t112 = __t114;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_125;
            (void)iter_1190;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_127;
            (void)keyeq_1191;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_129;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_152;
                (void)_un_unv_1320;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t156;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_157;
            (void)r_1370;
            int64_t __t158;
            bool __ps_159 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_159) {
                int64_t __ps_160 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t158 = __ps_160;
            } else {
                int64_t __ps_161 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
