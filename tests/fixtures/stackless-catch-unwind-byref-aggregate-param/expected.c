...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t157;
        {
            ...
            {
                tur_adt_Vec__int * __ps_159 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1321));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1322 = __ps_159;
                (void)_un_unv_1322;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t163;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1372 = __ps_164;
            (void)r_1372;
            int64_t __t165;
            bool __ps_166 = (schema_hydecode_hyok_qu(r_1372));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_166) {
                int64_t __ps_167 = (schema_hydecode_hyvalue(r_1372));
                if (tur_panicking) return ((int64_t)0);
                __t165 = __ps_167;
            } else {
                int64_t __ps_168 = (schema_hydecode_hyerrors(r_1372));
                if (tur_panicking) return ((int64_t)0);
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t182;
            bool __ps_183 = (ok___spec__bool_tur_adt_Result__int__int(acc));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_183) {
                __t182 = INT64_C(100);
            } else {
            ...
            tur_handler_node *__b184 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b184->parent = tur_handler_chain; tur_handler_chain = __b184;
            tur_cont *__n184 = (tur_cont*)malloc(sizeof(tur_cont));
            __n184->tag = 3; __n184->boundary = __b184; __n184->next = __k;
            __n184->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc, sizeof(tur_adt_Result__int__int)); __n184->saved[0] = (int64_t)(intptr_t)__ab; }
            __n184->saved[1] = (int64_t)(intptr_t)(n);
            __n184->saved[2] = (int64_t)(intptr_t)(__t180);
            __n184->saved[3] = (int64_t)(intptr_t)(__t181);
            __k = __n184; __pc = 2; break;
           }
          }
          case 2: {
           tur_adt_Result__int__int __ra185_0 = (acc);
           int64_t __ra185_1 = ((n) - (INT64_C(1)));
           acc = __ra185_0;
           n = __ra185_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           __t180 = (int64_t)(intptr_t)(__k->saved[2]);
           __t181 = (int64_t)(intptr_t)(__k->saved[3]);
           ...
           __v = (int64_t)(intptr_t)((n) + (__t186)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Result__int__int __ps_188 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_189 = (step(__ps_188, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        tur_adt_Result__int__int __ps_190 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_191 = (step(__ps_190, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_191));
        int64_t __t192;
        __t192 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_193 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        tur_adt_Result__int__int __ps_196 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        tur_adt_Result__int__int __ps_197 = (ctor_Result_Err__int__int(e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_197;
}
