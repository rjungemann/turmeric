...
static int64_t __fn_1282(void * __env_p_1285) {
        ...
        tur_adt_Result__int__int __t40 = __env___env_1284->acc;
        __auto_type __ps_41 = (step(&__t40, (__env___env_1284->n) - (INT64_C(1))));
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t157;
            __auto_type __ps_158 = (ok_qu((int64_t)(intptr_t)(acc)));
            if (tur_panicking) return (int64_t){0};
            if (__ps_158) {
                __t157 = INT64_C(100);
            } else {
            ...
            __v = (int64_t)(intptr_t)(__t157); __pc = __k->tag; break;
           } else {
            tur_handler_node *__b159 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b159->parent = tur_handler_chain; tur_handler_chain = __b159;
            tur_cont *__n159 = (tur_cont*)malloc(sizeof(tur_cont));
            __n159->tag = 3; __n159->boundary = __b159; __n159->next = __k;
            __n159->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, acc, sizeof(tur_adt_Result__int__int)); __n159->saved[0] = (int64_t)(intptr_t)__ab; }
            __n159->saved[1] = (int64_t)(intptr_t)(n);
            __n159->saved[2] = (int64_t)(intptr_t)(__t155);
            __n159->saved[3] = (int64_t)(intptr_t)(__t156);
            __k = __n159; __pc = 2; break;
           }
          }
          case 2: {
           __auto_type __ra160_0 = (acc);
           __auto_type __ra160_1 = ((n) - (INT64_C(1)));
           memmove(&acc__agg, __ra160_0, sizeof(tur_adt_Result__int__int)); acc = &acc__agg;
           n = __ra160_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           int64_t __box159;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp159 = global_panic_payload; global_panic_payload = 0; __box159 = tur_box_err((int64_t)(intptr_t)__pp159); }
           else { __box159 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box159);
           (void)(__box159);
           int64_t __t161;
           __auto_type __ps_162 = (ok_qu((int64_t)(intptr_t)(acc)));
           if (tur_panicking) return (int64_t){0};
           if (__ps_162) {
               __t161 = INT64_C(1);
           } else {
           ...
           __v = (int64_t)(intptr_t)((n) + (__t161)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_163 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t164 = __ps_163;
        __auto_type __ps_165 = (step(&__t164, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_165));
        __auto_type __ps_166 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Result__int__int __t167 = __ps_166;
        __auto_type __ps_168 = (step(&__t167, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_168));
        int64_t __t169;
        __t169 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_170 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_171 = (vec_new__spec__tur_adt_Vec__int__());
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
        __auto_type __ps_172 = (ctor_Result__int__int(true, x, (int64_t){0}));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
        __auto_type __ps_173 = (ctor_Result__int__int(false, (int64_t){0}, e));
        if (tur_panicking) return (tur_adt_Result__int__int){0};
        return __ps_173;
}
