...
static int64_t vec_pop_(void *);
static void vec_free(void *);
...
static int64_t vec_pop_(void * v) {
        struct { int64_t *data; size_t len; size_t cap; } *vec = (void*)v;
  if (vec->len == 0) {
...
int main() {
        int64_t __t0;
        {
            void * v_221 = vec_new();
            (void)v_221;
            printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(v_221))));
            vec_push_((void *)(intptr_t)(v_221), INT64_C(10));
            vec_push_((void *)(intptr_t)(v_221), INT64_C(20));
            printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(v_221))));
            printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(v_221), INT64_C(0))));
            printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(v_221), INT64_C(1))));
            printf("%lld\n", (long long)(vec_pop_((void *)(intptr_t)(v_221))));
            printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(v_221))));
            vec_free((void *)(intptr_t)(v_221));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
