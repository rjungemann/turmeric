...
int main() {
        int64_t __t0;
        {
            void * v_209 = vec_new();
            (void)v_209;
            printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(v_209))));
            vec_push_((void *)(intptr_t)(v_209), INT64_C(10));
            vec_push_((void *)(intptr_t)(v_209), INT64_C(20));
            printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(v_209))));
            printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(v_209), INT64_C(0))));
            printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(v_209), INT64_C(1))));
            printf("%lld\n", (long long)(vec_pop_((void *)(intptr_t)(v_209))));
            printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(v_209))));
            vec_free((void *)(intptr_t)(v_209));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
