...
static int64_t __inst_Parity_is_hyeven_P(int64_t, int64_t);
static int64_t __inst_Parity_is_hyodd_P(int64_t, int64_t);
...
static int64_t __inst_Parity_is_hyeven_P(int64_t self, int64_t n) {
        int64_t __t20;
        if ((n) == (INT64_C(0))) {
            __t20 = INT64_C(1);
        } else {
            __t20 = __inst_Parity_is_hyodd_P(self, (n) - (INT64_C(1)));
        }
        return __t20;
}

static int64_t __inst_Parity_is_hyodd_P(int64_t self, int64_t n) {
        int64_t __t21;
        if ((n) == (INT64_C(0))) {
            __t21 = INT64_C(0);
        } else {
            __t21 = __inst_Parity_is_hyeven_P(self, (n) - (INT64_C(1)));
        }
        return __t21;
}

typedef struct dict_Parity_P {
    int64_t (*is_hyeven)(int64_t, int64_t);
    int64_t (*is_hyodd)(int64_t, int64_t);
} dict_Parity_P;

static dict_Parity_P dict_Parity_P_singleton = {
    .is_hyeven = __inst_Parity_is_hyeven_P,
    .is_hyodd = __inst_Parity_is_hyodd_P,
};
...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_902 = (int64_t)(INT64_C(0));
            (void)w_902;
            int64_t p_903 = (int64_t)(INT64_C(0));
            (void)p_903;
            printf("%lld\n", (long long)(__inst_HasN_twice_ArrW(w_902, INT64_C(41))));
            printf("%lld\n", (long long)(__inst_Parity_is_hyeven_P(p_903, INT64_C(10))));
            printf("%lld\n", (long long)(__inst_Parity_is_hyeven_P(p_903, INT64_C(7))));
        }
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
