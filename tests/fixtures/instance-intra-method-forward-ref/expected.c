...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_891 = (int64_t)(INT64_C(0));
            (void)w_891;
            int64_t p_892 = (int64_t)(INT64_C(0));
            (void)p_892;
            printf("%lld\n", (long long)(__inst_HasN_twice_ArrW(w_891, INT64_C(41))));
            printf("%lld\n", (long long)(__inst_Parity_is_even_P(p_892, INT64_C(10))));
            printf("%lld\n", (long long)(__inst_Parity_is_even_P(p_892, INT64_C(7))));
        }
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
