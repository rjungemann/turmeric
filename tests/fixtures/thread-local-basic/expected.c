...
int main() {
        {
            ...
            (void)a1_36;
            {
                ...
                (void)a2_37;
                {
                    void * t1_38 = thread_spawn((void *)(intptr_t)(a1_36));
                    (void)t1_38;
                    {
                        void * t2_39 = thread_spawn((void *)(intptr_t)(a2_37));
                        (void)t2_39;
                        thread_join((void *)(intptr_t)(t1_38));
                        thread_join((void *)(intptr_t)(t2_39));
                    }
                }
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a1_36))));
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a2_37))));
                targ_free((void *)(intptr_t)(a1_36));
                targ_free((void *)(intptr_t)(a2_37));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
