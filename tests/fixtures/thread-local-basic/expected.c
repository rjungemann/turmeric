...
int main() {
        {
            void * a1_276 = targ_new(INT64_C(7));
            (void)a1_276;
            {
                void * a2_277 = targ_new(INT64_C(13));
                (void)a2_277;
                {
                    void * t1_278 = thread_spawn((void *)(intptr_t)(a1_276));
                    (void)t1_278;
                    {
                        void * t2_279 = thread_spawn((void *)(intptr_t)(a2_277));
                        (void)t2_279;
                        thread_join((void *)(intptr_t)(t1_278));
                        thread_join((void *)(intptr_t)(t2_279));
                    }
                }
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a1_276))));
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a2_277))));
                targ_free((void *)(intptr_t)(a1_276));
                targ_free((void *)(intptr_t)(a2_277));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
