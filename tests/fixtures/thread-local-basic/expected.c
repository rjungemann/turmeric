...
int main() {
        {
            void * a1_211 = targ_new(INT64_C(7));
            (void)a1_211;
            {
                void * a2_212 = targ_new(INT64_C(13));
                (void)a2_212;
                {
                    void * t1_213 = thread_spawn((void *)(intptr_t)(a1_211));
                    (void)t1_213;
                    {
                        void * t2_214 = thread_spawn((void *)(intptr_t)(a2_212));
                        (void)t2_214;
                        thread_join((void *)(intptr_t)(t1_213));
                        thread_join((void *)(intptr_t)(t2_214));
                    }
                }
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a1_211))));
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a2_212))));
                targ_free((void *)(intptr_t)(a1_211));
                targ_free((void *)(intptr_t)(a2_212));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
