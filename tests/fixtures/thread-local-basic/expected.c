...
static void * targ_new(int64_t id) {
...
int main() {
        {
            void * a1_631 = targ_new(INT64_C(7));
            (void)a1_631;
            {
                void * a2_632 = targ_new(INT64_C(13));
                (void)a2_632;
                {
                    void * t1_633 = thread_spawn((void *)(intptr_t)(a1_631));
                    (void)t1_633;
                    {
                        void * t2_634 = thread_spawn((void *)(intptr_t)(a2_632));
                        (void)t2_634;
                        thread_join((void *)(intptr_t)(t1_633));
                        thread_join((void *)(intptr_t)(t2_634));
                    }
                }
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a1_631))));
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a2_632))));
                targ_free((void *)(intptr_t)(a1_631));
                targ_free((void *)(intptr_t)(a2_632));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
