...
int main() {
        {
            void * a1_223 = targ_new(INT64_C(7));
            (void)a1_223;
            {
                void * a2_224 = targ_new(INT64_C(13));
                (void)a2_224;
                {
                    void * t1_225 = thread_spawn((void *)(intptr_t)(a1_223));
                    (void)t1_225;
                    {
                        void * t2_226 = thread_spawn((void *)(intptr_t)(a2_224));
                        (void)t2_226;
                        thread_join((void *)(intptr_t)(t1_225));
                        thread_join((void *)(intptr_t)(t2_226));
                    }
                }
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a1_223))));
                printf("%lld\n", (long long)(targ_result((void *)(intptr_t)(a2_224))));
                targ_free((void *)(intptr_t)(a1_223));
                targ_free((void *)(intptr_t)(a2_224));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
