...
int main() {
        {
            void *__t0 = (void *)tur_async_fiber((int64_t(*)(void))(intptr_t)compute_fail);
            void * fut_262 = __t0;
            (void)fut_262;
            {
                int64_t __t1 = tur_await_future((TurFuture*)(intptr_t)fut_262);
                int64_t result_263 = __t1;
                (void)result_263;
                if (((result_263) < (INT64_C(0)))) {
