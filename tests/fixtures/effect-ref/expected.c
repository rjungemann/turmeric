...
struct __defer_env_3 {void * base; };
...
static void __handle_body_9(void) {
    tur_current_fiber->result = (int64_t)sum_with_base();
}
...
static int64_t __dispatch_9(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "GetBase") == 0) {
...
static int64_t sum_with_base() {
        int64_t __t0;
        {
            ...
            *((int64_t *)__t1) = INT64_C(100);
            ...
            struct __defer_env_3 __t5 = {.base = base_616};
            tur_frame_push_defer(&__frame_2, __defer_4, &__t5);
            int64_t __t6;
            int64_t __t7 = *((int64_t *)base_616);
...
int main(int argc, char **argv) {
    ...
    __eff_frame_9.cases[0].effect_name = "GetBase";
