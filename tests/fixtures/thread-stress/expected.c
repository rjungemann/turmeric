...
int main() {
        {
            void * counter_238 = atomic_new(INT64_C(0));
            (void)counter_238;
            {
                void * handles_239 = spawn_all((void *)(intptr_t)(counter_238), INT64_C(100));
                (void)handles_239;
                join_all((void *)(intptr_t)(handles_239), INT64_C(100));
            }
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(counter_238))));
            atomic_free((void *)(intptr_t)(counter_238));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
