...
int main() {
        {
            void * counter_45 = atomic_new(INT64_C(0));
            (void)counter_45;
            {
                void * handles_46 = spawn_all((void *)(intptr_t)(counter_45), INT64_C(100));
                (void)handles_46;
                join_all((void *)(intptr_t)(handles_46), INT64_C(100));
            }
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(counter_45))));
            atomic_free((void *)(intptr_t)(counter_45));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
