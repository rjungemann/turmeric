...
int main() {
        {
            void * counter_220 = atomic_new(INT64_C(0));
            (void)counter_220;
            {
                void * handles_221 = spawn_all((void *)(intptr_t)(counter_220), INT64_C(100));
                (void)handles_221;
                join_all((void *)(intptr_t)(handles_221), INT64_C(100));
            }
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(counter_220))));
            atomic_free((void *)(intptr_t)(counter_220));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
