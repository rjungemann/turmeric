...
int main() {
        int64_t __t0;
        {
            ...
            (void)x_208;
            {
                ...
                (void)r1_209;
                {
                    int64_t __t1 = *((int64_t *)r1_209);
                    const void * r2_210 = &__t1;
                    (void)r2_210;
                    int64_t __t2 = *((int64_t *)r2_210);
                    printf("%lld\n", (long long)(__t2));
                }
            }
            {
                int64_t y_211 = INT64_C(20);
                (void)y_211;
                {
                    void * rm_212 = &y_211;
                    (void)rm_212;
                    {
                        int64_t __t3 = *((int64_t *)rm_212);
                        const void * r3_213 = &__t3;
                        (void)r3_213;
                        int64_t __t4 = *((int64_t *)r3_213);
                        printf("%lld\n", (long long)(__t4));
                    }
                }
            }
