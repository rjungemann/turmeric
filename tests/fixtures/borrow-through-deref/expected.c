...
int main() {
        int64_t __t0;
        {
            ...
            (void)x_196;
            {
                ...
                (void)r1_197;
                {
                    int64_t __t1 = *((int64_t *)r1_197);
                    const void * r2_198 = &__t1;
                    (void)r2_198;
                    int64_t __t2 = *((int64_t *)r2_198);
                    printf("%lld\n", (long long)(__t2));
                }
            }
            {
                int64_t y_199 = INT64_C(20);
                (void)y_199;
                {
                    void * rm_200 = &y_199;
                    (void)rm_200;
                    {
                        int64_t __t3 = *((int64_t *)rm_200);
                        const void * r3_201 = &__t3;
                        (void)r3_201;
                        int64_t __t4 = *((int64_t *)r3_201);
                        printf("%lld\n", (long long)(__t4));
                    }
                }
            }
