...
int main() {
        int64_t __t0;
        {
            ...
            (void)x_616;
            {
                ...
                (void)r1_617;
                {
                    int64_t __t1 = *((int64_t *)r1_617);
                    const void * r2_618 = &__t1;
                    (void)r2_618;
                    int64_t __t2 = *((int64_t *)r2_618);
                    printf("%lld\n", (long long)(__t2));
                }
            }
            {
                int64_t y_619 = INT64_C(20);
                (void)y_619;
                {
                    void * rm_620 = &y_619;
                    (void)rm_620;
                    {
                        int64_t __t3 = *((int64_t *)rm_620);
                        const void * r3_621 = &__t3;
                        (void)r3_621;
                        int64_t __t4 = *((int64_t *)r3_621);
                        printf("%lld\n", (long long)(__t4));
                    }
                }
            }
