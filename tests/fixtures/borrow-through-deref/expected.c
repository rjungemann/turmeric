...
int main() {
        int64_t __t0;
        {
            ...
            (void)x_261;
            {
                ...
                (void)r1_262;
                {
                    int64_t __t1 = *((int64_t *)r1_262);
                    const void * r2_263 = &__t1;
                    (void)r2_263;
                    int64_t __t2 = *((int64_t *)r2_263);
                    printf("%lld\n", (long long)(__t2));
                }
            }
            {
                int64_t y_264 = INT64_C(20);
                (void)y_264;
                {
                    void * rm_265 = &y_264;
                    (void)rm_265;
                    {
                        int64_t __t3 = *((int64_t *)rm_265);
                        const void * r3_266 = &__t3;
                        (void)r3_266;
                        int64_t __t4 = *((int64_t *)r3_266);
                        printf("%lld\n", (long long)(__t4));
                    }
                }
            }
