...
static int64_t __fn_287(void *, int64_t);
static int64_t __fn_297(void *, int64_t);
...
struct __env_289 { int64_t __fn; int64_t n; };
static int64_t __fn_287(void * __env_p_290, int64_t x) {
        struct __env_289 *__env___env_289 = (struct __env_289 *)__env_p_290;
        return ((x) + (__env___env_289->n));
}

struct __env_299 { int64_t __fn; int64_t a; int64_t b; };
static int64_t __fn_297(void * __env_p_300, int64_t x) {
        struct __env_299 *__env___env_299 = (struct __env_299 *)__env_p_300;
        return ((x) + (((__env___env_299->a) + (__env___env_299->b))));
}
...
int main() {
        {
            int64_t opt_280 = __opt_some(INT64_C(10));
            (void)opt_280;
            {
                int64_t result_281 = __fmap_option(opt_280, (int64_t)(intptr_t)(__add5));
                (void)result_281;
                puts((__opt_some_(result_281)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_281)));
            }
        }
        {
            int64_t opt2_282 = __opt_some(INT64_C(7));
            (void)opt2_282;
            {
                int64_t result2_283 = __fmap_option(opt2_282, (int64_t)(intptr_t)(__square));
                (void)result2_283;
                puts((__opt_some_(result2_283)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result2_283)));
            }
        }
        {
            int64_t n_284 = INT64_C(5);
            (void)n_284;
            {
                int64_t opt3_285 = __opt_some(INT64_C(10));
                (void)opt3_285;
                {
                    struct __env_289 *__t0 = (struct __env_289 *)malloc(sizeof(struct __env_289));
                    __t0->__fn = (int64_t)(intptr_t)__fn_287;
                    __t0->n = n_284;
                    void *__t1 = __t0;
                    int64_t result3_292 = __fmap_option_clos(opt3_285, (int64_t)(intptr_t)(__t1));
                    (void)result3_292;
                    puts((__opt_some_(result3_292)) ? "true" : "false");
                    printf("%lld\n", (long long)(__opt_unwrap(result3_292)));
                }
            }
        }
        {
            int64_t a_293 = INT64_C(3);
            (void)a_293;
            {
                int64_t b_294 = INT64_C(4);
                (void)b_294;
                {
                    int64_t opt4_295 = __opt_some(INT64_C(10));
                    (void)opt4_295;
                    {
                        struct __env_299 *__t2 = (struct __env_299 *)malloc(sizeof(struct __env_299));
                        __t2->__fn = (int64_t)(intptr_t)__fn_297;
                        __t2->a = a_293;
                        __t2->b = b_294;
                        void *__t3 = __t2;
                        int64_t result4_302 = __fmap_option_clos(opt4_295, (int64_t)(intptr_t)(__t3));
                        (void)result4_302;
                        puts((__opt_some_(result4_302)) ? "true" : "false");
                        printf("%lld\n", (long long)(__opt_unwrap(result4_302)));
                    }
                }
            }
        }
