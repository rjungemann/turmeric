...
static int64_t __fn_642(void *, int64_t);
static int64_t __fn_652(void *, int64_t);
...
static int64_t __fmap_option_clos(int64_t, int64_t);
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_489));
}
...
struct __env_644 { int64_t __fn; int64_t n; };
static int64_t __fn_642(void * __env_p_645, int64_t x) {
        struct __env_644 *__env___env_644 = (struct __env_644 *)__env_p_645;
        return ((x) + (__env___env_644->n));
}

struct __env_654 { int64_t __fn; int64_t a; int64_t b; };
static int64_t __fn_652(void * __env_p_655, int64_t x) {
        struct __env_654 *__env___env_654 = (struct __env_654 *)__env_p_655;
        return ((x) + (((__env___env_654->a) + (__env___env_654->b))));
}
...
static int64_t __fmap_option_clos(int64_t container, int64_t fn) {
...
int main() {
        {
            int64_t opt_635 = __opt_some(INT64_C(10));
            (void)opt_635;
            {
                int64_t result_636 = __fmap_option(opt_635, (int64_t)(intptr_t)(__add5));
                (void)result_636;
                puts((__opt_some_(result_636)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_636)));
            }
        }
        {
            int64_t opt2_637 = __opt_some(INT64_C(7));
            (void)opt2_637;
            {
                int64_t result2_638 = __fmap_option(opt2_637, (int64_t)(intptr_t)(__square));
                (void)result2_638;
                puts((__opt_some_(result2_638)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result2_638)));
            }
        }
        {
            int64_t n_639 = INT64_C(5);
            (void)n_639;
            {
                int64_t opt3_640 = __opt_some(INT64_C(10));
                (void)opt3_640;
                {
                    struct __env_644 *__t0 = (struct __env_644 *)malloc(sizeof(struct __env_644));
                    __t0->__fn = (int64_t)(intptr_t)__fn_642;
                    __t0->n = n_639;
                    void *__t1 = __t0;
                    int64_t result3_647 = __fmap_option_clos(opt3_640, (int64_t)(intptr_t)(__t1));
                    (void)result3_647;
                    puts((__opt_some_(result3_647)) ? "true" : "false");
                    printf("%lld\n", (long long)(__opt_unwrap(result3_647)));
                }
            }
        }
        {
            int64_t a_648 = INT64_C(3);
            (void)a_648;
            {
                int64_t b_649 = INT64_C(4);
                (void)b_649;
                {
                    int64_t opt4_650 = __opt_some(INT64_C(10));
                    (void)opt4_650;
                    {
                        struct __env_654 *__t2 = (struct __env_654 *)malloc(sizeof(struct __env_654));
                        __t2->__fn = (int64_t)(intptr_t)__fn_652;
                        __t2->a = a_648;
                        __t2->b = b_649;
                        void *__t3 = __t2;
                        int64_t result4_657 = __fmap_option_clos(opt4_650, (int64_t)(intptr_t)(__t3));
                        (void)result4_657;
                        puts((__opt_some_(result4_657)) ? "true" : "false");
                        printf("%lld\n", (long long)(__opt_unwrap(result4_657)));
                    }
                }
            }
        }
