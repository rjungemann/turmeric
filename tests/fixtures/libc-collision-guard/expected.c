...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_830 = __ps_72;
        bool __ps_73 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_829, (void *)(intptr_t)(k_830), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_73;
        if (__t1) {
            int64_t __ps_74 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_75 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_829, (void *)(intptr_t)(k_830), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t77;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_834 = __ps_79;
            (void)iter_834;
            void * __ps_80 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_81 = (hamt_slkeyeq((void *)(intptr_t)(__ps_80)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_835 = __ps_81;
            (void)keyeq_835;
            void * __ps_82 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_83 = (map_hyeq_hyloop((void *)(intptr_t)(iter_834), (void *)(intptr_t)(__ps_82), (void *)(intptr_t)(keyeq_835), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_836 = __ps_83;
            (void)result_836;
        ...
        if (__ps_102) {
            bool __t103;
            {
                ...
                if ((t1_1114) == (INT64_C(0))) {
                    __t104 = (t2_1115) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_1115) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1114, t2_1115));
                        if (tur_panicking) return ((bool)0);
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1130 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1130;
                __t113 = out_1130;
            }
            __t111 = __t113;
        ...
        if (__ps_122) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1201 = __ps_123;
                (void)h_1201;
                void * __ps_124 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1202 = __ps_124;
                (void)k_1202;
                bool __ps_125 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1201, (void *)(intptr_t)(k_1202), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_125) {
                    void * __t126 = iter;
                    void * __t127 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t129;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1205 = __ps_131;
            (void)iter_1205;
            void * __ps_132 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_133 = (hamt_slkeyeq((void *)(intptr_t)(__ps_132)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1206 = __ps_133;
            (void)keyeq_1206;
            void * __ps_134 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_135 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1205), (void *)(intptr_t)(__ps_134), (void *)(intptr_t)(keyeq_1206)));
            if (tur_panicking) return ((bool)0);
            bool result_1207 = __ps_135;
            (void)result_1207;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t156;
        {
            ...
            {
                tur_adt_Vec__int * __ps_158 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1335));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1336 = __ps_158;
                (void)_un_unv_1336;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t162;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1386 = __ps_163;
            (void)r_1386;
            int64_t __t164;
            bool __ps_165 = (schema_hydecode_hyok_qu(r_1386));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_165) {
                int64_t __ps_166 = (schema_hydecode_hyvalue(r_1386));
                if (tur_panicking) return ((int64_t)0);
                __t164 = __ps_166;
            } else {
                int64_t __ps_167 = (schema_hydecode_hyerrors(r_1386));
                if (tur_panicking) return ((int64_t)0);
