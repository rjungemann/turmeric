...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_828, (void *)(intptr_t)(k_829), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_833 = __ps_75;
            (void)iter_833;
            void * __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_834 = __ps_77;
            (void)keyeq_834;
            void * __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_833), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_834), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_835 = __ps_79;
            (void)result_835;
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                if ((t1_1113) == (INT64_C(0))) {
                    __t100 = (t2_1114) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_1114) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        bool __ps_102 = (cons_hyeq_hygo(t1_1113, t2_1114));
                        if (tur_panicking) return ((bool)0);
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1129 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1129;
                __t109 = out_1129;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1204 = __ps_120;
            (void)iter_1204;
            void * __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1205 = __ps_122;
            (void)keyeq_1205;
            void * __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1204), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1205)));
            if (tur_panicking) return ((bool)0);
            bool result_1206 = __ps_124;
            (void)result_1206;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                tur_adt_Vec__int * __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1333));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1334 = __ps_147;
                (void)_un_unv_1334;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1384 = __ps_152;
            (void)r_1384;
            int64_t __t153;
            bool __ps_154 = (schema_hydecode_hyok_qu(r_1384));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_154) {
                int64_t __ps_155 = (schema_hydecode_hyvalue(r_1384));
                if (tur_panicking) return ((int64_t)0);
                __t153 = __ps_155;
            } else {
                int64_t __ps_156 = (schema_hydecode_hyerrors(r_1384));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_168 = (tur_u_div(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_168));
        double __ps_169 = (tur_u_ldiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_169));
        double __ps_170 = (tur_u_lldiv(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_170));
        double __ps_171 = (tur_u_llabs(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_171));
        double __ps_172 = (tur_u_atexit(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_172));
        double __ps_173 = (tur_u_putchar(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_173));
        double __ps_174 = (tur_u_getchar(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_174));
        double __ps_175 = (tur_u_gets(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_175));
        double __ps_176 = (tur_u_chown(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_176));
        double __ps_177 = (tur_u_execl(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_177));
        double __ps_178 = (tur_u_drand48(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_178));
        double __ps_179 = (tur_u_erand48(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_179));
        double __ps_180 = (tur_u_read(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_180));
        double __ps_181 = (tur_u_write(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_181));
        double __ps_182 = (tur_u_time(7.1, 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_182));
        int64_t __t183;
        __t183 = INT64_C(0);
