...
int main() {
        int64_t __t0;
        {
            void * m_616 = map_new();
            (void)m_616;
            printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m_616))));
            int64_t __t1;
            int64_t __t2;
            {
                void * m2_617 = hamt_set((void *)(intptr_t)(m_616), hamt_hash_ptr("key1"), "key1", "value1");
                (void)m2_617;
                printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m2_617))));
                puts((hamt_has_((void *)(intptr_t)(m2_617), hamt_hash_ptr("key1"), "key1")) ? "true" : "false");
                int64_t __t3;
                int64_t __t4;
                {
                    void * m3_618 = hamt_set((void *)(intptr_t)(m2_617), hamt_hash_ptr("key2"), "key2", "value2");
                    (void)m3_618;
                    printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m3_618))));
                    int64_t __t5;
                    int64_t __t6;
                    {
                        void * m4_619 = hamt_del((void *)(intptr_t)(m3_618), hamt_hash_ptr("key1"), "key1");
                        (void)m4_619;
                        printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m4_619))));
                        puts((hamt_has_((void *)(intptr_t)(m4_619), hamt_hash_ptr("key1"), "key1")) ? "true" : "false");
                        puts((hamt_has_((void *)(intptr_t)(m4_619), hamt_hash_ptr("key2"), "key2")) ? "true" : "false");
                        int64_t __t7;
                        __t7 = INT64_C(0);
                        __t6 = __t7;
                    }
