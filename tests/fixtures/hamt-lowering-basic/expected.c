...
int main() {
        int64_t __t0;
        {
            void * m_208 = map_new();
            (void)m_208;
            printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m_208))));
            int64_t __t1;
            int64_t __t2;
            {
                void * m2_209 = hamt_set((void *)(intptr_t)(m_208), hamt_hash_ptr("key1"), "key1", "value1");
                (void)m2_209;
                printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m2_209))));
                puts((hamt_has_((void *)(intptr_t)(m2_209), hamt_hash_ptr("key1"), "key1")) ? "true" : "false");
                int64_t __t3;
                int64_t __t4;
                {
                    void * m3_210 = hamt_set((void *)(intptr_t)(m2_209), hamt_hash_ptr("key2"), "key2", "value2");
                    (void)m3_210;
                    printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m3_210))));
                    int64_t __t5;
                    int64_t __t6;
                    {
                        void * m4_211 = hamt_del((void *)(intptr_t)(m3_210), hamt_hash_ptr("key1"), "key1");
                        (void)m4_211;
                        printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m4_211))));
                        puts((hamt_has_((void *)(intptr_t)(m4_211), hamt_hash_ptr("key1"), "key1")) ? "true" : "false");
                        puts((hamt_has_((void *)(intptr_t)(m4_211), hamt_hash_ptr("key2"), "key2")) ? "true" : "false");
                        int64_t __t7;
                        __t7 = INT64_C(0);
                        __t6 = __t7;
                    }
