...
extern void * hamt_new();
extern void hamt_free(void *);
extern void * hamt_retain(void *);
extern int64_t hamt_count(void *);
extern void * hamt_set(void *, int64_t, void *, void *);
extern void * hamt_del(void *, int64_t, void *);
extern bool hamt_has(void *, int64_t, void *);
extern void * hamt_get(void *, int64_t, void *);
extern void * hamt_merge(void *, void *);
extern int64_t hamt_hash_str(const char *);
extern int64_t hamt_hash_ptr(void *);
...
static void hamt_free(void * m) {
        hamt_free((void *)(intptr_t)(m));
}

static void * hamt_retain(void * m) {
        return hamt_retain((void *)(intptr_t)(m));
}

static void * hamt_set(void * m, int64_t hash, void * key, void * val) {
        return hamt_set((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key), (void *)(intptr_t)(val));
}

static void * hamt_del(void * m, int64_t hash, void * key) {
        return hamt_del((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key));
}

static void * hamt_get(void * m, int64_t hash, void * key) {
        return hamt_get((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key));
}

static bool hamt_has_(void * m, int64_t hash, void * key) {
        return hamt_has((void *)(intptr_t)(m), hash, (void *)(intptr_t)(key));
}
...
int main() {
        int64_t __t0;
        {
            ...
            int64_t __t1;
            {
                void * (*m2)(void *, int64_t, void *, void *) = hamt_set((void *)(intptr_t)(m_98), (int64_t)(intptr_t)(hamt_hash_ptr("key1")), "key1", "value1");
                (void)m2;
                int64_t __t2;
                {
                    void * (*val)(void *, int64_t, void *) = hamt_get((void *)(intptr_t)(m2), (int64_t)(intptr_t)(hamt_hash_ptr("key1")), "key1");
                    (void)val;
                    int64_t __t3;
                    {
                        void * (*m3)(void *, int64_t, void *) = hamt_del((void *)(intptr_t)(m2), (int64_t)(intptr_t)(hamt_hash_ptr("key1")), "key1");
                        (void)m3;
                        int64_t __t4;
                        {
                            int64_t (*c)(void *) = hamt_count((void *)(intptr_t)(m3));
                            (void)c;
                            __t4 = c;
                        }
                        __t3 = __t4;
