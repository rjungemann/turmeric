...
int main() {
        int64_t __t0;
        {
            void * m_196 = map_new();
            (void)m_196;
            printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m_196))));
            int64_t __t1;
            int64_t __t2;
            {
                void * m2_197 = hamt_set((void *)(intptr_t)(m_196), hamt_hash_ptr("key1"), "key1", "value1");
                (void)m2_197;
                printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m2_197))));
                puts((hamt_has_((void *)(intptr_t)(m2_197), hamt_hash_ptr("key1"), "key1")) ? "true" : "false");
                int64_t __t3;
                int64_t __t4;
                {
                    void * m3_198 = hamt_set((void *)(intptr_t)(m2_197), hamt_hash_ptr("key2"), "key2", "value2");
                    (void)m3_198;
                    printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m3_198))));
                    int64_t __t5;
                    int64_t __t6;
                    {
                        void * m4_199 = hamt_del((void *)(intptr_t)(m3_198), hamt_hash_ptr("key1"), "key1");
                        (void)m4_199;
                        printf("%lld\n", (long long)(hamt_count((void *)(intptr_t)(m4_199))));
                        puts((hamt_has_((void *)(intptr_t)(m4_199), hamt_hash_ptr("key1"), "key1")) ? "true" : "false");
                        puts((hamt_has_((void *)(intptr_t)(m4_199), hamt_hash_ptr("key2"), "key2")) ? "true" : "false");
                        int64_t __t7;
                        __t7 = INT64_C(0);
                        __t6 = __t7;
                    }
