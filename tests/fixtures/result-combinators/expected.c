...
static void * u_result_map(void *, void *);
static void * u_result_map_err(void *, void *);
static void * u_result_flat_map(void *, void *);
static void * u_result_or(void *, void *);
static void * u_result_or_else(void *, void *);
static int64_t double_it(int64_t);
static int64_t negate(int64_t);
static void * safe_double(int64_t);
...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_451));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_471));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_498));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_518), (int64_t)(intptr_t)(__fn_522));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_538), (int64_t)(intptr_t)(__fn_542));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_558));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_629));
}
...
static void * u_result_map(void * r, void * f) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
  if (res == NULL || !res->is_ok) return r;
  int64_t new_val = ((int64_t (*)(int64_t))f)(res->ok_val);
  struct { bool is_ok; int64_t ok_val; int64_t err_val; } *out = malloc(sizeof(*out));
...
static void * u_result_map_err(void * r, void * f) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
  if (res == NULL || res->is_ok) return r;
  int64_t new_err = ((int64_t (*)(int64_t))f)(res->err_val);
  struct { bool is_ok; int64_t ok_val; int64_t err_val; } *out = malloc(sizeof(*out));
...
static void * u_result_flat_map(void * r, void * f) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
  if (res == NULL || !res->is_ok) return r;
  return (void *)((int64_t (*)(int64_t))f)(res->ok_val);
...
static void * u_result_or(void * r, void * alt) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
  if (res != NULL && res->is_ok) return r; return alt;
  
}

static void * u_result_or_else(void * r, void * f) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
  if (res != NULL && res->is_ok) return r;
  int64_t ev = res ? res->err_val : 0;
  return (void *)((int64_t (*)(int64_t))f)(ev);
...
static int64_t double_it(int64_t n) {
        return ((n) * (INT64_C(2)));
}

static int64_t negate(int64_t n) {
        return ((INT64_C(0)) - (n));
}

static void * safe_double(int64_t n) {
        return u_ok(((n) * (INT64_C(2))));
}

int main() {
        printf("%lld\n", (long long)(u_ok_val((void *)(intptr_t)(u_result_map((void *)(intptr_t)(u_ok(INT64_C(5))), (void *)(intptr_t)(double_it))))));
        puts((u_err_((void *)(intptr_t)(u_result_map((void *)(intptr_t)(u_err(INT64_C(3))), (void *)(intptr_t)(double_it))))) ? "true" : "false");
        printf("%lld\n", (long long)(u_err_val((void *)(intptr_t)(u_result_map_err((void *)(intptr_t)(u_err(INT64_C(4))), (void *)(intptr_t)(negate))))));
        puts((u_ok_((void *)(intptr_t)(u_result_map_err((void *)(intptr_t)(u_ok(INT64_C(7))), (void *)(intptr_t)(negate))))) ? "true" : "false");
        printf("%lld\n", (long long)(u_ok_val((void *)(intptr_t)(u_result_flat_map((void *)(intptr_t)(u_ok(INT64_C(6))), (void *)(intptr_t)(safe_double))))));
        puts((u_err_((void *)(intptr_t)(u_result_flat_map((void *)(intptr_t)(u_err(INT64_C(9))), (void *)(intptr_t)(safe_double))))) ? "true" : "false");
        printf("%lld\n", (long long)(u_ok_val((void *)(intptr_t)(u_result_or((void *)(intptr_t)(u_ok(INT64_C(11))), (void *)(intptr_t)(u_ok(INT64_C(99))))))));
        printf("%lld\n", (long long)(u_ok_val((void *)(intptr_t)(u_result_or((void *)(intptr_t)(u_err(INT64_C(0))), (void *)(intptr_t)(u_ok(INT64_C(22))))))));
        printf("%lld\n", (long long)(u_ok_val((void *)(intptr_t)(u_result_or_else((void *)(intptr_t)(u_ok(INT64_C(33))), (void *)(intptr_t)(safe_double))))));
        printf("%lld\n", (long long)(u_ok_val((void *)(intptr_t)(u_result_or_else((void *)(intptr_t)(u_err(INT64_C(5))), (void *)(intptr_t)(safe_double))))));
        printf("%lld\n", (long long)(u_result_unwrap_or((void *)(intptr_t)(u_err(INT64_C(0))), INT64_C(77))));
        printf("%lld\n", (long long)(u_result_expect((void *)(intptr_t)(u_ok(INT64_C(42))), "no panic")));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
