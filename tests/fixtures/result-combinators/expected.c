...
static void * safe_double(int64_t n) {
        return ok(((n) * (INT64_C(2))));
}

int main() {
        printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(result_map((void *)(intptr_t)(ok(INT64_C(5))), (void *)(intptr_t)(double_it))))));
        puts((err_((void *)(intptr_t)(result_map((void *)(intptr_t)(err(INT64_C(3))), (void *)(intptr_t)(double_it))))) ? "true" : "false");
        printf("%lld\n", (long long)(err_val((void *)(intptr_t)(result_map_err((void *)(intptr_t)(err(INT64_C(4))), (void *)(intptr_t)(negate))))));
        puts((ok_((void *)(intptr_t)(result_map_err((void *)(intptr_t)(ok(INT64_C(7))), (void *)(intptr_t)(negate))))) ? "true" : "false");
        printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(result_flat_map((void *)(intptr_t)(ok(INT64_C(6))), (void *)(intptr_t)(safe_double))))));
        puts((err_((void *)(intptr_t)(result_flat_map((void *)(intptr_t)(err(INT64_C(9))), (void *)(intptr_t)(safe_double))))) ? "true" : "false");
        printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(result_or((void *)(intptr_t)(ok(INT64_C(11))), (void *)(intptr_t)(ok(INT64_C(99))))))));
        printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(result_or((void *)(intptr_t)(err(INT64_C(0))), (void *)(intptr_t)(ok(INT64_C(22))))))));
        printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(result_or_else((void *)(intptr_t)(ok(INT64_C(33))), (void *)(intptr_t)(safe_double))))));
        printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(result_or_else((void *)(intptr_t)(err(INT64_C(5))), (void *)(intptr_t)(safe_double))))));
        printf("%lld\n", (long long)(result_unwrap_or((void *)(intptr_t)(err(INT64_C(0))), INT64_C(77))));
        printf("%lld\n", (long long)(result_expect((void *)(intptr_t)(ok(INT64_C(42))), "no panic")));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
