...
int main(int argc, char **argv) {
        ...
        {
            MutableMap__int__int * a_993 = mutmap_new__spec__MutableMap__int__int__();
            (void)a_993;
            mutmap_hyset_ex((int64_t)(intptr_t)(a_993), INT64_C(1), INT64_C(1), INT64_C(100));
            mutmap_hyset_ex((int64_t)(intptr_t)(a_993), INT64_C(2), INT64_C(2), INT64_C(200));
            mutmap_hyset_ex((int64_t)(intptr_t)(a_993), INT64_C(3), INT64_C(3), INT64_C(300));
            printf("%lld\n", (long long)(total(a_993)));
            printf("%lld\n", (long long)(mutmap_hylen((int64_t)(intptr_t)(a_993))));
            mutmap_hyfree((int64_t)(intptr_t)(a_993));
        }
        int64_t __t50;
        __t50 = INT64_C(0);
        return (int)__t50;
