...
static int64_t sum_hyvals(tur_adt_MutableMap__int__int * m, int64_t i, int64_t cap, int64_t acc) {
        ...
        if ((i) == (cap)) {
            ...
            bool __ps_168 = (mutmap_hyslot_hyoccupied_qu((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_168) {
                tur_adt_MutableMap__int__int * __t169 = m;
                int64_t __t170 = (i) + (INT64_C(1));
                int64_t __t171 = cap;
                int64_t __ps_172 = (mutmap_hyslot_hyvalue((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
                if (tur_panicking) return ((int64_t)0);
                int64_t __t173 = (acc) + (__ps_172);
                m = __t169;
                i = __t170;
                cap = __t171;
                acc = __t173;
...
static int64_t total(tur_adt_MutableMap__int__int * m) {
        int64_t __ps_178 = (mutmap_hycap((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m)))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_179 = (sum_hyvals((tur_adt_MutableMap__int__int *)(intptr_t)((int64_t)(intptr_t)(m)), INT64_C(0), __ps_178, INT64_C(0)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_179;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_MutableMap__int__int * __ps_180 = (mutmap_new__spec__tur_adt_MutableMap__int__int__());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_MutableMap__int__int * a_1439 = __ps_180;
            (void)a_1439;
            ...
            int64_t __ps_181 = (total((tur_adt_MutableMap__int__int *)(intptr_t)((int64_t)(intptr_t)(a_1439))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_181));
            int64_t __ps_182 = (mutmap_hylen((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1439)))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_182));
