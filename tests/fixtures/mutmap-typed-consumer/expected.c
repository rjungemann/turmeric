...
static int64_t sum_hyvals(tur_adt_MutableMap__int__int * m, int64_t i, int64_t cap, int64_t acc) {
        ...
        if ((i) == (cap)) {
            ...
            bool __ps_277 = (mutmap_hyslot_hyoccupied_qu((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_277) {
                tur_adt_MutableMap__int__int * __t278 = m;
                int64_t __t279 = (i) + (INT64_C(1));
                int64_t __t280 = cap;
                int64_t __ps_281 = (mutmap_hyslot_hyvalue((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
                if (tur_panicking) return ((int64_t)0);
                int64_t __t282 = (acc) + (__ps_281);
                m = __t278;
                i = __t279;
                cap = __t280;
                acc = __t282;
                ...
                tur_adt_MutableMap__int__int * __t283 = m;
                int64_t __t284 = (i) + (INT64_C(1));
                int64_t __t285 = cap;
                int64_t __t286 = acc;
                m = __t283;
                i = __t284;
...
static int64_t total(tur_adt_MutableMap__int__int * m) {
        int64_t __ps_287 = (mutmap_hycap((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m)))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_288 = (sum_hyvals((tur_adt_MutableMap__int__int *)(intptr_t)((int64_t)(intptr_t)(m)), INT64_C(0), __ps_287, INT64_C(0)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_288;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_MutableMap__int__int * __ps_289 = (mutmap_new__spec__tur_adt_MutableMap__int__int__());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_MutableMap__int__int * a_1613 = __ps_289;
            (void)a_1613;
            ...
            int64_t __ps_290 = (total((tur_adt_MutableMap__int__int *)(intptr_t)((int64_t)(intptr_t)(a_1613))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_290));
            int64_t __ps_291 = (mutmap_hylen((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1613)))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_291));
