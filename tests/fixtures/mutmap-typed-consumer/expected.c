...
static int64_t sum_hyvals(MutableMap__int__int * m, int64_t i, int64_t cap, int64_t acc) {
        ...
        if ((i) == (cap)) {
            ...
            if (mutmap_hyslot_hyoccupied_qu((int64_t)(intptr_t)(m), i)) {
                ...
                int64_t __t46 = cap;
                int64_t __t47 = (acc) + (mutmap_hyslot_hyvalue((int64_t)(intptr_t)(m), i));
                m = __t44;
                i = __t45;
                cap = __t46;
                acc = __t47;
...
int main(int argc, char **argv) {
        ...
        {
            MutableMap__int__int * a_1012 = mutmap_new__spec__MutableMap__int__int__();
            (void)a_1012;
            mutmap_hyset_ex((int64_t)(intptr_t)(a_1012), INT64_C(1), INT64_C(1), INT64_C(100));
            mutmap_hyset_ex((int64_t)(intptr_t)(a_1012), INT64_C(2), INT64_C(2), INT64_C(200));
            mutmap_hyset_ex((int64_t)(intptr_t)(a_1012), INT64_C(3), INT64_C(3), INT64_C(300));
            printf("%lld\n", (long long)(total(a_1012)));
            printf("%lld\n", (long long)(mutmap_hylen((int64_t)(intptr_t)(a_1012))));
            mutmap_hyfree((int64_t)(intptr_t)(a_1012));
        }
        int64_t __t52;
        __t52 = INT64_C(0);
        return (int)__t52;
