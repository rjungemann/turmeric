...
static int64_t sum_hyvals(MutableMap__int__int * m, int64_t i, int64_t cap, int64_t acc) {
        ...
        if ((i) == (cap)) {
            ...
            if (mutmap_hyslot_hyoccupied_qu((int64_t)(intptr_t)((int64_t)(intptr_t)(m)), i)) {
                MutableMap__int__int * __t50 = m;
                int64_t __t51 = (i) + (INT64_C(1));
                int64_t __t52 = cap;
                int64_t __t53 = (acc) + (mutmap_hyslot_hyvalue((int64_t)(intptr_t)((int64_t)(intptr_t)(m)), i));
                m = __t50;
                i = __t51;
                cap = __t52;
                acc = __t53;
...
int main(int argc, char **argv) {
        ...
        {
            MutableMap__int__int * a_1250 = mutmap_new__spec__MutableMap__int__int__();
            (void)a_1250;
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1250)), INT64_C(1), INT64_C(1), INT64_C(100));
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1250)), INT64_C(2), INT64_C(2), INT64_C(200));
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1250)), INT64_C(3), INT64_C(3), INT64_C(300));
            printf("%lld\n", (long long)(total(a_1250)));
            printf("%lld\n", (long long)(mutmap_hylen((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1250)))));
            mutmap_hyfree((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1250)));
        }
        int64_t __t58;
        __t58 = INT64_C(0);
        return (int)__t58;
