...
static int64_t sum_hyvals(tur_adt_MutableMap__int__int * m, int64_t i, int64_t cap, int64_t acc) {
        ...
        if ((i) == (cap)) {
            ...
            __auto_type __ps_153 = (mutmap_hyslot_hyoccupied_qu((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
            if (tur_panicking) return (int64_t){0};
            if (__ps_153) {
                tur_adt_MutableMap__int__int * __t154 = m;
                int64_t __t155 = (i) + (INT64_C(1));
                int64_t __t156 = cap;
                __auto_type __ps_157 = (mutmap_hyslot_hyvalue((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
                if (tur_panicking) return (int64_t){0};
                int64_t __t158 = (acc) + (__ps_157);
                m = __t154;
                i = __t155;
                cap = __t156;
                acc = __t158;
                ...
                tur_adt_MutableMap__int__int * __t159 = m;
                int64_t __t160 = (i) + (INT64_C(1));
                int64_t __t161 = cap;
                int64_t __t162 = acc;
                m = __t159;
                i = __t160;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            __auto_type __ps_165 = (mutmap_new__spec__tur_adt_MutableMap__int__int__());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_MutableMap__int__int * a_1286 = __ps_165;
            (void)a_1286;
