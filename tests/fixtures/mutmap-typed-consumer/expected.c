...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_MutableMap__int__int * a_1277 = __ps_185;
            (void)a_1277;
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1277))), INT64_C(1), INT64_C(1), INT64_C(100));
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1277))), INT64_C(2), INT64_C(2), INT64_C(200));
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1277))), INT64_C(3), INT64_C(3), INT64_C(300));
            __auto_type __ps_186 = (total((int64_t)(intptr_t)(a_1277)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_186));
            __auto_type __ps_187 = (mutmap_hylen((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1277)))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_187));
            mutmap_hyfree((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1277))));
        }
        int64_t __t188;
        __t188 = INT64_C(0);
        return (int)__t188;
