...
#endif
#ifndef TUR_TY_tur_adt_MutableMap__int__int
#define TUR_TY_tur_adt_MutableMap__int__int
#ifndef TUR_FWD_tur_adt_MutableMap__int__int
#define TUR_FWD_tur_adt_MutableMap__int__int
typedef struct tur_adt_MutableMap__int__int tur_adt_MutableMap__int__int;
#endif
struct tur_adt_MutableMap__int__int {
    void * storage;
};
#endif

#ifndef TUR_FN_tur_adt_MutableMap__int__int
#define TUR_FN_tur_adt_MutableMap__int__int
static tur_adt_MutableMap__int__int * ctor_MutableMap_MutableMap__int__int(void * _0) {
    tur_adt_MutableMap__int__int *__r = (tur_adt_MutableMap__int__int *)tur_region_alloc_or_malloc(sizeof(tur_adt_MutableMap__int__int));
    __r->storage = _0;
    return __r;
}
...
static int64_t sum_hyvals(tur_adt_MutableMap__int__int *, int64_t, int64_t, int64_t);
static int64_t total(tur_adt_MutableMap__int__int *);
...
static tur_adt_MutableMap__int__int * mutmap_new__spec__tur_adt_MutableMap__int__int__();
...
static void mutmap_hyset_ex(int64_t m, int64_t h, int64_t key, int64_t val) {
  ...
  /* region-lock-hardening: slot storage is malloc'd and outlives any region
     bracket; a region-allocated key or value is an escape.  See vec-push!. */
  TUR_REGION_NOTE(key);
  TUR_REGION_NOTE(val);
  for (;;) {
...
static int64_t sum_hyvals(tur_adt_MutableMap__int__int * m, int64_t i, int64_t cap, int64_t acc) {
        __tur_tailcall:;
        if ((i) == (cap)) {
            return acc;
        } else {
            bool __ps_172 = (mutmap_hyslot_hyoccupied_qu((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_172) {
                tur_adt_MutableMap__int__int * __t173 = m;
                int64_t __t174 = (i) + (INT64_C(1));
                int64_t __t175 = cap;
                int64_t __ps_176 = (mutmap_hyslot_hyvalue((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
                if (tur_panicking) return ((int64_t)0);
                int64_t __t177 = (acc) + (__ps_176);
                m = __t173;
                i = __t174;
                cap = __t175;
                acc = __t177;
                ...
                tur_adt_MutableMap__int__int * __t178 = m;
                int64_t __t179 = (i) + (INT64_C(1));
                int64_t __t180 = cap;
                int64_t __t181 = acc;
                m = __t178;
                i = __t179;
...
static int64_t total(tur_adt_MutableMap__int__int * m) {
        int64_t __ps_182 = (mutmap_hycap((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m)))));
        if (tur_panicking) return ((int64_t)0);
        return sum_hyvals((tur_adt_MutableMap__int__int *)(intptr_t)((int64_t)(intptr_t)(m)), INT64_C(0), __ps_182, INT64_C(0));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_MutableMap__int__int * __ps_183 = (mutmap_new__spec__tur_adt_MutableMap__int__int__());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_MutableMap__int__int * a_1613 = __ps_183;
            (void)a_1613;
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1613))), INT64_C(1), INT64_C(1), INT64_C(100));
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1613))), INT64_C(2), INT64_C(2), INT64_C(200));
            mutmap_hyset_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1613))), INT64_C(3), INT64_C(3), INT64_C(300));
            int64_t __ps_184 = (total((tur_adt_MutableMap__int__int *)(intptr_t)((int64_t)(intptr_t)(a_1613))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_184));
            int64_t __ps_185 = (mutmap_hylen((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1613)))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_185));
            mutmap_hyfree((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1613))));
        }
        int64_t __t186;
        __t186 = INT64_C(0);
        return (int)__t186;
