...
static int64_t sum_hyvals(tur_adt_MutableMap__int__int * m, int64_t i, int64_t cap, int64_t acc) {
        ...
        if ((i) == (cap)) {
            ...
            bool __ps_155 = (mutmap_hyslot_hyoccupied_qu((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_155) {
                tur_adt_MutableMap__int__int * __t156 = m;
                int64_t __t157 = (i) + (INT64_C(1));
                int64_t __t158 = cap;
                int64_t __ps_159 = (mutmap_hyslot_hyvalue((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t total(tur_adt_MutableMap__int__int * m) {
        int64_t __ps_165 = (mutmap_hycap((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m)))));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_166 = (sum_hyvals((tur_adt_MutableMap__int__int *)(intptr_t)((int64_t)(intptr_t)(m)), INT64_C(0), __ps_165, INT64_C(0)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_166;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_MutableMap__int__int * __ps_167 = (mutmap_new__spec__tur_adt_MutableMap__int__int__());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            int64_t __ps_168 = (total((tur_adt_MutableMap__int__int *)(intptr_t)((int64_t)(intptr_t)(a_1307))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_168));
            int64_t __ps_169 = (mutmap_hylen((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1307)))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_169));
