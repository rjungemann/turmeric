...
static int64_t sum_hyvals(tur_adt_MutableMap__int__int * m, int64_t i, int64_t cap, int64_t acc) {
        ...
        if ((i) == (cap)) {
            ...
            __auto_type __ps_177 = (mutmap_hyslot_hyoccupied_qu((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
            if (tur_panicking) return (int64_t){0};
            if (__ps_177) {
                tur_adt_MutableMap__int__int * __t178 = m;
                int64_t __t179 = (i) + (INT64_C(1));
                int64_t __t180 = cap;
                __auto_type __ps_181 = (mutmap_hyslot_hyvalue((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m))), i));
                if (tur_panicking) return (int64_t){0};
                int64_t __t182 = (acc) + (__ps_181);
                m = __t178;
                i = __t179;
                cap = __t180;
                acc = __t182;
                ...
                tur_adt_MutableMap__int__int * __t183 = m;
...
static int64_t total(tur_adt_MutableMap__int__int * m) {
        __auto_type __ps_187 = (mutmap_hycap((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(m)))));
        if (tur_panicking) return (int64_t){0};
        __auto_type __ps_188 = (sum_hyvals((int64_t)(intptr_t)(m), INT64_C(0), __ps_187, INT64_C(0)));
        if (tur_panicking) return (int64_t){0};
        return __ps_188;
}
...
int main(int argc, char **argv) {
        ...
        {
            __auto_type __ps_189 = (mutmap_new__spec__tur_adt_MutableMap__int__int__());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_MutableMap__int__int * a_1274 = __ps_189;
            (void)a_1274;
            ...
            __auto_type __ps_190 = (total((int64_t)(intptr_t)(a_1274)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_190));
            __auto_type __ps_191 = (mutmap_hylen((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(a_1274)))));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_191));
