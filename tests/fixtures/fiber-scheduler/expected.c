...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_448));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_468));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_495));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_515), (int64_t)(intptr_t)(__fn_519));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_535), (int64_t)(intptr_t)(__fn_539));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_555));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_626));
}
...
static int64_t fiber_resume_fn(void * f) {
...
static bool sched_empty_(void * q) {
        typedef struct { void *fibers[16]; int head; int tail; int count; } SchedQ;
...
int main() {
        int64_t __t0;
        {
            void * q_640 = sched_new();
            (void)q_640;
            sched_push((void *)(intptr_t)(q_640), (void *)(intptr_t)(fiber_new_fn((void *)(intptr_t)(fiber_a), INT64_C(0))));
            sched_push((void *)(intptr_t)(q_640), (void *)(intptr_t)(fiber_new_fn((void *)(intptr_t)(fiber_b), INT64_C(0))));
            sched_push((void *)(intptr_t)(q_640), (void *)(intptr_t)(fiber_new_fn((void *)(intptr_t)(fiber_c), INT64_C(0))));
            sched_run((void *)(intptr_t)(q_640));
            sched_free((void *)(intptr_t)(q_640));
            puts("done");
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
