...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t k_198 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_198, (int64_t)((x_197) * (INT64_C(2))));
    return (int64_t)__t2;
}
...
static void __handle_body_0(void) {
    int64_t __t3[1];
    __t3[0] = (int64_t)INT64_C(7);
    int64_t __t4 = tur_effect_perform("Scale", __t3, 1);
...
static int64_t __dispatch_0(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Scale") == 0) {
...
int main() {
        {
            ...
            (void)x_196;
            {
                ...
                __eff_frame_0.cases[0].effect_name = "Scale";
                ...
                int64_t result_199 = __t5;
                (void)result_199;
                printf("%lld\n", (long long)(result_199));
            }
        }
        int64_t __t6;
        __t6 = INT64_C(0);
