...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t k_263 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_263, (int64_t)((x_262) * (INT64_C(2))));
    return (int64_t)__t2;
}
...
int main() {
        {
            ...
            (void)x_261;
            {
                ...
                int64_t result_264 = __t5;
                (void)result_264;
                printf("%lld\n", (long long)(result_264));
            }
        }
        int64_t __t6;
        __t6 = INT64_C(0);
