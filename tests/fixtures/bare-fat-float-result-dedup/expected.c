...
static double __fn_900(void *, double);
...
struct __env_902 { tur_thunk_double_double_t __fn; double k; };
static double __fn_900(void * __env_p_903, double x) {
        struct __env_902 *__env___env_902 = (struct __env_902 *)__env_p_903;
        return (x) * (__env___env_902->k);
}

static double run_hywith_un_unbf_unfloat(void * g, double x) {
        double __t16;
        {
            double y_907 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_907;
            __t16 = use_hyfloat(y_907);
        }
        return __t16;
}
...
static void * make_hyscale(double k) {
        struct __env_902 *__t26 = (struct __env_902 *)malloc(sizeof(struct __env_902));
        __t26->__fn = (tur_thunk_double_double_t)__fn_900;
        __t26->k = k;
        void *__t27 = __t26;
        return __t27;
}
