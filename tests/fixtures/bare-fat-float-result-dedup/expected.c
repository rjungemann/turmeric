...
static double __fn_1337(void *, double);
...
struct __env_1339 { tur_thunk_double_double_t __fn; double k; };
...
static double __fn_1337(void * __env_p_1340, double x) {
        struct __env_1339 *__env___env_1339 = (struct __env_1339 *)__env_p_1340;
        return (x) * (__env___env_1339->k);
}

static int64_t run_hywith_un_unbf_unfloat__cps(void * g_1342, double x_1343, DK *__kont);
...
static int64_t run_hywith_un_unbf_unfloat__cps(void * g, double x, DK *__kont) {
    ...
    double __t42;
    {
        ...
        double y_1344 = __ps_43;
        (void)y_1344;
        double __ps_44 = (use_hyfloat(y_1344));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t42 = __ps_44;
    }
    __t0 = __t42;
        ...
        if (__ps_102) {
            bool __t103;
            {
                ...
                if ((t1_1040) == (INT64_C(0))) {
                    __t104 = (t2_1041) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_1041) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1040, t2_1041));
                        if (tur_panicking) return ((bool)0);
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1056 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1056;
                __t113 = out_1056;
            }
            __t111 = __t113;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t122;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1131 = __ps_124;
            (void)iter_1131;
            void * __ps_125 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_126 = (hamt_slkeyeq((void *)(intptr_t)(__ps_125)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1132 = __ps_126;
            (void)keyeq_1132;
            void * __ps_127 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_128 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1131), (void *)(intptr_t)(__ps_127), (void *)(intptr_t)(keyeq_1132)));
            if (tur_panicking) return ((bool)0);
            bool result_1133 = __ps_128;
            (void)result_1133;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t149;
        {
            ...
            {
                tur_adt_Vec__int * __ps_151 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1260));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1261 = __ps_151;
                (void)_un_unv_1261;
...
static void * make_hyscale(double k) {
        void *__t163 = malloc(sizeof(void *) + sizeof(struct __env_1339));
        *(void (**)(void *))__t163 = drop_glue___env_1339;
        struct __env_1339 *__t162 = (struct __env_1339 *)((char *)__t163 + sizeof(void *));
        __t162->__fn = (tur_thunk_double_double_t)__fn_1337;
        __t162->k = k;
        void *__t164 = __t162;
        return __t164;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __t165;
        {
            void * __ps_166 = (make_hyscale(2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1346_1347 = __ps_166;
            (void)_un_unborrowc_un1346_1347;
            double __ps_167 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1346_1347), 3.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t165 = __ps_167;
            TUR_CLOSURE_DROP(_un_unborrowc_un1346_1347);
        }
        printf("%g\n", (double)(__t165));
        double __t168;
        {
            void * __ps_169 = (make_hyscale(3.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1348_1349 = __ps_169;
            (void)_un_unborrowc_un1348_1349;
            double __ps_170 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1348_1349), 4.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t168 = __ps_170;
