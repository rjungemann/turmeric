...
static double __fn_1309(void *, double);
...
struct __env_1311 { tur_thunk_double_double_t __fn; double k; };
...
static double __fn_1309(void * __env_p_1312, double x) {
        struct __env_1311 *__env___env_1311 = (struct __env_1311 *)__env_p_1312;
        return (x) * (__env___env_1311->k);
}

static int64_t run_hywith_un_unbf_unfloat__cps(void * g_1314, double x_1315, DK *__kont);
...
static int64_t run_hywith_un_unbf_unfloat__cps(void * g, double x, DK *__kont) {
    ...
    double __t42;
    {
        ...
        double y_1316 = __ps_43;
        (void)y_1316;
        __auto_type __ps_44 = (use_hyfloat(y_1316));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t42 = __ps_44;
    }
    __t0 = __t42;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_72 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_764, (void *)(intptr_t)(k_765), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t74;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_769 = __ps_76;
            (void)iter_769;
            __auto_type __ps_77 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_78 = (hamt_slkeyeq((void *)(intptr_t)(__ps_77)));
            if (tur_panicking) return (bool){0};
            void * keyeq_770 = __ps_78;
            (void)keyeq_770;
            __auto_type __ps_79 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_80 = (map_hyeq_hyloop((void *)(intptr_t)(iter_769), (void *)(intptr_t)(__ps_79), (void *)(intptr_t)(keyeq_770), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_771 = __ps_80;
            (void)result_771;
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                if ((t1_1012) == (INT64_C(0))) {
                    __t100 = (t2_1013) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_1013) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        __auto_type __ps_102 = (cons_hyeq_hygo(t1_1012, t2_1013));
                        if (tur_panicking) return (bool){0};
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1028 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1028;
                __t109 = out_1028;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1103 = __ps_120;
            (void)iter_1103;
            __auto_type __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1104 = __ps_122;
            (void)keyeq_1104;
            __auto_type __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1103), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1104)));
            if (tur_panicking) return (bool){0};
            bool result_1105 = __ps_124;
            (void)result_1105;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                __auto_type __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1232));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1233 = __ps_147;
                (void)_un_unv_1233;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t150;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1282 = __ps_151;
            (void)r_1282;
            int64_t __t152;
            __auto_type __ps_153 = (schema_hydecode_hyok_qu(r_1282));
            if (tur_panicking) return (int64_t){0};
            if (__ps_153) {
                __auto_type __ps_154 = (schema_hydecode_hyvalue(r_1282));
                if (tur_panicking) return (int64_t){0};
                __t152 = __ps_154;
            } else {
                __auto_type __ps_155 = (schema_hydecode_hyerrors(r_1282));
                if (tur_panicking) return (int64_t){0};
...
static void * make_hyscale(double k) {
        void *__t159 = malloc(sizeof(void *) + sizeof(struct __env_1311));
        *(void (**)(void *))__t159 = drop_glue___env_1311;
        struct __env_1311 *__t158 = (struct __env_1311 *)((char *)__t159 + sizeof(void *));
        __t158->__fn = (tur_thunk_double_double_t)__fn_1309;
        __t158->k = k;
        void *__t160 = __t158;
        return __t160;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __t161;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1318_1319 = __ps_162;
            (void)_un_unborrowc_un1318_1319;
            __auto_type __ps_163 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1318_1319), 3.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t161 = __ps_163;
            TUR_CLOSURE_DROP(_un_unborrowc_un1318_1319);
        }
        printf("%g\n", (double)(__t161));
        double __t164;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1320_1321 = __ps_165;
            (void)_un_unborrowc_un1320_1321;
            __auto_type __ps_166 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1320_1321), 4.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t164 = __ps_166;
            TUR_CLOSURE_DROP(_un_unborrowc_un1320_1321);
        }
        printf("%g\n", (double)(__t164));
        int64_t __t167;
        __t167 = INT64_C(0);
