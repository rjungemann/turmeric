...
static double __fn_1252(void *, double);
...
struct __env_1254 { tur_thunk_double_double_t __fn; double k; };
static double __fn_1252(void * __env_p_1255, double x) {
        struct __env_1254 *__env___env_1254 = (struct __env_1254 *)__env_p_1255;
        return (x) * (__env___env_1254->k);
}

static double run_hywith_un_unbf_unfloat(void * g, double x) {
        double __t19;
        {
            double y_1259 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_1259;
            __t19 = use_hyfloat(y_1259);
        }
        return __t19;
}
...
static void * make_hyscale(double k) {
        struct __env_1254 *__t51 = (struct __env_1254 *)malloc(sizeof(struct __env_1254));
        __t51->__fn = (tur_thunk_double_double_t)__fn_1252;
        __t51->k = k;
        void *__t52 = __t51;
        return __t52;
}
...
int main(int argc, char **argv) {
        ...
        printf("%g\n", (double)(run_hywith_un_unbf_unfloat((void *)(intptr_t)(make_hyscale(2.0)), 3.5)));
        printf("%g\n", (double)(run_hywith_un_unbf_unfloat((void *)(intptr_t)(make_hyscale(3.0)), 4.0)));
        int64_t __t53;
        __t53 = INT64_C(0);
        return (int)__t53;
}
