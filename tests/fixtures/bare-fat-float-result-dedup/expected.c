...
static double __fn_898(void *, double);
...
struct __env_900 { tur_thunk_double_double_t __fn; double k; };
static double __fn_898(void * __env_p_901, double x) {
        struct __env_900 *__env___env_900 = (struct __env_900 *)__env_p_901;
        return (x) * (__env___env_900->k);
}

static double run_hywith_un_unbf_unfloat(void * g, double x) {
        double __t16;
        {
            double y_905 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_905;
            __t16 = use_hyfloat(y_905);
        }
        return __t16;
}
...
static void * make_hyscale(double k) {
        ...
        __t26->__fn = (tur_thunk_double_double_t)__fn_898;
        __t26->k = k;
        void *__t27 = __t26;
        return __t27;
}
