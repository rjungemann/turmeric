...
static int64_t run_hywith_un_unbf_unfloat__cps(void * g, double x, DK *__kont) {
    ...
    double __t42;
    {
        ...
        (void)y_1316;
        double __ps_44 = (use_hyfloat(y_1316));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t42 = __ps_44;
    }
    __t0 = __t42;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_72 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_764, (void *)(intptr_t)(k_765), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t74;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_80 = (map_hyeq_hyloop((void *)(intptr_t)(iter_769), (void *)(intptr_t)(__ps_79), (void *)(intptr_t)(keyeq_770), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            ...
            bool __t99;
            {
                ...
                if ((t1_1012) == (INT64_C(0))) {
                    ...
                    if ((t2_1013) == (INT64_C(0))) {
                        ...
                        bool __ps_102 = (cons_hyeq_hygo(t1_1012, t2_1013));
                        if (tur_panicking) return ((bool)0);
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1103), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1104)));
            if (tur_panicking) return ((bool)0);
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                tur_adt_Vec__int * __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1232));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t150;
        {
            ...
            (void)r_1282;
            int64_t __t152;
            bool __ps_153 = (schema_hydecode_hyok_qu(r_1282));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_153) {
                int64_t __ps_154 = (schema_hydecode_hyvalue(r_1282));
                if (tur_panicking) return ((int64_t)0);
                __t152 = __ps_154;
            } else {
                int64_t __ps_155 = (schema_hydecode_hyerrors(r_1282));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __t161;
        {
            void * __ps_162 = (make_hyscale(2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1318_1319 = __ps_162;
            (void)_un_unborrowc_un1318_1319;
            double __ps_163 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1318_1319), 3.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t161 = __ps_163;
        ...
        double __t164;
        {
            void * __ps_165 = (make_hyscale(3.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1320_1321 = __ps_165;
            (void)_un_unborrowc_un1320_1321;
            double __ps_166 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1320_1321), 4.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t164 = __ps_166;
