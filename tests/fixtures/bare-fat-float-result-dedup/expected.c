...
static int64_t run_hywith_un_unbf_unfloat__cps(void * g, double x, DK *__kont) {
    ...
    double __t104;
    {
        double __ps_105 = ((*( tur_thunk_double_double_t *)(g))(g, x));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double y_1483 = __ps_105;
        (void)y_1483;
        double __ps_106 = (use_hyfloat(y_1483));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t104 = __ps_106;
    }
    __t0 = __t104;
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_856 = __ps_139;
        bool __ps_140 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_855, (void *)(intptr_t)(k_856), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_140;
        if (__t1) {
            int64_t __ps_141 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_142 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_855, (void *)(intptr_t)(k_856), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t144;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_860 = __ps_146;
            (void)iter_860;
            void * __ps_147 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_148 = (hamt_slkeyeq((void *)(intptr_t)(__ps_147)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_861 = __ps_148;
            (void)keyeq_861;
            void * __ps_149 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_150 = (map_hyeq_hyloop((void *)(intptr_t)(iter_860), (void *)(intptr_t)(__ps_149), (void *)(intptr_t)(keyeq_861), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_862 = __ps_150;
            (void)result_862;
        ...
        if (__ps_169) {
            bool __t170;
            {
                ...
                if ((t1_1140) == (INT64_C(0))) {
                    __t171 = (t2_1141) == (INT64_C(0));
                } else {
                    bool __t172;
                    if ((t2_1141) == (INT64_C(0))) {
                        __t172 = false;
                    } else {
                        bool __ps_173 = (cons_hyeq_hygo(t1_1140, t2_1141));
                        if (tur_panicking) return ((bool)0);
                        __t172 = __ps_173;
                    }
                    __t171 = __t172;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_179) {
            ...
            int64_t __t180;
            {
                ...
                int64_t out_1156 = (int64_t)(intptr_t)(__ps_184);
                (void)out_1156;
                __t180 = out_1156;
            }
            __t178 = __t180;
        ...
        if (__ps_189) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1227 = __ps_190;
                (void)h_1227;
                void * __ps_191 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1228 = __ps_191;
                (void)k_1228;
                bool __ps_192 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1227, (void *)(intptr_t)(k_1228), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_192) {
                    void * __t193 = iter;
                    void * __t194 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t196;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1231 = __ps_198;
            (void)iter_1231;
            void * __ps_199 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_200 = (hamt_slkeyeq((void *)(intptr_t)(__ps_199)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1232 = __ps_200;
            (void)keyeq_1232;
            void * __ps_201 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_202 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1231), (void *)(intptr_t)(__ps_201), (void *)(intptr_t)(keyeq_1232)));
            if (tur_panicking) return ((bool)0);
            bool result_1233 = __ps_202;
            (void)result_1233;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t223;
        {
            ...
            {
                tur_adt_Vec__int * __ps_225 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1363));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1364 = __ps_225;
                (void)_un_unv_1364;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t229;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1414 = __ps_230;
            (void)r_1414;
            int64_t __t231;
            bool __ps_232 = (schema_hydecode_hyok_qu(r_1414));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_232) {
                int64_t __ps_233 = (schema_hydecode_hyvalue(r_1414));
                if (tur_panicking) return ((int64_t)0);
                __t231 = __ps_233;
            } else {
                int64_t __ps_234 = (schema_hydecode_hyerrors(r_1414));
                if (tur_panicking) return ((int64_t)0);
...
static void * make_hyscale(double k) {
        void *__t248 = malloc(sizeof(void *) + sizeof(struct __env_1478));
        *(void (**)(void *))__t248 = drop_glue___env_1478;
        struct __env_1478 *__t247 = (struct __env_1478 *)((char *)__t248 + sizeof(void *));
        __t247->__fn = (tur_thunk_double_double_t)__fn_1476;
        __t247->k = k;
        void *__t249 = __t247;
        return __t249;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __t250;
        {
            void * __ps_251 = (make_hyscale(2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1485_1486 = __ps_251;
            (void)_un_unborrowc_un1485_1486;
            double __ps_252 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1485_1486), 3.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t250 = __ps_252;
        ...
        double __t253;
        {
            void * __ps_254 = (make_hyscale(3.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1487_1488 = __ps_254;
            (void)_un_unborrowc_un1487_1488;
            double __ps_255 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1487_1488), 4.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t253 = __ps_255;
