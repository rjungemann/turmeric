...
static int64_t run_hywith_un_unbf_unfloat__cps(void * g, double x, DK *__kont) {
    ...
    double __t40;
    {
        double __ps_41 = ((*( tur_thunk_double_double_t *)(g))(g, x));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double y_1448 = __ps_41;
        (void)y_1448;
        double __ps_42 = (use_hyfloat(y_1448));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t40 = __ps_42;
    }
    __t0 = __t40;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_74 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_816, (void *)(intptr_t)(k_817), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t76;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_821 = __ps_78;
            (void)iter_821;
            void * __ps_79 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_80 = (hamt_slkeyeq((void *)(intptr_t)(__ps_79)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_822 = __ps_80;
            (void)keyeq_822;
            void * __ps_81 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_82 = (map_hyeq_hyloop((void *)(intptr_t)(iter_821), (void *)(intptr_t)(__ps_81), (void *)(intptr_t)(keyeq_822), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_823 = __ps_82;
            (void)result_823;
        ...
        if (__ps_101) {
            bool __t102;
            {
                ...
                if ((t1_1101) == (INT64_C(0))) {
                    __t103 = (t2_1102) == (INT64_C(0));
                } else {
                    bool __t104;
                    if ((t2_1102) == (INT64_C(0))) {
                        __t104 = false;
                    } else {
                        bool __ps_105 = (cons_hyeq_hygo(t1_1101, t2_1102));
                        if (tur_panicking) return ((bool)0);
                        __t104 = __ps_105;
                    }
                    __t103 = __t104;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1117 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1117;
                __t112 = out_1117;
            }
            __t110 = __t112;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t121;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_123;
            (void)iter_1192;
            void * __ps_124 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_125 = (hamt_slkeyeq((void *)(intptr_t)(__ps_124)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_125;
            (void)keyeq_1193;
            void * __ps_126 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_127 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_126), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_127;
            (void)result_1194;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t148;
        {
            ...
            {
                tur_adt_Vec__int * __ps_150 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1321));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1322 = __ps_150;
                (void)_un_unv_1322;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t154;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1372 = __ps_155;
            (void)r_1372;
            int64_t __t156;
            bool __ps_157 = (schema_hydecode_hyok_qu(r_1372));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_157) {
                int64_t __ps_158 = (schema_hydecode_hyvalue(r_1372));
                if (tur_panicking) return ((int64_t)0);
                __t156 = __ps_158;
            } else {
                int64_t __ps_159 = (schema_hydecode_hyerrors(r_1372));
                if (tur_panicking) return ((int64_t)0);
...
static void * make_hyscale(double k) {
        void *__t172 = malloc(sizeof(void *) + sizeof(struct __env_1443));
        *(void (**)(void *))__t172 = drop_glue___env_1443;
        struct __env_1443 *__t171 = (struct __env_1443 *)((char *)__t172 + sizeof(void *));
        __t171->__fn = (tur_thunk_double_double_t)__fn_1441;
        __t171->k = k;
        void *__t173 = __t171;
        return __t173;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __t174;
        {
            void * __ps_175 = (make_hyscale(2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1450_1451 = __ps_175;
            (void)_un_unborrowc_un1450_1451;
            double __ps_176 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1450_1451), 3.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t174 = __ps_176;
        ...
        double __t177;
        {
            void * __ps_178 = (make_hyscale(3.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1452_1453 = __ps_178;
            (void)_un_unborrowc_un1452_1453;
            double __ps_179 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1452_1453), 4.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t177 = __ps_179;
