...
static double __fn_877(void *, double);
...
struct __env_879 { tur_thunk_double_double_t __fn; double k; };
static double __fn_877(void * __env_p_880, double x) {
        struct __env_879 *__env___env_879 = (struct __env_879 *)__env_p_880;
        return (x) * (__env___env_879->k);
}

static double run_hywith_un_unbf_unfloat(void * g, double x) {
        double __t18;
        {
            double y_884 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_884;
            __t18 = use_hyfloat(y_884);
        }
        return __t18;
}
...
static void * make_hyscale(double k) {
        struct __env_879 *__t26 = (struct __env_879 *)malloc(sizeof(struct __env_879));
        __t26->__fn = (tur_thunk_double_double_t)__fn_877;
        __t26->k = k;
        void *__t27 = __t26;
        return __t27;
}
