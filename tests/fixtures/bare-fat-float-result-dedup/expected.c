...
static double __fn_1284(void *, double);
...
struct __env_1286 { tur_thunk_double_double_t __fn; double k; };
static double __fn_1284(void * __env_p_1287, double x) {
        struct __env_1286 *__env___env_1286 = (struct __env_1286 *)__env_p_1287;
        return (x) * (__env___env_1286->k);
}

static int64_t run_hywith_un_unbf_unfloat__cps(void * g_1289, double x_1290, DK *__kont);
...
static int64_t run_hywith_un_unbf_unfloat__cps(void * g, double x, DK *__kont) {
    ...
    y_1291 = __ps_40;
    __auto_type __ps_41 = (use_hyfloat(y_1291));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __t0 = __ps_41;
...
static void * make_hyscale(double k) {
        struct __env_1286 *__t175 = (struct __env_1286 *)malloc(sizeof(struct __env_1286));
        __t175->__fn = (tur_thunk_double_double_t)__fn_1284;
        __t175->k = k;
        void *__t176 = __t175;
        return __t176;
}
