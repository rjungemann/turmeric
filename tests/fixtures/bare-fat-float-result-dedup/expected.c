...
static double __fn_881(void *, double);
...
struct __env_883 { tur_thunk_double_double_t __fn; double k; };
static double __fn_881(void * __env_p_884, double x) {
        struct __env_883 *__env___env_883 = (struct __env_883 *)__env_p_884;
        return (x) * (__env___env_883->k);
}

static double run_hywith_un_unbf_unfloat(void * g, double x) {
        double __t16;
        {
            double y_888 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_888;
            __t16 = use_hyfloat(y_888);
        }
        return __t16;
}
...
static void * make_hyscale(double k) {
        struct __env_883 *__t26 = (struct __env_883 *)malloc(sizeof(struct __env_883));
        __t26->__fn = (tur_thunk_double_double_t)__fn_881;
        __t26->k = k;
        void *__t27 = __t26;
        return __t27;
}
