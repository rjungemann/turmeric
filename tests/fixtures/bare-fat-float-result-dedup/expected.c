...
static double __fn_1628(void *, double);
...
struct __env_1630 { tur_thunk_double_double_t __fn; double k; };
...
static double __fn_1628(void * __env_p_1631, double x) {
        struct __env_1630 *__env___env_1630 = (struct __env_1630 *)__env_p_1631;
        return (x) * (__env___env_1630->k);
}

static int64_t run_hywith_un_unbf_unfloat__cps(void * g_1633, double x_1634, DK *__kont);
...
static int64_t run_hywith_un_unbf_unfloat__cps(void * g, double x, DK *__kont) {
    ...
    double __t62;
    {
        ...
        double y_1635 = __ps_63;
        (void)y_1635;
        double __ps_64 = (use_hyfloat(y_1635));
        if (tur_panicking) return ((int64_t)0);
        __t62 = __ps_64;
    }
    __t0 = __t62;
...
static void * make_hyscale(double k) {
        void *__t176 = malloc(sizeof(void *) + sizeof(struct __env_1630));
        *(void (**)(void *))__t176 = drop_glue___env_1630;
        struct __env_1630 *__t175 = (struct __env_1630 *)((char *)__t176 + sizeof(void *));
        __t175->__fn = (tur_thunk_double_double_t)__fn_1628;
        __t175->k = k;
        void *__t177 = __t175;
        return __t177;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __t178;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1637_1638 = __ps_179;
            (void)_un_unborrowc_un1637_1638;
            double __ps_180 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1637_1638), 3.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t178 = __ps_180;
            TUR_CLOSURE_DROP(_un_unborrowc_un1637_1638);
        }
        printf("%g\n", (double)(__t178));
        double __t181;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1639_1640 = __ps_182;
            (void)_un_unborrowc_un1639_1640;
            double __ps_183 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1639_1640), 4.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t181 = __ps_183;
