...
static double __fn_1339(void *, double);
...
struct __env_1341 { tur_thunk_double_double_t __fn; double k; };
...
static double __fn_1339(void * __env_p_1342, double x) {
        struct __env_1341 *__env___env_1341 = (struct __env_1341 *)__env_p_1342;
        return (x) * (__env___env_1341->k);
}

static int64_t run_hywith_un_unbf_unfloat__cps(void * g_1344, double x_1345, DK *__kont);
...
static int64_t run_hywith_un_unbf_unfloat__cps(void * g, double x, DK *__kont) {
    ...
    double __t42;
    {
        ...
        double y_1346 = __ps_43;
        (void)y_1346;
        double __ps_44 = (use_hyfloat(y_1346));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t42 = __ps_44;
    }
    __t0 = __t42;
        ...
        if (__ps_102) {
            bool __t103;
            {
                ...
                if ((t1_1041) == (INT64_C(0))) {
                    __t104 = (t2_1042) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_1042) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1041, t2_1042));
                        if (tur_panicking) return ((bool)0);
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1057 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1057;
                __t113 = out_1057;
            }
            __t111 = __t113;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t122;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1132 = __ps_124;
            (void)iter_1132;
            void * __ps_125 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_126 = (hamt_slkeyeq((void *)(intptr_t)(__ps_125)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1133 = __ps_126;
            (void)keyeq_1133;
            void * __ps_127 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_128 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1132), (void *)(intptr_t)(__ps_127), (void *)(intptr_t)(keyeq_1133)));
            if (tur_panicking) return ((bool)0);
            bool result_1134 = __ps_128;
            (void)result_1134;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t149;
        {
            ...
            {
                tur_adt_Vec__int * __ps_151 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1261));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1262 = __ps_151;
                (void)_un_unv_1262;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t155;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1312 = __ps_156;
            (void)r_1312;
            int64_t __t157;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1312));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                int64_t __ps_159 = (schema_hydecode_hyvalue(r_1312));
                if (tur_panicking) return ((int64_t)0);
                __t157 = __ps_159;
            } else {
                int64_t __ps_160 = (schema_hydecode_hyerrors(r_1312));
                if (tur_panicking) return ((int64_t)0);
...
static void * make_hyscale(double k) {
        void *__t164 = malloc(sizeof(void *) + sizeof(struct __env_1341));
        *(void (**)(void *))__t164 = drop_glue___env_1341;
        struct __env_1341 *__t163 = (struct __env_1341 *)((char *)__t164 + sizeof(void *));
        __t163->__fn = (tur_thunk_double_double_t)__fn_1339;
        __t163->k = k;
        void *__t165 = __t163;
        return __t165;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __t166;
        {
            void * __ps_167 = (make_hyscale(2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1348_1349 = __ps_167;
            (void)_un_unborrowc_un1348_1349;
            double __ps_168 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1348_1349), 3.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t166 = __ps_168;
            TUR_CLOSURE_DROP(_un_unborrowc_un1348_1349);
        }
        printf("%g\n", (double)(__t166));
        double __t169;
        {
            void * __ps_170 = (make_hyscale(3.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unborrowc_un1350_1351 = __ps_170;
            (void)_un_unborrowc_un1350_1351;
            double __ps_171 = (run_hywith_un_unbf_unfloat((void *)(intptr_t)(_un_unborrowc_un1350_1351), 4.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t169 = __ps_171;
            TUR_CLOSURE_DROP(_un_unborrowc_un1350_1351);
        }
        printf("%g\n", (double)(__t169));
        int64_t __t172;
        __t172 = INT64_C(0);
