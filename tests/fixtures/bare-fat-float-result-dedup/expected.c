...
static void * make_hyscale(double k) {
        struct __env_885 *__t22 = (struct __env_885 *)malloc(sizeof(struct __env_885));
        __t22->__fn = (tur_thunk_double_double_t)__fn_883;
        __t22->k = k;
        void *__t23 = __t22;
        return __t23;
}
