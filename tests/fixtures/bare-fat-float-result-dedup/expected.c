...
static double __fn_891(void *, double);
...
struct __env_893 { tur_thunk_double_double_t __fn; double k; };
static double __fn_891(void * __env_p_894, double x) {
        struct __env_893 *__env___env_893 = (struct __env_893 *)__env_p_894;
        return (x) * (__env___env_893->k);
}

static double run_hywith_un_unbf_unfloat(void * g, double x) {
        double __t16;
        {
            double y_898 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_898;
            __t16 = use_hyfloat(y_898);
        }
        return __t16;
}
...
static void * make_hyscale(double k) {
        struct __env_893 *__t26 = (struct __env_893 *)malloc(sizeof(struct __env_893));
        __t26->__fn = (tur_thunk_double_double_t)__fn_891;
        __t26->k = k;
        void *__t27 = __t26;
        return __t27;
}
