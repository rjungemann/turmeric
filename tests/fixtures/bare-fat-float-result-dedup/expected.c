...
struct __env_1275 { tur_thunk_double_double_t __fn; double k; };
static double __fn_1273(void * __env_p_1276, double x) {
        struct __env_1275 *__env___env_1275 = (struct __env_1275 *)__env_p_1276;
        return (x) * (__env___env_1275->k);
}
...
static double run_hywith_un_unbf_unfloat(void * g, double x) {
        double __t43;
        {
            ...
            double y_1280 = __ps_44;
            (void)y_1280;
            __auto_type __ps_45 = (use_hyfloat(y_1280));
            if (tur_panicking) return (double){0};
            __t43 = __ps_45;
        }
        return __t43;
        ...
        if (__ps_136) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1063 = __ps_137;
                (void)h_1063;
                __auto_type __ps_138 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1064 = __ps_138;
                (void)k_1064;
                __auto_type __ps_139 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1063, (void *)(intptr_t)(k_1064), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_139) {
                    void * __t140 = iter;
                    void * __t141 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t143;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1067 = __ps_145;
            (void)iter_1067;
            __auto_type __ps_146 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_147 = (hamt_slkeyeq((void *)(intptr_t)(__ps_146)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1068 = __ps_147;
            (void)keyeq_1068;
            __auto_type __ps_148 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_149 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1067), (void *)(intptr_t)(__ps_148), (void *)(intptr_t)(keyeq_1068)));
            if (tur_panicking) return (bool){0};
            bool result_1069 = __ps_149;
            (void)result_1069;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t176;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1246 = __ps_177;
            (void)r_1246;
            int64_t __t178;
            __auto_type __ps_179 = (schema_hydecode_hyok_qu(r_1246));
            if (tur_panicking) return (int64_t){0};
            if (__ps_179) {
                __auto_type __ps_180 = (schema_hydecode_hyvalue(r_1246));
                if (tur_panicking) return (int64_t){0};
                __t178 = __ps_180;
            } else {
                __auto_type __ps_181 = (schema_hydecode_hyerrors(r_1246));
                if (tur_panicking) return (int64_t){0};
...
static void * make_hyscale(double k) {
        struct __env_1275 *__t184 = (struct __env_1275 *)malloc(sizeof(struct __env_1275));
        __t184->__fn = (tur_thunk_double_double_t)__fn_1273;
        __t184->k = k;
        void *__t185 = __t184;
        return __t185;
}
