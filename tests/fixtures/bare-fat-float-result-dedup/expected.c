...
static double __fn_1255(void *, double);
...
struct __env_1257 { tur_thunk_double_double_t __fn; double k; };
static double __fn_1255(void * __env_p_1258, double x) {
        struct __env_1257 *__env___env_1257 = (struct __env_1257 *)__env_p_1258;
        return (x) * (__env___env_1257->k);
}

static double run_hywith_un_unbf_unfloat(void * g, double x) {
        double __t20;
        {
            double y_1262 = (*( tur_thunk_double_double_t *)(g))(g, x);
            (void)y_1262;
            __t20 = use_hyfloat(y_1262);
        }
        return __t20;
}
...
static void * make_hyscale(double k) {
        struct __env_1257 *__t56 = (struct __env_1257 *)malloc(sizeof(struct __env_1257));
        __t56->__fn = (tur_thunk_double_double_t)__fn_1255;
        __t56->k = k;
        void *__t57 = __t56;
        return __t57;
}
