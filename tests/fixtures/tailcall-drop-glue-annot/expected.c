...
static int64_t with_hyref(int64_t);
...
struct __defer_env_174 {void * b; };

struct __defer_env_162 {int64_t m; };

static void __defer_175(void *__env) {
    struct __defer_env_174 *__e = (struct __defer_env_174 *)__env;
    free(__e->b);
}
...
static int64_t with_hyref(int64_t n) {
        __tur_tailcall:;
        {
            void * __t172 = malloc(sizeof(int64_t));
            *((int64_t *)__t172) = INT64_C(1);
            void * b_1609 = __t172;
            (void)b_1609;
            tur_frame __frame_173;
            tur_frame_init(&__frame_173, NULL);
            struct __defer_env_174 __t176 = {.b = b_1609};
            tur_frame_push_defer(&__frame_173, __defer_175, &__t176);
            if ((n) == (INT64_C(0))) {
                int64_t __t177;
                __t177 = INT64_C(0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_179 = (with_hyref(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        int64_t __t180;
        __t180 = INT64_C(0);
