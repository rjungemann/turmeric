...
int main() {
        int64_t __t0;
        {
            ...
            int64_t __t1;
            {
                void * fut_a_208 = tg_spawn_async((void *)(intptr_t)(tg_207), (void *)(intptr_t)(compute_a));
                (void)fut_a_208;
                int64_t __t2;
                {
                    void * fut_b_209 = tg_spawn_async((void *)(intptr_t)(tg_207), (void *)(intptr_t)(compute_b));
                    (void)fut_b_209;
                    int64_t __t3;
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut_a_208);
                        int64_t a_210 = __t4;
                        (void)a_210;
                        int64_t __t5;
                        {
                            int64_t __t6 = tur_await_future((TurFuture*)(intptr_t)fut_b_209);
                            int64_t b_211 = __t6;
                            (void)b_211;
                            printf("%lld\n", (long long)(a_210));
                            printf("%lld\n", (long long)(b_211));
                            printf("%lld\n", (long long)(((a_210) + (b_211))));
