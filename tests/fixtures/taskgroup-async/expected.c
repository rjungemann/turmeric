...
static void __tg_async_entry();
static void * tg_new();
static bool tg_done_(void *);
static void tg_free(void *);
static void * tg_spawn_async(void *, void *);
static int64_t compute_a();
static int64_t compute_b();
...
static bool tg_done_(void * group) {
        typedef struct {
...
static void * tg_spawn_async(void * group, void * f) {
        typedef struct {
      pthread_mutex_t lock; pthread_cond_t done_cond;
      int64_t task_count; int64_t completed_count;
      bool cancelled; bool done;
  ...
  fiber->task_group  = (void *)g;   /* enables auto-notify on done */
...
int main() {
        int64_t __t0;
        {
            ...
            int64_t __t1;
            {
                void * fut_a_628 = tg_spawn_async((void *)(intptr_t)(tg_627), (void *)(intptr_t)(compute_a));
                (void)fut_a_628;
                int64_t __t2;
                {
                    void * fut_b_629 = tg_spawn_async((void *)(intptr_t)(tg_627), (void *)(intptr_t)(compute_b));
                    (void)fut_b_629;
                    int64_t __t3;
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut_a_628);
                        int64_t a_630 = __t4;
                        (void)a_630;
                        int64_t __t5;
                        {
                            int64_t __t6 = tur_await_future((TurFuture*)(intptr_t)fut_b_629);
                            int64_t b_631 = __t6;
                            (void)b_631;
                            printf("%lld\n", (long long)(a_630));
                            printf("%lld\n", (long long)(b_631));
                            printf("%lld\n", (long long)(((a_630) + (b_631))));
