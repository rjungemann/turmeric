...
int main() {
        int64_t __t0;
        {
            ...
            int64_t __t1;
            {
                void * fut_a_273 = tg_spawn_async((void *)(intptr_t)(tg_272), (void *)(intptr_t)(compute_a));
                (void)fut_a_273;
                int64_t __t2;
                {
                    void * fut_b_274 = tg_spawn_async((void *)(intptr_t)(tg_272), (void *)(intptr_t)(compute_b));
                    (void)fut_b_274;
                    int64_t __t3;
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut_a_273);
                        int64_t a_275 = __t4;
                        (void)a_275;
                        int64_t __t5;
                        {
                            int64_t __t6 = tur_await_future((TurFuture*)(intptr_t)fut_b_274);
                            int64_t b_276 = __t6;
                            (void)b_276;
                            printf("%lld\n", (long long)(a_275));
                            printf("%lld\n", (long long)(b_276));
                            printf("%lld\n", (long long)(((a_275) + (b_276))));
