...
int main() {
        int64_t __t0;
        {
            ...
            int64_t __t1;
            {
                void * fut_a_220 = tg_spawn_async((void *)(intptr_t)(tg_219), (void *)(intptr_t)(compute_a));
                (void)fut_a_220;
                int64_t __t2;
                {
                    void * fut_b_221 = tg_spawn_async((void *)(intptr_t)(tg_219), (void *)(intptr_t)(compute_b));
                    (void)fut_b_221;
                    int64_t __t3;
                    {
                        int64_t __t4 = tur_await_future((TurFuture*)(intptr_t)fut_a_220);
                        int64_t a_222 = __t4;
                        (void)a_222;
                        int64_t __t5;
                        {
                            int64_t __t6 = tur_await_future((TurFuture*)(intptr_t)fut_b_221);
                            int64_t b_223 = __t6;
                            (void)b_223;
                            printf("%lld\n", (long long)(a_222));
                            printf("%lld\n", (long long)(b_223));
                            printf("%lld\n", (long long)(((a_222) + (b_223))));
