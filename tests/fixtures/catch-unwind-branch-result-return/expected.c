...
static void __defer_164(void *__env) {
    ...
    bool __ps_206 = (bt_hyundo_hyto_ex(__e->m));
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                (void)t2_1283;
                bool __t100;
                bool __ps_101 = (tnil_qu(t1_1282));
                if (tur_panicking) return ((bool)0);
                if (__ps_101) {
                    bool __ps_102 = (tnil_qu(t2_1283));
                    if (tur_panicking) return ((bool)0);
                    __t100 = __ps_102;
                } else {
                    bool __t103;
                    bool __ps_104 = (tnil_qu(t2_1283));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_104) {
                        __t103 = false;
                    } else {
                        bool __ps_105 = (cons_hyeq_hygo(t1_1282, t2_1283));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_105;
                    }
                    __t100 = __t103;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                int64_t out_1298 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1298;
                __t112 = out_1298;
            }
            __t110 = __t112;
        ...
        if (__ps_117) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1369 = __ps_118;
                (void)h_1369;
                void * __ps_119 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1370 = __ps_119;
                (void)k_1370;
                bool __ps_120 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1369, (void *)(intptr_t)(k_1370), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_120) {
                    void * __t121 = iter;
                    void * __t122 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t124;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1373 = __ps_126;
            (void)iter_1373;
            void * __ps_127 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_128 = (hamt_slkeyeq((void *)(intptr_t)(__ps_127)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1374 = __ps_128;
            (void)keyeq_1374;
            void * __ps_129 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_130 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1373), (void *)(intptr_t)(__ps_129), (void *)(intptr_t)(keyeq_1374)));
            if (tur_panicking) return ((bool)0);
            bool result_1375 = __ps_130;
            (void)result_1375;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t151;
        {
            ...
            {
                tur_adt_Vec__int * __ps_153 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1505));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1506 = __ps_153;
                (void)_un_unv_1506;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1556 = __ps_156;
            (void)r_1556;
            bool __ps_157 = (schema_hydecode_hyok_qu(r_1556));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_157) {
                return schema_hydecode_hyvalue(r_1556);
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1556));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t160;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1607 = __ps_161;
            (void)m_1607;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            struct __defer_env_163 __t165 = {.m = m_1607};
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((c) == (INT64_C(0))) {
            ...
            __n175->saved[1] = (int64_t)(intptr_t)(__t173);
            __n175->saved[2] = (int64_t)(intptr_t)(__t174);
            ...
            __n176->saved[0] = (int64_t)(intptr_t)(c);
            __n176->saved[1] = (int64_t)(intptr_t)(__t173);
            __n176->saved[2] = (int64_t)(intptr_t)(__t174);
            __k = __n176; __pc = 4; break;
           }
          }
          case 2: {
          ...
          case 3: {
           ...
           __t173 = (int64_t)(intptr_t)(__k->saved[1]);
          ...
          case 5: {
           ...
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Result__int__int __caggr176 = (*(tur_adt_Result__int__int *)(intptr_t)(__box176));
           tur_result_box_free((int64_t)(intptr_t)__box176);
           { tur_adt_Result__int__int __rv = (__caggr176); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
        ...
        int64_t __t177 = 0;
        {
            ...
            case 0: {
                ...
                *(void (**)(void *))__t179 = 0;
                ...
                __t178[0] = (int64_t)(intptr_t)__tur_fatshim0;
                __t178[1] = (int64_t)(intptr_t)__fn_1618;
                void *__t180 = __t178;
                int64_t __catch_result_181 = tur_catch_unwind_box((int64_t)(intptr_t)__t180);
                TUR_CLOSURE_DROP(__t180);
                __t177 = __catch_result_181;
                break;
            }
            case 1: {
                ...
                *(void (**)(void *))__t183 = 0;
                ...
                __t182[0] = (int64_t)(intptr_t)__tur_fatshim0;
                __t182[1] = (int64_t)(intptr_t)__fn_1620;
                void *__t184 = __t182;
                int64_t __catch_result_185 = tur_catch_unwind_box((int64_t)(intptr_t)__t184);
                TUR_CLOSURE_DROP(__t184);
                __t177 = __catch_result_185;
                break;
            }
            default: break;
            }
        }
                int64_t __t186 = (int64_t)(intptr_t)(__t177);
        tur_adt_Result__int__int __t187 = (*(tur_adt_Result__int__int *)(intptr_t)(__t186));
        tur_result_box_free(__t186);
        return __t187;
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((c) == (INT64_C(0))) {
            ...
            __n190->tag = 3; __n190->boundary = __b190; __n190->next = __k;
            __n190->aggr_mask = 0x0u;
            __n190->saved[0] = (int64_t)(intptr_t)(c);
            __n190->saved[1] = (int64_t)(intptr_t)(__t188);
            __n190->saved[2] = (int64_t)(intptr_t)(__t189);
            ...
            __n191->tag = 5; __n191->boundary = __b191; __n191->next = __k;
            __n191->aggr_mask = 0x0u;
            __n191->saved[0] = (int64_t)(intptr_t)(c);
            __n191->saved[1] = (int64_t)(intptr_t)(__t188);
            __n191->saved[2] = (int64_t)(intptr_t)(__t189);
            __k = __n191; __pc = 4; break;
           }
          }
          case 2: {
           tur_panic("boom");
          ...
          case 3: {
           c = (int64_t)(intptr_t)(__k->saved[0]);
           __t188 = (int64_t)(intptr_t)(__k->saved[1]);
          ...
          case 5: {
           ...
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Result__int__int __caggr191 = (*(tur_adt_Result__int__int *)(intptr_t)(__box191));
           tur_result_box_free((int64_t)(intptr_t)__box191);
           { tur_adt_Result__int__int __rv = (__caggr191); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Result__int__int __ps_192 = (make_hyif(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int a_1627 = __ps_192;
            (void)a_1627;
            bool __ps_193 = (ok___spec__bool_tur_adt_Result__int__int(a_1627));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_193) {
                puts("if-ok");
            } else {
        ...
        {
            tur_adt_Result__int__int __ps_194 = (make_hyif(INT64_C(1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int b_1628 = __ps_194;
            (void)b_1628;
            bool __ps_195 = (ok___spec__bool_tur_adt_Result__int__int(b_1628));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_195) {
                puts("if-ok2");
            } else {
        ...
        {
            tur_adt_Pick __ps_196 = (ctor_Pick_First());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int __ps_197 = (make_hymatch(__ps_196));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int m_1629 = __ps_197;
            (void)m_1629;
            bool __ps_198 = (ok___spec__bool_tur_adt_Result__int__int(m_1629));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_198) {
                puts("match-ok");
            } else {
        ...
        {
            tur_adt_Result__int__int __ps_199 = (make_hyif_hycaught(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int d_1630 = __ps_199;
            (void)d_1630;
            bool __ps_200 = (err___spec__bool_tur_adt_Result__int__int(d_1630));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_200) {
                puts("caught-err");
            } else {
