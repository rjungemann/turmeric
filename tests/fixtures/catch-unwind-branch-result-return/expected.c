...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t122;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1193 = __ps_124;
            (void)iter_1193;
            void * __ps_125 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_126 = (hamt_slkeyeq((void *)(intptr_t)(__ps_125)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1194 = __ps_126;
            (void)keyeq_1194;
            void * __ps_127 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_128 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1193), (void *)(intptr_t)(__ps_127), (void *)(intptr_t)(keyeq_1194)));
            if (tur_panicking) return ((bool)0);
            bool result_1195 = __ps_128;
            (void)result_1195;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t149;
        {
            ...
            {
                tur_adt_Vec__int * __ps_151 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1322));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1323 = __ps_151;
                (void)_un_unv_1323;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t155;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1373 = __ps_156;
            (void)r_1373;
            int64_t __t157;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1373));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                int64_t __ps_159 = (schema_hydecode_hyvalue(r_1373));
                if (tur_panicking) return ((int64_t)0);
                __t157 = __ps_159;
            } else {
                int64_t __ps_160 = (schema_hydecode_hyerrors(r_1373));
                if (tur_panicking) return ((int64_t)0);
...
static tur_adt_Result__int__int make_hyif(int64_t c) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((c) == (INT64_C(0))) {
            tur_handler_node *__b174 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b174->parent = tur_handler_chain; tur_handler_chain = __b174;
            tur_cont *__n174 = (tur_cont*)malloc(sizeof(tur_cont));
            __n174->tag = 3; __n174->boundary = __b174; __n174->next = __k;
            __n174->aggr_mask = 0x0u;
            __n174->saved[0] = (int64_t)(intptr_t)(c);
            __n174->saved[1] = (int64_t)(intptr_t)(__t172);
            __n174->saved[2] = (int64_t)(intptr_t)(__t173);
            __k = __n174; __pc = 2; break;
           } else {
            ...
            __n175->tag = 5; __n175->boundary = __b175; __n175->next = __k;
            __n175->aggr_mask = 0x0u;
            __n175->saved[0] = (int64_t)(intptr_t)(c);
            __n175->saved[1] = (int64_t)(intptr_t)(__t172);
            __n175->saved[2] = (int64_t)(intptr_t)(__t173);
            __k = __n175; __pc = 4; break;
           }
          }
          case 2: {
          ...
          case 3: {
           ...
           __t172 = (int64_t)(intptr_t)(__k->saved[1]);
           __t173 = (int64_t)(intptr_t)(__k->saved[2]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box174;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp174 = global_panic_payload; global_panic_payload = 0; __box174 = tur_box_err((int64_t)(intptr_t)__pp174); }
           else { __box174 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Result__int__int __caggr174 = (*(tur_adt_Result__int__int *)(intptr_t)(__box174));
           tur_result_box_free((int64_t)(intptr_t)__box174);
           { tur_adt_Result__int__int __rv = (__caggr174); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
          case 4: {
          ...
          case 5: {
           ...
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Result__int__int __caggr175 = (*(tur_adt_Result__int__int *)(intptr_t)(__box175));
           tur_result_box_free((int64_t)(intptr_t)__box175);
           { tur_adt_Result__int__int __rv = (__caggr175); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
static tur_adt_Result__int__int make_hymatch(tur_adt_Pick p) {
        int64_t __t176 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                void *__t178 = malloc(sizeof(void *) + 2 * sizeof(int64_t));
                *(void (**)(void *))__t178 = 0;
                int64_t *__t177 = (int64_t *)((char *)__t178 + sizeof(void *));
                __t177[0] = (int64_t)(intptr_t)__tur_fatshim0;
                __t177[1] = (int64_t)(intptr_t)__fn_1444;
                void *__t179 = __t177;
                int64_t __catch_result_180 = tur_catch_unwind_box((int64_t)(intptr_t)__t179);
                TUR_CLOSURE_DROP(__t179);
                __t176 = __catch_result_180;
                break;
            }
            case 1: {
                ...
                *(void (**)(void *))__t182 = 0;
                ...
                __t181[0] = (int64_t)(intptr_t)__tur_fatshim0;
                __t181[1] = (int64_t)(intptr_t)__fn_1446;
                void *__t183 = __t181;
                int64_t __catch_result_184 = tur_catch_unwind_box((int64_t)(intptr_t)__t183);
                TUR_CLOSURE_DROP(__t183);
                __t176 = __catch_result_184;
                break;
            }
            default: break;
            }
        }
                int64_t __t185 = (int64_t)(intptr_t)(__t176);
...
static tur_adt_Result__int__int make_hyif_hycaught(int64_t c) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((c) == (INT64_C(0))) {
            tur_handler_node *__b189 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b189->parent = tur_handler_chain; tur_handler_chain = __b189;
            tur_cont *__n189 = (tur_cont*)malloc(sizeof(tur_cont));
            __n189->tag = 3; __n189->boundary = __b189; __n189->next = __k;
            __n189->aggr_mask = 0x0u;
            __n189->saved[0] = (int64_t)(intptr_t)(c);
            __n189->saved[1] = (int64_t)(intptr_t)(__t187);
            __n189->saved[2] = (int64_t)(intptr_t)(__t188);
            __k = __n189; __pc = 2; break;
           } else {
            tur_handler_node *__b190 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b190->parent = tur_handler_chain; tur_handler_chain = __b190;
            tur_cont *__n190 = (tur_cont*)malloc(sizeof(tur_cont));
            __n190->tag = 5; __n190->boundary = __b190; __n190->next = __k;
            __n190->aggr_mask = 0x0u;
            __n190->saved[0] = (int64_t)(intptr_t)(c);
            __n190->saved[1] = (int64_t)(intptr_t)(__t187);
            __n190->saved[2] = (int64_t)(intptr_t)(__t188);
            __k = __n190; __pc = 4; break;
           }
          }
          case 2: {
           tur_panic("boom");
          ...
          case 3: {
           c = (int64_t)(intptr_t)(__k->saved[0]);
           __t187 = (int64_t)(intptr_t)(__k->saved[1]);
           __t188 = (int64_t)(intptr_t)(__k->saved[2]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box189;
           ...
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Result__int__int __caggr189 = (*(tur_adt_Result__int__int *)(intptr_t)(__box189));
           tur_result_box_free((int64_t)(intptr_t)__box189);
           { tur_adt_Result__int__int __rv = (__caggr189); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
          case 4: {
           __v = (int64_t)(intptr_t)(INT64_C(7)); __pc = __k->tag; break;
          ...
          case 5: {
           ...
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box190;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp190 = global_panic_payload; global_panic_payload = 0; __box190 = tur_box_err((int64_t)(intptr_t)__pp190); }
           else { __box190 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Result__int__int __caggr190 = (*(tur_adt_Result__int__int *)(intptr_t)(__box190));
           tur_result_box_free((int64_t)(intptr_t)__box190);
           { tur_adt_Result__int__int __rv = (__caggr190); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Result__int__int __ps_191 = (make_hyif(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int a_1453 = __ps_191;
            (void)a_1453;
            bool __ps_192 = (ok___spec__bool_tur_adt_Result__int__int(a_1453));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_192) {
                puts("if-ok");
            } else {
        ...
        {
            tur_adt_Result__int__int __ps_193 = (make_hyif(INT64_C(1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int b_1454 = __ps_193;
            (void)b_1454;
            bool __ps_194 = (ok___spec__bool_tur_adt_Result__int__int(b_1454));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_194) {
                puts("if-ok2");
            } else {
        ...
        {
            tur_adt_Pick __ps_195 = (ctor_Pick_First());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int __ps_196 = (make_hymatch(__ps_195));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int m_1455 = __ps_196;
            (void)m_1455;
            bool __ps_197 = (ok___spec__bool_tur_adt_Result__int__int(m_1455));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_197) {
                puts("match-ok");
            } else {
        ...
        {
            tur_adt_Result__int__int __ps_198 = (make_hyif_hycaught(INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Result__int__int d_1456 = __ps_198;
            (void)d_1456;
            bool __ps_199 = (err___spec__bool_tur_adt_Result__int__int(d_1456));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_199) {
                puts("caught-err");
            } else {
