...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_267 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_268 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_269 = (ctor_PairD_PairD(__ps_267, __ps_268));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1474 = __ps_269;
            (void)p_1474;
            int64_t __ps_270 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1474))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_271 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1474))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_270) + (__ps_271)));
        }
        {
            int64_t __ps_272 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_273 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_274 = (ctor_World_World(__ps_272, __ps_273));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1475 = __ps_274;
            (void)w_1475;
            int64_t __ps_275 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1475))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_276 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1475))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_275) + (__ps_276)));
        }
        int64_t __t277;
        __t277 = INT64_C(0);
        return (int)__t277;
