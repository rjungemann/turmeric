...
int main(int argc, char **argv) {
        ...
        {
            PairD__int__int p_993 = (PairD__int__int){.fst = dn(INT64_C(7)), .snd = dn(INT64_C(35))};
            (void)p_993;
            printf("%lld\n", (long long)((dense_hy_gtint((p_993).fst)) + (dense_hy_gtint((p_993).snd))));
        }
        {
            World__int__int__int w_994 = (World__int__int__int){.pos = dn(INT64_C(3)), .vel = dn(INT64_C(9))};
            (void)w_994;
            printf("%lld\n", (long long)((dense_hy_gtint((w_994).pos)) + (dense_hy_gtint((w_994).vel))));
        }
        int64_t __t42;
        __t42 = INT64_C(0);
        return (int)__t42;
