...
int main(int argc, char **argv) {
        ...
        {
            PairD__int__int p_1268 = (PairD__int__int){.fst = dn(INT64_C(7)), .snd = dn(INT64_C(35))};
            (void)p_1268;
            printf("%lld\n", (long long)((dense_hy_gtint((p_1268).fst)) + (dense_hy_gtint((p_1268).snd))));
        }
        {
            World__int__int__int w_1269 = (World__int__int__int){.pos = dn(INT64_C(3)), .vel = dn(INT64_C(9))};
            (void)w_1269;
            printf("%lld\n", (long long)((dense_hy_gtint((w_1269).pos)) + (dense_hy_gtint((w_1269).vel))));
        }
        int64_t __t50;
        __t50 = INT64_C(0);
        return (int)__t50;
