...
int main(int argc, char **argv) {
        ...
        {
            PairD__int__int p_907 = (PairD__int__int){.fst = dn(INT64_C(7)), .snd = dn(INT64_C(35))};
            (void)p_907;
            printf("%lld\n", (long long)((dense_hy_gtint((p_907).fst)) + (dense_hy_gtint((p_907).snd))));
        }
        {
            World__int__int__int w_908 = (World__int__int__int){.pos = dn(INT64_C(3)), .vel = dn(INT64_C(9))};
            (void)w_908;
            printf("%lld\n", (long long)((dense_hy_gtint((w_908).pos)) + (dense_hy_gtint((w_908).vel))));
        }
        int64_t __t29;
        __t29 = INT64_C(0);
        return (int)__t29;
