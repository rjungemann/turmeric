...
int main(int argc, char **argv) {
        ...
        {
            PairD__int__int p_887 = (PairD__int__int){.fst = dn(INT64_C(7)), .snd = dn(INT64_C(35))};
            (void)p_887;
            printf("%lld\n", (long long)((dense_hy_gtint((p_887).fst)) + (dense_hy_gtint((p_887).snd))));
        }
        {
            World__int__int__int w_888 = (World__int__int__int){.pos = dn(INT64_C(3)), .vel = dn(INT64_C(9))};
            (void)w_888;
            printf("%lld\n", (long long)((dense_hy_gtint((w_888).pos)) + (dense_hy_gtint((w_888).vel))));
        }
        int64_t __t24;
        __t24 = INT64_C(0);
        return (int)__t24;
