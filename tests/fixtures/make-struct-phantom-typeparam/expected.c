...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_244 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_245 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_246 = (ctor_PairD_PairD(__ps_244, __ps_245));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1476 = __ps_246;
            (void)p_1476;
            int64_t __ps_247 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1476))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_248 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1476))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_247) + (__ps_248)));
        }
        {
            int64_t __ps_249 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_250 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_251 = (ctor_World_World(__ps_249, __ps_250));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1477 = __ps_251;
            (void)w_1477;
            int64_t __ps_252 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1477))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_253 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1477))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_252) + (__ps_253)));
        }
        int64_t __t254;
        __t254 = INT64_C(0);
        return (int)__t254;
