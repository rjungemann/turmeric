...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_163 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_164 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_165 = (ctor_PairD(__ps_163, __ps_164));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1371 = __ps_165;
            (void)p_1371;
            int64_t __ps_166 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1371))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_167 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1371))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_166) + (__ps_167)));
        }
        {
            int64_t __ps_168 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_169 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_170 = (ctor_World(__ps_168, __ps_169));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1372 = __ps_170;
            (void)w_1372;
            int64_t __ps_171 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1372))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_172 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1372))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
