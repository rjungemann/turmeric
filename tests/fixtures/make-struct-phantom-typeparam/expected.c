...
#endif
typedef struct tur_adt_PairD {
    int64_t fst;
    int64_t snd;
} tur_adt_PairD;
typedef tur_adt_PairD PairD;

static int64_t ctor_PairD_PairD(int64_t _0, int64_t _1) {
    tur_adt_PairD *__r = (tur_adt_PairD *)malloc(sizeof(tur_adt_PairD));
    __r->fst = _0;
    TUR_REGION_NOTE_WORDS(&(__r->fst), sizeof(__r->fst));
    __r->snd = _1;
    TUR_REGION_NOTE_WORDS(&(__r->snd), sizeof(__r->snd));
...
#ifndef TUR_CTORALIAS_PairD
#define TUR_CTORALIAS_PairD
#define ctor_PairD ctor_PairD_PairD
#endif
typedef struct tur_adt_World {
    int64_t pos;
    int64_t vel;
} tur_adt_World;
typedef tur_adt_World World;

static int64_t ctor_World_World(int64_t _0, int64_t _1) {
    tur_adt_World *__r = (tur_adt_World *)malloc(sizeof(tur_adt_World));
    __r->pos = _0;
    TUR_REGION_NOTE_WORDS(&(__r->pos), sizeof(__r->pos));
    __r->vel = _1;
    TUR_REGION_NOTE_WORDS(&(__r->vel), sizeof(__r->vel));
    return (int64_t)(intptr_t)__r;
}

#ifndef TUR_CTORALIAS_World
#define TUR_CTORALIAS_World
#define ctor_World ctor_World_World
#endif
...
static int64_t dn(int64_t);
static int64_t dense_hy_gtint(int64_t);
...
static int64_t dn(int64_t v) {
        return v;
}

static int64_t dense_hy_gtint(int64_t d) {
        TUR_REGION_NOTE_WORDS(&(d), sizeof(d));
        return d;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_277 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_278 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_279 = (ctor_PairD_PairD(__ps_277, __ps_278));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1615 = __ps_279;
            (void)p_1615;
            int64_t __ps_280 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1615))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_281 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1615))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_280) + (__ps_281)));
        }
        {
            int64_t __ps_282 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_283 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_284 = (ctor_World_World(__ps_282, __ps_283));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1616 = __ps_284;
            (void)w_1616;
            int64_t __ps_285 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1616))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_286 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1616))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_285) + (__ps_286)));
        }
        int64_t __t287;
        __t287 = INT64_C(0);
        return (int)__t287;
