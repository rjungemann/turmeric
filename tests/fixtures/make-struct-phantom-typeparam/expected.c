...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_160 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_161 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_162 = (ctor_PairD(__ps_160, __ps_161));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1339 = __ps_162;
            (void)p_1339;
            int64_t __ps_163 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1339))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_164 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1339))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_163) + (__ps_164)));
        }
        {
            int64_t __ps_165 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_166 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_167 = (ctor_World(__ps_165, __ps_166));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1340 = __ps_167;
            (void)w_1340;
            int64_t __ps_168 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1340))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_169 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1340))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_168) + (__ps_169)));
        }
        int64_t __t170;
        __t170 = INT64_C(0);
        return (int)__t170;
