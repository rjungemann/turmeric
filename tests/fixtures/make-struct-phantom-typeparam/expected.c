...
int main(int argc, char **argv) {
        ...
        {
            PairD__int__int p_881 = (PairD__int__int){.fst = dn(INT64_C(7)), .snd = dn(INT64_C(35))};
            (void)p_881;
            printf("%lld\n", (long long)((dense_hy_gtint((p_881).fst)) + (dense_hy_gtint((p_881).snd))));
        }
        {
            World__int__int__int w_882 = (World__int__int__int){.pos = dn(INT64_C(3)), .vel = dn(INT64_C(9))};
            (void)w_882;
            printf("%lld\n", (long long)((dense_hy_gtint((w_882).pos)) + (dense_hy_gtint((w_882).vel))));
        }
        int64_t __t21;
        __t21 = INT64_C(0);
        return (int)__t21;
