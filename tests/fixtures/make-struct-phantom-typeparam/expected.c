...
int main(int argc, char **argv) {
        ...
        {
            PairD__int__int p_890 = (PairD__int__int){.fst = dn(INT64_C(7)), .snd = dn(INT64_C(35))};
            (void)p_890;
            printf("%lld\n", (long long)((dense_hy_gtint((p_890).fst)) + (dense_hy_gtint((p_890).snd))));
        }
        {
            World__int__int__int w_891 = (World__int__int__int){.pos = dn(INT64_C(3)), .vel = dn(INT64_C(9))};
            (void)w_891;
            printf("%lld\n", (long long)((dense_hy_gtint((w_891).pos)) + (dense_hy_gtint((w_891).vel))));
        }
        int64_t __t23;
        __t23 = INT64_C(0);
        return (int)__t23;
