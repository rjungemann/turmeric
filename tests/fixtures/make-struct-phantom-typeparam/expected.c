...
int main(int argc, char **argv) {
        ...
        {
            __auto_type __ps_177 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_178 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_179 = (ctor_PairD(__ps_177, __ps_178));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1276 = __ps_179;
            (void)p_1276;
            __auto_type __ps_180 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1276))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_181 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1276))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_180) + (__ps_181)));
        }
        {
            __auto_type __ps_182 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_183 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_184 = (ctor_World(__ps_182, __ps_183));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1277 = __ps_184;
            (void)w_1277;
            __auto_type __ps_185 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1277))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_186 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1277))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_185) + (__ps_186)));
        }
        int64_t __t187;
        __t187 = INT64_C(0);
        return (int)__t187;
