...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_180 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_181 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_182 = (ctor_PairD_PairD(__ps_180, __ps_181));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1445 = __ps_182;
            (void)p_1445;
            int64_t __ps_183 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1445))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_184 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1445))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_183) + (__ps_184)));
        }
        {
            int64_t __ps_185 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_186 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_187 = (ctor_World_World(__ps_185, __ps_186));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1446 = __ps_187;
            (void)w_1446;
            int64_t __ps_188 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1446))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_189 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1446))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_188) + (__ps_189)));
        }
        int64_t __t190;
        __t190 = INT64_C(0);
        return (int)__t190;
