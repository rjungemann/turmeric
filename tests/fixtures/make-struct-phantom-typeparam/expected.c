...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_168 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_169 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_170 = (ctor_PairD_PairD(__ps_168, __ps_169));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1441 = __ps_170;
            (void)p_1441;
            int64_t __ps_171 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1441))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_172 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1441))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_171) + (__ps_172)));
        }
        {
            int64_t __ps_173 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_174 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_175 = (ctor_World_World(__ps_173, __ps_174));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1442 = __ps_175;
            (void)w_1442;
            int64_t __ps_176 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1442))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_177 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1442))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
