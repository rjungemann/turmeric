...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_275 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_276 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_277 = (ctor_PairD_PairD(__ps_275, __ps_276));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1615 = __ps_277;
            (void)p_1615;
            int64_t __ps_278 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1615))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_279 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1615))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_278) + (__ps_279)));
        }
        {
            int64_t __ps_280 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_281 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_282 = (ctor_World_World(__ps_280, __ps_281));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1616 = __ps_282;
            (void)w_1616;
            int64_t __ps_283 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1616))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_284 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1616))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_283) + (__ps_284)));
        }
        int64_t __t285;
        __t285 = INT64_C(0);
        return (int)__t285;
