...
int main(int argc, char **argv) {
        ...
        {
            PairD__int__int p_1271 = (PairD__int__int){.fst = dn(INT64_C(7)), .snd = dn(INT64_C(35))};
            (void)p_1271;
            printf("%lld\n", (long long)((dense_hy_gtint((p_1271).fst)) + (dense_hy_gtint((p_1271).snd))));
        }
        {
            World__int__int__int w_1272 = (World__int__int__int){.pos = dn(INT64_C(3)), .vel = dn(INT64_C(9))};
            (void)w_1272;
            printf("%lld\n", (long long)((dense_hy_gtint((w_1272).pos)) + (dense_hy_gtint((w_1272).vel))));
        }
        int64_t __t55;
        __t55 = INT64_C(0);
        return (int)__t55;
