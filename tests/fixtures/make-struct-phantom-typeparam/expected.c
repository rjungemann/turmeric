...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            __auto_type __ps_153 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_154 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_155 = (ctor_PairD(__ps_153, __ps_154));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1288 = __ps_155;
            (void)p_1288;
            __auto_type __ps_156 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1288))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_157 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1288))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_156) + (__ps_157)));
        }
        {
            __auto_type __ps_158 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_159 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_160 = (ctor_World(__ps_158, __ps_159));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1289 = __ps_160;
            (void)w_1289;
            __auto_type __ps_161 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1289))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_162 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1289))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_161) + (__ps_162)));
        }
        int64_t __t163;
        __t163 = INT64_C(0);
        return (int)__t163;
