...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_264 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_265 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_266 = (ctor_PairD_PairD(__ps_264, __ps_265));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1476 = __ps_266;
            (void)p_1476;
            int64_t __ps_267 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1476))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_268 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1476))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_267) + (__ps_268)));
        }
        {
            int64_t __ps_269 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_270 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_271 = (ctor_World_World(__ps_269, __ps_270));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1477 = __ps_271;
            (void)w_1477;
            int64_t __ps_272 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1477))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_273 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1477))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_272) + (__ps_273)));
        }
        int64_t __t274;
        __t274 = INT64_C(0);
        return (int)__t274;
