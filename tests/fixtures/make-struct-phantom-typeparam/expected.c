...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_179 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_180 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_181 = (ctor_PairD_PairD(__ps_179, __ps_180));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1443 = __ps_181;
            (void)p_1443;
            int64_t __ps_182 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1443))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_183 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1443))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_182) + (__ps_183)));
        }
        {
            int64_t __ps_184 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_185 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_186 = (ctor_World_World(__ps_184, __ps_185));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1444 = __ps_186;
            (void)w_1444;
            int64_t __ps_187 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1444))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_188 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1444))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
