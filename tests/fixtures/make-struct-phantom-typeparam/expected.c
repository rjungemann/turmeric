...
int main(int argc, char **argv) {
        ...
        {
            int64_t p_1273 = ctor_PairD(dn(INT64_C(7)), dn(INT64_C(35)));
            (void)p_1273;
            printf("%lld\n", (long long)((dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1273))->fst)) + (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1273))->snd))));
        }
        {
            int64_t w_1274 = ctor_World(dn(INT64_C(3)), dn(INT64_C(9)));
            (void)w_1274;
            printf("%lld\n", (long long)((dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1274))->pos)) + (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1274))->vel))));
        }
        int64_t __t55;
        __t55 = INT64_C(0);
        return (int)__t55;
