...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_173 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_174 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_175 = (ctor_PairD_PairD(__ps_173, __ps_174));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1615 = __ps_175;
            (void)p_1615;
            int64_t __ps_176 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1615))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_177 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1615))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_176) + (__ps_177)));
        }
        {
            int64_t __ps_178 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_179 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_180 = (ctor_World_World(__ps_178, __ps_179));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1616 = __ps_180;
            (void)w_1616;
            int64_t __ps_181 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1616))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_182 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1616))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_181) + (__ps_182)));
        }
        int64_t __t183;
        __t183 = INT64_C(0);
        return (int)__t183;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_184 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
