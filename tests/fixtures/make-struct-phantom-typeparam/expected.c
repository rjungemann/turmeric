...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            __auto_type __ps_173 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_174 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_175 = (ctor_PairD(__ps_173, __ps_174));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1288 = __ps_175;
            (void)p_1288;
            __auto_type __ps_176 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1288))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_177 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1288))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_176) + (__ps_177)));
        }
        {
            __auto_type __ps_178 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_179 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_180 = (ctor_World(__ps_178, __ps_179));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1289 = __ps_180;
            (void)w_1289;
            __auto_type __ps_181 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1289))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_182 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1289))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
