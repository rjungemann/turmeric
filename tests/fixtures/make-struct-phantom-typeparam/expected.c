...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_172 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_173 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_174 = (ctor_PairD_PairD(__ps_172, __ps_173));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1615 = __ps_174;
            (void)p_1615;
            int64_t __ps_175 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1615))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_176 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1615))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_175) + (__ps_176)));
        }
        {
            int64_t __ps_177 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_178 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_179 = (ctor_World_World(__ps_177, __ps_178));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1616 = __ps_179;
            (void)w_1616;
            int64_t __ps_180 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1616))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_181 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1616))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_180) + (__ps_181)));
        }
        int64_t __t182;
        __t182 = INT64_C(0);
        return (int)__t182;
