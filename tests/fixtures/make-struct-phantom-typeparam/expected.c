...
static int64_t dense_hy_gtint(int64_t d) {
        __auto_type __t183 = (d);
        TUR_REGION_NOTE_WORDS(&(__t183), sizeof(__t183));
        return __t183;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_184 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_185 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_186 = (ctor_PairD_PairD(__ps_184, __ps_185));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1445 = __ps_186;
            (void)p_1445;
            int64_t __ps_187 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1445))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_188 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1445))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_187) + (__ps_188)));
        }
        {
            int64_t __ps_189 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_190 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_191 = (ctor_World_World(__ps_189, __ps_190));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1446 = __ps_191;
            (void)w_1446;
            int64_t __ps_192 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1446))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_193 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1446))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_192) + (__ps_193)));
        }
        int64_t __t194;
        __t194 = INT64_C(0);
        return (int)__t194;
