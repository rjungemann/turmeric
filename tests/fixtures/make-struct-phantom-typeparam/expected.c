...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_232 = (dn(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_233 = (dn(INT64_C(35)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_234 = (ctor_PairD_PairD(__ps_232, __ps_233));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1472 = __ps_234;
            (void)p_1472;
            int64_t __ps_235 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1472))->fst));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_236 = (dense_hy_gtint((int64_t)((tur_adt_PairD *)(intptr_t)(p_1472))->snd));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_235) + (__ps_236)));
        }
        {
            int64_t __ps_237 = (dn(INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_238 = (dn(INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_239 = (ctor_World_World(__ps_237, __ps_238));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t w_1473 = __ps_239;
            (void)w_1473;
            int64_t __ps_240 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1473))->pos));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_241 = (dense_hy_gtint((int64_t)((tur_adt_World *)(intptr_t)(w_1473))->vel));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)((__ps_240) + (__ps_241)));
        }
        int64_t __t242;
        __t242 = INT64_C(0);
        return (int)__t242;
