...
int main(int argc, char **argv) {
        ...
        __t7[1] = (int64_t)(intptr_t)__fn_864;
        void *__t8 = __t7;
        printf("%g\n", (double)(run_float((int64_t)(intptr_t)(__t8), 3.5)));
        int64_t *__t9 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t9[0] = (int64_t)(intptr_t)__tur_fatshim0;
        __t9[1] = (int64_t)(intptr_t)__fn_866;
        void *__t10 = __t9;
        printf("%lld\n", (long long)(run_nullary((int64_t)(intptr_t)(__t10))));
        int64_t *__t11 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t11[0] = (int64_t)(intptr_t)__tur_fatshim_int64_t_const_char__;
        __t11[1] = (int64_t)(intptr_t)__fn_869;
        void *__t12 = __t11;
        printf("%lld\n", (long long)(run_cstr((int64_t)(intptr_t)(__t12), "hello")));
        int64_t __t13;
        __t13 = INT64_C(0);
        return (int)__t13;
}
