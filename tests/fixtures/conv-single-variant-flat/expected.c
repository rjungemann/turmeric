...
static int64_t sum(tur_adt_S s) {
        int64_t __t181 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1273 = (int64_t)__scrut.a;
                int64_t b_1274 = (int64_t)__scrut.b;
                __t181 = (a_1273) + (b_1274);
                goto ____t182;
            }
            ____t182:;
        }
...
int main(int argc, char **argv) {
        ...
        int64_t __t183;
        {
            __auto_type __ps_184 = (ctor_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1275 = __ps_184;
            (void)s_1275;
            __auto_type __ps_185 = (sum(s_1275));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_185));
            int64_t __t186;
            __t186 = INT64_C(0);
