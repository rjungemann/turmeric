...
static int64_t sum(tur_adt_S s) {
        int64_t __t160 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1334 = (int64_t)__scrut.a;
                int64_t b_1335 = (int64_t)__scrut.b;
                __t160 = (a_1334) + (b_1335);
                goto ____t161;
            }
            ____t161:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t162;
        {
            tur_adt_S __ps_163 = (ctor_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1336 = __ps_163;
            (void)s_1336;
            int64_t __ps_164 = (sum(s_1336));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_164));
            int64_t __t165;
            __t165 = INT64_C(0);
