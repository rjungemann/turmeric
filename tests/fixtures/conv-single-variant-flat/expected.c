...
static int64_t sum(tur_adt_S s) {
        int64_t __t264 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1471 = (int64_t)__scrut.a;
                int64_t b_1472 = (int64_t)__scrut.b;
                __t264 = (a_1471) + (b_1472);
                goto ____t265;
            }
            ____t265:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t266;
        {
            tur_adt_S __ps_267 = (ctor_S_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1473 = __ps_267;
            (void)s_1473;
            int64_t __ps_268 = (sum(s_1473));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_268));
            int64_t __t269;
            __t269 = INT64_C(0);
