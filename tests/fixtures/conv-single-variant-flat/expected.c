...
static int64_t sum(tur_adt_S s) {
        int64_t __t275 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1610 = (int64_t)__scrut.a;
                int64_t b_1611 = (int64_t)__scrut.b;
                __t275 = (a_1610) + (b_1611);
                goto ____t276;
            }
            ____t276:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t277;
        {
            tur_adt_S __ps_278 = (ctor_S_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1612 = __ps_278;
            (void)s_1612;
            int64_t __ps_279 = (sum(s_1612));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_279));
            int64_t __t280;
            __t280 = INT64_C(0);
