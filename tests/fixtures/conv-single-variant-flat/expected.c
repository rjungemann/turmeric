...
static int64_t sum(tur_adt_S s) {
        int64_t __t267 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1469 = (int64_t)__scrut.a;
                int64_t b_1470 = (int64_t)__scrut.b;
                __t267 = (a_1469) + (b_1470);
                goto ____t268;
            }
            ____t268:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t269;
        {
            tur_adt_S __ps_270 = (ctor_S_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1471 = __ps_270;
            (void)s_1471;
            int64_t __ps_271 = (sum(s_1471));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_271));
            int64_t __t272;
            __t272 = INT64_C(0);
