...
static int64_t sum(tur_adt_S s) {
        int64_t __t232 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1467 = (int64_t)__scrut.a;
                int64_t b_1468 = (int64_t)__scrut.b;
                __t232 = (a_1467) + (b_1468);
                goto ____t233;
            }
            ____t233:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t234;
        {
            tur_adt_S __ps_235 = (ctor_S_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1469 = __ps_235;
            (void)s_1469;
            int64_t __ps_236 = (sum(s_1469));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_236));
            int64_t __t237;
            __t237 = INT64_C(0);
