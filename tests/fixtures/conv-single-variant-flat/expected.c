...
static int64_t sum(tur_adt_S s) {
        int64_t __t155 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1304 = (int64_t)__scrut.a;
                int64_t b_1305 = (int64_t)__scrut.b;
                __t155 = (a_1304) + (b_1305);
                goto ____t156;
            }
            ____t156:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t157;
        {
            __auto_type __ps_158 = (ctor_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1306 = __ps_158;
            (void)s_1306;
            __auto_type __ps_159 = (sum(s_1306));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_159));
            int64_t __t160;
            __t160 = INT64_C(0);
