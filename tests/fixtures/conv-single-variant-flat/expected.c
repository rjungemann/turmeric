...
static int64_t sum(tur_adt_S s) {
        int64_t __t159 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1330 = (int64_t)__scrut.a;
                int64_t b_1331 = (int64_t)__scrut.b;
                __t159 = (a_1330) + (b_1331);
                goto ____t160;
            }
            ____t160:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t161;
        {
            tur_adt_S __ps_162 = (ctor_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1332 = __ps_162;
            (void)s_1332;
            int64_t __ps_163 = (sum(s_1332));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_163));
            int64_t __t164;
            __t164 = INT64_C(0);
