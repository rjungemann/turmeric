...
static int64_t sum(tur_adt_S s) {
        int64_t __t173 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1283 = (int64_t)__scrut.a;
                int64_t b_1284 = (int64_t)__scrut.b;
                __t173 = (a_1283) + (b_1284);
                goto ____t174;
            }
            ____t174:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t175;
        {
            __auto_type __ps_176 = (ctor_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1285 = __ps_176;
            (void)s_1285;
            __auto_type __ps_177 = (sum(s_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            int64_t __t178;
            __t178 = INT64_C(0);
