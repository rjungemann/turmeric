...
static int64_t sum(tur_adt_S s) {
        int64_t __t163 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1370 = (int64_t)__scrut.a;
                int64_t b_1371 = (int64_t)__scrut.b;
                __t163 = (a_1370) + (b_1371);
                goto ____t164;
            }
            ____t164:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t165;
        {
            tur_adt_S __ps_166 = (ctor_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1372 = __ps_166;
            (void)s_1372;
            int64_t __ps_167 = (sum(s_1372));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_167));
            int64_t __t168;
            __t168 = INT64_C(0);
