...
static int64_t sum(tur_adt_S s) {
        int64_t __t179 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1438 = (int64_t)__scrut.a;
                int64_t b_1439 = (int64_t)__scrut.b;
                __t179 = (a_1438) + (b_1439);
                goto ____t180;
            }
            ____t180:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t181;
        {
            tur_adt_S __ps_182 = (ctor_S_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1440 = __ps_182;
            (void)s_1440;
            int64_t __ps_183 = (sum(s_1440));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_183));
            int64_t __t184;
            __t184 = INT64_C(0);
