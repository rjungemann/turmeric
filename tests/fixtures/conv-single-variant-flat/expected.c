...
static int64_t sum(tur_adt_S s) {
        int64_t __t180 = 0;
        {
            tur_adt_S __scrut = (s);
            {
                int64_t a_1440 = (int64_t)__scrut.a;
                int64_t b_1441 = (int64_t)__scrut.b;
                __t180 = (a_1440) + (b_1441);
                goto ____t181;
            }
            ____t181:;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t182;
        {
            tur_adt_S __ps_183 = (ctor_S_S(INT64_C(10), INT64_C(32)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_S s_1442 = __ps_183;
            (void)s_1442;
            int64_t __ps_184 = (sum(s_1442));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_184));
            int64_t __t185;
            __t185 = INT64_C(0);
