...
static int64_t list_hy_gtvec();
static int64_t list_slvec();
static int64_t list_hyvec();
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_155 = (list_hy_gtvec());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_155));
        __auto_type __ps_156 = (list_slvec());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_156));
        __auto_type __ps_157 = (list_hyvec());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_157));
        int64_t __t158;
        __t158 = INT64_C(0);
