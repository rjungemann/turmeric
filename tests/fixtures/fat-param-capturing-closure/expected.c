...
static void * make_adder(int64_t n) {
        struct __env_865 *__t7 = (struct __env_865 *)malloc(sizeof(struct __env_865));
        __t7->__fn = (tur_thunk_int64_t_int64_t_t)__fn_863;
        __t7->n = n;
        void *__t8 = __t7;
        return __t8;
}
...
static void * make_scale(double k) {
        struct __env_872 *__t9 = (struct __env_872 *)malloc(sizeof(struct __env_872));
        __t9->__fn = (tur_thunk_double_double_t)__fn_870;
        __t9->k = k;
        void *__t10 = __t9;
        return __t10;
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            int64_t *__t11 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t11[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t11[1] = (int64_t)(intptr_t)__fn_878;
            void *__t12 = __t11;
            printf("%lld\n", (long long)(apply_int((int64_t)(intptr_t)(__t12), INT64_C(5))));
            {
                int64_t n_880 = INT64_C(100);
                (void)n_880;
                struct __env_884 *__t13 = (struct __env_884 *)malloc(sizeof(struct __env_884));
                __t13->__fn = (tur_thunk_int64_t_int64_t_t)__fn_882;
                __t13->n = n_880;
                void *__t14 = __t13;
                printf("%lld\n", (long long)(apply_int((int64_t)(intptr_t)(__t14), INT64_C(5))));
            }
