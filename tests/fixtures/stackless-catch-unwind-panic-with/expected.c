...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1080 = (int64_t)(intptr_t)(__ps_114);
                (void)out_1080;
                __t109 = out_1080;
            }
            __t107 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1087 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1087;
                __t117 = out_1087;
            }
            __t115 = __t117;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t126;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1162 = __ps_128;
            (void)iter_1162;
            void * __ps_129 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_130 = (hamt_slkeyeq((void *)(intptr_t)(__ps_129)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1163 = __ps_130;
            (void)keyeq_1163;
            void * __ps_131 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_132 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1162), (void *)(intptr_t)(__ps_131), (void *)(intptr_t)(keyeq_1163)));
            if (tur_panicking) return ((bool)0);
            bool result_1164 = __ps_132;
            (void)result_1164;
        ...
        if ((i) == (cap)) {
            ...
            if (__ps_140) {
                ...
                if (__ps_144) {
                    ...
                    if (tur_panicking) return ((bool)0);
                    bool __ps_150 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_146, __ps_149));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_150) {
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t153;
        {
            ...
            {
                tur_adt_Vec__int * __ps_155 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1291));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1292 = __ps_155;
                (void)_un_unv_1292;
        ...
        int64_t __ps_157 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t153))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_157;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_158 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_158);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1342 = __ps_160;
            (void)r_1342;
            int64_t __t161;
            bool __ps_162 = (schema_hydecode_hyok_qu(r_1342));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_162) {
                int64_t __ps_163 = (schema_hydecode_hyvalue(r_1342));
                if (tur_panicking) return ((int64_t)0);
                __t161 = __ps_163;
            } else {
                int64_t __ps_164 = (schema_hydecode_hyerrors(r_1342));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_165 = (schema_hydecode_hyabort(__ps_164));
                if (tur_panicking) return ((int64_t)0);
                __t161 = __ps_165;
            }
            __t159 = __t161;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_166 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_166;
}
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            tur_handler_node *__b169 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b169->parent = tur_handler_chain; tur_handler_chain = __b169;
            tur_cont *__n169 = (tur_cont*)malloc(sizeof(tur_cont));
            __n169->tag = 3; __n169->boundary = __b169; __n169->next = __k;
            __n169->aggr_mask = 0x0u;
            __n169->saved[0] = (int64_t)(intptr_t)(n);
            __n169->saved[1] = (int64_t)(intptr_t)(r_1366);
            __n169->saved[2] = (int64_t)(intptr_t)(__t167);
            __n169->saved[3] = (int64_t)(intptr_t)(__t168);
            __k = __n169; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic_with(3, (void*)INT64_C(42), __FILE__, __LINE__);
          ...
          case 3: {
           ...
           r_1366 = (int64_t)(intptr_t)(__k->saved[1]);
           __t167 = (int64_t)(intptr_t)(__k->saved[2]);
           __t168 = (int64_t)(intptr_t)(__k->saved[3]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box169;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp169 = global_panic_payload; global_panic_payload = 0; __box169 = tur_box_err((int64_t)(intptr_t)__pp169); }
           else { __box169 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           r_1366 = __box169;
           bool __ps_170 = (err_qu(r_1366));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_170) {
            tur_cont *__n171 = (tur_cont*)malloc(sizeof(tur_cont));
            __n171->tag = 4; __n171->boundary = 0; __n171->next = __k;
            __n171->aggr_mask = 0x0u;
            __n171->saved[0] = (int64_t)(intptr_t)(n);
            __n171->saved[1] = (int64_t)(intptr_t)(r_1366);
            __n171->saved[2] = (int64_t)(intptr_t)(__t167);
            __n171->saved[3] = (int64_t)(intptr_t)(__t168);
            int64_t __ra171_0 = ((n) - (INT64_C(1)));
            n = __ra171_0;
            __k = __n171; __pc = 1; break;
           } else {
          ...
          case 4: {
           ...
           __t167 = (int64_t)(intptr_t)(__k->saved[2]);
           __t168 = (int64_t)(intptr_t)(__k->saved[3]);
           __t168 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t168)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_172 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_172));
        int64_t __t173;
        __t173 = INT64_C(0);
