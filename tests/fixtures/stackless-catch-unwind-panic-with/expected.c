         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n180->saved[1] = (int64_t)(intptr_t)(r_1610);
          ...
          case 3: {
           ...
           r_1610 = __box180;
           bool __ps_181 = (err_qu(r_1610));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_181) {
            tur_cont *__n182 = (tur_cont*)malloc(sizeof(tur_cont));
            __n182->tag = 4; __n182->boundary = 0; __n182->next = __k;
            __n182->aggr_mask = 0x0u;
            __n182->saved[0] = (int64_t)(intptr_t)(n);
            __n182->saved[1] = (int64_t)(intptr_t)(r_1610);
            __n182->saved[2] = (int64_t)(intptr_t)(__t178);
            __n182->saved[3] = (int64_t)(intptr_t)(__t179);
            int64_t __ra182_0 = ((n) - (INT64_C(1)));
            n = __ra182_0;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_185 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
