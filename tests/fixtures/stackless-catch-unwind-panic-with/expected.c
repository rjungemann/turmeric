         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            tur_handler_node *__b157 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b157->parent = tur_handler_chain; tur_handler_chain = __b157;
            tur_cont *__n157 = (tur_cont*)malloc(sizeof(tur_cont));
            __n157->tag = 3; __n157->boundary = __b157; __n157->next = __k;
            __n157->aggr_mask = 0x0u;
            __n157->saved[0] = (int64_t)(intptr_t)(n);
            __n157->saved[1] = (int64_t)(intptr_t)(r_1304);
            __n157->saved[2] = (int64_t)(intptr_t)(__t155);
            __n157->saved[3] = (int64_t)(intptr_t)(__t156);
            __k = __n157; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic_with(3, (void*)INT64_C(42), __FILE__, __LINE__);
          ...
          case 3: {
           ...
           r_1304 = (int64_t)(intptr_t)(__k->saved[1]);
           __t155 = (int64_t)(intptr_t)(__k->saved[2]);
           __t156 = (int64_t)(intptr_t)(__k->saved[3]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box157;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp157 = global_panic_payload; global_panic_payload = 0; __box157 = tur_box_err((int64_t)(intptr_t)__pp157); }
           else { __box157 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           r_1304 = __box157;
           bool __ps_158 = (err_qu(r_1304));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_158) {
            tur_cont *__n159 = (tur_cont*)malloc(sizeof(tur_cont));
            __n159->tag = 4; __n159->boundary = 0; __n159->next = __k;
            __n159->aggr_mask = 0x0u;
            __n159->saved[0] = (int64_t)(intptr_t)(n);
          ...
          case 4: {
           ...
           __t155 = (int64_t)(intptr_t)(__k->saved[2]);
           __t156 = (int64_t)(intptr_t)(__k->saved[3]);
           __t156 = (int64_t)(intptr_t)(__v);
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t156)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_160 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_160));
        int64_t __t161;
        __t161 = INT64_C(0);
