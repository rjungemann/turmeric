...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_161) {
            ...
            int64_t __t162;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_166 = (_un_uncons_hyfmap(__ps_165, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                ...
                int64_t out_1135 = (int64_t)(intptr_t)(__ps_167);
                (void)out_1135;
                __t162 = out_1135;
            }
            __t160 = __t162;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_169) {
            ...
            int64_t __t170;
            {
                int64_t __ps_171 = (list_hyhead(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_172 = (list_hytail(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_173 = (list_hyconcat(__ps_172, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_174 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_171, __ps_173));
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_174), sizeof(__ps_174));
                int64_t out_1142 = (int64_t)(intptr_t)(__ps_174);
                (void)out_1142;
                __t170 = out_1142;
            }
            __t168 = __t170;
...
static int64_t car(int64_t l) {
        int64_t __ps_175 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_175;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_176 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_176;
}

static bool null_qu(int64_t l) {
        bool __ps_177 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_177;
}

static int64_t length(int64_t l) {
        int64_t __ps_178 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_178;
}
        ...
        if (__ps_179) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1213 = __ps_180;
                (void)h_1213;
                void * __ps_181 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1214 = __ps_181;
                (void)k_1214;
                bool __ps_182 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1213, (void *)(intptr_t)(k_1214), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_182) {
                    void * __t183 = iter;
                    void * __t184 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t186;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1217 = __ps_188;
            (void)iter_1217;
            void * __ps_189 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_190 = (hamt_slkeyeq((void *)(intptr_t)(__ps_189)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1218 = __ps_190;
            (void)keyeq_1218;
            void * __ps_191 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_192 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1217), (void *)(intptr_t)(__ps_191), (void *)(intptr_t)(keyeq_1218)));
            if (tur_panicking) return ((bool)0);
            bool result_1219 = __ps_192;
            (void)result_1219;
        ...
        if ((i) == (cap)) {
            ...
            if (__ps_200) {
                ...
                if (__ps_204) {
                    ...
                    if (tur_panicking) return ((bool)0);
                    bool __ps_210 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_206, __ps_209));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_210) {
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t213;
        {
            ...
            {
                tur_adt_Vec__int * __ps_215 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1349));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1350 = __ps_215;
                (void)_un_unv_1350;
        ...
        int64_t __ps_217 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t213))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_217;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_218 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_218);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t219;
        {
            int64_t __ps_220 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1400 = __ps_220;
            (void)r_1400;
            int64_t __t221;
            bool __ps_222 = (schema_hydecode_hyok_qu(r_1400));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_222) {
                int64_t __ps_223 = (schema_hydecode_hyvalue(r_1400));
                if (tur_panicking) return ((int64_t)0);
                __t221 = __ps_223;
            } else {
                int64_t __ps_224 = (schema_hydecode_hyerrors(r_1400));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_225 = (schema_hydecode_hyabort(__ps_224));
                if (tur_panicking) return ((int64_t)0);
                __t221 = __ps_225;
            }
            __t219 = __t221;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_226 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_226;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t227;
        {
            int64_t __ps_228 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1459 = __ps_228;
            (void)m_1459;
            int64_t __ps_229 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1460 = __ps_229;
            (void)r_1460;
            bool __ps_230 = (bt_hyundo_hyto_ex(m_1459));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_230);
            int64_t __t231;
            __t231 = r_1460;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            tur_handler_node *__b239 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b239->parent = tur_handler_chain; tur_handler_chain = __b239;
            tur_cont *__n239 = (tur_cont*)malloc(sizeof(tur_cont));
            __n239->tag = 3; __n239->boundary = __b239; __n239->next = __k;
            __n239->aggr_mask = 0x0u;
            __n239->saved[0] = (int64_t)(intptr_t)(n);
            __n239->saved[1] = (int64_t)(intptr_t)(r_1467);
            __n239->saved[2] = (int64_t)(intptr_t)(__t237);
            __n239->saved[3] = (int64_t)(intptr_t)(__t238);
            __k = __n239; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic_with(3, (void*)INT64_C(42), __FILE__, __LINE__);
          ...
          case 3: {
           ...
           r_1467 = (int64_t)(intptr_t)(__k->saved[1]);
           __t237 = (int64_t)(intptr_t)(__k->saved[2]);
           __t238 = (int64_t)(intptr_t)(__k->saved[3]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box239;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp239 = global_panic_payload; global_panic_payload = 0; __box239 = tur_box_err((int64_t)(intptr_t)__pp239); }
           else { __box239 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           r_1467 = __box239;
           bool __ps_240 = (err_qu(r_1467));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_240) {
            tur_cont *__n241 = (tur_cont*)malloc(sizeof(tur_cont));
            __n241->tag = 4; __n241->boundary = 0; __n241->next = __k;
            __n241->aggr_mask = 0x0u;
            __n241->saved[0] = (int64_t)(intptr_t)(n);
            __n241->saved[1] = (int64_t)(intptr_t)(r_1467);
            __n241->saved[2] = (int64_t)(intptr_t)(__t237);
            __n241->saved[3] = (int64_t)(intptr_t)(__t238);
            int64_t __ra241_0 = ((n) - (INT64_C(1)));
            n = __ra241_0;
            __k = __n241; __pc = 1; break;
           } else {
            tur_result_box_free((int64_t)(intptr_t)r_1467);
          ...
          case 4: {
           ...
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)r_1467);
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t238)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_242 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_242));
        int64_t __t243;
        __t243 = INT64_C(0);
