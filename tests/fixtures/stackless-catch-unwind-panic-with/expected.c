...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t259;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1464 = __ps_261;
            (void)r_1464;
            bool __ps_262 = (bt_hyundo_hyto_ex(m_1463));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_262);
            int64_t __t263;
            __t263 = r_1464;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            tur_handler_node *__b271 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b271->parent = tur_handler_chain; tur_handler_chain = __b271;
            tur_cont *__n271 = (tur_cont*)malloc(sizeof(tur_cont));
            __n271->tag = 3; __n271->boundary = __b271; __n271->next = __k;
            __n271->aggr_mask = 0x0u;
            __n271->saved[0] = (int64_t)(intptr_t)(n);
            __n271->saved[1] = (int64_t)(intptr_t)(r_1471);
            __n271->saved[2] = (int64_t)(intptr_t)(__t269);
            __n271->saved[3] = (int64_t)(intptr_t)(__t270);
            __k = __n271; __pc = 2; break;
           }
          }
          case 2: {
           tur_panic_with(3, (void*)INT64_C(42), __FILE__, __LINE__);
          ...
          case 3: {
           ...
           r_1471 = (int64_t)(intptr_t)(__k->saved[1]);
           __t269 = (int64_t)(intptr_t)(__k->saved[2]);
           __t270 = (int64_t)(intptr_t)(__k->saved[3]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box271;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp271 = global_panic_payload; global_panic_payload = 0; __box271 = tur_box_err((int64_t)(intptr_t)__pp271); }
           else { __box271 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           r_1471 = __box271;
           bool __ps_272 = (err_qu(r_1471));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_272) {
            tur_cont *__n273 = (tur_cont*)malloc(sizeof(tur_cont));
            __n273->tag = 4; __n273->boundary = 0; __n273->next = __k;
            __n273->aggr_mask = 0x0u;
            __n273->saved[0] = (int64_t)(intptr_t)(n);
            __n273->saved[1] = (int64_t)(intptr_t)(r_1471);
            __n273->saved[2] = (int64_t)(intptr_t)(__t269);
            __n273->saved[3] = (int64_t)(intptr_t)(__t270);
            int64_t __ra273_0 = ((n) - (INT64_C(1)));
            n = __ra273_0;
            __k = __n273; __pc = 1; break;
           } else {
            tur_result_box_free((int64_t)(intptr_t)r_1471);
          ...
          case 4: {
           ...
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)r_1471);
           __v = (int64_t)(intptr_t)((INT64_C(1)) + (__t270)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_274 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_274));
        int64_t __t275;
        __t275 = INT64_C(0);
