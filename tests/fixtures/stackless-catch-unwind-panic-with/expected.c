...
static bool err_qu(int64_t r) {
        bool __t88 = 0;
        {
            ...
            switch (__scrut ? __scrut->tag : 0) {
            case 0: {
                int64_t _un_1117 = (int64_t)__scrut->as.Ok._0;
                __t88 = false;
                break;
            }
            case 1: {
                int64_t _un_1118 = (int64_t)__scrut->as.Err._0;
                __t88 = true;
                break;
            }
            default: break;
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           if (__ps_180) {
            ...
            __n181->saved[1] = (int64_t)(intptr_t)(r_1623);
