...
static bool classify(int64_t);
static int64_t add_hyone(int64_t);
...
static bool __fn_892(int64_t v) {
        return (v) > (INT64_C(0));
}
...
static bool classify(int64_t n) {
        bool __t25 = __fn_892(n);
        bool __t26 = (bool)dk_run(dk_shift(1, __dk_abort_body, (intptr_t)(__t25), dk_prompt(1, dk_done())), 0);
        return __t26;
}

static int64_t add_hyone(int64_t n) {
        int64_t __t27 = __fn_896(n);
...
int main(int argc, char **argv) {
        ...
        if (classify(INT64_C(5))) {
            printf("%lld\n", (long long)(INT64_C(1)));
        } else {
            printf("%lld\n", (long long)(INT64_C(0)));
        }
        if (classify(INT64_C(-3))) {
            printf("%lld\n", (long long)(INT64_C(1)));
        } else {
            printf("%lld\n", (long long)(INT64_C(0)));
        }
        printf("%lld\n", (long long)(add_hyone(INT64_C(41))));
        int64_t __t29;
        __t29 = INT64_C(0);
        return (int)__t29;
}
