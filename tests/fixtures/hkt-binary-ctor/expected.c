...
static int64_t __bimap_pair(int64_t, int64_t, int64_t);
static int64_t inc(int64_t);
static int64_t negate(int64_t);
...
static int64_t __inst_Bifunctor_bimap_pair(int64_t container, int64_t fn_left, int64_t fn_right) {
...
static int64_t __pair_fst(int64_t p) {
        return ((struct { int64_t fst; int64_t snd; } *)(intptr_t)p)->fst;
  
}

static int64_t __pair_snd(int64_t p) {
        return ((struct { int64_t fst; int64_t snd; } *)(intptr_t)p)->snd;
  
}

static int64_t __bimap_pair(int64_t container, int64_t fn_left, int64_t fn_right) {
...
int main() {
        int64_t __t0;
        {
            int64_t p_635 = __pair_make(INT64_C(10), INT64_C(20));
            (void)p_635;
            int64_t __t1;
            {
                int64_t mapped_636 = __bimap_pair(p_635, (int64_t)(intptr_t)(inc), (int64_t)(intptr_t)(negate));
                (void)mapped_636;
                printf("%lld\n", (long long)(__pair_fst(mapped_636)));
                printf("%lld\n", (long long)(__pair_snd(mapped_636)));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
