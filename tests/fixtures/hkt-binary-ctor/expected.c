...
int main() {
        int64_t __t0;
        {
            int64_t p_227 = __pair_make(INT64_C(10), INT64_C(20));
            (void)p_227;
            int64_t __t1;
            {
                int64_t mapped_228 = __bimap_pair(p_227, (int64_t)(intptr_t)(inc), (int64_t)(intptr_t)(negate));
                (void)mapped_228;
                printf("%lld\n", (long long)(__pair_fst(mapped_228)));
                printf("%lld\n", (long long)(__pair_snd(mapped_228)));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
