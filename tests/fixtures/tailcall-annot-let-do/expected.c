...
static int64_t sum_hyto(int64_t, int64_t);
static int64_t count_hydo(int64_t, int64_t);
...
static int64_t sum_hyto(int64_t n, int64_t acc) {
        __tur_tailcall:;
        if ((n) == (INT64_C(0))) {
            return acc;
        } else {
            {
                int64_t next_1610 = (n) - (INT64_C(1));
                (void)next_1610;
                int64_t more_1611 = (acc) + (n);
                (void)more_1611;
                int64_t __t277 = next_1610;
                int64_t __t278 = more_1611;
                n = __t277;
                acc = __t278;
                goto __tur_tailcall;
            }
...
static int64_t count_hydo(int64_t n, int64_t acc) {
        __tur_tailcall:;
        if ((n) == (INT64_C(0))) {
            return acc;
        } else {
            printf("%lld\n", (long long)(acc));
            int64_t __t279 = (n) - (INT64_C(1));
            int64_t __t280 = (acc) + (INT64_C(1));
            n = __t279;
            acc = __t280;
            goto __tur_tailcall;
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_281 = (sum_hyto(INT64_C(100), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_281));
        int64_t __ps_282 = (count_hydo(INT64_C(3), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_282));
        int64_t __t283;
        __t283 = INT64_C(0);
