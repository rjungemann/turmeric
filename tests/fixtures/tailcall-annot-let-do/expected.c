...
static int64_t sum_hyto(int64_t n, int64_t acc) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            {
                int64_t next_1611 = (n) - (INT64_C(1));
                (void)next_1611;
                int64_t more_1612 = (acc) + (n);
                (void)more_1612;
                int64_t __t172 = next_1611;
                int64_t __t173 = more_1612;
                n = __t172;
                acc = __t173;
                goto __tur_tailcall;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_176 = (sum_hyto(INT64_C(100), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        int64_t __ps_177 = (count_hydo(INT64_C(3), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        int64_t __t178;
        __t178 = INT64_C(0);
