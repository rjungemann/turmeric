...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * s_213 = (const char *)__effect_args[0];
    int64_t k_214 = __k;
    puts(s_213);
    int64_t __t2;
    int64_t __t3 = tur_effect_cont_resume((int64_t)(intptr_t)k_214, (int64_t)0);
    __t2 = __t3;
    return (int64_t)__t2;
}
...
static void __handle_body_0(void) {
    ...
    int64_t __t5[1];
    __t5[0] = (int64_t)"world";
    tur_effect_perform("Write", __t5, 1);
