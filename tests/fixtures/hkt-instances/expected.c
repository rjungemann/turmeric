...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_841 = __ps_124;
        bool __ps_125 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_840, (void *)(intptr_t)(k_841), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_125;
        if (__t1) {
            int64_t __ps_126 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_127 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_840, (void *)(intptr_t)(k_841), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t129;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_845 = __ps_131;
            (void)iter_845;
            void * __ps_132 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_133 = (hamt_slkeyeq((void *)(intptr_t)(__ps_132)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_846 = __ps_133;
            (void)keyeq_846;
            void * __ps_134 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_135 = (map_hyeq_hyloop((void *)(intptr_t)(iter_845), (void *)(intptr_t)(__ps_134), (void *)(intptr_t)(keyeq_846), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_847 = __ps_135;
            (void)result_847;
        ...
        if (__ps_154) {
            bool __t155;
            {
                ...
                if ((t1_1125) == (INT64_C(0))) {
                    __t156 = (t2_1126) == (INT64_C(0));
                } else {
                    bool __t157;
                    if ((t2_1126) == (INT64_C(0))) {
                        __t157 = false;
                    } else {
                        bool __ps_158 = (cons_hyeq_hygo(t1_1125, t2_1126));
                        if (tur_panicking) return ((bool)0);
                        __t157 = __ps_158;
                    }
                    __t156 = __t157;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_164) {
            ...
            int64_t __t165;
            {
                ...
                int64_t out_1141 = (int64_t)(intptr_t)(__ps_169);
                (void)out_1141;
                __t165 = out_1141;
            }
            __t163 = __t165;
        ...
        if (__ps_174) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1212 = __ps_175;
                (void)h_1212;
                void * __ps_176 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1213 = __ps_176;
                (void)k_1213;
                bool __ps_177 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1212, (void *)(intptr_t)(k_1213), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_177) {
                    void * __t178 = iter;
                    void * __t179 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t181;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1216 = __ps_183;
            (void)iter_1216;
            void * __ps_184 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_185 = (hamt_slkeyeq((void *)(intptr_t)(__ps_184)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1217 = __ps_185;
            (void)keyeq_1217;
            void * __ps_186 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_187 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1216), (void *)(intptr_t)(__ps_186), (void *)(intptr_t)(keyeq_1217)));
            if (tur_panicking) return ((bool)0);
            bool result_1218 = __ps_187;
            (void)result_1218;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t208;
        {
            ...
            {
                tur_adt_Vec__int * __ps_210 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1348));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1349 = __ps_210;
                (void)_un_unv_1349;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t214;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1399 = __ps_215;
            (void)r_1399;
            int64_t __t216;
            bool __ps_217 = (schema_hydecode_hyok_qu(r_1399));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_217) {
                int64_t __ps_218 = (schema_hydecode_hyvalue(r_1399));
                if (tur_panicking) return ((int64_t)0);
                __t216 = __ps_218;
            } else {
                int64_t __ps_219 = (schema_hydecode_hyerrors(r_1399));
                if (tur_panicking) return ((int64_t)0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_232 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_233 = (vec_new__spec__tur_adt_Vec__int__());
