...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t14;
        {
            ...
            bool __t15;
            if ((t1_970) == (INT64_C(0))) {
                __t15 = (t2_971) == (INT64_C(0));
            } else {
                bool __t16;
                if ((t2_971) == (INT64_C(0))) {
                    __t16 = false;
                } else {
                    __t16 = cons_hyeq_hygo(t1_970, t2_971);
                }
                __t15 = __t16;
            }
            __t14 = __t15;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t17) {
            ...
            __t18[1] = (int64_t)(intptr_t)__fn_1098;
            void *__t19 = __t18;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__inst_Eq_eq_qu_int(((Cons *)(intptr_t)(c1))->head, ((Cons *)(intptr_t)(c2))->head)) {
            bool __t32;
            {
                int64_t t1_965 = ((Cons *)(intptr_t)(c1))->tail;
                (void)t1_965;
                int64_t t2_966 = ((Cons *)(intptr_t)(c2))->tail;
                (void)t2_966;
                bool __t33;
                if ((t1_965) == (INT64_C(0))) {
                    __t33 = (t2_966) == (INT64_C(0));
                } else {
                    bool __t34;
                    if ((t2_966) == (INT64_C(0))) {
                        __t34 = false;
                    } else {
                        __t34 = cons_hyeq_hygo(t1_965, t2_966);
                    }
                    __t33 = __t34;
                }
                __t32 = __t33;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t53;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1225)) {
                __t54 = schema_hydecode_hyvalue(r_1225);
            } else {
                __t54 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1225));
            }
            __t53 = __t54;
        }
        return __t53;
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t55 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t55 = (Cons__int){.head = h, .tail = t};
        return __t55;
}
