...
static bool __fn_746(int64_t, int64_t);
...
static bool __fn_1115(int64_t, int64_t);
...
static bool __fn_746(int64_t a, int64_t b) {
...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t3) {
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_746;
            void *__t7 = __t6;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t10) {
            ...
            __t14[1] = (int64_t)(intptr_t)__fn_783;
            void *__t15 = __t14;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t30;
        {
            ...
            bool __t31;
            if ((t1_984) == (INT64_C(0))) {
                __t31 = (t2_985) == (INT64_C(0));
            } else {
                bool __t32;
                if ((t2_985) == (INT64_C(0))) {
                    __t32 = false;
                } else {
                    __auto_type __ps_33 = (cons_hyeq_hygo(t1_984, t2_985));
                    if (tur_panicking) return (bool){0};
                    __t32 = __ps_33;
                }
                __t31 = __t32;
...
static bool __fn_1115(int64_t a, int64_t b) {
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t36) {
            ...
            __t40[1] = (int64_t)(intptr_t)__fn_1115;
            void *__t41 = __t40;
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_70) {
            bool __t71;
            {
                ...
                (void)k_734;
                bool __t74;
                __auto_type __ps_75 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_733, (void *)(intptr_t)(k_734), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_75) {
                    bool __t76;
                    __auto_type __ps_77 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_78 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_733, (void *)(intptr_t)(k_734), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t81;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_738 = __ps_83;
            (void)iter_738;
            __auto_type __ps_84 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_85 = (hamt_slkeyeq((void *)(intptr_t)(__ps_84)));
            if (tur_panicking) return (bool){0};
            void * keyeq_739 = __ps_85;
            (void)keyeq_739;
            __auto_type __ps_86 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_87 = (map_hyeq_hyloop((void *)(intptr_t)(iter_738), (void *)(intptr_t)(__ps_86), (void *)(intptr_t)(keyeq_739), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_740 = __ps_87;
            (void)result_740;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_109) {
            bool __t110;
            {
                ...
                bool __t111;
                if ((t1_979) == (INT64_C(0))) {
                    __t111 = (t2_980) == (INT64_C(0));
                } else {
                    bool __t112;
                    if ((t2_980) == (INT64_C(0))) {
                        __t112 = false;
                    } else {
                        __auto_type __ps_113 = (cons_hyeq_hygo(t1_979, t2_980));
                        if (tur_panicking) return (bool){0};
                        __t112 = __ps_113;
                    }
                    __t111 = __t112;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_988 = (int64_t)(intptr_t)(__ps_121);
                (void)out_988;
                __t116 = out_988;
            }
            __t114 = __t116;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_123) {
            ...
            int64_t __t124;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_995 = (int64_t)(intptr_t)(__ps_128);
                (void)out_995;
                __t124 = out_995;
            }
            __t122 = __t124;
        ...
        if (__ps_133) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1060 = __ps_134;
                (void)h_1060;
                __auto_type __ps_135 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1061 = __ps_135;
                (void)k_1061;
                __auto_type __ps_136 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1060, (void *)(intptr_t)(k_1061), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_136) {
                    void * __t137 = iter;
                    void * __t138 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t140;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1064 = __ps_142;
            (void)iter_1064;
            __auto_type __ps_143 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_144 = (hamt_slkeyeq((void *)(intptr_t)(__ps_143)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1065 = __ps_144;
            (void)keyeq_1065;
            __auto_type __ps_145 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_146 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1064), (void *)(intptr_t)(__ps_145), (void *)(intptr_t)(keyeq_1065)));
            if (tur_panicking) return (bool){0};
            bool result_1066 = __ps_146;
            (void)result_1066;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_1064));
            bool __t147;
            __t147 = result_1066;
            __t140 = __t147;
        }
...
static int64_t SCHEMA_unSTR_1155;
static int64_t SCHEMA_unINT_1156;
static int64_t SCHEMA_unFLOAT_1157;
static int64_t SCHEMA_unBOOL_1158;
static int64_t SCHEMA_unNIL_1159;
static int64_t SCHEMA_unLITERAL_1160;
static int64_t SCHEMA_unOBJECT_1161;
static int64_t SCHEMA_unARRAY_1162;
static int64_t SCHEMA_unOPTIONAL_1163;
static int64_t SCHEMA_unUNION_1164;
static int64_t SCHEMA_unTRANSFORM_1165;
static int64_t SCHEMA_unREC_1166;
static int64_t SCHEMA_unALWAYS_1167;
static int64_t SCHEMA_unNEVER_1168;
static int64_t SCHEMA_unAP_1169;
static int64_t SCHEMA_unFIELD_1170;
static int64_t SCHEMA_unAP_unFAT_1171;
static int64_t schema_slstr() {
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        int64_t __t167;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t _un_unv_1194 = __ps_168;
            (void)_un_unv_1194;
            tur_hyvec_hyhomog_un_un(a, b);
            int64_t __t169;
            vec_hypush_ex(_un_unv_1194, a);
            int64_t __t170;
            vec_hypush_ex(_un_unv_1194, b);
            int64_t __t171;
            __t171 = _un_unv_1194;
            __t170 = __t171;
            __t169 = __t170;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t173;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1243 = __ps_174;
            (void)r_1243;
            int64_t __t175;
            __auto_type __ps_176 = (schema_hydecode_hyok_qu(r_1243));
            if (tur_panicking) return (int64_t){0};
            if (__ps_176) {
                __auto_type __ps_177 = (schema_hydecode_hyvalue(r_1243));
                if (tur_panicking) return (int64_t){0};
                __t175 = __ps_177;
            } else {
                __auto_type __ps_178 = (schema_hydecode_hyerrors(r_1243));
                if (tur_panicking) return (int64_t){0};
...
static void __tur_module_def_init(void) {
    SCHEMA_unSTR_1155 = INT64_C(0);
    SCHEMA_unINT_1156 = INT64_C(1);
    SCHEMA_unFLOAT_1157 = INT64_C(2);
    SCHEMA_unBOOL_1158 = INT64_C(3);
    SCHEMA_unNIL_1159 = INT64_C(4);
    SCHEMA_unLITERAL_1160 = INT64_C(5);
    SCHEMA_unOBJECT_1161 = INT64_C(6);
    SCHEMA_unARRAY_1162 = INT64_C(7);
    SCHEMA_unOPTIONAL_1163 = INT64_C(8);
    SCHEMA_unUNION_1164 = INT64_C(9);
    SCHEMA_unTRANSFORM_1165 = INT64_C(10);
    SCHEMA_unREC_1166 = INT64_C(11);
    SCHEMA_unALWAYS_1167 = INT64_C(12);
    SCHEMA_unNEVER_1168 = INT64_C(13);
    SCHEMA_unAP_1169 = INT64_C(14);
    SCHEMA_unFIELD_1170 = INT64_C(15);
    SCHEMA_unAP_unFAT_1171 = INT64_C(16);
}
