...
static int64_t __inst_Into_into_intint(int64_t x) {
        return ((int64_t (*)(int64_t))(intptr_t)(dict_From_intint_singleton.from))(x);
}
...
int main() {
        printf("%lld\n", (long long)(((int64_t (*)(int64_t))(intptr_t)(dict_From_intint_singleton.from))(INT64_C(41))));
        printf("%lld\n", (long long)(((int64_t (*)(int64_t))(intptr_t)(dict_Into_intint_singleton.into))(INT64_C(9))));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
