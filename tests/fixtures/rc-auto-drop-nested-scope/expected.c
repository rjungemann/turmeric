...
struct __defer_env_165 {RcControlBlock * inner; };

struct __defer_env_157 {RcControlBlock * outer; };
...
static void __defer_158(void *__env) {
    struct __defer_env_157 *__e = (struct __defer_env_157 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t153;
        {
            int64_t *__t154 = (int64_t *)malloc(sizeof(int64_t));
            *__t154 = INT64_C(10);
            RcControlBlock *__t155 = rc_cb_alloc(0, 3, NULL);
            __t155->value = __t154;
            RcControlBlock * outer_1279 = __t155;
            (void)outer_1279;
            tur_frame __frame_156;
            tur_frame_init(&__frame_156, NULL);
            struct __defer_env_157 __t159 = {.outer = outer_1279};
            tur_frame_push_defer(&__frame_156, __defer_158, &__t159);
            int64_t __t160;
            int64_t __t161;
            {
                int64_t *__t162 = (int64_t *)malloc(sizeof(int64_t));
                *__t162 = INT64_C(20);
                RcControlBlock *__t163 = rc_cb_alloc(0, 3, NULL);
                __t163->value = __t162;
                RcControlBlock * inner_1280 = __t163;
                (void)inner_1280;
                tur_frame __frame_164;
                tur_frame_init(&__frame_164, &__frame_156);
                struct __defer_env_165 __t167 = {.inner = inner_1280};
                tur_frame_push_defer(&__frame_164, __defer_166, &__t167);
                int64_t __t168;
                int64_t __t169 = rc_strong_count(outer_1279);
                int64_t __t170 = rc_strong_count(inner_1280);
                __t168 = (__t169) + (__t170);
                tur_frame_fire_lifo(&__frame_164);
                __t161 = __t168;
            }
            __t160 = __t161;
            tur_frame_fire_lifo(&__frame_156);
            __t153 = __t160;
        }
        return __t153;
}
