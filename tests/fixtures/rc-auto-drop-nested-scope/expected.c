...
struct __defer_env_244 {RcControlBlock * inner; };

struct __defer_env_236 {RcControlBlock * outer; };

static void __defer_245(void *__env) {
    struct __defer_env_244 *__e = (struct __defer_env_244 *)__env;
    rc_strong_decrement(__e->inner);
    rc_free_queue_drain();
}

static void __defer_237(void *__env) {
    struct __defer_env_236 *__e = (struct __defer_env_236 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t232;
        {
            int64_t *__t233 = (int64_t *)malloc(sizeof(int64_t));
            *__t233 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t233)), sizeof((*__t233)));
            RcControlBlock *__t234 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t234, __t233, NULL);
            RcControlBlock * outer_1463 = __t234;
            (void)outer_1463;
            tur_frame __frame_235;
            tur_frame_init(&__frame_235, NULL);
            struct __defer_env_236 __t238 = {.outer = outer_1463};
            tur_frame_push_defer(&__frame_235, __defer_237, &__t238);
            int64_t __t239;
            int64_t __t240;
            {
                int64_t *__t241 = (int64_t *)malloc(sizeof(int64_t));
                *__t241 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t241)), sizeof((*__t241)));
                RcControlBlock *__t242 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t242, __t241, NULL);
                RcControlBlock * inner_1464 = __t242;
                (void)inner_1464;
                tur_frame __frame_243;
                tur_frame_init(&__frame_243, &__frame_235);
                struct __defer_env_244 __t246 = {.inner = inner_1464};
                tur_frame_push_defer(&__frame_243, __defer_245, &__t246);
                int64_t __t247;
                int64_t __t248 = rc_strong_count(outer_1463);
                int64_t __t249 = rc_strong_count(inner_1464);
                __t247 = (__t248) + (__t249);
                tur_frame_fire_lifo(&__frame_243);
                __t240 = __t247;
            }
            __t239 = __t240;
            tur_frame_fire_lifo(&__frame_235);
            __t232 = __t239;
        }
        return __t232;
}
