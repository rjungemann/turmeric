...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t21;
        {
            ...
            *__t22 = INT64_C(10);
            ...
            __t23->value = __t22;
            RcControlBlock * outer_860 = __t23;
            (void)outer_860;
            tur_frame __frame_24;
            tur_frame_init(&__frame_24, NULL);
            struct __defer_env_25 __t27 = {.outer = outer_860};
            ...
            int64_t __t29;
            {
                ...
                *__t30 = INT64_C(20);
                ...
                __t31->value = __t30;
                RcControlBlock * inner_861 = __t31;
                (void)inner_861;
                tur_frame __frame_32;
                tur_frame_init(&__frame_32, &__frame_24);
                struct __defer_env_33 __t35 = {.inner = inner_861};
                tur_frame_push_defer(&__frame_32, __defer_34, &__t35);
                int64_t __t36;
                int64_t __t37 = rc_strong_count(outer_860);
                int64_t __t38 = rc_strong_count(inner_861);
                __t36 = (__t37) + (__t38);
