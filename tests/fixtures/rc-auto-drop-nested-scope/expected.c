...
struct __defer_env_180 {RcControlBlock * inner; };

struct __defer_env_172 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t168;
        {
            int64_t *__t169 = (int64_t *)malloc(sizeof(int64_t));
            *__t169 = INT64_C(10);
            RcControlBlock *__t170 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t170, __t169, NULL);
            RcControlBlock * outer_1432 = __t170;
            (void)outer_1432;
            tur_frame __frame_171;
            tur_frame_init(&__frame_171, NULL);
            struct __defer_env_172 __t174 = {.outer = outer_1432};
            tur_frame_push_defer(&__frame_171, __defer_173, &__t174);
            int64_t __t175;
            int64_t __t176;
            {
                int64_t *__t177 = (int64_t *)malloc(sizeof(int64_t));
                *__t177 = INT64_C(20);
                RcControlBlock *__t178 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t178, __t177, NULL);
                RcControlBlock * inner_1433 = __t178;
                (void)inner_1433;
                tur_frame __frame_179;
                tur_frame_init(&__frame_179, &__frame_171);
                struct __defer_env_180 __t182 = {.inner = inner_1433};
                tur_frame_push_defer(&__frame_179, __defer_181, &__t182);
                int64_t __t183;
                int64_t __t184 = rc_strong_count(outer_1432);
                int64_t __t185 = rc_strong_count(inner_1433);
                __t183 = (__t184) + (__t185);
