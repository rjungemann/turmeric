...
struct __defer_env_58 {RcControlBlock * inner; };

struct __defer_env_50 {RcControlBlock * outer; };
...
static void __defer_51(void *__env) {
    struct __defer_env_50 *__e = (struct __defer_env_50 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t46;
        {
            int64_t *__t47 = (int64_t *)malloc(sizeof(int64_t));
            *__t47 = INT64_C(10);
            RcControlBlock *__t48 = rc_cb_alloc(0, 3, NULL);
            __t48->value = __t47;
            RcControlBlock * outer_1005 = __t48;
            (void)outer_1005;
            tur_frame __frame_49;
            tur_frame_init(&__frame_49, NULL);
            struct __defer_env_50 __t52 = {.outer = outer_1005};
            tur_frame_push_defer(&__frame_49, __defer_51, &__t52);
            int64_t __t53;
            int64_t __t54;
            {
                int64_t *__t55 = (int64_t *)malloc(sizeof(int64_t));
                *__t55 = INT64_C(20);
                RcControlBlock *__t56 = rc_cb_alloc(0, 3, NULL);
                __t56->value = __t55;
                RcControlBlock * inner_1006 = __t56;
                (void)inner_1006;
                tur_frame __frame_57;
                tur_frame_init(&__frame_57, &__frame_49);
                struct __defer_env_58 __t60 = {.inner = inner_1006};
                tur_frame_push_defer(&__frame_57, __defer_59, &__t60);
                int64_t __t61;
                int64_t __t62 = rc_strong_count(outer_1005);
                int64_t __t63 = rc_strong_count(inner_1006);
                __t61 = (__t62) + (__t63);
                tur_frame_fire_lifo(&__frame_57);
                __t54 = __t61;
            }
            __t53 = __t54;
            tur_frame_fire_lifo(&__frame_49);
            __t46 = __t53;
        }
        return __t46;
}
