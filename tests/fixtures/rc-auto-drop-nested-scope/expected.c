...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t172;
        {
            ...
            *__t173 = INT64_C(10);
            ...
            RcControlBlock * outer_1616 = __t174;
            (void)outer_1616;
            tur_frame __frame_175;
            tur_frame_init(&__frame_175, NULL);
            struct __defer_env_176 __t178 = {.outer = outer_1616};
            ...
            int64_t __t180;
            {
                ...
                *__t181 = INT64_C(20);
                ...
                RcControlBlock * inner_1617 = __t182;
                (void)inner_1617;
                tur_frame __frame_183;
                tur_frame_init(&__frame_183, &__frame_175);
                struct __defer_env_184 __t186 = {.inner = inner_1617};
                tur_frame_push_defer(&__frame_183, __defer_185, &__t186);
                int64_t __t187;
                int64_t __t188 = rc_strong_count(outer_1616);
                int64_t __t189 = rc_strong_count(inner_1617);
