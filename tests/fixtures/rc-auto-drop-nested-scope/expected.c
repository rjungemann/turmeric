...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t163;
        {
            ...
            *__t164 = INT64_C(10);
            ...
            RcControlBlock * outer_1362 = __t165;
            (void)outer_1362;
            tur_frame __frame_166;
            tur_frame_init(&__frame_166, NULL);
            struct __defer_env_167 __t169 = {.outer = outer_1362};
            ...
            int64_t __t171;
            {
                ...
                *__t172 = INT64_C(20);
                ...
                RcControlBlock * inner_1363 = __t173;
                (void)inner_1363;
                tur_frame __frame_174;
                tur_frame_init(&__frame_174, &__frame_166);
                struct __defer_env_175 __t177 = {.inner = inner_1363};
                tur_frame_push_defer(&__frame_174, __defer_176, &__t177);
                int64_t __t178;
                int64_t __t179 = rc_strong_count(outer_1362);
                int64_t __t180 = rc_strong_count(inner_1363);
