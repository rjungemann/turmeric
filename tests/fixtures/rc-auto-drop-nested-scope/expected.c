...
static int64_t rc_hyauto_hydrop_hynested_hyscope();
...
struct __defer_env_289 {RcControlBlock * inner; };

struct __defer_env_281 {RcControlBlock * outer; };

struct __defer_env_267 {int64_t m; };

static void __defer_290(void *__env) {
    struct __defer_env_289 *__e = (struct __defer_env_289 *)__env;
    rc_strong_decrement(__e->inner);
    rc_free_queue_drain();
}

static void __defer_282(void *__env) {
    struct __defer_env_281 *__e = (struct __defer_env_281 *)__env;
    rc_strong_decrement(__e->outer);
    rc_free_queue_drain();
}
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t277;
        {
            int64_t *__t278 = (int64_t *)malloc(sizeof(int64_t));
            *__t278 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t278)), sizeof((*__t278)));
            RcControlBlock *__t279 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t279, __t278, NULL);
            RcControlBlock * outer_1606 = __t279;
            (void)outer_1606;
            tur_frame __frame_280;
            tur_frame_init(&__frame_280, NULL);
            struct __defer_env_281 __t283 = {.outer = outer_1606};
            tur_frame_push_defer(&__frame_280, __defer_282, &__t283);
            int64_t __t284;
            int64_t __t285;
            {
                int64_t *__t286 = (int64_t *)malloc(sizeof(int64_t));
                *__t286 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t286)), sizeof((*__t286)));
                RcControlBlock *__t287 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t287, __t286, NULL);
                RcControlBlock * inner_1607 = __t287;
                (void)inner_1607;
                tur_frame __frame_288;
                tur_frame_init(&__frame_288, &__frame_280);
                struct __defer_env_289 __t291 = {.inner = inner_1607};
                tur_frame_push_defer(&__frame_288, __defer_290, &__t291);
                int64_t __t292;
                int64_t __t293 = rc_strong_count(outer_1606);
                int64_t __t294 = rc_strong_count(inner_1607);
                __t292 = (__t293) + (__t294);
                tur_frame_fire_lifo(&__frame_288);
                __t285 = __t292;
            }
            __t284 = __t285;
            tur_frame_fire_lifo(&__frame_280);
            __t277 = __t284;
        }
        return __t277;
}
