...
struct __defer_env_185 {RcControlBlock * inner; };

struct __defer_env_177 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t173;
        {
            int64_t *__t174 = (int64_t *)malloc(sizeof(int64_t));
            *__t174 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t174)), sizeof((*__t174)));
            RcControlBlock *__t175 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t175, __t174, NULL);
            RcControlBlock * outer_1606 = __t175;
            (void)outer_1606;
            tur_frame __frame_176;
            tur_frame_init(&__frame_176, NULL);
            struct __defer_env_177 __t179 = {.outer = outer_1606};
            ...
            int64_t __t181;
            {
                ...
                *__t182 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t182)), sizeof((*__t182)));
                RcControlBlock *__t183 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t183, __t182, NULL);
                RcControlBlock * inner_1607 = __t183;
                (void)inner_1607;
                tur_frame __frame_184;
                tur_frame_init(&__frame_184, &__frame_176);
                struct __defer_env_185 __t187 = {.inner = inner_1607};
                tur_frame_push_defer(&__frame_184, __defer_186, &__t187);
                int64_t __t188;
                int64_t __t189 = rc_strong_count(outer_1606);
                int64_t __t190 = rc_strong_count(inner_1607);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_191 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
