...
struct __defer_env_175 {RcControlBlock * inner; };

struct __defer_env_167 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t163;
        {
            ...
            *__t164 = INT64_C(10);
            ...
            RcControlBlock * outer_1366 = __t165;
            (void)outer_1366;
            tur_frame __frame_166;
            tur_frame_init(&__frame_166, NULL);
            struct __defer_env_167 __t169 = {.outer = outer_1366};
            tur_frame_push_defer(&__frame_166, __defer_168, &__t169);
            int64_t __t170;
            int64_t __t171;
            {
                int64_t *__t172 = (int64_t *)malloc(sizeof(int64_t));
                *__t172 = INT64_C(20);
                RcControlBlock *__t173 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t173, __t172, NULL);
                RcControlBlock * inner_1367 = __t173;
                (void)inner_1367;
                tur_frame __frame_174;
                tur_frame_init(&__frame_174, &__frame_166);
                struct __defer_env_175 __t177 = {.inner = inner_1367};
                tur_frame_push_defer(&__frame_174, __defer_176, &__t177);
                int64_t __t178;
                int64_t __t179 = rc_strong_count(outer_1366);
                int64_t __t180 = rc_strong_count(inner_1367);
