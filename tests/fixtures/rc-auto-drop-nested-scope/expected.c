...
static int64_t rc_auto_drop_nested_scope() {
        int64_t __t1;
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * outer_617 = __t3;
            (void)outer_617;
            tur_frame __frame_4;
            tur_frame_init(&__frame_4, NULL);
            struct __defer_env_5 __t7 = {.outer = outer_617};
            ...
            int64_t __t9;
            {
                ...
                *__t10 = INT64_C(20);
                ...
                __t11->value = __t10;
                RcControlBlock * inner_618 = __t11;
                (void)inner_618;
                tur_frame __frame_12;
                tur_frame_init(&__frame_12, &__frame_4);
                struct __defer_env_13 __t15 = {.inner = inner_618};
                tur_frame_push_defer(&__frame_12, __defer_14, &__t15);
                int64_t __t16;
                int64_t __t17 = rc_strong_count(outer_617);
                int64_t __t18 = rc_strong_count(inner_618);
                __t16 = ((__t17) + (__t18));
