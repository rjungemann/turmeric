...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t179;
        {
            ...
            *__t180 = INT64_C(10);
            ...
            RcControlBlock * outer_1432 = __t181;
            (void)outer_1432;
            tur_frame __frame_182;
            tur_frame_init(&__frame_182, NULL);
            struct __defer_env_183 __t185 = {.outer = outer_1432};
            ...
            int64_t __t187;
            {
                ...
                *__t188 = INT64_C(20);
                ...
                RcControlBlock * inner_1433 = __t189;
                (void)inner_1433;
                tur_frame __frame_190;
                tur_frame_init(&__frame_190, &__frame_182);
                struct __defer_env_191 __t193 = {.inner = inner_1433};
                tur_frame_push_defer(&__frame_190, __defer_192, &__t193);
                int64_t __t194;
                int64_t __t195 = rc_strong_count(outer_1432);
                int64_t __t196 = rc_strong_count(inner_1433);
