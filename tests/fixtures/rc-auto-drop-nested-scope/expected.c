...
struct __defer_env_192 {RcControlBlock * inner; };

struct __defer_env_184 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t180;
        {
            ...
            *__t181 = INT64_C(10);
            ...
            RcControlBlock * outer_1436 = __t182;
            (void)outer_1436;
            tur_frame __frame_183;
            tur_frame_init(&__frame_183, NULL);
            struct __defer_env_184 __t186 = {.outer = outer_1436};
            tur_frame_push_defer(&__frame_183, __defer_185, &__t186);
            int64_t __t187;
            int64_t __t188;
            {
                int64_t *__t189 = (int64_t *)malloc(sizeof(int64_t));
                *__t189 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t189)), sizeof((*__t189)));
                RcControlBlock *__t190 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t190, __t189, NULL);
                RcControlBlock * inner_1437 = __t190;
                (void)inner_1437;
                tur_frame __frame_191;
                tur_frame_init(&__frame_191, &__frame_183);
                struct __defer_env_192 __t194 = {.inner = inner_1437};
                tur_frame_push_defer(&__frame_191, __defer_193, &__t194);
                int64_t __t195;
                int64_t __t196 = rc_strong_count(outer_1436);
                int64_t __t197 = rc_strong_count(inner_1437);
                __t195 = (__t196) + (__t197);
