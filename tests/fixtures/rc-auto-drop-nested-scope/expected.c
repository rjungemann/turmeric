...
struct __defer_env_167 {RcControlBlock * inner; };

struct __defer_env_159 {RcControlBlock * outer; };
...
static void __defer_160(void *__env) {
    struct __defer_env_159 *__e = (struct __defer_env_159 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t155;
        {
            ...
            *__t156 = INT64_C(10);
            ...
            RcControlBlock * outer_1300 = __t157;
            (void)outer_1300;
            tur_frame __frame_158;
            tur_frame_init(&__frame_158, NULL);
            struct __defer_env_159 __t161 = {.outer = outer_1300};
            tur_frame_push_defer(&__frame_158, __defer_160, &__t161);
            int64_t __t162;
            int64_t __t163;
            {
                int64_t *__t164 = (int64_t *)malloc(sizeof(int64_t));
                *__t164 = INT64_C(20);
                RcControlBlock *__t165 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t165, __t164, NULL);
                RcControlBlock * inner_1301 = __t165;
                (void)inner_1301;
                tur_frame __frame_166;
                tur_frame_init(&__frame_166, &__frame_158);
                struct __defer_env_167 __t169 = {.inner = inner_1301};
                tur_frame_push_defer(&__frame_166, __defer_168, &__t169);
                int64_t __t170;
                int64_t __t171 = rc_strong_count(outer_1300);
                int64_t __t172 = rc_strong_count(inner_1301);
                __t170 = (__t171) + (__t172);
                tur_frame_fire_lifo(&__frame_166);
                __t163 = __t170;
            }
            __t162 = __t163;
            tur_frame_fire_lifo(&__frame_158);
            __t155 = __t162;
        }
        return __t155;
}
