...
struct __defer_env_287 {RcControlBlock * inner; };

struct __defer_env_279 {RcControlBlock * outer; };
...
static void __defer_280(void *__env) {
    struct __defer_env_279 *__e = (struct __defer_env_279 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t275;
        {
            int64_t *__t276 = (int64_t *)malloc(sizeof(int64_t));
            *__t276 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t276)), sizeof((*__t276)));
            RcControlBlock *__t277 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t277, __t276, NULL);
            RcControlBlock * outer_1606 = __t277;
            (void)outer_1606;
            tur_frame __frame_278;
            tur_frame_init(&__frame_278, NULL);
            struct __defer_env_279 __t281 = {.outer = outer_1606};
            tur_frame_push_defer(&__frame_278, __defer_280, &__t281);
            int64_t __t282;
            int64_t __t283;
            {
                int64_t *__t284 = (int64_t *)malloc(sizeof(int64_t));
                *__t284 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t284)), sizeof((*__t284)));
                RcControlBlock *__t285 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t285, __t284, NULL);
                RcControlBlock * inner_1607 = __t285;
                (void)inner_1607;
                tur_frame __frame_286;
                tur_frame_init(&__frame_286, &__frame_278);
                struct __defer_env_287 __t289 = {.inner = inner_1607};
                tur_frame_push_defer(&__frame_286, __defer_288, &__t289);
                int64_t __t290;
                int64_t __t291 = rc_strong_count(outer_1606);
                int64_t __t292 = rc_strong_count(inner_1607);
                __t290 = (__t291) + (__t292);
