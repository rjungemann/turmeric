...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t159;
        {
            ...
            *__t160 = INT64_C(10);
            ...
            RcControlBlock * outer_1328 = __t161;
            (void)outer_1328;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            struct __defer_env_163 __t165 = {.outer = outer_1328};
            ...
            int64_t __t167;
            {
                ...
                *__t168 = INT64_C(20);
                ...
                RcControlBlock * inner_1329 = __t169;
                (void)inner_1329;
                tur_frame __frame_170;
                tur_frame_init(&__frame_170, &__frame_162);
                struct __defer_env_171 __t173 = {.inner = inner_1329};
                tur_frame_push_defer(&__frame_170, __defer_172, &__t173);
                int64_t __t174;
                int64_t __t175 = rc_strong_count(outer_1328);
                int64_t __t176 = rc_strong_count(inner_1329);
