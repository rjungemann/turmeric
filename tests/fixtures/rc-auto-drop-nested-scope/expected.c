...
struct __defer_env_19 {RcControlBlock * inner; };

struct __defer_env_11 {RcControlBlock * outer; };

static void __defer_20(void *__env) {
    struct __defer_env_19 *__e = (struct __defer_env_19 *)__env;
...
static int64_t rc_auto_drop_nested_scope() {
        int64_t __t7;
        {
            ...
            *__t8 = INT64_C(10);
            ...
            __t9->value = __t8;
            RcControlBlock * outer_853 = __t9;
            (void)outer_853;
            tur_frame __frame_10;
            tur_frame_init(&__frame_10, NULL);
            struct __defer_env_11 __t13 = {.outer = outer_853};
            tur_frame_push_defer(&__frame_10, __defer_12, &__t13);
            int64_t __t14;
            int64_t __t15;
            {
                int64_t *__t16 = (int64_t *)malloc(sizeof(int64_t));
                *__t16 = INT64_C(20);
                RcControlBlock *__t17 = rc_cb_alloc(0, 3, NULL);
                __t17->value = __t16;
                RcControlBlock * inner_854 = __t17;
                (void)inner_854;
                tur_frame __frame_18;
                tur_frame_init(&__frame_18, &__frame_10);
                struct __defer_env_19 __t21 = {.inner = inner_854};
                tur_frame_push_defer(&__frame_18, __defer_20, &__t21);
                int64_t __t22;
                int64_t __t23 = rc_strong_count(outer_853);
                int64_t __t24 = rc_strong_count(inner_854);
                __t22 = (__t23) + (__t24);
                tur_frame_fire_lifo(&__frame_18);
                __t15 = __t22;
            }
            __t14 = __t15;
            tur_frame_fire_lifo(&__frame_10);
            __t7 = __t14;
        }
        return __t7;
}
