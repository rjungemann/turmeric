...
struct __defer_env_189 {RcControlBlock * inner; };

struct __defer_env_181 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t177;
        {
            int64_t *__t178 = (int64_t *)malloc(sizeof(int64_t));
            *__t178 = INT64_C(10);
            RcControlBlock *__t179 = rc_cb_alloc(0, 3, NULL);
            __t179->value = __t178;
            RcControlBlock * outer_1267 = __t179;
            (void)outer_1267;
            tur_frame __frame_180;
            tur_frame_init(&__frame_180, NULL);
            struct __defer_env_181 __t183 = {.outer = outer_1267};
            tur_frame_push_defer(&__frame_180, __defer_182, &__t183);
            int64_t __t184;
            int64_t __t185;
            {
                int64_t *__t186 = (int64_t *)malloc(sizeof(int64_t));
                *__t186 = INT64_C(20);
                RcControlBlock *__t187 = rc_cb_alloc(0, 3, NULL);
                __t187->value = __t186;
                RcControlBlock * inner_1268 = __t187;
                (void)inner_1268;
                tur_frame __frame_188;
                tur_frame_init(&__frame_188, &__frame_180);
                struct __defer_env_189 __t191 = {.inner = inner_1268};
                tur_frame_push_defer(&__frame_188, __defer_190, &__t191);
                int64_t __t192;
                int64_t __t193 = rc_strong_count(outer_1267);
                int64_t __t194 = rc_strong_count(inner_1268);
                __t192 = (__t193) + (__t194);
                tur_frame_fire_lifo(&__frame_188);
                __t185 = __t192;
            }
            __t184 = __t185;
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_196 = (vec_new__spec__tur_adt_Vec__int__());
