...
struct __defer_env_276 {RcControlBlock * inner; };

struct __defer_env_268 {RcControlBlock * outer; };

static void __defer_277(void *__env) {
    struct __defer_env_276 *__e = (struct __defer_env_276 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t264;
        {
            int64_t *__t265 = (int64_t *)malloc(sizeof(int64_t));
            *__t265 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t265)), sizeof((*__t265)));
            RcControlBlock *__t266 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t266, __t265, NULL);
            RcControlBlock * outer_1467 = __t266;
            (void)outer_1467;
            tur_frame __frame_267;
            tur_frame_init(&__frame_267, NULL);
            struct __defer_env_268 __t270 = {.outer = outer_1467};
            tur_frame_push_defer(&__frame_267, __defer_269, &__t270);
            int64_t __t271;
            int64_t __t272;
            {
                int64_t *__t273 = (int64_t *)malloc(sizeof(int64_t));
                *__t273 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t273)), sizeof((*__t273)));
                RcControlBlock *__t274 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t274, __t273, NULL);
                RcControlBlock * inner_1468 = __t274;
                (void)inner_1468;
                tur_frame __frame_275;
                tur_frame_init(&__frame_275, &__frame_267);
                struct __defer_env_276 __t278 = {.inner = inner_1468};
                tur_frame_push_defer(&__frame_275, __defer_277, &__t278);
                int64_t __t279;
                int64_t __t280 = rc_strong_count(outer_1467);
                int64_t __t281 = rc_strong_count(inner_1468);
                __t279 = (__t280) + (__t281);
