...
static int64_t rc_auto_drop_nested_scope() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(10);
            ...
            __t2->value = __t1;
            RcControlBlock * outer_532 = __t2;
            (void)outer_532;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            struct __defer_env_4 __t6 = {.outer = outer_532};
            ...
            int64_t __t8;
            {
                ...
                *__t9 = INT64_C(20);
                ...
                __t10->value = __t9;
                RcControlBlock * inner_533 = __t10;
                (void)inner_533;
                tur_frame __frame_11;
                tur_frame_init(&__frame_11, &__frame_3);
                struct __defer_env_12 __t14 = {.inner = inner_533};
                tur_frame_push_defer(&__frame_11, __defer_13, &__t14);
                int64_t __t15;
                int64_t __t16 = rc_strong_count(outer_532);
                int64_t __t17 = rc_strong_count(inner_533);
                __t15 = ((__t16) + (__t17));
