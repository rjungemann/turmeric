...
struct __defer_env_195 {RcControlBlock * inner; };

struct __defer_env_187 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t183;
        {
            int64_t *__t184 = (int64_t *)malloc(sizeof(int64_t));
            *__t184 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t184)), sizeof((*__t184)));
            RcControlBlock *__t185 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t185, __t184, NULL);
            RcControlBlock * outer_1436 = __t185;
            (void)outer_1436;
            tur_frame __frame_186;
            tur_frame_init(&__frame_186, NULL);
            struct __defer_env_187 __t189 = {.outer = outer_1436};
            tur_frame_push_defer(&__frame_186, __defer_188, &__t189);
            int64_t __t190;
            int64_t __t191;
            {
                int64_t *__t192 = (int64_t *)malloc(sizeof(int64_t));
                *__t192 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t192)), sizeof((*__t192)));
                RcControlBlock *__t193 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t193, __t192, NULL);
                RcControlBlock * inner_1437 = __t193;
                (void)inner_1437;
                tur_frame __frame_194;
                tur_frame_init(&__frame_194, &__frame_186);
                struct __defer_env_195 __t197 = {.inner = inner_1437};
                tur_frame_push_defer(&__frame_194, __defer_196, &__t197);
                int64_t __t198;
                int64_t __t199 = rc_strong_count(outer_1436);
                int64_t __t200 = rc_strong_count(inner_1437);
