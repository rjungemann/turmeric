...
struct __defer_env_171 {RcControlBlock * inner; };

struct __defer_env_163 {RcControlBlock * outer; };

static void __defer_172(void *__env) {
    struct __defer_env_171 *__e = (struct __defer_env_171 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t159;
        {
            int64_t *__t160 = (int64_t *)malloc(sizeof(int64_t));
            *__t160 = INT64_C(10);
            RcControlBlock *__t161 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t161, __t160, NULL);
            RcControlBlock * outer_1326 = __t161;
            (void)outer_1326;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            struct __defer_env_163 __t165 = {.outer = outer_1326};
            tur_frame_push_defer(&__frame_162, __defer_164, &__t165);
            int64_t __t166;
            int64_t __t167;
            {
                int64_t *__t168 = (int64_t *)malloc(sizeof(int64_t));
                *__t168 = INT64_C(20);
                RcControlBlock *__t169 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t169, __t168, NULL);
                RcControlBlock * inner_1327 = __t169;
                (void)inner_1327;
                tur_frame __frame_170;
                tur_frame_init(&__frame_170, &__frame_162);
                struct __defer_env_171 __t173 = {.inner = inner_1327};
                tur_frame_push_defer(&__frame_170, __defer_172, &__t173);
                int64_t __t174;
                int64_t __t175 = rc_strong_count(outer_1326);
                int64_t __t176 = rc_strong_count(inner_1327);
                __t174 = (__t175) + (__t176);
