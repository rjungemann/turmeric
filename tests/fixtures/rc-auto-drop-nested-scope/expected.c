...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t173;
        {
            ...
            *__t174 = INT64_C(10);
            ...
            __t175->value = __t174;
            RcControlBlock * outer_1272 = __t175;
            (void)outer_1272;
            tur_frame __frame_176;
            tur_frame_init(&__frame_176, NULL);
            struct __defer_env_177 __t179 = {.outer = outer_1272};
            ...
            int64_t __t181;
            {
                ...
                *__t182 = INT64_C(20);
                ...
                __t183->value = __t182;
                RcControlBlock * inner_1273 = __t183;
                (void)inner_1273;
                tur_frame __frame_184;
                tur_frame_init(&__frame_184, &__frame_176);
                struct __defer_env_185 __t187 = {.inner = inner_1273};
                tur_frame_push_defer(&__frame_184, __defer_186, &__t187);
                int64_t __t188;
                int64_t __t189 = rc_strong_count(outer_1272);
                int64_t __t190 = rc_strong_count(inner_1273);
