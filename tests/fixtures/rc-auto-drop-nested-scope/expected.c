...
struct __defer_env_62 {RcControlBlock * inner; };

struct __defer_env_54 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t50;
        {
            int64_t *__t51 = (int64_t *)malloc(sizeof(int64_t));
            *__t51 = INT64_C(10);
            RcControlBlock *__t52 = rc_cb_alloc(0, 3, NULL);
            __t52->value = __t51;
            RcControlBlock * outer_1243 = __t52;
            (void)outer_1243;
            tur_frame __frame_53;
            tur_frame_init(&__frame_53, NULL);
            struct __defer_env_54 __t56 = {.outer = outer_1243};
            tur_frame_push_defer(&__frame_53, __defer_55, &__t56);
            int64_t __t57;
            int64_t __t58;
            {
                int64_t *__t59 = (int64_t *)malloc(sizeof(int64_t));
                *__t59 = INT64_C(20);
                RcControlBlock *__t60 = rc_cb_alloc(0, 3, NULL);
                __t60->value = __t59;
                RcControlBlock * inner_1244 = __t60;
                (void)inner_1244;
                tur_frame __frame_61;
                tur_frame_init(&__frame_61, &__frame_53);
                struct __defer_env_62 __t64 = {.inner = inner_1244};
                tur_frame_push_defer(&__frame_61, __defer_63, &__t64);
                int64_t __t65;
                int64_t __t66 = rc_strong_count(outer_1243);
                int64_t __t67 = rc_strong_count(inner_1244);
                __t65 = (__t66) + (__t67);
                tur_frame_fire_lifo(&__frame_61);
                __t58 = __t65;
            }
            __t57 = __t58;
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t68 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t68 = (Cons__int){.head = h, .tail = t};
        return __t68;
}
