...
struct __defer_env_63 {RcControlBlock * inner; };

struct __defer_env_55 {RcControlBlock * outer; };

static void __defer_64(void *__env) {
    struct __defer_env_63 *__e = (struct __defer_env_63 *)__env;
    rc_strong_decrement(__e->inner);
    rc_free_queue_drain();
}

static void __defer_56(void *__env) {
    struct __defer_env_55 *__e = (struct __defer_env_55 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t51;
        {
            int64_t *__t52 = (int64_t *)malloc(sizeof(int64_t));
            *__t52 = INT64_C(10);
            RcControlBlock *__t53 = rc_cb_alloc(0, 3, NULL);
            __t53->value = __t52;
            RcControlBlock * outer_1007 = __t53;
            (void)outer_1007;
            tur_frame __frame_54;
            tur_frame_init(&__frame_54, NULL);
            struct __defer_env_55 __t57 = {.outer = outer_1007};
            tur_frame_push_defer(&__frame_54, __defer_56, &__t57);
            int64_t __t58;
            int64_t __t59;
            {
                int64_t *__t60 = (int64_t *)malloc(sizeof(int64_t));
                *__t60 = INT64_C(20);
                RcControlBlock *__t61 = rc_cb_alloc(0, 3, NULL);
                __t61->value = __t60;
                RcControlBlock * inner_1008 = __t61;
                (void)inner_1008;
                tur_frame __frame_62;
                tur_frame_init(&__frame_62, &__frame_54);
                struct __defer_env_63 __t65 = {.inner = inner_1008};
                tur_frame_push_defer(&__frame_62, __defer_64, &__t65);
                int64_t __t66;
                int64_t __t67 = rc_strong_count(outer_1007);
                int64_t __t68 = rc_strong_count(inner_1008);
                __t66 = (__t67) + (__t68);
                tur_frame_fire_lifo(&__frame_62);
                __t59 = __t66;
            }
            __t58 = __t59;
