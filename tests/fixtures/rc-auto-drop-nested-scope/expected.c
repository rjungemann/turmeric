...
struct __defer_env_191 {RcControlBlock * inner; };

struct __defer_env_183 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t179;
        {
            int64_t *__t180 = (int64_t *)malloc(sizeof(int64_t));
            *__t180 = INT64_C(10);
            RcControlBlock *__t181 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t181, __t180, NULL);
            RcControlBlock * outer_1434 = __t181;
            (void)outer_1434;
            tur_frame __frame_182;
            tur_frame_init(&__frame_182, NULL);
            struct __defer_env_183 __t185 = {.outer = outer_1434};
            tur_frame_push_defer(&__frame_182, __defer_184, &__t185);
            int64_t __t186;
            int64_t __t187;
            {
                int64_t *__t188 = (int64_t *)malloc(sizeof(int64_t));
                *__t188 = INT64_C(20);
                RcControlBlock *__t189 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t189, __t188, NULL);
                RcControlBlock * inner_1435 = __t189;
                (void)inner_1435;
                tur_frame __frame_190;
                tur_frame_init(&__frame_190, &__frame_182);
                struct __defer_env_191 __t193 = {.inner = inner_1435};
                tur_frame_push_defer(&__frame_190, __defer_192, &__t193);
                int64_t __t194;
                int64_t __t195 = rc_strong_count(outer_1434);
                int64_t __t196 = rc_strong_count(inner_1435);
                __t194 = (__t195) + (__t196);
