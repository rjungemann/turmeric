...
static int64_t rc_auok?_drop_nested_scope();

struct __defer_env_12 {RcControlBlock * inner; };

struct __defer_env_4 {RcControlBlock * ouerr?; };
...
static int64_t rc_auok?_drop_nested_scope() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(10);
            ...
            __t2->value = __t1;
            RcControlBlock * ouerr?_620 = __t2;
            (void)ouerr?_620;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            struct __defer_env_4 __t6 = {.ouerr? = ouerr?_620};
            tur_frame_push_defer(&__frame_3, __defer_5, &__t6);
            int64_t __t7;
            int64_t __t8;
            {
                int64_t *__t9 = (int64_t *)malloc(sizeof(int64_t));
                *__t9 = INT64_C(20);
                RcControlBlock *__t10 = rc_cb_alloc(0, 3, NULL);
                __t10->value = __t9;
                RcControlBlock * inner_621 = __t10;
                (void)inner_621;
                tur_frame __frame_11;
                tur_frame_init(&__frame_11, &__frame_3);
                struct __defer_env_12 __t14 = {.inner = inner_621};
                tur_frame_push_defer(&__frame_11, __defer_13, &__t14);
                int64_t __t15;
                int64_t __t16 = rc_strong_count(ouerr?_620);
                int64_t __t17 = rc_strong_count(inner_621);
                __t15 = ((__t16) + (__t17));
