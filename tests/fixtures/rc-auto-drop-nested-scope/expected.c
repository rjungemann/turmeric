...
struct __defer_env_56 {RcControlBlock * inner; };

struct __defer_env_48 {RcControlBlock * outer; };
...
static void __defer_49(void *__env) {
    struct __defer_env_48 *__e = (struct __defer_env_48 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t44;
        {
            int64_t *__t45 = (int64_t *)malloc(sizeof(int64_t));
            *__t45 = INT64_C(10);
            RcControlBlock *__t46 = rc_cb_alloc(0, 3, NULL);
            __t46->value = __t45;
            RcControlBlock * outer_1005 = __t46;
            (void)outer_1005;
            tur_frame __frame_47;
            tur_frame_init(&__frame_47, NULL);
            struct __defer_env_48 __t50 = {.outer = outer_1005};
            tur_frame_push_defer(&__frame_47, __defer_49, &__t50);
            int64_t __t51;
            int64_t __t52;
            {
                int64_t *__t53 = (int64_t *)malloc(sizeof(int64_t));
                *__t53 = INT64_C(20);
                RcControlBlock *__t54 = rc_cb_alloc(0, 3, NULL);
                __t54->value = __t53;
                RcControlBlock * inner_1006 = __t54;
                (void)inner_1006;
                tur_frame __frame_55;
                tur_frame_init(&__frame_55, &__frame_47);
                struct __defer_env_56 __t58 = {.inner = inner_1006};
                tur_frame_push_defer(&__frame_55, __defer_57, &__t58);
                int64_t __t59;
                int64_t __t60 = rc_strong_count(outer_1005);
                int64_t __t61 = rc_strong_count(inner_1006);
                __t59 = (__t60) + (__t61);
                tur_frame_fire_lifo(&__frame_55);
                __t52 = __t59;
            }
            __t51 = __t52;
            tur_frame_fire_lifo(&__frame_47);
            __t44 = __t51;
        }
        return __t44;
}
