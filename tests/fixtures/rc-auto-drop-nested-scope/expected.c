...
struct __defer_env_256 {RcControlBlock * inner; };

struct __defer_env_248 {RcControlBlock * outer; };

static void __defer_257(void *__env) {
    struct __defer_env_256 *__e = (struct __defer_env_256 *)__env;
    rc_strong_decrement(__e->inner);
    rc_free_queue_drain();
}

static void __defer_249(void *__env) {
    struct __defer_env_248 *__e = (struct __defer_env_248 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t244;
        {
            int64_t *__t245 = (int64_t *)malloc(sizeof(int64_t));
            *__t245 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t245)), sizeof((*__t245)));
            RcControlBlock *__t246 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t246, __t245, NULL);
            RcControlBlock * outer_1467 = __t246;
            (void)outer_1467;
            tur_frame __frame_247;
            tur_frame_init(&__frame_247, NULL);
            struct __defer_env_248 __t250 = {.outer = outer_1467};
            tur_frame_push_defer(&__frame_247, __defer_249, &__t250);
            int64_t __t251;
            int64_t __t252;
            {
                int64_t *__t253 = (int64_t *)malloc(sizeof(int64_t));
                *__t253 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t253)), sizeof((*__t253)));
                RcControlBlock *__t254 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t254, __t253, NULL);
                RcControlBlock * inner_1468 = __t254;
                (void)inner_1468;
                tur_frame __frame_255;
                tur_frame_init(&__frame_255, &__frame_247);
                struct __defer_env_256 __t258 = {.inner = inner_1468};
                tur_frame_push_defer(&__frame_255, __defer_257, &__t258);
                int64_t __t259;
                int64_t __t260 = rc_strong_count(outer_1467);
                int64_t __t261 = rc_strong_count(inner_1468);
                __t259 = (__t260) + (__t261);
                tur_frame_fire_lifo(&__frame_255);
                __t252 = __t259;
            }
            __t251 = __t252;
            tur_frame_fire_lifo(&__frame_247);
            __t244 = __t251;
        }
        return __t244;
}
