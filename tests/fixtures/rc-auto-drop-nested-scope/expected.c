...
struct __defer_env_36 {RcControlBlock * inner; };

struct __defer_env_28 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t24;
        {
            int64_t *__t25 = (int64_t *)malloc(sizeof(int64_t));
            *__t25 = INT64_C(10);
            RcControlBlock *__t26 = rc_cb_alloc(0, 3, NULL);
            __t26->value = __t25;
            RcControlBlock * outer_880 = __t26;
            (void)outer_880;
            tur_frame __frame_27;
            tur_frame_init(&__frame_27, NULL);
            struct __defer_env_28 __t30 = {.outer = outer_880};
            tur_frame_push_defer(&__frame_27, __defer_29, &__t30);
            int64_t __t31;
            int64_t __t32;
            {
                int64_t *__t33 = (int64_t *)malloc(sizeof(int64_t));
                *__t33 = INT64_C(20);
                RcControlBlock *__t34 = rc_cb_alloc(0, 3, NULL);
                __t34->value = __t33;
                RcControlBlock * inner_881 = __t34;
                (void)inner_881;
                tur_frame __frame_35;
                tur_frame_init(&__frame_35, &__frame_27);
                struct __defer_env_36 __t38 = {.inner = inner_881};
                tur_frame_push_defer(&__frame_35, __defer_37, &__t38);
                int64_t __t39;
                int64_t __t40 = rc_strong_count(outer_880);
                int64_t __t41 = rc_strong_count(inner_881);
                __t39 = (__t40) + (__t41);
                tur_frame_fire_lifo(&__frame_35);
                __t32 = __t39;
            }
            __t31 = __t32;
