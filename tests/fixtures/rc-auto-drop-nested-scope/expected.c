...
struct __defer_env_184 {RcControlBlock * inner; };

struct __defer_env_176 {RcControlBlock * outer; };
...
static void __defer_177(void *__env) {
    struct __defer_env_176 *__e = (struct __defer_env_176 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t172;
        {
            int64_t *__t173 = (int64_t *)malloc(sizeof(int64_t));
            *__t173 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t173)), sizeof((*__t173)));
            RcControlBlock *__t174 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t174, __t173, NULL);
            RcControlBlock * outer_1621 = __t174;
            (void)outer_1621;
            tur_frame __frame_175;
            tur_frame_init(&__frame_175, NULL);
            struct __defer_env_176 __t178 = {.outer = outer_1621};
            tur_frame_push_defer(&__frame_175, __defer_177, &__t178);
            int64_t __t179;
            int64_t __t180;
            {
                int64_t *__t181 = (int64_t *)malloc(sizeof(int64_t));
                *__t181 = INT64_C(20);
                TUR_REGION_NOTE_WORDS(&((*__t181)), sizeof((*__t181)));
                RcControlBlock *__t182 = rc_cb_alloc(0, 3, NULL);
                rc_set_value(__t182, __t181, NULL);
                RcControlBlock * inner_1622 = __t182;
                (void)inner_1622;
                tur_frame __frame_183;
                tur_frame_init(&__frame_183, &__frame_175);
                struct __defer_env_184 __t186 = {.inner = inner_1622};
                tur_frame_push_defer(&__frame_183, __defer_185, &__t186);
                int64_t __t187;
                int64_t __t188 = rc_strong_count(outer_1621);
                int64_t __t189 = rc_strong_count(inner_1622);
                __t187 = (__t188) + (__t189);
