...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t155;
        {
            ...
            *__t156 = INT64_C(10);
            ...
            __t157->value = __t156;
            RcControlBlock * outer_1281 = __t157;
            (void)outer_1281;
            tur_frame __frame_158;
            tur_frame_init(&__frame_158, NULL);
            struct __defer_env_159 __t161 = {.outer = outer_1281};
            ...
            int64_t __t163;
            {
                ...
                *__t164 = INT64_C(20);
                ...
                __t165->value = __t164;
                RcControlBlock * inner_1282 = __t165;
                (void)inner_1282;
                tur_frame __frame_166;
                tur_frame_init(&__frame_166, &__frame_158);
                struct __defer_env_167 __t169 = {.inner = inner_1282};
                tur_frame_push_defer(&__frame_166, __defer_168, &__t169);
                int64_t __t170;
                int64_t __t171 = rc_strong_count(outer_1281);
                int64_t __t172 = rc_strong_count(inner_1282);
