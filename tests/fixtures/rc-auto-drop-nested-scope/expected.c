...
struct __defer_env_193 {RcControlBlock * inner; };

struct __defer_env_185 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t181;
        {
            ...
            *__t182 = INT64_C(10);
            ...
            __t183->value = __t182;
            RcControlBlock * outer_1264 = __t183;
            (void)outer_1264;
            tur_frame __frame_184;
            tur_frame_init(&__frame_184, NULL);
            struct __defer_env_185 __t187 = {.outer = outer_1264};
            tur_frame_push_defer(&__frame_184, __defer_186, &__t187);
            int64_t __t188;
            int64_t __t189;
            {
                int64_t *__t190 = (int64_t *)malloc(sizeof(int64_t));
                *__t190 = INT64_C(20);
                RcControlBlock *__t191 = rc_cb_alloc(0, 3, NULL);
                __t191->value = __t190;
                RcControlBlock * inner_1265 = __t191;
                (void)inner_1265;
                tur_frame __frame_192;
                tur_frame_init(&__frame_192, &__frame_184);
                struct __defer_env_193 __t195 = {.inner = inner_1265};
                tur_frame_push_defer(&__frame_192, __defer_194, &__t195);
                int64_t __t196;
                int64_t __t197 = rc_strong_count(outer_1264);
                int64_t __t198 = rc_strong_count(inner_1265);
                __t196 = (__t197) + (__t198);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_199 = (ctor_Cons__int(h, t));
