...
struct __defer_env_279 {RcControlBlock * inner; };

struct __defer_env_271 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t267;
        {
            int64_t *__t268 = (int64_t *)malloc(sizeof(int64_t));
            *__t268 = INT64_C(10);
            TUR_REGION_NOTE_WORDS(&((*__t268)), sizeof((*__t268)));
            RcControlBlock *__t269 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t269, __t268, NULL);
            RcControlBlock * outer_1465 = __t269;
            (void)outer_1465;
            tur_frame __frame_270;
            tur_frame_init(&__frame_270, NULL);
            struct __defer_env_271 __t273 = {.outer = outer_1465};
            ...
            int64_t __t275;
            {
                ...
                *__t276 = INT64_C(20);
                ...
                RcControlBlock * inner_1466 = __t277;
                (void)inner_1466;
                tur_frame __frame_278;
                tur_frame_init(&__frame_278, &__frame_270);
                struct __defer_env_279 __t281 = {.inner = inner_1466};
                tur_frame_push_defer(&__frame_278, __defer_280, &__t281);
                int64_t __t282;
                int64_t __t283 = rc_strong_count(outer_1465);
                int64_t __t284 = rc_strong_count(inner_1466);
                __t282 = (__t283) + (__t284);
