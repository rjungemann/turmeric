...
struct __defer_env_67 {RcControlBlock * inner; };

struct __defer_env_59 {RcControlBlock * outer; };

static void __defer_68(void *__env) {
    struct __defer_env_67 *__e = (struct __defer_env_67 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t55;
        {
            int64_t *__t56 = (int64_t *)malloc(sizeof(int64_t));
            *__t56 = INT64_C(10);
            RcControlBlock *__t57 = rc_cb_alloc(0, 3, NULL);
            __t57->value = __t56;
            RcControlBlock * outer_1246 = __t57;
            (void)outer_1246;
            tur_frame __frame_58;
            tur_frame_init(&__frame_58, NULL);
            struct __defer_env_59 __t61 = {.outer = outer_1246};
            tur_frame_push_defer(&__frame_58, __defer_60, &__t61);
            int64_t __t62;
            int64_t __t63;
            {
                int64_t *__t64 = (int64_t *)malloc(sizeof(int64_t));
                *__t64 = INT64_C(20);
                RcControlBlock *__t65 = rc_cb_alloc(0, 3, NULL);
                __t65->value = __t64;
                RcControlBlock * inner_1247 = __t65;
                (void)inner_1247;
                tur_frame __frame_66;
                tur_frame_init(&__frame_66, &__frame_58);
                struct __defer_env_67 __t69 = {.inner = inner_1247};
                tur_frame_push_defer(&__frame_66, __defer_68, &__t69);
                int64_t __t70;
                int64_t __t71 = rc_strong_count(outer_1246);
                int64_t __t72 = rc_strong_count(inner_1247);
                __t70 = (__t71) + (__t72);
                tur_frame_fire_lifo(&__frame_66);
                __t63 = __t70;
            }
            __t62 = __t63;
            tur_frame_fire_lifo(&__frame_58);
            __t55 = __t62;
        }
        return __t55;
}
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t73 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t73 = (Cons__int){.head = h, .tail = t};
        return __t73;
}
