...
struct __defer_env_172 {RcControlBlock * inner; };

struct __defer_env_164 {RcControlBlock * outer; };
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t160;
        {
            int64_t *__t161 = (int64_t *)malloc(sizeof(int64_t));
            *__t161 = INT64_C(10);
            RcControlBlock *__t162 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t162, __t161, NULL);
            RcControlBlock * outer_1330 = __t162;
            (void)outer_1330;
            tur_frame __frame_163;
            tur_frame_init(&__frame_163, NULL);
            struct __defer_env_164 __t166 = {.outer = outer_1330};
            ...
            int64_t __t168;
            {
                ...
                *__t169 = INT64_C(20);
                ...
                RcControlBlock * inner_1331 = __t170;
                (void)inner_1331;
                tur_frame __frame_171;
                tur_frame_init(&__frame_171, &__frame_163);
                struct __defer_env_172 __t174 = {.inner = inner_1331};
                tur_frame_push_defer(&__frame_171, __defer_173, &__t174);
                int64_t __t175;
                int64_t __t176 = rc_strong_count(outer_1330);
                int64_t __t177 = rc_strong_count(inner_1331);
                __t175 = (__t176) + (__t177);
