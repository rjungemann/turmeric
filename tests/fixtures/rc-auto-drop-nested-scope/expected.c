...
struct __defer_env_14 {RcControlBlock * inner; };

struct __defer_env_6 {RcControlBlock * outer; };
...
static int64_t rc_auto_drop_nested_scope() {
        int64_t __t2;
        {
            ...
            *__t3 = INT64_C(10);
            ...
            __t4->value = __t3;
            RcControlBlock * outer_794 = __t4;
            (void)outer_794;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            struct __defer_env_6 __t8 = {.outer = outer_794};
            tur_frame_push_defer(&__frame_5, __defer_7, &__t8);
            int64_t __t9;
            int64_t __t10;
            {
                int64_t *__t11 = (int64_t *)malloc(sizeof(int64_t));
                *__t11 = INT64_C(20);
                RcControlBlock *__t12 = rc_cb_alloc(0, 3, NULL);
                __t12->value = __t11;
                RcControlBlock * inner_795 = __t12;
                (void)inner_795;
                tur_frame __frame_13;
                tur_frame_init(&__frame_13, &__frame_5);
                struct __defer_env_14 __t16 = {.inner = inner_795};
                tur_frame_push_defer(&__frame_13, __defer_15, &__t16);
                int64_t __t17;
                int64_t __t18 = rc_strong_count(outer_794);
                int64_t __t19 = rc_strong_count(inner_795);
                __t17 = (__t18) + (__t19);
                tur_frame_fire_lifo(&__frame_13);
                __t10 = __t17;
            }
            __t9 = __t10;
