...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t181;
        {
            ...
            *__t182 = INT64_C(10);
            ...
            __t183->value = __t182;
            RcControlBlock * outer_1269 = __t183;
            (void)outer_1269;
            tur_frame __frame_184;
            tur_frame_init(&__frame_184, NULL);
            struct __defer_env_185 __t187 = {.outer = outer_1269};
            ...
            int64_t __t189;
            {
                ...
                *__t190 = INT64_C(20);
                ...
                __t191->value = __t190;
                RcControlBlock * inner_1270 = __t191;
                (void)inner_1270;
                tur_frame __frame_192;
                tur_frame_init(&__frame_192, &__frame_184);
                struct __defer_env_193 __t195 = {.inner = inner_1270};
                tur_frame_push_defer(&__frame_192, __defer_194, &__t195);
                int64_t __t196;
                int64_t __t197 = rc_strong_count(outer_1269);
                int64_t __t198 = rc_strong_count(inner_1270);
