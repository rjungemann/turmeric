...
struct __defer_env_41 {RcControlBlock * inner; };

struct __defer_env_33 {RcControlBlock * outer; };

static void __defer_42(void *__env) {
    struct __defer_env_41 *__e = (struct __defer_env_41 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t29;
        {
            int64_t *__t30 = (int64_t *)malloc(sizeof(int64_t));
            *__t30 = INT64_C(10);
            RcControlBlock *__t31 = rc_cb_alloc(0, 3, NULL);
            __t31->value = __t30;
            RcControlBlock * outer_900 = __t31;
            (void)outer_900;
            tur_frame __frame_32;
            tur_frame_init(&__frame_32, NULL);
            struct __defer_env_33 __t35 = {.outer = outer_900};
            tur_frame_push_defer(&__frame_32, __defer_34, &__t35);
            int64_t __t36;
            int64_t __t37;
            {
                int64_t *__t38 = (int64_t *)malloc(sizeof(int64_t));
                *__t38 = INT64_C(20);
                RcControlBlock *__t39 = rc_cb_alloc(0, 3, NULL);
                __t39->value = __t38;
                RcControlBlock * inner_901 = __t39;
                (void)inner_901;
                tur_frame __frame_40;
                tur_frame_init(&__frame_40, &__frame_32);
                struct __defer_env_41 __t43 = {.inner = inner_901};
                tur_frame_push_defer(&__frame_40, __defer_42, &__t43);
                int64_t __t44;
                int64_t __t45 = rc_strong_count(outer_900);
                int64_t __t46 = rc_strong_count(inner_901);
                __t44 = (__t45) + (__t46);
                tur_frame_fire_lifo(&__frame_40);
                __t37 = __t44;
            }
            __t36 = __t37;
            tur_frame_fire_lifo(&__frame_32);
            __t29 = __t36;
        }
        return __t29;
}
