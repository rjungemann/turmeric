...
struct __defer_env_64 {RcControlBlock * inner; };

struct __defer_env_56 {RcControlBlock * outer; };

static void __defer_65(void *__env) {
    struct __defer_env_64 *__e = (struct __defer_env_64 *)__env;
...
static int64_t rc_hyauto_hydrop_hynested_hyscope() {
        int64_t __t52;
        {
            ...
            *__t53 = INT64_C(10);
            ...
            __t54->value = __t53;
            RcControlBlock * outer_1007 = __t54;
            (void)outer_1007;
            tur_frame __frame_55;
            tur_frame_init(&__frame_55, NULL);
            struct __defer_env_56 __t58 = {.outer = outer_1007};
            tur_frame_push_defer(&__frame_55, __defer_57, &__t58);
            int64_t __t59;
            int64_t __t60;
            {
                int64_t *__t61 = (int64_t *)malloc(sizeof(int64_t));
                *__t61 = INT64_C(20);
                RcControlBlock *__t62 = rc_cb_alloc(0, 3, NULL);
                __t62->value = __t61;
                RcControlBlock * inner_1008 = __t62;
                (void)inner_1008;
                tur_frame __frame_63;
                tur_frame_init(&__frame_63, &__frame_55);
                struct __defer_env_64 __t66 = {.inner = inner_1008};
                tur_frame_push_defer(&__frame_63, __defer_65, &__t66);
                int64_t __t67;
                int64_t __t68 = rc_strong_count(outer_1007);
                int64_t __t69 = rc_strong_count(inner_1008);
                __t67 = (__t68) + (__t69);
                tur_frame_fire_lifo(&__frame_63);
                __t60 = __t67;
            }
            __t59 = __t60;
