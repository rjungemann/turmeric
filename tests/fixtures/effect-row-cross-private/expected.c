...
static int64_t provider__run_internal();
static int64_t provider__wrapper();
...
static int64_t provider__run_internal() {
        int64_t __t0[1];
        __t0[0] = (int64_t)"computing";
        tur_effect_perform("InternalLog", __t0, 1);
        int64_t __t1;
        __t1 = INT64_C(42);
        return __t1;
}
...
static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_618 = (const char *)__effect_args[0];
    int64_t k_619 = __k;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_619, (int64_t)0);
    return (int64_t)__t4;
}

static void __handle_body_2(void);
static void __handle_body_2(void) {
    tur_current_fiber->result = (int64_t)provider__run_internal();
}
...
static int64_t __dispatch_2(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "InternalLog") == 0) {
...
static int64_t provider__wrapper() {
        ...
        __eff_frame_2.cases[0].effect_name = "InternalLog";
