...
int main() {
        int64_t __t0;
        {
            void * a_270 = some(INT64_C(42));
            (void)a_270;
            int64_t __t1;
            {
                void * b_271 = none();
                (void)b_271;
                puts((some_((void *)(intptr_t)(a_270))) ? "true" : "false");
                puts((some_((void *)(intptr_t)(b_271))) ? "true" : "false");
                printf("%lld\n", (long long)(option_unwrap((void *)(intptr_t)(a_270))));
                option_free((void *)(intptr_t)(a_270));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
