...
int main() {
        int64_t __t0;
        {
            void * a_30 = some(INT64_C(42));
            (void)a_30;
            int64_t __t1;
            {
                void * b_31 = none();
                (void)b_31;
                puts((some_((void *)(intptr_t)(a_30))) ? "true" : "false");
                puts((some_((void *)(intptr_t)(b_31))) ? "true" : "false");
                printf("%lld\n", (long long)(option_unwrap((void *)(intptr_t)(a_30))));
                option_free((void *)(intptr_t)(a_30));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
