...
int main() {
        int64_t __t0;
        {
            void * a_205 = some(INT64_C(42));
            (void)a_205;
            int64_t __t1;
            {
                void * b_206 = none();
                (void)b_206;
                puts((some_((void *)(intptr_t)(a_205))) ? "true" : "false");
                puts((some_((void *)(intptr_t)(b_206))) ? "true" : "false");
                printf("%lld\n", (long long)(option_unwrap((void *)(intptr_t)(a_205))));
                option_free((void *)(intptr_t)(a_205));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
