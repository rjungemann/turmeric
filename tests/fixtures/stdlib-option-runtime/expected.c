...
static int64_t option_unwrap(void *);
static void option_free(void *);
...
static int64_t option_unwrap(void * o) {
        struct { bool is_some; int64_t value; } *opt = (void*)o;
...
static void option_free(void * o) {
        free(o);
...
int main() {
        int64_t __t0;
        {
            void * a_625 = some(INT64_C(42));
            (void)a_625;
            int64_t __t1;
            {
                void * b_626 = none();
                (void)b_626;
                puts((some_((void *)(intptr_t)(a_625))) ? "true" : "false");
                puts((some_((void *)(intptr_t)(b_626))) ? "true" : "false");
                printf("%lld\n", (long long)(option_unwrap((void *)(intptr_t)(a_625))));
                option_free((void *)(intptr_t)(a_625));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
