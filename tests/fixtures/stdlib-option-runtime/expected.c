...
int main() {
        int64_t __t0;
        {
            void * a_217 = some(INT64_C(42));
            (void)a_217;
            int64_t __t1;
            {
                void * b_218 = none();
                (void)b_218;
                puts((some_((void *)(intptr_t)(a_217))) ? "true" : "false");
                puts((some_((void *)(intptr_t)(b_218))) ? "true" : "false");
                printf("%lld\n", (long long)(option_unwrap((void *)(intptr_t)(a_217))));
                option_free((void *)(intptr_t)(a_217));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
