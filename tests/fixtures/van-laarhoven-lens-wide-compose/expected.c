...
typedef struct tur_adt_Identity__Line {
    int64_t wrapped;
    int64_t tag;
} tur_adt_Identity__Line;
#endif
...
typedef struct tur_adt_Const__int__int {
    int tag;
    union {
    } as;
} tur_adt_Const__int__int;
#endif
