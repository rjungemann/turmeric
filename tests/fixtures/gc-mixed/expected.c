...
int main() {
        ...
        int64_t __t1;
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * x_261 = __t3;
            (void)x_261;
            int64_t *__t4 = (int64_t *)malloc(sizeof(int64_t));
            *__t4 = INT64_C(20);
            RcControlBlock *__t5 = rc_cb_alloc(0, 3, NULL);
            __t5->value = __t4;
            RcControlBlock * y_262 = __t5;
            (void)y_262;
            int64_t __t6;
            int64_t __t7;
            {
                RcControlBlock *__t8 = y_262; rc_weak_increment(y_262);
                RcControlBlock * wy_263 = __t8;
                (void)wy_263;
                rc_strong_decrement(y_262);
                rc_free_queue_drain();
                gc_force();
                int64_t __t9 = rc_strong_count(x_261);
                printf("%lld\n", (long long)(__t9));
                {
                    RcControlBlock *__t10 = rc_upgrade(wy_263);
                    RcControlBlock * uy_264 = __t10;
                    (void)uy_264;
                    tur_frame __frame_11;
                    tur_frame_init(&__frame_11, NULL);
                    int64_t __t12 = rc_strong_count(uy_264);
                    printf("%lld\n", (long long)(__t12));
                    struct __defer_env_13 __t15 = {.uy = uy_264};
