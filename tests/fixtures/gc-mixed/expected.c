...
int main() {
        ...
        int64_t __t1;
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * x_618 = __t3;
            (void)x_618;
            int64_t *__t4 = (int64_t *)malloc(sizeof(int64_t));
            *__t4 = INT64_C(20);
            RcControlBlock *__t5 = rc_cb_alloc(0, 3, NULL);
            __t5->value = __t4;
            RcControlBlock * y_619 = __t5;
            (void)y_619;
            int64_t __t6;
            int64_t __t7;
            {
                RcControlBlock *__t8 = y_619; rc_weak_increment(y_619);
                RcControlBlock * wy_620 = __t8;
                (void)wy_620;
                rc_strong_decrement(y_619);
                rc_free_queue_drain();
                gc_force();
                int64_t __t9 = rc_strong_count(x_618);
                printf("%lld\n", (long long)(__t9));
                {
                    RcControlBlock *__t10 = rc_upgrade(wy_620);
