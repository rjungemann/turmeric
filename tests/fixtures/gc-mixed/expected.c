...
int main() {
        ...
        int64_t __t1;
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * x_208 = __t3;
            (void)x_208;
            int64_t *__t4 = (int64_t *)malloc(sizeof(int64_t));
            *__t4 = INT64_C(20);
            RcControlBlock *__t5 = rc_cb_alloc(0, 3, NULL);
            __t5->value = __t4;
            RcControlBlock * y_209 = __t5;
            (void)y_209;
            int64_t __t6;
            int64_t __t7;
            {
                RcControlBlock *__t8 = y_209; rc_weak_increment(y_209);
                RcControlBlock * wy_210 = __t8;
                (void)wy_210;
                rc_strong_decrement(y_209);
                rc_free_queue_drain();
                gc_force();
                int64_t __t9 = rc_strong_count(x_208);
                printf("%lld\n", (long long)(__t9));
                {
                    RcControlBlock *__t10 = rc_upgrade(wy_210);
                    RcControlBlock * uy_211 = __t10;
                    (void)uy_211;
                    tur_frame __frame_11;
                    tur_frame_init(&__frame_11, NULL);
                    int64_t __t12 = rc_strong_count(uy_211);
                    printf("%lld\n", (long long)(__t12));
                    struct __defer_env_13 __t15 = {.uy = uy_211};
