...
int main() {
        ...
        int64_t __t1;
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * x_196 = __t3;
            (void)x_196;
            int64_t *__t4 = (int64_t *)malloc(sizeof(int64_t));
            *__t4 = INT64_C(20);
            RcControlBlock *__t5 = rc_cb_alloc(0, 3, NULL);
            __t5->value = __t4;
            RcControlBlock * y_197 = __t5;
            (void)y_197;
            int64_t __t6;
            int64_t __t7;
            {
                RcControlBlock *__t8 = y_197; rc_weak_increment(y_197);
                RcControlBlock * wy_198 = __t8;
                (void)wy_198;
                rc_strong_decrement(y_197);
                rc_free_queue_drain();
                gc_force();
                int64_t __t9 = rc_strong_count(x_196);
                printf("%lld\n", (long long)(__t9));
                {
                    RcControlBlock *__t10 = rc_upgrade(wy_198);
                    RcControlBlock * uy_199 = __t10;
                    (void)uy_199;
                    tur_frame __frame_11;
                    tur_frame_init(&__frame_11, NULL);
                    int64_t __t12 = rc_strong_count(uy_199);
                    printf("%lld\n", (long long)(__t12));
                    struct __defer_env_13 __t15 = {.uy = uy_199};
