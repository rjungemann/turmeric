        ...
        if (__ps_102) {
            bool __t103;
            {
                ...
                if ((t1_1080) == (INT64_C(0))) {
                    __t104 = (t2_1081) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_1081) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        bool __ps_106 = (cons_hyeq_hygo(t1_1080, t2_1081));
                        if (tur_panicking) return ((bool)0);
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1096 = (int64_t)(intptr_t)(__ps_117);
                (void)out_1096;
                __t113 = out_1096;
            }
            __t111 = __t113;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t122;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1171 = __ps_124;
            (void)iter_1171;
            void * __ps_125 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_126 = (hamt_slkeyeq((void *)(intptr_t)(__ps_125)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1172 = __ps_126;
            (void)keyeq_1172;
            void * __ps_127 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_128 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1171), (void *)(intptr_t)(__ps_127), (void *)(intptr_t)(keyeq_1172)));
            if (tur_panicking) return ((bool)0);
            bool result_1173 = __ps_128;
            (void)result_1173;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t149;
        {
            ...
            {
                tur_adt_Vec__int * __ps_151 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1300));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1301 = __ps_151;
                (void)_un_unv_1301;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t155;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1351 = __ps_156;
            (void)r_1351;
            int64_t __t157;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1351));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                int64_t __ps_159 = (schema_hydecode_hyvalue(r_1351));
                if (tur_panicking) return ((int64_t)0);
                __t157 = __ps_159;
            } else {
                int64_t __ps_160 = (schema_hydecode_hyerrors(r_1351));
                if (tur_panicking) return ((int64_t)0);
...
static double first_hyx(const tur_adt_Line * l) {
        double __t163 = 0;
        {
            ...
            {
                tur_adt_Pt a_1376 = __scrut->a;
                tur_adt_Pt b_1377 = __scrut->b;
                double __t165 = 0;
                {
                    tur_adt_Pt __scrut = (a_1376);
                    {
                        double x_1378 = (double)__scrut.x;
                        double y_1379 = (double)__scrut.y;
                        __t165 = x_1378;
                        goto ____t166;
                    }
                    ____t166:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t167 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1381 = __scrut->a;
                tur_adt_Pt b_1382 = __scrut->b;
                double __t169 = 0;
                {
                    tur_adt_Pt __scrut = (b_1382);
                    {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t171;
        {
            tur_adt_Pt __ps_172 = (ctor_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_173 = (ctor_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_174 = (ctor_Line(__ps_172, __ps_173));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1386 = __ps_174;
            (void)l_1386;
            tur_adt_Pt __ps_175 = (ctor_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_176 = (ctor_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_177 = (ctor_Line(__ps_175, __ps_176));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1387 = __ps_177;
            (void)m_1387;
            tur_adt_Pt __ps_178 = (ctor_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_179 = (ctor_Box(__ps_178));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1388 = __ps_179;
            (void)b_1388;
            tur_adt_Line __t180 = l_1386;
            double __ps_181 = (first_hyx(&__t180));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_181));
            tur_adt_Line __t182 = m_1387;
            double __ps_183 = (second_hyy(&__t182));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_183));
            double __ps_184 = (box_hyx(b_1388));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_184));
            int64_t __t185;
            __t185 = INT64_C(0);
