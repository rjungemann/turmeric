...
static double first_hyx(const tur_adt_Line * l) {
        double __t179 = 0;
        {
            ...
            {
                tur_adt_Pt a_1444 = __scrut->a;
                tur_adt_Pt b_1445 = __scrut->b;
                double __t181 = 0;
                {
                    tur_adt_Pt __scrut = (a_1444);
                    {
                        double x_1446 = (double)__scrut.x;
                        double y_1447 = (double)__scrut.y;
                        __t181 = x_1446;
                        goto ____t182;
                    }
                    ____t182:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t183 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1449 = __scrut->a;
                tur_adt_Pt b_1450 = __scrut->b;
                double __t185 = 0;
                {
                    tur_adt_Pt __scrut = (b_1450);
                    {
