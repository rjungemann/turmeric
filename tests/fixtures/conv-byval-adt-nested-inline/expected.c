        ...
        if (__ps_166) {
            bool __t167;
            {
                ...
                if ((t1_1143) == (INT64_C(0))) {
                    __t168 = (t2_1144) == (INT64_C(0));
                } else {
                    bool __t169;
                    if ((t2_1144) == (INT64_C(0))) {
                        __t169 = false;
                    } else {
                        bool __ps_170 = (cons_hyeq_hygo(t1_1143, t2_1144));
                        if (tur_panicking) return ((bool)0);
                        __t169 = __ps_170;
                    }
                    __t168 = __t169;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_176) {
            ...
            int64_t __t177;
            {
                ...
                int64_t out_1159 = (int64_t)(intptr_t)(__ps_181);
                (void)out_1159;
                __t177 = out_1159;
            }
            __t175 = __t177;
        ...
        if (__ps_186) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1230 = __ps_187;
                (void)h_1230;
                void * __ps_188 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1231 = __ps_188;
                (void)k_1231;
                bool __ps_189 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1230, (void *)(intptr_t)(k_1231), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_189) {
                    void * __t190 = iter;
                    void * __t191 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t193;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1234 = __ps_195;
            (void)iter_1234;
            void * __ps_196 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_197 = (hamt_slkeyeq((void *)(intptr_t)(__ps_196)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1235 = __ps_197;
            (void)keyeq_1235;
            void * __ps_198 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_199 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1234), (void *)(intptr_t)(__ps_198), (void *)(intptr_t)(keyeq_1235)));
            if (tur_panicking) return ((bool)0);
            bool result_1236 = __ps_199;
            (void)result_1236;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t220;
        {
            ...
            {
                tur_adt_Vec__int * __ps_222 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1366));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1367 = __ps_222;
                (void)_un_unv_1367;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t226;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1417 = __ps_227;
            (void)r_1417;
            int64_t __t228;
            bool __ps_229 = (schema_hydecode_hyok_qu(r_1417));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_229) {
                int64_t __ps_230 = (schema_hydecode_hyvalue(r_1417));
                if (tur_panicking) return ((int64_t)0);
                __t228 = __ps_230;
            } else {
                int64_t __ps_231 = (schema_hydecode_hyerrors(r_1417));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t252;
        {
            tur_adt_Pt __ps_253 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_254 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_255 = (ctor_Line_Line(__ps_253, __ps_254));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1487 = __ps_255;
            (void)l_1487;
            tur_adt_Pt __ps_256 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_257 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_258 = (ctor_Line_Line(__ps_256, __ps_257));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1488 = __ps_258;
            (void)m_1488;
            tur_adt_Pt __ps_259 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_260 = (ctor_Box_Box(__ps_259));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1489 = __ps_260;
            (void)b_1489;
            double __ps_261 = (first_hyx(&l_1487));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_261));
            double __ps_262 = (second_hyy(&m_1488));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_262));
            double __ps_263 = (box_hyx(b_1489));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_263));
            int64_t __t264;
            __t264 = INT64_C(0);
