...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t188;
        {
            tur_adt_Pt __ps_189 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_190 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_191 = (ctor_Line_Line(__ps_189, __ps_190));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1456 = __ps_191;
            (void)l_1456;
            tur_adt_Pt __ps_192 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_193 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_194 = (ctor_Line_Line(__ps_192, __ps_193));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1457 = __ps_194;
            (void)m_1457;
            tur_adt_Pt __ps_195 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_196 = (ctor_Box_Box(__ps_195));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1458 = __ps_196;
            (void)b_1458;
            double __ps_197 = (first_hyx(&l_1456));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_197));
            double __ps_198 = (second_hyy(&m_1457));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_198));
            double __ps_199 = (box_hyx(b_1458));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_199));
            int64_t __t200;
            __t200 = INT64_C(0);
