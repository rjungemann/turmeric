...
static double first_hyx(const tur_adt_Line * l) {
        double __t173 = 0;
        {
            ...
            {
                tur_adt_Pt a_1280 = __scrut->a;
                tur_adt_Pt b_1281 = __scrut->b;
                double __t175 = 0;
                {
                    tur_adt_Pt __scrut = (a_1280);
                    {
                        double x_1282 = (double)__scrut.x;
                        double y_1283 = (double)__scrut.y;
                        __t175 = x_1282;
                        goto ____t176;
                    }
                    ____t176:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t177 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1285 = __scrut->a;
                tur_adt_Pt b_1286 = __scrut->b;
                double __t179 = 0;
                {
                    tur_adt_Pt __scrut = (b_1286);
                    {
                        double x_1287 = (double)__scrut.x;
                        double y_1288 = (double)__scrut.y;
                        __t179 = y_1288;
                        goto ____t180;
                    }
                    ____t180:;
