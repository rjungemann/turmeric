...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t122;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1195 = __ps_124;
            (void)iter_1195;
            void * __ps_125 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_126 = (hamt_slkeyeq((void *)(intptr_t)(__ps_125)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1196 = __ps_126;
            (void)keyeq_1196;
            void * __ps_127 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_128 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1195), (void *)(intptr_t)(__ps_127), (void *)(intptr_t)(keyeq_1196)));
            if (tur_panicking) return ((bool)0);
            bool result_1197 = __ps_128;
            (void)result_1197;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t149;
        {
            ...
            {
                tur_adt_Vec__int * __ps_151 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1324));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1325 = __ps_151;
                (void)_un_unv_1325;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t155;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1375 = __ps_156;
            (void)r_1375;
            int64_t __t157;
            bool __ps_158 = (schema_hydecode_hyok_qu(r_1375));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_158) {
                int64_t __ps_159 = (schema_hydecode_hyvalue(r_1375));
                if (tur_panicking) return ((int64_t)0);
                __t157 = __ps_159;
            } else {
                int64_t __ps_160 = (schema_hydecode_hyerrors(r_1375));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t180;
        {
            tur_adt_Pt __ps_181 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_182 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_183 = (ctor_Line_Line(__ps_181, __ps_182));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1452 = __ps_183;
            (void)l_1452;
            tur_adt_Pt __ps_184 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_185 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_186 = (ctor_Line_Line(__ps_184, __ps_185));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1453 = __ps_186;
            (void)m_1453;
            tur_adt_Pt __ps_187 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_188 = (ctor_Box_Box(__ps_187));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1454 = __ps_188;
            (void)b_1454;
            tur_adt_Line __t189 = l_1452;
            double __ps_190 = (first_hyx(&__t189));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_190));
            tur_adt_Line __t191 = m_1453;
            double __ps_192 = (second_hyy(&__t191));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_192));
            double __ps_193 = (box_hyx(b_1454));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_193));
            int64_t __t194;
            __t194 = INT64_C(0);
