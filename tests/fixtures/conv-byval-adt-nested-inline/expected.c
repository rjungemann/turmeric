...
static double first_hyx(const tur_adt_Line * l) {
        double __t159 = 0;
        {
            ...
            {
                tur_adt_Pt a_1336 = __scrut->a;
                tur_adt_Pt b_1337 = __scrut->b;
                double __t161 = 0;
                {
                    tur_adt_Pt __scrut = (a_1336);
                    {
                        double x_1338 = (double)__scrut.x;
                        double y_1339 = (double)__scrut.y;
                        __t161 = x_1338;
                        goto ____t162;
                    }
                    ____t162:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t163 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1341 = __scrut->a;
                tur_adt_Pt b_1342 = __scrut->b;
                double __t165 = 0;
                {
                    tur_adt_Pt __scrut = (b_1342);
                    {
                        double x_1343 = (double)__scrut.x;
                        double y_1344 = (double)__scrut.y;
                        __t165 = y_1344;
                        goto ____t166;
                    }
                    ____t166:;
