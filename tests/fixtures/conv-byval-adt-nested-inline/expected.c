...
static double first_hyx(const tur_adt_Line * l) {
        double __t163 = 0;
        {
            ...
            {
                tur_adt_Pt a_1372 = __scrut->a;
                tur_adt_Pt b_1373 = __scrut->b;
                double __t165 = 0;
                {
                    tur_adt_Pt __scrut = (a_1372);
                    {
                        double x_1374 = (double)__scrut.x;
                        double y_1375 = (double)__scrut.y;
                        __t165 = x_1374;
                        goto ____t166;
                    }
                    ____t166:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t167 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1377 = __scrut->a;
                tur_adt_Pt b_1378 = __scrut->b;
                double __t169 = 0;
                {
                    tur_adt_Pt __scrut = (b_1378);
                    {
