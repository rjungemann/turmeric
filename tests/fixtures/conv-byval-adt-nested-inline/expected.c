        ...
        if (__ps_154) {
            bool __t155;
            {
                ...
                if ((t1_1131) == (INT64_C(0))) {
                    __t156 = (t2_1132) == (INT64_C(0));
                } else {
                    bool __t157;
                    if ((t2_1132) == (INT64_C(0))) {
                        __t157 = false;
                    } else {
                        bool __ps_158 = (cons_hyeq_hygo(t1_1131, t2_1132));
                        if (tur_panicking) return ((bool)0);
                        __t157 = __ps_158;
                    }
                    __t156 = __t157;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_164) {
            ...
            int64_t __t165;
            {
                ...
                int64_t out_1147 = (int64_t)(intptr_t)(__ps_169);
                (void)out_1147;
                __t165 = out_1147;
            }
            __t163 = __t165;
        ...
        if (__ps_174) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1218 = __ps_175;
                (void)h_1218;
                void * __ps_176 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1219 = __ps_176;
                (void)k_1219;
                bool __ps_177 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1218, (void *)(intptr_t)(k_1219), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_177) {
                    void * __t178 = iter;
                    void * __t179 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t181;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1222 = __ps_183;
            (void)iter_1222;
            void * __ps_184 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_185 = (hamt_slkeyeq((void *)(intptr_t)(__ps_184)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1223 = __ps_185;
            (void)keyeq_1223;
            void * __ps_186 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_187 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1222), (void *)(intptr_t)(__ps_186), (void *)(intptr_t)(keyeq_1223)));
            if (tur_panicking) return ((bool)0);
            bool result_1224 = __ps_187;
            (void)result_1224;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t208;
        {
            ...
            {
                tur_adt_Vec__int * __ps_210 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1354));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1355 = __ps_210;
                (void)_un_unv_1355;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t214;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1405 = __ps_215;
            (void)r_1405;
            int64_t __t216;
            bool __ps_217 = (schema_hydecode_hyok_qu(r_1405));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_217) {
                int64_t __ps_218 = (schema_hydecode_hyvalue(r_1405));
                if (tur_panicking) return ((int64_t)0);
                __t216 = __ps_218;
            } else {
                int64_t __ps_219 = (schema_hydecode_hyerrors(r_1405));
                if (tur_panicking) return ((int64_t)0);
...
static double first_hyx(const tur_adt_Line * l) {
        double __t232 = 0;
        {
            ...
            {
                tur_adt_Pt a_1473 = __scrut->a;
                tur_adt_Pt b_1474 = __scrut->b;
                double __t234 = 0;
                {
                    tur_adt_Pt __scrut = (a_1473);
                    {
                        double x_1475 = (double)__scrut.x;
                        double y_1476 = (double)__scrut.y;
                        __t234 = x_1475;
                        goto ____t235;
                    }
                    ____t235:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t236 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1478 = __scrut->a;
                tur_adt_Pt b_1479 = __scrut->b;
                double __t238 = 0;
                {
                    tur_adt_Pt __scrut = (b_1479);
                    {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t240;
        {
            tur_adt_Pt __ps_241 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_242 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_243 = (ctor_Line_Line(__ps_241, __ps_242));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1483 = __ps_243;
            (void)l_1483;
            tur_adt_Pt __ps_244 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_245 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_246 = (ctor_Line_Line(__ps_244, __ps_245));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1484 = __ps_246;
            (void)m_1484;
            tur_adt_Pt __ps_247 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_248 = (ctor_Box_Box(__ps_247));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1485 = __ps_248;
            (void)b_1485;
            double __ps_249 = (first_hyx(&l_1483));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_249));
            double __ps_250 = (second_hyy(&m_1484));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_250));
            double __ps_251 = (box_hyx(b_1485));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_251));
            int64_t __t252;
            __t252 = INT64_C(0);
