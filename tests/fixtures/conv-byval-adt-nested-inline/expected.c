...
#endif
static tur_adt_Line ctor_Line_Line(tur_adt_Pt _0, tur_adt_Pt _1) {
    tur_adt_Line __r;
    __r.a = _0;
    __r.b = _1;
    return __r;
...
#endif
static tur_adt_Box ctor_Box_Box(tur_adt_Pt _0) {
    tur_adt_Box __r;
    __r.p = _0;
    return __r;
}

#ifndef TUR_CTORALIAS_Box
#define TUR_CTORALIAS_Box
#define ctor_Box ctor_Box_Box
#endif
...
static double first_hyx(const tur_adt_Line *);
static double second_hyy(const tur_adt_Line *);
static double box_hyx(tur_adt_Box);
        ...
        if (__ps_186) {
            bool __t187;
            {
                ...
                if ((t1_1143) == (INT64_C(0))) {
                    __t188 = (t2_1144) == (INT64_C(0));
                } else {
                    bool __t189;
                    if ((t2_1144) == (INT64_C(0))) {
                        __t189 = false;
                    } else {
                        bool __ps_190 = (cons_hyeq_hygo(t1_1143, t2_1144));
                        if (tur_panicking) return ((bool)0);
                        __t189 = __ps_190;
                    }
                    __t188 = __t189;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_196) {
            ...
            int64_t __t197;
            {
                ...
                int64_t out_1159 = (int64_t)(intptr_t)(__ps_201);
                (void)out_1159;
                __t197 = out_1159;
            }
            __t195 = __t197;
        ...
        if (__ps_206) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1230 = __ps_207;
                (void)h_1230;
                void * __ps_208 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1231 = __ps_208;
                (void)k_1231;
                bool __ps_209 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1230, (void *)(intptr_t)(k_1231), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_209) {
                    void * __t210 = iter;
                    void * __t211 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t213;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1234 = __ps_215;
            (void)iter_1234;
            void * __ps_216 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_217 = (hamt_slkeyeq((void *)(intptr_t)(__ps_216)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1235 = __ps_217;
            (void)keyeq_1235;
            void * __ps_218 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_219 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1234), (void *)(intptr_t)(__ps_218), (void *)(intptr_t)(keyeq_1235)));
            if (tur_panicking) return ((bool)0);
            bool result_1236 = __ps_219;
            (void)result_1236;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t240;
        {
            ...
            {
                tur_adt_Vec__int * __ps_242 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1366));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1367 = __ps_242;
                (void)_un_unv_1367;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t246;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1417 = __ps_247;
            (void)r_1417;
            int64_t __t248;
            bool __ps_249 = (schema_hydecode_hyok_qu(r_1417));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_249) {
                int64_t __ps_250 = (schema_hydecode_hyvalue(r_1417));
                if (tur_panicking) return ((int64_t)0);
                __t248 = __ps_250;
            } else {
                int64_t __ps_251 = (schema_hydecode_hyerrors(r_1417));
                if (tur_panicking) return ((int64_t)0);
...
static double first_hyx(const tur_adt_Line * l) {
        double __t264 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1477 = __scrut->a;
                tur_adt_Pt b_1478 = __scrut->b;
                double __t266 = 0;
                {
                    tur_adt_Pt __scrut = (a_1477);
                    {
                        double x_1479 = (double)__scrut.x;
                        double y_1480 = (double)__scrut.y;
                        __t266 = x_1479;
                        goto ____t267;
                    }
                    ____t267:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t268 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1482 = __scrut->a;
                tur_adt_Pt b_1483 = __scrut->b;
                double __t270 = 0;
                {
                    tur_adt_Pt __scrut = (b_1483);
                    {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t272;
        {
            tur_adt_Pt __ps_273 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_274 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_275 = (ctor_Line_Line(__ps_273, __ps_274));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1487 = __ps_275;
            (void)l_1487;
            tur_adt_Pt __ps_276 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_277 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_278 = (ctor_Line_Line(__ps_276, __ps_277));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1488 = __ps_278;
            (void)m_1488;
            tur_adt_Pt __ps_279 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_280 = (ctor_Box_Box(__ps_279));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1489 = __ps_280;
            (void)b_1489;
            double __ps_281 = (first_hyx(&l_1487));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_281));
            double __ps_282 = (second_hyy(&m_1488));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_282));
            double __ps_283 = (box_hyx(b_1489));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_283));
            int64_t __t284;
            __t284 = INT64_C(0);
