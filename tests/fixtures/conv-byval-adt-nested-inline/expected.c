...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t187;
        {
            tur_adt_Pt __ps_188 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_189 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_190 = (ctor_Line_Line(__ps_188, __ps_189));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1452 = __ps_190;
            (void)l_1452;
            tur_adt_Pt __ps_191 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_192 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_193 = (ctor_Line_Line(__ps_191, __ps_192));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1453 = __ps_193;
            (void)m_1453;
            tur_adt_Pt __ps_194 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_195 = (ctor_Box_Box(__ps_194));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1454 = __ps_195;
            (void)b_1454;
            tur_adt_Line __t196 = l_1452;
            double __ps_197 = (first_hyx(&__t196));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_197));
            tur_adt_Line __t198 = m_1453;
            double __ps_199 = (second_hyy(&__t198));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_199));
            double __ps_200 = (box_hyx(b_1454));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_200));
            int64_t __t201;
            __t201 = INT64_C(0);
