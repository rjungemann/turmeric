        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                if ((t1_1104) == (INT64_C(0))) {
                    __t100 = (t2_1105) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_1105) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        bool __ps_102 = (cons_hyeq_hygo(t1_1104, t2_1105));
                        if (tur_panicking) return ((bool)0);
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1120 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1120;
                __t109 = out_1120;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1195 = __ps_120;
            (void)iter_1195;
            void * __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1196 = __ps_122;
            (void)keyeq_1196;
            void * __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1195), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1196)));
            if (tur_panicking) return ((bool)0);
            bool result_1197 = __ps_124;
            (void)result_1197;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                tur_adt_Vec__int * __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1324));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1325 = __ps_147;
                (void)_un_unv_1325;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1375 = __ps_152;
            (void)r_1375;
            int64_t __t153;
            bool __ps_154 = (schema_hydecode_hyok_qu(r_1375));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_154) {
                int64_t __ps_155 = (schema_hydecode_hyvalue(r_1375));
                if (tur_panicking) return ((int64_t)0);
                __t153 = __ps_155;
            } else {
                int64_t __ps_156 = (schema_hydecode_hyerrors(r_1375));
                if (tur_panicking) return ((int64_t)0);
...
static double first_hyx(const tur_adt_Line * l) {
        double __t168 = 0;
        {
            ...
            {
                tur_adt_Pt a_1442 = __scrut->a;
                tur_adt_Pt b_1443 = __scrut->b;
                double __t170 = 0;
                {
                    tur_adt_Pt __scrut = (a_1442);
                    {
                        double x_1444 = (double)__scrut.x;
                        double y_1445 = (double)__scrut.y;
                        __t170 = x_1444;
                        goto ____t171;
                    }
                    ____t171:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t172 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1447 = __scrut->a;
                tur_adt_Pt b_1448 = __scrut->b;
                double __t174 = 0;
                {
                    tur_adt_Pt __scrut = (b_1448);
                    {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t176;
        {
            tur_adt_Pt __ps_177 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_178 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_179 = (ctor_Line_Line(__ps_177, __ps_178));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1452 = __ps_179;
            (void)l_1452;
            tur_adt_Pt __ps_180 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_181 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_182 = (ctor_Line_Line(__ps_180, __ps_181));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1453 = __ps_182;
            (void)m_1453;
            tur_adt_Pt __ps_183 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_184 = (ctor_Box_Box(__ps_183));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1454 = __ps_184;
            (void)b_1454;
            tur_adt_Line __t185 = l_1452;
            double __ps_186 = (first_hyx(&__t185));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_186));
            tur_adt_Line __t187 = m_1453;
            double __ps_188 = (second_hyy(&__t187));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_188));
            double __ps_189 = (box_hyx(b_1454));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_189));
            int64_t __t190;
            __t190 = INT64_C(0);
