...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_102) {
            bool __t103;
            {
                ...
                bool __t104;
                if ((t1_994) == (INT64_C(0))) {
                    __t104 = (t2_995) == (INT64_C(0));
                } else {
                    bool __t105;
                    if ((t2_995) == (INT64_C(0))) {
                        __t105 = false;
                    } else {
                        __auto_type __ps_106 = (cons_hyeq_hygo(t1_994, t2_995));
                        if (tur_panicking) return (bool){0};
                        __t105 = __ps_106;
                    }
                    __t104 = __t105;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1003 = (int64_t)(intptr_t)(__ps_114);
                (void)out_1003;
                __t109 = out_1003;
            }
            __t107 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1010 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1010;
                __t117 = out_1010;
            }
            __t115 = __t117;
        ...
        if (__ps_126) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1081 = __ps_127;
                (void)h_1081;
                __auto_type __ps_128 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1082 = __ps_128;
                (void)k_1082;
                __auto_type __ps_129 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1081, (void *)(intptr_t)(k_1082), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_129) {
                    void * __t130 = iter;
                    void * __t131 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t133;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1085 = __ps_135;
            (void)iter_1085;
            __auto_type __ps_136 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_137 = (hamt_slkeyeq((void *)(intptr_t)(__ps_136)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1086 = __ps_137;
            (void)keyeq_1086;
            __auto_type __ps_138 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_139 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1085), (void *)(intptr_t)(__ps_138), (void *)(intptr_t)(keyeq_1086)));
            if (tur_panicking) return (bool){0};
            bool result_1087 = __ps_139;
            (void)result_1087;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t160;
        {
            ...
            {
                __auto_type __ps_162 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1214));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1215 = __ps_162;
                (void)_un_unv_1215;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t165;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1264 = __ps_166;
            (void)r_1264;
            int64_t __t167;
            __auto_type __ps_168 = (schema_hydecode_hyok_qu(r_1264));
            if (tur_panicking) return (int64_t){0};
            if (__ps_168) {
                __auto_type __ps_169 = (schema_hydecode_hyvalue(r_1264));
                if (tur_panicking) return (int64_t){0};
                __t167 = __ps_169;
            } else {
                __auto_type __ps_170 = (schema_hydecode_hyerrors(r_1264));
                if (tur_panicking) return (int64_t){0};
