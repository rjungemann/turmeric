...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t180;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1627 = __ps_186;
            (void)m_1627;
            tur_adt_Pt __ps_187 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_188 = (ctor_Box_Box(__ps_187));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1628 = __ps_188;
            (void)b_1628;
            double __ps_189 = (first_hyx(&l_1626));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_189));
            double __ps_190 = (second_hyy(&m_1627));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_190));
            double __ps_191 = (box_hyx(b_1628));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_191));
            int64_t __t192;
            __t192 = INT64_C(0);
