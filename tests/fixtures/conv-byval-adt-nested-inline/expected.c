...
static double first_hyx(const tur_adt_Line * l) {
        double __t172 = 0;
        {
            ...
            {
                tur_adt_Pt a_1629 = __scrut->a;
                tur_adt_Pt b_1630 = __scrut->b;
                double __t174 = 0;
                {
                    tur_adt_Pt __scrut = (a_1629);
                    {
                        double x_1631 = (double)__scrut.x;
                        double y_1632 = (double)__scrut.y;
                        __t174 = x_1631;
                        goto ____t175;
                    }
                    ____t175:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t176 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1634 = __scrut->a;
                tur_adt_Pt b_1635 = __scrut->b;
                double __t178 = 0;
                {
                    tur_adt_Pt __scrut = (b_1635);
                    {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t180;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1640 = __ps_186;
            (void)m_1640;
            tur_adt_Pt __ps_187 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_188 = (ctor_Box_Box(__ps_187));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1641 = __ps_188;
            (void)b_1641;
            double __ps_189 = (first_hyx(&l_1639));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_189));
            double __ps_190 = (second_hyy(&m_1640));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_190));
            double __ps_191 = (box_hyx(b_1641));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_191));
            int64_t __t192;
            __t192 = INT64_C(0);
