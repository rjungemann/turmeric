        ...
        bool __t28;
        {
            ...
            if ((t1_1020) == (INT64_C(0))) {
                ...
                if ((t2_1021) == (INT64_C(0))) {
                    ...
                    bool __ps_31 = (cons_hyeq_hygo(t1_1020, t2_1021));
                    if (tur_panicking) return ((bool)0);
                    __t30 = __ps_31;
                }
                __t29 = __t30;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_767, (void *)(intptr_t)(k_768), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_772), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_773), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            ...
            bool __t96;
            {
                ...
                if ((t1_1015) == (INT64_C(0))) {
                    ...
                    if ((t2_1016) == (INT64_C(0))) {
                        ...
                        bool __ps_99 = (cons_hyeq_hygo(t1_1015, t2_1016));
                        if (tur_panicking) return ((bool)0);
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1106), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1107)));
            if (tur_panicking) return ((bool)0);
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                tur_adt_Vec__int * __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1235));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            (void)r_1285;
            int64_t __t149;
            bool __ps_150 = (schema_hydecode_hyok_qu(r_1285));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_150) {
                int64_t __ps_151 = (schema_hydecode_hyvalue(r_1285));
                if (tur_panicking) return ((int64_t)0);
                __t149 = __ps_151;
            } else {
                int64_t __ps_152 = (schema_hydecode_hyerrors(r_1285));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t163;
        {
            ...
            double __ps_173 = (first_hyx(&__t172));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_173));
            tur_adt_Line __t174 = m_1321;
            double __ps_175 = (second_hyy(&__t174));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_175));
            double __ps_176 = (box_hyx(b_1322));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_176));
            int64_t __t177;
            __t177 = INT64_C(0);
