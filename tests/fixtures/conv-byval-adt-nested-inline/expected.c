...
static double second_hyy(const tur_adt_Line * l) {
        double __t177 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1287 = __scrut->a;
                tur_adt_Pt b_1288 = __scrut->b;
                double __t179 = 0;
                {
                    tur_adt_Pt __scrut = (b_1288);
                    {
                        double x_1289 = (double)__scrut.x;
                        double y_1290 = (double)__scrut.y;
                        __t179 = y_1290;
                        goto ____t180;
                    }
                    ____t180:;
