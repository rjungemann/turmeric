...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                (void)t2_1285;
                bool __t100;
                bool __ps_101 = (tnil_qu(t1_1284));
                if (tur_panicking) return ((bool)0);
                if (__ps_101) {
                    bool __ps_102 = (tnil_qu(t2_1285));
                    if (tur_panicking) return ((bool)0);
                    __t100 = __ps_102;
                } else {
                    bool __t103;
                    ...
                    if (__ps_104) {
                        ...
                        bool __ps_105 = (cons_hyeq_hygo(t1_1284, t2_1285));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_105;
                    }
                    __t100 = __t103;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                int64_t out_1300 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1300;
                __t112 = out_1300;
            }
            __t110 = __t112;
        ...
        if (__ps_117) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1371 = __ps_118;
                (void)h_1371;
                void * __ps_119 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1372 = __ps_119;
                (void)k_1372;
                bool __ps_120 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1371, (void *)(intptr_t)(k_1372), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_120) {
                    void * __t121 = iter;
                    void * __t122 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t124;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1375 = __ps_126;
            (void)iter_1375;
            void * __ps_127 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_128 = (hamt_slkeyeq((void *)(intptr_t)(__ps_127)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1376 = __ps_128;
            (void)keyeq_1376;
            void * __ps_129 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_130 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1375), (void *)(intptr_t)(__ps_129), (void *)(intptr_t)(keyeq_1376)));
            if (tur_panicking) return ((bool)0);
            bool result_1377 = __ps_130;
            (void)result_1377;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t151;
        {
            ...
            {
                tur_adt_Vec__int * __ps_153 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1507));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1508 = __ps_153;
                (void)_un_unv_1508;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1558 = __ps_156;
            (void)r_1558;
            bool __ps_157 = (schema_hydecode_hyok_qu(r_1558));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_157) {
                return schema_hydecode_hyvalue(r_1558);
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1558));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t160;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1609 = __ps_161;
            (void)m_1609;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            struct __defer_env_163 __t165 = {.m = m_1609};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t181;
        {
            tur_adt_Pt __ps_182 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_183 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_184 = (ctor_Line_Line(__ps_182, __ps_183));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1626 = __ps_184;
            (void)l_1626;
            tur_adt_Pt __ps_185 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_186 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_187 = (ctor_Line_Line(__ps_185, __ps_186));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1627 = __ps_187;
            (void)m_1627;
            tur_adt_Pt __ps_188 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_189 = (ctor_Box_Box(__ps_188));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1628 = __ps_189;
            (void)b_1628;
            double __ps_190 = (first_hyx(&l_1626));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_190));
            double __ps_191 = (second_hyy(&m_1627));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_191));
            double __ps_192 = (box_hyx(b_1628));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_192));
            int64_t __t193;
            __t193 = INT64_C(0);
