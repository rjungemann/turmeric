...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                int64_t out_1122 = (int64_t)(intptr_t)(__t120);
                (void)out_1122;
                __t115 = out_1122;
            }
            __t113 = __t115;
        ...
        if (__ps_125) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1193 = __ps_126;
                (void)h_1193;
                void * __ps_127 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1194 = __ps_127;
                (void)k_1194;
                bool __ps_128 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1193, (void *)(intptr_t)(k_1194), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_128) {
                    void * __t129 = iter;
                    void * __t130 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t132;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1197 = __ps_134;
            (void)iter_1197;
            void * __ps_135 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_136 = (hamt_slkeyeq((void *)(intptr_t)(__ps_135)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1198 = __ps_136;
            (void)keyeq_1198;
            void * __ps_137 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_138 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1197), (void *)(intptr_t)(__ps_137), (void *)(intptr_t)(keyeq_1198)));
            if (tur_panicking) return ((bool)0);
            bool result_1199 = __ps_138;
            (void)result_1199;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t159;
        {
            ...
            {
                tur_adt_Vec__int * __ps_161 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1327));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1328 = __ps_161;
                (void)_un_unv_1328;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t165;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1378 = __ps_166;
            (void)r_1378;
            int64_t __t167;
            bool __ps_168 = (schema_hydecode_hyok_qu(r_1378));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_168) {
                int64_t __ps_169 = (schema_hydecode_hyvalue(r_1378));
                if (tur_panicking) return ((int64_t)0);
                __t167 = __ps_169;
            } else {
                int64_t __ps_170 = (schema_hydecode_hyerrors(r_1378));
                if (tur_panicking) return ((int64_t)0);
...
static double first_hyx(const tur_adt_Line * l) {
        double __t183 = 0;
        {
            ...
            {
                tur_adt_Pt a_1446 = __scrut->a;
                tur_adt_Pt b_1447 = __scrut->b;
                double __t185 = 0;
                {
                    tur_adt_Pt __scrut = (a_1446);
                    {
                        double x_1448 = (double)__scrut.x;
                        double y_1449 = (double)__scrut.y;
                        __t185 = x_1448;
                        goto ____t186;
                    }
                    ____t186:;
...
static double second_hyy(const tur_adt_Line * l) {
        double __t187 = 0;
        {
            const tur_adt_Line *__scrut = (l);
            {
                tur_adt_Pt a_1451 = __scrut->a;
                tur_adt_Pt b_1452 = __scrut->b;
                double __t189 = 0;
                {
                    tur_adt_Pt __scrut = (b_1452);
                    {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t191;
        {
            tur_adt_Pt __ps_192 = (ctor_Pt_Pt(7.1, 2.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_193 = (ctor_Pt_Pt(3.25, 9.0));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_194 = (ctor_Line_Line(__ps_192, __ps_193));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line l_1456 = __ps_194;
            (void)l_1456;
            tur_adt_Pt __ps_195 = (ctor_Pt_Pt(1.5, 2.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Pt __ps_196 = (ctor_Pt_Pt(3.5, 4.5));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line __ps_197 = (ctor_Line_Line(__ps_195, __ps_196));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Line m_1457 = __ps_197;
            (void)m_1457;
            tur_adt_Pt __ps_198 = (ctor_Pt_Pt(8.25, 6.75));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box __ps_199 = (ctor_Box_Box(__ps_198));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box b_1458 = __ps_199;
            (void)b_1458;
            double __ps_200 = (first_hyx(&l_1456));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_200));
            double __ps_201 = (second_hyy(&m_1457));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_201));
            double __ps_202 = (box_hyx(b_1458));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%g\n", (double)(__ps_202));
            int64_t __t203;
            __t203 = INT64_C(0);
