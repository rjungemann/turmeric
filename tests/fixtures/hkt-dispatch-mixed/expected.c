...
static const char * __inst_MyLabel_label_int(int64_t);
static const char * __inst_MyLabel_label_bool(bool);
...
static const char * __inst_MyLabel_label_int(int64_t x) {
        return "number";
}

typedef struct dict_MyLabel_int {
    const char * (*label)(int64_t);
} dict_MyLabel_int;

static dict_MyLabel_int dict_MyLabel_int_singleton = {
    .label = __inst_MyLabel_label_int,
};

static const char * __inst_MyLabel_label_bool(bool x) {
        return "flag";
}

typedef struct dict_MyLabel_bool {
    const char * (*label)(bool);
} dict_MyLabel_bool;

static dict_MyLabel_bool dict_MyLabel_bool_singleton = {
    .label = __inst_MyLabel_label_bool,
};
...
int main() {
        puts(((const char * (*)(int64_t))(intptr_t)(dict_MyLabel_int_singleton.label))(INT64_C(0)));
        puts(((const char * (*)(bool))(intptr_t)(dict_MyLabel_bool_singleton.label))(true));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
