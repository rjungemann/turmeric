...
static int64_t add_with_effect(int64_t);

static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_3(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t n_617 = (int64_t)__effect_args[0];
    int64_t k_618 = __k;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_618, (int64_t)n_617);
    return (int64_t)__t4;
}

static void __handle_body_2(void);
static void __handle_body_2(void) {
    tur_current_fiber->result = (int64_t)add_with_effect(INT64_C(5));
}
...
static int64_t __dispatch_2(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Increment") == 0) {
...
static int64_t add_with_effect(int64_t x) {
        int64_t __t0[1];
        __t0[0] = (int64_t)INT64_C(10);
        int64_t __t1 = tur_effect_perform("Increment", __t0, 1);
        return ((x) + (__t1));
}
...
int main(int argc, char **argv) {
    ...
    __eff_frame_2.cases[0].effect_name = "Increment";
