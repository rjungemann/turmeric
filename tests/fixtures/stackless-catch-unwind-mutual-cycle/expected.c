...
struct __env_1368 { tur_thunk_int64_t_t __fn; int64_t n; };
...
static int64_t __fn_1366(void * __env_p_1369) {
        ...
        int64_t __ps_44 = (b((__env___env_1368->n) - (INT64_C(1))));
        ...
        if (__ps_103) {
            bool __t104;
            {
                ...
                if ((t1_1073) == (INT64_C(0))) {
                    __t105 = (t2_1074) == (INT64_C(0));
                } else {
                    bool __t106;
                    if ((t2_1074) == (INT64_C(0))) {
                        __t106 = false;
                    } else {
                        bool __ps_107 = (cons_hyeq_hygo(t1_1073, t2_1074));
                        if (tur_panicking) return ((bool)0);
                        __t106 = __ps_107;
                    }
                    __t105 = __t106;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1089 = (int64_t)(intptr_t)(__ps_118);
                (void)out_1089;
                __t114 = out_1089;
            }
            __t112 = __t114;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1164 = __ps_125;
            (void)iter_1164;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1165 = __ps_127;
            (void)keyeq_1165;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1164), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1165)));
            if (tur_panicking) return ((bool)0);
            bool result_1166 = __ps_129;
            (void)result_1166;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1293));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1294 = __ps_152;
                (void)_un_unv_1294;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t156;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1344 = __ps_157;
            (void)r_1344;
            int64_t __t158;
            bool __ps_159 = (schema_hydecode_hyok_qu(r_1344));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_159) {
                int64_t __ps_160 = (schema_hydecode_hyvalue(r_1344));
                if (tur_panicking) return ((int64_t)0);
                __t158 = __ps_160;
            } else {
                int64_t __ps_161 = (schema_hydecode_hyerrors(r_1344));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t __cu_group_0(int __pc, int64_t __a0) {
 ...
 switch (__pc) {
  case 1: {
   n_1365 = (int64_t)(intptr_t)(__a0);
   break; }
  case 2: {
   n_1371 = (int64_t)(intptr_t)(__a0);
   break; }
  case 3: {
   n_1372 = (int64_t)(intptr_t)(__a0);
   break; }
 }
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1365) == (INT64_C(0))) {
     ...
     __n168->tag = 5; __n168->boundary = __b168; __n168->next = __k;
     __n168->aggr_mask = 0x0u;
     __n168->saved[0] = (int64_t)(intptr_t)(n_1365);
     __n168->saved[1] = (int64_t)(intptr_t)(n_1371);
     __n168->saved[2] = (int64_t)(intptr_t)(n_1372);
     __n168->saved[3] = (int64_t)(intptr_t)(__t164);
     __n168->saved[4] = (int64_t)(intptr_t)(__t165);
     __n168->saved[5] = (int64_t)(intptr_t)(__t166);
     __n168->saved[6] = (int64_t)(intptr_t)(__t167);
     __k = __n168; __pc = 4; break;
    }
   }
   case 4: {
    int64_t __ra169_0 = ((n_1365) - (INT64_C(1)));
    n_1371 = __ra169_0;
    __pc = 2; break;
   }
   case 5: {
    n_1365 = (int64_t)(intptr_t)(__k->saved[0]);
    n_1371 = (int64_t)(intptr_t)(__k->saved[1]);
    n_1372 = (int64_t)(intptr_t)(__k->saved[2]);
    ...
    (void)(__box168);
    __v = (int64_t)(intptr_t)((INT64_C(1)) + (n_1365)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1371) == (INT64_C(0))) {
     __v = (int64_t)(intptr_t)(INT64_C(0)); __pc = __k->tag; break;
     ...
     __n170->tag = 6; __n170->boundary = 0; __n170->next = __k;
     __n170->aggr_mask = 0x0u;
     __n170->saved[0] = (int64_t)(intptr_t)(n_1365);
     __n170->saved[1] = (int64_t)(intptr_t)(n_1371);
     __n170->saved[2] = (int64_t)(intptr_t)(n_1372);
     __n170->saved[3] = (int64_t)(intptr_t)(__t164);
     __n170->saved[4] = (int64_t)(intptr_t)(__t165);
     __n170->saved[5] = (int64_t)(intptr_t)(__t166);
     __n170->saved[6] = (int64_t)(intptr_t)(__t167);
     int64_t __ra170_0 = ((n_1371) - (INT64_C(1)));
     n_1372 = __ra170_0;
   ...
   case 6: {
    ...
    __t166 = (int64_t)(intptr_t)(__k->saved[5]);
    __t167 = (int64_t)(intptr_t)(__k->saved[6]);
    __t166 = (int64_t)(intptr_t)(__v);
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((INT64_C(10)) + (__t166)); __pc = __k->tag; break;
   }
   case 3: {
    if ((n_1372) == (INT64_C(0))) {
     __v = (int64_t)(intptr_t)(INT64_C(0)); __pc = __k->tag; break;
     ...
     __n171->tag = 7; __n171->boundary = 0; __n171->next = __k;
     __n171->aggr_mask = 0x0u;
     __n171->saved[0] = (int64_t)(intptr_t)(n_1365);
     __n171->saved[1] = (int64_t)(intptr_t)(n_1371);
     __n171->saved[2] = (int64_t)(intptr_t)(n_1372);
     __n171->saved[3] = (int64_t)(intptr_t)(__t164);
     __n171->saved[4] = (int64_t)(intptr_t)(__t165);
     __n171->saved[5] = (int64_t)(intptr_t)(__t166);
     __n171->saved[6] = (int64_t)(intptr_t)(__t167);
     int64_t __ra171_0 = ((n_1372) - (INT64_C(1)));
     n_1365 = __ra171_0;
   ...
   case 7: {
    ...
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((INT64_C(100)) + (__t167)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    int64_t __ps_172 = (a(INT64_C(300000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_172));
    int64_t __t173;
    __t173 = INT64_C(0);
