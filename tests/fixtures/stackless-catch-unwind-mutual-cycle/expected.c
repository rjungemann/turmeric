...
static int64_t __fn_1334(void * __env_p_1337) {
        ...
        int64_t __ps_42 = (b((__env___env_1336->n) - (INT64_C(1))));
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t153;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1312 = __ps_154;
            (void)r_1312;
            int64_t __t155;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1312));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                int64_t __ps_157 = (schema_hydecode_hyvalue(r_1312));
                if (tur_panicking) return ((int64_t)0);
                __t155 = __ps_157;
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1312));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t __cu_group_0(int __pc, int64_t __a0) {
 ...
 switch (__pc) {
  case 1: {
   n_1333 = (int64_t)(intptr_t)(__a0);
   break; }
  case 2: {
   n_1339 = (int64_t)(intptr_t)(__a0);
   break; }
  case 3: {
   n_1340 = (int64_t)(intptr_t)(__a0);
   break; }
 }
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1333) == (INT64_C(0))) {
     ...
     __n165->tag = 5; __n165->boundary = __b165; __n165->next = __k;
     __n165->aggr_mask = 0x0u;
     __n165->saved[0] = (int64_t)(intptr_t)(n_1333);
     __n165->saved[1] = (int64_t)(intptr_t)(n_1339);
     __n165->saved[2] = (int64_t)(intptr_t)(n_1340);
     __n165->saved[3] = (int64_t)(intptr_t)(__t161);
     __n165->saved[4] = (int64_t)(intptr_t)(__t162);
     __n165->saved[5] = (int64_t)(intptr_t)(__t163);
     __n165->saved[6] = (int64_t)(intptr_t)(__t164);
     __k = __n165; __pc = 4; break;
    }
   }
   case 4: {
    int64_t __ra166_0 = ((n_1333) - (INT64_C(1)));
    n_1339 = __ra166_0;
    __pc = 2; break;
   }
   case 5: {
    n_1333 = (int64_t)(intptr_t)(__k->saved[0]);
    n_1339 = (int64_t)(intptr_t)(__k->saved[1]);
    n_1340 = (int64_t)(intptr_t)(__k->saved[2]);
    ...
    (void)(__box165);
    __v = (int64_t)(intptr_t)((INT64_C(1)) + (n_1333)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1339) == (INT64_C(0))) {
     __v = (int64_t)(intptr_t)(INT64_C(0)); __pc = __k->tag; break;
     ...
     __n167->tag = 6; __n167->boundary = 0; __n167->next = __k;
     __n167->aggr_mask = 0x0u;
     __n167->saved[0] = (int64_t)(intptr_t)(n_1333);
     __n167->saved[1] = (int64_t)(intptr_t)(n_1339);
     __n167->saved[2] = (int64_t)(intptr_t)(n_1340);
     __n167->saved[3] = (int64_t)(intptr_t)(__t161);
     __n167->saved[4] = (int64_t)(intptr_t)(__t162);
     __n167->saved[5] = (int64_t)(intptr_t)(__t163);
     __n167->saved[6] = (int64_t)(intptr_t)(__t164);
     int64_t __ra167_0 = ((n_1339) - (INT64_C(1)));
     n_1340 = __ra167_0;
     __k = __n167; __pc = 3; break;
    }
   }
   case 6: {
    n_1333 = (int64_t)(intptr_t)(__k->saved[0]);
    ...
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((INT64_C(10)) + (__t163)); __pc = __k->tag; break;
   }
   case 3: {
    if ((n_1340) == (INT64_C(0))) {
     __v = (int64_t)(intptr_t)(INT64_C(0)); __pc = __k->tag; break;
     ...
     __n168->tag = 7; __n168->boundary = 0; __n168->next = __k;
     __n168->aggr_mask = 0x0u;
     __n168->saved[0] = (int64_t)(intptr_t)(n_1333);
     __n168->saved[1] = (int64_t)(intptr_t)(n_1339);
     __n168->saved[2] = (int64_t)(intptr_t)(n_1340);
     __n168->saved[3] = (int64_t)(intptr_t)(__t161);
     __n168->saved[4] = (int64_t)(intptr_t)(__t162);
     __n168->saved[5] = (int64_t)(intptr_t)(__t163);
     __n168->saved[6] = (int64_t)(intptr_t)(__t164);
     int64_t __ra168_0 = ((n_1340) - (INT64_C(1)));
     n_1333 = __ra168_0;
   ...
   case 7: {
    ...
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((INT64_C(100)) + (__t164)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    int64_t __ps_169 = (a(INT64_C(300000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_169));
    int64_t __t170;
    __t170 = INT64_C(0);
