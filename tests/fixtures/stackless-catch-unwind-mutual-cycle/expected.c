...
static int64_t __fn_1283(void * __env_p_1286) {
        ...
        __auto_type __ps_40 = (b((__env___env_1285->n) - (INT64_C(1))));
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_68 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_744, (void *)(intptr_t)(k_745), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t70;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_749 = __ps_72;
            (void)iter_749;
            __auto_type __ps_73 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_74 = (hamt_slkeyeq((void *)(intptr_t)(__ps_73)));
            if (tur_panicking) return (bool){0};
            void * keyeq_750 = __ps_74;
            (void)keyeq_750;
            __auto_type __ps_75 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_76 = (map_hyeq_hyloop((void *)(intptr_t)(iter_749), (void *)(intptr_t)(__ps_75), (void *)(intptr_t)(keyeq_750), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_751 = __ps_76;
            (void)result_751;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_94) {
            bool __t95;
            {
                ...
                bool __t96;
                if ((t1_991) == (INT64_C(0))) {
                    __t96 = (t2_992) == (INT64_C(0));
                } else {
                    bool __t97;
                    if ((t2_992) == (INT64_C(0))) {
                        __t97 = false;
                    } else {
                        __auto_type __ps_98 = (cons_hyeq_hygo(t1_991, t2_992));
                        if (tur_panicking) return (bool){0};
                        __t97 = __ps_98;
                    }
                    __t96 = __t97;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_104) {
            ...
            int64_t __t105;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1007 = (int64_t)(intptr_t)(__ps_109);
                (void)out_1007;
                __t105 = out_1007;
            }
            __t103 = __t105;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t114;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1082 = __ps_116;
            (void)iter_1082;
            __auto_type __ps_117 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_118 = (hamt_slkeyeq((void *)(intptr_t)(__ps_117)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1083 = __ps_118;
            (void)keyeq_1083;
            __auto_type __ps_119 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_120 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1082), (void *)(intptr_t)(__ps_119), (void *)(intptr_t)(keyeq_1083)));
            if (tur_panicking) return (bool){0};
            bool result_1084 = __ps_120;
            (void)result_1084;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t141;
        {
            ...
            {
                __auto_type __ps_143 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1211));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1212 = __ps_143;
                (void)_un_unv_1212;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t146;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1261 = __ps_147;
            (void)r_1261;
            int64_t __t148;
            __auto_type __ps_149 = (schema_hydecode_hyok_qu(r_1261));
            if (tur_panicking) return (int64_t){0};
            if (__ps_149) {
                __auto_type __ps_150 = (schema_hydecode_hyvalue(r_1261));
                if (tur_panicking) return (int64_t){0};
                __t148 = __ps_150;
            } else {
                __auto_type __ps_151 = (schema_hydecode_hyerrors(r_1261));
                if (tur_panicking) return (int64_t){0};
...
static int64_t __cu_group_0(int __pc, int64_t __a0) {
 ...
 switch (__pc) {
  case 1: {
   n_1282 = (int64_t)(intptr_t)(__a0);
   break; }
  case 2: {
   n_1288 = (int64_t)(intptr_t)(__a0);
   break; }
  case 3: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1282) == (INT64_C(0))) {
     ...
     __n158->tag = 5; __n158->boundary = __b158; __n158->next = __k;
     __n158->aggr_mask = 0x0u;
     __n158->saved[0] = (int64_t)(intptr_t)(n_1282);
     __n158->saved[1] = (int64_t)(intptr_t)(n_1288);
     __n158->saved[2] = (int64_t)(intptr_t)(n_1289);
     __n158->saved[3] = (int64_t)(intptr_t)(__t154);
     __n158->saved[4] = (int64_t)(intptr_t)(__t155);
     __n158->saved[5] = (int64_t)(intptr_t)(__t156);
     __n158->saved[6] = (int64_t)(intptr_t)(__t157);
     __k = __n158; __pc = 4; break;
    }
   }
   case 4: {
    __auto_type __ra159_0 = ((n_1282) - (INT64_C(1)));
    n_1288 = __ra159_0;
    __pc = 2; break;
   }
   case 5: {
    n_1282 = (int64_t)(intptr_t)(__k->saved[0]);
    n_1288 = (int64_t)(intptr_t)(__k->saved[1]);
    n_1289 = (int64_t)(intptr_t)(__k->saved[2]);
    __t154 = (int64_t)(intptr_t)(__k->saved[3]);
    __t155 = (int64_t)(intptr_t)(__k->saved[4]);
    __t156 = (int64_t)(intptr_t)(__k->saved[5]);
    __t157 = (int64_t)(intptr_t)(__k->saved[6]);
    ...
    (void)(__box158);
    __v = (int64_t)(intptr_t)((INT64_C(1)) + (n_1282)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1288) == (INT64_C(0))) {
     __v = (int64_t)(intptr_t)(INT64_C(0)); __pc = __k->tag; break;
     ...
     __n160->tag = 6; __n160->boundary = 0; __n160->next = __k;
     __n160->aggr_mask = 0x0u;
     __n160->saved[0] = (int64_t)(intptr_t)(n_1282);
     __n160->saved[1] = (int64_t)(intptr_t)(n_1288);
     __n160->saved[2] = (int64_t)(intptr_t)(n_1289);
     __n160->saved[3] = (int64_t)(intptr_t)(__t154);
     __n160->saved[4] = (int64_t)(intptr_t)(__t155);
     __n160->saved[5] = (int64_t)(intptr_t)(__t156);
     __n160->saved[6] = (int64_t)(intptr_t)(__t157);
     __auto_type __ra160_0 = ((n_1288) - (INT64_C(1)));
     n_1289 = __ra160_0;
     __k = __n160; __pc = 3; break;
    }
   }
   case 6: {
    n_1282 = (int64_t)(intptr_t)(__k->saved[0]);
    ...
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((INT64_C(10)) + (__t156)); __pc = __k->tag; break;
   }
   case 3: {
    if ((n_1289) == (INT64_C(0))) {
     __v = (int64_t)(intptr_t)(INT64_C(0)); __pc = __k->tag; break;
     ...
     __n161->tag = 7; __n161->boundary = 0; __n161->next = __k;
     __n161->aggr_mask = 0x0u;
     __n161->saved[0] = (int64_t)(intptr_t)(n_1282);
     __n161->saved[1] = (int64_t)(intptr_t)(n_1288);
     __n161->saved[2] = (int64_t)(intptr_t)(n_1289);
     __n161->saved[3] = (int64_t)(intptr_t)(__t154);
     __n161->saved[4] = (int64_t)(intptr_t)(__t155);
     __n161->saved[5] = (int64_t)(intptr_t)(__t156);
     __n161->saved[6] = (int64_t)(intptr_t)(__t157);
     __auto_type __ra161_0 = ((n_1289) - (INT64_C(1)));
     n_1282 = __ra161_0;
     __k = __n161; __pc = 1; break;
    }
   }
   case 7: {
    n_1282 = (int64_t)(intptr_t)(__k->saved[0]);
    ...
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((INT64_C(100)) + (__t157)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    __auto_type __ps_162 = (a(INT64_C(300000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_162));
    int64_t __t163;
    __t163 = INT64_C(0);
