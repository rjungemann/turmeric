...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(10);
            ...
            __t2->value = __t1;
            RcControlBlock * a_616 = __t2;
            (void)a_616;
            rc_strong_increment(a_616);
            RcControlBlock * b_617 = a_616;
            (void)b_617;
            rc_strong_increment(a_616);
            RcControlBlock * c_618 = a_616;
            (void)c_618;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            int64_t __t4 = rc_strong_count(a_616);
            printf("%lld\n", (long long)(__t4));
            rc_strong_decrement(b_617);
            rc_free_queue_drain();
            int64_t __t5 = rc_strong_count(a_616);
            printf("%lld\n", (long long)(__t5));
            rc_strong_decrement(c_618);
            rc_free_queue_drain();
            int64_t __t6 = rc_strong_count(a_616);
            printf("%lld\n", (long long)(__t6));
            struct __defer_env_7 __t9 = {.a = a_616};
