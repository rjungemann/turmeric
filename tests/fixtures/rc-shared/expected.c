...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(10);
            ...
            __t2->value = __t1;
            RcControlBlock * a_196 = __t2;
            (void)a_196;
            rc_strong_increment(a_196);
            RcControlBlock * b_197 = a_196;
            (void)b_197;
            rc_strong_increment(a_196);
            RcControlBlock * c_198 = a_196;
            (void)c_198;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            int64_t __t4 = rc_strong_count(a_196);
            printf("%lld\n", (long long)(__t4));
            rc_strong_decrement(b_197);
            rc_free_queue_drain();
            int64_t __t5 = rc_strong_count(a_196);
            printf("%lld\n", (long long)(__t5));
            rc_strong_decrement(c_198);
            rc_free_queue_drain();
            int64_t __t6 = rc_strong_count(a_196);
            printf("%lld\n", (long long)(__t6));
            struct __defer_env_7 __t9 = {.a = a_196};
