...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(10);
            ...
            __t2->value = __t1;
            RcControlBlock * a_208 = __t2;
            (void)a_208;
            rc_strong_increment(a_208);
            RcControlBlock * b_209 = a_208;
            (void)b_209;
            rc_strong_increment(a_208);
            RcControlBlock * c_210 = a_208;
            (void)c_210;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            int64_t __t4 = rc_strong_count(a_208);
            printf("%lld\n", (long long)(__t4));
            rc_strong_decrement(b_209);
            rc_free_queue_drain();
            int64_t __t5 = rc_strong_count(a_208);
            printf("%lld\n", (long long)(__t5));
            rc_strong_decrement(c_210);
            rc_free_queue_drain();
            int64_t __t6 = rc_strong_count(a_208);
            printf("%lld\n", (long long)(__t6));
            struct __defer_env_7 __t9 = {.a = a_208};
