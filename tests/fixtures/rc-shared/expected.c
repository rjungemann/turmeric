...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(10);
            ...
            __t2->value = __t1;
            RcControlBlock * a_261 = __t2;
            (void)a_261;
            rc_strong_increment(a_261);
            RcControlBlock * b_262 = a_261;
            (void)b_262;
            rc_strong_increment(a_261);
            RcControlBlock * c_263 = a_261;
            (void)c_263;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            int64_t __t4 = rc_strong_count(a_261);
            printf("%lld\n", (long long)(__t4));
            rc_strong_decrement(b_262);
            rc_free_queue_drain();
            int64_t __t5 = rc_strong_count(a_261);
            printf("%lld\n", (long long)(__t5));
            rc_strong_decrement(c_263);
            rc_free_queue_drain();
            int64_t __t6 = rc_strong_count(a_261);
            printf("%lld\n", (long long)(__t6));
            struct __defer_env_7 __t9 = {.a = a_261};
