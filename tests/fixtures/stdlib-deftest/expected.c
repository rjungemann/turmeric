...
static int64_t __fn_202();
static int64_t __fn_204();
...
int main() {
        (void)(register_test("addition", (void *)(intptr_t)(__fn_202)));
        (void)(register_test("equality", (void *)(intptr_t)(__fn_204)));
        int64_t __t6;
        __t6 = run_tests_();
        return (int)__t6;
}
