...
struct __env_1284 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1282(void * __env_p_1285) {
        struct __env_1284 *__env___env_1284 = (struct __env_1284 *)__env_p_1285;
        __auto_type __ps_42 = (f((__env___env_1284->n) - (INT64_C(1)), (__env___env_1284->acc) + (1.0)));
