...
struct __env_1277 { tur_thunk_double_t __fn; int64_t n; double acc; };
static double __fn_1275(void * __env_p_1278) {
        struct __env_1277 *__env___env_1277 = (struct __env_1277 *)__env_p_1278;
        __auto_type __ps_40 = (f((__env___env_1277->n) - (INT64_C(1)), (__env___env_1277->acc) + (1.0)));
