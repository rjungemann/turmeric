...
struct __env_1275 { tur_thunk_double_t __fn; int64_t n; double acc; };
static double __fn_1273(void * __env_p_1276) {
        struct __env_1275 *__env___env_1275 = (struct __env_1275 *)__env_p_1276;
        __auto_type __ps_40 = (f((__env___env_1275->n) - (INT64_C(1)), (__env___env_1275->acc) + (1.0)));
