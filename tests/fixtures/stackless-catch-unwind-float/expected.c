...
struct __env_1626 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1624(void * __env_p_1627) {
        struct __env_1626 *__env___env_1626 = (struct __env_1626 *)__env_p_1627;
        return f((__env___env_1626->n) - (INT64_C(1)), (__env___env_1626->acc) + (1.0));
}
