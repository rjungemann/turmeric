...
struct __env_1439 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1437(void * __env_p_1440) {
        struct __env_1439 *__env___env_1439 = (struct __env_1439 *)__env_p_1440;
        double __ps_40 = (f((__env___env_1439->n) - (INT64_C(1)), (__env___env_1439->acc) + (1.0)));
