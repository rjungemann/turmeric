...
struct __env_1286 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1284(void * __env_p_1287) {
        struct __env_1286 *__env___env_1286 = (struct __env_1286 *)__env_p_1287;
        __auto_type __ps_42 = (f((__env___env_1286->n) - (INT64_C(1)), (__env___env_1286->acc) + (1.0)));
