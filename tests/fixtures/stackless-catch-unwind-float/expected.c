...
static double f(int64_t n, double acc) {
        ...
        for (;;) {
         ...
         if (__act == 0) {
          if ((n) == (INT64_C(0))) {
           __v = tur_sc_bits_f64(acc); __act = 1;
          } else {
           ...
           __k2->saved[1] = tur_sc_bits_f64(acc);
           __auto_type __r0 = ((n) - (INT64_C(1)));
           __auto_type __r1 = ((acc) + (1.0));
           n = __r0;
           acc = __r1;
           __k = __k2;
          }
          ...
          if (__k->tag == 0) {
           ...
           free(__k); return tur_sc_f64_from_bits(__v);
          }
