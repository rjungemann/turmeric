...
struct __env_1333 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1331(void * __env_p_1334) {
        struct __env_1333 *__env___env_1333 = (struct __env_1333 *)__env_p_1334;
        double __ps_42 = (f((__env___env_1333->n) - (INT64_C(1)), (__env___env_1333->acc) + (1.0)));
