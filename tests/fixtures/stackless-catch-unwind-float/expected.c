...
struct __env_1612 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1610(void * __env_p_1613) {
        struct __env_1612 *__env___env_1612 = (struct __env_1612 *)__env_p_1613;
        return f((__env___env_1612->n) - (INT64_C(1)), (__env___env_1612->acc) + (1.0));
}
