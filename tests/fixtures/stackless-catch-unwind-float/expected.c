...
typedef double (*tur_thunk_double_t)(void *);
...
static double f(int64_t, double);
...
struct __env_1611 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1609(void * __env_p_1612) {
        struct __env_1611 *__env___env_1611 = (struct __env_1611 *)__env_p_1612;
        return f((__env___env_1611->n) - (INT64_C(1)), (__env___env_1611->acc) + (1.0));
}
...
static double f(int64_t n, double acc) {
        int64_t __t176 = 0;
        double __t177 = 0;
        ...
        for (;;) {
         if (tur_panicking) {
          ...
          if (__k->tag == 0) {
           free(__k);
           if (tur_handler_chain) return tur_sc_f64_from_bits(INT64_C(0));
         ...
         switch (__pc) {
          case 0: { free(__k); return tur_sc_f64_from_bits(__v); }
          case 1: {
           if ((n) == (INT64_C(0))) {
            __v = tur_sc_bits_f64(acc); __pc = __k->tag; break;
           } else {
            ...
            __n178->saved[1] = tur_sc_bits_f64(acc);
            __n178->saved[2] = (int64_t)(intptr_t)(__t176);
            __n178->saved[3] = tur_sc_bits_f64(__t177);
            __k = __n178; __pc = 2; break;
           }
          }
          case 2: {
           int64_t __ra179_0 = ((n) - (INT64_C(1)));
           double __ra179_1 = ((acc) + (1.0));
           n = __ra179_0;
           acc = __ra179_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           acc = tur_sc_f64_from_bits(__k->saved[1]);
           __t176 = (int64_t)(intptr_t)(__k->saved[2]);
           __t177 = tur_sc_f64_from_bits(__k->saved[3]);
           ...
           (void)(__box178);
           __v = tur_sc_bits_f64((acc) + (0.25)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        double __ps_180 = (f(INT64_C(500000), 2.5));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%g\n", (double)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
