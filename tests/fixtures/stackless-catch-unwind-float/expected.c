...
struct __env_1280 { tur_thunk_double_t __fn; int64_t n; double acc; };
static double __fn_1278(void * __env_p_1281) {
        struct __env_1280 *__env___env_1280 = (struct __env_1280 *)__env_p_1281;
        __auto_type __ps_40 = (f((__env___env_1280->n) - (INT64_C(1)), (__env___env_1280->acc) + (1.0)));
