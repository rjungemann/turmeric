...
struct __env_1624 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1622(void * __env_p_1625) {
        struct __env_1624 *__env___env_1624 = (struct __env_1624 *)__env_p_1625;
        return f((__env___env_1624->n) - (INT64_C(1)), (__env___env_1624->acc) + (1.0));
}
