...
struct __env_1621 { tur_thunk_double_t __fn; int64_t n; double acc; };
...
static double __fn_1619(void * __env_p_1622) {
        struct __env_1621 *__env___env_1621 = (struct __env_1621 *)__env_p_1622;
        return f((__env___env_1621->n) - (INT64_C(1)), (__env___env_1621->acc) + (1.0));
}
