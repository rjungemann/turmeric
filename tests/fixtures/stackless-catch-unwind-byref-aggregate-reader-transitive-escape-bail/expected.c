...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t278;
        tur_adt_Result__int__int __ps_279 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_280 = (ok___spec__bool_tur_adt_Result__int__int(__ps_279));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_280) {
            __t278 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 int64_t __t283 = 0;
 int64_t __t284 = 0;
 tur_adt_Result__int__int __t285; memset(&__t285, 0, sizeof(tur_adt_Result__int__int));
 switch (__pc) {
  case 1: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1612) == (INT64_C(0))) {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t285, sizeof(tur_adt_Result__int__int)); __n287->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t285, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t285, sizeof(tur_adt_Result__int__int)); __n289->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 2: {
    ...
    __n290->tag = 7; __n290->boundary = 0; __n290->next = __k;
    __n290->aggr_mask = 0x10du;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1611, sizeof(tur_adt_Result__int__int)); __n290->saved[0] = (int64_t)(intptr_t)__ab; }
    __n290->saved[1] = (int64_t)(intptr_t)(n_1612);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1610, sizeof(tur_adt_Result__int__int)); __n290->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1609, sizeof(tur_adt_Result__int__int)); __n290->saved[3] = (int64_t)(intptr_t)__ab; }
    __n290->saved[4] = (int64_t)(intptr_t)(__t281);
    __n290->saved[5] = (int64_t)(intptr_t)(__t282);
    __n290->saved[6] = (int64_t)(intptr_t)(__t283);
    __n290->saved[7] = (int64_t)(intptr_t)(__t284);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t285, sizeof(tur_adt_Result__int__int)); __n290->saved[8] = (int64_t)(intptr_t)__ab; }
    tur_adt_Result__int__int __ra290_0 = (r_1610);
    r_1609 = __ra290_0;
    __k = __n290; __pc = 3; break;
   }
   case 7: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1611, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1612 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t284 = (int64_t)(intptr_t)(__k->saved[7]);
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t285, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    tur_adt_Result__int__int __ur291; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur291, __rb, sizeof(tur_adt_Result__int__int)); free(__rb); }
    __t285 = __ur291;
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t292;
    bool __ps_293 = (ok___spec__bool_tur_adt_Result__int__int(__t285));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_293) {
        __t292 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)(__t292); __pc = __k->tag; break;
   }
   case 3: {
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_294 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_295 = (step(__ps_294, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_295));
    tur_adt_Result__int__int __ps_296 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_297 = (step(__ps_296, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_297));
    int64_t __t298;
    __t298 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_302 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_303 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_303;
}
