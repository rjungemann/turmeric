...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t276;
        tur_adt_Result__int__int __ps_277 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_278 = (ok___spec__bool_tur_adt_Result__int__int(__ps_277));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_278) {
            __t276 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 int64_t __t281 = 0;
 int64_t __t282 = 0;
 tur_adt_Result__int__int __t283; memset(&__t283, 0, sizeof(tur_adt_Result__int__int));
 switch (__pc) {
  case 1: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1612) == (INT64_C(0))) {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t283, sizeof(tur_adt_Result__int__int)); __n285->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t283, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t283, sizeof(tur_adt_Result__int__int)); __n287->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 2: {
    tur_cont *__n288 = (tur_cont*)malloc(sizeof(tur_cont));
    __n288->tag = 7; __n288->boundary = 0; __n288->next = __k;
    __n288->aggr_mask = 0x10du;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1611, sizeof(tur_adt_Result__int__int)); __n288->saved[0] = (int64_t)(intptr_t)__ab; }
    __n288->saved[1] = (int64_t)(intptr_t)(n_1612);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1610, sizeof(tur_adt_Result__int__int)); __n288->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1609, sizeof(tur_adt_Result__int__int)); __n288->saved[3] = (int64_t)(intptr_t)__ab; }
    __n288->saved[4] = (int64_t)(intptr_t)(__t279);
    __n288->saved[5] = (int64_t)(intptr_t)(__t280);
    __n288->saved[6] = (int64_t)(intptr_t)(__t281);
    __n288->saved[7] = (int64_t)(intptr_t)(__t282);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t283, sizeof(tur_adt_Result__int__int)); __n288->saved[8] = (int64_t)(intptr_t)__ab; }
    tur_adt_Result__int__int __ra288_0 = (r_1610);
    r_1609 = __ra288_0;
    __k = __n288; __pc = 3; break;
   }
   case 7: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1611, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1612 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t282 = (int64_t)(intptr_t)(__k->saved[7]);
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t283, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    tur_adt_Result__int__int __ur289; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur289, __rb, sizeof(tur_adt_Result__int__int)); free(__rb); }
    __t283 = __ur289;
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t290;
    bool __ps_291 = (ok___spec__bool_tur_adt_Result__int__int(__t283));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_291) {
        __t290 = INT64_C(1);
    } else {
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_292 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_293 = (step(__ps_292, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_293));
    tur_adt_Result__int__int __ps_294 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_295 = (step(__ps_294, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_295));
    int64_t __t296;
    __t296 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_300 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_301 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_301;
}
