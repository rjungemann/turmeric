...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t164;
        tur_adt_Result__int__int __ps_165 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_166 = (ok___spec__bool_tur_adt_Result__int__int(__ps_165));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_166) {
            __t164 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 int64_t __t169 = 0;
 int64_t __t170 = 0;
 tur_adt_Result__int__int __t171; memset(&__t171, 0, sizeof(tur_adt_Result__int__int));
 switch (__pc) {
  case 1: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1372) == (INT64_C(0))) {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t171, sizeof(tur_adt_Result__int__int)); __n173->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t171, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t171, sizeof(tur_adt_Result__int__int)); __n175->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 2: {
    ...
    __n176->aggr_mask = 0x10du;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1371, sizeof(tur_adt_Result__int__int)); __n176->saved[0] = (int64_t)(intptr_t)__ab; }
    __n176->saved[1] = (int64_t)(intptr_t)(n_1372);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1370, sizeof(tur_adt_Result__int__int)); __n176->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1369, sizeof(tur_adt_Result__int__int)); __n176->saved[3] = (int64_t)(intptr_t)__ab; }
    __n176->saved[4] = (int64_t)(intptr_t)(__t167);
    __n176->saved[5] = (int64_t)(intptr_t)(__t168);
    __n176->saved[6] = (int64_t)(intptr_t)(__t169);
    __n176->saved[7] = (int64_t)(intptr_t)(__t170);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t171, sizeof(tur_adt_Result__int__int)); __n176->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 7: {
    ...
    __t170 = (int64_t)(intptr_t)(__k->saved[7]);
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t171, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    tur_adt_Result__int__int __ur177; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur177, __rb, sizeof(tur_adt_Result__int__int)); free(__rb); }
    __t171 = __ur177;
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t178;
    bool __ps_179 = (ok___spec__bool_tur_adt_Result__int__int(__t171));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_179) {
        __t178 = INT64_C(1);
    } else {
   ...
   case 3: {
    { tur_adt_Result__int__int __rv = (r_1369); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
    __pc = __k->tag; break;
   }
  }
 }
...
int main(int argc, char **argv) {
    ...
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_183 = (step(__ps_182, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_183));
    int64_t __t184;
    __t184 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_188 = (ctor_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_189 = (ctor_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_189;
}
