...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            void *__t162 = malloc(sizeof(void *) + sizeof(struct __env_1288));
            *(void (**)(void *))__t162 = drop_glue___env_1288;
            struct __env_1288 *__t161 = (struct __env_1288 *)((char *)__t162 + sizeof(void *));
            __t161->__fn = (tur_thunk_int64_t_t)__fn_1286;
            __t161->acc = *acc;
            __t161->n = n;
            void *__t163 = __t161;
