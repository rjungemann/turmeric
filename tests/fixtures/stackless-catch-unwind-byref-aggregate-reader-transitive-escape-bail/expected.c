...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t180;
        tur_adt_Result__int__int __ps_181 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_182 = (ok___spec__bool_tur_adt_Result__int__int(__ps_181));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_182) {
            __t180 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 int64_t __t185 = 0;
 int64_t __t186 = 0;
 tur_adt_Result__int__int __t187; memset(&__t187, 0, sizeof(tur_adt_Result__int__int));
 switch (__pc) {
  case 1: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1440) == (INT64_C(0))) {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t187, sizeof(tur_adt_Result__int__int)); __n189->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t187, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t187, sizeof(tur_adt_Result__int__int)); __n191->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 2: {
    ...
    __n192->tag = 7; __n192->boundary = 0; __n192->next = __k;
    __n192->aggr_mask = 0x10du;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1439, sizeof(tur_adt_Result__int__int)); __n192->saved[0] = (int64_t)(intptr_t)__ab; }
    __n192->saved[1] = (int64_t)(intptr_t)(n_1440);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1438, sizeof(tur_adt_Result__int__int)); __n192->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1437, sizeof(tur_adt_Result__int__int)); __n192->saved[3] = (int64_t)(intptr_t)__ab; }
    __n192->saved[4] = (int64_t)(intptr_t)(__t183);
    __n192->saved[5] = (int64_t)(intptr_t)(__t184);
    __n192->saved[6] = (int64_t)(intptr_t)(__t185);
    __n192->saved[7] = (int64_t)(intptr_t)(__t186);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t187, sizeof(tur_adt_Result__int__int)); __n192->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 7: {
    ...
    __t186 = (int64_t)(intptr_t)(__k->saved[7]);
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t187, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    tur_adt_Result__int__int __ur193; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur193, __rb, sizeof(tur_adt_Result__int__int)); free(__rb); }
    __t187 = __ur193;
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t194;
    bool __ps_195 = (ok___spec__bool_tur_adt_Result__int__int(__t187));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_195) {
        __t194 = INT64_C(1);
    } else {
   ...
   case 3: {
    { tur_adt_Result__int__int __rv = (r_1437); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
    __pc = __k->tag; break;
   }
  }
 }
...
int main(int argc, char **argv) {
    ...
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_199 = (step(__ps_198, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_199));
    int64_t __t200;
    __t200 = INT64_C(0);
