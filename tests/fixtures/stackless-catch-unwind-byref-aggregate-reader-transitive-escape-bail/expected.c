...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t265;
        tur_adt_Result__int__int __ps_266 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_267 = (ok___spec__bool_tur_adt_Result__int__int(__ps_266));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_267) {
            __t265 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 int64_t __t270 = 0;
 int64_t __t271 = 0;
 tur_adt_Result__int__int __t272; memset(&__t272, 0, sizeof(tur_adt_Result__int__int));
 switch (__pc) {
  case 1: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1473) == (INT64_C(0))) {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t272, sizeof(tur_adt_Result__int__int)); __n274->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t272, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t272, sizeof(tur_adt_Result__int__int)); __n276->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 2: {
    ...
    __n277->tag = 7; __n277->boundary = 0; __n277->next = __k;
    __n277->aggr_mask = 0x10du;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1472, sizeof(tur_adt_Result__int__int)); __n277->saved[0] = (int64_t)(intptr_t)__ab; }
    __n277->saved[1] = (int64_t)(intptr_t)(n_1473);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1471, sizeof(tur_adt_Result__int__int)); __n277->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1470, sizeof(tur_adt_Result__int__int)); __n277->saved[3] = (int64_t)(intptr_t)__ab; }
    __n277->saved[4] = (int64_t)(intptr_t)(__t268);
    __n277->saved[5] = (int64_t)(intptr_t)(__t269);
    __n277->saved[6] = (int64_t)(intptr_t)(__t270);
    __n277->saved[7] = (int64_t)(intptr_t)(__t271);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t272, sizeof(tur_adt_Result__int__int)); __n277->saved[8] = (int64_t)(intptr_t)__ab; }
    tur_adt_Result__int__int __ra277_0 = (r_1471);
    r_1470 = __ra277_0;
    __k = __n277; __pc = 3; break;
   }
   case 7: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1472, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1473 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t271 = (int64_t)(intptr_t)(__k->saved[7]);
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t272, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    tur_adt_Result__int__int __ur278; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur278, __rb, sizeof(tur_adt_Result__int__int)); free(__rb); }
    __t272 = __ur278;
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t279;
    bool __ps_280 = (ok___spec__bool_tur_adt_Result__int__int(__t272));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_280) {
        __t279 = INT64_C(1);
    } else {
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_281 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_282 = (step(__ps_281, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_282));
    tur_adt_Result__int__int __ps_283 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_284 = (step(__ps_283, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_284));
    int64_t __t285;
    __t285 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_289 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_290 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_290;
}
