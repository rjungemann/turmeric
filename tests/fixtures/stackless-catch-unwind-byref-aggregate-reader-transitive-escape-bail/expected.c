...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t268;
        tur_adt_Result__int__int __ps_269 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_270 = (ok___spec__bool_tur_adt_Result__int__int(__ps_269));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_270) {
            __t268 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 int64_t __t273 = 0;
 int64_t __t274 = 0;
 tur_adt_Result__int__int __t275; memset(&__t275, 0, sizeof(tur_adt_Result__int__int));
 switch (__pc) {
  case 1: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1471) == (INT64_C(0))) {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t275, sizeof(tur_adt_Result__int__int)); __n277->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t275, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t275, sizeof(tur_adt_Result__int__int)); __n279->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 2: {
    ...
    __n280->tag = 7; __n280->boundary = 0; __n280->next = __k;
    __n280->aggr_mask = 0x10du;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1470, sizeof(tur_adt_Result__int__int)); __n280->saved[0] = (int64_t)(intptr_t)__ab; }
    __n280->saved[1] = (int64_t)(intptr_t)(n_1471);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1469, sizeof(tur_adt_Result__int__int)); __n280->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1468, sizeof(tur_adt_Result__int__int)); __n280->saved[3] = (int64_t)(intptr_t)__ab; }
    __n280->saved[4] = (int64_t)(intptr_t)(__t271);
    __n280->saved[5] = (int64_t)(intptr_t)(__t272);
    __n280->saved[6] = (int64_t)(intptr_t)(__t273);
    __n280->saved[7] = (int64_t)(intptr_t)(__t274);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t275, sizeof(tur_adt_Result__int__int)); __n280->saved[8] = (int64_t)(intptr_t)__ab; }
    tur_adt_Result__int__int __ra280_0 = (r_1469);
    r_1468 = __ra280_0;
    __k = __n280; __pc = 3; break;
   }
   case 7: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1470, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1471 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t274 = (int64_t)(intptr_t)(__k->saved[7]);
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t275, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    tur_adt_Result__int__int __ur281; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur281, __rb, sizeof(tur_adt_Result__int__int)); free(__rb); }
    __t275 = __ur281;
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t282;
    bool __ps_283 = (ok___spec__bool_tur_adt_Result__int__int(__t275));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_283) {
        __t282 = INT64_C(1);
    } else {
   ...
   case 3: {
    { tur_adt_Result__int__int __rv = (r_1468); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
    __pc = __k->tag; break;
   }
  }
 }
...
int main(int argc, char **argv) {
    ...
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_285 = (step(__ps_284, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_285));
