...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t184;
        tur_adt_Result__int__int __ps_185 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_186 = (ok___spec__bool_tur_adt_Result__int__int(__ps_185));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_186) {
            __t184 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 int64_t __t189 = 0;
 int64_t __t190 = 0;
 tur_adt_Result__int__int __t191; memset(&__t191, 0, sizeof(tur_adt_Result__int__int));
 switch (__pc) {
  case 1: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1442) == (INT64_C(0))) {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t191, sizeof(tur_adt_Result__int__int)); __n193->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t191, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t191, sizeof(tur_adt_Result__int__int)); __n195->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 2: {
    ...
    __n196->tag = 7; __n196->boundary = 0; __n196->next = __k;
    __n196->aggr_mask = 0x10du;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1441, sizeof(tur_adt_Result__int__int)); __n196->saved[0] = (int64_t)(intptr_t)__ab; }
    __n196->saved[1] = (int64_t)(intptr_t)(n_1442);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1440, sizeof(tur_adt_Result__int__int)); __n196->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1439, sizeof(tur_adt_Result__int__int)); __n196->saved[3] = (int64_t)(intptr_t)__ab; }
    __n196->saved[4] = (int64_t)(intptr_t)(__t187);
    __n196->saved[5] = (int64_t)(intptr_t)(__t188);
    __n196->saved[6] = (int64_t)(intptr_t)(__t189);
    __n196->saved[7] = (int64_t)(intptr_t)(__t190);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t191, sizeof(tur_adt_Result__int__int)); __n196->saved[8] = (int64_t)(intptr_t)__ab; }
    tur_adt_Result__int__int __ra196_0 = (r_1440);
    r_1439 = __ra196_0;
    __k = __n196; __pc = 3; break;
   }
   case 7: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1441, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1442 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t190 = (int64_t)(intptr_t)(__k->saved[7]);
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t191, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    tur_adt_Result__int__int __ur197; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur197, __rb, sizeof(tur_adt_Result__int__int)); free(__rb); }
    __t191 = __ur197;
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t198;
    bool __ps_199 = (ok___spec__bool_tur_adt_Result__int__int(__t191));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_199) {
        __t198 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)(__t198); __pc = __k->tag; break;
   }
   case 3: {
    { tur_adt_Result__int__int __rv = (r_1439); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
    __pc = __k->tag; break;
   }
  }
 }
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_200 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_201 = (step(__ps_200, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_201));
    tur_adt_Result__int__int __ps_202 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_203 = (step(__ps_202, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_203));
    int64_t __t204;
    __t204 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_208 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_209 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_209;
}
