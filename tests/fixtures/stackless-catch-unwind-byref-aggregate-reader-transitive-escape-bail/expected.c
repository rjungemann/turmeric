 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 2: {
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1437, sizeof(tur_adt_Result__int__int)); __n192->saved[0] = (int64_t)(intptr_t)__ab; }
    __n192->saved[1] = (int64_t)(intptr_t)(n_1438);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1436, sizeof(tur_adt_Result__int__int)); __n192->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1435, sizeof(tur_adt_Result__int__int)); __n192->saved[3] = (int64_t)(intptr_t)__ab; }
