...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t233;
        tur_adt_Result__int__int __ps_234 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_235 = (ok___spec__bool_tur_adt_Result__int__int(__ps_234));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_235) {
            __t233 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 int64_t __t238 = 0;
 int64_t __t239 = 0;
 tur_adt_Result__int__int __t240; memset(&__t240, 0, sizeof(tur_adt_Result__int__int));
 switch (__pc) {
  case 1: {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1469) == (INT64_C(0))) {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t240, sizeof(tur_adt_Result__int__int)); __n242->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t240, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t240, sizeof(tur_adt_Result__int__int)); __n244->saved[8] = (int64_t)(intptr_t)__ab; }
   ...
   case 2: {
    tur_cont *__n245 = (tur_cont*)malloc(sizeof(tur_cont));
    __n245->tag = 7; __n245->boundary = 0; __n245->next = __k;
    __n245->aggr_mask = 0x10du;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1468, sizeof(tur_adt_Result__int__int)); __n245->saved[0] = (int64_t)(intptr_t)__ab; }
    __n245->saved[1] = (int64_t)(intptr_t)(n_1469);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1467, sizeof(tur_adt_Result__int__int)); __n245->saved[2] = (int64_t)(intptr_t)__ab; }
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1466, sizeof(tur_adt_Result__int__int)); __n245->saved[3] = (int64_t)(intptr_t)__ab; }
    __n245->saved[4] = (int64_t)(intptr_t)(__t236);
    __n245->saved[5] = (int64_t)(intptr_t)(__t237);
    __n245->saved[6] = (int64_t)(intptr_t)(__t238);
    __n245->saved[7] = (int64_t)(intptr_t)(__t239);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &__t240, sizeof(tur_adt_Result__int__int)); __n245->saved[8] = (int64_t)(intptr_t)__ab; }
    tur_adt_Result__int__int __ra245_0 = (r_1467);
    r_1466 = __ra245_0;
    __k = __n245; __pc = 3; break;
   }
   case 7: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1468, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1469 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t239 = (int64_t)(intptr_t)(__k->saved[7]);
    { void *__ab = (void*)(intptr_t)__k->saved[8]; memcpy(&__t240, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    tur_adt_Result__int__int __ur246; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur246, __rb, sizeof(tur_adt_Result__int__int)); free(__rb); }
    __t240 = __ur246;
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t247;
    bool __ps_248 = (ok___spec__bool_tur_adt_Result__int__int(__t240));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_248) {
        __t247 = INT64_C(1);
    } else {
   ...
   case 3: {
    { tur_adt_Result__int__int __rv = (r_1466); void *__rb = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Result__int__int)); __v = (int64_t)(intptr_t)__rb; }
    __pc = __k->tag; break;
   }
  }
 }
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_249 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_250 = (step(__ps_249, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_250));
    tur_adt_Result__int__int __ps_251 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_252 = (step(__ps_251, INT64_C(3)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_252));
    int64_t __t253;
    __t253 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_257 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_258 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_258;
}
