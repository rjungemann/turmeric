...
static int64_t leak(int64_t r) {
        return r;
}

static int64_t describe(int64_t r) {
        int64_t __t166;
        int64_t __ps_167 = (leak(r));
        if (tur_panicking) return ((int64_t)0);
        bool __ps_168 = (ok_qu(__ps_167));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_168) {
            __t166 = INT64_C(1);
        } else {
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 2: {
    ...
    __n178->tag = 7; __n178->boundary = 0; __n178->next = __k;
    __n178->aggr_mask = 0x0u;
    __n178->saved[0] = (int64_t)(intptr_t)(acc_1367);
    __n178->saved[1] = (int64_t)(intptr_t)(n_1368);
    __n178->saved[2] = (int64_t)(intptr_t)(r_1366);
    __n178->saved[3] = (int64_t)(intptr_t)(r_1365);
    __n178->saved[4] = (int64_t)(intptr_t)(__t169);
    __n178->saved[5] = (int64_t)(intptr_t)(__t170);
    __n178->saved[6] = (int64_t)(intptr_t)(__t171);
    __n178->saved[7] = (int64_t)(intptr_t)(__t172);
    __n178->saved[8] = (int64_t)(intptr_t)(__t173);
   ...
   case 7: {
    ...
    __t172 = (int64_t)(intptr_t)(__k->saved[7]);
    __t173 = (int64_t)(intptr_t)(__k->saved[8]);
    __t173 = (int64_t)(intptr_t)(__v);
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    int64_t __t179;
    bool __ps_180 = (ok_qu(__t173));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_180) {
        __t179 = INT64_C(1);
    } else {
   ...
   case 3: {
    __v = (int64_t)(intptr_t)(r_1365); __pc = __k->tag; break;
   }
  }
 }
}
