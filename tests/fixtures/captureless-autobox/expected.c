...
static void * make_dbl() {
        ...
        __t25[1] = (int64_t)(intptr_t)__fn_885;
        void *__t26 = __t25;
        return __t26;
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            void * p_889 = make_dbl();
            (void)p_889;
            int64_t via_ret_890 = apply_fat((int64_t)(intptr_t)(p_889), INT64_C(21));
            (void)via_ret_890;
            int64_t *__t27 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t27[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t27[1] = (int64_t)(intptr_t)__fn_892;
            void *__t28 = __t27;
            int64_t via_arg_894 = run_with((void *)(intptr_t)(__t28), INT64_C(50));
            (void)via_arg_894;
            printf("%lld\n", (long long)(via_ret_890));
            printf("%lld\n", (long long)(via_arg_894));
        }
        return 0;
}
