...
static int64_t dbl_hyimpl(int64_t);
static void * make_hydbl();
static int64_t run_hywith(void *, int64_t);
...
static int64_t __fn_896(int64_t x) {
        return dbl_hyimpl(x);
}

static int64_t __fn_903(int64_t x) {
        return dbl_hyimpl(x);
}
...
static int64_t dbl_hyimpl(int64_t x) {
        return (x) * (INT64_C(2));
}

static void * make_hydbl() {
        int64_t *__t25 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t25[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t25[1] = (int64_t)(intptr_t)__fn_896;
        void *__t26 = __t25;
        return __t26;
}

static int64_t run_hywith(void * g, int64_t arg) {
        return apply_hyfat((int64_t)(intptr_t)(g), arg);
}
...
int main(int argc, char **argv) {
        ...
        {
            void * p_900 = make_hydbl();
            (void)p_900;
            int64_t via_hyret_901 = apply_hyfat((int64_t)(intptr_t)(p_900), INT64_C(21));
            (void)via_hyret_901;
            int64_t *__t27 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t27[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t27[1] = (int64_t)(intptr_t)__fn_903;
            void *__t28 = __t27;
            int64_t via_hyarg_905 = run_hywith((void *)(intptr_t)(__t28), INT64_C(50));
            (void)via_hyarg_905;
            printf("%lld\n", (long long)(via_hyret_901));
            printf("%lld\n", (long long)(via_hyarg_905));
        }
        return 0;
}
