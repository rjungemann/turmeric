...
static int64_t dbl_impl(int64_t x) {
        return (x) * (INT64_C(2));
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            void * p_900 = make_dbl();
            (void)p_900;
            int64_t via_ret_901 = apply_fat((int64_t)(intptr_t)(p_900), INT64_C(21));
            (void)via_ret_901;
            int64_t *__t27 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t27[0] = (int64_t)(intptr_t)__tur_fatshim1;
            __t27[1] = (int64_t)(intptr_t)__fn_903;
            void *__t28 = __t27;
            int64_t via_arg_905 = run_with((void *)(intptr_t)(__t28), INT64_C(50));
            (void)via_arg_905;
            printf("%lld\n", (long long)(via_ret_901));
            printf("%lld\n", (long long)(via_arg_905));
        }
        return 0;
}
