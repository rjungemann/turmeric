...
static int64_t __fn_1284(int64_t x) {
        return (x) + (INT64_C(1));
}
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t155;
        {
            ...
            *(void (**)(void *))__t157 = 0;
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Cell c_1286 = __ps_159;
            (void)c_1286;
            __auto_type __ps_160 = (TUR_APPLY1_T(int64_t, int64_t, (int64_t)(c_1286).f, INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_160));
            int64_t __t161;
            __t161 = INT64_C(0);
            __t155 = __t161;
            drop_fnfields_tur_adt_Cell((void *)&c_1286);
        }
        return (int)__t155;
}
