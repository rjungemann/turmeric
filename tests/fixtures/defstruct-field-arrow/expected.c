...
static int64_t __fn_1619(int64_t x) {
        return (x) + (INT64_C(1));
}
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t172;
        {
            ...
            *(void (**)(void *))__t174 = 0;
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Cell c_1621 = __ps_176;
            (void)c_1621;
            int64_t __ps_177 = (TUR_APPLY1_T(int64_t, int64_t, (int64_t)(c_1621).f, INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            int64_t __t178;
            __t178 = INT64_C(0);
            __t172 = __t178;
            drop_fnfields_tur_adt_Cell((void *)&c_1621);
        }
        return (int)__t172;
}
