...
static int64_t __fn_1275(int64_t x) {
        return (x) + (INT64_C(1));
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t173;
        {
            __auto_type __ps_174 = (ctor_Cell((int64_t)(intptr_t)(__fn_1275)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Cell c_1277 = __ps_174;
            (void)c_1277;
            __auto_type __ps_175 = (((int64_t (*)(int64_t))(intptr_t)((int64_t)(c_1277).f))(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_175));
            int64_t __t176;
            __t176 = INT64_C(0);
