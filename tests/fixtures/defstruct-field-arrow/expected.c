...
static tur_adt_Cell ctor_Cell_Cell(int64_t _0) {
    tur_adt_Cell __r;
    __r.f = _0;
    return __r;
}

#ifndef TUR_CTORALIAS_Cell
#define TUR_CTORALIAS_Cell
#define ctor_Cell ctor_Cell_Cell
#endif
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t172;
        {
            ...
            *(void (**)(void *))__t174 = 0;
            ...
            void *__t175 = __t173;
            tur_adt_Cell __ps_176 = (ctor_Cell_Cell((int64_t)(intptr_t)(__t175)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Cell c_1611 = __ps_176;
            (void)c_1611;
            int64_t __ps_177 = (TUR_APPLY1_T(int64_t, int64_t, (int64_t)(c_1611).f, INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
            int64_t __t178;
            __t178 = INT64_C(0);
            __t172 = __t178;
            drop_fnfields_tur_adt_Cell((void *)&c_1611);
        }
        return (int)__t172;
}
