...
static int64_t __fn_1439(int64_t x) {
        return (x) + (INT64_C(1));
}
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t183;
        {
            ...
            *(void (**)(void *))__t185 = 0;
            ...
            void *__t186 = __t184;
            tur_adt_Cell __ps_187 = (ctor_Cell_Cell((int64_t)(intptr_t)(__t186)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Cell c_1441 = __ps_187;
            (void)c_1441;
            int64_t __ps_188 = (TUR_APPLY1_T(int64_t, int64_t, (int64_t)(c_1441).f, INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_188));
            int64_t __t189;
            __t189 = INT64_C(0);
            __t183 = __t189;
            drop_fnfields_tur_adt_Cell((void *)&c_1441);
        }
        return (int)__t183;
}
