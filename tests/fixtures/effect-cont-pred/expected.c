...
static int64_t ask_with_check();

static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_261 = __k;
    bool __t3 = tur_effect_cont_valid(k_261);
    puts((__t3) ? "true" : "false");
    int64_t __t4;
    int64_t __t5 = tur_effect_cont_resume((int64_t)(intptr_t)k_261, (int64_t)INT64_C(42));
    __t4 = __t5;
    return (int64_t)__t4;
}
...
static void __handle_body_1(void) {
    tur_current_fiber->result = (int64_t)ask_with_check();
}
