...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_435));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_455));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_482));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_502), (int64_t)(intptr_t)(__fn_506));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_522), (int64_t)(intptr_t)(__fn_526));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_542));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_613));
}
...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t x_616 = (int64_t)__effect_args[0];
    int64_t k_617 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_617, (int64_t)((x_616) + (INT64_C(10))));
    return (int64_t)__t2;
}
...
static void __handle_body_0(void) {
    int64_t __t3[1];
    __t3[0] = (int64_t)INT64_C(5);
    int64_t __t4 = tur_effect_perform("AddTen", __t3, 1);
    tur_current_fiber->result = (int64_t)__t4;
}

static int64_t __dispatch_0(void *__ctx_void, int64_t __k_int, int64_t __resume_val);
static int64_t __dispatch_0(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "AddTen") == 0) {
        return __effect_handler_1(__dcap->eff_args, __dcap->eff_n_args, __k_int, NULL);
    } else {
        ...
        if (__outer_f && __outer_f->eff_ctx) {
            ...
            return __dispatch_0(__ctx_void, __k_int, __outer_f->arg);
        }
...
static int64_t __fn_618() {
        ...
        __cap_0.eff_n_args = 0;
        __cap_0.dispatch = __dispatch_0;
        __cap_0.body_env = NULL;
        FiberBlock *__fiber_0 = tur_fiber_block_new(__handle_body_0, 0);
        __fiber_0->eff_ctx = &__cap_0;
        EffectHandlerFrame *__parent_chain_0 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
        EffectHandlerFrame __eff_frame_0;
        __eff_frame_0.parent = __parent_chain_0;
        __eff_frame_0.n_cases = 1;
        __eff_frame_0.cases[0].effect_name = "AddTen";
        __eff_frame_0.cases[0].handler_fn = NULL;
        __eff_frame_0.cases[0].env = NULL;
        __fiber_0->effect_handler_chain = &__eff_frame_0;
        int64_t __t5 = (int64_t)__dispatch_0(&__cap_0, (int64_t)(intptr_t)__fiber_0, 0);
...
int main() {
        int64_t __t6;
        {
            void *__t7 = (void *)tur_async_fiber((int64_t(*)(void))(intptr_t)__fn_618);
            void * fut_620 = __t7;
            (void)fut_620;
            int64_t __t8;
            {
                int64_t __t9 = tur_await_future((TurFuture*)(intptr_t)fut_620);
                int64_t result_621 = __t9;
                (void)result_621;
                printf("%lld\n", (long long)(result_621));
                int64_t __t10;
                __t10 = INT64_C(0);
                __t8 = __t10;
            }
