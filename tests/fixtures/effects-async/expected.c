...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t x_261 = (int64_t)__effect_args[0];
    int64_t k_262 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_262, (int64_t)((x_261) + (INT64_C(10))));
    return (int64_t)__t2;
}
...
int main() {
        int64_t __t6;
        {
            void *__t7 = (void *)tur_async_fiber((int64_t(*)(void))(intptr_t)__fn_263);
            void * fut_265 = __t7;
            (void)fut_265;
            int64_t __t8;
            {
                int64_t __t9 = tur_await_future((TurFuture*)(intptr_t)fut_265);
                int64_t result_266 = __t9;
                (void)result_266;
                printf("%lld\n", (long long)(result_266));
                int64_t __t10;
                __t10 = INT64_C(0);
                __t8 = __t10;
            }
