...
static int64_t __fn_3() {
        ...
        __eff_frame_1.cases[0].effect_name = "AddTen";
...
int main() {
        int64_t __t5;
        {
            void *__t6 = (void *)tur_async_fiber((int64_t(*)(void))(intptr_t)__fn_3);
            void * fut_5 = __t6;
            (void)fut_5;
            int64_t __t7;
            {
                int64_t __t8 = tur_await_future((TurFuture*)(intptr_t)fut_5);
                int64_t result_6 = __t8;
                (void)result_6;
                printf("%lld\n", (long long)(result_6));
                int64_t __t9;
                __t9 = INT64_C(0);
