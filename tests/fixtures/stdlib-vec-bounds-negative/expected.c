...
static void * lv_hynew();
static int64_t lv_hyget(void *, int64_t);
...
static int64_t lv_hyget(void * v, int64_t i) {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t159;
        {
            void * __ps_160 = (lv_hynew());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * v_1330 = __ps_160;
            (void)v_1330;
            int64_t __ps_161 = (lv_hyget((void *)(intptr_t)(v_1330), INT64_C(0)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_161));
            int64_t __t162;
            __t162 = INT64_C(0);
