...
int main(int argc, char **argv) {
    ...
    {
        int64_t i_615 = INT64_C(1);
        (void)i_615;
        while (1) {
            if (!(((i_615) <= (INT64_C(100))))) break;
            if (((INT64_C(0)) == (((i_615) % (INT64_C(15)))))) {
                puts("fizzbuzz");
            } else {
                if (((INT64_C(0)) == (((i_615) % (INT64_C(3)))))) {
                    puts("fizz");
                } else {
                    if (((INT64_C(0)) == (((i_615) % (INT64_C(5)))))) {
                        puts("buzz");
                    } else {
                        printf("%lld\n", (long long)(i_615));
                    }
