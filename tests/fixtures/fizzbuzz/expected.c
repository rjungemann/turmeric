...
int main(void) {
    {
        int64_t i_207 = INT64_C(1);
        (void)i_207;
        while (1) {
            if (!(((i_207) <= (INT64_C(100))))) break;
            if (((INT64_C(0)) == (((i_207) % (INT64_C(15)))))) {
                puts("fizzbuzz");
            } else {
                if (((INT64_C(0)) == (((i_207) % (INT64_C(3)))))) {
                    puts("fizz");
                } else {
                    if (((INT64_C(0)) == (((i_207) % (INT64_C(5)))))) {
                        puts("buzz");
                    } else {
                        printf("%lld\n", (long long)(i_207));
                    }
