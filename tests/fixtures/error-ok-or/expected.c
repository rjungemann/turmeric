...
static void * u_some(int64_t);
static void * u_none();
static bool u_ok_(void *);
static int64_t u_ok_val(void *);
static void * u_ok_or(void *, int64_t);
...
static void * u_ok_or(void * opt, int64_t e) {
        struct { bool is_some; int64_t value; } *o = (void*)opt;
  struct { bool is_ok; int64_t ok_val; int64_t err_val; } *result = malloc(sizeof(*result));
  if (o != NULL && o->is_some) {
    result->is_ok   = true;
...
static const char * show_err_code(int64_t code) {
        switch (code) {
...
int main() {
        {
            void * opt1_628 = u_some(INT64_C(42));
            (void)opt1_628;
            {
                void * r1_629 = u_ok_or((void *)(intptr_t)(opt1_628), INT64_C(1));
                (void)r1_629;
                if (u_ok_((void *)(intptr_t)(r1_629))) {
                    printf("%lld\n", (long long)(u_ok_val((void *)(intptr_t)(r1_629))));
                } else {
                    puts("unexpected u-err");
                }
            }
        }
        {
            void * opt2_630 = u_none();
            (void)opt2_630;
            {
                void * r2_631 = u_ok_or((void *)(intptr_t)(opt2_630), INT64_C(1));
                (void)r2_631;
                if (u_ok_((void *)(intptr_t)(r2_631))) {
                    puts("unexpected u-ok");
                } else {
        ...
        {
            void * opt3_632 = u_none();
            (void)opt3_632;
            {
                void * r3_633 = u_ok_or((void *)(intptr_t)(opt3_632), INT64_C(2));
                (void)r3_633;
                if (u_ok_((void *)(intptr_t)(r3_633))) {
                    puts("unexpected u-ok");
                } else {
