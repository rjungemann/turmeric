...
int main() {
        {
            void * opt1_208 = some(INT64_C(42));
            (void)opt1_208;
            {
                void * r1_209 = ok_or((void *)(intptr_t)(opt1_208), INT64_C(1));
                (void)r1_209;
                if (ok_((void *)(intptr_t)(r1_209))) {
                    printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(r1_209))));
                } else {
                    puts("unexpected err");
                }
            }
        }
        {
            ...
            (void)opt2_210;
            {
                void * r2_211 = ok_or((void *)(intptr_t)(opt2_210), INT64_C(1));
                (void)r2_211;
                if (ok_((void *)(intptr_t)(r2_211))) {
                    puts("unexpected ok");
                } else {
        ...
        }
        {
            ...
            (void)opt3_212;
            {
                void * r3_213 = ok_or((void *)(intptr_t)(opt3_212), INT64_C(2));
                (void)r3_213;
                if (ok_((void *)(intptr_t)(r3_213))) {
                    puts("unexpected ok");
                } else {
