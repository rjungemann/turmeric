...
int main() {
        {
            void * opt1_273 = some(INT64_C(42));
            (void)opt1_273;
            {
                void * r1_274 = ok_or((void *)(intptr_t)(opt1_273), INT64_C(1));
                (void)r1_274;
                if (ok_((void *)(intptr_t)(r1_274))) {
                    printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(r1_274))));
                } else {
                    puts("unexpected err");
                }
            }
        }
        {
            ...
            (void)opt2_275;
            {
                void * r2_276 = ok_or((void *)(intptr_t)(opt2_275), INT64_C(1));
                (void)r2_276;
                if (ok_((void *)(intptr_t)(r2_276))) {
                    puts("unexpected ok");
                } else {
        ...
        }
        {
            ...
            (void)opt3_277;
            {
                void * r3_278 = ok_or((void *)(intptr_t)(opt3_277), INT64_C(2));
                (void)r3_278;
                if (ok_((void *)(intptr_t)(r3_278))) {
                    puts("unexpected ok");
                } else {
