...
int main() {
        {
            ...
            (void)opt1_33;
            {
                void * r1_34 = ok_or((void *)(intptr_t)(opt1_33), INT64_C(1));
                (void)r1_34;
                if (ok_((void *)(intptr_t)(r1_34))) {
                    printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(r1_34))));
                } else {
                    puts("unexpected err");
                }
            }
        }
        {
            ...
            (void)opt2_35;
            {
                void * r2_36 = ok_or((void *)(intptr_t)(opt2_35), INT64_C(1));
                (void)r2_36;
                if (ok_((void *)(intptr_t)(r2_36))) {
                    puts("unexpected ok");
                } else {
        ...
        }
        {
            ...
            (void)opt3_37;
            {
                void * r3_38 = ok_or((void *)(intptr_t)(opt3_37), INT64_C(2));
                (void)r3_38;
                if (ok_((void *)(intptr_t)(r3_38))) {
                    puts("unexpected ok");
                } else {
