...
int main() {
        {
            void * opt1_220 = some(INT64_C(42));
            (void)opt1_220;
            {
                void * r1_221 = ok_or((void *)(intptr_t)(opt1_220), INT64_C(1));
                (void)r1_221;
                if (ok_((void *)(intptr_t)(r1_221))) {
                    printf("%lld\n", (long long)(ok_val((void *)(intptr_t)(r1_221))));
                } else {
                    puts("unexpected err");
                }
            }
        }
        {
            ...
            (void)opt2_222;
            {
                void * r2_223 = ok_or((void *)(intptr_t)(opt2_222), INT64_C(1));
                (void)r2_223;
                if (ok_((void *)(intptr_t)(r2_223))) {
                    puts("unexpected ok");
                } else {
        ...
        }
        {
            ...
            (void)opt3_224;
            {
                void * r3_225 = ok_or((void *)(intptr_t)(opt3_224), INT64_C(2));
                (void)r3_225;
                if (ok_((void *)(intptr_t)(r3_225))) {
                    puts("unexpected ok");
                } else {
