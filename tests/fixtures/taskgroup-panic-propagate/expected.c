...
int main() {
        int64_t __t0;
        {
            void * tg_274 = tg_new();
            (void)tg_274;
            tg_spawn((void *)(intptr_t)(tg_274));
            tg_spawn((void *)(intptr_t)(tg_274));
            tg_cancel_panic((void *)(intptr_t)(tg_274));
            tg_task_done((void *)(intptr_t)(tg_274));
            tg_task_done((void *)(intptr_t)(tg_274));
            tg_wait((void *)(intptr_t)(tg_274));
            {
                int64_t reason_275 = tg_cancel_reason((void *)(intptr_t)(tg_274));
                (void)reason_275;
                if (((reason_275) == (INT64_C(1)))) {
                    puts("panic-propagated");
                } else {
                    puts("wrong-reason");
                }
            }
            tg_free((void *)(intptr_t)(tg_274));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
