...
int main() {
        int64_t __t0;
        {
            void * tg_34 = tg_new();
            (void)tg_34;
            tg_spawn((int64_t)(intptr_t)(tg_34));
            tg_spawn((int64_t)(intptr_t)(tg_34));
            tg_cancel_panic((int64_t)(intptr_t)(tg_34));
            tg_task_done((int64_t)(intptr_t)(tg_34));
            tg_task_done((int64_t)(intptr_t)(tg_34));
            tg_wait((int64_t)(intptr_t)(tg_34));
            {
                int64_t reason_35 = tg_cancel_reason((int64_t)(intptr_t)(tg_34));
                (void)reason_35;
                if (((reason_35) == (INT64_C(1)))) {
                    puts("panic-propagated");
                } else {
                    puts("wrong-reason");
                }
            }
            tg_free((int64_t)(intptr_t)(tg_34));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
