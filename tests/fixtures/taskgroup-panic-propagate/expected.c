...
static void tg_cancel_panic(void *);
static int64_t tg_cancel_reason(void *);
...
static void tg_cancel_panic(void * group) {
        typedef struct {
      pthread_mutex_t lock;
      pthread_cond_t done_cond;
      int64_t task_count;
...
static int64_t tg_cancel_reason(void * group) {
        typedef struct {
      pthread_mutex_t lock;
      pthread_cond_t done_cond;
      int64_t task_count;
...
int main() {
        int64_t __t0;
        {
            void * tg_629 = tg_new();
            (void)tg_629;
            tg_spawn((void *)(intptr_t)(tg_629));
            tg_spawn((void *)(intptr_t)(tg_629));
            tg_cancel_panic((void *)(intptr_t)(tg_629));
            tg_task_done((void *)(intptr_t)(tg_629));
            tg_task_done((void *)(intptr_t)(tg_629));
            tg_wait((void *)(intptr_t)(tg_629));
            {
                int64_t reason_630 = tg_cancel_reason((void *)(intptr_t)(tg_629));
                (void)reason_630;
                if (((reason_630) == (INT64_C(1)))) {
                    puts("panic-propagated");
                } else {
                    puts("wrong-reason");
                }
            }
            tg_free((void *)(intptr_t)(tg_629));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
