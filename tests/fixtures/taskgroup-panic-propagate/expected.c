...
int main() {
        int64_t __t0;
        {
            void * tg_34 = tg_new();
            (void)tg_34;
            tg_spawn((void *)(intptr_t)(tg_34));
            tg_spawn((void *)(intptr_t)(tg_34));
            tg_cancel_panic((void *)(intptr_t)(tg_34));
            tg_task_done((void *)(intptr_t)(tg_34));
            tg_task_done((void *)(intptr_t)(tg_34));
            tg_wait((void *)(intptr_t)(tg_34));
            {
                int64_t reason_35 = tg_cancel_reason((void *)(intptr_t)(tg_34));
                (void)reason_35;
