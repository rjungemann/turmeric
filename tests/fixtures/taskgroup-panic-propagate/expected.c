...
int main() {
        int64_t __t0;
        {
            void * tg_209 = tg_new();
            (void)tg_209;
            tg_spawn((void *)(intptr_t)(tg_209));
            tg_spawn((void *)(intptr_t)(tg_209));
            tg_cancel_panic((void *)(intptr_t)(tg_209));
            tg_task_done((void *)(intptr_t)(tg_209));
            tg_task_done((void *)(intptr_t)(tg_209));
            tg_wait((void *)(intptr_t)(tg_209));
            {
                int64_t reason_210 = tg_cancel_reason((void *)(intptr_t)(tg_209));
                (void)reason_210;
                if (((reason_210) == (INT64_C(1)))) {
                    puts("panic-propagated");
                } else {
                    puts("wrong-reason");
                }
            }
            tg_free((void *)(intptr_t)(tg_209));
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
        }
