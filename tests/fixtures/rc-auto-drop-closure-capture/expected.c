...
static int64_t rc_auto_drop_closure_capture() {
        int64_t __t1;
        {
            ...
            *__t2 = INT64_C(7);
            ...
            int64_t __t9;
            {
                struct __env_620 *__t10 = (struct __env_620 *)malloc(sizeof(struct __env_620));
                __t10->__fn = (int64_t)(intptr_t)__fn_618;
                __t10->x = x_617;
                void *__t11 = __t10;
                void * f_623 = __t11;
                (void)f_623;
