...
static int64_t rc_auto_drop_closure_capture();
...
static int64_t rc_auto_drop_closure_capture() {
        int64_t __t1;
        {
            ...
            *__t2 = INT64_C(7);
            ...
            __t3->value = __t2;
            RcControlBlock * x_262 = __t3;
            (void)x_262;
            tur_frame __frame_4;
            tur_frame_init(&__frame_4, NULL);
            struct __defer_env_5 __t7 = {.x = x_262};
            tur_frame_push_defer(&__frame_4, __defer_6, &__t7);
            int64_t __t8;
            int64_t __t9;
            {
                struct __env_265 *__t10 = (struct __env_265 *)malloc(sizeof(struct __env_265));
                __t10->__fn = (int64_t)(intptr_t)__fn_263;
                __t10->x = x_262;
                void *__t11 = __t10;
                void * f_268 = __t11;
                (void)f_268;
...
int main() {
        printf("%lld\n", (long long)(rc_auto_drop_closure_capture()));
        int64_t __t12;
        __t12 = INT64_C(0);
        return (int)__t12;
}
