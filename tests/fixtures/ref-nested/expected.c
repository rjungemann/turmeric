...
struct __defer_env_193 {void * outer; };

struct __defer_env_190 {void * inner; };
...
static void __defer_191(void *__env) {
    struct __defer_env_190 *__e = (struct __defer_env_190 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t183;
        {
            void * __t184 = malloc(sizeof(int64_t));
            *((int64_t *)__t184) = INT64_C(10);
            void * outer_1436 = __t184;
            (void)outer_1436;
            tur_frame __frame_185;
            tur_frame_init(&__frame_185, NULL);
            {
                void * __t186 = malloc(sizeof(int64_t));
                *((int64_t *)__t186) = INT64_C(20);
                void * inner_1437 = __t186;
                (void)inner_1437;
                tur_frame __frame_187;
                tur_frame_init(&__frame_187, &__frame_185);
                int64_t __t188 = *((int64_t *)inner_1437);
                printf("%lld\n", (long long)(__t188));
                int64_t __t189 = *((int64_t *)outer_1436);
                printf("%lld\n", (long long)(__t189));
                struct __defer_env_190 __t192 = {.inner = inner_1437};
                tur_frame_push_defer(&__frame_187, __defer_191, &__t192);
                tur_frame_fire_lifo(&__frame_187);
            }
            struct __defer_env_193 __t195 = {.outer = outer_1436};
            tur_frame_push_defer(&__frame_185, __defer_194, &__t195);
            int64_t __t196;
            __t196 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_185);
            __t183 = __t196;
        }
        return (int)__t183;
}
