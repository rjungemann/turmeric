...
struct __defer_env_178 {void * outer; };

struct __defer_env_175 {void * inner; };
...
static void __defer_176(void *__env) {
    struct __defer_env_175 *__e = (struct __defer_env_175 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t168;
        {
            void * __t169 = malloc(sizeof(int64_t));
            *((int64_t *)__t169) = INT64_C(10);
            void * outer_1432 = __t169;
            (void)outer_1432;
            tur_frame __frame_170;
            tur_frame_init(&__frame_170, NULL);
            {
                void * __t171 = malloc(sizeof(int64_t));
                *((int64_t *)__t171) = INT64_C(20);
                void * inner_1433 = __t171;
                (void)inner_1433;
                tur_frame __frame_172;
                tur_frame_init(&__frame_172, &__frame_170);
                int64_t __t173 = *((int64_t *)inner_1433);
                printf("%lld\n", (long long)(__t173));
                int64_t __t174 = *((int64_t *)outer_1432);
                printf("%lld\n", (long long)(__t174));
                struct __defer_env_175 __t177 = {.inner = inner_1433};
                tur_frame_push_defer(&__frame_172, __defer_176, &__t177);
                tur_frame_fire_lifo(&__frame_172);
            }
            struct __defer_env_178 __t180 = {.outer = outer_1432};
            tur_frame_push_defer(&__frame_170, __defer_179, &__t180);
            int64_t __t181;
            __t181 = INT64_C(0);
