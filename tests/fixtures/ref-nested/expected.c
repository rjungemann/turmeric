...
struct __defer_env_12 {void * outer; };

struct __defer_env_9 {void * inner; };
...
int main(int argc, char **argv) {
        ...
        int64_t __t2;
        {
            ...
            *((int64_t *)__t3) = INT64_C(10);
            void * outer_794 = __t3;
            (void)outer_794;
            tur_frame __frame_4;
            tur_frame_init(&__frame_4, NULL);
            {
                void * __t5 = malloc(sizeof(int64_t));
                *((int64_t *)__t5) = INT64_C(20);
                void * inner_795 = __t5;
                (void)inner_795;
                tur_frame __frame_6;
                tur_frame_init(&__frame_6, &__frame_4);
                int64_t __t7 = *((int64_t *)inner_795);
                printf("%lld\n", (long long)(__t7));
                int64_t __t8 = *((int64_t *)outer_794);
                printf("%lld\n", (long long)(__t8));
                struct __defer_env_9 __t11 = {.inner = inner_795};
                tur_frame_push_defer(&__frame_6, __defer_10, &__t11);
                tur_frame_fire_lifo(&__frame_6);
            }
            struct __defer_env_12 __t14 = {.outer = outer_794};
            tur_frame_push_defer(&__frame_4, __defer_13, &__t14);
            int64_t __t15;
            __t15 = INT64_C(0);
