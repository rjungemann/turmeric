...
struct __defer_env_274 {void * outer; };

struct __defer_env_271 {void * inner; };
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t264;
        {
            void * __t265 = malloc(sizeof(int64_t));
            *((int64_t *)__t265) = INT64_C(10);
            void * outer_1467 = __t265;
            (void)outer_1467;
            tur_frame __frame_266;
            tur_frame_init(&__frame_266, NULL);
            {
                void * __t267 = malloc(sizeof(int64_t));
                *((int64_t *)__t267) = INT64_C(20);
                void * inner_1468 = __t267;
                (void)inner_1468;
                tur_frame __frame_268;
                tur_frame_init(&__frame_268, &__frame_266);
                int64_t __t269 = *((int64_t *)inner_1468);
                printf("%lld\n", (long long)(__t269));
                int64_t __t270 = *((int64_t *)outer_1467);
                printf("%lld\n", (long long)(__t270));
                struct __defer_env_271 __t273 = {.inner = inner_1468};
                tur_frame_push_defer(&__frame_268, __defer_272, &__t273);
                tur_frame_fire_lifo(&__frame_268);
            }
            struct __defer_env_274 __t276 = {.outer = outer_1467};
            tur_frame_push_defer(&__frame_266, __defer_275, &__t276);
            int64_t __t277;
            __t277 = INT64_C(0);
