...
struct __defer_env_242 {void * outer; };

struct __defer_env_239 {void * inner; };

static void __defer_243(void *__env) {
    struct __defer_env_242 *__e = (struct __defer_env_242 *)__env;
    free(__e->outer);
}

static void __defer_240(void *__env) {
    struct __defer_env_239 *__e = (struct __defer_env_239 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t232;
        {
            void * __t233 = malloc(sizeof(int64_t));
            *((int64_t *)__t233) = INT64_C(10);
            void * outer_1463 = __t233;
            (void)outer_1463;
            tur_frame __frame_234;
            tur_frame_init(&__frame_234, NULL);
            {
                void * __t235 = malloc(sizeof(int64_t));
                *((int64_t *)__t235) = INT64_C(20);
                void * inner_1464 = __t235;
                (void)inner_1464;
                tur_frame __frame_236;
                tur_frame_init(&__frame_236, &__frame_234);
                int64_t __t237 = *((int64_t *)inner_1464);
                printf("%lld\n", (long long)(__t237));
                int64_t __t238 = *((int64_t *)outer_1463);
                printf("%lld\n", (long long)(__t238));
                struct __defer_env_239 __t241 = {.inner = inner_1464};
                tur_frame_push_defer(&__frame_236, __defer_240, &__t241);
                tur_frame_fire_lifo(&__frame_236);
            }
            struct __defer_env_242 __t244 = {.outer = outer_1463};
            tur_frame_push_defer(&__frame_234, __defer_243, &__t244);
            int64_t __t245;
            __t245 = INT64_C(0);
