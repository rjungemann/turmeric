...
int main(int argc, char **argv) {
        ...
        int64_t __t50;
        {
            void * __t51 = malloc(sizeof(int64_t));
            *((int64_t *)__t51) = INT64_C(10);
            void * outer_1261 = __t51;
            (void)outer_1261;
            ...
            tur_frame_init(&__frame_52, NULL);
            {
                ...
                *((int64_t *)__t53) = INT64_C(20);
                void * inner_1262 = __t53;
                (void)inner_1262;
                tur_frame __frame_54;
                tur_frame_init(&__frame_54, &__frame_52);
                int64_t __t55 = *((int64_t *)inner_1262);
                printf("%lld\n", (long long)(__t55));
                int64_t __t56 = *((int64_t *)outer_1261);
                printf("%lld\n", (long long)(__t56));
                struct __defer_env_57 __t59 = {.inner = inner_1262};
                tur_frame_push_defer(&__frame_54, __defer_58, &__t59);
                tur_frame_fire_lifo(&__frame_54);
            }
            struct __defer_env_60 __t62 = {.outer = outer_1261};
