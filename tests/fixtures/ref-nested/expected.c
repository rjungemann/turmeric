...
struct __defer_env_182 {void * outer; };

struct __defer_env_179 {void * inner; };

struct __defer_env_162 {int64_t m; };

static void __defer_183(void *__env) {
    struct __defer_env_182 *__e = (struct __defer_env_182 *)__env;
    free(__e->outer);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t172;
        {
            void * __t173 = malloc(sizeof(int64_t));
            *((int64_t *)__t173) = INT64_C(10);
            void * outer_1616 = __t173;
            (void)outer_1616;
            tur_frame __frame_174;
            tur_frame_init(&__frame_174, NULL);
            {
                void * __t175 = malloc(sizeof(int64_t));
                *((int64_t *)__t175) = INT64_C(20);
                void * inner_1617 = __t175;
                (void)inner_1617;
                tur_frame __frame_176;
                tur_frame_init(&__frame_176, &__frame_174);
                int64_t __t177 = *((int64_t *)inner_1617);
                printf("%lld\n", (long long)(__t177));
                int64_t __t178 = *((int64_t *)outer_1616);
                printf("%lld\n", (long long)(__t178));
                struct __defer_env_179 __t181 = {.inner = inner_1617};
                tur_frame_push_defer(&__frame_176, __defer_180, &__t181);
                tur_frame_fire_lifo(&__frame_176);
            }
            struct __defer_env_182 __t184 = {.outer = outer_1616};
            tur_frame_push_defer(&__frame_174, __defer_183, &__t184);
            int64_t __t185;
            __t185 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_174);
            __t172 = __t185;
        }
        return (int)__t172;
}
