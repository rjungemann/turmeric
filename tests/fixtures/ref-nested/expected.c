...
struct __defer_env_13 {void * outer; };

struct __defer_env_10 {void * inner; };
...
int main(int argc, char **argv) {
        ...
        int64_t __t3;
        {
            void * __t4 = malloc(sizeof(int64_t));
            *((int64_t *)__t4) = INT64_C(10);
            void * outer_872 = __t4;
            (void)outer_872;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            {
                void * __t6 = malloc(sizeof(int64_t));
                *((int64_t *)__t6) = INT64_C(20);
                void * inner_873 = __t6;
                (void)inner_873;
                tur_frame __frame_7;
                tur_frame_init(&__frame_7, &__frame_5);
                int64_t __t8 = *((int64_t *)inner_873);
                printf("%lld\n", (long long)(__t8));
                int64_t __t9 = *((int64_t *)outer_872);
                printf("%lld\n", (long long)(__t9));
                struct __defer_env_10 __t12 = {.inner = inner_873};
                tur_frame_push_defer(&__frame_7, __defer_11, &__t12);
                tur_frame_fire_lifo(&__frame_7);
            }
            struct __defer_env_13 __t15 = {.outer = outer_872};
            tur_frame_push_defer(&__frame_5, __defer_14, &__t15);
            int64_t __t16;
            __t16 = INT64_C(0);
