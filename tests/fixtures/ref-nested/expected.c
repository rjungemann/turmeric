...
struct __defer_env_65 {void * outer; };

struct __defer_env_62 {void * inner; };

static void __defer_66(void *__env) {
    struct __defer_env_65 *__e = (struct __defer_env_65 *)__env;
    free(__e->outer);
}

static void __defer_63(void *__env) {
    struct __defer_env_62 *__e = (struct __defer_env_62 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t55;
        {
            void * __t56 = malloc(sizeof(int64_t));
            *((int64_t *)__t56) = INT64_C(10);
            void * outer_1264 = __t56;
            (void)outer_1264;
            tur_frame __frame_57;
            tur_frame_init(&__frame_57, NULL);
            {
                void * __t58 = malloc(sizeof(int64_t));
                *((int64_t *)__t58) = INT64_C(20);
                void * inner_1265 = __t58;
                (void)inner_1265;
                tur_frame __frame_59;
                tur_frame_init(&__frame_59, &__frame_57);
                int64_t __t60 = *((int64_t *)inner_1265);
                printf("%lld\n", (long long)(__t60));
                int64_t __t61 = *((int64_t *)outer_1264);
                printf("%lld\n", (long long)(__t61));
                struct __defer_env_62 __t64 = {.inner = inner_1265};
                tur_frame_push_defer(&__frame_59, __defer_63, &__t64);
                tur_frame_fire_lifo(&__frame_59);
            }
            struct __defer_env_65 __t67 = {.outer = outer_1264};
            tur_frame_push_defer(&__frame_57, __defer_66, &__t67);
            int64_t __t68;
            __t68 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_57);
            __t55 = __t68;
        }
        return (int)__t55;
}
