...
struct __defer_env_170 {void * outer; };

struct __defer_env_167 {void * inner; };
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t160;
        {
            void * __t161 = malloc(sizeof(int64_t));
            *((int64_t *)__t161) = INT64_C(10);
            void * outer_1330 = __t161;
            (void)outer_1330;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            {
                void * __t163 = malloc(sizeof(int64_t));
                *((int64_t *)__t163) = INT64_C(20);
                void * inner_1331 = __t163;
                (void)inner_1331;
                tur_frame __frame_164;
                tur_frame_init(&__frame_164, &__frame_162);
                int64_t __t165 = *((int64_t *)inner_1331);
                printf("%lld\n", (long long)(__t165));
                int64_t __t166 = *((int64_t *)outer_1330);
                printf("%lld\n", (long long)(__t166));
                struct __defer_env_167 __t169 = {.inner = inner_1331};
                tur_frame_push_defer(&__frame_164, __defer_168, &__t169);
                tur_frame_fire_lifo(&__frame_164);
            }
            struct __defer_env_170 __t172 = {.outer = outer_1330};
            tur_frame_push_defer(&__frame_162, __defer_171, &__t172);
            int64_t __t173;
            __t173 = INT64_C(0);
