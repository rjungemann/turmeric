...
struct __defer_env_62 {void * outer; };

struct __defer_env_59 {void * inner; };
...
static void __defer_60(void *__env) {
    struct __defer_env_59 *__e = (struct __defer_env_59 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t52;
        {
            ...
            *((int64_t *)__t53) = INT64_C(10);
            void * outer_1007 = __t53;
            (void)outer_1007;
            tur_frame __frame_54;
            tur_frame_init(&__frame_54, NULL);
            {
                void * __t55 = malloc(sizeof(int64_t));
                *((int64_t *)__t55) = INT64_C(20);
                void * inner_1008 = __t55;
                (void)inner_1008;
                tur_frame __frame_56;
                tur_frame_init(&__frame_56, &__frame_54);
                int64_t __t57 = *((int64_t *)inner_1008);
                printf("%lld\n", (long long)(__t57));
                int64_t __t58 = *((int64_t *)outer_1007);
                printf("%lld\n", (long long)(__t58));
                struct __defer_env_59 __t61 = {.inner = inner_1008};
                tur_frame_push_defer(&__frame_56, __defer_60, &__t61);
                tur_frame_fire_lifo(&__frame_56);
            }
            struct __defer_env_62 __t64 = {.outer = outer_1007};
            tur_frame_push_defer(&__frame_54, __defer_63, &__t64);
            int64_t __t65;
            __t65 = INT64_C(0);
