            ...
            *((int64_t *)__t156) = INT64_C(10);
            ...
            tur_frame_init(&__frame_157, NULL);
            {
                ...
                *((int64_t *)__t158) = INT64_C(20);
                void * inner_1282 = __t158;
                (void)inner_1282;
                tur_frame __frame_159;
                tur_frame_init(&__frame_159, &__frame_157);
                int64_t __t160 = *((int64_t *)inner_1282);
                printf("%lld\n", (long long)(__t160));
                int64_t __t161 = *((int64_t *)outer_1281);
                printf("%lld\n", (long long)(__t161));
                struct __defer_env_162 __t164 = {.inner = inner_1282};
                tur_frame_push_defer(&__frame_159, __defer_163, &__t164);
                tur_frame_fire_lifo(&__frame_159);
            }
            struct __defer_env_165 __t167 = {.outer = outer_1281};
