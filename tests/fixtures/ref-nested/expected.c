...
struct __defer_env_169 {void * outer; };

struct __defer_env_166 {void * inner; };

static void __defer_170(void *__env) {
    struct __defer_env_169 *__e = (struct __defer_env_169 *)__env;
    free(__e->outer);
}

static void __defer_167(void *__env) {
    struct __defer_env_166 *__e = (struct __defer_env_166 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t159;
        {
            void * __t160 = malloc(sizeof(int64_t));
            *((int64_t *)__t160) = INT64_C(10);
            void * outer_1326 = __t160;
            (void)outer_1326;
            tur_frame __frame_161;
            tur_frame_init(&__frame_161, NULL);
            {
                void * __t162 = malloc(sizeof(int64_t));
                *((int64_t *)__t162) = INT64_C(20);
                void * inner_1327 = __t162;
                (void)inner_1327;
                tur_frame __frame_163;
                tur_frame_init(&__frame_163, &__frame_161);
                int64_t __t164 = *((int64_t *)inner_1327);
                printf("%lld\n", (long long)(__t164));
                int64_t __t165 = *((int64_t *)outer_1326);
                printf("%lld\n", (long long)(__t165));
                struct __defer_env_166 __t168 = {.inner = inner_1327};
                tur_frame_push_defer(&__frame_163, __defer_167, &__t168);
                tur_frame_fire_lifo(&__frame_163);
            }
            struct __defer_env_169 __t171 = {.outer = outer_1326};
            tur_frame_push_defer(&__frame_161, __defer_170, &__t171);
            int64_t __t172;
            __t172 = INT64_C(0);
