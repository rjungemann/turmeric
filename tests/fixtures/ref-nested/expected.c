...
struct __defer_env_17 {void * outer; };

struct __defer_env_14 {void * inner; };

static void __defer_18(void *__env) {
    struct __defer_env_17 *__e = (struct __defer_env_17 *)__env;
    free(__e->outer);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t7;
        {
            void * __t8 = malloc(sizeof(int64_t));
            *((int64_t *)__t8) = INT64_C(10);
            void * outer_853 = __t8;
            (void)outer_853;
            tur_frame __frame_9;
            tur_frame_init(&__frame_9, NULL);
            {
                void * __t10 = malloc(sizeof(int64_t));
                *((int64_t *)__t10) = INT64_C(20);
                void * inner_854 = __t10;
                (void)inner_854;
                tur_frame __frame_11;
                tur_frame_init(&__frame_11, &__frame_9);
                int64_t __t12 = *((int64_t *)inner_854);
                printf("%lld\n", (long long)(__t12));
                int64_t __t13 = *((int64_t *)outer_853);
                printf("%lld\n", (long long)(__t13));
                struct __defer_env_14 __t16 = {.inner = inner_854};
                tur_frame_push_defer(&__frame_11, __defer_15, &__t16);
                tur_frame_fire_lifo(&__frame_11);
            }
            struct __defer_env_17 __t19 = {.outer = outer_853};
            tur_frame_push_defer(&__frame_9, __defer_18, &__t19);
            int64_t __t20;
            __t20 = INT64_C(0);
