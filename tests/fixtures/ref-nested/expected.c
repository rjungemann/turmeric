...
struct __defer_env_287 {void * outer; };

struct __defer_env_284 {void * inner; };
...
static void __defer_285(void *__env) {
    struct __defer_env_284 *__e = (struct __defer_env_284 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t277;
        {
            void * __t278 = malloc(sizeof(int64_t));
            *((int64_t *)__t278) = INT64_C(10);
            void * outer_1606 = __t278;
            (void)outer_1606;
            tur_frame __frame_279;
            tur_frame_init(&__frame_279, NULL);
            {
                void * __t280 = malloc(sizeof(int64_t));
                *((int64_t *)__t280) = INT64_C(20);
                void * inner_1607 = __t280;
                (void)inner_1607;
                tur_frame __frame_281;
                tur_frame_init(&__frame_281, &__frame_279);
                int64_t __t282 = *((int64_t *)inner_1607);
                printf("%lld\n", (long long)(__t282));
                int64_t __t283 = *((int64_t *)outer_1606);
                printf("%lld\n", (long long)(__t283));
                struct __defer_env_284 __t286 = {.inner = inner_1607};
                tur_frame_push_defer(&__frame_281, __defer_285, &__t286);
                tur_frame_fire_lifo(&__frame_281);
            }
            struct __defer_env_287 __t289 = {.outer = outer_1606};
            tur_frame_push_defer(&__frame_279, __defer_288, &__t289);
            int64_t __t290;
            __t290 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_279);
            __t277 = __t290;
        }
        return (int)__t277;
}
