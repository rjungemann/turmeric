...
struct __defer_env_34 {void * outer; };

struct __defer_env_31 {void * inner; };

static void __defer_35(void *__env) {
    struct __defer_env_34 *__e = (struct __defer_env_34 *)__env;
    free(__e->outer);
}

static void __defer_32(void *__env) {
    struct __defer_env_31 *__e = (struct __defer_env_31 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t24;
        {
            void * __t25 = malloc(sizeof(int64_t));
            *((int64_t *)__t25) = INT64_C(10);
            void * outer_880 = __t25;
            (void)outer_880;
            tur_frame __frame_26;
            tur_frame_init(&__frame_26, NULL);
            {
                void * __t27 = malloc(sizeof(int64_t));
                *((int64_t *)__t27) = INT64_C(20);
                void * inner_881 = __t27;
                (void)inner_881;
                tur_frame __frame_28;
                tur_frame_init(&__frame_28, &__frame_26);
                int64_t __t29 = *((int64_t *)inner_881);
                printf("%lld\n", (long long)(__t29));
                int64_t __t30 = *((int64_t *)outer_880);
                printf("%lld\n", (long long)(__t30));
                struct __defer_env_31 __t33 = {.inner = inner_881};
                tur_frame_push_defer(&__frame_28, __defer_32, &__t33);
                tur_frame_fire_lifo(&__frame_28);
            }
            struct __defer_env_34 __t36 = {.outer = outer_880};
            tur_frame_push_defer(&__frame_26, __defer_35, &__t36);
            int64_t __t37;
            __t37 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_26);
            __t24 = __t37;
        }
        return (int)__t24;
}
