...
struct __defer_env_61 {void * outer; };

struct __defer_env_58 {void * inner; };

static void __defer_62(void *__env) {
    struct __defer_env_61 *__e = (struct __defer_env_61 *)__env;
    free(__e->outer);
}

static void __defer_59(void *__env) {
    struct __defer_env_58 *__e = (struct __defer_env_58 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t51;
        {
            ...
            *((int64_t *)__t52) = INT64_C(10);
            void * outer_1007 = __t52;
            (void)outer_1007;
            tur_frame __frame_53;
            tur_frame_init(&__frame_53, NULL);
            {
                void * __t54 = malloc(sizeof(int64_t));
                *((int64_t *)__t54) = INT64_C(20);
                void * inner_1008 = __t54;
                (void)inner_1008;
                tur_frame __frame_55;
                tur_frame_init(&__frame_55, &__frame_53);
                int64_t __t56 = *((int64_t *)inner_1008);
                printf("%lld\n", (long long)(__t56));
                int64_t __t57 = *((int64_t *)outer_1007);
                printf("%lld\n", (long long)(__t57));
                struct __defer_env_58 __t60 = {.inner = inner_1008};
                tur_frame_push_defer(&__frame_55, __defer_59, &__t60);
                tur_frame_fire_lifo(&__frame_55);
            }
            struct __defer_env_61 __t63 = {.outer = outer_1007};
            tur_frame_push_defer(&__frame_53, __defer_62, &__t63);
            int64_t __t64;
            __t64 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_53);
            __t51 = __t64;
        }
        return (int)__t51;
}
