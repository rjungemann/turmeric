...
struct __defer_env_190 {void * outer; };

struct __defer_env_187 {void * inner; };
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t180;
        {
            void * __t181 = malloc(sizeof(int64_t));
            *((int64_t *)__t181) = INT64_C(10);
            void * outer_1436 = __t181;
            (void)outer_1436;
            tur_frame __frame_182;
            tur_frame_init(&__frame_182, NULL);
            {
                void * __t183 = malloc(sizeof(int64_t));
                *((int64_t *)__t183) = INT64_C(20);
                void * inner_1437 = __t183;
                (void)inner_1437;
                tur_frame __frame_184;
                tur_frame_init(&__frame_184, &__frame_182);
                int64_t __t185 = *((int64_t *)inner_1437);
                printf("%lld\n", (long long)(__t185));
                int64_t __t186 = *((int64_t *)outer_1436);
                printf("%lld\n", (long long)(__t186));
                struct __defer_env_187 __t189 = {.inner = inner_1437};
                tur_frame_push_defer(&__frame_184, __defer_188, &__t189);
                tur_frame_fire_lifo(&__frame_184);
            }
            struct __defer_env_190 __t192 = {.outer = outer_1436};
            tur_frame_push_defer(&__frame_182, __defer_191, &__t192);
            int64_t __t193;
            __t193 = INT64_C(0);
