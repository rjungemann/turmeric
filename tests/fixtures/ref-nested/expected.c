...
struct __defer_env_39 {void * outer; };

struct __defer_env_36 {void * inner; };

static void __defer_40(void *__env) {
    struct __defer_env_39 *__e = (struct __defer_env_39 *)__env;
    free(__e->outer);
}

static void __defer_37(void *__env) {
    struct __defer_env_36 *__e = (struct __defer_env_36 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t29;
        {
            void * __t30 = malloc(sizeof(int64_t));
            *((int64_t *)__t30) = INT64_C(10);
            void * outer_900 = __t30;
            (void)outer_900;
            tur_frame __frame_31;
            tur_frame_init(&__frame_31, NULL);
            {
                void * __t32 = malloc(sizeof(int64_t));
                *((int64_t *)__t32) = INT64_C(20);
                void * inner_901 = __t32;
                (void)inner_901;
                tur_frame __frame_33;
                tur_frame_init(&__frame_33, &__frame_31);
                int64_t __t34 = *((int64_t *)inner_901);
                printf("%lld\n", (long long)(__t34));
                int64_t __t35 = *((int64_t *)outer_900);
                printf("%lld\n", (long long)(__t35));
                struct __defer_env_36 __t38 = {.inner = inner_901};
                tur_frame_push_defer(&__frame_33, __defer_37, &__t38);
                tur_frame_fire_lifo(&__frame_33);
            }
            struct __defer_env_39 __t41 = {.outer = outer_900};
            tur_frame_push_defer(&__frame_31, __defer_40, &__t41);
            int64_t __t42;
            __t42 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_31);
            __t29 = __t42;
        }
        return (int)__t29;
}
