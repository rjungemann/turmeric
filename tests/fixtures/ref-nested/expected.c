...
struct __defer_env_173 {void * outer; };

struct __defer_env_170 {void * inner; };

static void __defer_174(void *__env) {
    struct __defer_env_173 *__e = (struct __defer_env_173 *)__env;
    free(__e->outer);
}

static void __defer_171(void *__env) {
    struct __defer_env_170 *__e = (struct __defer_env_170 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t163;
        {
            void * __t164 = malloc(sizeof(int64_t));
            *((int64_t *)__t164) = INT64_C(10);
            void * outer_1366 = __t164;
            (void)outer_1366;
            tur_frame __frame_165;
            tur_frame_init(&__frame_165, NULL);
            {
                void * __t166 = malloc(sizeof(int64_t));
                *((int64_t *)__t166) = INT64_C(20);
                void * inner_1367 = __t166;
                (void)inner_1367;
                tur_frame __frame_167;
                tur_frame_init(&__frame_167, &__frame_165);
                int64_t __t168 = *((int64_t *)inner_1367);
                printf("%lld\n", (long long)(__t168));
                int64_t __t169 = *((int64_t *)outer_1366);
                printf("%lld\n", (long long)(__t169));
                struct __defer_env_170 __t172 = {.inner = inner_1367};
                tur_frame_push_defer(&__frame_167, __defer_171, &__t172);
                tur_frame_fire_lifo(&__frame_167);
            }
            struct __defer_env_173 __t175 = {.outer = outer_1366};
            tur_frame_push_defer(&__frame_165, __defer_174, &__t175);
            int64_t __t176;
            __t176 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_165);
            __t163 = __t176;
        }
        return (int)__t163;
}
