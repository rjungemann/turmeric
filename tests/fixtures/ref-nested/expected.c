            ...
            *((int64_t *)__t173) = INT64_C(10);
            ...
            tur_frame_init(&__frame_174, NULL);
            {
                ...
                *((int64_t *)__t175) = INT64_C(20);
                void * inner_1620 = __t175;
                (void)inner_1620;
                tur_frame __frame_176;
                tur_frame_init(&__frame_176, &__frame_174);
                int64_t __t177 = *((int64_t *)inner_1620);
                printf("%lld\n", (long long)(__t177));
                int64_t __t178 = *((int64_t *)outer_1619);
                printf("%lld\n", (long long)(__t178));
                struct __defer_env_179 __t181 = {.inner = inner_1620};
                tur_frame_push_defer(&__frame_176, __defer_180, &__t181);
                tur_frame_fire_lifo(&__frame_176);
            }
            struct __defer_env_182 __t184 = {.outer = outer_1619};
