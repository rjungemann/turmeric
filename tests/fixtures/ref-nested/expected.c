...
struct __defer_env_187 {void * outer; };

struct __defer_env_184 {void * inner; };
...
int main(int argc, char **argv) {
        ...
        int64_t __t177;
        {
            void * __t178 = malloc(sizeof(int64_t));
            *((int64_t *)__t178) = INT64_C(10);
            void * outer_1267 = __t178;
            (void)outer_1267;
            tur_frame __frame_179;
            tur_frame_init(&__frame_179, NULL);
            {
                void * __t180 = malloc(sizeof(int64_t));
                *((int64_t *)__t180) = INT64_C(20);
                void * inner_1268 = __t180;
                (void)inner_1268;
                tur_frame __frame_181;
                tur_frame_init(&__frame_181, &__frame_179);
                int64_t __t182 = *((int64_t *)inner_1268);
                printf("%lld\n", (long long)(__t182));
                int64_t __t183 = *((int64_t *)outer_1267);
                printf("%lld\n", (long long)(__t183));
                struct __defer_env_184 __t186 = {.inner = inner_1268};
                tur_frame_push_defer(&__frame_181, __defer_185, &__t186);
                tur_frame_fire_lifo(&__frame_181);
            }
            struct __defer_env_187 __t189 = {.outer = outer_1267};
            tur_frame_push_defer(&__frame_179, __defer_188, &__t189);
            int64_t __t190;
            __t190 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_179);
            __t177 = __t190;
        }
        return (int)__t177;
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_191 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_192 = (vec_new__spec__tur_adt_Vec__int__());
