...
struct __defer_env_163 {void * outer; };

struct __defer_env_160 {void * inner; };
...
static void __defer_161(void *__env) {
    struct __defer_env_160 *__e = (struct __defer_env_160 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t153;
        {
            void * __t154 = malloc(sizeof(int64_t));
            *((int64_t *)__t154) = INT64_C(10);
            void * outer_1279 = __t154;
            (void)outer_1279;
            tur_frame __frame_155;
            tur_frame_init(&__frame_155, NULL);
            {
                void * __t156 = malloc(sizeof(int64_t));
                *((int64_t *)__t156) = INT64_C(20);
                void * inner_1280 = __t156;
                (void)inner_1280;
                tur_frame __frame_157;
                tur_frame_init(&__frame_157, &__frame_155);
                int64_t __t158 = *((int64_t *)inner_1280);
                printf("%lld\n", (long long)(__t158));
                int64_t __t159 = *((int64_t *)outer_1279);
                printf("%lld\n", (long long)(__t159));
                struct __defer_env_160 __t162 = {.inner = inner_1280};
                tur_frame_push_defer(&__frame_157, __defer_161, &__t162);
                tur_frame_fire_lifo(&__frame_157);
            }
            struct __defer_env_163 __t165 = {.outer = outer_1279};
            tur_frame_push_defer(&__frame_155, __defer_164, &__t165);
            int64_t __t166;
            __t166 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_155);
            __t153 = __t166;
        }
        return (int)__t153;
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_167 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_168 = (vec_new__spec__tur_adt_Vec__int__());
