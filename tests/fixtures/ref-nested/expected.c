...
struct __defer_env_33 {void * outer; };

struct __defer_env_30 {void * inner; };

static void __defer_34(void *__env) {
    struct __defer_env_33 *__e = (struct __defer_env_33 *)__env;
    free(__e->outer);
}

static void __defer_31(void *__env) {
    struct __defer_env_30 *__e = (struct __defer_env_30 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t23;
        {
            void * __t24 = malloc(sizeof(int64_t));
            *((int64_t *)__t24) = INT64_C(10);
            void * outer_883 = __t24;
            (void)outer_883;
            tur_frame __frame_25;
            tur_frame_init(&__frame_25, NULL);
            {
                void * __t26 = malloc(sizeof(int64_t));
                *((int64_t *)__t26) = INT64_C(20);
                void * inner_884 = __t26;
                (void)inner_884;
                tur_frame __frame_27;
                tur_frame_init(&__frame_27, &__frame_25);
                int64_t __t28 = *((int64_t *)inner_884);
                printf("%lld\n", (long long)(__t28));
                int64_t __t29 = *((int64_t *)outer_883);
                printf("%lld\n", (long long)(__t29));
                struct __defer_env_30 __t32 = {.inner = inner_884};
                tur_frame_push_defer(&__frame_27, __defer_31, &__t32);
                tur_frame_fire_lifo(&__frame_27);
            }
            struct __defer_env_33 __t35 = {.outer = outer_883};
            tur_frame_push_defer(&__frame_25, __defer_34, &__t35);
            int64_t __t36;
            __t36 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_25);
            __t23 = __t36;
        }
        return (int)__t23;
}
