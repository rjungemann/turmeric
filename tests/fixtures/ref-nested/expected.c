            ...
            *((int64_t *)__t56) = INT64_C(10);
            ...
            tur_frame_init(&__frame_57, NULL);
            {
                ...
                *((int64_t *)__t58) = INT64_C(20);
                void * inner_1247 = __t58;
                (void)inner_1247;
                tur_frame __frame_59;
                tur_frame_init(&__frame_59, &__frame_57);
                int64_t __t60 = *((int64_t *)inner_1247);
                printf("%lld\n", (long long)(__t60));
                int64_t __t61 = *((int64_t *)outer_1246);
                printf("%lld\n", (long long)(__t61));
                struct __defer_env_62 __t64 = {.inner = inner_1247};
                tur_frame_push_defer(&__frame_59, __defer_63, &__t64);
                tur_frame_fire_lifo(&__frame_59);
            }
            struct __defer_env_65 __t67 = {.outer = outer_1246};
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t69 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t69 = (Cons__int){.head = h, .tail = t};
        return __t69;
}
