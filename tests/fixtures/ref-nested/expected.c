...
struct __defer_env_189 {void * outer; };

struct __defer_env_186 {void * inner; };

static void __defer_190(void *__env) {
    struct __defer_env_189 *__e = (struct __defer_env_189 *)__env;
    free(__e->outer);
}

static void __defer_187(void *__env) {
    struct __defer_env_186 *__e = (struct __defer_env_186 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t179;
        {
            void * __t180 = malloc(sizeof(int64_t));
            *((int64_t *)__t180) = INT64_C(10);
            void * outer_1434 = __t180;
            (void)outer_1434;
            tur_frame __frame_181;
            tur_frame_init(&__frame_181, NULL);
            {
                void * __t182 = malloc(sizeof(int64_t));
                *((int64_t *)__t182) = INT64_C(20);
                void * inner_1435 = __t182;
                (void)inner_1435;
                tur_frame __frame_183;
                tur_frame_init(&__frame_183, &__frame_181);
                int64_t __t184 = *((int64_t *)inner_1435);
                printf("%lld\n", (long long)(__t184));
                int64_t __t185 = *((int64_t *)outer_1434);
                printf("%lld\n", (long long)(__t185));
                struct __defer_env_186 __t188 = {.inner = inner_1435};
                tur_frame_push_defer(&__frame_183, __defer_187, &__t188);
                tur_frame_fire_lifo(&__frame_183);
            }
            struct __defer_env_189 __t191 = {.outer = outer_1434};
            tur_frame_push_defer(&__frame_181, __defer_190, &__t191);
            int64_t __t192;
            __t192 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_181);
            __t179 = __t192;
        }
        return (int)__t179;
}
