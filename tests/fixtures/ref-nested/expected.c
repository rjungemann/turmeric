...
struct __defer_env_11 {void * outer; };

struct __defer_env_8 {void * inner; };
...
int main(int argc, char **argv) {
        ...
        int64_t __t1;
        {
            void * __t2 = malloc(sizeof(int64_t));
            *((int64_t *)__t2) = INT64_C(10);
            void * outer_757 = __t2;
            (void)outer_757;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            {
                ...
                *((int64_t *)__t4) = INT64_C(20);
                void * inner_758 = __t4;
                (void)inner_758;
                tur_frame __frame_5;
                tur_frame_init(&__frame_5, &__frame_3);
                int64_t __t6 = *((int64_t *)inner_758);
                printf("%lld\n", (long long)(__t6));
                int64_t __t7 = *((int64_t *)outer_757);
                printf("%lld\n", (long long)(__t7));
                struct __defer_env_8 __t10 = {.inner = inner_758};
                tur_frame_push_defer(&__frame_5, __defer_9, &__t10);
                tur_frame_fire_lifo(&__frame_5);
            }
            struct __defer_env_11 __t13 = {.outer = outer_757};
            tur_frame_push_defer(&__frame_3, __defer_12, &__t13);
            int64_t __t14;
            __t14 = INT64_C(0);
