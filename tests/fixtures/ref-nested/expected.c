...
struct __defer_env_277 {void * outer; };

struct __defer_env_274 {void * inner; };
...
static void __defer_275(void *__env) {
    struct __defer_env_274 *__e = (struct __defer_env_274 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t267;
        {
            void * __t268 = malloc(sizeof(int64_t));
            *((int64_t *)__t268) = INT64_C(10);
            void * outer_1465 = __t268;
            (void)outer_1465;
            tur_frame __frame_269;
            tur_frame_init(&__frame_269, NULL);
            {
                void * __t270 = malloc(sizeof(int64_t));
                *((int64_t *)__t270) = INT64_C(20);
                void * inner_1466 = __t270;
                (void)inner_1466;
                tur_frame __frame_271;
                tur_frame_init(&__frame_271, &__frame_269);
                int64_t __t272 = *((int64_t *)inner_1466);
                printf("%lld\n", (long long)(__t272));
                int64_t __t273 = *((int64_t *)outer_1465);
                printf("%lld\n", (long long)(__t273));
                struct __defer_env_274 __t276 = {.inner = inner_1466};
                tur_frame_push_defer(&__frame_271, __defer_275, &__t276);
                tur_frame_fire_lifo(&__frame_271);
            }
            struct __defer_env_277 __t279 = {.outer = outer_1465};
            tur_frame_push_defer(&__frame_269, __defer_278, &__t279);
            int64_t __t280;
            __t280 = INT64_C(0);
