...
struct __defer_env_31 {void * outer; };

struct __defer_env_28 {void * inner; };
...
static void __defer_29(void *__env) {
    struct __defer_env_28 *__e = (struct __defer_env_28 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t21;
        {
            void * __t22 = malloc(sizeof(int64_t));
            *((int64_t *)__t22) = INT64_C(10);
            void * outer_880 = __t22;
            (void)outer_880;
            tur_frame __frame_23;
            tur_frame_init(&__frame_23, NULL);
            {
                void * __t24 = malloc(sizeof(int64_t));
                *((int64_t *)__t24) = INT64_C(20);
                void * inner_881 = __t24;
                (void)inner_881;
                tur_frame __frame_25;
                tur_frame_init(&__frame_25, &__frame_23);
                int64_t __t26 = *((int64_t *)inner_881);
                printf("%lld\n", (long long)(__t26));
                int64_t __t27 = *((int64_t *)outer_880);
                printf("%lld\n", (long long)(__t27));
                struct __defer_env_28 __t30 = {.inner = inner_881};
                tur_frame_push_defer(&__frame_25, __defer_29, &__t30);
                tur_frame_fire_lifo(&__frame_25);
            }
            struct __defer_env_31 __t33 = {.outer = outer_880};
            tur_frame_push_defer(&__frame_23, __defer_32, &__t33);
            int64_t __t34;
            __t34 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_23);
            __t21 = __t34;
        }
        return (int)__t21;
}
