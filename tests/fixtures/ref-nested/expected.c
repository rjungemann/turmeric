...
struct __defer_env_183 {void * outer; };

struct __defer_env_180 {void * inner; };

struct __defer_env_163 {int64_t m; };

static void __defer_184(void *__env) {
    struct __defer_env_183 *__e = (struct __defer_env_183 *)__env;
    free(__e->outer);
}

static void __defer_181(void *__env) {
    struct __defer_env_180 *__e = (struct __defer_env_180 *)__env;
    free(__e->inner);
}
...
static void __defer_164(void *__env) {
    ...
    bool __ps_189 = (bt_hyundo_hyto_ex(__e->m));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            void * __t174 = malloc(sizeof(int64_t));
            *((int64_t *)__t174) = INT64_C(10);
            void * outer_1606 = __t174;
            (void)outer_1606;
            tur_frame __frame_175;
            tur_frame_init(&__frame_175, NULL);
            {
                void * __t176 = malloc(sizeof(int64_t));
                *((int64_t *)__t176) = INT64_C(20);
                void * inner_1607 = __t176;
                (void)inner_1607;
                tur_frame __frame_177;
                tur_frame_init(&__frame_177, &__frame_175);
                int64_t __t178 = *((int64_t *)inner_1607);
                printf("%lld\n", (long long)(__t178));
                int64_t __t179 = *((int64_t *)outer_1606);
                printf("%lld\n", (long long)(__t179));
                struct __defer_env_180 __t182 = {.inner = inner_1607};
                tur_frame_push_defer(&__frame_177, __defer_181, &__t182);
                tur_frame_fire_lifo(&__frame_177);
            }
            struct __defer_env_183 __t185 = {.outer = outer_1606};
            tur_frame_push_defer(&__frame_175, __defer_184, &__t185);
            int64_t __t186;
            __t186 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_175);
            __t173 = __t186;
        }
        return (int)__t173;
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_187 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
