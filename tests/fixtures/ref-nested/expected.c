...
struct __defer_env_191 {void * outer; };

struct __defer_env_188 {void * inner; };
...
static void __defer_189(void *__env) {
    struct __defer_env_188 *__e = (struct __defer_env_188 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t181;
        {
            ...
            *((int64_t *)__t182) = INT64_C(10);
            void * outer_1269 = __t182;
            (void)outer_1269;
            tur_frame __frame_183;
            tur_frame_init(&__frame_183, NULL);
            {
                void * __t184 = malloc(sizeof(int64_t));
                *((int64_t *)__t184) = INT64_C(20);
                void * inner_1270 = __t184;
                (void)inner_1270;
                tur_frame __frame_185;
                tur_frame_init(&__frame_185, &__frame_183);
                int64_t __t186 = *((int64_t *)inner_1270);
                printf("%lld\n", (long long)(__t186));
                int64_t __t187 = *((int64_t *)outer_1269);
                printf("%lld\n", (long long)(__t187));
                struct __defer_env_188 __t190 = {.inner = inner_1270};
                tur_frame_push_defer(&__frame_185, __defer_189, &__t190);
                tur_frame_fire_lifo(&__frame_185);
            }
            struct __defer_env_191 __t193 = {.outer = outer_1269};
            tur_frame_push_defer(&__frame_183, __defer_192, &__t193);
            int64_t __t194;
            __t194 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_195 = (ctor_Cons__int(h, t));
