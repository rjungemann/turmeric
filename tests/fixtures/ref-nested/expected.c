...
struct __defer_env_285 {void * outer; };

struct __defer_env_282 {void * inner; };
...
static void __defer_283(void *__env) {
    struct __defer_env_282 *__e = (struct __defer_env_282 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t275;
        {
            void * __t276 = malloc(sizeof(int64_t));
            *((int64_t *)__t276) = INT64_C(10);
            void * outer_1606 = __t276;
            (void)outer_1606;
            tur_frame __frame_277;
            tur_frame_init(&__frame_277, NULL);
            {
                void * __t278 = malloc(sizeof(int64_t));
                *((int64_t *)__t278) = INT64_C(20);
                void * inner_1607 = __t278;
                (void)inner_1607;
                tur_frame __frame_279;
                tur_frame_init(&__frame_279, &__frame_277);
                int64_t __t280 = *((int64_t *)inner_1607);
                printf("%lld\n", (long long)(__t280));
                int64_t __t281 = *((int64_t *)outer_1606);
                printf("%lld\n", (long long)(__t281));
                struct __defer_env_282 __t284 = {.inner = inner_1607};
                tur_frame_push_defer(&__frame_279, __defer_283, &__t284);
                tur_frame_fire_lifo(&__frame_279);
            }
            struct __defer_env_285 __t287 = {.outer = outer_1606};
            tur_frame_push_defer(&__frame_277, __defer_286, &__t287);
            int64_t __t288;
            __t288 = INT64_C(0);
