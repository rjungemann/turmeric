...
struct __defer_env_254 {void * outer; };

struct __defer_env_251 {void * inner; };

static void __defer_255(void *__env) {
    struct __defer_env_254 *__e = (struct __defer_env_254 *)__env;
    free(__e->outer);
}

static void __defer_252(void *__env) {
    struct __defer_env_251 *__e = (struct __defer_env_251 *)__env;
    free(__e->inner);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t244;
        {
            void * __t245 = malloc(sizeof(int64_t));
            *((int64_t *)__t245) = INT64_C(10);
            void * outer_1467 = __t245;
            (void)outer_1467;
            tur_frame __frame_246;
            tur_frame_init(&__frame_246, NULL);
            {
                void * __t247 = malloc(sizeof(int64_t));
                *((int64_t *)__t247) = INT64_C(20);
                void * inner_1468 = __t247;
                (void)inner_1468;
                tur_frame __frame_248;
                tur_frame_init(&__frame_248, &__frame_246);
                int64_t __t249 = *((int64_t *)inner_1468);
                printf("%lld\n", (long long)(__t249));
                int64_t __t250 = *((int64_t *)outer_1467);
                printf("%lld\n", (long long)(__t250));
                struct __defer_env_251 __t253 = {.inner = inner_1468};
                tur_frame_push_defer(&__frame_248, __defer_252, &__t253);
                tur_frame_fire_lifo(&__frame_248);
            }
            struct __defer_env_254 __t256 = {.outer = outer_1467};
            tur_frame_push_defer(&__frame_246, __defer_255, &__t256);
            int64_t __t257;
            __t257 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_246);
            __t244 = __t257;
        }
        return (int)__t244;
}
