...
struct __defer_env_165 {void * outer; };

struct __defer_env_162 {void * inner; };
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t155;
        {
            void * __t156 = malloc(sizeof(int64_t));
            *((int64_t *)__t156) = INT64_C(10);
            void * outer_1300 = __t156;
            (void)outer_1300;
            tur_frame __frame_157;
            tur_frame_init(&__frame_157, NULL);
            {
                void * __t158 = malloc(sizeof(int64_t));
                *((int64_t *)__t158) = INT64_C(20);
                void * inner_1301 = __t158;
                (void)inner_1301;
                tur_frame __frame_159;
                tur_frame_init(&__frame_159, &__frame_157);
                int64_t __t160 = *((int64_t *)inner_1301);
                printf("%lld\n", (long long)(__t160));
                int64_t __t161 = *((int64_t *)outer_1300);
                printf("%lld\n", (long long)(__t161));
                struct __defer_env_162 __t164 = {.inner = inner_1301};
                tur_frame_push_defer(&__frame_159, __defer_163, &__t164);
                tur_frame_fire_lifo(&__frame_159);
            }
            struct __defer_env_165 __t167 = {.outer = outer_1300};
            tur_frame_push_defer(&__frame_157, __defer_166, &__t167);
            int64_t __t168;
            __t168 = INT64_C(0);
            tur_frame_fire_lifo(&__frame_157);
            __t155 = __t168;
        }
        return (int)__t155;
}
