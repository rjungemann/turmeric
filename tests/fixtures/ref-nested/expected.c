            ...
            *((int64_t *)__t160) = INT64_C(10);
            ...
            tur_frame_init(&__frame_161, NULL);
            {
                ...
                *((int64_t *)__t162) = INT64_C(20);
                void * inner_1329 = __t162;
                (void)inner_1329;
                tur_frame __frame_163;
                tur_frame_init(&__frame_163, &__frame_161);
                int64_t __t164 = *((int64_t *)inner_1329);
                printf("%lld\n", (long long)(__t164));
                int64_t __t165 = *((int64_t *)outer_1328);
                printf("%lld\n", (long long)(__t165));
                struct __defer_env_166 __t168 = {.inner = inner_1329};
                tur_frame_push_defer(&__frame_163, __defer_167, &__t168);
                tur_frame_fire_lifo(&__frame_163);
            }
            struct __defer_env_169 __t171 = {.outer = outer_1328};
