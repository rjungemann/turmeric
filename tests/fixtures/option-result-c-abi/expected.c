...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_180 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t181 = (int64_t)(intptr_t)(__ps_180);
        bool __ps_182 = (some___spec__bool_tur_adt_Option__int((__t181 ? (*(tur_adt_Option__int *)(intptr_t)(__t181)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_182) ? "true" : "false");
        int64_t __ps_183 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_184 = (opt_hyor(__ps_183, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_184));
        int64_t __ps_185 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t186 = (int64_t)(intptr_t)(__ps_185);
        bool __ps_187 = (some___spec__bool_tur_adt_Option__int((__t186 ? (*(tur_adt_Option__int *)(intptr_t)(__t186)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_187) ? "true" : "false");
        int64_t __ps_188 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_189 = (opt_hyor(__ps_188, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        int64_t __ps_190 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_191 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_190))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_191) ? "true" : "false");
        int64_t __ps_192 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_193 = (res_hypayload(__ps_192));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_193));
        int64_t __ps_194 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_195 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_194))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_195) ? "true" : "false");
        int64_t __ps_196 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_197 = (res_hypayload(__ps_196));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_197));
        int64_t __t198;
        __t198 = INT64_C(0);
