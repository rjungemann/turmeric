...
int main(int argc, char **argv) {
        ...
        tur_option_t *__t51 = (tur_option_t *)(intptr_t)(lookup(INT64_C(7)));
        ...
        tur_option_t *__t52 = (tur_option_t *)(intptr_t)(lookup(INT64_C(3)));
        puts((some___spec__bool_Option__int((__t52 ? (Option__int){.is_some = __t52->is_some, .value = __t52->value} : (Option__int){0}))) ? "true" : "false");
