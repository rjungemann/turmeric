...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_164 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_165 = (some_qu(__ps_164));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_169 = (some_qu(__ps_168));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_169) ? "true" : "false");
        int64_t __ps_170 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_171 = (opt_hyor(__ps_170, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_171));
        int64_t __ps_172 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_173 = (ok_qu(__ps_172));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_173) ? "true" : "false");
        int64_t __ps_174 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_175 = (res_hypayload(__ps_174));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_175));
        int64_t __ps_176 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_177 = (err_qu(__ps_176));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_177) ? "true" : "false");
        int64_t __ps_178 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_179 = (res_hypayload(__ps_178));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        int64_t __t180;
        __t180 = INT64_C(0);
