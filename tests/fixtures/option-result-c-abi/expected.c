...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_264 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t265 = (int64_t)(intptr_t)(__ps_264);
        bool __ps_266 = (some___spec__bool_tur_adt_Option__int((__t265 ? (*(tur_adt_Option__int *)(intptr_t)(__t265)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_266) ? "true" : "false");
        int64_t __ps_267 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_268 = (opt_hyor(__ps_267, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_268));
        int64_t __ps_269 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t270 = (int64_t)(intptr_t)(__ps_269);
        bool __ps_271 = (some___spec__bool_tur_adt_Option__int((__t270 ? (*(tur_adt_Option__int *)(intptr_t)(__t270)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_271) ? "true" : "false");
        int64_t __ps_272 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_273 = (opt_hyor(__ps_272, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_273));
        int64_t __ps_274 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_275 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_274))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_275) ? "true" : "false");
        int64_t __ps_276 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_277 = (res_hypayload(__ps_276));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_277));
        int64_t __ps_278 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_279 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_278))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_279) ? "true" : "false");
        int64_t __ps_280 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_281 = (res_hypayload(__ps_280));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_281));
        int64_t __t282;
        __t282 = INT64_C(0);
