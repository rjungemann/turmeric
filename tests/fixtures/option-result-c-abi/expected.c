...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_163 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t164 = (int64_t)(intptr_t)(__ps_163);
        bool __ps_165 = (some___spec__bool_tur_adt_Option__int((__t164 ? (*(tur_adt_Option__int *)(intptr_t)(__t164)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_165) ? "true" : "false");
        int64_t __ps_166 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_167 = (opt_hyor(__ps_166, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_167));
        int64_t __ps_168 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t169 = (int64_t)(intptr_t)(__ps_168);
        bool __ps_170 = (some___spec__bool_tur_adt_Option__int((__t169 ? (*(tur_adt_Option__int *)(intptr_t)(__t169)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_170) ? "true" : "false");
        int64_t __ps_171 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_172 = (opt_hyor(__ps_171, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_172));
        int64_t __ps_173 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_174 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_173))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_174) ? "true" : "false");
        int64_t __ps_175 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_176 = (res_hypayload(__ps_175));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        int64_t __ps_177 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_178 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_177))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_178) ? "true" : "false");
        int64_t __ps_179 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_180 = (res_hypayload(__ps_179));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
