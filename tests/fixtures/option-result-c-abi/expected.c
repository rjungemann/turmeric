...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_172 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t173 = (int64_t)(intptr_t)(__ps_172);
        bool __ps_174 = (some___spec__bool_tur_adt_Option__int((__t173 ? (*(tur_adt_Option__int *)(intptr_t)(__t173)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_174) ? "true" : "false");
        int64_t __ps_175 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_176 = (opt_hyor(__ps_175, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        int64_t __ps_177 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t178 = (int64_t)(intptr_t)(__ps_177);
        bool __ps_179 = (some___spec__bool_tur_adt_Option__int((__t178 ? (*(tur_adt_Option__int *)(intptr_t)(__t178)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_179) ? "true" : "false");
        int64_t __ps_180 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_181 = (opt_hyor(__ps_180, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        int64_t __ps_182 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_183 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_182))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_183) ? "true" : "false");
        int64_t __ps_184 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_185 = (res_hypayload(__ps_184));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        int64_t __ps_186 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_187 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_186))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_187) ? "true" : "false");
        int64_t __ps_188 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_189 = (res_hypayload(__ps_188));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        int64_t __t190;
        __t190 = INT64_C(0);
