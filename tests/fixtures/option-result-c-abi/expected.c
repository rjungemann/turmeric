...
int main(int argc, char **argv) {
        ...
        tur_option_t *__t46 = (tur_option_t *)(intptr_t)(lookup(INT64_C(7)));
        puts((some___spec__bool_Option__int((__t46 ? (Option__int){.is_some = __t46->is_some, .value = __t46->value} : (Option__int){0}))) ? "true" : "false");
        printf("%lld\n", (long long)(opt_hyor(lookup(INT64_C(7)), INT64_C(0))));
        tur_option_t *__t47 = (tur_option_t *)(intptr_t)(lookup(INT64_C(3)));
        puts((some___spec__bool_Option__int((__t47 ? (Option__int){.is_some = __t47->is_some, .value = __t47->value} : (Option__int){0}))) ? "true" : "false");
