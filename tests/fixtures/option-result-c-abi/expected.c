...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_181 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t182 = (tur_option_t *)(intptr_t)(__ps_181);
        __auto_type __ps_183 = (some___spec__bool_tur_adt_Option__int((__t182 ? (tur_adt_Option__int){.is_some = __t182->is_some, .value = __t182->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_183) ? "true" : "false");
        __auto_type __ps_184 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_185 = (opt_hyor(__ps_184, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        __auto_type __ps_186 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t187 = (tur_option_t *)(intptr_t)(__ps_186);
        __auto_type __ps_188 = (some___spec__bool_tur_adt_Option__int((__t187 ? (tur_adt_Option__int){.is_some = __t187->is_some, .value = __t187->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_188) ? "true" : "false");
        __auto_type __ps_189 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_190 = (opt_hyor(__ps_189, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_190));
        __auto_type __ps_191 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_192 = (ok_qu(__ps_191));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_192) ? "true" : "false");
        __auto_type __ps_193 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_194 = (res_hypayload(__ps_193));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_194));
        __auto_type __ps_195 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_196 = (err_qu(__ps_195));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_196) ? "true" : "false");
        __auto_type __ps_197 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_198 = (res_hypayload(__ps_197));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_198));
        int64_t __t199;
        __t199 = INT64_C(0);
