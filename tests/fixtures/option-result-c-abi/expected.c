...
int main(int argc, char **argv) {
        ...
        tur_option_t *__t50 = (tur_option_t *)(intptr_t)(lookup(INT64_C(7)));
        puts((some___spec__bool_tur_adt_Option__int((__t50 ? (tur_adt_Option__int){.is_some = __t50->is_some, .value = __t50->value} : (tur_adt_Option__int){0}))) ? "true" : "false");
        printf("%lld\n", (long long)(opt_hyor(lookup(INT64_C(7)), INT64_C(0))));
        tur_option_t *__t51 = (tur_option_t *)(intptr_t)(lookup(INT64_C(3)));
        puts((some___spec__bool_tur_adt_Option__int((__t51 ? (tur_adt_Option__int){.is_some = __t51->is_some, .value = __t51->value} : (tur_adt_Option__int){0}))) ? "true" : "false");
