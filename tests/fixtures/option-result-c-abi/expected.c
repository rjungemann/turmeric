...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        bool __ps_269 = (some___spec__bool_tur_adt_Option__int((__t268 ? (*(tur_adt_Option__int *)(intptr_t)(__t268)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_269) ? "true" : "false");
        int64_t __ps_270 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_271 = (opt_hyor(__ps_270, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_271));
        int64_t __ps_272 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t273 = (int64_t)(intptr_t)(__ps_272);
        bool __ps_274 = (some___spec__bool_tur_adt_Option__int((__t273 ? (*(tur_adt_Option__int *)(intptr_t)(__t273)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_274) ? "true" : "false");
        int64_t __ps_275 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_276 = (opt_hyor(__ps_275, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_276));
        int64_t __ps_277 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_278 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_277))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_278) ? "true" : "false");
        int64_t __ps_279 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_280 = (res_hypayload(__ps_279));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_280));
        int64_t __ps_281 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_282 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_281))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_282) ? "true" : "false");
        int64_t __ps_283 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_284 = (res_hypayload(__ps_283));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_284));
        int64_t __t285;
        __t285 = INT64_C(0);
