...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_153 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t154 = (tur_option_t *)(intptr_t)(__ps_153);
        __auto_type __ps_155 = (some___spec__bool_tur_adt_Option__int((__t154 ? (tur_adt_Option__int){.is_some = __t154->is_some, .value = __t154->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_155) ? "true" : "false");
        __auto_type __ps_156 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_157 = (opt_hyor(__ps_156, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_157));
        __auto_type __ps_158 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t159 = (tur_option_t *)(intptr_t)(__ps_158);
        __auto_type __ps_160 = (some___spec__bool_tur_adt_Option__int((__t159 ? (tur_adt_Option__int){.is_some = __t159->is_some, .value = __t159->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_160) ? "true" : "false");
        __auto_type __ps_161 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_162 = (opt_hyor(__ps_161, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_162));
        __auto_type __ps_163 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_164 = (ok_qu(__ps_163));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_164) ? "true" : "false");
        __auto_type __ps_165 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_166 = (res_hypayload(__ps_165));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_166));
        __auto_type __ps_167 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_168 = (err_qu(__ps_167));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_168) ? "true" : "false");
        __auto_type __ps_169 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_170 = (res_hypayload(__ps_169));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_170));
        int64_t __t171;
        __t171 = INT64_C(0);
