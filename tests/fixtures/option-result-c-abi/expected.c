...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_159 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t160 = (tur_option_t *)(intptr_t)(__ps_159);
        bool __ps_161 = (some___spec__bool_tur_adt_Option__int((__t160 ? (tur_adt_Option__int){.is_some = __t160->is_some, .value = __t160->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_161) ? "true" : "false");
        int64_t __ps_162 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_163 = (opt_hyor(__ps_162, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_163));
        int64_t __ps_164 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t165 = (tur_option_t *)(intptr_t)(__ps_164);
        bool __ps_166 = (some___spec__bool_tur_adt_Option__int((__t165 ? (tur_adt_Option__int){.is_some = __t165->is_some, .value = __t165->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_166) ? "true" : "false");
        int64_t __ps_167 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_168 = (opt_hyor(__ps_167, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_168));
        int64_t __ps_169 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_170 = (ok_qu(__ps_169));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_170) ? "true" : "false");
        int64_t __ps_171 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_172 = (res_hypayload(__ps_171));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_172));
        int64_t __ps_173 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_174 = (err_qu(__ps_173));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_174) ? "true" : "false");
        int64_t __ps_175 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
