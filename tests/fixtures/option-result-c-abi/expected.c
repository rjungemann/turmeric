...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_168 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        int64_t __ps_171 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_172 = (opt_hyor(__ps_171, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_172));
        int64_t __ps_173 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        int64_t __ps_176 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_177 = (opt_hyor(__ps_176, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        int64_t __ps_178 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_179 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_178))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_179) ? "true" : "false");
        int64_t __ps_180 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_181 = (res_hypayload(__ps_180));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        int64_t __ps_182 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_183 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_182))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_183) ? "true" : "false");
        int64_t __ps_184 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
