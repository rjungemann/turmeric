...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_275 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t276 = (int64_t)(intptr_t)(__ps_275);
        bool __ps_277 = (some___spec__bool_tur_adt_Option__int((__t276 ? (*(tur_adt_Option__int *)(intptr_t)(__t276)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_277) ? "true" : "false");
        int64_t __ps_278 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_279 = (opt_hyor(__ps_278, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_279));
        int64_t __ps_280 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t281 = (int64_t)(intptr_t)(__ps_280);
        bool __ps_282 = (some___spec__bool_tur_adt_Option__int((__t281 ? (*(tur_adt_Option__int *)(intptr_t)(__t281)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_282) ? "true" : "false");
        int64_t __ps_283 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_284 = (opt_hyor(__ps_283, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_284));
        int64_t __ps_285 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_286 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_285))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_286) ? "true" : "false");
        int64_t __ps_287 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_288 = (res_hypayload(__ps_287));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_288));
        int64_t __ps_289 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_290 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_289))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_290) ? "true" : "false");
        int64_t __ps_291 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_292 = (res_hypayload(__ps_291));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_292));
        int64_t __t293;
        __t293 = INT64_C(0);
