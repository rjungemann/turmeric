...
static int64_t opt_hyor(int64_t o, int64_t dflt) {
        return tur_is_some(o) ? tur_opt_value(o) : dflt; 
}

static int64_t safe_hydiv(int64_t a, int64_t b) {
        if (b == 0) return tur_box_err(-1);
  return tur_box_ok(a / b);
  
}

static int64_t res_hypayload(int64_t r) {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_244 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t245 = (int64_t)(intptr_t)(__ps_244);
        bool __ps_246 = (some___spec__bool_tur_adt_Option__int((__t245 ? (*(tur_adt_Option__int *)(intptr_t)(__t245)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_246) ? "true" : "false");
        int64_t __ps_247 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_248 = (opt_hyor(__ps_247, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_248));
        int64_t __ps_249 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t250 = (int64_t)(intptr_t)(__ps_249);
        bool __ps_251 = (some___spec__bool_tur_adt_Option__int((__t250 ? (*(tur_adt_Option__int *)(intptr_t)(__t250)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_251) ? "true" : "false");
        int64_t __ps_252 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_253 = (opt_hyor(__ps_252, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_253));
        int64_t __ps_254 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_255 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_254))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_255) ? "true" : "false");
        int64_t __ps_256 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_257 = (res_hypayload(__ps_256));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_257));
        int64_t __ps_258 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_259 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_258))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_259) ? "true" : "false");
        int64_t __ps_260 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_261 = (res_hypayload(__ps_260));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_261));
        int64_t __t262;
        __t262 = INT64_C(0);
