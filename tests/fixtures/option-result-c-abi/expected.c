...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_173 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t174 = (tur_option_t *)(intptr_t)(__ps_173);
        __auto_type __ps_175 = (some___spec__bool_tur_adt_Option__int((__t174 ? (tur_adt_Option__int){.is_some = __t174->is_some, .value = __t174->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_175) ? "true" : "false");
        __auto_type __ps_176 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_177 = (opt_hyor(__ps_176, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        __auto_type __ps_178 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t179 = (tur_option_t *)(intptr_t)(__ps_178);
        __auto_type __ps_180 = (some___spec__bool_tur_adt_Option__int((__t179 ? (tur_adt_Option__int){.is_some = __t179->is_some, .value = __t179->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_180) ? "true" : "false");
        __auto_type __ps_181 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_182 = (opt_hyor(__ps_181, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_182));
        __auto_type __ps_183 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_184 = (ok_qu(__ps_183));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_184) ? "true" : "false");
        __auto_type __ps_185 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_186 = (res_hypayload(__ps_185));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_186));
        __auto_type __ps_187 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_188 = (err_qu(__ps_187));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_188) ? "true" : "false");
        __auto_type __ps_189 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_190 = (res_hypayload(__ps_189));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_190));
        int64_t __t191;
        __t191 = INT64_C(0);
