...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_232 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t233 = (int64_t)(intptr_t)(__ps_232);
        bool __ps_234 = (some___spec__bool_tur_adt_Option__int((__t233 ? (*(tur_adt_Option__int *)(intptr_t)(__t233)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_234) ? "true" : "false");
        int64_t __ps_235 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_236 = (opt_hyor(__ps_235, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_236));
        int64_t __ps_237 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t238 = (int64_t)(intptr_t)(__ps_237);
        bool __ps_239 = (some___spec__bool_tur_adt_Option__int((__t238 ? (*(tur_adt_Option__int *)(intptr_t)(__t238)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_239) ? "true" : "false");
        int64_t __ps_240 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_241 = (opt_hyor(__ps_240, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_241));
        int64_t __ps_242 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_243 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_242))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_243) ? "true" : "false");
        int64_t __ps_244 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_245 = (res_hypayload(__ps_244));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_245));
        int64_t __ps_246 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_247 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_246))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_247) ? "true" : "false");
        int64_t __ps_248 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_249 = (res_hypayload(__ps_248));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_249));
        int64_t __t250;
        __t250 = INT64_C(0);
