...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        bool __ps_185 = (some___spec__bool_tur_adt_Option__int((__t184 ? (*(tur_adt_Option__int *)(intptr_t)(__t184)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_185) ? "true" : "false");
        int64_t __ps_186 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_187 = (opt_hyor(__ps_186, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_187));
        int64_t __ps_188 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t189 = (int64_t)(intptr_t)(__ps_188);
        bool __ps_190 = (some___spec__bool_tur_adt_Option__int((__t189 ? (*(tur_adt_Option__int *)(intptr_t)(__t189)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_190) ? "true" : "false");
        int64_t __ps_191 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_192 = (opt_hyor(__ps_191, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_192));
        int64_t __ps_193 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_194 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_193))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_194) ? "true" : "false");
        int64_t __ps_195 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_196 = (res_hypayload(__ps_195));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_196));
        int64_t __ps_197 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_198 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_197))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_198) ? "true" : "false");
        int64_t __ps_199 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_200 = (res_hypayload(__ps_199));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_200));
        int64_t __t201;
        __t201 = INT64_C(0);
