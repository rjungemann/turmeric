...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_155 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t156 = (tur_option_t *)(intptr_t)(__ps_155);
        __auto_type __ps_157 = (some___spec__bool_tur_adt_Option__int((__t156 ? (tur_adt_Option__int){.is_some = __t156->is_some, .value = __t156->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_157) ? "true" : "false");
        __auto_type __ps_158 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_159 = (opt_hyor(__ps_158, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_159));
        __auto_type __ps_160 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t161 = (tur_option_t *)(intptr_t)(__ps_160);
        __auto_type __ps_162 = (some___spec__bool_tur_adt_Option__int((__t161 ? (tur_adt_Option__int){.is_some = __t161->is_some, .value = __t161->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_162) ? "true" : "false");
        __auto_type __ps_163 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_164 = (opt_hyor(__ps_163, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_164));
        __auto_type __ps_165 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_166 = (ok_qu(__ps_165));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_166) ? "true" : "false");
        __auto_type __ps_167 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_168 = (res_hypayload(__ps_167));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_168));
        __auto_type __ps_169 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_170 = (err_qu(__ps_169));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_170) ? "true" : "false");
        __auto_type __ps_171 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_172 = (res_hypayload(__ps_171));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_172));
        int64_t __t173;
        __t173 = INT64_C(0);
