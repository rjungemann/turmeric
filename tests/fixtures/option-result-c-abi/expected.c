...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_179 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t180 = (int64_t)(intptr_t)(__ps_179);
        bool __ps_181 = (some___spec__bool_tur_adt_Option__int((__t180 ? (*(tur_adt_Option__int *)(intptr_t)(__t180)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_181) ? "true" : "false");
        int64_t __ps_182 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_183 = (opt_hyor(__ps_182, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_183));
        int64_t __ps_184 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t185 = (int64_t)(intptr_t)(__ps_184);
        bool __ps_186 = (some___spec__bool_tur_adt_Option__int((__t185 ? (*(tur_adt_Option__int *)(intptr_t)(__t185)) : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_186) ? "true" : "false");
        int64_t __ps_187 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_188 = (opt_hyor(__ps_187, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_188));
        int64_t __ps_189 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_190 = (ok___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_189))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_190) ? "true" : "false");
        int64_t __ps_191 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_192 = (res_hypayload(__ps_191));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_192));
        int64_t __ps_193 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_194 = (err___spec__bool_tur_adt_Result__int__int((*(tur_adt_Result__int__int *)(intptr_t)(__ps_193))));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_194) ? "true" : "false");
        int64_t __ps_195 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_196 = (res_hypayload(__ps_195));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_196));
        int64_t __t197;
        __t197 = INT64_C(0);
