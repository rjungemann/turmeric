...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_160 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_164 = (opt_hyor(__ps_163, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_164));
        int64_t __ps_165 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t166 = (tur_option_t *)(intptr_t)(__ps_165);
        bool __ps_167 = (some___spec__bool_tur_adt_Option__int((__t166 ? (tur_adt_Option__int){.is_some = __t166->is_some, .value = __t166->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_167) ? "true" : "false");
        int64_t __ps_168 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_169 = (opt_hyor(__ps_168, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_169));
        int64_t __ps_170 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_171 = (ok_qu(__ps_170));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_171) ? "true" : "false");
        int64_t __ps_172 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_173 = (res_hypayload(__ps_172));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_173));
        int64_t __ps_174 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_175 = (err_qu(__ps_174));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_175) ? "true" : "false");
        int64_t __ps_176 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_177 = (res_hypayload(__ps_176));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        int64_t __t178;
        __t178 = INT64_C(0);
