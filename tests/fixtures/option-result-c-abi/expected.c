...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_177 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t178 = (tur_option_t *)(intptr_t)(__ps_177);
        __auto_type __ps_179 = (some___spec__bool_tur_adt_Option__int((__t178 ? (tur_adt_Option__int){.is_some = __t178->is_some, .value = __t178->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_179) ? "true" : "false");
        __auto_type __ps_180 = (lookup(INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_181 = (opt_hyor(__ps_180, INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        __auto_type __ps_182 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t183 = (tur_option_t *)(intptr_t)(__ps_182);
        __auto_type __ps_184 = (some___spec__bool_tur_adt_Option__int((__t183 ? (tur_adt_Option__int){.is_some = __t183->is_some, .value = __t183->value} : (tur_adt_Option__int){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_184) ? "true" : "false");
        __auto_type __ps_185 = (lookup(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_186 = (opt_hyor(__ps_185, INT64_C(-9)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_186));
        __auto_type __ps_187 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_188 = (ok_qu(__ps_187));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_188) ? "true" : "false");
        __auto_type __ps_189 = (safe_hydiv(INT64_C(10), INT64_C(2)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_190 = (res_hypayload(__ps_189));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_190));
        __auto_type __ps_191 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_192 = (err_qu(__ps_191));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts((__ps_192) ? "true" : "false");
        __auto_type __ps_193 = (safe_hydiv(INT64_C(10), INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
