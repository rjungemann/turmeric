...
int main(int argc, char **argv) {
        ...
        puts((some___spec__bool_Option__int((__t50 ? (Option__int){.is_some = __t50->is_some, .value = __t50->value} : (Option__int){0}))) ? "true" : "false");
        printf("%lld\n", (long long)(opt_hyor(lookup(INT64_C(7)), INT64_C(0))));
        tur_option_t *__t51 = (tur_option_t *)(intptr_t)(lookup(INT64_C(3)));
        puts((some___spec__bool_Option__int((__t51 ? (Option__int){.is_some = __t51->is_some, .value = __t51->value} : (Option__int){0}))) ? "true" : "false");
