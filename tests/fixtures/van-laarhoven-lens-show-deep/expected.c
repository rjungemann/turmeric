...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_100 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_751, (void *)(intptr_t)(k_752), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t102;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_756 = __ps_104;
            (void)iter_756;
            __auto_type __ps_105 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_106 = (hamt_slkeyeq((void *)(intptr_t)(__ps_105)));
            if (tur_panicking) return (bool){0};
            void * keyeq_757 = __ps_106;
            (void)keyeq_757;
            __auto_type __ps_107 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_108 = (map_hyeq_hyloop((void *)(intptr_t)(iter_756), (void *)(intptr_t)(__ps_107), (void *)(intptr_t)(keyeq_757), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_758 = __ps_108;
            (void)result_758;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_126) {
            bool __t127;
            {
                ...
                bool __t128;
                if ((t1_998) == (INT64_C(0))) {
                    __t128 = (t2_999) == (INT64_C(0));
                } else {
                    bool __t129;
                    if ((t2_999) == (INT64_C(0))) {
                        __t129 = false;
                    } else {
                        __auto_type __ps_130 = (cons_hyeq_hygo(t1_998, t2_999));
                        if (tur_panicking) return (bool){0};
                        __t129 = __ps_130;
                    }
                    __t128 = __t129;
...
static intptr_t _un_uncons_hyfmap_j0(intptr_t env, intptr_t __t2__slot, DK *__kont) {
    ...
    int64_t out_1007;
    out_1007 = tcons(__t1, __t2); /* cps->direct */
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_136) {
            ...
            int64_t __t137;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1014 = (int64_t)(intptr_t)(__ps_141);
                (void)out_1014;
                __t137 = out_1014;
            }
            __t135 = __t137;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t146;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1089 = __ps_148;
            (void)iter_1089;
            __auto_type __ps_149 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_150 = (hamt_slkeyeq((void *)(intptr_t)(__ps_149)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1090 = __ps_150;
            (void)keyeq_1090;
            __auto_type __ps_151 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_152 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1089), (void *)(intptr_t)(__ps_151), (void *)(intptr_t)(keyeq_1090)));
            if (tur_panicking) return (bool){0};
            bool result_1091 = __ps_152;
            (void)result_1091;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t173;
        {
            ...
            {
                __auto_type __ps_175 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1218));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1219 = __ps_175;
                (void)_un_unv_1219;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t178;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1268 = __ps_179;
            (void)r_1268;
            int64_t __t180;
            __auto_type __ps_181 = (schema_hydecode_hyok_qu(r_1268));
            if (tur_panicking) return (int64_t){0};
            if (__ps_181) {
                __auto_type __ps_182 = (schema_hydecode_hyvalue(r_1268));
                if (tur_panicking) return (int64_t){0};
                __t180 = __ps_182;
            } else {
                __auto_type __ps_183 = (schema_hydecode_hyerrors(r_1268));
                if (tur_panicking) return (int64_t){0};
...
static const char * shown_hyint(tur_poly_fn_t l, int64_t s) {
        ...
        __t186[1] = (int64_t)(intptr_t)__fn_1326;
        void *__t187 = __t186;
        __auto_type __ps_188 = (((int64_t(*)(void*, int64_t, int64_t, int64_t, int64_t))l.fn)(l.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Functor_Identity_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)(__t187)), (int64_t)(s)));
        if (tur_panicking) return (const char *){0};
...
static const char * shown_hybool(tur_poly_fn_t l, bool s) {
        ...
        __t190[1] = (int64_t)(intptr_t)__fn_1331;
        void *__t191 = __t190;
        __auto_type __ps_192 = (((int64_t(*)(void*, int64_t, int64_t, int64_t, int64_t))l.fn)(l.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Functor_Identity_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_bool_singleton))), (int64_t)((int64_t)(intptr_t)(__t191)), (int64_t)(s)));
        if (tur_panicking) return (const char *){0};
        __auto_type __ps_193 = (run_hyid(__ps_192));
        if (tur_panicking) return (const char *){0};
        return ((union { int64_t s; const char * d; }){.s = __ps_193}).d;
}
...
static int64_t peek_hyint(tur_poly_fn_t l, int64_t s) {
        ...
        __t194[1] = (int64_t)(intptr_t)__fn_1336;
        void *__t195 = __t194;
        __auto_type __ps_196 = (((int64_t(*)(void*, int64_t, int64_t, int64_t, int64_t))l.fn)(l.env, (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Functor_Const_tyvar_singleton))), (int64_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(&dict_Show_int_singleton))), (int64_t)((int64_t)(intptr_t)(__t195)), (int64_t)(s)));
        if (tur_panicking) return (int64_t){0};
        __auto_type __ps_197 = (get_hyconst(__ps_196));
        if (tur_panicking) return (int64_t){0};
        return __ps_197;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_198 = (shown_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1350 }, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_198);
        __auto_type __ps_199 = (shown_hybool((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1364 }, true));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        puts(__ps_199);
        __auto_type __ps_200 = (peek_hyint((tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1378 }, INT64_C(42)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_200));
        int64_t __t201;
        __t201 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_202 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_203 = (vec_new__spec__tur_adt_Vec__int__());
