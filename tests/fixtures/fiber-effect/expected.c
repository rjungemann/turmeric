...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_32 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_32, (int64_t)INT64_C(10));
    return (int64_t)__t2;
}
...
static void fiber_body() {
        {
            ...
            int64_t result_33 = __t4;
            (void)result_33;
            fiber_yield_fn(result_33);
        }
}
...
static int64_t __effect_handler_10(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_36 = __k;
    int64_t __t11 = tur_effect_cont_resume((int64_t)(intptr_t)k_36, (int64_t)INT64_C(99));
...
int main() {
        int64_t __t5;
        {
            void * f_34 = fiber_new_fn((void *)(intptr_t)(fiber_body), INT64_C(0));
            (void)f_34;
            int64_t __t6;
            {
                int64_t fval_35 = fiber_resume_fn((void *)(intptr_t)(f_34), INT64_C(0));
                (void)fval_35;
                printf("%lld\n", (long long)(fval_35));
                fiber_free_fn((void *)(intptr_t)(f_34));
                int64_t __t7;
                int64_t __t8;
                {
