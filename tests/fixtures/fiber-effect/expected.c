...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_219 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_219, (int64_t)INT64_C(10));
    return (int64_t)__t2;
}
...
static void fiber_body() {
        {
            ...
            int64_t result_220 = __t4;
            (void)result_220;
            fiber_yield_fn(result_220);
        }
}
...
static int64_t __effect_handler_10(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_223 = __k;
    int64_t __t11 = tur_effect_cont_resume((int64_t)(intptr_t)k_223, (int64_t)INT64_C(99));
    return (int64_t)__t11;
}

static void __handle_body_9(void);
static void __handle_body_9(void) {
    int64_t __t12 = tur_effect_perform("Ask", NULL, 0);
    tur_current_fiber->result = (int64_t)__t12;
}

static int64_t __dispatch_9(void *__ctx_void, int64_t __k_int, int64_t __resume_val);
static int64_t __dispatch_9(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    TurEffectCaptureCtx *__dcap = (TurEffectCaptureCtx *)__ctx_void;
    FiberBlock *__fiber = (FiberBlock *)(intptr_t)__k_int;
    int64_t __r = tur_fiber_block_resume(__fiber, __resume_val);
    ...
    if (!__dcap->has_pending_effect) return __r;
    if (strcmp(__dcap->eff_name, "Ask") == 0) {
        return __effect_handler_10(__dcap->eff_args, __dcap->eff_n_args, __k_int, NULL);
    } else {
        /* Phase 19D: bubble up unhandled effect to outer fiber */
        FiberBlock *__outer_f = tur_current_fiber;
        if (__outer_f && __outer_f->eff_ctx) {
            ...
            tur_fiber_block_yield(0);
            __outer_cap->has_pending_effect = false;
            return __dispatch_9(__ctx_void, __k_int, __outer_f->arg);
        }
        fprintf(stderr, "dispatch: unhandled effect: %s\n", __dcap->eff_name);
        abort();
    }
...
int main() {
        int64_t __t5;
        {
            void * f_221 = fiber_new_fn((void *)(intptr_t)(fiber_body), INT64_C(0));
            (void)f_221;
            int64_t __t6;
            {
                int64_t fval_222 = fiber_resume_fn((void *)(intptr_t)(f_221), INT64_C(0));
                (void)fval_222;
                printf("%lld\n", (long long)(fval_222));
                fiber_free_fn((void *)(intptr_t)(f_221));
                int64_t __t7;
                int64_t __t8;
                {
                    TurEffectCaptureCtx __cap_9;
                    __cap_9.has_pending_effect = false;
                    __cap_9.eff_name = NULL;
                    __cap_9.eff_n_args = 0;
                    __cap_9.dispatch = __dispatch_9;
                    __cap_9.body_env = NULL;
                    FiberBlock *__fiber_9 = tur_fiber_block_new(__handle_body_9, 0);
                    __fiber_9->eff_ctx = &__cap_9;
                    EffectHandlerFrame *__parent_chain_9 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
                    EffectHandlerFrame __eff_frame_9;
                    __eff_frame_9.parent = __parent_chain_9;
                    __eff_frame_9.n_cases = 1;
                    __eff_frame_9.cases[0].effect_name = "Ask";
                    __eff_frame_9.cases[0].handler_fn = NULL;
