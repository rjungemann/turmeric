...
static int64_t __effect_handler_0(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_32 = __k;
    if (((TurContK *)(intptr_t)k_32)->origin_fiber != (void *)tur_current_fiber) { fprintf(stderr, "continuation error: resume on wrong fiber\n"); abort(); }
    ((TurContK *)(intptr_t)k_32)->consumed = true;
...
static int64_t __effect_handler_8(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_36 = __k;
    if (((TurContK *)(intptr_t)k_36)->origin_fiber != (void *)tur_current_fiber) { fprintf(stderr, "continuation error: resume on wrong fiber\n"); abort(); }
    ((TurContK *)(intptr_t)k_36)->consumed = true;
