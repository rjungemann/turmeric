...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_272 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_272, (int64_t)INT64_C(10));
    return (int64_t)__t2;
}
...
static void fiber_body() {
        {
            ...
            int64_t result_273 = __t4;
            (void)result_273;
            fiber_yield_fn(result_273);
        }
}
...
static int64_t __effect_handler_10(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_276 = __k;
    int64_t __t11 = tur_effect_cont_resume((int64_t)(intptr_t)k_276, (int64_t)INT64_C(99));
...
int main() {
        int64_t __t5;
        {
            void * f_274 = fiber_new_fn((void *)(intptr_t)(fiber_body), INT64_C(0));
            (void)f_274;
            int64_t __t6;
            {
                int64_t fval_275 = fiber_resume_fn((void *)(intptr_t)(f_274), INT64_C(0));
                (void)fval_275;
                printf("%lld\n", (long long)(fval_275));
                fiber_free_fn((void *)(intptr_t)(f_274));
                int64_t __t7;
                int64_t __t8;
                {
