...
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_627 = __k;
    int64_t __t2 = tur_effect_cont_resume((int64_t)(intptr_t)k_627, (int64_t)INT64_C(10));
    return (int64_t)__t2;
}
...
static void fiber_body() {
        {
            ...
            int64_t result_628 = __t4;
            (void)result_628;
            fiber_yield_fn(result_628);
        }
}
...
static int64_t __effect_handler_10(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_631 = __k;
    int64_t __t11 = tur_effect_cont_resume((int64_t)(intptr_t)k_631, (int64_t)INT64_C(99));
...
int main() {
        int64_t __t5;
        {
            void * f_629 = fiber_new_fn((void *)(intptr_t)(fiber_body), INT64_C(0));
            (void)f_629;
            int64_t __t6;
            {
                int64_t fval_630 = fiber_resume_fn((void *)(intptr_t)(f_629), INT64_C(0));
                (void)fval_630;
                printf("%lld\n", (long long)(fval_630));
                fiber_free_fn((void *)(intptr_t)(f_629));
                int64_t __t7;
                int64_t __t8;
                {
