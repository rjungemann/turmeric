...
struct __defer_env_11 {RcControlBlock * r; };
...
typedef struct __HEnv_7 __HEnv_7;
struct __HEnv_7 {
    void * p;
};
...
static int64_t __effect_handler_8(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    __HEnv_7 *__henv_7 = (__HEnv_7 *)__env;
    int64_t k_264 = __k;
    return 0;
}
...
static void __handle_body_7(void) {
    ...
    __HEnv_7 *__henv_7 = (__HEnv_7 *)__cap->body_env;
    {
        const void * b_263 = &__henv_7->p;
        (void)b_263;
        printf("%lld\n", (long long)(INT64_C(2)));
    }
...
static int64_t __dispatch_7(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Unsafe") == 0) {
        return __effect_handler_8(__dcap->eff_args, __dcap->eff_n_args, __k_int, __dcap->body_env);
    } else {
...
static void __handle_body_5(void) {
    ...
    __HEnv_7 *__henv_7 = (__HEnv_7 *)malloc(sizeof(__HEnv_7));
    __henv_7->p = __henv_5->p;
    ...
    __henv_5->p = __henv_7->p;
    if (__fiber_7->done) { free(__fiber_7->stack); free(__fiber_7); }
    if (__fiber_7->done) { free(__henv_7); }
    tur_current_fiber->result = 0;
}

static int64_t __dispatch_5(void *__ctx_void, int64_t __k_int, int64_t __resume_val);
static int64_t __dispatch_5(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    TurEffectCaptureCtx *__dcap = (TurEffectCaptureCtx *)__ctx_void;
    FiberBlock *__fiber = (FiberBlock *)(intptr_t)__k_int;
    int64_t __r = tur_fiber_block_resume(__fiber, __resume_val);
    ...
    if (strcmp(__dcap->eff_name, "Unsafe") == 0) {
        ...
        if (__outer_f && __outer_f->eff_ctx) {
            ...
            tur_fiber_block_yield(0);
            __outer_cap->has_pending_effect = false;
            return __dispatch_5(__ctx_void, __k_int, __outer_f->arg);
        }
        fprintf(stderr, "dispatch: unhandled effect: %s\n", __dcap->eff_name);
        abort();
    }
...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(7);
            ...
            __t2->value = __t1;
            RcControlBlock * r_261 = __t2;
            (void)r_261;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            {
                void *__t4 = rc_get_value(r_261);
                void * p_262 = __t4;
                (void)p_262;
                ...
                __eff_frame_5.parent = __parent_chain_5;
                __eff_frame_5.n_cases = 1;
                __eff_frame_5.cases[0].effect_name = "Unsafe";
                __eff_frame_5.cases[0].handler_fn = NULL;
            ...
            struct __defer_env_11 __t13 = {.r = r_261};
