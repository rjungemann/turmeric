...
struct __defer_env_163 {int64_t my_x; };
...
struct __env_1331 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1329(void * __env_p_1332, int64_t x) {
        ...
        return (__env___env_1331->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t160 = malloc(sizeof(void *) + sizeof(struct __env_1331));
        *(void (**)(void *))__t160 = drop_glue___env_1331;
        struct __env_1331 *__t159 = (struct __env_1331 *)((char *)__t160 + sizeof(void *));
        __t159->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1329;
        __t159->base_val = base_val;
        void *__t161 = __t159;
        return __t161;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1334 = INT64_C(10);
            (void)my_hyx_1334;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            struct __defer_env_163 __t165 = {.my_x = my_hyx_1334};
            tur_frame_push_defer(&__frame_162, __defer_164, &__t165);
            my_hyx_1334 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_162);
        }
        int64_t __t166;
        {
            void * __ps_167 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1335_1336 = __ps_167;
            (void)_un_unoar1335_1336;
            int64_t __ps_168 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1335_1336))(_un_unoar1335_1336, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t166 = __ps_168;
            TUR_CLOSURE_DROP(_un_unoar1335_1336);
        }
        printf("%lld\n", (long long)(__t166));
        int64_t __t169;
        __t169 = INT64_C(0);
