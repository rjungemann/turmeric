...
struct __defer_env_271 {int64_t my_x; };
...
struct __env_1470 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1468(void * __env_p_1471, int64_t x) {
        struct __env_1470 *__env___env_1470 = (struct __env_1470 *)__env_p_1471;
        return (__env___env_1470->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t268 = malloc(sizeof(void *) + sizeof(struct __env_1470));
        *(void (**)(void *))__t268 = drop_glue___env_1470;
        struct __env_1470 *__t267 = (struct __env_1470 *)((char *)__t268 + sizeof(void *));
        __t267->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1468;
        __t267->base_val = base_val;
        TUR_REGION_NOTE_WORDS(&(__t267->base_val), sizeof(__t267->base_val));
        void *__t269 = __t267;
        return __t269;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1473 = INT64_C(10);
            (void)my_hyx_1473;
            tur_frame __frame_270;
            tur_frame_init(&__frame_270, NULL);
            struct __defer_env_271 __t273 = {.my_x = my_hyx_1473};
            tur_frame_push_defer(&__frame_270, __defer_272, &__t273);
            my_hyx_1473 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_270);
        }
        int64_t __t274;
        {
            void * __ps_275 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1474_1475 = __ps_275;
            (void)_un_unoar1474_1475;
            int64_t __ps_276 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1474_1475))(_un_unoar1474_1475, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t274 = __ps_276;
            TUR_CLOSURE_DROP(_un_unoar1474_1475);
        }
        printf("%lld\n", (long long)(__t274));
        int64_t __t277;
        __t277 = INT64_C(0);
