...
struct __defer_env_279 {int64_t my_x; };
...
struct __env_1611 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1609(void * __env_p_1612, int64_t x) {
        ...
        return (__env___env_1611->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t276 = malloc(sizeof(void *) + sizeof(struct __env_1611));
        *(void (**)(void *))__t276 = drop_glue___env_1611;
        struct __env_1611 *__t275 = (struct __env_1611 *)((char *)__t276 + sizeof(void *));
        __t275->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1609;
        __t275->base_val = base_val;
        TUR_REGION_NOTE_WORDS(&(__t275->base_val), sizeof(__t275->base_val));
        void *__t277 = __t275;
        return __t277;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1614 = INT64_C(10);
            (void)my_hyx_1614;
            tur_frame __frame_278;
            tur_frame_init(&__frame_278, NULL);
            struct __defer_env_279 __t281 = {.my_x = my_hyx_1614};
            tur_frame_push_defer(&__frame_278, __defer_280, &__t281);
            my_hyx_1614 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_278);
        }
        int64_t __t282;
        {
            void * __ps_283 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1615_1616 = __ps_283;
            (void)_un_unoar1615_1616;
            int64_t __ps_284 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1615_1616))(_un_unoar1615_1616, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t282 = __ps_284;
            TUR_CLOSURE_DROP(_un_unoar1615_1616);
        }
        printf("%lld\n", (long long)(__t282));
        int64_t __t285;
        __t285 = INT64_C(0);
