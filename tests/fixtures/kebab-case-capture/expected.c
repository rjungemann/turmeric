...
static int64_t __fn_871(void *, int64_t);
...
struct __env_873 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
static int64_t __fn_871(void * __env_p_874, int64_t x) {
        struct __env_873 *__env___env_873 = (struct __env_873 *)__env_p_874;
        return (__env___env_873->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        struct __env_873 *__t25 = (struct __env_873 *)malloc(sizeof(struct __env_873));
        __t25->__fn = (tur_thunk_int64_t_int64_t_t)__fn_871;
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_hyx_876 = INT64_C(10);
            (void)my_hyx_876;
            tur_frame __frame_27;
            tur_frame_init(&__frame_27, NULL);
            struct __defer_env_28 __t30 = {.my_x = my_hyx_876};
            tur_frame_push_defer(&__frame_27, __defer_29, &__t30);
            my_hyx_876 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_27);
        }
        int64_t __t31;
        {
            void * _un_unoar877_878 = make_hyadder(INT64_C(100));
            (void)_un_unoar877_878;
            __t31 = (*( tur_thunk_int64_t_int64_t_t *)(_un_unoar877_878))(_un_unoar877_878, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t31));
        int64_t __t32;
        __t32 = INT64_C(0);
