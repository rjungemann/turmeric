...
static void * make_hyadder(int64_t base_val) {
        struct __env_1248 *__t50 = (struct __env_1248 *)malloc(sizeof(struct __env_1248));
        __t50->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1246;
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_hyx_1251 = INT64_C(10);
            (void)my_hyx_1251;
            tur_frame __frame_52;
            tur_frame_init(&__frame_52, NULL);
            struct __defer_env_53 __t55 = {.my_x = my_hyx_1251};
            tur_frame_push_defer(&__frame_52, __defer_54, &__t55);
            my_hyx_1251 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_52);
        }
        int64_t __t56;
        {
            void * _un_unoar1252_1253 = make_hyadder(INT64_C(100));
            (void)_un_unoar1252_1253;
            __t56 = (*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1252_1253))(_un_unoar1252_1253, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t56));
        int64_t __t57;
        __t57 = INT64_C(0);
