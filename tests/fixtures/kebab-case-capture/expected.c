...
struct __defer_env_268 {int64_t my_x; };
...
struct __env_1472 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1470(void * __env_p_1473, int64_t x) {
        struct __env_1472 *__env___env_1472 = (struct __env_1472 *)__env_p_1473;
        return (__env___env_1472->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t265 = malloc(sizeof(void *) + sizeof(struct __env_1472));
        *(void (**)(void *))__t265 = drop_glue___env_1472;
        struct __env_1472 *__t264 = (struct __env_1472 *)((char *)__t265 + sizeof(void *));
        __t264->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1470;
        __t264->base_val = base_val;
        TUR_REGION_NOTE_WORDS(&(__t264->base_val), sizeof(__t264->base_val));
        void *__t266 = __t264;
        return __t266;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1475 = INT64_C(10);
            (void)my_hyx_1475;
            tur_frame __frame_267;
            tur_frame_init(&__frame_267, NULL);
            struct __defer_env_268 __t270 = {.my_x = my_hyx_1475};
            tur_frame_push_defer(&__frame_267, __defer_269, &__t270);
            my_hyx_1475 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_267);
        }
        int64_t __t271;
        {
            void * __ps_272 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1476_1477 = __ps_272;
            (void)_un_unoar1476_1477;
            int64_t __ps_273 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1476_1477))(_un_unoar1476_1477, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t271 = __ps_273;
            TUR_CLOSURE_DROP(_un_unoar1476_1477);
        }
        printf("%lld\n", (long long)(__t271));
        int64_t __t274;
        __t274 = INT64_C(0);
