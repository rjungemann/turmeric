...
struct __defer_env_187 {int64_t my_x; };
...
struct __env_1441 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1439(void * __env_p_1442, int64_t x) {
        ...
        return (__env___env_1441->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t184 = malloc(sizeof(void *) + sizeof(struct __env_1441));
        *(void (**)(void *))__t184 = drop_glue___env_1441;
        struct __env_1441 *__t183 = (struct __env_1441 *)((char *)__t184 + sizeof(void *));
        __t183->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1439;
        __t183->base_val = base_val;
        TUR_REGION_NOTE_WORDS(&(__t183->base_val), sizeof(__t183->base_val));
        void *__t185 = __t183;
        return __t185;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1444 = INT64_C(10);
            (void)my_hyx_1444;
            tur_frame __frame_186;
            tur_frame_init(&__frame_186, NULL);
            struct __defer_env_187 __t189 = {.my_x = my_hyx_1444};
            tur_frame_push_defer(&__frame_186, __defer_188, &__t189);
            my_hyx_1444 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_186);
        }
        int64_t __t190;
        {
            void * __ps_191 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1445_1446 = __ps_191;
            (void)_un_unoar1445_1446;
            int64_t __ps_192 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1445_1446))(_un_unoar1445_1446, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t190 = __ps_192;
            TUR_CLOSURE_DROP(_un_unoar1445_1446);
        }
        printf("%lld\n", (long long)(__t190));
        int64_t __t193;
        __t193 = INT64_C(0);
