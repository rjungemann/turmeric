...
struct __defer_env_49 {int64_t my_x; };
...
struct __env_1010 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
static int64_t __fn_1008(void * __env_p_1011, int64_t x) {
        struct __env_1010 *__env___env_1010 = (struct __env_1010 *)__env_p_1011;
        return (__env___env_1010->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        struct __env_1010 *__t46 = (struct __env_1010 *)malloc(sizeof(struct __env_1010));
        __t46->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1008;
        __t46->base_val = base_val;
        void *__t47 = __t46;
        return __t47;
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_hyx_1013 = INT64_C(10);
            (void)my_hyx_1013;
            tur_frame __frame_48;
            tur_frame_init(&__frame_48, NULL);
            struct __defer_env_49 __t51 = {.my_x = my_hyx_1013};
            tur_frame_push_defer(&__frame_48, __defer_50, &__t51);
            my_hyx_1013 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_48);
        }
        int64_t __t52;
        {
            void * _un_unoar1014_1015 = make_hyadder(INT64_C(100));
            (void)_un_unoar1014_1015;
            __t52 = (*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1014_1015))(_un_unoar1014_1015, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t52));
        int64_t __t53;
        __t53 = INT64_C(0);
