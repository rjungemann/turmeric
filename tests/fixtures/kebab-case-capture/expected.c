...
static int64_t __fn_1249(void *, int64_t);
...
struct __env_1251 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
static int64_t __fn_1249(void * __env_p_1252, int64_t x) {
        struct __env_1251 *__env___env_1251 = (struct __env_1251 *)__env_p_1252;
        return (__env___env_1251->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        struct __env_1251 *__t55 = (struct __env_1251 *)malloc(sizeof(struct __env_1251));
        __t55->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1249;
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_hyx_1254 = INT64_C(10);
            (void)my_hyx_1254;
            tur_frame __frame_57;
            tur_frame_init(&__frame_57, NULL);
            struct __defer_env_58 __t60 = {.my_x = my_hyx_1254};
            tur_frame_push_defer(&__frame_57, __defer_59, &__t60);
            my_hyx_1254 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_57);
        }
        int64_t __t61;
        {
            void * _un_unoar1255_1256 = make_hyadder(INT64_C(100));
            (void)_un_unoar1255_1256;
            __t61 = (*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1255_1256))(_un_unoar1255_1256, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t61));
        int64_t __t62;
        __t62 = INT64_C(0);
