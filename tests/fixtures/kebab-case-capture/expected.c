...
static int64_t __fn_1284(void *, int64_t);
...
struct __defer_env_159 {int64_t my_x; };
...
struct __env_1286 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1284(void * __env_p_1287, int64_t x) {
        struct __env_1286 *__env___env_1286 = (struct __env_1286 *)__env_p_1287;
        return (__env___env_1286->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t156 = malloc(sizeof(void *) + sizeof(struct __env_1286));
        *(void (**)(void *))__t156 = drop_glue___env_1286;
        struct __env_1286 *__t155 = (struct __env_1286 *)((char *)__t156 + sizeof(void *));
        __t155->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1284;
        __t155->base_val = base_val;
        void *__t157 = __t155;
        return __t157;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1289 = INT64_C(10);
            (void)my_hyx_1289;
            tur_frame __frame_158;
            tur_frame_init(&__frame_158, NULL);
            struct __defer_env_159 __t161 = {.my_x = my_hyx_1289};
            tur_frame_push_defer(&__frame_158, __defer_160, &__t161);
            my_hyx_1289 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_158);
        }
        int64_t __t162;
        {
            __auto_type __ps_163 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1290_1291 = __ps_163;
            (void)_un_unoar1290_1291;
            __auto_type __ps_164 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1290_1291))(_un_unoar1290_1291, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t162 = __ps_164;
            TUR_CLOSURE_DROP(_un_unoar1290_1291);
        }
        printf("%lld\n", (long long)(__t162));
        int64_t __t165;
        __t165 = INT64_C(0);
