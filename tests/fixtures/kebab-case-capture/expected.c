...
struct __env_882 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
static int64_t __fn_880(void * __env_p_883, int64_t x) {
        struct __env_882 *__env___env_882 = (struct __env_882 *)__env_p_883;
        return (__env___env_882->base_val) + (x);
}
...
static void * make_adder(int64_t base_val) {
        ...
        __t25->__fn = (tur_thunk_int64_t_int64_t_t)__fn_880;
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_x_885 = INT64_C(10);
            (void)my_x_885;
            tur_frame __frame_27;
            tur_frame_init(&__frame_27, NULL);
            struct __defer_env_28 __t30 = {.my_x = my_x_885};
        ...
        int64_t __t31;
        {
            void * __oar886_887 = make_adder(INT64_C(100));
            (void)__oar886_887;
            __t31 = (*( tur_thunk_int64_t_int64_t_t *)(__oar886_887))(__oar886_887, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t31));
        int64_t __t32;
        __t32 = INT64_C(0);
