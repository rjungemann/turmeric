...
static void * make_hyadder(int64_t base_val) {
        struct __env_1274 *__t181 = (struct __env_1274 *)malloc(sizeof(struct __env_1274));
        __t181->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1272;
...
int main(int argc, char **argv) {
        ...
        int64_t __t187;
        {
            ...
            void * _un_unoar1278_1279 = __ps_188;
            (void)_un_unoar1278_1279;
            __auto_type __ps_189 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1278_1279))(_un_unoar1278_1279, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t187 = __ps_189;
        }
        printf("%lld\n", (long long)(__t187));
