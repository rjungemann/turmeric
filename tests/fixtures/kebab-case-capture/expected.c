...
struct __defer_env_236 {int64_t my_x; };
...
struct __env_1468 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1466(void * __env_p_1469, int64_t x) {
        ...
        return (__env___env_1468->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t233 = malloc(sizeof(void *) + sizeof(struct __env_1468));
        *(void (**)(void *))__t233 = drop_glue___env_1468;
        struct __env_1468 *__t232 = (struct __env_1468 *)((char *)__t233 + sizeof(void *));
        __t232->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1466;
        __t232->base_val = base_val;
        TUR_REGION_NOTE_WORDS(&(__t232->base_val), sizeof(__t232->base_val));
        void *__t234 = __t232;
        return __t234;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1471 = INT64_C(10);
            (void)my_hyx_1471;
            tur_frame __frame_235;
            tur_frame_init(&__frame_235, NULL);
            struct __defer_env_236 __t238 = {.my_x = my_hyx_1471};
            tur_frame_push_defer(&__frame_235, __defer_237, &__t238);
            my_hyx_1471 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_235);
        }
        int64_t __t239;
        {
            void * __ps_240 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1472_1473 = __ps_240;
            (void)_un_unoar1472_1473;
            int64_t __ps_241 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1472_1473))(_un_unoar1472_1473, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t239 = __ps_241;
            TUR_CLOSURE_DROP(_un_unoar1472_1473);
        }
        printf("%lld\n", (long long)(__t239));
        int64_t __t242;
        __t242 = INT64_C(0);
