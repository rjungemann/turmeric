...
struct __defer_env_55 {int64_t my_x; };
...
static void * make_hyadder(int64_t base_val) {
        struct __env_1012 *__t52 = (struct __env_1012 *)malloc(sizeof(struct __env_1012));
        __t52->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1010;
        __t52->base_val = base_val;
        void *__t53 = __t52;
        return __t53;
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_hyx_1015 = INT64_C(10);
            (void)my_hyx_1015;
            tur_frame __frame_54;
            tur_frame_init(&__frame_54, NULL);
            struct __defer_env_55 __t57 = {.my_x = my_hyx_1015};
            tur_frame_push_defer(&__frame_54, __defer_56, &__t57);
            my_hyx_1015 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_54);
        }
        int64_t __t58;
        {
            void * _un_unoar1016_1017 = make_hyadder(INT64_C(100));
            (void)_un_unoar1016_1017;
            __t58 = (*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1016_1017))(_un_unoar1016_1017, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t58));
        int64_t __t59;
        __t59 = INT64_C(0);
