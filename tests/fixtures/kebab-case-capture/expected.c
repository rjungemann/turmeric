...
struct __env_814 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
static int64_t __fn_812(void * __env_p_815, int64_t x) {
        struct __env_814 *__env___env_814 = (struct __env_814 *)__env_p_815;
        return (__env___env_814->base_val) + (x);
}
...
static void * make_adder(int64_t base_val) {
        struct __env_814 *__t3 = (struct __env_814 *)malloc(sizeof(struct __env_814));
        __t3->__fn = (tur_thunk_int64_t_int64_t_t)__fn_812;
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_x_817 = INT64_C(10);
            (void)my_x_817;
            tur_frame __frame_5;
            tur_frame_init(&__frame_5, NULL);
            struct __defer_env_6 __t8 = {.my_x = my_x_817};
        ...
        int64_t __t9;
        {
            void * __oar818_819 = make_adder(INT64_C(100));
            (void)__oar818_819;
            __t9 = (*( tur_thunk_int64_t_int64_t_t *)(__oar818_819))(__oar818_819, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t9));
        int64_t __t10;
        __t10 = INT64_C(0);
