...
struct __defer_env_167 {int64_t my_x; };
...
struct __env_1367 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1365(void * __env_p_1368, int64_t x) {
        ...
        return (__env___env_1367->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t164 = malloc(sizeof(void *) + sizeof(struct __env_1367));
        *(void (**)(void *))__t164 = drop_glue___env_1367;
        struct __env_1367 *__t163 = (struct __env_1367 *)((char *)__t164 + sizeof(void *));
        __t163->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1365;
        __t163->base_val = base_val;
        void *__t165 = __t163;
        return __t165;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1370 = INT64_C(10);
            (void)my_hyx_1370;
            tur_frame __frame_166;
            tur_frame_init(&__frame_166, NULL);
            struct __defer_env_167 __t169 = {.my_x = my_hyx_1370};
            tur_frame_push_defer(&__frame_166, __defer_168, &__t169);
            my_hyx_1370 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_166);
        }
        int64_t __t170;
        {
            void * __ps_171 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1371_1372 = __ps_171;
            (void)_un_unoar1371_1372;
            int64_t __ps_172 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1371_1372))(_un_unoar1371_1372, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t170 = __ps_172;
            TUR_CLOSURE_DROP(_un_unoar1371_1372);
        }
        printf("%lld\n", (long long)(__t170));
        int64_t __t173;
        __t173 = INT64_C(0);
