...
struct __defer_env_183 {int64_t my_x; };
...
struct __env_1439 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1437(void * __env_p_1440, int64_t x) {
        struct __env_1439 *__env___env_1439 = (struct __env_1439 *)__env_p_1440;
        return (__env___env_1439->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t180 = malloc(sizeof(void *) + sizeof(struct __env_1439));
        *(void (**)(void *))__t180 = drop_glue___env_1439;
        struct __env_1439 *__t179 = (struct __env_1439 *)((char *)__t180 + sizeof(void *));
        __t179->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1437;
        __t179->base_val = base_val;
        void *__t181 = __t179;
        return __t181;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t my_hyx_1442 = INT64_C(10);
            (void)my_hyx_1442;
            tur_frame __frame_182;
            tur_frame_init(&__frame_182, NULL);
            struct __defer_env_183 __t185 = {.my_x = my_hyx_1442};
            tur_frame_push_defer(&__frame_182, __defer_184, &__t185);
            my_hyx_1442 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_182);
        }
        int64_t __t186;
        {
            void * __ps_187 = (make_hyadder(INT64_C(100)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1443_1444 = __ps_187;
            (void)_un_unoar1443_1444;
            int64_t __ps_188 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1443_1444))(_un_unoar1443_1444, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t186 = __ps_188;
            TUR_CLOSURE_DROP(_un_unoar1443_1444);
        }
        printf("%lld\n", (long long)(__t186));
        int64_t __t189;
        __t189 = INT64_C(0);
