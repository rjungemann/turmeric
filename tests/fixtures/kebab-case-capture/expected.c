...
struct __defer_env_47 {int64_t my_x; };
...
static void * make_hyadder(int64_t base_val) {
        struct __env_1027 *__t44 = (struct __env_1027 *)malloc(sizeof(struct __env_1027));
        __t44->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1025;
        __t44->base_val = base_val;
        void *__t45 = __t44;
        return __t45;
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_hyx_1030 = INT64_C(10);
            (void)my_hyx_1030;
            tur_frame __frame_46;
            tur_frame_init(&__frame_46, NULL);
            struct __defer_env_47 __t49 = {.my_x = my_hyx_1030};
            tur_frame_push_defer(&__frame_46, __defer_48, &__t49);
            my_hyx_1030 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_46);
        }
        int64_t __t50;
        {
            void * _un_unoar1031_1032 = make_hyadder(INT64_C(100));
            (void)_un_unoar1031_1032;
            __t50 = (*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1031_1032))(_un_unoar1031_1032, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t50));
        int64_t __t51;
        __t51 = INT64_C(0);
