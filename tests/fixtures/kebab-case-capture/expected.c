...
struct __env_1626 { tur_thunk_int64_t_int64_t_t __fn; int64_t base_val; };
...
static int64_t __fn_1624(void * __env_p_1627, int64_t x) {
        struct __env_1626 *__env___env_1626 = (struct __env_1626 *)__env_p_1627;
        return (__env___env_1626->base_val) + (x);
}
...
static void * make_hyadder(int64_t base_val) {
        void *__t173 = malloc(sizeof(void *) + sizeof(struct __env_1626));
        *(void (**)(void *))__t173 = drop_glue___env_1626;
        struct __env_1626 *__t172 = (struct __env_1626 *)((char *)__t173 + sizeof(void *));
        __t172->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1624;
        __t172->base_val = base_val;
        TUR_REGION_NOTE_WORDS(&(__t172->base_val), sizeof(__t172->base_val));
        void *__t174 = __t172;
        return __t174;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t179;
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * _un_unoar1630_1631 = __ps_180;
            (void)_un_unoar1630_1631;
            int64_t __ps_181 = ((*( tur_thunk_int64_t_int64_t_t *)(_un_unoar1630_1631))(_un_unoar1630_1631, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t179 = __ps_181;
            TUR_CLOSURE_DROP(_un_unoar1630_1631);
        }
        printf("%lld\n", (long long)(__t179));
        int64_t __t182;
        __t182 = INT64_C(0);
