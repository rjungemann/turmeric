...
struct __defer_env_24 {int64_t my_x; };
...
static void * make_hyadder(int64_t base_val) {
        struct __env_885 *__t21 = (struct __env_885 *)malloc(sizeof(struct __env_885));
        __t21->__fn = (tur_thunk_int64_t_int64_t_t)__fn_883;
        __t21->base_val = base_val;
        void *__t22 = __t21;
        return __t22;
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t my_hyx_888 = INT64_C(10);
            (void)my_hyx_888;
            tur_frame __frame_23;
            tur_frame_init(&__frame_23, NULL);
            struct __defer_env_24 __t26 = {.my_x = my_hyx_888};
            tur_frame_push_defer(&__frame_23, __defer_25, &__t26);
            my_hyx_888 = INT64_C(20);
            tur_frame_fire_lifo(&__frame_23);
        }
        int64_t __t27;
        {
            void * _un_unoar889_890 = make_hyadder(INT64_C(100));
            (void)_un_unoar889_890;
            __t27 = (*( tur_thunk_int64_t_int64_t_t *)(_un_unoar889_890))(_un_unoar889_890, INT64_C(5));
        }
        printf("%lld\n", (long long)(__t27));
        int64_t __t28;
        __t28 = INT64_C(0);
