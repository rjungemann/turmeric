...
static double __fn_883(double x) {
        return dbl_impl(x);
}
...
static double dbl_impl(double x) {
        return (x) * (2.0);
}
...
int main(int argc, char **argv) {
        ...
        int64_t *__t25 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t25[0] = (int64_t)(intptr_t)__tur_fatshim_double_double;
        __t25[1] = (int64_t)(intptr_t)__fn_883;
        void *__t26 = __t25;
        printf("%g\n", (double)(call_fat((void *)(intptr_t)(__t26), 3.5)));
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
}
