...
static double dbl_hyimpl(double);
static double call_hyfat(int64_t, double);
...
static double dbl_hyimpl(double x) {
        return (x) * (2.0);
}

static double call_hyfat(int64_t g, double x) {
...
int main(int argc, char **argv) {
        ...
        void *__t26 = __t25;
        printf("%g\n", (double)(call_hyfat((int64_t)(intptr_t)(__t26), 3.5)));
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
}
