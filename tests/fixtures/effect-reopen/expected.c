...
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t k_25 = __k;
    int64_t __t7[1];
    __t7[0] = (int64_t)msg_24;
    tur_effect_perform("Write", __t7, 1);
    int64_t __t8;
    if (((TurContK *)(intptr_t)k_25)->origin_fiber != (void *)tur_current_fiber) { fprintf(stderr, "continuation error: resume on wrong fiber\n"); abort(); }
    ((TurContK *)(intptr_t)k_25)->consumed = true;
    __t8 = INT64_C(0);
    return (int64_t)__t8;
}
...
int main() {
        ...
        *__eff_chain_3 = &__eff_frame_3;
        ...
        __eff_frame_9.cases[0].handler_fn = __effect_handler_5;
        __eff_frame_9.cases[0].env = NULL;
        __eff_frame_9.cases[1].effect_name = "Counter";
        __eff_frame_9.cases[1].handler_fn = __effect_handler_6;
        __eff_frame_9.cases[1].env = NULL;
        *__eff_chain_9 = &__eff_frame_9;
        int64_t __t11[1];
        __t11[0] = (int64_t)"start";
        tur_effect_perform("Log", __t11, 1);
        int64_t __t12;
        int64_t __t13;
        {
            ...
            (void)result_23;
            int64_t __t14[1];
            __t14[0] = (int64_t)"done";
            tur_effect_perform("Log", __t14, 1);
            printf("%lld\n", (long long)(result_23));
            int64_t __t15;
            __t15 = INT64_C(0);
            __t13 = __t15;
