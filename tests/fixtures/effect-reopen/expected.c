...
static int64_t counted_sum(int64_t);
...
static int64_t counted_sum(int64_t n) {
        int64_t __t0 = tur_effect_perform("Counter", NULL, 0);
        return ((__t0) + (n));
}
...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    puts(msg_267);
    int64_t __t3;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_268, (int64_t)INT64_C(0));
    __t3 = __t4;
    return (int64_t)__t3;
}
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t k_265 = __k;
    int64_t __t8[1];
    __t8[0] = (int64_t)msg_264;
    tur_effect_perform("Write", __t8, 1);
    int64_t __t9;
    int64_t __t10 = tur_effect_cont_resume((int64_t)(intptr_t)k_265, (int64_t)INT64_C(0));
    __t9 = __t10;
    return (int64_t)__t9;
}
...
static int64_t __effect_handler_7(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_266 = __k;
    int64_t __t11 = tur_effect_cont_resume((int64_t)(intptr_t)k_266, (int64_t)INT64_C(42));
...
static void __handle_body_5(void) {
    int64_t __t12[1];
    __t12[0] = (int64_t)"start";
    tur_effect_perform("Log", __t12, 1);
    int64_t __t13;
    int64_t __t14;
    {
        int64_t result_263 = counted_sum(INT64_C(100));
        (void)result_263;
        int64_t __t15[1];
        __t15[0] = (int64_t)"done";
        tur_effect_perform("Log", __t15, 1);
        printf("%lld\n", (long long)(result_263));
        int64_t __t16;
        __t16 = INT64_C(0);
        __t14 = __t16;
    }
    __t13 = __t14;
    tur_current_fiber->result = (int64_t)__t13;
}
...
static int64_t __dispatch_5(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    } else if (strcmp(__dcap->eff_name, "Counter") == 0) {
...
static void __handle_body_1(void) {
    ...
    __eff_frame_5.n_cases = 2;
    __eff_frame_5.cases[0].effect_name = "Log";
    __eff_frame_5.cases[0].handler_fn = NULL;
    __eff_frame_5.cases[0].env = NULL;
    __eff_frame_5.cases[1].effect_name = "Counter";
    __eff_frame_5.cases[1].handler_fn = NULL;
    __eff_frame_5.cases[1].env = NULL;
    __fiber_5->effect_handler_chain = &__eff_frame_5;
    int64_t __t17 = (int64_t)__dispatch_5(&__cap_5, (int64_t)(intptr_t)__fiber_5, 0);
    if (__fiber_5->done) { free(__fiber_5->stack); free(__fiber_5); }
    tur_current_fiber->result = (int64_t)__t17;
}
...
int main() {
        ...
        int64_t __t18 = (int64_t)__dispatch_1(&__cap_1, (int64_t)(intptr_t)__fiber_1, 0);
