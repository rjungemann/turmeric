...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    puts(msg_622);
    int64_t __t3;
    int64_t __t4 = tur_effect_cont_resume((int64_t)(intptr_t)k_623, (int64_t)INT64_C(0));
    __t3 = __t4;
    return (int64_t)__t3;
}
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    int64_t k_620 = __k;
    int64_t __t8[1];
    __t8[0] = (int64_t)msg_619;
    tur_effect_perform("Write", __t8, 1);
    int64_t __t9;
    int64_t __t10 = tur_effect_cont_resume((int64_t)(intptr_t)k_620, (int64_t)INT64_C(0));
    __t9 = __t10;
    return (int64_t)__t9;
}
...
static int64_t __effect_handler_7(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_621 = __k;
    int64_t __t11 = tur_effect_cont_resume((int64_t)(intptr_t)k_621, (int64_t)INT64_C(42));
...
static void __handle_body_5(void) {
    ...
    int64_t __t14;
    {
        int64_t result_618 = counted_sum(INT64_C(100));
        (void)result_618;
        int64_t __t15[1];
        __t15[0] = (int64_t)"done";
        tur_effect_perform("Log", __t15, 1);
        printf("%lld\n", (long long)(result_618));
        int64_t __t16;
        __t16 = INT64_C(0);
        __t14 = __t16;
    }
