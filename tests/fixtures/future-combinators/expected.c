...
static bool __fn_449(int64_t, int64_t);
...
static int64_t future_get_ok(void *);
static bool future_is_ok(void *);
static void * future_map(void *, void *);
static void * future_then(void *, void *);
static void * future_all2(void *, void *);
static void * future_any2(void *, void *);
static void future_cancel(void *);
static bool future_cancelled_(void *);
...
static bool __fn_449(int64_t a, int64_t b) {
        return ((a) == (b));
}

static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_449));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_469));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_496));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_516), (int64_t)(intptr_t)(__fn_520));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_536), (int64_t)(intptr_t)(__fn_540));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_556));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_627));
}
...
static void * future_error_of(int64_t e) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
  FutureCell *cell = (FutureCell *)malloc(sizeof(FutureCell));
  if (!cell) abort();
  pthread_mutex_init(&cell->lock, NULL);
...
static void future_free(void * f) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
...
static int64_t future_get_ok(void * f) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
  FutureCell *fc = (FutureCell *)f;
...
static bool future_is_ok(void * f) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
  FutureCell *fc = (FutureCell *)f;
  pthread_mutex_lock(&fc->lock);
  while (!fc->is_set) pthread_cond_wait(&fc->ready, &fc->lock);
...
static void * future_map(void * f, void * fn) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
  FutureCell *fc = (FutureCell *)f;
  pthread_mutex_lock(&fc->lock);
  while (!fc->is_set) pthread_cond_wait(&fc->ready, &fc->lock);
...
static void * future_then(void * f, void * fn) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
  FutureCell *fc = (FutureCell *)f;
  pthread_mutex_lock(&fc->lock);
  while (!fc->is_set) pthread_cond_wait(&fc->ready, &fc->lock);
...
static void * future_all2(void * fa, void * fb) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
...
static void * future_any2(void * fa, void * fb) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
  FutureCell *a = (FutureCell *)fa; FutureCell *b = (FutureCell *)fb;
  pthread_mutex_lock(&a->lock); while (!a->is_set) pthread_cond_wait(&a->ready, &a->lock);
...
static void future_cancel(void * f) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
  FutureCell *fc = (FutureCell *)f;
  pthread_mutex_lock(&fc->lock);
...
static bool future_cancelled_(void * f) {
        typedef struct { pthread_mutex_t lock; pthread_cond_t ready; int64_t value; int64_t exn; bool is_set; bool is_ok; } FutureCell;
  FutureCell *fc = (FutureCell *)f;
  pthread_mutex_lock(&fc->lock);
...
static int64_t double_fn(int64_t x) {
        return ((x) * (INT64_C(2)));
}

static void * times10_fn(int64_t x) {
        return future_of(((x) * (INT64_C(10))));
}
...
int main() {
        {
            void * f1_647 = future_of(INT64_C(42));
            (void)f1_647;
            printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(f1_647))));
            future_free((void *)(intptr_t)(f1_647));
        }
        {
            void * f2_648 = future_error_of(INT64_C(-1));
            (void)f2_648;
            printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(f2_648))));
            future_free((void *)(intptr_t)(f2_648));
        }
        {
            void * f3_649 = future_of(INT64_C(10));
            (void)f3_649;
            {
                void * f3m_650 = future_map((void *)(intptr_t)(f3_649), (void *)(intptr_t)(double_fn));
                (void)f3m_650;
                printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(f3m_650))));
                future_free((void *)(intptr_t)(f3_649));
                future_free((void *)(intptr_t)(f3m_650));
            }
        }
        {
            void * f4_651 = future_error_of(INT64_C(-5));
            (void)f4_651;
            {
                void * f4m_652 = future_map((void *)(intptr_t)(f4_651), (void *)(intptr_t)(double_fn));
                (void)f4m_652;
                printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(f4m_652))));
                future_free((void *)(intptr_t)(f4_651));
                future_free((void *)(intptr_t)(f4m_652));
            }
        }
        {
            void * f5_653 = future_of(INT64_C(7));
            (void)f5_653;
            {
                void * f5t_654 = future_then((void *)(intptr_t)(f5_653), (void *)(intptr_t)(times10_fn));
                (void)f5t_654;
                printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(f5t_654))));
                future_free((void *)(intptr_t)(f5_653));
                future_free((void *)(intptr_t)(f5t_654));
            }
        }
        {
            void * f6_655 = future_error_of(INT64_C(-3));
            (void)f6_655;
            {
                void * f6t_656 = future_then((void *)(intptr_t)(f6_655), (void *)(intptr_t)(times10_fn));
                (void)f6t_656;
                printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(f6t_656))));
                future_free((void *)(intptr_t)(f6_655));
                future_free((void *)(intptr_t)(f6t_656));
            }
        }
        {
            void * fa_657 = future_of(INT64_C(100));
            (void)fa_657;
            {
                void * fb_658 = future_of(INT64_C(200));
                (void)fb_658;
                {
                    void * fall_659 = future_all2((void *)(intptr_t)(fa_657), (void *)(intptr_t)(fb_658));
                    (void)fall_659;
                    printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(fall_659))));
                    future_free((void *)(intptr_t)(fa_657));
                    future_free((void *)(intptr_t)(fb_658));
                    future_free((void *)(intptr_t)(fall_659));
                }
            }
        }
        {
            void * fa2_660 = future_of(INT64_C(100));
            (void)fa2_660;
            {
                void * fb2_661 = future_error_of(INT64_C(-7));
                (void)fb2_661;
                {
                    void * fall2_662 = future_all2((void *)(intptr_t)(fa2_660), (void *)(intptr_t)(fb2_661));
                    (void)fall2_662;
                    printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(fall2_662))));
                    future_free((void *)(intptr_t)(fa2_660));
                    future_free((void *)(intptr_t)(fb2_661));
                    future_free((void *)(intptr_t)(fall2_662));
                }
            }
        }
        {
            void * fa3_663 = future_of(INT64_C(55));
            (void)fa3_663;
            {
                void * fb3_664 = future_error_of(INT64_C(-8));
                (void)fb3_664;
                {
                    void * fany_665 = future_any2((void *)(intptr_t)(fa3_663), (void *)(intptr_t)(fb3_664));
                    (void)fany_665;
                    printf("%lld\n", (long long)(future_get_ok((void *)(intptr_t)(fany_665))));
                    future_free((void *)(intptr_t)(fa3_663));
                    future_free((void *)(intptr_t)(fb3_664));
                    future_free((void *)(intptr_t)(fany_665));
                }
            }
        }
        {
            void * fc_666 = make_unsettled();
            (void)fc_666;
            future_cancel((void *)(intptr_t)(fc_666));
            if (future_cancelled_((void *)(intptr_t)(fc_666))) {
                puts("cancelled");
            } else {
                puts("FAIL");
            }
            future_free((void *)(intptr_t)(fc_666));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
