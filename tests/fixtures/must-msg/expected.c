...
static int64_t u_option_expect(void *, const char *);
...
static int64_t u_option_expect(void * o, const char * msg) {
...
int main() {
        printf("%lld\n", (long long)(u_option_expect((void *)(intptr_t)(u_some(INT64_C(55))), "expect: failed")));
        printf("%lld\n", (long long)(u_result_must_msg((void *)(intptr_t)(u_ok(INT64_C(77))), "u-result-must-msg: failed")));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
