...
static bool rwlock_try_rdlock(void *);
...
int main() {
        {
            void * rw_221 = rwlock_new();
            (void)rw_221;
            rwlock_wrlock((void *)(intptr_t)(rw_221));
            printf("%lld\n", (long long)(INT64_C(1)));
            rwlock_unlock((void *)(intptr_t)(rw_221));
            rwlock_rdlock((void *)(intptr_t)(rw_221));
            printf("%lld\n", (long long)(INT64_C(2)));
            rwlock_unlock((void *)(intptr_t)(rw_221));
            {
                bool got_r_222 = rwlock_try_rdlock((void *)(intptr_t)(rw_221));
                (void)got_r_222;
                puts((got_r_222) ? "true" : "false");
                {
                    bool got_w_223 = rwlock_try_wrlock((void *)(intptr_t)(rw_221));
                    (void)got_w_223;
                    puts((got_w_223) ? "true" : "false");
                }
                rwlock_unlock((void *)(intptr_t)(rw_221));
            }
            rwlock_free((void *)(intptr_t)(rw_221));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
