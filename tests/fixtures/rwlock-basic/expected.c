...
int main() {
        {
            void * rw_209 = rwlock_new();
            (void)rw_209;
            rwlock_wrlock((void *)(intptr_t)(rw_209));
            printf("%lld\n", (long long)(INT64_C(1)));
            rwlock_unlock((void *)(intptr_t)(rw_209));
            rwlock_rdlock((void *)(intptr_t)(rw_209));
            printf("%lld\n", (long long)(INT64_C(2)));
            rwlock_unlock((void *)(intptr_t)(rw_209));
            {
                bool got_r_210 = rwlock_try_rdlock((void *)(intptr_t)(rw_209));
                (void)got_r_210;
                puts((got_r_210) ? "true" : "false");
                {
                    bool got_w_211 = rwlock_try_wrlock((void *)(intptr_t)(rw_209));
                    (void)got_w_211;
                    puts((got_w_211) ? "true" : "false");
                }
                rwlock_unlock((void *)(intptr_t)(rw_209));
            }
            rwlock_free((void *)(intptr_t)(rw_209));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
