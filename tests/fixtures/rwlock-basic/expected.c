...
int main() {
        {
            void * rw_274 = rwlock_new();
            (void)rw_274;
            rwlock_wrlock((void *)(intptr_t)(rw_274));
            printf("%lld\n", (long long)(INT64_C(1)));
            rwlock_unlock((void *)(intptr_t)(rw_274));
            rwlock_rdlock((void *)(intptr_t)(rw_274));
            printf("%lld\n", (long long)(INT64_C(2)));
            rwlock_unlock((void *)(intptr_t)(rw_274));
            {
                bool got_r_275 = rwlock_try_rdlock((void *)(intptr_t)(rw_274));
                (void)got_r_275;
                puts((got_r_275) ? "true" : "false");
                {
                    bool got_w_276 = rwlock_try_wrlock((void *)(intptr_t)(rw_274));
                    (void)got_w_276;
                    puts((got_w_276) ? "true" : "false");
                }
                rwlock_unlock((void *)(intptr_t)(rw_274));
            }
            rwlock_free((void *)(intptr_t)(rw_274));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
