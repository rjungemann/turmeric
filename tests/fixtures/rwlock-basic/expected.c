...
int main() {
        {
            ...
            (void)rw_34;
            rwlock_wrlock((void *)(intptr_t)(rw_34));
            printf("%lld\n", (long long)(INT64_C(1)));
            rwlock_unlock((void *)(intptr_t)(rw_34));
            rwlock_rdlock((void *)(intptr_t)(rw_34));
            printf("%lld\n", (long long)(INT64_C(2)));
            rwlock_unlock((void *)(intptr_t)(rw_34));
            {
                bool got_r_35 = rwlock_try_rdlock((void *)(intptr_t)(rw_34));
                (void)got_r_35;
                puts((got_r_35) ? "true" : "false");
                {
                    bool got_w_36 = rwlock_try_wrlock((void *)(intptr_t)(rw_34));
                    (void)got_w_36;
                    puts((got_w_36) ? "true" : "false");
                }
                rwlock_unlock((void *)(intptr_t)(rw_34));
            }
            rwlock_free((void *)(intptr_t)(rw_34));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
