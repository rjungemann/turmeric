...
int main() {
        {
            void * rw_629 = rwlock_new();
            (void)rw_629;
            rwlock_wrlock((void *)(intptr_t)(rw_629));
            printf("%lld\n", (long long)(INT64_C(1)));
            rwlock_unlock((void *)(intptr_t)(rw_629));
            rwlock_rdlock((void *)(intptr_t)(rw_629));
            printf("%lld\n", (long long)(INT64_C(2)));
            rwlock_unlock((void *)(intptr_t)(rw_629));
            {
                bool got_r_630 = rwlock_try_rdlock((void *)(intptr_t)(rw_629));
                (void)got_r_630;
                puts((got_r_630) ? "true" : "false");
                {
                    bool got_w_631 = rwlock_try_wrlock((void *)(intptr_t)(rw_629));
                    (void)got_w_631;
                    puts((got_w_631) ? "true" : "false");
                }
                rwlock_unlock((void *)(intptr_t)(rw_629));
            }
            rwlock_free((void *)(intptr_t)(rw_629));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
