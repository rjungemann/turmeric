...
static void * adder_hyfactory(int64_t);
static int64_t apply_hytwice(void *, int64_t);
...
static void * adder_hyfactory(int64_t base) {
...
static int64_t apply_hytwice(void * g, int64_t x) {
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            (void)bump;
            printf("%lld\n", (long long)(((int64_t (*)(void *, int64_t))(intptr_t)bump)(adder_hyfactory(INT64_C(100)), INT64_C(7))));
            printf("%lld\n", (long long)(apply_hytwice((void *)(intptr_t)(adder_hyfactory(INT64_C(3))), INT64_C(10))));
        }
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
