...
static int64_t consume(tur_tagged_t);
...
static int64_t consume(tur_tagged_t x) {
        return INT64_C(0);
}

int main() {
        printf("%lld\n", (long long)(consume(TUR_TAG(3, (int64_t)(intptr_t)(INT64_C(42))))));
        printf("%lld\n", (long long)(consume(TUR_TAG(2, (int64_t)(intptr_t)(true)))));
        printf("%lld\n", (long long)(consume(TUR_TAG(5, (int64_t)(intptr_t)("hello")))));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
