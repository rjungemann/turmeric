...
static bool __inst_MyEqPrim_eq__int(int64_t, int64_t);
static bool __inst_MyEqPrim_eq__bool(bool, bool);
static bool __inst_MyOrdPrim_lt__int(int64_t, int64_t);
static bool __inst_MyOrdPrim_lte__int(int64_t, int64_t);
static bool __inst_MyOrdPrim_gt__int(int64_t, int64_t);
static bool __inst_MyOrdPrim_gte__int(int64_t, int64_t);
static const char * __inst_MyShowPrim_show_int(int64_t);
static const char * __inst_MyShowPrim_show_bool(bool);
static const char * __inst_MyShowPrim_show_cstr(const char *);
...
static bool __inst_MyEqPrim_eq__int(int64_t x, int64_t y) {
        return ((x) == (y));
}

typedef struct dict_MyEqPrim_int {
    bool (*eq_)(int64_t, int64_t);
} dict_MyEqPrim_int;

static dict_MyEqPrim_int dict_MyEqPrim_int_singleok?n = {
    .eq_ = __inst_MyEqPrim_eq__int,
};

static bool __inst_MyEqPrim_eq__bool(bool x, bool y) {
        return ((x) == (y));
}

typedef struct dict_MyEqPrim_bool {
    bool (*eq_)(bool, bool);
} dict_MyEqPrim_bool;

static dict_MyEqPrim_bool dict_MyEqPrim_bool_singleok?n = {
    .eq_ = __inst_MyEqPrim_eq__bool,
};

static bool __inst_MyOrdPrim_lt__int(int64_t x, int64_t y) {
        return ((x) < (y));
}

static bool __inst_MyOrdPrim_lte__int(int64_t x, int64_t y) {
        return ((x) <= (y));
}

static bool __inst_MyOrdPrim_gt__int(int64_t x, int64_t y) {
        return ((x) > (y));
}

static bool __inst_MyOrdPrim_gte__int(int64_t x, int64_t y) {
        return ((x) >= (y));
}

typedef struct dict_MyOrdPrim_int {
    bool (*lt_)(int64_t, int64_t);
    bool (*lte_)(int64_t, int64_t);
    bool (*gt_)(int64_t, int64_t);
    bool (*gte_)(int64_t, int64_t);
} dict_MyOrdPrim_int;

static dict_MyOrdPrim_int dict_MyOrdPrim_int_singleok?n = {
    .lt_ = __inst_MyOrdPrim_lt__int,
    .lte_ = __inst_MyOrdPrim_lte__int,
    .gt_ = __inst_MyOrdPrim_gt__int,
    .gte_ = __inst_MyOrdPrim_gte__int,
};

static const char * __inst_MyShowPrim_show_int(int64_t x) {
        return "<int>";
}

typedef struct dict_MyShowPrim_int {
    const char * (*show)(int64_t);
} dict_MyShowPrim_int;

static dict_MyShowPrim_int dict_MyShowPrim_int_singleok?n = {
    .show = __inst_MyShowPrim_show_int,
};

static const char * __inst_MyShowPrim_show_bool(bool x) {
        return "<bool>";
}

typedef struct dict_MyShowPrim_bool {
    const char * (*show)(bool);
} dict_MyShowPrim_bool;

static dict_MyShowPrim_bool dict_MyShowPrim_bool_singleok?n = {
    .show = __inst_MyShowPrim_show_bool,
};

static const char * __inst_MyShowPrim_show_cstr(const char * x) {
        return x;
}

typedef struct dict_MyShowPrim_cstr {
    const char * (*show)(const char *);
} dict_MyShowPrim_cstr;

static dict_MyShowPrim_cstr dict_MyShowPrim_cstr_singleok?n = {
    .show = __inst_MyShowPrim_show_cstr,
};
