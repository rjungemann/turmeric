...
static bool __inst_Ord_lt__int(int64_t, int64_t);
static bool __inst_Ord_lte__int(int64_t, int64_t);
static bool __inst_Ord_gt__int(int64_t, int64_t);
static bool __inst_Ord_gte__int(int64_t, int64_t);
static const char * __inst_Show_show_int(int64_t);
static const char * __inst_Show_show_bool(bool);
static const char * __inst_Show_show_cstr(const char *);
...
static bool __inst_Ord_lt__int(int64_t x, int64_t y) {
        return ((x) < (y));
}

static bool __inst_Ord_lte__int(int64_t x, int64_t y) {
        return ((x) <= (y));
}

static bool __inst_Ord_gt__int(int64_t x, int64_t y) {
        return ((x) > (y));
}

static bool __inst_Ord_gte__int(int64_t x, int64_t y) {
        return ((x) >= (y));
}
...
static dict_Ord_int dict_Ord_int_singleton = {
    .lt_ = __inst_Ord_lt__int,
    .lte_ = __inst_Ord_lte__int,
    .gt_ = __inst_Ord_gt__int,
    .gte_ = __inst_Ord_gte__int,
};
...
static const char * __inst_Show_show_cstr(const char * x) {
        return x;
}

typedef struct dict_Show_cstr {
    const char * (*show)(const char *);
} dict_Show_cstr;

static dict_Show_cstr dict_Show_cstr_singleton = {
    .show = __inst_Show_show_cstr,
};
