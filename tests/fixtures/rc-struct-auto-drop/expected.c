...
static void drop_glue_Wrapper(void *ptr) {
    if (!ptr) return;
    Wrapper *s = (Wrapper *)ptr;
    if (s->val) { rc_strong_decrement(s->val); rc_free_queue_drain(); }
    free(ptr);
}

static void walk_glue_Wrapper(void *ptr, RcWalkChildFn cb, void *ctx) {
    if (!ptr || !cb) return;
    Wrapper *s = (Wrapper *)ptr;
    if (s->val) cb(s->val, ctx);
}
...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(10);
            ...
            __t2->value = __t1;
            RcControlBlock * inner_617 = __t2;
            (void)inner_617;
            int64_t __t3 = rc_strong_count(inner_617);
            printf("%lld\n", (long long)(__t3));
            int64_t __t4;
            int64_t __t5;
            {
                Wrapper *__t6 = (Wrapper *)malloc(sizeof(Wrapper));
                *__t6 = (Wrapper){.val = inner_617};
                RcControlBlock *__t7 = rc_cb_alloc_struct(0, 18, drop_glue_Wrapper, walk_glue_Wrapper);
                __t7->value = __t6;
                RcControlBlock * w_618 = __t7;
                (void)w_618;
                tur_frame __frame_8;
                tur_frame_init(&__frame_8, NULL);
                int64_t __t9 = rc_strong_count(w_618);
                printf("%lld\n", (long long)(__t9));
                struct __defer_env_10 __t12 = {.w = w_618};
                tur_frame_push_defer(&__frame_8, __defer_11, &__t12);
                int64_t __t13;
                __t13 = INT64_C(0);
