...
struct __defer_env_14 {RcControlBlock * w; };

struct __defer_env_5 {RcControlBlock * inner; };
...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(10);
            ...
            __t2->value = __t1;
            RcControlBlock * inner_197 = __t2;
            (void)inner_197;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            int64_t __t4 = rc_strong_count(inner_197);
            printf("%lld\n", (long long)(__t4));
            struct __defer_env_5 __t7 = {.inner = inner_197};
            tur_frame_push_defer(&__frame_3, __defer_6, &__t7);
            int64_t __t8;
            int64_t __t9;
            {
                Wrapper *__t10 = (Wrapper *)malloc(sizeof(Wrapper));
                *__t10 = (Wrapper){.val = inner_197};
                RcControlBlock *__t11 = rc_cb_alloc(0, 18, drop_glue_Wrapper);
                __t11->value = __t10;
                RcControlBlock * w_198 = __t11;
                (void)w_198;
                tur_frame __frame_12;
                tur_frame_init(&__frame_12, &__frame_3);
                int64_t __t13 = rc_strong_count(w_198);
                printf("%lld\n", (long long)(__t13));
                struct __defer_env_14 __t16 = {.w = w_198};
