...
int main() {
        {
            int64_t opt1_223 = __opt_some(INT64_C(21));
            (void)opt1_223;
            {
                int64_t mapped_224 = __fmap_option(opt1_223, (int64_t)(intptr_t)(twice));
                (void)mapped_224;
                puts((__opt_some_(mapped_224)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(mapped_224)));
            }
        }
        {
            int64_t opt2_225 = __opt_none();
            (void)opt2_225;
            {
                int64_t mapped2_226 = __fmap_option(opt2_225, (int64_t)(intptr_t)(twice));
                (void)mapped2_226;
                puts((__opt_some_(mapped2_226)) ? "true" : "false");
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
