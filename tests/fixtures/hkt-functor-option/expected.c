...
int main() {
        {
            int64_t opt1_276 = __opt_some(INT64_C(21));
            (void)opt1_276;
            {
                int64_t mapped_277 = __fmap_option(opt1_276, (int64_t)(intptr_t)(twice));
                (void)mapped_277;
                puts((__opt_some_(mapped_277)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(mapped_277)));
            }
        }
        {
            int64_t opt2_278 = __opt_none();
            (void)opt2_278;
            {
                int64_t mapped2_279 = __fmap_option(opt2_278, (int64_t)(intptr_t)(twice));
                (void)mapped2_279;
                puts((__opt_some_(mapped2_279)) ? "true" : "false");
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
