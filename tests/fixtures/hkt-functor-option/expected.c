...
int main() {
        {
            int64_t opt1_631 = __opt_some(INT64_C(21));
            (void)opt1_631;
            {
                int64_t mapped_632 = __fmap_option(opt1_631, (int64_t)(intptr_t)(twice));
                (void)mapped_632;
                puts((__opt_some_(mapped_632)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(mapped_632)));
            }
        }
        {
            int64_t opt2_633 = __opt_none();
            (void)opt2_633;
            {
                int64_t mapped2_634 = __fmap_option(opt2_633, (int64_t)(intptr_t)(twice));
                (void)mapped2_634;
                puts((__opt_some_(mapped2_634)) ? "true" : "false");
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
