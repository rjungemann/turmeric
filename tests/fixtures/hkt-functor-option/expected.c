...
int main() {
        {
            int64_t opt1_211 = __opt_some(INT64_C(21));
            (void)opt1_211;
            {
                int64_t mapped_212 = __fmap_option(opt1_211, (int64_t)(intptr_t)(twice));
                (void)mapped_212;
                puts((__opt_some_(mapped_212)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(mapped_212)));
            }
        }
        {
            int64_t opt2_213 = __opt_none();
            (void)opt2_213;
            {
                int64_t mapped2_214 = __fmap_option(opt2_213, (int64_t)(intptr_t)(twice));
                (void)mapped2_214;
                puts((__opt_some_(mapped2_214)) ? "true" : "false");
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
