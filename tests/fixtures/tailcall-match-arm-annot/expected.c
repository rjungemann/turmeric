...
static tur_adt_Step classify(int64_t n) {
        if ((n) == (INT64_C(0))) {
            tur_adt_Step __ps_172 = (ctor_Step_Done());
            if (tur_panicking) return (tur_adt_Step){0};
            return __ps_172;
        } else {
            tur_adt_Step __ps_173 = (ctor_Step_More((n) - (INT64_C(1))));
            if (tur_panicking) return (tur_adt_Step){0};
            return __ps_173;
        }
}
...
static int64_t loop_hymatch(int64_t n) {
        __tur_tailcall:;
        int64_t __t174 = 0;
        tur_adt_Step __ps_175 = (classify(n));
        if (tur_panicking) return ((int64_t)0);
        {
            tur_adt_Step __scrut_v = (__ps_175);
            ...
            case 0: {
                int64_t v_1614 = (int64_t)__scrut->as.More._0;
                int64_t __t176 = v_1614;
                n = __t176;
                goto __tur_tailcall;
                break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_177 = (loop_hymatch(INT64_C(10)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        int64_t __t178;
        __t178 = INT64_C(0);
