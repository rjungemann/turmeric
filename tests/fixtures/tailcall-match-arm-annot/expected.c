...
#endif
typedef struct tur_adt_Step {
    int tag;
    union {
        struct { int64_t _0; } More;
        struct { } Done;
    } as;
} tur_adt_Step;

static tur_adt_Step ctor_Step_More(int64_t _0) {
    tur_adt_Step __r;
    __r.tag = 0;
    memset((char *)&__r + sizeof(__r.tag), 0, offsetof(tur_adt_Step, as) - sizeof(__r.tag));
    memset((char *)&__r.as + sizeof(__r.as.More), 0, sizeof(__r.as) - sizeof(__r.as.More));
    __r.as.More._0 = _0;
    return __r;
}

#ifndef TUR_CTORALIAS_More
#define TUR_CTORALIAS_More
#define ctor_More ctor_Step_More
#endif
static tur_adt_Step ctor_Step_Done() {
    tur_adt_Step __r;
    __r.tag = 1;
    memset((char *)&__r + sizeof(__r.tag), 0, offsetof(tur_adt_Step, as) - sizeof(__r.tag));
    memset((char *)&__r.as + sizeof(__r.as.Done), 0, sizeof(__r.as) - sizeof(__r.as.Done));
    return __r;
}

#ifndef TUR_CTORALIAS_Done
#define TUR_CTORALIAS_Done
#define ctor_Done ctor_Step_Done
#endif
...
static tur_adt_Step classify(int64_t);
static int64_t loop_hymatch(int64_t);
...
static tur_adt_Step classify(int64_t n) {
        tur_adt_Step __t173;
        if ((n) == (INT64_C(0))) {
            tur_adt_Step __ps_174 = (ctor_Step_Done());
            if (tur_panicking) return (tur_adt_Step){0};
            __t173 = __ps_174;
        } else {
            tur_adt_Step __ps_175 = (ctor_Step_More((n) - (INT64_C(1))));
            if (tur_panicking) return (tur_adt_Step){0};
            __t173 = __ps_175;
        }
        return __t173;
...
static int64_t loop_hymatch(int64_t n) {
        __tur_tailcall:;
        int64_t __t176 = 0;
        tur_adt_Step __ps_177 = (classify(n));
        if (tur_panicking) return ((int64_t)0);
        {
            tur_adt_Step __scrut_v = (__ps_177);
            tur_adt_Step *__scrut = &__scrut_v;
            switch (__scrut->tag) {
            case 1: {
                return INT64_C(0);
                break;
            ...
            case 0: {
                int64_t v_1613 = (int64_t)__scrut->as.More._0;
                int64_t __t178 = v_1613;
                n = __t178;
                goto __tur_tailcall;
                break;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_179 = (loop_hymatch(INT64_C(10)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        int64_t __t180;
        __t180 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_181 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
