...
#ifndef TUR_FWD_tur_adt_Box__cstr
#define TUR_FWD_tur_adt_Box__cstr
typedef struct tur_adt_Box__cstr tur_adt_Box__cstr;
#endif
struct tur_adt_Box__cstr {
    const char * val;
    int64_t tag;
};
#endif
...
static tur_adt_Box__cstr * ctor_Box_Box__cstr(const char * _0, int64_t _1) {
    tur_adt_Box__cstr *__r = (tur_adt_Box__cstr *)tur_region_alloc_or_malloc(sizeof(tur_adt_Box__cstr));
    __r->val = _0;
    __r->tag = _1;
    return __r;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Box__cstr * __ps_172 = (ctor_Box_Box__cstr("hello", INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Box__cstr * bc_1608 = __ps_172;
            (void)bc_1608;
            puts((const char *)((tur_adt_Box__cstr *)(intptr_t)(bc_1608))->val);
        }
        int64_t __t173;
        __t173 = INT64_C(0);
        return (int)__t173;
