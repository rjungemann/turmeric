...
int main(int argc, char **argv) {
        ...
        {
            Box__cstr *__t23 = (Box__cstr *)malloc(sizeof(Box__cstr));
            *__t23 = (Box__cstr){.val = (int64_t)(intptr_t)"hello", .tag = INT64_C(9)};
            Box__cstr * bc_886 = __t23;
            (void)bc_886;
            puts(((union { int64_t s; const char * d; }){.s = (bc_886)->val}).d);
        }
        int64_t __t24;
        __t24 = INT64_C(0);
        return (int)__t24;
