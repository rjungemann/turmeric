...
int main(int argc, char **argv) {
        ...
        {
            Box__cstr *__t24 = (Box__cstr *)malloc(sizeof(Box__cstr));
            *__t24 = (Box__cstr){.val = (int64_t)(intptr_t)"hello", .tag = INT64_C(9)};
            Box__cstr * bc_881 = __t24;
            (void)bc_881;
            puts(((union { int64_t s; const char * d; }){.s = (bc_881)->val}).d);
        }
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
