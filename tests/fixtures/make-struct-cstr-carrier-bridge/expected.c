...
int main(int argc, char **argv) {
        ...
        {
            Box__cstr *__t55 = (Box__cstr *)malloc(sizeof(Box__cstr));
            *__t55 = (Box__cstr){.val = (int64_t)(intptr_t)"hello", .tag = INT64_C(9)};
            Box__cstr * bc_1247 = __t55;
            (void)bc_1247;
            puts(((union { int64_t s; const char * d; }){.s = (bc_1247)->val}).d);
        }
        int64_t __t56;
        __t56 = INT64_C(0);
        return (int)__t56;
