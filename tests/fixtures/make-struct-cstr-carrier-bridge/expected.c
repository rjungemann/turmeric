...
int main(int argc, char **argv) {
        ...
        {
            Box__cstr *__t29 = (Box__cstr *)malloc(sizeof(Box__cstr));
            *__t29 = (Box__cstr){.val = (int64_t)(intptr_t)"hello", .tag = INT64_C(9)};
            Box__cstr * bc_901 = __t29;
            (void)bc_901;
            puts(((union { int64_t s; const char * d; }){.s = (bc_901)->val}).d);
        }
        int64_t __t30;
        __t30 = INT64_C(0);
        return (int)__t30;
