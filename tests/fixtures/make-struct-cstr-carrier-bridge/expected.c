...
int main(int argc, char **argv) {
        ...
        {
            Box__cstr *__t50 = (Box__cstr *)malloc(sizeof(Box__cstr));
            *__t50 = (Box__cstr){.val = (int64_t)(intptr_t)"hello", .tag = INT64_C(9)};
            Box__cstr * bc_1244 = __t50;
            (void)bc_1244;
            puts(((union { int64_t s; const char * d; }){.s = (bc_1244)->val}).d);
        }
        int64_t __t51;
        __t51 = INT64_C(0);
        return (int)__t51;
