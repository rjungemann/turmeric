...
static int64_t process(int64_t x) {
        ...
        int64_t __t2;
        {
            int64_t result_210 = ((x) * (INT64_C(2)));
            (void)result_210;
            int64_t __t3[2];
            __t3[0] = (int64_t)"info";
            __t3[1] = (int64_t)"done";
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * level_211 = (const char *)__effect_args[0];
    const char * msg_212 = (const char *)__effect_args[1];
    int64_t k_213 = __k;
    puts(msg_212);
    int64_t __t7;
    int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_213, (int64_t)0);
    __t7 = __t8;
    return (int64_t)__t7;
}
...
static int64_t __effect_handler_11(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * level_215 = (const char *)__effect_args[0];
    const char * msg_216 = (const char *)__effect_args[1];
    int64_t k_217 = __k;
    int64_t __t12 = tur_effect_cont_resume((int64_t)(intptr_t)k_217, (int64_t)0);
