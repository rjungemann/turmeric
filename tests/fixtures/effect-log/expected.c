...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * level_24 = (const char *)__effect_args[0];
    const char * msg_25 = (const char *)__effect_args[1];
    int64_t k_26 = __k;
    puts(msg_25);
    int64_t __t7;
    int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_26, (int64_t)0);
    __t7 = __t8;
    return (int64_t)__t7;
}
...
static int64_t __effect_handler_11(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * level_28 = (const char *)__effect_args[0];
    const char * msg_29 = (const char *)__effect_args[1];
    int64_t k_30 = __k;
    int64_t __t12 = tur_effect_cont_resume((int64_t)(intptr_t)k_30, (int64_t)0);
