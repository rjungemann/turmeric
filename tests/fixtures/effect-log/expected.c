...
static int64_t process(int64_t x) {
        ...
        int64_t __t2;
        {
            int64_t result_198 = ((x) * (INT64_C(2)));
            (void)result_198;
            int64_t __t3[2];
            __t3[0] = (int64_t)"info";
            __t3[1] = (int64_t)"done";
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * level_199 = (const char *)__effect_args[0];
    const char * msg_200 = (const char *)__effect_args[1];
    int64_t k_201 = __k;
    puts(msg_200);
    int64_t __t7;
    int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_201, (int64_t)0);
    __t7 = __t8;
    return (int64_t)__t7;
}
...
static int64_t __effect_handler_11(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * level_203 = (const char *)__effect_args[0];
    const char * msg_204 = (const char *)__effect_args[1];
    int64_t k_205 = __k;
    int64_t __t12 = tur_effect_cont_resume((int64_t)(intptr_t)k_205, (int64_t)0);
