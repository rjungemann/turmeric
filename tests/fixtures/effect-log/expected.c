...
static int64_t process(int64_t);
...
static int64_t process(int64_t x) {
        int64_t __t0[2];
        __t0[0] = (int64_t)"info";
        __t0[1] = (int64_t)"starting";
        tur_effect_perform("Log", __t0, 2);
        int64_t __t1;
        int64_t __t2;
        {
            int64_t result_215 = ((x) * (INT64_C(2)));
            (void)result_215;
            int64_t __t3[2];
            __t3[0] = (int64_t)"info";
            __t3[1] = (int64_t)"done";
            tur_effect_perform("Log", __t3, 2);
            int64_t __t4;
            __t4 = result_215;
            __t2 = __t4;
        }
...
static int64_t __effect_handler_6(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * level_216 = (const char *)__effect_args[0];
    const char * msg_217 = (const char *)__effect_args[1];
    int64_t k_218 = __k;
    puts(msg_217);
    int64_t __t7;
    int64_t __t8 = tur_effect_cont_resume((int64_t)(intptr_t)k_218, (int64_t)0);
    __t7 = __t8;
    return (int64_t)__t7;
}
...
static void __handle_body_5(void) {
    tur_current_fiber->result = (int64_t)process(INT64_C(21));
}
...
static int64_t __effect_handler_11(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * level_220 = (const char *)__effect_args[0];
    const char * msg_221 = (const char *)__effect_args[1];
    int64_t k_222 = __k;
    int64_t __t12 = tur_effect_cont_resume((int64_t)(intptr_t)k_222, (int64_t)0);
    return (int64_t)__t12;
}

static void __handle_body_10(void);
static void __handle_body_10(void) {
    tur_current_fiber->result = (int64_t)process(INT64_C(5));
}

static int64_t __dispatch_10(void *__ctx_void, int64_t __k_int, int64_t __resume_val);
static int64_t __dispatch_10(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    TurEffectCaptureCtx *__dcap = (TurEffectCaptureCtx *)__ctx_void;
    FiberBlock *__fiber = (FiberBlock *)(intptr_t)__k_int;
    int64_t __r = tur_fiber_block_resume(__fiber, __resume_val);
    ...
    if (!__dcap->has_pending_effect) return __r;
    if (strcmp(__dcap->eff_name, "Log") == 0) {
        return __effect_handler_11(__dcap->eff_args, __dcap->eff_n_args, __k_int, NULL);
    } else {
        /* Phase 19D: bubble up unhandled effect to outer fiber */
        FiberBlock *__outer_f = tur_current_fiber;
        if (__outer_f && __outer_f->eff_ctx) {
            ...
            tur_fiber_block_yield(0);
            __outer_cap->has_pending_effect = false;
            return __dispatch_10(__ctx_void, __k_int, __outer_f->arg);
        }
        fprintf(stderr, "dispatch: unhandled effect: %s\n", __dcap->eff_name);
        abort();
    }
...
int main() {
        {
            ...
            __eff_frame_5.cases[0].effect_name = "Log";
        ...
        {
            TurEffectCaptureCtx __cap_10;
            __cap_10.has_pending_effect = false;
            __cap_10.eff_name = NULL;
            __cap_10.eff_n_args = 0;
            __cap_10.dispatch = __dispatch_10;
            __cap_10.body_env = NULL;
            FiberBlock *__fiber_10 = tur_fiber_block_new(__handle_body_10, 0);
            __fiber_10->eff_ctx = &__cap_10;
            EffectHandlerFrame *__parent_chain_10 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
            EffectHandlerFrame __eff_frame_10;
            __eff_frame_10.parent = __parent_chain_10;
            __eff_frame_10.n_cases = 1;
            __eff_frame_10.cases[0].effect_name = "Log";
            __eff_frame_10.cases[0].handler_fn = NULL;
            __eff_frame_10.cases[0].env = NULL;
            __fiber_10->effect_handler_chain = &__eff_frame_10;
            int64_t __t13 = (int64_t)__dispatch_10(&__cap_10, (int64_t)(intptr_t)__fiber_10, 0);
            if (__fiber_10->done) { free(__fiber_10->stack); free(__fiber_10); }
            int64_t r2_223 = __t13;
            (void)r2_223;
            printf("%lld\n", (long long)(r2_223));
        }
        int64_t __t14;
