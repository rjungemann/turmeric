...
int main() {
        int64_t __t0;
        {
            ...
            (void)tg_275;
            {
                void * timeout_276 = spawn_timeout_thread((void *)(intptr_t)(tg_275), INT64_C(100));
                (void)timeout_276;
                tg_wait((void *)(intptr_t)(tg_275));
                join_timeout_thread((void *)(intptr_t)(timeout_276));
                puts("timed out");
                tg_free((void *)(intptr_t)(tg_275));
            }
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
