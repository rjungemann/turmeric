...
int main() {
        int64_t __t0;
        {
            ...
            (void)tg_210;
            {
                void * timeout_211 = spawn_timeout_thread((void *)(intptr_t)(tg_210), INT64_C(100));
                (void)timeout_211;
                tg_wait((void *)(intptr_t)(tg_210));
                join_timeout_thread((void *)(intptr_t)(timeout_211));
                puts("timed out");
                tg_free((void *)(intptr_t)(tg_210));
            }
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
