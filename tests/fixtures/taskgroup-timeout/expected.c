...
static void join_timeout_thread(void * t) {
...
int main() {
        int64_t __t0;
        {
            ...
            (void)tg_630;
            {
                void * timeout_631 = spawn_timeout_thread((void *)(intptr_t)(tg_630), INT64_C(100));
                (void)timeout_631;
                tg_wait((void *)(intptr_t)(tg_630));
                join_timeout_thread((void *)(intptr_t)(timeout_631));
                puts("timed out");
                tg_free((void *)(intptr_t)(tg_630));
            }
            int64_t __t1;
            __t1 = INT64_C(0);
            __t0 = __t1;
