...
typedef struct tur_cont { int tag; int64_t saved; tur_handler_node *boundary; struct tur_cont *next; } tur_cont;
...
static int64_t __fn_1266(void * __env_p_1269) {
        ...
        __auto_type __ps_43 = (cu_hyrec((__env___env_1268->n) - (INT64_C(1))));
...
static int64_t cu_hyrec(int64_t n) {
        ...
        __k->tag = 0; __k->saved = 0; __k->boundary = 0; __k->next = 0;
        ...
        for (;;) {
         ...
         if (__act == 0) {
          if ((n) == (INT64_C(0))) {
           ...
           __k2->tag = 1; __k2->saved = (int64_t)(n); __k2->boundary = __b; __k2->next = __k;
           n = (n) - (INT64_C(1));
           __k = __k2;
          }
         } else {
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_182 = (cu_hyrec(INT64_C(500000)));
