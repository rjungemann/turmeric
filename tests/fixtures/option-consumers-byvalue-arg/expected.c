...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t23[1] = (int64_t)(intptr_t)__fn_888;
        void *__t24 = __t23;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t25) {
            ...
            __t26[1] = (int64_t)(intptr_t)__fn_1008;
            void *__t27 = __t26;
            ...
            bool __t29;
            {
                ...
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_653, (void *)(intptr_t)(k_654), (void *)(intptr_t)(keyeq))) {
                    ...
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)), map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_653, (void *)(intptr_t)(k_654), (void *)(intptr_t)(keyeq)))) {
                        __t31 = map_hyeq_hyloop((void *)(intptr_t)(iter), (void *)(intptr_t)(m2_hamt), (void *)(intptr_t)(keyeq), (int64_t)(intptr_t)(val_cmp));
                    } else {
                        __t31 = false;
                    }
                    __t30 = __t31;
...
static bool vec_hyeq_hyloop(int64_t x, int64_t y, int64_t i, int64_t len, int64_t cmp) {
        ...
        if ((i) == (len)) {
            ...
            if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(cmp)))[0])((void *)(intptr_t)(cmp), vec_hyget(x, i), vec_hyget(y, i))) {
                __t35 = vec_hyeq_hyloop(x, y, (i) + (INT64_C(1)), len, (int64_t)(intptr_t)(cmp));
            } else {
                __t35 = false;
            }
            __t34 = __t35;
...
static int64_t unwrap_hyor(int64_t o, int64_t dflt) {
        ...
        if (((o) ? ((Option *)(intptr_t)(o))->is_some : 0)) {
            __t36 = ((o) ? ((Option *)(intptr_t)(o))->value : 0);
        } else {
            __t36 = dflt;
        }
        return __t36;
        ...
        if (tnil_qu(l1)) {
            ...
            if (tnil_qu(l2)) {
                ...
                if ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), list_hyhead(l1), list_hyhead(l2))) {
                    __t39 = list_hyeq_qu(list_hytail(l1), list_hytail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t39 = false;
                }
                __t38 = __t39;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            __t40 = tcons((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f)));
        }
        return __t40;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            __t41 = tcons(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2));
        }
        return __t41;
}
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        bool __t47 = (set_hycount(s1)) == (set_hycount(s2));
        if (__t47) {
            __t47 = set_hyeq_hydriver(s1, s2);
        }
        return __t47;
}
            ...
            if (mutmap_hyslot_hyoccupied_qu(m1, i)) {
                ...
                if (mutmap_hyhas_qu(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i))) {
                    ...
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), mutmap_hyslot_hyvalue(m1, i), mutmap_hyget(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i)))) {
                        __t51 = mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp));
                    } else {
                        __t51 = false;
                    }
                    __t50 = __t51;
...
static Option__int g() {
                tur_option_t *__t52 = (tur_option_t *)(intptr_t)(some(INT64_C(5)));
        return (__t52 ? (Option__int){.is_some = __t52->is_some, .value = __t52->value} : (Option__int){0});
}

static Option__int gn() {
                tur_option_t *__t53 = (tur_option_t *)(intptr_t)(none());
...
int main(int argc, char **argv) {
        ...
        __t54[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t54[1] = (int64_t)(intptr_t)dbl;
        void *__t55 = __t54;
        puts((some___spec__bool_Option__int(option_map__spec__Option__int_Option__int_int64_t(g(), (int64_t)(intptr_t)(__t55)))) ? "true" : "false");
        int64_t *__t56 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t56[0] = (int64_t)(intptr_t)__tur_fatshim1;
        __t56[1] = (int64_t)(intptr_t)dbl;
        void *__t57 = __t56;
        printf("%lld\n", (long long)(unwrap_or__spec__int64_t_Option__int_int64_t(option_map__spec__Option__int_Option__int_int64_t(g(), (int64_t)(intptr_t)(__t57)), INT64_C(0))));
        int64_t *__t58 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t58[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
        __t58[1] = (int64_t)(intptr_t)__fn_1013;
        void *__t59 = __t58;
        puts((option_eq___spec__bool_Option__int_Option__int_bool(g(), g(), (int64_t)(intptr_t)(__t59))) ? "true" : "false");
        int64_t *__t60 = (int64_t *)malloc(2 * sizeof(int64_t));
        __t60[0] = (int64_t)(intptr_t)__tur_fatshim_bool_int64_t_int64_t;
        __t60[1] = (int64_t)(intptr_t)__fn_1017;
        void *__t61 = __t60;
        puts((option_eq___spec__bool_Option__int_Option__int_bool(g(), gn(), (int64_t)(intptr_t)(__t61))) ? "true" : "false");
        tur_option_t *__t62 = (tur_option_t *)(intptr_t)(some(INT64_C(1)));
        puts((some___spec__bool_Option__int((__t62 ? (Option__int){.is_some = __t62->is_some, .value = __t62->value} : (Option__int){0}))) ? "true" : "false");
...
static Option__int option_map__spec__Option__int_Option__int_int64_t(Option__int o, int64_t f) {
        Option__int __t65;
        if ((o).is_some) {
            __t65 = some__spec__Option__int_int64_t((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), (o).value));
        } else {
...
static bool option_eq___spec__bool_Option__int_Option__int_bool(Option__int o1, Option__int o2, int64_t cmp_fn) {
        ...
        if ((o1).is_some) {
            bool __t67;
            if ((o2).is_some) {
                __t67 = (*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), (o1).value, (o2).value);
            } else {
                __t67 = false;
            }
            __t66 = __t67;
