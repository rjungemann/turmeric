...
static int64_t list_hyeq_qu__cps(int64_t l1, int64_t l2, int64_t cmp_fn, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (__t2) {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_93 = ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), __ps_91, __ps_92));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t3 = __ps_93;
            if (__t3) {
...
static int64_t _un_uncons_hyfmap__cps(int64_t cell, void * f, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_104 = ((*( tur_thunk_int64_t_int64_t_t *)(f))(f, __ps_103));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_104;
        ...
        if ((i) == (cap)) {
            ...
            if (__ps_131) {
                ...
                if (__ps_135) {
                    ...
                    if (tur_panicking) return ((bool)0);
                    __auto_type __ps_141 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_137, __ps_140));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_141) {
...
static int64_t consume(int64_t x, int64_t f) {
        __auto_type __ps_156 = (((int64_t (*)(int64_t))(intptr_t)f)(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_156;
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_196 = (ctor_Cons__int(h, t));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_198 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_198;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        __auto_type __ps_199 = (ctor_Option__int(false, ((int64_t)0)));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_199;
}
...
static int64_t option_map__spec__tur_adt_Option__int_tur_adt_Option__int_int64_t__cps(tur_adt_Option__int o, int64_t f, DK *__kont) {
    ...
    if ((bool)(o).is_some) {
        __auto_type __ps_202 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(f)))((void *)(intptr_t)(f), (int64_t)(o).value));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static int64_t option_eq___spec__bool_tur_adt_Option__int_tur_adt_Option__int_bool__cps(tur_adt_Option__int o1, tur_adt_Option__int o2, int64_t cmp_fn, DK *__kont) {
    ...
    if ((bool)(o1).is_some) {
        bool __t206;
        if ((bool)(o2).is_some) {
            __auto_type __ps_207 = ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), (int64_t)(o1).value, (int64_t)(o2).value));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __t206 = __ps_207;
        } else {
            __t206 = false;
