...
struct __defer_env_4 {RcControlBlock * r; };
...
static int64_t __dispatch_9(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "GetCount") == 0) {
...
static int64_t use_rc() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(42);
            ...
            struct __defer_env_4 __t6 = {.r = r_196};
            tur_frame_push_defer(&__frame_3, __defer_5, &__t6);
            int64_t __t7;
            int64_t __t8 = tur_effect_perform("GetCount", NULL, 0);
            __t7 = ((INT64_C(0)) + (__t8));
...
int main(void) {
    ...
    __eff_frame_9.cases[0].effect_name = "GetCount";
    __eff_frame_9.cases[0].handler_fn = NULL;
    __eff_frame_9.cases[0].env = NULL;
    __fiber_9->effect_handler_chain = &__eff_frame_9;
    int64_t __t12 = (int64_t)__dispatch_9(&__cap_9, (int64_t)(intptr_t)__fiber_9, 0);
