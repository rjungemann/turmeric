...
static int64_t __poly_1633(void *, int64_t);
...
static void __defer_163(void *__env) {
    ...
    bool __ps_193 = (bt_hyundo_hyto_ex(__e->m));
...
static int64_t __poly_1633(void * __poly_env_1634, int64_t __poly_x0_1636) {
        return __inc(__poly_x0_1636);
}

struct __env_1644 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1642(void * __env_p_1645, int64_t x) {
        ...
        return (x) + (__env___env_1644->delta);
}

struct __env_1652 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1650(void * __env_p_1653, int64_t x) {
        ...
        return (x) + (__env___env_1652->delta);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_172 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_173 = (__inst_TestFunctor_fmap_option(__ps_172, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1633 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1639 = __ps_173;
            (void)result_1639;
            bool __ps_174 = (_un_unopt_unsome_qu(result_1639));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_174) ? "true" : "false");
            int64_t __ps_175 = (__opt_unwrap(result_1639));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_175));
        }
        {
            int64_t delta_1640 = INT64_C(100);
            (void)delta_1640;
            {
                int64_t __ps_176 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t178 = malloc(sizeof(void *) + sizeof(struct __env_1644));
                *(void (**)(void *))__t178 = drop_glue___env_1644;
                struct __env_1644 *__t177 = (struct __env_1644 *)((char *)__t178 + sizeof(void *));
                __t177->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1642;
                __t177->delta = delta_1640;
                TUR_REGION_NOTE_WORDS(&(__t177->delta), sizeof(__t177->delta));
                void *__t179 = __t177;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1647 = __ps_181;
                (void)result_1647;
                bool __ps_182 = (_un_unopt_unsome_qu(result_1647));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_182) ? "true" : "false");
                int64_t __ps_183 = (__opt_unwrap(result_1647));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_183));
            }
        }
        {
            int64_t delta_1648 = INT64_C(100);
            (void)delta_1648;
            int64_t __ps_184 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t186 = malloc(sizeof(void *) + sizeof(struct __env_1652));
            *(void (**)(void *))__t186 = drop_glue___env_1652;
            struct __env_1652 *__t185 = (struct __env_1652 *)((char *)__t186 + sizeof(void *));
            __t185->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1650;
            __t185->delta = delta_1648;
            TUR_REGION_NOTE_WORDS(&(__t185->delta), sizeof(__t185->delta));
            void *__t187 = __t185;
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_190 = (_un_unopt_unsome_qu(__ps_189));
            /* panic-return-signal: ret ctype unknown; no propagation here */
