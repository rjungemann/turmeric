...
static int64_t __poly_1282(void *, int64_t);
...
static int64_t __poly_1282(void * __poly_env_1283, int64_t __poly_x0_1285) {
        __auto_type __ps_40 = (__inc(__poly_x0_1285));
        if (tur_panicking) return (int64_t){0};
        return __ps_40;
}

struct __env_1293 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1291(void * __env_p_1294, int64_t x) {
        struct __env_1293 *__env___env_1293 = (struct __env_1293 *)__env_p_1294;
        return (x) + (__env___env_1293->delta);
}

struct __env_1301 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1299(void * __env_p_1302, int64_t x) {
        struct __env_1301 *__env___env_1301 = (struct __env_1301 *)__env_p_1302;
        return (x) + (__env___env_1301->delta);
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_175 = (__inst_TestFunctor_fmap_option(__ps_174, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1282 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1288 = __ps_175;
            (void)result_1288;
            __auto_type __ps_176 = (_un_unopt_unsome_qu(result_1288));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            __auto_type __ps_177 = (__opt_unwrap(result_1288));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
        }
        {
            int64_t delta_1289 = INT64_C(100);
            (void)delta_1289;
            {
                __auto_type __ps_178 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                struct __env_1293 *__t179 = (struct __env_1293 *)malloc(sizeof(struct __env_1293));
                __t179->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1291;
                __t179->delta = delta_1289;
                void *__t180 = __t179;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1296 = __ps_182;
                (void)result_1296;
                __auto_type __ps_183 = (_un_unopt_unsome_qu(result_1296));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_183) ? "true" : "false");
                __auto_type __ps_184 = (__opt_unwrap(result_1296));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_184));
            }
        }
        {
            int64_t delta_1297 = INT64_C(100);
            (void)delta_1297;
            __auto_type __ps_185 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            struct __env_1301 *__t186 = (struct __env_1301 *)malloc(sizeof(struct __env_1301));
            __t186->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1299;
            __t186->delta = delta_1297;
            void *__t187 = __t186;
