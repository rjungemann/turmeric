...
static int64_t __poly_821(void *, int64_t);
static int64_t __fn_830(void *, int64_t);
...
static int64_t __poly_821(void * __poly_env_822, int64_t __poly_x0_824) {
        return __inc(__poly_x0_824);
}

struct __env_832 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_830(void * __env_p_833, int64_t x) {
        struct __env_832 *__env___env_832 = (struct __env_832 *)__env_p_833;
        return (x) + (__env___env_832->delta);
}

struct __env_840 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_838(void * __env_p_841, int64_t x) {
        struct __env_840 *__env___env_840 = (struct __env_840 *)__env_p_841;
        return (x) + (__env___env_840->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_827 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_821 });
            (void)result_827;
            puts((__opt_some_(result_827)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_827)));
        }
        {
            int64_t delta_828 = INT64_C(100);
            (void)delta_828;
            {
                struct __env_832 *__t3 = (struct __env_832 *)malloc(sizeof(struct __env_832));
                __t3->__fn = (tur_thunk_int64_t_int64_t_t)__fn_830;
                __t3->delta = delta_828;
                void *__t4 = __t3;
                void *__t5 = __t4;
                int64_t result_835 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t5, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t5)) });
                (void)result_835;
                puts((__opt_some_(result_835)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_835)));
            }
        }
        {
            int64_t delta_836 = INT64_C(100);
            (void)delta_836;
            struct __env_840 *__t6 = (struct __env_840 *)malloc(sizeof(struct __env_840));
            __t6->__fn = (tur_thunk_int64_t_int64_t_t)__fn_838;
            __t6->delta = delta_836;
            void *__t7 = __t6;
            void *__t8 = __t7;
            puts((__opt_some_(__inst_TestFunctor_fmap_option(__opt_none(), (tur_poly_fn_t){ __t8, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t8)) }))) ? "true" : "false");
        }
        int64_t __t9;
        __t9 = INT64_C(0);
        return (int)__t9;
