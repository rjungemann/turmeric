...
static int64_t __poly_1032(void *, int64_t);
...
static int64_t __poly_1032(void * __poly_env_1033, int64_t __poly_x0_1035) {
        return __inc(__poly_x0_1035);
}

struct __env_1043 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1041(void * __env_p_1044, int64_t x) {
        struct __env_1043 *__env___env_1043 = (struct __env_1043 *)__env_p_1044;
        return (x) + (__env___env_1043->delta);
}

struct __env_1051 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1049(void * __env_p_1052, int64_t x) {
        struct __env_1051 *__env___env_1051 = (struct __env_1051 *)__env_p_1052;
        return (x) + (__env___env_1051->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1038 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1032 });
            (void)result_1038;
            puts((_un_unopt_unsome_qu(result_1038)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1038)));
        }
        {
            int64_t delta_1039 = INT64_C(100);
            (void)delta_1039;
            {
                struct __env_1043 *__t42 = (struct __env_1043 *)malloc(sizeof(struct __env_1043));
                __t42->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1041;
                __t42->delta = delta_1039;
                void *__t43 = __t42;
                void *__t44 = (void *)(intptr_t)(__t43);
                int64_t result_1046 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t44, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t44)) });
                (void)result_1046;
                puts((_un_unopt_unsome_qu(result_1046)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1046)));
            }
        }
        {
            int64_t delta_1047 = INT64_C(100);
            (void)delta_1047;
            struct __env_1051 *__t45 = (struct __env_1051 *)malloc(sizeof(struct __env_1051));
            __t45->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1049;
            __t45->delta = delta_1047;
            void *__t46 = __t45;
