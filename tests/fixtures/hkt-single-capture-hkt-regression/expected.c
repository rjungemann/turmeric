...
static int64_t __poly_1258(void *, int64_t);
static int64_t __fn_1267(void *, int64_t);
static int64_t __fn_1275(void *, int64_t);
...
static int64_t __poly_1258(void * __poly_env_1259, int64_t __poly_x0_1261) {
        return __inc(__poly_x0_1261);
}

struct __env_1269 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1267(void * __env_p_1270, int64_t x) {
        struct __env_1269 *__env___env_1269 = (struct __env_1269 *)__env_p_1270;
        return (x) + (__env___env_1269->delta);
}

struct __env_1277 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1275(void * __env_p_1278, int64_t x) {
        struct __env_1277 *__env___env_1277 = (struct __env_1277 *)__env_p_1278;
        return (x) + (__env___env_1277->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1264 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1258 });
            (void)result_1264;
            puts((_un_unopt_unsome_qu(result_1264)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1264)));
        }
        {
            int64_t delta_1265 = INT64_C(100);
            (void)delta_1265;
            {
                struct __env_1269 *__t55 = (struct __env_1269 *)malloc(sizeof(struct __env_1269));
                __t55->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1267;
                __t55->delta = delta_1265;
                void *__t56 = __t55;
                void *__t57 = (void *)(intptr_t)(__t56);
                int64_t result_1272 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t57, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t57)) });
                (void)result_1272;
                puts((_un_unopt_unsome_qu(result_1272)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1272)));
            }
        }
        {
            int64_t delta_1273 = INT64_C(100);
            (void)delta_1273;
            struct __env_1277 *__t58 = (struct __env_1277 *)malloc(sizeof(struct __env_1277));
            __t58->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1275;
            __t58->delta = delta_1273;
            void *__t59 = __t58;
