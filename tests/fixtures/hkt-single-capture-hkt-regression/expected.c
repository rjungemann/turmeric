...
static int64_t __poly_1034(void *, int64_t);
...
static int64_t __poly_1034(void * __poly_env_1035, int64_t __poly_x0_1037) {
        return __inc(__poly_x0_1037);
}

struct __env_1045 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1043(void * __env_p_1046, int64_t x) {
        struct __env_1045 *__env___env_1045 = (struct __env_1045 *)__env_p_1046;
        return (x) + (__env___env_1045->delta);
}

struct __env_1053 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1051(void * __env_p_1054, int64_t x) {
        struct __env_1053 *__env___env_1053 = (struct __env_1053 *)__env_p_1054;
        return (x) + (__env___env_1053->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1040 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1034 });
            (void)result_1040;
            puts((_un_unopt_unsome_qu(result_1040)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1040)));
        }
        {
            int64_t delta_1041 = INT64_C(100);
            (void)delta_1041;
            {
                struct __env_1045 *__t44 = (struct __env_1045 *)malloc(sizeof(struct __env_1045));
                __t44->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1043;
                __t44->delta = delta_1041;
                void *__t45 = __t44;
                void *__t46 = (void *)(intptr_t)(__t45);
                int64_t result_1048 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t46, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t46)) });
                (void)result_1048;
                puts((_un_unopt_unsome_qu(result_1048)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1048)));
            }
        }
        {
            int64_t delta_1049 = INT64_C(100);
            (void)delta_1049;
            struct __env_1053 *__t47 = (struct __env_1053 *)malloc(sizeof(struct __env_1053));
            __t47->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1051;
            __t47->delta = delta_1049;
            void *__t48 = __t47;
            void *__t49 = (void *)(intptr_t)(__t48);
            puts((_un_unopt_unsome_qu(__inst_TestFunctor_fmap_option(__opt_none(), (tur_poly_fn_t){ __t49, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t49)) }))) ? "true" : "false");
        }
        int64_t __t50;
        __t50 = INT64_C(0);
        return (int)__t50;
