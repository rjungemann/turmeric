...
static int64_t __poly_1001(void *, int64_t);
static int64_t __fn_1010(void *, int64_t);
...
static int64_t __poly_1001(void * __poly_env_1002, int64_t __poly_x0_1004) {
        return __inc(__poly_x0_1004);
}

struct __env_1012 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1010(void * __env_p_1013, int64_t x) {
        struct __env_1012 *__env___env_1012 = (struct __env_1012 *)__env_p_1013;
        return (x) + (__env___env_1012->delta);
}

struct __env_1020 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1018(void * __env_p_1021, int64_t x) {
        struct __env_1020 *__env___env_1020 = (struct __env_1020 *)__env_p_1021;
        return (x) + (__env___env_1020->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1007 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1001 });
            (void)result_1007;
            puts((_un_unopt_unsome_qu(result_1007)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1007)));
        }
        {
            int64_t delta_1008 = INT64_C(100);
            (void)delta_1008;
            {
                struct __env_1012 *__t42 = (struct __env_1012 *)malloc(sizeof(struct __env_1012));
                __t42->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1010;
                __t42->delta = delta_1008;
                void *__t43 = __t42;
                void *__t44 = (void *)(intptr_t)(__t43);
                int64_t result_1015 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t44, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t44)) });
                (void)result_1015;
                puts((_un_unopt_unsome_qu(result_1015)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1015)));
            }
        }
        {
            int64_t delta_1016 = INT64_C(100);
            (void)delta_1016;
            struct __env_1020 *__t45 = (struct __env_1020 *)malloc(sizeof(struct __env_1020));
            __t45->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1018;
            __t45->delta = delta_1016;
            void *__t46 = __t45;
