...
static int64_t __poly_1291(void *, int64_t);
...
static int64_t __poly_1291(void * __poly_env_1292, int64_t __poly_x0_1294) {
        __auto_type __ps_42 = (__inc(__poly_x0_1294));
        if (tur_panicking) return (int64_t){0};
        return __ps_42;
}

struct __env_1302 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1300(void * __env_p_1303, int64_t x) {
        ...
        return (x) + (__env___env_1302->delta);
}

struct __env_1310 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static void drop_glue___env_1310(void *__p) {
    struct __env_1310 *__e = (struct __env_1310 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1308(void * __env_p_1311, int64_t x) {
        struct __env_1310 *__env___env_1310 = (struct __env_1310 *)__env_p_1311;
        return (x) + (__env___env_1310->delta);
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_70 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_746, (void *)(intptr_t)(k_747), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t72;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_751 = __ps_74;
            (void)iter_751;
            __auto_type __ps_75 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_76 = (hamt_slkeyeq((void *)(intptr_t)(__ps_75)));
            if (tur_panicking) return (bool){0};
            void * keyeq_752 = __ps_76;
            (void)keyeq_752;
            __auto_type __ps_77 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_78 = (map_hyeq_hyloop((void *)(intptr_t)(iter_751), (void *)(intptr_t)(__ps_77), (void *)(intptr_t)(keyeq_752), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_753 = __ps_78;
            (void)result_753;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_96) {
            bool __t97;
            {
                ...
                bool __t98;
                if ((t1_993) == (INT64_C(0))) {
                    __t98 = (t2_994) == (INT64_C(0));
                } else {
                    bool __t99;
                    if ((t2_994) == (INT64_C(0))) {
                        __t99 = false;
                    } else {
                        __auto_type __ps_100 = (cons_hyeq_hygo(t1_993, t2_994));
                        if (tur_panicking) return (bool){0};
                        __t99 = __ps_100;
                    }
                    __t98 = __t99;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_106) {
            ...
            int64_t __t107;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1009 = (int64_t)(intptr_t)(__ps_111);
                (void)out_1009;
                __t107 = out_1009;
            }
            __t105 = __t107;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t116;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1084 = __ps_118;
            (void)iter_1084;
            __auto_type __ps_119 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_120 = (hamt_slkeyeq((void *)(intptr_t)(__ps_119)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1085 = __ps_120;
            (void)keyeq_1085;
            __auto_type __ps_121 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_122 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1084), (void *)(intptr_t)(__ps_121), (void *)(intptr_t)(keyeq_1085)));
            if (tur_panicking) return (bool){0};
            bool result_1086 = __ps_122;
            (void)result_1086;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t143;
        {
            ...
            {
                __auto_type __ps_145 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1213));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1214 = __ps_145;
                (void)_un_unv_1214;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t148;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1263 = __ps_149;
            (void)r_1263;
            int64_t __t150;
            __auto_type __ps_151 = (schema_hydecode_hyok_qu(r_1263));
            if (tur_panicking) return (int64_t){0};
            if (__ps_151) {
                __auto_type __ps_152 = (schema_hydecode_hyvalue(r_1263));
                if (tur_panicking) return (int64_t){0};
                __t150 = __ps_152;
            } else {
                __auto_type __ps_153 = (schema_hydecode_hyerrors(r_1263));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            __auto_type __ps_156 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_157 = (__inst_TestFunctor_fmap_option(__ps_156, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1291 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1297 = __ps_157;
            (void)result_1297;
            __auto_type __ps_158 = (_un_unopt_unsome_qu(result_1297));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_158) ? "true" : "false");
            __auto_type __ps_159 = (__opt_unwrap(result_1297));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_159));
        }
        {
            int64_t delta_1298 = INT64_C(100);
            (void)delta_1298;
            {
                __auto_type __ps_160 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t162 = malloc(sizeof(void *) + sizeof(struct __env_1302));
                *(void (**)(void *))__t162 = drop_glue___env_1302;
                struct __env_1302 *__t161 = (struct __env_1302 *)((char *)__t162 + sizeof(void *));
                __t161->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1300;
                __t161->delta = delta_1298;
                void *__t163 = __t161;
                void *__t164 = (void *)(intptr_t)(__t163);
                __auto_type __ps_165 = (__inst_TestFunctor_fmap_option(__ps_160, (tur_poly_fn_t){ __t164, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t164)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1305 = __ps_165;
                (void)result_1305;
                __auto_type __ps_166 = (_un_unopt_unsome_qu(result_1305));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_166) ? "true" : "false");
                __auto_type __ps_167 = (__opt_unwrap(result_1305));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_167));
            }
        }
        {
            int64_t delta_1306 = INT64_C(100);
            (void)delta_1306;
            __auto_type __ps_168 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t170 = malloc(sizeof(void *) + sizeof(struct __env_1310));
            *(void (**)(void *))__t170 = drop_glue___env_1310;
            struct __env_1310 *__t169 = (struct __env_1310 *)((char *)__t170 + sizeof(void *));
            __t169->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1308;
            __t169->delta = delta_1306;
            void *__t171 = __t169;
            void *__t172 = (void *)(intptr_t)(__t171);
            __auto_type __ps_173 = (__inst_TestFunctor_fmap_option(__ps_168, (tur_poly_fn_t){ __t172, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t172)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_174 = (_un_unopt_unsome_qu(__ps_173));
            /* panic-return-signal: ret ctype unknown; no propagation here */
