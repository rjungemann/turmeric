...
struct __env_913 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_911(void * __env_p_914, int64_t x) {
        struct __env_913 *__env___env_913 = (struct __env_913 *)__env_p_914;
        return (x) + (__env___env_913->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_900 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_894 });
            (void)result_900;
        ...
        }
        {
            ...
            (void)delta_901;
            {
                struct __env_905 *__t25 = (struct __env_905 *)malloc(sizeof(struct __env_905));
                __t25->__fn = (tur_thunk_int64_t_int64_t_t)__fn_903;
                __t25->delta = delta_901;
                void *__t26 = __t25;
                void *__t27 = (void *)(intptr_t)(__t26);
                int64_t result_908 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t27, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t27)) });
                (void)result_908;
        ...
        {
            int64_t delta_909 = INT64_C(100);
            (void)delta_909;
            struct __env_913 *__t28 = (struct __env_913 *)malloc(sizeof(struct __env_913));
            __t28->__fn = (tur_thunk_int64_t_int64_t_t)__fn_911;
            __t28->delta = delta_909;
            void *__t29 = __t28;
