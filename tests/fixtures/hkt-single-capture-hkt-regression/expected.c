...
static int64_t __poly_998(void *, int64_t);
static int64_t __fn_1007(void *, int64_t);
static int64_t __fn_1015(void *, int64_t);
...
static int64_t __poly_998(void * __poly_env_999, int64_t __poly_x0_1001) {
        return __inc(__poly_x0_1001);
}

struct __env_1009 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1007(void * __env_p_1010, int64_t x) {
        struct __env_1009 *__env___env_1009 = (struct __env_1009 *)__env_p_1010;
        return (x) + (__env___env_1009->delta);
}

struct __env_1017 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1015(void * __env_p_1018, int64_t x) {
        struct __env_1017 *__env___env_1017 = (struct __env_1017 *)__env_p_1018;
        return (x) + (__env___env_1017->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1004 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_998 });
            (void)result_1004;
            puts((_un_unopt_unsome_qu(result_1004)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1004)));
        }
        {
            int64_t delta_1005 = INT64_C(100);
            (void)delta_1005;
            {
                struct __env_1009 *__t42 = (struct __env_1009 *)malloc(sizeof(struct __env_1009));
                __t42->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1007;
                __t42->delta = delta_1005;
                void *__t43 = __t42;
                void *__t44 = (void *)(intptr_t)(__t43);
                int64_t result_1012 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t44, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t44)) });
                (void)result_1012;
                puts((_un_unopt_unsome_qu(result_1012)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1012)));
            }
        }
        {
            int64_t delta_1013 = INT64_C(100);
            (void)delta_1013;
            struct __env_1017 *__t45 = (struct __env_1017 *)malloc(sizeof(struct __env_1017));
            __t45->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1015;
            __t45->delta = delta_1013;
            void *__t46 = __t45;
            void *__t47 = (void *)(intptr_t)(__t46);
            puts((_un_unopt_unsome_qu(__inst_TestFunctor_fmap_option(__opt_none(), (tur_poly_fn_t){ __t47, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t47)) }))) ? "true" : "false");
        }
        int64_t __t48;
        __t48 = INT64_C(0);
        return (int)__t48;
