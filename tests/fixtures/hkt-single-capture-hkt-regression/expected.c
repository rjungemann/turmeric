...
static int64_t __poly_1293(void *, int64_t);
static int64_t __fn_1302(void *, int64_t);
static int64_t __fn_1310(void *, int64_t);
...
static int64_t __poly_1293(void * __poly_env_1294, int64_t __poly_x0_1296) {
        __auto_type __ps_42 = (__inc(__poly_x0_1296));
        if (tur_panicking) return (int64_t){0};
        return __ps_42;
}

struct __env_1304 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1302(void * __env_p_1305, int64_t x) {
        ...
        return (x) + (__env___env_1304->delta);
}

struct __env_1312 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static void drop_glue___env_1312(void *__p) {
    struct __env_1312 *__e = (struct __env_1312 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1310(void * __env_p_1313, int64_t x) {
        struct __env_1312 *__env___env_1312 = (struct __env_1312 *)__env_p_1313;
        return (x) + (__env___env_1312->delta);
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_70 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_747, (void *)(intptr_t)(k_748), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t72;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_752 = __ps_74;
            (void)iter_752;
            __auto_type __ps_75 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_76 = (hamt_slkeyeq((void *)(intptr_t)(__ps_75)));
            if (tur_panicking) return (bool){0};
            void * keyeq_753 = __ps_76;
            (void)keyeq_753;
            __auto_type __ps_77 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_78 = (map_hyeq_hyloop((void *)(intptr_t)(iter_752), (void *)(intptr_t)(__ps_77), (void *)(intptr_t)(keyeq_753), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_754 = __ps_78;
            (void)result_754;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_96) {
            bool __t97;
            {
                ...
                bool __t98;
                if ((t1_995) == (INT64_C(0))) {
                    __t98 = (t2_996) == (INT64_C(0));
                } else {
                    bool __t99;
                    if ((t2_996) == (INT64_C(0))) {
                        __t99 = false;
                    } else {
                        __auto_type __ps_100 = (cons_hyeq_hygo(t1_995, t2_996));
                        if (tur_panicking) return (bool){0};
                        __t99 = __ps_100;
                    }
                    __t98 = __t99;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_106) {
            ...
            int64_t __t107;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1011 = (int64_t)(intptr_t)(__ps_111);
                (void)out_1011;
                __t107 = out_1011;
            }
            __t105 = __t107;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t116;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1086 = __ps_118;
            (void)iter_1086;
            __auto_type __ps_119 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_120 = (hamt_slkeyeq((void *)(intptr_t)(__ps_119)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1087 = __ps_120;
            (void)keyeq_1087;
            __auto_type __ps_121 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_122 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1086), (void *)(intptr_t)(__ps_121), (void *)(intptr_t)(keyeq_1087)));
            if (tur_panicking) return (bool){0};
            bool result_1088 = __ps_122;
            (void)result_1088;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t143;
        {
            ...
            {
                __auto_type __ps_145 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1215));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1216 = __ps_145;
                (void)_un_unv_1216;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t148;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1265 = __ps_149;
            (void)r_1265;
            int64_t __t150;
            __auto_type __ps_151 = (schema_hydecode_hyok_qu(r_1265));
            if (tur_panicking) return (int64_t){0};
            if (__ps_151) {
                __auto_type __ps_152 = (schema_hydecode_hyvalue(r_1265));
                if (tur_panicking) return (int64_t){0};
                __t150 = __ps_152;
            } else {
                __auto_type __ps_153 = (schema_hydecode_hyerrors(r_1265));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_157 = (__inst_TestFunctor_fmap_option(__ps_156, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1293 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1299 = __ps_157;
            (void)result_1299;
            __auto_type __ps_158 = (_un_unopt_unsome_qu(result_1299));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_158) ? "true" : "false");
            __auto_type __ps_159 = (__opt_unwrap(result_1299));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_159));
        }
        {
            int64_t delta_1300 = INT64_C(100);
            (void)delta_1300;
            {
                __auto_type __ps_160 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t162 = malloc(sizeof(void *) + sizeof(struct __env_1304));
                *(void (**)(void *))__t162 = drop_glue___env_1304;
                struct __env_1304 *__t161 = (struct __env_1304 *)((char *)__t162 + sizeof(void *));
                __t161->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1302;
                __t161->delta = delta_1300;
                void *__t163 = __t161;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1307 = __ps_165;
                (void)result_1307;
                __auto_type __ps_166 = (_un_unopt_unsome_qu(result_1307));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_166) ? "true" : "false");
                __auto_type __ps_167 = (__opt_unwrap(result_1307));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_167));
            }
        }
        {
            int64_t delta_1308 = INT64_C(100);
            (void)delta_1308;
            __auto_type __ps_168 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t170 = malloc(sizeof(void *) + sizeof(struct __env_1312));
            *(void (**)(void *))__t170 = drop_glue___env_1312;
            struct __env_1312 *__t169 = (struct __env_1312 *)((char *)__t170 + sizeof(void *));
            __t169->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1310;
            __t169->delta = delta_1308;
            void *__t171 = __t169;
