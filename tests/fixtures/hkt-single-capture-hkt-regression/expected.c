...
static int64_t __poly_1444(void * __poly_env_1445, int64_t __poly_x0_1447) {
        int64_t __ps_44 = (__inc(__poly_x0_1447));
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1194 = __ps_125;
            (void)iter_1194;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1195 = __ps_127;
            (void)keyeq_1195;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1194), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1195)));
            if (tur_panicking) return ((bool)0);
            bool result_1196 = __ps_129;
            (void)result_1196;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1323));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1324 = __ps_152;
                (void)_un_unv_1324;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t156;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1374 = __ps_157;
            (void)r_1374;
            int64_t __t158;
            bool __ps_159 = (schema_hydecode_hyok_qu(r_1374));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_159) {
                int64_t __ps_160 = (schema_hydecode_hyvalue(r_1374));
                if (tur_panicking) return ((int64_t)0);
                __t158 = __ps_160;
            } else {
                int64_t __ps_161 = (schema_hydecode_hyerrors(r_1374));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_173 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_174 = (__inst_TestFunctor_fmap_option(__ps_173, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1444 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1450 = __ps_174;
            (void)result_1450;
            bool __ps_175 = (_un_unopt_unsome_qu(result_1450));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_175) ? "true" : "false");
            int64_t __ps_176 = (__opt_unwrap(result_1450));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_176));
        }
        {
            ...
            (void)delta_1451;
            {
                int64_t __ps_177 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t179 = malloc(sizeof(void *) + sizeof(struct __env_1455));
                *(void (**)(void *))__t179 = drop_glue___env_1455;
                struct __env_1455 *__t178 = (struct __env_1455 *)((char *)__t179 + sizeof(void *));
                __t178->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1453;
                __t178->delta = delta_1451;
                void *__t180 = __t178;
                void *__t181 = (void *)(intptr_t)(__t180);
                int64_t __ps_182 = (__inst_TestFunctor_fmap_option(__ps_177, (tur_poly_fn_t){ __t181, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t181)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1458 = __ps_182;
                (void)result_1458;
                bool __ps_183 = (_un_unopt_unsome_qu(result_1458));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_183) ? "true" : "false");
                int64_t __ps_184 = (__opt_unwrap(result_1458));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_184));
            }
        }
        {
            ...
            (void)delta_1459;
            int64_t __ps_185 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t187 = malloc(sizeof(void *) + sizeof(struct __env_1463));
            *(void (**)(void *))__t187 = drop_glue___env_1463;
            struct __env_1463 *__t186 = (struct __env_1463 *)((char *)__t187 + sizeof(void *));
            __t186->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1461;
            __t186->delta = delta_1459;
            void *__t188 = __t186;
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_191 = (_un_unopt_unsome_qu(__ps_190));
            /* panic-return-signal: ret ctype unknown; no propagation here */
