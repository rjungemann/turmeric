...
static int64_t __poly_1618(void *, int64_t);
...
static int64_t __poly_1618(void * __poly_env_1619, int64_t __poly_x0_1621) {
        int64_t __ps_128 = (__inc(__poly_x0_1621));
        if (tur_panicking) return ((int64_t)0);
        return __ps_128;
}

struct __env_1629 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1627(void * __env_p_1630, int64_t x) {
        struct __env_1629 *__env___env_1629 = (struct __env_1629 *)__env_p_1630;
        return (x) + (__env___env_1629->delta);
}

struct __env_1637 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static void drop_glue___env_1637(void *__p) {
    struct __env_1637 *__e = (struct __env_1637 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1635(void * __env_p_1638, int64_t x) {
        struct __env_1637 *__env___env_1637 = (struct __env_1637 *)__env_p_1638;
        return (x) + (__env___env_1637->delta);
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_999 = __ps_165;
        bool __ps_166 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_998, (void *)(intptr_t)(k_999), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_166;
        if (__t1) {
            int64_t __ps_167 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_168 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_998, (void *)(intptr_t)(k_999), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t170;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1003 = __ps_172;
            (void)iter_1003;
            void * __ps_173 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_174 = (hamt_slkeyeq((void *)(intptr_t)(__ps_173)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1004 = __ps_174;
            (void)keyeq_1004;
            void * __ps_175 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_176 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1003), (void *)(intptr_t)(__ps_175), (void *)(intptr_t)(keyeq_1004), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1005 = __ps_176;
            (void)result_1005;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_195) {
            bool __t196;
            {
                ...
                (void)t2_1284;
                bool __t197;
                bool __ps_198 = (tnil_qu(t1_1283));
                if (tur_panicking) return ((bool)0);
                if (__ps_198) {
                    bool __ps_199 = (tnil_qu(t2_1284));
                    if (tur_panicking) return ((bool)0);
                    __t197 = __ps_199;
                } else {
                    bool __t200;
                    bool __ps_201 = (tnil_qu(t2_1284));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_201) {
                        __t200 = false;
                    } else {
                        bool __ps_202 = (cons_hyeq_hygo(t1_1283, t2_1284));
                        if (tur_panicking) return ((bool)0);
                        __t200 = __ps_202;
                    }
                    __t197 = __t200;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_208) {
            ...
            int64_t __t209;
            {
                ...
                int64_t out_1299 = (int64_t)(intptr_t)(__ps_213);
                (void)out_1299;
                __t209 = out_1299;
            }
            __t207 = __t209;
        ...
        if (__ps_217) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1370 = __ps_218;
                (void)h_1370;
                void * __ps_219 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1371 = __ps_219;
                (void)k_1371;
                bool __ps_220 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1370, (void *)(intptr_t)(k_1371), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_220) {
                    void * __t221 = iter;
                    void * __t222 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t224;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1374 = __ps_226;
            (void)iter_1374;
            void * __ps_227 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_228 = (hamt_slkeyeq((void *)(intptr_t)(__ps_227)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1375 = __ps_228;
            (void)keyeq_1375;
            void * __ps_229 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_230 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1374), (void *)(intptr_t)(__ps_229), (void *)(intptr_t)(keyeq_1375)));
            if (tur_panicking) return ((bool)0);
            bool result_1376 = __ps_230;
            (void)result_1376;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t251;
        {
            ...
            {
                tur_adt_Vec__int * __ps_253 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1506));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1507 = __ps_253;
                (void)_un_unv_1507;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t257;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1557 = __ps_258;
            (void)r_1557;
            int64_t __t259;
            bool __ps_260 = (schema_hydecode_hyok_qu(r_1557));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_260) {
                int64_t __ps_261 = (schema_hydecode_hyvalue(r_1557));
                if (tur_panicking) return ((int64_t)0);
                __t259 = __ps_261;
            } else {
                int64_t __ps_262 = (schema_hydecode_hyerrors(r_1557));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t265;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1608 = __ps_266;
            (void)m_1608;
            tur_frame __frame_267;
            tur_frame_init(&__frame_267, NULL);
            struct __defer_env_268 __t270 = {.m = m_1608};
...
static int64_t __inc(int64_t x) {
        return (x) + (INT64_C(1));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_278 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_279 = (__inst_TestFunctor_fmap_option(__ps_278, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1618 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1624 = __ps_279;
            (void)result_1624;
            bool __ps_280 = (_un_unopt_unsome_qu(result_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_280) ? "true" : "false");
            int64_t __ps_281 = (__opt_unwrap(result_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_281));
        }
        {
            int64_t delta_1625 = INT64_C(100);
            (void)delta_1625;
            {
                int64_t __ps_282 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t284 = malloc(sizeof(void *) + sizeof(struct __env_1629));
                *(void (**)(void *))__t284 = drop_glue___env_1629;
                struct __env_1629 *__t283 = (struct __env_1629 *)((char *)__t284 + sizeof(void *));
                __t283->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1627;
                __t283->delta = delta_1625;
                TUR_REGION_NOTE_WORDS(&(__t283->delta), sizeof(__t283->delta));
                void *__t285 = __t283;
                void *__t286 = (void *)(intptr_t)(__t285);
                int64_t __ps_287 = (__inst_TestFunctor_fmap_option(__ps_282, (tur_poly_fn_t){ __t286, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t286)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1632 = __ps_287;
                (void)result_1632;
                bool __ps_288 = (_un_unopt_unsome_qu(result_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_288) ? "true" : "false");
                int64_t __ps_289 = (__opt_unwrap(result_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_289));
            }
        }
        {
            int64_t delta_1633 = INT64_C(100);
            (void)delta_1633;
            int64_t __ps_290 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t292 = malloc(sizeof(void *) + sizeof(struct __env_1637));
            *(void (**)(void *))__t292 = drop_glue___env_1637;
            struct __env_1637 *__t291 = (struct __env_1637 *)((char *)__t292 + sizeof(void *));
            __t291->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1635;
            __t291->delta = delta_1633;
            TUR_REGION_NOTE_WORDS(&(__t291->delta), sizeof(__t291->delta));
            void *__t293 = __t291;
            void *__t294 = (void *)(intptr_t)(__t293);
            int64_t __ps_295 = (__inst_TestFunctor_fmap_option(__ps_290, (tur_poly_fn_t){ __t294, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t294)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_296 = (_un_unopt_unsome_qu(__ps_295));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_298 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
