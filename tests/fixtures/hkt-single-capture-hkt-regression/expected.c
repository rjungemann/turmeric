...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_173 = (__inst_TestFunctor_fmap_option(__ps_172, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1618 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1624 = __ps_173;
            (void)result_1624;
            bool __ps_174 = (_un_unopt_unsome_qu(result_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_174) ? "true" : "false");
            int64_t __ps_175 = (__opt_unwrap(result_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_175));
        }
        {
            ...
            (void)delta_1625;
            {
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t178 = malloc(sizeof(void *) + sizeof(struct __env_1629));
                *(void (**)(void *))__t178 = drop_glue___env_1629;
                struct __env_1629 *__t177 = (struct __env_1629 *)((char *)__t178 + sizeof(void *));
                __t177->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1627;
                __t177->delta = delta_1625;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1632 = __ps_181;
                (void)result_1632;
                bool __ps_182 = (_un_unopt_unsome_qu(result_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_182) ? "true" : "false");
                int64_t __ps_183 = (__opt_unwrap(result_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_183));
            }
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t186 = malloc(sizeof(void *) + sizeof(struct __env_1637));
            *(void (**)(void *))__t186 = drop_glue___env_1637;
            struct __env_1637 *__t185 = (struct __env_1637 *)((char *)__t186 + sizeof(void *));
            __t185->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1635;
            __t185->delta = delta_1633;
