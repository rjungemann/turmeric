...
static int64_t __poly_1338(void *, int64_t);
...
static int64_t __poly_1338(void * __poly_env_1339, int64_t __poly_x0_1341) {
        int64_t __ps_42 = (__inc(__poly_x0_1341));
        if (tur_panicking) return ((int64_t)0);
        return __ps_42;
}

struct __env_1349 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1347(void * __env_p_1350, int64_t x) {
        struct __env_1349 *__env___env_1349 = (struct __env_1349 *)__env_p_1350;
        return (x) + (__env___env_1349->delta);
}

struct __env_1357 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1355(void * __env_p_1358, int64_t x) {
        ...
        return (x) + (__env___env_1357->delta);
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_74 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_792, (void *)(intptr_t)(k_793), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t76;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_797 = __ps_78;
            (void)iter_797;
            void * __ps_79 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_80 = (hamt_slkeyeq((void *)(intptr_t)(__ps_79)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_798 = __ps_80;
            (void)keyeq_798;
            void * __ps_81 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_82 = (map_hyeq_hyloop((void *)(intptr_t)(iter_797), (void *)(intptr_t)(__ps_81), (void *)(intptr_t)(keyeq_798), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_799 = __ps_82;
            (void)result_799;
        ...
        if (__ps_100) {
            bool __t101;
            {
                ...
                if ((t1_1040) == (INT64_C(0))) {
                    __t102 = (t2_1041) == (INT64_C(0));
                } else {
                    bool __t103;
                    if ((t2_1041) == (INT64_C(0))) {
                        __t103 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1040, t2_1041));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_104;
                    }
                    __t102 = __t103;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1056 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1056;
                __t111 = out_1056;
            }
            __t109 = __t111;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t120;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1131 = __ps_122;
            (void)iter_1131;
            void * __ps_123 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_124 = (hamt_slkeyeq((void *)(intptr_t)(__ps_123)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1132 = __ps_124;
            (void)keyeq_1132;
            void * __ps_125 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_126 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1131), (void *)(intptr_t)(__ps_125), (void *)(intptr_t)(keyeq_1132)));
            if (tur_panicking) return ((bool)0);
            bool result_1133 = __ps_126;
            (void)result_1133;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t147;
        {
            ...
            {
                tur_adt_Vec__int * __ps_149 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1260));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1261 = __ps_149;
                (void)_un_unv_1261;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_160 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_161 = (__inst_TestFunctor_fmap_option(__ps_160, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1338 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1344 = __ps_161;
            (void)result_1344;
            bool __ps_162 = (_un_unopt_unsome_qu(result_1344));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_162) ? "true" : "false");
            int64_t __ps_163 = (__opt_unwrap(result_1344));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_163));
        }
        {
            int64_t delta_1345 = INT64_C(100);
            (void)delta_1345;
            {
                int64_t __ps_164 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t166 = malloc(sizeof(void *) + sizeof(struct __env_1349));
                *(void (**)(void *))__t166 = drop_glue___env_1349;
                struct __env_1349 *__t165 = (struct __env_1349 *)((char *)__t166 + sizeof(void *));
                __t165->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1347;
                __t165->delta = delta_1345;
                void *__t167 = __t165;
                void *__t168 = (void *)(intptr_t)(__t167);
                int64_t __ps_169 = (__inst_TestFunctor_fmap_option(__ps_164, (tur_poly_fn_t){ __t168, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t168)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1352 = __ps_169;
                (void)result_1352;
                bool __ps_170 = (_un_unopt_unsome_qu(result_1352));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_170) ? "true" : "false");
                int64_t __ps_171 = (__opt_unwrap(result_1352));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_171));
            }
        }
        {
            int64_t delta_1353 = INT64_C(100);
            (void)delta_1353;
            int64_t __ps_172 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t174 = malloc(sizeof(void *) + sizeof(struct __env_1357));
            *(void (**)(void *))__t174 = drop_glue___env_1357;
            struct __env_1357 *__t173 = (struct __env_1357 *)((char *)__t174 + sizeof(void *));
            __t173->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1355;
            __t173->delta = delta_1353;
            void *__t175 = __t173;
            void *__t176 = (void *)(intptr_t)(__t175);
            int64_t __ps_177 = (__inst_TestFunctor_fmap_option(__ps_172, (tur_poly_fn_t){ __t176, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t176)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_178 = (_un_unopt_unsome_qu(__ps_177));
            /* panic-return-signal: ret ctype unknown; no propagation here */
