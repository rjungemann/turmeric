...
static int64_t __poly_1273(void *, int64_t);
static int64_t __fn_1282(void *, int64_t);
...
static int64_t __poly_1273(void * __poly_env_1274, int64_t __poly_x0_1276) {
        return __inc(__poly_x0_1276);
}

struct __env_1284 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1282(void * __env_p_1285, int64_t x) {
        struct __env_1284 *__env___env_1284 = (struct __env_1284 *)__env_p_1285;
        return (x) + (__env___env_1284->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1279 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1273 });
            (void)result_1279;
            puts((_un_unopt_unsome_qu(result_1279)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1279)));
        }
        {
            int64_t delta_1280 = INT64_C(100);
            (void)delta_1280;
            {
                struct __env_1284 *__t50 = (struct __env_1284 *)malloc(sizeof(struct __env_1284));
                __t50->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1282;
                __t50->delta = delta_1280;
                void *__t51 = __t50;
                void *__t52 = (void *)(intptr_t)(__t51);
                int64_t result_1287 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t52, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t52)) });
                (void)result_1287;
                puts((_un_unopt_unsome_qu(result_1287)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1287)));
            }
        }
        {
            int64_t delta_1288 = INT64_C(100);
            (void)delta_1288;
            struct __env_1292 *__t53 = (struct __env_1292 *)malloc(sizeof(struct __env_1292));
            __t53->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1290;
            __t53->delta = delta_1288;
            void *__t54 = __t53;
