...
static int64_t __poly_1279(void *, int64_t);
...
static int64_t __poly_1279(void * __poly_env_1280, int64_t __poly_x0_1282) {
        __auto_type __ps_40 = (__inc(__poly_x0_1282));
        if (tur_panicking) return (int64_t){0};
        return __ps_40;
}

struct __env_1290 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1288(void * __env_p_1291, int64_t x) {
        struct __env_1290 *__env___env_1290 = (struct __env_1290 *)__env_p_1291;
        return (x) + (__env___env_1290->delta);
}

struct __env_1298 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1296(void * __env_p_1299, int64_t x) {
        struct __env_1298 *__env___env_1298 = (struct __env_1298 *)__env_p_1299;
        return (x) + (__env___env_1298->delta);
}
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_107) {
            bool __t108;
            {
                ...
                bool __t109;
                if ((t1_981) == (INT64_C(0))) {
                    __t109 = (t2_982) == (INT64_C(0));
                } else {
                    bool __t110;
                    if ((t2_982) == (INT64_C(0))) {
                        __t110 = false;
                    } else {
                        __auto_type __ps_111 = (cons_hyeq_hygo(t1_981, t2_982));
                        if (tur_panicking) return (bool){0};
                        __t110 = __ps_111;
                    }
                    __t109 = __t110;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_990 = (int64_t)(intptr_t)(__ps_119);
                (void)out_990;
                __t114 = out_990;
            }
            __t112 = __t114;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_121) {
            ...
            int64_t __t122;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_997 = (int64_t)(intptr_t)(__ps_126);
                (void)out_997;
                __t122 = out_997;
            }
            __t120 = __t122;
        ...
        if (__ps_131) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1068 = __ps_132;
                (void)h_1068;
                __auto_type __ps_133 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1069 = __ps_133;
                (void)k_1069;
                __auto_type __ps_134 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1068, (void *)(intptr_t)(k_1069), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_134) {
                    void * __t135 = iter;
                    void * __t136 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t138;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1072 = __ps_140;
            (void)iter_1072;
            __auto_type __ps_141 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_142 = (hamt_slkeyeq((void *)(intptr_t)(__ps_141)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1073 = __ps_142;
            (void)keyeq_1073;
            __auto_type __ps_143 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_144 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1072), (void *)(intptr_t)(__ps_143), (void *)(intptr_t)(keyeq_1073)));
            if (tur_panicking) return (bool){0};
            bool result_1074 = __ps_144;
            (void)result_1074;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t165;
        {
            ...
            {
                __auto_type __ps_167 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1201));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1202 = __ps_167;
                (void)_un_unv_1202;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t170;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1251 = __ps_171;
            (void)r_1251;
            int64_t __t172;
            __auto_type __ps_173 = (schema_hydecode_hyok_qu(r_1251));
            if (tur_panicking) return (int64_t){0};
            if (__ps_173) {
                __auto_type __ps_174 = (schema_hydecode_hyvalue(r_1251));
                if (tur_panicking) return (int64_t){0};
                __t172 = __ps_174;
            } else {
                __auto_type __ps_175 = (schema_hydecode_hyerrors(r_1251));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        {
            __auto_type __ps_178 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_179 = (__inst_TestFunctor_fmap_option(__ps_178, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1279 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1285 = __ps_179;
            (void)result_1285;
            __auto_type __ps_180 = (_un_unopt_unsome_qu(result_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_180) ? "true" : "false");
            __auto_type __ps_181 = (__opt_unwrap(result_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_181));
        }
        {
            int64_t delta_1286 = INT64_C(100);
            (void)delta_1286;
            {
                __auto_type __ps_182 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                struct __env_1290 *__t183 = (struct __env_1290 *)malloc(sizeof(struct __env_1290));
                __t183->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1288;
                __t183->delta = delta_1286;
                void *__t184 = __t183;
                void *__t185 = (void *)(intptr_t)(__t184);
                __auto_type __ps_186 = (__inst_TestFunctor_fmap_option(__ps_182, (tur_poly_fn_t){ __t185, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t185)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1293 = __ps_186;
                (void)result_1293;
                __auto_type __ps_187 = (_un_unopt_unsome_qu(result_1293));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_187) ? "true" : "false");
                __auto_type __ps_188 = (__opt_unwrap(result_1293));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_188));
            }
        }
        {
            int64_t delta_1294 = INT64_C(100);
            (void)delta_1294;
            __auto_type __ps_189 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            struct __env_1298 *__t190 = (struct __env_1298 *)malloc(sizeof(struct __env_1298));
            __t190->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1296;
            __t190->delta = delta_1294;
            void *__t191 = __t190;
            void *__t192 = (void *)(intptr_t)(__t191);
            __auto_type __ps_193 = (__inst_TestFunctor_fmap_option(__ps_189, (tur_poly_fn_t){ __t192, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t192)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_194 = (_un_unopt_unsome_qu(__ps_193));
            /* panic-return-signal: ret ctype unknown; no propagation here */
