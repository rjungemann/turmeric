...
static int64_t __poly_1276(void *, int64_t);
...
static int64_t __poly_1276(void * __poly_env_1277, int64_t __poly_x0_1279) {
        __auto_type __ps_43 = (__inc(__poly_x0_1279));
        if (tur_panicking) return (int64_t){0};
        return __ps_43;
}

struct __env_1287 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1285(void * __env_p_1288, int64_t x) {
        struct __env_1287 *__env___env_1287 = (struct __env_1287 *)__env_p_1288;
        return (x) + (__env___env_1287->delta);
}
        ...
        if (__ps_134) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1065 = __ps_135;
                (void)h_1065;
                __auto_type __ps_136 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1066 = __ps_136;
                (void)k_1066;
                __auto_type __ps_137 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1065, (void *)(intptr_t)(k_1066), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_137) {
                    void * __t138 = iter;
                    void * __t139 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t141;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1069 = __ps_143;
            (void)iter_1069;
            __auto_type __ps_144 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_145 = (hamt_slkeyeq((void *)(intptr_t)(__ps_144)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1070 = __ps_145;
            (void)keyeq_1070;
            __auto_type __ps_146 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_147 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1069), (void *)(intptr_t)(__ps_146), (void *)(intptr_t)(keyeq_1070)));
            if (tur_panicking) return (bool){0};
            bool result_1071 = __ps_147;
            (void)result_1071;
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            __auto_type __ps_183 = (__inst_TestFunctor_fmap_option(__ps_182, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1276 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1282 = __ps_183;
            (void)result_1282;
            __auto_type __ps_184 = (_un_unopt_unsome_qu(result_1282));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_184) ? "true" : "false");
            __auto_type __ps_185 = (__opt_unwrap(result_1282));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_185));
        }
        {
            int64_t delta_1283 = INT64_C(100);
            (void)delta_1283;
            {
                __auto_type __ps_186 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                struct __env_1287 *__t187 = (struct __env_1287 *)malloc(sizeof(struct __env_1287));
                __t187->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1285;
                __t187->delta = delta_1283;
                void *__t188 = __t187;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1290 = __ps_190;
                (void)result_1290;
                __auto_type __ps_191 = (_un_unopt_unsome_qu(result_1290));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_191) ? "true" : "false");
                __auto_type __ps_192 = (__opt_unwrap(result_1290));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_192));
            }
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            struct __env_1295 *__t194 = (struct __env_1295 *)malloc(sizeof(struct __env_1295));
            __t194->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1293;
            __t194->delta = delta_1291;
            void *__t195 = __t194;
