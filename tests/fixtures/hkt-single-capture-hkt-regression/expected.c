...
static int64_t __poly_1475(void *, int64_t);
...
static int64_t __poly_1475(void * __poly_env_1476, int64_t __poly_x0_1478) {
        int64_t __ps_92 = (__inc(__poly_x0_1478));
        if (tur_panicking) return ((int64_t)0);
        return __ps_92;
}

struct __env_1486 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1484(void * __env_p_1487, int64_t x) {
        ...
        return (x) + (__env___env_1486->delta);
}

struct __env_1494 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static void drop_glue___env_1494(void *__p) {
    struct __env_1494 *__e = (struct __env_1494 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1492(void * __env_p_1495, int64_t x) {
        struct __env_1494 *__env___env_1494 = (struct __env_1494 *)__env_p_1495;
        return (x) + (__env___env_1494->delta);
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_846 = __ps_125;
        bool __ps_126 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_845, (void *)(intptr_t)(k_846), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_126;
        if (__t1) {
            int64_t __ps_127 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_128 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_845, (void *)(intptr_t)(k_846), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t130;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_850 = __ps_132;
            (void)iter_850;
            void * __ps_133 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_134 = (hamt_slkeyeq((void *)(intptr_t)(__ps_133)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_851 = __ps_134;
            (void)keyeq_851;
            void * __ps_135 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_136 = (map_hyeq_hyloop((void *)(intptr_t)(iter_850), (void *)(intptr_t)(__ps_135), (void *)(intptr_t)(keyeq_851), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_852 = __ps_136;
            (void)result_852;
        ...
        if (__ps_155) {
            bool __t156;
            {
                ...
                if ((t1_1130) == (INT64_C(0))) {
                    __t157 = (t2_1131) == (INT64_C(0));
                } else {
                    bool __t158;
                    if ((t2_1131) == (INT64_C(0))) {
                        __t158 = false;
                    } else {
                        bool __ps_159 = (cons_hyeq_hygo(t1_1130, t2_1131));
                        if (tur_panicking) return ((bool)0);
                        __t158 = __ps_159;
                    }
                    __t157 = __t158;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_165) {
            ...
            int64_t __t166;
            {
                ...
                int64_t out_1146 = (int64_t)(intptr_t)(__ps_170);
                (void)out_1146;
                __t166 = out_1146;
            }
            __t164 = __t166;
        ...
        if (__ps_175) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1217 = __ps_176;
                (void)h_1217;
                void * __ps_177 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1218 = __ps_177;
                (void)k_1218;
                bool __ps_178 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1217, (void *)(intptr_t)(k_1218), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_178) {
                    void * __t179 = iter;
                    void * __t180 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t182;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1221 = __ps_184;
            (void)iter_1221;
            void * __ps_185 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_186 = (hamt_slkeyeq((void *)(intptr_t)(__ps_185)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1222 = __ps_186;
            (void)keyeq_1222;
            void * __ps_187 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_188 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1221), (void *)(intptr_t)(__ps_187), (void *)(intptr_t)(keyeq_1222)));
            if (tur_panicking) return ((bool)0);
            bool result_1223 = __ps_188;
            (void)result_1223;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t209;
        {
            ...
            {
                tur_adt_Vec__int * __ps_211 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1353));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1354 = __ps_211;
                (void)_un_unv_1354;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t215;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1404 = __ps_216;
            (void)r_1404;
            int64_t __t217;
            bool __ps_218 = (schema_hydecode_hyok_qu(r_1404));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_218) {
                int64_t __ps_219 = (schema_hydecode_hyvalue(r_1404));
                if (tur_panicking) return ((int64_t)0);
                __t217 = __ps_219;
            } else {
                int64_t __ps_220 = (schema_hydecode_hyerrors(r_1404));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_233 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_234 = (__inst_TestFunctor_fmap_option(__ps_233, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1475 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1481 = __ps_234;
            (void)result_1481;
            bool __ps_235 = (_un_unopt_unsome_qu(result_1481));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_235) ? "true" : "false");
            int64_t __ps_236 = (__opt_unwrap(result_1481));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_236));
        }
        {
            int64_t delta_1482 = INT64_C(100);
            (void)delta_1482;
            {
                int64_t __ps_237 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t239 = malloc(sizeof(void *) + sizeof(struct __env_1486));
                *(void (**)(void *))__t239 = drop_glue___env_1486;
                struct __env_1486 *__t238 = (struct __env_1486 *)((char *)__t239 + sizeof(void *));
                __t238->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1484;
                __t238->delta = delta_1482;
                TUR_REGION_NOTE_WORDS(&(__t238->delta), sizeof(__t238->delta));
                void *__t240 = __t238;
                void *__t241 = (void *)(intptr_t)(__t240);
                int64_t __ps_242 = (__inst_TestFunctor_fmap_option(__ps_237, (tur_poly_fn_t){ __t241, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t241)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1489 = __ps_242;
                (void)result_1489;
                bool __ps_243 = (_un_unopt_unsome_qu(result_1489));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_243) ? "true" : "false");
                int64_t __ps_244 = (__opt_unwrap(result_1489));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_244));
            }
        }
        {
            int64_t delta_1490 = INT64_C(100);
            (void)delta_1490;
            int64_t __ps_245 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t247 = malloc(sizeof(void *) + sizeof(struct __env_1494));
            *(void (**)(void *))__t247 = drop_glue___env_1494;
            struct __env_1494 *__t246 = (struct __env_1494 *)((char *)__t247 + sizeof(void *));
            __t246->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1492;
            __t246->delta = delta_1490;
            TUR_REGION_NOTE_WORDS(&(__t246->delta), sizeof(__t246->delta));
            void *__t248 = __t246;
            void *__t249 = (void *)(intptr_t)(__t248);
            int64_t __ps_250 = (__inst_TestFunctor_fmap_option(__ps_245, (tur_poly_fn_t){ __t249, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t249)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_251 = (_un_unopt_unsome_qu(__ps_250));
            /* panic-return-signal: ret ctype unknown; no propagation here */
