...
static int64_t __poly_912(void *, int64_t);
...
static int64_t __poly_912(void * __poly_env_913, int64_t __poly_x0_915) {
        return __inc(__poly_x0_915);
}

struct __env_923 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_921(void * __env_p_924, int64_t x) {
        struct __env_923 *__env___env_923 = (struct __env_923 *)__env_p_924;
        return (x) + (__env___env_923->delta);
}

struct __env_931 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_929(void * __env_p_932, int64_t x) {
        struct __env_931 *__env___env_931 = (struct __env_931 *)__env_p_932;
        return (x) + (__env___env_931->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_918 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_912 });
            (void)result_918;
            puts((_un_unopt_unsome_qu(result_918)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_918)));
        }
        {
            int64_t delta_919 = INT64_C(100);
            (void)delta_919;
            {
                struct __env_923 *__t29 = (struct __env_923 *)malloc(sizeof(struct __env_923));
                __t29->__fn = (tur_thunk_int64_t_int64_t_t)__fn_921;
                __t29->delta = delta_919;
                void *__t30 = __t29;
                void *__t31 = (void *)(intptr_t)(__t30);
                int64_t result_926 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t31, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t31)) });
                (void)result_926;
                puts((_un_unopt_unsome_qu(result_926)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_926)));
            }
        }
        {
            int64_t delta_927 = INT64_C(100);
            (void)delta_927;
            struct __env_931 *__t32 = (struct __env_931 *)malloc(sizeof(struct __env_931));
            __t32->__fn = (tur_thunk_int64_t_int64_t_t)__fn_929;
            __t32->delta = delta_927;
            void *__t33 = __t32;
            void *__t34 = (void *)(intptr_t)(__t33);
            puts((_un_unopt_unsome_qu(__inst_TestFunctor_fmap_option(__opt_none(), (tur_poly_fn_t){ __t34, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t34)) }))) ? "true" : "false");
        }
        int64_t __t35;
        __t35 = INT64_C(0);
        return (int)__t35;
