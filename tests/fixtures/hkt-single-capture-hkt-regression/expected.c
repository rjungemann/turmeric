...
static int64_t __poly_1287(void *, int64_t);
...
static int64_t __poly_1287(void * __poly_env_1288, int64_t __poly_x0_1290) {
        __auto_type __ps_40 = (__inc(__poly_x0_1290));
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_68) {
            bool __t69;
            {
                ...
                (void)k_746;
                bool __t72;
                __auto_type __ps_73 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_745, (void *)(intptr_t)(k_746), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_73) {
                    bool __t74;
                    __auto_type __ps_75 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_76 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_745, (void *)(intptr_t)(k_746), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_750 = __ps_81;
            (void)iter_750;
            __auto_type __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return (bool){0};
            void * keyeq_751 = __ps_83;
            (void)keyeq_751;
            __auto_type __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_750), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_751), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_752 = __ps_85;
            (void)result_752;
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_175 = (__inst_TestFunctor_fmap_option(__ps_174, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1287 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1293 = __ps_175;
            (void)result_1293;
            __auto_type __ps_176 = (_un_unopt_unsome_qu(result_1293));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            __auto_type __ps_177 = (__opt_unwrap(result_1293));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
        }
        {
            ...
            (void)delta_1294;
            {
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                struct __env_1298 *__t179 = (struct __env_1298 *)malloc(sizeof(struct __env_1298));
                __t179->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1296;
                __t179->delta = delta_1294;
                void *__t180 = __t179;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1301 = __ps_182;
                (void)result_1301;
                __auto_type __ps_183 = (_un_unopt_unsome_qu(result_1301));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_183) ? "true" : "false");
                __auto_type __ps_184 = (__opt_unwrap(result_1301));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_184));
            }
        }
        {
            int64_t delta_1302 = INT64_C(100);
            (void)delta_1302;
            __auto_type __ps_185 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            struct __env_1306 *__t186 = (struct __env_1306 *)malloc(sizeof(struct __env_1306));
            __t186->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1304;
            __t186->delta = delta_1302;
            void *__t187 = __t186;
