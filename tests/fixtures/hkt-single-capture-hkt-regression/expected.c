        ...
        if (__ps_195) {
            bool __t196;
            {
                ...
                if ((t1_1283) == (INT64_C(0))) {
                    __t197 = (t2_1284) == (INT64_C(0));
                } else {
                    bool __t198;
                    if ((t2_1284) == (INT64_C(0))) {
                        __t198 = false;
                    } else {
                        bool __ps_199 = (cons_hyeq_hygo(t1_1283, t2_1284));
                        if (tur_panicking) return ((bool)0);
                        __t198 = __ps_199;
                    }
                    __t197 = __t198;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_205) {
            ...
            int64_t __t206;
            {
                ...
                int64_t out_1299 = (int64_t)(intptr_t)(__ps_210);
                (void)out_1299;
                __t206 = out_1299;
            }
            __t204 = __t206;
        ...
        if (__ps_215) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1370 = __ps_216;
                (void)h_1370;
                void * __ps_217 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1371 = __ps_217;
                (void)k_1371;
                bool __ps_218 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1370, (void *)(intptr_t)(k_1371), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_218) {
                    void * __t219 = iter;
                    void * __t220 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t222;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1374 = __ps_224;
            (void)iter_1374;
            void * __ps_225 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_226 = (hamt_slkeyeq((void *)(intptr_t)(__ps_225)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1375 = __ps_226;
            (void)keyeq_1375;
            void * __ps_227 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_228 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1374), (void *)(intptr_t)(__ps_227), (void *)(intptr_t)(keyeq_1375)));
            if (tur_panicking) return ((bool)0);
            bool result_1376 = __ps_228;
            (void)result_1376;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t249;
        {
            ...
            {
                tur_adt_Vec__int * __ps_251 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1506));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1507 = __ps_251;
                (void)_un_unv_1507;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t255;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1557 = __ps_256;
            (void)r_1557;
            int64_t __t257;
            bool __ps_258 = (schema_hydecode_hyok_qu(r_1557));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_258) {
                int64_t __ps_259 = (schema_hydecode_hyvalue(r_1557));
                if (tur_panicking) return ((int64_t)0);
                __t257 = __ps_259;
            } else {
                int64_t __ps_260 = (schema_hydecode_hyerrors(r_1557));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t263;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1608 = __ps_264;
            (void)m_1608;
            tur_frame __frame_265;
            tur_frame_init(&__frame_265, NULL);
            struct __defer_env_266 __t268 = {.m = m_1608};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_276 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_277 = (__inst_TestFunctor_fmap_option(__ps_276, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1618 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1624 = __ps_277;
            (void)result_1624;
            bool __ps_278 = (_un_unopt_unsome_qu(result_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_278) ? "true" : "false");
            int64_t __ps_279 = (__opt_unwrap(result_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_279));
        }
        {
            ...
            (void)delta_1625;
            {
                int64_t __ps_280 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t282 = malloc(sizeof(void *) + sizeof(struct __env_1629));
                *(void (**)(void *))__t282 = drop_glue___env_1629;
                struct __env_1629 *__t281 = (struct __env_1629 *)((char *)__t282 + sizeof(void *));
                __t281->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1627;
                __t281->delta = delta_1625;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1632 = __ps_285;
                (void)result_1632;
                bool __ps_286 = (_un_unopt_unsome_qu(result_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_286) ? "true" : "false");
                int64_t __ps_287 = (__opt_unwrap(result_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_287));
            }
        }
        {
            ...
            (void)delta_1633;
            int64_t __ps_288 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t290 = malloc(sizeof(void *) + sizeof(struct __env_1637));
            *(void (**)(void *))__t290 = drop_glue___env_1637;
            struct __env_1637 *__t289 = (struct __env_1637 *)((char *)__t290 + sizeof(void *));
            __t289->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1635;
            __t289->delta = delta_1633;
            TUR_REGION_NOTE_WORDS(&(__t289->delta), sizeof(__t289->delta));
            void *__t291 = __t289;
            void *__t292 = (void *)(intptr_t)(__t291);
            int64_t __ps_293 = (__inst_TestFunctor_fmap_option(__ps_288, (tur_poly_fn_t){ __t292, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t292)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_294 = (_un_unopt_unsome_qu(__ps_293));
            /* panic-return-signal: ret ctype unknown; no propagation here */
