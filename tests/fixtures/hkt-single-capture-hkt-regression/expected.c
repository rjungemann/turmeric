...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1282 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1276 });
            (void)result_1282;
            puts((_un_unopt_unsome_qu(result_1282)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1282)));
        }
        {
            int64_t delta_1283 = INT64_C(100);
            (void)delta_1283;
            {
                struct __env_1287 *__t55 = (struct __env_1287 *)malloc(sizeof(struct __env_1287));
                __t55->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1285;
                __t55->delta = delta_1283;
                void *__t56 = __t55;
                void *__t57 = (void *)(intptr_t)(__t56);
                int64_t result_1290 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t57, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t57)) });
                (void)result_1290;
                puts((_un_unopt_unsome_qu(result_1290)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1290)));
            }
        }
        {
            int64_t delta_1291 = INT64_C(100);
            (void)delta_1291;
            struct __env_1295 *__t58 = (struct __env_1295 *)malloc(sizeof(struct __env_1295));
            __t58->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1293;
            __t58->delta = delta_1291;
            void *__t59 = __t58;
            void *__t60 = (void *)(intptr_t)(__t59);
            puts((_un_unopt_unsome_qu(__inst_TestFunctor_fmap_option(__opt_none(), (tur_poly_fn_t){ __t60, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t60)) }))) ? "true" : "false");
        }
        int64_t __t61;
        __t61 = INT64_C(0);
        return (int)__t61;
