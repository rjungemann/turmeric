...
static int64_t __fn_903(void *, int64_t);
...
static int64_t __poly_886(void * __poly_env_887, int64_t __poly_x0_889) {
        return __inc(__poly_x0_889);
}

struct __env_897 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_895(void * __env_p_898, int64_t x) {
        struct __env_897 *__env___env_897 = (struct __env_897 *)__env_p_898;
        return (x) + (__env___env_897->delta);
}

struct __env_905 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_903(void * __env_p_906, int64_t x) {
        struct __env_905 *__env___env_905 = (struct __env_905 *)__env_p_906;
        return (x) + (__env___env_905->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_892 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_886 });
            (void)result_892;
            puts((_un_unopt_unsome_qu(result_892)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_892)));
        }
        {
            int64_t delta_893 = INT64_C(100);
            (void)delta_893;
            {
                struct __env_897 *__t21 = (struct __env_897 *)malloc(sizeof(struct __env_897));
                __t21->__fn = (tur_thunk_int64_t_int64_t_t)__fn_895;
                __t21->delta = delta_893;
                void *__t22 = __t21;
                void *__t23 = (void *)(intptr_t)(__t22);
                int64_t result_900 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t23, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t23)) });
                (void)result_900;
                puts((_un_unopt_unsome_qu(result_900)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_900)));
            }
        }
        {
            int64_t delta_901 = INT64_C(100);
            (void)delta_901;
            struct __env_905 *__t24 = (struct __env_905 *)malloc(sizeof(struct __env_905));
            __t24->__fn = (tur_thunk_int64_t_int64_t_t)__fn_903;
            __t24->delta = delta_901;
            void *__t25 = __t24;
