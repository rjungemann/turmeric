...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_174 = (__inst_TestFunctor_fmap_option(__ps_173, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1618 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1624 = __ps_174;
            (void)result_1624;
            bool __ps_175 = (_un_unopt_unsome_qu(result_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_175) ? "true" : "false");
            int64_t __ps_176 = (__opt_unwrap(result_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_176));
        }
        {
            ...
            (void)delta_1625;
            {
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t179 = malloc(sizeof(void *) + sizeof(struct __env_1629));
                *(void (**)(void *))__t179 = drop_glue___env_1629;
                struct __env_1629 *__t178 = (struct __env_1629 *)((char *)__t179 + sizeof(void *));
                __t178->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1627;
                __t178->delta = delta_1625;
                TUR_REGION_NOTE_WORDS(&(__t178->delta), sizeof(__t178->delta));
                void *__t180 = __t178;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1632 = __ps_182;
                (void)result_1632;
                bool __ps_183 = (_un_unopt_unsome_qu(result_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_183) ? "true" : "false");
                int64_t __ps_184 = (__opt_unwrap(result_1632));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_184));
            }
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t187 = malloc(sizeof(void *) + sizeof(struct __env_1637));
            *(void (**)(void *))__t187 = drop_glue___env_1637;
            struct __env_1637 *__t186 = (struct __env_1637 *)((char *)__t187 + sizeof(void *));
            __t186->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1635;
            __t186->delta = delta_1633;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_193 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
