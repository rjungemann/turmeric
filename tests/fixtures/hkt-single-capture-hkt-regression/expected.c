...
static int64_t __poly_903(void *, int64_t);
...
static int64_t __poly_903(void * __poly_env_904, int64_t __poly_x0_906) {
        return __inc(__poly_x0_906);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_909 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_903 });
            (void)result_909;
        ...
        }
        {
            ...
            (void)delta_910;
            {
                struct __env_914 *__t25 = (struct __env_914 *)malloc(sizeof(struct __env_914));
                __t25->__fn = (tur_thunk_int64_t_int64_t_t)__fn_912;
                __t25->delta = delta_910;
                void *__t26 = __t25;
                void *__t27 = (void *)(intptr_t)(__t26);
                int64_t result_917 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t27, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t27)) });
                (void)result_917;
                puts((_un_unopt_unsome_qu(result_917)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_917)));
            }
        }
        {
            int64_t delta_918 = INT64_C(100);
            (void)delta_918;
            struct __env_922 *__t28 = (struct __env_922 *)malloc(sizeof(struct __env_922));
            __t28->__fn = (tur_thunk_int64_t_int64_t_t)__fn_920;
            __t28->delta = delta_918;
            void *__t29 = __t28;
