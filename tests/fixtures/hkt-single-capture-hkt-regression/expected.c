...
static int64_t __poly_1027(void *, int64_t);
...
static int64_t __poly_1027(void * __poly_env_1028, int64_t __poly_x0_1030) {
        return __inc(__poly_x0_1030);
}

struct __env_1038 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1036(void * __env_p_1039, int64_t x) {
        struct __env_1038 *__env___env_1038 = (struct __env_1038 *)__env_p_1039;
        return (x) + (__env___env_1038->delta);
}

struct __env_1046 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1044(void * __env_p_1047, int64_t x) {
        struct __env_1046 *__env___env_1046 = (struct __env_1046 *)__env_p_1047;
        return (x) + (__env___env_1046->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1033 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1027 });
            (void)result_1033;
            puts((_un_unopt_unsome_qu(result_1033)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1033)));
        }
        {
            int64_t delta_1034 = INT64_C(100);
            (void)delta_1034;
            {
                struct __env_1038 *__t42 = (struct __env_1038 *)malloc(sizeof(struct __env_1038));
                __t42->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1036;
                __t42->delta = delta_1034;
                void *__t43 = __t42;
                void *__t44 = (void *)(intptr_t)(__t43);
                int64_t result_1041 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t44, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t44)) });
                (void)result_1041;
                puts((_un_unopt_unsome_qu(result_1041)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1041)));
            }
        }
        {
            int64_t delta_1042 = INT64_C(100);
            (void)delta_1042;
            struct __env_1046 *__t45 = (struct __env_1046 *)malloc(sizeof(struct __env_1046));
            __t45->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1044;
            __t45->delta = delta_1042;
            void *__t46 = __t45;
