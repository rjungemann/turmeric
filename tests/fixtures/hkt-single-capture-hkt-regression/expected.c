...
static int64_t __poly_1030(void *, int64_t);
...
static int64_t __poly_1030(void * __poly_env_1031, int64_t __poly_x0_1033) {
        return __inc(__poly_x0_1033);
}

struct __env_1041 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1039(void * __env_p_1042, int64_t x) {
        struct __env_1041 *__env___env_1041 = (struct __env_1041 *)__env_p_1042;
        return (x) + (__env___env_1041->delta);
}

struct __env_1049 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1047(void * __env_p_1050, int64_t x) {
        struct __env_1049 *__env___env_1049 = (struct __env_1049 *)__env_p_1050;
        return (x) + (__env___env_1049->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1036 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1030 });
            (void)result_1036;
            puts((_un_unopt_unsome_qu(result_1036)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1036)));
        }
        {
            int64_t delta_1037 = INT64_C(100);
            (void)delta_1037;
            {
                struct __env_1041 *__t42 = (struct __env_1041 *)malloc(sizeof(struct __env_1041));
                __t42->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1039;
                __t42->delta = delta_1037;
                void *__t43 = __t42;
                void *__t44 = (void *)(intptr_t)(__t43);
                int64_t result_1044 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t44, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t44)) });
                (void)result_1044;
                puts((_un_unopt_unsome_qu(result_1044)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1044)));
            }
        }
        {
            int64_t delta_1045 = INT64_C(100);
            (void)delta_1045;
            struct __env_1049 *__t45 = (struct __env_1049 *)malloc(sizeof(struct __env_1049));
            __t45->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1047;
            __t45->delta = delta_1045;
            void *__t46 = __t45;
