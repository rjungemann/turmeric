...
static int64_t __poly_1619(void *, int64_t);
...
static int64_t __poly_1619(void * __poly_env_1620, int64_t __poly_x0_1622) {
        return __inc(__poly_x0_1622);
}

struct __env_1630 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1628(void * __env_p_1631, int64_t x) {
        struct __env_1630 *__env___env_1630 = (struct __env_1630 *)__env_p_1631;
        return (x) + (__env___env_1630->delta);
}

struct __env_1638 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static void drop_glue___env_1638(void *__p) {
    struct __env_1638 *__e = (struct __env_1638 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1636(void * __env_p_1639, int64_t x) {
        struct __env_1638 *__env___env_1638 = (struct __env_1638 *)__env_p_1639;
        return (x) + (__env___env_1638->delta);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_173 = (__inst_TestFunctor_fmap_option(__ps_172, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1619 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1625 = __ps_173;
            (void)result_1625;
            bool __ps_174 = (_un_unopt_unsome_qu(result_1625));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_174) ? "true" : "false");
            int64_t __ps_175 = (__opt_unwrap(result_1625));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_175));
        }
        {
            int64_t delta_1626 = INT64_C(100);
            (void)delta_1626;
            {
                int64_t __ps_176 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t178 = malloc(sizeof(void *) + sizeof(struct __env_1630));
                *(void (**)(void *))__t178 = drop_glue___env_1630;
                struct __env_1630 *__t177 = (struct __env_1630 *)((char *)__t178 + sizeof(void *));
                __t177->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1628;
                __t177->delta = delta_1626;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1633 = __ps_181;
                (void)result_1633;
                bool __ps_182 = (_un_unopt_unsome_qu(result_1633));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_182) ? "true" : "false");
                int64_t __ps_183 = (__opt_unwrap(result_1633));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_183));
            }
        }
        {
            int64_t delta_1634 = INT64_C(100);
            (void)delta_1634;
            int64_t __ps_184 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t186 = malloc(sizeof(void *) + sizeof(struct __env_1638));
            *(void (**)(void *))__t186 = drop_glue___env_1638;
            struct __env_1638 *__t185 = (struct __env_1638 *)((char *)__t186 + sizeof(void *));
            __t185->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1636;
            __t185->delta = delta_1634;
