...
static int64_t __poly_1628(void *, int64_t);
...
static int64_t __poly_1628(void * __poly_env_1629, int64_t __poly_x0_1631) {
        return __inc(__poly_x0_1631);
}

struct __env_1639 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1637(void * __env_p_1640, int64_t x) {
        struct __env_1639 *__env___env_1639 = (struct __env_1639 *)__env_p_1640;
        return (x) + (__env___env_1639->delta);
}

struct __env_1647 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1645(void * __env_p_1648, int64_t x) {
        ...
        return (x) + (__env___env_1647->delta);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_173 = (__inst_TestFunctor_fmap_option(__ps_172, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1628 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1634 = __ps_173;
            (void)result_1634;
            bool __ps_174 = (_un_unopt_unsome_qu(result_1634));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_174) ? "true" : "false");
            int64_t __ps_175 = (__opt_unwrap(result_1634));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_175));
        }
        {
            int64_t delta_1635 = INT64_C(100);
            (void)delta_1635;
            {
                int64_t __ps_176 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t178 = malloc(sizeof(void *) + sizeof(struct __env_1639));
                *(void (**)(void *))__t178 = drop_glue___env_1639;
                struct __env_1639 *__t177 = (struct __env_1639 *)((char *)__t178 + sizeof(void *));
                __t177->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1637;
                __t177->delta = delta_1635;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1642 = __ps_181;
                (void)result_1642;
                bool __ps_182 = (_un_unopt_unsome_qu(result_1642));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_182) ? "true" : "false");
                int64_t __ps_183 = (__opt_unwrap(result_1642));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_183));
            }
        }
        {
            int64_t delta_1643 = INT64_C(100);
            (void)delta_1643;
            int64_t __ps_184 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t186 = malloc(sizeof(void *) + sizeof(struct __env_1647));
            *(void (**)(void *))__t186 = drop_glue___env_1647;
            struct __env_1647 *__t185 = (struct __env_1647 *)((char *)__t186 + sizeof(void *));
            __t185->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1645;
            __t185->delta = delta_1643;
