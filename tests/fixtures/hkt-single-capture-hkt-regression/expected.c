...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_175 = (__inst_TestFunctor_fmap_option(__ps_174, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1279 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1285 = __ps_175;
            (void)result_1285;
            __auto_type __ps_176 = (_un_unopt_unsome_qu(result_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            __auto_type __ps_177 = (__opt_unwrap(result_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_177));
        }
        {
            ...
            (void)delta_1286;
            {
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                struct __env_1290 *__t179 = (struct __env_1290 *)malloc(sizeof(struct __env_1290));
                __t179->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1288;
                __t179->delta = delta_1286;
                void *__t180 = __t179;
                ...
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1293 = __ps_182;
                (void)result_1293;
                __auto_type __ps_183 = (_un_unopt_unsome_qu(result_1293));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_183) ? "true" : "false");
                __auto_type __ps_184 = (__opt_unwrap(result_1293));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_184));
            }
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            struct __env_1298 *__t186 = (struct __env_1298 *)malloc(sizeof(struct __env_1298));
            __t186->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1296;
            __t186->delta = delta_1294;
            void *__t187 = __t186;
