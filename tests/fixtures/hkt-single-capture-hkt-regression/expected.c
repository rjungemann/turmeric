...
static int64_t __poly_1281(void *, int64_t);
static int64_t __fn_1290(void *, int64_t);
...
static int64_t __poly_1281(void * __poly_env_1282, int64_t __poly_x0_1284) {
        __auto_type __ps_43 = (__inc(__poly_x0_1284));
        if (tur_panicking) return (int64_t){0};
        return __ps_43;
}

struct __env_1292 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1290(void * __env_p_1293, int64_t x) {
        struct __env_1292 *__env___env_1292 = (struct __env_1292 *)__env_p_1293;
        return (x) + (__env___env_1292->delta);
}

struct __env_1300 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1298(void * __env_p_1301, int64_t x) {
        struct __env_1300 *__env___env_1300 = (struct __env_1300 *)__env_p_1301;
        return (x) + (__env___env_1300->delta);
}
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_71) {
            bool __t72;
            {
                ...
                (void)k_739;
                bool __t75;
                __auto_type __ps_76 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_738, (void *)(intptr_t)(k_739), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_76) {
                    bool __t77;
                    __auto_type __ps_78 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_79 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_738, (void *)(intptr_t)(k_739), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t82;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_743 = __ps_84;
            (void)iter_743;
            __auto_type __ps_85 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_86 = (hamt_slkeyeq((void *)(intptr_t)(__ps_85)));
            if (tur_panicking) return (bool){0};
            void * keyeq_744 = __ps_86;
            (void)keyeq_744;
            __auto_type __ps_87 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_88 = (map_hyeq_hyloop((void *)(intptr_t)(iter_743), (void *)(intptr_t)(__ps_87), (void *)(intptr_t)(keyeq_744), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_745 = __ps_88;
            (void)result_745;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_110) {
            bool __t111;
            {
                ...
                bool __t112;
                if ((t1_984) == (INT64_C(0))) {
                    __t112 = (t2_985) == (INT64_C(0));
                } else {
                    bool __t113;
                    if ((t2_985) == (INT64_C(0))) {
                        __t113 = false;
                    } else {
                        __auto_type __ps_114 = (cons_hyeq_hygo(t1_984, t2_985));
                        if (tur_panicking) return (bool){0};
                        __t113 = __ps_114;
                    }
                    __t112 = __t113;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_124) {
            ...
            int64_t __t125;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1000 = (int64_t)(intptr_t)(__ps_129);
                (void)out_1000;
                __t125 = out_1000;
            }
            __t123 = __t125;
        ...
        if (__ps_134) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1071 = __ps_135;
                (void)h_1071;
                __auto_type __ps_136 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1072 = __ps_136;
                (void)k_1072;
                __auto_type __ps_137 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1071, (void *)(intptr_t)(k_1072), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_137) {
                    void * __t138 = iter;
                    void * __t139 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t141;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1075 = __ps_143;
            (void)iter_1075;
            __auto_type __ps_144 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_145 = (hamt_slkeyeq((void *)(intptr_t)(__ps_144)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1076 = __ps_145;
            (void)keyeq_1076;
            __auto_type __ps_146 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_147 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1075), (void *)(intptr_t)(__ps_146), (void *)(intptr_t)(keyeq_1076)));
            if (tur_panicking) return (bool){0};
            bool result_1077 = __ps_147;
            (void)result_1077;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t174;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1253 = __ps_175;
            (void)r_1253;
            int64_t __t176;
            __auto_type __ps_177 = (schema_hydecode_hyok_qu(r_1253));
            if (tur_panicking) return (int64_t){0};
            if (__ps_177) {
                __auto_type __ps_178 = (schema_hydecode_hyvalue(r_1253));
                if (tur_panicking) return (int64_t){0};
                __t176 = __ps_178;
            } else {
                __auto_type __ps_179 = (schema_hydecode_hyerrors(r_1253));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        {
            __auto_type __ps_182 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_183 = (__inst_TestFunctor_fmap_option(__ps_182, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1281 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1287 = __ps_183;
            (void)result_1287;
            __auto_type __ps_184 = (_un_unopt_unsome_qu(result_1287));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_184) ? "true" : "false");
            __auto_type __ps_185 = (__opt_unwrap(result_1287));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_185));
        }
        {
            int64_t delta_1288 = INT64_C(100);
            (void)delta_1288;
            {
                __auto_type __ps_186 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                struct __env_1292 *__t187 = (struct __env_1292 *)malloc(sizeof(struct __env_1292));
                __t187->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1290;
                __t187->delta = delta_1288;
                void *__t188 = __t187;
                void *__t189 = (void *)(intptr_t)(__t188);
                __auto_type __ps_190 = (__inst_TestFunctor_fmap_option(__ps_186, (tur_poly_fn_t){ __t189, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t189)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1295 = __ps_190;
                (void)result_1295;
                __auto_type __ps_191 = (_un_unopt_unsome_qu(result_1295));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_191) ? "true" : "false");
                __auto_type __ps_192 = (__opt_unwrap(result_1295));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_192));
            }
        }
        {
            int64_t delta_1296 = INT64_C(100);
            (void)delta_1296;
            __auto_type __ps_193 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            struct __env_1300 *__t194 = (struct __env_1300 *)malloc(sizeof(struct __env_1300));
            __t194->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1298;
            __t194->delta = delta_1296;
            void *__t195 = __t194;
            void *__t196 = (void *)(intptr_t)(__t195);
            __auto_type __ps_197 = (__inst_TestFunctor_fmap_option(__ps_193, (tur_poly_fn_t){ __t196, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t196)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_198 = (_un_unopt_unsome_qu(__ps_197));
            /* panic-return-signal: ret ctype unknown; no propagation here */
