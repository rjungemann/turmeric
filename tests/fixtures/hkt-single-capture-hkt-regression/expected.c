...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_68 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_746, (void *)(intptr_t)(k_747), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t70;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_751 = __ps_72;
            (void)iter_751;
            __auto_type __ps_73 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_74 = (hamt_slkeyeq((void *)(intptr_t)(__ps_73)));
            if (tur_panicking) return (bool){0};
            void * keyeq_752 = __ps_74;
            (void)keyeq_752;
            __auto_type __ps_75 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_76 = (map_hyeq_hyloop((void *)(intptr_t)(iter_751), (void *)(intptr_t)(__ps_75), (void *)(intptr_t)(keyeq_752), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_753 = __ps_76;
            (void)result_753;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_94) {
            bool __t95;
            {
                ...
                bool __t96;
                if ((t1_993) == (INT64_C(0))) {
                    __t96 = (t2_994) == (INT64_C(0));
                } else {
                    bool __t97;
                    if ((t2_994) == (INT64_C(0))) {
                        __t97 = false;
                    } else {
                        __auto_type __ps_98 = (cons_hyeq_hygo(t1_993, t2_994));
                        if (tur_panicking) return (bool){0};
                        __t97 = __ps_98;
                    }
                    __t96 = __t97;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_104) {
            ...
            int64_t __t105;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1009 = (int64_t)(intptr_t)(__ps_109);
                (void)out_1009;
                __t105 = out_1009;
            }
            __t103 = __t105;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t114;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1084 = __ps_116;
            (void)iter_1084;
            __auto_type __ps_117 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_118 = (hamt_slkeyeq((void *)(intptr_t)(__ps_117)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1085 = __ps_118;
            (void)keyeq_1085;
            __auto_type __ps_119 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_120 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1084), (void *)(intptr_t)(__ps_119), (void *)(intptr_t)(keyeq_1085)));
            if (tur_panicking) return (bool){0};
            bool result_1086 = __ps_120;
            (void)result_1086;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t141;
        {
            ...
            {
                __auto_type __ps_143 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1213));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1214 = __ps_143;
                (void)_un_unv_1214;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t146;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1263 = __ps_147;
            (void)r_1263;
            int64_t __t148;
            __auto_type __ps_149 = (schema_hydecode_hyok_qu(r_1263));
            if (tur_panicking) return (int64_t){0};
            if (__ps_149) {
                __auto_type __ps_150 = (schema_hydecode_hyvalue(r_1263));
                if (tur_panicking) return (int64_t){0};
                __t148 = __ps_150;
            } else {
                __auto_type __ps_151 = (schema_hydecode_hyerrors(r_1263));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            __auto_type __ps_154 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_155 = (__inst_TestFunctor_fmap_option(__ps_154, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1291 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1297 = __ps_155;
            (void)result_1297;
            __auto_type __ps_156 = (_un_unopt_unsome_qu(result_1297));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_156) ? "true" : "false");
            __auto_type __ps_157 = (__opt_unwrap(result_1297));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_157));
        }
        {
            ...
            (void)delta_1298;
            {
                __auto_type __ps_158 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                struct __env_1302 *__t159 = (struct __env_1302 *)malloc(sizeof(struct __env_1302));
                __t159->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1300;
                __t159->delta = delta_1298;
                void *__t160 = __t159;
                void *__t161 = (void *)(intptr_t)(__t160);
                __auto_type __ps_162 = (__inst_TestFunctor_fmap_option(__ps_158, (tur_poly_fn_t){ __t161, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t161)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1305 = __ps_162;
                (void)result_1305;
                __auto_type __ps_163 = (_un_unopt_unsome_qu(result_1305));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_163) ? "true" : "false");
                __auto_type __ps_164 = (__opt_unwrap(result_1305));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_164));
            }
        }
        {
            ...
            (void)delta_1306;
            __auto_type __ps_165 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            struct __env_1310 *__t166 = (struct __env_1310 *)malloc(sizeof(struct __env_1310));
            __t166->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1308;
            __t166->delta = delta_1306;
            void *__t167 = __t166;
            void *__t168 = (void *)(intptr_t)(__t167);
            __auto_type __ps_169 = (__inst_TestFunctor_fmap_option(__ps_165, (tur_poly_fn_t){ __t168, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t168)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_170 = (_un_unopt_unsome_qu(__ps_169));
            /* panic-return-signal: ret ctype unknown; no propagation here */
