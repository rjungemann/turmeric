...
static int64_t __poly_1479(void *, int64_t);
...
static int64_t __poly_1479(void * __poly_env_1480, int64_t __poly_x0_1482) {
        int64_t __ps_104 = (__inc(__poly_x0_1482));
        if (tur_panicking) return ((int64_t)0);
        return __ps_104;
}

struct __env_1490 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1488(void * __env_p_1491, int64_t x) {
        ...
        return (x) + (__env___env_1490->delta);
}

struct __env_1498 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static void drop_glue___env_1498(void *__p) {
    struct __env_1498 *__e = (struct __env_1498 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1496(void * __env_p_1499, int64_t x) {
        struct __env_1498 *__env___env_1498 = (struct __env_1498 *)__env_p_1499;
        return (x) + (__env___env_1498->delta);
}
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_858 = __ps_137;
        bool __ps_138 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_857, (void *)(intptr_t)(k_858), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_138;
        if (__t1) {
            int64_t __ps_139 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_140 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_857, (void *)(intptr_t)(k_858), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t142;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_862 = __ps_144;
            (void)iter_862;
            void * __ps_145 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_146 = (hamt_slkeyeq((void *)(intptr_t)(__ps_145)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_863 = __ps_146;
            (void)keyeq_863;
            void * __ps_147 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_148 = (map_hyeq_hyloop((void *)(intptr_t)(iter_862), (void *)(intptr_t)(__ps_147), (void *)(intptr_t)(keyeq_863), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_864 = __ps_148;
            (void)result_864;
        ...
        if (__ps_167) {
            bool __t168;
            {
                ...
                if ((t1_1142) == (INT64_C(0))) {
                    __t169 = (t2_1143) == (INT64_C(0));
                } else {
                    bool __t170;
                    if ((t2_1143) == (INT64_C(0))) {
                        __t170 = false;
                    } else {
                        bool __ps_171 = (cons_hyeq_hygo(t1_1142, t2_1143));
                        if (tur_panicking) return ((bool)0);
                        __t170 = __ps_171;
                    }
                    __t169 = __t170;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_177) {
            ...
            int64_t __t178;
            {
                ...
                int64_t out_1158 = (int64_t)(intptr_t)(__ps_182);
                (void)out_1158;
                __t178 = out_1158;
            }
            __t176 = __t178;
        ...
        if (__ps_187) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1229 = __ps_188;
                (void)h_1229;
                void * __ps_189 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1230 = __ps_189;
                (void)k_1230;
                bool __ps_190 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1229, (void *)(intptr_t)(k_1230), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_190) {
                    void * __t191 = iter;
                    void * __t192 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t194;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1233 = __ps_196;
            (void)iter_1233;
            void * __ps_197 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_198 = (hamt_slkeyeq((void *)(intptr_t)(__ps_197)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1234 = __ps_198;
            (void)keyeq_1234;
            void * __ps_199 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_200 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1233), (void *)(intptr_t)(__ps_199), (void *)(intptr_t)(keyeq_1234)));
            if (tur_panicking) return ((bool)0);
            bool result_1235 = __ps_200;
            (void)result_1235;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t221;
        {
            ...
            {
                tur_adt_Vec__int * __ps_223 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1365));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1366 = __ps_223;
                (void)_un_unv_1366;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t227;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1416 = __ps_228;
            (void)r_1416;
            int64_t __t229;
            bool __ps_230 = (schema_hydecode_hyok_qu(r_1416));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_230) {
                int64_t __ps_231 = (schema_hydecode_hyvalue(r_1416));
                if (tur_panicking) return ((int64_t)0);
                __t229 = __ps_231;
            } else {
                int64_t __ps_232 = (schema_hydecode_hyerrors(r_1416));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_245 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_246 = (__inst_TestFunctor_fmap_option(__ps_245, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1479 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1485 = __ps_246;
            (void)result_1485;
            bool __ps_247 = (_un_unopt_unsome_qu(result_1485));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_247) ? "true" : "false");
            int64_t __ps_248 = (__opt_unwrap(result_1485));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_248));
        }
        {
            int64_t delta_1486 = INT64_C(100);
            (void)delta_1486;
            {
                int64_t __ps_249 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t251 = malloc(sizeof(void *) + sizeof(struct __env_1490));
                *(void (**)(void *))__t251 = drop_glue___env_1490;
                struct __env_1490 *__t250 = (struct __env_1490 *)((char *)__t251 + sizeof(void *));
                __t250->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1488;
                __t250->delta = delta_1486;
                TUR_REGION_NOTE_WORDS(&(__t250->delta), sizeof(__t250->delta));
                void *__t252 = __t250;
                void *__t253 = (void *)(intptr_t)(__t252);
                int64_t __ps_254 = (__inst_TestFunctor_fmap_option(__ps_249, (tur_poly_fn_t){ __t253, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t253)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1493 = __ps_254;
                (void)result_1493;
                bool __ps_255 = (_un_unopt_unsome_qu(result_1493));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_255) ? "true" : "false");
                int64_t __ps_256 = (__opt_unwrap(result_1493));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_256));
            }
        }
        {
            int64_t delta_1494 = INT64_C(100);
            (void)delta_1494;
            int64_t __ps_257 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t259 = malloc(sizeof(void *) + sizeof(struct __env_1498));
            *(void (**)(void *))__t259 = drop_glue___env_1498;
            struct __env_1498 *__t258 = (struct __env_1498 *)((char *)__t259 + sizeof(void *));
            __t258->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1496;
            __t258->delta = delta_1494;
            TUR_REGION_NOTE_WORDS(&(__t258->delta), sizeof(__t258->delta));
            void *__t260 = __t258;
            void *__t261 = (void *)(intptr_t)(__t260);
            int64_t __ps_262 = (__inst_TestFunctor_fmap_option(__ps_257, (tur_poly_fn_t){ __t261, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t261)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_263 = (_un_unopt_unsome_qu(__ps_262));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_263) ? "true" : "false");
        }
        int64_t __t264;
        __t264 = INT64_C(0);
        return (int)__t264;
