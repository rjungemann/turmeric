...
static int64_t __poly_1255(void *, int64_t);
static int64_t __fn_1264(void *, int64_t);
static int64_t __fn_1272(void *, int64_t);
...
static int64_t __poly_1255(void * __poly_env_1256, int64_t __poly_x0_1258) {
        return __inc(__poly_x0_1258);
}

struct __env_1266 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1264(void * __env_p_1267, int64_t x) {
        struct __env_1266 *__env___env_1266 = (struct __env_1266 *)__env_p_1267;
        return (x) + (__env___env_1266->delta);
}

struct __env_1274 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_1272(void * __env_p_1275, int64_t x) {
        struct __env_1274 *__env___env_1274 = (struct __env_1274 *)__env_p_1275;
        return (x) + (__env___env_1274->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_1261 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1255 });
            (void)result_1261;
            puts((_un_unopt_unsome_qu(result_1261)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_1261)));
        }
        {
            int64_t delta_1262 = INT64_C(100);
            (void)delta_1262;
            {
                struct __env_1266 *__t50 = (struct __env_1266 *)malloc(sizeof(struct __env_1266));
                __t50->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1264;
                __t50->delta = delta_1262;
                void *__t51 = __t50;
                void *__t52 = (void *)(intptr_t)(__t51);
                int64_t result_1269 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t52, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t52)) });
                (void)result_1269;
                puts((_un_unopt_unsome_qu(result_1269)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_1269)));
            }
        }
        {
            int64_t delta_1270 = INT64_C(100);
            (void)delta_1270;
            struct __env_1274 *__t53 = (struct __env_1274 *)malloc(sizeof(struct __env_1274));
            __t53->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1272;
            __t53->delta = delta_1270;
            void *__t54 = __t53;
            void *__t55 = (void *)(intptr_t)(__t54);
            puts((_un_unopt_unsome_qu(__inst_TestFunctor_fmap_option(__opt_none(), (tur_poly_fn_t){ __t55, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t55)) }))) ? "true" : "false");
        }
        int64_t __t56;
        __t56 = INT64_C(0);
        return (int)__t56;
