...
static int64_t __poly_901(void *, int64_t);
...
static int64_t __poly_901(void * __poly_env_902, int64_t __poly_x0_904) {
        return __inc(__poly_x0_904);
}

struct __env_912 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_910(void * __env_p_913, int64_t x) {
        struct __env_912 *__env___env_912 = (struct __env_912 *)__env_p_913;
        return (x) + (__env___env_912->delta);
}

struct __env_920 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static int64_t __fn_918(void * __env_p_921, int64_t x) {
        struct __env_920 *__env___env_920 = (struct __env_920 *)__env_p_921;
        return (x) + (__env___env_920->delta);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t result_907 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(41)), (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_901 });
            (void)result_907;
            puts((_un_unopt_unsome_qu(result_907)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_907)));
        }
        {
            int64_t delta_908 = INT64_C(100);
            (void)delta_908;
            {
                struct __env_912 *__t25 = (struct __env_912 *)malloc(sizeof(struct __env_912));
                __t25->__fn = (tur_thunk_int64_t_int64_t_t)__fn_910;
                __t25->delta = delta_908;
                void *__t26 = __t25;
                void *__t27 = (void *)(intptr_t)(__t26);
                int64_t result_915 = __inst_TestFunctor_fmap_option(__opt_some(INT64_C(23)), (tur_poly_fn_t){ __t27, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t27)) });
                (void)result_915;
                puts((_un_unopt_unsome_qu(result_915)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(result_915)));
            }
        }
        {
            int64_t delta_916 = INT64_C(100);
            (void)delta_916;
            struct __env_920 *__t28 = (struct __env_920 *)malloc(sizeof(struct __env_920));
            __t28->__fn = (tur_thunk_int64_t_int64_t_t)__fn_918;
            __t28->delta = delta_916;
            void *__t29 = __t28;
