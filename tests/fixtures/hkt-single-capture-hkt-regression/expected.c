...
static int64_t __poly_1444(void *, int64_t);
...
static int64_t __poly_1444(void * __poly_env_1445, int64_t __poly_x0_1447) {
        int64_t __ps_40 = (__inc(__poly_x0_1447));
        if (tur_panicking) return ((int64_t)0);
        return __ps_40;
}

struct __env_1455 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
...
static int64_t __fn_1453(void * __env_p_1456, int64_t x) {
        ...
        return (x) + (__env___env_1455->delta);
}

struct __env_1463 { tur_thunk_int64_t_int64_t_t __fn; int64_t delta; };
static void drop_glue___env_1463(void *__p) {
    struct __env_1463 *__e = (struct __env_1463 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1461(void * __env_p_1464, int64_t x) {
        struct __env_1463 *__env___env_1463 = (struct __env_1463 *)__env_p_1464;
        return (x) + (__env___env_1463->delta);
}
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_72 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_818, (void *)(intptr_t)(k_819), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t74;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_823 = __ps_76;
            (void)iter_823;
            void * __ps_77 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_78 = (hamt_slkeyeq((void *)(intptr_t)(__ps_77)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_824 = __ps_78;
            (void)keyeq_824;
            void * __ps_79 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_80 = (map_hyeq_hyloop((void *)(intptr_t)(iter_823), (void *)(intptr_t)(__ps_79), (void *)(intptr_t)(keyeq_824), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_825 = __ps_80;
            (void)result_825;
        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if ((t1_1103) == (INT64_C(0))) {
                    __t101 = (t2_1104) == (INT64_C(0));
                } else {
                    bool __t102;
                    if ((t2_1104) == (INT64_C(0))) {
                        __t102 = false;
                    } else {
                        bool __ps_103 = (cons_hyeq_hygo(t1_1103, t2_1104));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_103;
                    }
                    __t101 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_109) {
            ...
            int64_t __t110;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1119 = (int64_t)(intptr_t)(__ps_114);
                (void)out_1119;
                __t110 = out_1119;
            }
            __t108 = __t110;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t119;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1194 = __ps_121;
            (void)iter_1194;
            void * __ps_122 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_123 = (hamt_slkeyeq((void *)(intptr_t)(__ps_122)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1195 = __ps_123;
            (void)keyeq_1195;
            void * __ps_124 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_125 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1194), (void *)(intptr_t)(__ps_124), (void *)(intptr_t)(keyeq_1195)));
            if (tur_panicking) return ((bool)0);
            bool result_1196 = __ps_125;
            (void)result_1196;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t146;
        {
            ...
            {
                tur_adt_Vec__int * __ps_148 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1323));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1324 = __ps_148;
                (void)_un_unv_1324;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t152;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1374 = __ps_153;
            (void)r_1374;
            int64_t __t154;
            bool __ps_155 = (schema_hydecode_hyok_qu(r_1374));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_155) {
                int64_t __ps_156 = (schema_hydecode_hyvalue(r_1374));
                if (tur_panicking) return ((int64_t)0);
                __t154 = __ps_156;
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1374));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_169 = (__opt_some(INT64_C(41)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_170 = (__inst_TestFunctor_fmap_option(__ps_169, (tur_poly_fn_t){ NULL, (int64_t(*)(void*,int64_t))__poly_1444 }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t result_1450 = __ps_170;
            (void)result_1450;
            bool __ps_171 = (_un_unopt_unsome_qu(result_1450));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_171) ? "true" : "false");
            int64_t __ps_172 = (__opt_unwrap(result_1450));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_172));
        }
        {
            int64_t delta_1451 = INT64_C(100);
            (void)delta_1451;
            {
                int64_t __ps_173 = (__opt_some(INT64_C(23)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void *__t175 = malloc(sizeof(void *) + sizeof(struct __env_1455));
                *(void (**)(void *))__t175 = drop_glue___env_1455;
                struct __env_1455 *__t174 = (struct __env_1455 *)((char *)__t175 + sizeof(void *));
                __t174->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1453;
                __t174->delta = delta_1451;
                void *__t176 = __t174;
                void *__t177 = (void *)(intptr_t)(__t176);
                int64_t __ps_178 = (__inst_TestFunctor_fmap_option(__ps_173, (tur_poly_fn_t){ __t177, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t177)) }));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t result_1458 = __ps_178;
                (void)result_1458;
                bool __ps_179 = (_un_unopt_unsome_qu(result_1458));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                puts((__ps_179) ? "true" : "false");
                int64_t __ps_180 = (__opt_unwrap(result_1458));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_180));
            }
        }
        {
            int64_t delta_1459 = INT64_C(100);
            (void)delta_1459;
            int64_t __ps_181 = (__opt_none());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void *__t183 = malloc(sizeof(void *) + sizeof(struct __env_1463));
            *(void (**)(void *))__t183 = drop_glue___env_1463;
            struct __env_1463 *__t182 = (struct __env_1463 *)((char *)__t183 + sizeof(void *));
            __t182->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1461;
            __t182->delta = delta_1459;
            void *__t184 = __t182;
            void *__t185 = (void *)(intptr_t)(__t184);
            int64_t __ps_186 = (__inst_TestFunctor_fmap_option(__ps_181, (tur_poly_fn_t){ __t185, (int64_t(*)(void*,int64_t))(*( tur_thunk_int64_t_int64_t_t *)(__t185)) }));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            bool __ps_187 = (_un_unopt_unsome_qu(__ps_186));
            /* panic-return-signal: ret ctype unknown; no propagation here */
