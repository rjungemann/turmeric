...
static int64_t __inst_HasArr_inc_hyby_ArrW(int64_t, int64_t);
static int64_t __fn_903(void *, int64_t);
static int64_t __inst_HasArr_mul_hyby_ArrW(int64_t, int64_t);
...
static int64_t __inst_HasArr_inc_hyby_ArrW(int64_t self, int64_t n) {
...
static int64_t __inst_HasArr_mul_hyby_ArrW(int64_t self, int64_t k) {
...
typedef struct dict_HasArr_ArrW {
    int64_t (*inc_hyby)(int64_t, int64_t);
    int64_t (*mul_hyby)(int64_t, int64_t);
} dict_HasArr_ArrW;

static dict_HasArr_ArrW dict_HasArr_ArrW_singleton = {
    .inc_hyby = __inst_HasArr_inc_hyby_ArrW,
    .mul_hyby = __inst_HasArr_mul_hyby_ArrW,
};
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            (void)w_910;
            int64_t f = (int64_t)(intptr_t)(__inst_HasArr_inc_hyby_ArrW(w_910, INT64_C(10)));
            (void)f;
            int64_t g = (int64_t)(intptr_t)(__inst_HasArr_mul_hyby_ArrW(w_910, INT64_C(3)));
            (void)g;
