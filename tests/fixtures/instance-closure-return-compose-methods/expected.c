...
static int64_t __fn_903(void * __env_p_906, int64_t x) {
        ...
        return (x) * (__env___env_905->k);
}

static int64_t __inst_HasArr_mul_by_ArrW(int64_t self, int64_t k) {
        struct __env_905 *__t22 = (struct __env_905 *)malloc(sizeof(struct __env_905));
...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_910 = (int64_t)(INT64_C(0));
            (void)w_910;
            int64_t f = (int64_t)(intptr_t)(__inst_HasArr_inc_by_ArrW(w_910, INT64_C(10)));
            (void)f;
            int64_t g = (int64_t)(intptr_t)(__inst_HasArr_mul_by_ArrW(w_910, INT64_C(3)));
            (void)g;
