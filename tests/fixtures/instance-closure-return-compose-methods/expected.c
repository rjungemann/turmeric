...
struct __env_888 { tur_thunk_int64_t_int64_t_t __fn; int64_t n; };
static int64_t __fn_886(void * __env_p_889, int64_t x) {
        struct __env_888 *__env___env_888 = (struct __env_888 *)__env_p_889;
        return (x) + (__env___env_888->n);
}

static int64_t __inst_HasArr_inc_by_ArrW(int64_t self, int64_t n) {
        struct __env_888 *__t20 = (struct __env_888 *)malloc(sizeof(struct __env_888));
        __t20->__fn = (tur_thunk_int64_t_int64_t_t)__fn_886;
        __t20->n = n;
        void *__t21 = __t20;
        return __t21;
}

struct __env_894 { tur_thunk_int64_t_int64_t_t __fn; int64_t k; };
...
static int64_t __inst_HasArr_mul_by_ArrW(int64_t self, int64_t k) {
        struct __env_894 *__t22 = (struct __env_894 *)malloc(sizeof(struct __env_894));
        __t22->__fn = (tur_thunk_int64_t_int64_t_t)__fn_892;
        __t22->k = k;
        void *__t23 = __t22;
        return __t23;
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_899 = (int64_t)(INT64_C(0));
            (void)w_899;
            int64_t f = (int64_t)(intptr_t)(__inst_HasArr_inc_by_ArrW(w_899, INT64_C(10)));
            (void)f;
            int64_t g = (int64_t)(intptr_t)(__inst_HasArr_mul_by_ArrW(w_899, INT64_C(3)));
            (void)g;
