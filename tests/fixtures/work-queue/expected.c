...
int main() {
        {
            void * q_48 = work_queue_new_bounded(INT64_C(4));
            (void)q_48;
            {
                void * prod_arg_49 = wq_arg_new((void *)(intptr_t)(q_48));
                (void)prod_arg_49;
                {
                    void * cons_arg_50 = wq_arg_new((void *)(intptr_t)(q_48));
                    (void)cons_arg_50;
                    {
                        void * tp_51 = wq_thread_spawn((void *)(intptr_t)(wq_producer), (void *)(intptr_t)(prod_arg_49));
                        (void)tp_51;
                        {
                            void * tc_52 = wq_thread_spawn((void *)(intptr_t)(wq_consumer), (void *)(intptr_t)(cons_arg_50));
                            (void)tc_52;
                            wq_thread_join((void *)(intptr_t)(tp_51));
                            wq_thread_join((void *)(intptr_t)(tc_52));
                        }
                    }
                    printf("%lld\n", (long long)(wq_arg_result((void *)(intptr_t)(cons_arg_50))));
                    wq_arg_free((void *)(intptr_t)(prod_arg_49));
                    wq_arg_free((void *)(intptr_t)(cons_arg_50));
                }
            }
            work_queue_free((void *)(intptr_t)(q_48));
        }
        {
            void * uq_53 = work_queue_new();
            (void)uq_53;
            work_queue_push((void *)(intptr_t)(uq_53), INT64_C(10));
            work_queue_push((void *)(intptr_t)(uq_53), INT64_C(20));
            work_queue_push((void *)(intptr_t)(uq_53), INT64_C(30));
            printf("%lld\n", (long long)(work_queue_pop((void *)(intptr_t)(uq_53))));
            printf("%lld\n", (long long)(work_queue_pop((void *)(intptr_t)(uq_53))));
            printf("%lld\n", (long long)(work_queue_pop((void *)(intptr_t)(uq_53))));
            work_queue_free((void *)(intptr_t)(uq_53));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
