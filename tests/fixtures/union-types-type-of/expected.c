...
static int64_t show_type(tur_tagged_t);
...
static int64_t show_type(tur_tagged_t x) {
        puts(__tur_any_type_name(TUR_GETTAG(x)));
        int64_t __t0;
        __t0 = INT64_C(0);
        return __t0;
}
...
int main() {
        (void)(show_type(TUR_TAG(3, (int64_t)(intptr_t)(INT64_C(42)))));
        (void)(show_type(TUR_TAG(2, (int64_t)(intptr_t)(true))));
        (void)(show_type(TUR_TAG(5, (int64_t)(intptr_t)("hello"))));
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
}
