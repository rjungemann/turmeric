...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(42);
            ...
            __t2->value = __t1;
            RcControlBlock * r_265 = __t2;
            (void)r_265;
            int64_t __t3 = rc_strong_count(r_265);
            printf("%lld\n", (long long)(__t3));
            {
                int64_t r2_266 = ((int64_t (*)(RcControlBlock *))(intptr_t)(dict_Clone_T_singleton.clone))(r_265);
                (void)r2_266;
                int64_t __t4 = rc_strong_count(r_265);
                printf("%lld\n", (long long)(__t4));
                rc_drop_raw(r2_266);
                int64_t __t5 = rc_strong_count(r_265);
                printf("%lld\n", (long long)(__t5));
            }
            rc_strong_decrement(r_265);
            rc_free_queue_drain();
            int64_t __t6;
            __t6 = INT64_C(0);
            __t0 = __t6;
