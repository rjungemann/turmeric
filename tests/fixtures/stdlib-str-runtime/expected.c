...
int main() {
        int64_t __t0;
        {
            void * a_205 = str_from_cstr("abc");
            (void)a_205;
            int64_t __t1;
            {
                void * b_206 = str_from_cstr("abc");
                (void)b_206;
                int64_t __t2;
                {
                    void * c_207 = str_from_cstr("abd");
                    (void)c_207;
                    printf("%lld\n", (long long)(str_len((void *)(intptr_t)(a_205))));
                    puts((str_eq_((void *)(intptr_t)(a_205), (void *)(intptr_t)(b_206))) ? "true" : "false");
                    puts((str_eq_((void *)(intptr_t)(a_205), (void *)(intptr_t)(c_207))) ? "true" : "false");
                    str_free((void *)(intptr_t)(a_205));
                    str_free((void *)(intptr_t)(b_206));
                    str_free((void *)(intptr_t)(c_207));
                    int64_t __t3;
                    __t3 = INT64_C(0);
                    __t2 = __t3;
                }
