...
static void * str_from_cstr(const char *);
static int64_t str_len(void *);
static bool str_eq_(void *, void *);
static void str_free(void *);
...
static void * str_from_cstr(const char * cstr) {
...
static int64_t str_len(void * s) {
        struct { const char *p; size_t len; } *str = (void*)s;
  return (int)str->len;
  
}

static bool str_eq_(void * s1, void * s2) {
...
int main() {
        int64_t __t0;
        {
            void * a_217 = str_from_cstr("abc");
            (void)a_217;
            int64_t __t1;
            {
                void * b_218 = str_from_cstr("abc");
                (void)b_218;
                int64_t __t2;
                {
                    void * c_219 = str_from_cstr("abd");
                    (void)c_219;
                    printf("%lld\n", (long long)(str_len((void *)(intptr_t)(a_217))));
                    puts((str_eq_((void *)(intptr_t)(a_217), (void *)(intptr_t)(b_218))) ? "true" : "false");
                    puts((str_eq_((void *)(intptr_t)(a_217), (void *)(intptr_t)(c_219))) ? "true" : "false");
                    str_free((void *)(intptr_t)(a_217));
                    str_free((void *)(intptr_t)(b_218));
                    str_free((void *)(intptr_t)(c_219));
                    int64_t __t3;
                    __t3 = INT64_C(0);
                    __t2 = __t3;
                }
