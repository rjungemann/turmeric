...
int main() {
        int64_t __t0;
        {
            void * a_270 = str_from_cstr("abc");
            (void)a_270;
            int64_t __t1;
            {
                void * b_271 = str_from_cstr("abc");
                (void)b_271;
                int64_t __t2;
                {
                    void * c_272 = str_from_cstr("abd");
                    (void)c_272;
                    printf("%lld\n", (long long)(str_len((void *)(intptr_t)(a_270))));
                    puts((str_eq_((void *)(intptr_t)(a_270), (void *)(intptr_t)(b_271))) ? "true" : "false");
                    puts((str_eq_((void *)(intptr_t)(a_270), (void *)(intptr_t)(c_272))) ? "true" : "false");
                    str_free((void *)(intptr_t)(a_270));
                    str_free((void *)(intptr_t)(b_271));
                    str_free((void *)(intptr_t)(c_272));
                    int64_t __t3;
                    __t3 = INT64_C(0);
                    __t2 = __t3;
                }
