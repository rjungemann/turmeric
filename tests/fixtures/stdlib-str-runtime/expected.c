...
int main() {
        int64_t __t0;
        {
            void * a_625 = str_from_cstr("abc");
            (void)a_625;
            int64_t __t1;
            {
                void * b_626 = str_from_cstr("abc");
                (void)b_626;
                int64_t __t2;
                {
                    void * c_627 = str_from_cstr("abd");
                    (void)c_627;
                    printf("%lld\n", (long long)(str_len((void *)(intptr_t)(a_625))));
                    puts((str_eq_((void *)(intptr_t)(a_625), (void *)(intptr_t)(b_626))) ? "true" : "false");
                    puts((str_eq_((void *)(intptr_t)(a_625), (void *)(intptr_t)(c_627))) ? "true" : "false");
                    str_free((void *)(intptr_t)(a_625));
                    str_free((void *)(intptr_t)(b_626));
                    str_free((void *)(intptr_t)(c_627));
                    int64_t __t3;
                    __t3 = INT64_C(0);
                    __t2 = __t3;
                }
