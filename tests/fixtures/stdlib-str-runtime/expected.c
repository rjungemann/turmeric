...
int main() {
        int64_t __t0;
        {
            void * a_30 = str_from_cstr("abc");
            (void)a_30;
            int64_t __t1;
            {
                void * b_31 = str_from_cstr("abc");
                (void)b_31;
                int64_t __t2;
                {
                    void * c_32 = str_from_cstr("abd");
                    (void)c_32;
                    printf("%lld\n", (long long)(str_len((void *)(intptr_t)(a_30))));
                    puts((str_eq_((void *)(intptr_t)(a_30), (void *)(intptr_t)(b_31))) ? "true" : "false");
                    puts((str_eq_((void *)(intptr_t)(a_30), (void *)(intptr_t)(c_32))) ? "true" : "false");
                    str_free((void *)(intptr_t)(a_30));
                    str_free((void *)(intptr_t)(b_31));
                    str_free((void *)(intptr_t)(c_32));
                    int64_t __t3;
                    __t3 = INT64_C(0);
                    __t2 = __t3;
                }
