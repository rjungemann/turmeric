...
int main() {
        int64_t __t0;
        {
            void * a_10 = str_from_cstr("abc");
            (void)a_10;
            int64_t __t1;
            {
                void * b_11 = str_from_cstr("abc");
                (void)b_11;
                int64_t __t2;
                {
                    void * c_12 = str_from_cstr("abd");
                    (void)c_12;
                    printf("%lld\n", (long long)(str_len(a_10)));
                    puts((str_eq_(a_10, b_11)) ? "true" : "false");
                    puts((str_eq_(a_10, c_12)) ? "true" : "false");
                    str_free(a_10);
                    str_free(b_11);
                    str_free(c_12);
                    int64_t __t3;
