...
static int64_t ping(tur_adt_Option__int, int64_t);
static int64_t pong(tur_adt_Option__int, int64_t);
...
struct __env_1473 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
struct __env_1480 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
static int64_t some(int64_t x) {
        int64_t __ps_157 = (ctor_Option_Some(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_157;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_179) {
            ...
            int64_t __t180;
            {
                ...
                int64_t out_1155 = (int64_t)(intptr_t)(__ps_184);
                (void)out_1155;
                __t180 = out_1155;
            }
            __t178 = __t180;
        ...
        if (__ps_189) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1226 = __ps_190;
                (void)h_1226;
                void * __ps_191 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1227 = __ps_191;
                (void)k_1227;
                bool __ps_192 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1226, (void *)(intptr_t)(k_1227), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_192) {
                    void * __t193 = iter;
                    void * __t194 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t196;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1230 = __ps_198;
            (void)iter_1230;
            void * __ps_199 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_200 = (hamt_slkeyeq((void *)(intptr_t)(__ps_199)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1231 = __ps_200;
            (void)keyeq_1231;
            void * __ps_201 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_202 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1230), (void *)(intptr_t)(__ps_201), (void *)(intptr_t)(keyeq_1231)));
            if (tur_panicking) return ((bool)0);
            bool result_1232 = __ps_202;
            (void)result_1232;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t223;
        {
            ...
            {
                tur_adt_Vec__int * __ps_225 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1362));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1363 = __ps_225;
                (void)_un_unv_1363;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t229;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1413 = __ps_230;
            (void)r_1413;
            int64_t __t231;
            bool __ps_232 = (schema_hydecode_hyok_qu(r_1413));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_232) {
                int64_t __ps_233 = (schema_hydecode_hyvalue(r_1413));
                if (tur_panicking) return ((int64_t)0);
                __t231 = __ps_233;
            } else {
                int64_t __ps_234 = (schema_hydecode_hyerrors(r_1413));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Option__int acc_1469; memset(&acc_1469, 0, sizeof(tur_adt_Option__int));
 int64_t n_1470 = 0;
 tur_adt_Option__int acc_1476; memset(&acc_1476, 0, sizeof(tur_adt_Option__int));
 int64_t n_1477 = 0;
 int64_t __t247 = 0;
 int64_t __t248 = 0;
 int64_t __t249 = 0;
 ...
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1469, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
   n_1470 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1476, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1470) == (INT64_C(0))) {
     int64_t __t251;
     bool __ps_252 = (some___spec__bool_tur_adt_Option__int(acc_1469));
     if (tur_panicking) return ((int64_t)0);
     if (__ps_252) {
         __t251 = INT64_C(100);
     } else {
     ...
     tur_handler_node *__b253 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
     __b253->parent = tur_handler_chain; tur_handler_chain = __b253;
     tur_cont *__n253 = (tur_cont*)malloc(sizeof(tur_cont));
     __n253->tag = 4; __n253->boundary = __b253; __n253->next = __k;
     __n253->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1469, sizeof(tur_adt_Option__int)); __n253->saved[0] = (int64_t)(intptr_t)__ab; }
     __n253->saved[1] = (int64_t)(intptr_t)(n_1470);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1476, sizeof(tur_adt_Option__int)); __n253->saved[2] = (int64_t)(intptr_t)__ab; }
     __n253->saved[3] = (int64_t)(intptr_t)(n_1477);
     __n253->saved[4] = (int64_t)(intptr_t)(__t247);
     __n253->saved[5] = (int64_t)(intptr_t)(__t248);
     __n253->saved[6] = (int64_t)(intptr_t)(__t249);
     __n253->saved[7] = (int64_t)(intptr_t)(__t250);
     __k = __n253; __pc = 3; break;
    }
   }
   case 3: {
    tur_adt_Option__int __ra254_0 = (acc_1469);
    int64_t __ra254_1 = ((n_1470) - (INT64_C(1)));
    acc_1476 = __ra254_0;
    n_1477 = __ra254_1;
    __pc = 2; break;
   }
   case 4: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1469, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    n_1470 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&acc_1476, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    n_1477 = (int64_t)(intptr_t)(__k->saved[3]);
    __t247 = (int64_t)(intptr_t)(__k->saved[4]);
    __t248 = (int64_t)(intptr_t)(__k->saved[5]);
    __t249 = (int64_t)(intptr_t)(__k->saved[6]);
    __t250 = (int64_t)(intptr_t)(__k->saved[7]);
    tur_handler_chain = __k->boundary->parent; free(__k->boundary);
    int64_t __box253;
    if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp253 = global_panic_payload; global_panic_payload = 0; __box253 = tur_box_err((int64_t)(intptr_t)__pp253); }
    else { __box253 = tur_box_ok(__v); }
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    tur_result_box_free((int64_t)(intptr_t)__box253);
    (void)(__box253);
    int64_t __t255;
    bool __ps_256 = (some___spec__bool_tur_adt_Option__int(acc_1469));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_256) {
        __t255 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1470) + (__t255)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1477) == (INT64_C(0))) {
     int64_t __t257;
     bool __ps_258 = (some___spec__bool_tur_adt_Option__int(acc_1476));
     if (tur_panicking) return ((int64_t)0);
     if (__ps_258) {
         __t257 = INT64_C(300);
     } else {
     ...
     __v = (int64_t)(intptr_t)(__t257); __pc = __k->tag; break;
    } else {
     tur_handler_node *__b259 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
     __b259->parent = tur_handler_chain; tur_handler_chain = __b259;
     tur_cont *__n259 = (tur_cont*)malloc(sizeof(tur_cont));
     __n259->tag = 6; __n259->boundary = __b259; __n259->next = __k;
     __n259->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1469, sizeof(tur_adt_Option__int)); __n259->saved[0] = (int64_t)(intptr_t)__ab; }
     __n259->saved[1] = (int64_t)(intptr_t)(n_1470);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1476, sizeof(tur_adt_Option__int)); __n259->saved[2] = (int64_t)(intptr_t)__ab; }
     __n259->saved[3] = (int64_t)(intptr_t)(n_1477);
     __n259->saved[4] = (int64_t)(intptr_t)(__t247);
     __n259->saved[5] = (int64_t)(intptr_t)(__t248);
     __n259->saved[6] = (int64_t)(intptr_t)(__t249);
     __n259->saved[7] = (int64_t)(intptr_t)(__t250);
     __k = __n259; __pc = 5; break;
    }
   }
   case 5: {
    tur_adt_Option__int __ra260_0 = (acc_1476);
    int64_t __ra260_1 = ((n_1477) - (INT64_C(1)));
    acc_1469 = __ra260_0;
    n_1470 = __ra260_1;
    __pc = 1; break;
   }
   case 6: {
    ...
    tur_handler_chain = __k->boundary->parent; free(__k->boundary);
    int64_t __box259;
    if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp259 = global_panic_payload; global_panic_payload = 0; __box259 = tur_box_err((int64_t)(intptr_t)__pp259); }
    else { __box259 = tur_box_ok(__v); }
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    tur_result_box_free((int64_t)(intptr_t)__box259);
    (void)(__box259);
    int64_t __t261;
    bool __ps_262 = (some___spec__bool_tur_adt_Option__int(acc_1476));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_262) {
        __t261 = INT64_C(2);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1477) + (__t261)); __pc = __k->tag; break;
   }
  }
 }
}
static int64_t ping(tur_adt_Option__int acc, int64_t n) {
    void *__ab0 = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab0, &acc, sizeof(tur_adt_Option__int));
    return (int64_t)(intptr_t)(__cu_group_0(1, (int64_t)(intptr_t)__ab0, (int64_t)(intptr_t)(n)));
}

static int64_t pong(tur_adt_Option__int acc, int64_t n) {
    void *__ab0 = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab0, &acc, sizeof(tur_adt_Option__int));
...
int main(int argc, char **argv) {
    ...
    tur_adt_Option__int __ps_263 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_264 = (ping(__ps_263, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_264));
    tur_adt_Option__int __ps_265 = (none__spec__tur_adt_Option__int());
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_266 = (ping(__ps_265, INT64_C(6)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_266));
    int64_t __t267;
    __t267 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
    tur_adt_Option__int __ps_271 = (ctor_Option_Some__int(x));
    if (tur_panicking) return (tur_adt_Option__int){0};
    return __ps_271;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
    tur_adt_Option__int __ps_272 = (ctor_Option_None__int());
    if (tur_panicking) return (tur_adt_Option__int){0};
    return __ps_272;
}
