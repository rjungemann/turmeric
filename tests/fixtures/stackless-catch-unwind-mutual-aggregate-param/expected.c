...
struct __env_1278 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
static int64_t __fn_1276(void * __env_p_1279) {
        struct __env_1278 *__env___env_1278 = (struct __env_1278 *)__env_p_1279;
        __auto_type __ps_40 = (pong(__env___env_1278->acc, (__env___env_1278->n) - (INT64_C(1))));
...
static int64_t __fn_1283(void * __env_p_1286) {
        ...
        __auto_type __ps_41 = (ping(__env___env_1285->acc, (__env___env_1285->n) - (INT64_C(1))));
        if (tur_panicking) return (int64_t){0};
        return __ps_41;
}
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_105) {
            bool __t106;
            {
                ...
                bool __t107;
                if ((t1_983) == (INT64_C(0))) {
                    __t107 = (t2_984) == (INT64_C(0));
                } else {
                    bool __t108;
                    if ((t2_984) == (INT64_C(0))) {
                        __t108 = false;
                    } else {
                        __auto_type __ps_109 = (cons_hyeq_hygo(t1_983, t2_984));
                        if (tur_panicking) return (bool){0};
                        __t108 = __ps_109;
                    }
                    __t107 = __t108;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_992 = (int64_t)(intptr_t)(__ps_117);
                (void)out_992;
                __t112 = out_992;
            }
            __t110 = __t112;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_119) {
            ...
            int64_t __t120;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_999 = (int64_t)(intptr_t)(__ps_124);
                (void)out_999;
                __t120 = out_999;
            }
            __t118 = __t120;
        ...
        if (__ps_129) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1070 = __ps_130;
                (void)h_1070;
                __auto_type __ps_131 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1071 = __ps_131;
                (void)k_1071;
                __auto_type __ps_132 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1070, (void *)(intptr_t)(k_1071), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_132) {
                    void * __t133 = iter;
                    void * __t134 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t136;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1074 = __ps_138;
            (void)iter_1074;
            __auto_type __ps_139 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_140 = (hamt_slkeyeq((void *)(intptr_t)(__ps_139)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1075 = __ps_140;
            (void)keyeq_1075;
            __auto_type __ps_141 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_142 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1074), (void *)(intptr_t)(__ps_141), (void *)(intptr_t)(keyeq_1075)));
            if (tur_panicking) return (bool){0};
            bool result_1076 = __ps_142;
            (void)result_1076;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t163;
        {
            ...
            {
                __auto_type __ps_165 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1203));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1204 = __ps_165;
                (void)_un_unv_1204;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t168;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1253 = __ps_169;
            (void)r_1253;
            int64_t __t170;
            __auto_type __ps_171 = (schema_hydecode_hyok_qu(r_1253));
            if (tur_panicking) return (int64_t){0};
            if (__ps_171) {
                __auto_type __ps_172 = (schema_hydecode_hyvalue(r_1253));
                if (tur_panicking) return (int64_t){0};
                __t170 = __ps_172;
            } else {
                __auto_type __ps_173 = (schema_hydecode_hyerrors(r_1253));
                if (tur_panicking) return (int64_t){0};
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Option__int acc_1274; memset(&acc_1274, 0, sizeof(tur_adt_Option__int));
 int64_t n_1275 = 0;
 ...
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1274, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1275) == (INT64_C(0))) {
     int64_t __t180;
     __auto_type __ps_181 = (some___spec__bool_tur_adt_Option__int(acc_1274));
     if (tur_panicking) return (int64_t){0};
     if (__ps_181) {
         __t180 = INT64_C(100);
     } else {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1274, sizeof(tur_adt_Option__int)); __n182->saved[0] = (int64_t)(intptr_t)__ab; }
     __n182->saved[1] = (int64_t)(intptr_t)(n_1275);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1281, sizeof(tur_adt_Option__int)); __n182->saved[2] = (int64_t)(intptr_t)__ab; }
     __n182->saved[3] = (int64_t)(intptr_t)(n_1282);
   ...
   case 3: {
    __auto_type __ra183_0 = (acc_1274);
    __auto_type __ra183_1 = ((n_1275) - (INT64_C(1)));
    acc_1281 = __ra183_0;
    n_1282 = __ra183_1;
    __pc = 2; break;
   }
   case 4: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1274, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    n_1275 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&acc_1281, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    ...
    (void)(__box182);
    int64_t __t184;
    __auto_type __ps_185 = (some___spec__bool_tur_adt_Option__int(acc_1274));
    if (tur_panicking) return (int64_t){0};
    if (__ps_185) {
        __t184 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1275) + (__t184)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1282) == (INT64_C(0))) {
     int64_t __t186;
     __auto_type __ps_187 = (some___spec__bool_tur_adt_Option__int(acc_1281));
     if (tur_panicking) return (int64_t){0};
     if (__ps_187) {
         __t186 = INT64_C(300);
     } else {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1274, sizeof(tur_adt_Option__int)); __n188->saved[0] = (int64_t)(intptr_t)__ab; }
     __n188->saved[1] = (int64_t)(intptr_t)(n_1275);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1281, sizeof(tur_adt_Option__int)); __n188->saved[2] = (int64_t)(intptr_t)__ab; }
     __n188->saved[3] = (int64_t)(intptr_t)(n_1282);
   ...
   case 5: {
    __auto_type __ra189_0 = (acc_1281);
    __auto_type __ra189_1 = ((n_1282) - (INT64_C(1)));
    acc_1274 = __ra189_0;
    n_1275 = __ra189_1;
    __pc = 1; break;
   }
   case 6: {
    ...
    (void)(__box188);
    int64_t __t190;
    __auto_type __ps_191 = (some___spec__bool_tur_adt_Option__int(acc_1281));
    if (tur_panicking) return (int64_t){0};
    if (__ps_191) {
        __t190 = INT64_C(2);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1282) + (__t190)); __pc = __k->tag; break;
   }
  }
 }
}
