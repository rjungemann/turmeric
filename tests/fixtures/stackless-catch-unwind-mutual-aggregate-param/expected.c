...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t125;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1191 = __ps_127;
            (void)iter_1191;
            void * __ps_128 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_129 = (hamt_slkeyeq((void *)(intptr_t)(__ps_128)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1192 = __ps_129;
            (void)keyeq_1192;
            void * __ps_130 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_131 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1191), (void *)(intptr_t)(__ps_130), (void *)(intptr_t)(keyeq_1192)));
            if (tur_panicking) return ((bool)0);
            bool result_1193 = __ps_131;
            (void)result_1193;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t152;
        {
            ...
            {
                tur_adt_Vec__int * __ps_154 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1320));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1321 = __ps_154;
                (void)_un_unv_1321;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t158;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1371 = __ps_159;
            (void)r_1371;
            int64_t __t160;
            bool __ps_161 = (schema_hydecode_hyok_qu(r_1371));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_161) {
                int64_t __ps_162 = (schema_hydecode_hyvalue(r_1371));
                if (tur_panicking) return ((int64_t)0);
                __t160 = __ps_162;
            } else {
                int64_t __ps_163 = (schema_hydecode_hyerrors(r_1371));
                if (tur_panicking) return ((int64_t)0);
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1435) == (INT64_C(0))) {
     ...
     __n181->tag = 4; __n181->boundary = __b181; __n181->next = __k;
     __n181->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1434, sizeof(tur_adt_Option__int)); __n181->saved[0] = (int64_t)(intptr_t)__ab; }
     __n181->saved[1] = (int64_t)(intptr_t)(n_1435);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1441, sizeof(tur_adt_Option__int)); __n181->saved[2] = (int64_t)(intptr_t)__ab; }
     __n181->saved[3] = (int64_t)(intptr_t)(n_1442);
     ...
     __k = __n181; __pc = 3; break;
    }
   }
   case 3: {
    tur_adt_Option__int __ra182_0 = (acc_1434);
    int64_t __ra182_1 = ((n_1435) - (INT64_C(1)));
    acc_1441 = __ra182_0;
    n_1442 = __ra182_1;
    __pc = 2; break;
   }
   case 4: {
    ...
    (void)(__box181);
    int64_t __t183;
    bool __ps_184 = (some___spec__bool_tur_adt_Option__int(acc_1434));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_184) {
        __t183 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1435) + (__t183)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1442) == (INT64_C(0))) {
     int64_t __t185;
     ...
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1434, sizeof(tur_adt_Option__int)); __n187->saved[0] = (int64_t)(intptr_t)__ab; }
     __n187->saved[1] = (int64_t)(intptr_t)(n_1435);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1441, sizeof(tur_adt_Option__int)); __n187->saved[2] = (int64_t)(intptr_t)__ab; }
     __n187->saved[3] = (int64_t)(intptr_t)(n_1442);
     __n187->saved[4] = (int64_t)(intptr_t)(__t175);
     __n187->saved[5] = (int64_t)(intptr_t)(__t176);
     __n187->saved[6] = (int64_t)(intptr_t)(__t177);
     __n187->saved[7] = (int64_t)(intptr_t)(__t178);
     __k = __n187; __pc = 5; break;
    }
   }
   case 5: {
    tur_adt_Option__int __ra188_0 = (acc_1441);
    int64_t __ra188_1 = ((n_1442) - (INT64_C(1)));
    acc_1434 = __ra188_0;
    n_1435 = __ra188_1;
    __pc = 1; break;
   }
   case 6: {
    ...
    (void)(__box187);
    int64_t __t189;
    bool __ps_190 = (some___spec__bool_tur_adt_Option__int(acc_1441));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_190) {
        __t189 = INT64_C(2);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1442) + (__t189)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_192 = (ping(__ps_191, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_192));
    tur_adt_Option__int __ps_193 = (none__spec__tur_adt_Option__int());
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_194 = (ping(__ps_193, INT64_C(6)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_194));
    int64_t __t195;
    __t195 = INT64_C(0);
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
    tur_adt_Option__int __ps_200 = (ctor_None__int());
    if (tur_panicking) return (tur_adt_Option__int){0};
    return __ps_200;
}
