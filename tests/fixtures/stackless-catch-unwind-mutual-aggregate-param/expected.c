...
struct __env_1281 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
static int64_t __fn_1279(void * __env_p_1282) {
        struct __env_1281 *__env___env_1281 = (struct __env_1281 *)__env_p_1282;
        __auto_type __ps_40 = (pong(__env___env_1281->acc, (__env___env_1281->n) - (INT64_C(1))));
        if (tur_panicking) return (int64_t){0};
        return __ps_40;
}

struct __env_1288 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
static int64_t __fn_1286(void * __env_p_1289) {
        struct __env_1288 *__env___env_1288 = (struct __env_1288 *)__env_p_1289;
        __auto_type __ps_41 = (ping(__env___env_1288->acc, (__env___env_1288->n) - (INT64_C(1))));
        if (tur_panicking) return (int64_t){0};
        return __ps_41;
}
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_105) {
            bool __t106;
            {
                ...
                bool __t107;
                if ((t1_986) == (INT64_C(0))) {
                    __t107 = (t2_987) == (INT64_C(0));
                } else {
                    bool __t108;
                    if ((t2_987) == (INT64_C(0))) {
                        __t108 = false;
                    } else {
                        __auto_type __ps_109 = (cons_hyeq_hygo(t1_986, t2_987));
                        if (tur_panicking) return (bool){0};
                        __t108 = __ps_109;
                    }
                    __t107 = __t108;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_995 = (int64_t)(intptr_t)(__ps_117);
                (void)out_995;
                __t112 = out_995;
            }
            __t110 = __t112;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_119) {
            ...
            int64_t __t120;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1002 = (int64_t)(intptr_t)(__ps_124);
                (void)out_1002;
                __t120 = out_1002;
            }
            __t118 = __t120;
        ...
        if (__ps_129) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1073 = __ps_130;
                (void)h_1073;
                __auto_type __ps_131 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1074 = __ps_131;
                (void)k_1074;
                __auto_type __ps_132 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1073, (void *)(intptr_t)(k_1074), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_132) {
                    void * __t133 = iter;
                    void * __t134 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t136;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1077 = __ps_138;
            (void)iter_1077;
            __auto_type __ps_139 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_140 = (hamt_slkeyeq((void *)(intptr_t)(__ps_139)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1078 = __ps_140;
            (void)keyeq_1078;
            __auto_type __ps_141 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_142 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1077), (void *)(intptr_t)(__ps_141), (void *)(intptr_t)(keyeq_1078)));
            if (tur_panicking) return (bool){0};
            bool result_1079 = __ps_142;
            (void)result_1079;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t163;
        {
            ...
            {
                __auto_type __ps_165 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1206));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1207 = __ps_165;
                (void)_un_unv_1207;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t168;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1256 = __ps_169;
            (void)r_1256;
            int64_t __t170;
            __auto_type __ps_171 = (schema_hydecode_hyok_qu(r_1256));
            if (tur_panicking) return (int64_t){0};
            if (__ps_171) {
                __auto_type __ps_172 = (schema_hydecode_hyvalue(r_1256));
                if (tur_panicking) return (int64_t){0};
                __t170 = __ps_172;
            } else {
                __auto_type __ps_173 = (schema_hydecode_hyerrors(r_1256));
                if (tur_panicking) return (int64_t){0};
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Option__int acc_1277; memset(&acc_1277, 0, sizeof(tur_adt_Option__int));
 int64_t n_1278 = 0;
 tur_adt_Option__int acc_1284; memset(&acc_1284, 0, sizeof(tur_adt_Option__int));
 int64_t n_1285 = 0;
 int64_t __t176 = 0;
 int64_t __t177 = 0;
 int64_t __t178 = 0;
 ...
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1277, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
   n_1278 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1284, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1278) == (INT64_C(0))) {
     int64_t __t180;
     __auto_type __ps_181 = (some___spec__bool_tur_adt_Option__int(acc_1277));
     if (tur_panicking) return (int64_t){0};
     if (__ps_181) {
         __t180 = INT64_C(100);
     } else {
     ...
     __n182->tag = 4; __n182->boundary = __b182; __n182->next = __k;
     __n182->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1277, sizeof(tur_adt_Option__int)); __n182->saved[0] = (int64_t)(intptr_t)__ab; }
     __n182->saved[1] = (int64_t)(intptr_t)(n_1278);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1284, sizeof(tur_adt_Option__int)); __n182->saved[2] = (int64_t)(intptr_t)__ab; }
     __n182->saved[3] = (int64_t)(intptr_t)(n_1285);
     ...
     __k = __n182; __pc = 3; break;
    }
   }
   case 3: {
    __auto_type __ra183_0 = (acc_1277);
    __auto_type __ra183_1 = ((n_1278) - (INT64_C(1)));
    acc_1284 = __ra183_0;
    n_1285 = __ra183_1;
    __pc = 2; break;
   }
   case 4: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1277, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    n_1278 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&acc_1284, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    ...
    (void)(__box182);
    int64_t __t184;
    __auto_type __ps_185 = (some___spec__bool_tur_adt_Option__int(acc_1277));
    if (tur_panicking) return (int64_t){0};
    if (__ps_185) {
        __t184 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1278) + (__t184)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1285) == (INT64_C(0))) {
     int64_t __t186;
     __auto_type __ps_187 = (some___spec__bool_tur_adt_Option__int(acc_1284));
     if (tur_panicking) return (int64_t){0};
     if (__ps_187) {
         __t186 = INT64_C(300);
     } else {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1277, sizeof(tur_adt_Option__int)); __n188->saved[0] = (int64_t)(intptr_t)__ab; }
     __n188->saved[1] = (int64_t)(intptr_t)(n_1278);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1284, sizeof(tur_adt_Option__int)); __n188->saved[2] = (int64_t)(intptr_t)__ab; }
     __n188->saved[3] = (int64_t)(intptr_t)(n_1285);
     __n188->saved[4] = (int64_t)(intptr_t)(__t176);
     __n188->saved[5] = (int64_t)(intptr_t)(__t177);
     __n188->saved[6] = (int64_t)(intptr_t)(__t178);
     __n188->saved[7] = (int64_t)(intptr_t)(__t179);
     __k = __n188; __pc = 5; break;
    }
   }
   case 5: {
    __auto_type __ra189_0 = (acc_1284);
    __auto_type __ra189_1 = ((n_1285) - (INT64_C(1)));
    acc_1277 = __ra189_0;
    n_1278 = __ra189_1;
    __pc = 1; break;
   }
   case 6: {
    ...
    (void)(__box188);
    int64_t __t190;
    __auto_type __ps_191 = (some___spec__bool_tur_adt_Option__int(acc_1284));
    if (tur_panicking) return (int64_t){0};
    if (__ps_191) {
        __t190 = INT64_C(2);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1285) + (__t190)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    __auto_type __ps_192 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __auto_type __ps_193 = (ping(__ps_192, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_193));
    __auto_type __ps_194 = (none__spec__tur_adt_Option__int());
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __auto_type __ps_195 = (ping(__ps_194, INT64_C(6)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_195));
    int64_t __t196;
    __t196 = INT64_C(0);
