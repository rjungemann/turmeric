...
struct __env_1471 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
struct __env_1478 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
...
static int64_t some(int64_t x) {
        int64_t __ps_177 = (ctor_Option_Some(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_177;
}
        ...
        if (__ps_189) {
            bool __t190;
            {
                ...
                if ((t1_1139) == (INT64_C(0))) {
                    __t191 = (t2_1140) == (INT64_C(0));
                } else {
                    bool __t192;
                    if ((t2_1140) == (INT64_C(0))) {
                        __t192 = false;
                    } else {
                        bool __ps_193 = (cons_hyeq_hygo(t1_1139, t2_1140));
                        if (tur_panicking) return ((bool)0);
                        __t192 = __ps_193;
                    }
                    __t191 = __t192;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_199) {
            ...
            int64_t __t200;
            {
                ...
                int64_t out_1155 = (int64_t)(intptr_t)(__ps_204);
                (void)out_1155;
                __t200 = out_1155;
            }
            __t198 = __t200;
        ...
        if (__ps_209) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1226 = __ps_210;
                (void)h_1226;
                void * __ps_211 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1227 = __ps_211;
                (void)k_1227;
                bool __ps_212 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1226, (void *)(intptr_t)(k_1227), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_212) {
                    void * __t213 = iter;
                    void * __t214 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t216;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1230 = __ps_218;
            (void)iter_1230;
            void * __ps_219 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_220 = (hamt_slkeyeq((void *)(intptr_t)(__ps_219)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1231 = __ps_220;
            (void)keyeq_1231;
            void * __ps_221 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_222 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1230), (void *)(intptr_t)(__ps_221), (void *)(intptr_t)(keyeq_1231)));
            if (tur_panicking) return ((bool)0);
            bool result_1232 = __ps_222;
            (void)result_1232;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t243;
        {
            ...
            {
                tur_adt_Vec__int * __ps_245 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1362));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1363 = __ps_245;
                (void)_un_unv_1363;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t249;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1413 = __ps_250;
            (void)r_1413;
            int64_t __t251;
            bool __ps_252 = (schema_hydecode_hyok_qu(r_1413));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_252) {
                int64_t __ps_253 = (schema_hydecode_hyvalue(r_1413));
                if (tur_panicking) return ((int64_t)0);
                __t251 = __ps_253;
            } else {
                int64_t __ps_254 = (schema_hydecode_hyerrors(r_1413));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t257;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1464 = __ps_258;
            (void)m_1464;
            tur_frame __frame_259;
            tur_frame_init(&__frame_259, NULL);
            struct __defer_env_260 __t262 = {.m = m_1464};
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Option__int acc_1467; memset(&acc_1467, 0, sizeof(tur_adt_Option__int));
 int64_t n_1468 = 0;
 tur_adt_Option__int acc_1474; memset(&acc_1474, 0, sizeof(tur_adt_Option__int));
 int64_t n_1475 = 0;
 int64_t __t270 = 0;
 int64_t __t271 = 0;
 int64_t __t272 = 0;
 ...
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1467, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
   n_1468 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1474, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1468) == (INT64_C(0))) {
     int64_t __t274;
     bool __ps_275 = (some___spec__bool_tur_adt_Option__int(acc_1467));
     if (tur_panicking) return ((int64_t)0);
     if (__ps_275) {
         __t274 = INT64_C(100);
     } else {
     ...
     tur_handler_node *__b276 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
     __b276->parent = tur_handler_chain; tur_handler_chain = __b276;
     tur_cont *__n276 = (tur_cont*)malloc(sizeof(tur_cont));
     __n276->tag = 4; __n276->boundary = __b276; __n276->next = __k;
     __n276->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1467, sizeof(tur_adt_Option__int)); __n276->saved[0] = (int64_t)(intptr_t)__ab; }
     __n276->saved[1] = (int64_t)(intptr_t)(n_1468);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1474, sizeof(tur_adt_Option__int)); __n276->saved[2] = (int64_t)(intptr_t)__ab; }
     __n276->saved[3] = (int64_t)(intptr_t)(n_1475);
     __n276->saved[4] = (int64_t)(intptr_t)(__t270);
     __n276->saved[5] = (int64_t)(intptr_t)(__t271);
     __n276->saved[6] = (int64_t)(intptr_t)(__t272);
     __n276->saved[7] = (int64_t)(intptr_t)(__t273);
     __k = __n276; __pc = 3; break;
    }
   }
   case 3: {
    tur_adt_Option__int __ra277_0 = (acc_1467);
    int64_t __ra277_1 = ((n_1468) - (INT64_C(1)));
    acc_1474 = __ra277_0;
    n_1475 = __ra277_1;
    __pc = 2; break;
   }
   case 4: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1467, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    n_1468 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&acc_1474, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    n_1475 = (int64_t)(intptr_t)(__k->saved[3]);
    __t270 = (int64_t)(intptr_t)(__k->saved[4]);
    __t271 = (int64_t)(intptr_t)(__k->saved[5]);
    __t272 = (int64_t)(intptr_t)(__k->saved[6]);
    __t273 = (int64_t)(intptr_t)(__k->saved[7]);
    tur_handler_chain = __k->boundary->parent; free(__k->boundary);
    int64_t __box276;
    if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp276 = global_panic_payload; global_panic_payload = 0; __box276 = tur_box_err((int64_t)(intptr_t)__pp276); }
    else { __box276 = tur_box_ok(__v); }
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    tur_result_box_free((int64_t)(intptr_t)__box276);
    (void)(__box276);
    int64_t __t278;
    bool __ps_279 = (some___spec__bool_tur_adt_Option__int(acc_1467));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_279) {
        __t278 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1468) + (__t278)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1475) == (INT64_C(0))) {
     int64_t __t280;
     bool __ps_281 = (some___spec__bool_tur_adt_Option__int(acc_1474));
     if (tur_panicking) return ((int64_t)0);
     if (__ps_281) {
         __t280 = INT64_C(300);
     } else {
     ...
     __n282->tag = 6; __n282->boundary = __b282; __n282->next = __k;
     __n282->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1467, sizeof(tur_adt_Option__int)); __n282->saved[0] = (int64_t)(intptr_t)__ab; }
     __n282->saved[1] = (int64_t)(intptr_t)(n_1468);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1474, sizeof(tur_adt_Option__int)); __n282->saved[2] = (int64_t)(intptr_t)__ab; }
     __n282->saved[3] = (int64_t)(intptr_t)(n_1475);
     __n282->saved[4] = (int64_t)(intptr_t)(__t270);
     __n282->saved[5] = (int64_t)(intptr_t)(__t271);
     __n282->saved[6] = (int64_t)(intptr_t)(__t272);
     __n282->saved[7] = (int64_t)(intptr_t)(__t273);
     __k = __n282; __pc = 5; break;
    }
   }
   case 5: {
    tur_adt_Option__int __ra283_0 = (acc_1474);
    int64_t __ra283_1 = ((n_1475) - (INT64_C(1)));
    acc_1467 = __ra283_0;
    n_1468 = __ra283_1;
    __pc = 1; break;
   }
   case 6: {
    ...
    (void)(__box282);
    int64_t __t284;
    bool __ps_285 = (some___spec__bool_tur_adt_Option__int(acc_1474));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_285) {
        __t284 = INT64_C(2);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1475) + (__t284)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    tur_adt_Option__int __ps_286 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_287 = (ping(__ps_286, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_287));
    tur_adt_Option__int __ps_288 = (none__spec__tur_adt_Option__int());
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_289 = (ping(__ps_288, INT64_C(6)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_289));
    int64_t __t290;
    __t290 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
    tur_adt_Option__int __ps_294 = (ctor_Option_Some__int(x));
    if (tur_panicking) return (tur_adt_Option__int){0};
    return __ps_294;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
    tur_adt_Option__int __ps_295 = (ctor_Option_None__int());
    if (tur_panicking) return (tur_adt_Option__int){0};
    return __ps_295;
}
