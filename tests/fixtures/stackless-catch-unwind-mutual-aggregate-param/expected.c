...
struct __env_1273 { tur_thunk_int64_t_t __fn; tur_adt_Option__int acc; int64_t n; };
static int64_t __fn_1271(void * __env_p_1274) {
        struct __env_1273 *__env___env_1273 = (struct __env_1273 *)__env_p_1274;
        __auto_type __ps_40 = (pong(__env___env_1273->acc, (__env___env_1273->n) - (INT64_C(1))));
...
static int64_t __fn_1278(void * __env_p_1281) {
        ...
        __auto_type __ps_41 = (ping(__env___env_1280->acc, (__env___env_1280->n) - (INT64_C(1))));
        if (tur_panicking) return (int64_t){0};
        return __ps_41;
}
...
static int64_t some(int64_t x) {
        __auto_type __ps_94 = (ctor_Option(true, x));
        if (tur_panicking) return (int64_t){0};
        return __ps_94;
}
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t167;
        {
            ...
            {
                __auto_type __ps_169 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1198));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1199 = __ps_169;
                (void)_un_unv_1199;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t172;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1248 = __ps_173;
            (void)r_1248;
            int64_t __t174;
            __auto_type __ps_175 = (schema_hydecode_hyok_qu(r_1248));
            if (tur_panicking) return (int64_t){0};
            if (__ps_175) {
                __auto_type __ps_176 = (schema_hydecode_hyvalue(r_1248));
                if (tur_panicking) return (int64_t){0};
                __t174 = __ps_176;
            } else {
                __auto_type __ps_177 = (schema_hydecode_hyerrors(r_1248));
                if (tur_panicking) return (int64_t){0};
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Option__int acc_1269; memset(&acc_1269, 0, sizeof(tur_adt_Option__int));
 int64_t n_1270 = 0;
 tur_adt_Option__int acc_1276; memset(&acc_1276, 0, sizeof(tur_adt_Option__int));
 int64_t n_1277 = 0;
 int64_t __t180 = 0;
 int64_t __t181 = 0;
 int64_t __t182 = 0;
 ...
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1269, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
   n_1270 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1276, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1270) == (INT64_C(0))) {
     int64_t __t184;
     __auto_type __ps_185 = (some___spec__bool_tur_adt_Option__int(acc_1269));
     if (tur_panicking) return (int64_t){0};
     if (__ps_185) {
         __t184 = INT64_C(100);
     } else {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1269, sizeof(tur_adt_Option__int)); __n186->saved[0] = (int64_t)(intptr_t)__ab; }
     __n186->saved[1] = (int64_t)(intptr_t)(n_1270);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1276, sizeof(tur_adt_Option__int)); __n186->saved[2] = (int64_t)(intptr_t)__ab; }
     __n186->saved[3] = (int64_t)(intptr_t)(n_1277);
     __n186->saved[4] = (int64_t)(intptr_t)(__t180);
     __n186->saved[5] = (int64_t)(intptr_t)(__t181);
     __n186->saved[6] = (int64_t)(intptr_t)(__t182);
     __n186->saved[7] = (int64_t)(intptr_t)(__t183);
     __k = __n186; __pc = 3; break;
    }
   }
   case 3: {
    __auto_type __ra187_0 = (acc_1269);
    __auto_type __ra187_1 = ((n_1270) - (INT64_C(1)));
    acc_1276 = __ra187_0;
    n_1277 = __ra187_1;
    __pc = 2; break;
   }
   case 4: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1269, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    n_1270 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&acc_1276, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
    n_1277 = (int64_t)(intptr_t)(__k->saved[3]);
    __t180 = (int64_t)(intptr_t)(__k->saved[4]);
    __t181 = (int64_t)(intptr_t)(__k->saved[5]);
    __t182 = (int64_t)(intptr_t)(__k->saved[6]);
    __t183 = (int64_t)(intptr_t)(__k->saved[7]);
    ...
    (void)(__box186);
    int64_t __t188;
    __auto_type __ps_189 = (some___spec__bool_tur_adt_Option__int(acc_1269));
    if (tur_panicking) return (int64_t){0};
    if (__ps_189) {
        __t188 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1270) + (__t188)); __pc = __k->tag; break;
   }
   case 2: {
    if ((n_1277) == (INT64_C(0))) {
     int64_t __t190;
     __auto_type __ps_191 = (some___spec__bool_tur_adt_Option__int(acc_1276));
     if (tur_panicking) return (int64_t){0};
     if (__ps_191) {
         __t190 = INT64_C(300);
     } else {
     ...
     __n192->tag = 6; __n192->boundary = __b192; __n192->next = __k;
     __n192->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1269, sizeof(tur_adt_Option__int)); __n192->saved[0] = (int64_t)(intptr_t)__ab; }
     __n192->saved[1] = (int64_t)(intptr_t)(n_1270);
     { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc_1276, sizeof(tur_adt_Option__int)); __n192->saved[2] = (int64_t)(intptr_t)__ab; }
     __n192->saved[3] = (int64_t)(intptr_t)(n_1277);
     __n192->saved[4] = (int64_t)(intptr_t)(__t180);
     __n192->saved[5] = (int64_t)(intptr_t)(__t181);
     __n192->saved[6] = (int64_t)(intptr_t)(__t182);
     __n192->saved[7] = (int64_t)(intptr_t)(__t183);
     __k = __n192; __pc = 5; break;
    }
   }
   case 5: {
    __auto_type __ra193_0 = (acc_1276);
    __auto_type __ra193_1 = ((n_1277) - (INT64_C(1)));
    acc_1269 = __ra193_0;
    n_1270 = __ra193_1;
    __pc = 1; break;
   }
   case 6: {
    ...
    (void)(__box192);
    int64_t __t194;
    __auto_type __ps_195 = (some___spec__bool_tur_adt_Option__int(acc_1276));
    if (tur_panicking) return (int64_t){0};
    if (__ps_195) {
        __t194 = INT64_C(2);
    } else {
    ...
    __v = (int64_t)(intptr_t)((n_1277) + (__t194)); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    __auto_type __ps_196 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __auto_type __ps_197 = (ping(__ps_196, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_197));
    __auto_type __ps_198 = (none__spec__tur_adt_Option__int());
    /* panic-return-signal: ret ctype unknown; no propagation here */
    __auto_type __ps_199 = (ping(__ps_198, INT64_C(6)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_199));
    int64_t __t200;
    __t200 = INT64_C(0);
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
    __auto_type __ps_204 = (ctor_Option__int(false, (int64_t){0}));
    if (tur_panicking) return (tur_adt_Option__int){0};
    return __ps_204;
}
