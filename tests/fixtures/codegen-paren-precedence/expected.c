...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_159 = (check(INT64_C(1), INT64_C(2), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_159));
        __auto_type __ps_160 = (check(INT64_C(1), INT64_C(9), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_160));
        __auto_type __ps_161 = (check(INT64_C(0), INT64_C(2), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_161));
        int64_t __t162;
        __t162 = INT64_C(0);
