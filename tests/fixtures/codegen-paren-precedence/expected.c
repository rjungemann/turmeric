...
static int64_t check(int64_t, int64_t, int64_t);
...
static int64_t check(int64_t a, int64_t b, int64_t c) {
        int64_t __t172;
        bool __t173 = (a) == (INT64_C(1));
        if (__t173) {
            bool __t174 = (b) < (c);
            if (!__t174) {
                __t174 = (b) == (INT64_C(2));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_176 = (check(INT64_C(1), INT64_C(2), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        int64_t __ps_177 = (check(INT64_C(1), INT64_C(9), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        int64_t __ps_178 = (check(INT64_C(0), INT64_C(2), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_178));
        int64_t __t179;
        __t179 = INT64_C(0);
