...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_177 = (check(INT64_C(1), INT64_C(2), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        int64_t __ps_178 = (check(INT64_C(1), INT64_C(9), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_178));
        int64_t __ps_179 = (check(INT64_C(0), INT64_C(2), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        int64_t __t180;
        __t180 = INT64_C(0);
