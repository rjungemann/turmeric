...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_187 = (check(INT64_C(1), INT64_C(2), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_187));
        int64_t __ps_188 = (check(INT64_C(1), INT64_C(9), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_188));
        int64_t __ps_189 = (check(INT64_C(0), INT64_C(2), INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_189));
        int64_t __t190;
        __t190 = INT64_C(0);
