...
int main() {
        ...
        int64_t __t1;
        {
            void * s_273 = mk_scheduler();
            (void)s_273;
            sched_spawn((void *)(intptr_t)(s_273), (void *)(intptr_t)(mk_fiber((void *)(intptr_t)(fiber_server))));
            sched_spawn((void *)(intptr_t)(s_273), (void *)(intptr_t)(mk_fiber((void *)(intptr_t)(fiber_client))));
            sched_run((void *)(intptr_t)(s_273));
            puts("all done");
            int64_t __t2;
            __t2 = INT64_C(0);
            __t1 = __t2;
