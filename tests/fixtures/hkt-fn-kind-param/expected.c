...
static int64_t apply_functor(int64_t, int64_t);
static int64_t triple(int64_t);
...
static int64_t apply_functor(int64_t container, int64_t fn) {
        return ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_option_singleton.fmap))(container, fn);
}
...
int main() {
        {
            int64_t opt_632 = __opt_some(INT64_C(7));
            (void)opt_632;
            {
                int64_t result_633 = apply_functor(opt_632, (int64_t)(intptr_t)(triple));
                (void)result_633;
                printf("%lld\n", (long long)(__opt_unwrap(result_633)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
