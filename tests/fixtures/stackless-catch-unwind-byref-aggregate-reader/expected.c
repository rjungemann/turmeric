...
struct __defer_env_266 {int64_t m; };

static void __defer_272(void *__env) {
    untrailed_hyend();
}

static void __defer_267(void *__env) {
    struct __defer_env_266 *__e = (struct __defer_env_266 *)__env;
...
static int64_t list_hyeq_qu__cps(int64_t l1, int64_t l2, int64_t cmp_fn, DK *__kont) {
    ...
    int64_t __t4;
    int64_t __t5;
    bool __ps_186 = (tnil_qu(l1));
    if (tur_panicking) return ((int64_t)0);
    __t0 = __ps_186;
    if (__t0) {
        bool __ps_187 = (tnil_qu(l2));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_187;
        return dk_run(__kont, (intptr_t)(__t1));
    } else {
        bool __ps_188 = (tnil_qu(l2));
        if (tur_panicking) return ((int64_t)0);
        __t2 = __ps_188;
        if (__t2) {
            return dk_run(__kont, (intptr_t)(false));
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_195) {
            bool __t196;
            {
                ...
                (void)t2_1281;
                bool __t197;
                if ((t1_1280) == (INT64_C(0))) {
                    __t197 = (t2_1281) == (INT64_C(0));
                } else {
                    bool __t198;
                    if ((t2_1281) == (INT64_C(0))) {
                        __t198 = false;
                    } else {
                        bool __ps_199 = (cons_hyeq_hygo(t1_1280, t2_1281));
                        if (tur_panicking) return ((bool)0);
                        __t198 = __ps_199;
                    }
                    __t197 = __t198;
...
static int64_t _un_uncons_hyfmap__cps(int64_t cell, void * f, DK *__kont) {
    ...
    int64_t __t1;
    int64_t __t3;
    bool __ps_200 = (tnil_qu(cell));
    if (tur_panicking) return ((int64_t)0);
    __t0 = __ps_200;
    if (__t0) {
        return dk_run(__kont, (intptr_t)(INT64_C(0)));
    } else {
        int64_t __ps_201 = (list_hyhead(cell));
        if (tur_panicking) return ((int64_t)0);
        int64_t __ps_202 = ((*( tur_thunk_int64_t_int64_t_t *)(f))(f, __ps_201));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_202;
        int64_t __ps_203 = (list_hytail(cell));
        if (tur_panicking) return ((int64_t)0);
        __t3 = __ps_203;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_205) {
            ...
            int64_t __t206;
            {
                int64_t __ps_207 = (list_hyhead(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_208 = (list_hytail(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_209 = (list_hyconcat(__ps_208, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_210 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_207, __ps_209));
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_210), sizeof(__ps_210));
                int64_t out_1296 = (int64_t)(intptr_t)(__ps_210);
                (void)out_1296;
                __t206 = out_1296;
            }
            __t204 = __t206;
...
static int64_t car(int64_t l) {
        int64_t __ps_211 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_211;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_212 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_212;
}

static bool null_qu(int64_t l) {
        bool __ps_213 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_213;
}

static int64_t length(int64_t l) {
        int64_t __ps_214 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_214;
}
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        __tur_tailcall:;
        bool __ps_215 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((bool)0);
        if (__ps_215) {
            {
                int64_t __ps_216 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                int64_t h_1367 = __ps_216;
                (void)h_1367;
                void * __ps_217 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1368 = __ps_217;
                (void)k_1368;
                bool __ps_218 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1367, (void *)(intptr_t)(k_1368), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_218) {
                    void * __t219 = iter;
                    void * __t220 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t222;
        {
            void * __ps_223 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_224 = (hamt_sliter_hyalloc((void *)(intptr_t)(__ps_223)));
            if (tur_panicking) return ((bool)0);
            void * iter_1371 = __ps_224;
            (void)iter_1371;
            void * __ps_225 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_226 = (hamt_slkeyeq((void *)(intptr_t)(__ps_225)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1372 = __ps_226;
            (void)keyeq_1372;
            void * __ps_227 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_228 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1371), (void *)(intptr_t)(__ps_227), (void *)(intptr_t)(keyeq_1372)));
            if (tur_panicking) return ((bool)0);
            bool result_1373 = __ps_228;
            (void)result_1373;
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        int64_t __ps_231 = (set_hycount(s1));
        if (tur_panicking) return ((bool)0);
        int64_t __ps_232 = (set_hycount(s2));
        if (tur_panicking) return ((bool)0);
        bool __t230 = (__ps_231) == (__ps_232);
        if (__t230) {
            bool __ps_233 = (set_hyeq_hydriver(s1, s2));
            if (tur_panicking) return ((bool)0);
            __t230 = __ps_233;
        }
        return __t230;
...
static bool mutmap_hyeq_hyloop(int64_t m1, int64_t m2, int64_t i, int64_t cap, int64_t val_cmp) {
        ...
        if ((i) == (cap)) {
            ...
            bool __t235;
            bool __ps_236 = (mutmap_hyslot_hyoccupied_qu(m1, i));
            if (tur_panicking) return ((bool)0);
            if (__ps_236) {
                bool __t237;
                int64_t __ps_238 = (mutmap_hyslot_hyhash(m1, i));
                if (tur_panicking) return ((bool)0);
                int64_t __ps_239 = (mutmap_hyslot_hykey(m1, i));
                if (tur_panicking) return ((bool)0);
                bool __ps_240 = (mutmap_hyhas_qu(m2, __ps_238, __ps_239));
                if (tur_panicking) return ((bool)0);
                if (__ps_240) {
                    bool __t241;
                    int64_t __ps_242 = (mutmap_hyslot_hyvalue(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_243 = (mutmap_hyslot_hyhash(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_244 = (mutmap_hyslot_hykey(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_245 = (mutmap_hyget(m2, __ps_243, __ps_244));
                    if (tur_panicking) return ((bool)0);
                    bool __ps_246 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_242, __ps_245));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_246) {
                        bool __ps_247 = (mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp)));
                        if (tur_panicking) return ((bool)0);
                        __t241 = __ps_247;
                    } else {
                        __t241 = false;
                ...
                bool __ps_248 = (mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp)));
                if (tur_panicking) return ((bool)0);
                __t235 = __ps_248;
            }
            __t234 = __t235;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t249;
        {
            int64_t _un_unvw_1503 = a;
            (void)_un_unvw_1503;
            tur_adt_Vec__int * __t250;
            {
                tur_adt_Vec__int * __ps_251 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1503));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1504 = __ps_251;
                (void)_un_unv_1504;
        ...
        int64_t __ps_253 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t249))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_253;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_254 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_254);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t255;
        {
            int64_t __ps_256 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1554 = __ps_256;
            (void)r_1554;
            int64_t __t257;
            bool __ps_258 = (schema_hydecode_hyok_qu(r_1554));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_258) {
                int64_t __ps_259 = (schema_hydecode_hyvalue(r_1554));
                if (tur_panicking) return ((int64_t)0);
                __t257 = __ps_259;
            } else {
                int64_t __ps_260 = (schema_hydecode_hyerrors(r_1554));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_261 = (schema_hydecode_hyabort(__ps_260));
                if (tur_panicking) return ((int64_t)0);
                __t257 = __ps_261;
            }
            __t255 = __t257;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_262 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_262;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t263;
        {
            int64_t __ps_264 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1605 = __ps_264;
            (void)m_1605;
            tur_frame __frame_265;
            tur_frame_init(&__frame_265, NULL);
            struct __defer_env_266 __t268 = {.m = m_1605};
            tur_frame_push_defer(&__frame_265, __defer_267, &__t268);
            int64_t __t269;
            int64_t __ps_270 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) { tur_frame_fire_lifo(&__frame_265); return ((int64_t)0); }
            __t269 = __ps_270;
            tur_frame_fire_lifo(&__frame_265);
            __t263 = __t269;
        }
        return __t263;
}
...
static int64_t with_hyuntrailed(int64_t body) {
        tur_frame __frame_271;
        tur_frame_init(&__frame_271, NULL);
        untrailed_hybegin();
        tur_frame_push_defer(&__frame_271, __defer_272, NULL);
        int64_t __t273;
        int64_t __ps_274 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
        if (tur_panicking) { tur_frame_fire_lifo(&__frame_271); return ((int64_t)0); }
        __t273 = __ps_274;
        tur_frame_fire_lifo(&__frame_271);
        return __t273;
}
...
static int64_t with_hyregion(int64_t body) {
        int64_t __ps_275 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_275;
}
...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t276;
        bool __ps_277 = (ok___spec__bool_tur_adt_Result__int__int(r));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_277) {
            __t276 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1610) == (INT64_C(0))) {
     tur_adt_Result__int__int __ra282_0 = (acc_1609);
     r_1608 = __ra282_0;
     __pc = 2; break;
    } else {
     tur_handler_node *__b283 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
     __b283->parent = tur_handler_chain; tur_handler_chain = __b283;
     tur_cont *__n283 = (tur_cont*)malloc(sizeof(tur_cont));
     __n283->tag = 4; __n283->boundary = __b283; __n283->next = __k;
     __n283->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1609, sizeof(tur_adt_Result__int__int)); __n283->saved[0] = (int64_t)(intptr_t)__ab; }
     __n283->saved[1] = (int64_t)(intptr_t)(n_1610);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1608, sizeof(tur_adt_Result__int__int)); __n283->saved[2] = (int64_t)(intptr_t)__ab; }
     __n283->saved[3] = (int64_t)(intptr_t)(__t278);
     __n283->saved[4] = (int64_t)(intptr_t)(__t279);
     __n283->saved[5] = (int64_t)(intptr_t)(__t280);
     __n283->saved[6] = (int64_t)(intptr_t)(__t281);
     __k = __n283; __pc = 3; break;
    }
   }
   case 3: {
    tur_adt_Result__int__int __ra284_0 = (acc_1609);
    int64_t __ra284_1 = ((n_1610) - (INT64_C(1)));
    acc_1609 = __ra284_0;
    n_1610 = __ra284_1;
    __pc = 1; break;
   }
   case 4: {
    ...
    __t278 = (int64_t)(intptr_t)(__k->saved[3]);
    __t279 = (int64_t)(intptr_t)(__k->saved[4]);
    __t280 = (int64_t)(intptr_t)(__k->saved[5]);
    __t281 = (int64_t)(intptr_t)(__k->saved[6]);
    tur_handler_chain = __k->boundary->parent; free(__k->boundary);
    int64_t __box283;
    if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp283 = global_panic_payload; global_panic_payload = 0; __box283 = tur_box_err((int64_t)(intptr_t)__pp283); }
    else { __box283 = tur_box_ok(__v); }
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    tur_result_box_free((int64_t)(intptr_t)__box283);
    (void)(__box283);
    tur_cont *__n285 = (tur_cont*)malloc(sizeof(tur_cont));
    __n285->tag = 5; __n285->boundary = 0; __n285->next = __k;
    ...
    __n285->saved[3] = (int64_t)(intptr_t)(__t278);
    __n285->saved[4] = (int64_t)(intptr_t)(__t279);
    __n285->saved[5] = (int64_t)(intptr_t)(__t280);
    __n285->saved[6] = (int64_t)(intptr_t)(__t281);
    tur_adt_Result__int__int __ra285_0 = (acc_1609);
    r_1608 = __ra285_0;
    __k = __n285; __pc = 2; break;
   }
   case 5: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1609, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1610 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t280 = (int64_t)(intptr_t)(__k->saved[5]);
    __t281 = (int64_t)(intptr_t)(__k->saved[6]);
    __t281 = (int64_t)(intptr_t)(__v);
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((n_1610) + (__t281)); __pc = __k->tag; break;
   }
   case 2: {
    int64_t __t286;
    bool __ps_287 = (ok___spec__bool_tur_adt_Result__int__int(r_1608));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_287) {
        __t286 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)(__t286); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_288 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_289 = (step(__ps_288, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_289));
    tur_adt_Result__int__int __ps_290 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_291 = (step(__ps_290, INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_291));
    int64_t __t292;
    __t292 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
    tur_adt_Cons__int * __ps_293 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
    tur_adt_Vec__int * __ps_294 = (vec_new__spec__tur_adt_Vec__int__());
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_296 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_297 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_297;
}
