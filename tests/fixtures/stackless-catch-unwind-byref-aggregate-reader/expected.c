...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t153;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1309 = __ps_154;
            (void)r_1309;
            int64_t __t155;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1309));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                int64_t __ps_157 = (schema_hydecode_hyvalue(r_1309));
                if (tur_panicking) return ((int64_t)0);
                __t155 = __ps_157;
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1309));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __ps_164 = (describe(acc));
            if (tur_panicking) break;
            __v = (int64_t)(intptr_t)(__ps_164); __pc = __k->tag; break;
           } else {
            tur_handler_node *__b165 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b165->parent = tur_handler_chain; tur_handler_chain = __b165;
            tur_cont *__n165 = (tur_cont*)malloc(sizeof(tur_cont));
            __n165->tag = 3; __n165->boundary = __b165; __n165->next = __k;
            __n165->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, acc, sizeof(tur_adt_Result__int__int)); __n165->saved[0] = (int64_t)(intptr_t)__ab; }
            __n165->saved[1] = (int64_t)(intptr_t)(n);
            __n165->saved[2] = (int64_t)(intptr_t)(__t162);
            __n165->saved[3] = (int64_t)(intptr_t)(__t163);
            __k = __n165; __pc = 2; break;
           }
          }
          case 2: {
           const tur_adt_Result__int__int *__ra166_0 = (acc);
           int64_t __ra166_1 = ((n) - (INT64_C(1)));
           memmove(&acc__agg, __ra166_0, sizeof(tur_adt_Result__int__int)); acc = &acc__agg;
           n = __ra166_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           int64_t __box165;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp165 = global_panic_payload; global_panic_payload = 0; __box165 = tur_box_err((int64_t)(intptr_t)__pp165); }
           else { __box165 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_result_box_free((int64_t)(intptr_t)__box165);
           (void)(__box165);
           int64_t __ps_167 = (describe(acc));
           if (tur_panicking) break;
           __v = (int64_t)(intptr_t)((n) + (__ps_167)); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_170 = (step(&__t169, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_170));
        ...
        int64_t __ps_173 = (step(&__t172, INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_173));
        int64_t __t174;
        __t174 = INT64_C(0);
