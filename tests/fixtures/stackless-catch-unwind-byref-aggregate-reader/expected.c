...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_97) {
            bool __t98;
            {
                ...
                (void)t2_1281;
                bool __t99;
                bool __ps_100 = (tnil_qu(t1_1280));
                if (tur_panicking) return ((bool)0);
                if (__ps_100) {
                    bool __ps_101 = (tnil_qu(t2_1281));
                    if (tur_panicking) return ((bool)0);
                    __t99 = __ps_101;
                } else {
                    bool __t102;
                    bool __ps_103 = (tnil_qu(t2_1281));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_103) {
                        __t102 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1280, t2_1281));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_104;
                    }
                    __t99 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                int64_t out_1296 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1296;
                __t111 = out_1296;
            }
            __t109 = __t111;
        ...
        if (__ps_116) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1367 = __ps_117;
                (void)h_1367;
                void * __ps_118 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1368 = __ps_118;
                (void)k_1368;
                bool __ps_119 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1367, (void *)(intptr_t)(k_1368), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_119) {
                    void * __t120 = iter;
                    void * __t121 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1371 = __ps_125;
            (void)iter_1371;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1372 = __ps_127;
            (void)keyeq_1372;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1371), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1372)));
            if (tur_panicking) return ((bool)0);
            bool result_1373 = __ps_129;
            (void)result_1373;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1503));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1504 = __ps_152;
                (void)_un_unv_1504;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1554 = __ps_155;
            (void)r_1554;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1554));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                return schema_hydecode_hyvalue(r_1554);
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1554));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1605 = __ps_160;
            (void)m_1605;
            tur_frame __frame_161;
            tur_frame_init(&__frame_161, NULL);
            struct __defer_env_162 __t164 = {.m = m_1605};
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1610) == (INT64_C(0))) {
     tur_adt_Result__int__int __ra178_0 = (acc_1609);
     r_1608 = __ra178_0;
     __pc = 2; break;
    } else {
     ...
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1609, sizeof(tur_adt_Result__int__int)); __n179->saved[0] = (int64_t)(intptr_t)__ab; }
     __n179->saved[1] = (int64_t)(intptr_t)(n_1610);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1608, sizeof(tur_adt_Result__int__int)); __n179->saved[2] = (int64_t)(intptr_t)__ab; }
   ...
   case 3: {
    tur_adt_Result__int__int __ra180_0 = (acc_1609);
    int64_t __ra180_1 = ((n_1610) - (INT64_C(1)));
    acc_1609 = __ra180_0;
    n_1610 = __ra180_1;
    __pc = 1; break;
   }
   case 4: {
    ...
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1609, sizeof(tur_adt_Result__int__int)); __n181->saved[0] = (int64_t)(intptr_t)__ab; }
    __n181->saved[1] = (int64_t)(intptr_t)(n_1610);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1608, sizeof(tur_adt_Result__int__int)); __n181->saved[2] = (int64_t)(intptr_t)__ab; }
   ...
   case 5: {
    ...
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((n_1610) + (__t177)); __pc = __k->tag; break;
   }
   case 2: {
    int64_t __t182;
    bool __ps_183 = (ok___spec__bool_tur_adt_Result__int__int(r_1608));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_183) {
        __t182 = INT64_C(1);
    } else {
