...
static bool __fn_785(int64_t, int64_t);
...
static bool __fn_785(int64_t a, int64_t b) {
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t10) {
            ...
            __t14[1] = (int64_t)(intptr_t)__fn_785;
            void *__t15 = __t14;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t30;
        {
            ...
            bool __t31;
            if ((t1_986) == (INT64_C(0))) {
                __t31 = (t2_987) == (INT64_C(0));
            } else {
                bool __t32;
                if ((t2_987) == (INT64_C(0))) {
                    __t32 = false;
                } else {
                    __auto_type __ps_33 = (cons_hyeq_hygo(t1_986, t2_987));
                    if (tur_panicking) return (bool){0};
                    __t32 = __ps_33;
                }
                __t31 = __t32;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t36) {
            ...
            __t40[1] = (int64_t)(intptr_t)__fn_1117;
            void *__t41 = __t40;
...
struct __env_1271 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
static int64_t __fn_1269(void * __env_p_1272) {
        struct __env_1271 *__env___env_1271 = (struct __env_1271 *)__env_p_1272;
        tur_adt_Result__int__int __t43 = __env___env_1271->acc;
        __auto_type __ps_44 = (step(&__t43, (__env___env_1271->n) - (INT64_C(1))));
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_72) {
            bool __t73;
            {
                ...
                (void)k_736;
                bool __t76;
                __auto_type __ps_77 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_735, (void *)(intptr_t)(k_736), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_77) {
                    bool __t78;
                    __auto_type __ps_79 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_80 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_735, (void *)(intptr_t)(k_736), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t83;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_740 = __ps_85;
            (void)iter_740;
            __auto_type __ps_86 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_87 = (hamt_slkeyeq((void *)(intptr_t)(__ps_86)));
            if (tur_panicking) return (bool){0};
            void * keyeq_741 = __ps_87;
            (void)keyeq_741;
            __auto_type __ps_88 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_89 = (map_hyeq_hyloop((void *)(intptr_t)(iter_740), (void *)(intptr_t)(__ps_88), (void *)(intptr_t)(keyeq_741), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_742 = __ps_89;
            (void)result_742;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_111) {
            bool __t112;
            {
                ...
                bool __t113;
                if ((t1_981) == (INT64_C(0))) {
                    __t113 = (t2_982) == (INT64_C(0));
                } else {
                    bool __t114;
                    if ((t2_982) == (INT64_C(0))) {
                        __t114 = false;
                    } else {
                        __auto_type __ps_115 = (cons_hyeq_hygo(t1_981, t2_982));
                        if (tur_panicking) return (bool){0};
                        __t114 = __ps_115;
                    }
                    __t113 = __t114;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_117) {
            ...
            int64_t __t118;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_990 = (int64_t)(intptr_t)(__ps_123);
                (void)out_990;
                __t118 = out_990;
            }
            __t116 = __t118;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_125) {
            ...
            int64_t __t126;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_997 = (int64_t)(intptr_t)(__ps_130);
                (void)out_997;
                __t126 = out_997;
            }
            __t124 = __t126;
        ...
        if (__ps_135) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1062 = __ps_136;
                (void)h_1062;
                __auto_type __ps_137 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1063 = __ps_137;
                (void)k_1063;
                __auto_type __ps_138 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1062, (void *)(intptr_t)(k_1063), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_138) {
                    void * __t139 = iter;
                    void * __t140 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t142;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1066 = __ps_144;
            (void)iter_1066;
            __auto_type __ps_145 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_146 = (hamt_slkeyeq((void *)(intptr_t)(__ps_145)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1067 = __ps_146;
            (void)keyeq_1067;
            __auto_type __ps_147 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_148 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1066), (void *)(intptr_t)(__ps_147), (void *)(intptr_t)(keyeq_1067)));
            if (tur_panicking) return (bool){0};
            bool result_1068 = __ps_148;
            (void)result_1068;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_1066));
            bool __t149;
            __t149 = result_1068;
            __t142 = __t149;
        }
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        int64_t __t169;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t _un_unv_1196 = __ps_170;
            (void)_un_unv_1196;
            tur_hyvec_hyhomog_un_un(a, b);
            int64_t __t171;
            vec_hypush_ex(_un_unv_1196, a);
            int64_t __t172;
            vec_hypush_ex(_un_unv_1196, b);
            int64_t __t173;
            __t173 = _un_unv_1196;
            __t172 = __t173;
            __t171 = __t172;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t175;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1245 = __ps_176;
            (void)r_1245;
            int64_t __t177;
            __auto_type __ps_178 = (schema_hydecode_hyok_qu(r_1245));
            if (tur_panicking) return (int64_t){0};
            if (__ps_178) {
                __auto_type __ps_179 = (schema_hydecode_hyvalue(r_1245));
                if (tur_panicking) return (int64_t){0};
                __t177 = __ps_179;
            } else {
                __auto_type __ps_180 = (schema_hydecode_hyerrors(r_1245));
                if (tur_panicking) return (int64_t){0};
...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            __auto_type __ps_186 = (describe(acc));
            if (tur_panicking) break;
            __v = (int64_t)(intptr_t)(__ps_186); __pc = __k->tag; break;
           } else {
            ...
            __n187->aggr_mask = 0x1u;
            { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, acc, sizeof(tur_adt_Result__int__int)); __n187->saved[0] = (int64_t)(intptr_t)__ab; }
            __n187->saved[1] = (int64_t)(intptr_t)(n);
            __n187->saved[2] = (int64_t)(intptr_t)(__t184);
            __n187->saved[3] = (int64_t)(intptr_t)(__t185);
            __k = __n187; __pc = 2; break;
           }
          }
          case 2: {
           __auto_type __ra188_0 = (acc);
           __auto_type __ra188_1 = ((n) - (INT64_C(1)));
           memmove(&acc__agg, __ra188_0, sizeof(tur_adt_Result__int__int)); acc = &acc__agg;
           n = __ra188_1;
           __pc = 1; break;
          }
          case 3: {
           ...
           (void)(__box187);
           __auto_type __ps_189 = (describe(acc));
           if (tur_panicking) break;
           __v = (int64_t)(intptr_t)((n) + (__ps_189)); __pc = __k->tag; break;
          }
         }
        }
}
