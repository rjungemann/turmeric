...
struct __env_1474 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1472(void * __env_p_1475) {
        struct __env_1474 *__env___env_1474 = (struct __env_1474 *)__env_p_1475;
        int64_t __ps_124 = (step(__env___env_1474->acc, (__env___env_1474->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t255;
        {
            ...
            (void)m_1464;
            int64_t __ps_257 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1465 = __ps_257;
            (void)r_1465;
            bool __ps_258 = (bt_hyundo_hyto_ex(m_1464));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_258);
            int64_t __t259;
            __t259 = r_1465;
...
static int64_t with_hyregion(int64_t body) {
        int64_t __ps_264 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_264;
}
...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t265;
        bool __ps_266 = (ok___spec__bool_tur_adt_Result__int__int(r));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_266) {
            __t265 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Result__int__int acc_1470; memset(&acc_1470, 0, sizeof(tur_adt_Result__int__int));
 int64_t n_1471 = 0;
 tur_adt_Result__int__int r_1469; memset(&r_1469, 0, sizeof(tur_adt_Result__int__int));
 int64_t __t267 = 0;
 int64_t __t268 = 0;
 int64_t __t269 = 0;
 int64_t __t270 = 0;
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1470, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   n_1471 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&r_1469, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   break; }
 }
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1471) == (INT64_C(0))) {
     tur_adt_Result__int__int __ra271_0 = (acc_1470);
     r_1469 = __ra271_0;
     __pc = 2; break;
    } else {
     tur_handler_node *__b272 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
     __b272->parent = tur_handler_chain; tur_handler_chain = __b272;
     tur_cont *__n272 = (tur_cont*)malloc(sizeof(tur_cont));
     __n272->tag = 4; __n272->boundary = __b272; __n272->next = __k;
     __n272->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1470, sizeof(tur_adt_Result__int__int)); __n272->saved[0] = (int64_t)(intptr_t)__ab; }
     __n272->saved[1] = (int64_t)(intptr_t)(n_1471);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1469, sizeof(tur_adt_Result__int__int)); __n272->saved[2] = (int64_t)(intptr_t)__ab; }
     __n272->saved[3] = (int64_t)(intptr_t)(__t267);
     __n272->saved[4] = (int64_t)(intptr_t)(__t268);
     __n272->saved[5] = (int64_t)(intptr_t)(__t269);
     __n272->saved[6] = (int64_t)(intptr_t)(__t270);
     __k = __n272; __pc = 3; break;
    }
   }
   case 3: {
    tur_adt_Result__int__int __ra273_0 = (acc_1470);
    int64_t __ra273_1 = ((n_1471) - (INT64_C(1)));
    acc_1470 = __ra273_0;
    n_1471 = __ra273_1;
    __pc = 1; break;
   }
   case 4: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1470, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1471 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&r_1469, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    __t267 = (int64_t)(intptr_t)(__k->saved[3]);
    __t268 = (int64_t)(intptr_t)(__k->saved[4]);
    __t269 = (int64_t)(intptr_t)(__k->saved[5]);
    __t270 = (int64_t)(intptr_t)(__k->saved[6]);
    tur_handler_chain = __k->boundary->parent; free(__k->boundary);
    int64_t __box272;
    if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp272 = global_panic_payload; global_panic_payload = 0; __box272 = tur_box_err((int64_t)(intptr_t)__pp272); }
    else { __box272 = tur_box_ok(__v); }
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    tur_result_box_free((int64_t)(intptr_t)__box272);
    (void)(__box272);
    tur_cont *__n274 = (tur_cont*)malloc(sizeof(tur_cont));
    __n274->tag = 5; __n274->boundary = 0; __n274->next = __k;
    __n274->aggr_mask = 0x5u;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1470, sizeof(tur_adt_Result__int__int)); __n274->saved[0] = (int64_t)(intptr_t)__ab; }
    __n274->saved[1] = (int64_t)(intptr_t)(n_1471);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1469, sizeof(tur_adt_Result__int__int)); __n274->saved[2] = (int64_t)(intptr_t)__ab; }
    __n274->saved[3] = (int64_t)(intptr_t)(__t267);
    __n274->saved[4] = (int64_t)(intptr_t)(__t268);
    __n274->saved[5] = (int64_t)(intptr_t)(__t269);
    __n274->saved[6] = (int64_t)(intptr_t)(__t270);
    tur_adt_Result__int__int __ra274_0 = (acc_1470);
    r_1469 = __ra274_0;
    __k = __n274; __pc = 2; break;
   }
   case 5: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1470, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1471 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t269 = (int64_t)(intptr_t)(__k->saved[5]);
    __t270 = (int64_t)(intptr_t)(__k->saved[6]);
    __t270 = (int64_t)(intptr_t)(__v);
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((n_1471) + (__t270)); __pc = __k->tag; break;
   }
   case 2: {
    int64_t __t275;
    bool __ps_276 = (ok___spec__bool_tur_adt_Result__int__int(r_1469));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_276) {
        __t275 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)(__t275); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_277 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_278 = (step(__ps_277, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_278));
    tur_adt_Result__int__int __ps_279 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_280 = (step(__ps_279, INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_280));
    int64_t __t281;
    __t281 = INT64_C(0);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
    tur_adt_Cons__int * __ps_282 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_285 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_286 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_286;
}
