...
struct __env_1441 { tur_thunk_int64_t_t __fn; tur_adt_Result__int__int acc; int64_t n; };
...
static int64_t __fn_1439(void * __env_p_1442) {
        struct __env_1441 *__env___env_1441 = (struct __env_1441 *)__env_p_1442;
        int64_t __ps_40 = (step(__env___env_1441->acc, (__env___env_1441->n) - (INT64_C(1))));
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_817 = __ps_73;
        bool __ps_74 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_816, (void *)(intptr_t)(k_817), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_74;
        if (__t1) {
        ...
        if (__ps_123) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1188 = __ps_124;
                (void)h_1188;
                void * __ps_125 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1189 = __ps_125;
                (void)k_1189;
                bool __ps_126 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1188, (void *)(intptr_t)(k_1189), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_126) {
                    void * __t127 = iter;
                    void * __t128 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t130;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_132;
            (void)iter_1192;
            void * __ps_133 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_134 = (hamt_slkeyeq((void *)(intptr_t)(__ps_133)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_134;
            (void)keyeq_1193;
            void * __ps_135 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_136 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_135), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_136;
            (void)result_1194;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t157;
        {
            ...
            {
                tur_adt_Vec__int * __ps_159 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1322));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1323 = __ps_159;
                (void)_un_unv_1323;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t163;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1373 = __ps_164;
            (void)r_1373;
            int64_t __t165;
            bool __ps_166 = (schema_hydecode_hyok_qu(r_1373));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_166) {
                int64_t __ps_167 = (schema_hydecode_hyvalue(r_1373));
                if (tur_panicking) return ((int64_t)0);
                __t165 = __ps_167;
            } else {
                int64_t __ps_168 = (schema_hydecode_hyerrors(r_1373));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t describe(tur_adt_Result__int__int r) {
        int64_t __t180;
        bool __ps_181 = (ok___spec__bool_tur_adt_Result__int__int(r));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_181) {
            __t180 = INT64_C(1);
        } else {
...
static int64_t __cu_group_0(int __pc, int64_t __a0, int64_t __a1) {
 tur_adt_Result__int__int acc_1437; memset(&acc_1437, 0, sizeof(tur_adt_Result__int__int));
 int64_t n_1438 = 0;
 tur_adt_Result__int__int r_1436; memset(&r_1436, 0, sizeof(tur_adt_Result__int__int));
 int64_t __t182 = 0;
 int64_t __t183 = 0;
 int64_t __t184 = 0;
 int64_t __t185 = 0;
 switch (__pc) {
  case 1: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&acc_1437, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   n_1438 = (int64_t)(intptr_t)(__a1);
   break; }
  case 2: {
   { void *__ab = (void*)(intptr_t)__a0; memcpy(&r_1436, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
   break; }
 }
 ...
 for (;;) {
  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1438) == (INT64_C(0))) {
     tur_adt_Result__int__int __ra186_0 = (acc_1437);
     r_1436 = __ra186_0;
     __pc = 2; break;
    } else {
     tur_handler_node *__b187 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
     __b187->parent = tur_handler_chain; tur_handler_chain = __b187;
     tur_cont *__n187 = (tur_cont*)malloc(sizeof(tur_cont));
     __n187->tag = 4; __n187->boundary = __b187; __n187->next = __k;
     __n187->aggr_mask = 0x5u;
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1437, sizeof(tur_adt_Result__int__int)); __n187->saved[0] = (int64_t)(intptr_t)__ab; }
     __n187->saved[1] = (int64_t)(intptr_t)(n_1438);
     { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1436, sizeof(tur_adt_Result__int__int)); __n187->saved[2] = (int64_t)(intptr_t)__ab; }
     __n187->saved[3] = (int64_t)(intptr_t)(__t182);
     __n187->saved[4] = (int64_t)(intptr_t)(__t183);
     __n187->saved[5] = (int64_t)(intptr_t)(__t184);
     __n187->saved[6] = (int64_t)(intptr_t)(__t185);
     __k = __n187; __pc = 3; break;
    }
   }
   case 3: {
    tur_adt_Result__int__int __ra188_0 = (acc_1437);
    int64_t __ra188_1 = ((n_1438) - (INT64_C(1)));
    acc_1437 = __ra188_0;
    n_1438 = __ra188_1;
    __pc = 1; break;
   }
   case 4: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1437, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1438 = (int64_t)(intptr_t)(__k->saved[1]);
    { void *__ab = (void*)(intptr_t)__k->saved[2]; memcpy(&r_1436, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    __t182 = (int64_t)(intptr_t)(__k->saved[3]);
    __t183 = (int64_t)(intptr_t)(__k->saved[4]);
    __t184 = (int64_t)(intptr_t)(__k->saved[5]);
    __t185 = (int64_t)(intptr_t)(__k->saved[6]);
    ...
    (void)(__box187);
    tur_cont *__n189 = (tur_cont*)malloc(sizeof(tur_cont));
    __n189->tag = 5; __n189->boundary = 0; __n189->next = __k;
    __n189->aggr_mask = 0x5u;
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &acc_1437, sizeof(tur_adt_Result__int__int)); __n189->saved[0] = (int64_t)(intptr_t)__ab; }
    __n189->saved[1] = (int64_t)(intptr_t)(n_1438);
    { void *__ab = malloc(sizeof(tur_adt_Result__int__int)); memcpy(__ab, &r_1436, sizeof(tur_adt_Result__int__int)); __n189->saved[2] = (int64_t)(intptr_t)__ab; }
    __n189->saved[3] = (int64_t)(intptr_t)(__t182);
    __n189->saved[4] = (int64_t)(intptr_t)(__t183);
    __n189->saved[5] = (int64_t)(intptr_t)(__t184);
    __n189->saved[6] = (int64_t)(intptr_t)(__t185);
    tur_adt_Result__int__int __ra189_0 = (acc_1437);
    r_1436 = __ra189_0;
    __k = __n189; __pc = 2; break;
   }
   case 5: {
    { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc_1437, __ab, sizeof(tur_adt_Result__int__int)); free(__ab); }
    n_1438 = (int64_t)(intptr_t)(__k->saved[1]);
    ...
    __t184 = (int64_t)(intptr_t)(__k->saved[5]);
    __t185 = (int64_t)(intptr_t)(__k->saved[6]);
    __t185 = (int64_t)(intptr_t)(__v);
    { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
    __v = (int64_t)(intptr_t)((n_1438) + (__t185)); __pc = __k->tag; break;
   }
   case 2: {
    int64_t __t190;
    bool __ps_191 = (ok___spec__bool_tur_adt_Result__int__int(r_1436));
    if (tur_panicking) return ((int64_t)0);
    if (__ps_191) {
        __t190 = INT64_C(1);
    } else {
    ...
    __v = (int64_t)(intptr_t)(__t190); __pc = __k->tag; break;
   }
  }
 }
}
...
int main(int argc, char **argv) {
    ...
    tur_adt_Result__int__int __ps_192 = (ok__spec__tur_adt_Result__int__int_int64_t(INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_193 = (step(__ps_192, INT64_C(200000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_193));
    tur_adt_Result__int__int __ps_194 = (err__spec__tur_adt_Result__int__int_int64_t(INT64_C(9)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    int64_t __ps_195 = (step(__ps_194, INT64_C(7)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_195));
    int64_t __t196;
    __t196 = INT64_C(0);
...
static tur_adt_Result__int__int ok__spec__tur_adt_Result__int__int_int64_t(int64_t x) {
    tur_adt_Result__int__int __ps_200 = (ctor_Result_Ok__int__int(x));
...
static tur_adt_Result__int__int err__spec__tur_adt_Result__int__int_int64_t(int64_t e) {
    tur_adt_Result__int__int __ps_201 = (ctor_Result_Err__int__int(e));
    if (tur_panicking) return (tur_adt_Result__int__int){0};
    return __ps_201;
}
