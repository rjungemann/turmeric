...
static int64_t __fn_1284(void * __env_p_1287) {
        ...
        tur_adt_Result__int__int __t40 = __env___env_1286->acc;
        __auto_type __ps_41 = (step(&__t40, (__env___env_1286->n) - (INT64_C(1))));
...
static int64_t step(const tur_adt_Result__int__int * acc, int64_t n) {
        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            __auto_type __ps_158 = (describe(acc));
            if (tur_panicking) break;
            __v = (int64_t)(intptr_t)(__ps_158); __pc = __k->tag; break;
           } else {
            ...
            __n159->saved[3] = (int64_t)(intptr_t)(__t157);
          ...
          case 3: {
           ...
           if (tur_panicking) break;
           __v = (int64_t)(intptr_t)((n) + (__ps_161)); __pc = __k->tag; break;
          }
         }
        }
}
