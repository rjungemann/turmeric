...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t28;
        {
            ...
            bool __t29;
            if ((t1_995) == (INT64_C(0))) {
                __t29 = (t2_996) == (INT64_C(0));
            } else {
                bool __t30;
                if ((t2_996) == (INT64_C(0))) {
                    __t30 = false;
                } else {
                    __auto_type __ps_31 = (cons_hyeq_hygo(t1_995, t2_996));
                    if (tur_panicking) return (bool){0};
                    __t30 = __ps_31;
                }
                __t29 = __t30;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t34) {
            ...
            *(void (**)(void *))__t39 = 0;
            ...
            __t38[1] = (int64_t)(intptr_t)__fn_1131;
            void *__t40 = __t38;
...
static int64_t _un_uncons_hyfmap__cps(int64_t cell_997, void * f_998, DK *__kont);
static int64_t set_hyeq_hyloop__cps(void * iter_1074, void * s2_hyhamt_1075, void * keyeq_1076, DK *__kont);
static int64_t hamt_slnew__cps(DK *__kont) {
    void * __t0;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_97) {
            bool __t98;
            {
                ...
                bool __t99;
                if ((t1_990) == (INT64_C(0))) {
                    __t99 = (t2_991) == (INT64_C(0));
                } else {
                    bool __t100;
                    if ((t2_991) == (INT64_C(0))) {
                        __t100 = false;
                    } else {
                        __auto_type __ps_101 = (cons_hyeq_hygo(t1_990, t2_991));
                        if (tur_panicking) return (bool){0};
                        __t100 = __ps_101;
                    }
                    __t99 = __t100;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_107) {
            ...
            int64_t __t108;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1006 = (int64_t)(intptr_t)(__ps_112);
                (void)out_1006;
                __t108 = out_1006;
            }
            __t106 = __t108;
...
static intptr_t set_hyeq_hyloop_j2(intptr_t env, intptr_t k_1078__slot, DK *__kont) {
    set_hyeq_hyloop_j2_env *__cap = (set_hyeq_hyloop_j2_env *)(intptr_t)env;
    void * iter = __cap->f0;
    void * s2_hamt = __cap->f1;
    void * keyeq = __cap->f2;
    int64_t h_1077 = __cap->f3;
    void * k_1078 = (void *)(k_1078__slot);
    ...
    return hamt_slhas_hydynamic_qu__cps(s2_hamt, h_1077, k_1078, keyeq, __dk_reap_node(dk_frame_resume(set_hyeq_hyloop_j3, (intptr_t)__ce_set_hyeq_hyloop_j3, __kont))); /* cps->cps heap join */
}
typedef struct { void * f0; void * f1; void * f2; } set_hyeq_hyloop_j1_env;
static intptr_t set_hyeq_hyloop_j1(intptr_t env, intptr_t h_1077__slot, DK *__kont) {
    set_hyeq_hyloop_j1_env *__cap = (set_hyeq_hyloop_j1_env *)(intptr_t)env;
    void * iter = __cap->f0;
    void * s2_hamt = __cap->f1;
    void * keyeq = __cap->f2;
    int64_t h_1077 = (int64_t)(h_1077__slot);
    ...
    __ce_set_hyeq_hyloop_j2->f3 = h_1077;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t117;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1081 = __ps_119;
            (void)iter_1081;
            __auto_type __ps_120 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_121 = (hamt_slkeyeq((void *)(intptr_t)(__ps_120)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1082 = __ps_121;
            (void)keyeq_1082;
            __auto_type __ps_122 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_123 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1081), (void *)(intptr_t)(__ps_122), (void *)(intptr_t)(keyeq_1082)));
            if (tur_panicking) return (bool){0};
            bool result_1083 = __ps_123;
            (void)result_1083;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t144;
        {
            ...
            {
                __auto_type __ps_146 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1210));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1211 = __ps_146;
                (void)_un_unv_1211;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t149;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1260 = __ps_150;
            (void)r_1260;
            int64_t __t151;
            __auto_type __ps_152 = (schema_hydecode_hyok_qu(r_1260));
            if (tur_panicking) return (int64_t){0};
            if (__ps_152) {
                __auto_type __ps_153 = (schema_hydecode_hyvalue(r_1260));
                if (tur_panicking) return (int64_t){0};
                __t151 = __ps_153;
            } else {
                __auto_type __ps_154 = (schema_hydecode_hyerrors(r_1260));
                if (tur_panicking) return (int64_t){0};
