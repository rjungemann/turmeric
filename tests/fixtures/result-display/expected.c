...
int main() {
        int64_t __t0;
        {
            void * r_ok_31 = ok(INT64_C(7));
            (void)r_ok_31;
            int64_t __t1;
            {
                void * r_err_32 = err(INT64_C(9));
                (void)r_err_32;
                puts(result_display((void *)(intptr_t)(r_ok_31)));
                puts(result_display((void *)(intptr_t)(r_err_32)));
                puts(result_debug((void *)(intptr_t)(r_ok_31)));
                puts(result_debug((void *)(intptr_t)(r_err_32)));
                puts(result_error_message((void *)(intptr_t)(r_ok_31)));
                puts(result_error_message((void *)(intptr_t)(r_err_32)));
                int64_t __t2;
                __t2 = INT64_C(0);
                __t1 = __t2;
            }
