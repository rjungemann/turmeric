...
static int64_t u_result_must(void *);
static int64_t u_result_must_msg(void *, const char *);
...
static int64_t u_result_must(void * r) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
...
static int64_t u_result_must_msg(void * r, const char * msg) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
...
int main() {
        printf("%lld\n", (long long)(u_result_must((void *)(intptr_t)(u_ok(INT64_C(7))))));
        printf("%lld\n", (long long)(u_result_must_msg((void *)(intptr_t)(u_ok(INT64_C(13))), "custom msg")));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
