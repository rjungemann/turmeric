...
int main() {
        printf("%lld\n", (long long)(result_must((void *)(intptr_t)(ok(INT64_C(7))))));
        printf("%lld\n", (long long)(result_must_msg((void *)(intptr_t)(ok(INT64_C(13))), "custom msg")));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
