...
int main() {
        {
            int64_t o_234 = __opt_some(INT64_C(10));
            (void)o_234;
            {
                int64_t o2_235 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_vec_singleton.fmap))(o_234, (int64_t)(intptr_t)(add5));
                (void)o2_235;
                puts((__opt_some_(o2_235)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(o2_235)));
            }
        }
        {
            int64_t v_236 = __vec_of(INT64_C(7));
            (void)v_236;
            {
                int64_t v2_237 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_vec_singleton.fmap))(v_236, (int64_t)(intptr_t)(twice));
                (void)v2_237;
                printf("%lld\n", (long long)(__vec_get0(v2_237)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
