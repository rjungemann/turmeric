...
int main() {
        {
            int64_t o_222 = __opt_some(INT64_C(10));
            (void)o_222;
            {
                int64_t o2_223 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_vec_singleton.fmap))(o_222, (int64_t)(intptr_t)(add5));
                (void)o2_223;
                puts((__opt_some_(o2_223)) ? "true" : "false");
                printf("%lld\n", (long long)(__opt_unwrap(o2_223)));
            }
        }
        {
            int64_t v_224 = __vec_of(INT64_C(7));
            (void)v_224;
            {
                int64_t v2_225 = ((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_Functor_vec_singleton.fmap))(v_224, (int64_t)(intptr_t)(twice));
                (void)v2_225;
                printf("%lld\n", (long long)(__vec_get0(v2_225)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
