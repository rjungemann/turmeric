...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_762, (void *)(intptr_t)(k_763), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_767 = __ps_73;
            (void)iter_767;
            void * __ps_74 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_75 = (hamt_slkeyeq((void *)(intptr_t)(__ps_74)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_768 = __ps_75;
            (void)keyeq_768;
            void * __ps_76 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_767), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_768), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_769 = __ps_77;
            (void)result_769;
        ...
        if (__ps_95) {
            bool __t96;
            {
                ...
                if ((t1_1010) == (INT64_C(0))) {
                    __t97 = (t2_1011) == (INT64_C(0));
                } else {
                    bool __t98;
                    if ((t2_1011) == (INT64_C(0))) {
                        __t98 = false;
                    } else {
                        bool __ps_99 = (cons_hyeq_hygo(t1_1010, t2_1011));
                        if (tur_panicking) return ((bool)0);
                        __t98 = __ps_99;
                    }
                    __t97 = __t98;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_105) {
            ...
            int64_t __t106;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1026 = (int64_t)(intptr_t)(__ps_110);
                (void)out_1026;
                __t106 = out_1026;
            }
            __t104 = __t106;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t115;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1101 = __ps_117;
            (void)iter_1101;
            void * __ps_118 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_119 = (hamt_slkeyeq((void *)(intptr_t)(__ps_118)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1102 = __ps_119;
            (void)keyeq_1102;
            void * __ps_120 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_121 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1101), (void *)(intptr_t)(__ps_120), (void *)(intptr_t)(keyeq_1102)));
            if (tur_panicking) return ((bool)0);
            bool result_1103 = __ps_121;
            (void)result_1103;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t142;
        {
            ...
            {
                tur_adt_Vec__int * __ps_144 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1230));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1231 = __ps_144;
                (void)_un_unv_1231;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t147;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1280 = __ps_148;
            (void)r_1280;
            int64_t __t149;
            bool __ps_150 = (schema_hydecode_hyok_qu(r_1280));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_150) {
                int64_t __ps_151 = (schema_hydecode_hyvalue(r_1280));
                if (tur_panicking) return ((int64_t)0);
                __t149 = __ps_151;
            } else {
                int64_t __ps_152 = (schema_hydecode_hyerrors(r_1280));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t __dk_hcase_155(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_155(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1302 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1302)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1302, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_158(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_158(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1303 = (const char *)((int64_t)__dkarg);
    int64_t k_1304 = (int64_t)(intptr_t)__dksubk;
    puts(s_1303);
    ((struct DK *)(intptr_t)k_1304)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1304, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_adt_HRow2 row_1305;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t157 = tur_handler_table_new(1);
    __t157->entries[0].eff_name = "Ask";
    __t157->entries[0].fn = NULL;
    __t157->entries[0].env = NULL;
    ...
    __t161->entries[0].eff_name = "Tell";
    __t161->entries[0].fn = NULL;
    __t161->entries[0].env = NULL;
    __t161->entries[0].cont_kind = 0;
    __t161->entries[0].dk_tag = 3;
    __t161->entries[0].dk_fn = __dk_hcase_158;
    tur_handler_table_t *__t162 = tur_handler_table_concat(__t157, __t161);
    tur_adt_HRow2 __ps_163 = (ctor_HRow2((int64_t)(intptr_t)(__t162)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1305 = __ps_163;
    __t1 = (tur_handler_table_t *)(row_1305).h;
