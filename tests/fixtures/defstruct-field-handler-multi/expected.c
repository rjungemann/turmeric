...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_842 = __ps_124;
        bool __ps_125 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_841, (void *)(intptr_t)(k_842), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_125;
        if (__t1) {
            int64_t __ps_126 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_127 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_841, (void *)(intptr_t)(k_842), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t129;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_846 = __ps_131;
            (void)iter_846;
            void * __ps_132 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_133 = (hamt_slkeyeq((void *)(intptr_t)(__ps_132)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_847 = __ps_133;
            (void)keyeq_847;
            void * __ps_134 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_135 = (map_hyeq_hyloop((void *)(intptr_t)(iter_846), (void *)(intptr_t)(__ps_134), (void *)(intptr_t)(keyeq_847), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_848 = __ps_135;
            (void)result_848;
        ...
        if (__ps_154) {
            bool __t155;
            {
                ...
                if ((t1_1126) == (INT64_C(0))) {
                    __t156 = (t2_1127) == (INT64_C(0));
                } else {
                    bool __t157;
                    if ((t2_1127) == (INT64_C(0))) {
                        __t157 = false;
                    } else {
                        bool __ps_158 = (cons_hyeq_hygo(t1_1126, t2_1127));
                        if (tur_panicking) return ((bool)0);
                        __t157 = __ps_158;
                    }
                    __t156 = __t157;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_164) {
            ...
            int64_t __t165;
            {
                ...
                int64_t out_1142 = (int64_t)(intptr_t)(__ps_169);
                (void)out_1142;
                __t165 = out_1142;
            }
            __t163 = __t165;
        ...
        if (__ps_174) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1213 = __ps_175;
                (void)h_1213;
                void * __ps_176 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1214 = __ps_176;
                (void)k_1214;
                bool __ps_177 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1213, (void *)(intptr_t)(k_1214), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_177) {
                    void * __t178 = iter;
                    void * __t179 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t181;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1217 = __ps_183;
            (void)iter_1217;
            void * __ps_184 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_185 = (hamt_slkeyeq((void *)(intptr_t)(__ps_184)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1218 = __ps_185;
            (void)keyeq_1218;
            void * __ps_186 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_187 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1217), (void *)(intptr_t)(__ps_186), (void *)(intptr_t)(keyeq_1218)));
            if (tur_panicking) return ((bool)0);
            bool result_1219 = __ps_187;
            (void)result_1219;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t208;
        {
            ...
            {
                tur_adt_Vec__int * __ps_210 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1349));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1350 = __ps_210;
                (void)_un_unv_1350;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t214;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1400 = __ps_215;
            (void)r_1400;
            int64_t __t216;
            bool __ps_217 = (schema_hydecode_hyok_qu(r_1400));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_217) {
                int64_t __ps_218 = (schema_hydecode_hyvalue(r_1400));
                if (tur_panicking) return ((int64_t)0);
                __t216 = __ps_218;
            } else {
                int64_t __ps_219 = (schema_hydecode_hyerrors(r_1400));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t __dk_hcase_232(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_232(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1465 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1465)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1465, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_235(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_235(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1466 = (const char *)((int64_t)__dkarg);
    int64_t k_1467 = (int64_t)(intptr_t)__dksubk;
    puts(s_1466);
    ((struct DK *)(intptr_t)k_1467)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1467, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_adt_HRow2 row_1468;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t234 = tur_handler_table_new(1);
    __t234->entries[0].eff_name = "Ask";
    __t234->entries[0].fn = NULL;
    __t234->entries[0].env = NULL;
    __t234->entries[0].cont_kind = 0;
    __t234->entries[0].dk_tag = 2;
    __t234->entries[0].dk_fn = __dk_hcase_232;
    tur_handler_table_t *__t238 = tur_handler_table_new(1);
    __t238->entries[0].eff_name = "Tell";
    __t238->entries[0].fn = NULL;
    __t238->entries[0].env = NULL;
    __t238->entries[0].cont_kind = 0;
    __t238->entries[0].dk_tag = 3;
    __t238->entries[0].dk_fn = __dk_hcase_235;
    tur_handler_table_t *__t239 = tur_handler_table_concat(__t234, __t238);
    tur_adt_HRow2 __ps_240 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(__t239)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1468 = __ps_240;
    __t1 = (tur_handler_table_t *)(row_1468).h;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_241 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_242 = (vec_new__spec__tur_adt_Vec__int__());
