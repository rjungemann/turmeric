...
static intptr_t __dk_hcase_172(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    ...
    int64_t k_1609 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1609)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1609, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_175(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_175(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1610 = (const char *)((int64_t)__dkarg);
    int64_t k_1611 = (int64_t)(intptr_t)__dksubk;
    puts(s_1610);
    ((struct DK *)(intptr_t)k_1611)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1611, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_handler_table_t * _un_unctlhoist_un1612_1613;
    tur_adt_HRow2 row_1614;
    ...
    _un_unctlhoist_un1612_1613 = __t179;
    tur_adt_HRow2 __ps_180 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(_un_unctlhoist_un1612_1613)));
    if (tur_panicking) return ((int64_t)0);
    row_1614 = __ps_180;
    __t1 = (tur_handler_table_t *)(row_1614).h;
