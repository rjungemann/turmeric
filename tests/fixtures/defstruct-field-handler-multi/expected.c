...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_67 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_742, (void *)(intptr_t)(k_743), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t69;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_747 = __ps_71;
            (void)iter_747;
            __auto_type __ps_72 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_73 = (hamt_slkeyeq((void *)(intptr_t)(__ps_72)));
            if (tur_panicking) return (bool){0};
            void * keyeq_748 = __ps_73;
            (void)keyeq_748;
            __auto_type __ps_74 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_75 = (map_hyeq_hyloop((void *)(intptr_t)(iter_747), (void *)(intptr_t)(__ps_74), (void *)(intptr_t)(keyeq_748), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_749 = __ps_75;
            (void)result_749;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_93) {
            bool __t94;
            {
                ...
                bool __t95;
                if ((t1_989) == (INT64_C(0))) {
                    __t95 = (t2_990) == (INT64_C(0));
                } else {
                    bool __t96;
                    if ((t2_990) == (INT64_C(0))) {
                        __t96 = false;
                    } else {
                        __auto_type __ps_97 = (cons_hyeq_hygo(t1_989, t2_990));
                        if (tur_panicking) return (bool){0};
                        __t96 = __ps_97;
                    }
                    __t95 = __t96;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_103) {
            ...
            int64_t __t104;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1005 = (int64_t)(intptr_t)(__ps_108);
                (void)out_1005;
                __t104 = out_1005;
            }
            __t102 = __t104;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t113;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1080 = __ps_115;
            (void)iter_1080;
            __auto_type __ps_116 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_117 = (hamt_slkeyeq((void *)(intptr_t)(__ps_116)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1081 = __ps_117;
            (void)keyeq_1081;
            __auto_type __ps_118 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_119 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1080), (void *)(intptr_t)(__ps_118), (void *)(intptr_t)(keyeq_1081)));
            if (tur_panicking) return (bool){0};
            bool result_1082 = __ps_119;
            (void)result_1082;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t140;
        {
            ...
            {
                __auto_type __ps_142 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1209));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1210 = __ps_142;
                (void)_un_unv_1210;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t145;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1259 = __ps_146;
            (void)r_1259;
            int64_t __t147;
            __auto_type __ps_148 = (schema_hydecode_hyok_qu(r_1259));
            if (tur_panicking) return (int64_t){0};
            if (__ps_148) {
                __auto_type __ps_149 = (schema_hydecode_hyvalue(r_1259));
                if (tur_panicking) return (int64_t){0};
                __t147 = __ps_149;
            } else {
                __auto_type __ps_150 = (schema_hydecode_hyerrors(r_1259));
                if (tur_panicking) return (int64_t){0};
...
static int64_t __effect_handler_154(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_154(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_1281 = __k;
    int64_t __t155 = tur_effect_cont_resume((int64_t)(intptr_t)k_1281, (int64_t)INT64_C(41));
    return (int64_t)__t155;
}

static int64_t __effect_handler_157(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_157(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * s_1282 = (const char *)__effect_args[0];
    int64_t k_1283 = __k;
    puts(s_1282);
    int64_t __t158;
    int64_t __t159 = tur_effect_cont_resume((int64_t)(intptr_t)k_1283, (int64_t)0);
    __t158 = __t159;
    return (int64_t)__t158;
}

static void __wh_body_163(void);
static void __wh_body_163(void) {
    int64_t __t164[1];
    __t164[0] = (int64_t)"hi";
    tur_effect_perform("Tell", __t164, 1);
    int64_t __t165 = tur_effect_perform("Ask", NULL, 0);
    printf("%lld\n", (long long)((__t165) + (INT64_C(1))));
    int64_t __t166;
    __t166 = INT64_C(0);
    tur_current_fiber->result = (int64_t)__t166;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t153;
        {
            tur_handler_table_t *__t156 = tur_handler_table_new(1);
            __t156->entries[0].eff_name = "Ask";
            __t156->entries[0].fn = __effect_handler_154;
            __t156->entries[0].env = NULL;
            __t156->entries[0].cont_kind = 0;
            tur_handler_table_t *__t160 = tur_handler_table_new(1);
            __t160->entries[0].eff_name = "Tell";
            __t160->entries[0].fn = __effect_handler_157;
            __t160->entries[0].env = NULL;
            __t160->entries[0].cont_kind = 0;
            tur_handler_table_t *__t161 = tur_handler_table_concat(__t156, __t160);
            __auto_type __ps_162 = (ctor_HRow2((int64_t)(intptr_t)(__t161)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_HRow2 row_1284 = __ps_162;
            (void)row_1284;
            tur_handler_table_t *__wh_tbl_163 = (tur_handler_table_t *)(row_1284).h;
            TurEffectCaptureCtx __wh_cap_163;
            __wh_cap_163.has_pending_effect = false;
            __wh_cap_163.eff_name = NULL;
            __wh_cap_163.eff_n_args = 0;
            __wh_cap_163.dispatch = tur_handler_dispatch;
            __wh_cap_163.body_env = NULL;
            __wh_cap_163.table = __wh_tbl_163;
            FiberBlock *__wh_fiber_163 = tur_fiber_block_new(__wh_body_163, 0);
            __wh_fiber_163->eff_ctx = &__wh_cap_163;
            EffectHandlerFrame *__wh_parent_163 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
            EffectHandlerFrame __wh_frame_163;
            __wh_frame_163.parent = __wh_parent_163;
            int __wh_nf_163 = __wh_tbl_163->n_entries < 8 ? __wh_tbl_163->n_entries : 8;
            __wh_frame_163.n_cases = __wh_nf_163;
            for (int __wi = 0; __wi < __wh_nf_163; __wi++) {
                __wh_frame_163.cases[__wi].effect_name = __wh_tbl_163->entries[__wi].eff_name;
                __wh_frame_163.cases[__wi].handler_fn = NULL;
                __wh_frame_163.cases[__wi].env = NULL;
            }
            __wh_fiber_163->effect_handler_chain = &__wh_frame_163;
            int64_t __t167 = (int64_t)tur_handler_dispatch(&__wh_cap_163, (int64_t)(intptr_t)__wh_fiber_163, 0);
            if (__wh_fiber_163->done) { free(__wh_fiber_163->stack); free(__wh_fiber_163); }
            __t153 = __t167;
        }
        return (int)__t153;
}
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        __auto_type __ps_168 = (ctor_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        __auto_type __ps_169 = (vec_new__spec__tur_adt_Vec__int__());
