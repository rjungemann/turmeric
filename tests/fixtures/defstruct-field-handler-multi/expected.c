...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_854 = __ps_136;
        bool __ps_137 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_853, (void *)(intptr_t)(k_854), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_137;
        if (__t1) {
            int64_t __ps_138 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_139 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_853, (void *)(intptr_t)(k_854), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t141;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_858 = __ps_143;
            (void)iter_858;
            void * __ps_144 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_145 = (hamt_slkeyeq((void *)(intptr_t)(__ps_144)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_859 = __ps_145;
            (void)keyeq_859;
            void * __ps_146 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_147 = (map_hyeq_hyloop((void *)(intptr_t)(iter_858), (void *)(intptr_t)(__ps_146), (void *)(intptr_t)(keyeq_859), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_860 = __ps_147;
            (void)result_860;
        ...
        if (__ps_166) {
            bool __t167;
            {
                ...
                if ((t1_1138) == (INT64_C(0))) {
                    __t168 = (t2_1139) == (INT64_C(0));
                } else {
                    bool __t169;
                    if ((t2_1139) == (INT64_C(0))) {
                        __t169 = false;
                    } else {
                        bool __ps_170 = (cons_hyeq_hygo(t1_1138, t2_1139));
                        if (tur_panicking) return ((bool)0);
                        __t169 = __ps_170;
                    }
                    __t168 = __t169;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_176) {
            ...
            int64_t __t177;
            {
                ...
                int64_t out_1154 = (int64_t)(intptr_t)(__ps_181);
                (void)out_1154;
                __t177 = out_1154;
            }
            __t175 = __t177;
        ...
        if (__ps_186) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1225 = __ps_187;
                (void)h_1225;
                void * __ps_188 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1226 = __ps_188;
                (void)k_1226;
                bool __ps_189 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1225, (void *)(intptr_t)(k_1226), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_189) {
                    void * __t190 = iter;
                    void * __t191 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t193;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1229 = __ps_195;
            (void)iter_1229;
            void * __ps_196 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_197 = (hamt_slkeyeq((void *)(intptr_t)(__ps_196)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1230 = __ps_197;
            (void)keyeq_1230;
            void * __ps_198 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_199 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1229), (void *)(intptr_t)(__ps_198), (void *)(intptr_t)(keyeq_1230)));
            if (tur_panicking) return ((bool)0);
            bool result_1231 = __ps_199;
            (void)result_1231;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t220;
        {
            ...
            {
                tur_adt_Vec__int * __ps_222 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1361));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1362 = __ps_222;
                (void)_un_unv_1362;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t226;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1412 = __ps_227;
            (void)r_1412;
            int64_t __t228;
            bool __ps_229 = (schema_hydecode_hyok_qu(r_1412));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_229) {
                int64_t __ps_230 = (schema_hydecode_hyvalue(r_1412));
                if (tur_panicking) return ((int64_t)0);
                __t228 = __ps_230;
            } else {
                int64_t __ps_231 = (schema_hydecode_hyerrors(r_1412));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t __dk_hcase_244(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_244(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1469 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1469)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1469, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_247(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_247(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1470 = (const char *)((int64_t)__dkarg);
    int64_t k_1471 = (int64_t)(intptr_t)__dksubk;
    puts(s_1470);
    ((struct DK *)(intptr_t)k_1471)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1471, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_adt_HRow2 row_1472;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t246 = tur_handler_table_new(1);
    __t246->entries[0].eff_name = "Ask";
    __t246->entries[0].fn = NULL;
    __t246->entries[0].env = NULL;
    __t246->entries[0].cont_kind = 0;
    __t246->entries[0].dk_tag = 2;
    __t246->entries[0].dk_fn = __dk_hcase_244;
    tur_handler_table_t *__t250 = tur_handler_table_new(1);
    __t250->entries[0].eff_name = "Tell";
    __t250->entries[0].fn = NULL;
    __t250->entries[0].env = NULL;
    __t250->entries[0].cont_kind = 0;
    __t250->entries[0].dk_tag = 3;
    __t250->entries[0].dk_fn = __dk_hcase_247;
    tur_handler_table_t *__t251 = tur_handler_table_concat(__t246, __t250);
    tur_adt_HRow2 __ps_252 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(__t251)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1472 = __ps_252;
    __t1 = (tur_handler_table_t *)(row_1472).h;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_253 = (ctor_Cons_Cons__int(h, t));
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_254 = (vec_new__spec__tur_adt_Vec__int__());
