...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_814, (void *)(intptr_t)(k_815), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_819 = __ps_75;
            (void)iter_819;
            void * __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_820 = __ps_77;
            (void)keyeq_820;
            void * __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_819), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_820), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_821 = __ps_79;
            (void)result_821;
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                if ((t1_1099) == (INT64_C(0))) {
                    __t100 = (t2_1100) == (INT64_C(0));
                } else {
                    bool __t101;
                    if ((t2_1100) == (INT64_C(0))) {
                        __t101 = false;
                    } else {
                        bool __ps_102 = (cons_hyeq_hygo(t1_1099, t2_1100));
                        if (tur_panicking) return ((bool)0);
                        __t101 = __ps_102;
                    }
                    __t100 = __t101;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_108) {
            ...
            int64_t __t109;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1115 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1115;
                __t109 = out_1115;
            }
            __t107 = __t109;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t118;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_120;
            (void)iter_1190;
            void * __ps_121 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_122 = (hamt_slkeyeq((void *)(intptr_t)(__ps_121)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_122;
            (void)keyeq_1191;
            void * __ps_123 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_124 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_123), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_124;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t145;
        {
            ...
            {
                tur_adt_Vec__int * __ps_147 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_147;
                (void)_un_unv_1320;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t151;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_152;
            (void)r_1370;
            int64_t __t153;
            bool __ps_154 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_154) {
                int64_t __ps_155 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t153 = __ps_155;
            } else {
                int64_t __ps_156 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t __dk_hcase_168(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_168(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1434 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1434)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1434, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_171(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_171(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1435 = (const char *)((int64_t)__dkarg);
    int64_t k_1436 = (int64_t)(intptr_t)__dksubk;
    puts(s_1435);
    ((struct DK *)(intptr_t)k_1436)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1436, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_adt_HRow2 row_1437;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t170 = tur_handler_table_new(1);
    __t170->entries[0].eff_name = "Ask";
    __t170->entries[0].fn = NULL;
    __t170->entries[0].env = NULL;
    __t170->entries[0].cont_kind = 0;
    __t170->entries[0].dk_tag = 2;
    __t170->entries[0].dk_fn = __dk_hcase_168;
    tur_handler_table_t *__t174 = tur_handler_table_new(1);
    __t174->entries[0].eff_name = "Tell";
    __t174->entries[0].fn = NULL;
    __t174->entries[0].env = NULL;
    __t174->entries[0].cont_kind = 0;
    __t174->entries[0].dk_tag = 3;
    __t174->entries[0].dk_fn = __dk_hcase_171;
    tur_handler_table_t *__t175 = tur_handler_table_concat(__t170, __t174);
    tur_adt_HRow2 __ps_176 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(__t175)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1437 = __ps_176;
    __t1 = (tur_handler_table_t *)(row_1437).h;
...
int main(int argc, char **argv) {
    ...
    int64_t __r;
    jmp_buf __dkjb; jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (setjmp(__dkjb) == 0) { __r = main__cps(__root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_177 = (ctor_Cons_Cons__int(h, t));
