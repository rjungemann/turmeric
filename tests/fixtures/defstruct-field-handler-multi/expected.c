...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t254;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1464 = __ps_256;
            (void)r_1464;
            bool __ps_257 = (bt_hyundo_hyto_ex(m_1463));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_257);
            int64_t __t258;
            __t258 = r_1464;
...
static intptr_t __dk_hcase_264(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_264(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
...
static int64_t main__cps(DK *__kont) {
    ...
    tur_handler_table_t *__t266 = tur_handler_table_new(1);
    __t266->entries[0].eff_name = "Ask";
    __t266->entries[0].fn = NULL;
    __t266->entries[0].env = NULL;
    __t266->entries[0].cont_kind = 0;
    __t266->entries[0].dk_tag = 2;
    __t266->entries[0].dk_fn = __dk_hcase_264;
    tur_handler_table_t *__t270 = tur_handler_table_new(1);
    __t270->entries[0].eff_name = "Tell";
    __t270->entries[0].fn = NULL;
    __t270->entries[0].env = NULL;
    __t270->entries[0].cont_kind = 0;
    __t270->entries[0].dk_tag = 3;
    __t270->entries[0].dk_fn = __dk_hcase_267;
    tur_handler_table_t *__t271 = tur_handler_table_concat(__t266, __t270);
    tur_adt_HRow2 __ps_272 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(__t271)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1472 = __ps_272;
