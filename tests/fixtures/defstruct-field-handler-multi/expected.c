...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_817 = __ps_74;
        bool __ps_75 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_816, (void *)(intptr_t)(k_817), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_75;
        if (__t1) {
            int64_t __ps_76 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_77 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_816, (void *)(intptr_t)(k_817), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_821 = __ps_81;
            (void)iter_821;
            void * __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_822 = __ps_83;
            (void)keyeq_822;
            void * __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_821), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_822), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_823 = __ps_85;
            (void)result_823;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                int64_t out_1117 = (int64_t)(intptr_t)(__t120);
                (void)out_1117;
                __t115 = out_1117;
            }
            __t113 = __t115;
        ...
        if (__ps_125) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1188 = __ps_126;
                (void)h_1188;
                void * __ps_127 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1189 = __ps_127;
                (void)k_1189;
                bool __ps_128 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1188, (void *)(intptr_t)(k_1189), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_128) {
                    void * __t129 = iter;
                    void * __t130 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t132;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_134;
            (void)iter_1192;
            void * __ps_135 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_136 = (hamt_slkeyeq((void *)(intptr_t)(__ps_135)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_136;
            (void)keyeq_1193;
            void * __ps_137 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_138 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_137), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_138;
            (void)result_1194;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t159;
        {
            ...
            {
                tur_adt_Vec__int * __ps_161 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1322));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1323 = __ps_161;
                (void)_un_unv_1323;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t165;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1373 = __ps_166;
            (void)r_1373;
            int64_t __t167;
            bool __ps_168 = (schema_hydecode_hyok_qu(r_1373));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_168) {
                int64_t __ps_169 = (schema_hydecode_hyvalue(r_1373));
                if (tur_panicking) return ((int64_t)0);
                __t167 = __ps_169;
            } else {
                int64_t __ps_170 = (schema_hydecode_hyerrors(r_1373));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t __dk_hcase_183(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_183(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1438 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1438)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1438, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_186(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_186(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1439 = (const char *)((int64_t)__dkarg);
    int64_t k_1440 = (int64_t)(intptr_t)__dksubk;
    puts(s_1439);
    ((struct DK *)(intptr_t)k_1440)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1440, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_adt_HRow2 row_1441;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t185 = tur_handler_table_new(1);
    __t185->entries[0].eff_name = "Ask";
    __t185->entries[0].fn = NULL;
    __t185->entries[0].env = NULL;
    __t185->entries[0].cont_kind = 0;
    __t185->entries[0].dk_tag = 2;
    __t185->entries[0].dk_fn = __dk_hcase_183;
    tur_handler_table_t *__t189 = tur_handler_table_new(1);
    __t189->entries[0].eff_name = "Tell";
    __t189->entries[0].fn = NULL;
    __t189->entries[0].env = NULL;
    __t189->entries[0].cont_kind = 0;
    __t189->entries[0].dk_tag = 3;
    __t189->entries[0].dk_fn = __dk_hcase_186;
    tur_handler_table_t *__t190 = tur_handler_table_concat(__t185, __t189);
    tur_adt_HRow2 __ps_191 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(__t190)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1441 = __ps_191;
    __t1 = (tur_handler_table_t *)(row_1441).h;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_192 = (ctor_Cons_Cons__int(h, t));
