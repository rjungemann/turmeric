...
static int64_t __effect_handler_174(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_174(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_1281 = __k;
    int64_t __t175 = tur_effect_cont_resume((int64_t)(intptr_t)k_1281, (int64_t)INT64_C(41));
    return (int64_t)__t175;
}

static int64_t __effect_handler_177(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_177(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * s_1282 = (const char *)__effect_args[0];
    int64_t k_1283 = __k;
    puts(s_1282);
    int64_t __t178;
    int64_t __t179 = tur_effect_cont_resume((int64_t)(intptr_t)k_1283, (int64_t)0);
    __t178 = __t179;
    return (int64_t)__t178;
}

static void __wh_body_183(void);
static void __wh_body_183(void) {
    int64_t __t184[1];
    __t184[0] = (int64_t)"hi";
    tur_effect_perform("Tell", __t184, 1);
    int64_t __t185 = tur_effect_perform("Ask", NULL, 0);
    printf("%lld\n", (long long)((__t185) + (INT64_C(1))));
    int64_t __t186;
    __t186 = INT64_C(0);
    tur_current_fiber->result = (int64_t)__t186;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            tur_handler_table_t *__t176 = tur_handler_table_new(1);
            __t176->entries[0].eff_name = "Ask";
            __t176->entries[0].fn = __effect_handler_174;
            __t176->entries[0].env = NULL;
            __t176->entries[0].cont_kind = 0;
            tur_handler_table_t *__t180 = tur_handler_table_new(1);
            __t180->entries[0].eff_name = "Tell";
            __t180->entries[0].fn = __effect_handler_177;
            __t180->entries[0].env = NULL;
            __t180->entries[0].cont_kind = 0;
            tur_handler_table_t *__t181 = tur_handler_table_concat(__t176, __t180);
            __auto_type __ps_182 = (ctor_HRow2((int64_t)(intptr_t)(__t181)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_HRow2 row_1284 = __ps_182;
            (void)row_1284;
            tur_handler_table_t *__wh_tbl_183 = (tur_handler_table_t *)(row_1284).h;
            TurEffectCaptureCtx __wh_cap_183;
            __wh_cap_183.has_pending_effect = false;
            __wh_cap_183.eff_name = NULL;
            __wh_cap_183.eff_n_args = 0;
            __wh_cap_183.dispatch = tur_handler_dispatch;
            __wh_cap_183.body_env = NULL;
            __wh_cap_183.table = __wh_tbl_183;
            FiberBlock *__wh_fiber_183 = tur_fiber_block_new(__wh_body_183, 0);
            __wh_fiber_183->eff_ctx = &__wh_cap_183;
            EffectHandlerFrame *__wh_parent_183 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
            EffectHandlerFrame __wh_frame_183;
            __wh_frame_183.parent = __wh_parent_183;
            int __wh_nf_183 = __wh_tbl_183->n_entries < 8 ? __wh_tbl_183->n_entries : 8;
            __wh_frame_183.n_cases = __wh_nf_183;
            for (int __wi = 0; __wi < __wh_nf_183; __wi++) {
                __wh_frame_183.cases[__wi].effect_name = __wh_tbl_183->entries[__wi].eff_name;
                __wh_frame_183.cases[__wi].handler_fn = NULL;
                __wh_frame_183.cases[__wi].env = NULL;
            }
            __wh_fiber_183->effect_handler_chain = &__wh_frame_183;
            int64_t __t187 = (int64_t)tur_handler_dispatch(&__wh_cap_183, (int64_t)(intptr_t)__wh_fiber_183, 0);
            if (__wh_fiber_183->done) { free(__wh_fiber_183->stack); free(__wh_fiber_183); }
            __t173 = __t187;
        }
        return (int)__t173;
}
