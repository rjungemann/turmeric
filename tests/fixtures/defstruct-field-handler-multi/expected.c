...
static int64_t main__cps(DK *__kont) {
    ...
    __t159->entries[0].dk_fn = __dk_hcase_156;
    tur_handler_table_t *__t160 = tur_handler_table_concat(__t155, __t159);
    __auto_type __ps_161 = (ctor_HRow2((int64_t)(intptr_t)(__t160)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1284 = __ps_161;
