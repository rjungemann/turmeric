        ...
        if (__ps_186) {
            bool __t187;
            {
                ...
                if ((t1_1138) == (INT64_C(0))) {
                    __t188 = (t2_1139) == (INT64_C(0));
                } else {
                    bool __t189;
                    if ((t2_1139) == (INT64_C(0))) {
                        __t189 = false;
                    } else {
                        bool __ps_190 = (cons_hyeq_hygo(t1_1138, t2_1139));
                        if (tur_panicking) return ((bool)0);
                        __t189 = __ps_190;
                    }
                    __t188 = __t189;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_196) {
            ...
            int64_t __t197;
            {
                ...
                int64_t out_1154 = (int64_t)(intptr_t)(__ps_201);
                (void)out_1154;
                __t197 = out_1154;
            }
            __t195 = __t197;
        ...
        if (__ps_206) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1225 = __ps_207;
                (void)h_1225;
                void * __ps_208 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1226 = __ps_208;
                (void)k_1226;
                bool __ps_209 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1225, (void *)(intptr_t)(k_1226), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_209) {
                    void * __t210 = iter;
                    void * __t211 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t213;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1229 = __ps_215;
            (void)iter_1229;
            void * __ps_216 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_217 = (hamt_slkeyeq((void *)(intptr_t)(__ps_216)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1230 = __ps_217;
            (void)keyeq_1230;
            void * __ps_218 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_219 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1229), (void *)(intptr_t)(__ps_218), (void *)(intptr_t)(keyeq_1230)));
            if (tur_panicking) return ((bool)0);
            bool result_1231 = __ps_219;
            (void)result_1231;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t240;
        {
            ...
            {
                tur_adt_Vec__int * __ps_242 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1361));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1362 = __ps_242;
                (void)_un_unv_1362;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t246;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1412 = __ps_247;
            (void)r_1412;
            int64_t __t248;
            bool __ps_249 = (schema_hydecode_hyok_qu(r_1412));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_249) {
                int64_t __ps_250 = (schema_hydecode_hyvalue(r_1412));
                if (tur_panicking) return ((int64_t)0);
                __t248 = __ps_250;
            } else {
                int64_t __ps_251 = (schema_hydecode_hyerrors(r_1412));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t254;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1463 = __ps_255;
            (void)m_1463;
            tur_frame __frame_256;
            tur_frame_init(&__frame_256, NULL);
            struct __defer_env_257 __t259 = {.m = m_1463};
...
static intptr_t __dk_hcase_267(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_267(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1467 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1467)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1467, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_270(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_270(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1468 = (const char *)((int64_t)__dkarg);
    int64_t k_1469 = (int64_t)(intptr_t)__dksubk;
    puts(s_1468);
    ((struct DK *)(intptr_t)k_1469)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1469, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_adt_HRow2 row_1470;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t269 = tur_handler_table_new(1);
    __t269->entries[0].eff_name = "Ask";
    __t269->entries[0].fn = NULL;
    __t269->entries[0].env = NULL;
    __t269->entries[0].cont_kind = 0;
    __t269->entries[0].dk_tag = 2;
    __t269->entries[0].dk_fn = __dk_hcase_267;
    tur_handler_table_t *__t273 = tur_handler_table_new(1);
    __t273->entries[0].eff_name = "Tell";
    __t273->entries[0].fn = NULL;
    __t273->entries[0].env = NULL;
    __t273->entries[0].cont_kind = 0;
    __t273->entries[0].dk_tag = 3;
    __t273->entries[0].dk_fn = __dk_hcase_270;
    tur_handler_table_t *__t274 = tur_handler_table_concat(__t269, __t273);
    tur_adt_HRow2 __ps_275 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(__t274)));
    if (tur_panicking) return ((int64_t)0);
    row_1470 = __ps_275;
    __t1 = (tur_handler_table_t *)(row_1470).h;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_276 = (ctor_Cons_Cons__int(h, t));
