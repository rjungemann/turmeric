        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if ((t1_1039) == (INT64_C(0))) {
                    __t101 = (t2_1040) == (INT64_C(0));
                } else {
                    bool __t102;
                    if ((t2_1040) == (INT64_C(0))) {
                        __t102 = false;
                    } else {
                        bool __ps_103 = (cons_hyeq_hygo(t1_1039, t2_1040));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_103;
                    }
                    __t101 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_109) {
            ...
            int64_t __t110;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1055 = (int64_t)(intptr_t)(__ps_114);
                (void)out_1055;
                __t110 = out_1055;
            }
            __t108 = __t110;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t119;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1130 = __ps_121;
            (void)iter_1130;
            void * __ps_122 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_123 = (hamt_slkeyeq((void *)(intptr_t)(__ps_122)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1131 = __ps_123;
            (void)keyeq_1131;
            void * __ps_124 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_125 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1130), (void *)(intptr_t)(__ps_124), (void *)(intptr_t)(keyeq_1131)));
            if (tur_panicking) return ((bool)0);
            bool result_1132 = __ps_125;
            (void)result_1132;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t146;
        {
            ...
            {
                tur_adt_Vec__int * __ps_148 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1259));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1260 = __ps_148;
                (void)_un_unv_1260;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t152;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1310 = __ps_153;
            (void)r_1310;
            int64_t __t154;
            bool __ps_155 = (schema_hydecode_hyok_qu(r_1310));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_155) {
                int64_t __ps_156 = (schema_hydecode_hyvalue(r_1310));
                if (tur_panicking) return ((int64_t)0);
                __t154 = __ps_156;
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1310));
                if (tur_panicking) return ((int64_t)0);
...
static intptr_t __dk_hcase_160(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_160(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1332 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1332)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1332, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_163(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_163(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1333 = (const char *)((int64_t)__dkarg);
    int64_t k_1334 = (int64_t)(intptr_t)__dksubk;
    puts(s_1333);
    ((struct DK *)(intptr_t)k_1334)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1334, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_adt_HRow2 row_1335;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t162 = tur_handler_table_new(1);
    __t162->entries[0].eff_name = "Ask";
    __t162->entries[0].fn = NULL;
    __t162->entries[0].env = NULL;
    __t162->entries[0].cont_kind = 0;
    __t162->entries[0].dk_tag = 2;
    __t162->entries[0].dk_fn = __dk_hcase_160;
    tur_handler_table_t *__t166 = tur_handler_table_new(1);
    __t166->entries[0].eff_name = "Tell";
    __t166->entries[0].fn = NULL;
    __t166->entries[0].env = NULL;
    __t166->entries[0].cont_kind = 0;
    __t166->entries[0].dk_tag = 3;
    __t166->entries[0].dk_fn = __dk_hcase_163;
    tur_handler_table_t *__t167 = tur_handler_table_concat(__t162, __t166);
    tur_adt_HRow2 __ps_168 = (ctor_HRow2((int64_t)(intptr_t)(__t167)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1335 = __ps_168;
    __t1 = (tur_handler_table_t *)(row_1335).h;
