...
#endif
typedef struct tur_adt_HRow2 {
    int64_t h;
} tur_adt_HRow2;
typedef tur_adt_HRow2 HRow2;

static tur_adt_HRow2 ctor_HRow2_HRow2(int64_t _0) {
    tur_adt_HRow2 __r;
    __r.h = _0;
    return __r;
}

#ifndef TUR_CTORALIAS_HRow2
#define TUR_CTORALIAS_HRow2
#define ctor_HRow2 ctor_HRow2_HRow2
#endif
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_995 = __ps_164;
        bool __ps_165 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_994, (void *)(intptr_t)(k_995), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_165;
        if (__t1) {
            int64_t __ps_166 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_167 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_994, (void *)(intptr_t)(k_995), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t169;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_999 = __ps_171;
            (void)iter_999;
            void * __ps_172 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_173 = (hamt_slkeyeq((void *)(intptr_t)(__ps_172)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1000 = __ps_173;
            (void)keyeq_1000;
            void * __ps_174 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_175 = (map_hyeq_hyloop((void *)(intptr_t)(iter_999), (void *)(intptr_t)(__ps_174), (void *)(intptr_t)(keyeq_1000), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1001 = __ps_175;
            (void)result_1001;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_194) {
            bool __t195;
            {
                ...
                (void)t2_1280;
                bool __t196;
                bool __ps_197 = (tnil_qu(t1_1279));
                if (tur_panicking) return ((bool)0);
                if (__ps_197) {
                    bool __ps_198 = (tnil_qu(t2_1280));
                    if (tur_panicking) return ((bool)0);
                    __t196 = __ps_198;
                } else {
                    bool __t199;
                    bool __ps_200 = (tnil_qu(t2_1280));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_200) {
                        __t199 = false;
                    } else {
                        bool __ps_201 = (cons_hyeq_hygo(t1_1279, t2_1280));
                        if (tur_panicking) return ((bool)0);
                        __t199 = __ps_201;
                    }
                    __t196 = __t199;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_207) {
            ...
            int64_t __t208;
            {
                ...
                int64_t out_1295 = (int64_t)(intptr_t)(__ps_212);
                (void)out_1295;
                __t208 = out_1295;
            }
            __t206 = __t208;
        ...
        if (__ps_216) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1366 = __ps_217;
                (void)h_1366;
                void * __ps_218 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1367 = __ps_218;
                (void)k_1367;
                bool __ps_219 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1366, (void *)(intptr_t)(k_1367), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_219) {
                    void * __t220 = iter;
                    void * __t221 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t223;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1370 = __ps_225;
            (void)iter_1370;
            void * __ps_226 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_227 = (hamt_slkeyeq((void *)(intptr_t)(__ps_226)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1371 = __ps_227;
            (void)keyeq_1371;
            void * __ps_228 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_229 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1370), (void *)(intptr_t)(__ps_228), (void *)(intptr_t)(keyeq_1371)));
            if (tur_panicking) return ((bool)0);
            bool result_1372 = __ps_229;
            (void)result_1372;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t250;
        {
            ...
            {
                tur_adt_Vec__int * __ps_252 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1502));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1503 = __ps_252;
                (void)_un_unv_1503;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t256;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1553 = __ps_257;
            (void)r_1553;
            int64_t __t258;
            bool __ps_259 = (schema_hydecode_hyok_qu(r_1553));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_259) {
                int64_t __ps_260 = (schema_hydecode_hyvalue(r_1553));
                if (tur_panicking) return ((int64_t)0);
                __t258 = __ps_260;
            } else {
                int64_t __ps_261 = (schema_hydecode_hyerrors(r_1553));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t264;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1604 = __ps_265;
            (void)m_1604;
            tur_frame __frame_266;
            tur_frame_init(&__frame_266, NULL);
            struct __defer_env_267 __t269 = {.m = m_1604};
...
static intptr_t main_pf2(intptr_t env, intptr_t __t4__slot) {
    (void)env;
    int64_t __t4 = (int64_t)(__t4__slot);
    int64_t __t3;
    int64_t __t2;
    __t3 = (__t4) + (INT64_C(1));
    printf("%lld\n", (long long)(__t3));
...
static intptr_t main_rf1(intptr_t env, intptr_t __t5__slot, DK *__kont) {
    (void)env;
    int64_t __t5 = (int64_t)(__t5__slot);
    return dk_perform(2, (intptr_t)(0), __dk_reap_node(dk_frame(main_pf2, 0, __kont)));
}
static intptr_t __dk_hcase_277(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_277(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1608 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1608)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1608, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_280(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_280(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1609 = (const char *)((int64_t)__dkarg);
    int64_t k_1610 = (int64_t)(intptr_t)__dksubk;
    puts(s_1609);
    ((struct DK *)(intptr_t)k_1610)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1610, (intptr_t)0);
}
...
static int64_t main__cps(DK *__kont) {
    ...
    tur_handler_table_t *__t279 = tur_handler_table_new(1);
    __t279->entries[0].eff_name = "Ask";
    __t279->entries[0].fn = NULL;
    __t279->entries[0].env = NULL;
    __t279->entries[0].cont_kind = 0;
    __t279->entries[0].dk_tag = 2;
    __t279->entries[0].dk_fn = __dk_hcase_277;
    tur_handler_table_t *__t283 = tur_handler_table_new(1);
    __t283->entries[0].eff_name = "Tell";
    __t283->entries[0].fn = NULL;
    __t283->entries[0].env = NULL;
    __t283->entries[0].cont_kind = 0;
    __t283->entries[0].dk_tag = 3;
    __t283->entries[0].dk_fn = __dk_hcase_280;
    tur_handler_table_t *__t284 = tur_handler_table_concat(__t279, __t283);
    _un_unctlhoist_un1611_1612 = __t284;
    tur_adt_HRow2 __ps_285 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(_un_unctlhoist_un1611_1612)));
    if (tur_panicking) return ((int64_t)0);
    row_1613 = __ps_285;
...
int main(int argc, char **argv) {
    ...
    int64_t __r;
    tur_jmp_buf __dkjb; tur_jmp_buf *__dksave = g_dk_driver; g_dk_driver = &__dkjb;
    if (TUR_SETJMP(__dkjb) == 0) { __r = main__cps(__root); }
    else { __r = __dk_drive_after(); }
    g_dk_driver = __dksave;
    int __mret = (int)((int64_t)(__r));
    if (!tur_async_suspended) dk_free(__root);
    if (!tur_async_suspended && --__dk_entry_depth == 0) __dk_reap_run();
    return __mret;
}
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_286 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
