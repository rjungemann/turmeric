...
static bool __inst_Eq_eq_qu_Map(int64_t x, int64_t y) {
        ...
        if (__t2) {
            ...
            __t3[1] = (int64_t)(intptr_t)__fn_747;
            void *__t4 = __t3;
...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t5) {
            ...
            __t6[1] = (int64_t)(intptr_t)__fn_784;
            void *__t7 = __t6;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t14;
        {
            ...
            bool __t15;
            if ((t1_985) == (INT64_C(0))) {
                __t15 = (t2_986) == (INT64_C(0));
            } else {
                bool __t16;
                if ((t2_986) == (INT64_C(0))) {
                    __t16 = false;
                } else {
                    __t16 = cons_hyeq_hygo(t1_985, t2_986);
                }
                __t15 = __t16;
            }
            __t14 = __t15;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t17) {
            ...
            __t18[1] = (int64_t)(intptr_t)__fn_1116;
            void *__t19 = __t18;
...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            bool __t21;
            {
                int64_t h_734 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_734;
                void * k_735 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_735;
                bool __t22;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_734, (void *)(intptr_t)(k_735), (void *)(intptr_t)(keyeq))) {
                    bool __t23;
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)), map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_734, (void *)(intptr_t)(k_735), (void *)(intptr_t)(keyeq)))) {
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t24;
        {
            void * iter_739 = hamt_sliter_hyalloc((void *)(intptr_t)(map_hyhamt(m1)));
            (void)iter_739;
            void * keyeq_740 = hamt_slkeyeq((void *)(intptr_t)(map_hyhamt(m1)));
            (void)keyeq_740;
            bool result_741 = map_hyeq_hyloop((void *)(intptr_t)(iter_739), (void *)(intptr_t)(map_hyhamt(m2)), (void *)(intptr_t)(keyeq_740), (int64_t)(intptr_t)(val_cmp));
            (void)result_741;
        ...
        if (tnil_qu(l1)) {
            ...
            if (tnil_qu(l2)) {
                ...
                if ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), list_hyhead(l1), list_hyhead(l2))) {
                    __t30 = list_hyeq_qu(list_hytail(l1), list_hytail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t30 = false;
                }
                __t29 = __t30;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__inst_Eq_eq_qu_int((int64_t)((tur_adt_Cons *)(intptr_t)(c1))->head, (int64_t)((tur_adt_Cons *)(intptr_t)(c2))->head)) {
            bool __t32;
            {
                ...
                bool __t33;
                if ((t1_980) == (INT64_C(0))) {
                    __t33 = (t2_981) == (INT64_C(0));
                } else {
                    bool __t34;
                    if ((t2_981) == (INT64_C(0))) {
                        __t34 = false;
                    } else {
                        __t34 = cons_hyeq_hygo(t1_980, t2_981);
                    }
                    __t33 = __t34;
                }
                __t32 = __t33;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            int64_t __t36;
            {
                int64_t out_989 = (int64_t)(intptr_t)(tcons__spec__tur_adt_Cons__int___int64_t_int64_t((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f))));
                (void)out_989;
                __t36 = out_989;
            }
            __t35 = __t36;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            int64_t __t38;
            {
                int64_t out_996 = (int64_t)(intptr_t)(tcons__spec__tur_adt_Cons__int___int64_t_int64_t(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2)));
                (void)out_996;
                __t38 = out_996;
            }
            __t37 = __t38;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_1061 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_1061;
                void * k_1062 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_1062;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1061, (void *)(intptr_t)(k_1062), (void *)(intptr_t)(keyeq))) {
                    void * __t39 = iter;
                    void * __t40 = s2_hamt;
                    void * __t41 = keyeq;
                    iter = __t39;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t42;
        {
            void * iter_1065 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_1065;
            void * keyeq_1066 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_1066;
            bool result_1067 = set_hyeq_hyloop((void *)(intptr_t)(iter_1065), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_1066));
            (void)result_1067;
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        bool __t44 = (set_hycount(s1)) == (set_hycount(s2));
        if (__t44) {
            ...
            if (mutmap_hyslot_hyoccupied_qu(m1, i)) {
                ...
                if (mutmap_hyhas_qu(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i))) {
                    ...
                    if (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), mutmap_hyslot_hyvalue(m1, i), mutmap_hyget(m2, mutmap_hyslot_hyhash(m1, i), mutmap_hyslot_hykey(m1, i)))) {
                        __t48 = mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp));
                    } else {
                        __t48 = false;
                    }
                    __t47 = __t48;
                ...
                __t46 = mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp));
            }
            __t45 = __t46;
        }
        return __t45;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        int64_t __t49;
        {
            int64_t _un_unv_1195 = vec_hynew();
            (void)_un_unv_1195;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t53;
        {
            int64_t r_1244 = schema_hydecode(schema, node);
            (void)r_1244;
            int64_t __t54;
            if (schema_hydecode_hyok_qu(r_1244)) {
                __t54 = schema_hydecode_hyvalue(r_1244);
            } else {
                __t54 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1244));
            }
            __t53 = __t54;
        }
        return __t53;
...
static int64_t __effect_handler_56(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_56(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_1266 = __k;
    int64_t __t57 = tur_effect_cont_resume((int64_t)(intptr_t)k_1266, (int64_t)INT64_C(41));
    return (int64_t)__t57;
}

static int64_t __effect_handler_59(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_59(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * s_1267 = (const char *)__effect_args[0];
    int64_t k_1268 = __k;
    puts(s_1267);
    int64_t __t60;
    int64_t __t61 = tur_effect_cont_resume((int64_t)(intptr_t)k_1268, (int64_t)0);
    __t60 = __t61;
    return (int64_t)__t60;
}

static void __wh_body_64(void);
static void __wh_body_64(void) {
    int64_t __t65[1];
    __t65[0] = (int64_t)"hi";
    tur_effect_perform("Tell", __t65, 1);
    int64_t __t66 = tur_effect_perform("Ask", NULL, 0);
    printf("%lld\n", (long long)((__t66) + (INT64_C(1))));
    int64_t __t67;
    __t67 = INT64_C(0);
    tur_current_fiber->result = (int64_t)__t67;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t55;
        {
            tur_handler_table_t *__t58 = tur_handler_table_new(1);
            __t58->entries[0].eff_name = "Ask";
            __t58->entries[0].fn = __effect_handler_56;
            __t58->entries[0].env = NULL;
            __t58->entries[0].cont_kind = 0;
            tur_handler_table_t *__t62 = tur_handler_table_new(1);
            __t62->entries[0].eff_name = "Tell";
            __t62->entries[0].fn = __effect_handler_59;
            __t62->entries[0].env = NULL;
            __t62->entries[0].cont_kind = 0;
            tur_handler_table_t *__t63 = tur_handler_table_concat(__t58, __t62);
            tur_adt_HRow2 row_1269 = ctor_HRow2((int64_t)(intptr_t)(__t63));
            (void)row_1269;
            tur_handler_table_t *__wh_tbl_64 = (tur_handler_table_t *)(row_1269).h;
            TurEffectCaptureCtx __wh_cap_64;
            __wh_cap_64.has_pending_effect = false;
            __wh_cap_64.eff_name = NULL;
            __wh_cap_64.eff_n_args = 0;
            __wh_cap_64.dispatch = tur_handler_dispatch;
            __wh_cap_64.body_env = NULL;
            __wh_cap_64.table = __wh_tbl_64;
            FiberBlock *__wh_fiber_64 = tur_fiber_block_new(__wh_body_64, 0);
            __wh_fiber_64->eff_ctx = &__wh_cap_64;
            EffectHandlerFrame *__wh_parent_64 = (tur_current_fiber ? (EffectHandlerFrame *)tur_current_fiber->effect_handler_chain : global_effect_handler_chain);
            EffectHandlerFrame __wh_frame_64;
            __wh_frame_64.parent = __wh_parent_64;
            int __wh_nf_64 = __wh_tbl_64->n_entries < 8 ? __wh_tbl_64->n_entries : 8;
            __wh_frame_64.n_cases = __wh_nf_64;
            for (int __wi = 0; __wi < __wh_nf_64; __wi++) {
                __wh_frame_64.cases[__wi].effect_name = __wh_tbl_64->entries[__wi].eff_name;
                __wh_frame_64.cases[__wi].handler_fn = NULL;
                __wh_frame_64.cases[__wi].env = NULL;
            }
            __wh_fiber_64->effect_handler_chain = &__wh_frame_64;
            int64_t __t68 = (int64_t)tur_handler_dispatch(&__wh_cap_64, (int64_t)(intptr_t)__wh_fiber_64, 0);
            if (__wh_fiber_64->done) { free(__wh_fiber_64->stack); free(__wh_fiber_64); }
            __t55 = __t68;
        }
        return (int)__t55;
}
