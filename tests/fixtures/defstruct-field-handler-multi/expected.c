...
static intptr_t __dk_hcase_173(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_173(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
...
static intptr_t __dk_hcase_176(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_176(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
...
static int64_t main__cps(DK *__kont) {
    ...
    tur_handler_table_t *__t175 = tur_handler_table_new(1);
    __t175->entries[0].eff_name = "Ask";
    __t175->entries[0].fn = NULL;
    __t175->entries[0].env = NULL;
    __t175->entries[0].cont_kind = 0;
    __t175->entries[0].dk_tag = 2;
    __t175->entries[0].dk_fn = __dk_hcase_173;
    tur_handler_table_t *__t179 = tur_handler_table_new(1);
    __t179->entries[0].eff_name = "Tell";
    __t179->entries[0].fn = NULL;
    __t179->entries[0].env = NULL;
    __t179->entries[0].cont_kind = 0;
    __t179->entries[0].dk_tag = 3;
    __t179->entries[0].dk_fn = __dk_hcase_176;
    tur_handler_table_t *__t180 = tur_handler_table_concat(__t175, __t179);
    _un_unctlhoist_un1611_1612 = __t180;
    tur_adt_HRow2 __ps_181 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(_un_unctlhoist_un1611_1612)));
    if (tur_panicking) return ((int64_t)0);
    row_1613 = __ps_181;
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_182 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
