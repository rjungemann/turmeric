...
static void __defer_163(void *__env) {
    ...
    bool __ps_182 = (bt_hyundo_hyto_ex(__e->m));
...
static intptr_t __dk_hcase_172(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    ...
    int64_t k_1618 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1618)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1618, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_175(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_175(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1619 = (const char *)((int64_t)__dkarg);
    int64_t k_1620 = (int64_t)(intptr_t)__dksubk;
    puts(s_1619);
    ((struct DK *)(intptr_t)k_1620)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1620, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_handler_table_t * _un_unctlhoist_un1621_1622;
    tur_adt_HRow2 row_1623;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t174 = tur_handler_table_new(1);
    __t174->entries[0].eff_name = "Ask";
    __t174->entries[0].fn = NULL;
    __t174->entries[0].env = NULL;
    __t174->entries[0].cont_kind = 0;
    __t174->entries[0].dk_tag = 2;
    __t174->entries[0].dk_fn = __dk_hcase_172;
    tur_handler_table_t *__t178 = tur_handler_table_new(1);
    __t178->entries[0].eff_name = "Tell";
    __t178->entries[0].fn = NULL;
    __t178->entries[0].env = NULL;
    __t178->entries[0].cont_kind = 0;
    __t178->entries[0].dk_tag = 3;
    __t178->entries[0].dk_fn = __dk_hcase_175;
    tur_handler_table_t *__t179 = tur_handler_table_concat(__t174, __t178);
    _un_unctlhoist_un1621_1622 = __t179;
    tur_adt_HRow2 __ps_180 = (ctor_HRow2_HRow2((int64_t)(intptr_t)(_un_unctlhoist_un1621_1622)));
    if (tur_panicking) return ((int64_t)0);
    row_1623 = __ps_180;
    __t1 = (tur_handler_table_t *)(row_1623).h;
...
static tur_adt_Vec__int * vec_empty_like____spec__tur_adt_Vec__int___int64_t(int64_t witness) {
        tur_adt_Vec__int * __ps_181 = (vec_new__spec__tur_adt_Vec__int__());
