...
static intptr_t __dk_hcase_163(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_163(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    int64_t k_1368 = (int64_t)(intptr_t)__dksubk;
    ((struct DK *)(intptr_t)k_1368)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1368, (intptr_t)((int64_t)INT64_C(41)));
}

static intptr_t __dk_hcase_166(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk);
static intptr_t __dk_hcase_166(intptr_t __dkenv, intptr_t __dkarg, struct DK *__dksubk) {
    (void)__dkenv; (void)__dkarg; (void)__dksubk;
    const char * s_1369 = (const char *)((int64_t)__dkarg);
    int64_t k_1370 = (int64_t)(intptr_t)__dksubk;
    puts(s_1369);
    ((struct DK *)(intptr_t)k_1370)->consumed = 1;
    return dk_tail_resume((struct DK *)(intptr_t)k_1370, (intptr_t)0);
}

static int64_t main__cps(DK *__kont) {
    tur_adt_HRow2 row_1371;
    tur_handler_table_t * __t1;
    tur_handler_table_t *__t165 = tur_handler_table_new(1);
    __t165->entries[0].eff_name = "Ask";
    __t165->entries[0].fn = NULL;
    __t165->entries[0].env = NULL;
    __t165->entries[0].cont_kind = 0;
    __t165->entries[0].dk_tag = 2;
    __t165->entries[0].dk_fn = __dk_hcase_163;
    tur_handler_table_t *__t169 = tur_handler_table_new(1);
    __t169->entries[0].eff_name = "Tell";
    __t169->entries[0].fn = NULL;
    __t169->entries[0].env = NULL;
    __t169->entries[0].cont_kind = 0;
    __t169->entries[0].dk_tag = 3;
    __t169->entries[0].dk_fn = __dk_hcase_166;
    tur_handler_table_t *__t170 = tur_handler_table_concat(__t165, __t169);
    tur_adt_HRow2 __ps_171 = (ctor_HRow2((int64_t)(intptr_t)(__t170)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    row_1371 = __ps_171;
    __t1 = (tur_handler_table_t *)(row_1371).h;
