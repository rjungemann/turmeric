...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            int64_t __t28;
            {
                Point _un_untur_unmk_un_un_906 = (Point){.x = INT64_C(3), .y = INT64_C(4)};
                (void)_un_untur_unmk_un_un_906;
                __t28 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(m_905, &_un_untur_unmk_un_un_906), __inst_Hash_hash_Point(_un_untur_unmk_un_un_906), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_906), INT64_C(999), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_906), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_906));
            }
            int64_t m2_907 = __t28;
            (void)m2_907;
            int64_t __t29;
            {
                Point _un_untur_unmk_un_un_908 = (Point){.x = INT64_C(3), .y = INT64_C(4)};
                (void)_un_untur_unmk_un_un_908;
                __t29 = map_hyget_hyeq_hyo(tur_hymap_hykcheck(m2_907, &_un_untur_unmk_un_un_908), __inst_Hash_hash_Point(_un_untur_unmk_un_un_908), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_908), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_908), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_908));
            }
            printf("%lld\n", (long long)(__t29));
            int64_t __t30;
            {
                ...
                __t30 = map_hyget_hyeq_hyo(tur_hymap_hykcheck(m2_907, &_un_untur_unmk_un_un_909), __inst_Hash_hash_Point(_un_untur_unmk_un_un_909), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_909), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_909), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_909));
            }
            printf("%lld\n", (long long)(__t30));
            printf("%lld\n", (long long)(map_hycount(m2_907)));
            int64_t __t31;
            bool __t32;
            {
                Point _un_untur_unmk_un_un_910 = (Point){.x = INT64_C(5), .y = INT64_C(6)};
                (void)_un_untur_unmk_un_un_910;
                __t32 = map_hyhas_hyeq_hyo_qu(tur_hymap_hykcheck(m2_907, &_un_untur_unmk_un_un_910), __inst_Hash_hash_Point(_un_untur_unmk_un_un_910), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_910), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_910), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_910));
            }
            if (__t32) {
                __t31 = INT64_C(1);
            } else {
            ...
            bool __t34;
            {
                Point _un_untur_unmk_un_un_911 = (Point){.x = INT64_C(9), .y = INT64_C(9)};
                (void)_un_untur_unmk_un_un_911;
                __t34 = map_hyhas_hyeq_hyo_qu(tur_hymap_hykcheck(m2_907, &_un_untur_unmk_un_un_911), __inst_Hash_hash_Point(_un_untur_unmk_un_un_911), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_911), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_911), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_911));
            }
            if (__t34) {
                __t33 = INT64_C(1);
            } else {
            ...
            bool __t36;
            {
                Point _un_untur_unmk_un_un_912 = (Point){.x = INT64_C(3), .y = INT64_C(4)};
                (void)_un_untur_unmk_un_un_912;
                int64_t __t37;
                {
                    Point _un_untur_unmk_un_un_913 = (Point){.x = INT64_C(3), .y = INT64_C(4)};
                    (void)_un_untur_unmk_un_un_913;
                    __t37 = map_hydissoc_hyeq_hyo(tur_hymap_hykcheck(m2_907, &_un_untur_unmk_un_un_913), __inst_Hash_hash_Point(_un_untur_unmk_un_un_913), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_913), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_913), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_913));
                }
                __t36 = map_hyhas_hyeq_hyo_qu(tur_hymap_hykcheck(__t37, &_un_untur_unmk_un_un_912), __inst_Hash_hash_Point(_un_untur_unmk_un_un_912), __inst_MapKey_mk_hybox_Point(_un_untur_unmk_un_un_912), __inst_MapKey_mk_hycmp_Point(_un_untur_unmk_un_un_912), __inst_MapKey_mk_hyowned_qu_Point(_un_untur_unmk_un_un_912));
            }
            if (__t36) {
                __t35 = INT64_C(1);
            } else {
