...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            int64_t __t28;
            {
                ...
                (void)__tur_mk___895;
                __t28 = map_assoc_eq_o(tur_map_kcheck(m_894, &__tur_mk___895), __inst_Hash_hash_Point(__tur_mk___895), __inst_MapKey_mk_box_Point(__tur_mk___895), INT64_C(999), __inst_MapKey_mk_cmp_Point(__tur_mk___895), __inst_MapKey_mk_owned__Point(__tur_mk___895));
            }
            ...
            int64_t __t29;
            {
                ...
                (void)__tur_mk___897;
                __t29 = map_get_eq_o(tur_map_kcheck(m2_896, &__tur_mk___897), __inst_Hash_hash_Point(__tur_mk___897), __inst_MapKey_mk_box_Point(__tur_mk___897), __inst_MapKey_mk_cmp_Point(__tur_mk___897), __inst_MapKey_mk_owned__Point(__tur_mk___897));
            }
            printf("%lld\n", (long long)(__t29));
            int64_t __t30;
            {
                ...
                (void)__tur_mk___898;
                __t30 = map_get_eq_o(tur_map_kcheck(m2_896, &__tur_mk___898), __inst_Hash_hash_Point(__tur_mk___898), __inst_MapKey_mk_box_Point(__tur_mk___898), __inst_MapKey_mk_cmp_Point(__tur_mk___898), __inst_MapKey_mk_owned__Point(__tur_mk___898));
            }
            printf("%lld\n", (long long)(__t30));
            ...
            bool __t32;
            {
                ...
                (void)__tur_mk___899;
                __t32 = map_has_eq_o_qu(tur_map_kcheck(m2_896, &__tur_mk___899), __inst_Hash_hash_Point(__tur_mk___899), __inst_MapKey_mk_box_Point(__tur_mk___899), __inst_MapKey_mk_cmp_Point(__tur_mk___899), __inst_MapKey_mk_owned__Point(__tur_mk___899));
            }
            if (__t32) {
                __t31 = INT64_C(1);
            } else {
            ...
            bool __t34;
            {
                ...
                (void)__tur_mk___900;
                __t34 = map_has_eq_o_qu(tur_map_kcheck(m2_896, &__tur_mk___900), __inst_Hash_hash_Point(__tur_mk___900), __inst_MapKey_mk_box_Point(__tur_mk___900), __inst_MapKey_mk_cmp_Point(__tur_mk___900), __inst_MapKey_mk_owned__Point(__tur_mk___900));
            }
            if (__t34) {
                __t33 = INT64_C(1);
            } else {
            ...
            bool __t36;
            {
                ...
                int64_t __t37;
                {
                    ...
                    (void)__tur_mk___902;
                    __t37 = map_dissoc_eq_o(tur_map_kcheck(m2_896, &__tur_mk___902), __inst_Hash_hash_Point(__tur_mk___902), __inst_MapKey_mk_box_Point(__tur_mk___902), __inst_MapKey_mk_cmp_Point(__tur_mk___902), __inst_MapKey_mk_owned__Point(__tur_mk___902));
                }
                __t36 = map_has_eq_o_qu(tur_map_kcheck(__t37, &__tur_mk___901), __inst_Hash_hash_Point(__tur_mk___901), __inst_MapKey_mk_box_Point(__tur_mk___901), __inst_MapKey_mk_cmp_Point(__tur_mk___901), __inst_MapKey_mk_owned__Point(__tur_mk___901));
            }
            if (__t36) {
                __t35 = INT64_C(1);
            } else {
