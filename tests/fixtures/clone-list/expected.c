...
int main() {
        {
            Cons cell_28 = (Cons){.value = INT64_C(42), .next = INT64_C(0)};
            (void)cell_28;
            {
                int64_t cell2_29 = ((int64_t (*)(Cons))(intptr_t)(dict_Clone_Cons_singleton.clone))(cell_28);
                (void)cell2_29;
                printf("%lld\n", (long long)(heap_cons_value(cell2_29)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
