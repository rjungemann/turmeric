...
int main() {
        {
            Cons cell_268 = (Cons){.value = INT64_C(42), .next = INT64_C(0)};
            (void)cell_268;
            {
                int64_t cell2_269 = ((int64_t (*)(Cons))(intptr_t)(dict_Clone_Cons_singleton.clone))(cell_268);
                (void)cell2_269;
                printf("%lld\n", (long long)(heap_cons_value(cell2_269)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
