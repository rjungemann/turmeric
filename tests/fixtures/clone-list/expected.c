...
int main() {
        {
            Cell cell_623 = (Cell){.value = INT64_C(42), .next = INT64_C(0)};
            (void)cell_623;
            {
                int64_t cell2_624 = ((int64_t (*)(Cell))(intptr_t)(dict_Clone_Cell_singleton.clone))(cell_623);
                (void)cell2_624;
                printf("%lld\n", (long long)(heap_cons_value(cell2_624)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
