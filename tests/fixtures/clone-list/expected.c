...
int main() {
        {
            Cons cell_215 = (Cons){.value = INT64_C(42), .next = INT64_C(0)};
            (void)cell_215;
            {
                int64_t cell2_216 = ((int64_t (*)(Cons))(intptr_t)(dict_Clone_Cons_singleton.clone))(cell_215);
                (void)cell2_216;
                printf("%lld\n", (long long)(heap_cons_value(cell2_216)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
