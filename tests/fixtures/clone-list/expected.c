...
int main() {
        {
            Cons cell_203 = (Cons){.value = INT64_C(42), .next = INT64_C(0)};
            (void)cell_203;
            {
                int64_t cell2_204 = ((int64_t (*)(Cons))(intptr_t)(dict_Clone_Cons_singleton.clone))(cell_203);
                (void)cell2_204;
                printf("%lld\n", (long long)(heap_cons_value(cell2_204)));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
