...
static int64_t deep_hypanic(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            int64_t __ps_184 = (deep_hypanic((n) - (INT64_C(1))));
            if (tur_panicking) return ((int64_t)0);
            __t183 = (INT64_C(1)) + (__ps_184);
        }
        return __t183;
}
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *(void (**)(void *))__t186 = 0;
            ...
            __t185[1] = (int64_t)(intptr_t)__fn_1438;
            void *__t187 = __t185;
            int64_t __catch_result_188 = tur_catch_unwind_box((int64_t)(intptr_t)__t187);
            TUR_CLOSURE_DROP(__t187);
            int64_t caught_1440 = __catch_result_188;
            (void)caught_1440;
            bool __ps_189 = (err_qu(caught_1440));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_189) {
                puts("caught");
            } else {
        ...
        }
        {
            ...
            *(void (**)(void *))__t191 = 0;
            ...
            __t190[0] = (int64_t)(intptr_t)__tur_fatshim0;
            __t190[1] = (int64_t)(intptr_t)__fn_1441;
            void *__t192 = __t190;
            int64_t __catch_result_193 = tur_catch_unwind_box((int64_t)(intptr_t)__t192);
            TUR_CLOSURE_DROP(__t192);
            int64_t ok_1443 = __catch_result_193;
            (void)ok_1443;
            bool __ps_194 = (ok_qu(ok_1443));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_194) {
                puts("ok");
            } else {
