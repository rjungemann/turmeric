...
static int64_t __fn_1434() {
        int64_t __ps_44 = (deep_hypanic(INT64_C(2000)));
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *(void (**)(void *))__t178 = 0;
            ...
            __t177[1] = (int64_t)(intptr_t)__fn_1434;
            void *__t179 = __t177;
            int64_t __catch_result_180 = tur_catch_unwind_box((int64_t)(intptr_t)__t179);
            TUR_CLOSURE_DROP(__t179);
            int64_t caught_1436 = __catch_result_180;
            (void)caught_1436;
            bool __ps_181 = (err_qu(caught_1436));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_181) {
                puts("caught");
            } else {
        ...
        }
        {
            ...
            *(void (**)(void *))__t183 = 0;
            ...
            __t182[1] = (int64_t)(intptr_t)__fn_1437;
            void *__t184 = __t182;
            int64_t __catch_result_185 = tur_catch_unwind_box((int64_t)(intptr_t)__t184);
            TUR_CLOSURE_DROP(__t184);
            int64_t ok_1439 = __catch_result_185;
            (void)ok_1439;
            bool __ps_186 = (ok_qu(ok_1439));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_186) {
                puts("ok");
            } else {
