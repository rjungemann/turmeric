...
static int64_t __fn_1302() {
        __auto_type __ps_42 = (deep_hypanic(INT64_C(2000)));
...
static int64_t deep_hypanic(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            __auto_type __ps_157 = (deep_hypanic((n) - (INT64_C(1))));
            if (tur_panicking) return (int64_t){0};
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *(void (**)(void *))__t159 = 0;
            ...
            (void)caught_1304;
            __auto_type __ps_162 = (err_qu(caught_1304));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_162) {
                puts("caught");
            } else {
        ...
        }
        {
            ...
            *(void (**)(void *))__t164 = 0;
            ...
            (void)ok_1307;
            __auto_type __ps_167 = (ok_qu(ok_1307));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_167) {
                puts("ok");
            } else {
