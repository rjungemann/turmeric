...
static int64_t __fn_1281() {
        __auto_type __ps_40 = (deep_hypanic(INT64_C(2000)));
...
static int64_t deep_hypanic(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            __auto_type __ps_155 = (deep_hypanic((n) - (INT64_C(1))));
            if (tur_panicking) return (int64_t){0};
            __t154 = (INT64_C(1)) + (__ps_155);
        }
        return __t154;
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t156 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t156[0] = (int64_t)(intptr_t)__tur_fatshim0;
            __t156[1] = (int64_t)(intptr_t)__fn_1281;
            void *__t157 = __t156;
            int64_t __catch_result_158 = tur_catch_unwind_box((int64_t)(intptr_t)__t157);
            free((void *)(intptr_t)__t157);
            int64_t caught_1283 = __catch_result_158;
            (void)caught_1283;
            __auto_type __ps_159 = (err_qu(caught_1283));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_159) {
                puts("caught");
            } else {
        ...
        }
        {
            ...
            __t160[1] = (int64_t)(intptr_t)__fn_1284;
            void *__t161 = __t160;
            int64_t __catch_result_162 = tur_catch_unwind_box((int64_t)(intptr_t)__t161);
            free((void *)(intptr_t)__t161);
            int64_t ok_1286 = __catch_result_162;
            (void)ok_1286;
            __auto_type __ps_163 = (ok_qu(ok_1286));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_163) {
                puts("ok");
            } else {
