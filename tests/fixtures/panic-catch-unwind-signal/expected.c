...
static int64_t deep_hypanic(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            int64_t __ps_172 = (deep_hypanic((n) - (INT64_C(1))));
            if (tur_panicking) return ((int64_t)0);
            __t171 = (INT64_C(1)) + (__ps_172);
        }
        return __t171;
}
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *(void (**)(void *))__t174 = 0;
            ...
            __t173[1] = (int64_t)(intptr_t)__fn_1434;
            void *__t175 = __t173;
            int64_t __catch_result_176 = tur_catch_unwind_box((int64_t)(intptr_t)__t175);
            TUR_CLOSURE_DROP(__t175);
            int64_t caught_1436 = __catch_result_176;
            (void)caught_1436;
            bool __ps_177 = (err_qu(caught_1436));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_177) {
                puts("caught");
            } else {
        ...
        }
        {
            ...
            *(void (**)(void *))__t179 = 0;
            ...
            __t178[1] = (int64_t)(intptr_t)__fn_1437;
            void *__t180 = __t178;
            int64_t __catch_result_181 = tur_catch_unwind_box((int64_t)(intptr_t)__t180);
            TUR_CLOSURE_DROP(__t180);
            int64_t ok_1439 = __catch_result_181;
            (void)ok_1439;
            bool __ps_182 = (ok_qu(ok_1439));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_182) {
                puts("ok");
            } else {
