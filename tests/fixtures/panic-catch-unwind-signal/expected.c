...
static int64_t __fn_1469() {
        int64_t __ps_104 = (deep_hypanic(INT64_C(2000)));
        if (tur_panicking) return ((int64_t)0);
        return __ps_104;
}
...
static int64_t deep_hypanic(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            int64_t __ps_248 = (deep_hypanic((n) - (INT64_C(1))));
            if (tur_panicking) return ((int64_t)0);
            __t247 = (INT64_C(1)) + (__ps_248);
        }
        return __t247;
}
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *(void (**)(void *))__t250 = 0;
            ...
            __t249[1] = (int64_t)(intptr_t)__fn_1469;
            void *__t251 = __t249;
            int64_t __catch_result_252 = tur_catch_unwind_box((int64_t)(intptr_t)__t251);
            TUR_CLOSURE_DROP(__t251);
            int64_t caught_1471 = __catch_result_252;
            (void)caught_1471;
            bool __ps_253 = (err_qu(caught_1471));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_253) {
                puts("caught");
            } else {
        ...
        }
        {
            ...
            *(void (**)(void *))__t255 = 0;
            ...
            __t254[0] = (int64_t)(intptr_t)__tur_fatshim0;
            __t254[1] = (int64_t)(intptr_t)__fn_1472;
            void *__t256 = __t254;
            int64_t __catch_result_257 = tur_catch_unwind_box((int64_t)(intptr_t)__t256);
            TUR_CLOSURE_DROP(__t256);
            int64_t ok_1474 = __catch_result_257;
            (void)ok_1474;
            bool __ps_258 = (ok_qu(ok_1474));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_258) {
                puts("ok");
            } else {
