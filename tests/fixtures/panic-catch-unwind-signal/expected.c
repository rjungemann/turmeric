...
static int64_t deep_hypanic(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            __auto_type __ps_179 = (deep_hypanic((n) - (INT64_C(1))));
            if (tur_panicking) return (int64_t){0};
            __t178 = (INT64_C(1)) + (__ps_179);
        }
        return __t178;
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            __t180[1] = (int64_t)(intptr_t)__fn_1269;
            void *__t181 = __t180;
            int64_t __catch_result_182 = tur_catch_unwind_box((int64_t)(intptr_t)__t181);
            free((void *)(intptr_t)__t181);
            int64_t caught_1271 = __catch_result_182;
            (void)caught_1271;
            __auto_type __ps_183 = (err_qu(caught_1271));
        ...
        }
        {
            ...
            __t184[1] = (int64_t)(intptr_t)__fn_1272;
            void *__t185 = __t184;
            int64_t __catch_result_186 = tur_catch_unwind_box((int64_t)(intptr_t)__t185);
            free((void *)(intptr_t)__t185);
            int64_t ok_1274 = __catch_result_186;
            (void)ok_1274;
            __auto_type __ps_187 = (ok_qu(ok_1274));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_187) {
                puts("ok");
            } else {
