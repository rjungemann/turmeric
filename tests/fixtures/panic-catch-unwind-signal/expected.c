...
static int64_t deep_hypanic(int64_t n) {
        ...
        if ((n) == (INT64_C(0))) {
            ...
            __auto_type __ps_175 = (deep_hypanic((n) - (INT64_C(1))));
            if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t176 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t176[0] = (int64_t)(intptr_t)__tur_fatshim0;
            __t176[1] = (int64_t)(intptr_t)__fn_1281;
            void *__t177 = __t176;
            int64_t __catch_result_178 = tur_catch_unwind_box((int64_t)(intptr_t)__t177);
            free((void *)(intptr_t)__t177);
            int64_t caught_1283 = __catch_result_178;
            (void)caught_1283;
            __auto_type __ps_179 = (err_qu(caught_1283));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_179) {
                puts("caught");
            } else {
        ...
        }
        {
            ...
            int64_t ok_1286 = __catch_result_182;
            (void)ok_1286;
            __auto_type __ps_183 = (ok_qu(ok_1286));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_183) {
                puts("ok");
            } else {
