    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *(void (**)(void *))__t177 = 0;
            ...
            __t176[1] = (int64_t)(intptr_t)__fn_1608;
            void *__t178 = __t176;
            int64_t __catch_result_179 = tur_catch_unwind_box((int64_t)(intptr_t)__t178);
            TUR_CLOSURE_DROP(__t178);
            int64_t caught_1610 = __catch_result_179;
            (void)caught_1610;
            bool __ps_180 = (err_qu(caught_1610));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_180) {
                puts("caught");
            } else {
        ...
        }
        {
            ...
            *(void (**)(void *))__t182 = 0;
            ...
            __t181[1] = (int64_t)(intptr_t)__fn_1611;
            void *__t183 = __t181;
            int64_t __catch_result_184 = tur_catch_unwind_box((int64_t)(intptr_t)__t183);
            TUR_CLOSURE_DROP(__t183);
            int64_t ok_1613 = __catch_result_184;
            (void)ok_1613;
            bool __ps_185 = (ok_qu(ok_1613));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_185) {
                puts("ok");
            } else {
