         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n163->aggr_mask = 0x9u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n163->saved[0] = (int64_t)(intptr_t)__ab; }
            __n163->saved[1] = (int64_t)(intptr_t)(n);
            __n163->saved[2] = (int64_t)(intptr_t)(__t161);
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t162, sizeof(tur_adt_Option__int)); __n163->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t162, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           __n164->aggr_mask = 0x9u;
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n164->saved[0] = (int64_t)(intptr_t)__ab; }
           __n164->saved[1] = (int64_t)(intptr_t)(n);
           __n164->saved[2] = (int64_t)(intptr_t)(__t161);
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t162, sizeof(tur_adt_Option__int)); __n164->saved[3] = (int64_t)(intptr_t)__ab; }
           tur_adt_Option__int __ra164_0 = (acc);
           int64_t __ra164_1 = ((n) - (INT64_C(1)));
           acc = __ra164_0;
           n = __ra164_1;
          ...
          case 4: {
           ...
           __t161 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t162, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur165; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur165, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t162 = __ur165;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t166;
           bool __ps_167 = (some___spec__bool_tur_adt_Option__int(__t162));
           ...
           { tur_adt_Option__int __rv = (__t166); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_169 = (go(__ps_168, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1335 = __ps_169;
            (void)r_1335;
            bool __ps_170 = (some___spec__bool_tur_adt_Option__int(r_1335));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_170) {
                int64_t __ps_171 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1335));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_171));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_173 = (go(__ps_172, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1336 = __ps_173;
            (void)s_1336;
            bool __ps_174 = (some___spec__bool_tur_adt_Option__int(s_1336));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_174) {
                int64_t __ps_175 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1336));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_175));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_179 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_179;
}
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_180 = (ctor_Option__int(false, ((int64_t)0)));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_180;
}
