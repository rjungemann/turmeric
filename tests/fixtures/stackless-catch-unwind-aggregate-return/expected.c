        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 4: {
           ...
           __auto_type __ps_162 = (some___spec__bool_tur_adt_Option__int(__t157));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_164 = (go(__ps_163, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1305 = __ps_164;
            (void)r_1305;
            __auto_type __ps_165 = (some___spec__bool_tur_adt_Option__int(r_1305));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_165) {
                __auto_type __ps_166 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1305));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_166));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_168 = (go(__ps_167, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1306 = __ps_168;
            (void)s_1306;
            __auto_type __ps_169 = (some___spec__bool_tur_adt_Option__int(s_1306));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_169) {
                __auto_type __ps_170 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1306));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_170));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_174 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_174;
}
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        __auto_type __ps_175 = (ctor_Option__int(false, (int64_t){0}));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_175;
}
