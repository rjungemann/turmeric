         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n156->aggr_mask = 0x9u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n156->saved[0] = (int64_t)(intptr_t)__ab; }
            __n156->saved[1] = (int64_t)(intptr_t)(n);
            __n156->saved[2] = (int64_t)(intptr_t)(__t154);
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t155, sizeof(tur_adt_Option__int)); __n156->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t155, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           __n157->aggr_mask = 0x9u;
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n157->saved[0] = (int64_t)(intptr_t)__ab; }
           __n157->saved[1] = (int64_t)(intptr_t)(n);
           __n157->saved[2] = (int64_t)(intptr_t)(__t154);
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t155, sizeof(tur_adt_Option__int)); __n157->saved[3] = (int64_t)(intptr_t)__ab; }
           __auto_type __ra157_0 = (acc);
           __auto_type __ra157_1 = ((n) - (INT64_C(1)));
           acc = __ra157_0;
           n = __ra157_1;
          ...
          case 4: {
           ...
           __t154 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t155, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur158; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur158, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t155 = __ur158;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t159;
           __auto_type __ps_160 = (some___spec__bool_tur_adt_Option__int(__t155));
           ...
           { tur_adt_Option__int __rv = (__t159); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_162 = (go(__ps_161, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1284 = __ps_162;
            (void)r_1284;
            __auto_type __ps_163 = (some___spec__bool_tur_adt_Option__int(r_1284));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_163) {
                __auto_type __ps_164 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1284));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_164));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_166 = (go(__ps_165, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1285 = __ps_166;
            (void)s_1285;
            __auto_type __ps_167 = (some___spec__bool_tur_adt_Option__int(s_1285));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_167) {
                __auto_type __ps_168 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1285));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_168));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
