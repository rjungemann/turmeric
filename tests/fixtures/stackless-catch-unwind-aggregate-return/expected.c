...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1611 = __ps_180;
            (void)r_1611;
            bool __ps_181 = (some___spec__bool_tur_adt_Option__int(r_1611));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_181) {
                int64_t __ps_182 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1611));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_182));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1612 = __ps_184;
            (void)s_1612;
            bool __ps_185 = (some___spec__bool_tur_adt_Option__int(s_1612));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_185) {
                int64_t __ps_186 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1612));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_186));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
