         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n158->aggr_mask = 0x9u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n158->saved[0] = (int64_t)(intptr_t)__ab; }
            __n158->saved[1] = (int64_t)(intptr_t)(n);
            __n158->saved[2] = (int64_t)(intptr_t)(__t156);
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t157, sizeof(tur_adt_Option__int)); __n158->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t157, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
          ...
          case 4: {
           ...
           __t156 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t157, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur160; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur160, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t157 = __ur160;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t161;
           bool __ps_162 = (some___spec__bool_tur_adt_Option__int(__t157));
           ...
           { tur_adt_Option__int __rv = (__t161); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_164 = (go(__ps_163, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1305 = __ps_164;
            (void)r_1305;
            bool __ps_165 = (some___spec__bool_tur_adt_Option__int(r_1305));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_165) {
                int64_t __ps_166 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1305));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_166));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_168 = (go(__ps_167, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1306 = __ps_168;
            (void)s_1306;
            bool __ps_169 = (some___spec__bool_tur_adt_Option__int(s_1306));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_169) {
                int64_t __ps_170 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1306));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_170));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_174 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_174;
}
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_175 = (ctor_Option__int(false, ((int64_t)0)));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_175;
}
