         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t183, sizeof(tur_adt_Option__int)); __n184->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t183, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t183, sizeof(tur_adt_Option__int)); __n185->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 4: {
           ...
           __t182 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t183, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur186; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur186, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t183 = __ur186;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t187;
           __auto_type __ps_188 = (some___spec__bool_tur_adt_Option__int(__t183));
           ...
           { tur_adt_Option__int __rv = (__t187); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            __auto_type __ps_190 = (go(__ps_189, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1269 = __ps_190;
            (void)r_1269;
            __auto_type __ps_191 = (some___spec__bool_tur_adt_Option__int(r_1269));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_191) {
                __auto_type __ps_192 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1269));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_192));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_194 = (go(__ps_193, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1270 = __ps_194;
            (void)s_1270;
            __auto_type __ps_195 = (some___spec__bool_tur_adt_Option__int(s_1270));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_195) {
                __auto_type __ps_196 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1270));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_196));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_199 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_199;
}
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        __auto_type __ps_200 = (ctor_Option__int(false, (int64_t){0}));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_200;
}
