...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1333 = __ps_168;
            (void)r_1333;
            bool __ps_169 = (some___spec__bool_tur_adt_Option__int(r_1333));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_169) {
                int64_t __ps_170 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1333));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_170));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1334 = __ps_172;
            (void)s_1334;
            bool __ps_173 = (some___spec__bool_tur_adt_Option__int(s_1334));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_173) {
                int64_t __ps_174 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1334));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_174));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
