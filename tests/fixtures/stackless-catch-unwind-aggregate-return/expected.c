         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n162->aggr_mask = 0x9u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n162->saved[0] = (int64_t)(intptr_t)__ab; }
            __n162->saved[1] = (int64_t)(intptr_t)(n);
            __n162->saved[2] = (int64_t)(intptr_t)(__t160);
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t161, sizeof(tur_adt_Option__int)); __n162->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t161, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t161, sizeof(tur_adt_Option__int)); __n163->saved[3] = (int64_t)(intptr_t)__ab; }
           tur_adt_Option__int __ra163_0 = (acc);
          ...
          case 4: {
           ...
           __t160 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t161, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur164; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur164, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t161 = __ur164;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t165;
           bool __ps_166 = (some___spec__bool_tur_adt_Option__int(__t161));
           ...
           { tur_adt_Option__int __rv = (__t165); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_168 = (go(__ps_167, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1331 = __ps_168;
            (void)r_1331;
            bool __ps_169 = (some___spec__bool_tur_adt_Option__int(r_1331));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_169) {
                int64_t __ps_170 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1331));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_170));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_172 = (go(__ps_171, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1332 = __ps_172;
            (void)s_1332;
            bool __ps_173 = (some___spec__bool_tur_adt_Option__int(s_1332));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_173) {
                int64_t __ps_174 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1332));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_174));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_178 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_178;
}
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_179 = (ctor_Option__int(false, ((int64_t)0)));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_179;
}
