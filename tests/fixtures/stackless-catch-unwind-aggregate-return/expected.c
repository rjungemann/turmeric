...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1275 = __ps_182;
            (void)r_1275;
            __auto_type __ps_183 = (some___spec__bool_tur_adt_Option__int(r_1275));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_183) {
                __auto_type __ps_184 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1275));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_184));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1276 = __ps_186;
            (void)s_1276;
            __auto_type __ps_187 = (some___spec__bool_tur_adt_Option__int(s_1276));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_187) {
                __auto_type __ps_188 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1276));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_188));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
