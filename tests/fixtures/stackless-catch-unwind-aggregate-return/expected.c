...
static tur_adt_Option__int go(tur_adt_Option__int, int64_t);
...
static tur_adt_Option__int go(tur_adt_Option__int acc, int64_t n) {
        int64_t __t233 = 0;
        tur_adt_Option__int __t234 = {0};
        ...
        for (;;) {
         if (tur_panicking) {
          ...
          if (__k->tag == 0) {
           free(__k);
           if (tur_handler_chain) return (tur_adt_Option__int){0};
         ...
         switch (__pc) {
          case 0: { void *__rb = (void*)(intptr_t)__v; tur_adt_Option__int __rr; memcpy(&__rr, __rb, sizeof(tur_adt_Option__int)); free(__rb); free(__k); return __rr; }
          case 1: {
           if ((n) == (INT64_C(0))) {
            { tur_adt_Option__int __rv = (acc); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
            __pc = __k->tag; break;
           } else {
            ...
            __n235->aggr_mask = 0x9u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n235->saved[0] = (int64_t)(intptr_t)__ab; }
            __n235->saved[1] = (int64_t)(intptr_t)(n);
            __n235->saved[2] = (int64_t)(intptr_t)(__t233);
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t234, sizeof(tur_adt_Option__int)); __n235->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t234, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           (void)(__box235);
           tur_cont *__n236 = (tur_cont*)malloc(sizeof(tur_cont));
           __n236->tag = 4; __n236->boundary = 0; __n236->next = __k;
           __n236->aggr_mask = 0x9u;
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n236->saved[0] = (int64_t)(intptr_t)__ab; }
           __n236->saved[1] = (int64_t)(intptr_t)(n);
           __n236->saved[2] = (int64_t)(intptr_t)(__t233);
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t234, sizeof(tur_adt_Option__int)); __n236->saved[3] = (int64_t)(intptr_t)__ab; }
           tur_adt_Option__int __ra236_0 = (acc);
           int64_t __ra236_1 = ((n) - (INT64_C(1)));
           acc = __ra236_0;
           n = __ra236_1;
           __k = __n236; __pc = 1; break;
          }
          case 4: {
           { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           n = (int64_t)(intptr_t)(__k->saved[1]);
           __t233 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t234, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur237; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur237, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t234 = __ur237;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t238;
           bool __ps_239 = (some___spec__bool_tur_adt_Option__int(__t234));
           ...
           { tur_adt_Option__int __rv = (__t238); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Option__int __ps_240 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_241 = (go(__ps_240, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1468 = __ps_241;
            (void)r_1468;
            bool __ps_242 = (some___spec__bool_tur_adt_Option__int(r_1468));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_242) {
                int64_t __ps_243 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1468));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_243));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_245 = (go(__ps_244, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1469 = __ps_245;
            (void)s_1469;
            bool __ps_246 = (some___spec__bool_tur_adt_Option__int(s_1469));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_246) {
                int64_t __ps_247 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1469));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_247));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_252 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_252;
}
...
static int64_t unwrap__spec__int64_t_tur_adt_Option__int(tur_adt_Option__int o) {
        int64_t __t253 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_913 = (int64_t)__scrut->as.Some._0;
                __t253 = v_913;
                break;
            }
            case 0: {
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_254 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_254;
}
