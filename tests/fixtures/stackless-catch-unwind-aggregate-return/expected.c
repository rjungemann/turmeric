...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1626 = __ps_180;
            (void)r_1626;
            bool __ps_181 = (some___spec__bool_tur_adt_Option__int(r_1626));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_181) {
                int64_t __ps_182 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1626));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_182));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1627 = __ps_184;
            (void)s_1627;
            bool __ps_185 = (some___spec__bool_tur_adt_Option__int(s_1627));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_185) {
                int64_t __ps_186 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1627));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_186));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static int64_t unwrap__spec__int64_t_tur_adt_Option__int(tur_adt_Option__int o) {
        int64_t __t190 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_1069 = (int64_t)__scrut->as.Some._0;
                __t190 = v_1069;
                break;
            }
            case 0: {
