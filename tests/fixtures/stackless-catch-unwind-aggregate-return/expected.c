         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n174->saved[2] = (int64_t)(intptr_t)(__t172);
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t173, sizeof(tur_adt_Option__int)); __n174->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t173, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           __n175->tag = 4; __n175->boundary = 0; __n175->next = __k;
           __n175->aggr_mask = 0x9u;
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n175->saved[0] = (int64_t)(intptr_t)__ab; }
           __n175->saved[1] = (int64_t)(intptr_t)(n);
           __n175->saved[2] = (int64_t)(intptr_t)(__t172);
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t173, sizeof(tur_adt_Option__int)); __n175->saved[3] = (int64_t)(intptr_t)__ab; }
           tur_adt_Option__int __ra175_0 = (acc);
           int64_t __ra175_1 = ((n) - (INT64_C(1)));
           acc = __ra175_0;
           n = __ra175_1;
           __k = __n175; __pc = 1; break;
          }
          case 4: {
           { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&acc, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           n = (int64_t)(intptr_t)(__k->saved[1]);
           __t172 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t173, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur176; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur176, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t173 = __ur176;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t177;
           bool __ps_178 = (some___spec__bool_tur_adt_Option__int(__t173));
           ...
           { tur_adt_Option__int __rv = (__t177); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Option__int __ps_179 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_180 = (go(__ps_179, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1624 = __ps_180;
            (void)r_1624;
            bool __ps_181 = (some___spec__bool_tur_adt_Option__int(r_1624));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_181) {
                int64_t __ps_182 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1624));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_182));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_184 = (go(__ps_183, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1625 = __ps_184;
            (void)s_1625;
            bool __ps_185 = (some___spec__bool_tur_adt_Option__int(s_1625));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_185) {
                int64_t __ps_186 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1625));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_186));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static int64_t unwrap__spec__int64_t_tur_adt_Option__int(tur_adt_Option__int o) {
        int64_t __t190 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_1068 = (int64_t)__scrut->as.Some._0;
                __t190 = v_1068;
                break;
            }
            case 0: {
