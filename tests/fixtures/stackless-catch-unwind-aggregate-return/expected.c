...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1286 = __ps_164;
            (void)r_1286;
            __auto_type __ps_165 = (some___spec__bool_tur_adt_Option__int(r_1286));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_165) {
                __auto_type __ps_166 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1286));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_166));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1287 = __ps_168;
            (void)s_1287;
            __auto_type __ps_169 = (some___spec__bool_tur_adt_Option__int(s_1287));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_169) {
                __auto_type __ps_170 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1287));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_170));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
