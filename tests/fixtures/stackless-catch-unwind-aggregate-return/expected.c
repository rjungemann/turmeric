         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n247->aggr_mask = 0x9u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n247->saved[0] = (int64_t)(intptr_t)__ab; }
            __n247->saved[1] = (int64_t)(intptr_t)(n);
            __n247->saved[2] = (int64_t)(intptr_t)(__t245);
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t246, sizeof(tur_adt_Option__int)); __n247->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t246, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           __n248->saved[2] = (int64_t)(intptr_t)(__t245);
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t246, sizeof(tur_adt_Option__int)); __n248->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 4: {
           ...
           __t245 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t246, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur249; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur249, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t246 = __ur249;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t250;
           bool __ps_251 = (some___spec__bool_tur_adt_Option__int(__t246));
           ...
           { tur_adt_Option__int __rv = (__t250); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Option__int __ps_252 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(7)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_253 = (go(__ps_252, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1472 = __ps_253;
            (void)r_1472;
            bool __ps_254 = (some___spec__bool_tur_adt_Option__int(r_1472));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_254) {
                int64_t __ps_255 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1472));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_255));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_257 = (go(__ps_256, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1473 = __ps_257;
            (void)s_1473;
            bool __ps_258 = (some___spec__bool_tur_adt_Option__int(s_1473));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_258) {
                int64_t __ps_259 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1473));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_259));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_264 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_264;
}
...
static int64_t unwrap__spec__int64_t_tur_adt_Option__int(tur_adt_Option__int o) {
        int64_t __t265 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_925 = (int64_t)__scrut->as.Some._0;
                __t265 = v_925;
                break;
            }
            case 0: {
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_266 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_266;
}
