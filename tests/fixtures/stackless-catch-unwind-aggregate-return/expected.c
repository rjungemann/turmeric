         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t179, sizeof(tur_adt_Option__int)); __n180->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t179, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           __n181->aggr_mask = 0x9u;
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n181->saved[0] = (int64_t)(intptr_t)__ab; }
           __n181->saved[1] = (int64_t)(intptr_t)(n);
           __n181->saved[2] = (int64_t)(intptr_t)(__t178);
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t179, sizeof(tur_adt_Option__int)); __n181->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 4: {
           ...
           __t178 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t179, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur182; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur182, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t179 = __ur182;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t183;
           __auto_type __ps_184 = (some___spec__bool_tur_adt_Option__int(__t179));
           ...
           { tur_adt_Option__int __rv = (__t183); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            __auto_type __ps_186 = (go(__ps_185, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1272 = __ps_186;
            (void)r_1272;
            __auto_type __ps_187 = (some___spec__bool_tur_adt_Option__int(r_1272));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_187) {
                __auto_type __ps_188 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1272));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_188));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_190 = (go(__ps_189, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1273 = __ps_190;
            (void)s_1273;
            __auto_type __ps_191 = (some___spec__bool_tur_adt_Option__int(s_1273));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_191) {
                __auto_type __ps_192 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1273));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_192));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
