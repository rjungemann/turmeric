         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n171->aggr_mask = 0x9u;
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n171->saved[0] = (int64_t)(intptr_t)__ab; }
            __n171->saved[1] = (int64_t)(intptr_t)(n);
            __n171->saved[2] = (int64_t)(intptr_t)(__t169);
            { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t170, sizeof(tur_adt_Option__int)); __n171->saved[3] = (int64_t)(intptr_t)__ab; }
          ...
          case 3: {
           ...
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t170, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           ...
           __n172->aggr_mask = 0x9u;
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &acc, sizeof(tur_adt_Option__int)); __n172->saved[0] = (int64_t)(intptr_t)__ab; }
           __n172->saved[1] = (int64_t)(intptr_t)(n);
           __n172->saved[2] = (int64_t)(intptr_t)(__t169);
           { void *__ab = malloc(sizeof(tur_adt_Option__int)); memcpy(__ab, &__t170, sizeof(tur_adt_Option__int)); __n172->saved[3] = (int64_t)(intptr_t)__ab; }
           tur_adt_Option__int __ra172_0 = (acc);
           int64_t __ra172_1 = ((n) - (INT64_C(1)));
           acc = __ra172_0;
           n = __ra172_1;
          ...
          case 4: {
           ...
           __t169 = (int64_t)(intptr_t)(__k->saved[2]);
           { void *__ab = (void*)(intptr_t)__k->saved[3]; memcpy(&__t170, __ab, sizeof(tur_adt_Option__int)); free(__ab); }
           tur_adt_Option__int __ur173; { void *__rb = (void*)(intptr_t)__v; memcpy(&__ur173, __rb, sizeof(tur_adt_Option__int)); free(__rb); }
           __t170 = __ur173;
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           tur_adt_Option__int __t174;
           bool __ps_175 = (some___spec__bool_tur_adt_Option__int(__t170));
           ...
           { tur_adt_Option__int __rv = (__t174); void *__rb = malloc(sizeof(tur_adt_Option__int)); memcpy(__rb, &__rv, sizeof(tur_adt_Option__int)); __v = (int64_t)(intptr_t)__rb; }
           __pc = __k->tag; break;
          }
         }
        }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_177 = (go(__ps_176, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1437 = __ps_177;
            (void)r_1437;
            bool __ps_178 = (some___spec__bool_tur_adt_Option__int(r_1437));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_178) {
                int64_t __ps_179 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1437));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_179));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_181 = (go(__ps_180, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1438 = __ps_181;
            (void)s_1438;
            bool __ps_182 = (some___spec__bool_tur_adt_Option__int(s_1438));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_182) {
                int64_t __ps_183 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1438));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_183));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_188 = (ctor_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_188;
}
...
static int64_t unwrap__spec__int64_t_tur_adt_Option__int(tur_adt_Option__int o) {
        int64_t __t189 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_886 = (int64_t)__scrut->as.Some._0;
                __t189 = v_886;
                break;
            }
            case 0: {
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_190 = (ctor_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_190;
}
