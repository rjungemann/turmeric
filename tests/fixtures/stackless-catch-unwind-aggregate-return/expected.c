        ...
        for (;;) {
         ...
         switch (__pc) {
          ...
          case 4: {
           ...
           bool __ps_180 = (some___spec__bool_tur_adt_Option__int(__t175));
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_182 = (go(__ps_181, INT64_C(200000)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int r_1611 = __ps_182;
            (void)r_1611;
            bool __ps_183 = (some___spec__bool_tur_adt_Option__int(r_1611));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_183) {
                int64_t __ps_184 = (unwrap__spec__int64_t_tur_adt_Option__int(r_1611));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_184));
            } else {
                printf("%lld\n", (long long)(INT64_C(-1)));
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int __ps_186 = (go(__ps_185, INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__int s_1612 = __ps_186;
            (void)s_1612;
            bool __ps_187 = (some___spec__bool_tur_adt_Option__int(s_1612));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_187) {
                int64_t __ps_188 = (unwrap__spec__int64_t_tur_adt_Option__int(s_1612));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                printf("%lld\n", (long long)(__ps_188));
            } else {
                printf("%lld\n", (long long)(INT64_C(-2)));
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_193 = (ctor_Option_Some__int(x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_193;
}
