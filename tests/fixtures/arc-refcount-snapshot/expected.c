...
static void * arc_hynew(int64_t);
static void * arc_hyclone(void *);
static int64_t arc_hyget(void *);
static void arc_hydrop(void *);
...
static void * arc_hynew(int64_t val) {
...
static void * arc_hyclone(void * p) {
        typedef struct { uint64_t strong; uint64_t weak; int64_t value; } ArcCell;
  ArcCell *b = (ArcCell *)p;
...
static int64_t arc_hyget(void * p) {
        typedef struct { uint64_t strong; uint64_t weak; int64_t value; } ArcCell;
  return (int64_t)((ArcCell *)p)->value;
  
}

static void arc_hydrop(void * p) {
        typedef struct { uint64_t strong; uint64_t weak; int64_t value; } ArcCell;
  ArcCell *b = (ArcCell *)p;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            __auto_type __ps_173 = (arc_hynew(INT64_C(42)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * a_1287 = __ps_173;
            (void)a_1287;
            {
                __auto_type __ps_174 = (arc_hyclone((void *)(intptr_t)(a_1287)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                void * b_1288 = __ps_174;
                (void)b_1288;
                arc_hydrop((void *)(intptr_t)(b_1288));
            }
            arc_hydrop((void *)(intptr_t)(a_1287));
        }
        int64_t __t175;
        __t175 = INT64_C(0);
        return (int)__t175;
