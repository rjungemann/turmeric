...
int main(int argc, char **argv) {
        ...
        {
            __auto_type __ps_181 = (mutex_hynew());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * m_1276 = __ps_181;
            (void)m_1276;
            mutex_hylock((void *)(intptr_t)(m_1276));
            mutex_hyunlock((void *)(intptr_t)(m_1276));
            mutex_hyfree((void *)(intptr_t)(m_1276));
        }
        int64_t __t182;
        __t182 = INT64_C(0);
        return (int)__t182;
