...
int main(int argc, char **argv) {
        ...
        {
            __auto_type __ps_177 = (mutex_hynew());
            /* panic-return-signal: ret ctype unknown; no propagation here */
            void * m_1274 = __ps_177;
            (void)m_1274;
            mutex_hylock((void *)(intptr_t)(m_1274));
            mutex_hyunlock((void *)(intptr_t)(m_1274));
            mutex_hyfree((void *)(intptr_t)(m_1274));
        }
        int64_t __t178;
        __t178 = INT64_C(0);
        return (int)__t178;
