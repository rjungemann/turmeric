...
static bool __fn_543(int64_t, int64_t);
...
static void run_with_handler(tur_handler_t, tur_handler_t);
...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_436));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_456));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_483));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_503), (int64_t)(intptr_t)(__fn_507));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_523), (int64_t)(intptr_t)(__fn_527));
}
...
static bool __fn_543(int64_t a, int64_t b) {
        return ((a) == (b));
}

static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_543));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_614));
}
...
static void run_with_handler(tur_handler_t h1, tur_handler_t h2) {
}

static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_1(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * s_619 = (const char *)__effect_args[0];
    int64_t k_620 = __k;
    puts(s_619);
    int64_t __t2;
    int64_t __t3 = tur_effect_cont_resume((int64_t)(intptr_t)k_620, (int64_t)0);
    __t2 = __t3;
    return (int64_t)__t2;
}
...
static void __handle_body_0(void) {
    int64_t __t4[1];
    __t4[0] = (int64_t)"hello";
    tur_effect_perform("Write", __t4, 1);
    int64_t __t5;
    __t5 = INT64_C(0);
    tur_current_fiber->result = (int64_t)__t5;
}
