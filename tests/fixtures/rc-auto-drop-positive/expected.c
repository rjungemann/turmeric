...
struct __defer_env_59 {RcControlBlock * x; };
...
static Cons__int * tcons__spec__Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        Cons__int *__t63 = (Cons__int *)malloc(sizeof(Cons__int));
        *__t63 = (Cons__int){.head = h, .tail = t};
        return __t63;
}
