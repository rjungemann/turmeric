...
static void __handle_body_3(void) {
    tur_current_fiber->result = (int64_t)safe_divide(INT64_C(42), INT64_C(6));
}
...
static int64_t __effect_handler_7(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_622 = (const char *)__effect_args[0];
    int64_t k_623 = __k;
    tur_panic(msg_622);
    return 0; /* unreachable */
}
...
static void __handle_body_6(void) {
    tur_current_fiber->result = (int64_t)safe_divide(INT64_C(100), INT64_C(4));
}
...
int main() {
        ...
        }
        {
            ...
            __eff_frame_6.cases[0].effect_name = "Abort";
