...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(42);
            ...
            __t2->value = __t1;
            RcControlBlock * x_261 = __t2;
            (void)x_261;
            /* rc-elision: skipped rc_strong_increment(x_261) — last-use clone */
            RcControlBlock * c_262 = x_261;
            (void)c_262;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            /* rc-elision: skipped rc_strong_decrement(c_262) — matched elided clone */
            int64_t __t4 = rc_strong_count(x_261);
            printf("%lld\n", (long long)(__t4));
            struct __defer_env_5 __t7 = {.x = x_261};
