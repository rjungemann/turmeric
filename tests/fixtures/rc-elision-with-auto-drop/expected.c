...
int main() {
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(42);
            ...
            __t2->value = __t1;
            RcControlBlock * x_196 = __t2;
            (void)x_196;
            /* rc-elision: skipped rc_strong_increment(x_196) — last-use clone */
            RcControlBlock * c_197 = x_196;
            (void)c_197;
            tur_frame __frame_3;
            tur_frame_init(&__frame_3, NULL);
            /* rc-elision: skipped rc_strong_decrement(c_197) — matched elided clone */
            int64_t __t4 = rc_strong_count(x_196);
            printf("%lld\n", (long long)(__t4));
            struct __defer_env_5 __t7 = {.x = x_196};
