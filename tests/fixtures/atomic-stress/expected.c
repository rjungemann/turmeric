...
int main() {
        {
            void * counter_215 = atomic_new(INT64_C(0));
            (void)counter_215;
            {
                void * handles_216 = as_spawn_all((void *)(intptr_t)(as_worker), (void *)(intptr_t)(counter_215), INT64_C(100), INT64_C(100));
                (void)handles_216;
                as_join_all((void *)(intptr_t)(handles_216), INT64_C(100));
            }
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(counter_215))));
            atomic_free((void *)(intptr_t)(counter_215));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
