...
int main() {
        {
            void * counter_227 = atomic_new(INT64_C(0));
            (void)counter_227;
            {
                void * handles_228 = as_spawn_all((void *)(intptr_t)(as_worker), (void *)(intptr_t)(counter_227), INT64_C(100), INT64_C(100));
                (void)handles_228;
                as_join_all((void *)(intptr_t)(handles_228), INT64_C(100));
            }
            printf("%lld\n", (long long)(atomic_load((void *)(intptr_t)(counter_227))));
            atomic_free((void *)(intptr_t)(counter_227));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
