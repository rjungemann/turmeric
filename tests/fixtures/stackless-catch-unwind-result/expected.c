...
struct __env_1623 { tur_thunk_int64_t_t __fn; int64_t n; };
...
static int64_t __fn_1621(void * __env_p_1624) {
        ...
        return f((__env___env_1623->n) - (INT64_C(1)));
}
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                (void)t2_1293;
                bool __t100;
                bool __ps_101 = (tnil_qu(t1_1292));
                if (tur_panicking) return ((bool)0);
                if (__ps_101) {
                    bool __ps_102 = (tnil_qu(t2_1293));
                    if (tur_panicking) return ((bool)0);
                    __t100 = __ps_102;
                } else {
                    bool __t103;
                    bool __ps_104 = (tnil_qu(t2_1293));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_104) {
                        __t103 = false;
                    } else {
                        bool __ps_105 = (cons_hyeq_hygo(t1_1292, t2_1293));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_105;
                    }
                    __t100 = __t103;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_107) {
            ...
            int64_t __t108;
            {
                ...
                int64_t out_1301 = (int64_t)(intptr_t)(__ps_113);
                (void)out_1301;
                __t108 = out_1301;
            }
            __t106 = __t108;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                int64_t out_1308 = (int64_t)(intptr_t)(__ps_120);
                (void)out_1308;
                __t116 = out_1308;
            }
            __t114 = __t116;
        ...
        if (__ps_121) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1379 = __ps_122;
                (void)h_1379;
                void * __ps_123 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1380 = __ps_123;
                (void)k_1380;
                bool __ps_124 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1379, (void *)(intptr_t)(k_1380), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_124) {
                    void * __t125 = iter;
                    void * __t126 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t128;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1383 = __ps_130;
            (void)iter_1383;
            void * __ps_131 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_132 = (hamt_slkeyeq((void *)(intptr_t)(__ps_131)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1384 = __ps_132;
            (void)keyeq_1384;
            void * __ps_133 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_134 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1383), (void *)(intptr_t)(__ps_133), (void *)(intptr_t)(keyeq_1384)));
            if (tur_panicking) return ((bool)0);
            bool result_1385 = __ps_134;
            (void)result_1385;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t155;
        {
            ...
            {
                tur_adt_Vec__int * __ps_157 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1515));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1516 = __ps_157;
                (void)_un_unv_1516;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1566 = __ps_160;
            (void)r_1566;
            bool __ps_161 = (schema_hydecode_hyok_qu(r_1566));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_161) {
                return schema_hydecode_hyvalue(r_1566);
            } else {
                int64_t __ps_162 = (schema_hydecode_hyerrors(r_1566));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t164;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1617 = __ps_165;
            (void)m_1617;
            tur_frame __frame_166;
            tur_frame_init(&__frame_166, NULL);
            struct __defer_env_167 __t169 = {.m = m_1617};
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n179->saved[1] = (int64_t)(intptr_t)(r_1626);
          ...
          case 3: {
           ...
           r_1626 = (int64_t)(intptr_t)(__k->saved[1]);
           ...
           tur_result_box_free((int64_t)(intptr_t)r_1626);
