...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_815 = __ps_73;
        bool __ps_74 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_814, (void *)(intptr_t)(k_815), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_74;
        if (__t1) {
        ...
        if (__ps_128) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1186 = __ps_129;
                (void)h_1186;
                void * __ps_130 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1187 = __ps_130;
                (void)k_1187;
                bool __ps_131 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1186, (void *)(intptr_t)(k_1187), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_131) {
                    void * __t132 = iter;
                    void * __t133 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t135;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_137;
            (void)iter_1190;
            void * __ps_138 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_139 = (hamt_slkeyeq((void *)(intptr_t)(__ps_138)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_139;
            (void)keyeq_1191;
            void * __ps_140 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_141 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_140), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_141;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t162;
        {
            ...
            {
                tur_adt_Vec__int * __ps_164 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_164;
                (void)_un_unv_1320;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t168;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_169;
            (void)r_1370;
            int64_t __t170;
            bool __ps_171 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_171) {
                int64_t __ps_172 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t170 = __ps_172;
            } else {
                int64_t __ps_173 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n187->saved[1] = (int64_t)(intptr_t)(r_1439);
