...
static int64_t __fn_1434(void * __env_p_1437) {
        ...
        int64_t __ps_40 = (f((__env___env_1436->n) - (INT64_C(1))));
        ...
        if (__ps_100) {
            bool __t101;
            {
                ...
                if ((t1_1099) == (INT64_C(0))) {
                    __t102 = (t2_1100) == (INT64_C(0));
                } else {
                    bool __t103;
                    if ((t2_1100) == (INT64_C(0))) {
                        __t103 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1099, t2_1100));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_104;
                    }
                    __t102 = __t103;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_106) {
            ...
            int64_t __t107;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_111 = (_un_uncons_hyfmap(__ps_110, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_112 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_109, __ps_111));
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1108 = (int64_t)(intptr_t)(__ps_112);
                (void)out_1108;
                __t107 = out_1108;
            }
            __t105 = __t107;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1115 = (int64_t)(intptr_t)(__ps_119);
                (void)out_1115;
                __t115 = out_1115;
            }
            __t113 = __t115;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t124;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_126;
            (void)iter_1190;
            void * __ps_127 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_128 = (hamt_slkeyeq((void *)(intptr_t)(__ps_127)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_128;
            (void)keyeq_1191;
            void * __ps_129 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_130 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_129), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_130;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t151;
        {
            ...
            {
                tur_adt_Vec__int * __ps_153 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_153;
                (void)_un_unv_1320;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t157;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_158;
            (void)r_1370;
            int64_t __t159;
            bool __ps_160 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_160) {
                int64_t __ps_161 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t159 = __ps_161;
            } else {
                int64_t __ps_162 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n176->saved[1] = (int64_t)(intptr_t)(r_1439);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_180 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_180));
        int64_t __t181;
        __t181 = INT64_C(0);
