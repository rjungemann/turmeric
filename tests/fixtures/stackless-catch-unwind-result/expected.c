...
static int64_t __fn_1438(void * __env_p_1441) {
        ...
        int64_t __ps_40 = (f((__env___env_1440->n) - (INT64_C(1))));
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                int64_t out_1110 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1110;
                __t111 = out_1110;
            }
            __t109 = __t111;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_118) {
            ...
            int64_t __t119;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_123), sizeof(__ps_123));
                int64_t out_1117 = (int64_t)(intptr_t)(__ps_123);
                (void)out_1117;
                __t119 = out_1117;
            }
            __t117 = __t119;
        ...
        if (__ps_128) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1188 = __ps_129;
                (void)h_1188;
                void * __ps_130 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1189 = __ps_130;
                (void)k_1189;
                bool __ps_131 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1188, (void *)(intptr_t)(k_1189), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_131) {
                    void * __t132 = iter;
                    void * __t133 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t135;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_137;
            (void)iter_1192;
            void * __ps_138 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_139 = (hamt_slkeyeq((void *)(intptr_t)(__ps_138)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_139;
            (void)keyeq_1193;
            void * __ps_140 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_141 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_140), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_141;
            (void)result_1194;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t162;
        {
            ...
            {
                tur_adt_Vec__int * __ps_164 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1322));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1323 = __ps_164;
                (void)_un_unv_1323;
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_167 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_167);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t168;
        {
            int64_t __ps_169 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1373 = __ps_169;
            (void)r_1373;
            int64_t __t170;
            bool __ps_171 = (schema_hydecode_hyok_qu(r_1373));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_171) {
                int64_t __ps_172 = (schema_hydecode_hyvalue(r_1373));
                if (tur_panicking) return ((int64_t)0);
                __t170 = __ps_172;
            } else {
                int64_t __ps_173 = (schema_hydecode_hyerrors(r_1373));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_174 = (schema_hydecode_hyabort(__ps_173));
                if (tur_panicking) return ((int64_t)0);
                __t170 = __ps_174;
            }
            __t168 = __t170;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n188->aggr_mask = 0x0u;
            __n188->saved[0] = (int64_t)(intptr_t)(n);
            __n188->saved[1] = (int64_t)(intptr_t)(r_1443);
            __n188->saved[2] = (int64_t)(intptr_t)(__t186);
            __n188->saved[3] = (int64_t)(intptr_t)(__t187);
          ...
          case 3: {
           ...
           __t186 = (int64_t)(intptr_t)(__k->saved[2]);
           __t187 = (int64_t)(intptr_t)(__k->saved[3]);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_192 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_192));
        int64_t __t193;
        __t193 = INT64_C(0);
