...
struct __env_1440 { tur_thunk_int64_t_t __fn; int64_t n; };
...
static int64_t __fn_1438(void * __env_p_1441) {
        ...
        int64_t __ps_42 = (f((__env___env_1440->n) - (INT64_C(1))));
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                if ((t1_1101) == (INT64_C(0))) {
                    __t108 = (t2_1102) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_1102) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        bool __ps_110 = (cons_hyeq_hygo(t1_1101, t2_1102));
                        if (tur_panicking) return ((bool)0);
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_112) {
            ...
            int64_t __t113;
            {
                int64_t __ps_114 = (list_hyhead(cell));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_115 = ((*( tur_thunk_int64_t_int64_t_t *)(f))(f, __ps_114));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_116 = (list_hytail(cell));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_117 = (_un_uncons_hyfmap(__ps_116, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_118 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_115, __ps_117));
                if (tur_panicking) return ((int64_t)0);
                __auto_type __t119 = (__ps_118);
                TUR_REGION_NOTE_WORDS(&(__t119), sizeof(__t119));
                int64_t out_1110 = (int64_t)(intptr_t)(__t119);
                (void)out_1110;
                __t113 = out_1110;
            }
            __t111 = __t113;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_121) {
            ...
            int64_t __t122;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_125 = (list_hyconcat(__ps_124, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_126 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_123, __ps_125));
                if (tur_panicking) return ((int64_t)0);
                __auto_type __t127 = (__ps_126);
                TUR_REGION_NOTE_WORDS(&(__t127), sizeof(__t127));
                int64_t out_1117 = (int64_t)(intptr_t)(__t127);
                (void)out_1117;
                __t122 = out_1117;
            }
            __t120 = __t122;
...
static int64_t car(int64_t l) {
        int64_t __ps_128 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_128;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_129 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_129;
}

static bool null_qu(int64_t l) {
        bool __ps_130 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_130;
}

static int64_t length(int64_t l) {
        int64_t __ps_131 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_131;
}
        ...
        if (__ps_132) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1188 = __ps_133;
                (void)h_1188;
                void * __ps_134 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1189 = __ps_134;
                (void)k_1189;
                bool __ps_135 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1188, (void *)(intptr_t)(k_1189), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_135) {
                    void * __t136 = iter;
                    void * __t137 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t139;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1192 = __ps_141;
            (void)iter_1192;
            void * __ps_142 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_143 = (hamt_slkeyeq((void *)(intptr_t)(__ps_142)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1193 = __ps_143;
            (void)keyeq_1193;
            void * __ps_144 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_145 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1192), (void *)(intptr_t)(__ps_144), (void *)(intptr_t)(keyeq_1193)));
            if (tur_panicking) return ((bool)0);
            bool result_1194 = __ps_145;
            (void)result_1194;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t166;
        {
            ...
            {
                tur_adt_Vec__int * __ps_168 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1322));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1323 = __ps_168;
                (void)_un_unv_1323;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t172;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1373 = __ps_173;
            (void)r_1373;
            int64_t __t174;
            bool __ps_175 = (schema_hydecode_hyok_qu(r_1373));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_175) {
                int64_t __ps_176 = (schema_hydecode_hyvalue(r_1373));
                if (tur_panicking) return ((int64_t)0);
                __t174 = __ps_176;
            } else {
                int64_t __ps_177 = (schema_hydecode_hyerrors(r_1373));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t180;
        {
            int64_t __ps_181 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1432 = __ps_181;
            (void)m_1432;
            int64_t __ps_182 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1433 = __ps_182;
            (void)r_1433;
            bool __ps_183 = (bt_hyundo_hyto_ex(m_1432));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_183);
            int64_t __t184;
            __t184 = r_1433;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            tur_handler_node *__b192 = (tur_handler_node*)malloc(sizeof(tur_handler_node));
            __b192->parent = tur_handler_chain; tur_handler_chain = __b192;
            tur_cont *__n192 = (tur_cont*)malloc(sizeof(tur_cont));
            __n192->tag = 3; __n192->boundary = __b192; __n192->next = __k;
            __n192->aggr_mask = 0x0u;
            __n192->saved[0] = (int64_t)(intptr_t)(n);
            __n192->saved[1] = (int64_t)(intptr_t)(r_1443);
            __n192->saved[2] = (int64_t)(intptr_t)(__t190);
            __n192->saved[3] = (int64_t)(intptr_t)(__t191);
            __k = __n192; __pc = 2; break;
           }
          }
          case 2: {
           int64_t __ra193_0 = ((n) - (INT64_C(1)));
           n = __ra193_0;
           __pc = 1; break;
          }
          case 3: {
           n = (int64_t)(intptr_t)(__k->saved[0]);
           r_1443 = (int64_t)(intptr_t)(__k->saved[1]);
           __t190 = (int64_t)(intptr_t)(__k->saved[2]);
           __t191 = (int64_t)(intptr_t)(__k->saved[3]);
           tur_handler_chain = __k->boundary->parent; free(__k->boundary);
           int64_t __box192;
           if (tur_panicking) { tur_panicking = 0; tur_panic_in_progress = 0; tur_panic_payload *__pp192 = global_panic_payload; global_panic_payload = 0; __box192 = tur_box_err((int64_t)(intptr_t)__pp192); }
           else { __box192 = tur_box_ok(__v); }
           { tur_cont *__pk = __k->next; free(__k); __k = __pk; }
           r_1443 = __box192;
           int64_t __t194;
           bool __ps_195 = (ok_qu(r_1443));
           if (tur_panicking) return ((int64_t)0);
           if (__ps_195) {
               __t194 = n;
           } else {
           ...
           tur_result_box_free((int64_t)(intptr_t)r_1443);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_196 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_196));
        int64_t __t197;
        __t197 = INT64_C(0);
