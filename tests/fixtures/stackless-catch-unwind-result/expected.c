...
struct __env_1467 { tur_thunk_int64_t_t __fn; int64_t n; };
...
static int64_t __fn_1465(void * __env_p_1468) {
        struct __env_1467 *__env___env_1467 = (struct __env_1467 *)__env_p_1468;
        int64_t __ps_92 = (f((__env___env_1467->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_92;
}
        ...
        if (__ps_156) {
            bool __t157;
            {
                ...
                if ((t1_1126) == (INT64_C(0))) {
                    __t158 = (t2_1127) == (INT64_C(0));
                } else {
                    bool __t159;
                    if ((t2_1127) == (INT64_C(0))) {
                        __t159 = false;
                    } else {
                        bool __ps_160 = (cons_hyeq_hygo(t1_1126, t2_1127));
                        if (tur_panicking) return ((bool)0);
                        __t159 = __ps_160;
                    }
                    __t158 = __t159;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_162) {
            ...
            int64_t __t163;
            {
                int64_t __ps_164 = (list_hyhead(cell));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_165 = ((*( tur_thunk_int64_t_int64_t_t *)(f))(f, __ps_164));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_166 = (list_hytail(cell));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_167 = (_un_uncons_hyfmap(__ps_166, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                ...
                int64_t out_1135 = (int64_t)(intptr_t)(__ps_168);
                (void)out_1135;
                __t163 = out_1135;
            }
            __t161 = __t163;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_170) {
            ...
            int64_t __t171;
            {
                int64_t __ps_172 = (list_hyhead(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_173 = (list_hytail(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_174 = (list_hyconcat(__ps_173, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_175 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_172, __ps_174));
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_175), sizeof(__ps_175));
                int64_t out_1142 = (int64_t)(intptr_t)(__ps_175);
                (void)out_1142;
                __t171 = out_1142;
            }
            __t169 = __t171;
...
static int64_t car(int64_t l) {
        int64_t __ps_176 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_176;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_177 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_177;
}

static bool null_qu(int64_t l) {
        bool __ps_178 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_178;
}

static int64_t length(int64_t l) {
        int64_t __ps_179 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_179;
}
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        __tur_tailcall:;
        bool __ps_180 = (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter)));
        if (tur_panicking) return ((bool)0);
        if (__ps_180) {
            {
                int64_t __ps_181 = (hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                int64_t h_1213 = __ps_181;
                (void)h_1213;
                void * __ps_182 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1214 = __ps_182;
                (void)k_1214;
                bool __ps_183 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1213, (void *)(intptr_t)(k_1214), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_183) {
                    void * __t184 = iter;
                    void * __t185 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t187;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1217 = __ps_189;
            (void)iter_1217;
            void * __ps_190 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_191 = (hamt_slkeyeq((void *)(intptr_t)(__ps_190)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1218 = __ps_191;
            (void)keyeq_1218;
            void * __ps_192 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_193 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1217), (void *)(intptr_t)(__ps_192), (void *)(intptr_t)(keyeq_1218)));
            if (tur_panicking) return ((bool)0);
            bool result_1219 = __ps_193;
            (void)result_1219;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t214;
        {
            ...
            {
                tur_adt_Vec__int * __ps_216 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1349));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1350 = __ps_216;
                (void)_un_unv_1350;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t220;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1400 = __ps_221;
            (void)r_1400;
            int64_t __t222;
            bool __ps_223 = (schema_hydecode_hyok_qu(r_1400));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_223) {
                int64_t __ps_224 = (schema_hydecode_hyvalue(r_1400));
                if (tur_panicking) return ((int64_t)0);
                __t222 = __ps_224;
            } else {
                int64_t __ps_225 = (schema_hydecode_hyerrors(r_1400));
                if (tur_panicking) return ((int64_t)0);
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n240->tag = 3; __n240->boundary = __b240; __n240->next = __k;
            __n240->aggr_mask = 0x0u;
            __n240->saved[0] = (int64_t)(intptr_t)(n);
            __n240->saved[1] = (int64_t)(intptr_t)(r_1470);
            __n240->saved[2] = (int64_t)(intptr_t)(__t238);
            __n240->saved[3] = (int64_t)(intptr_t)(__t239);
            __k = __n240; __pc = 2; break;
           }
          }
          case 2: {
           int64_t __ra241_0 = ((n) - (INT64_C(1)));
           n = __ra241_0;
           __pc = 1; break;
          }
          case 3: {
           n = (int64_t)(intptr_t)(__k->saved[0]);
           r_1470 = (int64_t)(intptr_t)(__k->saved[1]);
           __t238 = (int64_t)(intptr_t)(__k->saved[2]);
           __t239 = (int64_t)(intptr_t)(__k->saved[3]);
           ...
           tur_result_box_free((int64_t)(intptr_t)r_1470);
           __v = (int64_t)(intptr_t)(__t242); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_244 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_244));
        int64_t __t245;
        __t245 = INT64_C(0);
