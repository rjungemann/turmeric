...
struct __env_1436 { tur_thunk_int64_t_t __fn; int64_t n; };
static void drop_glue___env_1436(void *__p) {
    struct __env_1436 *__e = (struct __env_1436 *)__p; (void)__e;
    free((void *)((char *)__p - sizeof(void *)));
}
static int64_t __fn_1434(void * __env_p_1437) {
        struct __env_1436 *__env___env_1436 = (struct __env_1436 *)__env_p_1437;
        int64_t __ps_44 = (f((__env___env_1436->n) - (INT64_C(1))));
        ...
        if (__ps_104) {
            bool __t105;
            {
                ...
                if ((t1_1099) == (INT64_C(0))) {
                    __t106 = (t2_1100) == (INT64_C(0));
                } else {
                    bool __t107;
                    if ((t2_1100) == (INT64_C(0))) {
                        __t107 = false;
                    } else {
                        bool __ps_108 = (cons_hyeq_hygo(t1_1099, t2_1100));
                        if (tur_panicking) return ((bool)0);
                        __t107 = __ps_108;
                    }
                    __t106 = __t107;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_115 = (_un_uncons_hyfmap(__ps_114, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_116 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_113, __ps_115));
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1108 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1108;
                __t111 = out_1108;
            }
            __t109 = __t111;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_118) {
            ...
            int64_t __t119;
            {
                int64_t __ps_120 = (list_hyhead(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_121 = (list_hytail(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_122 = (list_hyconcat(__ps_121, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_123 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_120, __ps_122));
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1115 = (int64_t)(intptr_t)(__ps_123);
                (void)out_1115;
                __t119 = out_1115;
            }
            __t117 = __t119;
...
static int64_t car(int64_t l) {
        int64_t __ps_124 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_124;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_125 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_125;
}

static bool null_qu(int64_t l) {
        bool __ps_126 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_126;
}

static int64_t length(int64_t l) {
        int64_t __ps_127 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_127;
}
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t128;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1190 = __ps_130;
            (void)iter_1190;
            void * __ps_131 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_132 = (hamt_slkeyeq((void *)(intptr_t)(__ps_131)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1191 = __ps_132;
            (void)keyeq_1191;
            void * __ps_133 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_134 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1190), (void *)(intptr_t)(__ps_133), (void *)(intptr_t)(keyeq_1191)));
            if (tur_panicking) return ((bool)0);
            bool result_1192 = __ps_134;
            (void)result_1192;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t155;
        {
            ...
            {
                tur_adt_Vec__int * __ps_157 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1319));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1320 = __ps_157;
                (void)_un_unv_1320;
        ...
        int64_t __ps_159 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t155))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_159;
}
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t161;
        {
            int64_t __ps_162 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1370 = __ps_162;
            (void)r_1370;
            int64_t __t163;
            bool __ps_164 = (schema_hydecode_hyok_qu(r_1370));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_164) {
                int64_t __ps_165 = (schema_hydecode_hyvalue(r_1370));
                if (tur_panicking) return ((int64_t)0);
                __t163 = __ps_165;
            } else {
                int64_t __ps_166 = (schema_hydecode_hyerrors(r_1370));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_167 = (schema_hydecode_hyabort(__ps_166));
                if (tur_panicking) return ((int64_t)0);
                __t163 = __ps_167;
            }
            __t161 = __t163;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_168 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_168;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t169;
        {
            int64_t __ps_170 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1429 = __ps_170;
            (void)m_1429;
            int64_t __ps_171 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1430 = __ps_171;
            (void)r_1430;
            bool __ps_172 = (bt_hyundo_hyto_ex(m_1429));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_172);
            int64_t __t173;
            __t173 = r_1430;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n180->saved[1] = (int64_t)(intptr_t)(r_1439);
          ...
          case 3: {
           ...
           r_1439 = (int64_t)(intptr_t)(__k->saved[1]);
