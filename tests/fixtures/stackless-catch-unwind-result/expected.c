...
struct __env_1471 { tur_thunk_int64_t_t __fn; int64_t n; };
...
static int64_t __fn_1469(void * __env_p_1472) {
        struct __env_1471 *__env___env_1471 = (struct __env_1471 *)__env_p_1472;
        int64_t __ps_104 = (f((__env___env_1471->n) - (INT64_C(1))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_104;
}
        ...
        if (__ps_168) {
            bool __t169;
            {
                ...
                if ((t1_1138) == (INT64_C(0))) {
                    __t170 = (t2_1139) == (INT64_C(0));
                } else {
                    bool __t171;
                    if ((t2_1139) == (INT64_C(0))) {
                        __t171 = false;
                    } else {
                        bool __ps_172 = (cons_hyeq_hygo(t1_1138, t2_1139));
                        if (tur_panicking) return ((bool)0);
                        __t171 = __ps_172;
                    }
                    __t170 = __t171;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_174) {
            ...
            int64_t __t175;
            {
                int64_t __ps_176 = (list_hyhead(cell));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_177 = ((*( tur_thunk_int64_t_int64_t_t *)(f))(f, __ps_176));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_178 = (list_hytail(cell));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_179 = (_un_uncons_hyfmap(__ps_178, (void *)(intptr_t)(f)));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_180 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_177, __ps_179));
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_180), sizeof(__ps_180));
                int64_t out_1147 = (int64_t)(intptr_t)(__ps_180);
                (void)out_1147;
                __t175 = out_1147;
            }
            __t173 = __t175;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_182) {
            ...
            int64_t __t183;
            {
                int64_t __ps_184 = (list_hyhead(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_185 = (list_hytail(l1));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_186 = (list_hyconcat(__ps_185, l2));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Cons__int * __ps_187 = (tcons__spec__tur_adt_Cons__int___int64_t_int64_t(__ps_184, __ps_186));
                if (tur_panicking) return ((int64_t)0);
                TUR_REGION_NOTE_WORDS(&(__ps_187), sizeof(__ps_187));
                int64_t out_1154 = (int64_t)(intptr_t)(__ps_187);
                (void)out_1154;
                __t183 = out_1154;
            }
            __t181 = __t183;
...
static int64_t car(int64_t l) {
        int64_t __ps_188 = (list_hyhead(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_188;
}

static int64_t cdr(int64_t l) {
        int64_t __ps_189 = (list_hytail(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_189;
}

static bool null_qu(int64_t l) {
        bool __ps_190 = (tnil_qu(l));
        if (tur_panicking) return ((bool)0);
        return __ps_190;
}

static int64_t length(int64_t l) {
        int64_t __ps_191 = (list_hylength(l));
        if (tur_panicking) return ((int64_t)0);
        return __ps_191;
}
        ...
        if (__ps_192) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1225 = __ps_193;
                (void)h_1225;
                void * __ps_194 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1226 = __ps_194;
                (void)k_1226;
                bool __ps_195 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1225, (void *)(intptr_t)(k_1226), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_195) {
                    void * __t196 = iter;
                    void * __t197 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t199;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1229 = __ps_201;
            (void)iter_1229;
            void * __ps_202 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_203 = (hamt_slkeyeq((void *)(intptr_t)(__ps_202)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1230 = __ps_203;
            (void)keyeq_1230;
            void * __ps_204 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_205 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1229), (void *)(intptr_t)(__ps_204), (void *)(intptr_t)(keyeq_1230)));
            if (tur_panicking) return ((bool)0);
            bool result_1231 = __ps_205;
            (void)result_1231;
...
static bool set_hyeq_hyfull(int64_t s1, int64_t s2) {
        int64_t __ps_208 = (set_hycount(s1));
        if (tur_panicking) return ((bool)0);
        int64_t __ps_209 = (set_hycount(s2));
        if (tur_panicking) return ((bool)0);
        bool __t207 = (__ps_208) == (__ps_209);
        if (__t207) {
            bool __ps_210 = (set_hyeq_hydriver(s1, s2));
            if (tur_panicking) return ((bool)0);
            __t207 = __ps_210;
        }
        return __t207;
...
static bool mutmap_hyeq_hyloop(int64_t m1, int64_t m2, int64_t i, int64_t cap, int64_t val_cmp) {
        ...
        if ((i) == (cap)) {
            ...
            bool __t212;
            bool __ps_213 = (mutmap_hyslot_hyoccupied_qu(m1, i));
            if (tur_panicking) return ((bool)0);
            if (__ps_213) {
                bool __t214;
                ...
                if (tur_panicking) return ((bool)0);
                bool __ps_217 = (mutmap_hyhas_qu(m2, __ps_215, __ps_216));
                if (tur_panicking) return ((bool)0);
                if (__ps_217) {
                    bool __t218;
                    int64_t __ps_219 = (mutmap_hyslot_hyvalue(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_220 = (mutmap_hyslot_hyhash(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_221 = (mutmap_hyslot_hykey(m1, i));
                    if (tur_panicking) return ((bool)0);
                    int64_t __ps_222 = (mutmap_hyget(m2, __ps_220, __ps_221));
                    if (tur_panicking) return ((bool)0);
                    bool __ps_223 = (((bool (*)(void*, int64_t, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(val_cmp)))[0])((void *)(intptr_t)(val_cmp), __ps_219, __ps_222));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_223) {
                        bool __ps_224 = (mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp)));
                        if (tur_panicking) return ((bool)0);
                        __t218 = __ps_224;
                    } else {
                        __t218 = false;
                ...
                bool __ps_225 = (mutmap_hyeq_hyloop(m1, m2, (i) + (INT64_C(1)), cap, (int64_t)(intptr_t)(val_cmp)));
                if (tur_panicking) return ((bool)0);
                __t212 = __ps_225;
            }
            __t211 = __t212;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t226;
        {
            ...
            {
                tur_adt_Vec__int * __ps_228 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1361));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1362 = __ps_228;
                (void)_un_unv_1362;
        ...
        int64_t __ps_230 = (schema_slunion((int64_t)(intptr_t)((int64_t)(intptr_t)(__t226))));
        if (tur_panicking) return ((int64_t)0);
        return __ps_230;
}
...
static int64_t schema_hydecode_hyabort(int64_t errs) {
        int64_t __ps_231 = (schema_hydecode_hyreport(errs));
        if (tur_panicking) return ((int64_t)0);
        (void)(__ps_231);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t232;
        {
            int64_t __ps_233 = (schema_hydecode(schema, node));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1412 = __ps_233;
            (void)r_1412;
            int64_t __t234;
            bool __ps_235 = (schema_hydecode_hyok_qu(r_1412));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_235) {
                int64_t __ps_236 = (schema_hydecode_hyvalue(r_1412));
                if (tur_panicking) return ((int64_t)0);
                __t234 = __ps_236;
            } else {
                int64_t __ps_237 = (schema_hydecode_hyerrors(r_1412));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_238 = (schema_hydecode_hyabort(__ps_237));
                if (tur_panicking) return ((int64_t)0);
                __t234 = __ps_238;
            }
            __t232 = __t234;
...
static int64_t consume(int64_t x, int64_t f) {
        int64_t __ps_239 = (((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(f)))[0])((void *)(intptr_t)(f), x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_239;
}
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t240;
        {
            int64_t __ps_241 = (bt_hymark());
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1463 = __ps_241;
            (void)m_1463;
            int64_t __ps_242 = (((int64_t (*)(void*))(intptr_t)((int64_t *)((void *)(intptr_t)(body)))[0])((void *)(intptr_t)(body)));
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1464 = __ps_242;
            (void)r_1464;
            bool __ps_243 = (bt_hyundo_hyto_ex(m_1463));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_243);
            int64_t __t244;
            __t244 = r_1464;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            __n252->tag = 3; __n252->boundary = __b252; __n252->next = __k;
            __n252->aggr_mask = 0x0u;
            __n252->saved[0] = (int64_t)(intptr_t)(n);
            __n252->saved[1] = (int64_t)(intptr_t)(r_1474);
            __n252->saved[2] = (int64_t)(intptr_t)(__t250);
            __n252->saved[3] = (int64_t)(intptr_t)(__t251);
            __k = __n252; __pc = 2; break;
           }
          }
          case 2: {
           int64_t __ra253_0 = ((n) - (INT64_C(1)));
           n = __ra253_0;
           __pc = 1; break;
          }
          case 3: {
           n = (int64_t)(intptr_t)(__k->saved[0]);
           r_1474 = (int64_t)(intptr_t)(__k->saved[1]);
           __t250 = (int64_t)(intptr_t)(__k->saved[2]);
           __t251 = (int64_t)(intptr_t)(__k->saved[3]);
           ...
           tur_result_box_free((int64_t)(intptr_t)r_1474);
           __v = (int64_t)(intptr_t)(__t254); __pc = __k->tag; break;
          }
         }
        }
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_256 = (f(INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_256));
        int64_t __t257;
        __t257 = INT64_C(0);
