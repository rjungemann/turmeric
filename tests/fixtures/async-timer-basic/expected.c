...
static void * mk_scheduler();
static void * mk_fiber(void *);
static void sched_spawn(void *, void *);
static void sched_run(void *);
static void timer_sleep_ms(int64_t);
static void fiber_fast();
static void fiber_medium();
static void fiber_slow();
...
static void * mk_fiber(void * fn) {
        return (void *)tur_fiber_block_new((void(*)(void))fn, 0);
  
}

static void sched_spawn(void * s, void * f) {
        tur_scheduler_spawn((TurScheduler *)s, (FiberBlock *)f);
  
}

static void sched_run(void * s) {
...
static void fiber_fast() {
        timer_sleep_ms(INT64_C(50));
        puts("fiber-fast done (50ms)");
}

static void fiber_medium() {
        timer_sleep_ms(INT64_C(100));
        puts("fiber-medium done (100ms)");
}

static void fiber_slow() {
        timer_sleep_ms(INT64_C(150));
        puts("fiber-slow done (150ms)");
}
...
int main() {
        ...
        int64_t __t1;
        {
            void * s_629 = mk_scheduler();
            (void)s_629;
            sched_spawn((void *)(intptr_t)(s_629), (void *)(intptr_t)(mk_fiber((void *)(intptr_t)(fiber_fast))));
            sched_spawn((void *)(intptr_t)(s_629), (void *)(intptr_t)(mk_fiber((void *)(intptr_t)(fiber_medium))));
            sched_spawn((void *)(intptr_t)(s_629), (void *)(intptr_t)(mk_fiber((void *)(intptr_t)(fiber_slow))));
            sched_run((void *)(intptr_t)(s_629));
            puts("all done");
            int64_t __t2;
            __t2 = INT64_C(0);
            __t1 = __t2;
