...
static int64_t __fn_1270(int64_t x) {
        return (x) + (INT64_C(5));
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t181;
        {
            int64_t (*add5)(int64_t) = (int64_t (*)(int64_t))(intptr_t)(__fn_1270);
            (void)add5;
            __auto_type __ps_182 = (((int64_t (*)(int64_t))(intptr_t)add5)(INT64_C(10)));
