...
static int64_t __fn_1607(int64_t);
...
static int64_t __fn_1607(int64_t x) {
        return (x) + (INT64_C(5));
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t275;
        {
            int64_t (*add5)(int64_t) = (int64_t (*)(int64_t))(intptr_t)(__fn_1607);
            (void)add5;
            int64_t __ps_276 = (((int64_t (*)(int64_t))(intptr_t)add5)(INT64_C(10)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_276));
            int64_t __t277;
            __t277 = INT64_C(0);
