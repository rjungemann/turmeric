...
int main() {
        {
            int64_t result_229 = __bind_option(__opt_some(INT64_C(4)), (int64_t)(intptr_t)(safe_reciprocal));
            (void)result_229;
            puts((__opt_some_(result_229)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_229)));
        }
        {
            int64_t result2_230 = __bind_option(__opt_none(), (int64_t)(intptr_t)(safe_reciprocal));
            (void)result2_230;
