...
int main() {
        {
            int64_t result_282 = __bind_option(__opt_some(INT64_C(4)), (int64_t)(intptr_t)(safe_reciprocal));
            (void)result_282;
            puts((__opt_some_(result_282)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_282)));
        }
        {
            int64_t result2_283 = __bind_option(__opt_none(), (int64_t)(intptr_t)(safe_reciprocal));
            (void)result2_283;
