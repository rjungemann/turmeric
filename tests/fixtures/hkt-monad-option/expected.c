...
int main() {
        {
            int64_t result_637 = __bind_option(__opt_some(INT64_C(4)), (int64_t)(intptr_t)(safe_reciprocal));
            (void)result_637;
            puts((__opt_some_(result_637)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_637)));
        }
        {
            int64_t result2_638 = __bind_option(__opt_none(), (int64_t)(intptr_t)(safe_reciprocal));
            (void)result2_638;
