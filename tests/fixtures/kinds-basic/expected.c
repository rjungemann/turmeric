...
static int64_t __inst_MyNum_add_int(int64_t, int64_t);
...
static int64_t __inst_MyNum_add_int(int64_t x, int64_t y) {
        return ((x) + (y));
}

typedef struct dict_MyNum_int {
    int64_t (*add)(int64_t, int64_t);
} dict_MyNum_int;

static dict_MyNum_int dict_MyNum_int_singleton = {
    .add = __inst_MyNum_add_int,
};
...
int main() {
        ...
        printf("%lld\n", (long long)(((int64_t (*)(int64_t, int64_t))(intptr_t)(dict_MyNum_int_singleton.add))(INT64_C(3), INT64_C(4))));
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
}
