...
static bool __fn_988(int64_t, int64_t);
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_879;
        void *__t15 = __t14;
...
static bool __fn_988(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_988;
            void *__t18 = __t17;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_934 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_934;
                void * k_935 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_935;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_934, (void *)(intptr_t)(k_935), (void *)(intptr_t)(keyeq))) {
                    void * __t32 = iter;
                    void * __t33 = s2_hamt;
                    void * __t34 = keyeq;
                    iter = __t32;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t35;
        {
            void * iter_938 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_938;
            void * keyeq_939 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_939;
            bool result_940 = set_hyeq_hyloop((void *)(intptr_t)(iter_938), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_939));
            (void)result_940;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_938));
            bool __t36;
            __t36 = result_940;
            __t35 = __t36;
        }
...
int main(int argc, char **argv) {
        ...
        {
            Option__BoundedIdx a_994 = bidx_hyof_qu(INT64_C(5), INT64_C(2));
            (void)a_994;
            Option__BoundedIdx b_995 = bidx_hyof_qu(INT64_C(5), INT64_C(9));
            (void)b_995;
            Option__BoundedIdx c_996 = bidx_hyof_qu(INT64_C(5), INT64_C(-1));
            (void)c_996;
            int64_t __t45;
            if (some___spec__bool_Option__BoundedIdx(a_994)) {
                __t45 = bidx_hy_gtint(bidx_hyunwrap(a_994));
            } else {
                __t45 = INT64_C(-1);
            }
            printf("%lld\n", (long long)(__t45));
            int64_t __t46;
            if (some___spec__bool_Option__BoundedIdx(b_995)) {
                __t46 = INT64_C(1);
            } else {
                __t46 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t46));
            int64_t __t47;
            if (some___spec__bool_Option__BoundedIdx(c_996)) {
                __t47 = INT64_C(1);
            } else {
                __t47 = INT64_C(0);
            }
