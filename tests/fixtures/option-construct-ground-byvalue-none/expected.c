...
static int64_t ctor_None__BoundedIdx() {
    tur_adt_Option__BoundedIdx *__r = (tur_adt_Option__BoundedIdx *)malloc(sizeof(tur_adt_Option__BoundedIdx));
    __r->tag = 0;
    return (int64_t)(intptr_t)__r;
}

static int64_t ctor_Some__BoundedIdx(int64_t _0) {
    tur_adt_Option__BoundedIdx *__r = (tur_adt_Option__BoundedIdx *)malloc(sizeof(tur_adt_Option__BoundedIdx));
    __r->tag = 1;
    __r->as.Some._0 = _0;
    return (int64_t)(intptr_t)__r;
...
static int64_t bidx_hyof_qu(int64_t, int64_t);
static int64_t bidx_hyunwrap(int64_t);
        ...
        if (__ps_104) {
            bool __t105;
            {
                ...
                if ((t1_1074) == (INT64_C(0))) {
                    __t106 = (t2_1075) == (INT64_C(0));
                } else {
                    bool __t107;
                    if ((t2_1075) == (INT64_C(0))) {
                        __t107 = false;
                    } else {
                        bool __ps_108 = (cons_hyeq_hygo(t1_1074, t2_1075));
                        if (tur_panicking) return ((bool)0);
                        __t107 = __ps_108;
                    }
                    __t106 = __t107;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_114) {
            ...
            int64_t __t115;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1090 = (int64_t)(intptr_t)(__ps_119);
                (void)out_1090;
                __t115 = out_1090;
            }
            __t113 = __t115;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t124;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1165 = __ps_126;
            (void)iter_1165;
            void * __ps_127 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_128 = (hamt_slkeyeq((void *)(intptr_t)(__ps_127)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1166 = __ps_128;
            (void)keyeq_1166;
            void * __ps_129 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_130 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1165), (void *)(intptr_t)(__ps_129), (void *)(intptr_t)(keyeq_1166)));
            if (tur_panicking) return ((bool)0);
            bool result_1167 = __ps_130;
            (void)result_1167;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t151;
        {
            ...
            {
                tur_adt_Vec__int * __ps_153 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1294));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1295 = __ps_153;
                (void)_un_unv_1295;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t157;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1345 = __ps_158;
            (void)r_1345;
            int64_t __t159;
            bool __ps_160 = (schema_hydecode_hyok_qu(r_1345));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_160) {
                int64_t __ps_161 = (schema_hydecode_hyvalue(r_1345));
                if (tur_panicking) return ((int64_t)0);
                __t159 = __ps_161;
            } else {
                int64_t __ps_162 = (schema_hydecode_hyerrors(r_1345));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bidx_hyof_qu(int64_t n, int64_t i) {
        int64_t __t165;
        bool __t166 = (i) < (INT64_C(0));
        if (!__t166) {
            __t166 = (i) >= (n);
        }
        if (__t166) {
            int64_t __ps_167 = (none__spec__int64_t());
            if (tur_panicking) return ((int64_t)0);
            __t165 = __ps_167;
        } else {
            int64_t __ps_168 = (some__spec__int64_t_int64_t(i));
            if (tur_panicking) return ((int64_t)0);
            __t165 = __ps_168;
        }
        return __t165;
...
static int64_t bidx_hyunwrap(int64_t o) {
        int64_t __t169 = 0;
        {
            tur_adt_Option__BoundedIdx *__scrut = (tur_adt_Option__BoundedIdx *)(intptr_t)(o);
            switch (__scrut ? __scrut->tag : 0) {
            case 1: {
                int64_t v_1369 = (int64_t)__scrut->as.Some._0;
                __t169 = v_1369;
                break;
            }
            case 0: {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t __ps_170 = (bidx_hyof_qu(INT64_C(5), INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t a_1371 = __ps_170;
            (void)a_1371;
            int64_t __ps_171 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t b_1372 = __ps_171;
            (void)b_1372;
            int64_t __ps_172 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t c_1373 = __ps_172;
            (void)c_1373;
            int64_t __t173;
            bool __ps_174 = (some_qu(a_1371));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_174) {
                int64_t __ps_175 = (bidx_hyunwrap(a_1371));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_176 = (bidx_hy_gtint(__ps_175));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t173 = __ps_176;
            } else {
                __t173 = INT64_C(-1);
...
static int64_t none__spec__int64_t() {
        int64_t __ps_184 = (ctor_None__BoundedIdx());
        if (tur_panicking) return ((int64_t)0);
        return __ps_184;
}

static int64_t some__spec__int64_t_int64_t(int64_t x) {
        int64_t __ps_185 = (ctor_Some__BoundedIdx(x));
        if (tur_panicking) return ((int64_t)0);
        return __ps_185;
}
