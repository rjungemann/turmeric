...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t23[1] = (int64_t)(intptr_t)__fn_889;
        void *__t24 = __t23;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t25) {
            ...
            __t26[1] = (int64_t)(intptr_t)__fn_1009;
            void *__t27 = __t26;
...
static Option__BoundedIdx bidx_hyof_qu(int64_t n, int64_t i) {
        Option__BoundedIdx __t51;
        bool __t52 = (i) < (INT64_C(0));
        if (!__t52) {
            __t52 = (i) >= (n);
        }
        if (__t52) {
            __t51 = none__spec__Option__BoundedIdx();
        } else {
            __t51 = some__spec__Option__BoundedIdx_int64_t(i);
        }
        return __t51;
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            if (some___spec__bool_Option__BoundedIdx(a_1015)) {
                __t54 = bidx_hy_gtint(bidx_hyunwrap(a_1015));
            } else {
                __t54 = INT64_C(-1);
            }
            printf("%lld\n", (long long)(__t54));
