...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t51;
        {
            ...
            if ((t1_1288) == (INT64_C(0))) {
                __t52 = (t2_1289) == (INT64_C(0));
            } else {
                bool __t53;
                if ((t2_1289) == (INT64_C(0))) {
                    __t53 = false;
                } else {
                    bool __ps_54 = (cons_hyeq_hygo(t1_1288, t2_1289));
                    if (tur_panicking) return ((bool)0);
                    __t53 = __ps_54;
                }
                __t52 = __t53;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_97) {
            bool __t98;
            {
                ...
                (void)t2_1284;
                bool __t99;
                bool __ps_100 = (tnil_qu(t1_1283));
                if (tur_panicking) return ((bool)0);
                if (__ps_100) {
                    bool __ps_101 = (tnil_qu(t2_1284));
                    if (tur_panicking) return ((bool)0);
                    __t99 = __ps_101;
                } else {
                    bool __t102;
                    bool __ps_103 = (tnil_qu(t2_1284));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_103) {
                        __t102 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1283, t2_1284));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_104;
                    }
                    __t99 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                int64_t out_1299 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1299;
                __t111 = out_1299;
            }
            __t109 = __t111;
        ...
        if (__ps_116) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1370 = __ps_117;
                (void)h_1370;
                void * __ps_118 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1371 = __ps_118;
                (void)k_1371;
                bool __ps_119 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1370, (void *)(intptr_t)(k_1371), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_119) {
                    void * __t120 = iter;
                    void * __t121 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1374 = __ps_125;
            (void)iter_1374;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1375 = __ps_127;
            (void)keyeq_1375;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1374), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1375)));
            if (tur_panicking) return ((bool)0);
            bool result_1376 = __ps_129;
            (void)result_1376;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1506));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1507 = __ps_152;
                (void)_un_unv_1507;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1557 = __ps_155;
            (void)r_1557;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1557));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                return schema_hydecode_hyvalue(r_1557);
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1557));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1608 = __ps_160;
            (void)m_1608;
            tur_frame __frame_161;
            tur_frame_init(&__frame_161, NULL);
            struct __defer_env_162 __t164 = {.m = m_1608};
...
static int64_t bidx_hyunwrap(tur_adt_Option__BoundedIdx o) {
        int64_t __t175 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_1614 = (int64_t)__scrut->as.Some._0;
                __t175 = v_1614;
                break;
            }
            case 0: {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx a_1616 = __ps_176;
            (void)a_1616;
            tur_adt_Option__BoundedIdx __ps_177 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx b_1617 = __ps_177;
            (void)b_1617;
            tur_adt_Option__BoundedIdx __ps_178 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx c_1618 = __ps_178;
            (void)c_1618;
            int64_t __t179;
            bool __ps_180 = (some___spec__bool_tur_adt_Option__BoundedIdx(a_1616));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_180) {
                int64_t __ps_181 = (bidx_hyunwrap(a_1616));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t179));
            int64_t __t183;
            bool __ps_184 = (some___spec__bool_tur_adt_Option__BoundedIdx(b_1617));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_184) {
                __t183 = INT64_C(1);
            } else {
            ...
            printf("%lld\n", (long long)(__t183));
            int64_t __t185;
            bool __ps_186 = (some___spec__bool_tur_adt_Option__BoundedIdx(c_1618));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_186) {
                __t185 = INT64_C(1);
            } else {
