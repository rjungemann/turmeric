...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        bool __t28;
        {
            ...
            int64_t t1_1109 = __t29;
            (void)t1_1109;
            __auto_type __t30 = (y);
            TUR_REGION_NOTE_WORDS(&(__t30), sizeof(__t30));
            int64_t t2_1110 = __t30;
            (void)t2_1110;
            bool __t31;
            if ((t1_1109) == (INT64_C(0))) {
                __t31 = (t2_1110) == (INT64_C(0));
            } else {
                bool __t32;
                if ((t2_1110) == (INT64_C(0))) {
                    __t32 = false;
                } else {
                    bool __ps_33 = (cons_hyeq_hygo(t1_1109, t2_1110));
                    if (tur_panicking) return ((bool)0);
                    __t32 = __ps_33;
                }
                __t31 = __t32;
...
static int64_t map_hyeq_hyloop__cps(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp, DK *__kont) {
    ...
    if (__t0) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        k_820 = __ps_74;
        bool __ps_75 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_819, (void *)(intptr_t)(k_820), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __t1 = __ps_75;
        if (__t1) {
            int64_t __ps_76 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_77 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_819, (void *)(intptr_t)(k_820), (void *)(intptr_t)(keyeq)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t79;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_824 = __ps_81;
            (void)iter_824;
            void * __ps_82 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_83 = (hamt_slkeyeq((void *)(intptr_t)(__ps_82)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_825 = __ps_83;
            (void)keyeq_825;
            void * __ps_84 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_85 = (map_hyeq_hyloop((void *)(intptr_t)(iter_824), (void *)(intptr_t)(__ps_84), (void *)(intptr_t)(keyeq_825), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_826 = __ps_85;
            (void)result_826;
        ...
        if (__ps_105) {
            bool __t106;
            {
                ...
                if ((t1_1104) == (INT64_C(0))) {
                    __t107 = (t2_1105) == (INT64_C(0));
                } else {
                    bool __t108;
                    if ((t2_1105) == (INT64_C(0))) {
                        __t108 = false;
                    } else {
                        bool __ps_109 = (cons_hyeq_hygo(t1_1104, t2_1105));
                        if (tur_panicking) return ((bool)0);
                        __t108 = __ps_109;
                    }
                    __t107 = __t108;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_115) {
            ...
            int64_t __t116;
            {
                ...
                int64_t out_1120 = (int64_t)(intptr_t)(__t121);
                (void)out_1120;
                __t116 = out_1120;
            }
            __t114 = __t116;
        ...
        if (__ps_126) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1191 = __ps_127;
                (void)h_1191;
                void * __ps_128 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1192 = __ps_128;
                (void)k_1192;
                bool __ps_129 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1191, (void *)(intptr_t)(k_1192), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_129) {
                    void * __t130 = iter;
                    void * __t131 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t133;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1195 = __ps_135;
            (void)iter_1195;
            void * __ps_136 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_137 = (hamt_slkeyeq((void *)(intptr_t)(__ps_136)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1196 = __ps_137;
            (void)keyeq_1196;
            void * __ps_138 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_139 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1195), (void *)(intptr_t)(__ps_138), (void *)(intptr_t)(keyeq_1196)));
            if (tur_panicking) return ((bool)0);
            bool result_1197 = __ps_139;
            (void)result_1197;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t160;
        {
            ...
            {
                tur_adt_Vec__int * __ps_162 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1325));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1326 = __ps_162;
                (void)_un_unv_1326;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t166;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1376 = __ps_167;
            (void)r_1376;
            int64_t __t168;
            bool __ps_169 = (schema_hydecode_hyok_qu(r_1376));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_169) {
                int64_t __ps_170 = (schema_hydecode_hyvalue(r_1376));
                if (tur_panicking) return ((int64_t)0);
                __t168 = __ps_170;
            } else {
                int64_t __ps_171 = (schema_hydecode_hyerrors(r_1376));
                if (tur_panicking) return ((int64_t)0);
...
static tur_adt_Option__BoundedIdx bidx_hyof_qu(int64_t n, int64_t i) {
        tur_adt_Option__BoundedIdx __t184;
        bool __t185 = (i) < (INT64_C(0));
        if (!__t185) {
            __t185 = (i) >= (n);
        }
        if (__t185) {
            tur_adt_Option__BoundedIdx __ps_186 = (none__spec__tur_adt_Option__BoundedIdx());
            if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
            __t184 = __ps_186;
        } else {
            tur_adt_Option__BoundedIdx __ps_187 = (some__spec__tur_adt_Option__BoundedIdx_int64_t(i));
            if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
            __t184 = __ps_187;
        }
        return __t184;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Option__BoundedIdx __ps_189 = (bidx_hyof_qu(INT64_C(5), INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx a_1445 = __ps_189;
            (void)a_1445;
            tur_adt_Option__BoundedIdx __ps_190 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx b_1446 = __ps_190;
            (void)b_1446;
            tur_adt_Option__BoundedIdx __ps_191 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx c_1447 = __ps_191;
            (void)c_1447;
            int64_t __t192;
            bool __ps_193 = (some___spec__bool_tur_adt_Option__BoundedIdx(a_1445));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_193) {
                int64_t __ps_194 = (bidx_hyunwrap(a_1445));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_195 = (bidx_hy_gtint(__ps_194));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t192 = __ps_195;
            } else {
                __t192 = INT64_C(-1);
            ...
            printf("%lld\n", (long long)(__t192));
            int64_t __t196;
            bool __ps_197 = (some___spec__bool_tur_adt_Option__BoundedIdx(b_1446));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_197) {
                __t196 = INT64_C(1);
            } else {
            ...
            printf("%lld\n", (long long)(__t196));
            int64_t __t198;
            bool __ps_199 = (some___spec__bool_tur_adt_Option__BoundedIdx(c_1447));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_199) {
                __t198 = INT64_C(1);
            } else {
...
static tur_adt_Option__BoundedIdx none__spec__tur_adt_Option__BoundedIdx() {
        tur_adt_Option__BoundedIdx __ps_203 = (ctor_Option_None__BoundedIdx());
        if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
        return __ps_203;
}

static tur_adt_Option__BoundedIdx some__spec__tur_adt_Option__BoundedIdx_int64_t(int64_t x) {
        tur_adt_Option__BoundedIdx __ps_204 = (ctor_Option_Some__BoundedIdx(x));
        if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
        return __ps_204;
}
