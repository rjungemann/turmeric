...
static tur_adt_Option__BoundedIdx bidx_hyof_qu(int64_t n, int64_t i) {
        tur_adt_Option__BoundedIdx __t180;
        bool __t181 = (i) < (INT64_C(0));
        if (!__t181) {
            __t181 = (i) >= (n);
        }
        if (__t181) {
            tur_adt_Option__BoundedIdx __ps_182 = (none__spec__tur_adt_Option__BoundedIdx());
            if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
            __t180 = __ps_182;
        } else {
            tur_adt_Option__BoundedIdx __ps_183 = (some__spec__tur_adt_Option__BoundedIdx_int64_t(i));
            if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
            __t180 = __ps_183;
        }
        return __t180;
...
static int64_t bidx_hyunwrap(tur_adt_Option__BoundedIdx o) {
        int64_t __t184 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_1441 = (int64_t)__scrut->as.Some._0;
                __t184 = v_1441;
                break;
            }
            case 0: {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Option__BoundedIdx __ps_185 = (bidx_hyof_qu(INT64_C(5), INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx a_1443 = __ps_185;
            (void)a_1443;
            tur_adt_Option__BoundedIdx __ps_186 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx b_1444 = __ps_186;
            (void)b_1444;
            tur_adt_Option__BoundedIdx __ps_187 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx c_1445 = __ps_187;
            (void)c_1445;
            int64_t __t188;
            bool __ps_189 = (some___spec__bool_tur_adt_Option__BoundedIdx(a_1443));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_189) {
                int64_t __ps_190 = (bidx_hyunwrap(a_1443));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_191 = (bidx_hy_gtint(__ps_190));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t188 = __ps_191;
            } else {
                __t188 = INT64_C(-1);
            ...
            printf("%lld\n", (long long)(__t188));
            int64_t __t192;
            bool __ps_193 = (some___spec__bool_tur_adt_Option__BoundedIdx(b_1444));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_193) {
                __t192 = INT64_C(1);
            } else {
            ...
            printf("%lld\n", (long long)(__t192));
            int64_t __t194;
            bool __ps_195 = (some___spec__bool_tur_adt_Option__BoundedIdx(c_1445));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_195) {
                __t194 = INT64_C(1);
            } else {
...
static tur_adt_Option__BoundedIdx none__spec__tur_adt_Option__BoundedIdx() {
        tur_adt_Option__BoundedIdx __ps_199 = (ctor_Option_None__BoundedIdx());
        if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
        return __ps_199;
}

static tur_adt_Option__BoundedIdx some__spec__tur_adt_Option__BoundedIdx_int64_t(int64_t x) {
        tur_adt_Option__BoundedIdx __ps_200 = (ctor_Option_Some__BoundedIdx(x));
        if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
        return __ps_200;
}
