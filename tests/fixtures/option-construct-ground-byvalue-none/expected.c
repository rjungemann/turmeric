...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx a_1441 = __ps_185;
            (void)a_1441;
            tur_adt_Option__BoundedIdx __ps_186 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx b_1442 = __ps_186;
            (void)b_1442;
            tur_adt_Option__BoundedIdx __ps_187 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx c_1443 = __ps_187;
            (void)c_1443;
            int64_t __t188;
            bool __ps_189 = (some___spec__bool_tur_adt_Option__BoundedIdx(a_1441));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_189) {
                int64_t __ps_190 = (bidx_hyunwrap(a_1441));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t188));
            int64_t __t192;
            bool __ps_193 = (some___spec__bool_tur_adt_Option__BoundedIdx(b_1442));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_193) {
                __t192 = INT64_C(1);
            } else {
            ...
            printf("%lld\n", (long long)(__t192));
            int64_t __t194;
            bool __ps_195 = (some___spec__bool_tur_adt_Option__BoundedIdx(c_1443));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_195) {
                __t194 = INT64_C(1);
            } else {
