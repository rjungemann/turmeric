...
static bool __fn_889(int64_t, int64_t);
...
static int64_t __inst_Applicative_ap_Option(int64_t ff, int64_t fa) {
        ...
        if (some___spec__bool_Option__opaque((__t12 ? (Option__opaque){.is_some = __t12->is_some, .value = (void *)(__t12->value)} : (Option__opaque){0}))) {
            ...
            if (some_qu(fa)) {
                int64_t __t14;
                {
                    int64_t _un_uncall_unhead_un738_739 = (int64_t)(intptr_t)(((ff) ? ((Option *)(intptr_t)(ff))->value : 0));
                    (void)_un_uncall_unhead_un738_739;
                    __t14 = ((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(_un_uncall_unhead_un738_739)))[0])((void *)(intptr_t)(_un_uncall_unhead_un738_739), ((fa) ? ((Option *)(intptr_t)(fa))->value : 0));
                }
                __t13 = some(__t14);
            } else {
                __t13 = none();
...
static bool __fn_889(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t24[1] = (int64_t)(intptr_t)__fn_889;
        void *__t25 = __t24;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t26) {
            ...
            __t27[1] = (int64_t)(intptr_t)__fn_1009;
            void *__t28 = __t27;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_955 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_955;
                void * k_956 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_956;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_955, (void *)(intptr_t)(k_956), (void *)(intptr_t)(keyeq))) {
                    void * __t42 = iter;
                    void * __t43 = s2_hamt;
                    void * __t44 = keyeq;
                    iter = __t42;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t45;
        {
            void * iter_959 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_959;
            void * keyeq_960 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_960;
            bool result_961 = set_hyeq_hyloop((void *)(intptr_t)(iter_959), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_960));
            (void)result_961;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_959));
            bool __t46;
            __t46 = result_961;
            __t45 = __t46;
        }
...
static Option__BoundedIdx bidx_hyof_qu(int64_t n, int64_t i) {
        Option__BoundedIdx __t52;
        bool __t53 = (i) < (INT64_C(0));
        if (!__t53) {
            __t53 = (i) >= (n);
        }
        if (__t53) {
            __t52 = none__spec__Option__BoundedIdx();
        } else {
            __t52 = some__spec__Option__BoundedIdx_int64_t(i);
        }
        return __t52;
}
...
int main(int argc, char **argv) {
        ...
        {
            Option__BoundedIdx a_1015 = bidx_hyof_qu(INT64_C(5), INT64_C(2));
            (void)a_1015;
            Option__BoundedIdx b_1016 = bidx_hyof_qu(INT64_C(5), INT64_C(9));
            (void)b_1016;
            Option__BoundedIdx c_1017 = bidx_hyof_qu(INT64_C(5), INT64_C(-1));
            (void)c_1017;
            int64_t __t55;
            if (some___spec__bool_Option__BoundedIdx(a_1015)) {
                __t55 = bidx_hy_gtint(bidx_hyunwrap(a_1015));
            } else {
                __t55 = INT64_C(-1);
            }
            printf("%lld\n", (long long)(__t55));
            int64_t __t56;
            if (some___spec__bool_Option__BoundedIdx(b_1016)) {
                __t56 = INT64_C(1);
            } else {
                __t56 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t56));
            int64_t __t57;
            if (some___spec__bool_Option__BoundedIdx(c_1017)) {
                __t57 = INT64_C(1);
            } else {
                __t57 = INT64_C(0);
            }
