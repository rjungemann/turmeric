        ...
        if (__ps_100) {
            bool __t101;
            {
                ...
                if ((t1_1041) == (INT64_C(0))) {
                    __t102 = (t2_1042) == (INT64_C(0));
                } else {
                    bool __t103;
                    if ((t2_1042) == (INT64_C(0))) {
                        __t103 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1041, t2_1042));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_104;
                    }
                    __t102 = __t103;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1057 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1057;
                __t111 = out_1057;
            }
            __t109 = __t111;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t120;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1132 = __ps_122;
            (void)iter_1132;
            void * __ps_123 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_124 = (hamt_slkeyeq((void *)(intptr_t)(__ps_123)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1133 = __ps_124;
            (void)keyeq_1133;
            void * __ps_125 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_126 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1132), (void *)(intptr_t)(__ps_125), (void *)(intptr_t)(keyeq_1133)));
            if (tur_panicking) return ((bool)0);
            bool result_1134 = __ps_126;
            (void)result_1134;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t147;
        {
            ...
            {
                tur_adt_Vec__int * __ps_149 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1261));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1262 = __ps_149;
                (void)_un_unv_1262;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t152;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1311 = __ps_153;
            (void)r_1311;
            int64_t __t154;
            bool __ps_155 = (schema_hydecode_hyok_qu(r_1311));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_155) {
                int64_t __ps_156 = (schema_hydecode_hyvalue(r_1311));
                if (tur_panicking) return ((int64_t)0);
                __t154 = __ps_156;
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1311));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx a_1336 = __ps_166;
            (void)a_1336;
            tur_adt_Option__BoundedIdx __ps_167 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx b_1337 = __ps_167;
            (void)b_1337;
            tur_adt_Option__BoundedIdx __ps_168 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx c_1338 = __ps_168;
            (void)c_1338;
            int64_t __t169;
            bool __ps_170 = (some___spec__bool_tur_adt_Option__BoundedIdx(a_1336));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_170) {
                int64_t __ps_171 = (bidx_hyunwrap(a_1336));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t169));
            int64_t __t173;
            bool __ps_174 = (some___spec__bool_tur_adt_Option__BoundedIdx(b_1337));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_174) {
                __t173 = INT64_C(1);
            } else {
            ...
            printf("%lld\n", (long long)(__t173));
            int64_t __t175;
            bool __ps_176 = (some___spec__bool_tur_adt_Option__BoundedIdx(c_1338));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_176) {
                __t175 = INT64_C(1);
            } else {
