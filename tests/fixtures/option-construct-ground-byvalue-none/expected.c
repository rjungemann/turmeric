...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t20) {
            ...
            __t21[1] = (int64_t)(intptr_t)__fn_1007;
            void *__t22 = __t21;
...
static Option__BoundedIdx bidx_hyof_qu(int64_t n, int64_t i) {
        Option__BoundedIdx __t46;
        bool __t47 = (i) < (INT64_C(0));
        if (!__t47) {
            __t47 = (i) >= (n);
        }
        if (__t47) {
            __t46 = none__spec__Option__BoundedIdx();
        } else {
            __t46 = some__spec__Option__BoundedIdx_int64_t(i);
        }
        return __t46;
}
...
int main(int argc, char **argv) {
        ...
        {
            Option__BoundedIdx a_1013 = bidx_hyof_qu(INT64_C(5), INT64_C(2));
            (void)a_1013;
            Option__BoundedIdx b_1014 = bidx_hyof_qu(INT64_C(5), INT64_C(9));
            (void)b_1014;
            Option__BoundedIdx c_1015 = bidx_hyof_qu(INT64_C(5), INT64_C(-1));
            (void)c_1015;
            int64_t __t49;
            if (some___spec__bool_Option__BoundedIdx(a_1013)) {
                __t49 = bidx_hy_gtint(bidx_hyunwrap(a_1013));
            } else {
                __t49 = INT64_C(-1);
            }
            printf("%lld\n", (long long)(__t49));
            int64_t __t50;
            if (some___spec__bool_Option__BoundedIdx(b_1014)) {
                __t50 = INT64_C(1);
            } else {
                __t50 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t50));
            int64_t __t51;
            if (some___spec__bool_Option__BoundedIdx(c_1015)) {
                __t51 = INT64_C(1);
            } else {
                __t51 = INT64_C(0);
            }
