...
static bool __fn_985(int64_t, int64_t);
...
static bool __fn_985(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_985;
        void *__t15 = __t14;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_1116;
            void *__t18 = __t17;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t48;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1244)) {
                __t49 = schema_hydecode_hyvalue(r_1244);
            } else {
                __t49 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1244));
            }
            __t48 = __t49;
        }
        return __t48;
...
static tur_adt_Option__BoundedIdx bidx_hyof_qu(int64_t n, int64_t i) {
        tur_adt_Option__BoundedIdx __t50;
        bool __t51 = (i) < (INT64_C(0));
        if (!__t51) {
            __t51 = (i) >= (n);
        }
        if (__t51) {
            __t50 = none__spec__tur_adt_Option__BoundedIdx();
        } else {
            __t50 = some__spec__tur_adt_Option__BoundedIdx_int64_t(i);
        }
        return __t50;
}
...
int main(int argc, char **argv) {
        ...
        {
            tur_adt_Option__BoundedIdx a_1269 = bidx_hyof_qu(INT64_C(5), INT64_C(2));
            (void)a_1269;
            tur_adt_Option__BoundedIdx b_1270 = bidx_hyof_qu(INT64_C(5), INT64_C(9));
            (void)b_1270;
            tur_adt_Option__BoundedIdx c_1271 = bidx_hyof_qu(INT64_C(5), INT64_C(-1));
            (void)c_1271;
            int64_t __t53;
            if (some___spec__bool_tur_adt_Option__BoundedIdx(a_1269)) {
                __t53 = bidx_hy_gtint(bidx_hyunwrap(a_1269));
            } else {
                __t53 = INT64_C(-1);
            }
            printf("%lld\n", (long long)(__t53));
            int64_t __t54;
            if (some___spec__bool_tur_adt_Option__BoundedIdx(b_1270)) {
                __t54 = INT64_C(1);
            } else {
                __t54 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t54));
            int64_t __t55;
            if (some___spec__bool_tur_adt_Option__BoundedIdx(c_1271)) {
                __t55 = INT64_C(1);
            } else {
                __t55 = INT64_C(0);
            }
