...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_96) {
            bool __t97;
            {
                ...
                bool __t98;
                if ((t1_992) == (INT64_C(0))) {
                    __t98 = (t2_993) == (INT64_C(0));
                } else {
                    bool __t99;
                    if ((t2_993) == (INT64_C(0))) {
                        __t99 = false;
                    } else {
                        __auto_type __ps_100 = (cons_hyeq_hygo(t1_992, t2_993));
                        if (tur_panicking) return (bool){0};
                        __t99 = __ps_100;
                    }
                    __t98 = __t99;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_106) {
            ...
            int64_t __t107;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1008 = (int64_t)(intptr_t)(__ps_111);
                (void)out_1008;
                __t107 = out_1008;
            }
            __t105 = __t107;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t116;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1083 = __ps_118;
            (void)iter_1083;
            __auto_type __ps_119 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_120 = (hamt_slkeyeq((void *)(intptr_t)(__ps_119)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1084 = __ps_120;
            (void)keyeq_1084;
            __auto_type __ps_121 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_122 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1083), (void *)(intptr_t)(__ps_121), (void *)(intptr_t)(keyeq_1084)));
            if (tur_panicking) return (bool){0};
            bool result_1085 = __ps_122;
            (void)result_1085;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t143;
        {
            ...
            {
                __auto_type __ps_145 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1212));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1213 = __ps_145;
                (void)_un_unv_1213;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t148;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1262 = __ps_149;
            (void)r_1262;
            int64_t __t150;
            __auto_type __ps_151 = (schema_hydecode_hyok_qu(r_1262));
            if (tur_panicking) return (int64_t){0};
            if (__ps_151) {
                __auto_type __ps_152 = (schema_hydecode_hyvalue(r_1262));
                if (tur_panicking) return (int64_t){0};
                __t150 = __ps_152;
            } else {
                __auto_type __ps_153 = (schema_hydecode_hyerrors(r_1262));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx a_1287 = __ps_162;
            (void)a_1287;
            __auto_type __ps_163 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx b_1288 = __ps_163;
            (void)b_1288;
            __auto_type __ps_164 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx c_1289 = __ps_164;
            (void)c_1289;
            int64_t __t165;
            __auto_type __ps_166 = (some___spec__bool_tur_adt_Option__BoundedIdx(a_1287));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_166) {
                __auto_type __ps_167 = (bidx_hyunwrap(a_1287));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t165));
            int64_t __t169;
            __auto_type __ps_170 = (some___spec__bool_tur_adt_Option__BoundedIdx(b_1288));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_170) {
                __t169 = INT64_C(1);
            } else {
            ...
            printf("%lld\n", (long long)(__t169));
            int64_t __t171;
            __auto_type __ps_172 = (some___spec__bool_tur_adt_Option__BoundedIdx(c_1289));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_172) {
                __t171 = INT64_C(1);
            } else {
