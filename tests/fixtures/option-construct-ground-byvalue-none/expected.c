...
static bool __fn_991(int64_t, int64_t);
...
static bool __fn_991(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_991;
            void *__t18 = __t17;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_937 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_937;
                void * k_938 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_938;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_937, (void *)(intptr_t)(k_938), (void *)(intptr_t)(keyeq))) {
                    void * __t32 = iter;
                    void * __t33 = s2_hamt;
                    void * __t34 = keyeq;
                    iter = __t32;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t35;
        {
            void * iter_941 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_941;
            void * keyeq_942 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_942;
            bool result_943 = set_hyeq_hyloop((void *)(intptr_t)(iter_941), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_942));
            (void)result_943;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_941));
            bool __t36;
            __t36 = result_943;
            __t35 = __t36;
        }
...
int main(int argc, char **argv) {
        ...
        {
            Option__BoundedIdx a_997 = bidx_hyof_qu(INT64_C(5), INT64_C(2));
            (void)a_997;
            Option__BoundedIdx b_998 = bidx_hyof_qu(INT64_C(5), INT64_C(9));
            (void)b_998;
            Option__BoundedIdx c_999 = bidx_hyof_qu(INT64_C(5), INT64_C(-1));
            (void)c_999;
            int64_t __t45;
            if (some___spec__bool_Option__BoundedIdx(a_997)) {
                __t45 = bidx_hy_gtint(bidx_hyunwrap(a_997));
            } else {
                __t45 = INT64_C(-1);
            }
            printf("%lld\n", (long long)(__t45));
            int64_t __t46;
            if (some___spec__bool_Option__BoundedIdx(b_998)) {
                __t46 = INT64_C(1);
            } else {
                __t46 = INT64_C(0);
            }
            printf("%lld\n", (long long)(__t46));
            int64_t __t47;
            if (some___spec__bool_Option__BoundedIdx(c_999)) {
                __t47 = INT64_C(1);
            } else {
                __t47 = INT64_C(0);
            }
