...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx a_1615 = __ps_176;
            (void)a_1615;
            tur_adt_Option__BoundedIdx __ps_177 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx b_1616 = __ps_177;
            (void)b_1616;
            tur_adt_Option__BoundedIdx __ps_178 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx c_1617 = __ps_178;
            (void)c_1617;
            int64_t __t179;
            bool __ps_180 = (some___spec__bool_tur_adt_Option__BoundedIdx(a_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_180) {
                int64_t __ps_181 = (bidx_hyunwrap(a_1615));
                /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            printf("%lld\n", (long long)(__t179));
            int64_t __t183;
            bool __ps_184 = (some___spec__bool_tur_adt_Option__BoundedIdx(b_1616));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_184) {
                __t183 = INT64_C(1);
            } else {
            ...
            printf("%lld\n", (long long)(__t183));
            int64_t __t185;
            bool __ps_186 = (some___spec__bool_tur_adt_Option__BoundedIdx(c_1617));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_186) {
                __t185 = INT64_C(1);
            } else {
