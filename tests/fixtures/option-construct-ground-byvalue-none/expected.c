...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t255;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1467 = __ps_257;
            (void)r_1467;
            bool __ps_258 = (bt_hyundo_hyto_ex(m_1466));
            if (tur_panicking) return ((int64_t)0);
            (void)(__ps_258);
            int64_t __t259;
            __t259 = r_1467;
...
static tur_adt_Option__BoundedIdx bidx_hyof_qu(int64_t n, int64_t i) {
        tur_adt_Option__BoundedIdx __t265;
        bool __t266 = (i) < (INT64_C(0));
        if (!__t266) {
            __t266 = (i) >= (n);
        }
        if (__t266) {
            tur_adt_Option__BoundedIdx __ps_267 = (none__spec__tur_adt_Option__BoundedIdx());
            if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
            __t265 = __ps_267;
        } else {
            tur_adt_Option__BoundedIdx __ps_268 = (some__spec__tur_adt_Option__BoundedIdx_int64_t(i));
            if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
            __t265 = __ps_268;
        }
        return __t265;
...
static int64_t bidx_hyunwrap(tur_adt_Option__BoundedIdx o) {
        int64_t __t269 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_1474 = (int64_t)__scrut->as.Some._0;
                __t269 = v_1474;
                break;
            }
            case 0: {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            tur_adt_Option__BoundedIdx __ps_270 = (bidx_hyof_qu(INT64_C(5), INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx a_1476 = __ps_270;
            (void)a_1476;
            tur_adt_Option__BoundedIdx __ps_271 = (bidx_hyof_qu(INT64_C(5), INT64_C(9)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx b_1477 = __ps_271;
            (void)b_1477;
            tur_adt_Option__BoundedIdx __ps_272 = (bidx_hyof_qu(INT64_C(5), INT64_C(-1)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Option__BoundedIdx c_1478 = __ps_272;
            (void)c_1478;
            int64_t __t273;
            bool __ps_274 = (some___spec__bool_tur_adt_Option__BoundedIdx(a_1476));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_274) {
                int64_t __ps_275 = (bidx_hyunwrap(a_1476));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                int64_t __ps_276 = (bidx_hy_gtint(__ps_275));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t273 = __ps_276;
            } else {
                __t273 = INT64_C(-1);
            ...
            printf("%lld\n", (long long)(__t273));
            int64_t __t277;
            bool __ps_278 = (some___spec__bool_tur_adt_Option__BoundedIdx(b_1477));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_278) {
                __t277 = INT64_C(1);
            } else {
            ...
            printf("%lld\n", (long long)(__t277));
            int64_t __t279;
            bool __ps_280 = (some___spec__bool_tur_adt_Option__BoundedIdx(c_1478));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            if (__ps_280) {
                __t279 = INT64_C(1);
            } else {
...
static tur_adt_Option__BoundedIdx none__spec__tur_adt_Option__BoundedIdx() {
        tur_adt_Option__BoundedIdx __ps_284 = (ctor_Option_None__BoundedIdx());
        if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
        return __ps_284;
}

static tur_adt_Option__BoundedIdx some__spec__tur_adt_Option__BoundedIdx_int64_t(int64_t x) {
        tur_adt_Option__BoundedIdx __ps_285 = (ctor_Option_Some__BoundedIdx(x));
        if (tur_panicking) return (tur_adt_Option__BoundedIdx){0};
        return __ps_285;
}
