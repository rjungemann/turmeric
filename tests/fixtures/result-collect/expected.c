...
int main() {
        {
            void * v1_58 = vec_new();
            (void)v1_58;
            vec_push_ptr_((void *)(intptr_t)(v1_58), (void *)(intptr_t)(ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v1_58), (void *)(intptr_t)(ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v1_58), (void *)(intptr_t)(ok(INT64_C(30))));
            {
                void * c1_59 = result_collect((void *)(intptr_t)(v1_58));
                (void)c1_59;
                puts((ok_((void *)(intptr_t)(c1_59))) ? "true" : "false");
                {
                    void * ov_60 = ok_val_ptr((void *)(intptr_t)(c1_59));
                    (void)ov_60;
                    printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(ov_60))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_60), INT64_C(0))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_60), INT64_C(1))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_60), INT64_C(2))));
                }
            }
        }
        {
            void * v2_61 = vec_new();
            (void)v2_61;
            vec_push_ptr_((void *)(intptr_t)(v2_61), (void *)(intptr_t)(ok(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v2_61), (void *)(intptr_t)(err(INT64_C(99))));
            vec_push_ptr_((void *)(intptr_t)(v2_61), (void *)(intptr_t)(ok(INT64_C(2))));
            {
                void * c2_62 = result_collect((void *)(intptr_t)(v2_61));
                (void)c2_62;
                puts((err_((void *)(intptr_t)(c2_62))) ? "true" : "false");
                printf("%lld\n", (long long)(err_val((void *)(intptr_t)(c2_62))));
            }
        }
        {
            void * v3_63 = vec_new();
            (void)v3_63;
            vec_push_ptr_((void *)(intptr_t)(v3_63), (void *)(intptr_t)(ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v3_63), (void *)(intptr_t)(err(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v3_63), (void *)(intptr_t)(ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v3_63), (void *)(intptr_t)(err(INT64_C(2))));
            {
                void * p_64 = result_partition((void *)(intptr_t)(v3_63));
                (void)p_64;
                {
                    void * oks_65 = result_partition_ok((void *)(intptr_t)(p_64));
                    (void)oks_65;
                    {
                        void * errs_66 = result_partition_err((void *)(intptr_t)(p_64));
                        (void)errs_66;
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(oks_65))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_65), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_65), INT64_C(1))));
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(errs_66))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_66), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_66), INT64_C(1))));
                    }
                }
            }
        }
