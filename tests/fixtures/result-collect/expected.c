...
int main() {
        {
            void * v1_245 = vec_new();
            (void)v1_245;
            vec_push_ptr_((void *)(intptr_t)(v1_245), (void *)(intptr_t)(ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v1_245), (void *)(intptr_t)(ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v1_245), (void *)(intptr_t)(ok(INT64_C(30))));
            {
                void * c1_246 = result_collect((void *)(intptr_t)(v1_245));
                (void)c1_246;
                puts((ok_((void *)(intptr_t)(c1_246))) ? "true" : "false");
                {
                    void * ov_247 = ok_val_ptr((void *)(intptr_t)(c1_246));
                    (void)ov_247;
                    printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(ov_247))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_247), INT64_C(0))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_247), INT64_C(1))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_247), INT64_C(2))));
                }
            }
        }
        {
            void * v2_248 = vec_new();
            (void)v2_248;
            vec_push_ptr_((void *)(intptr_t)(v2_248), (void *)(intptr_t)(ok(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v2_248), (void *)(intptr_t)(err(INT64_C(99))));
            vec_push_ptr_((void *)(intptr_t)(v2_248), (void *)(intptr_t)(ok(INT64_C(2))));
            {
                void * c2_249 = result_collect((void *)(intptr_t)(v2_248));
                (void)c2_249;
                puts((err_((void *)(intptr_t)(c2_249))) ? "true" : "false");
                printf("%lld\n", (long long)(err_val((void *)(intptr_t)(c2_249))));
            }
        }
        {
            void * v3_250 = vec_new();
            (void)v3_250;
            vec_push_ptr_((void *)(intptr_t)(v3_250), (void *)(intptr_t)(ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v3_250), (void *)(intptr_t)(err(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v3_250), (void *)(intptr_t)(ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v3_250), (void *)(intptr_t)(err(INT64_C(2))));
            {
                void * p_251 = result_partition((void *)(intptr_t)(v3_250));
                (void)p_251;
                {
                    void * oks_252 = result_partition_ok((void *)(intptr_t)(p_251));
                    (void)oks_252;
                    {
                        void * errs_253 = result_partition_err((void *)(intptr_t)(p_251));
                        (void)errs_253;
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(oks_252))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_252), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_252), INT64_C(1))));
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(errs_253))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_253), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_253), INT64_C(1))));
                    }
                }
            }
        }
