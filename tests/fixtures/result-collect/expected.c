...
int main() {
        {
            void * v1_298 = vec_new();
            (void)v1_298;
            vec_push_ptr_((void *)(intptr_t)(v1_298), (void *)(intptr_t)(ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v1_298), (void *)(intptr_t)(ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v1_298), (void *)(intptr_t)(ok(INT64_C(30))));
            {
                void * c1_299 = result_collect((void *)(intptr_t)(v1_298));
                (void)c1_299;
                puts((ok_((void *)(intptr_t)(c1_299))) ? "true" : "false");
                {
                    void * ov_300 = ok_val_ptr((void *)(intptr_t)(c1_299));
                    (void)ov_300;
                    printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(ov_300))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_300), INT64_C(0))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_300), INT64_C(1))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_300), INT64_C(2))));
                }
            }
        }
        {
            void * v2_301 = vec_new();
            (void)v2_301;
            vec_push_ptr_((void *)(intptr_t)(v2_301), (void *)(intptr_t)(ok(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v2_301), (void *)(intptr_t)(err(INT64_C(99))));
            vec_push_ptr_((void *)(intptr_t)(v2_301), (void *)(intptr_t)(ok(INT64_C(2))));
            {
                void * c2_302 = result_collect((void *)(intptr_t)(v2_301));
                (void)c2_302;
                puts((err_((void *)(intptr_t)(c2_302))) ? "true" : "false");
                printf("%lld\n", (long long)(err_val((void *)(intptr_t)(c2_302))));
            }
        }
        {
            void * v3_303 = vec_new();
            (void)v3_303;
            vec_push_ptr_((void *)(intptr_t)(v3_303), (void *)(intptr_t)(ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v3_303), (void *)(intptr_t)(err(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v3_303), (void *)(intptr_t)(ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v3_303), (void *)(intptr_t)(err(INT64_C(2))));
            {
                void * p_304 = result_partition((void *)(intptr_t)(v3_303));
                (void)p_304;
                {
                    void * oks_305 = result_partition_ok((void *)(intptr_t)(p_304));
                    (void)oks_305;
                    {
                        void * errs_306 = result_partition_err((void *)(intptr_t)(p_304));
                        (void)errs_306;
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(oks_305))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_305), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_305), INT64_C(1))));
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(errs_306))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_306), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_306), INT64_C(1))));
                    }
                }
            }
        }
