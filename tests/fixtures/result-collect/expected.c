...
int main() {
        {
            void * v1_233 = vec_new();
            (void)v1_233;
            vec_push_ptr_((void *)(intptr_t)(v1_233), (void *)(intptr_t)(ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v1_233), (void *)(intptr_t)(ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v1_233), (void *)(intptr_t)(ok(INT64_C(30))));
            {
                void * c1_234 = result_collect((void *)(intptr_t)(v1_233));
                (void)c1_234;
                puts((ok_((void *)(intptr_t)(c1_234))) ? "true" : "false");
                {
                    void * ov_235 = ok_val_ptr((void *)(intptr_t)(c1_234));
                    (void)ov_235;
                    printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(ov_235))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_235), INT64_C(0))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_235), INT64_C(1))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_235), INT64_C(2))));
                }
            }
        }
        {
            void * v2_236 = vec_new();
            (void)v2_236;
            vec_push_ptr_((void *)(intptr_t)(v2_236), (void *)(intptr_t)(ok(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v2_236), (void *)(intptr_t)(err(INT64_C(99))));
            vec_push_ptr_((void *)(intptr_t)(v2_236), (void *)(intptr_t)(ok(INT64_C(2))));
            {
                void * c2_237 = result_collect((void *)(intptr_t)(v2_236));
                (void)c2_237;
                puts((err_((void *)(intptr_t)(c2_237))) ? "true" : "false");
                printf("%lld\n", (long long)(err_val((void *)(intptr_t)(c2_237))));
            }
        }
        {
            void * v3_238 = vec_new();
            (void)v3_238;
            vec_push_ptr_((void *)(intptr_t)(v3_238), (void *)(intptr_t)(ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v3_238), (void *)(intptr_t)(err(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v3_238), (void *)(intptr_t)(ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v3_238), (void *)(intptr_t)(err(INT64_C(2))));
            {
                void * p_239 = result_partition((void *)(intptr_t)(v3_238));
                (void)p_239;
                {
                    void * oks_240 = result_partition_ok((void *)(intptr_t)(p_239));
                    (void)oks_240;
                    {
                        void * errs_241 = result_partition_err((void *)(intptr_t)(p_239));
                        (void)errs_241;
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(oks_240))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_240), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_240), INT64_C(1))));
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(errs_241))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_241), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_241), INT64_C(1))));
                    }
                }
            }
        }
