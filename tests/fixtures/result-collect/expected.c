...
static void * u_result_collect(void *);
static void * u_result_partition(void *);
static void * u_result_partition_ok(void *);
static void * u_result_partition_err(void *);
...
static bool __inst_Eq_eq__Map(int64_t x, int64_t y) {
        return tmap_eq_(x, y, (int64_t)(intptr_t)(__fn_452));
}
...
static bool __inst_Eq_eq__Vec(int64_t x, int64_t y) {
        return tvec_eq_(x, y, (int64_t)(intptr_t)(__fn_472));
}
...
static bool __inst_Eq_eq__Option(int64_t x, int64_t y) {
        return toption_eq_(x, y, (int64_t)(intptr_t)(__fn_499));
}
...
static bool __inst_Eq_eq__Result(int64_t x, int64_t y) {
        return tresult_eq_(x, y, (int64_t)(intptr_t)(__fn_519), (int64_t)(intptr_t)(__fn_523));
}
...
static bool __inst_Eq_eq__Pair(int64_t x, int64_t y) {
        return tpair_eq_(x, y, (int64_t)(intptr_t)(__fn_539), (int64_t)(intptr_t)(__fn_543));
}
...
static bool __inst_Eq_eq__Cons(int64_t x, int64_t y) {
        return tlist_eq_(x, y, (int64_t)(intptr_t)(__fn_559));
}
...
static bool __inst_Eq_eq__MutableMap(int64_t x, int64_t y) {
        return tmutmap_eq_(x, y, (int64_t)(intptr_t)(__fn_630));
}
...
static void * u_result_collect(void * v) {
...
static void * u_result_partition(void * v) {
        struct { int64_t *data; size_t len; size_t cap; } *vec =
      (struct { int64_t *data; size_t len; size_t cap; } *)(void*)v;
  struct { bool is_ok; int64_t ok_val; int64_t err_val; } *rp;
  struct { int64_t *data; size_t len; size_t cap; } *ov = malloc(sizeof(*ov));
...
static void * u_result_partition_ok(void * pair) {
        struct { void *ok_vec; void *err_vec; } *p = (void*)pair;
  return p->ok_vec;
  
}

static void * u_result_partition_err(void * pair) {
        struct { void *ok_vec; void *err_vec; } *p = (void*)pair;
  return p->err_vec;
...
int main() {
        {
            void * v1_653 = vec_new();
            (void)v1_653;
            vec_push_ptr_((void *)(intptr_t)(v1_653), (void *)(intptr_t)(u_ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v1_653), (void *)(intptr_t)(u_ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v1_653), (void *)(intptr_t)(u_ok(INT64_C(30))));
            {
                void * c1_654 = u_result_collect((void *)(intptr_t)(v1_653));
                (void)c1_654;
                puts((u_ok_((void *)(intptr_t)(c1_654))) ? "true" : "false");
                {
                    void * ov_655 = ok_val_ptr((void *)(intptr_t)(c1_654));
                    (void)ov_655;
                    printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(ov_655))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_655), INT64_C(0))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_655), INT64_C(1))));
                    printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(ov_655), INT64_C(2))));
                }
            }
        }
        {
            void * v2_656 = vec_new();
            (void)v2_656;
            vec_push_ptr_((void *)(intptr_t)(v2_656), (void *)(intptr_t)(u_ok(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v2_656), (void *)(intptr_t)(u_err(INT64_C(99))));
            vec_push_ptr_((void *)(intptr_t)(v2_656), (void *)(intptr_t)(u_ok(INT64_C(2))));
            {
                void * c2_657 = u_result_collect((void *)(intptr_t)(v2_656));
                (void)c2_657;
                puts((u_err_((void *)(intptr_t)(c2_657))) ? "true" : "false");
                printf("%lld\n", (long long)(u_err_val((void *)(intptr_t)(c2_657))));
            }
        }
        {
            void * v3_658 = vec_new();
            (void)v3_658;
            vec_push_ptr_((void *)(intptr_t)(v3_658), (void *)(intptr_t)(u_ok(INT64_C(10))));
            vec_push_ptr_((void *)(intptr_t)(v3_658), (void *)(intptr_t)(u_err(INT64_C(1))));
            vec_push_ptr_((void *)(intptr_t)(v3_658), (void *)(intptr_t)(u_ok(INT64_C(20))));
            vec_push_ptr_((void *)(intptr_t)(v3_658), (void *)(intptr_t)(u_err(INT64_C(2))));
            {
                void * p_659 = u_result_partition((void *)(intptr_t)(v3_658));
                (void)p_659;
                {
                    void * oks_660 = u_result_partition_ok((void *)(intptr_t)(p_659));
                    (void)oks_660;
                    {
                        void * errs_661 = u_result_partition_err((void *)(intptr_t)(p_659));
                        (void)errs_661;
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(oks_660))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_660), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(oks_660), INT64_C(1))));
                        printf("%lld\n", (long long)(vec_len((void *)(intptr_t)(errs_661))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_661), INT64_C(0))));
                        printf("%lld\n", (long long)(vec_get((void *)(intptr_t)(errs_661), INT64_C(1))));
                    }
                }
            }
        }
