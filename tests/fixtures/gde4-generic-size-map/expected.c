...
static int64_t __inst_Size_size_int(int64_t);
static int64_t __inst_Size_size_Map(int64_t);
...
static int64_t count_hyit(int64_t);
static int64_t count_it__spec__int64_t_int64_t(int64_t);
...
static int64_t __inst_Size_size_int(int64_t x) {
        return INT64_C(-1);
}

typedef struct dict_Size_int {
    int64_t (*size)(int64_t);
} dict_Size_int;

static dict_Size_int dict_Size_int_singleton = {
    .size = __inst_Size_size_int,
};

static int64_t __inst_Size_size_Map(int64_t x) {
...
typedef struct dict_Size_Map {
    int64_t (*size)(int64_t);
} dict_Size_Map;

static dict_Size_Map dict_Size_Map_singleton = {
    .size = __inst_Size_size_Map,
};
...
static int64_t count_hyit(int64_t x) {
        return __inst_Size_size_int(x);
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t m0_894 = map_hynew();
            (void)m0_894;
            int64_t __t25;
            {
                const char * _un_untur_unmk_un_un_895 = "a";
                (void)_un_untur_unmk_un_un_895;
                __t25 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(m0_894, &_un_untur_unmk_un_un_895), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_895), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_895), INT64_C(1), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_895), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_895));
            }
            int64_t m1_896 = __t25;
            (void)m1_896;
            int64_t __t26;
            {
                const char * _un_untur_unmk_un_un_897 = "b";
                (void)_un_untur_unmk_un_un_897;
                __t26 = map_hyassoc_hyeq_hyo(tur_hymap_hykcheck(m1_896, &_un_untur_unmk_un_un_897), __inst_Hash_hash_cstr(_un_untur_unmk_un_un_897), __inst_MapKey_mk_hybox_cstr(_un_untur_unmk_un_un_897), INT64_C(2), __inst_MapKey_mk_hycmp_cstr(_un_untur_unmk_un_un_897), __inst_MapKey_mk_hyowned_qu_cstr(_un_untur_unmk_un_un_897));
            }
            int64_t m2_898 = __t26;
            (void)m2_898;
            printf("%lld\n", (long long)(count_it__spec__int64_t_int64_t(m0_894)));
            printf("%lld\n", (long long)(count_it__spec__int64_t_int64_t(m1_896)));
            printf("%lld\n", (long long)(count_it__spec__int64_t_int64_t(m2_898)));
        }
        printf("%lld\n", (long long)(count_hyit(INT64_C(42))));
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
}

static int64_t count_it__spec__int64_t_int64_t(int64_t x) {
        return __inst_Size_size_Map(x);
}
