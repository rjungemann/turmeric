...
int main(int argc, char **argv) {
        ...
        {
            int64_t m0_859 = map_new();
            (void)m0_859;
            int64_t __t25;
            {
                const char * __tur_mk___860 = "a";
                (void)__tur_mk___860;
                __t25 = map_assoc_eq_o(tur_map_kcheck(m0_859, &__tur_mk___860), __inst_Hash_hash_cstr(__tur_mk___860), __inst_MapKey_mk_box_cstr(__tur_mk___860), INT64_C(1), __inst_MapKey_mk_cmp_cstr(__tur_mk___860), __inst_MapKey_mk_owned__cstr(__tur_mk___860));
            }
            int64_t m1_861 = __t25;
            (void)m1_861;
            int64_t __t26;
            {
                const char * __tur_mk___862 = "b";
                (void)__tur_mk___862;
                __t26 = map_assoc_eq_o(tur_map_kcheck(m1_861, &__tur_mk___862), __inst_Hash_hash_cstr(__tur_mk___862), __inst_MapKey_mk_box_cstr(__tur_mk___862), INT64_C(2), __inst_MapKey_mk_cmp_cstr(__tur_mk___862), __inst_MapKey_mk_owned__cstr(__tur_mk___862));
            }
            int64_t m2_863 = __t26;
            (void)m2_863;
            printf("%lld\n", (long long)(count_it__spec__int64_t_int64_t(m0_859)));
            printf("%lld\n", (long long)(count_it__spec__int64_t_int64_t(m1_861)));
            printf("%lld\n", (long long)(count_it__spec__int64_t_int64_t(m2_863)));
        }
