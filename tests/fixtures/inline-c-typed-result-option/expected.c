...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            tur_result_box_t *__t24 = (tur_result_box_t *)(intptr_t)(r_889);
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t24->is_ok, .ok_val = (int64_t)(intptr_t)(__t24->ok_val), .err_val = __t24->err_val}))));
            tur_result_box_t *__t25 = (tur_result_box_t *)(intptr_t)(r_889);
            device_hyfree(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t25->is_ok, .ok_val = (int64_t)(intptr_t)(__t25->ok_val), .err_val = __t25->err_val}));
        }
        {
            int64_t e_890 = open_hydevice(INT64_C(-1));
            (void)e_890;
            puts((err_qu(e_890)) ? "true" : "false");
            tur_result_box_t *__t26 = (tur_result_box_t *)(intptr_t)(e_890);
            printf("%lld\n", (long long)(err_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t26->is_ok, .ok_val = (int64_t)(intptr_t)(__t26->ok_val), .err_val = __t26->err_val})));
        }
        {
