...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1288 = (tur_adt_Result__Device__int){.is_ok = __t154->is_ok, .ok_val = (int64_t)(__t154->ok_val), .err_val = __t154->err_val};
            (void)r_1288;
            tur_adt_Result__Device__int __t155 = r_1288;
            __auto_type __ps_156 = (ok_qu((int64_t)(intptr_t)(&__t155)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_156) ? "true" : "false");
            __auto_type __ps_157 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1288));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1289 = (tur_adt_Result__Device__int){.is_ok = __t161->is_ok, .ok_val = (int64_t)(__t161->ok_val), .err_val = __t161->err_val};
            (void)e_1289;
            tur_adt_Result__Device__int __t162 = e_1289;
            __auto_type __ps_163 = (err_qu((int64_t)(intptr_t)(&__t162)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_163) ? "true" : "false");
            __auto_type __ps_164 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1289));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_164));
        }
        {
            __auto_type __ps_165 = (maybe_hyopen(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        tur_option_t *__t166 = (tur_option_t *)(intptr_t)(__ps_165);
            tur_adt_Option__Device o_1290 = (__t166 ? (tur_adt_Option__Device){.is_some = __t166->is_some, .value = (int64_t)(__t166->value)} : (tur_adt_Option__Device){0});
            (void)o_1290;
            __auto_type __ps_167 = (some___spec__bool_tur_adt_Option__Device(o_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_167) ? "true" : "false");
            __auto_type __ps_168 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_169 = (device_hytag(__ps_168));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_169));
            __auto_type __ps_170 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree(__ps_170);
        }
        __auto_type __ps_171 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t172 = (tur_option_t *)(intptr_t)(__ps_171);
        __auto_type __ps_173 = (some___spec__bool_tur_adt_Option__Device((__t172 ? (tur_adt_Option__Device){.is_some = __t172->is_some, .value = (int64_t)(__t172->value)} : (tur_adt_Option__Device){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
