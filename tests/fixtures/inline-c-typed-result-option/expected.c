...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            __auto_type __ps_159 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1309));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_160 = (device_hytag(__ps_159));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_160));
            __auto_type __ps_161 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1309));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            __auto_type __ps_166 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1310));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_166));
        }
        {
            __auto_type __ps_167 = (maybe_hyopen(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            ...
            (void)o_1311;
            __auto_type __ps_169 = (some___spec__bool_tur_adt_Option__Device(o_1311));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_169) ? "true" : "false");
            __auto_type __ps_170 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1311));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_171 = (device_hytag(__ps_170));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_171));
            __auto_type __ps_172 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1311));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree(__ps_172);
        }
        __auto_type __ps_173 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t174 = (tur_option_t *)(intptr_t)(__ps_173);
        __auto_type __ps_175 = (some___spec__bool_tur_adt_Option__Device((__t174 ? (tur_adt_Option__Device){.is_some = __t174->is_some, .value = (int64_t)(__t174->value)} : (tur_adt_Option__Device){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
