...
static int64_t ok_hyval(int64_t r) {
        int64_t __t95 = 0;
        {
            ...
            switch (__scrut ? __scrut->tag : 0) {
            case 0: {
                int64_t v_914 = (int64_t)__scrut->as.Ok._0;
                __t95 = v_914;
                break;
            }
            case 1: {
...
static int64_t err_hyval(int64_t r) {
        int64_t __t96 = 0;
        {
            ...
            case 1: {
                int64_t e_918 = (int64_t)__scrut->as.Err._0;
                __t96 = e_918;
                break;
            }
            default: break;
        ...
        if (__ps_106) {
            bool __t107;
            {
                ...
                if ((t1_1075) == (INT64_C(0))) {
                    __t108 = (t2_1076) == (INT64_C(0));
                } else {
                    bool __t109;
                    if ((t2_1076) == (INT64_C(0))) {
                        __t109 = false;
                    } else {
                        bool __ps_110 = (cons_hyeq_hygo(t1_1075, t2_1076));
                        if (tur_panicking) return ((bool)0);
                        __t109 = __ps_110;
                    }
                    __t108 = __t109;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_116) {
            ...
            int64_t __t117;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1091 = (int64_t)(intptr_t)(__ps_121);
                (void)out_1091;
                __t117 = out_1091;
            }
            __t115 = __t117;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t126;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1166 = __ps_128;
            (void)iter_1166;
            void * __ps_129 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_130 = (hamt_slkeyeq((void *)(intptr_t)(__ps_129)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1167 = __ps_130;
            (void)keyeq_1167;
            void * __ps_131 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_132 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1166), (void *)(intptr_t)(__ps_131), (void *)(intptr_t)(keyeq_1167)));
            if (tur_panicking) return ((bool)0);
            bool result_1168 = __ps_132;
            (void)result_1168;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t153;
        {
            ...
            {
                tur_adt_Vec__int * __ps_155 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1295));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1296 = __ps_155;
                (void)_un_unv_1296;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1346 = __ps_160;
            (void)r_1346;
            int64_t __t161;
            bool __ps_162 = (schema_hydecode_hyok_qu(r_1346));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_162) {
                int64_t __ps_163 = (schema_hydecode_hyvalue(r_1346));
                if (tur_panicking) return ((int64_t)0);
                __t161 = __ps_163;
            } else {
                int64_t __ps_164 = (schema_hydecode_hyerrors(r_1346));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            (void)r_1371;
            bool __ps_168 = (ok_qu(r_1371));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_168) ? "true" : "false");
            int64_t __ps_169 = (ok_hyval(r_1371));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_170 = (device_hytag(__ps_169));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_170));
            int64_t __ps_171 = (ok_hyval(r_1371));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t e_1372 = __ps_172;
            (void)e_1372;
            bool __ps_173 = (err_qu(e_1372));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_173) ? "true" : "false");
            int64_t __ps_174 = (err_hyval(e_1372));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_174));
        }
        {
            ...
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t o_1373 = __ps_175;
            (void)o_1373;
            bool __ps_176 = (some_qu(o_1373));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            int64_t __ps_177 = (unwrap(o_1373));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_178 = (device_hytag(__ps_177));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_178));
            int64_t __ps_179 = (unwrap(o_1373));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree(__ps_179);
        }
        int64_t __ps_180 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        bool __ps_181 = (some_qu(__ps_180));
        /* panic-return-signal: ret ctype unknown; no propagation here */
