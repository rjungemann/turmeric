...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1276 = (tur_adt_Result__Device__int){.is_ok = __t178->is_ok, .ok_val = (int64_t)(__t178->ok_val), .err_val = __t178->err_val};
            (void)r_1276;
            tur_adt_Result__Device__int __t179 = r_1276;
            __auto_type __ps_180 = (ok_qu((int64_t)(intptr_t)(&__t179)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_180) ? "true" : "false");
            __auto_type __ps_181 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1276));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_182 = (device_hytag(__ps_181));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_182));
            __auto_type __ps_183 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1276));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1277 = (tur_adt_Result__Device__int){.is_ok = __t185->is_ok, .ok_val = (int64_t)(__t185->ok_val), .err_val = __t185->err_val};
            (void)e_1277;
            tur_adt_Result__Device__int __t186 = e_1277;
            __auto_type __ps_187 = (err_qu((int64_t)(intptr_t)(&__t186)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_187) ? "true" : "false");
            __auto_type __ps_188 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1277));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_188));
        }
        {
            __auto_type __ps_189 = (maybe_hyopen(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        tur_option_t *__t190 = (tur_option_t *)(intptr_t)(__ps_189);
            tur_adt_Option__Device o_1278 = (__t190 ? (tur_adt_Option__Device){.is_some = __t190->is_some, .value = (int64_t)(__t190->value)} : (tur_adt_Option__Device){0});
            (void)o_1278;
            __auto_type __ps_191 = (some___spec__bool_tur_adt_Option__Device(o_1278));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_191) ? "true" : "false");
            __auto_type __ps_192 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1278));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_193 = (device_hytag(__ps_192));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_193));
            __auto_type __ps_194 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1278));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree(__ps_194);
        }
        __auto_type __ps_195 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t196 = (tur_option_t *)(intptr_t)(__ps_195);
        __auto_type __ps_197 = (some___spec__bool_tur_adt_Option__Device((__t196 ? (tur_adt_Option__Device){.is_some = __t196->is_some, .value = (int64_t)(__t196->value)} : (tur_adt_Option__Device){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
