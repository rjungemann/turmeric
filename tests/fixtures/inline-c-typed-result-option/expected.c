...
int main(int argc, char **argv) {
        ...
        {
            int64_t r_1014 = open_hydevice(INT64_C(7));
            (void)r_1014;
            puts((ok_qu(r_1014)) ? "true" : "false");
            tur_result_box_t *__t42 = (tur_result_box_t *)(intptr_t)(r_1014);
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t42->is_ok, .ok_val = (int64_t)(intptr_t)(__t42->ok_val), .err_val = __t42->err_val}))));
            tur_result_box_t *__t43 = (tur_result_box_t *)(intptr_t)(r_1014);
            device_hyfree(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t43->is_ok, .ok_val = (int64_t)(intptr_t)(__t43->ok_val), .err_val = __t43->err_val}));
        }
        {
            int64_t e_1015 = open_hydevice(INT64_C(-1));
            (void)e_1015;
            puts((err_qu(e_1015)) ? "true" : "false");
            tur_result_box_t *__t44 = (tur_result_box_t *)(intptr_t)(e_1015);
            printf("%lld\n", (long long)(err_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t44->is_ok, .ok_val = (int64_t)(intptr_t)(__t44->ok_val), .err_val = __t44->err_val})));
        }
        {
            int64_t o_1016 = maybe_hyopen(INT64_C(5));
            (void)o_1016;
            tur_option_t *__t45 = (tur_option_t *)(intptr_t)(o_1016);
            ...
            tur_option_t *__t46 = (tur_option_t *)(intptr_t)(o_1016);
            ...
            tur_option_t *__t47 = (tur_option_t *)(intptr_t)(o_1016);
