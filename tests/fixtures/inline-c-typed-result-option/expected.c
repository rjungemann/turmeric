...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1615 = __t279;
            (void)r_1615;
            bool __ps_280 = (ok___spec__bool_tur_adt_Result__Device__int(r_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_280) ? "true" : "false");
            void * __ps_281 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_282 = (device_hytag((void *)(intptr_t)(__ps_281)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_282));
            void * __ps_283 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1616 = __t286;
            (void)e_1616;
            bool __ps_287 = (err___spec__bool_tur_adt_Result__Device__int(e_1616));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_287) ? "true" : "false");
            int64_t __ps_288 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1616));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_288));
        }
        {
            int64_t __ps_289 = (maybe_hyopen(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        int64_t __t290 = (int64_t)(intptr_t)(__ps_289);
            tur_adt_Option__Device __t291 = (__t290 ? (*(tur_adt_Option__Device *)(intptr_t)(__t290)) : (tur_adt_Option__Device){0});
            if (__t290) free((void *)(intptr_t)(__t290));
            tur_adt_Option__Device o_1617 = __t291;
            (void)o_1617;
            bool __ps_292 = (some___spec__bool_tur_adt_Option__Device(o_1617));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_292) ? "true" : "false");
            void * __ps_293 = (unwrap__spec__void___tur_adt_Option__Device(o_1617));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_294 = (device_hytag((void *)(intptr_t)(__ps_293)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_294));
            void * __ps_295 = (unwrap__spec__void___tur_adt_Option__Device(o_1617));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree((void *)(intptr_t)(__ps_295));
        }
        int64_t __ps_296 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t297 = (int64_t)(intptr_t)(__ps_296);
        bool __ps_298 = (some___spec__bool_tur_adt_Option__Device((__t297 ? (*(tur_adt_Option__Device *)(intptr_t)(__t297)) : (tur_adt_Option__Device){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_296) tur_region_free((void *)(intptr_t)__ps_296);
