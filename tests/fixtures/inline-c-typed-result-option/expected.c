...
int main(int argc, char **argv) {
        ...
        {
            int64_t r_1255 = open_hydevice(INT64_C(7));
            (void)r_1255;
            puts((ok_qu(r_1255)) ? "true" : "false");
            tur_result_box_t *__t55 = (tur_result_box_t *)(intptr_t)(r_1255);
            ...
            tur_result_box_t *__t56 = (tur_result_box_t *)(intptr_t)(r_1255);
        ...
        {
            int64_t e_1256 = open_hydevice(INT64_C(-1));
            (void)e_1256;
            puts((err_qu(e_1256)) ? "true" : "false");
            tur_result_box_t *__t57 = (tur_result_box_t *)(intptr_t)(e_1256);
        ...
        {
            int64_t o_1257 = maybe_hyopen(INT64_C(5));
            (void)o_1257;
            tur_option_t *__t58 = (tur_option_t *)(intptr_t)(o_1257);
            ...
            tur_option_t *__t59 = (tur_option_t *)(intptr_t)(o_1257);
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_Option__Device((__t59 ? (Option__Device){.is_some = __t59->is_some, .value = (int64_t)(intptr_t)(__t59->value)} : (Option__Device){0})))));
            tur_option_t *__t60 = (tur_option_t *)(intptr_t)(o_1257);
            device_hyfree(unwrap__spec__int64_t_Option__Device((__t60 ? (Option__Device){.is_some = __t60->is_some, .value = (int64_t)(intptr_t)(__t60->value)} : (Option__Device){0})));
        }
        tur_option_t *__t61 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(-1)));
        puts((some___spec__bool_Option__Device((__t61 ? (Option__Device){.is_some = __t61->is_some, .value = (int64_t)(intptr_t)(__t61->value)} : (Option__Device){0}))) ? "true" : "false");
        int64_t __t62;
        __t62 = INT64_C(0);
        return (int)__t62;
}
