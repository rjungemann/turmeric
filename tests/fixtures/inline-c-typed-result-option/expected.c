...
static int64_t open_hydevice(int64_t id) {
          if (id < 0) return tur_box_err(22);
  int64_t *h = (int64_t *)malloc(sizeof(int64_t));
  *h = 1000 + id;
  return tur_box_ok((int64_t)(intptr_t)h);
...
static int64_t maybe_hyopen(int64_t id) {
  ...
  int64_t *h = (int64_t *)malloc(sizeof(int64_t));
  *h = 2000 + id;
  return tur_box_some((int64_t)(intptr_t)h);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1615 = __t175;
            (void)r_1615;
            bool __ps_176 = (ok___spec__bool_tur_adt_Result__Device__int(r_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_176) ? "true" : "false");
            void * __ps_177 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_178 = (device_hytag((void *)(intptr_t)(__ps_177)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_178));
            void * __ps_179 = (ok_val__spec__void___tur_adt_Result__Device__int(r_1615));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1616 = __t182;
            (void)e_1616;
            bool __ps_183 = (err___spec__bool_tur_adt_Result__Device__int(e_1616));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_183) ? "true" : "false");
            int64_t __ps_184 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1616));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_184));
        }
        {
            int64_t __ps_185 = (maybe_hyopen(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        int64_t __t186 = (int64_t)(intptr_t)(__ps_185);
            tur_adt_Option__Device __t187 = (__t186 ? (*(tur_adt_Option__Device *)(intptr_t)(__t186)) : (tur_adt_Option__Device){0});
            if (__t186) free((void *)(intptr_t)(__t186));
            tur_adt_Option__Device o_1617 = __t187;
            (void)o_1617;
            bool __ps_188 = (some___spec__bool_tur_adt_Option__Device(o_1617));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_188) ? "true" : "false");
            void * __ps_189 = (unwrap__spec__void___tur_adt_Option__Device(o_1617));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_190 = (device_hytag((void *)(intptr_t)(__ps_189)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_190));
            void * __ps_191 = (unwrap__spec__void___tur_adt_Option__Device(o_1617));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree((void *)(intptr_t)(__ps_191));
        }
        int64_t __ps_192 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __t193 = (int64_t)(intptr_t)(__ps_192);
        bool __ps_194 = (some___spec__bool_tur_adt_Option__Device((__t193 ? (*(tur_adt_Option__Device *)(intptr_t)(__t193)) : (tur_adt_Option__Device){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        if (__ps_192) tur_region_free((void *)(intptr_t)__ps_192);
...
static tur_adt_Cons__int * tcons__spec__tur_adt_Cons__int___int64_t_int64_t(int64_t h, int64_t t) {
        tur_adt_Cons__int * __ps_196 = (ctor_Cons_Cons__int(h, (tur_adt_Cons__int *)(intptr_t)(t)));
...
static bool ok___spec__bool_tur_adt_Result__Device__int(tur_adt_Result__Device__int r) {
        bool __t198 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                void * _un_1116 = (void *)__scrut->as.Ok._0;
                __t198 = true;
                break;
            }
            case 1: {
...
static void * ok_val__spec__void___tur_adt_Result__Device__int(tur_adt_Result__Device__int r) {
        void * __t199 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                void * v_1122 = (void *)__scrut->as.Ok._0;
                __t199 = v_1122;
                break;
            }
            case 1: {
...
static int64_t err_val__spec__int64_t_tur_adt_Result__Device__int(tur_adt_Result__Device__int r) {
        int64_t __t201 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 0: {
                void * _un_1125 = (void *)__scrut->as.Ok._0;
                __t201 = ((int64_t)0);
                break;
            }
            case 1: {
                int64_t e_1126 = (int64_t)__scrut->as.Err._0;
                __t201 = e_1126;
                break;
            }
            default: break;
...
static bool some___spec__bool_tur_adt_Option__Device(tur_adt_Option__Device o) {
        bool __t202 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                void * _un_1066 = (void *)__scrut->as.Some._0;
                __t202 = true;
                break;
            }
            case 0: {
...
static void * unwrap__spec__void___tur_adt_Option__Device(tur_adt_Option__Device o) {
        void * __t203 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                void * v_1070 = (void *)__scrut->as.Some._0;
                __t203 = v_1070;
                break;
            }
            case 0: {
