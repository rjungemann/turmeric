...
int main(int argc, char **argv) {
        ...
        {
            int64_t r_1252 = open_hydevice(INT64_C(7));
            (void)r_1252;
            puts((ok_qu(r_1252)) ? "true" : "false");
            tur_result_box_t *__t50 = (tur_result_box_t *)(intptr_t)(r_1252);
            ...
            tur_result_box_t *__t51 = (tur_result_box_t *)(intptr_t)(r_1252);
        ...
        {
            int64_t e_1253 = open_hydevice(INT64_C(-1));
            (void)e_1253;
            puts((err_qu(e_1253)) ? "true" : "false");
            tur_result_box_t *__t52 = (tur_result_box_t *)(intptr_t)(e_1253);
        ...
        {
            int64_t o_1254 = maybe_hyopen(INT64_C(5));
            (void)o_1254;
            tur_option_t *__t53 = (tur_option_t *)(intptr_t)(o_1254);
            puts((some___spec__bool_Option__Device((__t53 ? (Option__Device){.is_some = __t53->is_some, .value = (int64_t)(intptr_t)(__t53->value)} : (Option__Device){0}))) ? "true" : "false");
            tur_option_t *__t54 = (tur_option_t *)(intptr_t)(o_1254);
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_Option__Device((__t54 ? (Option__Device){.is_some = __t54->is_some, .value = (int64_t)(intptr_t)(__t54->value)} : (Option__Device){0})))));
            tur_option_t *__t55 = (tur_option_t *)(intptr_t)(o_1254);
            device_hyfree(unwrap__spec__int64_t_Option__Device((__t55 ? (Option__Device){.is_some = __t55->is_some, .value = (int64_t)(intptr_t)(__t55->value)} : (Option__Device){0})));
        }
        tur_option_t *__t56 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(-1)));
        puts((some___spec__bool_Option__Device((__t56 ? (Option__Device){.is_some = __t56->is_some, .value = (int64_t)(intptr_t)(__t56->value)} : (Option__Device){0}))) ? "true" : "false");
        int64_t __t57;
        __t57 = INT64_C(0);
        return (int)__t57;
}
