...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1337 = (tur_adt_Result__Device__int){.is_ok = __t160->is_ok, .ok_val = (int64_t)(__t160->ok_val), .err_val = __t160->err_val};
            (void)r_1337;
            tur_adt_Result__Device__int __t161 = r_1337;
            bool __ps_162 = (ok_qu((int64_t)(intptr_t)(&__t161)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_162) ? "true" : "false");
            int64_t __ps_163 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1337));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_164 = (device_hytag(__ps_163));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_164));
            int64_t __ps_165 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1337));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1338 = (tur_adt_Result__Device__int){.is_ok = __t167->is_ok, .ok_val = (int64_t)(__t167->ok_val), .err_val = __t167->err_val};
            (void)e_1338;
            tur_adt_Result__Device__int __t168 = e_1338;
            bool __ps_169 = (err_qu((int64_t)(intptr_t)(&__t168)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_169) ? "true" : "false");
            int64_t __ps_170 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1338));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_170));
        }
        {
            ...
            tur_adt_Option__Device o_1339 = (__t172 ? (tur_adt_Option__Device){.is_some = __t172->is_some, .value = (int64_t)(__t172->value)} : (tur_adt_Option__Device){0});
            (void)o_1339;
            bool __ps_173 = (some___spec__bool_tur_adt_Option__Device(o_1339));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_173) ? "true" : "false");
            int64_t __ps_174 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1339));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_175 = (device_hytag(__ps_174));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_175));
            int64_t __ps_176 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1339));
            /* panic-return-signal: ret ctype unknown; no propagation here */
