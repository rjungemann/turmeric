...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Option__Device o_1290 = (__t186 ? (tur_adt_Option__Device){.is_some = __t186->is_some, .value = (int64_t)(__t186->value)} : (tur_adt_Option__Device){0});
            (void)o_1290;
            __auto_type __ps_187 = (some___spec__bool_tur_adt_Option__Device(o_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_187) ? "true" : "false");
            __auto_type __ps_188 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_189 = (device_hytag(__ps_188));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_189));
            __auto_type __ps_190 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
