...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            tur_result_box_t *__t44 = (tur_result_box_t *)(intptr_t)(r_1014);
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t44->is_ok, .ok_val = (int64_t)(intptr_t)(__t44->ok_val), .err_val = __t44->err_val}))));
            tur_result_box_t *__t45 = (tur_result_box_t *)(intptr_t)(r_1014);
            device_hyfree(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t45->is_ok, .ok_val = (int64_t)(intptr_t)(__t45->ok_val), .err_val = __t45->err_val}));
        }
        {
            int64_t e_1015 = open_hydevice(INT64_C(-1));
            (void)e_1015;
            puts((err_qu(e_1015)) ? "true" : "false");
            tur_result_box_t *__t46 = (tur_result_box_t *)(intptr_t)(e_1015);
            printf("%lld\n", (long long)(err_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t46->is_ok, .ok_val = (int64_t)(intptr_t)(__t46->ok_val), .err_val = __t46->err_val})));
        }
        {
            int64_t o_1016 = maybe_hyopen(INT64_C(5));
            (void)o_1016;
            tur_option_t *__t47 = (tur_option_t *)(intptr_t)(o_1016);
            puts((some___spec__bool_Option__Device((__t47 ? (Option__Device){.is_some = __t47->is_some, .value = (int64_t)(intptr_t)(__t47->value)} : (Option__Device){0}))) ? "true" : "false");
            tur_option_t *__t48 = (tur_option_t *)(intptr_t)(o_1016);
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_Option__Device((__t48 ? (Option__Device){.is_some = __t48->is_some, .value = (int64_t)(intptr_t)(__t48->value)} : (Option__Device){0})))));
            tur_option_t *__t49 = (tur_option_t *)(intptr_t)(o_1016);
            device_hyfree(unwrap__spec__int64_t_Option__Device((__t49 ? (Option__Device){.is_some = __t49->is_some, .value = (int64_t)(intptr_t)(__t49->value)} : (Option__Device){0})));
        }
        tur_option_t *__t50 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(-1)));
        puts((some___spec__bool_Option__Device((__t50 ? (Option__Device){.is_some = __t50->is_some, .value = (int64_t)(intptr_t)(__t50->value)} : (Option__Device){0}))) ? "true" : "false");
        int64_t __t51;
        __t51 = INT64_C(0);
        return (int)__t51;
}
