...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1290 = (tur_adt_Result__Device__int){.is_ok = __t156->is_ok, .ok_val = (int64_t)(__t156->ok_val), .err_val = __t156->err_val};
            (void)r_1290;
            tur_adt_Result__Device__int __t157 = r_1290;
            __auto_type __ps_158 = (ok_qu((int64_t)(intptr_t)(&__t157)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_158) ? "true" : "false");
            __auto_type __ps_159 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_160 = (device_hytag(__ps_159));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_160));
            __auto_type __ps_161 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1290));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1291 = (tur_adt_Result__Device__int){.is_ok = __t163->is_ok, .ok_val = (int64_t)(__t163->ok_val), .err_val = __t163->err_val};
            (void)e_1291;
            tur_adt_Result__Device__int __t164 = e_1291;
            __auto_type __ps_165 = (err_qu((int64_t)(intptr_t)(&__t164)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_165) ? "true" : "false");
            __auto_type __ps_166 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1291));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_166));
        }
        {
            ...
            tur_adt_Option__Device o_1292 = (__t168 ? (tur_adt_Option__Device){.is_some = __t168->is_some, .value = (int64_t)(__t168->value)} : (tur_adt_Option__Device){0});
            (void)o_1292;
            __auto_type __ps_169 = (some___spec__bool_tur_adt_Option__Device(o_1292));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_169) ? "true" : "false");
            __auto_type __ps_170 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1292));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            __auto_type __ps_171 = (device_hytag(__ps_170));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_171));
            __auto_type __ps_172 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1292));
            /* panic-return-signal: ret ctype unknown; no propagation here */
