...
int main(int argc, char **argv) {
        ...
        {
            int64_t r_909 = open_hydevice(INT64_C(7));
            (void)r_909;
            puts((ok_qu(r_909)) ? "true" : "false");
            tur_result_box_t *__t29 = (tur_result_box_t *)(intptr_t)(r_909);
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t29->is_ok, .ok_val = (int64_t)(intptr_t)(__t29->ok_val), .err_val = __t29->err_val}))));
            tur_result_box_t *__t30 = (tur_result_box_t *)(intptr_t)(r_909);
            device_hyfree(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t30->is_ok, .ok_val = (int64_t)(intptr_t)(__t30->ok_val), .err_val = __t30->err_val}));
        }
        {
            int64_t e_910 = open_hydevice(INT64_C(-1));
            (void)e_910;
            puts((err_qu(e_910)) ? "true" : "false");
            tur_result_box_t *__t31 = (tur_result_box_t *)(intptr_t)(e_910);
            printf("%lld\n", (long long)(err_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t31->is_ok, .ok_val = (int64_t)(intptr_t)(__t31->ok_val), .err_val = __t31->err_val})));
        }
        {
            int64_t o_911 = maybe_hyopen(INT64_C(5));
            (void)o_911;
            puts((some_qu(o_911)) ? "true" : "false");
            tur_option_t *__t32 = (tur_option_t *)(intptr_t)(o_911);
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_Option__Device((__t32 ? (Option__Device){.is_some = __t32->is_some, .value = (int64_t)(intptr_t)(__t32->value)} : (Option__Device){0})))));
            tur_option_t *__t33 = (tur_option_t *)(intptr_t)(o_911);
            device_hyfree(unwrap__spec__int64_t_Option__Device((__t33 ? (Option__Device){.is_some = __t33->is_some, .value = (int64_t)(intptr_t)(__t33->value)} : (Option__Device){0})));
        }
