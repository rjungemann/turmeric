...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1270 = (tur_adt_Result__Device__int){.is_ok = __t50->is_ok, .ok_val = (int64_t)(__t50->ok_val), .err_val = __t50->err_val};
            (void)r_1270;
            tur_adt_Result__Device__int __t51 = r_1270;
            puts((ok_qu((int64_t)(intptr_t)(&__t51))) ? "true" : "false");
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1270))));
            device_hyfree(ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1270));
        }
        {
                        tur_result_box_t *__t52 = (tur_result_box_t *)(intptr_t)(open_hydevice(INT64_C(-1)));
            tur_adt_Result__Device__int e_1271 = (tur_adt_Result__Device__int){.is_ok = __t52->is_ok, .ok_val = (int64_t)(__t52->ok_val), .err_val = __t52->err_val};
            (void)e_1271;
            tur_adt_Result__Device__int __t53 = e_1271;
            puts((err_qu((int64_t)(intptr_t)(&__t53))) ? "true" : "false");
            printf("%lld\n", (long long)(err_val__spec__int64_t_tur_adt_Result__Device__int(e_1271)));
        }
        {
                        tur_option_t *__t54 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(5)));
            tur_adt_Option__Device o_1272 = (__t54 ? (tur_adt_Option__Device){.is_some = __t54->is_some, .value = (int64_t)(__t54->value)} : (tur_adt_Option__Device){0});
            (void)o_1272;
            puts((some___spec__bool_tur_adt_Option__Device(o_1272)) ? "true" : "false");
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_tur_adt_Option__Device(o_1272))));
            device_hyfree(unwrap__spec__int64_t_tur_adt_Option__Device(o_1272));
        }
        tur_option_t *__t55 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(-1)));
        puts((some___spec__bool_tur_adt_Option__Device((__t55 ? (tur_adt_Option__Device){.is_some = __t55->is_some, .value = (int64_t)(__t55->value)} : (tur_adt_Option__Device){0}))) ? "true" : "false");
        int64_t __t56;
        __t56 = INT64_C(0);
        return (int)__t56;
}
