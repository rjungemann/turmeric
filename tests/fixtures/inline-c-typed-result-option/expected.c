...
int main(int argc, char **argv) {
        ...
        {
            int64_t r_1016 = open_hydevice(INT64_C(7));
            (void)r_1016;
            puts((ok_qu(r_1016)) ? "true" : "false");
            tur_result_box_t *__t51 = (tur_result_box_t *)(intptr_t)(r_1016);
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t51->is_ok, .ok_val = (int64_t)(intptr_t)(__t51->ok_val), .err_val = __t51->err_val}))));
            tur_result_box_t *__t52 = (tur_result_box_t *)(intptr_t)(r_1016);
            device_hyfree(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t52->is_ok, .ok_val = (int64_t)(intptr_t)(__t52->ok_val), .err_val = __t52->err_val}));
        }
        {
            int64_t e_1017 = open_hydevice(INT64_C(-1));
            (void)e_1017;
            puts((err_qu(e_1017)) ? "true" : "false");
            tur_result_box_t *__t53 = (tur_result_box_t *)(intptr_t)(e_1017);
            printf("%lld\n", (long long)(err_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t53->is_ok, .ok_val = (int64_t)(intptr_t)(__t53->ok_val), .err_val = __t53->err_val})));
        }
        {
            int64_t o_1018 = maybe_hyopen(INT64_C(5));
            (void)o_1018;
            tur_option_t *__t54 = (tur_option_t *)(intptr_t)(o_1018);
            puts((some___spec__bool_Option__Device((__t54 ? (Option__Device){.is_some = __t54->is_some, .value = (int64_t)(intptr_t)(__t54->value)} : (Option__Device){0}))) ? "true" : "false");
            tur_option_t *__t55 = (tur_option_t *)(intptr_t)(o_1018);
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_Option__Device((__t55 ? (Option__Device){.is_some = __t55->is_some, .value = (int64_t)(intptr_t)(__t55->value)} : (Option__Device){0})))));
            tur_option_t *__t56 = (tur_option_t *)(intptr_t)(o_1018);
            device_hyfree(unwrap__spec__int64_t_Option__Device((__t56 ? (Option__Device){.is_some = __t56->is_some, .value = (int64_t)(intptr_t)(__t56->value)} : (Option__Device){0})));
        }
        tur_option_t *__t57 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(-1)));
        puts((some___spec__bool_Option__Device((__t57 ? (Option__Device){.is_some = __t57->is_some, .value = (int64_t)(intptr_t)(__t57->value)} : (Option__Device){0}))) ? "true" : "false");
        int64_t __t58;
        __t58 = INT64_C(0);
        return (int)__t58;
}
