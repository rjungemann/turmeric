...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1339 = (tur_adt_Result__Device__int){.is_ok = __t161->is_ok, .ok_val = (int64_t)(__t161->ok_val), .err_val = __t161->err_val};
            (void)r_1339;
            tur_adt_Result__Device__int __t162 = r_1339;
            bool __ps_163 = (ok_qu((int64_t)(intptr_t)(&__t162)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_163) ? "true" : "false");
            int64_t __ps_164 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1339));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_165 = (device_hytag(__ps_164));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_165));
            int64_t __ps_166 = (ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1339));
            /* panic-return-signal: ret ctype unknown; no propagation here */
        ...
        }
        {
            ...
            tur_adt_Result__Device__int e_1340 = (tur_adt_Result__Device__int){.is_ok = __t168->is_ok, .ok_val = (int64_t)(__t168->ok_val), .err_val = __t168->err_val};
            (void)e_1340;
            tur_adt_Result__Device__int __t169 = e_1340;
            bool __ps_170 = (err_qu((int64_t)(intptr_t)(&__t169)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_170) ? "true" : "false");
            int64_t __ps_171 = (err_val__spec__int64_t_tur_adt_Result__Device__int(e_1340));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_171));
        }
        {
            int64_t __ps_172 = (maybe_hyopen(INT64_C(5)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
                        tur_option_t *__t173 = (tur_option_t *)(intptr_t)(__ps_172);
            tur_adt_Option__Device o_1341 = (__t173 ? (tur_adt_Option__Device){.is_some = __t173->is_some, .value = (int64_t)(__t173->value)} : (tur_adt_Option__Device){0});
            (void)o_1341;
            bool __ps_174 = (some___spec__bool_tur_adt_Option__Device(o_1341));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            puts((__ps_174) ? "true" : "false");
            int64_t __ps_175 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1341));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t __ps_176 = (device_hytag(__ps_175));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            printf("%lld\n", (long long)(__ps_176));
            int64_t __ps_177 = (unwrap__spec__int64_t_tur_adt_Option__Device(o_1341));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            device_hyfree(__ps_177);
        }
        int64_t __ps_178 = (maybe_hyopen(INT64_C(-1)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_option_t *__t179 = (tur_option_t *)(intptr_t)(__ps_178);
        bool __ps_180 = (some___spec__bool_tur_adt_Option__Device((__t179 ? (tur_adt_Option__Device){.is_some = __t179->is_some, .value = (int64_t)(__t179->value)} : (tur_adt_Option__Device){0})));
        /* panic-return-signal: ret ctype unknown; no propagation here */
