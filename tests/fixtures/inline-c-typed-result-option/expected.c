...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            tur_adt_Result__Device__int r_1273 = (tur_adt_Result__Device__int){.is_ok = __t55->is_ok, .ok_val = (int64_t)(__t55->ok_val), .err_val = __t55->err_val};
            (void)r_1273;
            tur_adt_Result__Device__int __t56 = r_1273;
            puts((ok_qu((int64_t)(intptr_t)(&__t56))) ? "true" : "false");
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1273))));
            device_hyfree(ok_val__spec__int64_t_tur_adt_Result__Device__int(r_1273));
        }
        {
                        tur_result_box_t *__t57 = (tur_result_box_t *)(intptr_t)(open_hydevice(INT64_C(-1)));
            tur_adt_Result__Device__int e_1274 = (tur_adt_Result__Device__int){.is_ok = __t57->is_ok, .ok_val = (int64_t)(__t57->ok_val), .err_val = __t57->err_val};
            (void)e_1274;
            tur_adt_Result__Device__int __t58 = e_1274;
            puts((err_qu((int64_t)(intptr_t)(&__t58))) ? "true" : "false");
            printf("%lld\n", (long long)(err_val__spec__int64_t_tur_adt_Result__Device__int(e_1274)));
        }
        {
                        tur_option_t *__t59 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(5)));
            tur_adt_Option__Device o_1275 = (__t59 ? (tur_adt_Option__Device){.is_some = __t59->is_some, .value = (int64_t)(__t59->value)} : (tur_adt_Option__Device){0});
            (void)o_1275;
            puts((some___spec__bool_tur_adt_Option__Device(o_1275)) ? "true" : "false");
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_tur_adt_Option__Device(o_1275))));
            device_hyfree(unwrap__spec__int64_t_tur_adt_Option__Device(o_1275));
        }
        tur_option_t *__t60 = (tur_option_t *)(intptr_t)(maybe_hyopen(INT64_C(-1)));
        puts((some___spec__bool_tur_adt_Option__Device((__t60 ? (tur_adt_Option__Device){.is_some = __t60->is_some, .value = (int64_t)(__t60->value)} : (tur_adt_Option__Device){0}))) ? "true" : "false");
        int64_t __t61;
        __t61 = INT64_C(0);
        return (int)__t61;
}
