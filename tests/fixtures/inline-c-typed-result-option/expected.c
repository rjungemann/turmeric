...
int main(int argc, char **argv) {
        ...
        {
            int64_t r_900 = open_hydevice(INT64_C(7));
            (void)r_900;
            puts((ok_qu(r_900)) ? "true" : "false");
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_Result__Device__int((*(Result__Device__int *)(intptr_t)(r_900))))));
            device_hyfree(ok_val__spec__int64_t_Result__Device__int((*(Result__Device__int *)(intptr_t)(r_900))));
        }
        {
            int64_t e_901 = open_hydevice(INT64_C(-1));
            (void)e_901;
            puts((err_qu(e_901)) ? "true" : "false");
            printf("%lld\n", (long long)(err_val__spec__int64_t_Result__Device__int((*(Result__Device__int *)(intptr_t)(e_901)))));
        }
        {
            int64_t o_902 = maybe_hyopen(INT64_C(5));
            (void)o_902;
            puts((some_qu(o_902)) ? "true" : "false");
            printf("%lld\n", (long long)(device_hytag(unwrap__spec__int64_t_Option__Device((*(Option__Device *)(intptr_t)(o_902))))));
            device_hyfree(unwrap__spec__int64_t_Option__Device((*(Option__Device *)(intptr_t)(o_902))));
        }
