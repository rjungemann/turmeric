...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            printf("%lld\n", (long long)(device_hytag(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t52->is_ok, .ok_val = (int64_t)(intptr_t)(__t52->ok_val), .err_val = __t52->err_val}))));
            tur_result_box_t *__t53 = (tur_result_box_t *)(intptr_t)(r_1016);
            device_hyfree(ok_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t53->is_ok, .ok_val = (int64_t)(intptr_t)(__t53->ok_val), .err_val = __t53->err_val}));
        }
        {
            int64_t e_1017 = open_hydevice(INT64_C(-1));
            (void)e_1017;
            puts((err_qu(e_1017)) ? "true" : "false");
            tur_result_box_t *__t54 = (tur_result_box_t *)(intptr_t)(e_1017);
            printf("%lld\n", (long long)(err_val__spec__int64_t_Result__Device__int((Result__Device__int){.is_ok = __t54->is_ok, .ok_val = (int64_t)(intptr_t)(__t54->ok_val), .err_val = __t54->err_val})));
        }
        {
            ...
            tur_option_t *__t57 = (tur_option_t *)(intptr_t)(o_1018);
