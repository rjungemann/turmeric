...
static int64_t geom__helper_qu(int64_t, int64_t);
static int64_t geom__use_hyit();
...
static int64_t geom__helper_qu(int64_t a, int64_t b) {
        int64_t __t172;
        if ((a) == (b)) {
            __t172 = INT64_C(1);
        } else {
...
static int64_t geom__use_hyit() {
    ...
    return (int)geom__helper_qu(7, 7);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_173 = (geom__use_hyit());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_173));
        return (int)0;
}
