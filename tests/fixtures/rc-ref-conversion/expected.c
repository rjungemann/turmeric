...
int main() {
        {
            ...
            *((int64_t *)__t0) = INT64_C(123);
            ...
            (void)r_213;
            {
                RcControlBlock *__t1 = tur_rc_from_ref(r_213, 3);
                RcControlBlock * rc_214 = __t1;
                (void)rc_214;
                tur_frame __frame_2;
                tur_frame_init(&__frame_2, NULL);
                int64_t __t3 = rc_strong_count(rc_214);
                printf("%lld\n", (long long)(__t3));
                struct __defer_env_4 __t6 = {.rc = rc_214};
        ...
        }
        {
            ...
            *__t7 = INT64_C(321);
            ...
            __t8->value = __t7;
            RcControlBlock * rc2_215 = __t8;
            (void)rc2_215;
            {
                void *__t9 = tur_ref_from_rc(rc2_215);
                void * r2_216 = __t9;
                (void)r2_216;
                int64_t __t10 = *((int64_t *)r2_216);
                printf("%lld\n", (long long)(__t10));
            }
        }
        int64_t __t11;
