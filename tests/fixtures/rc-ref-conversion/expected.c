...
struct __defer_env_4 {RcControlBlock * rc; };
...
int main() {
        {
            ...
            *((int64_t *)__t0) = INT64_C(123);
            ...
            (void)r_261;
            {
                RcControlBlock *__t1 = tur_rc_from_ref(r_261, 3);
                RcControlBlock * rc_262 = __t1;
                (void)rc_262;
                tur_frame __frame_2;
                tur_frame_init(&__frame_2, NULL);
                int64_t __t3 = rc_strong_count(rc_262);
                printf("%lld\n", (long long)(__t3));
                struct __defer_env_4 __t6 = {.rc = rc_262};
        ...
        }
        {
            ...
            *__t7 = INT64_C(321);
            ...
            __t8->value = __t7;
            RcControlBlock * rc2_263 = __t8;
            (void)rc2_263;
            {
                void *__t9 = tur_ref_from_rc(rc2_263);
                void * r2_264 = __t9;
                (void)r2_264;
                int64_t __t10 = *((int64_t *)r2_264);
                printf("%lld\n", (long long)(__t10));
            }
        }
        int64_t __t11;
