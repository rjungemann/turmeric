...
int main() {
        {
            ...
            *((int64_t *)__t0) = INT64_C(123);
            ...
            (void)r_214;
            {
                RcControlBlock *__t1 = tur_rc_from_ref(r_214, 3);
                RcControlBlock * rc_215 = __t1;
                (void)rc_215;
                tur_frame __frame_2;
                tur_frame_init(&__frame_2, NULL);
                int64_t __t3 = rc_strong_count(rc_215);
                printf("%lld\n", (long long)(__t3));
                struct __defer_env_4 __t6 = {.rc = rc_215};
        ...
        }
        {
            ...
            *__t7 = INT64_C(321);
            ...
            __t8->value = __t7;
            RcControlBlock * rc2_216 = __t8;
            (void)rc2_216;
            {
                void *__t9 = tur_ref_from_rc(rc2_216);
                void * r2_217 = __t9;
                (void)r2_217;
                int64_t __t10 = *((int64_t *)r2_217);
                printf("%lld\n", (long long)(__t10));
            }
        }
        int64_t __t11;
