...
static int64_t __effect_handler_2(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_197 = __k;
    int64_t __t3 = tur_effect_cont_resume((int64_t)(intptr_t)k_197, (int64_t)INT64_C(10));
    return (int64_t)__t3;
}
...
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_196 = __k;
    int64_t __t6 = tur_effect_cont_resume((int64_t)(intptr_t)k_196, (int64_t)INT64_C(42));
    return (int64_t)__t6;
}
