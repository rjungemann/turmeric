...
int main() {
        {
            int64_t a_31 = option_expect((void *)(intptr_t)(some(INT64_C(7))), "expected some(7)");
            (void)a_31;
            printf("%lld\n", (long long)(a_31));
        }
        {
            int64_t b_32 = result_expect((void *)(intptr_t)(ok(INT64_C(13))), "expected ok(13)");
            (void)b_32;
            printf("%lld\n", (long long)(b_32));
        }
        {
            int64_t x_33 = option_expect((void *)(intptr_t)(some(INT64_C(100))), "expected some");
            (void)x_33;
            {
                int64_t y_34 = result_expect((void *)(intptr_t)(ok(x_33)), "expected ok");
                (void)y_34;
                printf("%lld\n", (long long)(y_34));
            }
        }
