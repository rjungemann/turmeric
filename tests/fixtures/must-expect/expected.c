...
int main() {
        {
            int64_t a_626 = u_option_expect((void *)(intptr_t)(u_some(INT64_C(7))), "expected u-some(7)");
            (void)a_626;
            printf("%lld\n", (long long)(a_626));
        }
        {
            int64_t b_627 = u_result_expect((void *)(intptr_t)(u_ok(INT64_C(13))), "expected u-ok(13)");
            (void)b_627;
            printf("%lld\n", (long long)(b_627));
        }
        {
            int64_t x_628 = u_option_expect((void *)(intptr_t)(u_some(INT64_C(100))), "expected u-some");
            (void)x_628;
            {
                int64_t y_629 = u_result_expect((void *)(intptr_t)(u_ok(x_628)), "expected u-ok");
                (void)y_629;
                printf("%lld\n", (long long)(y_629));
            }
        }
