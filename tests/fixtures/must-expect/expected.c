...
int main() {
        {
            int64_t a_206 = option_expect((void *)(intptr_t)(some(INT64_C(7))), "expected some(7)");
            (void)a_206;
            printf("%lld\n", (long long)(a_206));
        }
        {
            int64_t b_207 = result_expect((void *)(intptr_t)(ok(INT64_C(13))), "expected ok(13)");
            (void)b_207;
            printf("%lld\n", (long long)(b_207));
        }
        {
            int64_t x_208 = option_expect((void *)(intptr_t)(some(INT64_C(100))), "expected some");
            (void)x_208;
            {
                int64_t y_209 = result_expect((void *)(intptr_t)(ok(x_208)), "expected ok");
                (void)y_209;
                printf("%lld\n", (long long)(y_209));
            }
        }
