...
int main() {
        {
            int64_t a_218 = option_expect((void *)(intptr_t)(some(INT64_C(7))), "expected some(7)");
            (void)a_218;
            printf("%lld\n", (long long)(a_218));
        }
        {
            int64_t b_219 = result_expect((void *)(intptr_t)(ok(INT64_C(13))), "expected ok(13)");
            (void)b_219;
            printf("%lld\n", (long long)(b_219));
        }
        {
            int64_t x_220 = option_expect((void *)(intptr_t)(some(INT64_C(100))), "expected some");
            (void)x_220;
            {
                int64_t y_221 = result_expect((void *)(intptr_t)(ok(x_220)), "expected ok");
                (void)y_221;
                printf("%lld\n", (long long)(y_221));
            }
        }
