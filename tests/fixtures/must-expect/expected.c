...
int main() {
        {
            int64_t a_271 = option_expect((void *)(intptr_t)(some(INT64_C(7))), "expected some(7)");
            (void)a_271;
            printf("%lld\n", (long long)(a_271));
        }
        {
            int64_t b_272 = result_expect((void *)(intptr_t)(ok(INT64_C(13))), "expected ok(13)");
            (void)b_272;
            printf("%lld\n", (long long)(b_272));
        }
        {
            int64_t x_273 = option_expect((void *)(intptr_t)(some(INT64_C(100))), "expected some");
            (void)x_273;
            {
                int64_t y_274 = result_expect((void *)(intptr_t)(ok(x_273)), "expected ok");
                (void)y_274;
                printf("%lld\n", (long long)(y_274));
            }
        }
