...
static int64_t __fn_875(void *, int64_t);
...
struct __env_877 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_875(void * __env_p_878, int64_t n) {
        struct __env_877 *__env___env_877 = (struct __env_877 *)__env_p_878;
        int64_t __t2;
        {
            int64_t offset_874 = __env___env_877->base;
            (void)offset_874;
            __t2 = (n) + (offset_874);
        }
        return __t2;
...
static int64_t make_adder(int64_t base) {
        int64_t __t4;
        {
            struct __env_877 *__t5 = (struct __env_877 *)malloc(sizeof(struct __env_877));
            __t5->__fn = (tur_thunk_int64_t_int64_t_t)__fn_875;
            __t5->base = base;
            void *__t6 = __t5;
            void * f_880 = __t6;
            (void)f_880;
            __t4 = __fn_875(f_880, INT64_C(5));
        }
        return __t4;
}
