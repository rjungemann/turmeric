...
static int64_t __fn_697(void *, int64_t);
...
struct __env_699 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_697(void * __env_p_700, int64_t n) {
        struct __env_699 *__env___env_699 = (struct __env_699 *)__env_p_700;
        int64_t __t0;
        {
            int64_t offset_696 = __env___env_699->base;
            (void)offset_696;
            __t0 = (n) + (offset_696);
        }
        return __t0;
...
static int64_t make_adder(int64_t base) {
        int64_t __t2;
        {
            struct __env_699 *__t3 = (struct __env_699 *)malloc(sizeof(struct __env_699));
            __t3->__fn = (tur_thunk_int64_t_int64_t_t)__fn_697;
            __t3->base = base;
            void *__t4 = __t3;
            void * f_702 = __t4;
            (void)f_702;
            __t2 = __fn_697(f_702, INT64_C(5));
        }
        return __t2;
}
