...
static int64_t __fn_856(void *, int64_t);
...
struct __env_858 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_856(void * __env_p_859, int64_t n) {
        struct __env_858 *__env___env_858 = (struct __env_858 *)__env_p_859;
        int64_t __t20;
        {
            int64_t offset_855 = __env___env_858->base;
            (void)offset_855;
            __t20 = (n) + (offset_855);
        }
        return __t20;
...
static int64_t make_adder(int64_t base) {
        int64_t __t26;
        {
            struct __env_858 *__t27 = (struct __env_858 *)malloc(sizeof(struct __env_858));
            __t27->__fn = (tur_thunk_int64_t_int64_t_t)__fn_856;
            __t27->base = base;
            void *__t28 = __t27;
            int64_t f_861 = (int64_t)(intptr_t)(__t28);
            (void)f_861;
            __t26 = __fn_856((void *)(intptr_t)(f_861), INT64_C(5));
        }
        return __t26;
}
