...
static int64_t __fn_848(void *, int64_t);
...
struct __env_850 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_848(void * __env_p_851, int64_t n) {
        struct __env_850 *__env___env_850 = (struct __env_850 *)__env_p_851;
        int64_t __t2;
        {
            int64_t offset_847 = __env___env_850->base;
            (void)offset_847;
            __t2 = (n) + (offset_847);
        }
        return __t2;
...
static int64_t make_adder(int64_t base) {
        int64_t __t4;
        {
            struct __env_850 *__t5 = (struct __env_850 *)malloc(sizeof(struct __env_850));
            __t5->__fn = (tur_thunk_int64_t_int64_t_t)__fn_848;
            __t5->base = base;
            void *__t6 = __t5;
            void * f_853 = __t6;
            (void)f_853;
            __t4 = __fn_848(f_853, INT64_C(5));
        }
        return __t4;
}
