...
static int64_t __fn_700(void *, int64_t);
...
struct __env_702 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_700(void * __env_p_703, int64_t n) {
        struct __env_702 *__env___env_702 = (struct __env_702 *)__env_p_703;
        int64_t __t0;
        {
            int64_t offset_699 = __env___env_702->base;
            (void)offset_699;
            __t0 = (n) + (offset_699);
        }
        return __t0;
...
static int64_t make_adder(int64_t base) {
        int64_t __t2;
        {
            struct __env_702 *__t3 = (struct __env_702 *)malloc(sizeof(struct __env_702));
            __t3->__fn = (tur_thunk_int64_t_int64_t_t)__fn_700;
            __t3->base = base;
            void *__t4 = __t3;
            void * f_705 = __t4;
            (void)f_705;
            __t2 = __fn_700(f_705, INT64_C(5));
        }
        return __t2;
}
