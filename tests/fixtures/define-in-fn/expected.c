...
static int64_t __fn_760(void *, int64_t);
...
struct __env_762 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_760(void * __env_p_763, int64_t n) {
        struct __env_762 *__env___env_762 = (struct __env_762 *)__env_p_763;
        int64_t __t0;
        {
            int64_t offset_759 = __env___env_762->base;
            (void)offset_759;
            __t0 = (n) + (offset_759);
        }
        return __t0;
...
static int64_t make_adder(int64_t base) {
        int64_t __t2;
        {
            struct __env_762 *__t3 = (struct __env_762 *)malloc(sizeof(struct __env_762));
            __t3->__fn = (tur_thunk_int64_t_int64_t_t)__fn_760;
            __t3->base = base;
            void *__t4 = __t3;
            void * f_765 = __t4;
            (void)f_765;
            __t2 = __fn_760(f_765, INT64_C(5));
        }
        return __t2;
}
