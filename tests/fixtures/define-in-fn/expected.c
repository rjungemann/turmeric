...
struct __env_799 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_797(void * __env_p_800, int64_t n) {
        struct __env_799 *__env___env_799 = (struct __env_799 *)__env_p_800;
        int64_t __t1;
        {
            int64_t offset_796 = __env___env_799->base;
            (void)offset_796;
            __t1 = (n) + (offset_796);
        }
        return __t1;
...
static int64_t make_adder(int64_t base) {
        int64_t __t3;
        {
            struct __env_799 *__t4 = (struct __env_799 *)malloc(sizeof(struct __env_799));
            __t4->__fn = (tur_thunk_int64_t_int64_t_t)__fn_797;
            __t4->base = base;
            void *__t5 = __t4;
            void * f_802 = __t5;
            (void)f_802;
            __t3 = __fn_797(f_802, INT64_C(5));
        }
        return __t3;
}
