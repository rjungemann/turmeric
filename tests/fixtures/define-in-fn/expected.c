...
static int64_t __fn_768(void *, int64_t);
...
struct __env_770 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_768(void * __env_p_771, int64_t n) {
        struct __env_770 *__env___env_770 = (struct __env_770 *)__env_p_771;
        int64_t __t1;
        {
            int64_t offset_767 = __env___env_770->base;
            (void)offset_767;
            __t1 = (n) + (offset_767);
        }
        return __t1;
...
static int64_t make_adder(int64_t base) {
        int64_t __t3;
        {
            struct __env_770 *__t4 = (struct __env_770 *)malloc(sizeof(struct __env_770));
            __t4->__fn = (tur_thunk_int64_t_int64_t_t)__fn_768;
            __t4->base = base;
            void *__t5 = __t4;
            void * f_773 = __t5;
            (void)f_773;
            __t3 = __fn_768(f_773, INT64_C(5));
        }
        return __t3;
}
