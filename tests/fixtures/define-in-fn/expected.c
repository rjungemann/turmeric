...
static int64_t __fn_812(void *, int64_t);
...
struct __env_814 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_812(void * __env_p_815, int64_t n) {
        struct __env_814 *__env___env_814 = (struct __env_814 *)__env_p_815;
        int64_t __t2;
        {
            int64_t offset_811 = __env___env_814->base;
            (void)offset_811;
            __t2 = (n) + (offset_811);
        }
        return __t2;
...
static int64_t make_adder(int64_t base) {
        int64_t __t4;
        {
            struct __env_814 *__t5 = (struct __env_814 *)malloc(sizeof(struct __env_814));
            __t5->__fn = (tur_thunk_int64_t_int64_t_t)__fn_812;
            __t5->base = base;
            void *__t6 = __t5;
            void * f_817 = __t6;
            (void)f_817;
            __t4 = __fn_812(f_817, INT64_C(5));
        }
        return __t4;
}
