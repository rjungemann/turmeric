...
static int64_t __fn_880(void *, int64_t);
...
static int64_t make_adder(int64_t);
...
struct __env_882 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_880(void * __env_p_883, int64_t n) {
        struct __env_882 *__env___env_882 = (struct __env_882 *)__env_p_883;
        int64_t __t20;
        {
            int64_t offset_879 = __env___env_882->base;
            (void)offset_879;
            __t20 = (n) + (offset_879);
        }
        return __t20;
        ...
        if (tnil_qu(l1)) {
            ...
            if (tnil_qu(l2)) {
                ...
                if ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), list_head(l1), list_head(l2))) {
                    __t23 = list_eq_qu(list_tail(l1), list_tail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t23 = false;
                }
                __t22 = __t23;
...
static int64_t __cons_fmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            __t24 = tcons((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_head(cell)), __cons_fmap(list_tail(cell), (void *)(intptr_t)(f)));
        }
        return __t24;
}
...
static int64_t list_concat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            __t25 = tcons(list_head(l1), list_concat(list_tail(l1), l2));
        }
        return __t25;
}
...
static int64_t make_adder(int64_t base) {
        int64_t __t26;
        {
            struct __env_882 *__t27 = (struct __env_882 *)malloc(sizeof(struct __env_882));
            __t27->__fn = (tur_thunk_int64_t_int64_t_t)__fn_880;
            __t27->base = base;
            void *__t28 = __t27;
...
int main(int argc, char **argv) {
    ...
    printf("%lld\n", (long long)(make_adder(INT64_C(10))));
    return 0;
}
