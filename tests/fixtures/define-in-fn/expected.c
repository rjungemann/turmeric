...
static int64_t __fn_691(void *, int64_t);
...
struct __env_693 { tur_thunk_int64_t_int64_t_t __fn; int64_t base; };
static int64_t __fn_691(void * __env_p_694, int64_t n) {
        struct __env_693 *__env___env_693 = (struct __env_693 *)__env_p_694;
        int64_t __t0;
        {
            int64_t offset_690 = __env___env_693->base;
            (void)offset_690;
            __t0 = ((n) + (offset_690));
        }
        return __t0;
...
static int64_t make_adder(int64_t base) {
        int64_t __t2;
        {
            struct __env_693 *__t3 = (struct __env_693 *)malloc(sizeof(struct __env_693));
            __t3->__fn = (tur_thunk_int64_t_int64_t_t)__fn_691;
            __t3->base = base;
            void *__t4 = __t3;
            void * f_696 = __t4;
            (void)f_696;
            __t2 = __fn_691(f_696, INT64_C(5));
        }
        return __t2;
}
