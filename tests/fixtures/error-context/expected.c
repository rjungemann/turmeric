...
int main() {
        {
            void * r1_228 = err("file not found");
            (void)r1_228;
            {
                void * r2_229 = err_context((void *)(intptr_t)(r1_228), "reading config");
                (void)r2_229;
                if (ok_((void *)(intptr_t)(r2_229))) {
                    puts("unexpected ok");
                } else {
                    puts(err_val_cstr((void *)(intptr_t)(r2_229)));
                }
            }
        }
        {
            void * r3_230 = ok(INT64_C(42));
            (void)r3_230;
            {
                void * r4_231 = err_context((void *)(intptr_t)(r3_230), "some context");
                (void)r4_231;
                if (ok_((void *)(intptr_t)(r4_231))) {
        ...
        {
            void * e1_232 = io_error("connection refused");
            (void)e1_232;
            puts(show_io_error((void *)(intptr_t)(e1_232)));
        }
        {
            void * e2_233 = parse_error_simple("unexpected token", INT64_C(12));
            (void)e2_233;
            puts(show_parse_error((void *)(intptr_t)(e2_233)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
