...
static void * u_err_cstr(const char *);
static bool u_ok_(void *);
static const char * u_err_val_cstr(void *);
static void * u_err_context(void *, const char *);
...
static void * u_err_cstr(const char * x) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *r = malloc(sizeof(*r));
...
static const char * u_err_val_cstr(void * r) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
  return (const char*)(intptr_t)res->err_val;
  
}

static void * u_err_context(void * r, const char * ctx) {
        extern size_t strlen(const char*);
  struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
  if (res == NULL || res->is_ok) return r;
  const char *orig = (const char *)(intptr_t)res->err_val;
...
static void * io_error(const char * msg) {
...
static const char * show_io_error(void * err) {
        typedef struct { const char *message; int errno_; } IoError;
...
static void * parse_error_simple(const char * msg, int64_t line) {
...
static const char * show_parse_error(void * err) {
        typedef struct { const char *message; int line; int col; const char *file; } ParseError;
...
int main() {
        {
            void * r1_636 = u_err_cstr("file not found");
            (void)r1_636;
            {
                void * r2_637 = u_err_context((void *)(intptr_t)(r1_636), "reading config");
                (void)r2_637;
                if (u_ok_((void *)(intptr_t)(r2_637))) {
                    puts("unexpected ok");
                } else {
                    puts(u_err_val_cstr((void *)(intptr_t)(r2_637)));
                }
            }
        }
        {
            void * r3_638 = u_ok(INT64_C(42));
            (void)r3_638;
            {
                void * r4_639 = u_err_context((void *)(intptr_t)(r3_638), "some context");
                (void)r4_639;
                if (u_ok_((void *)(intptr_t)(r4_639))) {
        ...
        {
            void * e1_640 = io_error("connection refused");
            (void)e1_640;
            puts(show_io_error((void *)(intptr_t)(e1_640)));
        }
        {
            void * e2_641 = parse_error_simple("unexpected token", INT64_C(12));
            (void)e2_641;
            puts(show_parse_error((void *)(intptr_t)(e2_641)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
