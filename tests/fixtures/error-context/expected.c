...
int main() {
        {
            ...
            (void)r1_41;
            {
                void * r2_42 = err_context((void *)(intptr_t)(r1_41), "reading config");
                (void)r2_42;
                if (ok_((void *)(intptr_t)(r2_42))) {
                    puts("unexpected ok");
                } else {
                    puts(err_val_cstr((void *)(intptr_t)(r2_42)));
                }
            }
        }
        {
            ...
            (void)r3_43;
            {
                void * r4_44 = err_context((void *)(intptr_t)(r3_43), "some context");
                (void)r4_44;
                if (ok_((void *)(intptr_t)(r4_44))) {
        ...
        }
        {
            ...
            (void)e1_45;
            puts(show_io_error((void *)(intptr_t)(e1_45)));
        }
        {
            void * e2_46 = parse_error_simple("unexpected token", INT64_C(12));
            (void)e2_46;
            puts(show_parse_error((void *)(intptr_t)(e2_46)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
