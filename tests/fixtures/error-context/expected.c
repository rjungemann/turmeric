...
static const char * err_val_cstr(void *);
...
static const char * err_val_cstr(void * r) {
        struct { bool is_ok; int64_t ok_val; int64_t err_val; } *res = (void*)r;
...
int main() {
        {
            void * r1_281 = err("file not found");
            (void)r1_281;
            {
                void * r2_282 = err_context((void *)(intptr_t)(r1_281), "reading config");
                (void)r2_282;
                if (ok_((void *)(intptr_t)(r2_282))) {
                    puts("unexpected ok");
                } else {
                    puts(err_val_cstr((void *)(intptr_t)(r2_282)));
                }
            }
        }
        {
            void * r3_283 = ok(INT64_C(42));
            (void)r3_283;
            {
                void * r4_284 = err_context((void *)(intptr_t)(r3_283), "some context");
                (void)r4_284;
                if (ok_((void *)(intptr_t)(r4_284))) {
        ...
        {
            void * e1_285 = io_error("connection refused");
            (void)e1_285;
            puts(show_io_error((void *)(intptr_t)(e1_285)));
        }
        {
            void * e2_286 = parse_error_simple("unexpected token", INT64_C(12));
            (void)e2_286;
            puts(show_parse_error((void *)(intptr_t)(e2_286)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
