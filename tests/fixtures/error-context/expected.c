...
int main() {
        {
            void * r1_216 = err("file not found");
            (void)r1_216;
            {
                void * r2_217 = err_context((void *)(intptr_t)(r1_216), "reading config");
                (void)r2_217;
                if (ok_((void *)(intptr_t)(r2_217))) {
                    puts("unexpected ok");
                } else {
                    puts(err_val_cstr((void *)(intptr_t)(r2_217)));
                }
            }
        }
        {
            void * r3_218 = ok(INT64_C(42));
            (void)r3_218;
            {
                void * r4_219 = err_context((void *)(intptr_t)(r3_218), "some context");
                (void)r4_219;
                if (ok_((void *)(intptr_t)(r4_219))) {
        ...
        {
            void * e1_220 = io_error("connection refused");
            (void)e1_220;
            puts(show_io_error((void *)(intptr_t)(e1_220)));
        }
        {
            void * e2_221 = parse_error_simple("unexpected token", INT64_C(12));
            (void)e2_221;
            puts(show_parse_error((void *)(intptr_t)(e2_221)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
