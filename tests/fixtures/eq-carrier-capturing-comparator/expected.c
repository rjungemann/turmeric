...
static bool __fn_891(void *, int64_t, int64_t);
...
struct __env_893 { tur_thunk_bool_int64_t_int64_t_t __fn; int64_t k; };
static bool __fn_891(void * __env_p_894, int64_t a, int64_t b) {
        struct __env_893 *__env___env_893 = (struct __env_893 *)__env_p_894;
        return ((a) + (__env___env_893->k)) == ((b) + (__env___env_893->k));
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t k_888 = INT64_C(1000);
            (void)k_888;
            struct __env_893 *__t25 = (struct __env_893 *)malloc(sizeof(struct __env_893));
            __t25->__fn = (tur_thunk_bool_int64_t_int64_t_t)__fn_891;
            __t25->k = k_888;
            void *__t26 = __t25;
            int64_t cmp_896 = (int64_t)(intptr_t)(__t26);
            (void)cmp_896;
            puts((option_hyeq_qu(some(INT64_C(5)), some(INT64_C(5)), (int64_t)(intptr_t)(cmp_896))) ? "true" : "false");
            puts((option_hyeq_qu(some(INT64_C(5)), some(INT64_C(9)), (int64_t)(intptr_t)(cmp_896))) ? "true" : "false");
            {
                int64_t v1_897 = vec_hynew();
                (void)v1_897;
                int64_t v2_898 = vec_hynew();
                (void)v2_898;
                vec_hypush_ex(v1_897, INT64_C(3));
                vec_hypush_ex(v1_897, INT64_C(4));
                vec_hypush_ex(v2_898, INT64_C(3));
                vec_hypush_ex(v2_898, INT64_C(4));
                puts((vec_hyeq_qu(v1_897, v2_898, (int64_t)(intptr_t)(cmp_896))) ? "true" : "false");
                vec_hypush_ex(v2_898, INT64_C(5));
                puts((vec_hyeq_qu(v1_897, v2_898, (int64_t)(intptr_t)(cmp_896))) ? "true" : "false");
            }
            {
                int64_t a_899 = mutmap_hynew();
                (void)a_899;
                int64_t b_900 = mutmap_hynew();
                (void)b_900;
                int64_t c_901 = mutmap_hynew();
                (void)c_901;
                mutmap_hyset_ex(a_899, INT64_C(1), INT64_C(1), INT64_C(100));
                mutmap_hyset_ex(a_899, INT64_C(2), INT64_C(2), INT64_C(200));
                mutmap_hyset_ex(b_900, INT64_C(2), INT64_C(2), INT64_C(200));
                mutmap_hyset_ex(b_900, INT64_C(1), INT64_C(1), INT64_C(100));
                mutmap_hyset_ex(c_901, INT64_C(1), INT64_C(1), INT64_C(100));
                mutmap_hyset_ex(c_901, INT64_C(2), INT64_C(2), INT64_C(999));
                puts((mutmap_hyeq_qu(a_899, b_900, (int64_t)(intptr_t)(cmp_896))) ? "true" : "false");
                puts((mutmap_hyeq_qu(a_899, c_901, (int64_t)(intptr_t)(cmp_896))) ? "true" : "false");
                mutmap_hyfree(a_899);
                mutmap_hyfree(b_900);
                mutmap_hyfree(c_901);
            }
