...
static double sig__probe__apply_hytwice(int64_t, double);
...
static double __fn_895(double x) {
        return (x) * (2.0);
}
...
static double sig__probe__apply_hytwice(int64_t f, double x) {
        return sig__probe__sample((int64_t)(intptr_t)(f), sig__probe__sample((int64_t)(intptr_t)(f), x));
}

static double sig__probe__sample(int64_t sig, double t) {
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            double (*double_it)(double) = __fn_895;
            (void)double_it;
            int64_t *__t26 = (int64_t *)malloc(2 * sizeof(int64_t));
            __t26[0] = (int64_t)(intptr_t)__tur_fatshim_double_double;
            __t26[1] = (int64_t)(intptr_t)double_it;
            void *__t27 = __t26;
            printf("%g\n", (double)(sig__probe__apply_hytwice((int64_t)(intptr_t)(__t27), 1.0)));
            int64_t __t28;
            __t28 = INT64_C(0);
            __t25 = __t28;
        }
