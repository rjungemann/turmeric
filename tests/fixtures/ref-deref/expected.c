...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t153;
        {
            ...
            *((int64_t *)__t154) = INT64_C(42);
            void * r_1279 = __t154;
            (void)r_1279;
            tur_frame __frame_155;
            tur_frame_init(&__frame_155, NULL);
            int64_t __t156 = *((int64_t *)r_1279);
            printf("%lld\n", (long long)(__t156));
            struct __defer_env_157 __t159 = {.r = r_1279};
            tur_frame_push_defer(&__frame_155, __defer_158, &__t159);
            int64_t __t160;
            __t160 = INT64_C(0);
