...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t264;
        {
            ...
            *((int64_t *)__t265) = INT64_C(42);
            void * r_1467 = __t265;
            (void)r_1467;
            tur_frame __frame_266;
            tur_frame_init(&__frame_266, NULL);
            int64_t __t267 = *((int64_t *)r_1467);
            printf("%lld\n", (long long)(__t267));
            struct __defer_env_268 __t270 = {.r = r_1467};
            tur_frame_push_defer(&__frame_266, __defer_269, &__t270);
            int64_t __t271;
            __t271 = INT64_C(0);
