...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t155;
        {
            ...
            *((int64_t *)__t156) = INT64_C(42);
            void * r_1300 = __t156;
            (void)r_1300;
            tur_frame __frame_157;
            tur_frame_init(&__frame_157, NULL);
            int64_t __t158 = *((int64_t *)r_1300);
            printf("%lld\n", (long long)(__t158));
            struct __defer_env_159 __t161 = {.r = r_1300};
            tur_frame_push_defer(&__frame_157, __defer_160, &__t161);
            int64_t __t162;
            __t162 = INT64_C(0);
