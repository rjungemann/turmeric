...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t277;
        {
            ...
            *((int64_t *)__t278) = INT64_C(42);
            void * r_1606 = __t278;
            (void)r_1606;
            tur_frame __frame_279;
            tur_frame_init(&__frame_279, NULL);
            int64_t __t280 = *((int64_t *)r_1606);
            printf("%lld\n", (long long)(__t280));
            struct __defer_env_281 __t283 = {.r = r_1606};
            tur_frame_push_defer(&__frame_279, __defer_282, &__t283);
            int64_t __t284;
            __t284 = INT64_C(0);
