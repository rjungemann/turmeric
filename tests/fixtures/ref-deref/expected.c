...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t172;
        {
            ...
            *((int64_t *)__t173) = INT64_C(42);
            void * r_1432 = __t173;
            (void)r_1432;
            tur_frame __frame_174;
            tur_frame_init(&__frame_174, NULL);
            int64_t __t175 = *((int64_t *)r_1432);
            printf("%lld\n", (long long)(__t175));
            struct __defer_env_176 __t178 = {.r = r_1432};
            tur_frame_push_defer(&__frame_174, __defer_177, &__t178);
            int64_t __t179;
            __t179 = INT64_C(0);
