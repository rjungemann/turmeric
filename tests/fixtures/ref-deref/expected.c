...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t232;
        {
            ...
            *((int64_t *)__t233) = INT64_C(42);
            void * r_1463 = __t233;
            (void)r_1463;
            tur_frame __frame_234;
            tur_frame_init(&__frame_234, NULL);
            int64_t __t235 = *((int64_t *)r_1463);
            printf("%lld\n", (long long)(__t235));
            struct __defer_env_236 __t238 = {.r = r_1463};
            tur_frame_push_defer(&__frame_234, __defer_237, &__t238);
            int64_t __t239;
            __t239 = INT64_C(0);
