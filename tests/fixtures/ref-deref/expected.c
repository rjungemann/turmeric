...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t163;
        {
            ...
            *((int64_t *)__t164) = INT64_C(42);
            void * r_1362 = __t164;
            (void)r_1362;
            tur_frame __frame_165;
            tur_frame_init(&__frame_165, NULL);
            int64_t __t166 = *((int64_t *)r_1362);
            printf("%lld\n", (long long)(__t166));
            struct __defer_env_167 __t169 = {.r = r_1362};
            tur_frame_push_defer(&__frame_165, __defer_168, &__t169);
            int64_t __t170;
            __t170 = INT64_C(0);
