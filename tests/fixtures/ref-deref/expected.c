...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t275;
        {
            ...
            *((int64_t *)__t276) = INT64_C(42);
            void * r_1606 = __t276;
            (void)r_1606;
            tur_frame __frame_277;
            tur_frame_init(&__frame_277, NULL);
            int64_t __t278 = *((int64_t *)r_1606);
            printf("%lld\n", (long long)(__t278));
            struct __defer_env_279 __t281 = {.r = r_1606};
            tur_frame_push_defer(&__frame_277, __defer_280, &__t281);
            int64_t __t282;
            __t282 = INT64_C(0);
