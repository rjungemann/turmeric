...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t173;
        {
            ...
            *((int64_t *)__t174) = INT64_C(42);
            void * r_1606 = __t174;
            (void)r_1606;
            tur_frame __frame_175;
            tur_frame_init(&__frame_175, NULL);
            int64_t __t176 = *((int64_t *)r_1606);
            printf("%lld\n", (long long)(__t176));
            struct __defer_env_177 __t179 = {.r = r_1606};
            tur_frame_push_defer(&__frame_175, __defer_178, &__t179);
            int64_t __t180;
            __t180 = INT64_C(0);
