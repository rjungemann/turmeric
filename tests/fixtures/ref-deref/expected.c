...
int main(int argc, char **argv) {
        ...
        int64_t __t181;
        {
            ...
            *((int64_t *)__t182) = INT64_C(42);
            void * r_1264 = __t182;
            (void)r_1264;
            tur_frame __frame_183;
            tur_frame_init(&__frame_183, NULL);
            int64_t __t184 = *((int64_t *)r_1264);
            printf("%lld\n", (long long)(__t184));
            struct __defer_env_185 __t187 = {.r = r_1264};
            tur_frame_push_defer(&__frame_183, __defer_186, &__t187);
            int64_t __t188;
            __t188 = INT64_C(0);
