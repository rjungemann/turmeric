...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t180;
        {
            ...
            *((int64_t *)__t181) = INT64_C(42);
            void * r_1436 = __t181;
            (void)r_1436;
            tur_frame __frame_182;
            tur_frame_init(&__frame_182, NULL);
            int64_t __t183 = *((int64_t *)r_1436);
            printf("%lld\n", (long long)(__t183));
            struct __defer_env_184 __t186 = {.r = r_1436};
            tur_frame_push_defer(&__frame_182, __defer_185, &__t186);
            int64_t __t187;
            __t187 = INT64_C(0);
