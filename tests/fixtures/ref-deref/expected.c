...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t159;
        {
            ...
            *((int64_t *)__t160) = INT64_C(42);
            void * r_1326 = __t160;
            (void)r_1326;
            tur_frame __frame_161;
            tur_frame_init(&__frame_161, NULL);
            int64_t __t162 = *((int64_t *)r_1326);
            printf("%lld\n", (long long)(__t162));
            struct __defer_env_163 __t165 = {.r = r_1326};
            tur_frame_push_defer(&__frame_161, __defer_164, &__t165);
            int64_t __t166;
            __t166 = INT64_C(0);
