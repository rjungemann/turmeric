...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t160;
        {
            ...
            *((int64_t *)__t161) = INT64_C(42);
            void * r_1330 = __t161;
            (void)r_1330;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            int64_t __t163 = *((int64_t *)r_1330);
            printf("%lld\n", (long long)(__t163));
            struct __defer_env_164 __t166 = {.r = r_1330};
            tur_frame_push_defer(&__frame_162, __defer_165, &__t166);
            int64_t __t167;
            __t167 = INT64_C(0);
