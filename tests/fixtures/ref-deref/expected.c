...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t267;
        {
            ...
            *((int64_t *)__t268) = INT64_C(42);
            void * r_1465 = __t268;
            (void)r_1465;
            tur_frame __frame_269;
            tur_frame_init(&__frame_269, NULL);
            int64_t __t270 = *((int64_t *)r_1465);
            printf("%lld\n", (long long)(__t270));
            struct __defer_env_271 __t273 = {.r = r_1465};
            tur_frame_push_defer(&__frame_269, __defer_272, &__t273);
            int64_t __t274;
            __t274 = INT64_C(0);
