...
int main(int argc, char **argv) {
        ...
        int64_t __t177;
        {
            ...
            *((int64_t *)__t178) = INT64_C(42);
            void * r_1267 = __t178;
            (void)r_1267;
            tur_frame __frame_179;
            tur_frame_init(&__frame_179, NULL);
            int64_t __t180 = *((int64_t *)r_1267);
            printf("%lld\n", (long long)(__t180));
            struct __defer_env_181 __t183 = {.r = r_1267};
            tur_frame_push_defer(&__frame_179, __defer_182, &__t183);
            int64_t __t184;
            __t184 = INT64_C(0);
