...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t179;
        {
            ...
            *((int64_t *)__t180) = INT64_C(42);
            void * r_1434 = __t180;
            (void)r_1434;
            tur_frame __frame_181;
            tur_frame_init(&__frame_181, NULL);
            int64_t __t182 = *((int64_t *)r_1434);
            printf("%lld\n", (long long)(__t182));
            struct __defer_env_183 __t185 = {.r = r_1434};
            tur_frame_push_defer(&__frame_181, __defer_184, &__t185);
            int64_t __t186;
            __t186 = INT64_C(0);
