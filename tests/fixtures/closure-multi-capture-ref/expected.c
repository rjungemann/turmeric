...
struct __env_214 { int64_t __fn; int64_t v; int64_t a; int64_t b; };
static int64_t __fn_212(void * __env_p_215) {
        struct __env_214 *__env___env_214 = (struct __env_214 *)__env_p_215;
        return ((__env___env_214->v) + (((__env___env_214->a) + (__env___env_214->b))));
}
...
int main() {
        int64_t __t0;
        {
            ...
            *((int64_t *)__t1) = INT64_C(5);
            ...
            int64_t __t7;
            {
                int64_t a_209 = INT64_C(10);
                (void)a_209;
                int64_t __t8;
                {
                    int64_t b_210 = INT64_C(20);
                    (void)b_210;
                    int64_t __t9;
                    {
                        int64_t __t10 = *((int64_t *)r_208);
                        int64_t v_211 = __t10;
                        (void)v_211;
                        int64_t __t11;
                        {
                            struct __env_214 *__t12 = (struct __env_214 *)malloc(sizeof(struct __env_214));
                            __t12->__fn = (int64_t)(intptr_t)__fn_212;
                            __t12->v = v_211;
                            __t12->a = a_209;
                            __t12->b = b_210;
                            void *__t13 = __t12;
