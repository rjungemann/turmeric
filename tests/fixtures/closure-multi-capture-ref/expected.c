...
struct __env_202 { int64_t __fn; int64_t v; int64_t a; int64_t b; };
static int64_t __fn_200(void * __env_p_203) {
        struct __env_202 *__env___env_202 = (struct __env_202 *)__env_p_203;
        return ((__env___env_202->v) + (((__env___env_202->a) + (__env___env_202->b))));
}
...
int main() {
        int64_t __t0;
        {
            ...
            *((int64_t *)__t1) = INT64_C(5);
            ...
            int64_t __t7;
            {
                int64_t a_197 = INT64_C(10);
                (void)a_197;
                int64_t __t8;
                {
                    int64_t b_198 = INT64_C(20);
                    (void)b_198;
                    int64_t __t9;
                    {
                        int64_t __t10 = *((int64_t *)r_196);
                        int64_t v_199 = __t10;
                        (void)v_199;
                        int64_t __t11;
                        {
                            struct __env_202 *__t12 = (struct __env_202 *)malloc(sizeof(struct __env_202));
                            __t12->__fn = (int64_t)(intptr_t)__fn_200;
                            __t12->v = v_199;
                            __t12->a = a_197;
                            __t12->b = b_198;
                            void *__t13 = __t12;
