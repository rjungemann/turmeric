...
struct __env_267 { int64_t __fn; int64_t v; int64_t a; int64_t b; };
static int64_t __fn_265(void * __env_p_268) {
        struct __env_267 *__env___env_267 = (struct __env_267 *)__env_p_268;
        return ((__env___env_267->v) + (((__env___env_267->a) + (__env___env_267->b))));
}
...
int main() {
        int64_t __t0;
        {
            ...
            *((int64_t *)__t1) = INT64_C(5);
            ...
            struct __defer_env_3 __t5 = {.r = r_261};
            tur_frame_push_defer(&__frame_2, __defer_4, &__t5);
            int64_t __t6;
            int64_t __t7;
            {
                int64_t a_262 = INT64_C(10);
                (void)a_262;
                int64_t __t8;
                {
                    int64_t b_263 = INT64_C(20);
                    (void)b_263;
                    int64_t __t9;
                    {
                        int64_t __t10 = *((int64_t *)r_261);
                        int64_t v_264 = __t10;
                        (void)v_264;
                        int64_t __t11;
                        {
                            struct __env_267 *__t12 = (struct __env_267 *)malloc(sizeof(struct __env_267));
                            __t12->__fn = (int64_t)(intptr_t)__fn_265;
                            __t12->v = v_264;
                            __t12->a = a_262;
                            __t12->b = b_263;
                            void *__t13 = __t12;
