...
struct __env_622 { int64_t __fn; int64_t v; int64_t a; int64_t b; };
static int64_t __fn_620(void * __env_p_623) {
        struct __env_622 *__env___env_622 = (struct __env_622 *)__env_p_623;
        return ((__env___env_622->v) + (((__env___env_622->a) + (__env___env_622->b))));
}
...
int main() {
        int64_t __t0;
        {
            ...
            *((int64_t *)__t1) = INT64_C(5);
            ...
            struct __defer_env_3 __t5 = {.r = r_616};
            tur_frame_push_defer(&__frame_2, __defer_4, &__t5);
            int64_t __t6;
            int64_t __t7;
            {
                int64_t a_617 = INT64_C(10);
                (void)a_617;
                int64_t __t8;
                {
                    int64_t b_618 = INT64_C(20);
                    (void)b_618;
                    int64_t __t9;
                    {
                        int64_t __t10 = *((int64_t *)r_616);
                        int64_t v_619 = __t10;
                        (void)v_619;
                        int64_t __t11;
                        {
                            struct __env_622 *__t12 = (struct __env_622 *)malloc(sizeof(struct __env_622));
                            __t12->__fn = (int64_t)(intptr_t)__fn_620;
                            __t12->v = v_619;
                            __t12->a = a_617;
                            __t12->b = b_618;
                            void *__t13 = __t12;
