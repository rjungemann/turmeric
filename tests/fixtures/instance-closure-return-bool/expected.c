...
static bool __fn_893(int64_t);
static tur_fnptr_bool_int64_t_t __inst_HasPred_pred_hyof_PredW(int64_t);
...
static bool call_hythin(int64_t, int64_t);
...
static bool __fn_893(int64_t x) {
        return (x) > (INT64_C(0));
}

static tur_fnptr_bool_int64_t_t __inst_HasPred_pred_hyof_PredW(int64_t self) {
        return __fn_893;
}

typedef struct dict_HasPred_PredW {
    tur_fnptr_bool_int64_t_t (*pred_hyof)(int64_t);
} dict_HasPred_PredW;

static dict_HasPred_PredW dict_HasPred_PredW_singleton = {
    .pred_hyof = __inst_HasPred_pred_hyof_PredW,
};
...
static bool call_hythin(int64_t f, int64_t x) {
...
int main(int argc, char **argv) {
        ...
        {
            int64_t g = (int64_t)(intptr_t)(__inst_HasPred_pred_hyof_PredW((int64_t)(INT64_C(0))));
            (void)g;
            puts((call_hythin((int64_t)(intptr_t)(g), INT64_C(7))) ? "true" : "false");
            puts((call_hythin((int64_t)(intptr_t)(g), INT64_C(-3))) ? "true" : "false");
        }
        int64_t __t25;
        __t25 = INT64_C(0);
        return (int)__t25;
