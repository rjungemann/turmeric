...
static int64_t __fn_222(int64_t x) {
...
int main() {
        {
            int64_t result_224 = __bind_option(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_222));
            (void)result_224;
            puts((__opt_some_(result_224)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_224)));
        }
        {
            int64_t result2_225 = __bind_option(__opt_some(INT64_C(7)), (int64_t)(intptr_t)(__opt_some));
            (void)result2_225;
            puts((__opt_some_(result2_225)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result2_225)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
