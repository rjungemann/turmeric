...
static int64_t __fn_275(int64_t);
...
static int64_t __fn_275(int64_t x) {
...
int main() {
        {
            int64_t result_277 = __bind_option(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_275));
            (void)result_277;
            puts((__opt_some_(result_277)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_277)));
        }
        {
            int64_t result2_278 = __bind_option(__opt_some(INT64_C(7)), (int64_t)(intptr_t)(__opt_some));
            (void)result2_278;
            puts((__opt_some_(result2_278)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result2_278)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
