...
static int64_t __fn_35(int64_t);
...
static int64_t __fn_35(int64_t x) {
...
int main() {
        {
            int64_t result_37 = __bind_option(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_35));
            (void)result_37;
            puts((__opt_some_(result_37)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_37)));
        }
        {
            int64_t result2_38 = __bind_option(__opt_some(INT64_C(7)), (int64_t)(intptr_t)(__opt_some));
            (void)result2_38;
            puts((__opt_some_(result2_38)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result2_38)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
