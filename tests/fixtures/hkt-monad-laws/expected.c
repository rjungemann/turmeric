...
static int64_t __fn_630(int64_t);
...
static int64_t __fn_630(int64_t x) {
...
int main() {
        {
            int64_t result_632 = __bind_option(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_630));
            (void)result_632;
            puts((__opt_some_(result_632)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_632)));
        }
        {
            int64_t result2_633 = __bind_option(__opt_some(INT64_C(7)), (int64_t)(intptr_t)(__opt_some));
            (void)result2_633;
            puts((__opt_some_(result2_633)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result2_633)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
