...
static int64_t __fn_210(int64_t);
...
static int64_t __fn_210(int64_t x) {
...
int main() {
        {
            int64_t result_212 = __bind_option(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_210));
            (void)result_212;
            puts((__opt_some_(result_212)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_212)));
        }
        {
            int64_t result2_213 = __bind_option(__opt_some(INT64_C(7)), (int64_t)(intptr_t)(__opt_some));
            (void)result2_213;
            puts((__opt_some_(result2_213)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result2_213)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
