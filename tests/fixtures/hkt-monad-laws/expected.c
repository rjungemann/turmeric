...
static int64_t __fn_15(int64_t x) {
...
int main() {
        {
            int64_t result_17 = __bind_option(__opt_some(INT64_C(5)), (int64_t)(intptr_t)(__fn_15));
            (void)result_17;
            puts((__opt_some_(result_17)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result_17)));
        }
        {
            int64_t result2_18 = __bind_option(__opt_some(INT64_C(7)), (int64_t)(intptr_t)(__opt_some));
            (void)result2_18;
            puts((__opt_some_(result2_18)) ? "true" : "false");
            printf("%lld\n", (long long)(__opt_unwrap(result2_18)));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
