...
struct __env_860 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; int64_t n; };
static int64_t __fn_858(void * __env_p_861, int64_t y) {
        struct __env_860 *__env___env_860 = (struct __env_860 *)__env_p_861;
        return ((__env___env_860->x) + (y)) + (__env___env_860->n);
}

struct __env_865 { int64_t __fn; int64_t n; };
...
static int64_t adder(int64_t n) {
        ...
        __t27->__fn = (int64_t)(intptr_t)__fn_863;
        __t27->n = n;
        void *__t28 = __t27;
        return __t28;
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            (void)f1;
            int64_t f2_871 = call_fat((int64_t)(intptr_t)(f1), INT64_C(20));
            (void)f2_871;
            printf("%lld\n", (long long)(call_fat(f2_871, INT64_C(3))));
        }
        int64_t __t29;
        __t29 = INT64_C(0);
        return (int)__t29;
