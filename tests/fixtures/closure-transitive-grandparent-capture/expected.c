...
struct __env_884 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; int64_t n; };
static int64_t __fn_882(void * __env_p_885, int64_t y) {
        struct __env_884 *__env___env_884 = (struct __env_884 *)__env_p_885;
        return ((__env___env_884->x) + (y)) + (__env___env_884->n);
}

struct __env_889 { int64_t __fn; int64_t n; };
static int64_t __fn_887(void * __env_p_890, int64_t x) {
        struct __env_889 *__env___env_889 = (struct __env_889 *)__env_p_890;
        struct __env_884 *__t20 = (struct __env_884 *)malloc(sizeof(struct __env_884));
        __t20->__fn = (tur_thunk_int64_t_int64_t_t)__fn_882;
        __t20->x = x;
        __t20->n = __env___env_889->n;
        void *__t21 = __t20;
        return __t21;
}
...
static int64_t adder(int64_t n) {
        struct __env_889 *__t27 = (struct __env_889 *)malloc(sizeof(struct __env_889));
        __t27->__fn = (int64_t)(intptr_t)__fn_887;
        __t27->n = n;
        void *__t28 = __t27;
        return __t28;
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            (void)f1;
            int64_t f2_895 = call_fat((int64_t)(intptr_t)(f1), INT64_C(20));
            (void)f2_895;
            printf("%lld\n", (long long)(call_fat(f2_895, INT64_C(3))));
        }
        int64_t __t29;
        __t29 = INT64_C(0);
        return (int)__t29;
