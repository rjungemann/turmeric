...
struct __env_895 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; int64_t n; };
static int64_t __fn_893(void * __env_p_896, int64_t y) {
        struct __env_895 *__env___env_895 = (struct __env_895 *)__env_p_896;
        return ((__env___env_895->x) + (y)) + (__env___env_895->n);
}

struct __env_900 { int64_t __fn; int64_t n; };
static int64_t __fn_898(void * __env_p_901, int64_t x) {
        struct __env_900 *__env___env_900 = (struct __env_900 *)__env_p_901;
        struct __env_895 *__t20 = (struct __env_895 *)malloc(sizeof(struct __env_895));
        __t20->__fn = (tur_thunk_int64_t_int64_t_t)__fn_893;
        __t20->x = x;
...
static int64_t adder(int64_t n) {
        struct __env_900 *__t27 = (struct __env_900 *)malloc(sizeof(struct __env_900));
...
int main(int argc, char **argv) {
        ...
        {
            int64_t f1 = (int64_t)(intptr_t)(adder(INT64_C(100)));
            (void)f1;
            int64_t f2_906 = call_hyfat((int64_t)(intptr_t)(f1), INT64_C(20));
            (void)f2_906;
            printf("%lld\n", (long long)(call_hyfat(f2_906, INT64_C(3))));
        }
        int64_t __t29;
        __t29 = INT64_C(0);
        return (int)__t29;
