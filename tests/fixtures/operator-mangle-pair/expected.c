...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            int64_t s_900 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_900;
            int64_t p_901 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_901;
            int64_t d_902 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_902;
            int64_t b_903 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_903;
            printf("%lld\n", (long long)(s_900));
            printf("%lld\n", (long long)(p_901));
            printf("%lld\n", (long long)(d_902));
