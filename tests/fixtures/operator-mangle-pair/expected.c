...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t12[1] = (int64_t)(intptr_t)__fn_787;
        void *__t13 = __t12;
...
int main(int argc, char **argv) {
        ...
        int64_t __t21;
        {
            int64_t s_876 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_876;
            int64_t p_877 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_877;
            int64_t d_878 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_878;
            int64_t b_879 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_879;
            printf("%lld\n", (long long)(s_876));
            printf("%lld\n", (long long)(p_877));
            printf("%lld\n", (long long)(d_878));
