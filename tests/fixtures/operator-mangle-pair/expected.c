...
int main(int argc, char **argv) {
        ...
        int64_t __t50;
        {
            int64_t s_1273 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1273;
            int64_t p_1274 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1274;
            int64_t d_1275 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1275;
            int64_t b_1276 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1276;
            printf("%lld\n", (long long)(s_1273));
            printf("%lld\n", (long long)(p_1274));
            printf("%lld\n", (long long)(d_1275));
