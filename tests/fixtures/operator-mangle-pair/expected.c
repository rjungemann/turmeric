...
int main(int argc, char **argv) {
        ...
        int64_t __t42;
        {
            int64_t s_1032 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1032;
            int64_t p_1033 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1033;
            int64_t d_1034 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1034;
            int64_t b_1035 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1035;
            printf("%lld\n", (long long)(s_1032));
            printf("%lld\n", (long long)(p_1033));
            printf("%lld\n", (long long)(d_1034));
