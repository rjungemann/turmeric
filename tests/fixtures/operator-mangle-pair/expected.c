...
int main(int argc, char **argv) {
        ...
        int64_t __t44;
        {
            int64_t s_1034 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1034;
            int64_t p_1035 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1035;
            int64_t d_1036 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1036;
            int64_t b_1037 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1037;
            printf("%lld\n", (long long)(s_1034));
            printf("%lld\n", (long long)(p_1035));
            printf("%lld\n", (long long)(d_1036));
