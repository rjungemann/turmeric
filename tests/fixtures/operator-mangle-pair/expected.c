...
int main(int argc, char **argv) {
        ...
        int64_t __t42;
        {
            int64_t s_1027 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1027;
            int64_t p_1028 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1028;
            int64_t d_1029 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1029;
            int64_t b_1030 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1030;
            printf("%lld\n", (long long)(s_1027));
            printf("%lld\n", (long long)(p_1028));
            printf("%lld\n", (long long)(d_1029));
