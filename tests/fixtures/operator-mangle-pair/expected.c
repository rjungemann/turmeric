...
int main(int argc, char **argv) {
        ...
        int64_t __t50;
        {
            int64_t s_1255 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1255;
            int64_t p_1256 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1256;
            int64_t d_1257 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1257;
            int64_t b_1258 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1258;
            printf("%lld\n", (long long)(s_1255));
            printf("%lld\n", (long long)(p_1256));
            printf("%lld\n", (long long)(d_1257));
