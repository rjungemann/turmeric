...
int main(int argc, char **argv) {
        ...
        int64_t __t42;
        {
            int64_t s_1017 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1017;
            int64_t p_1018 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1018;
            int64_t d_1019 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1019;
            int64_t b_1020 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1020;
            printf("%lld\n", (long long)(s_1017));
            printf("%lld\n", (long long)(p_1018));
            printf("%lld\n", (long long)(d_1019));
