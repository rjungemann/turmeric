...
int main(int argc, char **argv) {
        ...
        int64_t __t42;
        {
            int64_t s_998 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_998;
            int64_t p_999 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_999;
            int64_t d_1000 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1000;
            int64_t b_1001 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1001;
            printf("%lld\n", (long long)(s_998));
            printf("%lld\n", (long long)(p_999));
            printf("%lld\n", (long long)(d_1000));
