...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            int64_t s_884 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_884;
            int64_t p_885 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_885;
            int64_t d_886 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_886;
            int64_t b_887 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_887;
            printf("%lld\n", (long long)(s_884));
            printf("%lld\n", (long long)(p_885));
            printf("%lld\n", (long long)(d_886));
