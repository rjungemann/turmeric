...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t155;
        {
            __auto_type __ps_156 = (_gt_gt_gt(INT64_C(2), INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t s_1312 = __ps_156;
            (void)s_1312;
            __auto_type __ps_157 = (_lt_lt_lt(INT64_C(2), INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1313 = __ps_157;
            (void)p_1313;
            __auto_type __ps_158 = (_eq_eq_eq(INT64_C(10), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t d_1314 = __ps_158;
            (void)d_1314;
            __auto_type __ps_159 = (_ex_ex_ex(INT64_C(4), INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
