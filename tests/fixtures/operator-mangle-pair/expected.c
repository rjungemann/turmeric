...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            int64_t s_894 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_894;
            int64_t p_895 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_895;
            int64_t d_896 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_896;
            int64_t b_897 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_897;
            printf("%lld\n", (long long)(s_894));
            printf("%lld\n", (long long)(p_895));
            printf("%lld\n", (long long)(d_896));
