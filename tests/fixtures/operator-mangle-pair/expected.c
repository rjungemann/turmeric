...
int main(int argc, char **argv) {
        ...
        int64_t __t55;
        {
            int64_t s_1258 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1258;
            int64_t p_1259 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1259;
            int64_t d_1260 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1260;
            int64_t b_1261 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1261;
            printf("%lld\n", (long long)(s_1258));
            printf("%lld\n", (long long)(p_1259));
            printf("%lld\n", (long long)(d_1260));
