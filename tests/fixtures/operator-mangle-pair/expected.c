...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        ...
        if (__t4) {
            ...
            __t5[1] = (int64_t)(intptr_t)__fn_618;
            void *__t6 = __t5;
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t13[1] = (int64_t)(intptr_t)__fn_800;
        void *__t14 = __t13;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t15[1] = (int64_t)(intptr_t)__fn_882;
        void *__t16 = __t15;
...
int main(int argc, char **argv) {
        ...
        int64_t __t24;
        {
            int64_t s_892 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_892;
            int64_t p_893 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_893;
            int64_t d_894 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_894;
            int64_t b_895 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_895;
            printf("%lld\n", (long long)(s_892));
            printf("%lld\n", (long long)(p_893));
            printf("%lld\n", (long long)(d_894));
