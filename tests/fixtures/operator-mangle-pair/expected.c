...
int main(int argc, char **argv) {
        ...
        int64_t __t52;
        {
            int64_t s_1019 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1019;
            int64_t p_1020 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1020;
            int64_t d_1021 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1021;
            int64_t b_1022 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1022;
            printf("%lld\n", (long long)(s_1019));
            printf("%lld\n", (long long)(p_1020));
            printf("%lld\n", (long long)(d_1021));
