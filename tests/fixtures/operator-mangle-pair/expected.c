...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_876;
        void *__t15 = __t14;
...
int main(int argc, char **argv) {
        ...
        int64_t __t21;
        {
            int64_t s_886 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_886;
            int64_t p_887 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_887;
            int64_t d_888 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_888;
            int64_t b_889 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_889;
            printf("%lld\n", (long long)(s_886));
            printf("%lld\n", (long long)(p_887));
            printf("%lld\n", (long long)(d_888));
