...
static bool __inst_Eq_eq__Tuple2(int64_t x, int64_t y) {
        return tuple2_eq_carrier_qu(x, y, (int64_t)(intptr_t)(__fn_778), (int64_t)(intptr_t)(__fn_782));
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            int64_t s_889 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_889;
            int64_t p_890 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_890;
            int64_t d_891 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_891;
            int64_t b_892 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_892;
            printf("%lld\n", (long long)(s_889));
            printf("%lld\n", (long long)(p_890));
            printf("%lld\n", (long long)(d_891));
