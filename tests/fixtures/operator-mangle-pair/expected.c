...
static bool __inst_Eq_eq_qu_Vec(int64_t x, int64_t y) {
        bool __t4;
        {
            int64_t lx_625 = vec_hylen_hybyval(x);
            (void)lx_625;
            int64_t ly_626 = vec_hylen_hybyval(y);
            (void)ly_626;
            bool __t5;
            if ((lx_625) == (ly_626)) {
                __t5 = vec_hyeq_hyloop_hybyval(x, y, INT64_C(0), lx_625);
            } else {
                __t5 = false;
            }
            __t4 = __t5;
...
int main(int argc, char **argv) {
        ...
        int64_t __t25;
        {
            int64_t s_903 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_903;
            int64_t p_904 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_904;
            int64_t d_905 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_905;
            int64_t b_906 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_906;
            printf("%lld\n", (long long)(s_903));
            printf("%lld\n", (long long)(p_904));
            printf("%lld\n", (long long)(d_905));
