...
int main(int argc, char **argv) {
        ...
        int64_t __t55;
        {
            int64_t s_1276 = _gt_gt_gt(INT64_C(2), INT64_C(3));
            (void)s_1276;
            int64_t p_1277 = _lt_lt_lt(INT64_C(2), INT64_C(3));
            (void)p_1277;
            int64_t d_1278 = _eq_eq_eq(INT64_C(10), INT64_C(4));
            (void)d_1278;
            int64_t b_1279 = _ex_ex_ex(INT64_C(4), INT64_C(2));
            (void)b_1279;
            printf("%lld\n", (long long)(s_1276));
            printf("%lld\n", (long long)(p_1277));
            printf("%lld\n", (long long)(d_1278));
