...
static int64_t _gt_gt_gt(int64_t, int64_t);
static int64_t _lt_lt_lt(int64_t, int64_t);
static int64_t _eq_eq_eq(int64_t, int64_t);
static int64_t _ex_ex_ex(int64_t, int64_t);
...
static int64_t _gt_gt_gt(int64_t a, int64_t b) {
        return (a) + (b);
}

static int64_t _lt_lt_lt(int64_t a, int64_t b) {
        return (a) * (b);
}

static int64_t _eq_eq_eq(int64_t a, int64_t b) {
        return (a) - (b);
}

static int64_t _ex_ex_ex(int64_t a, int64_t b) {
        return ((a) * (INT64_C(10))) + (b);
}
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t277;
        {
            int64_t __ps_278 = (_gt_gt_gt(INT64_C(2), INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t s_1618 = __ps_278;
            (void)s_1618;
            int64_t __ps_279 = (_lt_lt_lt(INT64_C(2), INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t p_1619 = __ps_279;
            (void)p_1619;
            int64_t __ps_280 = (_eq_eq_eq(INT64_C(10), INT64_C(4)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t d_1620 = __ps_280;
            (void)d_1620;
            int64_t __ps_281 = (_ex_ex_ex(INT64_C(4), INT64_C(2)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            int64_t b_1621 = __ps_281;
            (void)b_1621;
            printf("%lld\n", (long long)(s_1618));
            printf("%lld\n", (long long)(p_1619));
            printf("%lld\n", (long long)(d_1620));
