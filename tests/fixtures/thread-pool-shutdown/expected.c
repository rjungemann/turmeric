...
static void * tp_sd_worker_fn(void *);
...
static void * tp_sd_worker_fn(void * arg) {
        typedef struct {
      void *queue;
      pthread_t *threads;
      int64_t n_threads;
