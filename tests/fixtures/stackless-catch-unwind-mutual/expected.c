  ...
  switch (__pc) {
   ...
   case 1: {
    if ((n_1281) == (INT64_C(0))) {
     ...
     __n179->saved[0] = (int64_t)(intptr_t)(n_1281);
     __n179->saved[1] = (int64_t)(intptr_t)(n_1287);
     __n179->saved[2] = (int64_t)(intptr_t)(__t175);
     __n179->saved[3] = (int64_t)(intptr_t)(__t176);
     __n179->saved[4] = (int64_t)(intptr_t)(__t177);
     __n179->saved[5] = (int64_t)(intptr_t)(__t178);
     __k = __n179; __pc = 3; break;
    }
   }
   case 3: {
    __auto_type __ra180_0 = ((n_1281) - (INT64_C(1)));
    n_1287 = __ra180_0;
    __pc = 2; break;
   }
   case 4: {
   ...
   case 2: {
    if ((n_1287) == (INT64_C(0))) {
     ...
     __n181->tag = 6; __n181->boundary = __b181; __n181->next = __k;
     __n181->aggr_mask = 0x0u;
     __n181->saved[0] = (int64_t)(intptr_t)(n_1281);
     __n181->saved[1] = (int64_t)(intptr_t)(n_1287);
     __n181->saved[2] = (int64_t)(intptr_t)(__t175);
     __n181->saved[3] = (int64_t)(intptr_t)(__t176);
     __n181->saved[4] = (int64_t)(intptr_t)(__t177);
     __n181->saved[5] = (int64_t)(intptr_t)(__t178);
     __k = __n181; __pc = 5; break;
    }
   }
   case 5: {
    __auto_type __ra182_0 = ((n_1287) - (INT64_C(1)));
    n_1281 = __ra182_0;
    __pc = 1; break;
   }
   case 6: {
...
int main(int argc, char **argv) {
    ...
    __auto_type __ps_183 = (ping(INT64_C(500000)));
    /* panic-return-signal: ret ctype unknown; no propagation here */
    printf("%lld\n", (long long)(__ps_183));
    int64_t __t184;
    __t184 = INT64_C(0);
