...
static double __fn_859(void *, double);
...
static double call_f(void *, double);
static void * make_adder(double);
...
struct __env_861 { tur_thunk_double_double_t __fn; double n; };
static double __fn_859(void * __env_p_862, double x) {
...
static double call_f(void * f, double x) {
        return TUR_APPLY1_T(double, double, f, x);
  
}

static void * make_adder(double n) {
        struct __env_861 *__t25 = (struct __env_861 *)malloc(sizeof(struct __env_861));
        __t25->__fn = (tur_thunk_double_double_t)__fn_859;
        __t25->n = n;
        void *__t26 = __t25;
        return __t26;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            void * add_864 = make_adder(10.0);
            (void)add_864;
            double r_865 = call_f((void *)(intptr_t)(add_864), 3.5);
            (void)r_865;
            printf("%g\n", (double)(r_865));
            int64_t __t28;
            __t28 = INT64_C(0);
