...
static double call_hyf(void *, double);
static void * make_hyadder(double);
...
struct __env_896 { tur_thunk_double_double_t __fn; double n; };
static double __fn_894(void * __env_p_897, double x) {
...
static double call_hyf(void * f, double x) {
        return TUR_APPLY1_T(double, double, f, x);
  
}

static void * make_hyadder(double n) {
        struct __env_896 *__t25 = (struct __env_896 *)malloc(sizeof(struct __env_896));
        __t25->__fn = (tur_thunk_double_double_t)__fn_894;
        __t25->n = n;
        void *__t26 = __t25;
        return __t26;
}
...
int main(int argc, char **argv) {
        ...
        int64_t __t27;
        {
            void * add_899 = make_hyadder(10.0);
            (void)add_899;
            double r_900 = call_hyf((void *)(intptr_t)(add_899), 3.5);
            (void)r_900;
            printf("%g\n", (double)(r_900));
            int64_t __t28;
            __t28 = INT64_C(0);
