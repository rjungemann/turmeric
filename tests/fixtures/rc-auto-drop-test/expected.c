...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *__t179 = INT64_C(200);
            TUR_REGION_NOTE_WORDS(&((*__t179)), sizeof((*__t179)));
            RcControlBlock *__t180 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t180, __t179, NULL);
            RcControlBlock * x_1617 = __t180;
            (void)x_1617;
            {
                void *__t181 = tur_ref_from_rc(x_1617);
                void * r_1618 = __t181;
                (void)r_1618;
                tur_frame __frame_182;
                tur_frame_init(&__frame_182, NULL);
                int64_t __t183 = *((int64_t *)r_1618);
                printf("%lld\n", (long long)(__t183));
                struct __defer_env_184 __t186 = {.r = r_1618};
