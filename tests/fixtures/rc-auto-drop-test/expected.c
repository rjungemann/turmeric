    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *__t172 = INT64_C(100);
            ...
            RcControlBlock * x_1606 = __t173;
            (void)x_1606;
            tur_frame __frame_174;
            tur_frame_init(&__frame_174, NULL);
            int64_t __t175 = rc_strong_count(x_1606);
            printf("%lld\n", (long long)(__t175));
        ...
        }
        {
            ...
            *__t179 = INT64_C(200);
            ...
            RcControlBlock * x_1607 = __t180;
            (void)x_1607;
            {
                void *__t181 = tur_ref_from_rc(x_1607);
                void * r_1608 = __t181;
                (void)r_1608;
                tur_frame __frame_182;
                tur_frame_init(&__frame_182, NULL);
                int64_t __t183 = *((int64_t *)r_1608);
                printf("%lld\n", (long long)(__t183));
                struct __defer_env_184 __t186 = {.r = r_1608};
