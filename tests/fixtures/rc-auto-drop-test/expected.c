...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t267 = (int64_t *)malloc(sizeof(int64_t));
            *__t267 = INT64_C(100);
            TUR_REGION_NOTE_WORDS(&((*__t267)), sizeof((*__t267)));
            RcControlBlock *__t268 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t268, __t267, NULL);
            RcControlBlock * x_1465 = __t268;
            (void)x_1465;
            tur_frame __frame_269;
            tur_frame_init(&__frame_269, NULL);
            int64_t __t270 = rc_strong_count(x_1465);
            printf("%lld\n", (long long)(__t270));
        ...
        {
            int64_t *__t274 = (int64_t *)malloc(sizeof(int64_t));
            *__t274 = INT64_C(200);
            TUR_REGION_NOTE_WORDS(&((*__t274)), sizeof((*__t274)));
            RcControlBlock *__t275 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t275, __t274, NULL);
            RcControlBlock * x_1466 = __t275;
            (void)x_1466;
            {
                void *__t276 = tur_ref_from_rc(x_1466);
                void * r_1467 = __t276;
                (void)r_1467;
                tur_frame __frame_277;
                tur_frame_init(&__frame_277, NULL);
                int64_t __t278 = *((int64_t *)r_1467);
                printf("%lld\n", (long long)(__t278));
                struct __defer_env_279 __t281 = {.r = r_1467};
