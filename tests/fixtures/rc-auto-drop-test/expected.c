...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t55 = INT64_C(100);
            ...
            __t56->value = __t55;
            RcControlBlock * x_1264 = __t56;
            (void)x_1264;
            tur_frame __frame_57;
            tur_frame_init(&__frame_57, NULL);
            int64_t __t58 = rc_strong_count(x_1264);
            printf("%lld\n", (long long)(__t58));
        ...
        {
            int64_t *__t62 = (int64_t *)malloc(sizeof(int64_t));
            *__t62 = INT64_C(200);
            RcControlBlock *__t63 = rc_cb_alloc(0, 3, NULL);
            __t63->value = __t62;
            RcControlBlock * x_1265 = __t63;
            (void)x_1265;
            {
                void *__t64 = tur_ref_from_rc(x_1265);
                void * r_1266 = __t64;
                (void)r_1266;
                int64_t __t65 = *((int64_t *)r_1266);
                printf("%lld\n", (long long)(__t65));
            }
        }
        int64_t __t66;
