...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t42 = INT64_C(100);
            ...
            __t43->value = __t42;
            RcControlBlock * x_1018 = __t43;
            (void)x_1018;
            tur_frame __frame_44;
            tur_frame_init(&__frame_44, NULL);
            int64_t __t45 = rc_strong_count(x_1018);
            printf("%lld\n", (long long)(__t45));
        ...
        }
        {
            ...
            *__t49 = INT64_C(200);
            ...
            __t50->value = __t49;
            RcControlBlock * x_1019 = __t50;
            (void)x_1019;
            {
                void *__t51 = tur_ref_from_rc(x_1019);
                void * r_1020 = __t51;
                (void)r_1020;
                int64_t __t52 = *((int64_t *)r_1020);
                printf("%lld\n", (long long)(__t52));
            }
        }
        int64_t __t53;
