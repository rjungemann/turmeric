...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t55 = INT64_C(100);
            ...
            __t56->value = __t55;
            RcControlBlock * x_1246 = __t56;
            (void)x_1246;
            tur_frame __frame_57;
            tur_frame_init(&__frame_57, NULL);
            int64_t __t58 = rc_strong_count(x_1246);
            printf("%lld\n", (long long)(__t58));
        ...
        }
        {
            ...
            *__t62 = INT64_C(200);
            ...
            __t63->value = __t62;
            RcControlBlock * x_1247 = __t63;
            (void)x_1247;
            {
                void *__t64 = tur_ref_from_rc(x_1247);
                void * r_1248 = __t64;
                (void)r_1248;
                int64_t __t65 = *((int64_t *)r_1248);
                printf("%lld\n", (long long)(__t65));
            }
        }
        int64_t __t66;
