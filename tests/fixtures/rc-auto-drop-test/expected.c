...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t181 = INT64_C(100);
            ...
            __t182->value = __t181;
            RcControlBlock * x_1264 = __t182;
            (void)x_1264;
            tur_frame __frame_183;
            tur_frame_init(&__frame_183, NULL);
            int64_t __t184 = rc_strong_count(x_1264);
            printf("%lld\n", (long long)(__t184));
        ...
        }
        {
            ...
            *__t188 = INT64_C(200);
            ...
            __t189->value = __t188;
            RcControlBlock * x_1265 = __t189;
            (void)x_1265;
            {
                void *__t190 = tur_ref_from_rc(x_1265);
                void * r_1266 = __t190;
                (void)r_1266;
                int64_t __t191 = *((int64_t *)r_1266);
                printf("%lld\n", (long long)(__t191));
            }
        }
        int64_t __t192;
