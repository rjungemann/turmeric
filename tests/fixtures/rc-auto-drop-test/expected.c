...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t179 = (int64_t *)malloc(sizeof(int64_t));
            *__t179 = INT64_C(100);
            RcControlBlock *__t180 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t180, __t179, NULL);
            RcControlBlock * x_1434 = __t180;
            (void)x_1434;
            tur_frame __frame_181;
            tur_frame_init(&__frame_181, NULL);
            int64_t __t182 = rc_strong_count(x_1434);
            printf("%lld\n", (long long)(__t182));
        ...
        }
        {
            ...
            *__t186 = INT64_C(200);
            ...
            rc_set_value(__t187, __t186, NULL);
            RcControlBlock * x_1435 = __t187;
            (void)x_1435;
            {
                void *__t188 = tur_ref_from_rc(x_1435);
                void * r_1436 = __t188;
                (void)r_1436;
                tur_frame __frame_189;
                tur_frame_init(&__frame_189, NULL);
                int64_t __t190 = *((int64_t *)r_1436);
                printf("%lld\n", (long long)(__t190));
                struct __defer_env_191 __t193 = {.r = r_1436};
                tur_frame_push_defer(&__frame_189, __defer_192, &__t193);
