...
int main(int argc, char **argv) {
        ...
        {
            int64_t *__t50 = (int64_t *)malloc(sizeof(int64_t));
            *__t50 = INT64_C(100);
            RcControlBlock *__t51 = rc_cb_alloc(0, 3, NULL);
            __t51->value = __t50;
            RcControlBlock * x_1243 = __t51;
            (void)x_1243;
            tur_frame __frame_52;
            tur_frame_init(&__frame_52, NULL);
            int64_t __t53 = rc_strong_count(x_1243);
            printf("%lld\n", (long long)(__t53));
        ...
        {
            int64_t *__t57 = (int64_t *)malloc(sizeof(int64_t));
            *__t57 = INT64_C(200);
            RcControlBlock *__t58 = rc_cb_alloc(0, 3, NULL);
            __t58->value = __t57;
            RcControlBlock * x_1244 = __t58;
            (void)x_1244;
            {
                void *__t59 = tur_ref_from_rc(x_1244);
                void * r_1245 = __t59;
                (void)r_1245;
                int64_t __t60 = *((int64_t *)r_1245);
                printf("%lld\n", (long long)(__t60));
            }
        }
        int64_t __t61;
