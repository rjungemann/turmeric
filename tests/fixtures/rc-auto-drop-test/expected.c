...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t173 = INT64_C(100);
            ...
            __t174->value = __t173;
            RcControlBlock * x_1270 = __t174;
            (void)x_1270;
            tur_frame __frame_175;
            tur_frame_init(&__frame_175, NULL);
            int64_t __t176 = rc_strong_count(x_1270);
            printf("%lld\n", (long long)(__t176));
        ...
        }
        {
            ...
            *__t180 = INT64_C(200);
            ...
            __t181->value = __t180;
            RcControlBlock * x_1271 = __t181;
            (void)x_1271;
            {
                void *__t182 = tur_ref_from_rc(x_1271);
                void * r_1272 = __t182;
                (void)r_1272;
                int64_t __t183 = *((int64_t *)r_1272);
                printf("%lld\n", (long long)(__t183));
            }
        }
        int64_t __t184;
