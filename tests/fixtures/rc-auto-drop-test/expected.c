...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t264 = (int64_t *)malloc(sizeof(int64_t));
            *__t264 = INT64_C(100);
            TUR_REGION_NOTE_WORDS(&((*__t264)), sizeof((*__t264)));
            RcControlBlock *__t265 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t265, __t264, NULL);
            RcControlBlock * x_1467 = __t265;
            (void)x_1467;
            tur_frame __frame_266;
            tur_frame_init(&__frame_266, NULL);
            int64_t __t267 = rc_strong_count(x_1467);
            printf("%lld\n", (long long)(__t267));
        ...
        {
            int64_t *__t271 = (int64_t *)malloc(sizeof(int64_t));
            *__t271 = INT64_C(200);
            TUR_REGION_NOTE_WORDS(&((*__t271)), sizeof((*__t271)));
            RcControlBlock *__t272 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t272, __t271, NULL);
            RcControlBlock * x_1468 = __t272;
            (void)x_1468;
            {
                void *__t273 = tur_ref_from_rc(x_1468);
                void * r_1469 = __t273;
                (void)r_1469;
                tur_frame __frame_274;
                tur_frame_init(&__frame_274, NULL);
                int64_t __t275 = *((int64_t *)r_1469);
                printf("%lld\n", (long long)(__t275));
                struct __defer_env_276 __t278 = {.r = r_1469};
                tur_frame_push_defer(&__frame_274, __defer_277, &__t278);
