...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t181 = INT64_C(100);
            ...
            __t182->value = __t181;
            RcControlBlock * x_1269 = __t182;
            (void)x_1269;
            tur_frame __frame_183;
            tur_frame_init(&__frame_183, NULL);
            int64_t __t184 = rc_strong_count(x_1269);
            printf("%lld\n", (long long)(__t184));
        ...
        }
        {
            ...
            *__t188 = INT64_C(200);
            ...
            __t189->value = __t188;
            RcControlBlock * x_1270 = __t189;
            (void)x_1270;
            {
                void *__t190 = tur_ref_from_rc(x_1270);
                void * r_1271 = __t190;
                (void)r_1271;
                int64_t __t191 = *((int64_t *)r_1271);
                printf("%lld\n", (long long)(__t191));
            }
        }
        int64_t __t192;
