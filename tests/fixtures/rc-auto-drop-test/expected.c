...
int main(int argc, char **argv) {
        ...
        {
            int64_t *__t42 = (int64_t *)malloc(sizeof(int64_t));
            *__t42 = INT64_C(100);
            RcControlBlock *__t43 = rc_cb_alloc(0, 3, NULL);
            __t43->value = __t42;
            RcControlBlock * x_1005 = __t43;
            (void)x_1005;
            tur_frame __frame_44;
            tur_frame_init(&__frame_44, NULL);
            int64_t __t45 = rc_strong_count(x_1005);
            printf("%lld\n", (long long)(__t45));
        ...
        {
            int64_t *__t49 = (int64_t *)malloc(sizeof(int64_t));
            *__t49 = INT64_C(200);
            RcControlBlock *__t50 = rc_cb_alloc(0, 3, NULL);
            __t50->value = __t49;
            RcControlBlock * x_1006 = __t50;
            (void)x_1006;
            {
                void *__t51 = tur_ref_from_rc(x_1006);
                void * r_1007 = __t51;
                (void)r_1007;
                int64_t __t52 = *((int64_t *)r_1007);
                printf("%lld\n", (long long)(__t52));
            }
        }
        int64_t __t53;
