...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t183 = (int64_t *)malloc(sizeof(int64_t));
            *__t183 = INT64_C(100);
            TUR_REGION_NOTE_WORDS(&((*__t183)), sizeof((*__t183)));
            RcControlBlock *__t184 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t184, __t183, NULL);
            RcControlBlock * x_1436 = __t184;
            (void)x_1436;
            tur_frame __frame_185;
            tur_frame_init(&__frame_185, NULL);
            int64_t __t186 = rc_strong_count(x_1436);
            printf("%lld\n", (long long)(__t186));
            struct __defer_env_187 __t189 = {.x = x_1436};
            tur_frame_push_defer(&__frame_185, __defer_188, &__t189);
            tur_frame_fire_lifo(&__frame_185);
        }
        {
            int64_t *__t190 = (int64_t *)malloc(sizeof(int64_t));
            *__t190 = INT64_C(200);
            TUR_REGION_NOTE_WORDS(&((*__t190)), sizeof((*__t190)));
            RcControlBlock *__t191 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t191, __t190, NULL);
            RcControlBlock * x_1437 = __t191;
            (void)x_1437;
            {
                void *__t192 = tur_ref_from_rc(x_1437);
                void * r_1438 = __t192;
                (void)r_1438;
                tur_frame __frame_193;
                tur_frame_init(&__frame_193, NULL);
                int64_t __t194 = *((int64_t *)r_1438);
                printf("%lld\n", (long long)(__t194));
                struct __defer_env_195 __t197 = {.r = r_1438};
                tur_frame_push_defer(&__frame_193, __defer_196, &__t197);
