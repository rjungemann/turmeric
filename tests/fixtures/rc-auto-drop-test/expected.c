    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *__t163 = INT64_C(100);
            ...
            RcControlBlock * x_1362 = __t164;
            (void)x_1362;
            tur_frame __frame_165;
            tur_frame_init(&__frame_165, NULL);
            int64_t __t166 = rc_strong_count(x_1362);
            printf("%lld\n", (long long)(__t166));
        ...
        }
        {
            ...
            *__t170 = INT64_C(200);
            ...
            RcControlBlock * x_1363 = __t171;
            (void)x_1363;
            {
                void *__t172 = tur_ref_from_rc(x_1363);
                void * r_1364 = __t172;
                (void)r_1364;
                tur_frame __frame_173;
                tur_frame_init(&__frame_173, NULL);
                int64_t __t174 = *((int64_t *)r_1364);
                printf("%lld\n", (long long)(__t174));
                struct __defer_env_175 __t177 = {.r = r_1364};
