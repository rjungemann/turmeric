...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t159 = (int64_t *)malloc(sizeof(int64_t));
            *__t159 = INT64_C(100);
            RcControlBlock *__t160 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t160, __t159, NULL);
            RcControlBlock * x_1326 = __t160;
            (void)x_1326;
            tur_frame __frame_161;
            tur_frame_init(&__frame_161, NULL);
            int64_t __t162 = rc_strong_count(x_1326);
            printf("%lld\n", (long long)(__t162));
        ...
        {
            int64_t *__t166 = (int64_t *)malloc(sizeof(int64_t));
            *__t166 = INT64_C(200);
            RcControlBlock *__t167 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t167, __t166, NULL);
            RcControlBlock * x_1327 = __t167;
            (void)x_1327;
            {
                void *__t168 = tur_ref_from_rc(x_1327);
                void * r_1328 = __t168;
                (void)r_1328;
                int64_t __t169 = *((int64_t *)r_1328);
                printf("%lld\n", (long long)(__t169));
            }
        }
        int64_t __t170;
