...
int main(int argc, char **argv) {
        ...
        {
            int64_t *__t44 = (int64_t *)malloc(sizeof(int64_t));
            *__t44 = INT64_C(100);
            RcControlBlock *__t45 = rc_cb_alloc(0, 3, NULL);
            __t45->value = __t44;
            RcControlBlock * x_1022 = __t45;
            (void)x_1022;
            tur_frame __frame_46;
            tur_frame_init(&__frame_46, NULL);
            int64_t __t47 = rc_strong_count(x_1022);
            printf("%lld\n", (long long)(__t47));
        ...
        }
        {
            ...
            *__t51 = INT64_C(200);
            ...
            __t52->value = __t51;
            RcControlBlock * x_1023 = __t52;
            (void)x_1023;
            {
                void *__t53 = tur_ref_from_rc(x_1023);
                void * r_1024 = __t53;
                (void)r_1024;
                int64_t __t54 = *((int64_t *)r_1024);
                printf("%lld\n", (long long)(__t54));
            }
        }
        int64_t __t55;
