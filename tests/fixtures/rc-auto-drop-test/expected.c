    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *__t172 = INT64_C(100);
            ...
            RcControlBlock * x_1432 = __t173;
            (void)x_1432;
            tur_frame __frame_174;
            tur_frame_init(&__frame_174, NULL);
            int64_t __t175 = rc_strong_count(x_1432);
            printf("%lld\n", (long long)(__t175));
        ...
        }
        {
            ...
            *__t179 = INT64_C(200);
            ...
            RcControlBlock * x_1433 = __t180;
            (void)x_1433;
            {
                void *__t181 = tur_ref_from_rc(x_1433);
                void * r_1434 = __t181;
                (void)r_1434;
                tur_frame __frame_182;
                tur_frame_init(&__frame_182, NULL);
                int64_t __t183 = *((int64_t *)r_1434);
                printf("%lld\n", (long long)(__t183));
                struct __defer_env_184 __t186 = {.r = r_1434};
