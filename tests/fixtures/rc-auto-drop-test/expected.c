...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t42 = INT64_C(100);
            ...
            __t43->value = __t42;
            RcControlBlock * x_1020 = __t43;
            (void)x_1020;
            tur_frame __frame_44;
            tur_frame_init(&__frame_44, NULL);
            int64_t __t45 = rc_strong_count(x_1020);
            printf("%lld\n", (long long)(__t45));
        ...
        }
        {
            ...
            *__t49 = INT64_C(200);
            ...
            __t50->value = __t49;
            RcControlBlock * x_1021 = __t50;
            (void)x_1021;
            {
                void *__t51 = tur_ref_from_rc(x_1021);
                void * r_1022 = __t51;
                (void)r_1022;
                int64_t __t52 = *((int64_t *)r_1022);
                printf("%lld\n", (long long)(__t52));
            }
        }
        int64_t __t53;
