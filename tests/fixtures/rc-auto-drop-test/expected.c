...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t277 = (int64_t *)malloc(sizeof(int64_t));
            *__t277 = INT64_C(100);
            TUR_REGION_NOTE_WORDS(&((*__t277)), sizeof((*__t277)));
            RcControlBlock *__t278 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t278, __t277, NULL);
            RcControlBlock * x_1606 = __t278;
            (void)x_1606;
            tur_frame __frame_279;
            tur_frame_init(&__frame_279, NULL);
            int64_t __t280 = rc_strong_count(x_1606);
            printf("%lld\n", (long long)(__t280));
        ...
        }
        {
            ...
            *__t284 = INT64_C(200);
            ...
            RcControlBlock * x_1607 = __t285;
            (void)x_1607;
            {
                void *__t286 = tur_ref_from_rc(x_1607);
                void * r_1608 = __t286;
                (void)r_1608;
                tur_frame __frame_287;
                tur_frame_init(&__frame_287, NULL);
                int64_t __t288 = *((int64_t *)r_1608);
                printf("%lld\n", (long long)(__t288));
                struct __defer_env_289 __t291 = {.r = r_1608};
                tur_frame_push_defer(&__frame_287, __defer_290, &__t291);
