...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t24 = INT64_C(100);
            ...
            __t25->value = __t24;
            RcControlBlock * x_880 = __t25;
            (void)x_880;
            tur_frame __frame_26;
            tur_frame_init(&__frame_26, NULL);
            int64_t __t27 = rc_strong_count(x_880);
            printf("%lld\n", (long long)(__t27));
        ...
        {
            int64_t *__t31 = (int64_t *)malloc(sizeof(int64_t));
            *__t31 = INT64_C(200);
            RcControlBlock *__t32 = rc_cb_alloc(0, 3, NULL);
            __t32->value = __t31;
            RcControlBlock * x_881 = __t32;
            (void)x_881;
            {
                void *__t33 = tur_ref_from_rc(x_881);
                void * r_882 = __t33;
                (void)r_882;
                int64_t __t34 = *((int64_t *)r_882);
                printf("%lld\n", (long long)(__t34));
            }
        }
        int64_t __t35;
