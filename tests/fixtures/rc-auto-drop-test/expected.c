...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t177 = INT64_C(100);
            ...
            __t178->value = __t177;
            RcControlBlock * x_1267 = __t178;
            (void)x_1267;
            tur_frame __frame_179;
            tur_frame_init(&__frame_179, NULL);
            int64_t __t180 = rc_strong_count(x_1267);
            printf("%lld\n", (long long)(__t180));
        ...
        }
        {
            ...
            *__t184 = INT64_C(200);
            ...
            __t185->value = __t184;
            RcControlBlock * x_1268 = __t185;
            (void)x_1268;
            {
                void *__t186 = tur_ref_from_rc(x_1268);
                void * r_1269 = __t186;
                (void)r_1269;
                int64_t __t187 = *((int64_t *)r_1269);
                printf("%lld\n", (long long)(__t187));
            }
        }
        int64_t __t188;
