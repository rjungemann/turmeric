...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t232 = (int64_t *)malloc(sizeof(int64_t));
            *__t232 = INT64_C(100);
            TUR_REGION_NOTE_WORDS(&((*__t232)), sizeof((*__t232)));
            RcControlBlock *__t233 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t233, __t232, NULL);
            RcControlBlock * x_1463 = __t233;
            (void)x_1463;
            tur_frame __frame_234;
            tur_frame_init(&__frame_234, NULL);
            int64_t __t235 = rc_strong_count(x_1463);
            printf("%lld\n", (long long)(__t235));
        ...
        {
            int64_t *__t239 = (int64_t *)malloc(sizeof(int64_t));
            *__t239 = INT64_C(200);
            TUR_REGION_NOTE_WORDS(&((*__t239)), sizeof((*__t239)));
            RcControlBlock *__t240 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t240, __t239, NULL);
            RcControlBlock * x_1464 = __t240;
            (void)x_1464;
            {
                void *__t241 = tur_ref_from_rc(x_1464);
                void * r_1465 = __t241;
                (void)r_1465;
                tur_frame __frame_242;
                tur_frame_init(&__frame_242, NULL);
                int64_t __t243 = *((int64_t *)r_1465);
                printf("%lld\n", (long long)(__t243));
                struct __defer_env_244 __t246 = {.r = r_1465};
                tur_frame_push_defer(&__frame_242, __defer_245, &__t246);
                tur_frame_fire_lifo(&__frame_242);
            }
        }
        int64_t __t247;
        __t247 = INT64_C(0);
