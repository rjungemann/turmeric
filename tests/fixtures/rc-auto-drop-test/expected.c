...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t244 = (int64_t *)malloc(sizeof(int64_t));
            *__t244 = INT64_C(100);
            TUR_REGION_NOTE_WORDS(&((*__t244)), sizeof((*__t244)));
            RcControlBlock *__t245 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t245, __t244, NULL);
            RcControlBlock * x_1467 = __t245;
            (void)x_1467;
            tur_frame __frame_246;
            tur_frame_init(&__frame_246, NULL);
            int64_t __t247 = rc_strong_count(x_1467);
            printf("%lld\n", (long long)(__t247));
            struct __defer_env_248 __t250 = {.x = x_1467};
            tur_frame_push_defer(&__frame_246, __defer_249, &__t250);
            tur_frame_fire_lifo(&__frame_246);
        }
        {
            int64_t *__t251 = (int64_t *)malloc(sizeof(int64_t));
            *__t251 = INT64_C(200);
            TUR_REGION_NOTE_WORDS(&((*__t251)), sizeof((*__t251)));
            RcControlBlock *__t252 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t252, __t251, NULL);
            RcControlBlock * x_1468 = __t252;
            (void)x_1468;
            {
                void *__t253 = tur_ref_from_rc(x_1468);
                void * r_1469 = __t253;
                (void)r_1469;
                tur_frame __frame_254;
                tur_frame_init(&__frame_254, NULL);
                int64_t __t255 = *((int64_t *)r_1469);
                printf("%lld\n", (long long)(__t255));
                struct __defer_env_256 __t258 = {.r = r_1469};
                tur_frame_push_defer(&__frame_254, __defer_257, &__t258);
                tur_frame_fire_lifo(&__frame_254);
            }
        }
        int64_t __t259;
        __t259 = INT64_C(0);
