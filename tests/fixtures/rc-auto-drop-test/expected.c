...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t50 = INT64_C(100);
            ...
            __t51->value = __t50;
            RcControlBlock * x_1261 = __t51;
            (void)x_1261;
            tur_frame __frame_52;
            tur_frame_init(&__frame_52, NULL);
            int64_t __t53 = rc_strong_count(x_1261);
            printf("%lld\n", (long long)(__t53));
        ...
        }
        {
            ...
            *__t57 = INT64_C(200);
            ...
            __t58->value = __t57;
            RcControlBlock * x_1262 = __t58;
            (void)x_1262;
            {
                void *__t59 = tur_ref_from_rc(x_1262);
                void * r_1263 = __t59;
                (void)r_1263;
                int64_t __t60 = *((int64_t *)r_1263);
                printf("%lld\n", (long long)(__t60));
            }
        }
        int64_t __t61;
