...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t51 = INT64_C(100);
            ...
            __t52->value = __t51;
            RcControlBlock * x_1007 = __t52;
            (void)x_1007;
            tur_frame __frame_53;
            tur_frame_init(&__frame_53, NULL);
            int64_t __t54 = rc_strong_count(x_1007);
            printf("%lld\n", (long long)(__t54));
        ...
        {
            int64_t *__t58 = (int64_t *)malloc(sizeof(int64_t));
            *__t58 = INT64_C(200);
            RcControlBlock *__t59 = rc_cb_alloc(0, 3, NULL);
            __t59->value = __t58;
            RcControlBlock * x_1008 = __t59;
            (void)x_1008;
            {
                void *__t60 = tur_ref_from_rc(x_1008);
                void * r_1009 = __t60;
                (void)r_1009;
                int64_t __t61 = *((int64_t *)r_1009);
                printf("%lld\n", (long long)(__t61));
            }
        }
        int64_t __t62;
