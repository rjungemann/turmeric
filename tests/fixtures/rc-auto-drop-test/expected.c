...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t163 = (int64_t *)malloc(sizeof(int64_t));
            *__t163 = INT64_C(100);
            RcControlBlock *__t164 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t164, __t163, NULL);
            RcControlBlock * x_1366 = __t164;
            (void)x_1366;
            tur_frame __frame_165;
            tur_frame_init(&__frame_165, NULL);
            int64_t __t166 = rc_strong_count(x_1366);
            printf("%lld\n", (long long)(__t166));
        ...
        {
            int64_t *__t170 = (int64_t *)malloc(sizeof(int64_t));
            *__t170 = INT64_C(200);
            RcControlBlock *__t171 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t171, __t170, NULL);
            RcControlBlock * x_1367 = __t171;
            (void)x_1367;
            {
                void *__t172 = tur_ref_from_rc(x_1367);
                void * r_1368 = __t172;
                (void)r_1368;
                tur_frame __frame_173;
                tur_frame_init(&__frame_173, NULL);
                int64_t __t174 = *((int64_t *)r_1368);
                printf("%lld\n", (long long)(__t174));
                struct __defer_env_175 __t177 = {.r = r_1368};
                tur_frame_push_defer(&__frame_173, __defer_176, &__t177);
