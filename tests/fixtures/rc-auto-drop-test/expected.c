...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t155 = (int64_t *)malloc(sizeof(int64_t));
            *__t155 = INT64_C(100);
            RcControlBlock *__t156 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t156, __t155, NULL);
            RcControlBlock * x_1300 = __t156;
            (void)x_1300;
            tur_frame __frame_157;
            tur_frame_init(&__frame_157, NULL);
            int64_t __t158 = rc_strong_count(x_1300);
            printf("%lld\n", (long long)(__t158));
        ...
        }
        {
            ...
            *__t162 = INT64_C(200);
            ...
            RcControlBlock * x_1301 = __t163;
            (void)x_1301;
            {
                void *__t164 = tur_ref_from_rc(x_1301);
                void * r_1302 = __t164;
                (void)r_1302;
                int64_t __t165 = *((int64_t *)r_1302);
                printf("%lld\n", (long long)(__t165));
            }
        }
        int64_t __t166;
