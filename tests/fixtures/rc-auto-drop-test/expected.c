    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *__t179 = INT64_C(100);
            ...
            RcControlBlock * x_1432 = __t180;
            (void)x_1432;
            tur_frame __frame_181;
            tur_frame_init(&__frame_181, NULL);
            int64_t __t182 = rc_strong_count(x_1432);
            printf("%lld\n", (long long)(__t182));
        ...
        }
        {
            ...
            *__t186 = INT64_C(200);
            ...
            RcControlBlock * x_1433 = __t187;
            (void)x_1433;
            {
                void *__t188 = tur_ref_from_rc(x_1433);
                void * r_1434 = __t188;
                (void)r_1434;
                tur_frame __frame_189;
                tur_frame_init(&__frame_189, NULL);
                int64_t __t190 = *((int64_t *)r_1434);
                printf("%lld\n", (long long)(__t190));
                struct __defer_env_191 __t193 = {.r = r_1434};
