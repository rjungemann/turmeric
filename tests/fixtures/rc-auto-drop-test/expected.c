...
int main(int argc, char **argv) {
        ...
        {
            int64_t *__t46 = (int64_t *)malloc(sizeof(int64_t));
            *__t46 = INT64_C(100);
            RcControlBlock *__t47 = rc_cb_alloc(0, 3, NULL);
            __t47->value = __t46;
            RcControlBlock * x_1005 = __t47;
            (void)x_1005;
            tur_frame __frame_48;
            tur_frame_init(&__frame_48, NULL);
            int64_t __t49 = rc_strong_count(x_1005);
            printf("%lld\n", (long long)(__t49));
        ...
        }
        {
            ...
            *__t53 = INT64_C(200);
            ...
            __t54->value = __t53;
            RcControlBlock * x_1006 = __t54;
            (void)x_1006;
            {
                void *__t55 = tur_ref_from_rc(x_1006);
                void * r_1007 = __t55;
                (void)r_1007;
                int64_t __t56 = *((int64_t *)r_1007);
                printf("%lld\n", (long long)(__t56));
            }
        }
        int64_t __t57;
