...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t173 = INT64_C(100);
            ...
            __t174->value = __t173;
            RcControlBlock * x_1272 = __t174;
            (void)x_1272;
            tur_frame __frame_175;
            tur_frame_init(&__frame_175, NULL);
            int64_t __t176 = rc_strong_count(x_1272);
            printf("%lld\n", (long long)(__t176));
            struct __defer_env_177 __t179 = {.x = x_1272};
        ...
        }
        {
            ...
            *__t180 = INT64_C(200);
            ...
            __t181->value = __t180;
            RcControlBlock * x_1273 = __t181;
            (void)x_1273;
            {
                void *__t182 = tur_ref_from_rc(x_1273);
                void * r_1274 = __t182;
                (void)r_1274;
                int64_t __t183 = *((int64_t *)r_1274);
                printf("%lld\n", (long long)(__t183));
            }
        }
        int64_t __t184;
