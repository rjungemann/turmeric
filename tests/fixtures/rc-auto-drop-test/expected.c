...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t187 = (int64_t *)malloc(sizeof(int64_t));
            *__t187 = INT64_C(200);
            TUR_REGION_NOTE_WORDS(&((*__t187)), sizeof((*__t187)));
            RcControlBlock *__t188 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t188, __t187, NULL);
            RcControlBlock * x_1437 = __t188;
            (void)x_1437;
            {
                void *__t189 = tur_ref_from_rc(x_1437);
                void * r_1438 = __t189;
                (void)r_1438;
                tur_frame __frame_190;
                tur_frame_init(&__frame_190, NULL);
                int64_t __t191 = *((int64_t *)r_1438);
                printf("%lld\n", (long long)(__t191));
                struct __defer_env_192 __t194 = {.r = r_1438};
                tur_frame_push_defer(&__frame_190, __defer_193, &__t194);
