...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        {
            int64_t *__t275 = (int64_t *)malloc(sizeof(int64_t));
            *__t275 = INT64_C(100);
            TUR_REGION_NOTE_WORDS(&((*__t275)), sizeof((*__t275)));
            RcControlBlock *__t276 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t276, __t275, NULL);
            RcControlBlock * x_1606 = __t276;
            (void)x_1606;
            tur_frame __frame_277;
            tur_frame_init(&__frame_277, NULL);
            int64_t __t278 = rc_strong_count(x_1606);
            printf("%lld\n", (long long)(__t278));
        ...
        {
            int64_t *__t282 = (int64_t *)malloc(sizeof(int64_t));
            *__t282 = INT64_C(200);
            TUR_REGION_NOTE_WORDS(&((*__t282)), sizeof((*__t282)));
            RcControlBlock *__t283 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t283, __t282, NULL);
            RcControlBlock * x_1607 = __t283;
            (void)x_1607;
            {
                void *__t284 = tur_ref_from_rc(x_1607);
                void * r_1608 = __t284;
                (void)r_1608;
                tur_frame __frame_285;
                tur_frame_init(&__frame_285, NULL);
                int64_t __t286 = *((int64_t *)r_1608);
                printf("%lld\n", (long long)(__t286));
                struct __defer_env_287 __t289 = {.r = r_1608};
                tur_frame_push_defer(&__frame_285, __defer_288, &__t289);
                tur_frame_fire_lifo(&__frame_285);
            }
        }
        int64_t __t290;
        __t290 = INT64_C(0);
