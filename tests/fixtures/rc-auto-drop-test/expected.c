    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        }
        {
            ...
            *__t168 = INT64_C(100);
            ...
            RcControlBlock * x_1432 = __t169;
            (void)x_1432;
            tur_frame __frame_170;
            tur_frame_init(&__frame_170, NULL);
            int64_t __t171 = rc_strong_count(x_1432);
            printf("%lld\n", (long long)(__t171));
        ...
        {
            int64_t *__t175 = (int64_t *)malloc(sizeof(int64_t));
            *__t175 = INT64_C(200);
            RcControlBlock *__t176 = rc_cb_alloc(0, 3, NULL);
            rc_set_value(__t176, __t175, NULL);
            RcControlBlock * x_1433 = __t176;
            (void)x_1433;
            {
                void *__t177 = tur_ref_from_rc(x_1433);
                void * r_1434 = __t177;
                (void)r_1434;
                tur_frame __frame_178;
                tur_frame_init(&__frame_178, NULL);
                int64_t __t179 = *((int64_t *)r_1434);
                printf("%lld\n", (long long)(__t179));
                struct __defer_env_180 __t182 = {.r = r_1434};
                tur_frame_push_defer(&__frame_178, __defer_181, &__t182);
