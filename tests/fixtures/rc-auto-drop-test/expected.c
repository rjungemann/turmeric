...
int main(int argc, char **argv) {
        ...
        {
            int64_t *__t29 = (int64_t *)malloc(sizeof(int64_t));
            *__t29 = INT64_C(100);
            RcControlBlock *__t30 = rc_cb_alloc(0, 3, NULL);
            __t30->value = __t29;
            RcControlBlock * x_900 = __t30;
            (void)x_900;
            tur_frame __frame_31;
            tur_frame_init(&__frame_31, NULL);
            int64_t __t32 = rc_strong_count(x_900);
            printf("%lld\n", (long long)(__t32));
        ...
        {
            int64_t *__t36 = (int64_t *)malloc(sizeof(int64_t));
            *__t36 = INT64_C(200);
            RcControlBlock *__t37 = rc_cb_alloc(0, 3, NULL);
            __t37->value = __t36;
            RcControlBlock * x_901 = __t37;
            (void)x_901;
            {
                void *__t38 = tur_ref_from_rc(x_901);
                void * r_902 = __t38;
                (void)r_902;
                int64_t __t39 = *((int64_t *)r_902);
                printf("%lld\n", (long long)(__t39));
            }
        }
        int64_t __t40;
