...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            *__t173 = INT64_C(100);
            ...
            __t174->value = __t173;
            RcControlBlock * x_1275 = __t174;
            (void)x_1275;
            tur_frame __frame_175;
            tur_frame_init(&__frame_175, NULL);
            int64_t __t176 = rc_strong_count(x_1275);
            printf("%lld\n", (long long)(__t176));
        ...
        }
        {
            ...
            *__t180 = INT64_C(200);
            ...
            __t181->value = __t180;
            RcControlBlock * x_1276 = __t181;
            (void)x_1276;
            {
                void *__t182 = tur_ref_from_rc(x_1276);
                void * r_1277 = __t182;
                (void)r_1277;
                int64_t __t183 = *((int64_t *)r_1277);
                printf("%lld\n", (long long)(__t183));
            }
        }
        int64_t __t184;
