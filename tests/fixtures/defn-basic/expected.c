...
static int64_t __inst_Applicative_ap_Option(int64_t ff, int64_t fa) {
        ...
        if (some___spec__bool_Option__opaque((__t12 ? (Option__opaque){.is_some = __t12->is_some, .value = (void *)(__t12->value)} : (Option__opaque){0}))) {
            ...
            if (some_qu(fa)) {
                int64_t __t14;
                {
                    int64_t _un_uncall_unhead_un735_736 = (int64_t)(intptr_t)(((ff) ? ((Option *)(intptr_t)(ff))->value : 0));
                    (void)_un_uncall_unhead_un735_736;
                    __t14 = ((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(_un_uncall_unhead_un735_736)))[0])((void *)(intptr_t)(_un_uncall_unhead_un735_736), ((fa) ? ((Option *)(intptr_t)(fa))->value : 0));
                }
                __t13 = some(__t14);
            } else {
                __t13 = none();
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t24[1] = (int64_t)(intptr_t)__fn_886;
        void *__t25 = __t24;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t26) {
            ...
            __t27[1] = (int64_t)(intptr_t)__fn_1006;
            void *__t28 = __t27;
