...
int main(int argc, char **argv) {
        ...
        pint(__inst_Hash_hash_int(INT64_C(5)));
        pint(__inst_Hash_hash_bool(true));
        if (__inst_Eq_eq_qu_int(INT64_C(1), INT64_C(1))) {
            puts("eq-1-1-true");
        } else {
            puts("BAD");
        }
        if (__inst_Eq_eq_qu_int(INT64_C(1), INT64_C(2))) {
            puts("BAD");
        } else {
            puts("eq-1-2-false");
        }
        if ((__inst_Hash_hash_cstr("abc")) == (__inst_Hash_hash_cstr("abc"))) {
            puts("hash-abc-stable");
        } else {
            puts("BAD");
        }
        int64_t __t25;
