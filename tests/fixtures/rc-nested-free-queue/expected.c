...
int main() {
        {
            ...
            *__t0 = INT64_C(1);
            ...
            __t1->value = __t0;
            RcControlBlock * inner_196 = __t1;
            (void)inner_196;
            {
                rc_strong_increment(inner_196);
                RcControlBlock * outer_197 = inner_196;
                (void)outer_197;
                puts("Before inner drop");
                rc_strong_decrement(inner_196);
                rc_free_queue_drain();
                puts("After inner drop");
                rc_strong_decrement(outer_197);
                rc_free_queue_drain();
        ...
        }
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * a_198 = __t3;
            (void)a_198;
            {
                rc_strong_increment(a_198);
                RcControlBlock * b_199 = a_198;
                (void)b_199;
                {
                    rc_strong_increment(b_199);
                    RcControlBlock * c_200 = b_199;
                    (void)c_200;
                    {
                        rc_strong_increment(c_200);
                        RcControlBlock * d_201 = c_200;
                        (void)d_201;
                        puts("Nested level 4");
                        rc_strong_decrement(d_201);
                        rc_free_queue_drain();
                        rc_strong_decrement(c_200);
                        rc_free_queue_drain();
                        rc_strong_decrement(b_199);
                        rc_free_queue_drain();
                        rc_strong_decrement(a_198);
                        rc_free_queue_drain();
                    }
                }
            }
