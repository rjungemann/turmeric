...
int main() {
        {
            ...
            *__t0 = INT64_C(1);
            ...
            __t1->value = __t0;
            RcControlBlock * inner_616 = __t1;
            (void)inner_616;
            {
                rc_strong_increment(inner_616);
                RcControlBlock * outer_617 = inner_616;
                (void)outer_617;
                puts("Before inner drop");
                rc_strong_decrement(inner_616);
                rc_free_queue_drain();
                puts("After inner drop");
                rc_strong_decrement(outer_617);
                rc_free_queue_drain();
        ...
        }
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * a_618 = __t3;
            (void)a_618;
            {
                rc_strong_increment(a_618);
                RcControlBlock * b_619 = a_618;
                (void)b_619;
                {
                    rc_strong_increment(b_619);
                    RcControlBlock * c_620 = b_619;
                    (void)c_620;
                    {
                        rc_strong_increment(c_620);
                        RcControlBlock * d_621 = c_620;
                        (void)d_621;
                        puts("Nested level 4");
                        rc_strong_decrement(d_621);
                        rc_free_queue_drain();
                        rc_strong_decrement(c_620);
                        rc_free_queue_drain();
                        rc_strong_decrement(b_619);
                        rc_free_queue_drain();
                        rc_strong_decrement(a_618);
                        rc_free_queue_drain();
                    }
                }
            }
