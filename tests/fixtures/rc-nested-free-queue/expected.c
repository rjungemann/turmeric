...
int main() {
        {
            ...
            *__t0 = INT64_C(1);
            ...
            __t1->value = __t0;
            RcControlBlock * inner_261 = __t1;
            (void)inner_261;
            {
                rc_strong_increment(inner_261);
                RcControlBlock * outer_262 = inner_261;
                (void)outer_262;
                puts("Before inner drop");
                rc_strong_decrement(inner_261);
                rc_free_queue_drain();
                puts("After inner drop");
                rc_strong_decrement(outer_262);
                rc_free_queue_drain();
        ...
        }
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * a_263 = __t3;
            (void)a_263;
            {
                rc_strong_increment(a_263);
                RcControlBlock * b_264 = a_263;
                (void)b_264;
                {
                    rc_strong_increment(b_264);
                    RcControlBlock * c_265 = b_264;
                    (void)c_265;
                    {
                        rc_strong_increment(c_265);
                        RcControlBlock * d_266 = c_265;
                        (void)d_266;
                        puts("Nested level 4");
                        rc_strong_decrement(d_266);
                        rc_free_queue_drain();
                        rc_strong_decrement(c_265);
                        rc_free_queue_drain();
                        rc_strong_decrement(b_264);
                        rc_free_queue_drain();
                        rc_strong_decrement(a_263);
                        rc_free_queue_drain();
                    }
                }
            }
