...
int main() {
        {
            ...
            *__t0 = INT64_C(1);
            ...
            __t1->value = __t0;
            RcControlBlock * inner_208 = __t1;
            (void)inner_208;
            {
                rc_strong_increment(inner_208);
                RcControlBlock * outer_209 = inner_208;
                (void)outer_209;
                puts("Before inner drop");
                rc_strong_decrement(inner_208);
                rc_free_queue_drain();
                puts("After inner drop");
                rc_strong_decrement(outer_209);
                rc_free_queue_drain();
        ...
        }
        {
            ...
            *__t2 = INT64_C(10);
            ...
            __t3->value = __t2;
            RcControlBlock * a_210 = __t3;
            (void)a_210;
            {
                rc_strong_increment(a_210);
                RcControlBlock * b_211 = a_210;
                (void)b_211;
                {
                    rc_strong_increment(b_211);
                    RcControlBlock * c_212 = b_211;
                    (void)c_212;
                    {
                        rc_strong_increment(c_212);
                        RcControlBlock * d_213 = c_212;
                        (void)d_213;
                        puts("Nested level 4");
                        rc_strong_decrement(d_213);
                        rc_free_queue_drain();
                        rc_strong_decrement(c_212);
                        rc_free_queue_drain();
                        rc_strong_decrement(b_211);
                        rc_free_queue_drain();
                        rc_strong_decrement(a_210);
                        rc_free_queue_drain();
                    }
                }
            }
