...
struct __env_869 { tur_thunk_int64_t_int64_t_t __fn; int64_t self; };
static int64_t __fn_867(void * __env_p_870, int64_t x) {
        struct __env_869 *__env___env_869 = (struct __env_869 *)__env_p_870;
        return (x) + (__inst_HasArr_bump_Box(__env___env_869->self, INT64_C(0)));
}

static int64_t __inst_HasArr_adder_Box(int64_t self) {
        struct __env_869 *__t20 = (struct __env_869 *)malloc(sizeof(struct __env_869));
        __t20->__fn = (tur_thunk_int64_t_int64_t_t)__fn_867;
        __t20->self = self;
        void *__t21 = __t20;
        return __t21;
}
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            (void)w_875;
            int64_t b_876 = (int64_t)(INT64_C(0));
            (void)b_876;
            int64_t f = (int64_t)(intptr_t)(__inst_HasArr_adder_Box(b_876));
            (void)f;
            printf("%lld\n", (long long)(__inst_HasN_twice_ArrW(w_875, INT64_C(41))));
