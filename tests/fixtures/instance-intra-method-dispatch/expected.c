...
struct __env_870 { tur_thunk_int64_t_int64_t_t __fn; int64_t self; };
static int64_t __fn_868(void * __env_p_871, int64_t x) {
        struct __env_870 *__env___env_870 = (struct __env_870 *)__env_p_871;
        return (x) + (__inst_HasArr_bump_Box(__env___env_870->self, INT64_C(0)));
}

static int64_t __inst_HasArr_adder_Box(int64_t self) {
        struct __env_870 *__t20 = (struct __env_870 *)malloc(sizeof(struct __env_870));
        __t20->__fn = (tur_thunk_int64_t_int64_t_t)__fn_868;
        __t20->self = self;
        void *__t21 = __t20;
        return __t21;
}
