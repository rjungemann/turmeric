...
int main() {
        {
            void * a_224 = arc_new(INT64_C(42));
            (void)a_224;
            printf("%lld\n", (long long)(arc_get((void *)(intptr_t)(a_224))));
            printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_224))));
            {
                void * b_225 = arc_clone((void *)(intptr_t)(a_224));
                (void)b_225;
                printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_224))));
                printf("%lld\n", (long long)(arc_get((void *)(intptr_t)(b_225))));
                arc_drop((void *)(intptr_t)(b_225));
                printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_224))));
            }
            arc_drop((void *)(intptr_t)(a_224));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
