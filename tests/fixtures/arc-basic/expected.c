...
int main() {
        {
            void * a_271 = arc_new(INT64_C(42));
            (void)a_271;
            printf("%lld\n", (long long)(arc_get((void *)(intptr_t)(a_271))));
            printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_271))));
            {
                void * b_272 = arc_clone((void *)(intptr_t)(a_271));
                (void)b_272;
                printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_271))));
                printf("%lld\n", (long long)(arc_get((void *)(intptr_t)(b_272))));
                arc_drop((void *)(intptr_t)(b_272));
                printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_271))));
            }
            arc_drop((void *)(intptr_t)(a_271));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
