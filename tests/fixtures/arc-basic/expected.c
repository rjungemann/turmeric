...
static int64_t arc_strong_count(void * p) {
        typedef struct { uint64_t strong; uint64_t weak; int64_t value; } ArcBlock;
  ArcBlock *b = (ArcBlock *)p;
  return (int64_t)__atomic_load_n(&b->strong, __ATOMIC_SEQ_CST);
...
static void arc_drop(void * p) {
        typedef struct { uint64_t strong; uint64_t weak; int64_t value; } ArcBlock;
  ArcBlock *b = (ArcBlock *)p;
  uint64_t prev_strong = __atomic_fetch_sub(&b->strong, (uint64_t)1, __ATOMIC_ACQ_REL);
  if (prev_strong == 1) {
      /* Last strong ref dropped: drop value, then drop sentinel weak ref */
      uint64_t prev_weak = __atomic_fetch_sub(&b->weak, (uint64_t)1, __ATOMIC_ACQ_REL);
      if (prev_weak == 1) {
          free(b);
      }
  }
...
int main() {
        {
            void * a_223 = arc_new(INT64_C(42));
            (void)a_223;
            printf("%lld\n", (long long)(arc_get((void *)(intptr_t)(a_223))));
            printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_223))));
            {
                void * b_224 = arc_clone((void *)(intptr_t)(a_223));
                (void)b_224;
                printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_223))));
                printf("%lld\n", (long long)(arc_get((void *)(intptr_t)(b_224))));
                arc_drop((void *)(intptr_t)(b_224));
                printf("%lld\n", (long long)(arc_strong_count((void *)(intptr_t)(a_223))));
            }
            arc_drop((void *)(intptr_t)(a_223));
        }
        int64_t __t0;
        __t0 = INT64_C(0);
        return (int)__t0;
