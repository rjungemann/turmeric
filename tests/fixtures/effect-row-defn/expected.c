...
int main() {
        ...
        __eff_frame_8.cases[0].handler_fn = __effect_handler_6;
        __eff_frame_8.cases[0].env = NULL;
        *__eff_chain_8 = &__eff_frame_8;
        log_hello();
        int64_t __t10;
        __t10 = INT64_C(0);
        int64_t __t9 = __t10;
        *__eff_chain_8 = (*__eff_chain_8)->parent;
        {
            ...
            __eff_frame_13.cases[0].handler_fn = __effect_handler_11;
