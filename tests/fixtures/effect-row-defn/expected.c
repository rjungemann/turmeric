...
static int64_t __effect_handler_7(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    ...
    puts(msg_202);
    int64_t __t8;
    int64_t __t9 = tur_effect_cont_resume((int64_t)(intptr_t)k_203, (int64_t)INT64_C(0));
    __t8 = __t9;
    return (int64_t)__t8;
}
...
static int64_t __effect_handler_13(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    const char * msg_205 = (const char *)__effect_args[0];
    int64_t k_206 = __k;
    puts(msg_205);
    int64_t __t14;
    int64_t __t15 = tur_effect_cont_resume((int64_t)(intptr_t)k_206, (int64_t)INT64_C(0));
    __t14 = __t15;
...
static int64_t __effect_handler_17(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t k_204 = __k;
    int64_t __t18 = tur_effect_cont_resume((int64_t)(intptr_t)k_204, (int64_t)INT64_C(42));
...
int main() {
        ...
        if (__fiber_6->done) { free(__fiber_6->stack); free(__fiber_6); }
        {
            ...
            int64_t result_207 = __t20;
            (void)result_207;
            printf("%lld\n", (long long)(result_207));
        }
