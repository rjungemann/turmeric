...
static int64_t __inst_Applicative_ap_Option(int64_t ff, int64_t fa) {
        ...
        if (some___spec__bool_Option__opaque((__t12 ? (Option__opaque){.is_some = __t12->is_some, .value = (void *)(__t12->value)} : (Option__opaque){0}))) {
            ...
            if (some_qu(fa)) {
                int64_t __t14;
                {
                    int64_t _un_uncall_unhead_un744_745 = (int64_t)(intptr_t)(((ff) ? ((Option *)(intptr_t)(ff))->value : 0));
                    (void)_un_uncall_unhead_un744_745;
                    __t14 = ((int64_t (*)(void*, int64_t))(intptr_t)((int64_t *)((void *)(intptr_t)(_un_uncall_unhead_un744_745)))[0])((void *)(intptr_t)(_un_uncall_unhead_un744_745), ((fa) ? ((Option *)(intptr_t)(fa))->value : 0));
                }
                __t13 = some(__t14);
            } else {
                __t13 = none();
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t23[1] = (int64_t)(intptr_t)__fn_895;
        void *__t24 = __t23;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t25) {
            ...
            __t26[1] = (int64_t)(intptr_t)__fn_1015;
            void *__t27 = __t26;
...
int main(int argc, char **argv) {
        ...
        printf("%lld\n", (long long)(takes_hybyval((__t53 ? (Option__int){.is_some = __t53->is_some, .value = __t53->value} : (Option__int){0}))));
        ...
        tur_option_t *__t55 = (tur_option_t *)(intptr_t)(some(((union { double s; int64_t d; }){.s = 7.25}).d));
        printf("%lld\n", (long long)(float_hy_gtint((takes_hybyval_hyf((__t55 ? (Option__float){.is_some = __t55->is_some, .value = ((union { int64_t s; double d; }){.s = __t55->value}).d} : (Option__float){0}))) * (100.0))));
