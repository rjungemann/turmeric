        ...
        if (__ps_99) {
            bool __t100;
            {
                ...
                if ((t1_1113) == (INT64_C(0))) {
                    __t101 = (t2_1114) == (INT64_C(0));
                } else {
                    bool __t102;
                    if ((t2_1114) == (INT64_C(0))) {
                        __t102 = false;
                    } else {
                        bool __ps_103 = (cons_hyeq_hygo(t1_1113, t2_1114));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_103;
                    }
                    __t101 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_109) {
            ...
            int64_t __t110;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1129 = (int64_t)(intptr_t)(__ps_114);
                (void)out_1129;
                __t110 = out_1129;
            }
            __t108 = __t110;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t119;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1204 = __ps_121;
            (void)iter_1204;
            void * __ps_122 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_123 = (hamt_slkeyeq((void *)(intptr_t)(__ps_122)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1205 = __ps_123;
            (void)keyeq_1205;
            void * __ps_124 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_125 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1204), (void *)(intptr_t)(__ps_124), (void *)(intptr_t)(keyeq_1205)));
            if (tur_panicking) return ((bool)0);
            bool result_1206 = __ps_125;
            (void)result_1206;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t146;
        {
            ...
            {
                tur_adt_Vec__int * __ps_148 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1333));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1334 = __ps_148;
                (void)_un_unv_1334;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t152;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1384 = __ps_153;
            (void)r_1384;
            int64_t __t154;
            bool __ps_155 = (schema_hydecode_hyok_qu(r_1384));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_155) {
                int64_t __ps_156 = (schema_hydecode_hyvalue(r_1384));
                if (tur_panicking) return ((int64_t)0);
                __t154 = __ps_156;
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1384));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t takes_hybyval(tur_adt_Option__int o) {
        int64_t __t169;
        bool __ps_170 = (some___spec__bool_tur_adt_Option__int(o));
        if (tur_panicking) return ((int64_t)0);
        if (__ps_170) {
            int64_t __ps_171 = (unwrap__spec__int64_t_tur_adt_Option__int(o));
            if (tur_panicking) return ((int64_t)0);
            __t169 = __ps_171;
        } else {
            __t169 = INT64_C(-1);
...
static double takes_hybyval_hyf(tur_adt_Option__float o) {
        double __t172;
        bool __ps_173 = (some___spec__bool_tur_adt_Option__float(o));
        if (tur_panicking) return ((double)0);
        if (__ps_173) {
            double __ps_174 = (unwrap__spec__double_tur_adt_Option__float(o));
            if (tur_panicking) return ((double)0);
            __t172 = __ps_174;
        } else {
            __t172 = -1.0;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_175 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_176 = (takes_hybyval(__ps_175));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_176));
        tur_adt_Option__int __ps_177 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_178 = (takes_hybyval(__ps_177));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_178));
        tur_adt_Option__float __ps_179 = (some__spec__tur_adt_Option__float_double(7.25));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_180 = (takes_hybyval_hyf(__ps_179));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_181 = (float_hy_gtint((__ps_180) * (100.0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_181));
        tur_adt_Option__float __ps_182 = (none__spec__tur_adt_Option__float());
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_193 = (ctor_Option_None__int());
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_193;
}

static tur_adt_Option__float some__spec__tur_adt_Option__float_double(double x) {
        tur_adt_Option__float __ps_194 = (ctor_Option_Some__float(x));
        if (tur_panicking) return (tur_adt_Option__float){0};
        return __ps_194;
}

static tur_adt_Option__float none__spec__tur_adt_Option__float() {
        tur_adt_Option__float __ps_195 = (ctor_Option_None__float());
        if (tur_panicking) return (tur_adt_Option__float){0};
        return __ps_195;
}
