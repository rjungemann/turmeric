...
static bool __fn_997(int64_t, int64_t);
...
static bool __fn_997(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_997;
            void *__t18 = __t17;
...
static bool set_hyeq_hyloop(void * iter, void * s2_hamt, void * keyeq) {
        ...
        if (hamt_sliter_hyadvance_ex((void *)(intptr_t)(iter))) {
            {
                int64_t h_943 = hamt_sliter_hycur_hyhash((void *)(intptr_t)(iter));
                (void)h_943;
                void * k_944 = hamt_sliter_hycur_hykey((void *)(intptr_t)(iter));
                (void)k_944;
                if (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_943, (void *)(intptr_t)(k_944), (void *)(intptr_t)(keyeq))) {
                    void * __t32 = iter;
                    void * __t33 = s2_hamt;
                    void * __t34 = keyeq;
                    iter = __t32;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t35;
        {
            void * iter_947 = hamt_sliter_hyalloc((void *)(intptr_t)(set_hyhamt(s1)));
            (void)iter_947;
            void * keyeq_948 = hamt_slkeyeq((void *)(intptr_t)(set_hyhamt(s1)));
            (void)keyeq_948;
            bool result_949 = set_hyeq_hyloop((void *)(intptr_t)(iter_947), (void *)(intptr_t)(set_hyhamt(s2)), (void *)(intptr_t)(keyeq_948));
            (void)result_949;
            hamt_sliter_hydestroy_ex((void *)(intptr_t)(iter_947));
            bool __t36;
            __t36 = result_949;
            __t35 = __t36;
        }
...
int main(int argc, char **argv) {
        ...
        tur_option_t *__t44 = (tur_option_t *)(intptr_t)(some(INT64_C(5)));
        printf("%lld\n", (long long)(takes_hybyval((__t44 ? (Option__int){.is_some = __t44->is_some, .value = __t44->value} : (Option__int){0}))));
        tur_option_t *__t45 = (tur_option_t *)(intptr_t)(none());
        printf("%lld\n", (long long)(takes_hybyval((__t45 ? (Option__int){.is_some = __t45->is_some, .value = __t45->value} : (Option__int){0}))));
        tur_option_t *__t46 = (tur_option_t *)(intptr_t)(some(((union { double s; int64_t d; }){.s = 7.25}).d));
        printf("%lld\n", (long long)(float_hy_gtint((takes_hybyval_hyf((__t46 ? (Option__float){.is_some = __t46->is_some, .value = ((union { int64_t s; double d; }){.s = __t46->value}).d} : (Option__float){0}))) * (100.0))));
        tur_option_t *__t47 = (tur_option_t *)(intptr_t)(none());
        printf("%lld\n", (long long)(float_hy_gtint((takes_hybyval_hyf((__t47 ? (Option__float){.is_some = __t47->is_some, .value = ((union { int64_t s; double d; }){.s = __t47->value}).d} : (Option__float){0}))) * (100.0))));
        int64_t __t48;
        __t48 = INT64_C(0);
        return (int)__t48;
}
