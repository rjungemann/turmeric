...
static int64_t unwrap__spec__int64_t_tur_adt_Option__int(tur_adt_Option__int o) {
        int64_t __t189 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                int64_t v_1086 = (int64_t)__scrut->as.Some._0;
                __t189 = v_1086;
                break;
            }
            case 0: {
...
static bool some___spec__bool_tur_adt_Option__float(tur_adt_Option__float o) {
        bool __t190 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                double _un_1082 = (double)__scrut->as.Some._0;
                __t190 = true;
                break;
            }
            case 0: {
...
static double unwrap__spec__double_tur_adt_Option__float(tur_adt_Option__float o) {
        double __t191 = 0;
        {
            ...
            switch (__scrut->tag) {
            case 1: {
                double v_1086 = (double)__scrut->as.Some._0;
                __t191 = v_1086;
                break;
            }
            case 0: {
