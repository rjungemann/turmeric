            ...
            bool __t97;
            {
                ...
                if ((t1_1019) == (INT64_C(0))) {
                    ...
                    if ((t2_1020) == (INT64_C(0))) {
                        ...
                        __auto_type __ps_100 = (cons_hyeq_hygo(t1_1019, t2_1020));
                        if (tur_panicking) return (bool){0};
                        __t99 = __ps_100;
                    }
                    __t98 = __t99;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t116;
        {
            ...
            if (tur_panicking) return (bool){0};
            __auto_type __ps_122 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1110), (void *)(intptr_t)(__ps_121), (void *)(intptr_t)(keyeq_1111)));
            if (tur_panicking) return (bool){0};
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t143;
        {
            ...
            {
                __auto_type __ps_145 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1239));
                if (tur_panicking) return (int64_t){0};
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t148;
        {
            ...
            (void)r_1289;
            int64_t __t150;
            __auto_type __ps_151 = (schema_hydecode_hyok_qu(r_1289));
            if (tur_panicking) return (int64_t){0};
            if (__ps_151) {
                __auto_type __ps_152 = (schema_hydecode_hyvalue(r_1289));
                if (tur_panicking) return (int64_t){0};
                __t150 = __ps_152;
            } else {
                __auto_type __ps_153 = (schema_hydecode_hyerrors(r_1289));
                if (tur_panicking) return (int64_t){0};
