        ...
        if (__ps_103) {
            bool __t104;
            {
                ...
                if ((t1_1115) == (INT64_C(0))) {
                    __t105 = (t2_1116) == (INT64_C(0));
                } else {
                    bool __t106;
                    if ((t2_1116) == (INT64_C(0))) {
                        __t106 = false;
                    } else {
                        bool __ps_107 = (cons_hyeq_hygo(t1_1115, t2_1116));
                        if (tur_panicking) return ((bool)0);
                        __t106 = __ps_107;
                    }
                    __t105 = __t106;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_113) {
            ...
            int64_t __t114;
            {
                ...
                if (tur_panicking) return ((int64_t)0);
                int64_t out_1131 = (int64_t)(intptr_t)(__ps_118);
                (void)out_1131;
                __t114 = out_1131;
            }
            __t112 = __t114;
        ...
        if (__ps_123) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1202 = __ps_124;
                (void)h_1202;
                void * __ps_125 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1203 = __ps_125;
                (void)k_1203;
                bool __ps_126 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1202, (void *)(intptr_t)(k_1203), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_126) {
                    void * __t127 = iter;
                    void * __t128 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t130;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1206 = __ps_132;
            (void)iter_1206;
            void * __ps_133 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_134 = (hamt_slkeyeq((void *)(intptr_t)(__ps_133)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1207 = __ps_134;
            (void)keyeq_1207;
            void * __ps_135 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_136 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1206), (void *)(intptr_t)(__ps_135), (void *)(intptr_t)(keyeq_1207)));
            if (tur_panicking) return ((bool)0);
            bool result_1208 = __ps_136;
            (void)result_1208;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t157;
        {
            ...
            {
                tur_adt_Vec__int * __ps_159 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1336));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1337 = __ps_159;
                (void)_un_unv_1337;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t163;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1387 = __ps_164;
            (void)r_1387;
            int64_t __t165;
            bool __ps_166 = (schema_hydecode_hyok_qu(r_1387));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_166) {
                int64_t __ps_167 = (schema_hydecode_hyvalue(r_1387));
                if (tur_panicking) return ((int64_t)0);
                __t165 = __ps_167;
            } else {
                int64_t __ps_168 = (schema_hydecode_hyerrors(r_1387));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_187 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_188 = (takes_hybyval(__ps_187));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_188));
        tur_adt_Option__int __ps_189 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_190 = (takes_hybyval(__ps_189));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_190));
        tur_adt_Option__float __ps_191 = (some__spec__tur_adt_Option__float_double(7.25));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_192 = (takes_hybyval_hyf(__ps_191));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_193 = (float_hy_gtint((__ps_192) * (100.0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_193));
        tur_adt_Option__float __ps_194 = (none__spec__tur_adt_Option__float());
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Option__float none__spec__tur_adt_Option__float() {
        tur_adt_Option__float __ps_207 = (ctor_Option_None__float());
        if (tur_panicking) return (tur_adt_Option__float){0};
        return __ps_207;
}
