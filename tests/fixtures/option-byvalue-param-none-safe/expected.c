...
static bool map_hyeq_hyloop(void * iter, void * m2_hamt, void * keyeq, int64_t val_cmp) {
        ...
        if (__ps_67) {
            bool __t68;
            {
                ...
                (void)k_751;
                bool __t71;
                __auto_type __ps_72 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_750, (void *)(intptr_t)(k_751), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_72) {
                    bool __t73;
                    __auto_type __ps_74 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
                    if (tur_panicking) return (bool){0};
                    __auto_type __ps_75 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_750, (void *)(intptr_t)(k_751), (void *)(intptr_t)(keyeq)));
                    if (tur_panicking) return (bool){0};
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t78;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_755 = __ps_80;
            (void)iter_755;
            __auto_type __ps_81 = (map_hyhamt(m1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_82 = (hamt_slkeyeq((void *)(intptr_t)(__ps_81)));
            if (tur_panicking) return (bool){0};
            void * keyeq_756 = __ps_82;
            (void)keyeq_756;
            __auto_type __ps_83 = (map_hyhamt(m2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_84 = (map_hyeq_hyloop((void *)(intptr_t)(iter_755), (void *)(intptr_t)(__ps_83), (void *)(intptr_t)(keyeq_756), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return (bool){0};
            bool result_757 = __ps_84;
            (void)result_757;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_103) {
            bool __t104;
            {
                ...
                bool __t105;
                if ((t1_994) == (INT64_C(0))) {
                    __t105 = (t2_995) == (INT64_C(0));
                } else {
                    bool __t106;
                    if ((t2_995) == (INT64_C(0))) {
                        __t106 = false;
                    } else {
                        __auto_type __ps_107 = (cons_hyeq_hygo(t1_994, t2_995));
                        if (tur_panicking) return (bool){0};
                        __t106 = __ps_107;
                    }
                    __t105 = __t106;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (__ps_109) {
            ...
            int64_t __t110;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1003 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1003;
                __t110 = out_1003;
            }
            __t108 = __t110;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_117) {
            ...
            int64_t __t118;
            {
                ...
                if (tur_panicking) return (int64_t){0};
                int64_t out_1010 = (int64_t)(intptr_t)(__ps_122);
                (void)out_1010;
                __t118 = out_1010;
            }
            __t116 = __t118;
        ...
        if (__ps_127) {
            {
                ...
                if (tur_panicking) return (bool){0};
                int64_t h_1081 = __ps_128;
                (void)h_1081;
                __auto_type __ps_129 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return (bool){0};
                void * k_1082 = __ps_129;
                (void)k_1082;
                __auto_type __ps_130 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1081, (void *)(intptr_t)(k_1082), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return (bool){0};
                if (__ps_130) {
                    void * __t131 = iter;
                    void * __t132 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t134;
        {
            ...
            if (tur_panicking) return (bool){0};
            void * iter_1085 = __ps_136;
            (void)iter_1085;
            __auto_type __ps_137 = (set_hyhamt(s1));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_138 = (hamt_slkeyeq((void *)(intptr_t)(__ps_137)));
            if (tur_panicking) return (bool){0};
            void * keyeq_1086 = __ps_138;
            (void)keyeq_1086;
            __auto_type __ps_139 = (set_hyhamt(s2));
            if (tur_panicking) return (bool){0};
            __auto_type __ps_140 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1085), (void *)(intptr_t)(__ps_139), (void *)(intptr_t)(keyeq_1086)));
            if (tur_panicking) return (bool){0};
            bool result_1087 = __ps_140;
            (void)result_1087;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t161;
        {
            ...
            {
                __auto_type __ps_163 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1214));
                if (tur_panicking) return (int64_t){0};
                tur_adt_Vec__int * _un_unv_1215 = __ps_163;
                (void)_un_unv_1215;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t166;
        {
            ...
            if (tur_panicking) return (int64_t){0};
            int64_t r_1264 = __ps_167;
            (void)r_1264;
            int64_t __t168;
            __auto_type __ps_169 = (schema_hydecode_hyok_qu(r_1264));
            if (tur_panicking) return (int64_t){0};
            if (__ps_169) {
                __auto_type __ps_170 = (schema_hydecode_hyvalue(r_1264));
                if (tur_panicking) return (int64_t){0};
                __t168 = __ps_170;
            } else {
                __auto_type __ps_171 = (schema_hydecode_hyerrors(r_1264));
                if (tur_panicking) return (int64_t){0};
...
int main(int argc, char **argv) {
        ...
        __auto_type __ps_176 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_177 = (takes_hybyval(__ps_176));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_177));
        __auto_type __ps_178 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_179 = (takes_hybyval(__ps_178));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_179));
        __auto_type __ps_180 = (some__spec__tur_adt_Option__float_double(7.25));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_181 = (takes_hybyval_hyf(__ps_180));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_182 = (float_hy_gtint((__ps_181) * (100.0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_182));
        __auto_type __ps_183 = (none__spec__tur_adt_Option__float());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_184 = (takes_hybyval_hyf(__ps_183));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        __auto_type __ps_185 = (float_hy_gtint((__ps_184) * (100.0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_185));
        int64_t __t186;
        __t186 = INT64_C(0);
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        __auto_type __ps_189 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_189;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        __auto_type __ps_190 = (ctor_Option__int(false, (int64_t){0}));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_190;
}

static tur_adt_Option__float some__spec__tur_adt_Option__float_double(double x) {
        __auto_type __ps_191 = (ctor_Option__float(true, x));
        if (tur_panicking) return (tur_adt_Option__float){0};
        return __ps_191;
}

static tur_adt_Option__float none__spec__tur_adt_Option__float() {
        __auto_type __ps_192 = (ctor_Option__float(false, (double){0}));
        if (tur_panicking) return (tur_adt_Option__float){0};
        return __ps_192;
}
