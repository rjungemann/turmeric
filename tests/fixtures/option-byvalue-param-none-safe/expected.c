...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t18[1] = (int64_t)(intptr_t)__fn_893;
        void *__t19 = __t18;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t20) {
            ...
            __t21[1] = (int64_t)(intptr_t)__fn_1013;
            void *__t22 = __t21;
...
int main(int argc, char **argv) {
        ...
        tur_option_t *__t48 = (tur_option_t *)(intptr_t)(some(INT64_C(5)));
        printf("%lld\n", (long long)(takes_hybyval((__t48 ? (Option__int){.is_some = __t48->is_some, .value = __t48->value} : (Option__int){0}))));
        tur_option_t *__t49 = (tur_option_t *)(intptr_t)(none());
        printf("%lld\n", (long long)(takes_hybyval((__t49 ? (Option__int){.is_some = __t49->is_some, .value = __t49->value} : (Option__int){0}))));
        tur_option_t *__t50 = (tur_option_t *)(intptr_t)(some(((union { double s; int64_t d; }){.s = 7.25}).d));
        printf("%lld\n", (long long)(float_hy_gtint((takes_hybyval_hyf((__t50 ? (Option__float){.is_some = __t50->is_some, .value = ((union { int64_t s; double d; }){.s = __t50->value}).d} : (Option__float){0}))) * (100.0))));
        tur_option_t *__t51 = (tur_option_t *)(intptr_t)(none());
        printf("%lld\n", (long long)(float_hy_gtint((takes_hybyval_hyf((__t51 ? (Option__float){.is_some = __t51->is_some, .value = ((union { int64_t s; double d; }){.s = __t51->value}).d} : (Option__float){0}))) * (100.0))));
        int64_t __t52;
        __t52 = INT64_C(0);
        return (int)__t52;
}
