        ...
        bool __t28;
        {
            ...
            if ((t1_1029) == (INT64_C(0))) {
                ...
                if ((t2_1030) == (INT64_C(0))) {
                    ...
                    bool __ps_31 = (cons_hyeq_hygo(t1_1029, t2_1030));
                    if (tur_panicking) return ((bool)0);
                    __t30 = __ps_31;
                }
                __t29 = __t30;
...
static intptr_t map_hyeq_hyloop_j3(intptr_t env, intptr_t __t1__slot, DK *__kont) {
    ...
    if (__t1) {
        ...
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_69 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_776, (void *)(intptr_t)(k_777), (void *)(intptr_t)(keyeq)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t71;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_77 = (map_hyeq_hyloop((void *)(intptr_t)(iter_781), (void *)(intptr_t)(__ps_76), (void *)(intptr_t)(keyeq_782), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            ...
            bool __t97;
            {
                ...
                if ((t1_1024) == (INT64_C(0))) {
                    ...
                    if ((t2_1025) == (INT64_C(0))) {
                        ...
                        bool __ps_100 = (cons_hyeq_hygo(t1_1024, t2_1025));
                        if (tur_panicking) return ((bool)0);
                        __t99 = __ps_100;
                    }
                    __t98 = __t99;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t116;
        {
            ...
            if (tur_panicking) return ((bool)0);
            bool __ps_122 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1115), (void *)(intptr_t)(__ps_121), (void *)(intptr_t)(keyeq_1116)));
            if (tur_panicking) return ((bool)0);
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t143;
        {
            ...
            {
                tur_adt_Vec__int * __ps_145 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1244));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t148;
        {
            ...
            (void)r_1294;
            int64_t __t150;
            bool __ps_151 = (schema_hydecode_hyok_qu(r_1294));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_151) {
                int64_t __ps_152 = (schema_hydecode_hyvalue(r_1294));
                if (tur_panicking) return ((int64_t)0);
                __t150 = __ps_152;
            } else {
                int64_t __ps_153 = (schema_hydecode_hyerrors(r_1294));
                if (tur_panicking) return ((int64_t)0);
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Option__int __ps_158 = (some__spec__tur_adt_Option__int_int64_t(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_159 = (takes_hybyval(__ps_158));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_159));
        tur_adt_Option__int __ps_160 = (none__spec__tur_adt_Option__int());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_161 = (takes_hybyval(__ps_160));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_161));
        tur_adt_Option__float __ps_162 = (some__spec__tur_adt_Option__float_double(7.25));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_163 = (takes_hybyval_hyf(__ps_162));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        int64_t __ps_164 = (float_hy_gtint((__ps_163) * (100.0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_164));
        tur_adt_Option__float __ps_165 = (none__spec__tur_adt_Option__float());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        double __ps_166 = (takes_hybyval_hyf(__ps_165));
        /* panic-return-signal: ret ctype unknown; no propagation here */
...
static tur_adt_Option__int some__spec__tur_adt_Option__int_int64_t(int64_t x) {
        tur_adt_Option__int __ps_171 = (ctor_Option__int(true, x));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_171;
}

static tur_adt_Option__int none__spec__tur_adt_Option__int() {
        tur_adt_Option__int __ps_172 = (ctor_Option__int(false, ((int64_t)0)));
        if (tur_panicking) return (tur_adt_Option__int){0};
        return __ps_172;
}

static tur_adt_Option__float some__spec__tur_adt_Option__float_double(double x) {
        tur_adt_Option__float __ps_173 = (ctor_Option__float(true, x));
