...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t18) {
            ...
            __t19[1] = (int64_t)(intptr_t)__fn_1013;
            void *__t20 = __t19;
...
int main(int argc, char **argv) {
        ...
        tur_option_t *__t46 = (tur_option_t *)(intptr_t)(some(INT64_C(5)));
        printf("%lld\n", (long long)(takes_hybyval((__t46 ? (Option__int){.is_some = __t46->is_some, .value = __t46->value} : (Option__int){0}))));
        tur_option_t *__t47 = (tur_option_t *)(intptr_t)(none());
        printf("%lld\n", (long long)(takes_hybyval((__t47 ? (Option__int){.is_some = __t47->is_some, .value = __t47->value} : (Option__int){0}))));
        tur_option_t *__t48 = (tur_option_t *)(intptr_t)(some(((union { double s; int64_t d; }){.s = 7.25}).d));
        printf("%lld\n", (long long)(float_hy_gtint((takes_hybyval_hyf((__t48 ? (Option__float){.is_some = __t48->is_some, .value = ((union { int64_t s; double d; }){.s = __t48->value}).d} : (Option__float){0}))) * (100.0))));
        tur_option_t *__t49 = (tur_option_t *)(intptr_t)(none());
        printf("%lld\n", (long long)(float_hy_gtint((takes_hybyval_hyf((__t49 ? (Option__float){.is_some = __t49->is_some, .value = ((union { int64_t s; double d; }){.s = __t49->value}).d} : (Option__float){0}))) * (100.0))));
        int64_t __t50;
        __t50 = INT64_C(0);
        return (int)__t50;
}
