...
static bool __fn_977(int64_t, int64_t);
...
static bool __fn_977(int64_t a, int64_t b) {
        return __inst_Eq_eq_qu_int(a, b);
}
...
static bool __inst_Eq_eq_qu_Cons(int64_t x, int64_t y) {
        ...
        __t14[1] = (int64_t)(intptr_t)__fn_977;
        void *__t15 = __t14;
...
static bool __inst_Eq_eq_qu_MutableMap(int64_t x, int64_t y) {
        ...
        if (__t16) {
            ...
            __t17[1] = (int64_t)(intptr_t)__fn_1105;
            void *__t18 = __t17;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        int64_t __t48;
        {
            ...
            if (schema_hydecode_hyok_qu(r_1232)) {
                __t49 = schema_hydecode_hyvalue(r_1232);
            } else {
                __t49 = schema_hydecode_hyabort(schema_hydecode_hyerrors(r_1232));
            }
            __t48 = __t49;
        }
        return __t48;
