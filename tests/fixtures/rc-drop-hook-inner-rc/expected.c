        ...
        int64_t __t0;
        {
            ...
            *__t1 = INT64_C(7);
            ...
            int64_t __t4;
            {
                ...
                RcControlBlock * *__t5 = (RcControlBlock * *)malloc(sizeof(RcControlBlock *));
                *__t5 = a_616;
                RcControlBlock *__t6 = rc_cb_alloc(0, 9, NULL);
                __t6->value = __t5;
                RcControlBlock * b_617 = __t6;
                (void)b_617;
                int64_t __t7 = rc_strong_count(a_616);
                printf("%lld\n", (long long)(__t7));
                rc_strong_decrement(b_617);
                rc_free_queue_drain();
                int64_t __t8 = rc_strong_count(a_616);
                printf("%lld\n", (long long)(__t8));
                rc_strong_decrement(a_616);
                rc_free_queue_drain();
                int64_t __t9;
                __t9 = INT64_C(0);
                __t4 = __t9;
