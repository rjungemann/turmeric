...
static tur_adt_Pt ctor_Pt_Pt(int64_t _0, int64_t _1) {
    tur_adt_Pt __r;
    __r.x = _0;
    __r.y = _1;
    return __r;
...
#endif
typedef struct tur_adt_Box2 {
    int64_t fst;
    int64_t snd;
} tur_adt_Box2;
typedef tur_adt_Box2 Box2;

static int64_t ctor_Box2_Box2(int64_t _0, int64_t _1) {
    tur_adt_Box2 *__r = (tur_adt_Box2 *)malloc(sizeof(tur_adt_Box2));
    __r->fst = _0;
    TUR_REGION_NOTE_WORDS(&(__r->fst), sizeof(__r->fst));
    __r->snd = _1;
    TUR_REGION_NOTE_WORDS(&(__r->snd), sizeof(__r->snd));
...
#ifndef TUR_CTORALIAS_Box2
#define TUR_CTORALIAS_Box2
#define ctor_Box2 ctor_Box2_Box2
#endif
...
#endif
#ifndef TUR_TY_tur_adt_Box2__int__int
#define TUR_TY_tur_adt_Box2__int__int
#ifndef TUR_FWD_tur_adt_Box2__int__int
#define TUR_FWD_tur_adt_Box2__int__int
typedef struct tur_adt_Box2__int__int tur_adt_Box2__int__int;
#endif
struct tur_adt_Box2__int__int {
    int64_t fst;
    int64_t snd;
};
#endif

#ifndef TUR_FN_tur_adt_Box2__int__int
#define TUR_FN_tur_adt_Box2__int__int
static tur_adt_Box2__int__int ctor_Box2_Box2__int__int(int64_t _0, int64_t _1) {
    tur_adt_Box2__int__int __r;
    __r.fst = _0;
    __r.snd = _1;
    return __r;
}
...
static tur_adt_Pt mk(int64_t);
static int64_t side(int64_t);
static tur_adt_Pt via_hyblock(int64_t);
static tur_adt_Pt via_hyblock_hythen(int64_t);
static tur_adt_Box2__int__int mk2(int64_t);
static tur_adt_Box2__int__int via_hyblock_hyparametric(int64_t);
...
__tur_cps_self:;
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_1005 = __ps_68;
        bool __ps_69 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_1004, (void *)(intptr_t)(k_1005), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_69;
        if (__t1) {
            int64_t __ps_70 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_71 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_1004, (void *)(intptr_t)(k_1005), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t73;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1009 = __ps_75;
            (void)iter_1009;
            void * __ps_76 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_77 = (hamt_slkeyeq((void *)(intptr_t)(__ps_76)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1010 = __ps_77;
            (void)keyeq_1010;
            void * __ps_78 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_79 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1009), (void *)(intptr_t)(__ps_78), (void *)(intptr_t)(keyeq_1010), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1011 = __ps_79;
            (void)result_1011;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_97) {
            bool __t98;
            {
                ...
                (void)t2_1302;
                bool __t99;
                bool __ps_100 = (tnil_qu(t1_1301));
                if (tur_panicking) return ((bool)0);
                if (__ps_100) {
                    bool __ps_101 = (tnil_qu(t2_1302));
                    if (tur_panicking) return ((bool)0);
                    __t99 = __ps_101;
                } else {
                    bool __t102;
                    bool __ps_103 = (tnil_qu(t2_1302));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_103) {
                        __t102 = false;
                    } else {
                        bool __ps_104 = (cons_hyeq_hygo(t1_1301, t2_1302));
                        if (tur_panicking) return ((bool)0);
                        __t102 = __ps_104;
                    }
                    __t99 = __t102;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_110) {
            ...
            int64_t __t111;
            {
                ...
                int64_t out_1317 = (int64_t)(intptr_t)(__ps_115);
                (void)out_1317;
                __t111 = out_1317;
            }
            __t109 = __t111;
        ...
        if (__ps_116) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1388 = __ps_117;
                (void)h_1388;
                void * __ps_118 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1389 = __ps_118;
                (void)k_1389;
                bool __ps_119 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1388, (void *)(intptr_t)(k_1389), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_119) {
                    void * __t120 = iter;
                    void * __t121 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t123;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1392 = __ps_125;
            (void)iter_1392;
            void * __ps_126 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_127 = (hamt_slkeyeq((void *)(intptr_t)(__ps_126)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1393 = __ps_127;
            (void)keyeq_1393;
            void * __ps_128 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_129 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1392), (void *)(intptr_t)(__ps_128), (void *)(intptr_t)(keyeq_1393)));
            if (tur_panicking) return ((bool)0);
            bool result_1394 = __ps_129;
            (void)result_1394;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t150;
        {
            ...
            {
                tur_adt_Vec__int * __ps_152 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1524));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1525 = __ps_152;
                (void)_un_unv_1525;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1575 = __ps_155;
            (void)r_1575;
            bool __ps_156 = (schema_hydecode_hyok_qu(r_1575));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_156) {
                return schema_hydecode_hyvalue(r_1575);
            } else {
                int64_t __ps_157 = (schema_hydecode_hyerrors(r_1575));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t159;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1626 = __ps_160;
            (void)m_1626;
            tur_frame __frame_161;
            tur_frame_init(&__frame_161, NULL);
            struct __defer_env_162 __t164 = {.m = m_1626};
...
static tur_adt_Pt mk(int64_t n) {
        tur_adt_Pt __ps_172 = (ctor_Pt_Pt(n, INT64_C(7)));
        if (tur_panicking) return (tur_adt_Pt){0};
        return __ps_172;
}

static int64_t side(int64_t x) {
        return x;
}

static tur_adt_Pt via_hyblock(int64_t n) {
        if ((n) == (INT64_C(0))) {
            tur_adt_Pt __ps_173 = (mk(INT64_C(0)));
            if (tur_panicking) return (tur_adt_Pt){0};
            return __ps_173;
        } else {
            {
                tur_adt_Pt __ps_174 = (mk(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                tur_adt_Pt r_1633 = __ps_174;
                (void)r_1633;
                int64_t __ps_175 = (side(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                int64_t _un_1634 = __ps_175;
                (void)_un_1634;
                int64_t __ps_176 = (side(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                (void)(__ps_176);
                return r_1633;
            }
...
static tur_adt_Pt via_hyblock_hythen(int64_t n) {
        if ((n) != (INT64_C(0))) {
            {
                tur_adt_Pt __ps_177 = (mk(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                tur_adt_Pt r_1636 = __ps_177;
                (void)r_1636;
                int64_t __ps_178 = (side(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                (void)(__ps_178);
                return r_1636;
            }
        } else {
            tur_adt_Pt __ps_179 = (mk(INT64_C(0)));
            if (tur_panicking) return (tur_adt_Pt){0};
            return __ps_179;
        }
}

static tur_adt_Box2__int__int mk2(int64_t n) {
        tur_adt_Box2__int__int __ps_180 = (ctor_Box2_Box2__int__int(n, INT64_C(7)));
        if (tur_panicking) return (tur_adt_Box2__int__int){0};
        return __ps_180;
}

static tur_adt_Box2__int__int via_hyblock_hyparametric(int64_t n) {
        if ((n) == (INT64_C(0))) {
            tur_adt_Box2__int__int __ps_181 = (mk2(INT64_C(0)));
            if (tur_panicking) return (tur_adt_Box2__int__int){0};
            return __ps_181;
        } else {
            {
                tur_adt_Box2__int__int __ps_182 = (mk2(n));
                if (tur_panicking) return (tur_adt_Box2__int__int){0};
                tur_adt_Box2__int__int r_1640 = __ps_182;
                (void)r_1640;
                int64_t __ps_183 = (side(n));
                if (tur_panicking) return (tur_adt_Box2__int__int){0};
                (void)(__ps_183);
                return r_1640;
            }
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Pt __ps_184 = (via_hyblock(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_184).x));
        tur_adt_Pt __ps_185 = (via_hyblock(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_185).y));
        tur_adt_Pt __ps_186 = (via_hyblock(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_186).x));
        tur_adt_Pt __ps_187 = (via_hyblock_hythen(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_187).x));
        tur_adt_Pt __ps_188 = (via_hyblock_hythen(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_188).y));
        tur_adt_Pt __ps_189 = (via_hyblock_hythen(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_189).x));
        tur_adt_Box2__int__int __ps_190 = (via_hyblock_hyparametric(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_190).fst));
        tur_adt_Box2__int__int __ps_191 = (via_hyblock_hyparametric(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_191).snd));
        int64_t __t192;
        __t192 = INT64_C(0);
        return (int)__t192;
}
