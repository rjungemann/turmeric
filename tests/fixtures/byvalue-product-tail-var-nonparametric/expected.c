...
static tur_adt_Pt mk(int64_t n) {
        tur_adt_Pt __ps_264 = (ctor_Pt_Pt(n, INT64_C(7)));
...
static tur_adt_Pt via_hyblock(int64_t n) {
        tur_adt_Pt __t265;
        if ((n) == (INT64_C(0))) {
            tur_adt_Pt __ps_266 = (mk(INT64_C(0)));
            if (tur_panicking) return (tur_adt_Pt){0};
            __t265 = __ps_266;
        } else {
            tur_adt_Pt __t267;
            {
                tur_adt_Pt __ps_268 = (mk(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                tur_adt_Pt r_1479 = __ps_268;
                (void)r_1479;
                int64_t __ps_269 = (side(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                int64_t _un_1480 = __ps_269;
                (void)_un_1480;
                int64_t __ps_270 = (side(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                (void)(__ps_270);
                tur_adt_Pt __t271;
                __t271 = r_1479;
...
static tur_adt_Pt via_hyblock_hythen(int64_t n) {
        ...
        if ((n) != (INT64_C(0))) {
            tur_adt_Pt __t273;
            {
                tur_adt_Pt __ps_274 = (mk(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                tur_adt_Pt r_1482 = __ps_274;
                (void)r_1482;
                int64_t __ps_275 = (side(n));
                if (tur_panicking) return (tur_adt_Pt){0};
                (void)(__ps_275);
                tur_adt_Pt __t276;
                __t276 = r_1482;
...
static tur_adt_Box2__int__int mk2(int64_t n) {
        tur_adt_Box2__int__int __ps_278 = (ctor_Box2_Box2__int__int(n, INT64_C(7)));
        if (tur_panicking) return (tur_adt_Box2__int__int){0};
        return __ps_278;
}

static tur_adt_Box2__int__int via_hyblock_hyparametric(int64_t n) {
        tur_adt_Box2__int__int __t279;
        if ((n) == (INT64_C(0))) {
            tur_adt_Box2__int__int __ps_280 = (mk2(INT64_C(0)));
            if (tur_panicking) return (tur_adt_Box2__int__int){0};
            __t279 = __ps_280;
        } else {
            tur_adt_Box2__int__int __t281;
            {
                tur_adt_Box2__int__int __ps_282 = (mk2(n));
                if (tur_panicking) return (tur_adt_Box2__int__int){0};
                tur_adt_Box2__int__int r_1486 = __ps_282;
                (void)r_1486;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Pt __ps_285 = (via_hyblock(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_285).x));
        tur_adt_Pt __ps_286 = (via_hyblock(INT64_C(3)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_286).y));
        tur_adt_Pt __ps_287 = (via_hyblock(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_287).x));
        tur_adt_Pt __ps_288 = (via_hyblock_hythen(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_288).x));
        tur_adt_Pt __ps_289 = (via_hyblock_hythen(INT64_C(4)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_289).y));
        tur_adt_Pt __ps_290 = (via_hyblock_hythen(INT64_C(0)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_290).x));
        tur_adt_Box2__int__int __ps_291 = (via_hyblock_hyparametric(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_291).fst));
        tur_adt_Box2__int__int __ps_292 = (via_hyblock_hyparametric(INT64_C(5)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)((int64_t)(__ps_292).snd));
        int64_t __t293;
        __t293 = INT64_C(0);
        return (int)__t293;
}
