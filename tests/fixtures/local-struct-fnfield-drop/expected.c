...
static tur_adt_Adder ctor_Adder_Adder(int64_t _0, int64_t _1) {
    tur_adt_Adder __r;
    __r.f = _0;
    __r.base = _1;
    return __r;
...
#ifndef TUR_CTORALIAS_Adder
#define TUR_CTORALIAS_Adder
#define ctor_Adder ctor_Adder_Adder
#endif
...
struct __env_1469 { tur_thunk_int64_t_int64_t_t __fn; int64_t n; };
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __t232;
        {
            int64_t n_1465 = INT64_C(100);
            (void)n_1465;
            void *__t234 = malloc(sizeof(void *) + sizeof(struct __env_1469));
            *(void (**)(void *))__t234 = drop_glue___env_1469;
            struct __env_1469 *__t233 = (struct __env_1469 *)((char *)__t234 + sizeof(void *));
            __t233->__fn = (tur_thunk_int64_t_int64_t_t)__fn_1467;
            __t233->n = n_1465;
            TUR_REGION_NOTE_WORDS(&(__t233->n), sizeof(__t233->n));
            void *__t235 = __t233;
            tur_adt_Adder __ps_236 = (ctor_Adder_Adder((int64_t)(intptr_t)(__t235), INT64_C(3)));
            /* panic-return-signal: ret ctype unknown; no propagation here */
            tur_adt_Adder a_1472 = __ps_236;
            (void)a_1472;
            int64_t __t237;
            {
                int64_t _un_uncall_unhead_un1473_1474 = (int64_t)(intptr_t)((int64_t)(a_1472).f);
                (void)_un_uncall_unhead_un1473_1474;
                int64_t __ps_238 = ((*( tur_thunk_int64_t_int64_t_t *)((void *)(intptr_t)(_un_uncall_unhead_un1473_1474)))((void *)(intptr_t)(_un_uncall_unhead_un1473_1474), INT64_C(10)));
                /* panic-return-signal: ret ctype unknown; no propagation here */
                __t237 = __ps_238;
            }
            printf("%lld\n", (long long)(__t237));
            ...
            __t239 = INT64_C(0);
            __t232 = __t239;
            drop_fnfields_tur_adt_Adder((void *)&a_1472);
        }
        return (int)__t232;
}
