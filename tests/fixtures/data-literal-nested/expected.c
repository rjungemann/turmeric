...
static int64_t vec_hyof_hymaps() {
        int64_t __t232;
        {
            tur_adt_Vec__Map__sym__int * __t233;
            {
                tur_adt_Map__sym__int * __t234;
                tur_adt_Map__sym__int * __t235;
                {
                    tur_adt_Map__sym__int * __ps_236 = (map_empty_for__spec__tur_adt_Map__sym__int___const_struct___tur_sym___int64_t(((const struct __tur_sym *)&__tur_sym_k), INT64_C(1)));
                    if (tur_panicking) return ((int64_t)0);
                    tur_adt_Map__sym__int * _un_untur_unmprev_un_un_1465 = __ps_236;
                    (void)_un_untur_unmprev_un_un_1465;
                    tur_adt_Map__sym__int * __t237;
                    {
                        tur_adt_Map__sym__int * __t238;
                        {
                            const struct __tur_sym * _un_untur_unmk_un_un_1466 = ((const struct __tur_sym *)&__tur_sym_k);
                            (void)_un_untur_unmk_un_un_1466;
                            int64_t _un_untur_unmv_un_un_1467 = INT64_C(1);
                            (void)_un_untur_unmv_un_un_1467;
                            int64_t __ps_239 = (INT64_C(0));
                            if (tur_panicking) return ((int64_t)0);
                            int64_t _un_untur_unmw_un_un_1468 = __ps_239;
                            (void)_un_untur_unmw_un_un_1468;
                            int64_t __ps_240 = (INT64_C(0));
                            if (tur_panicking) return ((int64_t)0);
                            int64_t _un_untur_unmr_un_un_1469 = __ps_240;
                            (void)_un_untur_unmr_un_un_1469;
                            tur_adt_Map__sym__int * __ps_241 = (tur_map_kcheck__spec__tur_adt_Map__sym__int___tur_adt_Map__sym__int___const_void__(_un_untur_unmprev_un_un_1465, &_un_untur_unmk_un_un_1466));
                            if (tur_panicking) return ((int64_t)0);
                            int64_t __ps_242 = (__inst_Hash_hash_Sym(_un_untur_unmk_un_un_1466));
                            if (tur_panicking) return ((int64_t)0);
                            int64_t __ps_243 = (__inst_MapKey_mk_hybox_Sym(_un_untur_unmk_un_un_1466));
                            if (tur_panicking) return ((int64_t)0);
                            int64_t __ps_244 = (__inst_MapKey_mk_hycmp_Sym(_un_untur_unmk_un_un_1466));
                            if (tur_panicking) return ((int64_t)0);
                            int64_t __ps_245 = (__inst_MapKey_mk_hyowned_qu_Sym(_un_untur_unmk_un_un_1466));
                            if (tur_panicking) return ((int64_t)0);
                            tur_adt_Map__sym__int * __ps_246 = (map_assoc_eq_o__spec__tur_adt_Map__sym__int___tur_adt_Map__sym__int___int64_t_int64_t_int64_t_int64_t_int64_t(__ps_241, __ps_242, __ps_243, _un_untur_unmv_un_un_1467, __ps_244, (__ps_245) + (((INT64_C(2)) * (_un_untur_unmw_un_un_1468)) + ((INT64_C(4)) * (_un_untur_unmr_un_un_1469)))));
                            if (tur_panicking) return ((int64_t)0);
                            __t238 = __ps_246;
                        }
                        tur_adt_Map__sym__int * _un_untur_unmnext_un_un_1470 = __t238;
                        (void)_un_untur_unmnext_un_un_1470;
                        map_hyfree((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(_un_untur_unmprev_un_un_1465))));
                        tur_adt_Map__sym__int * __t247;
                        __t247 = _un_untur_unmnext_un_un_1470;
                        __t237 = __t247;
                    }
                    __t235 = __t237;
                }
                __t234 = __t235;
                tur_adt_Map__sym__int * _un_unvw_1471 = __t234;
                (void)_un_unvw_1471;
                tur_adt_Vec__Map__sym__int * __t248;
                {
                    tur_adt_Vec__Map__sym__int * __ps_249 = (vec_empty_like____spec__tur_adt_Vec__Map__sym__int___tur_adt_Map__sym__int__(_un_unvw_1471));
                    if (tur_panicking) return ((int64_t)0);
                    tur_adt_Vec__Map__sym__int * _un_unv_1472 = __ps_249;
                    (void)_un_unv_1472;
                    vec_hypush_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(_un_unv_1472))), (int64_t)(intptr_t)((int64_t)(intptr_t)(_un_unvw_1471)));
                    tur_adt_Map__sym__int * __t250;
                    tur_adt_Map__sym__int * __t251;
                    {
                        tur_adt_Map__sym__int * __ps_252 = (map_empty_for__spec__tur_adt_Map__sym__int___const_struct___tur_sym___int64_t(((const struct __tur_sym *)&__tur_sym_k), INT64_C(2)));
                        if (tur_panicking) return ((int64_t)0);
                        tur_adt_Map__sym__int * _un_untur_unmprev_un_un_1473 = __ps_252;
                        (void)_un_untur_unmprev_un_un_1473;
                        tur_adt_Map__sym__int * __t253;
                        {
                            tur_adt_Map__sym__int * __t254;
                            {
                                const struct __tur_sym * _un_untur_unmk_un_un_1474 = ((const struct __tur_sym *)&__tur_sym_k);
                                (void)_un_untur_unmk_un_un_1474;
                                int64_t _un_untur_unmv_un_un_1475 = INT64_C(2);
                                (void)_un_untur_unmv_un_un_1475;
                                int64_t __ps_255 = (INT64_C(0));
                                if (tur_panicking) return ((int64_t)0);
                                int64_t _un_untur_unmw_un_un_1476 = __ps_255;
                                (void)_un_untur_unmw_un_un_1476;
                                int64_t __ps_256 = (INT64_C(0));
                                if (tur_panicking) return ((int64_t)0);
                                int64_t _un_untur_unmr_un_un_1477 = __ps_256;
                                (void)_un_untur_unmr_un_un_1477;
                                tur_adt_Map__sym__int * __ps_257 = (tur_map_kcheck__spec__tur_adt_Map__sym__int___tur_adt_Map__sym__int___const_void__(_un_untur_unmprev_un_un_1473, &_un_untur_unmk_un_un_1474));
                                if (tur_panicking) return ((int64_t)0);
                                int64_t __ps_258 = (__inst_Hash_hash_Sym(_un_untur_unmk_un_un_1474));
                                if (tur_panicking) return ((int64_t)0);
                                int64_t __ps_259 = (__inst_MapKey_mk_hybox_Sym(_un_untur_unmk_un_un_1474));
                                if (tur_panicking) return ((int64_t)0);
                                int64_t __ps_260 = (__inst_MapKey_mk_hycmp_Sym(_un_untur_unmk_un_un_1474));
                                if (tur_panicking) return ((int64_t)0);
                                int64_t __ps_261 = (__inst_MapKey_mk_hyowned_qu_Sym(_un_untur_unmk_un_un_1474));
                                if (tur_panicking) return ((int64_t)0);
                                tur_adt_Map__sym__int * __ps_262 = (map_assoc_eq_o__spec__tur_adt_Map__sym__int___tur_adt_Map__sym__int___int64_t_int64_t_int64_t_int64_t_int64_t(__ps_257, __ps_258, __ps_259, _un_untur_unmv_un_un_1475, __ps_260, (__ps_261) + (((INT64_C(2)) * (_un_untur_unmw_un_un_1476)) + ((INT64_C(4)) * (_un_untur_unmr_un_un_1477)))));
                                if (tur_panicking) return ((int64_t)0);
                                __t254 = __ps_262;
                            }
                            tur_adt_Map__sym__int * _un_untur_unmnext_un_un_1478 = __t254;
                            (void)_un_untur_unmnext_un_un_1478;
                            map_hyfree((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(_un_untur_unmprev_un_un_1473))));
                            tur_adt_Map__sym__int * __t263;
                            __t263 = _un_untur_unmnext_un_un_1478;
                            __t253 = __t263;
                        }
                        __t251 = __t253;
                    }
                    __t250 = __t251;
                    vec_hypush_ex((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(_un_unv_1472))), (int64_t)(intptr_t)((int64_t)(intptr_t)(__t250)));
                    tur_adt_Vec__Map__sym__int * __t264;
                    __t264 = _un_unv_1472;
                    __t248 = __t264;
                }
                __t233 = __t248;
            }
            tur_adt_Vec__Map__sym__int * v_1479 = __t233;
            (void)v_1479;
            int64_t __ps_265 = (vec_hylen((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(v_1479)))));
            if (tur_panicking) return ((int64_t)0);
            __t232 = __ps_265;
        }
        return __t232;
...
static int64_t map_hywith_hyset() {
        int64_t __t266;
        {
            tur_adt_Map__sym__Set__int * __t267;
            tur_adt_Map__sym__Set__int * __t268;
            {
                tur_adt_Set__int * __ps_269 = (set_empty_for__spec__tur_adt_Set__int___int64_t(INT64_C(1)));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Set__int * __ps_270 = (set_add_elem____spec__tur_adt_Set__int___tur_adt_Set__int___int64_t(__ps_269, INT64_C(1)));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Set__int * __ps_271 = (set_add_elem____spec__tur_adt_Set__int___tur_adt_Set__int___int64_t(__ps_270, INT64_C(2)));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Set__int * __ps_272 = (set_add_elem____spec__tur_adt_Set__int___tur_adt_Set__int___int64_t(__ps_271, INT64_C(3)));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Map__sym__Set__int * __ps_273 = (map_empty_for__spec__tur_adt_Map__sym__Set__int___const_struct___tur_sym___tur_adt_Set__int__(((const struct __tur_sym *)&__tur_sym_tags), __ps_272));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Map__sym__Set__int * _un_untur_unmprev_un_un_1480 = __ps_273;
                (void)_un_untur_unmprev_un_un_1480;
                tur_adt_Map__sym__Set__int * __t274;
                {
                    tur_adt_Map__sym__Set__int * __t275;
                    {
                        const struct __tur_sym * _un_untur_unmk_un_un_1481 = ((const struct __tur_sym *)&__tur_sym_tags);
                        (void)_un_untur_unmk_un_un_1481;
                        tur_adt_Set__int * __ps_276 = (set_empty_for__spec__tur_adt_Set__int___int64_t(INT64_C(1)));
                        if (tur_panicking) return ((int64_t)0);
                        tur_adt_Set__int * __ps_277 = (set_add_elem____spec__tur_adt_Set__int___tur_adt_Set__int___int64_t(__ps_276, INT64_C(1)));
                        if (tur_panicking) return ((int64_t)0);
                        tur_adt_Set__int * __ps_278 = (set_add_elem____spec__tur_adt_Set__int___tur_adt_Set__int___int64_t(__ps_277, INT64_C(2)));
                        if (tur_panicking) return ((int64_t)0);
                        tur_adt_Set__int * __ps_279 = (set_add_elem____spec__tur_adt_Set__int___tur_adt_Set__int___int64_t(__ps_278, INT64_C(3)));
                        if (tur_panicking) return ((int64_t)0);
                        tur_adt_Set__int * _un_untur_unmv_un_un_1482 = __ps_279;
                        (void)_un_untur_unmv_un_un_1482;
                        int64_t __ps_280 = (INT64_C(0));
                        if (tur_panicking) return ((int64_t)0);
                        int64_t _un_untur_unmw_un_un_1483 = __ps_280;
                        (void)_un_untur_unmw_un_un_1483;
                        int64_t __ps_281 = (INT64_C(0));
                        if (tur_panicking) return ((int64_t)0);
                        int64_t _un_untur_unmr_un_un_1484 = __ps_281;
                        (void)_un_untur_unmr_un_un_1484;
                        tur_adt_Map__sym__Set__int * __ps_282 = (tur_map_kcheck__spec__tur_adt_Map__sym__Set__int___tur_adt_Map__sym__Set__int___const_void__(_un_untur_unmprev_un_un_1480, &_un_untur_unmk_un_un_1481));
                        if (tur_panicking) return ((int64_t)0);
                        int64_t __ps_283 = (__inst_Hash_hash_Sym(_un_untur_unmk_un_un_1481));
                        if (tur_panicking) return ((int64_t)0);
                        int64_t __ps_284 = (__inst_MapKey_mk_hybox_Sym(_un_untur_unmk_un_un_1481));
                        if (tur_panicking) return ((int64_t)0);
                        int64_t __ps_285 = (__inst_MapKey_mk_hycmp_Sym(_un_untur_unmk_un_un_1481));
                        if (tur_panicking) return ((int64_t)0);
                        int64_t __ps_286 = (__inst_MapKey_mk_hyowned_qu_Sym(_un_untur_unmk_un_un_1481));
                        if (tur_panicking) return ((int64_t)0);
                        tur_adt_Map__sym__Set__int * __ps_287 = (map_assoc_eq_o__spec__tur_adt_Map__sym__Set__int___tur_adt_Map__sym__Set__int___int64_t_int64_t_int64_t_int64_t_int64_t(__ps_282, __ps_283, __ps_284, (int64_t)(intptr_t)((int64_t)(intptr_t)(_un_untur_unmv_un_un_1482)), __ps_285, (__ps_286) + (((INT64_C(2)) * (_un_untur_unmw_un_un_1483)) + ((INT64_C(4)) * (_un_untur_unmr_un_un_1484)))));
                        if (tur_panicking) return ((int64_t)0);
                        __t275 = __ps_287;
                    }
                    tur_adt_Map__sym__Set__int * _un_untur_unmnext_un_un_1485 = __t275;
                    (void)_un_untur_unmnext_un_un_1485;
                    map_hyfree((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(_un_untur_unmprev_un_un_1480))));
                    tur_adt_Map__sym__Set__int * __t288;
                    __t288 = _un_untur_unmnext_un_un_1485;
                    __t274 = __t288;
                }
                __t268 = __t274;
            }
            __t267 = __t268;
            tur_adt_Map__sym__Set__int * m_1486 = __t267;
            (void)m_1486;
            tur_adt_Set__int * __t289;
            {
                const struct __tur_sym * _un_untur_unmk_un_un_1487 = ((const struct __tur_sym *)&__tur_sym_tags);
                (void)_un_untur_unmk_un_un_1487;
                tur_adt_Map__sym__Set__int * __ps_290 = (tur_map_kcheck__spec__tur_adt_Map__sym__Set__int___tur_adt_Map__sym__Set__int___const_void__(m_1486, &_un_untur_unmk_un_un_1487));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_291 = (__inst_Hash_hash_Sym(_un_untur_unmk_un_un_1487));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_292 = (__inst_MapKey_mk_hybox_Sym(_un_untur_unmk_un_un_1487));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_293 = (__inst_MapKey_mk_hycmp_Sym(_un_untur_unmk_un_un_1487));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_294 = (__inst_MapKey_mk_hyowned_qu_Sym(_un_untur_unmk_un_un_1487));
                if (tur_panicking) return ((int64_t)0);
                int64_t __ps_295 = (map_hyget_hyeq_hyo((int64_t)(intptr_t)((int64_t)(intptr_t)((int64_t)(intptr_t)(__ps_290))), __ps_291, __ps_292, __ps_293, __ps_294));
                if (tur_panicking) return ((int64_t)0);
                __t289 = (tur_adt_Set__int *)(intptr_t)(__ps_295);
            }
            int64_t __ps_296 = (set_hycount((int64_t)(intptr_t)(__t289)));
            if (tur_panicking) return ((int64_t)0);
            __t266 = __ps_296;
        }
        return __t266;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        int64_t __ps_297 = (vec_hyof_hymaps());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_297));
        int64_t __ps_298 = (map_hywith_hyset());
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_298));
        int64_t __t299;
        __t299 = INT64_C(0);
...
static tur_adt_Map__sym__int * map_empty_for__spec__tur_adt_Map__sym__int___const_struct___tur_sym___int64_t(const struct __tur_sym * k, int64_t v) {
        tur_adt_Map__sym__int * __ps_302 = (map_new__spec__tur_adt_Map__sym__int__());
...
static tur_adt_Vec__Map__sym__int * vec_empty_like____spec__tur_adt_Vec__Map__sym__int___tur_adt_Map__sym__int__(tur_adt_Map__sym__int * witness) {
        tur_adt_Vec__Map__sym__int * __ps_303 = (vec_new__spec__tur_adt_Vec__Map__sym__int__());
...
static tur_adt_Map__sym__Set__int * map_empty_for__spec__tur_adt_Map__sym__Set__int___const_struct___tur_sym___tur_adt_Set__int__(const struct __tur_sym * k, tur_adt_Set__int * v) {
        tur_adt_Map__sym__Set__int * __ps_304 = (map_new__spec__tur_adt_Map__sym__Set__int__());
...
static tur_adt_Set__int * set_add_elem____spec__tur_adt_Set__int___tur_adt_Set__int___int64_t(tur_adt_Set__int * s, int64_t x) {
        int64_t __ps_305 = (__inst_Hash_hash_int(x));
        if (tur_panicking) return ((tur_adt_Set__int *)0);
        int64_t __ps_306 = (__inst_MapKey_mk_hybox_int(x));
        if (tur_panicking) return ((tur_adt_Set__int *)0);
        int64_t __ps_307 = (__inst_MapKey_mk_hycmp_int(x));
        if (tur_panicking) return ((tur_adt_Set__int *)0);
        int64_t __ps_308 = (__inst_MapKey_mk_hyowned_qu_int(x));
        if (tur_panicking) return ((tur_adt_Set__int *)0);
        tur_adt_Set__int * __ps_309 = (set_add_eq_o__spec__tur_adt_Set__int___tur_adt_Set__int___int64_t_int64_t_int64_t_int64_t((tur_adt_Set__int *)(intptr_t)(s), __ps_305, __ps_306, __ps_307, __ps_308));
        if (tur_panicking) return ((tur_adt_Set__int *)0);
        return __ps_309;
}
...
static tur_adt_Set__int * set_empty_for__spec__tur_adt_Set__int___int64_t(int64_t x) {
        tur_adt_Set__int * __ps_310 = (set_new__spec__tur_adt_Set__int__());
        if (tur_panicking) return ((tur_adt_Set__int *)0);
        return __ps_310;
}
