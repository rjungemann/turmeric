...
static int64_t __fn_895(void *, int64_t);
static int64_t __fn_900(int64_t);
static int64_t __inst_HasAdder_adder_AddW(int64_t);
...
static int64_t call_fat(int64_t, int64_t);
...
struct __env_897 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_895(void * __env_p_898, int64_t y) {
        struct __env_897 *__env___env_897 = (struct __env_897 *)__env_p_898;
        return (__env___env_897->x) + (y);
}

static int64_t __fn_900(int64_t x) {
        struct __env_897 *__t20 = (struct __env_897 *)malloc(sizeof(struct __env_897));
...
typedef struct dict_HasAdder_AddW {
    int64_t (*adder)(int64_t);
} dict_HasAdder_AddW;

static dict_HasAdder_AddW dict_HasAdder_AddW_singleton = {
    .adder = __inst_HasAdder_adder_AddW,
};
        ...
        if (tnil_qu(l1)) {
            ...
            if (tnil_qu(l2)) {
                ...
                if ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), list_head(l1), list_head(l2))) {
                    __t24 = list_eq_qu(list_tail(l1), list_tail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t24 = false;
                }
                __t23 = __t24;
...
static int64_t call_fat(int64_t f, int64_t x) {
...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_906 = (int64_t)(INT64_C(0));
            (void)w_906;
            int64_t f1 = (int64_t)(intptr_t)(__inst_HasAdder_adder_AddW(w_906));
            (void)f1;
            int64_t f2_908 = call_thin((int64_t)(intptr_t)(f1), INT64_C(20));
            (void)f2_908;
            printf("%lld\n", (long long)(call_fat(f2_908, INT64_C(3))));
        }
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
