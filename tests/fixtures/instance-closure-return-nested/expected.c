...
static int64_t __fn_884(void *, int64_t);
...
struct __env_886 { tur_thunk_int64_t_int64_t_t __fn; int64_t x; };
static int64_t __fn_884(void * __env_p_887, int64_t y) {
        struct __env_886 *__env___env_886 = (struct __env_886 *)__env_p_887;
        return (__env___env_886->x) + (y);
}

static int64_t __fn_889(int64_t x) {
        struct __env_886 *__t20 = (struct __env_886 *)malloc(sizeof(struct __env_886));
        __t20->__fn = (tur_thunk_int64_t_int64_t_t)__fn_884;
        __t20->x = x;
        void *__t21 = __t20;
        return __t21;
}
...
int main(int argc, char **argv) {
        ...
        {
            int64_t w_895 = (int64_t)(INT64_C(0));
            (void)w_895;
            int64_t f1 = (int64_t)(intptr_t)(__inst_HasAdder_adder_AddW(w_895));
            (void)f1;
            int64_t f2_897 = call_thin((int64_t)(intptr_t)(f1), INT64_C(20));
            (void)f2_897;
            printf("%lld\n", (long long)(call_fat(f2_897, INT64_C(3))));
        }
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
