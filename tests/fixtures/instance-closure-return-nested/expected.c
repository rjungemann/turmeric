...
static int64_t call_hythin(int64_t, int64_t);
static int64_t call_hyfat(int64_t, int64_t);
        ...
        if (tnil_qu(l1)) {
            ...
            if (tnil_qu(l2)) {
                ...
                if ((*( tur_thunk_bool_int64_t_int64_t_t *)((void *)(intptr_t)(cmp_fn)))((void *)(intptr_t)(cmp_fn), list_hyhead(l1), list_hyhead(l2))) {
                    __t24 = list_hyeq_qu(list_hytail(l1), list_hytail(l2), (int64_t)(intptr_t)(cmp_fn));
                } else {
                    __t24 = false;
                }
                __t23 = __t24;
...
static int64_t _un_uncons_hyfmap(int64_t cell, void * f) {
        ...
        if (tnil_qu(cell)) {
            ...
            __t25 = tcons((*( tur_thunk_int64_t_int64_t_t *)(f))(f, list_hyhead(cell)), _un_uncons_hyfmap(list_hytail(cell), (void *)(intptr_t)(f)));
        }
        return __t25;
}
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (tnil_qu(l1)) {
            ...
            __t26 = tcons(list_hyhead(l1), list_hyconcat(list_hytail(l1), l2));
        }
        return __t26;
}
...
static int64_t call_hythin(int64_t f, int64_t x) {
...
int main(int argc, char **argv) {
        ...
        }
        {
            ...
            (void)f1;
            int64_t f2_908 = call_hythin((int64_t)(intptr_t)(f1), INT64_C(20));
            (void)f2_908;
            printf("%lld\n", (long long)(call_hyfat(f2_908, INT64_C(3))));
        }
        int64_t __t27;
        __t27 = INT64_C(0);
        return (int)__t27;
