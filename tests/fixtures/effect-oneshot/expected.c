...
static int64_t pick_two();

static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env);
static int64_t __effect_handler_5(int64_t *__effect_args, int __n_effect_args, int64_t __k, void *__env) {
    int64_t n_208 = (int64_t)__effect_args[0];
    int64_t k_209 = __k;
    int64_t __t6 = tur_effect_cont_resume((int64_t)(intptr_t)k_209, (int64_t)((n_208) * (INT64_C(10))));
    return (int64_t)__t6;
}

static void __handle_body_4(void);
static void __handle_body_4(void) {
    tur_current_fiber->result = (int64_t)pick_two();
}
...
static int64_t __dispatch_4(void *__ctx_void, int64_t __k_int, int64_t __resume_val) {
    ...
    if (strcmp(__dcap->eff_name, "Choose") == 0) {
...
static int64_t pick_two() {
        int64_t __t0[1];
        __t0[0] = (int64_t)INT64_C(1);
        int64_t __t1 = tur_effect_perform("Choose", __t0, 1);
        int64_t __t2[1];
        __t2[0] = (int64_t)INT64_C(2);
        int64_t __t3 = tur_effect_perform("Choose", __t2, 1);
        return ((__t1) + (__t3));
}
...
int main(void) {
    ...
    __eff_frame_4.cases[0].effect_name = "Choose";
