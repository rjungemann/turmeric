...
static int64_t __inst_Clone_clone_Pr(Pr x) {
...
typedef struct dict_Clone_Pr {
    int64_t (*clone)(Pr);
} dict_Clone_Pr;

static dict_Clone_Pr dict_Clone_Pr_singleton = {
    .clone = __inst_Clone_clone_Pr,
};
