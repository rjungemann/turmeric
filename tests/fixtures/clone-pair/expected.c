...
int main() {
        {
            Pair p_205 = (Pair){.first = INT64_C(10), .second = INT64_C(20)};
            (void)p_205;
            {
                int64_t p2_206 = ((int64_t (*)(Pair))(intptr_t)(dict_Clone_Pair_singleton.clone))(p_205);
                (void)p2_206;
                printf("%lld\n", (long long)(((heap_pair_first(p2_206)) + (heap_pair_second(p2_206)))));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
