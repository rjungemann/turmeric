...
static int64_t __inst_Clone_clone_Pair(Pair);
...
static int64_t heap_pair_first(int64_t);
static int64_t heap_pair_second(int64_t);
...
static int64_t __inst_Clone_clone_Pair(Pair x) {
...
typedef struct dict_Clone_Pair {
    int64_t (*clone)(Pair);
} dict_Clone_Pair;

static dict_Clone_Pair dict_Clone_Pair_singleton = {
    .clone = __inst_Clone_clone_Pair,
};
...
static int64_t heap_pair_first(int64_t p) {
        struct { int64_t first; int64_t second; } *pair = (void *)(intptr_t)p;
  return pair->first;
  
}

static int64_t heap_pair_second(int64_t p) {
        struct { int64_t first; int64_t second; } *pair = (void *)(intptr_t)p;
  return pair->second;
...
int main() {
        {
            Pair p_270 = (Pair){.first = INT64_C(10), .second = INT64_C(20)};
            (void)p_270;
            {
                int64_t p2_271 = ((int64_t (*)(Pair))(intptr_t)(dict_Clone_Pair_singleton.clone))(p_270);
                (void)p2_271;
                printf("%lld\n", (long long)(((heap_pair_first(p2_271)) + (heap_pair_second(p2_271)))));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
