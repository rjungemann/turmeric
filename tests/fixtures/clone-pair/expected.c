...
int main() {
        {
            Pair p_217 = (Pair){.first = INT64_C(10), .second = INT64_C(20)};
            (void)p_217;
            {
                int64_t p2_218 = ((int64_t (*)(Pair))(intptr_t)(dict_Clone_Pair_singleton.clone))(p_217);
                (void)p2_218;
                printf("%lld\n", (long long)(((heap_pair_first(p2_218)) + (heap_pair_second(p2_218)))));
            }
        }
        int64_t __t0;
        __t0 = INT64_C(0);
