...
struct __defer_env_2 {void * r; };

static void __defer_3(void *__env) {
    struct __defer_env_2 *__e = (struct __defer_env_2 *)__env;
    free(__e->r);
}

static int64_t ret_int(int64_t);
static void * ret_ref();
static int64_t ret_int(int64_t x) {
        return x;
}
...
static void * ret_ref() {
        {
            ...
            *((int64_t *)__t0) = INT64_C(7);
            ...
            tur_frame_fire_chain(&__frame_1);
            return r_4;
            struct __defer_env_2 __t4 = {.r = r_4};
            tur_frame_push_defer(&__frame_1, __defer_3, &__t4);
