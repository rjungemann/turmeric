...
struct __env_1285 { tur_thunk_int64_t_t __fn; tur_adt_Box__int w; int64_t n; };
static int64_t __fn_1283(void * __env_p_1286) {
        struct __env_1285 *__env___env_1285 = (struct __env_1285 *)__env_p_1286;
        tur_adt_Box__int __t40 = __env___env_1285->w;
        __auto_type __ps_41 = (step(&__t40, (__env___env_1285->n) - (INT64_C(1))));
         ...
         switch (__pc) {
          ...
          case 3: {
           ...
           int64_t __t181 = 0;
           {
               const tur_adt_Box__int *__scrut = (w);
               {
                   int64_t a_1288 = (int64_t)__scrut->as.MkBox._0;
                   int64_t b_1289 = (int64_t)__scrut->as.MkBox._1;
                   int64_t c_1290 = (int64_t)__scrut->as.MkBox._2;
                   __t181 = b_1289;
                   goto ____t182;
               }
               ____t182:;
