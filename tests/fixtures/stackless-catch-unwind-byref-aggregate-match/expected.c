...
typedef struct tur_adt_Box {
    union {
        struct { int64_t _0; int64_t _1; int64_t _2; } MkBox;
    } as;
} tur_adt_Box;

static int64_t ctor_Box_MkBox(int64_t _0, int64_t _1, int64_t _2) {
    tur_adt_Box *__r = (tur_adt_Box *)malloc(sizeof(tur_adt_Box));
    __r->as.MkBox._0 = _0;
    TUR_REGION_NOTE_WORDS(&(__r->as.MkBox._0), sizeof(__r->as.MkBox._0));
    __r->as.MkBox._1 = _1;
    TUR_REGION_NOTE_WORDS(&(__r->as.MkBox._1), sizeof(__r->as.MkBox._1));
    __r->as.MkBox._2 = _2;
    TUR_REGION_NOTE_WORDS(&(__r->as.MkBox._2), sizeof(__r->as.MkBox._2));
    return (int64_t)(intptr_t)__r;
}

#ifndef TUR_CTORALIAS_MkBox
#define TUR_CTORALIAS_MkBox
#define ctor_MkBox ctor_Box_MkBox
#endif
...
#endif
#ifndef TUR_TY_tur_adt_Box__int
#define TUR_TY_tur_adt_Box__int
#ifndef TUR_FWD_tur_adt_Box__int
#define TUR_FWD_tur_adt_Box__int
typedef struct tur_adt_Box__int tur_adt_Box__int;
#endif
struct tur_adt_Box__int {
    union {
        struct { int64_t _0; int64_t _1; int64_t _2; } MkBox;
    } as;
};
...
#ifndef TUR_FN_tur_adt_Box__int
#define TUR_FN_tur_adt_Box__int
static tur_adt_Box__int ctor_Box_MkBox__int(int64_t _0, int64_t _1, int64_t _2) {
    tur_adt_Box__int __r;
    __r.as.MkBox._0 = _0;
    __r.as.MkBox._1 = _1;
    __r.as.MkBox._2 = _2;
    return __r;
...
static int64_t step(const tur_adt_Box__int *, int64_t);
...
struct __env_1631 { tur_thunk_int64_t_t __fn; tur_adt_Box__int w; int64_t n; };
...
static int64_t __fn_1629(void * __env_p_1632) {
        ...
        tur_adt_Box__int __t62 = __env___env_1631->w;
        return step(&__t62, (__env___env_1631->n) - (INT64_C(1)));
}
...
__tur_cps_self:;
    ...
    if (__t0) {
        ...
        if (tur_panicking) return ((int64_t)0);
        k_999 = __ps_69;
        bool __ps_70 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(m2_hamt), h_998, (void *)(intptr_t)(k_999), (void *)(intptr_t)(keyeq)));
        if (tur_panicking) return ((int64_t)0);
        __t1 = __ps_70;
        if (__t1) {
            int64_t __ps_71 = (map_hyiter_hycur_hyval_hyas((void *)(intptr_t)(iter)));
            if (tur_panicking) return ((int64_t)0);
            int64_t __ps_72 = (map_hyget_hydynamic_hyas((void *)(intptr_t)(m2_hamt), h_998, (void *)(intptr_t)(k_999), (void *)(intptr_t)(keyeq)));
            if (tur_panicking) return ((int64_t)0);
...
static bool map_hyeq_hydriver(int64_t m1, int64_t m2, int64_t val_cmp) {
        bool __t74;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1003 = __ps_76;
            (void)iter_1003;
            void * __ps_77 = (map_hyhamt(m1));
            if (tur_panicking) return ((bool)0);
            void * __ps_78 = (hamt_slkeyeq((void *)(intptr_t)(__ps_77)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1004 = __ps_78;
            (void)keyeq_1004;
            void * __ps_79 = (map_hyhamt(m2));
            if (tur_panicking) return ((bool)0);
            bool __ps_80 = (map_hyeq_hyloop((void *)(intptr_t)(iter_1003), (void *)(intptr_t)(__ps_79), (void *)(intptr_t)(keyeq_1004), (int64_t)(intptr_t)(val_cmp)));
            if (tur_panicking) return ((bool)0);
            bool result_1005 = __ps_80;
            (void)result_1005;
...
static bool cons_hyeq_hygo(int64_t c1, int64_t c2) {
        ...
        if (__ps_98) {
            bool __t99;
            {
                ...
                (void)t2_1296;
                bool __t100;
                bool __ps_101 = (tnil_qu(t1_1295));
                if (tur_panicking) return ((bool)0);
                if (__ps_101) {
                    bool __ps_102 = (tnil_qu(t2_1296));
                    if (tur_panicking) return ((bool)0);
                    __t100 = __ps_102;
                } else {
                    bool __t103;
                    bool __ps_104 = (tnil_qu(t2_1296));
                    if (tur_panicking) return ((bool)0);
                    if (__ps_104) {
                        __t103 = false;
                    } else {
                        bool __ps_105 = (cons_hyeq_hygo(t1_1295, t2_1296));
                        if (tur_panicking) return ((bool)0);
                        __t103 = __ps_105;
                    }
                    __t100 = __t103;
...
static int64_t list_hyconcat(int64_t l1, int64_t l2) {
        ...
        if (__ps_111) {
            ...
            int64_t __t112;
            {
                ...
                int64_t out_1311 = (int64_t)(intptr_t)(__ps_116);
                (void)out_1311;
                __t112 = out_1311;
            }
            __t110 = __t112;
        ...
        if (__ps_117) {
            {
                ...
                if (tur_panicking) return ((bool)0);
                int64_t h_1382 = __ps_118;
                (void)h_1382;
                void * __ps_119 = (hamt_sliter_hycur_hykey((void *)(intptr_t)(iter)));
                if (tur_panicking) return ((bool)0);
                void * k_1383 = __ps_119;
                (void)k_1383;
                bool __ps_120 = (hamt_slhas_hydynamic_qu((void *)(intptr_t)(s2_hamt), h_1382, (void *)(intptr_t)(k_1383), (void *)(intptr_t)(keyeq)));
                if (tur_panicking) return ((bool)0);
                if (__ps_120) {
                    void * __t121 = iter;
                    void * __t122 = s2_hamt;
...
static bool set_hyeq_hydriver(int64_t s1, int64_t s2) {
        bool __t124;
        {
            ...
            if (tur_panicking) return ((bool)0);
            void * iter_1386 = __ps_126;
            (void)iter_1386;
            void * __ps_127 = (set_hyhamt(s1));
            if (tur_panicking) return ((bool)0);
            void * __ps_128 = (hamt_slkeyeq((void *)(intptr_t)(__ps_127)));
            if (tur_panicking) return ((bool)0);
            void * keyeq_1387 = __ps_128;
            (void)keyeq_1387;
            void * __ps_129 = (set_hyhamt(s2));
            if (tur_panicking) return ((bool)0);
            bool __ps_130 = (set_hyeq_hyloop((void *)(intptr_t)(iter_1386), (void *)(intptr_t)(__ps_129), (void *)(intptr_t)(keyeq_1387)));
            if (tur_panicking) return ((bool)0);
            bool result_1388 = __ps_130;
            (void)result_1388;
...
static int64_t schema_slalt(int64_t a, int64_t b) {
        tur_adt_Vec__int * __t151;
        {
            ...
            {
                tur_adt_Vec__int * __ps_153 = (vec_empty_like____spec__tur_adt_Vec__int___int64_t(_un_unvw_1518));
                if (tur_panicking) return ((int64_t)0);
                tur_adt_Vec__int * _un_unv_1519 = __ps_153;
                (void)_un_unv_1519;
...
static int64_t schema_hydecode_ex(int64_t schema, int64_t node) {
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t r_1569 = __ps_156;
            (void)r_1569;
            bool __ps_157 = (schema_hydecode_hyok_qu(r_1569));
            if (tur_panicking) return ((int64_t)0);
            if (__ps_157) {
                return schema_hydecode_hyvalue(r_1569);
            } else {
                int64_t __ps_158 = (schema_hydecode_hyerrors(r_1569));
                if (tur_panicking) return ((int64_t)0);
...
static int64_t bt_hyscope(int64_t body) {
        int64_t __t160;
        {
            ...
            if (tur_panicking) return ((int64_t)0);
            int64_t m_1620 = __ps_161;
            (void)m_1620;
            tur_frame __frame_162;
            tur_frame_init(&__frame_162, NULL);
            struct __defer_env_163 __t165 = {.m = m_1620};
...
static int64_t step(const tur_adt_Box__int * w, int64_t n) {
        tur_adt_Box__int w__agg;
        int64_t __t173 = 0;
        int64_t __t174 = 0;
         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            int64_t __t175 = 0;
            {
                const tur_adt_Box__int *__scrut = (w);
                {
                    int64_t a_1626 = (int64_t)__scrut->as.MkBox._0;
                    int64_t b_1627 = (int64_t)__scrut->as.MkBox._1;
                    int64_t c_1628 = (int64_t)__scrut->as.MkBox._2;
                    __t175 = a_1626;
                    goto ____t176;
                }
                ____t176:;
            ...
            { void *__ab = malloc(sizeof(tur_adt_Box__int)); memcpy(__ab, w, sizeof(tur_adt_Box__int)); __n177->saved[0] = (int64_t)(intptr_t)__ab; }
          ...
          case 2: {
           const tur_adt_Box__int *__ra178_0 = (w);
           int64_t __ra178_1 = ((n) - (INT64_C(1)));
           memmove(&w__agg, __ra178_0, sizeof(tur_adt_Box__int)); w = &w__agg;
           n = __ra178_1;
           __pc = 1; break;
          }
          case 3: {
           { void *__ab = (void*)(intptr_t)__k->saved[0]; memcpy(&w__agg, __ab, sizeof(tur_adt_Box__int)); free(__ab); w = &w__agg; }
           ...
           int64_t __t179 = 0;
           {
               const tur_adt_Box__int *__scrut = (w);
               {
                   int64_t a_1634 = (int64_t)__scrut->as.MkBox._0;
                   int64_t b_1635 = (int64_t)__scrut->as.MkBox._1;
                   int64_t c_1636 = (int64_t)__scrut->as.MkBox._2;
                   __t179 = b_1635;
                   goto ____t180;
               }
               ____t180:;
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        tur_adt_Box__int __ps_181 = (ctor_Box_MkBox__int(INT64_C(5), INT64_C(6), INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Box__int __t182 = __ps_181;
        int64_t __ps_183 = (step(&__t182, INT64_C(200000)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        printf("%lld\n", (long long)(__ps_183));
        int64_t __t184;
        __t184 = INT64_C(0);
