         ...
         switch (__pc) {
          ...
          case 1: {
           if ((n) == (INT64_C(0))) {
            ...
            { void *__ab = malloc(sizeof(tur_adt_Box__int)); memcpy(__ab, w, sizeof(tur_adt_Box__int)); __n159->saved[0] = (int64_t)(intptr_t)__ab; }
          ...
          case 2: {
           __auto_type __ra160_0 = (w);
           __auto_type __ra160_1 = ((n) - (INT64_C(1)));
           memmove(&w__agg, __ra160_0, sizeof(tur_adt_Box__int)); w = &w__agg;
           n = __ra160_1;
           __pc = 1; break;
          }
          case 3: {
...
int main(int argc, char **argv) {
    ...
    _setmode(_fileno(stderr), _O_BINARY);
        ...
        __auto_type __ps_163 = (ctor_MkBox__int(INT64_C(5), INT64_C(6), INT64_C(7)));
        /* panic-return-signal: ret ctype unknown; no propagation here */
        tur_adt_Box__int __t164 = __ps_163;
