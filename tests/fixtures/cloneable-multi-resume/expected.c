...
static int64_t k_identity(int64_t);
...
static int64_t k_identity(int64_t k) {
        return k;
}
...
int main() {
        {
            ...
            int64_t __t2 = k_identity((int64_t)(intptr_t)__t1);
            int64_t k_618 = __t2;
            (void)k_618;
            printf("%lld\n", (long long)(tur_cloneable_cont_resume(tur_cloneable_cont_clone(k_618), INT64_C(10))));
            printf("%lld\n", (long long)(tur_cloneable_cont_resume(k_618, INT64_C(20))));
        }
        int64_t __t3;
        __t3 = INT64_C(0);
        return (int)__t3;
