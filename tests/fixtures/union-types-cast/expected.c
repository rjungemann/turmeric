...
static int64_t print_as_int(tur_tagged_t);
...
static int64_t print_as_int(tur_tagged_t x) {
        printf("%lld\n", (long long)(((int64_t)(intptr_t)TUR_UNTAG(x))));
        int64_t __t0;
        __t0 = INT64_C(0);
        return __t0;
}
...
int main() {
        (void)(print_as_int(TUR_TAG(3, (int64_t)(intptr_t)(INT64_C(99)))));
        int64_t __t1;
        __t1 = INT64_C(0);
        return (int)__t1;
}
