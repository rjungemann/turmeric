...
static const char * describe(tur_tagged_t);
...
static const char * describe(tur_tagged_t x) {
        const char * __t0 = 0;
        {
            tur_tagged_t __t1 = x;
            if (TUR_GETTAG(__t1) == 0) {
                int64_t n_263 = (int64_t)(intptr_t)TUR_UNTAG(__t1);
                __t0 = "got-int";
            }
            else if (TUR_GETTAG(__t1) == 1) {
                bool b_264 = (bool)(intptr_t)TUR_UNTAG(__t1);
                __t0 = "got-bool";
            }
        }
        return __t0;
...
int main() {
        puts(describe(TUR_TAG(0, (int64_t)(intptr_t)(INT64_C(42)))));
        puts(describe(TUR_TAG(1, (int64_t)(intptr_t)(true))));
        puts(describe(TUR_TAG(0, (int64_t)(intptr_t)(INT64_C(0)))));
        puts(describe(TUR_TAG(1, (int64_t)(intptr_t)(false))));
        int64_t __t2;
        __t2 = INT64_C(0);
        return (int)__t2;
}
