#!/usr/bin/env bash
# Runner for tools/spaced-types-rewrite.py against the test corpus.
#
# Each fixture directory under tests/codemod/spaced-types/ contains:
#   before.tur   -- input
...
CORPUS_DIR="tests/codemod/spaced-types"
TOOL="tools/spaced-types-rewrite.py"
