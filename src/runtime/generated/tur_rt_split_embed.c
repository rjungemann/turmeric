 ...
 * makes at JIT time). */
const uint64_t tur_rt_split_hash = 0x9dd1cc6132974554ull;
...
const char tur_rt_split_decls[] =
  ...
  "\n"
  "int64_t tur_catch_unwind_box_via(int64_t (*__call)(void *), int64_t thunk);\n"
  "\n"
  "int64_t tur_catch_panic_of_box_via(int expected_type, int64_t (*__call)(void *), int64_t thunk);\n"
  "\n"
