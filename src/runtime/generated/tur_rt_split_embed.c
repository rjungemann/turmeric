 ...
 * makes at JIT time). */
const uint64_t tur_rt_split_hash = 0xb0ab08d25e60ff1cull;
...
const char tur_rt_split_decls[] =
  ...
  "int64_t __tur_fatshim6(void *__e, int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5);\n"
  "int64_t __tur_fatshim7(void *__e, int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6);\n"
  "int64_t __tur_fatshim8(void *__e, int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6, int64_t a7);\n"
  ...
  "int64_t __tur_poly_to_fat6(void *__e, int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5);\n"
  "int64_t __tur_poly_to_fat7(void *__e, int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6);\n"
  "int64_t __tur_poly_to_fat8(void *__e, int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6, int64_t a7);\n"
  ...
  "extern __tur_any_tichunk *g_tur_any_types;\n"
  "void __tur_any_register(__tur_any_tichunk *c);\n"
  "const __tur_any_ti *__tur_any_find(int64_t tag);\n"
  ...
  "#endif\n"
  "void tur_escape_live_push(tur_escape_cont *cc);\n"
  "void tur_escape_live_pop(tur_escape_cont *cc);\n"
  ...
  "int64_t __tur_escape_box_any(tur_tagged_t v);\n"
  "\n"
  ...
  "\n"
  "TurFuture *tur_async_fiber_via(int64_t (*wrap)(void *), void *env);\n"
  "\n"
  "typedef struct { int64_t (*call)(void *); void *env; TurFuture *future; } TurAsyncThreadArg;\n"
  "\n"
  "int64_t __tur_async_call_box(void *clos);\n"
  "\n"
  "void *tur_async_thread_main(void *p);\n"
  "\n"
  "TurFuture *tur_async_thread_via(int64_t (*call)(void *), void *env);\n"
  "\n"
  "void tur_future_join_thread(TurFuture *f);\n"
  "\n"
  ...
  "#endif\n"
  "int64_t tur_session_f64_bits(double d);\n"
  "double tur_session_bits_f64(int64_t i);\n"
  "int64_t tur_session_f32_bits(float f);\n"
  "float tur_session_bits_f32(int64_t i);\n"
  "typedef struct {\n"
  "    pthread_mutex_t mu;\n"
  "    pthread_cond_t  cv;\n"
  "    int64_t val;\n"
