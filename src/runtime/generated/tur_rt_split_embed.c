 ...
 * makes at JIT time). */
const uint64_t tur_rt_split_hash = 0x89d1c5bb0818cb97ull;
...
const char tur_rt_split_decls[] =
  ...
  "#endif /* _WIN32 */\n"
  "#ifdef _WIN32\n"
  "#error \"stdlib/re.tur needs POSIX <regex.h>, which MinGW does not provide; regex is not supported on Windows yet\"\n"
  "#else\n"
  "#include <regex.h>\n"
  "#endif\n"
